...
public class RelatorioDiferimentoAnteriorValidadorImpl
				implements ValidadorParametros {

	private static final String PARAMETRO_MES_ANO_REFERENCIA = "mesAnoReferencia";

	private static final String PARAMETRO_DATA_FIM_DIFERIMENTO = "dataFimDiferimento";
	...
	public Map<String, String> validar(Map<String, Object> parametros){
		...
		String dataFimDeferimento = (String) parametros.get(PARAMETRO_DATA_FIM_DIFERIMENTO);

		if(Util.isVazioOuBranco(dataFimDeferimento)){

			erros.put(PARAMETRO_DATA_FIM_DIFERIMENTO, "Data Fim Diferimento");
		}
	...
	private void converterDadosAnoMes(Map<String, Object> parametros){
		...
		if(!Util.isVazioOuBranco(pReferenciaAnoMes)){
			...
			Date pDataFimDiferimento = Util.criarData(ultimoDiaMes, mesReferencia, anoReferencia);

			parametros.put(PARAMETRO_DATA_FIM_DIFERIMENTO, pDataFimDiferimento);
