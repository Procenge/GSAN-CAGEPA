...
public interface ControladorUtilLocal
	...
	public void inserirColecaoObjetos(Collection colecaoContaHistoricoInserir) throws ControladorException;

	public void inserirListaObjetos(List listaObjetos) throws ControladorException;

	public void atualizarColecaoObjetos(Collection colecaoObjetos) throws ControladorException;
	...
	public void registrarOperacaoCodId(ObjetoTransacao objeto, Usuario usuarioLogado, Integer codOperacao) throws ControladorException;

	/**
	 * @param objeto
	 * @param usuarioLogado
	 * @param codOperacao
	 * @param campoValorArgumento
	 *            - Deve ser o nome do campo que retorne um Integer
	 * @throws ControladorException
	 */
