 ...
 * @author rodrigo
 */
public class RemocaoRegistroNaoExistenteException
				extends ErroRepositorioException {
	...
	public RemocaoRegistroNaoExistenteException(Exception excecaoCausa, String mensagem) {
