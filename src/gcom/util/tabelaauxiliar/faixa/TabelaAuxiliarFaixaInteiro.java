 ...
 */
public class TabelaAuxiliarFaixaInteiro
	...
	protected Integer menorFaixa;

	protected Integer maiorFaixa;

	protected String faixaCompleta;

	protected String faixaCompletaComId;
	 ...
	 *            Descrição do parâmetro
	 */
	public TabelaAuxiliarFaixaInteiro(Integer id, Date ultimaAlteracao, Integer menorFaixa, Integer maiorFaixa, String faixaCompleta) {
	...
	public String getFaixaCompleta(){
		...
		faixaCompleta = this.getMenorFaixa() + " a " + this.getMaiorFaixa() + "m2";
