 ...
 */
public class TabelaAuxiliarFaixaReal
	 ...
	 *            Descrição do parâmetro
	 */
	public TabelaAuxiliarFaixaReal(Integer id, Date ultimaAlteracao, BigDecimal faixaInical, BigDecimal faixaFinal, String faixaCompleta) {
	...
	public String getFaixaCompleta(){
		...
		faixaCompleta = this.getVolumeMenorFaixa() + " a " + this.getVolumeMaiorFaixa() + "m3";
