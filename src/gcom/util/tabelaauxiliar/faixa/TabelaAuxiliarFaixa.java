 ...
 */
public abstract class TabelaAuxiliarFaixa
	 ...
	 *            Descrição do parâmetro
	 */
	public TabelaAuxiliarFaixa(Integer id, Date ultimaAlteracao, String faixaInical, String faixaFinal) {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("id", getId()).append("faixaInicial", getFaixaInicial()).append("faixaFinal",
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getId(), castOther.getId()).append(this.getFaixaInicial(), castOther.getFaixaInicial())
						.isEquals();
	}
	...
	public int hashCode(){
		...
		return new HashCodeBuilder().append(getId()).append(getFaixaInicial()).append(getFaixaFinal()).toHashCode();
	}
