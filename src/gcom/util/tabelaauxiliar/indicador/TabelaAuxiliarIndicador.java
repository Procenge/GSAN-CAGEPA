 ...
 * @author gcom
 */
public class TabelaAuxiliarIndicador
	...
	/*
	 * public TabelaAuxiliarIndicador(Integer id, Short indicadorUso, String descricao, Date
	 * ultimaAlteracao, Short indicadorBaixaRenda) {
	 * super.setId(id);
	 ...
	 * this.getIndicador(),
	 * castOther.getIndicador()).isEquals();
	 * }
	 */
	...
	public Filtro retornaFiltro(){
		...
		filtroTabelaAuxiliarIndicador.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliarIndicador.ID, this.getId()));
