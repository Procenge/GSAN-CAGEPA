...
public class ZipUtil {
	 ...
	 * @throws IOException
	 */
	public static void adicionarArquivo(ZipOutputStream zipFile, File file) throws IOException{
	 ...
	 * @throws IOException
	 */
	public static void adicionarPasta(File dir2zip, ZipOutputStream zos) throws IOException{
	...
	/**
	 * Adiciona conjunto de arquivos ao zip
	 * 
	 * @author Hebert Falcão
	 * @date 12/04/2012
	 */
	public static void adicionarArquivos(ZipOutputStream zipFile, File... files) throws IOException{

		List<File> asList = Arrays.asList(files);

		for(File file : asList){
			adicionarArquivo(zipFile, file);
		}
	}
