...
public class ConstantesAplicacao {
	...
	static{
		// Nome do Arquivo de propriedades
		NOME_ARQUIVO_PROPRIEDADES = "/gcom/properties/application.properties";
		loadResources();
	}
	...
	public static String get(String key, String... params){
		...
		return MessageResources.getMessageResources("gcom.properties.application").getMessage(key, params);
	}
	...
	private static void loadResources(){
		...
		try{
			...
			if(stream == null){
				stream = gcom.util.ConstantesAplicacao.class.getClassLoader().getResourceAsStream(NOME_ARQUIVO_PROPRIEDADES);
			}

			if(stream == null){
				stream = gcom.util.ConstantesAplicacao.class.getResourceAsStream(NOME_ARQUIVO_PROPRIEDADES);
			}
