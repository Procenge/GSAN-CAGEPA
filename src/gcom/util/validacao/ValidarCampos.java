...
public class ValidarCampos
	 ...
	 */
	public static boolean validateCpf(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateCnpj(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateCaracterEspecial(Object bean, ValidatorAction va, Field field, ActionErrors errors,
					HttpServletRequest request){

		// texto que vai ser validado
		String texto = ValidatorUtil.getValueAsString(bean, field.getProperty());
		...
		if(texto != null){
			...
			for(int i = 0; i < indesejaveis.length; i++){
				...
				StringTokenizer stringTokenizer = new StringTokenizer(textoBuffer.toString(), delimitador);
	 ...
	 * @return
	 */
	public static boolean validateNumeroSelo(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateMatricula(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){

		// a variável Matricula recebe o valor do campo
		String MATRICULA = ValidatorUtil.getValueAsString(bean, field.getProperty());
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateDecimal(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){

		// a variável Decimal recebe o valor do campo
		String decimal = ValidatorUtil.getValueAsString(bean, field.getProperty());
		...
		if(decimal != null){
			...
			if(!decimal.trim().equals("")){
				try{
					...
					// Verifica o range do float
					if(decimalConvertido.floatValue() > 0f && decimalConvertido.floatValue() < 1000000000f){
						return true;
					}
				}catch(Exception e){
					errors.add(field.getKey(), Resources.getActionError(request, va, field));
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateInteiroZeroPositivo(Object bean, ValidatorAction va, Field field, ActionErrors errors,
					HttpServletRequest request){

		// a variável Inteiro recebe o valor do campo
		String inteiro = ValidatorUtil.getValueAsString(bean, field.getProperty());
		...
		if(!inteiro.trim().equals("")){
			try{
				...
				// Verifica o range do float
				if(inteiroConvertido >= 0 && inteiroConvertido < 2147483647){
					return true;
				}
			}catch(Exception e){
				errors.add(field.getKey(), Resources.getActionError(request, va, field));
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateInteiroNegativoZeroPositivo(Object bean, ValidatorAction va, Field field, ActionErrors errors,
					HttpServletRequest request){
		...
		if(!inteiro.trim().equals("")){
			try{
				...
				// Verifica o range do float
				if(inteiroConvertido >= -2147483647 && inteiroConvertido < 2147483647){
					return true;
				}
			}catch(Exception e){
				errors.add(field.getKey(), Resources.getActionError(request, va, field));
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateMesAno(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){

		// a variável mesAno recebe o valor do campo
		String mesAno = ValidatorUtil.getValueAsString(bean, field.getProperty());
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateHoraMinuto(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){

		// a variável horaMinuto recebe o valor do campo
		String horaMinuto = ValidatorUtil.getValueAsString(bean, field.getProperty());
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateDecimalZeroPositivo(Object bean, ValidatorAction va, Field field, ActionErrors errors,
					HttpServletRequest request){
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateDecimalNegativoZeroPositivo(Object bean, ValidatorAction va, Field field, ActionErrors errors,
					HttpServletRequest request){
		...
		if(!decimal.trim().equals("")){
			try{
				...
				// Verifica o range do float
				if(decimalConvertido.floatValue() > -1000000000f && decimalConvertido.floatValue() < 1000000000f){
					return true;
				}
			}catch(Exception e){
				errors.add(field.getKey(), Resources.getActionError(request, va, field));
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateRadioRequired(Object bean, ValidatorAction va, Field field, ActionErrors errors,
					HttpServletRequest request){
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateCheckRequired(Object bean, ValidatorAction va, Field field, ActionErrors errors,
					HttpServletRequest request){
	 ...
	 * @return Descrição do retorno
	 */
	public static boolean validateBigInteger(Object bean, ValidatorAction va, Field field, ActionErrors errors, HttpServletRequest request){
	...
	/**
	 * Retorna o valor de validaFoto
	 * 
	 * @return O valor de validaFoto
	 */
	public static boolean validaFoto(FormFile foto){

		byte[] fotoByte = null;
		try{
			fotoByte = foto.getFileData();
		...
		if(fotoByte.length != 0){
			...
			if(foto.getFileName().toUpperCase().endsWith(".JPG")){
				// condiciona o arquivo ser menor que 200Kb ou 204800 Bytes
				if(fotoByte.length < 204800){
					return true;
				}else{
	 ...
	 * @return O valor de validaFoto
	 */
	public static boolean validaFotoOrdemServico(FormFile foto){
		...
		if(fotoByte.length != 0){
			// condiciona ao arquivo ser do tipo JPG ou GIF
			if(foto.getFileName().toUpperCase().endsWith(".JPG") || foto.getFileName().toUpperCase().endsWith(".JPEG")
							|| foto.getFileName().toUpperCase().endsWith(".BMP") || foto.getFileName().toUpperCase().endsWith(".GIF")
							|| foto.getFileName().toUpperCase().endsWith(".TIF") || foto.getFileName().toUpperCase().endsWith(".TIFF")
							|| foto.getFileName().toUpperCase().endsWith(".PNG")){
				// condiciona o arquivo ser menor que 200Kb ou 204800 Bytes
				if(fotoByte.length < 204800){
					return true;
				}else{
				...
				throw new ActionServletException("atencao.arquivo_nao_imagem");
			}
		}
		return false;
	}
