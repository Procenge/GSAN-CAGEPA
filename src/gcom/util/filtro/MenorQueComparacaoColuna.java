 ...
 * @date 27/03/2006
 */
public class MenorQueComparacaoColuna
	...
	public MenorQueComparacaoColuna(String nomeAtributoIntervalo, String nomeAtributoIntervaloComparacao) {

		super(nomeAtributoIntervalo);
		this.nomeAtributoIntervaloComparacao = nomeAtributoIntervaloComparacao;
	}

	public MenorQueComparacaoColuna(String nomeAtributoIntervalo, String nomeAtributoIntervaloComparacao, String conector) {

		super(nomeAtributoIntervalo, conector);
		this.nomeAtributoIntervaloComparacao = nomeAtributoIntervaloComparacao;
	}

	public MenorQueComparacaoColuna(String nomeAtributo, String nomeAtributoIntervaloComparacao, String conector,
	...
	public void setNomeAtributoIntervaloComparacao(String nomeAtributoIntervaloComparacao){
