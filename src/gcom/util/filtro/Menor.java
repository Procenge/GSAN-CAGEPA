...
public class Menor
	 ...
	 *            Descrição do parâmetro
	 */
	public Menor(String nomeAtributoIntervalo, String nomeSegundoAtributo) {
	 ...
	 *            Conector da query
	 */
	public Menor(String nomePrimeiroAtributo, String nomeSegundoAtributo, String conector) {
	 ...
	 *            Descrição do parâmetro
	 */
	public Menor(String nomeAtributo, String nomeSegundoAtributo, String conector, int numeroParametrosIsoladosConector) {
