 ...
 * @author rodrigo
 */
public abstract class FiltroParametro
				implements Serializable {

	private static final long serialVersionUID = 7641182780379805655L;
	 ...
	 *            nome do atributo de que será feita a filtragem
	 */
	public FiltroParametro(String nomeAtributo, boolean hasAlias) {
	 ...
	 */
	public FiltroParametro(String nomeAtributo, String conector, int numeroArgumentosIsoladosPeloConector) {
	...
	public boolean equals(Object obj){
		...
		if(obj != null){
			return new EqualsBuilder().append(((FiltroParametro) obj).getNomeAtributo(), getNomeAtributo()).isEquals();
		}
		return false;
	}
