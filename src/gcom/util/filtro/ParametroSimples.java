...
public class ParametroSimples
	...
	public ParametroSimples(boolean hasAlias, String nomeAtributo, Object valor) {

		super(nomeAtributo, hasAlias);
		this.valor = valor;
	}
	 ...
	 *            Descrição do parâmetro
	 */
	public ParametroSimples(String nomeAtributo, Object valor, String conector, int numeroParametrosIsoladosConector) {
