...
public class FachadaException
	 ...
	 */
	public FachadaException(String mensagem, Exception excecaoCausa, List<String> parametrosMensagem) {

		super(mensagem, excecaoCausa);
		this.parametrosMensagem = parametrosMensagem;
	}

	public FachadaException(String mensagem, Exception excecaoCausa, String parametroMensagem) {
	 ...
	 * @param parametroMensagem
	 */
	public FachadaException(String mensagem, String urlBotaoVoltar, Exception excecaoCausa, List<String> parametrosMensagem) {
	...
	public String getParametroMensagem(int numeroMensagem){
		...
		return parametrosMensagem.get(numeroMensagem);
	}
