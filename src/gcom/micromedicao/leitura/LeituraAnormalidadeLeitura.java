...
public class LeituraAnormalidadeLeitura
	 ...
	 */
	public final static Integer ANTERIOR_MAIS_MEDIA = Integer.valueOf(0);

	/**
	 * Description of the Field
	 */
	public final static Integer ANTERIOR = Integer.valueOf(1);

	/**
	 * Description of the Field
	 */
	public final static Integer ANTERIOR_MAIS_CONSUMO = Integer.valueOf(2);

	/**
	 * Description of the Field
	 */
	public final static Integer INFORMADA = Integer.valueOf(3);

	public final static Integer NORMAL = Integer.valueOf(4);

	public static final Integer NAO_OCORRE = Integer.valueOf(5);
	 ...
	 *            Descrição do parâmetro
	 */
	public LeituraAnormalidadeLeitura(String descricaoFaturamento, Short indicadorSemLeitura, Short indicadorComLeitura,
