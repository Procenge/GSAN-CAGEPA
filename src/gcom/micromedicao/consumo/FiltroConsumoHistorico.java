 ...
 */
public class FiltroConsumoHistorico
				extends Filtro {
	...
	public final static String CONSUMO_EMPRESA = "imovel.rota.id";
	...
	public final static String CONSUMO_HISTORICO_CONDOMINIO = "consumoHistoricoCondominio";

	public final static String LIGACAO_TIPO = "ligacaoTipo";
