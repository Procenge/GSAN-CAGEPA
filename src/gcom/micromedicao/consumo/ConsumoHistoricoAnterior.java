...
public class ConsumoHistoricoAnterior
	...
	/** full constructor */
	public ConsumoHistoricoAnterior(Integer id, int anoMesFaturamento, Short indicadorAlteracaoUltimosConsumos, Short indicadorAjuste,
									Integer numeroConsumoFaturadoMes, Integer numeroConsumoRateio, Short indicadorImovelCondominio,
									Integer numeroConsumoMedio, Integer numeroConsumoMinimo, Short indicadorFaturamento,
									BigDecimal percentualColeta, Date ultimaAlteracao, Rota rota, ConsumoAnormalidade consumoAnormalidade,
									PocoTipo pocoTipo, Imovel imovel, LigacaoTipo ligacaoTipo,
									ConsumoHistoricoAnterior consumoHistoricoAnterior, FaturamentoSituacaoTipo faturamentoSituacaoTipo,
									ConsumoTipo consumoTipo, RateioTipo rateioTipo) {
	...
	public void setConsumoHistoricoAnterior(ConsumoHistoricoAnterior consumoHistoricoAnterior){
