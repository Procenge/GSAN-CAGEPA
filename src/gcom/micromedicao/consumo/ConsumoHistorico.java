...
public class ConsumoHistorico
	...
	public static final int ATRIBUTOS_SUBSTITUIR_CONSUMOS_ANTERIORES = 355; // Operacao.OPERACAO_SUBSTITUIR_CONSUMOS_ANTERIORES;
	...
	@ControleAlteracao(funcionalidade = ATRIBUTOS_SUBSTITUIR_CONSUMOS_ANTERIORES)
	 ...
	 */
	public final static Short INDICADOR_FATURAMENTO_FATURAR_AGUA = Short.valueOf("1");
	 ...
	 */
	public final static Short INDICADOR_FATURAMENTO_FATURAR_ESGOTO = Short.valueOf("2");

	public final static Short FATURAR_AGUA = Short.valueOf("1");

	public final static Short FATURAR_ESGOTO = Short.valueOf("1");

	/**
	 * Description of the Field
	 */
	public final static Integer NUMERO_CONSUMO_FATURADO_MES_PADRAO = Integer.valueOf(0);
	 ...
	 * full constructor
	 * 
	 * @param consumoMinimoCreditado
	 *            TODO
	 */
	public ConsumoHistorico(int referenciaFaturamento, Short indicadorAlteracaoUltimosConsumos, Short indicadorAjuste,
							Integer numeroConsumoFaturadoMes, Integer consumoRateio, Short indicadorImovelCondominio, Integer consumoMedio,
							Integer consumoMinimo, Short indicadorFaturamento, BigDecimal percentualColeta, Date ultimaAlteracao,
							Integer consumoImovelCondominio, Integer consumoImovelVinculadosCondominio,
							gcom.micromedicao.consumo.ConsumoHistorico consumoHistoricoCondominio,
							gcom.micromedicao.consumo.ConsumoTipo consumoTipo, RateioTipo rateioTipo,
							gcom.micromedicao.consumo.LigacaoTipo ligacaoTipo,
							gcom.micromedicao.consumo.ConsumoAnormalidade consumoAnormalidade, PocoTipo pocoTipo,
							FaturamentoSituacaoTipo faturamentoSituacaoTipo, Imovel imovel, Integer consumoMinimoCreditado) {
		...
		this.imovel = imovel;
		this.consumoMinimoCreditado = consumoMinimoCreditado;
	}
	...
	public ConsumoHistorico(ConsumoHistorico consumoHistorico) {
		...
		this.consumoMinimoCreditado = consumoHistorico.getConsumoMinimoCreditado();
	}
	...
	/** minimal constructor */
	public ConsumoHistorico(int referenciaFaturamento, gcom.micromedicao.consumo.ConsumoHistorico consumoHistoricoCondominio,
							gcom.micromedicao.consumo.ConsumoTipo consumoTipo, RateioTipo rateioTipo,
							gcom.micromedicao.consumo.LigacaoTipo ligacaoTipo,
							gcom.micromedicao.consumo.ConsumoAnormalidade consumoAnormalidade, PocoTipo pocoTipo,
							FaturamentoSituacaoTipo faturamentoSituacaoTipo, Imovel imovel) {
	...
	public ConsumoHistorico(Integer id) {
	...
	public void setConsumoHistoricoCondominio(gcom.micromedicao.consumo.ConsumoHistorico consumoHistoricoCondominio){
	...
	public void setConsumoAnormalidade(gcom.micromedicao.consumo.ConsumoAnormalidade consumoAnormalidade){
	 ...
	 *            O consumoImovelVinculadosCondominio a ser setado.
	 */
	...
	public Integer getConsumoMinimoCreditado(){

		return consumoMinimoCreditado;
	}

	public void setConsumoMinimoCreditado(Integer consumoMinimoCreditado){
	...
	public Filtro retornaFiltro(){
		...
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.CONSUMO_HISTORICO_CONDOMINIO);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.LIGACAO_TIPO);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.CONSUMO_ANORMALIDADE);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.POCO_TIPO);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.FATURAMENTO_SITUACAO_TIPO);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.IMOVEL);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.ROTA);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.RATEIO_TIPO);
		filtroConsumoHistorico.adicionarCaminhoParaCarregamentoEntidade(FiltroConsumoHistorico.CONSUMO_TIPO);
		filtroConsumoHistorico.adicionarParametro(new ParametroSimples(FiltroConsumoHistorico.ID, this.getId()));
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"imovel.id", "consumoTipo.descricao", "mesAno"};
		return atributos;
	}

	public String[] retornarLabelsInformacoesOperacaoEfetuada(){

		String[] labels = {"Id Imovel", "Tipo Cons", "Ref."};
		return labels;
	}
