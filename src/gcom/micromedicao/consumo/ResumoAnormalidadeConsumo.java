...
public class ResumoAnormalidadeConsumo {
	...
	public ResumoAnormalidadeConsumo(Integer id, Integer anoMesReferencia, Integer codigoSetorComercial, Integer numeroQuadra,
										Integer quantidadeLigacoes, GerenciaRegional gerenciaRegional, Localidade localidade,
										...
										Categoria categoria, EsferaPoder esferaPoder, ConsumoAnormalidade consumoAnormalidade,
	...
	public ResumoAnormalidadeConsumo(Integer anoMesReferencia, Integer codigoSetorComercial, Integer numeroQuadra,
										Integer quantidadeLigacoes, GerenciaRegional gerenciaRegional, Localidade localidade,
										SetorComercial setorComercial, Rota rota, Quadra quadra, ImovelPerfil imovelPerfil,
										LigacaoAguaSituacao ligacaoAguaSituacao, LigacaoEsgotoSituacao ligacaoEsgotoSituacao,
										Categoria categoria, EsferaPoder esferaPoder, ConsumoAnormalidade consumoAnormalidade,
										LigacaoTipo ligacaoTipo, Localidade eloLocalidade) {
	...
	public ResumoAnormalidadeConsumo(Integer anoMesReferencia, Integer codigoSetorComercial, Integer numeroQuadra,
										...
										LigacaoAguaSituacao ligacaoAguaSituacao, LigacaoEsgotoSituacao ligacaoEsgotoSituacao,
										Categoria categoria, EsferaPoder esferaPoder, ConsumoAnormalidade consumoAnormalidade,
										LigacaoTipo ligacaoTipo, Localidade eloLocalidade, UnidadeNegocio unidadeNegocio) {
	...
	/**
	 * @param anoMesRreferencia
	 *            O anoMesRreferencia a ser setado.
	 */
