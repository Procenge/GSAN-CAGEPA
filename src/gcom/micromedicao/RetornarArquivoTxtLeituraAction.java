 ...
 * @date 27/08/2007
 */
public class RetornarArquivoTxtLeituraAction
				extends GcomAction {

	/**
	 * Este caso de uso permite Retornar um Arquivo Txt Leitura
	 * [UC0437] Retornar Arquivo Txt Leitura
	 * 
	 * @author Thiago Tenório
	 * @date 31/07/2006
	 * @param actionMapping
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaoArquivoTxtLeitura = fachada.pesquisar(filtroArquivoTextoRoteiroEmpresa, ArquivoTextoRoteiroEmpresa.class
						.getName());
		...
		try{
			...
			httpServletResponse.addHeader("Content-Disposition", "attachment; filename=numeroArquivo.txt");
