...
public class HidrometroMovimentadoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("hidrometroMovimentacaoId", getHidrometroMovimentacaoId()).append("hidrometroId",
						getHidrometroId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getHidrometroMovimentacaoId(), castOther.getHidrometroMovimentacaoId()).append(
						this.getHidrometroId(), castOther.getHidrometroId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getHidrometroMovimentacaoId()).append(getHidrometroId()).toHashCode();
	}
