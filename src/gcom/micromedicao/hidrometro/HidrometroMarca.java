...
public class HidrometroMarca
	...
	/** full constructor */
	public HidrometroMarca(String descricao, String descricaoAbreviada, short intervaloDiasRevisao, Short indicadorUso, Date ultimaAlteracao) {
	...
	/** minimal constructor */
	public HidrometroMarca(String descricao, String descricaoAbreviada, short intervaloDiasRevisao) {
	...
	public boolean equals(Object other){
		...
		if(!(other instanceof HidrometroMarca)){
			return false;
		}
		HidrometroMarca castOther = (HidrometroMarca) other;
