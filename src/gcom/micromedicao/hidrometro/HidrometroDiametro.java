...
public class HidrometroDiametro
	...
	/** full constructor */
	public HidrometroDiametro(String descricao, String descricaoAbreviada, Short indicadorUso, Date ultimaAlteracao) {
	...
	public Filtro retornaFiltro(){
		...
		filtroHidrometroDiametro.adicionarParametro(new ParametroSimples(FiltroHidrometroDiametro.ID, this.getId()));
		return filtroHidrometroDiametro;
	}
