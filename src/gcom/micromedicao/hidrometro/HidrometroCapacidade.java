...
public class HidrometroCapacidade
	...
	public static final String CAPACIDADE_K = "K";

	public static final String CAPACIDADE_M = "M";

	public static final String CAPACIDADE_N = "N";

	public static final String CAPACIDADE_P = "P";

	public static final String CAPACIDADE_Q = "Q";

	public static final String CAPACIDADE_R = "R";

	/** full constructor */
	public HidrometroCapacidade(String descricao, String descricaoAbreviada, Short leituraMinimo, Short leituraMaximo, Short indicadorUso,
	...
	public String getNumeroDigitosLeituraMinimoMaximo(){
		...
		return (getLeituraMinimo().toString() + " - " + getLeituraMaximo().toString());
	}
	...
	public Filtro retornaFiltro(){
		...
		filtroHidrometroCapacidade.adicionarParametro(new ParametroSimples(FiltroHidrometroCapacidade.ID, this.getId()));
		// Estava dando erro no Interceptor.java em consultarDescricao pois a descrição não é uma
		// entidade para ser carregada.
