...
public class FiltroRota
	...
	public static final String FATURAMENTO_GRUPO_DESCRICAO = "faturamentoGrupo.descricao";
	...
	public static final String SETOR_COMERCIAL_LOCALIDADE = "setorComercial.localidade";
	...
	public static final String CODIGO_LEITURISTA_ID = "leiturista.id";

	public static final String LEITURA_TIPO_DESCRICAO = "leituraTipo.descricao";

	public static final String SETOR_COMERCIAL_INDICADOR_USO = "setorComercial.indicadorUso";

	public static final String SETOR_COMERCIAL_LOCALIDADE_INDICADOR_USO = "setorComercial.localidade.indicadorUso";

	public static final String FATURAMENTO_GRUPO_INDICADOR_USO = "faturamentoGrupo.indicadorUso";
