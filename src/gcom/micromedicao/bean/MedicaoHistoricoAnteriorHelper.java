 ...
 * @date 11/09/2008
 *       Alteração para obter o CreditoConsumoAnterior do mês da Referência, segundo alterações no
 *       [UC0082]/[UC0712]
 */
public class MedicaoHistoricoAnteriorHelper {
	...
	public void setIdHidrometroInstalacaoHistorico(Integer idHidrometroInstalacaoHistorico){
	...
	public void setLeituraAtualMesAnteriorFaturamento(int leituraAtualMesAnteriorFaturamento){
	...
	public void setLeituraAtualMesAnteriorInformada(int leituraAtualMesAnteriorInformada){

		this.leituraAtualMesAnteriorInformada = leituraAtualMesAnteriorInformada;
	}

	/**
	 * @return the numeroConsumoCreditoAnterior
	 */
	public Integer getNumeroConsumoCreditoAnterior(){

		return numeroConsumoCreditoAnterior;
	}

	/**
	 * @param numeroConsumoCreditoAnterior
	 *            the numeroConsumoCreditoAnterior to set
	 */
