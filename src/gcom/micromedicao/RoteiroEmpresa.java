...
public class RoteiroEmpresa
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroRoteiroEmpresa.ID_ROTEIRO, this.getId()));
		return filtro;
	}
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"id", "empresa.descricao", "leiturista.cliente.nome", "leiturista.funcionario.nome"};
		return atributos;
	}
	...
	public String[] retornarLabelsInformacoesOperacaoEfetuada(){
		...
		String[] labels = {"Código do Roteiro Empresa", "Empresa", "Nome do Cliente", "Nome do Funcionário"};
		return labels;
	}
}
