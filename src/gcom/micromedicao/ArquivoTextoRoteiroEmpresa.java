...
public class ArquivoTextoRoteiroEmpresa
	...
	/** full constructor */
	public ArquivoTextoRoteiroEmpresa(Integer id, Integer anoMesReferencia, Integer codigoSetorComercial1, Integer numeroQuadraInicial1,
										Integer numeroQuadraFinal1, Integer codigoSetorComercial2, Integer numeroQuadraInicial2,
										Integer numeroQuadraFinal2, Integer codigoSetorComercial3, Integer numeroQuadraInicial3,
										Integer numeroQuadraFinal3, Integer quantidadeImovel, String numeroArquivo,
										String codigoLeiturista, String numeroFoneLeiturista, Date tempoEnvioEmpresa, byte[] arquivoTexto,
										Date ultimaAlteracao, Localidade localidade, FaturamentoGrupo faturamentoGrupo,
										gcom.micromedicao.Leiturista leiturista, gcom.micromedicao.RoteiroEmpresa roteiroEmpresa,
										Empresa empresa, SituacaoTransmissaoLeitura situacaoTransmissaoLeitura) {
	...
	/** minimal constructor */
	public ArquivoTextoRoteiroEmpresa(Integer id, Integer anoMesReferencia, Integer codigoSetorComercial1, Integer numeroQuadraInicial1,
										Integer numeroQuadraFinal1, Integer quantidadeImovel, String numeroArquivo,
										String codigoLeiturista, String numeroFoneLeiturista, byte[] arquivoTexto, Date ultimaAlteracao,
										Localidade localidade, FaturamentoGrupo faturamentoGrupo, gcom.micromedicao.Leiturista leiturista,
										gcom.micromedicao.RoteiroEmpresa roteiroEmpresa, Empresa empresa,
