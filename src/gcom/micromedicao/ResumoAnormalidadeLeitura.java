...
public class ResumoAnormalidadeLeitura {
	...
	public ResumoAnormalidadeLeitura(Integer id, Integer anoMesReferencia, Integer codigoSetorComercial, Integer numeroQuadra,
										Integer quantidadeMedicao, Date ultimaAlteracao, GerenciaRegional gerenciaRegional,
										Localidade localidade, SetorComercial setorComercial, Rota rota, Quadra quadra,
										ImovelPerfil imovelPerfil, LigacaoAguaSituacao ligacaoAguaSituacao,
										LigacaoEsgotoSituacao ligacaoEsgotoSituacao, Categoria categoria, EsferaPoder esferaPoder,
										MedicaoTipo medicaoTipo, LeituraAnormalidade leituraAnormalidade) {
	...
	public ResumoAnormalidadeLeitura(Integer id, Integer anoMesReferencia, Integer codigoSetorComercial, Integer numeroQuadra,
										...
										ImovelPerfil imovelPerfil, LigacaoAguaSituacao ligacaoAguaSituacao,
										LigacaoEsgotoSituacao ligacaoEsgotoSituacao, Categoria categoria, EsferaPoder esferaPoder,
										MedicaoTipo medicaoTipo, LeituraAnormalidade leituraAnormalidade, UnidadeNegocio unidadeNegocio) {
	...
	/**
	 * @param quantidadeMedicao
	 *            O quantidadeMedicao a ser setado.
	 */
	...
	/**
	 * @return Retorna o campo eloLocalidade.
	 */
