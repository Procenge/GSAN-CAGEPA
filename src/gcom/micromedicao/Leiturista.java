...
public class Leiturista
	...
	/** full constructor */
	public Leiturista(Integer id, String codigoDDD, String numeroFone, Short indicadorUso, Date ultimaAlteracao, Cliente cliente,
						Funcionario funcionario, Set roteiroEmpresas) {
	...
	/** minimal constructor */
	public Leiturista(Integer id, Date ultimaAlteracao, Cliente cliente, Funcionario funcionario, Set roteiroEmpresas) {
	...
	public String getIdDescricao(){
		...
		return getId() + " - " + (getCliente() != null ? getCliente().getNome() : "")
						+ (getFuncionario() != null ? getFuncionario().getNome() : "");
	}

	public String getNomeLeiturista(){

		return (getCliente() != null ? getCliente().getNome() : "") + (getFuncionario() != null ? getFuncionario().getNome() : "");
	}
