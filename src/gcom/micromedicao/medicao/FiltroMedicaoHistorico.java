 ...
 */
public class FiltroMedicaoHistorico
				extends Filtro
	...
	public final static String GRUPO_FATURAMENTO = "imovel.rota.faturamentoGrupo.id";

	public final static String IMOVEL_EMPRESA = "imovel.rota.empresa.id";
	...
	public final static String MEDICAO_EMPRESA = "imovel.rota.empresa.id";
	...
	public final static String MH_DT_LEITURA_ATUAL_FAT = "dataLeituraAtualFaturamento";

	public final static String MH_DT_LEITURA_ANTERIOR_FAT = "dataLeituraAnteriorFaturamento";

	public final static String LEITURA_ANORMALIDADE_FATURADA = "leituraAnormalidadeFaturamento";
