...
public class CreditoRealizadoCategoriaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("creditoRealizado", getCreditoRealizado()).append("categoria", getCategoria()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getCreditoRealizado(), castOther.getCreditoRealizado()).append(this.getCategoria(),
						castOther.getCategoria()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getCreditoRealizado()).append(getCategoria()).toHashCode();
	}
