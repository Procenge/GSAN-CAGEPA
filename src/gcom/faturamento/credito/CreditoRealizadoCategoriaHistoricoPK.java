...
public class CreditoRealizadoCategoriaHistoricoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("creditoRealizadoHistoricoId", getCreditoRealizadoHistoricoId()).append("categoriaId",
						getCategoriaId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getCreditoRealizadoHistoricoId(), castOther.getCreditoRealizadoHistoricoId()).append(
						this.getCategoriaId(), castOther.getCategoriaId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getCreditoRealizadoHistoricoId()).append(getCategoriaId()).toHashCode();
	}
