...
public class CreditoARealizar
	...
	/** persistent field */
	private Set<CreditoARealizarCategoria> creditoARealizarCategoria;
	...
	public CreditoARealizar(Date geracaoCredito, Integer anoMesReferenciaCredito, Integer anoMesReferenciaContabil,
							...
							Short numeroPrestacaoCredito, Short numeroPrestacaoRealizada, Integer codigoSetorComercial,
							Integer numeroQuadra, Short numeroLote, Short numeroSubLote, Date ultimaAlteracao,
							RegistroAtendimento registroAtendimento, Imovel imovel, OrdemServico ordemServico, Quadra quadra,
							Localidade localidade, gcom.faturamento.credito.CreditoTipo creditoTipo,
							LancamentoItemContabil lancamentoItemContabil, DebitoCreditoSituacao debitoCreditoSituacaoAtual,
							DebitoCreditoSituacao debitoCreditoSituacaoAnterior, gcom.faturamento.credito.CreditoOrigem creditoOrigem,
							Parcelamento parcelamento, DocumentoTipo documentoTipo, Set creditoARealizarCategoria) {
	...
	/** minimal constructor */
	public CreditoARealizar(Date geracaoCredito, RegistroAtendimento registroAtendimento, Imovel imovel, OrdemServico ordemServico,
							Quadra quadra, Localidade localidade, LancamentoItemContabil lancamentoItemContabil,
							DebitoCreditoSituacao debitoCreditoSituacaoAtual, DebitoCreditoSituacao debitoCreditoSituacaoAnterior,
							gcom.faturamento.credito.CreditoOrigem creditoOrigem, Parcelamento parcelamento, DocumentoTipo documentoTipo,
	...
	public void setCreditoOrigem(gcom.faturamento.credito.CreditoOrigem creditoOrigem){
	...
	/**
	 * Obtem o valor "liquido" (restante) de um Credito a Realizar, baseado em suas parcelas.
	 * Obrigatório que atributos de nr. parcelas concedidas, totais e valor total do credito estejam
	 * atribuidos.
	 * 
	 * @return BigDecimal [valor liquido credito]
	 * @author eduardo henrique
	 * @date 04/08/2009
	 */
	public BigDecimal getValorTotal(){

		BigDecimal retornoDivisao = BigDecimal.ZERO; // valor por Prestação
		BigDecimal retornoMultiplicacao = BigDecimal.ZERO; // valor já concedido
		BigDecimal retornoSubtracao = BigDecimal.ZERO;
	...
	public short getParcelasRestante(){
		...
		short retorno = Short.parseShort("" + (getNumeroPrestacaoCredito() - getNumeroPrestacaoRealizada()));
	...
	public Filtro retornaFiltro(){
		...
		filtroCreditoARealizar.adicionarCaminhoParaCarregamentoEntidade(FiltroCreditoARealizar.DEBITO_CREDITO_SITUACAO_ANTERIOR);
		...
		filtroCreditoARealizar.adicionarParametro(new ParametroSimples(FiltroCreditoARealizar.ID, this.getId()));
	 ...
	 *            O creditoARealizarGeral a ser setado.
	 */
	...
	public boolean equals(Object other){
		...
		if(!(other instanceof CreditoARealizar)) return false;
		CreditoARealizar castOther = (CreditoARealizar) other;
