...
public class CreditoARealizarCategoriaHistoricoPK
	...
	/** full constructor */
	public CreditoARealizarCategoriaHistoricoPK(CreditoARealizarHistorico creditoARealizarHistorico, Categoria categoria) {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("creditoARealizarHistorico", getCreditoARealizarHistorico()).append("categoria",
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getCreditoARealizarHistorico(), castOther.getCreditoARealizarHistorico()).append(
						this.getCategoria(), castOther.getCategoria()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getCreditoARealizarHistorico()).append(getCategoria()).toHashCode();
	}
