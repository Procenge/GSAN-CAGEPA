...
public class CreditoRealizado
	...
	/** persistent field */
	private Date dataHoraCreditoRealizado;
	...
	private Boolean pgtAssociado;

	private PagamentoHistorico pagamentoHistorico;

	/** full constructor */
	public CreditoRealizado(Date creditoRealizado, Integer codigoSetorComercial, Integer numeroQuadra, Short numeroLote,
							Short numeroSubLote, Integer anoMesReferenciaCredito, Integer anoMesCobrancaCredito, BigDecimal valorCredito,
							Short numeroPrestacao, Short numeroPrestacaoCredito, Date ultimaAlteracao, Conta conta, Quadra quadra,
							Localidade localidade, gcom.faturamento.credito.CreditoTipo creditoTipo,
							LancamentoItemContabil lancamentoItemContabil, Set creditoRealizadoCategorias, CreditoOrigem creditoOrigem) {

		this.dataHoraCreditoRealizado = creditoRealizado;
	...
	/** minimal constructor */
	public CreditoRealizado(Date creditoRealizado, Conta conta, Quadra quadra, Localidade localidade,
							LancamentoItemContabil lancamentoItemContabil, Set creditoRealizadoCategorias) {
	...
	public Date getDataHoraCreditoRealizado(){

		return this.dataHoraCreditoRealizado;
	}

	public void setDataHoraCreditoRealizado(Date creditoRealizado){
	...
	public Boolean getPgtAssociado(){

		return pgtAssociado;
	}

	public void setPgtAssociado(Boolean pgtAssociado){

		this.pgtAssociado = pgtAssociado;
	}
	...
	public String getHint(){
		...
		if(this.creditoTipo != null){

			retorno.append("Tipo do Crédito: " + this.creditoTipo.getDescricao());

		}else{

			retorno.append("Tipo do Crédito: ");
		}

		retorno.append(System.getProperty("line.separator"));

		if(this.creditoOrigem != null){

			retorno.append("Origem do Crédito: " + this.creditoOrigem.getDescricao());

		}else{

			retorno.append("Origem do Crédito: ");

		}

		retorno.append(System.getProperty("line.separator"));

		if(this.pgtAssociado != null && this.pgtAssociado){
			retorno.append("Pagamento Associado: SIM");

		}else{

			retorno.append("Pagamento Associado: NÃO");
		}

		retorno.append(System.getProperty("line.separator"));

		if(this.pagamentoHistorico != null && this.pagamentoHistorico.getId() != null){

			retorno.append("Id do pagamento em histórico: " + this.pagamentoHistorico.getId());
