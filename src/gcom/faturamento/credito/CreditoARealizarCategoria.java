...
public class CreditoARealizarCategoria
	...
	/** full constructor */
	public CreditoARealizarCategoria(gcom.faturamento.credito.CreditoARealizarCategoriaPK comp_id, Integer quantidadeEconomia,
										BigDecimal valorCategoria, Date ultimaAlteracao,
										gcom.faturamento.credito.CreditoARealizar creditoARealizar, Categoria categoria) {
	...
	public Filtro retornaFiltro(){
		...
		filtroCreditoARealizarCategoria.adicionarParametro(new ParametroSimples(FiltroCreditoARealizarCategoria.ID_CATEGORIA, categoria
						.getId()));
