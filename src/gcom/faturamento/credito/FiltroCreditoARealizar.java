 ...
 * @author Saulo Lima
 * @date 05/02/2009
 *       Acréscimo e organização das constantes
 */
public class FiltroCreditoARealizar
				extends Filtro
	...
	public final static String ORIGEM_CREDITO_A_REALIZAR_IMOVEL = "origem.creditoARealizar.imovel";
	...
	public static final String DATA_GERACAO_CREDITO = "geracaoCredito";

	public static final String CREDITO_TIPO_DESCRICAO = "creditoTipo.descricao";

	public static final String PRESTACAO_CREDITO_NUMERO = "numeroPrestacaoCredito";

	public static final String PRESTACAO_REALIZADA_NUMERO = "numeroPrestacaoRealizada";

	public final static String ID_PAGAMENTO_HISTORICO = "pagamentoHistorico.id";
