...
public class EmitirHistogramaEsgotoHelper
	...
	public void setColecaoEmitirHistogramaEsgotoDetalhe(Collection<EmitirHistogramaEsgotoDetalheHelper> colecaoEmitirHistogramaEsgotoDetalhe){
	...
	public int getTotalMediaConsumo(){
		...
		if(this.totalQuantidadeLigacoes > 0){
			media = this.totalQuantidadeVolumeTotal / this.totalQuantidadeLigacoes;
		}
	...
	public void setTotalPercentualAcumuladoConsumo(double totalPercentualAcumuladoConsumo){
	...
	public void setTotalPercentualAcumuladoFaturamento(double totalPercentualAcumuladoFaturamento){
	...
	public void setTotalPercentualAcumuladoLigacao(double totalPercentualAcumuladoLigacao){
	...
	public void setTotalPercentualParcialConsumo(double totalPercentualParcialConsumo){
	...
	public void setTotalPercentualParcialFaturamento(double totalPercentualParcialFaturamento){
	...
	public void setTotalPercentualParcialLigacao(double totalPercentualParcialLigacao){
	...
	public int getTotalQuantidadeVolumeTotal(){
		...
		int total = this.totalQuantidadeVolumeMedido + this.totalQuantidadeVolumeEstimado;
