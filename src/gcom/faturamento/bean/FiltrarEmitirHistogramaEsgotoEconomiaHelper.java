 ...
 * @date 07/11/2007
 */
public class FiltrarEmitirHistogramaEsgotoEconomiaHelper
	...
	private Integer idFuncionalidadeIniciada = null;
	...
	public FiltrarEmitirHistogramaEsgotoEconomiaHelper(FiltrarEmitirHistogramaEsgotoEconomiaHelper filtro) {
		...
		this.idFuncionalidadeIniciada=filtro.getIdFuncionalidadeIniciada();
	}
	...
	public void setLinkedHashMapConsumoFaixaCategoria(LinkedHashMap linkedHashMapConsumoFaixaCategoria){
	...
	public void setColecaoPercentualLigacaoEsgoto(Collection<BigDecimal> colecaoPercentualLigacaoEsgoto){
	...
	public Integer getIdFuncionalidadeIniciada(){
	
		return idFuncionalidadeIniciada;
	}

	
	public void setIdFuncionalidadeIniciada(Integer idFuncionalidadeIniciada){
