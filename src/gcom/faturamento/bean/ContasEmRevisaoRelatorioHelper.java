...
public class ContasEmRevisaoRelatorioHelper {
	 ...
	 *            O anoMesReferenciaConta a ser setado.
	 */
	...
	/**
	 * @param descricaoMotivoRevisao
	 *            O descricaoMotivoRevisao a ser setado.
	 */
	...
	public String getInscricaoFormatada(){
		...
		imovel.setLocalidade(new Localidade(this.getIdLocalidade()));
		imovel.setSetorComercial(new SetorComercial(this.getCodigoSetorComercial().intValue()));
		imovel.setQuadra(new Quadra(this.getNumeroQuadra().intValue()));
		imovel.setLote(this.getLote().shortValue());
		imovel.setSubLote(this.getSublote().shortValue());
