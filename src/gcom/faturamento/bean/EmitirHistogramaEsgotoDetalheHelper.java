...
public class EmitirHistogramaEsgotoDetalheHelper
	...
	public int getMediaConsumo(){
		...
		if(this.quantidadeLigacoes > 0){
			media = this.quantidadeVolumeTotal / this.quantidadeLigacoes;
		}
	...
	public void setPercentualAcumuladoFaturamento(double percentualAcumuladoFaturamento){
	...
	public int getQuantidadeVolumeTotal(){
		...
		int total = this.quantidadeVolumeMedido + this.quantidadeVolumeEstimado;
