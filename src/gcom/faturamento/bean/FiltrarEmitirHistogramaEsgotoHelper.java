 ...
 * @date 05/11/2007
 */
public class FiltrarEmitirHistogramaEsgotoHelper
	...
	public void setConsumoFaixaLigacaoIntervaloMedido(ConsumoFaixaLigacao consumoFaixaLigacaoIntervaloMedido){

		this.consumoFaixaLigacaoIntervaloMedido = consumoFaixaLigacaoIntervaloMedido;
	}

	public void setConsumoFaixaLigacaoIntervaloNaoMedido(ConsumoFaixaLigacao consumoFaixaLigacaoIntervaloNaoMedido){
	...
	public void setColecaoSituacaoLigacaoEsgoto(Collection<Integer> colecaoSituacaoLigacaoEsgoto){
	...
	public FiltrarEmitirHistogramaEsgotoHelper(FiltrarEmitirHistogramaEsgotoHelper filtro) {
		...
		this.colecaoConsumoFaixaLigacaoMedido = filtro.getColecaoConsumoFaixaLigacaoMedido();
		this.colecaoConsumoFaixaLigacaoNaoMedido = filtro.getColecaoConsumoFaixaLigacaoNaoMedido();
	...
	public void setColecaoConsumoFaixaLigacaoMedido(Collection<ConsumoFaixaLigacao> colecaoConsumoFaixaLigacaoMedido){
	...
	public void setColecaoConsumoFaixaLigacaoNaoMedido(Collection<ConsumoFaixaLigacao> colecaoConsumoFaixaLigacaoNaoMedido){
	...
	public ConsumoFaixaLigacao retornaOLimiteConsultaTotal(short indicadorHidrometro){
		...
		if(indicadorHidrometro == ConstantesSistema.INDICADOR_USO_ATIVO.shortValue()){
			...
			if(this.colecaoConsumoFaixaLigacaoMedido != null && !this.colecaoConsumoFaixaLigacaoMedido.isEmpty()){
			...
			if(this.colecaoConsumoFaixaLigacaoNaoMedido != null && !this.colecaoConsumoFaixaLigacaoNaoMedido.isEmpty()){
	...
	public Collection getColecaoPercentualLigacaoEsgoto(){

		return colecaoPercentualLigacaoEsgoto;
	}

	public void setColecaoPercentualLigacaoEsgoto(Collection colecaoPercentualLigacaoEsgoto){
