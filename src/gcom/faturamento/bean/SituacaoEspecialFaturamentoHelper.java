 ...
 * @date 09/01/2009
 *       Alteração para inclusão de mais um filtro , nome de Bairro.
 */
public class SituacaoEspecialFaturamentoHelper {

	private String idImovel;

	private String idsImoveis;
	...
	private String indicadorNovo;

	private Boolean mesAnoReferenciaMenorIgualInicial = Boolean.FALSE;

	private Boolean mesAnoReferenciaMenorIgualFinal = Boolean.FALSE;

	public String getIdsImoveis(){

		return idsImoveis;
	}

	public void setIdsImoveis(String idsImoveis){
	...
	public void setQuantidadeImoveisCOMSituacaoEspecialFaturamento(String quantidadeImoveisCOMSituacaoEspecialFaturamento){
	...
	public void setQuantidadeImoveisSEMSituacaoEspecialFaturamento(String quantidadeImoveisSEMSituacaoEspecialFaturamento){
	...
	public String getIndicadorNovo(){

		return indicadorNovo;
	}

	public void setIndicadorNovo(String indicadorNovo){

		this.indicadorNovo = indicadorNovo;
	}

	/**
	 * @return the mesAnoReferenciaMenorIgualInicial
	 */
	public Boolean getMesAnoReferenciaMenorIgualInicial(){

		return mesAnoReferenciaMenorIgualInicial;
	}

	/**
	 * @param mesAnoReferenciaMenorIgualInicial the mesAnoReferenciaMenorIgualInicial to set
	 */
	public void setMesAnoReferenciaMenorIgualInicial(Boolean mesAnoReferenciaMenorIgualInicial){

		this.mesAnoReferenciaMenorIgualInicial = mesAnoReferenciaMenorIgualInicial;
	}

	/**
	 * @return the mesAnoReferenciaMenorIgualFinal
	 */
	public Boolean getMesAnoReferenciaMenorIgualFinal(){

		return mesAnoReferenciaMenorIgualFinal;
	}

	/**
	 * @param mesAnoReferenciaMenorIgualFinal the mesAnoReferenciaMenorIgualFinal to set
	 */
	public void setMesAnoReferenciaMenorIgualFinal(Boolean mesAnoReferenciaMenorIgualFinal){

		this.mesAnoReferenciaMenorIgualFinal = mesAnoReferenciaMenorIgualFinal;
	}
	...
	public boolean equals(Object o){
		...
		if(o instanceof String){
			String idImovelObjeto = (String) o;
			return idImovelObjeto.equals(idImovel);
		}
		if(o instanceof SituacaoEspecialFaturamentoHelper){
			SituacaoEspecialFaturamentoHelper objeto = (SituacaoEspecialFaturamentoHelper) o;
			return this.idImovel.equals(objeto.getIdImovel());
		}
		return false;
	}
