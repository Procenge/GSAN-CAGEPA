...
@ControleAlteracao()
public class FaturamentoAtividadeCronograma
				extends ObjetoTransacao {

	private static final long serialVersionUID = 1L;

	/** Inserir Comando de Atividade de Faturamento */
	public static final int ATRIBUTO_INSERIR_COMANDO_ATIVIDADE_FATURAMENTO = 437;

	/** Remover Comando de Atividade de Faturamento */
	public static final int ATRIBUTO_REMOVER_COMANDO_ATIVIDADE_FATURAMENTO = 438;

	/** Atualizar Comando de Atividade de Faturamento */
	public static final int ATRIBUTO_ATUALIZAR_COMANDO_ATIVIDADE_FATURAMENTO = 442;

	public static final int ATRIBUTO_ATUALIZAR_COMANDO_ATIVIDADE_DATA_VENCIMENTO_FATURAMENTO = 583;

	/** identifier field */
	private Integer id;

	/** nullable persistent field */
	@ControleAlteracao(funcionalidade = {ATRIBUTO_ATUALIZAR_COMANDO_ATIVIDADE_DATA_VENCIMENTO_FATURAMENTO, ATRIBUTO_ATUALIZAR_COMANDO_ATIVIDADE_FATURAMENTO, ATRIBUTO_REMOVER_COMANDO_ATIVIDADE_FATURAMENTO, ATRIBUTO_INSERIR_COMANDO_ATIVIDADE_FATURAMENTO, FaturamentoGrupoCronogramaMensal.ATRIBUTOS_INSERIR_CRONOGRAMA_FATURAMENTO, FaturamentoGrupoCronogramaMensal.ATRIBUTOS_ATUALIZAR_CRONOGRAMA_FATURAMENTO, FaturamentoGrupoCronogramaMensal.ATRIBUTOS_REMOVER_CRONOGRAMA_FATURAMENTO})
	...
	/** persistent field */
	@ControleAlteracao(funcionalidade = {ATRIBUTO_ATUALIZAR_COMANDO_ATIVIDADE_FATURAMENTO, ATRIBUTO_REMOVER_COMANDO_ATIVIDADE_FATURAMENTO, ATRIBUTO_INSERIR_COMANDO_ATIVIDADE_FATURAMENTO, FaturamentoGrupoCronogramaMensal.ATRIBUTOS_INSERIR_CRONOGRAMA_FATURAMENTO, FaturamentoGrupoCronogramaMensal.ATRIBUTOS_ATUALIZAR_CRONOGRAMA_FATURAMENTO, FaturamentoGrupoCronogramaMensal.ATRIBUTOS_REMOVER_CRONOGRAMA_FATURAMENTO})
	...
	public Filtro retornaFiltro(){
		...
		filtroFaturamentoAtividadeCronograma
						.adicionarParametro(new ParametroSimples(FiltroFaturamentoAtividadeCronograma.ID, this.getId()));
		return filtroFaturamentoAtividadeCronograma;
	}

	/** full constructor */
	public FaturamentoAtividadeCronograma(Date dataPrevista, Date dataRealizacao, Date comando, Date ultimaAlteracao,
	...
	/** minimal constructor */
	public FaturamentoAtividadeCronograma(gcom.faturamento.FaturamentoAtividade faturamentoAtividade,
											gcom.faturamento.FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal) {
	 ...
	 */
	public FaturamentoAtividadeCronograma(Integer id, Date dataPrevista, Date dataRealizacao, Date comando, Date ultimaAlteracao,
											gcom.faturamento.FaturamentoAtividade faturamentoAtividade,
											gcom.faturamento.FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal) {
	...
	public void setFaturamentoAtividadeCronogramaRotas(Set faturamentoAtividadeCronogramaRotas){

		this.faturamentoAtividadeCronogramaRotas = faturamentoAtividadeCronogramaRotas;
	}

	/**
	 * O Relatorio sempre é gerado pelo fluxo de faturamento Segundo o caso de uso de Aviso de corte
	 * pelo faturamento
	 * 
	 * @return
	 */
