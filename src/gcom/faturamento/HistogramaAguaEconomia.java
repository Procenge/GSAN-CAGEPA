...
public class HistogramaAguaEconomia
	...
	/** full constructor */
	public HistogramaAguaEconomia(Integer id, int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, short indicadorConsumoReal,
									short indicadorHidrometro, short indicadorPoco, short indicadorVolFixadoAgua, int quantidadeConsumo,
									int quantidadeEconomia, BigDecimal valorFaturadoEconomia, int volumeFaturadoEconomia,
									Date ultimaAlteracao, int quantidadeLigacao, GerenciaRegional gerenciaRegional, Localidade localidade,
									...
									int quantidadeEconomiaRefaturamento, BigDecimal valorFaturadoEconomiaRefaturamento,
									int volumeFaturadoEconomiaRefaturamento, int quantidadeLigacaoRefaturamento) {
