...
public class HistogramaEsgotoLigacao
	...
	/** full constructor */
	public HistogramaEsgotoLigacao(Integer id, int referencia, int codigoSetorComercial, int numeroQuadra, short indicadorLigacaoMista,
									short indicadorConsumoReal, short indicadorHidrometro, short indicadorPoco,
									short indicadorVolumeFixadoEsgoto, short percentualEsgoto, int quantidadeConsumo,
									int quantidadeLigacao, int quantidadeEconomiaLigacao, BigDecimal valorFaturadoLigacao,
									int volumeFaturadoLigacao, Date ultimaAlteracao, GerenciaRegional gerenciaRegional,
									Localidade localidadeElo, Localidade localidade, Quadra quadra, ConsumoTarifa consumoTarifa,
									ImovelPerfil imovelPerfil, LigacaoEsgotoSituacao ligacaoEsgotoSituacao, SetorComercial setorComercial,
									UnidadeNegocio unidadeNegocio, EsferaPoder esferaPoder, Categoria categoria,
									CategoriaTipo categoriaTipo, int quantidadeLigacaoRefaturamento,
									int quantidadeEconomiaLigacaoRefaturamento, BigDecimal valorFaturadoLigacaoRefaturamento,
									int volumeFaturadoLigacaoRefaturamento) {
