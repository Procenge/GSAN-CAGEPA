...
public class ResumoFaturamentoSimulacao
	...
	private FaturamentoSimulacaoComando faturamentoSimulacaoComando;

	/** full constructor */
	public ResumoFaturamentoSimulacao(Integer anoMesReferencia, Short indicadorDebitoConta, Integer indicadorSimulacao,
										Short quantidadeEconomia, BigDecimal valorAgua, Integer codigoSetorComercial, Integer consumoAgua,
										Integer numeroQuadra, BigDecimal valorEsgoto, Integer consumoEsgoto, BigDecimal valorDebitos,
										BigDecimal valorCreditos, Date ultimaAlteracao, gcom.faturamento.FaturamentoGrupo faturamentoGrupo,
										LigacaoEsgotoSituacao ligacaoEsgotoSituacao, ImovelPerfil imovelPerfil, Quadra quadra,
										Localidade localidade, LigacaoAguaSituacao ligacaoAguaSituacao, Categoria categoria,
										Integer quantidadeContas, EsferaPoder esferaPoder, GerenciaRegional gerenciaRegional,
										SetorComercial setorComercial, Rota rota, UnidadeNegocio unidadeNegocio) {
	...
	/** minimal constructor */
	public ResumoFaturamentoSimulacao(gcom.faturamento.FaturamentoGrupo faturamentoGrupo, LigacaoEsgotoSituacao ligacaoEsgotoSituacao,
										ImovelPerfil imovelPerfil, Quadra quadra, Localidade localidade,
										LigacaoAguaSituacao ligacaoAguaSituacao, Categoria categoria) {
	 ...
	 *            O quantidadeContas a ser setado.
	 */
	...
	public FaturamentoSimulacaoComando getFaturamentoSimulacaoComando(){

		return faturamentoSimulacaoComando;
	}

	public void setFaturamentoSimulacaoComando(FaturamentoSimulacaoComando faturamentoSimulacaoComando){

		this.faturamentoSimulacaoComando = faturamentoSimulacaoComando;
	}
