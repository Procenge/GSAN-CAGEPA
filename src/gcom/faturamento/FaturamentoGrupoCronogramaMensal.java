...
@ControleAlteracao()
public class FaturamentoGrupoCronogramaMensal
				extends ObjetoTransacao {

	public static final int ATRIBUTOS_INSERIR_CRONOGRAMA_FATURAMENTO = 102;

	public static final int ATRIBUTOS_ATUALIZAR_CRONOGRAMA_FATURAMENTO = 106;

	public static final int ATRIBUTOS_REMOVER_CRONOGRAMA_FATURAMENTO = 426;

	private static final long serialVersionUID = 1L;

	/** identifier field */
	@ControleAlteracao(funcionalidade = {ATRIBUTOS_INSERIR_CRONOGRAMA_FATURAMENTO, ATRIBUTOS_ATUALIZAR_CRONOGRAMA_FATURAMENTO, ATRIBUTOS_REMOVER_CRONOGRAMA_FATURAMENTO})
	private Integer id;
	...
	public Filtro retornaFiltro(){
		...
		filtroFaturamentoGrupoCronogramaMensal.adicionarParametro(new ParametroSimples(FiltroFaturamentoGrupoCronogramaMensal.ID, this
						.getId()));
	...
	/** full constructor */
	public FaturamentoGrupoCronogramaMensal(Integer anoMesReferencia, Date ultimaAlteracao,
											gcom.faturamento.FaturamentoGrupo faturamentoGrupo) {
	 ...
	 *            O faturamentoAtividadeCronogramas a ser setado.
	 */
	public void setFaturamentoAtividadeCronogramas(Set faturamentoAtividadeCronogramas){
		...
		if(faturamentoAtividadeCronogramas != null && !faturamentoAtividadeCronogramas.isEmpty()){
			...
			while(it.hasNext()){
				...
				if(faturamentoAtividadeCronograma.getFaturamentoAtividade() != null) faturamentoAtividadeCronograma
								.getFaturamentoAtividade().getFaturamentoAtividadePrecedente();
			}
		}
