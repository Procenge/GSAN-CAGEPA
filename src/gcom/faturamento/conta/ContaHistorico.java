...
public class ContaHistorico
	...
	/** persistent field */
	private Set<DebitoCobradoHistorico> debitoCobradoHistoricos;
	...
	/** persistent field */
	private Set contaCategoriaHistoricos;

	/** persistent field */
	private Set contaImpostosDeduzidosHistoricos;
	...
	public ContaHistorico(Integer id, int anoMesReferenciaConta, Date contaHistorico, Short lote, Short sublote, Integer setorComercial,
							Integer numeroQuadra, short verificadorConta, short indicadorCobrancaMulta, Short indicadorAlteracaoVencimento,
							Integer consumoAgua, Integer consumoEsgoto, Integer consumoRateioAgua, Integer consumoRateioEsgoto,
							BigDecimal valorAgua, BigDecimal valorEsgoto, BigDecimal valorDebitos, BigDecimal valorCreditos,
							BigDecimal percentualEsgoto, Date dataVencimentoConta, Date dataValidadeConta, Date dataInclusao,
							Date dataRevisao, Date dataRetificacao, Date dataCancelamento, Date dataEmissao,
							Integer anoMesReferenciaContabil, Integer anoMesReferenciaBaixaContabil, Short indicadorDebitoConta,
							Date ultimaAlteracao, FaturamentoTipo faturamentoTipo, ContaMotivoCancelamento contaMotivoCancelamento,
							ContaBancaria contaBancaria, ContaMotivoInclusao contaMotivoInclusao,
							DebitoCreditoSituacao debitoCreditoSituacaoAnterior, DebitoCreditoSituacao debitoCreditoSituacaoAtual,
							ContaMotivoRevisao contaMotivoRevisao, RegistroAtendimento registroAtendimento, Imovel imovel,
							LigacaoEsgotoSituacao ligacaoEsgotoSituacao, DocumentoTipo documentoTipo, ConsumoTarifa consumoTarifa,
	...
	/** minimal constructor */
	public ContaHistorico(Integer id, int anoMesReferenciaConta, Short lote, Short sublote, Integer setorComercial, Integer numeroQuadra,
							short verificadorConta, short indicadorCobrancaMulta, Short indicadorAlteracaoVencimento, Integer consumoAgua,
							Integer consumoEsgoto, BigDecimal valorAgua, BigDecimal valorEsgoto, BigDecimal valorDebitos,
							BigDecimal percentualEsgoto, Date dataVencimentoConta, Date dataInclusao, FaturamentoTipo faturamentoTipo,
							ContaMotivoCancelamento contaMotivoCancelamento, ContaBancaria contaBancaria,
							ContaMotivoInclusao contaMotivoInclusao, DebitoCreditoSituacao debitoCreditoSituacaoAnterior,
							DebitoCreditoSituacao debitoCreditoSituacaoAtual, ContaMotivoRevisao contaMotivoRevisao,
							RegistroAtendimento registroAtendimento, Imovel imovel, LigacaoEsgotoSituacao ligacaoEsgotoSituacao,
							DocumentoTipo documentoTipo, ConsumoTarifa consumoTarifa, ImovelPerfil imovelPerfil, Quadra quadra,
	...
	/**
	 * @param alteracaoVencimento
	 *            The alteracaoVencimento to set.
	 */
	 ...
	 *            The anoMesReferenciaBaixaContabil to set.
	 */
	...
	/**
	 * @param consumoRateioAgua
	 *            The consumoRateioAgua to set.
	 */
	 ...
	 *            The consumoRateioEsgoto to set.
	 */
	 ...
	 *            The contaMotivoCancelamento to set.
	 */
	 ...
	 *            The contaMotivoInclusao to set.
	 */
	 ...
	 *            The contaMotivoRetificacao to set.
	 */
	...
	/**
	 * @param creditoRealizadoHistoricos
	 *            The creditoRealizadoHistoricos to set.
	 */
	 ...
	 */
	public Set<DebitoCobradoHistorico> getDebitoCobradoHistoricos(){

		return debitoCobradoHistoricos;
	}

	/**
	 * @param debitoCobradoHistoricos
	 *            The debitoCobradoHistoricos to set.
	 */
	 ...
	 *            The debitoCreditoSituacaoAnterior to set.
	 */
	 ...
	 *            The funcionarioEntrega to set.
	 */
	public void setFuncionarioEntrega(gcom.cadastro.funcionario.Funcionario funcionarioEntrega){
	...
	/**
	 * @param funcionarioLeitura
	 *            The funcionarioLeitura to set.
	 */
	public void setFuncionarioLeitura(gcom.cadastro.funcionario.Funcionario funcionarioLeitura){
	 ...
	 */
	public void setLigacaoAguaSituacao(gcom.atendimentopublico.ligacaoagua.LigacaoAguaSituacao ligacaoAguaSituacao){
	 ...
	 */
	public void setLigacaoEsgotoSituacao(gcom.atendimentopublico.ligacaoesgoto.LigacaoEsgotoSituacao ligacaoEsgotoSituacao){
	 ...
	 *            The motivoNaoEntregaDocumento to set.
	 */
	...
	/**
	 * @param parcelamentoItems
	 *            The parcelamentoItems to set.
	 */
	 ...
	 *            The registroAtendimento to set.
	 */
	...
	/**
	 * @param verificadorConta
	 *            The verificadorConta to set.
	 */
	 ...
	 * @author Saulo Lima
	 * @date 12/08/2009
	 *       Subtrair o valor dos impostos para obter o valor total da conta no histórico.
	 */
	 ...
	 *            O dataVencimentoOriginal a ser setado.
	 */
	...
	public boolean equals(Object obj){
		...
		final ContaHistorico other = (ContaHistorico) obj;
		if(id == null){
	...
	public void setContaCategoriaHistoricos(Set contaCategoriaHistoricos){

		this.contaCategoriaHistoricos = contaCategoriaHistoricos;
	}

	public Set getContaCategoriaHistoricos(){

		return contaCategoriaHistoricos;
	}

	public void setContaImpostosDeduzidosHistoricos(Set contaImpostosDeduzidosHistoricos){

		this.contaImpostosDeduzidosHistoricos = contaImpostosDeduzidosHistoricos;
	}

	public Set getContaImpostosDeduzidosHistoricos(){

		return contaImpostosDeduzidosHistoricos;
	}
	...
	/**
	 * Este método retorna o valor total da conta no historico sem impostos
