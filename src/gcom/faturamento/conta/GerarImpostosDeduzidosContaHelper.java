...
public class GerarImpostosDeduzidosContaHelper {
	 ...
	 */
	public GerarImpostosDeduzidosContaHelper(BigDecimal valorTotalImposto, Collection<ImpostoDeduzidoHelper> listaImpostosDeduzidos) {
	...
	/**
	 * @param listaImpostosDeduzidos
	 *            O listaImpostosDeduzidos a ser setado.
	 */
	public void setListaImpostosDeduzidos(Collection<ImpostoDeduzidoHelper> listaImpostosDeduzidos){
	...
	/**
	 * @param valorTotalImposto
	 *            O valorTotalImposto a ser setado.
	 */
