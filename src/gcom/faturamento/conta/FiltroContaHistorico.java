 ...
 * @date 29/03/2006
 */
public class FiltroContaHistorico
				extends Filtro {
	...
	public final static String ORIGEM_COBRANCA_DOCUMENTO_ITEM = "origem.cobrancaDocumentoItem";

	public final static String PARCELAMENTO_COBRANCA_DOCUMENTO = "parcelamento.cobrancaDocumento";

	public final static String PARCELAMENTO_ID = "parcelamento.id";

	public final static String DEBITO_COBRADO_HISTORICOS = "debitoCobradoHistoricos";

	public final static String IMOVEL_LIGACAO_AGUA = "imovel.ligacaoAgua";

	public final static String CONTA_CATEGORIA_HISTORICOS = "contaCategoriaHistoricos";

	public final static String CONTA_MOTIVO_REVISAO = "contaMotivoRevisao";

	public final static String ID_ATUAL = "debitoCreditoSituacaoAtual";
	...
	public final static String CONTA_HISTORICO = "contaHistorico";
