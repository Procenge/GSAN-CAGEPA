...
public class ContaCategoriaHistoricoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("contaHistorico", getContaHistorico()).append("categoria", getCategoria()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getContaHistorico(), castOther.getContaHistorico()).append(this.getCategoria(),
						castOther.getCategoria()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getContaHistorico()).append(getCategoria()).toHashCode();
	}
