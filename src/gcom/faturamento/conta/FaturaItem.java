...
public class FaturaItem
	...
	/** full constructor */
	public FaturaItem(short itemSequencia, BigDecimal valorConta, Date ultimaAlteracao, Integer numeroConsumo,
						gcom.faturamento.conta.Fatura fatura, gcom.faturamento.conta.ContaGeral contaGeral, Imovel imovel) {
	...
	/** minimal constructor */
	public FaturaItem(short itemSequencia, gcom.faturamento.conta.Fatura fatura, gcom.faturamento.conta.ContaGeral contaGeral) {
	...
	public short getItemSequencia(){

		return this.itemSequencia;
	}

	public void setItemSequencia(short itemSequencia){
