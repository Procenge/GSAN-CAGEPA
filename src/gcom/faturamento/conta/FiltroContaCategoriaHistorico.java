 ...
 * @created 31/10/2012
 */
public class FiltroContaCategoriaHistorico
				extends Filtro {
	...
	public final static String CATEGORIA_TIPO = "comp_id.categoria.categoriaTipo";

	public final static String CATEGORIA_TIPO_ID = "comp_id.categoria.categoriaTipo.id";
	 ...
	 * Description of the Field
	 */
	public final static String CONTA_HISTORICO = "comp_id.contaHistorico";

	public final static String CONTA_HISTORICO_ID = "comp_id.contaHistorico.id";
