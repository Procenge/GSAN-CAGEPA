...
public class ContaCategoriaPK
	...
	public ContaCategoriaPK(gcom.faturamento.conta.Conta conta, Categoria categoria, Subcategoria subcategoria) {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("conta", getConta()).append("categoria", getCategoria()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder()
						...
						.append(this.getCategoria(), castOther.getCategoria()).append(this.getSubcategoria(), castOther.getSubcategoria())
						.isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getConta()).append(getCategoria()).toHashCode();
	}
