 ...
 * @created 13/06/2007
 */
public class FiltroContaCategoriaConsumoFaixa
				extends Filtro {
	...
	public final static String CONSUMO_FAIXA_INICIO = "consumoFaixaInicio";

	public final static String CONTA_CATEGORIA = "contaCategoria";
