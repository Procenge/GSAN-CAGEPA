 ...
 */
public interface ControladorFaturamentoRemote
	...
	public void inserirFaturamentoCronograma(Collection faturamentoAtividadeCronogramas,
					FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal) throws RemoteException;
	...
	public void inserirComandoAtividadeFaturamento(FaturamentoGrupo faturamentoGrupo, FaturamentoAtividade faturamentoAtividade,
					Collection colecaoRotas, Date dataVencimentoGrupo) throws RemoteException;
	 ...
	 * realizadas
	 */
	public Collection buscarAtividadeComandadaNaoRealizada(FiltroFaturamentoAtividadeCronograma filtroFaturamentoAtividadeCronograma)
					throws RemoteException;
	...
	public Collection<CalcularValoresAguaEsgotoHelper> calcularValoresAguaEsgoto(Integer anoMesReferencia, Integer ligacaoSituacaoAguaId,
					...
					Integer tarifaImovel) throws RemoteException;
	...
	public Collection<CalcularValoresAguaEsgotoHelper> calcularValoresConta(String mesAnoConta, String imovelID, Integer situacaoAguaConta,
					...
					String percentualEsgoto, Date dataLeituraAnteriorFaturada, Date dataLeituraAtualFaturada) throws RemoteException;
	 ...
	 *            - coleção com todas as contas do imóvel
	 * @param identificadores
	 *            - identifica através do ID, quais as contas que serão colocadas em revisão
	 ...
	 *            - coleção com todas as contas do imóvel
	 * @param identificadores
	 *            - identifica através do ID, quais as contas que serão retiradas de revisão
	 */
	 ...
	 *            - coleção com todas as contas do imóvel
	 * @param identificadores
	 *            - identifica através do ID, quais as contas que sofrerão alteração na sua data de
	 *            vencimento
	 ...
	 * @throws ControladorException
	 */
	public void retificarConta(Integer mesAnoConta, Conta contaAtual, Imovel imovel, Collection colecaoDebitoCobrado,
	...
	public void inserirConsumoTarifa(ConsumoTarifa consumoTarifa, ConsumoTarifaVigencia consumoTarifaVigencia,
					...
					Collection<ConsumoTarifaFaixa> colecaoConsumoTarifaFaixa) throws RemoteException;
	...
	public BigDecimal calcularValorTotalAguaOuEsgotoPorCategoria(
					Collection<CalcularValoresAguaEsgotoHelper> calcularValoresAguaEsgotoHelper, String tipoRetorno) throws RemoteException;
	 ...
	 * @date 05/08/2006
	 * @param Collection
	 *            <ImovelCobrarDoacaoHelper> imovelCobrarDoacaoHelpers - Coleção de
	 *            imovelCobrarDoacaoHelpers
	 ...
	 **/
	public void gerarDebitoACobrarDoacao(Collection<Rota> rotas) throws RemoteException;
