...
public class FaturamentoAtivCronRotaPK
				extends ObjetoGcom {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("faturamentoAtividadeCronogramaId", getFaturamentoAtividadeCronogramaId()).append("rotaId",
						getRotaId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getFaturamentoAtividadeCronogramaId(), castOther.getFaturamentoAtividadeCronogramaId())
						.append(this.getRotaId(), castOther.getRotaId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getFaturamentoAtividadeCronogramaId()).append(getRotaId()).toHashCode();
	}
