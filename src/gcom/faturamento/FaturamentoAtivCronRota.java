...
@ControleAlteracao()
public class FaturamentoAtivCronRota
	...
	public Filtro retornaFiltro(){
		...
		faturamentoAtivCronRota.adicionarParametro(new ParametroSimples(
						FiltroFaturamentoAtivCronRota.COMP_ID_FATURAMENTO_ATIVIDADE_CRONOGRAMA_ID, this.getFaturamentoAtividadeCronograma()
										.getId()));
		faturamentoAtivCronRota.adicionarParametro(new ParametroSimples(FiltroFaturamentoAtivCronRota.COMP_ID_ROTA_ID, this.getRota()
						.getId()));
	...
	/** full constructor */
	public FaturamentoAtivCronRota(gcom.faturamento.FaturamentoAtivCronRotaPK comp_id, Date dataContaVencimento, Date ultimaAlteracao,
									Rota rota, gcom.faturamento.FaturamentoAtividadeCronograma faturamentoAtividadeCronograma) {
