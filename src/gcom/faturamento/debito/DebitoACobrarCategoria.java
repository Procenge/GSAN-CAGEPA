...
public class DebitoACobrarCategoria
	...
	public Filtro retornaFiltro(){
		...
		filtroDebitoACobrarCategoria.adicionarParametro(new ParametroSimples(FiltroDebitoACobrarCategoria.ID_DEBITO_A_COBRAR, debitoACobrar
						.getId()));
		filtroDebitoACobrarCategoria.adicionarParametro(new ParametroSimples(FiltroDebitoACobrarCategoria.ID_CATEGORIA, categoria.getId()));
		return filtroDebitoACobrarCategoria;
	}

	/** full constructor */
	public DebitoACobrarCategoria(gcom.faturamento.debito.DebitoACobrarCategoriaPK comp_id, Integer quantidadeEconomia,
									Date ultimaAlteracao, BigDecimal valorCategoria, gcom.faturamento.debito.DebitoACobrar debitoACobrar,
									Categoria categoria) {
