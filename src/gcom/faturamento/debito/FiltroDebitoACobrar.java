 ...
 * @since 30/12/2005
 */
public class FiltroDebitoACobrar
				extends Filtro
	...
	public final static String REFERENCIA_COBRANCA_DEBITO = "anoMesCobrancaDebito";

	public final static String REFERENCIA_CONTABIL_DEBITO = "anoMesReferenciaContabil";
	...
	public final static String COLECAO_DEBITOS_A_COBRAR_CATEGORIA = "debitoACobrarCategorias";

	public final static String LOCALIDADE = "localidade";

	public final static String IMOVEL = "imovel";

	public final static String INDICADOR_REMUNERACAO_COBRANCA_ADMINISTRATIVA = "indicadorRemuneraCobrancaAdministrativa";
}
