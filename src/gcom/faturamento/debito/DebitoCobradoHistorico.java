...
public class DebitoCobradoHistorico
	...
	/** persistent field */
	private Set debitoCobradoCategoriasHistorico;
	...
	/** full constructor */
	public DebitoCobradoHistorico(Date debitoCobrado, Integer codigoSetorComercial, Integer numeroQuadra, Short numeroLote,
									Short numeroSubLote, Integer anoMesReferenciaDebito, Integer anoMesCobrancaDebito,
									BigDecimal valorPrestacao, Short numeroPrestacao, Short numeroPrestacaoDebito, Date ultimaAlteracao,
									FinanciamentoTipo financiamentoTipo, Quadra quadra, Localidade localidade,
									ContaHistorico contaHistorico, gcom.faturamento.debito.DebitoTipo debitoTipo,
									LancamentoItemContabil lancamentoItemContabil, ParcelamentoGrupo parcelamentoGrupo) {
	...
	/** minimal constructor */
	public DebitoCobradoHistorico(Date debitoCobrado, FinanciamentoTipo financiamentoTipo, Quadra quadra, Localidade localidade,
									ContaHistorico contaHistorico, gcom.faturamento.debito.DebitoTipo debitoTipo,
									LancamentoItemContabil lancamentoItemContabil, ParcelamentoGrupo parcelamentoGrupo) {
	...
	public boolean equals(Object other){
		...
		if(!(other instanceof DebitoCobradoHistorico)){
			return false;
		}
		DebitoCobradoHistorico castOther = (DebitoCobradoHistorico) other;

		return new EqualsBuilder().append(this.getId(), castOther.getId()).isEquals();
	}

	public void setDebitoCobradoCategoriasHistorico(Set debitoCobradoCategoriasHistorico){

		this.debitoCobradoCategoriasHistorico = debitoCobradoCategoriasHistorico;
	}

	public Set getDebitoCobradoCategoriasHistorico(){

		return debitoCobradoCategoriasHistorico;
	}
