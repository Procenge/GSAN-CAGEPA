 ...
 */
public class FiltroDebitoCobrado
				extends Filtro {
	...
	public final static String PARCELAMENTO_RESOLUCAO_DIRETORIA = "parcelamento.resolucaoDiretoria";
	...
	public final static String CONTA_IMOVEL_ID = "conta.imovel.id";

	public final static String DEBITO_COBRADO = "debitoCobrado";

	public final static String ANO_MES_COBRANCA_DEBITO = "anoMesCobrancaDebito";
