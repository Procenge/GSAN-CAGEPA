...
public class DebitoCobrado
	...
	private Collection<Integer> idsDebitosCobradosAgrupados;
	...
	public DebitoCobrado(Date debitoCobrado, Integer codigoSetorComercial, Integer numeroQuadra, Short numeroLote, Short numeroSubLote,
							...
							short numeroPrestacaoDebito, Date ultimaAlteracao, int lictId, LancamentoItemContabil lancamentoItemContabil,
							Conta conta, FinanciamentoTipo financiamentoTipo, Quadra quadra, Localidade localidade,
							gcom.faturamento.debito.DebitoTipo debitoTipo, ParcelamentoGrupo parcelamentoGrupo, Set debitoCobradoCategorias) {
	...
	/** minimal constructor */
	public DebitoCobrado(Date debitoCobrado, BigDecimal valorPrestacao, short numeroPrestacao, short numeroPrestacaoDebito,
							LancamentoItemContabil lancamentoItemContabil, Conta conta, FinanciamentoTipo financiamentoTipo, Quadra quadra,
							Localidade localidade, gcom.faturamento.debito.DebitoTipo debitoTipo, ParcelamentoGrupo parcelamentoGrupo,
							Set debitoCobradoCategorias) {
	...
	public DebitoCobrado(short numeroPrestacaoDebito, Integer anoMesReferenciaConta) {

		this.numeroPrestacaoDebito = numeroPrestacaoDebito;
		this.conta = new Conta();
		this.conta.setReferencia(anoMesReferenciaConta);
	}
	...
	public Collection<Integer> getIdsDebitosCobradosAgrupados(){

		return idsDebitosCobradosAgrupados;
	}

	public void setIdsDebitosCobradosAgrupados(Collection<Integer> idsDebitosCobradosAgrupados){

		this.idsDebitosCobradosAgrupados = idsDebitosCobradosAgrupados;
	}

	public void addIdDebitoCobradosAgrupado(Integer idDebitoCobrados){

		if(id != null && !id.equals(idDebitoCobrados)){

			if(idsDebitosCobradosAgrupados != null){

				idsDebitosCobradosAgrupados.add(idDebitoCobrados);

			}else{

				idsDebitosCobradosAgrupados = new ArrayList<Integer>();
				idsDebitosCobradosAgrupados.add(idDebitoCobrados);
	...
	public Short getNumeroPrestacaoTemp(){

		return numeroPrestacaoTemp;
	}
