...
public class DebitoACobrarCategoriaPK
				extends ObjetoGcom {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("debitoACobrar", getDebitoACobrar()).append("categoria", getCategoria()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getDebitoACobrar(), castOther.getDebitoACobrar()).append(this.getCategoria(),
						castOther.getCategoria()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getDebitoACobrar()).append(getCategoria()).toHashCode();
	}
