...
public class DebitoCobradoCategoria
	...
	/** full constructor */
	public DebitoCobradoCategoria(gcom.faturamento.debito.DebitoCobradoCategoriaPK comp_id, Integer quantidadeEconomia,
									Date ultimaAlteracao, BigDecimal valorCategoria, gcom.faturamento.debito.DebitoCobrado debitoCobrado,
									Categoria categoria) {
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroDebitoCobradoCategoria.DEBITO_COBRADO_ID, this.getComp_id()));
		return filtro;
	}
