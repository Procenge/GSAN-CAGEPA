...
public class DebitoCreditoSituacao
	...
	public final static Integer INCLUIDA = Integer.valueOf(2);

	public final static Integer CANCELADA = Integer.valueOf(3);

	public final static Integer ENTRADA_DE_PARCELAMENTO = Integer.valueOf(4);

	public final static Integer PARCELADA = Integer.valueOf(5);

	public final static Integer ARRASTADA = Integer.valueOf(6);

	public final static Integer CANCELADA_POR_RETIFICACAO = Integer.valueOf(7);

	public final static Integer PAGA = Integer.valueOf(8);

	public final static Integer PRE_FATURADA = Integer.valueOf(9);

	public final static Integer PRESCRITA = Integer.valueOf(10);
