...
public class FaturamentoAtividade
				extends ObjetoGcom {
	...
	public final static String GERAR_ARQUIVO_LEITURA_DESCRICAO = "GERAR E ENVIAR ARQ. LEITURA";
	...
	public final static String FATURAR_GRUPO_DESCRICAO = "FATURAR GRUPO";
	...
	public final static Integer GERAR_FATURAMENTO_IMEDIATO = new Integer("10");

	public final static Integer REGISTRAR_FATURAMENTO_IMEDIATO = new Integer("11");

	public final static String REGISTRAR_FATURAMENTO_IMEDIATO_DESCRICAO = "ATUALIZAR FATURAMENTO IMEDIATO";
	...
	/** full constructor */
	public FaturamentoAtividade(String descricao, Short indicadorUso, Short indicadorObrigatoriedadeAtividade,
								Short indicadorPossibilidadeRepeticaoAtividade, Short indicadorPossibilidadeComandoAtividade,
								Date ultimaAlteracao, gcom.faturamento.FaturamentoAtividade faturamentoAtividadePrecedente,
	...
	/** minimal constructor */
	public FaturamentoAtividade(gcom.faturamento.FaturamentoAtividade faturamentoAtividadePrecedente) {
	...
	public void setIndicadorObrigatoriedadeAtividade(Short indicadorObrigatoriedadeAtividade){
	...
	public void setIndicadorPossibilidadeRepeticaoAtividade(Short indicadorPossibilidadeRepeticaoAtividade){
	...
	public void setIndicadorPossibilidadeComandoAtividade(Short indicadorPossibilidadeComandoAtividade){
	...
	public void setFaturamentoAtividadePrecedente(gcom.faturamento.FaturamentoAtividade faturamentoAtividadePrecedente){
