 ...
 */
public class FiltroFaturamentoAtivCronRota
				extends Filtro {
	 ...
	 * Description of the Field
	 */
	public final static String COMP_ID_ROTA = "rota";

	/**
	 * Description of the Field
	 */
	public final static String COMP_ID_ROTA_GRUPO_FATURAMENTO = "rota.faturamentoGrupo";
	 ...
	 * Description of the Field
	 */
	public final static String FATURAMENTO_ATIVIDADE_CRONOGRAMA = "faturamentoAtividadeCronograma";
