...
public class AbastecimentoProgramacao
	...
	/** full constructor */
	public AbastecimentoProgramacao(int anoMesReferencia, Date dataInicio, Date dataFim, Date horaInicio, Date horaFim,
									Date ultimaAlteracao, gcom.operacional.SistemaAbastecimento sistemaAbastecimento, Municipio municipio,
	...
	/** minimal constructor */
	public AbastecimentoProgramacao(int anoMesReferencia, Date dataInicio, Date dataFim, Date horaInicio, Date horaFim,
									Date ultimaAlteracao, Municipio municipio, Bairro bairro,
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroAbastecimentoProgramacao.ID, this.getId()));
