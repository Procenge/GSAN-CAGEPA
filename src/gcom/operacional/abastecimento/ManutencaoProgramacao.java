...
public class ManutencaoProgramacao
	...
	/** full constructor */
	public ManutencaoProgramacao(Date dataInicio, Date dataFim, Date horaInicio, String descricao, short situacao, Date horaFim,
									int anoMesReferencia, gcom.operacional.SistemaAbastecimento sistemaAbastecimento, Municipio municipio,
									Bairro bairro, gcom.operacional.SetorAbastecimento setorAbastecimento,
									gcom.operacional.DistritoOperacional distritoOperacional,
									gcom.operacional.ZonaAbastecimento zonaAbastecimento, BairroArea bairroArea) {
	...
	/** minimal constructor */
	public ManutencaoProgramacao(Date dataInicio, Date dataFim, Date horaInicio, String descricao, short situacao, Date horaFim,
									int anoMesReferencia, Municipio municipio, Bairro bairro,
									gcom.operacional.SetorAbastecimento setorAbastecimento,
									gcom.operacional.DistritoOperacional distritoOperacional,
									gcom.operacional.ZonaAbastecimento zonaAbastecimento, BairroArea bairroArea) {
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroManutencaoProgramacao.ID, this.getId()));
