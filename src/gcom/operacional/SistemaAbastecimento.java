...
public class SistemaAbastecimento
	...
	public static final int ATRIBUTOS_SISTEMA_ABASTECIMENTO_INSERIR = 976;

	public static final int ATRIBUTOS_SISTEMA_ABASTECIMENTO_ATUALIZAR = 978;

	public static final int ATRIBUTOS_SISTEMA_ABASTECIMENTO_REMOVER = 979;

	/** identifier field */
	private Integer id;

	/** persistent field */
	@ControleAlteracao(funcionalidade = {ATRIBUTOS_SISTEMA_ABASTECIMENTO_INSERIR, ATRIBUTOS_SISTEMA_ABASTECIMENTO_ATUALIZAR, ATRIBUTOS_SISTEMA_ABASTECIMENTO_REMOVER})
	...
	public SistemaAbastecimento(Integer id, Integer codigo, String descricao, String descricaoAbreviada, Date ultimaAlteracao,
								short indicadorUso) {
	...
	public Filtro retornaFiltro(){
		...
		filtroSistemaAbastecimento.adicionarParametro(new ParametroSimples(FiltroSistemaAbastecimento.ID, this.getId()));

		return filtroSistemaAbastecimento;
	}
