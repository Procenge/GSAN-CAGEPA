 ...
 * @date 31/08/2006
 */
public class FiltroZonaAbastecimento
				extends Filtro {
	...
	public static final String FAIXA_PRESSAO_INFERIOR = "faixaPressaoInferior";

	public static final String FAIXA_PRESSAO_SUPERIOR = "faixaPressaoSuperior";
