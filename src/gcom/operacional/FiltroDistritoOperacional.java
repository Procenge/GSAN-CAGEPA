 ...
 */
public class FiltroDistritoOperacional
				extends Filtro {
	...
	public static final String BAIRRO_ID = "bairro.id";

	public static final String SISTEMA_ABASTECIMENTO_ID = "sistemaAbastecimento.id";
