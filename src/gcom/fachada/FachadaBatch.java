...
public class FachadaBatch {
	 ...
	 *             
	 *             this.getControladorArrecadacao().pesquisaDebitoAutomaticoMovimento(idFaturamentoGrupo
	...
	public void gerarResumoSituacaoEspecialCobranca() throws ErroEmailException{
		...
		try{
			EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.GERAR_RESUMO_SITUACAO_ESPECIAL_COBRANCA);
			 ...
			 */ServicosEmail.enviarMensagem(remetente, receptor, titulo, corpoMensagem);
	...
	public Categoria obterPrincipalCategoriaImovel(Integer idImovel){
		...
		try{
			return this.getControladorImovel().obterPrincipalCategoriaImovel(idImovel);
	...
	//
	// try{
	// this.getControladorGerencialMicromedicao().gerarResumoAnormalidadeConsumo();
	// EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.GERAR_RESUMO_ANORMALIDADE_CONSUMO);
	// String remetente = envioEmail.getEmailRemetente();
	// String receptor = envioEmail.getEmailReceptor();
	// String titulo = envioEmail.getTituloMensagem();
	// String corpoMensagem = envioEmail.getCorpoMensagem();
	...
	// ex.printStackTrace();
	// try{
	// EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.GERAR_RESUMO_ANORMALIDADE_CONSUMO_FALHA);
	// String remetente = envioEmail.getEmailRemetente();
	// String receptor = envioEmail.getEmailReceptor();
	// String titulo = envioEmail.getTituloMensagem();
	// String corpoMensagem = envioEmail.getCorpoMensagem();
	...
	public void gerarResumoAnormalidadeLeitura() throws ErroEmailException{
		...
		try{
			 ...
			 */EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.GERAR_RESUMO_ANORMALIDADE_LEITURA);
			String remetente = envioEmail.getEmailRemetente();
			String receptor = envioEmail.getEmailReceptor();
			String titulo = envioEmail.getTituloMensagem();
			String corpoMensagem = envioEmail.getCorpoMensagem();
			...
			ex.printStackTrace();
			try{
				EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.GERAR_RESUMO_ANORMALIDADE_LEITURA_FALHA);
				String remetente = envioEmail.getEmailRemetente();
				String receptor = envioEmail.getEmailReceptor();
				String titulo = envioEmail.getTituloMensagem();
				String corpoMensagem = envioEmail.getCorpoMensagem();
	...
	public Collection pesquisarIdsTodasConta() throws ErroEmailException{
		...
		try{
			...
			EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.PESQUISAR_IDS_TODAS_CONTAS);
			String remetente = envioEmail.getEmailRemetente();
			String receptor = envioEmail.getEmailReceptor();
			String titulo = envioEmail.getTituloMensagem();
			String corpoMensagem = envioEmail.getCorpoMensagem();
			...
			ex.printStackTrace();
			try{
				EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.PESQUISAR_IDS_TODAS_CONTAS_FALHA);
				String remetente = envioEmail.getEmailRemetente();
				String receptor = envioEmail.getEmailReceptor();
				String titulo = envioEmail.getTituloMensagem();
				String corpoMensagem = envioEmail.getCorpoMensagem();
	...
	// *
	// */
	// public void gerarFaturaClienteResponsavel(Integer idFuncionalidadeIniciada) throws
	// ErroEmailException {
	// try {
	 ...
	 * @throws ControladorException
	 */
	public void encerrarArrecadacaoMes(Collection<Integer> colecaoIdsLocalidades, int idFuncionalidadeIniciada) throws ErroEmailException{

		try{
			this.getControladorArrecadacao().encerrarArrecadacaoMes(colecaoIdsLocalidades, idFuncionalidadeIniciada);
			EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.ENCERRAR_ARRECADACAO_MES);
			String remetente = envioEmail.getEmailRemetente();
			String receptor = envioEmail.getEmailReceptor();
			String titulo = envioEmail.getTituloMensagem();
			String corpoMensagem = envioEmail.getCorpoMensagem();
			...
			ex.printStackTrace();
			try{
				EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.ENCERRAR_ARRECADACAO_MES_FALHA);
				String remetente = envioEmail.getEmailRemetente();
				String receptor = envioEmail.getEmailReceptor();
				String titulo = envioEmail.getTituloMensagem();
				String corpoMensagem = envioEmail.getCorpoMensagem();
	 ...
	 * @date 02/06/2006
	 */
	public void gerarLancamentoContabeisArrecadacao(Integer anoMes) throws ErroEmailException{

		try{
			this.getControladorFinanceiro().gerarLancamentoContabeisArrecadacao(anoMes, 1, 1);
			EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.GERAR_MOVIMENTO_CONTABEIS_ARRECADACAO);
			String remetente = envioEmail.getEmailRemetente();
			String receptor = envioEmail.getEmailReceptor();
			String titulo = envioEmail.getTituloMensagem();
			String corpoMensagem = envioEmail.getCorpoMensagem();
			...
			try{
				EnvioEmail envioEmail = getControladorCadastro()
								.pesquisarEnvioEmail(EnvioEmail.GERAR_MOVIMENTO_CONTABEIS_ARRECADACAO_FALHA);
				String remetente = envioEmail.getEmailRemetente();
				String receptor = envioEmail.getEmailReceptor();
				String titulo = envioEmail.getTituloMensagem();
				String corpoMensagem = envioEmail.getCorpoMensagem();
	 ...
	 * @date 02/06/2006
	 */
	public void desfazerParcelamentosPorEntradaNaoPaga() throws ErroEmailException{
		...
		try{
			 ...
			 */
			EnvioEmail envioEmail = getControladorCadastro().pesquisarEnvioEmail(EnvioEmail.DESFAZER_PARCELAMENTO_POR_ENTRADA_NAO_PAGA);
			String remetente = envioEmail.getEmailRemetente();
			String receptor = envioEmail.getEmailReceptor();
			String titulo = envioEmail.getTituloMensagem();
			String corpoMensagem = envioEmail.getCorpoMensagem();
	 ...
	 * @throws ControladorException
	 */
	public void encerrarOSDoServicoTipoSemRA(Usuario usuarioLogado, Integer idServicoTipo){

		try{
			this.getControladorOrdemServico().encerrarOSDoServicoTipoSemRA(usuarioLogado, idServicoTipo);
		}catch(Exception ex){
			ex.printStackTrace();
			/*
			 * ServicosEmail.enviarMensagem("gcom@compesa.com.br",
	...
	public void gerarDebitoACobrarteste(){
		...
		try{
			this.getControladorFaturamento().gerarDebitosACobrarDeAcrescimosPorImpontualidade(rotas, 0, true);
	...
	public void gerarLancamentosContabeisFaturamento(){
		...
		try{
			...
			Collection<Integer> idsLocalidade = this.getControladorFinanceiro()
							.pesquisarIdsLocalidadesParaGerarLancamentosContabeisFaturamento(200703);
	...
	public void gerarLancamentosContabeisArrecadacao(){
		...
		try{
			System.out.println("Inicio " + new Date());
			Collection<Integer> idsLocalidade = this.getControladorFinanceiro()
							.pesquisarIdsLocalidadesParaGerarLancamentosContabeisArrecadacao(200702);
	...
	public void verificarAnormalidadesConsumo(){

		try{
			Collection rotas = new ArrayList();
			rotas.add(1150);

			this.getControladorMicromedicao().verificarAnormalidadesConsumo(rotas, 200705, new FaturamentoGrupo(), 0);
