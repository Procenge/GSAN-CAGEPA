...
public class FiscalizacaoSituacaoServicoACobrarPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("fzstId", getIdFiscalizacaoSituacao()).append("dbtpId", getIdDebitoTipo()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdFiscalizacaoSituacao(), castOther.getIdFiscalizacaoSituacao()).append(
						this.getIdDebitoTipo(), castOther.getIdDebitoTipo()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdFiscalizacaoSituacao()).append(getIdDebitoTipo()).toHashCode();
	}
