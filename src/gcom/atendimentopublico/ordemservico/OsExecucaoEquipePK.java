...
public class OsExecucaoEquipePK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("idOsAtividadePeriodoExecucao", getIdOsAtividadePeriodoExecucao()).append("idEquipe",
						getIdEquipe()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdOsAtividadePeriodoExecucao(), castOther.getIdOsAtividadePeriodoExecucao()).append(
						this.getIdEquipe(), castOther.getIdEquipe()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdOsAtividadePeriodoExecucao()).append(getIdEquipe()).toHashCode();
	}
