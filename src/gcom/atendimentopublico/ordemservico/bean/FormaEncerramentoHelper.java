 ...
 * @date 26/05/2009
 */
public class FormaEncerramentoHelper {
	...
	public FormaEncerramentoHelper(int idFormaGeracao) {

		if(idFormaGeracao == FormaEncerramento.FormaEncerramentoServico.AUTOMATICA.valorId()){
			this.automatica = true;
		}else if(idFormaGeracao == FormaEncerramento.FormaEncerramentoServico.SOLICITA_AUTORIZACAO.valorId()){
			this.solicitaAutorizacao = true;
		}else if(idFormaGeracao == FormaEncerramento.FormaEncerramentoServico.POSTERIOR.valorId()){
			this.posterior = true;
		}
	}
