...
public class ObterCargaTrabalhoEquipeHelper {
	...
	private Integer cargaTrabalhoPrevistaHoras;
	...
	public void setPercentualCargaTrabalhoPrevista(BigDecimal percentualCargaTrabalhoPrevista){

		this.percentualCargaTrabalhoPrevista = percentualCargaTrabalhoPrevista;
	}

	public Integer getCargaTrabalhoPrevistaHoras(){

		return cargaTrabalhoPrevistaHoras;
	}

	public void setCargaTrabalhoPrevistaHoras(Integer cargaTrabalhoPrevistaHoras){

		this.cargaTrabalhoPrevistaHoras = cargaTrabalhoPrevistaHoras;
	}
