 ...
 * @date 26/05/2009
 */
public class FormaSelecaoEquipeHelper {
	...
	public FormaSelecaoEquipeHelper(int idFormaGeracao) {

		if(idFormaGeracao == FormaSelecaoEquipe.FormaSelecaoEquipeServico.ATUAL.valorId()){
			this.atual = true;
		}else if(idFormaGeracao == FormaSelecaoEquipe.FormaSelecaoEquipeServico.SOLICITA_AUTORIZACAO.valorId()){
			this.solicitaAutorizacao = true;
		}else if(idFormaGeracao == FormaSelecaoEquipe.FormaSelecaoEquipeServico.POSTERIOR.valorId()){
			this.posterior = true;
		}
	}
