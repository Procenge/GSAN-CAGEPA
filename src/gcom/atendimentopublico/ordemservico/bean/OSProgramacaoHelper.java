...
public class OSProgramacaoHelper {
	...
	private String situacaoDescricaoAbreviada;
	...
	/**
	 * @return the situacaoDescricaoAbreviada
	 */
	public String getSituacaoDescricaoAbreviada(){

		return situacaoDescricaoAbreviada;
	}

	/**
	 * @param situacaoDescricaoAbreviada
	 *            the situacaoDescricaoAbreviada to set
	 */
	public void setSituacaoDescricaoAbreviada(String situacaoDescricaoAbreviada){

		this.situacaoDescricaoAbreviada = situacaoDescricaoAbreviada;
	}
	...
	public void setAlertaEquipeDeServicoPerfilTipo(String alertaEquipeDeServicoPerfilTipo){
	...
	public void setColecaoAlertaEquipeDeLogradouro(Collection colecaoAlertaEquipeDeLogradouro){
	...
	public String getDescricaoEnvioAcquaGIS(){

		String str = "";

		if(this.ordemServicoProgramacao != null && this.ordemServicoProgramacao.getIndicadorEnvioAcquaGis() == 1){
			str = "Ordem de serviço já enviada para o AcquaGIS";
		}
		return str;
	}
}
