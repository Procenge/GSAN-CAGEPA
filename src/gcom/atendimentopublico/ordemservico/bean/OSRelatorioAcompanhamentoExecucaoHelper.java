 ...
 * @date 18/08/2006
 */
public class OSRelatorioAcompanhamentoExecucaoHelper
	 ...
	 *            O idRegistroAtendimento a ser setado.
	 */
	...
	/**
	 * @param nomeUnidadeAtendimento
	 *            O nomeUnidadeAtendimento a ser setado.
	 */
	...
	/**
	 * @param nomeUnidadeAtual
	 *            O nomeUnidadeAtual a ser setado.
	 */
	...
	/**
	 * @param dataEncerramentoRA
	 *            O dataEncerramentoRA a ser setado.
	 */
	...
	public boolean equals(Object arg0){
		...
		if(arg0 instanceof OSRelatorioAcompanhamentoExecucaoHelper){
			OSRelatorioAcompanhamentoExecucaoHelper help = (OSRelatorioAcompanhamentoExecucaoHelper) arg0;
			if(this.getIdOrdemServico() != null && null != help.getIdOrdemServico()){
				retorno = this.getIdOrdemServico().equals(help.getIdOrdemServico());
			}else if(this.getIdOrdemServico() == null && null == help.getIdOrdemServico()){
				retorno = true;
			}else{
				retorno = false;
			}
			...
			if(retorno){
				if(this.getIdRegistroAtendimento() != null && null != help.getIdRegistroAtendimento()){
					retorno = this.getIdRegistroAtendimento().equals(help.getIdRegistroAtendimento());
				}else if(this.getIdRegistroAtendimento() == null && null == help.getIdRegistroAtendimento()){
					retorno = true;
				}else{
					retorno = false;
				}
