...
public class PesquisarOrdemServicoHelper {
	...
	private Integer equipe = null;

	private Integer diasAtraso = null;

	private Short programado = null;
	...
	private Date dataExecucaoInicial = null;

	private Date dataExecucaoFinal = null;
	...
	/**
	 * @param programado
	 *            the programado to set
	 */
	public void setProgramado(Short programado){
	 ...
	 */
	public Short getProgramado(){

		return programado;
	}

	public Date getDataExecucaoInicial(){

		return dataExecucaoInicial;
	}

	public void setDataExecucaoInicial(Date dataExecucaoInicial){

		this.dataExecucaoInicial = dataExecucaoInicial;
	}

	public Date getDataExecucaoFinal(){

		return dataExecucaoFinal;
	}

	public void setDataExecucaoFinal(Date dataExecucaoFinal){
