 ...
 * @date 26/05/2009
 */
public class FormaTramiteHelper {
	...
	public FormaTramiteHelper(int idFormaGeracao) {

		if(idFormaGeracao == FormaTramite.FormaTramiteServico.AUTOMATICA.valorId()){
			this.automatica = true;
		}else if(idFormaGeracao == FormaTramite.FormaTramiteServico.SOLICITA_AUTORIZACAO.valorId()){
			this.solicitaAutorizacao = true;
		}else if(idFormaGeracao == FormaTramite.FormaTramiteServico.POSTERIOR.valorId()){
			this.posterior = true;
		}
	}
