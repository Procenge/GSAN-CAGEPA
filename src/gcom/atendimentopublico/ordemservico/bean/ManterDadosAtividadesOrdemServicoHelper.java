...
public class ManterDadosAtividadesOrdemServicoHelper {
	...
	private Collection<OrdemServicoInterrupcaoExecucao> colecaoInterrupcao;
	...
	public void setColecaoOsAtividadeMaterialExecucao(Collection<OsAtividadeMaterialExecucao> colecaoOsAtividadeMaterialExecucao){
	...
	public Collection<OrdemServicoInterrupcaoExecucao> getColecaoInterrupcao(){

		return colecaoInterrupcao;
	}

	public void setColecaoInterrupcao(Collection<OrdemServicoInterrupcaoExecucao> colecaoInterrupcao){

		this.colecaoInterrupcao = colecaoInterrupcao;
	}
