...
public class OSAtividadePeriodoExecucaoHelper {
	...
	private OSExecucaoEquipeHelper ordemServicoExecucaoEquipeHelper;
	...
	public void setOsAtividadePeriodoExecucao(OsAtividadePeriodoExecucao osAtividadePeriodoExecucao){

		this.osAtividadePeriodoExecucao = osAtividadePeriodoExecucao;
	}

	public OSExecucaoEquipeHelper getOrdemServicoExecucaoEquipeHelper(){

		return ordemServicoExecucaoEquipeHelper;
	}

	public void setOrdemServicoExecucaoEquipeHelper(OSExecucaoEquipeHelper ordemServicoExecucaoEquipeHelper){

		this.ordemServicoExecucaoEquipeHelper = ordemServicoExecucaoEquipeHelper;
	}
}
