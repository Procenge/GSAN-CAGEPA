...
public class ServicoTipoOperacaoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("idServicoTipo", getIdServicoTipo()).append("idOperacao", getIdOperacao()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdServicoTipo(), castOther.getIdServicoTipo()).append(this.getIdOperacao(),
						castOther.getIdOperacao()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdServicoTipo()).append(getIdOperacao()).toHashCode();
	}
