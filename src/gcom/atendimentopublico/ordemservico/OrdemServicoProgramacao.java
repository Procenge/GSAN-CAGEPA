...
public class OrdemServicoProgramacao
	...
	/** persistent field */
	private short indicadorEnvioAcquaGis = 2; // DEFAULT 2
	...
	/** full constructor */
	public OrdemServicoProgramacao(Integer id, short nnSequencialProgramacao, short indicadorAtivo, short indicadorEquipePrincipal,
									Date ultimaAlteracao, Equipe equipe, Usuario usuarioProgramacao, Usuario usuarioFechamento,
									ProgramacaoRoteiro programacaoRoteiro, OsProgramNaoEncerMotivo osProgramNaoEncerMotivo,
	...
	public void setOsProgramNaoEncerMotivo(OsProgramNaoEncerMotivo osProgramNaoEncerMotivo){
	...
	public short getIndicadorEnvioAcquaGis(){

		return indicadorEnvioAcquaGis;
	}

	public void setIndicadorEnvioAcquaGis(short indicadorEnvioAcquaGis){

		this.indicadorEnvioAcquaGis = indicadorEnvioAcquaGis;
	}
	...
	public Filtro retornaFiltro(){
		...
		filtroOrdemServicoProgramacao.adicionarParametro(new ParametroSimples(FiltroOrdemServicoProgramacao.ID, this.getId()));
