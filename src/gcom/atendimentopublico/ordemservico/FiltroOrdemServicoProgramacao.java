 ...
 * @since 09/1/2006
 */
public class FiltroOrdemServicoProgramacao
				extends Filtro
	...
	public final static String PROGRAMACAO_ROTEIRO_DATA = "programacaoRoteiro.dataRoteiro";

	public final static String ORDEM_SERVICO = "ordemServico";

	public final static String ORDEM_SERVICO_ID = "ordemServico.id";

	public final static String EQUIPE = "equipe";

	public final static String EQUIPE_ID = "equipe.id";

	public final static String ORDERM_SERVICO_ID = "ordemServico.id";
