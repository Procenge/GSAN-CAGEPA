...
public class OsProgramacaoEquipePK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("idOrdemServicoProgramacao", getIdOrdemServicoProgramacao()).append("idEquipe",
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdOrdemServicoProgramacao(), castOther.getIdOrdemServicoProgramacao()).append(
						this.getIdEquipe(), castOther.getIdEquipe()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdOrdemServicoProgramacao()).append(getIdEquipe()).toHashCode();
	}
