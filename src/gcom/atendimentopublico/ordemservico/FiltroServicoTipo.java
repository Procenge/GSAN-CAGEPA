 ...
 * @date 27/07/2006
 */
public class FiltroServicoTipo
				extends Filtro
	...
	public final static String SERVICO_TIPO_REFERENCIA_ID = "servicoTipoReferencia.id";
	...
	public final static String INDICADOR_GERAR_HISTORICO_IMOVEL = "indicadorGerarHistoricoImovel";

	public final static String SERVICOS_ASSOCIADOS = "servicosAssociados";

	public final static String INDICADOR_ORDEM_SELETIVA = "indicadorOrdemSeletiva";

	public final static String INDICADOR_SERVICO_CRITICO = "indicadorServicoCritico";

	public final static String SERVICO_TIPO_SUB_GRUPO = "servicoTipoSubgrupo";
}
