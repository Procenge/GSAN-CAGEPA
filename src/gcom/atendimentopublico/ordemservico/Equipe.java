...
public class Equipe
	...
	/** minimal constructor */
	public Equipe(Date ultimaAlteracao, UnidadeOrganizacional unidadeOrganizacional,
	...
	public Filtro retornaFiltro(){
		...
		filtroEquipe.adicionarParametro(new ParametroSimples(FiltroEquipe.ID, this.getId()));
		return filtroEquipe;
	}
