...
public class EspecificacaoServicoTipoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("idSolicitacaoTipoEspecificacao", getIdSolicitacaoTipoEspecificacao()).append(
						"idServicoTipo", getIdServicoTipo()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdSolicitacaoTipoEspecificacao(), castOther.getIdSolicitacaoTipoEspecificacao()).append(
						this.getIdServicoTipo(), castOther.getIdServicoTipo()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdSolicitacaoTipoEspecificacao()).append(getIdServicoTipo()).toHashCode();
	}
