...
public class FiscalizacaoSituacaoHidrometroCapacidadePK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("fzstId", getIdFiscalizacaoSituacao()).append("hicpId", getIdHidrometroCapacidade())
						.toString();
	}
	 ...
	 *            O idFiscalizacaoSituacao a ser setado.
	 */
	 ...
	 *            O idHidrometroCapacidade a ser setado.
	 */
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdFiscalizacaoSituacao(), castOther.getIdFiscalizacaoSituacao()).append(
						this.getIdHidrometroCapacidade(), castOther.getIdHidrometroCapacidade()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdFiscalizacaoSituacao()).append(getIdHidrometroCapacidade()).toHashCode();
	}
