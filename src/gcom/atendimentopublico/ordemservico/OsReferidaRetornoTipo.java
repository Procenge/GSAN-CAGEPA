...
public class OsReferidaRetornoTipo
	...
	/** full constructor */
	public OsReferidaRetornoTipo(String descricao, String descricaoAbreviada, short indicadorDeferimento, Short situacaoOsReferencia,
									short indicadorTrocaServico, short indicadorUso, Date ultimaAlteracao, Integer codigoPenalidade,
									BigDecimal penaSemInfracao, AtendimentoMotivoEncerramento atendimentoMotivoEncerramento,
	...
	/** minimal constructor */
	public OsReferidaRetornoTipo(short indicadorDeferimento, Short situacaoOsReferencia, short indicadorTrocaServico, short indicadorUso,
									Date ultimaAlteracao, AtendimentoMotivoEncerramento atendimentoMotivoEncerramento,
									gcom.atendimentopublico.ordemservico.ServicoTipoReferencia servicoTipoReferencia) {
	...
	public Filtro retornaFiltro(){
		...
		filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.ID, this.getId()));
