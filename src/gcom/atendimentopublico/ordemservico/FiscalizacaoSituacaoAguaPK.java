...
public class FiscalizacaoSituacaoAguaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("fzstId", getIdFiscalizacaoSituacao()).append("lastId", getIdLigacaoAguaSituacao())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdFiscalizacaoSituacao(), castOther.getIdFiscalizacaoSituacao()).append(
						this.getIdLigacaoAguaSituacao(), castOther.getIdLigacaoAguaSituacao()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdFiscalizacaoSituacao()).append(getIdLigacaoAguaSituacao()).toHashCode();
	}
