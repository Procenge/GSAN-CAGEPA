...
public class ServicoTipoReferencia
	 ...
	 */
	public final static Short INDICADOR_FISCALIZACAO_SIM = new Short("1");

	/**
	 * Description of the Field
	 */
	public final static Short INDICADOR_EXISTENCIA_OS_REFERENCIA_ATIVO = new Short("1");

	/**
	 * Description of the Field
	 */
	public final static Short INDICADOR_DIAGNOSTICO_ATIVO = new Short("1");

	/** persistent field */
	private gcom.atendimentopublico.ordemservico.ServicoTipo servicoTipo;

	/** full constructor */
	public ServicoTipoReferencia(String descricao, String descricaoAbreviada, short indicadorUso, Integer situacaoOsReferenciaApos,
									Integer situacaoOsReferenciaAntes, Date ultimaAlteracao, short indicadorExistenciaOsReferencia,
	...
	/** minimal constructor */
	public ServicoTipoReferencia(short indicadorUso, Date ultimaAlteracao, short indicadorExistenciaOsReferencia,
									gcom.atendimentopublico.ordemservico.ServicoTipo servicoTipo) {
	...
	public void setIndicadorExistenciaOsReferencia(short indicadorExistenciaOsReferencia){
	...
	public Filtro retornaFiltro(){
		...
		filtroServicoTipoReferencia.adicionarParametro(new ParametroSimples(FiltroImovel.ID, this.getId()));
