...
public class ServicoTipoPrioridade
	...
	/** full constructor */
	public ServicoTipoPrioridade(String descricao, String descricaoAbreviada, short indicadorUso, Date ultimaAlteracao,
									short prazoExecucaoInicio, short prazoExecucaoFim, Date tmCadastramento) {
	...
	/** minimal constructor */
	public ServicoTipoPrioridade(String descricao, short indicadorUso, Date ultimaAlteracao) {
