...
public class FiscalizacaoSituacaoEsgotoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("fzstId", getIdFiscalizacaoSituacao()).append("lestId", getIdLigacaoEsgotoSituacao())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdFiscalizacaoSituacao(), castOther.getIdFiscalizacaoSituacao()).append(
						this.getIdLigacaoEsgotoSituacao(), castOther.getIdLigacaoEsgotoSituacao()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdFiscalizacaoSituacao()).append(getIdLigacaoEsgotoSituacao()).toHashCode();
	}
}
