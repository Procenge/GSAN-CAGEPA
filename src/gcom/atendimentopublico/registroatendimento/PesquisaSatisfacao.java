...
public class PesquisaSatisfacao
	...
	private Short indicadorBemAtendidoEquipeCampo;

	private String comentarioAtendimentoEquipeCampo;
	...
	public void setComentarioSolicitacaoResolvida(String comentarioSolicitacaoResolvida){

		this.comentarioSolicitacaoResolvida = comentarioSolicitacaoResolvida;
	}

	public Short getIndicadorBemAtendidoEquipeCampo(){

		return indicadorBemAtendidoEquipeCampo;
	}

	public void setIndicadorBemAtendidoEquipeCampo(Short indicadorBemAtendidoEquipeCampo){

		this.indicadorBemAtendidoEquipeCampo = indicadorBemAtendidoEquipeCampo;
	}

	public String getComentarioAtendimentoEquipeCampo(){

		return comentarioAtendimentoEquipeCampo;
	}

	public void setComentarioAtendimentoEquipeCampo(String comentarioAtendimentoEquipeCampo){

		this.comentarioAtendimentoEquipeCampo = comentarioAtendimentoEquipeCampo;
	}
	...
	public Filtro retornaFiltro(){
		...
		return new FiltroPesquisaSatisfacao();
	}
