...
public class LocalidadeSolicTipoGrupoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("idLocalidade", getIdLocalidade()).append("idSolicitacaoTipoGrupo",
						getIdSolicitacaoTipoGrupo()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdLocalidade(), castOther.getIdLocalidade()).append(this.getIdSolicitacaoTipoGrupo(),
						castOther.getIdSolicitacaoTipoGrupo()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdLocalidade()).append(getIdSolicitacaoTipoGrupo()).toHashCode();
	}
