...
public class RaDadosAgenciaReguladora
	...
	public RaDadosAgenciaReguladora(
									...
									short codigoSituacaoArpe,
									Date dataPrevisaoOriginal,
									Date dataPrevisaoAtual,
									Date dataReclamacao,
									...
									gcom.atendimentopublico.registroatendimento.AgenciaReguladoraMotRetorno agenciaReguladoraMotRetorno,
									gcom.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento,
									gcom.atendimentopublico.registroatendimento.AgenciaReguladoraMotReclamacao agenciaReguladoraMotReclamacao) {
	...
	public void setAgenciaReguladoraMotRetorno(
					gcom.atendimentopublico.registroatendimento.AgenciaReguladoraMotRetorno agenciaReguladoraMotRetorno){
	...
	public void setAgenciaReguladoraMotReclamacao(
					gcom.atendimentopublico.registroatendimento.AgenciaReguladoraMotReclamacao agenciaReguladoraMotReclamacao){
