...
public class Tramite
	...
	public final static String TRAMITE_GERADO_PELO_SISTEMA_ABERTURA_RA = "TRAMITE GERADO PELO SISTEMA NA ABERTURA DO REGISTRO DE ATENDIMENTO";

	public final static String TRAMITE_GERADO_PELO_SISTEMA_GERACAO_OS = "TRAMITE GERADO PELO SISTEMA NA GERACAO DA ORDEM DE SERVICO";
	...
	/**
	 * Atributo não existente na entidade - Utilizado na tela de tramitar registros de atendimento
	 * para indicar se um RA será tramitado em conjunto com sua OS
	 */
	private String indicadorTramiteApenasRA;

	/** full constructor */
	public Tramite(String parecerTramite, Date dataTramite, Date ultimaAlteracao, Usuario usuarioResponsavel, Usuario usuarioRegistro,
					gcom.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento,
					UnidadeOrganizacional unidadeOrganizacionalOrigem, UnidadeOrganizacional unidadeOrganizacionalDestino) {
	...
	public String getIndicadorTramiteApenasRA(){

		return indicadorTramiteApenasRA;
	}

	public void setIndicadorTramiteApenasRA(String indicadorTramiteApenasRA){

		this.indicadorTramiteApenasRA = indicadorTramiteApenasRA;
	}
