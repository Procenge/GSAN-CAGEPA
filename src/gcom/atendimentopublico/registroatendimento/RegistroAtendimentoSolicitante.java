...
public class RegistroAtendimentoSolicitante
	...
	/** full constructor */
	public RegistroAtendimentoSolicitante(String numeroImovel, String pontoReferencia, String complementoEndereco, String solicitante,
											short indicadorSolicitantePrincipal, Date ultimaAlteracao, LogradouroBairro logradouroBairro,
											Cliente cliente, LogradouroCep logradouroCep,
	...
	/** minimal constructor */
	public RegistroAtendimentoSolicitante(short indicadorSolicitantePrincipal, Date ultimaAlteracao, LogradouroBairro logradouroBairro,
											Cliente cliente, LogradouroCep logradouroCep,
											gcom.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento,
											UnidadeOrganizacional unidadeOrganizacional, Funcionario funcionario) {
	...
	public void setIndicadorSolicitantePrincipal(short indicadorSolicitantePrincipal){
	...
	public String getEnderecoFormatado(){
		...
		if(this.getNumeroImovel() != null && !this.getNumeroImovel().trim().equals("")){
	...
	public Short getClienteTipo(){

		return clienteTipo;
	}

	public void setClienteTipo(Short clienteTipo){
