...
/**
 * Filtro Especificacao Tramite
 * 
 * @author Yara Souza
 * @date 25/09/2014
 */
public class FiltroEspecificacaoTramite
				extends Filtro {
	...
	public FiltroEspecificacaoTramite() {

	}

	public FiltroEspecificacaoTramite(String campoOrderBy) {
	...
	public final static String UNIDADE_ORGANIZACIONAL_DESTNO = "unidadeOrganizacionalDestino";

	public final static String UNIDADE_ORGANIZACIONAL_DESTNO_ID = "unidadeOrganizacionalDestino.id";

	public final static String INDICADOR_PRIMEIROTRAMITE = "indicadorPrimeiroTramite";
