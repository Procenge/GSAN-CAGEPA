 ...
 * @since 09/01/2006
 */
public class FiltroRegistroAtendimento
				extends Filtro
	...
	public final static String ID_ESPECIFIACAO_TIPO_VALIDADCAO = "solicitacaoTipoEspecificacao.id";
	...
	public final static String SITUACAO = "codigoSituacao";

	public final static String LOGRADOURO_CEP = "logradouroCep";

	public final static String LOGRADOURO_CEP_LOGRADOURO = "logradouroCep.logradouro";

	public final static String LOGRADOURO_BAIRRO = "logradouroBairro";

	public final static String LOGRADOURO_BAIRRO_BAIRRO = "logradouroBairro.bairro";

	public final static String LOGRADOURO_BAIRRO_LOGRADOURO = "logradouroBairro.logradouro";

	public final static String INDICADOR_PROCESSO_ADMINISTRATIVO_JUDICIARIO = "indicadorProcessoAdmJud";
