...
public class EspecificacaoImovSitCriterio
	...
	public EspecificacaoImovSitCriterio(
										...
										gcom.atendimentopublico.registroatendimento.EspecificacaoImovelSituacao especificacaoImovelSituacao,
										LigacaoEsgotoSituacao ligacaoEsgotoSituacao, LigacaoAguaSituacao ligacaoAguaSituacao) {
	...
	public boolean equals(Object other){
		...
		if(castOther.getLigacaoAguaSituacao() != null && this.getLigacaoAguaSituacao() != null){
			...
			equals = (castOther.getLigacaoAguaSituacao().getId().intValue() == this.getLigacaoAguaSituacao().getId().intValue());
		...
		if(castOther.getLigacaoEsgotoSituacao() != null && this.getLigacaoEsgotoSituacao() != null){
			...
			equals = equals
							&& (castOther.getLigacaoEsgotoSituacao().getId().intValue() == this.getLigacaoEsgotoSituacao().getId()
											.intValue());
		...
		if(castOther.getIndicadorHidrometroLigacaoAgua() != null && this.getIndicadorHidrometroLigacaoAgua() != null){
			...
			equals = equals
							&& (castOther.getIndicadorHidrometroLigacaoAgua().shortValue() == this.getIndicadorHidrometroLigacaoAgua()
											.shortValue());
		...
		if(castOther.getIndicadorHidrometroPoco() != null && this.getIndicadorHidrometroPoco() != null){
			...
			equals = equals && (castOther.getIndicadorHidrometroPoco().shortValue() == this.getIndicadorHidrometroPoco().shortValue());
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroEspecificacaoImovelSituacaoCriterio.ID, this.getId()));
