...
public class LigacaoEsgotoPerfil
	...
	// CONSTANTES
	public final static Integer NAO_INFORMADO = Integer.valueOf(0);

	public final static Integer CONVENCIONAL = Integer.valueOf(1);

	public final static Integer CONDOMINIAL = Integer.valueOf(2);
	...
	/** full constructor */
	public LigacaoEsgotoPerfil(String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	public String getPercentualEsgotoConsumidaColetadaFormatado(){

		String retorno = "";

		BigDecimal percentualEsgotoConsumidaColetadaBD = this.getPercentualEsgotoConsumidaColetada();

		if(percentualEsgotoConsumidaColetadaBD != null){
			retorno = Util.formataBigDecimal(percentualEsgotoConsumidaColetadaBD, 2, true);
		}
