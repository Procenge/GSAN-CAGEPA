 ...
 * @date 20/07/2006
 */
public abstract class TarefaBatch
				extends Tarefa {
	...
	protected void enviarMensagemControladorBatch(String queueMDB, Object[] parametros){
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException{
		...
		this.setIdFuncionalidadeIniciada((Integer) arg0.getJobDetail().getJobDataMap().get("idFuncionalidadeIniciada"));
