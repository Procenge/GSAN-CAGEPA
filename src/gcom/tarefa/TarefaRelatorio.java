...
public abstract class TarefaRelatorio
		...
		try{
			...
			switch(tipoSaidaRelatorio){
				...
				case TIPO_XLS:
					...
					/*
					 * Código comentado abaixo pois estava dando erro em todos os relatórios XLS nas
					 * versões 2.10 e 2.11
					 */
	 ...
	 * @date 12/01/2009
	 *       Alteracao na assinatura do método, incluido parametro descricaoArquivoGerado
	 * @param relatorioConcluido
	 *            conteúdo do report gerado
	 * @param idRelatorio
