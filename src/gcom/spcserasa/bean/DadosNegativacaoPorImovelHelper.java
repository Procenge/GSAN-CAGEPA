...
public class DadosNegativacaoPorImovelHelper {
	 ...
	 * @param cnpjCliente
	 */
	public DadosNegativacaoPorImovelHelper(Integer idCliente, String cpfCliente, String cnpjCliente) {
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdImovel(), castOther.getIdImovel()).isEquals();
	}
