...
public class NegativadorMovimentoHelper
	...
	public NegativadorMovimentoHelper(Integer idNegativador, short codigoMovimento, Integer idImovel, Integer numeroSequencialArquivo,
										String dataProcessamentoInicial, String dataProcessamentoFinal, short indicadorMovimento,
										short indicadorRegistro, short indicadorCorrigido) {
	...
	public NegativadorMovimentoHelper(Integer idNegativador, String negativadorDescricao, short codigoMovimento,
										Integer numeroSequencialArquivo, String dataProcessamentoInicial, String dataProcessamentoFinal,
										short indicadorRegistro, short indicadorCorrigido) {
	...
	public NegativadorMovimentoHelper(Integer idNegativador, short codigoMovimento, Integer numeroSequencialArquivo,
										String dataProcessamentoInicial, String dataProcessamentoFinal, short indicadorMovimento,
										short indicadorRegistro, short indicadorCorrigido, Integer idNegativadorMovimento) {
	...
	public NegativadorMovimentoHelper clone(){
		...
		try{
			return (NegativadorMovimentoHelper) super.clone();
	...
	/**
	 * @param negativadorDescricao
	 *            O negativadorDescricao a ser setado.
	 */
	 ...
	 *            O indicadorRegistro a ser setado.
	 */
	...
	/**
	 * @param indicadorMovimento
	 *            O indicadorMovimento a ser setado.
	 */
	...
	/**
	 * @param indicadorCorrigido
	 *            O indicadorCorrigido a ser setado.
	 */
	...
	/**
	 * @param idNegativadorMovimento
	 *            O idNegativadorMovimento a ser setado.
	 */
