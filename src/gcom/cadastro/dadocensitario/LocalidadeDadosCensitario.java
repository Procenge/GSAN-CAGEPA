...
@ControleAlteracao()
public class LocalidadeDadosCensitario
	...
	/** persistent field */
	@ControleAlteracao(value = FiltroLocalidadeDadosCensitario.LOCALIDADE, funcionalidade = {ATRIBUTOS_DADOS_CENSITARIOS_INSERIR, ATRIBUTOS_DADOS_CENSITARIOS_REMOVER, ATRIBUTOS_DADOS_CENSITARIOS_ATUALIZAR})
	private Localidade localidade;

	/** persistent field */
	@ControleAlteracao(value = FiltroLocalidadeDadosCensitario.FONTE_DADOS_CENSITARIO, funcionalidade = {ATRIBUTOS_DADOS_CENSITARIOS_INSERIR, ATRIBUTOS_DADOS_CENSITARIOS_REMOVER, ATRIBUTOS_DADOS_CENSITARIOS_ATUALIZAR})
	private gcom.cadastro.dadocensitario.FonteDadosCensitario fonteDadosCensitario;

	/** full constructor */
	public LocalidadeDadosCensitario(int anoMesReferencia, Integer numeroPopulacaoUrbana, BigDecimal taxaAnualCrescimentoPopulacaoUrbana,
										BigDecimal taxaOcupacaoUrbana, Integer numeroPopulacaoRural,
										BigDecimal taxaCrescimentoPopulacaoRural, BigDecimal taxaOcupacaoRural, Date ultimaAlteracao,
										Localidade localidade, gcom.cadastro.dadocensitario.FonteDadosCensitario fonteDadosCensitario) {
	...
	/** minimal constructor */
	public LocalidadeDadosCensitario(int anoMesReferencia, Localidade localidade,
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"localidade.id", "formatarAnoMesParaMesAno"};
		return atributos;
	}

	public String[] retornarLabelsInformacoesOperacaoEfetuada(){

		String[] labels = {"Localidade", "Ano/Mes Referencia"};
		return labels;
	}
	...
	public Filtro retornaFiltro(){
		...
		filtroLocalidadeDadosCensitario.adicionarParametro(new ParametroSimples(FiltroLocalidadeDadosCensitario.ID, this.getId()));
		filtroLocalidadeDadosCensitario.adicionarCaminhoParaCarregamentoEntidade(FiltroLocalidadeDadosCensitario.LOCALIDADE);
		filtroLocalidadeDadosCensitario.adicionarCaminhoParaCarregamentoEntidade(FiltroLocalidadeDadosCensitario.FONTE_DADOS_CENSITARIO);

		return filtroLocalidadeDadosCensitario;
	}
