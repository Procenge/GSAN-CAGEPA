...
public class IbgeSetorCensitarioDado
	...
	/** full constructor */
	public IbgeSetorCensitarioDado(int anoMesReferencia, Integer numeroPopulacaoUrbana, BigDecimal taxaAnualCrescimentoPopulacaoUrbana,
									BigDecimal taxaOcupacaoUrbana, Integer numeroPopulacaoRural, BigDecimal taxaCrescimentoPopulacaoRural,
									BigDecimal taxaOcupacaoRural, Date ultimaAlteracao,
	...
	/** minimal constructor */
	public IbgeSetorCensitarioDado(int anoMesReferencia, gcom.cadastro.dadocensitario.IbgeSetorCensitario ibgeSetorCensitario,
									gcom.cadastro.dadocensitario.FonteDadosCensitario fonteDadosCensitario) {
	...
	public void setIbgeSetorCensitario(gcom.cadastro.dadocensitario.IbgeSetorCensitario ibgeSetorCensitario){
