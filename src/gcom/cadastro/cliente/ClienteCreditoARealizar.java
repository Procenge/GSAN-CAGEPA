...
@ControleAlteracao()
public class ClienteCreditoARealizar
	...
	/** full constructor */
	public ClienteCreditoARealizar(gcom.cadastro.cliente.Cliente cliente, gcom.cadastro.cliente.ClienteRelacaoTipo clienteRelacaoTipo,
									CreditoARealizar creditoARealizar) {
	...
	/** default constructor */
	public ClienteCreditoARealizar() {
	...
	public Filtro retornaFiltro(){
		...
		filtroClienteCreditoARealizar.adicionarCaminhoParaCarregamentoEntidade(FiltroClienteCreditoARealizar.CREDITO_A_REALIZAR);

		filtroClienteCreditoARealizar.adicionarParametro(new ParametroSimples(FiltroClienteConta.ID, this.getId()));
		return filtroClienteCreditoARealizar;
	}
	...
	public String getDescricaoParaRegistroTransacao(){
		...
		if(this.getCliente() != null && this.getCreditoARealizar() != null){
