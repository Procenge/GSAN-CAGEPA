...
public class ClienteImovelSimplificado
	 ...
	 *            Description of the Parameter
	 */
	public ClienteImovelSimplificado(Integer idImovel, String numeroImovel, LogradouroCep logradouroCep, LogradouroBairro logradouroBairro,
										Quadra quadra, EnderecoReferencia enderecoReferencia, String complementoEndereco,
										String nomeCliente, Integer idCliente, SetorComercial setorComercial, Localidade localidade,
										Date dataFimRelacao) {

		this.imovel = new Imovel(idImovel, numeroImovel, logradouroCep, logradouroBairro, quadra,/* hidrometro */null, enderecoReferencia,
	...
	public ClienteImovelSimplificado(Integer idImovel, String numeroImovel, LogradouroCep logradouroCep, LogradouroBairro logradouroBairro,
		...
		this.imovel = new Imovel(idImovel, numeroImovel, logradouroCep, logradouroBairro, quadra,/* hidrometro */null, enderecoReferencia,
						complementoEndereco, setorComercial, localidade, ultimaAlteracao);
		this.cliente = new Cliente(nomeCliente, idCliente);
		this.dataFimRelacao = dataFimRelacao;
	}
