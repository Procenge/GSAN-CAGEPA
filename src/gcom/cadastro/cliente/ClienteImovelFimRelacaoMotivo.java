 ...
 */
@ControleAlteracao()
public class ClienteImovelFimRelacaoMotivo
	 ...
	 */
	// public final static Integer RELACAO_EXISTENTE = new Integer(1);
	/**
	 * full constructor
	 * 
	 * @param descricao
	 ...
	 *            Descrição do parâmetro
	 */
	public ClienteImovelFimRelacaoMotivo(String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	public Filtro retornaFiltro(){
		...
		filtroClienteImovelFimRelacaoMotivo.adicionarParametro(new ParametroSimples(
						FiltroClienteImovelFimRelacaoMotivo.CLIENTE_IMOVEL_FIM_RELACAO_MOTIVO_ID, this.getId()));
