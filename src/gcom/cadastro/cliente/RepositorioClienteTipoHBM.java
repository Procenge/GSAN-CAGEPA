...
public class RepositorioClienteTipoHBM
				implements IRepositorioClienteTipo {
	 ...
	 */
	public Collection pesquisarClienteTipo(FiltroClienteTipo filtroClienteTipo) throws ErroRepositorioException{
		...
		try{
			...
			retorno = new ArrayList(new CopyOnWriteArraySet(GeradorHQLCondicional.gerarCondicionalQuery(filtroClienteTipo,
							"gcom.cadastro.cliente.ClienteTipo", "clienteTipo", "from gcom.cadastro.cliente.ClienteTipo clienteTipo",
							session).list()));
