...
public class FiltroClienteImovel
				extends Filtro
	...
	public final static String CLIENTE_TIPO_USUARIO = "2";
	 ...
	 * Description of the Field
	 */
	public final static String CLIENTE_FONES = "cliente.clienteFones";
	 ...
	 * Description of the Field
	 */
	public final static String NUMERO_SEGMENTO = "imovel.numeroSegmento";
	...
	public static final String HIDROMETRO_INSTALACAO_HISTORICO_ID = "imovel.hidrometroInstalacaoHistorico.id";

	public static final String HIDROMETRO_INSTALACAO_HISTORICO_DATA_RETIRADA = "imovel.hidrometroInstalacaoHistorico.dataRetirada";

	public static final String HIDROMETRO_NUMERO = "imovel.hidrometroInstalacaoHistorico.hidrometro.numero";

	public static final String IMOVEL_NUMERO = "imovel.numeroImovel";

	// public final static String IMOVEL_LIGACAO_ESGOTO_PERCENTUAL =
	// "imovel.ligacaoEsgoto.percentual";

	public static final String CLIENTE_CLIENTE_TIPO = "cliente.clienteTipo";

	public static final String CLIENTE_CLIENTE_TIPO_ESFERA_PODER = "cliente.clienteTipo.esferaPoder";

	public final static String IMOVEL_INDICADOR_EMISSAO_EXTRATO_FATURAMENTO = "imovel.indicadorEmissaoExtratoFaturamento";

	public final static String CLIENTE_PROFISSAO = "cliente.profissao";

	public final static String CLIENTE_RG_ORGAO_EXPEDIDOR = "cliente.orgaoExpedidorRg";
