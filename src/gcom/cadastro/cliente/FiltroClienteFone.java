 ...
 */
public class FiltroClienteFone
				extends Filtro {
	 ...
	 * Description of the Field
	 */
	public final static String FONE_TIPO_ID = "foneTipo.id";

	/**
	 * Description of the Field
	 */
	public final static String INDICADOR_TELEFONE_PADRAO = "indicadorTelefonePadrao";
