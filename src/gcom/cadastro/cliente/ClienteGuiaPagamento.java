...
public class ClienteGuiaPagamento
	...
	public Filtro retornaFiltro(){
		...
		filtroClienteGuiaPagamento.adicionarParametro(new ParametroSimples(FiltroClienteGuiaPagamento.ID, this.getId()));
		filtroClienteGuiaPagamento.adicionarCaminhoParaCarregamentoEntidade("cliente");
		filtroClienteGuiaPagamento.adicionarCaminhoParaCarregamentoEntidade("clienteRelacaoTipo");
		filtroClienteGuiaPagamento.adicionarCaminhoParaCarregamentoEntidade("guiaPagamento");
	...
	/** full constructor */
	public ClienteGuiaPagamento(gcom.cadastro.cliente.Cliente cliente, gcom.cadastro.cliente.ClienteRelacaoTipo clienteRelacaoTipo,
