...
/**
 * O filtro serve para armazenar os critérios de busca de um debito a cobrar par um cliente
 * FiltroClienteDebitoACobrar
 * 
 * @author Yara Souza
 * @date 29/07/2014
 */
public class FiltroClienteDebitoACobrar
				extends Filtro
	...
	/**
	 * Constructor for the FiltroClienteDebitoACobrar object
	 */
	public FiltroClienteDebitoACobrar() {
	 ...
	 */
	public FiltroClienteDebitoACobrar(String campoOrderBy) {
	...
	public final static String DEBITO_A_COBRAR_PARCELAMENTO = "debitoACobrar.parcelamento";
}
