...
@ControleAlteracao()
public class ClienteDebitoACobrar
	...
	/** full constructor */
	public ClienteDebitoACobrar(gcom.cadastro.cliente.Cliente cliente, gcom.cadastro.cliente.ClienteRelacaoTipo clienteRelacaoTipo,
	...
	public Filtro retornaFiltro(){
		...
		filtroClienteDebitoACobrar.adicionarParametro(new ParametroSimples(FiltroClienteConta.ID, this.getId()));
		return filtroClienteDebitoACobrar;
	}
	...
	public String getDescricaoParaRegistroTransacao(){
		...
		if(this.getCliente() != null && this.getDebitoACobrar() != null){
			...
			}else if(this.getDebitoACobrar() != null){

				retorno += " / " + "ID da Débito a Cobrar: " + this.getDebitoACobrar().getId().toString();
			}
		}else{
