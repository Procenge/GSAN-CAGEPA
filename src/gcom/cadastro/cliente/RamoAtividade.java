...
public class RamoAtividade
	...
	/** full constructor */
	public RamoAtividade(short codigo, String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	public Filtro retornaFiltro(){
		...
		filtroRamoAtividade.adicionarParametro(new ParametroSimples(FiltroRamoAtividade.ID, getId()));
