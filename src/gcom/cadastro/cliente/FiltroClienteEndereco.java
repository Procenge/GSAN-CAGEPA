...
public class FiltroClienteEndereco
				extends Filtro
	...
	public final static String ENDERECO_TIPO_ID = "enderecoTipo.id";

	public final static String ENDERECO_REFERENCIA = "enderecoReferencia";

	public final static String ENDERECO_REFERENCIA_ID = "enderecoReferencia.id";
