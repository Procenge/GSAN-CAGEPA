...
public class Profissao
	...
	/** full constructor */
	public Profissao(Integer codigo, String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	/** minimal constructor */
	public Profissao(Integer codigo) {
	...
	public Filtro retornaFiltro(){
		...
		filtroProfissao.adicionarParametro(new ParametroSimples(FiltroProfissao.ID, getId()));
