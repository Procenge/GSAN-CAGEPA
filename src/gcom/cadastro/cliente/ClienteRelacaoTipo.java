...
public class ClienteRelacaoTipo
	...
	public final static String DESCRICAO_RESPONSAVEL = "RESPONSAVEL";
	...
	public Filtro retornaFiltro(){
		...
		filtroClienteRelacaoTipo.adicionarParametro(new ParametroSimples(FiltroClienteRelacaoTipo.CLIENTE_RELACAO_TIPO_ID, this.getId()));
