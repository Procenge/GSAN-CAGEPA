...
public class GerenciaRegional
	...
	/** full constructor */
	public GerenciaRegional(String nome, String nomeAbreviado, String numeroImovel, String complementoEndereco, String fone,
							String ramalFone, String fax, String email, Short indicadorUso, Date ultimaAlteracao, Logradouro logradouro,
							Bairro bairro, EnderecoReferencia enderecoReferencia, Cep cep, LogradouroCep logradouroCep,
	...
	/** minimal constructor */
	public GerenciaRegional(String nome, String nomeAbreviado, String fone, Logradouro logradouro, Bairro bairro,
	...
	public Filtro retornaFiltro(){
		...
		filtroGerenciaRegional.adicionarCaminhoParaCarregamentoEntidade("logradouro");
		filtroGerenciaRegional.adicionarCaminhoParaCarregamentoEntidade("bairro");
		...
		filtroGerenciaRegional.adicionarParametro(new ParametroSimples(FiltroGerenciaRegional.ID, this.getId()));
