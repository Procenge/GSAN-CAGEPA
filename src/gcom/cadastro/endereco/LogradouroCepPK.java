...
public class LogradouroCepPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("LogradouroId", getLogradouroId()).append("CepId", getCepId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getLogradouroId(), castOther.getLogradouroId())
						.append(this.getCepId(), castOther.getCepId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getCepId()).append(getLogradouroId()).toHashCode();
	}
}
