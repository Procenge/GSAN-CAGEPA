...
public class EnderecoReferencia
	 ...
	 */
	/*
	 * public EnderecoReferencia(String descricao, String descricaoAbreviada, Short indicadorUso,
	...
	public Filtro retornaFiltro(){
		...
		filtroEnderecoReferencia.adicionarParametro(new ParametroSimples(FiltroEnderecoReferencia.ID, this.getId()));
