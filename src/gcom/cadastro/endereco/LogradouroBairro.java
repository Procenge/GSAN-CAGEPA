...
public class LogradouroBairro
	...
	/** full constructor */
	public LogradouroBairro(Integer id, Logradouro logradouro, Bairro bairro, Date ultimaAlteracao) {
	...
	public boolean equals(Object other){
		...
		if(!(other instanceof LogradouroBairro)) return false;
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"bairro.id", "logradouro.id"};
		return atributos;
	}

	public String[] retornarLabelsInformacoesOperacaoEfetuada(){

		String[] labels = {"Bairro", "Logradouro"};
		return labels;
	}
