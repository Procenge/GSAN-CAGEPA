...
public interface IRepositorioUnidade {
	...
	/**
	 * Retorna uma coleção de unidade organizacional hierarquia que tenham como superior o superior
	 * da unidade passada
	 * 
	...
	/**
	 * Retorna uma coleção de unidade organizacional hierarquia filtrando pela unidade superior
	 * 
	 * @author Hebert Falcão
	 * @date 11/04/2011
	 */
	...
	/**
	 * Retorna uma coleção de unidade organizacional hierarquia filtrando pela unidade
	 * 
	 * @author Hebert Falcão
	 * @date 11/04/2011
	 */
