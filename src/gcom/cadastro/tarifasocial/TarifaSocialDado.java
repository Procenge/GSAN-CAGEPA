...
public class TarifaSocialDado
	 ...
	 *         ParametroSimples(FiltroTarifaSocialDado.ID,this.getId()));
	 *         return filtro;
	 *         }
	 *         /**
	 ...
	 *            Descrição do parâmetro
	 */
	public TarifaSocialDado(Date dataImplantacao, Date dataExclusao, Short quantidadeRecadastramento, Date dataRecadastramento,
							Date ultimaAlteracao, Imovel imovel,
	 ...
	 *            Descrição do parâmetro
	 */
	public TarifaSocialDado(gcom.cadastro.tarifasocial.TarifaSocialExclusaoMotivo tarifaSocialExclusaoMotivo) {
	 ...
	 */
	public void setTarifaSocialExclusaoMotivo(gcom.cadastro.tarifasocial.TarifaSocialExclusaoMotivo tarifaSocialExclusaoMotivo){
