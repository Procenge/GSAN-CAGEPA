...
public class TarifaSocialRevisaoMotivo
	...
	public final static Integer CONSUMO = new Integer("1");

	public final static Integer INADIMPLENCIA = new Integer("2");

	public final static Integer MUDANCA_CATEGORIA = new Integer("3");

	public final static Integer QUANTIDADE_ECONOMIA_FORA_LIMITE = new Integer("3");

	public final static Integer DATA_VALIDADE_FORA_VIGENCIA = new Integer("3");

	public String toString(){

		return new ToStringBuilder(this).append("rtsmId", getId()).toString();
	}
	...
	/**
	 * @param indicadorPermiteRecadastramento
	 *            O indicadorPermiteRecadastramento a ser setado.
	 */
	public void setIndicadorPermiteRecadastramento(Integer indicadorPermiteRecadastramento){
	 ...
	 *            O tarifaSocialDadoEconomias a ser setado.
	 */
