...
@ControleAlteracao()
public class TarifaSocialDadoEconomia
	...
	/** full constructor */
	public TarifaSocialDadoEconomia(Long numeroCartaoProgramaSocial, Short numeroMesesAdesao, Integer consumoCelpe,
	...
	/** minimal constructor */
	public TarifaSocialDadoEconomia(gcom.cadastro.tarifasocial.RendaTipo rendaTipo,
									gcom.cadastro.tarifasocial.TarifaSocialCartaoTipo tarifaSocialCartaoTipo, ImovelEconomia imovelEconomia) {
	...
	public Filtro retornaFiltro(){
		...
		filtroTarifaSocialDadoEconomia.adicionarParametro(new ParametroSimples(FiltroTarifaSocialDadoEconomia.ID, this.getId()));
		filtroTarifaSocialDadoEconomia.adicionarCaminhoParaCarregamentoEntidade(FiltroTarifaSocialDadoEconomia.IMOVEL);
