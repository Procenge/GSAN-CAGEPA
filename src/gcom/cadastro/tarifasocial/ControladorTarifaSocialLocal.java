 ...
 * @author rodrigo
 */
public interface ControladorTarifaSocialLocal
	...
	/**
	 * Método que verifica se o usuario esta cadastrado em outro imovel que esteja na tarifa social
	 * e
	 * verifica se ja esta cadastrado como usuario de algum imovel economia,
	 * Caso o idImovel seja diferente de nula ele verifa se o usuario esta cadastrado num imovel
	 * diferente
	 * do id passado.
	 * Caso o idImovelEconomia seja diferente de nula ele verifaca se o usuario esta cadastrado num
	 * imovel economia
