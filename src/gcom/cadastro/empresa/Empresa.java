...
public class Empresa
				extends ObjetoGcom
				implements Serializable, Comparable<Empresa> {
	...
	private Set<CobrancaContrato> cobrancaContratos;
	...
	/** full constructor */
	public Empresa(String descricao, String descricaoAbreviada, Short indicadorUso, String email, Date ultimaAlteracao,
	...
	public boolean equals(Object obj){
		...
		try{
			return ((Empresa) obj).getId().equals(this.id);
	...
	public Set<CobrancaContrato> getCobrancaContratos(){

		return cobrancaContratos;
	}

	public void setCobrancaContratos(Set<CobrancaContrato> cobrancaContratos){

		this.cobrancaContratos = cobrancaContratos;
	}
