...
public class Funcionario
	...
	/** minimal constructor */
	public Funcionario(String descricaoCargo, String nome, Empresa empresa, UnidadeOrganizacional unidadeOrganizacional) {
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"empresa.id", "nome"};
		return atributos;
	}

	public String[] retornarLabelsInformacoesOperacaoEfetuada(){

		String[] labels = {"Empresa", "Nome"};
		return labels;
	}
	...
	public Filtro retornaFiltro(){
		...
		filtroFuncionario.adicionarParametro(new ParametroSimples(FiltroFuncionario.ID, this.getId()));
		filtroFuncionario.adicionarCaminhoParaCarregamentoEntidade(FiltroFuncionario.UNIDADE_EMPRESA);
