...
public class Bairro
	...
	public Filtro retornaFiltro(){
		...
		filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.ID, this.getId()));
	...
	public String getNomeComCodigo(){
		...
		if(Integer.valueOf(this.getCodigo()).compareTo(10) == -1){
			descricaoComCodigo = "0" + getCodigo() + " - " + getNome();
		}else{
			descricaoComCodigo = getCodigo() + " - " + getNome();
		}
