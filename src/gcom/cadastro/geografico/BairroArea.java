...
public class BairroArea
	...
	/** full constructor */
	public BairroArea(String nome, Date ultimaAlteracao, Short codigoBairroArea, Short codigoMunicipio,
						gcom.cadastro.geografico.Bairro bairro, DistritoOperacional distritoOperacional) {
	...
	/**
	 * @param codigoBairroArea
	 *            O codigoBairroArea a ser setado.
	 */
	...
	public Filtro retornaFiltro(){
		...
		filtroBairroArea.adicionarParametro(new ParametroSimples(FiltroBairroArea.ID, this.getId()));
