...
public class FonteAbastecimento
	...
	/** full constructor */
	/*
	 * public FonteAbastecimento(String descricao, String descricaoAbreviada, Short indicadorUso,
	...
	public Filtro retornaFiltro(){
		...
		filtroFonteAbastecimento.adicionarParametro(new ParametroSimples(FiltroFonteAbastecimento.ID, this.getId()));
		return filtroFonteAbastecimento;
	}
