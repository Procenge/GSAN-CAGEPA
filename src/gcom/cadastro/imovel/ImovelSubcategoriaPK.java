...
public class ImovelSubcategoriaPK
				extends ObjetoGcom {
	...
	/** full constructor */
	public ImovelSubcategoriaPK(gcom.cadastro.imovel.Imovel imovel, gcom.cadastro.imovel.Subcategoria subcategoria) {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("imovel", getImovel()).append("subcategoria", getSubcategoria()).toString();
	}

	public boolean equals(Object other){

		if((this == other)) return true;
		if(!(other instanceof ImovelSubcategoriaPK)) return false;
		ImovelSubcategoriaPK castOther = (ImovelSubcategoriaPK) other;
		return new EqualsBuilder().append(this.getImovel(), castOther.getImovel()).append(this.getSubcategoria(),
						castOther.getSubcategoria()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getImovel()).append(getSubcategoria()).toHashCode();
	}
