 ...
 */
public class ImovelRelatorioHelper
	...
	public void setConsumoMinimoFixadoLigacaoEsgoto(Integer consumoMinimoFixadoLigacaoEsgoto){
	...
	public void setDataInstalacaoHidrometroAgua(Date dataInstalacaoHidrometroAgua){
	...
	public void setDataInstalacaoHidrometroPoco(Date dataInstalacaoHidrometroPoco){
	...
	public void setIndicadorExistenciaCavaleteAgua(short indicadorExistenciaCavaleteAgua){
	...
	public void setIndicadorExistenciaCavaletePoco(short indicadorExistenciaCavaletePoco){
	...
	public void setLocalInstalacaoHidrometroAgua(String localInstalacaoHidrometroAgua){
	...
	public void setLocalIstalacaoHidrometroPoco(String localIstalacaoHidrometroPoco){
	...
	public String getEnderecoFormatado(){
		...
		String retorno = "";
		if(this.nomeLogradouro != null && !this.nomeLogradouro.trim().equalsIgnoreCase("")){
			if(this.tipoLogradouro != null && !this.tipoLogradouro.trim().equalsIgnoreCase("")){
				retorno = this.tipoLogradouro.trim();
			}
			if(this.tituloLogradouro != null && !this.tituloLogradouro.trim().equalsIgnoreCase("")){
				retorno = retorno + " " + this.tituloLogradouro.trim();
			}
			retorno = retorno + " " + this.nomeLogradouro.trim();

			if(this.enderecoReferencia != null && !this.enderecoReferencia.trim().equalsIgnoreCase("")){
				retorno = retorno + " - " + this.enderecoReferencia.trim();
			}

			if(this.numeroImovel != null && !this.numeroImovel.trim().equalsIgnoreCase("")){
				retorno = retorno + " - " + this.numeroImovel.trim();
			}

			if(this.complementoImovel != null && !this.complementoImovel.trim().equalsIgnoreCase("")){
				retorno = retorno + " - " + this.complementoImovel.trim();
			}

			if(this.nomeBairro != null && !this.nomeBairro.trim().equalsIgnoreCase("")){
				retorno = retorno + " - " + this.nomeBairro;
			}
			if(this.nomeMunicipio != null && !this.nomeMunicipio.trim().equalsIgnoreCase("")){
				retorno = retorno + " - " + this.nomeMunicipio;
			}
			if(this.unidadeFederacao != null && !this.unidadeFederacao.trim().equalsIgnoreCase("")){
				retorno = retorno + " - " + this.unidadeFederacao;
			}

			if(this.cepFormatado != null && !this.cepFormatado.toString().trim().equals("")){
				retorno = retorno + " - " + this.cepFormatado;
			}

		}else{
			if(this.cepTipoLogradouro != null && !this.cepLogradouro.trim().equalsIgnoreCase("")){
				retorno = retorno + this.cepLogradouro + " - ";
			}
			if(this.cepLogradouro != null && !this.cepLogradouro.trim().equalsIgnoreCase("")){
				retorno = retorno + this.cepLogradouro + " - ";
			}
			if(this.cepBairro != null && !this.cepBairro.trim().equalsIgnoreCase("")){
				retorno = retorno + this.cepBairro + " - ";
			}
			if(this.cepMunicipio != null && !this.cepMunicipio.trim().equalsIgnoreCase("")){
				retorno = retorno + this.cepMunicipio + " - ";
			}
			if(this.cepSigla != null && !this.cepSigla.trim().equalsIgnoreCase("")){
	...
	public void setClienteUsuarioResponsavel(Collection clienteUsuarioResponsavel){
	...
	public void setIndicadorImovelCondominioDescricao(String indicadorImovelCondominioDescricao){
	...
	public void setIndicadorExistenciaCavaleteAguaDescricao(String indicadorExistenciaCavaleteAguaDescricao){
	...
	public void setIndicadorExistenciaCavaletePocoDescricao(String indicadorExistenciaCavaletePocoDescricao){
	...
	public String getInscricaoFormatada(){
		...
		retorno = this.idLocalidade + "." + this.codigoSetorComercial + "." + this.numeroQuadra + "." + this.numeroLote + "."
						+ this.numeroSubLote;

		return retorno;
	}

	// método que retorna a inscrição contendo quadra, Lote e sublote, requeridos pelo relatório
	// cadastro consumidores por inscrição
	public String getInscricaoSemLocalidade(){
		...
		String nLote = "";
		String nSubLote = "";
		Integer numeroLote = (int) this.numeroLote;
		Integer numeroSubLote = (int) this.numeroSubLote;

		// padronização do número da quadra com 3 dígitos
		if(this.numeroQuadra.compareTo(10) == -1){
			nQuadra = "00" + this.numeroQuadra;
		}else if(this.numeroQuadra.compareTo(100) == -1){
			nQuadra = "0" + this.numeroQuadra;
		}else{
			nQuadra = this.numeroQuadra.toString();
		}

		// padronização do número do Lote com 4 dígitos
		if(numeroLote.compareTo(10) == -1){
			nLote = "000" + numeroLote;
		}else if(numeroLote.compareTo(100) == -1){
			nLote = "00" + numeroLote;
		}else if(numeroLote.compareTo(1000) == -1){
			nLote = "0" + numeroLote;
		}else{
			nLote = numeroLote.toString();
		}

		// padronização do número do SubLote com 3 dígitos

		if(numeroSubLote.compareTo(10) == -1){
			nSubLote = "00" + numeroSubLote;
		}else if(numeroSubLote.compareTo(100) == -1){
			nSubLote = "0" + numeroSubLote;
		}else{
			nSubLote = numeroSubLote.toString();
		}

		retorno = nQuadra + "." + nLote + "." + nSubLote;
		return retorno;
	}
	...
	public void setVolumeReservatorioInferiorMaiorFaixa(BigDecimal volumeReservatorioInferiorMaiorFaixa){
	...
	public void setVolumeReservatorioInferiorMenorFaixa(BigDecimal volumeReservatorioInferiorMenorFaixa){
	...
	public void setVolumeReservatorioSuperiorMaiorFaixa(BigDecimal volumeReservatorioSuperiorMaiorFaixa){
	...
	public void setVolumeReservatorioSuperiorMenorFaixa(BigDecimal volumeReservatorioSuperiorMenorFaixa){
	 ...
	 *            O numeroSequencialRota a ser setado.
	 */
	...
	public void setIndicadorExistenciaHidrometro(Integer indicadorExistenciaHidrometro){
