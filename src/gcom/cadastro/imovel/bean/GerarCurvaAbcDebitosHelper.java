...
public class GerarCurvaAbcDebitosHelper {
	...
	public GerarCurvaAbcDebitosHelper(BigDecimal faixaInicial, BigDecimal faixaFinal, Integer idFaixa, Integer quantidadeLigacoes,
										BigDecimal valor, Integer idGerenciaRegional, String nomeGerenciaRegional, Integer idLocalidade,
										String nomeLocalidade, Integer idSetorComercial, Integer codigoSetorComercial,
	...
	public GerarCurvaAbcDebitosHelper(Integer idFaixa, BigDecimal faixaInicial, BigDecimal faixaFinal) {
	...
	public boolean equals(Object obj){
		...
		if(!(obj instanceof GerarCurvaAbcDebitosHelper)){
			...
			return propriedadesIguais(this.idFaixa, resumoTemp.idFaixa);// &&
