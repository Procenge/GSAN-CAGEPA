 ...
 * @author Sávio Luiz
 */
public class FiltroImovelSubCategoria
				extends Filtro
	...
	public final static String GRUPO_FATURAMENTO = "comp_id.imovel.rota.faturamentoGrupo.id";

	public final static String EMPRESA_LEITURA = "comp_id.imovel.rota.empresa.id";
	...
	public final static String IMOVEL_EMPRESA = "comp_id.imovel.rota.empresa.id";
