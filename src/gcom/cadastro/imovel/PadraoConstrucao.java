...
public class PadraoConstrucao
	 ...
	 *            Descrição do parâmetro
	 */
	public PadraoConstrucao(String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroPadraoConstrucao.ID, this.getId()));
		return filtro;
	}
