...
public class CadastroOcorrencia
	...
	/** full constructor */
	public CadastroOcorrencia(String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	public Filtro retornaFiltro(){
		...
		filtroCadastroOcorrencia.adicionarParametro(new ParametroSimples(FiltroCadastroOcorrencia.ID, this.getId()));
		return filtroCadastroOcorrencia;
	}
