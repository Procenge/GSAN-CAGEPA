 ...
 */
public class FiltroRendaFamiliarFaixa
				extends Filtro {
	 ...
	 */
	public FiltroRendaFamiliarFaixa() {

	}

	/**
	 * Construtor da classe FiltroRendaFamiliar
	 * 
	 * @param campoOrderBy
	 *            Descrição do parâmetro
	 */
	public FiltroRendaFamiliarFaixa(String campoOrderBy) {
