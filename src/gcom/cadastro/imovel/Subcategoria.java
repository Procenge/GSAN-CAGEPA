...
public class Subcategoria
	...
	public static final int ATRIBUTOS_SUBCATEGORIA_INSERIR = 32;

	public static final int ATRIBUTOS_SUBCATEGORIA_ATUALIZAR = 33;

	public static final int ATRIBUTOS_SUBCATEGORIA_REMOVER = 34;

	/**
	 * Description of the Field
	 */
	public static Integer RESIDENCIAL = Integer.valueOf(10);
	...
	@ControleAlteracao(funcionalidade = {ATRIBUTOS_SUBCATEGORIA_ATUALIZAR, ATRIBUTOS_SUBCATEGORIA_REMOVER, ATRIBUTOS_SUBCATEGORIA_INSERIR})
	private int codigo;
	...
	@ControleAlteracao(value = FiltroSubCategoria.CATEGORIA, funcionalidade = {ATRIBUTOS_SUBCATEGORIA_ATUALIZAR, ATRIBUTOS_SUBCATEGORIA_REMOVER, ATRIBUTOS_SUBCATEGORIA_INSERIR})
	...
	static{
		...
		SUBCATEGORIA_ZERO.setId(Integer.valueOf(0));
	}
	 ...
	 *            Descrição do parâmetro
	 */
	public Subcategoria(int codigo, String descricao, Short indicadorUso, Date ultimaAlteracao, gcom.cadastro.imovel.Categoria categoria) {
	 ...
	 *            Descrição do parâmetro
	 */
	public Subcategoria(int codigo, String descricao, gcom.cadastro.imovel.Categoria categoria) {
	...
	public int hashCode(){
		...
		return new HashCodeBuilder().append(getId()).append(getCodigo()).append(getDescricao()).append(getIndicadorUso()).append(
						getCategoria()).append(getUltimaAlteracao()).toHashCode();
	}
	...
	/**
	 * @param codigoTarifaSocial
	 *            O codigoTarifaSocial a ser setado.
	 */
	...
	/**
	 * @param numeroFatorFiscalizacao
	 *            O numeroFatorFiscalizacao a ser setado.
	 */
	...
	/**
	 * @param indicadorTarifaConsumo
	 *            O indicadorTarifaConsumo a ser setado.
	 */
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"codigo", "descricao"};
		return atributos;
	}

	public String[] retornarLabelsInformacoesOperacaoEfetuada(){

		String[] labels = {"codigo", "descricao"};
		return labels;
	}
	...
	public Filtro retornaFiltro(){
		...
		filtroSubCategoria.adicionarParametro(new ParametroSimples(FiltroSubCategoria.ID, this.getId()));
