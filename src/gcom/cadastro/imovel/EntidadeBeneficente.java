...
public class EntidadeBeneficente
	...
	public String getIndicadorUsoDesc(){

		return (indicadorUso == 1 ? "ATIVO" : "INATIVO");
	}

	public void setIndicadorUsoDesc(String indicadorUsoDesc){

		IndicadorUsoDesc = indicadorUsoDesc;
	}
