...
@ControleAlteracao()
public class ImovelEnderecoAnterior
	...
	/** full constructor */
	public ImovelEnderecoAnterior(String enderecoAnterior, Date ultimaAlteracao, gcom.cadastro.imovel.Imovel imovel) {
	...
	public Filtro retornaFiltro(){
		...
		filtroImovelEnderecoAnterior.adicionarParametro(new ParametroSimples(FiltroImovelEnderecoAnterior.ID, this.getId()));
		filtroImovelEnderecoAnterior.adicionarCaminhoParaCarregamentoEntidade(FiltroImovelEnderecoAnterior.IMOVEL);

		return filtroImovelEnderecoAnterior;
	}
