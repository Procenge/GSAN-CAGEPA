 ...
 */
@ControleAlteracao()
public class ReservatorioVolumeFaixa
				extends TabelaAuxiliarFaixaReal
	...
	public Filtro retornaFiltro(){
		...
		FiltroReservatorioVolumeFaixa filtroReservatorioVolumeFaix = new FiltroReservatorioVolumeFaixa();
		filtroReservatorioVolumeFaix.adicionarParametro(new ParametroSimples(FiltroReservatorioVolumeFaixa.ID, this.getId()));
		return filtroReservatorioVolumeFaix;
	}
