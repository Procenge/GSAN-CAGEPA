 ...
 */
@ControleAlteracao()
public class RendaFamiliarFaixa
				extends TabelaAuxiliarFaixaInteiro
	...
	public String getFaixaCompleta(){
		...
		faixaCompleta = "R$ " + this.getMenorFaixa() + " a R$ " + +this.getMaiorFaixa();
    ...
    *//**
	...
	public String getFaixaCompletaComId(){
		...
		if(this.getId().compareTo(10) == -1){
			faixaCompletaComId = "0" + getId() + " - R$ " + this.getMenorFaixa() + " a R$ " + this.getMaiorFaixa();
		}else{
			faixaCompletaComId = getId() + " - R$ " + this.getMenorFaixa() + " a R$ " + this.getMaiorFaixa();
		}
    ...
    *//**
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"faixaCompleta"};
		return atributos;
	}

	public String[] retornarLabelsInformacoesOperacaoEfetuada(){

		String[] labels = {"Faixa Completa"};
		return labels;
	}
	...
	public Filtro retornaFiltro(){
		...
		filtroRendaFamiliarFaixa.adicionarParametro(new ParametroSimples(FiltroRendaFamiliarFaixa.CODIGO, this.getId()));
		return filtroRendaFamiliarFaixa;
	}
