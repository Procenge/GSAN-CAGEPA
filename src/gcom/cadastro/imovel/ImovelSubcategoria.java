 ...
 */
@ControleAlteracao()
public class ImovelSubcategoria
				extends ObjetoTransacao {

	private static final long serialVersionUID = 1L;

	public static final int ATRIBUTOS_IMOVEL_SUBCATEGORIA_ATUALIZAR = 55371;

	public static final int ATRIBUTOS_IMOVEL_SUBCATEGORIA_REMOVER = 55889;

	public static final int ATRIBUTOS_IMOVEL_SUBCATEGORIA_INSERIR = 56407;
	 ...
	 * persistent field
	 */
	@ControleAlteracao(funcionalidade = {ATRIBUTOS_IMOVEL_SUBCATEGORIA_ATUALIZAR, ATRIBUTOS_IMOVEL_SUBCATEGORIA_REMOVER, ATRIBUTOS_IMOVEL_SUBCATEGORIA_INSERIR})
	 ...
	 *            Description of the Parameter
	 */
	public ImovelSubcategoria(gcom.cadastro.imovel.ImovelSubcategoriaPK comp_id, short quantidadeEconomias, Date ultimaAlteracao) {
	 ...
	 *            Description of the Parameter
	 */
	public ImovelSubcategoria(gcom.cadastro.imovel.ImovelSubcategoriaPK comp_id, short quantidadeEconomias) {
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"quantidadeEconomias"};
		return atributos;
	}

	public String[] retornarLabelsInformacoesOperacaoEfetuada(){

		String[] labels = {"Quantidade de Economias"};
		return labels;
	}
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarCaminhoParaCarregamentoEntidade(FiltroImovelSubCategoria.CATEGORIA);
		filtro.adicionarParametro(new ParametroSimples(FiltroImovelSubCategoria.IMOVEL_ID, this.getComp_id().getImovel().getId()));
		filtro.adicionarParametro(new ParametroSimples(FiltroImovelSubCategoria.SUBCATEGORIA_ID, this.getComp_id().getSubcategoria()
						.getId()));
		return filtro;
	}
	...
	public String getDescricaoParaRegistroTransacao(){
		...
		if(this.getComp_id().getSubcategoria() != null){
