 ...
 */
@ControleAlteracao()
public class AreaConstruidaFaixa
	...
	public Filtro retornaFiltro(){
		...
		filtroAreaConstruidaFaixa.adicionarParametro(new ParametroSimples(FiltroAreaConstruidaFaixa.CODIGO, this.getId()));
		return filtroAreaConstruidaFaixa;
	}
