...
public class ImovelEconomia
	...
	@ControleAlteracao(value = FiltroImovelEconomia.AREA_CONSTRUIDA_FAIXA, funcionalidade = {Imovel.ATRIBUTOS_IMOVEL_INSERIR, Imovel.ATRIBUTOS_IMOVEL_ATUALIZAR, Imovel.ATRIBUTOS_IMOVEL_REMOVER})
	private gcom.cadastro.imovel.AreaConstruidaFaixa areaConstruidaFaixa;

	@ControleAlteracao(value = FiltroImovelEconomia.IMOVEL_SUB_CATEGORIA, funcionalidade = {Imovel.ATRIBUTOS_IMOVEL_INSERIR, Imovel.ATRIBUTOS_IMOVEL_ATUALIZAR, Imovel.ATRIBUTOS_IMOVEL_REMOVER})
	...
	/** full constructor */
	public ImovelEconomia(String complementoEndereco, Short numeroMorador, Short numeroPontosUtilizacao, BigDecimal numeroIptu,
							...
							gcom.cadastro.imovel.ImovelSubcategoria imovelSubcategoria, Set tarifaSocialDadoEconomias,
	...
	/** minimal constructor */
	public ImovelEconomia(gcom.cadastro.imovel.AreaConstruidaFaixa areaConstruidaFaixa,
							gcom.cadastro.imovel.ImovelSubcategoria imovelSubcategoria, Set tarifaSocialDadoEconomias,
							Set clienteImovelEconomias) {
	...
	public int hashCode(){
		...
		return new HashCodeBuilder().append(getId()).append(getComplementoEndereco()).append(getNumeroMorador()).append(
						getNumeroPontosUtilizacao()).append(getNumeroIptu()).append(getNumeroCelpe()).append(getAreaConstruida()).append(
						getUltimaAlteracao()).append(getAreaConstruidaFaixa()).append(getImovelSubcategoria()).toHashCode();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getComplementoEndereco(), castOther.getComplementoEndereco()).append(
						this.getNumeroMorador(), castOther.getNumeroMorador()).append(this.getNumeroPontosUtilizacao(),
						castOther.getNumeroPontosUtilizacao()).append(this.getNumeroIptu(), castOther.getNumeroIptu()).append(
						this.getNumeroCelpe(), castOther.getNumeroCelpe()).append(this.getAreaConstruida(), castOther.getAreaConstruida())
						.append(this.getAreaConstruidaFaixa(), castOther.getAreaConstruidaFaixa()).append(this.getImovelSubcategoria(),
	...
	public ImovelEconomia(String complementoEndereco, Short numeroMorador, Short numeroPontosUtilizacao, BigDecimal numeroIptu,
							Long numeroCelpe, BigDecimal areaConstruida, Date ultimaAlteracao,
							gcom.cadastro.imovel.AreaConstruidaFaixa areaConstruidaFaixa,
							gcom.cadastro.imovel.ImovelSubcategoria imovelSubcategoria, Set clienteImovelEconomias) {
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroImovelEconomia.ID, this.getId()));
