...
public class PavimentoRua
	 ...
	 *//** full constructor */
	/*
	 * public PavimentoRua(String descricao, String descricaoAbreviada, Short indicadorUso, Date
	 * ultimaAlteracao) {
	 ...
	 * filtro.adicionarParametro(new ParametroSimples(FiltroPavimentoRua.ID, this.getId()));
	 * return filtro;
	 * }
	 */
