...
public class PavimentoCalcada
	 ...
	 *//** full constructor */
	/*
	 * public PavimentoCalcada(String descricao, String descricaoAbreviada, Short indicadorUso, Date
	 * ultimaAlteracao) {
	 ...
	 * filtro.adicionarParametro(new ParametroSimples(FiltroPavimentoCalcada.ID, this.getId()));
	 * return filtro;
	 * }
	 */
