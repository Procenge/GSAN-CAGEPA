 ...
 */
public interface ControladorImovelRemote
	 ...
	 *                Descrição da exceção
	 */
	public void atualizarImovel(Imovel imovel, Collection subcategorias, Collection enderecoImovel, Collection clientes)
					throws RemoteException;
	...
	/**
	 * Pesquisa todos os imóveis de determinada rota com paginação.
	 * 
