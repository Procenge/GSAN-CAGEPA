...
public class ImovelSituacao
	...
	/** full constructor */
	public ImovelSituacao(LigacaoEsgotoSituacao ligacaoEsgotoSituacao, gcom.cadastro.imovel.ImovelSituacaoTipo imovelSituacaoTipo,
	...
	public void setImovelSituacaoTipo(gcom.cadastro.imovel.ImovelSituacaoTipo imovelSituacaoTipo){
	...
	public Filtro retornaFiltro(){
		...
		filtroImovelSituacao.adicionarParametro(new ParametroSimples(FiltroImovelSituacao.ID, this.getId()));
