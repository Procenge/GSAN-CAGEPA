...
public class EntidadeBeneficenteContrato
	...
	private BigDecimal valorMinimoDoacao;
	
	private BigDecimal valorMaximoDoacao;
	...
	/** default constructor */
	public EntidadeBeneficenteContrato() {
	...
	public BigDecimal getPercentualRemuneracao(){
		...
		return this.percentualRemuneracao;
	}
	...
	public BigDecimal getValorMinimoDoacao(){

		return this.valorMinimoDoacao;
	}

	public void setValorMinimoDoacao(BigDecimal valorMinimoDoacao){

		this.valorMinimoDoacao = valorMinimoDoacao;
	}

	public BigDecimal getValorMaximoDoacao(){

		return this.valorMaximoDoacao;
	}

	public void setValorMaximoDoacao(BigDecimal valorMaximoDoacao){
	...
	public Filtro retornaFiltro(){
		...
		filtroEntidadeBeneficenteContrato.adicionarParametro(new ParametroSimples(FiltroEntidadeBeneficenteContrato.ID, this.getId()));
		filtroEntidadeBeneficenteContrato.adicionarCaminhoParaCarregamentoEntidade("entidadeBeneficente");

		return filtroEntidadeBeneficenteContrato;
	}
