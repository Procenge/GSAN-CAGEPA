...
public class ImovelSituacaoTipo
				extends ObjetoGcom {
	...
	public final static Integer ATIVO = Integer.valueOf(1);

	public final static Integer INATIVO = Integer.valueOf(2);

	public final static Integer LIGADO_SO_ESGOTO = Integer.valueOf(3);
