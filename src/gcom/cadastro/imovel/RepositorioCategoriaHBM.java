 ...
 * @version 1.0
 */
public class RepositorioCategoriaHBM
				implements IRepositorioCategoria {
	...
	public Object pesquisarObterQuantidadeCategoria() throws ErroRepositorioException{
		...
		try{
			consulta = "SELECT count(*) " + "FROM gcom.cadastro.imovel.Categoria catg ";
	...
	public Object pesquisarObterQuantidadeSubcategoria() throws ErroRepositorioException{
		...
		try{
			consulta = "SELECT count(*) " + "FROM gcom.cadastro.imovel.Subcategoria scat ";
