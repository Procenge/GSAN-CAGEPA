...
public class Esgotamento
	 ...
	 *            Descrição do parâmetro
	 */
	public Esgotamento(String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroEsgotamento.ID, this.getId()));
		return filtro;
	}
