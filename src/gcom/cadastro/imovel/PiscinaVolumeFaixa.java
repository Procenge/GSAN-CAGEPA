...
@ControleAlteracao()
public class PiscinaVolumeFaixa
	...
	public String[] retornarAtributosInformacoesOperacaoEfetuada(){
		...
		String[] atributos = {"faixaCompletaComId"};
		return atributos;
	}
	...
	public Filtro retornaFiltro(){
		...
		filtroPiscinaVolumeFaixa.adicionarParametro(new ParametroSimples(FiltroPiscinaVolumeFaixa.ID, this.getId()));
		return filtroPiscinaVolumeFaixa;
	}
