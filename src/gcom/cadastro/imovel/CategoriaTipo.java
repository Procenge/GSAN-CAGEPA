...
public class CategoriaTipo
	...
	// Constantes
	public final static Integer PARTICULAR = Integer.valueOf(1);

	public final static Integer PUBLICO = Integer.valueOf(2);
	...
	public Filtro retornaFiltro(){
		...
		filtroCategoriaTipo.adicionarParametro(new ParametroSimples(FiltroCategoriaTipo.CODIGO, this.getId()));
		return filtroCategoriaTipo;
	}
