 ...
 * @author Rodrigo
 */
public class ExibirInserirAvisoBancarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirInserirAvisoBancarioAction");
		...
		StatusWizard statusWizard = new StatusWizard("exibirInserirAvisoBancarioWizardAction", "inserirAvisoBancarioAction",
						"cancelarInserirAvisoBancarioAction", "exibirInserirAvisoBancarioAction.do");

		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "ArrecadadorA.gif", "ArrecadadorD.gif",
						"exibirProcessoUmInserirAvisoBancarioAction", "validarProcessoUmInserirAvisoBancarioAction"));

		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "AvisoBancarioA2.gif", "AvisoBancarioD2.gif",
						"exibirProcessoDoisInserirAvisoBancarioAction", "validarProcessoDoisInserirAvisoBancarioAction"));

		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(3, "ConclusaoA.gif", "ConclusaoD.gif",
						"exibirProcessoTresInserirAvisoBancarioAction", "validarProcessoTresInserirAvisoBancarioAction"));
