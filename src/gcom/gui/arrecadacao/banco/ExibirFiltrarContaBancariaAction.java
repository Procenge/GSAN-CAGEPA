 ...
 */
public class ExibirFiltrarContaBancariaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(filtrarContaBancariaActionForm.getBanco() == null || filtrarContaBancariaActionForm.getBanco().equals("")){
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				throw new ActionServletException("atencao.pesquisa.nenhum_registro_tabela", null, "Banco");
			}else{
			...
			filtroAgencia.adicionarParametro(new ParametroSimples(FiltroAgencia.BANCO_ID, filtrarContaBancariaActionForm.getBanco()));
		...
		ActionForward retorno = actionMapping.findForward("filtrarContaBancaria");
