 ...
 * @since 31/10/2006
 */
public class ExibirManterContaBancariaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroContaBancaria filtroContaBancaria = (FiltroContaBancaria) sessao.getAttribute("filtroContaBancaria");
		...
		if(filtroContaBancaria != null && !filtroContaBancaria.equals("")){
			...
			colecaoContaBancaria = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoContaBancaria != null && !colecaoContaBancaria.isEmpty()){
			...
			if(colecaoContaBancaria.size() == 1
				...
				if(sessao.getAttribute("atualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarContaBancaria");
					ContaBancaria contaBancaria = (ContaBancaria) colecaoContaBancaria.iterator().next();
					sessao.setAttribute("contaBancaria", contaBancaria);
				}else{
