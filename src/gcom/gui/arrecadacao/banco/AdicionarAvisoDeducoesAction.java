...
public class AdicionarAvisoDeducoesAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirInserirAvisoBancarioProcessoDoisParaTres");
		...
		if(Util.isNaoNuloBrancoZero(httpServletRequest.getParameter("idCampoEnviarDados"))
						&& Util.isNaoNuloBrancoZero(httpServletRequest.getParameter("descricaoCampoEnviarDados"))){
			form.setTipoDeducaoInclusao(httpServletRequest.getParameter("idCampoEnviarDados"));
			form.setValorDeducaoInclusao(httpServletRequest.getParameter("descricaoCampoEnviarDados"));
		}
		...
		if(sessao.getAttribute("collectionAvisoDeducao") != null && !sessao.getAttribute("collectionAvisoDeducao").equals("")){
			...
			if(form.getValorDeducaoInclusao() == null) throw new ActionServletException("errors.required", null, "valor dedução");
