 ...
 * @date 10/03/2006
 */
public class ExibirManterAvisoBancarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		AvisoBancarioHelper avisoBancarioHelper = (AvisoBancarioHelper) sessao.getAttribute("avisoBancarioHelper");
		int count = 0;
		if(avisoBancarioHelper != null){
			...
			if(sessao.getAttribute("totalRegistros") == null){
				...
				while(iterator.hasNext()){
					...
					avisoBancarioHelperNovo.setAvisoBancario(objetoAvisoBancario.getAvisoBancario());
					count++;
				}
				...
				// totalRegistros =
				// fachada.filtrarAvisoBancarioAbertoFechadoCount(avisoBancarioHelper,
