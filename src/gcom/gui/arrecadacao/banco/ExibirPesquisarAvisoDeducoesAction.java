...
public class ExibirPesquisarAvisoDeducoesAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirAvisoBancarioDeducoesPopup");
		...
		if(collectionDeducaoTipo != null && !collectionDeducaoTipo.isEmpty()) sessao.setAttribute("collectionDeducaoTipo",
						collectionDeducaoTipo);
		// Populando Deducao Tipo
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaArrecadador") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaArrecadador",
							httpServletRequest.getParameter("caminhoRetornoTelaPesquisaArrecadador"));
			sessao.setAttribute("montarPopUp", httpServletRequest.getParameter("montarPopUp"));
			sessao.setAttribute("action", httpServletRequest.getParameter("action"));
		}
