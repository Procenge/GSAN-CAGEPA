...
public class VerificarExistenciaContaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("pesquisarContaBancaria");
		...
		String idConta = (String) httpServletRequest.getParameter("idContaBancaria");

		// fachada.verificarExistenciaContaParaAvisoBancario(idArrecadador, idConta);

		String idBanco = (String) httpServletRequest.getParameter("idBanco");
		String codigoAgencia = (String) httpServletRequest.getParameter("codigoAgencia");
		String numeroConta = (String) httpServletRequest.getParameter("numeroConta");
