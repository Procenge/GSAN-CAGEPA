 ...
 * @date 07/02/2007
 */
public class ExibirInserirContaBancariaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("inserirContaBancaria");
		...
		if(inserirContaBancariaActionForm.getBanco() == null || inserirContaBancariaActionForm.getBanco().equals("")){
			...
			filtroAgencia.adicionarParametro(new ParametroSimples(FiltroAgencia.BANCO_ID, inserirContaBancariaActionForm.getBanco()));
