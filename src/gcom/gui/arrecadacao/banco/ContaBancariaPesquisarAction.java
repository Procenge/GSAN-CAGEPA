...
public class ContaBancariaPesquisarAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirContaBancariaPesquisar");
		...
		Collection<Banco> collectionBanco = fachada.pesquisar(filtroBanco, Banco.class.getName());
		...
		if(idBanco != null && !idBanco.trim().equals("")){
			...
			Collection<Agencia> collectionAgencia = fachada.pesquisar(filtroAgencia, Agencia.class.getName());
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaContaBancaria") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaContaBancaria", httpServletRequest
