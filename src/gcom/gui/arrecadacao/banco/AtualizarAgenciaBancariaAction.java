...
public class AtualizarAgenciaBancariaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		agencia.setCodigoAgencia(atualizarAgenciaBancariaActionForm.getCodigo());
		...
		agencia.setNumeroTelefone(atualizarAgenciaBancariaActionForm.getTelefone());
		...
		String codigo = atualizarAgenciaBancariaActionForm.getCodigo();

		String nome = atualizarAgenciaBancariaActionForm.getNome();
		...
		if(atualizarAgenciaBancariaActionForm.getBancoID() != null){
			...
			Integer idBanco = new Integer(atualizarAgenciaBancariaActionForm.getBancoID());
			...
			if(idBanco.equals(ConstantesSistema.NUMERO_NAO_INFORMADO)){
				...
				filtroBanco.adicionarParametro(new ParametroSimples(FiltroBanco.ID, atualizarAgenciaBancariaActionForm.getBancoID()
								.toString()));
		...
		montarPaginaSucesso(httpServletRequest, "Agência Bancária de código " + agencia.getCodigoAgencia().toString()
						+ " atualizado com sucesso.", "Realizar outra Manutenção de Agência Bancaria",
