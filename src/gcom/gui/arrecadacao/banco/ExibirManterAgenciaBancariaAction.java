 ...
 * @since 31/10/2006
 */
public class ExibirManterAgenciaBancariaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroAgencia filtroAgencia = (FiltroAgencia) sessao.getAttribute("filtroAgencia");
		...
		if(filtroAgencia != null && !filtroAgencia.equals("")){
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroAgencia, Agencia.class.getName());
		...
		if(colecaoAgencia != null && !colecaoAgencia.isEmpty()){
			...
			if(colecaoAgencia.size() == 1
				...
				if(sessao.getAttribute("atualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarAgenciaBancaria");
