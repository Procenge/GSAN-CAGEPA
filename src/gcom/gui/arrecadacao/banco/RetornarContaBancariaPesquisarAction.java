...
public class RetornarContaBancariaPesquisarAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("retornarContaBancariaPesquisar");
		...
		if(idAgencia != null && !idAgencia.equals("") && (new Integer(idAgencia).intValue() != ConstantesSistema.NUMERO_NAO_INFORMADO)){
		...
		// Alterado para retornar a coleção com o controle novo de paginação - Fernanda Paiva -
		// 10/08/2006
		// Collection<ContaBancaria> collectionContaBancaria =fachada.pesquisar(filtroContaBancaria,
		// ContaBancaria.class.getName());

		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroContaBancaria, ContaBancaria.class.getName());
		...
		if(collectionContaBancaria == null || collectionContaBancaria.isEmpty()){
			...
			throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, "conta bancaria");
