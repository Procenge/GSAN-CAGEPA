 ...
 * @author Rodrigo
 */
public class ValidarProcessoTresInserirAvisoBancarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(dataRealizacao.getTime() > atual.getTime()){
			throw new ActionServletException("atencao.data.realizacao.posterior", null, Util.formatarData(atual));
		}
		if(dataLancamento.getTime() > dataRealizacao.getTime()){
			throw new ActionServletException("atencao.avisoBancario.data_realizacao_menor_que_data_lancamento", Util
							.formatarData(dataRealizacao), Util.formatarData(dataLancamento));
		}
