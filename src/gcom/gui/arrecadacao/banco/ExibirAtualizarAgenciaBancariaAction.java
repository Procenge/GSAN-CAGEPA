 ...
 * @date 30/10/2006
 */
public class ExibirAtualizarAgenciaBancariaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("agenciaAtualizar") == null){
			...
			if(sessao.getAttribute("agencia") != null){
				...
				if(idAgencia != null){
					...
					Collection<Agencia> colecaoAgencia = fachada.pesquisar(filtroAgencia, Agencia.class.getName());
		...
		httpServletRequest.setAttribute("colecaoAgenciaTela", sessao.getAttribute("colecaoAgenciaTipoValorTela"));
