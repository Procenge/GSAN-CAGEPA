 ...
 * @date 10/03/2006
 */
public class ExibirPesquisarAvisoAcertoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest request,
		 ...
		 * if (Util.converteStringParaDate(dataRealizacaoAcerto).getTime() > new
		 * Date(System.currentTimeMillis()).getTime()) {
		 * throw new
		 * ActionServletException("atencao.avisoBancario.data_realizacao_acerto_menor_que_hoje"
		 * ,null,Util.formatarData(new Date(System.currentTimeMillis())));
		 * }else{
