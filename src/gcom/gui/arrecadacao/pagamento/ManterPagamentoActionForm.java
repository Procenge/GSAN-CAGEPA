 ...
 * @date 21/03/2006
 */
public class ManterPagamentoActionForm
	...
	private String gerarDevolucaoValores;

	private String idCreditoTipo;

	private boolean habilitarGerarDevolucoesValores;

	private PagamentoSituacao situacaoPagamentoOriginal;

	private String habilitaBotaoAutenticarPagamento;
	...
	public String getGerarDevolucaoValores(){

		return gerarDevolucaoValores;
	}

	public void setGerarDevolucaoValores(String gerarDevolucaoValores){

		this.gerarDevolucaoValores = gerarDevolucaoValores;
	}
	...
	public boolean isHabilitarGerarDevolucoesValores(){

		return habilitarGerarDevolucoesValores;
	}

	public void setHabilitarGerarDevolucoesValores(boolean habilitarGerarDevolucoesValores){

		this.habilitarGerarDevolucoesValores = habilitarGerarDevolucoesValores;
	}

	public PagamentoSituacao getSituacaoPagamentoOriginal(){

		return situacaoPagamentoOriginal;
	}

	public void setSituacaoPagamentoOriginal(PagamentoSituacao situacaoPagamentoOriginal){

		this.situacaoPagamentoOriginal = situacaoPagamentoOriginal;
	}

	/**
	 * @return the habilitaBotaoAutenticarPagamento
	 */
	public String getHabilitaBotaoAutenticarPagamento(){

		return habilitaBotaoAutenticarPagamento;
	}

	/**
	 * @param habilitaBotaoAutenticarPagamento
	 *            the habilitaBotaoAutenticarPagamento to set
	 */
	public void setHabilitaBotaoAutenticarPagamento(String habilitaBotaoAutenticarPagamento){

		this.habilitaBotaoAutenticarPagamento = habilitaBotaoAutenticarPagamento;
	}
