 ...
 * @created 16/02/2006
 */
public class ExibirInserirPagamentosAvisoBancarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		this.recuperaAvisoBancarioPopup(actionForm, httpServletRequest, fachada, usuarioLogado);
	 ...
	 */
	private void recuperaAvisoBancarioPopup(ActionForm actionForm, HttpServletRequest httpServletRequest, Fachada fachada,
					Usuario usuarioLogado) throws NumberFormatException, ActionServletException{

		// Recupera o form
		DynaValidatorActionForm pagamentoActionForm = (DynaValidatorActionForm) actionForm;

		if(Util.isNaoNuloBrancoZero(httpServletRequest.getParameter("descricaoCampoEnviarDados"))){
			Integer idAvisoBancario = Integer.valueOf(httpServletRequest.getParameter("descricaoCampoEnviarDados"));
			...
			if(!Util.isVazioOrNulo(colecaoAvisoBancario)){
				...
				if(Util.isNaoNuloBrancoZero(avisoBancario.getNumeroSequencial())){
				...
				pagamentoActionForm.set("idAvisoBancario", avisoBancario.getId().toString());
