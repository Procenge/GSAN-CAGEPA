 ...
 * @date 04/01/2007
 */
public class InformarExpurgoPagamentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaoExpurgado = (Collection) sessao.getAttribute("colecaoExpurgado");
		Collection colecaoNaoExpurgado = (Collection) sessao.getAttribute("colecaoNaoExpurgado");
		...
		if(colecaoExpurgado != null && !colecaoExpurgado.isEmpty()){
			...
			while(iteExpurgado.hasNext()){
				...
				pagamento.setIndicadorExpurgado(new Short(indicadorExpurgadoID));
		...
		montarPaginaSucesso(httpServletRequest, "Situação de Expurgado do pagamento atualizado com sucesso.",
						"Informar outra Situação de Expurgado do Pagamento", "exibirInformarExpurgoPagamentoAction.do?limpar=sim");
