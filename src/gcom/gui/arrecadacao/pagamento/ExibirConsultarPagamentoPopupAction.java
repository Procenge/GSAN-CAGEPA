 ...
 * @created 10/07/2007
 */
public class ExibirConsultarPagamentoPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ConsultarPagamentoPopupActionForm consultarPagamentoPopupActionForm = (ConsultarPagamentoPopupActionForm) actionForm;
		...
		if(idPagamento != null){
			...
			if(colecaoPagamentos != null && !colecaoPagamentos.isEmpty()){
				...
				if(pagamento.getAvisoBancario().getArrecadador().getCliente() != null){
					...
					consultarPagamentoPopupActionForm.setNomeClienteArrecadador(pagamento.getAvisoBancario().getArrecadador().getCliente()
									.getNome());
				}
			...
			filtroPagamentoHistorico
							.adicionarParametro(new ParametroSimples(FiltroPagamentoHistorico.ID, new Integer(idPagamentoHistorico)));
			...
			if(colecaoPagamentos != null && !colecaoPagamentos.isEmpty()){
				...
				if(pagamentoHistorico.getAvisoBancario() != null){
					...
					if(pagamentoHistorico.getAvisoBancario().getArrecadador().getCliente() != null){
						...
						consultarPagamentoPopupActionForm.setNomeClienteArrecadador(pagamentoHistorico.getAvisoBancario().getArrecadador()
										.getCliente().getNome());
					}
				}
