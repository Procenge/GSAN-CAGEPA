...
public class ExibirManterPagamentoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// } else {
		// // Caso o exibirManterPagamento não tenha passado por algum esquema de
		...
		// }
		//
		// // A pesquisa de pagamentos só será feita se o forward estiver direcionado
		// // para a página de manterPagamento
