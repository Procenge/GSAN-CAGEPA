 ...
 * @date 10/05/2006
 */
public class ConsultarPagamentoActionForm
	...
	private String codigoArrecadadorAuxiliar;

	private String nomeArrecadadorAuxiliar;
	...
	/**
	 * @param numeroRegistrosMovimento
	 *            O numeroRegistrosMovimento a ser setado.
	 */
	 ...
	 *            O valorTotalMovimento a ser setado.
	 */
	 ...
	 *            O dataProcessamento a ser setado.
	 */
	...
	/**
	 * @param horaProcessamento
	 *            O horaProcessamento a ser setado.
	 */
	...
	public String getCodigoArrecadadorAuxiliar(){

		return codigoArrecadadorAuxiliar;
	}

	public void setCodigoArrecadadorAuxiliar(String codigoArrecadadorAuxiliar){

		this.codigoArrecadadorAuxiliar = codigoArrecadadorAuxiliar;
	}

	public String getNomeArrecadadorAuxiliar(){

		return nomeArrecadadorAuxiliar;
	}

	public void setNomeArrecadadorAuxiliar(String nomeArrecadadorAuxiliar){

		this.nomeArrecadadorAuxiliar = nomeArrecadadorAuxiliar;
	}

	public String getIndicadorTotalizarPorDataPagamento(){

		return indicadorTotalizarPorDataPagamento;
	}

	public void setIndicadorTotalizarPorDataPagamento(String indicadorTotalizarPorDataPagamento){

		this.indicadorTotalizarPorDataPagamento = indicadorTotalizarPorDataPagamento;
	}
