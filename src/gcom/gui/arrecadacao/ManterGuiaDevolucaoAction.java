...
public class ManterGuiaDevolucaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String[] idsRegistrosRemocao = manterGuiaDevolucaoActionForm.getIdRegistrosRemocao();
		...
		montarPaginaSucesso(httpServletRequest, idsRegistrosRemocao.length + " Guia(s) de Devolução removida(s) com sucesso.",
						"Realizar outra Manutenção de Guia de Devolução", "exibirFiltrarGuiaDevolucaoAction.do?menu=sim");
