 ...
 * @date 09/05/2006
 */
public class AtualizarGuiaDevolucaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idGuiaDevolucao = atualizarGuiaDevolucaoActionForm.getIdGuiaDevolucao();
		...
		String tipoDocumento = atualizarGuiaDevolucaoActionForm.getDocumentoTipoHidden();
		...
		String dataValidade = atualizarGuiaDevolucaoActionForm.getDataValidade();
		String valorDevolucao = atualizarGuiaDevolucaoActionForm.getValorDevolucao();

		GuiaDevolucao guiaDevolucao = (GuiaDevolucao) sessao.getAttribute("guiaDevolucaoAtualizar");
		...
		if(dataValidade != null && !dataValidade.trim().equals("")){
			guiaDevolucao.setDataValidade(Util.converteStringParaDate(dataValidade));
		}else{
			throw new ActionServletException("atencao.Informe_entidade", null, "Data de Validade");
		}
		...
		montarPaginaSucesso(httpServletRequest, "Guia de Devolução " + guiaDevolucao.getId().toString() + " atualizada com sucesso.",
						"Realizar outra Manutenção de Guia de Devololução", "exibirFiltrarGuiaDevolucaoAction.do?menu=sim");
