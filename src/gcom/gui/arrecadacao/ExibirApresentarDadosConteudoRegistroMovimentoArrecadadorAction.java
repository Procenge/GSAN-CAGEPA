...
/**
 * Esta classe tem por finalidade exibir para o usuário os dados do conteúdo do registro de
 * movimento do
 * arrecadador
 * 
 ...
 * @date 21/03/2006
 */
public class ExibirApresentarDadosConteudoRegistroMovimentoArrecadadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		DadosConteudoRegistroMovimentoArrecadadorHelper dadosConteudoRegistroMovimentoArrecadadorHelper = null;
		try{

			dadosConteudoRegistroMovimentoArrecadadorHelper = fachada
		...
		/*
		 * Caso o código do registro corresponda a "F" ou "G", dentro do popup correspondente o
		 * sistema
		 * habilita o botão "Consultar Pagamentos".
		 */
		if(dadosConteudoRegistroMovimentoArrecadadorHelper.getCodigoRegistro() != null
						&& (dadosConteudoRegistroMovimentoArrecadadorHelper.getCodigoRegistro().equals(RegistroCodigo.CODIGO_F) || dadosConteudoRegistroMovimentoArrecadadorHelper
										.getCodigoRegistro().equals(RegistroCodigo.CODIGO_G))){

			httpServletRequest.setAttribute("consultarPagamentos", "OK");
		}

		httpServletRequest.setAttribute("dadosConteudoRegistroMovimentoArrecadadorHelper", dadosConteudoRegistroMovimentoArrecadadorHelper);
