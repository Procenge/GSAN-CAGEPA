...
public class FiltrarArrecadadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Short indicadorCaixaEmpresa = filtrarArrecadadorActionForm.getIndicadorCaixaEmpresa();
		...
		Collection<Arrecadador> colecaoArrecadador = (Collection) resultado.get("colecaoRetorno");
