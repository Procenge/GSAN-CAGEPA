 ...
 * @date 13/03/2007
 */
public class ExibirFiltrarContratoArrecadadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Colecao a ser usada por todas as colecoes de combos da tela, afim de reutilizar variável.
		...
		// [SB0001] - Atualizar Contrato de Arrecadador
		// item 1.2
		try{
			...
			if(!ConstantesSistema.NUMERO_NAO_INFORMADO_STRING.equals(indicadorConcessionaria)){
				...
				if(Util.isNaoNuloBrancoZero(colecaoConcessionaria)){
