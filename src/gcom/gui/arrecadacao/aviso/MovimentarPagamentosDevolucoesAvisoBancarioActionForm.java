 ...
 * @date 07/06/2007
 */
public class MovimentarPagamentosDevolucoesAvisoBancarioActionForm
	...
	/**
	 * @param arrecadacaoCalculadoAntesDestino
	 *            O arrecadacaoCalculadoAntesDestino a ser setado.
	 */
	public void setArrecadacaoCalculadoAntesDestino(String arrecadacaoCalculadoAntesDestino){
	...
	/**
	 * @param arrecadacaoCalculadoAntesOrigem
	 *            O arrecadacaoCalculadoAntesOrigem a ser setado.
	 */
	public void setArrecadacaoCalculadoAntesOrigem(String arrecadacaoCalculadoAntesOrigem){
	...
	/**
	 * @param arrecadacaoCalculadoDepoisDestino
	 *            O arrecadacaoCalculadoDepoisDestino a ser setado.
	 */
	public void setArrecadacaoCalculadoDepoisDestino(String arrecadacaoCalculadoDepoisDestino){
	...
	/**
	 * @param arrecadacaoCalculadoDepoisOrigem
	 *            O arrecadacaoCalculadoDepoisOrigem a ser setado.
	 */
	public void setArrecadacaoCalculadoDepoisOrigem(String arrecadacaoCalculadoDepoisOrigem){
	...
	/**
	 * @param arrecadacaoInformadoAntesDestino
	 *            O arrecadacaoInformadoAntesDestino a ser setado.
	 */
	public void setArrecadacaoInformadoAntesDestino(String arrecadacaoInformadoAntesDestino){
	...
	/**
	 * @param arrecadacaoInformadoAntesOrigem
	 *            O arrecadacaoInformadoAntesOrigem a ser setado.
	 */
	public void setArrecadacaoInformadoAntesOrigem(String arrecadacaoInformadoAntesOrigem){
	...
	/**
	 * @param arrecadacaoInformadoDepoisDestino
	 *            O arrecadacaoInformadoDepoisDestino a ser setado.
	 */
	public void setArrecadacaoInformadoDepoisDestino(String arrecadacaoInformadoDepoisDestino){
	...
	/**
	 * @param arrecadacaoInformadoDepoisOrigem
	 *            O arrecadacaoInformadoDepoisOrigem a ser setado.
	 */
	public void setArrecadacaoInformadoDepoisOrigem(String arrecadacaoInformadoDepoisOrigem){
	...
	/**
	 * @param devolucaoCalculadoAntesDestino
	 *            O devolucaoCalculadoAntesDestino a ser setado.
	 */
	public void setDevolucaoCalculadoAntesDestino(String devolucaoCalculadoAntesDestino){
	...
	/**
	 * @param devolucaoCalculadoAntesOrigem
	 *            O devolucaoCalculadoAntesOrigem a ser setado.
	 */
	public void setDevolucaoCalculadoAntesOrigem(String devolucaoCalculadoAntesOrigem){
	...
	/**
	 * @param devolucaoCalculadoDepoisDestino
	 *            O devolucaoCalculadoDepoisDestino a ser setado.
	 */
	public void setDevolucaoCalculadoDepoisDestino(String devolucaoCalculadoDepoisDestino){
	...
	/**
	 * @param devolucaoCalculadoDepoisOrigem
	 *            O devolucaoCalculadoDepoisOrigem a ser setado.
	 */
	public void setDevolucaoCalculadoDepoisOrigem(String devolucaoCalculadoDepoisOrigem){
	...
	/**
	 * @param devolucaoInformadoAntesDestino
	 *            O devolucaoInformadoAntesDestino a ser setado.
	 */
	public void setDevolucaoInformadoAntesDestino(String devolucaoInformadoAntesDestino){
	...
	/**
	 * @param devolucaoInformadoAntesOrigem
	 *            O devolucaoInformadoAntesOrigem a ser setado.
	 */
	public void setDevolucaoInformadoAntesOrigem(String devolucaoInformadoAntesOrigem){
	...
	/**
	 * @param devolucaoInformadoDepoisDestino
	 *            O devolucaoInformadoDepoisDestino a ser setado.
	 */
	public void setDevolucaoInformadoDepoisDestino(String devolucaoInformadoDepoisDestino){
	...
	/**
	 * @param devolucaoInformadoDepoisOrigem
	 *            O devolucaoInformadoDepoisOrigem a ser setado.
	 */
	public void setDevolucaoInformadoDepoisOrigem(String devolucaoInformadoDepoisOrigem){
	...
	/**
	 * @param idRegistrosRemocaoDevolucao
	 *            O idRegistrosRemocaoDevolucao a ser setado.
	 */
	...
	/**
	 * @param idRegistrosRemocaoPagamento
	 *            O idRegistrosRemocaoPagamento a ser setado.
	 */
