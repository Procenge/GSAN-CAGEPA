...
public class MovimentarPagamentosDevolucoesAvisoBancarioAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(
						httpServletRequest,
						"Pagamentos/Devoluções foram movimentados com sucesso do Aviso Bancário "
										+ sessao.getAttribute("descricaoABOrigem") + " para o Aviso Bancário "
										+ sessao.getAttribute("descricaoABDestino"), "Realizar outra Movimentação",
