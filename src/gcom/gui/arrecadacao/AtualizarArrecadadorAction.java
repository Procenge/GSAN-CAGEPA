...
public class AtualizarArrecadadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(atualizarArrecadadorActionForm.getIdCliente() == null || atualizarArrecadadorActionForm.getIdCliente().equals("")){
		...
		montarPaginaSucesso(httpServletRequest, "Agente Arrecadador de código " + atualizarArrecadadorActionForm.getIdAgente()
						+ " atualizado com sucesso.", "Realizar outra Manutenção de Arrecadador",
