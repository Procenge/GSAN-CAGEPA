 ...
 **/
public class ExibirConsultarDadosDiariosArrecadadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirConsultarDadosDiariosArrecadador");
		...
		if(sessao.getAttribute("dadosArrecadacaoArrecadador") == null){
			Collection colecaoArrecadacaoDadosDiariosArrecadador = null;

			colecaoArrecadacaoDadosDiariosArrecadador = (Collection) sessao.getAttribute("colecaoArrecadacaoDadosDiarios");
			...
			while(iteratorColecaoArrecadacaoDadosDiariosArrecadador.hasNext()){

				contador++;

				dadosDiarios = (ArrecadacaoDadosDiarios) iteratorColecaoArrecadacaoDadosDiariosArrecadador.next();
				...
				dadosDiariosCopia.setArrecadador(dadosDiarios.getArrecadador());
				...
				if(anoMes.equals(anoMesAnterior) || primeiraVez){
					...
					if(contador == colecaoArrecadacaoDadosDiariosArrecadador.size()){
						map = new TreeMap();
			...
			sessao.setAttribute("dadosArrecadacaoArrecadador", mapPrincipal);
