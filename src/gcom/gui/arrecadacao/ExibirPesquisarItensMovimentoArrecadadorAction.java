 ...
 * @date 05/12/2006
 */
public class ExibirPesquisarItensMovimentoArrecadadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(idImovel != null && !idImovel.equals("")){
			String inscricaoImovel = fachada.pesquisarInscricaoImovel(new Integer(idImovel), true);
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null && !httpServletRequest.getParameter("tipoConsulta").equals("")){
			...
			// a pagina .jsp
			pesquisarItensMovimentoArrecadadorActionForm.setMatriculaImovel(httpServletRequest.getParameter("idCampoEnviarDados"));
			pesquisarItensMovimentoArrecadadorActionForm.setInscricaoImovel(httpServletRequest.getParameter("descricaoCampoEnviarDados"));
		}
