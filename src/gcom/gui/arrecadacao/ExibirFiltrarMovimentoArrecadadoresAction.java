 ...
 */
public class ExibirFiltrarMovimentoArrecadadoresAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(!Util.isVazioOuBranco(httpServletRequest.getParameter("idImovel"))){
			Imovel imovel = getFachada().pesquisarImovel(Util.obterInteger(httpServletRequest.getParameter("idImovel")));
			if(imovel != null){
				filtrarMovimentoArrecadadoresActionForm.setIdImovel(imovel.getId().toString());
				filtrarMovimentoArrecadadoresActionForm.setInscricaoImovel(imovel.getInscricaoFormatada());
			}else{
				filtrarMovimentoArrecadadoresActionForm.setIdImovel("");
				filtrarMovimentoArrecadadoresActionForm.setInscricaoImovel("IMÓVEL NÃO ENCONTRADO");
			}
		}

		if(filtrarMovimentoArrecadadoresActionForm.getIndicadorRelatorio() == null
						|| filtrarMovimentoArrecadadoresActionForm.getIndicadorRelatorio().equals("")){
		...
		if(filtrarMovimentoArrecadadoresActionForm.getBanco() != null && !filtrarMovimentoArrecadadoresActionForm.getBanco().equals("")){
			...
			filtroArrecadador.adicionarParametro(new ParametroSimples(FiltroArrecadador.CODIGO_AGENTE,
							filtrarMovimentoArrecadadoresActionForm.getBanco()));
		...
		httpServletRequest.setAttribute("colecaoConcessionaria", colecaoConcessionaria);
