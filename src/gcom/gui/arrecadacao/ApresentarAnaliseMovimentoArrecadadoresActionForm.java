...
/**
 * Esta classe tem por finalidade gerar o formulário que irá apresentar a análise do movimento dos
 * arrecadadores
 ...
 * @date 07/03/2006
 */
public class ApresentarAnaliseMovimentoArrecadadoresActionForm
				extends ActionForm {
	...
	private String mensagemMovimentoItensNaoAceitos;
	...
	public String getMensagemMovimentoItensNaoAceitos(){

		return mensagemMovimentoItensNaoAceitos;
	}

	public void setMensagemMovimentoItensNaoAceitos(String mensagemMovimentoItensNaoAceitos){

		this.mensagemMovimentoItensNaoAceitos = mensagemMovimentoItensNaoAceitos;
	}

	public String getIdNomeConcessionaria(){

		return idNomeConcessionaria;
	}
