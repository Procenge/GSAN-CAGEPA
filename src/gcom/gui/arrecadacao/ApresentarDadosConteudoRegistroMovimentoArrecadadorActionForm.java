...
/**
 * Esta classe tem por finalidade gerar o formulário que irá apresentar os dados do conteúdo do
 * registro
 ...
 * @date 21/03/2006
 */
public class ApresentarDadosConteudoRegistroMovimentoArrecadadorActionForm
				extends ActionForm {
	...
	public void setDigitoVerificadorContaModulo10(String digitoVerificadorContaModulo10){
	...
	public void setIdentificacaoClienteEmpresaCodigoBarras(String identificacaoClienteEmpresaCodigoBarras){
	...
	public void setIdentificacaoValorRealOUReferencia(String identificacaoValorRealOUReferencia){
	...
	public void setMesAnoReferenciaContaCodigoBarras(String mesAnoReferenciaContaCodigoBarras){
	...
	public void setSequencialFaturaClienteResponsavel(String sequencialFaturaClienteResponsavel){
