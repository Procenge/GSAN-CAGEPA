 ...
 **/
public class ExibirConsultarDadosDiariosConcessionariaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirConsultarDadosDiariosConcessionaria");
		...
		if(sessao.getAttribute("dadosArrecadacaoConcessionaria") == null){

			Collection colecaoArrecadacaoDadosDiariosConcessionaria = null;

			colecaoArrecadacaoDadosDiariosConcessionaria = (Collection) sessao.getAttribute("colecaoArrecadacaoDadosDiarios");

			Iterator iteratorColecaoArrecadacaoDadosDiariosConcessionaria = colecaoArrecadacaoDadosDiariosConcessionaria.iterator();
			...
			while(iteratorColecaoArrecadacaoDadosDiariosConcessionaria.hasNext()){
				contador++;

				dadosDiarios = (ArrecadacaoDadosDiarios) iteratorColecaoArrecadacaoDadosDiariosConcessionaria.next();
				...
				dadosDiariosCopia.setConcessionaria(dadosDiarios.getConcessionaria());
				...
				if(anoMes.equals(anoMesAnterior) || primeiraVez){
					...
					if(contador == colecaoArrecadacaoDadosDiariosConcessionaria.size()){
						map = new TreeMap();
				...
				while(iteratorValorAcumulado.hasNext()){
					...
					Collections.sort((List) colecaoDadosDiariosArrecadacao, new Comparator() {
						...
						public int compare(Object a, Object b){
							...
							String codigo1 = ((ArrecadacaoDadosDiarios) a).getConcessionaria().getNome();
							String codigo2 = ((ArrecadacaoDadosDiarios) b).getConcessionaria().getNome();
			...
			sessao.setAttribute("dadosArrecadacaoConcessionaria", mapPrincipal);
			sessao.setAttribute("valordadosArrecadacaoConcessionaria", valor);
		}
