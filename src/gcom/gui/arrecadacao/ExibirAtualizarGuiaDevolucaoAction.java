...
public class ExibirAtualizarGuiaDevolucaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirAtualizarGuiaDevolucao");
		...
		if(sessao.getAttribute("guiaDevolucaoAtualizar") == null){
			...
			if(sessao.getAttribute("guiaDevolucao") != null){
				...
				guiaDevolucao = (GuiaDevolucao) sessao.getAttribute("guiaDevolucao");
				...
				if(httpServletRequest.getParameter("guiaDevolucaoID") != null){
					...
					idGuiaDevolucao = httpServletRequest.getParameter("guiaDevolucaoID");
				}else{
					idGuiaDevolucao = (String) sessao.getAttribute("idGuiaDevolucao");
				}

				sessao.setAttribute("idGuiaDevolucao", idGuiaDevolucao);

				FiltroGuiaDevolucao filtroGuiaDevolucao = new FiltroGuiaDevolucao();
				filtroGuiaDevolucao.adicionarParametro(new ParametroSimples(FiltroGuiaDevolucao.ID, idGuiaDevolucao));
				...
				filtroGuiaDevolucao.adicionarCaminhoParaCarregamentoEntidade("contaGeral");
				filtroGuiaDevolucao.adicionarCaminhoParaCarregamentoEntidade("contaGeral.conta");
				filtroGuiaDevolucao.adicionarCaminhoParaCarregamentoEntidade("contaGeral.contaHistorico");
				filtroGuiaDevolucao.adicionarCaminhoParaCarregamentoEntidade("guiaPagamentoGeral.guiaPagamento.debitoTipo");
				...
				Collection colecaoGuiaDevolucao = fachada.pesquisar(filtroGuiaDevolucao, GuiaDevolucao.class.getName());

				if(colecaoGuiaDevolucao == null || colecaoGuiaDevolucao.isEmpty()){
					throw new ActionServletException("atencao.colecao_vazia");
				}

				guiaDevolucao = (GuiaDevolucao) colecaoGuiaDevolucao.iterator().next();
			...
			atualizarGuiaDevolucaoActionForm.setIdGuiaDevolucao(guiaDevolucao.getId().toString());
			atualizarGuiaDevolucaoActionForm.setIdRegistroAtendimento(guiaDevolucao.getRegistroAtendimento().getId().toString());
			atualizarGuiaDevolucaoActionForm.setNomeRegistroAtendimento("FUNC. IMPLEMENTADA PARCIALMENTE");

			if(guiaDevolucao.getOrdemServico() != null){
				atualizarGuiaDevolucaoActionForm.setIdOrdemServico(guiaDevolucao.getOrdemServico().getId().toString());
				atualizarGuiaDevolucaoActionForm.setNomeOrdemServico("FUNC. IMPLEMENTADA PARCIALMENTE");
				if(guiaDevolucao.getOrdemServico().getServicoTipo() != null
								&& guiaDevolucao.getOrdemServico().getServicoTipo().getDebitoTipo() != null){
			...
			atualizarGuiaDevolucaoActionForm.setDocumentoTipo(guiaDevolucao.getDocumentoTipo().getId().toString());
			atualizarGuiaDevolucaoActionForm.setDocumentoTipoHidden(guiaDevolucao.getDocumentoTipo().getId().toString());

			if(guiaDevolucao.getLocalidade() != null){
				atualizarGuiaDevolucaoActionForm.setIdLocalidade(guiaDevolucao.getLocalidade().getId().toString());
				atualizarGuiaDevolucaoActionForm.setIdLocalidadeHidden(guiaDevolucao.getLocalidade().getId().toString());
				atualizarGuiaDevolucaoActionForm.setDescricaoLocalidade(guiaDevolucao.getLocalidade().getDescricao());
			}else{
			...
			if(guiaDevolucao.getImovel() != null){
				atualizarGuiaDevolucaoActionForm.setIdImovel(guiaDevolucao.getImovel().getId().toString());
				atualizarGuiaDevolucaoActionForm.setDescricaoImovel(guiaDevolucao.getImovel().getInscricaoFormatada());
				...
				atualizarGuiaDevolucaoActionForm.setCodigoCliente(guiaDevolucao.getCliente().getId().toString());
				atualizarGuiaDevolucaoActionForm.setNomeCliente(guiaDevolucao.getCliente().getNome());
			...
			if(guiaDevolucao.getDebitoTipo() != null){
				atualizarGuiaDevolucaoActionForm.setIdTipoDebito(guiaDevolucao.getDebitoTipo().getId().toString());
				atualizarGuiaDevolucaoActionForm.setIdTipoDebitoHidden(guiaDevolucao.getDebitoTipo().getId().toString());
				atualizarGuiaDevolucaoActionForm.setDescricaoTipoDebito(guiaDevolucao.getDebitoTipo().getDescricao());
			}else{
			...
			if(guiaDevolucao.getDocumentoTipo().getId().equals(DocumentoTipo.CONTA)){
				...
				atualizarGuiaDevolucaoActionForm
								.setReferenciaConta(Util.formatarMesAnoReferencia(guiaDevolucao.getContaGeral().getConta().getReferencia()));
				atualizarGuiaDevolucaoActionForm.setDescricaoConta(guiaDevolucao.getContaGeral().getConta().getValorTotalConta());
				...
				atualizarGuiaDevolucaoActionForm.setIdGuiaPagamento(guiaDevolucao.getGuiaPagamentoGeral().getGuiaPagamento().getId()
								.toString());
				atualizarGuiaDevolucaoActionForm.setDescricaoGuiaPagamento("");// guiaDevolucao
				// .getGuiaPagamento().getDebitoTipo()
				// .getDescricao());
				atualizarGuiaDevolucaoActionForm.setValorGuiaPagamento(Util.formatarMoedaReal(guiaDevolucao.getGuiaPagamentoGeral()
								.getGuiaPagamento()
								.getValorDebito()));
				...
				atualizarGuiaDevolucaoActionForm.setIdDebitoACobrar(guiaDevolucao.getDebitoACobrarGeral().getDebitoACobrar().getId()
								.toString());
				atualizarGuiaDevolucaoActionForm.setDescricaoDebitoACobrar(guiaDevolucao.getDebitoACobrarGeral().getDebitoACobrar()
								.getDebitoTipo().getDescricao());
				atualizarGuiaDevolucaoActionForm.setValorDebitoACobrar(Util.formatarMoedaReal(guiaDevolucao.getDebitoACobrarGeral()
								.getDebitoACobrar()
								.getValorTotal()));
			...
			atualizarGuiaDevolucaoActionForm.setDataValidade(Util.formatarData(guiaDevolucao.getDataValidade()));
			atualizarGuiaDevolucaoActionForm.setValorDevolucao(Util.formatarMoedaReal(guiaDevolucao.getValorDevolucao()));
			...
			String idRegistroAtendimento = atualizarGuiaDevolucaoActionForm.getIdRegistroAtendimento();
			String idOrdemServico = atualizarGuiaDevolucaoActionForm.getIdOrdemServico();
			String idLocalidade = atualizarGuiaDevolucaoActionForm.getIdLocalidadeHidden();
			String referenciaConta = atualizarGuiaDevolucaoActionForm.getReferenciaConta();
			String idGuiaPagamento = atualizarGuiaDevolucaoActionForm.getIdGuiaPagamento();
			String idDebitoACobrar = atualizarGuiaDevolucaoActionForm.getIdDebitoACobrar();
			String idDebitoTipo = atualizarGuiaDevolucaoActionForm.getIdTipoDebitoHidden();
			String idImovel = atualizarGuiaDevolucaoActionForm.getIdImovel();
			String idCliente = atualizarGuiaDevolucaoActionForm.getCodigoCliente();
			...
			if(idRegistroAtendimento != null && !idRegistroAtendimento.trim().equals("")){
				...
				Collection colecaoRegistrosAtendimentos = fachada.pesquisar(filtroRegistroAtendimento, RegistroAtendimento.class.getName());
				...
				if(colecaoRegistrosAtendimentos != null && !colecaoRegistrosAtendimentos.isEmpty()){
					...
					if(registroAtendimento.getImovel() != null){
						...
						atualizarGuiaDevolucaoActionForm.setIdImovel(registroAtendimento.getImovel().getId().toString());
						atualizarGuiaDevolucaoActionForm.setDescricaoImovel(registroAtendimento.getImovel().getInscricaoFormatada());
					...
					} /*--<merge>--else if (registroAtendimento.getCliente() != null) {

						if (atualizarGuiaDevolucaoActionForm.getDocumentoTipo()
								.equals(DocumentoTipo.CONTA.toString())
								|| atualizarGuiaDevolucaoActionForm
										.getDocumentoTipo().equals(
							...
							httpServletRequest.setAttribute(
									"bloqueioLocalidade", true);
							httpServletRequest.setAttribute("bloqueioGuia",
									true);
							httpServletRequest.setAttribute("bloqueioConta",
									true);
							httpServletRequest.setAttribute(
									"bloqueioDebitoTipo", true);
							httpServletRequest.setAttribute(
									"bloqueioDebitoACobrar", true);

							// Caso o registro de atendimento não esteja
							// associado a
							// um imóvel e o tipo de documento escolhido for
							// conta
							// ou débito a cobrar, passa uma flag para no jsp
							// verificar se está presente e em caso afirmativo
							// dar
							// um alert em forma de javascript.
							httpServletRequest.setAttribute(
									"RegistroAtendimentoSemImovel", true);
							// throw new ActionServletException(
							// "atencao.registro.atendimento.sem.imovel",
							// null, idRegistroAtendimento);
						}

						atualizarGuiaDevolucaoActionForm
								.setCodigoCliente(registroAtendimento
										.getCliente().getId().toString());
						atualizarGuiaDevolucaoActionForm
								.setNomeCliente(registroAtendimento
										.getCliente().getNome());
						atualizarGuiaDevolucaoActionForm.setIdImovel("");
						atualizarGuiaDevolucaoActionForm.setDescricaoImovel("");
						...
						throw new ActionServletException("atencao.registro.atendimento.sem.imovel.cliente", null, idRegistroAtendimento);
					}

				}else{
					atualizarGuiaDevolucaoActionForm.setIdRegistroAtendimento("");
					atualizarGuiaDevolucaoActionForm.setNomeRegistroAtendimento("RA - REGISTRO DE ATENDIMENTO INEXISTENTE");
				}
			...
			if(idOrdemServico != null && !idOrdemServico.trim().equals("")){
				...
				if(colecaoOrdemServico != null && !colecaoOrdemServico.isEmpty()){
					...
					if(ordemServico.getServicoTipo() != null && ordemServico.getServicoTipo().getDebitoTipo() != null){
						...
						httpServletRequest.setAttribute("bloqueioDebitoTipo", true);
						atualizarGuiaDevolucaoActionForm.setDocumentoTipo("" + DocumentoTipo.DEVOLUCAO_VALOR);
						atualizarGuiaDevolucaoActionForm.setDocumentoTipoHidden("" + DocumentoTipo.DEVOLUCAO_VALOR);
						httpServletRequest.setAttribute("bloqueioDocumentoTipo", true);
					}
				}else{
					atualizarGuiaDevolucaoActionForm.setIdOrdemServico("");
					atualizarGuiaDevolucaoActionForm.setNomeOrdemServico("ORDEM DE SERVIÇO INEXISTENTE");
				}
			...
			if(idLocalidade != null && !idLocalidade.trim().equals("")){
				...
				if(colecaoLocalidade != null && !colecaoLocalidade.isEmpty()){
					...
					atualizarGuiaDevolucaoActionForm.setIdLocalidade(idLocalidade);
					atualizarGuiaDevolucaoActionForm.setIdLocalidadeHidden(idLocalidade);
					atualizarGuiaDevolucaoActionForm.setDescricaoLocalidade(localidade.getDescricao());

				}else{
					atualizarGuiaDevolucaoActionForm.setIdLocalidade("");
					atualizarGuiaDevolucaoActionForm.setIdLocalidadeHidden("");
					atualizarGuiaDevolucaoActionForm.setDescricaoLocalidade("LOCALIDADE INEXISTENTE");
				...
				if(guiaPagamento != null){
					...
					if(idImovel != null && !idImovel.equals("")){
						...
						if(guiaPagamento.getCliente() == null){
							...
							if(!(idCliente.equals(guiaPagamento.getCliente().getId().toString()))){
								...
								// Guia
								// de Pagamento
								atualizarGuiaDevolucaoActionForm.setIdLocalidade(guiaPagamento.getLocalidade().getId().toString());
								atualizarGuiaDevolucaoActionForm.setDescricaoLocalidade(guiaPagamento.getLocalidade().getDescricao());
							}
						}
					}
					...
					if(ordemServico != null){
						if(ordemServico.getServicoTipo().getDebitoTipo() != null){
							...
							if(!("".equals(ordemServico.getServicoTipo().getDebitoTipo().getId()))){
								throw new ActionServletException("atencao.debito.tipo.guia.pagamento.diferente.ordem.servico.debito.tipo",
					...
					if(httpServletRequest.getAttribute("RegistroAtendimentoSemImovel") == null){
						...
						if(valorDevolucao != null){
							...
							atualizarGuiaDevolucaoActionForm.setValorDevolucao(Util.formatarMoedaReal(valorDevolucao));

							atualizarGuiaDevolucaoActionForm.setValorGuiaPagamento("" + Util.formatarMoedaReal(valorDevolucao));
						}
					}
					...
					atualizarGuiaDevolucaoActionForm.setIdGuiaPagamento("");
					atualizarGuiaDevolucaoActionForm.setDescricaoGuiaPagamento("GUIA PAG. INEXISTENTE");
			...
			if(idDebitoTipo != null && !idDebitoTipo.equals("")){
				...
				if(colecaoDebitoTipo != null && !colecaoDebitoTipo.isEmpty()){
					...
					atualizarGuiaDevolucaoActionForm.setIdTipoDebito(idDebitoTipo);
					atualizarGuiaDevolucaoActionForm.setIdTipoDebitoHidden(idDebitoTipo);
					atualizarGuiaDevolucaoActionForm.setDescricaoTipoDebito(debitoTipo.getDescricao());
				}else{
					atualizarGuiaDevolucaoActionForm.setIdTipoDebito("");
					atualizarGuiaDevolucaoActionForm.setIdTipoDebitoHidden("");
					atualizarGuiaDevolucaoActionForm.setDescricaoTipoDebito("TIPO DE DÉBITO INEXISTENTE");
			...
			if(referenciaConta != null && !referenciaConta.trim().equalsIgnoreCase("")){
				...
				if(colecaoConta != null && !colecaoConta.isEmpty()){
					...
					if(!idLocalidade.equals(conta.getLocalidade().getId().toString())){
						...
						atualizarGuiaDevolucaoActionForm.setDescricaoConta("" + Util.formatarMoedaReal(conta.getValorTotal()));
						atualizarGuiaDevolucaoActionForm.setValorDevolucao(Util.formatarMoedaReal(conta.getValorTotal()));
						httpServletRequest.setAttribute("contaInexistente", false);
					}
				}else{
					atualizarGuiaDevolucaoActionForm.setReferenciaConta("");
					atualizarGuiaDevolucaoActionForm.setDescricaoConta("CONTA INEXISTENTE");
			...
			if(idDebitoACobrar != null && !idDebitoACobrar.trim().equalsIgnoreCase("")){
				...
				if(debitoACobrar != null){
					if(!(idImovel.equals(debitoACobrar.getImovel().getId().toString()))){
						throw new ActionServletException("atencao.imovel.debito.a.cobrar.diferente.registro.atendimento.imovel",
										debitoACobrar.getImovel().getId().toString(), idImovel);
					}else{
						// [FS0015] - Verificar localidade do débito a cobrar
						if(!idLocalidade.equals(debitoACobrar.getLocalidade().getId().toString())){
							throw new ActionServletException("atencao.imovel.localidade.diferente.debito.a.cobrar.localidade",
											debitoACobrar.getLocalidade().getId().toString(), idLocalidade, idImovel);
						}
					}
					...
					if(valorDevolucao != null){
						atualizarGuiaDevolucaoActionForm.setValorDevolucao(Util.formatarMoedaReal(valorDevolucao));
						atualizarGuiaDevolucaoActionForm.setValorDebitoACobrar(Util.formatarMoedaReal(valorDevolucao));
					}

					atualizarGuiaDevolucaoActionForm.setDescricaoDebitoACobrar(debitoACobrar.getDebitoTipo().getDescricao());

				}else{
					atualizarGuiaDevolucaoActionForm.setIdDebitoACobrar("");
					atualizarGuiaDevolucaoActionForm.setDescricaoDebitoACobrar("DEB. A COB. INEXISTENTE");
			...
			if(atualizarGuiaDevolucaoActionForm.getDocumentoTipo() != null
							&& !atualizarGuiaDevolucaoActionForm.getDocumentoTipo().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){

				if(atualizarGuiaDevolucaoActionForm.getDocumentoTipo().equals(DocumentoTipo.CONTA.toString())){
					atualizarGuiaDevolucaoActionForm.setIdGuiaPagamento("");
					atualizarGuiaDevolucaoActionForm.setDescricaoGuiaPagamento("");
					atualizarGuiaDevolucaoActionForm.setValorGuiaPagamento("");
					atualizarGuiaDevolucaoActionForm.setIdDebitoACobrar("");
					...
					httpServletRequest.setAttribute("bloqueioDebitoACobrar", true);
					httpServletRequest.setAttribute("bloqueioDebitoTipo", true);
				}else if(atualizarGuiaDevolucaoActionForm.getDocumentoTipo().equals(DocumentoTipo.GUIA_PAGAMENTO.toString())){
					atualizarGuiaDevolucaoActionForm.setReferenciaConta("");
					atualizarGuiaDevolucaoActionForm.setDescricaoConta("");
					atualizarGuiaDevolucaoActionForm.setIdDebitoACobrar("");
					atualizarGuiaDevolucaoActionForm.setDescricaoDebitoACobrar("");
					...
					httpServletRequest.setAttribute("bloqueioConta", true);
					httpServletRequest.setAttribute("bloqueioDebitoTipo", true);
				}else if(atualizarGuiaDevolucaoActionForm.getDocumentoTipo().equals(DocumentoTipo.DEBITO_A_COBRAR.toString())){
					atualizarGuiaDevolucaoActionForm.setReferenciaConta("");
					atualizarGuiaDevolucaoActionForm.setDescricaoConta("");
					atualizarGuiaDevolucaoActionForm.setIdGuiaPagamento("");
					atualizarGuiaDevolucaoActionForm.setDescricaoGuiaPagamento("");
					...
					httpServletRequest.setAttribute("bloqueioConta", true);
					httpServletRequest.setAttribute("bloqueioDebitoTipo", true);
				}else if(atualizarGuiaDevolucaoActionForm.getDocumentoTipo().equals(DocumentoTipo.DEVOLUCAO_VALOR.toString())){
					atualizarGuiaDevolucaoActionForm.setReferenciaConta("");
					atualizarGuiaDevolucaoActionForm.setDescricaoConta("");
					atualizarGuiaDevolucaoActionForm.setIdGuiaPagamento("");
					atualizarGuiaDevolucaoActionForm.setDescricaoGuiaPagamento("");
