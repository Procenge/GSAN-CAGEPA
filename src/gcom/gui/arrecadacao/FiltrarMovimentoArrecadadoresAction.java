 ...
 */
public class FiltrarMovimentoArrecadadoresAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(filtrarMovimentoArrecadadoresActionForm.getIdImovel() != null
						&& !filtrarMovimentoArrecadadoresActionForm.getIdImovel().equalsIgnoreCase("")){

			idImovel = filtrarMovimentoArrecadadoresActionForm.getIdImovel().trim();
		...
		if(indicadorRelatorio != null && indicadorRelatorio.equals("" + ConstantesSistema.SIM)){
			...
			httpServletRequest.setAttribute("idConcessionaria", idConcessionaria);

			Collection colecaoMovimentoArrecadador = fachada.filtrarIdsMovimentoArrecadador(codigoBanco, codigoRemessa,
			...
			Integer totalRegistros = fachada.filtrarMovimentoArrecadadoresCount(codigoBanco, codigoRemessa, descricaoIdentificacaoServico,
			...
			Collection colecaoFiltrarMovimentoArrecadadoresHelper = fachada.filtrarMovimentoArrecadadorParaPaginacao(codigoBanco,
							codigoRemessa,
							descricaoIdentificacaoServico, idImovel, numeroSequencialArquivo, dataGeracaoInicio, dataGeracaoFim,
							ultimaAlteracaoInicio, ultimaAlteracaoFim, descricaoOcorrencia, indicadorAceitacao,
							((Integer) httpServletRequest.getAttribute("numeroPaginasPesquisa")), idConcessionaria);

			sessao.setAttribute("colecaoFiltrarMovimentoArrecadadoresHelper", colecaoFiltrarMovimentoArrecadadoresHelper);
		}
