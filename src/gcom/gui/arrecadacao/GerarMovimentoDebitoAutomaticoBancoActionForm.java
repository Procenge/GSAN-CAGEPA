 ...
 * @date 17/04/2006
 */
public class GerarMovimentoDebitoAutomaticoBancoActionForm
	...
	private Boolean habilitarCampoGrupoFaturamento;

	private Boolean habilitarCampoReferencia;

	private Boolean habilitarCampoDebitoAutomaticoPrefeitura;
	...
	public Boolean getHabilitarCampoGrupoFaturamento(){

		return habilitarCampoGrupoFaturamento;
	}

	public void setHabilitarCampoGrupoFaturamento(Boolean habilitarCampoGrupoFaturamento){

		this.habilitarCampoGrupoFaturamento = habilitarCampoGrupoFaturamento;
	}

	public Boolean getHabilitarCampoReferencia(){

		return habilitarCampoReferencia;
	}


	public void setHabilitarCampoReferencia(Boolean habilitarCampoReferencia){

		this.habilitarCampoReferencia = habilitarCampoReferencia;
	}

	public Boolean getHabilitarCampoDebitoAutomaticoPrefeitura(){

		return habilitarCampoDebitoAutomaticoPrefeitura;
	}

	public void setHabilitarCampoDebitoAutomaticoPrefeitura(Boolean habilitarCampoDebitoAutomaticoPrefeitura){

		this.habilitarCampoDebitoAutomaticoPrefeitura = habilitarCampoDebitoAutomaticoPrefeitura;
	}
