 ...
 */
public class ExibirPesquisarAvisoBancarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("pesquisarAvisoBancario");
		...
		String idDigitadoEnterArrecadador = (String) pesquisarAvisoBancarioActionForm.getIdArrecadador();
		 ...
		 * sessao.setAttribute("idArrecadador","idArrecadador");
		 * }
		 * if(requestMap.get("idArrecadador") == null && sessao.getAttribute("idArrecadador") ==
		 * null && idDigitadoEnterArrecadador != null){
		 * pesquisarAvisoBancarioActionForm.setIdArrecadador("");
		 * pesquisarAvisoBancarioActionForm.setArrecadadorNome("");
		 * }else
		 */
		...
		if(idDigitadoEnterArrecadador != null && !idDigitadoEnterArrecadador.trim().equals("")
			...
			Collection colecaoArrecadadorEncontrado = fachada.pesquisar(filtroArrecadador, Arrecadador.class.getName());

			if(colecaoArrecadadorEncontrado != null && !colecaoArrecadadorEncontrado.isEmpty()){
				// O arrecadador foi encontrado

				Arrecadador arrecadadorEncontrado = (Arrecadador) Util.retonarObjetoDeColecao(colecaoArrecadadorEncontrado);

				if(arrecadadorEncontrado != null && arrecadadorEncontrado.getCliente() != null){
				pesquisarAvisoBancarioActionForm.setIdArrecadador(""
 + arrecadadorEncontrado.getCodigoAgente());
				pesquisarAvisoBancarioActionForm.setArrecadadorNome(""
 + arrecadadorEncontrado.getCliente().getNome());
				httpServletRequest.setAttribute("idArrecadadorNaoEncontrado", "true");
				httpServletRequest.setAttribute("nomeCampo", "tipoRemessa");
				}else{
					throw new ActionServletException("atencao.cliente_arrecadador_inexistente");
				}
			}else{

				pesquisarAvisoBancarioActionForm.setIdArrecadador("");
				pesquisarAvisoBancarioActionForm.setArrecadadorNome("ARRECADADOR INEXISTENTE");
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null && !httpServletRequest.getParameter("tipoConsulta").equals("")){
			...
			if(httpServletRequest.getParameter("tipoConsulta").equals("contaBancaria")){

				pesquisarAvisoBancarioActionForm.setIdConta(httpServletRequest.getParameter("idCampoEnviarDados"));

				pesquisarAvisoBancarioActionForm.setIdBancoConta(httpServletRequest.getParameter("descricaoCampoEnviarDados1"));

				pesquisarAvisoBancarioActionForm.setIdAgenciaConta(httpServletRequest.getParameter("descricaoCampoEnviarDados2"));

				pesquisarAvisoBancarioActionForm.setNumeroConta(httpServletRequest.getParameter("descricaoCampoEnviarDados3"));

			}

			if(httpServletRequest.getParameter("tipoConsulta").equals("movimentoArrecadador")){

				pesquisarAvisoBancarioActionForm.setIdMovimento(httpServletRequest.getParameter("idCampoEnviarDados"));

				pesquisarAvisoBancarioActionForm.setCodigoBanco(httpServletRequest.getParameter("descricaoCampoEnviarDados1"));

				pesquisarAvisoBancarioActionForm.setCodigoRemessa(httpServletRequest.getParameter("descricaoCampoEnviarDados2"));

				pesquisarAvisoBancarioActionForm.setIdentificacaoServico(httpServletRequest.getParameter("descricaoCampoEnviarDados3"));

				pesquisarAvisoBancarioActionForm.setNumeroSequencial(httpServletRequest.getParameter("descricaoCampoEnviarDados4"));

			}
			if((httpServletRequest.getParameter("tipoConsulta") != null)
							&& (httpServletRequest.getParameter("tipoConsulta").equals("arrecadador"))){

				pesquisarAvisoBancarioActionForm.setArrecadadorNome(httpServletRequest.getParameter("descricaoCampoEnviarDados"));
				pesquisarAvisoBancarioActionForm.setIdArrecadador(httpServletRequest.getParameter("idCampoEnviarDados"));
