 ...
 * @date 03/05/2013
 */
public class ExibirConsultarQuadroComparativoFaturamentoArrecadacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirConsultarQuadroComparativoFaturamentoArrecadacaoAction");
	 ...
	 * @date 06/05/2013
	 */
	private void pesquisarLocalidade(HttpServletRequest request, ConsultarQuadroComparativoFaturamentoArrecadacaoActionForm form){
