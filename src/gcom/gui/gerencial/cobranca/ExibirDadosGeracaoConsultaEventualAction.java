 ...
 * @date 26/10/2006
 */
public class ExibirDadosGeracaoConsultaEventualAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirDadosGeracaoConsultaEventual");
		...
		Collection colecaoResumoAcaoCobranca = fachada
						.consultarResumoCobrancaAcaoEventual(informarDadosGeracaoResumoAcaoConsultaEventualHelper);

		sessao.setAttribute("colecaoResumoAcaoCobranca", colecaoResumoAcaoCobranca);

		Collection colecaoAgrupamento = fachada
						.criarColecaoAgrupamentoResumosCobrancaAcaoEventual(informarDadosGeracaoResumoAcaoConsultaEventualHelper);
