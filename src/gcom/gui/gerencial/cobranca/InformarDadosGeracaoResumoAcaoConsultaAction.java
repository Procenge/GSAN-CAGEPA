 ...
 * @date 22/05/2007
 */
public class InformarDadosGeracaoResumoAcaoConsultaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("consultarResumoAcaoCobrancaParametros");
		...
		StatusWizard statusWizard = new StatusWizard("consultarResumoAcaoCobrancaWizardAction",
						"exibirInformarDadosGeracaoResumoAcaoConsultaAction", "cancelarConsultarResumoAcaoCobrancaAction",
						"exibirInformarDadosGeracaoResumoAcaoConsultaAction", "informarDadosGeracaoResumoAcaoConsultaAction.do");
		...
		String mesAnoFaturamento = informarDadosGeracaoResumoAcaoConsultaActionForm.getMesAnoFaturamento();
		...
		if(informarDadosGeracaoResumoAcaoConsultaActionForm.getEloPolo() != null
			...
			idEloPolo = new Integer(informarDadosGeracaoResumoAcaoConsultaActionForm.getEloPolo());
		}
		...
		if(informarDadosGeracaoResumoAcaoConsultaActionForm.getLocalidade() != null
			...
			idLocalidade = new Integer(informarDadosGeracaoResumoAcaoConsultaActionForm.getLocalidade());
		}

		Integer idUnidadeNegocio = null;
		if(informarDadosGeracaoResumoAcaoConsultaActionForm.getUnidadeNegocio() != null
						&& !informarDadosGeracaoResumoAcaoConsultaActionForm.getUnidadeNegocio().equals("")){

			idUnidadeNegocio = new Integer(informarDadosGeracaoResumoAcaoConsultaActionForm.getUnidadeNegocio());
		}

		Integer idSetorComercial = null;
		if(informarDadosGeracaoResumoAcaoConsultaActionForm.getSetorComercial() != null
						&& !informarDadosGeracaoResumoAcaoConsultaActionForm.getSetorComercial().equals("")){

			if(informarDadosGeracaoResumoAcaoConsultaActionForm.getIdSetorComercial() != null
							&& !informarDadosGeracaoResumoAcaoConsultaActionForm.getIdSetorComercial().equals("")){

				idSetorComercial = new Integer(informarDadosGeracaoResumoAcaoConsultaActionForm.getIdSetorComercial());
			}else{
		...
		if(informarDadosGeracaoResumoAcaoConsultaActionForm.getQuadra() != null
			...
			nmQuadra = new Integer(informarDadosGeracaoResumoAcaoConsultaActionForm.getQuadra());
		}

		String[] cobrancaGrupo = informarDadosGeracaoResumoAcaoConsultaActionForm.getGrupoCobranca();
		String[] gerenciaRegional = informarDadosGeracaoResumoAcaoConsultaActionForm.getGerencialRegional();

		String[] imovelPerfil = informarDadosGeracaoResumoAcaoConsultaActionForm.getPerfilImovel();
		String[] ligacaoAguaSituacao = informarDadosGeracaoResumoAcaoConsultaActionForm.getSituacaoLigacaoAgua();
		String[] ligacaoEsgotoSituacao = informarDadosGeracaoResumoAcaoConsultaActionForm.getSituacaoLigacaoEsgoto();
		String[] categoria = informarDadosGeracaoResumoAcaoConsultaActionForm.getCategoria();
		String[] esferaPoder = informarDadosGeracaoResumoAcaoConsultaActionForm.getEsferaPoder();
		String[] empresa = informarDadosGeracaoResumoAcaoConsultaActionForm.getEmpresa();
		...
		InformarDadosGeracaoResumoAcaoConsultaHelper informarDadosGeracaoResumoAcaoConsultaHelper = fachada
						.informarDadosGeracaoResumoAcaoConsulta(mesAnoFaturamento, cobrancaGrupo, gerenciaRegional, idEloPolo,
										idLocalidade, idSetorComercial, nmQuadra, imovelPerfil, ligacaoAguaSituacao, ligacaoEsgotoSituacao,
										categoria, esferaPoder, empresa, idUnidadeNegocio);
				...
				if(!cobrancaGrupo[i].equals("") && !cobrancaGrupo[i].equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
					...
					if(i + 1 < cobrancaGrupo.length){
						filtroCobrancaGrupo.adicionarParametro(new ParametroSimples(FiltroCobrancaGrupo.ID, cobrancaGrupo[i],
										ConectorOr.CONECTOR_OR, cobrancaGrupo.length));
