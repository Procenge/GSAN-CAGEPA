 ...
 * @date 25/06/2007
 */
public class ExibirInformarDadosGeracaoResumoAcaoConsultaEventualAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("colecaoCobrancaAcao") == null){
			...
			FiltroCobrancaAcao filtroCobrancaAcao = new FiltroCobrancaAcao(FiltroCobrancaAcao.DESCRICAO);
			filtroCobrancaAcao.setConsultaSemLimites(true);
			...
			if(colecaoCobrancaAcao == null || colecaoCobrancaAcao.isEmpty()){
				throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, "COBRANCA_ACAO");
			}
		...
		if(pesquisarEloPolo != null && !pesquisarEloPolo.equals("")
			...
			filtroLocalidade.adicionarParametro(new ParametroSimples(FiltroLocalidade.ID,
							informarDadosGeracaoResumoAcaoConsultaEventualActionForm.getEloPolo()));
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				}else if(!eloPlo.getLocalidade().getId()
								.equals(new Integer(informarDadosGeracaoResumoAcaoConsultaEventualActionForm.getEloPolo()))){
		...
		if(pesquisarUnidadeNegocio != null && !pesquisarUnidadeNegocio.equals("")
						&& informarDadosGeracaoResumoAcaoConsultaEventualActionForm.getUnidadeNegocio() != null
			...
			filtroUnidadeNegocio.adicionarParametro(new ParametroSimples(FiltroUnidadeNegocio.ID,
							informarDadosGeracaoResumoAcaoConsultaEventualActionForm.getUnidadeNegocio()));
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setUnidadeNegocio("");
				informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setDescricaoUnidadeNegocio("Unidade de Négócio inexistente");
				...
				informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setUnidadeNegocio(String.valueOf(unidadeNegocio.getId()));
				informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setDescricaoUnidadeNegocio(unidadeNegocio.getNome());
				httpServletRequest.setAttribute("nomeCampo", "perfilImovel");
			}
		}
		...
		if(limparForm != null && !limparForm.equals("")){
			...
			informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setCobrancaAcao(null);
			...
			informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setUnidadeNegocio("");
			informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setDescricaoUnidadeNegocio("");
			informarDadosGeracaoResumoAcaoConsultaEventualActionForm.setEloPolo("");
