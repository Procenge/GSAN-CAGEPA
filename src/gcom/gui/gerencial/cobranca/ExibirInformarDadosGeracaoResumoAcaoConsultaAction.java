 ...
 * @date 22/05/2007
 */
public class ExibirInformarDadosGeracaoResumoAcaoConsultaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(pesquisarEloPolo != null && !pesquisarEloPolo.equals("")
			...
			filtroLocalidade.adicionarParametro(new ParametroSimples(FiltroLocalidade.ID, informarDadosGeracaoResumoAcaoConsultaActionForm
							.getEloPolo()));
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				}else if(!eloPlo.getLocalidade().getId().equals(new Integer(informarDadosGeracaoResumoAcaoConsultaActionForm.getEloPolo()))){
		...
		if(pesquisarUnidadeNegocio != null && !pesquisarUnidadeNegocio.equals("")
						&& informarDadosGeracaoResumoAcaoConsultaActionForm.getUnidadeNegocio() != null
			...
			filtroUnidadeNegocio.adicionarParametro(new ParametroSimples(FiltroUnidadeNegocio.ID,
							informarDadosGeracaoResumoAcaoConsultaActionForm.getUnidadeNegocio()));
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				informarDadosGeracaoResumoAcaoConsultaActionForm.setUnidadeNegocio("");
				informarDadosGeracaoResumoAcaoConsultaActionForm.setDescricaoUnidadeNegocio("Unidade de Négócio inexistente");
				...
				informarDadosGeracaoResumoAcaoConsultaActionForm.setUnidadeNegocio(String.valueOf(unidadeNegocio.getId()));
				informarDadosGeracaoResumoAcaoConsultaActionForm.setDescricaoUnidadeNegocio(unidadeNegocio.getNome());
				httpServletRequest.setAttribute("nomeCampo", "perfilImovel");
			}
		}
		...
		if(pesquisarQuadra != null && !pesquisarQuadra.equals("") && informarDadosGeracaoResumoAcaoConsultaActionForm.getQuadra() != null
		...
		if(limparForm != null && !limparForm.equals("")){
			...
			informarDadosGeracaoResumoAcaoConsultaActionForm.setUnidadeNegocio("");
			informarDadosGeracaoResumoAcaoConsultaActionForm.setDescricaoUnidadeNegocio("");
			informarDadosGeracaoResumoAcaoConsultaActionForm.setEloPolo("");
