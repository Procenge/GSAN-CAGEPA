 ...
 * @date 09/11/2006
 */
public class ExibirConsultarResumoAcaoCobrancaPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("consultarResumoAcaoCobrancaPopup");
		...
		if(colecaoCobrancaAcao != null && !colecaoCobrancaAcao.isEmpty()){
			...
			if(cobrancaAcao.getCobrancaCriterio() != null && !cobrancaAcao.getCobrancaCriterio().equals("")
							&& cobrancaAcao.getCobrancaCriterio().getValorLimitePrioridade() != null){
