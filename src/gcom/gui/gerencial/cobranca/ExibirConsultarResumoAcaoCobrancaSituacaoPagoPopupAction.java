 ...
 * @date 09/11/2006
 */
public class ExibirConsultarResumoAcaoCobrancaSituacaoPagoPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("consultarResumoAcaoCobrancaSituacaoPagoPopup");
		...
		Collection cobrancaAcaoDebitoHelperParaPago = fachada.consultarCobrancaAcaoDebitoComIndicador(
						informarDadosGeracaoResumoAcaoConsultaHelper, idCobrancaAcao, idCobrancaAcaoSituacao, idCobrancaAcaoDebito);
