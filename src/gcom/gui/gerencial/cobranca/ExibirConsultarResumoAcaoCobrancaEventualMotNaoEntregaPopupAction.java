 ...
 * @date 26/06/2007
 */
public class ExibirConsultarResumoAcaoCobrancaEventualMotNaoEntregaPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("consultarResumoAcaoCobrancaEventualMotNaoEntregaPopup");
		...
		if(colecaoCobrancaAcao != null && !colecaoCobrancaAcao.isEmpty()){
			...
			cobrancaAcao = (CobrancaAcao) iteratorCobrancaAcao.next();
		}
		...
		Collection colecao = fachada.consultarResumoCobrancaAcaoEventual(cobrancaAcao.getId(),
