 ...
 */
public class ExibirFiltrarExcecoesLeiturasConsumosCaracteristicasAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection<ImovelPerfil> imovelPerfis = fachada.pesquisar(filtroImovelPerfil, ImovelPerfil.class.getName());
		...
		filtroMedicaoTipo.adicionarParametro(new ParametroSimples(FiltroMedicaoTipo.INDICADOR_USO, ConstantesSistema.INDICADOR_USO_ATIVO));
		Collection<MedicaoTipo> medicaoTipos = fachada.pesquisar(filtroMedicaoTipo, MedicaoTipo.class.getName());
		...
		Collection<LigacaoTipo> ligacaoTipos = fachada.pesquisar(filtroLigacaoTipo, LigacaoTipo.class.getName());
