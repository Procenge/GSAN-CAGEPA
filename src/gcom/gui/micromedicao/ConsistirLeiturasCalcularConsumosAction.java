 ...
 */
public class ConsistirLeiturasCalcularConsumosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// (ConsistirLeiturasCalcularConsumosActionForm) sessao
		...
		TarefaBatchConsistirLeiturasCalcularConsumos batch = new TarefaBatchConsistirLeiturasCalcularConsumos(usuarioLogado, 1);
