...
public class GerarDadosParaLeituraAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		//			
		// int[] mediaPeriodo =
		// fachada.obterConsumoMedioHidrometro(imovel,sistemaParametro,medicaoTipo);
		//        
		...
		// try {
		// consumoMinino =
		// fachada.calcularFaixaLeituraFalsa(imovel,mediaConsumoHidrometro,leituraAnterior,medicaoHistorico,hidrometroSelecionado,hidrometro);
		// } catch (ControladorException e) {
		// // TODO Auto-generated catch block
		// e.printStackTrace();
		// }
