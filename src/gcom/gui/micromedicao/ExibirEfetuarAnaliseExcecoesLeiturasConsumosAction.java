 ...
 */
public class ExibirEfetuarAnaliseExcecoesLeiturasConsumosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// imoveisMicromedicao = (Collection<ImovelMicromedicao>)
		// httpServletRequest.getAttribute("imoveisFiltrados");
		...
		while(iterator.hasNext()){
			...
			if(imovel != null && imovel.getRota() != null && imovel.getRota().getFaturamentoGrupo() != null){
			...
			if(imovel != null && imovel.getRota() != null && imovel.getRota().getFaturamentoGrupo() != null){
				...
				filtroConsumoHistorico.adicionarParametro(new ParametroSimples(FiltroConsumoHistorico.ANO_MES_FATURAMENTO, sistemaParametro
