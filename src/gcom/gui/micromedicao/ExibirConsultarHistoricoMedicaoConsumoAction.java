 ...
 */
public class ExibirConsultarHistoricoMedicaoConsumoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection<MedicaoHistorico> medicoesHistorico = fachada.consultaMedicaoHistorio(codigoImovel);
		Collection<ImovelMicromedicao> imoveisMicromedicao = fachada.consultarConsumoHistorio(codigoImovel);
