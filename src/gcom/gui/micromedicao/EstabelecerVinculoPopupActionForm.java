 ...
 */
public class EstabelecerVinculoPopupActionForm
				extends ActionForm {
	...
	private String[] imoveisSelecionados;
	 ...
	 *            the imoveisSelecionados to set
	 */
	public void setImoveisSelecionados(String[] imoveisSelecionados){

		this.imoveisSelecionados = imoveisSelecionados;
	}

	/**
	 * @return the imoveisSelecionados
	 */
	public String[] getImoveisSelecionados(){
