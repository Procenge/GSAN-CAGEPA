 ...
 * @since 11/01/2006
 */
public class ExibirAtualizarTipoRateioPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		AtualizarTipoRateioPopupActionForm atualizarTipoRateioPopupActionForm = (AtualizarTipoRateioPopupActionForm) actionForm;
		atualizarTipoRateioPopupActionForm.reset(actionMapping, httpServletRequest);
		...
		httpServletRequest.setAttribute("colecaoRateioTipo", colecaoRateioTipo);
		...
		if(colecaoHidrometroInstalacaoHistorico != null && !colecaoHidrometroInstalacaoHistorico.isEmpty()){
			...
			RateioTipo rateioTipo = ((HidrometroInstalacaoHistorico) colecaoHidrometroInstalacaoHistorico.iterator().next())
							.getRateioTipo();
			if(rateioTipo != null){
				atualizarTipoRateioPopupActionForm.setRateioTipoAgua(rateioTipo.getId().toString());
			}else{
				atualizarTipoRateioPopupActionForm.setRateioTipoAgua("");
			}
			atualizarTipoRateioPopupActionForm.setBotao("Visualizar");
		}
		...
		if(colecaoHidrometroInstalacaoHistoricoPoco != null && !colecaoHidrometroInstalacaoHistoricoPoco.isEmpty()){
			...
			RateioTipo rateioTipo = ((HidrometroInstalacaoHistorico) colecaoHidrometroInstalacaoHistoricoPoco.iterator().next())
							.getRateioTipo();
			if(rateioTipo != null){
				atualizarTipoRateioPopupActionForm.setRateioTipoPoco(rateioTipo.getId().toString());
			}else{
				atualizarTipoRateioPopupActionForm.setRateioTipoPoco("");
			}
			atualizarTipoRateioPopupActionForm.setBotao("Visualizar");
		}
		...
		// imovel.getHidrometroInstalacaoHistorico().getRateioTipo() != null){
		// }

		// [FS0009] - Verificar se o imóvel é um condomínio
		if(imovel.getIndicadorImovelCondominio() != null
						&& (imovel.getIndicadorImovelCondominio().shortValue() != Imovel.IMOVEL_CONDOMINIO.shortValue())){
