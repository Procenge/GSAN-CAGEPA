...
public class InserirHidrometroDiametroActionForm
	...
	public HidrometroDiametro setFormValues(HidrometroDiametro hidrometroDiametro){
		...
		hidrometroDiametro.setDescricao(getDescricao());
		...
		hidrometroDiametro.setIndicadorUso(ConstantesSistema.INDICADOR_USO_ATIVO);
