 ...
 */
public class HidrometroActionForm
	...
	private boolean indicadorHidrometroComposto;

	private String fatorConversao = "1";
	 ...
	 */
	public void setIdHidrometroClasseMetrologica(String idHidrometroClasseMetrologica){
	...
	public void setLocalArmazenagemDescricaoDestino(String localArmazenagemDescricaoDestino){
	...
	public void setLocalArmazenagemDescricaoOrigem(String localArmazenagemDescricaoOrigem){
	 ...
	 */
	public boolean isIndicadorHidrometroComposto(){
	 ...
	 */
	public void setIndicadorHidrometroComposto(boolean indicadorHidrometroComposto){
	...
	public String getCodigoFormatoNumeracao(){

		return codigoFormatoNumeracao;
	}

	public void setCodigoFormatoNumeracao(String codigoFormatoNumeracao){

		this.codigoFormatoNumeracao = codigoFormatoNumeracao;
	}

	public String getIdHidrometroTipoTurbina(){
	...
	public void limparCampos(){
		...
		idHidrometroClasseMetrologica = "" + ConstantesSistema.NUMERO_NAO_INFORMADO;
		idHidrometroDiametro = "" + ConstantesSistema.NUMERO_NAO_INFORMADO;
		idHidrometroTipo = "" + ConstantesSistema.NUMERO_NAO_INFORMADO;
		idLocalArmazenagem = "";
		localArmazenagemDescricao = "";
		// localArmazenagemDescricaoOrigem = "";
		// localArmazenagemDescricaoDestino = "";
		idHidrometroMarca = "" + ConstantesSistema.NUMERO_NAO_INFORMADO;
		idNumeroDigitosLeitura = "";
		indicadorMacromedidor = "" + ConstantesSistema.NUMERO_NAO_INFORMADO;
		// numeroHidrometro = "";
		// hidrometroSelectID = null;
		// dataMovimentacaoInicial = "";
		// dataMovimentacaoFinal = "";
		// horaMovimentacaoInicial = "";
		// horaMovimentacaoFinal = "";
		// motivoMovimentacao = "";
		...
		// finalidade = "";
		indicadorHidrometroComposto = false;
		fatorConversao = "1";
