 ...
 */
public class ConsultarHistoricoInstalacaoHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((codigoImovel != null && !codigoImovel.equals("")) && (codigoHidrometro != null && !codigoHidrometro.equals(""))){
			...
			if(imovelPesquisado != null && !imovelPesquisado.isEmpty()){
				...
				if(imovel.getLigacaoAgua() != null){
					filtroHidrometroInstalacaoHistorico.adicionarParametro(new ParametroSimples(
									FiltroHidrometroInstalacaoHistorico.IMOVEL_ID, imovel.getId(), FiltroParametro.CONECTOR_OR));
					filtroHidrometroInstalacaoHistorico.adicionarParametro(new ParametroSimples(
									FiltroHidrometroInstalacaoHistorico.LIGACAO_AGUA_ID, imovel.getLigacaoAgua().getId()));
				}else{
					filtroHidrometroInstalacaoHistorico.adicionarParametro(new ParametroSimples(
									FiltroHidrometroInstalacaoHistorico.IMOVEL_ID, imovel.getId()));
				}
				...
				// hidrometrosInstalacaoHistorico.iterator().next()).getHidrometro().getNumero();
				// ((HidrometroInstalacaoHistorico)
				// hidrometrosInstalacaoHistorico.iterator().next()).getHidrometro().getId();
		...
		if(codigoHidrometro != null && !codigoHidrometro.trim().equals("")){
			...
			filtroHidrometro.adicionarCaminhoParaCarregamentoEntidade("hidrometroMotivoBaixa");
