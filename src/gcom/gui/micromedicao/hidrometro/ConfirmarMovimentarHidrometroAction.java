 ...
 */
public class ConfirmarMovimentarHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String numeroHidrometrosSelecionados = (String) sessao.getAttribute("numeroHidrometrosSelecionados");

		Collection colecaoHidrometroSelecionado = (Collection) sessao.getAttribute("colecaoHidrometroSelecionado");

		fachada.inserirAtualizarMovimentacaoHidrometroIds(colecaoHidrometroSelecionado, confirmarMovimentarHidrometroActionForm
						.getDataMovimentacao(), confirmarMovimentarHidrometroActionForm.getHoraMovimentacao(),
						confirmarMovimentarHidrometroActionForm.getIdLocalArmazenagemDestino(), confirmarMovimentarHidrometroActionForm
										.getIdMotivoMovimentacao(), confirmarMovimentarHidrometroActionForm.getParecer(), usuario);

		// Método utilizado para montar a página de sucesso
		montarPaginaSucesso(httpServletRequest, numeroHidrometrosSelecionados + " Hidrômetro(s) " + " movimentado(s) com sucesso.",
						"Movimentar outro(s) Hidrômetro(s)", "exibirFiltrarHidrometroAction.do?menu=sim&tela=movimentarHidrometro");
