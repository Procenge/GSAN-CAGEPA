 ...
 * @date 18/06/2007
 */
public class FiltrarCapacidadeHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(descricao != null && !descricao.trim().equalsIgnoreCase("")){
			...
			if(tipoPesquisa != null && tipoPesquisa.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				...
				filtroHidrometroCapacidade.adicionarParametro(new ComparacaoTextoCompleto(FiltroHidrometroCapacidade.DESCRICAO, descricao));
			}else{
				filtroHidrometroCapacidade.adicionarParametro(new ComparacaoTexto(FiltroHidrometroCapacidade.DESCRICAO, descricao));
			}
		}
