...
public class AtualizarHidrometroTipoActionForm
	...
	public HidrometroTipo setFormValues(HidrometroTipo hidrometroTipo){

		// Metodo usado para setar todos os valores do Form na base de dados
		hidrometroTipo.setId(new Integer(getIdHidrometroTipo()));
		hidrometroTipo.setDescricao(getDescricaoTipoHidrometro());
		hidrometroTipo.setDescricaoAbreviada(getDescricaoAbreviada());
		hidrometroTipo.setUltimaAlteracao(new Date());
		hidrometroTipo.setIndicadorUso(new Short(getIndicadorUso()));
