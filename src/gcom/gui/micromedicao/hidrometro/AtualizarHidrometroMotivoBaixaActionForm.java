...
/**
 * [UC] ATUALIZAR MotivoBaixa HIDROMETRO
 * 
 * @author Deyverson Santos
 * @date 12/12/2008
 */

public class AtualizarHidrometroMotivoBaixaActionForm
	...
	private String idHidrometroMotivoBaixa;
	...
	public HidrometroMotivoBaixa setFormValues(HidrometroMotivoBaixa hidrometroMotivoBaixa){
		...
		return hidrometroMotivoBaixa;
	}

	public String getDescricaoMotivoBaixaHidrometro(){

		return descricaoMotivoBaixaHidrometro;
	}

	public void setDescricaoMotivoBaixaHidrometro(String descricaoMotivoBaixaHidrometro){

		this.descricaoMotivoBaixaHidrometro = descricaoMotivoBaixaHidrometro;
	}

	public String getIdHidrometroMotivoBaixa(){
