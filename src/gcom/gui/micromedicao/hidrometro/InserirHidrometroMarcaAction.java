...
public class InserirHidrometroMarcaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Marca de Hidrômetro de código " + idHidrometroMarca + " inserido com sucesso.",
						"Inserir outra marca de hidrômetro", "exibirInserirHidrometroMarcaAction.do?menu=sim",
						"exibirAtualizarHidrometroMarcaAction.do?idRegistroInseridoAtualizar=" + idHidrometroMarca,
						"Atualizar marca de hidrômetro");
