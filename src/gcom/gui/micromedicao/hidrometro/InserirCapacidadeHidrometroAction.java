...
public class InserirCapacidadeHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String abreviatura = inserirCapacidadeHidrometroActionForm.getAbreviatura();
		...
		String indicadorUso = inserirCapacidadeHidrometroActionForm.getIndicadorUso();
		...
		if(codigo == null || codigo.equalsIgnoreCase("")){
			throw new ActionServletException("atencao.required", null, "Código da capacidade do hidrômetro");
		}

		// A descrição da Capacidade do Hidrômetro é obrigatório.
		if(descricao == null || descricao.equalsIgnoreCase("")){
			throw new ActionServletException("atencao.required", null, "Descrição da capacidade de hidrômetro");
		}
		...
		if(numMinimo == null || numMinimo.equalsIgnoreCase("")){
			throw new ActionServletException("atencao.required", null, "Número mínimo de digitos de leitura do hidrômetro");
		}
		...
		if(numOrdem != null && !numOrdem.equalsIgnoreCase("")){
		...
		filtroHidrometroCapacidade.adicionarParametro(new ParametroSimples(FiltroHidrometroCapacidade.NUMERO_ORDEM,
		...
		if(colecaoPesquisa != null && !colecaoPesquisa.isEmpty()){
			...
			throw new ActionServletException("atencao.pesquisa_numero_de_ordem_da_capacidade_do_hidrometro_ja_cadastrada", null, numOrdem);
		}

		filtroHidrometroCapacidade.limparListaParametros();
		...
		if(colecaoPesquisa != null && !colecaoPesquisa.isEmpty()){
			...
			idHidrometroCapacidade = fachada.inserirCapacidadeHidrometro(hidrometroCapacidadeInserir, usuarioLogado);

			montarPaginaSucesso(httpServletRequest,
							"Capacidade do Hidrômetro de código " + hidrometroCapacidadeInserir.getCodigoHidrometroCapacidade()
											+ " inserida com sucesso.", "Inserir outra Capacidade do Hidrômetro",
							"exibirInserirCapacidadeHidrometroAction.do?menu=sim",
							"exibirAtualizarCapacidadeHidrometroAction.do?inserir=sim&idRegistroAtualizacao=" + idHidrometroCapacidade,
