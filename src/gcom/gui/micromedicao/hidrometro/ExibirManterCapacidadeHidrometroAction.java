 ...
 * @since 18/06/2007
 */
public class ExibirManterCapacidadeHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirManterCapacidadeHidrometro");
		...
		if(filtroHidrometroCapacidade != null && !filtroHidrometroCapacidade.equals("")){
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroHidrometroCapacidade, HidrometroCapacidade.class
							.getName());
			colecaoCapacidadeHidrometro = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoCapacidadeHidrometro != null && !colecaoCapacidadeHidrometro.isEmpty()){
			...
			if(colecaoCapacidadeHidrometro.size() == 1
				...
				if(httpServletRequest.getAttribute("atualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarCapacidadeHidrometro");
					HidrometroCapacidade hidrometroCapacidade = (HidrometroCapacidade) colecaoCapacidadeHidrometro.iterator().next();
					sessao.setAttribute("hidrometroCapacidade", hidrometroCapacidade);
				}else{
