...
public class FiltrarHidrometroMarcaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(descricaoMarcaHidrometro != null && !descricaoMarcaHidrometro.equalsIgnoreCase("")){
			...
			if(tipoPesquisa != null && tipoPesquisa.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				...
				filtroHidrometroMarca.adicionarParametro(new ComparacaoTexto(FiltroSistemaEsgoto.DESCRICAO, descricaoMarcaHidrometro));
			}
		}
		...
		if(descricaoAbreviada != null && !descricaoAbreviada.trim().equalsIgnoreCase("")){
			...
			filtroHidrometroMarca.adicionarParametro(new ParametroSimples(FiltroHidrometroMarca.DESCRICAO_ABREVIADA, descricaoAbreviada));
		}
		...
		if(validadeRevisao != null && !validadeRevisao.trim().equalsIgnoreCase("")){
			...
			filtroHidrometroMarca.adicionarParametro(new ParametroSimples(FiltroHidrometroMarca.VALIDADE_REVISAO, validadeRevisao));
		}
		...
		if(indicadorUso != null && !indicadorUso.trim().equalsIgnoreCase("")){
			...
			filtroHidrometroMarca.adicionarParametro(new ParametroSimples(FiltroHidrometroMarca.INDICADOR_USO, indicadorUso));
		}
