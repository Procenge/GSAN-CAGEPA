 ...
 */
public class ExibirFiltrarCapacidadeHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("menu") != null){
			...
			filtrarCapacidadeHidrometroActionForm.setIndicadorUso("3");
		...
		if(primeiraVez != null && !primeiraVez.equals("")){
			...
			filtrarCapacidadeHidrometroActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
		...
		if(sessao.getAttribute("voltar") != null && sessao.getAttribute("voltar").equals("filtrar")){
			...
			if(sessao.getAttribute("tipoPesquisa") != null){
				filtrarCapacidadeHidrometroActionForm.setTipoPesquisa(sessao.getAttribute("tipoPesquisa").toString());
			}
		}

		// Seta o mapeamento de retorno
		ActionForward retorno = actionMapping.findForward("filtrarCapacidadeHidrometro");
