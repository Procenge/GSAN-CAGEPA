...
public class ExibirInserirHidrometroAction
	 ...
	 * @date 30/07/2008
	 *       Alteração na forma de Carregamento das Marcas e Capacidades do Hidrômetro (baseadas no
	 *       nr. fixo)
	 * @author Saulo Lima
	 * @date 03/03/2009
	 *       Alteração para evitar consultas desnecessárias.
	 * @param actionMapping
	 * @param actionForm
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// O usuário pode chamar o filtro de hidrômetro que carrega objetos na sessão
		// e depois chamar o inserir hidrômetro. Necessário remover os objetos da sessão deixados
		// pelo filtro.
		...
		if(objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("")){
			...
			if(objetoConsulta.trim().equalsIgnoreCase("1")){ // Local de Armazenagem
				...
				// Capacidade do Hidrômetro, baseada no Número Fixo
				...
				// Marca do Hidrômetro, baseada no Número Fixo
				...
				// Tipo de Instalação da Turbina do Hidrômetro, baseada no Número Fixo
			...
			// Filtro de hidrômetro classe metrológica para obter todas as classes metrológicas
			// ativas
