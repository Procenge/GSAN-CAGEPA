...
public class AtualizarHidrometroMarcaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Marca de Hidrômetro de código " + hidrometroMarca.getId() + " atualizado com sucesso.",
						"Realizar outra Manutenção de Marca de Hidrômetro", "exibirFiltrarHidrometroMarcaAction.do?menu=sim");
