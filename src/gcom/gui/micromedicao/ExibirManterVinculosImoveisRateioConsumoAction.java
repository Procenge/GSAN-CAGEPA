 ...
 * @since 11/01/2006
 */
public class ExibirManterVinculosImoveisRateioConsumoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getAttribute("filtroImovelPreenchido") != null){
			filtroClienteImovel = (FiltroClienteImovel) httpServletRequest.getAttribute("filtroImovelPreenchido");
		}
		...
		if(retorno.getName().equalsIgnoreCase("exibirManterVinculosImoveisRateioConsumo")){
			...
			// imoveisVinculos = fachada.pesquisar(filtroClienteImovel,
			...
			String idHidrometroHistInst = (String) sessao.getAttribute("idHidrometroHistInst");
			...
			// na tela
			int totalRegistros = fachada.pesquisarQuantidadeImovel(idImovel, idLocalidade, codigoSetorComercial, numeroQuadra,
							idHidrometroHistInst, lote, subLote, codigoCliente, idMunicipio, cep, idBairro, idLogradouro, true, false,
							null, null).intValue();
			...
			imoveisVinculos = fachada.pesquisarImovel(idImovel, idLocalidade, codigoSetorComercial, numeroQuadra, idHidrometroHistInst,
							lote, subLote, codigoCliente, idMunicipio, cep, idBairro, idLogradouro, true, false,
