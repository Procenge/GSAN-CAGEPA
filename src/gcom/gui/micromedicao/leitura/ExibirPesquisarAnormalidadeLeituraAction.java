...
public class ExibirPesquisarAnormalidadeLeituraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		pesquisarLeituraAnormalidadeActionForm.setMensagemImpressaoConta(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setSugestaoAgenteManutencao(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setSugestaoAgentePrevencao(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setAceiteLeitura(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setImpressaoRelatorioCriticaFiscalizacao(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setIndicadorRetencaoConta(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setIndicadorIsencaoCobrancaAgua(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setIndicadorIsencaoCobrancaEsgoto(ConstantesSistema.TODOS + "");
		pesquisarLeituraAnormalidadeActionForm.setIndicadorConcessaoCreditoConsumo(ConstantesSistema.TODOS + "");
		...
		filtroLeituraAnormalidadeConsumo.adicionarParametro(new ParametroSimples(FiltroLeituraAnormalidadeConsumo.INDICADOR_USO,
						ConstantesSistema.INDICADOR_USO_ATIVO));
		Collection leiturasAnormalidadesConsumo = fachada.pesquisar(filtroLeituraAnormalidadeConsumo, LeituraAnormalidadeConsumo.class
						.getName());
		if(leiturasAnormalidadesConsumo.isEmpty()){
			throw new ActionServletException("atencao.naocadastrado", null, "Consumo a ser cobrado");
		}else{
		...
		filtroLeituraAnormalidadeLeitura.adicionarParametro(new ParametroSimples(FiltroLeituraAnormalidadeLeitura.INDICADOR_USO,
						ConstantesSistema.INDICADOR_USO_ATIVO));
		Collection leiturasAnormalidadesLeitura = fachada.pesquisar(filtroLeituraAnormalidadeLeitura, LeituraAnormalidadeLeitura.class
						.getName());
		if(leiturasAnormalidadesConsumo.isEmpty()){
			throw new ActionServletException("atencao.naocadastrado", null, "Leitura para Faturamento");
		}else{
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaAnormalidadeLeitura") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaAnormalidadeLeitura", httpServletRequest
		...
		Collection colecaoPesquisa = fachada.pesquisar(filtroTipoServico, ServicoTipo.class.getName());
