...
public class ExibirInserirLeituristaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirInserirLeiturista");
		...
		// Retorna empresa
		colecaoPesquisa = fachada.pesquisar(filtroEmpresa, Empresa.class.getName());
		...
		filtroEmpresa.adicionarParametro(new ParametroSimples(FiltroEmpresa.ID, ConstantesSistema.INDICADOR_USO_ATIVO));

		sessao.setAttribute("colecaoEmpresa", fachada.pesquisar(filtroEmpresa, Empresa.class.getName(), "EMPRESA"));
