 ...
 */
public class FiltrarInformarLeituraFiscalizacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirInformarLeituraFiscalizacao");
		...
		httpServletRequest.setAttribute("mesAnoReferencia", form.getMesAnoReferencia());
