 ...
 */
public class FiltrarAnormalidadeLeituraActionForm
	...
	String numeroIncidenciasGeracaoOS;

	String aceiteLeitura;

	String impressaoRelatorioCriticaFiscalizacao;

	String indicadorRetencaoConta;

	String indicadorIsencaoCobrancaAgua;

	String indicadorIsencaoCobrancaEsgoto;

	String indicadorConcessaoCreditoConsumo;

	String mensagemImpressaoConta;

	String sugestaoAgenteManutencao;

	String sugestaoAgentePrevencao;
