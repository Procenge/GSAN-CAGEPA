 ...
 * @data 15/05/2007
 */
public class ExibirFiltrarInformarLeituraFiscalizacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarInformarLeituraFiscalizacao");
		...
		this.carregarCombos(httpServletRequest, colecaoMedicaoTipo, colecaoLeituraAnormalidade);

		String matricula = form.getMatricula();

		// Obtendo dados do imovel
		if(matricula != null && !matricula.trim().equals("") && Integer.parseInt(matricula) > 0){
		...
		if(httpServletRequest.getParameter("menu") != null){
			...
			form.setMesAnoReferencia(Util.formatarAnoMesParaMesAno(anoMes.toString()));
		}
	...
	public void carregarCombos(HttpServletRequest httpServletRequest, Collection colecaoMedicaoTipo, Collection colecaoLeituraAnormalidade){
	...
	public void pesquisarImovel(HttpServletRequest httpServletRequest, FiltrarInformarLeituraFiscalizacaoActionForm form, String matricula){
