 ...
 */
public class ExibirFiltrarLeituristaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((filtrarLeituristaActionForm.getIdFuncionario() != null && !filtrarLeituristaActionForm.getIdFuncionario().equals(""))){

			FiltroFuncionario filtroFuncionario = new FiltroFuncionario();

			filtroFuncionario
							.adicionarParametro(new ParametroSimples(FiltroFuncionario.ID, filtrarLeituristaActionForm.getIdFuncionario()));
			...
			if(colecaoFuncionario != null && !colecaoFuncionario.isEmpty()){
				...
				filtrarLeituristaActionForm.setDescricaoFuncionario(funcionario.getNome());

			}else{
				httpServletRequest.setAttribute("funcionarioEncontrado", "exception");
				filtrarLeituristaActionForm.setIdFuncionario("");
				filtrarLeituristaActionForm.setDescricaoFuncionario("FUNCIONARIO INEXISTENTE");
			}
		...
		if((filtrarLeituristaActionForm.getIdCliente() != null && !filtrarLeituristaActionForm.getIdCliente().equals(""))){

			FiltroCliente filtroCliente = new FiltroCliente();

			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.ID, filtrarLeituristaActionForm.getIdCliente()));
			...
			if(colecaoCliente != null && !colecaoCliente.isEmpty()){
				...
				filtrarLeituristaActionForm.setDescricaoCliente(cliente.getNome());

			}else{
				httpServletRequest.setAttribute("clienteEncontrado", "exception");
				filtrarLeituristaActionForm.setIdCliente("");
				filtrarLeituristaActionForm.setDescricaoCliente("CLIENTE INEXISTENTE");
			}
		...
		if(filtrarLeituristaActionForm.getTipoPesquisa() == null || filtrarLeituristaActionForm.getTipoPesquisa().equalsIgnoreCase("")){
			filtrarLeituristaActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
		}
		...
		if(sessao.getAttribute("voltar") != null && sessao.getAttribute("voltar").equals("filtrar")){
			...
			if(sessao.getAttribute("tipoPesquisa") != null){
				filtrarLeituristaActionForm.setTipoPesquisa(sessao.getAttribute("tipoPesquisa").toString());
			}
		}
