...
/**
 * Action que define o pré-processamento da página de Filtro de Anormalidade de Leitura, para
 ...
 */
public class ExibirFiltrarAnormalidadeLeituraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		filtrarAnormalidadeLeituraActionForm.setIndicadorRelativoHidrometro(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setIndicadorImovelSemHidrometro(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setUsoRestritoSistema(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setPerdaTarifaSocial(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setOsAutomatico(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setMensagemImpressaoConta(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setSugestaoAgenteManutencao(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setSugestaoAgentePrevencao(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setAceiteLeitura(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setImpressaoRelatorioCriticaFiscalizacao(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setIndicadorRetencaoConta(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setIndicadorIsencaoCobrancaAgua(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setIndicadorIsencaoCobrancaEsgoto(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setIndicadorConcessaoCreditoConsumo(ConstantesSistema.TODOS + "");
		filtrarAnormalidadeLeituraActionForm.setIndicadorUso(ConstantesSistema.SIM + "");
		...
		ActionForward retorno = actionMapping.findForward("filtrarAnormalidadeLeitura");
