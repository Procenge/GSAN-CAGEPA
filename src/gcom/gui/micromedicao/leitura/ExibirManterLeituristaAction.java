 ...
 * @since 22/07/2007
 */
public class ExibirManterLeituristaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroLeiturista filtroLeiturista = (FiltroLeiturista) sessao.getAttribute("filtroLeiturista");
		...
		if(filtroLeiturista != null && !filtroLeiturista.equals("")){
			...
			colecaoLeiturista = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoLeiturista != null && !colecaoLeiturista.isEmpty()){
			...
			if(colecaoLeiturista.size() == 1
				...
				if(httpServletRequest.getParameter("indicadorAtualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarLeiturista");
					Leiturista leiturista = (Leiturista) colecaoLeiturista.iterator().next();
					sessao.setAttribute("leiturista", leiturista);
				}else{
					httpServletRequest.setAttribute("colecaoLeiturista", colecaoLeiturista);
					sessao.setAttribute("leiturista", colecaoLeiturista);
				}
			}else{
				httpServletRequest.setAttribute("colecaoLeiturista", colecaoLeiturista);
			}
