 ...
 */
public class ExibirFiltrarExcecoesLeiturasConsumosAnormalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection<LeituraAnormalidade> leituraAnormalidades = fachada.pesquisar(filtroLeituraAnormalidade, LeituraAnormalidade.class
						.getName());
		if(leituraAnormalidades.isEmpty()){
			throw new ActionServletException("atencao.naocadastrado");
		}else{
			httpServletRequest.setAttribute("leituraAnormalidades", leituraAnormalidades);
		}
		...
		if(consumoAnormalidades.isEmpty()){
			...
			httpServletRequest.setAttribute("consumoAnormalidades", consumoAnormalidades);
		}
		...
		Collection<LeituraSituacao> colecaoLeituraSituacaoAtual = fachada.pesquisar(filtroLeituraSituacao, LeituraSituacao.class.getName());
