 ...
 * @created 25/04/2006
 */
public class RemoverAdicionarCriterioCobrancaRotaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("UseCase") != null && sessao.getAttribute("UseCase").equals("INSERIRROTA")){
		...
		if(idCobrancaAcaoExcluir != null && !idCobrancaAcaoExcluir.equalsIgnoreCase("")
			...
			Collection collectionRotaAcaoCriterio = (Collection) sessao.getAttribute("collectionRotaAcaoCriterio");
