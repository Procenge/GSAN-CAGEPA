 ...
 * @since 23/08/2007
 */
public class ExibirManterRoteiroEmpresaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer totalRegistros = fachada.pesquisarRoteiroEmpresaCount(empresa, idLocalidade, idLeiturista, idSetorComercial, indicadorUso);

		retorno = this.controlarPaginacao(httpServletRequest, retorno, totalRegistros);

		Collection colecaoRoteiroEmpresas = fachada.pesquisarRoteiroEmpresa(empresa, idLocalidade, idSetorComercial, idLeiturista,
						indicadorUso, (Integer) httpServletRequest.getAttribute("numeroPaginasPesquisa"));
		...
		if(colecaoRoteiroEmpresas != null && !colecaoRoteiroEmpresas.isEmpty()){
			...
			if(colecaoRoteiroEmpresas.size() == 1
				...
				if(sessao.getAttribute("atualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarRoteiroEmpresa");
					...
					httpServletRequest.setAttribute("colecaoRoteiroEmpresa", colecaoRoteiroEmpresas);
				}
			}else{
				httpServletRequest.setAttribute("colecaoRoteiroEmpresa", colecaoRoteiroEmpresas);
			}
