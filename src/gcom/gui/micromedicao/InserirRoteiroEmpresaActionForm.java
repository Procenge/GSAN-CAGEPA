 ...
 * @created 24/07/2007
 */
public class InserirRoteiroEmpresaActionForm
				extends ActionForm {
	...
	/**
	 * @param idSetorComercialSelecionados
	 *            The idSetorComercialSelecionados to set.
	 */
	public void setIdSetorComercialSelecionados(String[] idSetorComercialSelecionados){
	...
	/**
	 * @param idQuadraAdicionar
	 *            The idQuadraAdicionar to set.
	 */
