 ...
 */
public class ExibirConsistirLeiturasCalcularConsumosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("consistirLeiturasCalcularConsumos");

		// ConsistirLeiturasCalcularConsumosActionForm consistirLeiturasCalcularConsumosActionForm =
		// (ConsistirLeiturasCalcularConsumosActionForm) actionForm;
		...
		if(confirmacao != null && confirmacao.equals("sim")){
			...
			if(colecaoSistemaParametro != null && !colecaoSistemaParametro.equals("")){
			...
			filtroFaturamentoAtividadeCronograma.adicionarParametro(new ParametroSimples(
							FiltroFaturamentoAtividadeCronograma.FATURAMENTO_GRUPO_CRONOGRAMA_MENSAL_ANO_MES_REFERENCIA, new Integer(
											sistemaParametro.getAnoMesArrecadacao()), FiltroParametro.CONECTOR_AND));
			...
			if(colecaoFaturamentoAtividadeCronograma != null && !colecaoFaturamentoAtividadeCronograma.equals("")){
				...
				if(faturamentoAtividadeCronograma.getDataRealizacao() == null){
					httpServletRequest.setAttribute("confirmacao", "confirmacao");
				}else{
					// Foi realizado
				...
				throw new ActionServletException("atencao.inexistente.faturamento_atividade_cronograma");
			}
		}
		...
		faturamentoGrupos = fachada.pesquisar(filtroFaturamentoGrupo, FaturamentoGrupo.class.getName());
