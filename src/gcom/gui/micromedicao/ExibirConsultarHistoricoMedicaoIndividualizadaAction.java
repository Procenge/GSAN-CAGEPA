 ...
 * @since 11/01/2006
 */
public class ExibirConsultarHistoricoMedicaoIndividualizadaAction
				extends GcomAction {
			...
			if(codigoImovel != null && !codigoImovel.trim().equals("")){
				...
				if(imovelPesquisado != null && imovelPesquisado.isEmpty()){
					...
					if(imovelCondominio.getIndicadorImovelCondominio() != null
									&& (imovelCondominio.getIndicadorImovelCondominio().shortValue() == Imovel.IMOVEL_NAO_CONDOMINIO
													.shortValue())){
					...
					if(httpServletRequest.getParameter("pesquisaImovel") == null
									|| httpServletRequest.getParameter("pesquisaImovel").equals("")){
						...
						if(anoMes != null && !anoMes.equalsIgnoreCase("")){
							...
							boolean maior = Util.compararAnoMesReferencia(new Integer(anoReferencia + "" + mesReferencia), new Integer(
											anoAtual + "" + mesAtual), ">");
							if(maior){
						...
						if(anoMes != null && !anoMes.equalsIgnoreCase("")){
							...
							anoMesInformado.set(Calendar.YEAR, new Integer(ano).intValue());
							anoMesInformado.set(Calendar.MONTH, new Integer(mes).intValue() - 1);
							anoMesInformado.set(Calendar.DATE, 1);

							anoMes = imovelCondominio.getRota().getFaturamentoGrupo().getAnoMesReferencia() + "";
						...
						Collection colecaoConsultarHistoricoMedicaoIndividualizada;
						colecaoConsultarHistoricoMedicaoIndividualizada = fachada.consultarHistoricoMedicaoIndividualizada(
										imovelCondominio, anoMesFaturamentoInformado);

						if(colecaoConsultarHistoricoMedicaoIndividualizada != null
										&& !colecaoConsultarHistoricoMedicaoIndividualizada.isEmpty()){
						...
						sessao.setAttribute("colecaoConsultarHistoricoMedicaoIndividualizada",
										colecaoConsultarHistoricoMedicaoIndividualizada);
