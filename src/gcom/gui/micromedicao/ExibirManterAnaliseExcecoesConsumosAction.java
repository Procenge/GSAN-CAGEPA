 ...
 * @date 07/03/2006
 */
public class ExibirManterAnaliseExcecoesConsumosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroMedicaoHistoricoSql") != null){
			...
			Integer totalRegistros = fachada.filtrarExcecoesLeiturasConsumosCount(faturamentoGrupo, filtroMedicaoHistoricoSql);
			...
			colecaoImovelMedicao = fachada.filtrarExcecoesLeiturasConsumos(faturamentoGrupo, filtroMedicaoHistoricoSql,
	...
	public void capturarImoveisJaSelecionados(HttpSession sessao, HttpServletRequest httpServletRequest){
		...
		if(imoveisPorPagina != null && !imoveisPorPagina.isEmpty() && imoveisPorPagina.containsKey(proximaPagina)){
