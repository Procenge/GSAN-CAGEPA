...
public class LigacoesMedicaoIndividualizadasAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Obtém o action form
		// LigacoesMedicaoIndividualizadaActionForm ligacoesMedicaoIndividualizadaActionForm =
		...
		Collection colecaoLigacoesMedicaoIndividualizada = fachada.pesquisarLigacoesMedicaoIndividualizada(new Integer(idImovel),
