 ...
 * @author Sávio Luiz
 */
public class ExibirRegistrarLeiturasAnormalidadesRelatorioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("registrarLeiturasAnormalidadesRelatorio");
		...
		if(faturamentosGrupos == null || faturamentosGrupos.isEmpty()){
			...
			new ActionServletException("atencao.pesquisa.nenhumresultado", null, "faturamento grupo");
		}

		httpServletRequest.setAttribute("faturamentosGrupos", faturamentosGrupos);
