...
public class AtualizarLigacoesMedicaoIndividualizadaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// LigacoesMedicaoIndividualizadaActionForm form =
		// (LigacoesMedicaoIndividualizadaActionForm) actionForm;
		...
		while(iterator.hasNext()){
			...
			leituraAnterior = (String) httpServletRequest.getParameter("leituraAnterior&"
							+ ligacaoMedicaoIndividualizadaHelperSessao.getIdImovel());
			dataLeituraAnterior = (String) httpServletRequest.getParameter("dataLeituraAnterior&"
							+ ligacaoMedicaoIndividualizadaHelperSessao.getIdImovel());
			leituraAtual = (String) httpServletRequest.getParameter("leituraAtual&"
							+ ligacaoMedicaoIndividualizadaHelperSessao.getIdImovel());
			dataLeituraAtual = (String) httpServletRequest.getParameter("dataLeituraAtual&"
							+ ligacaoMedicaoIndividualizadaHelperSessao.getIdImovel());
			anormalidadeLeitura = (String) httpServletRequest.getParameter("idLeituraAnormalidade&"
							+ ligacaoMedicaoIndividualizadaHelperSessao.getIdImovel());
			consumoInformado = (String) httpServletRequest.getParameter("consumoInformado&"
							+ ligacaoMedicaoIndividualizadaHelperSessao.getIdImovel());
