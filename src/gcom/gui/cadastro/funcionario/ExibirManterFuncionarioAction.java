 ...
 */
public class ExibirManterFuncionarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroFuncionario filtroFuncionario = (FiltroFuncionario) sessao.getAttribute("filtroFuncionario");
		...
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroFuncionario, Funcionario.class.getName());
		Collection colecaoFuncionario = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoFuncionario != null && !colecaoFuncionario.isEmpty()){
			...
			if(colecaoFuncionario.size() == 1
				...
				if(httpServletRequest.getParameter("atualizar") != null){
					retorno = actionMapping.findForward("atualizarFuncionario");
