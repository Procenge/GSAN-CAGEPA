...
public class PesquisarFuncionarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		//
		// Collection<Funcionario> collectionFuncionario = fachada.pesquisar(filtroFuncionario,
		...
		Collection collectionFuncionario = (Collection) resultado.get("colecaoRetorno");
		...
		if(collectionFuncionario == null || collectionFuncionario.isEmpty()){
			...
			throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, "funcionario");
