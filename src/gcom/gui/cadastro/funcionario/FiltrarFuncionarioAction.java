 ...
 * @date 13/04/2007
 */
public class FiltrarFuncionarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirManterFuncionarioAction");
		...
		if(matricula != null && !matricula.trim().equalsIgnoreCase("")){
			...
			filtroFuncionario.adicionarParametro(new ParametroSimples(FiltroFuncionario.ID, matricula));
		...
		if(descricaoCargo != null && !descricaoCargo.trim().equalsIgnoreCase("")){

			peloMenosUmParametroInformado = true;

			filtroFuncionario.adicionarParametro(new ComparacaoTexto(FiltroFuncionario.DESCRICAO_CARGO, descricaoCargo));
		...
		if(idEmpresa != null && !idEmpresa.trim().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
			peloMenosUmParametroInformado = true;
			filtroFuncionario.adicionarParametro(new ParametroSimples(FiltroFuncionario.UNIDADE_EMPRESA_ID, new Integer(idEmpresa)));
