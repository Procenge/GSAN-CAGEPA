 ...
 */
public class AtualizarFuncionarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(colecaoUnidadeEmpresa == null || colecaoUnidadeEmpresa.isEmpty()){
			...
			fachada.atualizarFuncionario(funcionario, usuarioLogado);

			sessao.removeAttribute("idFuncionario");

			sessao.removeAttribute("funcionarioAtualizar");

			montarPaginaSucesso(httpServletRequest, "Funcionario de matricula " + funcionario.getId() + " atualizado com sucesso.",
							"Manter outro Funcionário", "exibirFiltrarFuncionarioAction.do?menu=sim");
