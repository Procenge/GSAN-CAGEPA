 ...
 * @date 04/04/2007
 */
public class InserirFuncionarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Unidade Organizacional do funcionario
		...
		Collection<UnidadeOrganizacional> colecaoUnidadeEmpresa = fachada.pesquisar(filtroUnidadeEmpresa, UnidadeOrganizacional.class
						.getName());
		...
		if(colecaoUnidadeEmpresa == null || colecaoUnidadeEmpresa.isEmpty()){
			...
			montarPaginaSucesso(httpServletRequest, "Funcionario de matricula " + funcionario.getId() + " inserida com sucesso.",
							"Inserir outro Funcionario", "exibirInserirFuncionarioAction.do?menu=sim",
							"exibirAtualizarFuncionarioAction.do?idFuncionario=" + funcionario.getId(), "Atualizar Funcionario inserido");
