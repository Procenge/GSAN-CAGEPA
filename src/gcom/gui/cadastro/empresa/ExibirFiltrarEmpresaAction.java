...
public class ExibirFiltrarEmpresaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("filtrarEmpresa");
		...
		if(filtrarEmpresaActionForm.getTipoPesquisa() == null || filtrarEmpresaActionForm.getTipoPesquisa().equals("")){
		...
		if(filtrarEmpresaActionForm.getCheckAtualizar() == null){
			filtrarEmpresaActionForm.setCheckAtualizar("1");
		}
		...
		if(httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")){
			...
			filtrarEmpresaActionForm.setCodigoEmpresa("");
			filtrarEmpresaActionForm.setNomeEmpresa("");
