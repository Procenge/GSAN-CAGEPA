 ...
 */
public class InserirUnidadeOperacionalActionForm
	...
	public UnidadeOperacional setFormValues(UnidadeOperacional unidadeOperacional){
		...
		unidadeOperacional.setCodigoUnidadeOperacional(Short.valueOf(codigoUnidadeOperacional));
		unidadeOperacional.setDescricao(descricao);
		unidadeOperacional.setDescricaoAbreviada(descricaoAbreviada);
		SistemaAbastecimento sistemaUnidade = new SistemaAbastecimento();
		sistemaUnidade.setId(Integer.parseInt(sistemaAbastecimento));
		unidadeOperacional.setSistemaAbastecimento(sistemaUnidade);
