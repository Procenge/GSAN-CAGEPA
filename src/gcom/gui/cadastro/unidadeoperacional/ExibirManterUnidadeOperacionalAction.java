...
/**
 * [] MANTER UNIDADE OPERACIONAL
 * 
 * @author Péricles Tavares
 * @date 31/01/2011
 */

public class ExibirManterUnidadeOperacionalAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("manterUnidadeOperacional");

		HttpSession sessao = httpServletRequest.getSession(false);

		Collection colecaoUnidadeOperacional = null;

		// Parte da verificação do filtro
		FiltroUnidadeOperacional filtroUnidadeOperacional = new FiltroUnidadeOperacional(FiltroUnidadeOperacional.ID);
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterUnidadeOperacional"))){

			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroUnidadeOperacional, UnidadeOperacional.class.getName());
			colecaoUnidadeOperacional = (Collection) resultado.get("colecaoRetorno");
			...
			sessao.setAttribute("colecaoUnidadeOperacional", colecaoUnidadeOperacional);
			sessao.setAttribute("caminhoRetornoVoltar", "/gsan");
