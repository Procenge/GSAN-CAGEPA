 ...
 */
public class ExibirManterTarifaSocialCartaoTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("manterTarifaSocialCartaoTipo");
		...
		if(httpServletRequest.getAttribute("filtroTarifaSocialCartaoTipo") != null){
			filtroTarifaSocialCartaoTipo = (FiltroTarifaSocialCartaoTipo) httpServletRequest.getAttribute("filtroTarifaSocialCartaoTipo");
		}else{
			...
			if(fachada.registroMaximo(TarifaSocialCartaoTipo.class) > ConstantesSistema.NUMERO_MAXIMO_REGISTROS_MANUTENCAO){
				...
				// é chamada
				retorno = actionMapping.findForward("filtrarTarifaSocialCartaoTipo");
		...
		if(retorno.getName().equalsIgnoreCase("manterTarifaSocialCartaoTipo")){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroTarifaSocialCartaoTipo, TarifaSocialCartaoTipo.class
							.getName());
			...
			if(colecaoTarifaSocialCartaoTipo == null || colecaoTarifaSocialCartaoTipo.isEmpty()){
				...
				throw new ActionServletException("atencao.naocadastrado", null, "tipo de cartão da tarifa social");
			}
