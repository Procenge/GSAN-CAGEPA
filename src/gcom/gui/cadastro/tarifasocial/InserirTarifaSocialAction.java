...
public class InserirTarifaSocialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(Util.isVazioOuBranco(registroAtendimento.getDataEncerramento())){
			registroAtendimento.setDataEncerramento(new Date());
		}

		// Caso tenha sido informado, atualizar com as informações do ORSE_DSPARECERENCERRAMENTO,
		// caso contrário “Encerrado através da funcionalidade Inserir dados da Tarifa Social”.
		if(Util.isVazioOuBranco(registroAtendimento.getParecerEncerramento())){
			registroAtendimento.setParecerEncerramento("Encerrado através da funcionalidade Inserir dados da Tarifa Social.");
		}
		...
		if(sessao.getAttribute("colecaoDadosTarifaSocial") != null){
			colecaoTarifaSocialDadoEconomia = (Collection) sessao.getAttribute("colecaoDadosTarifaSocial");
		}else{
			colecaoTarifaSocialDadoEconomia = (Collection) sessao.getAttribute("colecaoTarifaSocialDadoEconomia");
		}
		...
		Collection colecaoTarifaSocialRecadastrar = (Collection) sessao.getAttribute("colecaoTarifaSocialDadoEconomia");
		...
		fachada.inserirTarifaSocial(imovelSessao, clienteImovel, registroAtendimento, registroAtendimentoUnidade, usuarioLogado,
						idTarifaSocialDadoEconomiaExcluida, colecaoTarifaSocialDadoEconomia, colecaoClienteImovelEconomia,
						colecaoTarifaSocialRecadastrar, imovelAtualizar, colecaoImovelEconomiaAtualizar);

		montarPaginaSucesso(httpServletRequest, "Imóvel de matrícula " + imovelSessao.getId() + " incluído na tarifa social com sucesso.",
						"Inserir outra tarifa social", "exibirInserirTarifaSocialAction.do?menu=sim");
