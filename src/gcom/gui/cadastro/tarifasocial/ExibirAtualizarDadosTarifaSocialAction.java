 ...
 */
public class ExibirAtualizarDadosTarifaSocialAction
				extends GcomAction {
	...
	/**
	 * Metodo que pesquisa a Tarfia Social Dados Economia e o cliente de um imovel e os colocam na
	 * sessao
	 * 
	 * @author thiago toscano
	 * @date 15/12/2005
	...
	public void pesquisaTarifasocialDadoEconomeia(ExibirAtualizarDadosTarifaSocialActionForm form, HttpSession sessao){
		...
		filtroTarifaSocialDadoEconomia.adicionarParametro(new ParametroSimples(FiltroTarifaSocialDadoEconomia.IMOVEL_ID,
		...
		Collection tarifasocialDadoEconomeia = Fachada.getInstancia().pesquisarTarifaSocialDadoEconomia(filtroTarifaSocialDadoEconomia);
