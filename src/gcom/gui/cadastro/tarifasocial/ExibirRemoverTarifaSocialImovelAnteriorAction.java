 ...
 * @since 16/01/2007
 */
public class ExibirRemoverTarifaSocialImovelAnteriorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		removerTarifaSocialImovelAnteriorActionForm
						.setMotivoRevisao(tarifaSocialDadoEconomia.getTarifaSocialRevisaoMotivo().getDescricao());
