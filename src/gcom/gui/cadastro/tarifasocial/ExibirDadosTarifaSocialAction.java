 ...
 * @author rodrigo
 */
public class ExibirDadosTarifaSocialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// FiltroTarifaSocialDadoEconomia filtroTarifaSocialDadoEconomia = new
		// FiltroTarifaSocialDadoEconomia();
		// filtroTarifaSocialDadoEconomia.adicionarParametro(new
		// ParametroSimples(FiltroTarifaSocialDadoEconomia.ID,new
		// Integer(form.getIdTarifaSocialDadoEconomia())));
