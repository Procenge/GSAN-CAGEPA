 ...
 */
public class ExibirInserirTarifaSocialCartaoTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirTarifaSocialCartaoTipo");
		...
		tarifaSocialCartaoTipoActionForm.setValidade((TarifaSocialCartaoTipo.INDICADOR_EXISTENCIA_VALIDADE_SIM).toString());
