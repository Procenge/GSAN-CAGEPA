 ...
 * @since 16/01/2007
 */
public class RemoverTarifaSocialImovelAnteriorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idMotivoExclusao = removerTarifaSocialImovelAnteriorActionForm.getMotivoExclusao();

		Cliente cliente = (Cliente) sessao.getAttribute("clienteTarifaSocialImovelAnterior");
		...
		if(manter == null || manter.trim().equals("")){
			...
			Date dataInicioRelacao = (Date) sessao.getAttribute("dataInicioRelacao");
			...
			if(sessao.getAttribute("colecaoClienteImovel") != null){
				...
				if(tarifaSocialHelperAtualizar.getColecaoClientesEconomiaInseridos() != null){
			...
			if(sessao.getAttribute("colecaoTarifasSociaisRecadastradas") != null){
				colecaoTarifasSociaisRecadastradas = (Collection) sessao.getAttribute("colecaoTarifasSociaisRecadastradas");
			}else{
				colecaoTarifasSociaisRecadastradas = new ArrayList();
			}

			colecaoTarifasSociaisRecadastradas.add(tarifaSocialDadoEconomiaRecadastrar);

			sessao.setAttribute("colecaoTarifasSociaisRecadastradas", colecaoTarifasSociaisRecadastradas);
			...
			while(colecaoTarifaSocialHelperIterator.hasNext()){
				...
				if(tarifaSocialHelper.getTarifaSocialDadoEconomia().getId().equals(tarifaSocialDadoEconomiaRecadastrar.getId())){

					tarifaSocialHelper.setTarifaSocialDadoEconomia(tarifaSocialDadoEconomiaRecadastrar);
		...
		TarifaSocialDadoEconomia tarifaSocialDadoEconomiaSessao = (TarifaSocialDadoEconomia) sessao
		...
		tarifaSocialHelperImovelAnterior.setTarifaSocialDadoEconomia(tarifaSocialDadoEconomia);
		...
		if(sessao.getAttribute("colecaoImoveisExcluidosTarifaSocial") != null){
			colecaoImoveisExcluidosTarifaSocial = (Collection) sessao.getAttribute("colecaoImoveisExcluidosTarifaSocial");
		}else{
			colecaoImoveisExcluidosTarifaSocial = new ArrayList();
		}

		colecaoImoveisExcluidosTarifaSocial.add(tarifaSocialHelperImovelAnterior);

		sessao.setAttribute("colecaoImoveisExcluidosTarifaSocial", colecaoImoveisExcluidosTarifaSocial);
