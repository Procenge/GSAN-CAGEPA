 ...
 * @since 16/01/2007
 */
public class ExibirRemoverTarifaSocialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaoTarifaSocialExclusaoMotivo = fachada.pesquisar(filtroTarifaSocialExclusaoMotivo, TarifaSocialExclusaoMotivo.class
						.getName());
		...
		if(sessao.getAttribute("colecaoTarifasSociaisRecadastradas") != null){
			...
			if(!colecaoTarifasSociaisRecadastradas.isEmpty()){
				...
				while(colecaoTarifasSociaisRecadastradasIterator.hasNext()){
					...
					if(tarifaSocialDadoEconomia.getId().equals(new Integer(idTarifaSocialDadoEconomia))){
						colecaoTarifasSociaisRecadastradas.remove(tarifaSocialDadoEconomia);
