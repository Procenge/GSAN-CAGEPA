 ...
 */
public class InserirTarifaSocialCartaoTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		TarifaSocialCartaoTipo tarifaSocialCartaoTipo = new TarifaSocialCartaoTipo(tarifaSocialCartaoTipoActionForm.getDescricao(),
						tarifaSocialCartaoTipoActionForm.getDescricaoAbreviada(),
						new Short(tarifaSocialCartaoTipoActionForm.getValidade()), numeroMaximoMeses, indicadorDeUsoAtivo, new Date());
		...
		montarPaginaSucesso(httpServletRequest, "Tipo de Cartão da Tarifa Social de código " + tarifaSocialCartaoTipo.getId()
						+ " inserido com sucesso.", "Inserir outro Tipo de Cartão da Tarifa Social",
