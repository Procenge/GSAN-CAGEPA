 ...
 * @created 20/12/2005
 */
public class ConsultaImovelTarifaSocialActionForm
				extends ControladorConsultaGcomActionForm {
	...
	public void setCollTarifaSocialExclusaoMotivo(Collection collTarifaSocialExclusaoMotivo){
