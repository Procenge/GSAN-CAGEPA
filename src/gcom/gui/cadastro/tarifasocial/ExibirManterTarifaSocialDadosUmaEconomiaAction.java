 ...
 * @author rodrigo
 */
public class ExibirManterTarifaSocialDadosUmaEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("manterTarifaSocialUmaEconomia");
		...
		if(idTarifaSocial != null && !idTarifaSocial.equals("")){
			...
			if(!Util.isVazioOrNulo(colecaoTarifaSocialExcluida)){
