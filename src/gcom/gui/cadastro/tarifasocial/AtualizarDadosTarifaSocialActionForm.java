 ...
 */
public class AtualizarDadosTarifaSocialActionForm
				extends ControladorAlteracaoGcomActionForm {
	...
	private String qtdRecadastramento;

	private String dataUltimoRecadastramento;
	...
	public void setConsumoEnergiaMaximoTarifaSocial(String consumoEnergiaMaximoTarifaSocial){
	...
	public String getQtdRecadastramento(){

		return qtdRecadastramento;
	}

	public void setQtdRecadastramento(String qtdRecadastramento){

		this.qtdRecadastramento = qtdRecadastramento;
	}

	public String getDataUltimoRecadastramento(){

		return dataUltimoRecadastramento;
	}

	public void setDataUltimoRecadastramento(String dataUltimoRecadastramento){
