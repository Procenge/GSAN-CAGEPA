 ...
 * @author rodrigo
 */
public class ExibirInserirTarifaSocialDadosMultiplasEconomiasAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirTarifaSocialMultiplasEconomia");
		...
		if(valorConfirmacao == null || valorConfirmacao.equals("")){
			...
			if(inserirTarifaSocialActionForm.get("idImovel") != null && !inserirTarifaSocialActionForm.get("idImovel").equals("")){

				idImovel = (String) inserirTarifaSocialActionForm.get("idImovel");
			...
			Integer qtdEconomiasImovel = (Integer) inserirTarifaSocialActionForm.get("qtdEconomia");
			...
			if(qtdEconomiasImovel != null){
				...
				if(imovelEconomias.size() < qtdEconomiasImovel.intValue()){
					throw new ActionServletException("atencao.imovel.economia_quantidade_invalida");
				}
			...
			while(imovelEconomiaIterator.hasNext()){
				...
				if(!tipoProprietario){
					throw new ActionServletException("atencao.proprietario.nao_cadastrado_economia");
				}

				filtroClienteImovelEconomia.limparListaParametros();

				imovelEconomiaObj = (ImovelEconomia) imovelEconomiaIterator.next();
				...
				filtroClienteImovelEconomia.adicionarCaminhoParaCarregamentoEntidade("imovelEconomia.imovelSubcategoria.comp_id.imovel");
				filtroClienteImovelEconomia.adicionarCaminhoParaCarregamentoEntidade("cliente.clienteTipo");

				filtroClienteImovelEconomia.adicionarParametro(new ParametroSimples(FiltroClienteImovelEconomia.IMOVEL_ECONOMIA_ID,
				...
				filtroClienteImovelEconomia.adicionarParametro(new ParametroSimples(FiltroClienteImovelEconomia.CLIENTE_RELACAO_TIPO,
								ClienteRelacaoTipo.PROPRIETARIO, FiltroParametro.CONECTOR_OR, 2));
				filtroClienteImovelEconomia.adicionarParametro(new ParametroSimples(FiltroClienteImovelEconomia.CLIENTE_RELACAO_TIPO,
								ClienteRelacaoTipo.USUARIO));
				filtroClienteImovelEconomia.adicionarParametro(new ParametroNulo(FiltroClienteImovelEconomia.FIM_RELACAO_MOTIVO_ID));

				colecaoClienteImovelEconomia = fachada.pesquisar(filtroClienteImovelEconomia, ClienteImovelEconomia.class.getName());

				clienteImovelEconomiaIterator = colecaoClienteImovelEconomia.iterator();
				...
				while(clienteImovelEconomiaIterator.hasNext()){
					...
					clienteImovelEconomiaObj = (ClienteImovelEconomia) clienteImovelEconomiaIterator.next();

					if(clienteImovelEconomiaObj.getClienteRelacaoTipo().getId().shortValue() == ClienteRelacaoTipo.PROPRIETARIO
									.shortValue()){

						tipoProprietario = true;

						if(clienteImovelEconomiaObj.getCliente().getClienteTipo().getIndicadorPessoaFisicaJuridica().equals(
										ClienteTipo.INDICADOR_PESSOA_FISICA)){

							if((clienteImovelEconomiaObj.getCliente().getRg() == null || clienteImovelEconomiaObj.getCliente().getRg()
											.equals(""))
											&& clienteImovelEconomiaObj.getCliente().getCpf() == null){
								throw new ActionServletException("atencao.proprietario.rg_cpf_nao_cadastrado_economia");
							}

						}else{
							if(clienteImovelEconomiaObj.getCliente().getCnpj() == null){
								throw new ActionServletException("atencao.proprietario.cnpj_nao_cadastrado_economia");
							}
						}
					...
					// do imóvel
					else if(clienteImovelEconomiaObj.getClienteRelacaoTipo().getId().shortValue() == ClienteRelacaoTipo.USUARIO
									.shortValue()){

						// Verifica se o cliente usuário tem RG ou CPF
						if((clienteImovelEconomiaObj.getCliente().getRg() == null || clienteImovelEconomiaObj.getCliente().getRg().equals(
										""))
										&& clienteImovelEconomiaObj.getCliente().getCpf() == null){
							throw new ActionServletException("atencao.usuario.rg_cpf_nao_cadastrado_economia");
						}else{

							// Verifica se o mesmo cliente está vinculado a mais
							// de uma economia do imóvel como usuário
							int qtde = fachada.pesquisarClienteImovelEconomiaCount(new Integer(idImovel), clienteImovelEconomiaObj
											.getCliente().getId());

							if(qtde >= 2){
								throw new ActionServletException("atencao.usuarios.nao_distintos");
							}

							// Verifica se o cliente usuário já foi excluído por um motivo que
							// permita recadastramento
							fachada.verificarClienteMotivoExclusaoRecadastramento(clienteImovelEconomiaObj.getCliente().getId());

							// Carregando os objetos que serão visualizados no
							// JSP
							clienteImovelEconomiaObj.setImovelEconomia(imovelEconomiaObj);
							colecaoClienteImovelEconomiaJSP.add(clienteImovelEconomiaObj);

							// Verificar se o cliente usuário está relacionado a
							// algum outro imóvel na tarifa social

							Collection colecaoImovel = fachada.verificarClienteCadastradoTarifaSocial(clienteImovelEconomiaObj.getCliente()
											.getId());
							...
							if(colecaoImovel != null && !colecaoImovel.isEmpty()){
								...
								return montarPaginaConfirmacaoWizard("atencao.usuario.ja_cadastrado_tarifasocial", httpServletRequest,
												actionMapping, imovel.getId().toString());
							}
							...
							filtroClienteImovelEconomiaVerificacao.adicionarParametro(new ParametroSimples(
											FiltroClienteImovelEconomia.IMOVEL_PERFIL, ImovelPerfil.TARIFA_SOCIAL));
							filtroClienteImovelEconomiaVerificacao.adicionarParametro(new ParametroSimples(
											FiltroClienteImovelEconomia.CLIENTE_ID, clienteImovelEconomiaObj.getCliente().getId()));
							filtroClienteImovelEconomiaVerificacao.adicionarParametro(new ParametroSimples(
											FiltroClienteImovelEconomia.CLIENTE_RELACAO_TIPO, ClienteRelacaoTipo.USUARIO));
							filtroClienteImovelEconomiaVerificacao.adicionarParametro(new ParametroNulo(
											FiltroClienteImovelEconomia.FIM_RELACAO_MOTIVO_ID));

							colecaoClienteImovelEconomiaVerificacao = fachada.pesquisar(filtroClienteImovelEconomiaVerificacao,
											ClienteImovelEconomia.class.getName());

							if(colecaoClienteImovelEconomiaVerificacao != null && !colecaoClienteImovelEconomiaVerificacao.isEmpty()){

								/*
								 * clienteImovelEconomiaVerificacaoObj =
								 * (ClienteImovelEconomia)
								 */colecaoClienteImovelEconomiaVerificacao.iterator().next();

								throw new ActionServletException("atencao.usuario.ja_cadastrado_tarifasocial", null,
												clienteImovelEconomiaObj.getImovelEconomia().getImovelSubcategoria().getComp_id()
							 ...
							 */
							if(colecaoClienteUsuario.contains(clienteImovelEconomiaObj.getCliente())){
								throw new ActionServletException("atencao.usuario.ja_cadastrado_tarifasocial_mesmo_imovel", null, idImovel
												.toString());
							}else{
								colecaoClienteUsuario.add(clienteImovelEconomiaObj.getCliente());
							}
			...
			if(reload == null){
				sessao.setAttribute("colecaoClienteImovelEconomia", colecaoClienteImovelEconomiaJSP);
			}

			// [FS0003] - Verificar pré-requisitos para cadastramento na tarifa
			// social
			String[] dados = fachada.verificarPreRequisitosCadastramentoTarifaSocial(new Integer(idImovel), qtdEconomiasImovel);
			...
			switch(prerequisito){
				...
				case 1:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.nao_imovel_residencial", httpServletRequest, actionMapping);
				...
				case 2:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.nao_imovel.com.subcategorias", httpServletRequest,
									actionMapping, parametroMensagem, "Encerramento");
				...
				case 3:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.nao_imovel.com.subcategorias", httpServletRequest,
									actionMapping, parametroMensagem, "Tramitação");
				...
				case 4:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.imovel.perfil.grande_consumidor", httpServletRequest,
									actionMapping);
				...
				case 5:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.agua_nao_ligada", httpServletRequest, actionMapping);
				...
				case 6:
					...
					return montarPaginaConfirmacaoWizard("atencao.anormalidade.leitura.tarifasocial", httpServletRequest, actionMapping,
									parametroMensagem);
				...
				case 7:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifa_social.permitida.apenas.imovel.sem_debitos", httpServletRequest,
									actionMapping);
				...
				case 8:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifa_social.permitida.imoveis.consumo_medio", httpServletRequest,
									actionMapping, parametroMensagem);
				...
				case 9:
					...
					// LIGAÇÃO CLANDESTINA - T
				case 15:
					sessao.setAttribute("prerequisito", "15");

					httpServletRequest
									.setAttribute("caminhoActionConclusao",
													"/gsan/inserirTarifaSocialWizardAction.do?action=exibirInserirTarifaSocialDadosMultiplasEconomiaAction");

					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.agua_ligacao_clandestina", httpServletRequest, actionMapping);
				...
				case 16:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.nao_imovel_residencial_uma_economia", httpServletRequest,
									actionMapping);
			...
			if(sessao.getAttribute("prerequisito") != null){
				...
				if(prerequisito.equals("")){
					...
					retorno = actionMapping.findForward("exibirTramitarRegistroAtendimentoAction");
				}else if(prerequisito.equals("1")){
					// CATEGORIA RESIDENCIAL - E

					retorno = actionMapping.findForward("exibirEncerrarRegistroAtendimentoAction");
				...
				}else if(prerequisito.equals("15")){
					// LIGAÇÃO CLANDESTINA - T
					retorno = actionMapping.findForward("exibirTramitarRegistroAtendimentoAction");
				}
			}
		...
		if(codigo != null && !codigo.equals("")){
			...
			if(codigo.equals("9")){
				...
				return montarPaginaConfirmacaoWizard("atencao.tarifa_social.renda_familiar.maior.salario_minimo", httpServletRequest,
								actionMapping, valor);
				...
				return montarPaginaConfirmacaoWizard("atencao.preencher.tarifa_social.valor.consumo_energia", httpServletRequest,
								actionMapping, valor);
				...
				return montarPaginaConfirmacaoWizard("atencao.preencher.tarifa_social.requisitos", httpServletRequest, actionMapping, valor);
	...
	private void carregarObjetosImovelEconomia(Collection imovelEconomias){
		...
		while(imovelEconomiasIt.hasNext()){
			ImovelEconomia imovelEconomiaObject = (ImovelEconomia) imovelEconomiasIt.next();
			...
			while(tarifaSocialDadoEconomiasIt.hasNext()){
				TarifaSocialDadoEconomia tarifaSocialDadoEconomiaObject = (TarifaSocialDadoEconomia) tarifaSocialDadoEconomiasIt.next();
				...
				Collection colecaoTarifaSocialDadoEconomia = fachada.pesquisar(filtroTarifaSocialDadoEconomia,
				...
				tarifaSocialDadoEconomiaObject.setTarifaSocialCartaoTipo(tarifaSocialDadoEconomiaCompleto.getTarifaSocialCartaoTipo());

				// RendaTipo
				tarifaSocialDadoEconomiaObject.setRendaTipo(tarifaSocialDadoEconomiaCompleto.getRendaTipo());
