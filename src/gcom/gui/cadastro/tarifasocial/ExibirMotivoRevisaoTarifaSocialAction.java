 ...
 * @since 16/01/2007
 */
public class ExibirMotivoRevisaoTarifaSocialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		filtroTarifaSocialRevisaoMotivo.adicionarParametro(new ParametroSimples(FiltroTarifaSocialExclusaoMotivo.INDICADOR_USO,
						ConstantesSistema.INDICADOR_USO_ATIVO));
		filtroTarifaSocialRevisaoMotivo.setCampoOrderBy(FiltroTarifaSocialExclusaoMotivo.DESCRICAO);

		Collection colecaoTarifaSocialRevisaoMotivo = fachada.pesquisar(filtroTarifaSocialRevisaoMotivo, TarifaSocialRevisaoMotivo.class
						.getName());

		sessao.setAttribute("colecaoTarifaSocialRevisaoMotivo", colecaoTarifaSocialRevisaoMotivo);
		...
		if(tarifaSocialHelper.getTarifaSocialDadoEconomia().getTarifaSocialRevisaoMotivo() != null){
			inserirMotivoRevisaoTarifaSocialActionForm.setIdMotivoRevisao(tarifaSocialHelper.getTarifaSocialDadoEconomia()
