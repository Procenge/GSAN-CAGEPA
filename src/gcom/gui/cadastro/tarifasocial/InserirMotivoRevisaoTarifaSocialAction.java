 ...
 * @since 16/01/2007
 */
public class InserirMotivoRevisaoTarifaSocialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserir");
		...
		if(tarifaSocialHelperMotivoRevisao != null){
			...
			if(idMotivoRevisao != null && !idMotivoRevisao.equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
				...
				tarifaSocialDadoEconomia
								.setQuantidadeRecadastramento((short) (tarifaSocialDadoEconomia.getQuantidadeRecadastramento() + 1));
		...
		while(colecaoTarifaSocialHelperIterator.hasNext()){
			...
			if(tarifaSocialHelper != null){
				...
				// Múltiplas Economias
					...
					if(tarifaSocialHelper.getClienteImovelEconomia().getImovelEconomia().getId().equals(
									tarifaSocialHelperMotivoRevisao.getClienteImovelEconomia().getImovelEconomia().getId())){
						colecaoTarifaSocialHelper.set(i, tarifaSocialHelperMotivoRevisao);
						break;
					}
