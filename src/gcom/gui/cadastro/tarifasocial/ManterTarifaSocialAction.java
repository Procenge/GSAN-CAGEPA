...
public class ManterTarifaSocialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("pesquisaImovel") == null){
			...
			registroAtendimento = (RegistroAtendimento) sessao.getAttribute("ra");
		...
		Collection colecaoTarifaSocialHelperAtualizar = (Collection) sessao.getAttribute("colecaoTarifaSocialHelperAtualizar");

		// Imóveis Anteriores do Usuários que foram excluídos da Tarifa Social
		Collection colecaoImoveisExcluidosTarifaSocial = (Collection) sessao.getAttribute("colecaoImoveisExcluidosTarifaSocial");
		...
		// Recadastramento
		Collection colecaoTarifasSociaisRecadastradas = (Collection) sessao.getAttribute("colecaoTarifasSociaisRecadastradas");

		fachada.manterTarifaSocial(imovelSessao, colecaoTarifaSocialHelperAtualizar, colecaoImoveisExcluidosTarifaSocial,
						colecaoTarifaSocialExcluida, colecaoTarifasSociaisRecadastradas, usuarioLogado);
		...
		if(colecaoTarifaSocialExcluida != null){
			montarPaginaSucesso(httpServletRequest, "Imóvel de matrícula " + imovelSessao.getId()
							+ " excluído da tarifa social com sucesso.", "Manter outra tarifa social",
							"exibirManterTarifaSocialAction.do?menu=sim");
		}else{
			montarPaginaSucesso(httpServletRequest, "Imóvel de matrícula " + imovelSessao.getId()
							+ " mantido na tarifa social com sucesso.", "Manter outra tarifa social",
							"exibirManterTarifaSocialAction.do?menu=sim");
		}
