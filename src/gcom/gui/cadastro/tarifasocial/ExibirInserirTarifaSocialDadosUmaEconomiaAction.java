 ...
 * @author rodrigo
 */
public class ExibirInserirTarifaSocialDadosUmaEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirTarifaSocialUmaEconomia");
		...
		if(valorConfirmacao == null || valorConfirmacao.equals("")){
			...
			String idImovel = (String) inserirTarifaSocialActionForm.get("idImovel");
			...
			filtroClienteImovelEconomia.adicionarParametro(new ParametroSimples(
							"imovelEconomia.imovelSubcategoria.comp_id.imovel.imovelPerfil.id", ImovelPerfil.TARIFA_SOCIAL));
			filtroClienteImovelEconomia.adicionarParametro(new ParametroSimples("cliente.id", cliente.getId()));
			...
			// Realiza uma pesquisa pelos parametros fornecidos
			Collection clienteImoveisEconomias = fachada.pesquisar(filtroClienteImovelEconomia, ClienteImovelEconomia.class.getName());
			...
			colecaoTarifaSocialDadoEconomia = fachada.pesquisarTarifaSocialDadoEconomia(new Integer(idImovel));
			...
			if(colecaoIdImovel != null && !colecaoIdImovel.isEmpty()){
				...
				while(iteratorColecaoImovel.hasNext()){
					...
					colecaoTarifaSocialDadoEconomiaVerificar = fachada.pesquisarTarifaSocialDadoEconomia(matriculaImovel);

					if(colecaoTarifaSocialDadoEconomiaVerificar != null && !colecaoTarifaSocialDadoEconomiaVerificar.isEmpty()){

						TarifaSocialDadoEconomia tarifaSocialDadoEconomia = (TarifaSocialDadoEconomia) colecaoTarifaSocialDadoEconomiaVerificar
										.iterator().next();
						...
						if(tarifaSocialDadoEconomia.getTarifaSocialExclusaoMotivo() != null
							...
							throw new ActionServletException("atencao.motivo_exclusao_imovel_nao_permite_recadastramento");
						}

						if(tarifaSocialDadoEconomia.getTarifaSocialRevisaoMotivo() == null
										&& tarifaSocialDadoEconomia.getTarifaSocialExclusaoMotivo() == null){

							sessao.setAttribute("prerequisito", "");

							httpServletRequest
											.setAttribute("atencao.cliente.usuario.tarifa.social",
															"/gsan/inserirTarifaSocialWizardAction.do?action=exibirInserirTarifaSocialDadosUmaEconomiaAction");

							sessao.setAttribute("prerequisito", "");

							return montarPaginaConfirmacaoWizard("atencao.cliente.usuario.tarifa.social", httpServletRequest,
											actionMapping, matriculaImovel.toString());
						}else{

							if(tarifaSocialDadoEconomia.getTarifaSocialExclusaoMotivo() == null
											&& tarifaSocialDadoEconomia.getTarifaSocialRevisaoMotivo().getIndicadorPermiteRecadastramento()
															.intValue() == 2){
			...
			if(colecaoIdImovelEconomia != null && !colecaoIdImovelEconomia.isEmpty()){
				...
				while(iteratorColecaoIdImovelEconomia.hasNext()){
					...
					colecaoTarifaSocialDadoEconomiaVerificar = fachada.pesquisarTarifaSocialDadoEconomiaImovelEconomia(idImovelEconomia);
					...
					if(colecaoTarifaSocialDadoEconomiaVerificar != null && !colecaoTarifaSocialDadoEconomiaVerificar.isEmpty()){
						...
						if(tarifaSocialDadoEconomia.getTarifaSocialRevisaoMotivo() == null
							...
							return montarPaginaConfirmacaoWizard("atencao.cliente.usuario.tarifa.social", httpServletRequest,
											actionMapping, tarifaSocialDadoEconomia.getImovel().getId().toString());
						}else{
			...
			switch(prerequisito){
				...
				case 2:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.nao_imovel.com.subcategorias", httpServletRequest,
									actionMapping, parametroMensagem, "provoca o encerramento", "Encerramento");
				...
				case 3:
					...
					return montarPaginaConfirmacaoWizard("atencao.tarifasocial.nao_imovel.com.subcategorias", httpServletRequest,
									actionMapping, parametroMensagem, "exige a tramitação", "Tramitação");
	...
	private void carregarObjetosClienteImovel(Collection clienteImoveis){
		...
		while(clienteImoveisIt.hasNext()){
			...
			Collection tarifaSocialDadoEconomias = fachada.pesquisar(filtroTarifaSocialDadoEconomia, TarifaSocialDadoEconomia.class
							.getName());
			...
			if(tarifaSocialDadoEconomias != null && !tarifaSocialDadoEconomias.isEmpty()){
				...
				while(tarifaSocialDadoEconomiasIt.hasNext()){
					...
					tarifaSocialDadoEconomiaObject.setTarifaSocialCartaoTipo(tarifaSocialDadoEconomiaObject.getTarifaSocialCartaoTipo());
