 ...
 * @created 27/12/2005
 */
public class AtualizarDadosTarifaSocialClienteActionForm
				extends ControladorInclusaoGcomActionForm {
	...
	public void setClienteImovelFimRelacaoMotivo(String clienteImovelFimRelacaoMotivo){
