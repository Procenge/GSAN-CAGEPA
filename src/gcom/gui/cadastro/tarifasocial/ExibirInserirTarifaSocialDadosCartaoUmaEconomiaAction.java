 ...
 * @author rodrigo
 */
public class ExibirInserirTarifaSocialDadosCartaoUmaEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaotarifaSocialDadoEconomia = fachada.pesquisarClientesUsuarioExistenteTarifaSocial(clienteImovel.getCliente()
						.getId());
		...
		if(sessao.getAttribute("colecaoDadosTarifaSocial") != null){
			Collection colecaoDadosTarifaSocialMemoria = (Collection) sessao.getAttribute("colecaoDadosTarifaSocial");

			if(!colecaoDadosTarifaSocialMemoria.isEmpty()){
				httpServletRequest.setAttribute("tarifaSocialDadoEconomia", Util.retonarObjetoDeColecao(colecaoDadosTarifaSocialMemoria));
			}
		}else{
			...
			Collection colecaoTarifaSocialDadoEconomia = fachada.pesquisar(filtroTarifaSocialDadoEconomia, TarifaSocialDadoEconomia.class
							.getName());

			// Se existir, é colocado no request para a página
			if(!colecaoTarifaSocialDadoEconomia.isEmpty()){
				httpServletRequest.setAttribute("tarifaSocialDadoEconomia", colecaoTarifaSocialDadoEconomia.iterator().next());
			}
		}
		...
		if(imovel != null){
			...
			if(imovel.getNumeroCelpe() != null){
				tarifaSocialCartaoActionForm.setNumeroContratoCelpe(imovel.getNumeroCelpe().toString());
			}else{
			...
			if(imovel.getNumeroIptu() != null){
				tarifaSocialCartaoActionForm.setNumeroIPTU(imovel.getNumeroIptu().toString());
			}else{
			...
			if(imovel.getAreaConstruida() != null){
				String areaConstruidaFormatada = Util.formatarMoedaReal(imovel.getAreaConstruida());
			...
			if(imovel.getAreaConstruidaFaixa() != null){
				tarifaSocialCartaoActionForm.setAreaConstruidaFaixa(imovel.getAreaConstruidaFaixa().getId().toString());
			}else{
