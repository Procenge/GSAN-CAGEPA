 ...
 * @author rodrigo
 */
public class ExibirManterTarifaSocialDadosEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(quantidadeEconomiasImovel == 1){
			...
			retorno = actionMapping.findForward("manterTarifaSocialDadosUmaEconomia");
			...
			retorno = actionMapping.findForward("manterTarifaSocialDadosMultiplasEconomias");
		}
