 ...
 * @author rodrigo
 */
public class InserirTarifaSocialDadosCartaoUmaEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirTarifaSocialDadosCartaoUmaEconomia");
		...
		String[] dado = fachada.verificarPreenchimentoInserirDadosTarifaSocial(numeroCelpeFormatado, areaConstruidaFormatada,
						numeroIptuFormatado, idImovel, form.getNumero(), form.getDataValidade(), form.getNumeroParcelas(), new Integer(form
										.getNumeroCelpe().trim().equals("") ? "0" : form.getNumeroCelpe()), form.getValorRendaFamiliar()
										.trim().equals("") ? Util.formatarMoedaRealparaBigDecimal("0") : Util
										.formatarMoedaRealparaBigDecimal(form.getValorRendaFamiliar()), form.getTipoCartao(), form
										.getTipoRenda());
		...
		if(form.getValorRendaFamiliar() != null && !form.getValorRendaFamiliar().equals("")){
			tarifaSocialDadoEconomia.setValorRendaFamiliar(Util.formatarMoedaRealparaBigDecimal(form.getValorRendaFamiliar()));
		...
		// Número do IPTU
		if(numeroIptu != null && !numeroIptu.trim().equals("")){
			idImovel = fachada.verificarNumeroIptu(numeroIptuFormatado, imovel.getId(), null, imovel.getSetorComercial().getMunicipio()
							.getId());
		...
		sessao.setAttribute("colecaoDadosTarifaSocial", colecaoDadosTarifaSocial);
