 ...
 */
public class AtualizarTarifaSocialClienteAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("voltar");
			...
			if(colecaoClienteImovel != null && !colecaoClienteImovel.isEmpty()){
				...
				while(colecaoClienteImovelIterator.hasNext()){
					...
					if(clienteImovel.getClienteRelacaoTipo() != null){
						...
						}else if(clienteImovel.getClienteRelacaoTipo().getId().toString()
										.equals(ClienteRelacaoTipo.PROPRIETARIO.toString())){
			...
			if(colecaoClienteImovelEconomia != null && !colecaoClienteImovelEconomia.isEmpty()){
				...
				while(colecaoClienteImovelEconomiaIterator.hasNext()){
					...
					if(clienteImovelEconomia.getClienteRelacaoTipo() != null){
						if(clienteImovelEconomia.getClienteRelacaoTipo().getId().toString().equals(ClienteRelacaoTipo.USUARIO.toString())){
							existeUsuario = true;
							clienteEconomiaUsuario = clienteImovelEconomia.getCliente();
						}else if(clienteImovelEconomia.getClienteRelacaoTipo().getId().toString().equals(
