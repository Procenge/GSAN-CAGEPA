...
public class FiltrarTarifaSocialCartaoTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("retornarFiltroTarifaSocialCartaoTipo");
		 ...
		 */
		FiltroTarifaSocialCartaoTipo filtroTarifaSocialCartaoTipo = new FiltroTarifaSocialCartaoTipo(FiltroTarifaSocialCartaoTipo.DESCRICAO);
		/**
		...
		httpServletRequest.setAttribute("filtroTarifaSocialCartaoTipo", filtroTarifaSocialCartaoTipo);
