 ...
 * @date 23/09/2014
 */
public class AtualizarAtendimentoProcedimentoActionForm
	...
	private String indicadorImovel;
	...
	public void setIndicadorImovel(String indicadorImovel){

		this.indicadorImovel = indicadorImovel;
	}

	public String getIndicadorImovel(){
	...
	public void setDescricaoNormaProcedimental(String descricaoNormaProcedimental){

		this.descricaoNormaProcedimental = descricaoNormaProcedimental;
	}

	public String getDescricaoNormaProcedimental(){

		return descricaoNormaProcedimental;
	}
	...
	public void setIdNormaProcedimental(String idNormaProcedimental){

		this.idNormaProcedimental = idNormaProcedimental;
	}

	public String getIdNormaProcedimental(){

		return idNormaProcedimental;
	}
