 ...
 * @date 25/09/2014
 */
public class RemoverAtualizarAdicionarAtendProcDocumentosPessoaTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarRemoverAtendProcDocumentosPessoaTipo");
		...
		if(operacao.equals("inserir")){
			...
			if(httpServletRequest.getParameter("idDocumentoTipoPessoRemovao") != null
				...
				while(iterator.hasNext()){
					...
					if(atendProcDocumentoPessoaTipo.getUltimaAlteracao().getTime() == timestamp){
						iterator.remove();
					}
				}
				sessao.setAttribute("colecaoAtendProcDocumentoPessoaTipo", colecaoAtendProcDocumentoPessoaTipo);
