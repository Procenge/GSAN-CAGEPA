...
public class ExibirManterUnidadeOrganizacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroUnidadeOrganizacional") != null){
			filtroUnidadeOrganizacional = (FiltroUnidadeOrganizacional) sessao.getAttribute("filtroUnidadeOrganizacional");

			// 1º Passo - Pegar o total de registros através de um count da
			// consulta que aparecerá na tela
			Integer totalRegistros = fachada.pesquisarUnidadeOrganizacionalFiltroCount(filtroUnidadeOrganizacional);
			...
			colecaoUnidadeOrganizacional = fachada.pesquisarUnidadeOrganizacionalFiltro(filtroUnidadeOrganizacional,
		 ...
		 * }
		 * if ((retorno !=
		 * null)&&(retorno.getName().equalsIgnoreCase("manterUnidadeOrganizacional"))) {
		 ...
		 * FiltroUnidadeOrganizacional.DESCRICAO);
		 ...
		 * (UnidadeOrganizacional)collectionUnidadeOrganizacional.iterator().next();
		 * sessao.setAttribute("idRegistroAtualizacao", new Integer
