 ...
 * @created 25/07/2006
 */
public class ExibirPesquisarUnidadeSuperiorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisa") != null
						&& httpServletRequest.getParameter("caminhoRetornoTelaPesquisa").equals(
										"exibirPesquisarUnidadeOrganizacionalAction")){
	...
	private void pesquisarLocalidade(HttpServletRequest httpServletRequest, ActionForward retorno,
		...
		filtroLocalidade.adicionarParametro(new ParametroSimples(FiltroLocalidade.ID, new Integer(pesquisarUnidadeSuperiorActionForm
						.getIdLocalidadeFilho())));
	 ...
	 * @date 16/08/2006
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, PesquisarUnidadeSuperiorActionForm pesquisarUnidadeSuperiorActionForm){
