 ...
 * @created 25/07/2006
 */
public class ExibirPesquisarUnidadeOrganizacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("tipo") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaUnidadeOrganizacional", httpServletRequest.getParameter("tipo"));
		}else{
		...
		if(httpServletRequest.getParameter("tipoUnidade") != null && !httpServletRequest.getParameter("tipoUnidade").equals("")){
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null && !httpServletRequest.getParameter("tipoConsulta").equals("")){
			...
			if(httpServletRequest.getParameter("tipoConsulta").equals("unidadeSuperior")){
				...
				pesquisarUnidadeOrganizacionalActionForm.setIdUnidadeSuperior(httpServletRequest.getParameter("idCampoEnviarDados"));

				pesquisarUnidadeOrganizacionalActionForm.setDescricaoUnidadeSuperior(httpServletRequest
				...
				pesquisarUnidadeOrganizacionalActionForm.setIdLocalidade(httpServletRequest.getParameter("idCampoEnviarDados"));

				pesquisarUnidadeOrganizacionalActionForm.setDescricaoLocalidade(httpServletRequest
								.getParameter("descricaoCampoEnviarDados"));
	...
	private void pesquisarLocalidade(HttpServletRequest httpServletRequest, ActionForward retorno,
		...
		filtroLocalidade.adicionarParametro(new ParametroSimples(FiltroLocalidade.ID, new Integer(pesquisarUnidadeOrganizacionalActionForm
						.getIdLocalidade())));
	...
	private void pesquisarUnidadeOrganizacional(HttpServletRequest httpServletRequest, ActionForward retorno,
		...
		filtroUnidadeOrganizacional.adicionarParametro(new ParametroSimples(FiltroEmpresa.ID, idUnidade));
