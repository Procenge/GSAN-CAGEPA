 ...
 * @created 26/07/2006
 */
public class PesquisarUnidadeSuperiorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		PesquisarUnidadeSuperiorActionForm pesquisarUnidadeSuperiorActionForm = (PesquisarUnidadeSuperiorActionForm) actionForm;
		...
		if(unidadeTipo != null && !unidadeTipo.trim().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
			...
			filtroUnidadeOrganizacional.adicionarParametro(new ParametroSimples(FiltroUnidadeOrganizacional.ID, unidadeTipo));
		}
		...
		colecaoUnidadeOrganizacionalSuperior = fachada.pesquisar(filtroUnidadeOrganizacional, UnidadeOrganizacional.class.getName());
