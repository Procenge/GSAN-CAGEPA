 ...
 * @date 20/11/2006
 */
public class FiltrarUnidadeOrganizacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sigla != null && !sigla.trim().equals("")){
			...
			filtroUnidadeOrganizacional.adicionarParametro(new ComparacaoTexto(FiltroUnidadeOrganizacional.SIGLA, sigla));
		}
		...
		if(unidadeCentralizadora != null && !unidadeCentralizadora.trim().equals("")){
		...
		if(meioSolicitacao != null && !meioSolicitacao.trim().equals("")){
		...
		if(indicadorUso != null && !indicadorUso.trim().equals("")){
			...
			if(!indicadorUso.trim().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
				filtroUnidadeOrganizacional
								.adicionarParametro(new ParametroSimples(FiltroUnidadeOrganizacional.INDICADOR_USO, indicadorUso));
			}
		}
