 ...
 * @date 20/11/2006
 */
public class ExibirFiltrarUnidadeOrganizacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(consultaUnidadeSuperior != null && !consultaUnidadeSuperior.trim().equalsIgnoreCase("")
			...
			// Pesquisa de acordo com os parâmetros informados no filtro
			Collection colecaoUnidadeSuperior = fachada.pesquisar(filtroUnidadeOrganizacional, UnidadeOrganizacional.class.getName());
		...
		if(sessao.getAttribute("colecaoTipoUnidade") == null && sessao.getAttribute("colecaoGerenciaRegional") == null
						&& sessao.getAttribute("colecaoEmpresa") == null && sessao.getAttribute("colecaoUnidadeCentralizadora") == null
			...
			Collection colecaoTipoUnidade = fachada.pesquisar(filtroUnidadeTipo, UnidadeTipo.class.getName());
			...
			Collection colecaoUnidadeCentralizadora = fachada.pesquisar(filtroUnidadeOrganizacional, UnidadeOrganizacional.class.getName());
