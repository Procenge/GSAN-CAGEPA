 ...
 * @author rossiter
 */
public class PesquisarLogradouroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("pesquisarLogradouro");
		...
		String codigoMunicipioJSP = exibirPesquisarLogradouroActionForm.getCodigoMunicipio();
		String nomeJSP = exibirPesquisarLogradouroActionForm.getNome();
		String nomepopularJSP = exibirPesquisarLogradouroActionForm.getNomePopular();
		String logradouroTipoJSP = exibirPesquisarLogradouroActionForm.getTipoLogradouro();
		String logradouroTituloJSP = exibirPesquisarLogradouroActionForm.getTitulo();
		String cep = exibirPesquisarLogradouroActionForm.getCep();
		String codigoBairroJSP = exibirPesquisarLogradouroActionForm.getCodigoBairro();
		String tipoPesquisa = exibirPesquisarLogradouroActionForm.getTipoPesquisa();
		String tipoPesquisaPopular = exibirPesquisarLogradouroActionForm.getTipoPesquisaPopular();
		...
		if(codigoMunicipioJSP != null && !codigoMunicipioJSP.equalsIgnoreCase("")){

			filtroMunicipio.adicionarParametro(new ParametroSimples(FiltroMunicipio.ID, new Integer(codigoMunicipioJSP)));
			...
			throw new ActionServletException("atencao.pesquisa.logradouro_codigo_nome_municipio");
		}

		// Validando o campo código e o campo nome do Bairro
		if(codigoBairroJSP != null && !codigoBairroJSP.equalsIgnoreCase("")){

			filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.ID, new Integer(codigoBairroJSP)));
		...
		if(cep == null || cep.trim().equals("")){
			...
			if(logradouroTipoJSP != null && !logradouroTipoJSP.equalsIgnoreCase(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO))){
				peloMenosUmParametroInformado = true;
				// filtroLogradouro.adicionarParametro(new ParametroSimples(
			...
			if(logradouroTituloJSP != null && !logradouroTituloJSP.equalsIgnoreCase(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO))){
				peloMenosUmParametroInformado = true;
				// filtroLogradouro.adicionarParametro(new ParametroSimples(
			...
			if(colecaoCep.isEmpty()){
				...
				throw new ActionServletException("atencao.pesquisa.cep_inexistente");
			}

			/**
			 * //caminho da entidades a serem carregadas
			 ...
			 * filtroLogradouroCep.adicionarCaminhoParaCarregamentoEntidade(
			 * "logradouro.logradouroTitulo");
			 * filtroLogradouroCep.adicionarCaminhoParaCarregamentoEntidade(
			 * "logradouro.logradouroTipo");
			 * filtroLogradouroCep.adicionarCaminhoParaCarregamentoEntidade("logradouro.municipio");
			 * //cep filtroLogradouroCep.adicionarParametro(new
			 * ParametroSimples(FiltroLogradouroCep.CODIGO_CEP, cep));
			 */
		...
		Integer totalRegistros = fachada.pesquisarLogradouroCompletoCount(codigoMunicipioJSP, codigoBairroJSP, nomeJSP, nomepopularJSP,
						logradouroTipoJSP, logradouroTituloJSP, cep, "", "", tipoPesquisa, tipoPesquisaPopular);
		...
		colecaoLogradouro = fachada.pesquisarLogradouroCompleto(codigoMunicipioJSP, codigoBairroJSP, nomeJSP, nomepopularJSP,
						logradouroTipoJSP, logradouroTituloJSP, cep, "", "", tipoPesquisa, tipoPesquisaPopular,
