 ...
 * @date 03/05/2006
 */
public class SelecionarCepActionForm
				extends ActionForm {
	...
	public String getCodigoLado(){

		return codigoLado;
	}

	public void setCodigoLado(String codigoLado){

		this.codigoLado = codigoLado;
	}
