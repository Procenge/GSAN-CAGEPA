 ...
 * @date 28/06/2006
 */
public class ExibirManterLogradouroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// FiltroLogradouro filtroLogradouro = null;
		...
		String nomeLogradouro = (String) pesquisarActionForm.get("nomeLogradouro");
		String nomePopularLogradouro = (String) pesquisarActionForm.get("nomePopularLogradouro");
		...
		if(httpServletRequest.getAttribute("filtroLogradouro") != null){
			// filtroLogradouro = (FiltroLogradouro) httpServletRequest
			// .getAttribute("filtroLogradouro");
		}else{
			...
			// de filtragem
			// filtroLogradouro = new FiltroLogradouro();
		...
		if(retorno.getName().equalsIgnoreCase("manterLogradouro")){
			...
			Integer totalRegistros = fachada.pesquisarLogradouroCompletoCount(idMunicipio, idBairro, nomeLogradouro, nomePopularLogradouro,
							idTipoLogradouro, idTituloLogradouro, codigoCep, idLogradouro, indicadorUso, tipoPesquisa, tipoPesquisaPopular);
			...
			Collection colecaoLogradouro = fachada.pesquisarLogradouroCompleto(idMunicipio, idBairro, nomeLogradouro,
							nomePopularLogradouro, idTipoLogradouro, idTituloLogradouro, codigoCep, idLogradouro, indicadorUso,
							tipoPesquisa, tipoPesquisaPopular, (Integer) httpServletRequest.getAttribute("numeroPaginasPesquisa"));

			Collection colecaoLogradouroRelatorio = fachada.pesquisarLogradouroCompletoRelatorio(idMunicipio, idBairro, nomeLogradouro,
							nomePopularLogradouro, idTipoLogradouro, idTituloLogradouro, codigoCep, idLogradouro, indicadorUso,
							tipoPesquisa, tipoPesquisaPopular);

			sessao.setAttribute("logradouros", colecaoLogradouro);

			sessao.setAttribute("logradourosRelatorio", colecaoLogradouroRelatorio);

			String atualizar = (String) sessao.getAttribute("atualizar");

			if(atualizar != null && colecaoLogradouro != null && colecaoLogradouro.size() == 1){
				retorno = actionMapping.findForward("atualizarLogradouro");
				Logradouro logradouro = (Logradouro) colecaoLogradouro.iterator().next();
				httpServletRequest.setAttribute("idRegistroAtualizacao", logradouro.getId());
			}
		}
		return retorno;
	}
