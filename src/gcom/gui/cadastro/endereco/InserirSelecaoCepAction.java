...
/**
 * Esta classe tem por finalidade incluir os CEPs que foram selecionados pelo usuário na coleção
 * final
 * 
 * @author Raphael Rossiter
 * @date 03/05/2006
 */
public class InserirSelecaoCepAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(tipoRetorno != null && !tipoRetorno.trim().equalsIgnoreCase("")){
			...
			if(sessao.getAttribute("colecaoCepSelecionados") != null){
				...
				Collection colecaoCepSelecionados = (Collection) sessao.getAttribute("colecaoCepSelecionados");
				...
				if(selecionarCepActionForm.getIdCepSelecao() != null){
					...
					while(cepSelecionados.length > indexArray){
						...
						colecaoCepSelecionadosIterator = colecaoCepSelecionados.iterator();

						while(colecaoCepSelecionadosIterator.hasNext()){

							cepInserir = (Cep) colecaoCepSelecionadosIterator.next();
					...
					if(sessao.getAttribute("colecaoCepSelecionadosUsuario") != null){
						...
						Collection colecaoCepSelecionadosUsuarioSessao = (Collection) sessao.getAttribute("colecaoCepSelecionadosUsuario");
