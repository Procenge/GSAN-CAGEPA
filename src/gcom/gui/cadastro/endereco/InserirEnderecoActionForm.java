...
public class InserirEnderecoActionForm
				extends ActionForm {
	...
	public void setObjetoClienteEnderecoSelecionado(String objetoClienteEnderecoSelecionado){
	...
	/**
	 * @param codigoCepUnico
	 *            O codigoCepUnico a ser setado.
	 */
