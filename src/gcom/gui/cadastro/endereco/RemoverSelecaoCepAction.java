...
/**
 * Esta classe tem por finalidade remover os CEPs que foram selecionados pelo usuário na coleção
 * final
 * 
 * @author Raphael Rossiter
 * @date 03/05/2006
 */
public class RemoverSelecaoCepAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("colecaoCepSelecionados") != null){
			...
			Collection colecaoCepSelecionadosUsuario = (Collection) sessao.getAttribute("colecaoCepSelecionados");
