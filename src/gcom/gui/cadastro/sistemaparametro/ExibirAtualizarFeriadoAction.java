...
public class ExibirAtualizarFeriadoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(tipoFeriado.equals("2")){
			...
			if((idMunicipio != null && !idMunicipio.equals(""))
							&& (httpServletRequest.getParameter("pesquisa") != null && httpServletRequest.getParameter("pesquisa").equals(
											"S"))){
				...
				if(municipioFeriado == null){
					...
					if(idFeriado != null && !idFeriado.equals("")){
						...
						Collection colecaoMunicipioFeriado = fachada.pesquisar(filtroMunicipioFeriado, MunicipioFeriado.class.getName());
			...
			if(nacionalFeriado == null){
				...
				if(idFeriado != null && !idFeriado.equals("")){
					...
					Collection colecaoFeriado = fachada.pesquisar(filtroNacionalFeriado, NacionalFeriado.class.getName());
			...
			if(nacionalFeriado.getAbrangencia().equals(NacionalFeriado.ESTADUAL)){
				atualizarFeriadoActionForm.setIndicadorTipoFeriado("3");
			}else{
				atualizarFeriadoActionForm.setIndicadorTipoFeriado(tipoFeriado);
			}
