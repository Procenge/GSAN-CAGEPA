...
public class InserirFeriadoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(municipio != null && !municipio.trim().equals("")){
			...
			if(inserirFeriadoActionForm.getIndicadorTipoFeriado().equals("1")){
				nomeFeriado = "Nacional";
			}else{
				nomeFeriado = "Estadual";
			}
			tipoFeriado = "1";
		}
		...
		montarPaginaSucesso(httpServletRequest, "Feriado " + nomeFeriado + " de código " + idFeriado + " inserido com sucesso.",
						"Inserir outro Feriado", "exibirInserirFeriadoAction.do?menu=sim", "exibirAtualizarFeriadoAction.do?tipoFeriado="
										+ tipoFeriado + "&idRegistroInseridoAtualizar=" + idFeriado, "Atualizar Feriado Inserido");
