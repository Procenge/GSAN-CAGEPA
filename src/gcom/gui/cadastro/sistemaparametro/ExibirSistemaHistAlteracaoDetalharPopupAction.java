...
public class ExibirSistemaHistAlteracaoDetalharPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		SistemaHistoricoAlteracaoDetalharPopupActionForm sistemaHistoricoAlteracaoDetalharPopupActionForm = (SistemaHistoricoAlteracaoDetalharPopupActionForm) actionForm;
		...
		if(sistemaAlteracaoHistorico == null){
			...
			if(idSistemaAlteracaoHistorico != null && !idSistemaAlteracaoHistorico.equals("")){
				...
				filtroSistemaAlteracaoHistorico.adicionarParametro(new ParametroSimples(FiltroSistemaAlteracaoHistorico.ID,
								idSistemaAlteracaoHistorico));

				Collection colecaoSistemaAlteracaoHistorico = fachada.pesquisar(filtroSistemaAlteracaoHistorico,
		...
		sistemaHistoricoAlteracaoDetalharPopupActionForm.setDescricaoFuncionalidade(""
						+ sistemaAlteracaoHistorico.getFuncionalidade().getDescricao());
