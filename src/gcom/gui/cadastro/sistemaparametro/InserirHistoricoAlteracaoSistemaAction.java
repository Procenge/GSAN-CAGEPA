 ...
 * @since 30/03/2006
 */
public class InserirHistoricoAlteracaoSistemaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		funcionalidade.setId(new Integer(inserirHistoricoAlteracaoSistemaActionForm.getIdFuncionalidade()));

		sistemaAlteracaoHistorico.setFuncionalidade(funcionalidade);

		sistemaAlteracaoHistorico.setNome(inserirHistoricoAlteracaoSistemaActionForm.getTituloAlteracao());

		sistemaAlteracaoHistorico.setDescricao(inserirHistoricoAlteracaoSistemaActionForm.getDescricao());
		...
		if(inserirHistoricoAlteracaoSistemaActionForm.getDataAlteracao() != null
						&& !inserirHistoricoAlteracaoSistemaActionForm.getDataAlteracao().equals("")){
			sistemaAlteracaoHistorico.setData(Util.converteStringParaDate(inserirHistoricoAlteracaoSistemaActionForm.getDataAlteracao()));
		}

		// Insere um Historico Alteração de Sistema na base, mas fazendo, antes,
		// algumas verificações no ControladorCadastroSEJB.
		fachada.inserirHistoricoAlteracaoSistema(sistemaAlteracaoHistorico);

		// Exibe a página de sucesso
		montarPaginaSucesso(httpServletRequest, "Histórico de Alterações do Sistema " + sistemaAlteracaoHistorico.getDescricao()
