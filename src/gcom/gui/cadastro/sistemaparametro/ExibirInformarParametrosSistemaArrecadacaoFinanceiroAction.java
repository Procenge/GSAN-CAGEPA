 ...
 * @date 09/01/2007
 */
public class ExibirInformarParametrosSistemaArrecadacaoFinanceiroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirInformarParametrosSistemaArrecadacaoFinanceiro");
