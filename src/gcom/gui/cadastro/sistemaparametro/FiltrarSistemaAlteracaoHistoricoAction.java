...
public class FiltrarSistemaAlteracaoHistoricoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(idFuncionalidade != null && !idFuncionalidade.trim().equals("")){
			...
			if(descricaoFuncionalidade == null || descricaoFuncionalidade.equals("")){
				...
				filtroTabelaAuxiliarAbreviada.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliarAbreviada.ID, idFuncionalidade));
			...
			filtroSistemaAlteracaoHistorico.adicionarParametro(new ParametroSimples(FiltroSistemaAlteracaoHistorico.ID_FUNCIONALIDADE,
							idFuncionalidade));
