...
public class AtualizarFeriadoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		 ...
		 * !atualizarFeriadoActionForm.getIdMunicipio().equals(""))) {
		 * FiltroTabelaAuxiliarAbreviada filtroTabelaAuxiliarAbreviada = new
		 * FiltroTabelaAuxiliarAbreviada();
		 * filtroTabelaAuxiliarAbreviada.adicionarParametro(new
		 * ParametroSimples(FiltroTabelaAuxiliarAbreviada.ID,
		 * atualizarFeriadoActionForm.getIdMunicipio()));
		 * Collection colecaoMunicipio =
		 * fachada.pesquisar(filtroTabelaAuxiliarAbreviada,Municipio.class.getName());
		...
		if(atualizarFeriadoActionForm.getIdMunicipio() != null && !atualizarFeriadoActionForm.getIdMunicipio().trim().equals("")){
			...
			if(atualizarFeriadoActionForm.getIndicadorTipoFeriado().equals("1")){
