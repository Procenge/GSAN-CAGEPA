...
public class FiltrarFeriadoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(indicadorTipoFeriado.equals("1") || indicadorTipoFeriado.equals("4")){

			// Indicador de Tipo do feriado
			peloMenosUmParametroInformado = true;

			// Data do Feriado
			if((form.getDataFeriadoInicio() != null && form.getDataFeriadoFim() != null)
							&& (!form.getDataFeriadoInicio().equalsIgnoreCase("") && !form.getDataFeriadoFim().equalsIgnoreCase(""))){
			...
			if(form.getIdMunicipio() != null && !form.getIdMunicipio().trim().equals("")){
				...
				if(descricaoMunicipio == null || descricaoMunicipio.equals("")){
					...
					filtroTabelaAuxiliarAbreviada.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliarAbreviada.ID, idMunicipio));
		...
		Integer totalRegistros = fachada.pesquisarFeriadoCount(Short.parseShort(indicadorTipoFeriado), descricaoFeriado, dataFeriadoInicio,
						dataFeriadoFim, idMunicipio);

		retorno = this.controlarPaginacao(httpServletRequest, retorno, totalRegistros);

		Collection colecaoFeriado = fachada.pesquisarFeriado(Short.parseShort(indicadorTipoFeriado), descricaoFeriado, dataFeriadoInicio,
		...
		if(colecaoFeriado != null && !colecaoFeriado.isEmpty()){
			...
			sessao.setAttribute("parametrosfiltroferiado", form);
		}else{
