 ...
 * @date 08/07/2006
 */
public class FiltrarQuadraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("retornarFiltroQuadra");
		...
		String bairroCD = filtrarQuadraActionForm.getBairroCD();
		...
		if(localidadeID != null && !localidadeID.equalsIgnoreCase("")){
			...
			filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.ID_LOCALIDADE, new Integer(localidadeID)));
		}
		...
		if(setorComercialCD != null && !setorComercialCD.equalsIgnoreCase("")){
			...
			peloMenosUmParametroInformado = true;
			filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.CODIGO_SETORCOMERCIAL, new Integer(setorComercialCD)));
		}

		if(bairroCD != null && !bairroCD.equalsIgnoreCase("")){
			pesquisarBairro(filtrarQuadraActionForm, fachada, bairroCD, setorComercialCD, localidadeID);
			peloMenosUmParametroInformado = true;
			filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.CD_BAIRRO, new Integer(bairroCD)));
		}

		if(quadraNM != null && !quadraNM.equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.NUMERO_QUADRA, new Integer(quadraNM)));
		}
		/*
		 * if (bairroNome != null && !bairroNome.equalsIgnoreCase("")) {
		 * peloMenosUmParametroInformado = true; if (tipoPesquisa != null &&
		 ...
		 * FiltroQuadra.NOME_BAIRRO, bairroNome)); } else {
		...
		if(indicadorUso != null && !indicadorUso.equalsIgnoreCase("") && !indicadorUso.equalsIgnoreCase("3")){
			...
			if(indicadorUso.equalsIgnoreCase(String.valueOf(ConstantesSistema.INDICADOR_USO_ATIVO))){
				...
				filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.INDICADORUSO, ConstantesSistema.INDICADOR_USO_DESATIVO));
			}
		}
		...
		filtroQuadra.setCampoOrderBy(FiltroQuadra.NUMERO_QUADRA, FiltroQuadra.DESCRICAO_LOCALIDADE);
	...
	private void pesquisarBairro(FiltrarQuadraActionForm filtrarQuadraActionForm, Fachada fachada, String bairroCD,
					String setorComercialCD, String localidadeID){
		...
		if(localidadeID == null || localidadeID.trim().equalsIgnoreCase("")){
			...
			filtrarQuadraActionForm.setBairroCD("");
			filtrarQuadraActionForm.setBairroID("");
			filtrarQuadraActionForm.setSetorComercialNome("Informe Localidade.");
			throw new ActionServletException("atencao.campo_selecionado.obrigatorio", null, "Localidade");

		}else if(setorComercialCD == null || setorComercialCD.trim().equalsIgnoreCase("")){
			filtrarQuadraActionForm.setSetorComercialCD("");
			filtrarQuadraActionForm.setSetorComercialID("");
			filtrarQuadraActionForm.setBairroCD("");
			filtrarQuadraActionForm.setBairroID("");
			filtrarQuadraActionForm.setSetorComercialNome("Informe Setor Comercial.");
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				filtrarQuadraActionForm.setBairroCD("");
				filtrarQuadraActionForm.setBairroID("");
				filtrarQuadraActionForm.setSetorComercialNome("Setor comercial inexistente.");
				throw new ActionServletException("atencao.setor_comercial_nao_existe");
			}else{
				SetorComercial objetoSetor = (SetorComercial) Util.retonarObjetoDeColecao(colecaoPesquisa);
				FiltroBairro filtroBairro = new FiltroBairro();
				filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.MUNICIPIO_ID, objetoSetor.getMunicipio().getId()));
				filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.CODIGO, bairroCD));
				colecaoPesquisa = fachada.pesquisar(filtroBairro, Bairro.class.getName());

				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					filtrarQuadraActionForm.setBairroID("");
					filtrarQuadraActionForm.setBairroNome("Bairro inexistente.");
					...
					filtrarQuadraActionForm.setBairroID(String.valueOf(objetoBairro.getId()));
					filtrarQuadraActionForm.setBairroNome(objetoBairro.getNome());
				}
			}
	...
	private void pesquisarLocalidade(FiltrarQuadraActionForm filtrarQuadraActionForm, Fachada fachada, String localidadeID){
		...
		if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
			...
			filtrarQuadraActionForm.setLocalidadeNome("Localidade inexistente.");

			throw new ActionServletException("atencao.pesquisa_inexistente", null, "Localidade");

		}else{
			Localidade objetoLocalidade = (Localidade) Util.retonarObjetoDeColecao(colecaoPesquisa);
			filtrarQuadraActionForm.setLocalidadeID(String.valueOf(objetoLocalidade.getId()));
			filtrarQuadraActionForm.setLocalidadeNome(objetoLocalidade.getDescricao());

		}

	}

	private void pesquisarSetorComercial(FiltrarQuadraActionForm filtrarQuadraActionForm, Fachada fachada, String setorComercialCD,
					String localidadeID){
		...
		if(localidadeID == null || localidadeID.trim().equalsIgnoreCase("")){
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				filtrarQuadraActionForm.setSetorComercialCD(String.valueOf(objetoSetorComercial.getCodigo()));
				filtrarQuadraActionForm.setSetorComercialID(String.valueOf(objetoSetorComercial.getId()));
				filtrarQuadraActionForm.setSetorComercialNome(objetoSetorComercial.getDescricao());
