...
public class ExibirFiltrarSetorComercialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("exibirFiltrarSetorComercial");
		...
		if(objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("")){
			...
			switch(Integer.parseInt(objetoConsulta)){
				...
				case 1:
					...
					localidadeID = pesquisarFiltrarSetorComercialActionForm.getLocalidadeID();
					...
					if(localidadeID != null && !localidadeID.equalsIgnoreCase("")){
						...
						if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
							...
							pesquisarFiltrarSetorComercialActionForm.setLocalidadeNome("Localidade Inexistente.");
							httpServletRequest.setAttribute("nomeCampo", "localidadeID");
						}else{
							httpServletRequest.setAttribute("corLocalidade", "valor");
							Localidade objetoLocalidade = (Localidade) Util.retonarObjetoDeColecao(colecaoPesquisa);
							pesquisarFiltrarSetorComercialActionForm.setLocalidadeID(String.valueOf(objetoLocalidade.getId()));
							pesquisarFiltrarSetorComercialActionForm.setLocalidadeNome(objetoLocalidade.getDescricao());
				...
				case 3:
					...
					if(municipioID != null && !municipioID.equalsIgnoreCase("")){
						...
						if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
							...
							pesquisarFiltrarSetorComercialActionForm.setMunicipioNome("Município Inexistente.");
							...
							pesquisarFiltrarSetorComercialActionForm.setMunicipioID(String.valueOf(objetoMunicipio.getId()));
							pesquisarFiltrarSetorComercialActionForm.setMunicipioNome(objetoMunicipio.getNome());
			...
			pesquisarFiltrarSetorComercialActionForm.setSetorComercialNome("");
