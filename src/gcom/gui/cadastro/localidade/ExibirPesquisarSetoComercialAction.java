 ...
 * @author Flávio
 */
public class ExibirPesquisarSetoComercialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idLocalidade = (String) httpServletRequest.getParameter("idLocalidade");
		...
		if(pesquisarActionForm.get("tipoPesquisaDescricao") == null || pesquisarActionForm.get("tipoPesquisaDescricao").equals("")){

			pesquisarActionForm.set("tipoPesquisaDescricao", ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());

		}

		if(pesquisarActionForm.get("tipoPesquisaMunicipio") == null || pesquisarActionForm.get("tipoPesquisaMunicipio").equals("")){

			pesquisarActionForm.set("tipoPesquisaMunicipio", ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
