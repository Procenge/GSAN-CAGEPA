...
public class RemoverQuadraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String[] selecaoQuadra = filtrarQuadraActionForm.getQuadraID();
		...
		if(selecaoQuadra == null || selecaoQuadra.length < 1){
			...
			// fachada.remover(selecaoQuadra, Quadra.class.getName(),operacaoEfetuada,
			// colecaoUsuarios);
		}

		montarPaginaSucesso(httpServletRequest, selecaoQuadra.length + " Quadra(s) removida(s) com sucesso.",
