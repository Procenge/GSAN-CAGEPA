...
public class PesquisarAtualizarSetorComercialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(colecaoPesquisa != null && !colecaoPesquisa.isEmpty()){
			if(atualizar != null && colecaoPesquisa.size() == 1){
				...
				httpServletRequest.setAttribute("setorComercialID", setorComercial.getId());

				retorno = actionMapping.findForward("exibirManterSetorComercialAction");

			}else{
				retorno = actionMapping.findForward("pesquisarAtualizarSetorComercial");

				Collection setoresComercial = null;
				// Aciona o controle de paginação para que sejam pesquisados apenas
				// os registros que aparecem na página
				Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroSetorComercial, SetorComercial.class.getName());
