 ...
 */
public class PesquisarEloAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(idGerencia != null && !idGerencia.trim().equalsIgnoreCase("")
						&& !idGerencia.trim().equalsIgnoreCase(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO))){

			peloMenosUmParametroInformado = true;
			filtroLocalidade.adicionarParametro(new ParametroSimples(FiltroLocalidade.ID_GERENCIA, new Integer(idGerencia)));
		}

		filtroLocalidade.adicionarParametro(new ComparacaoCampos(FiltroLocalidade.ID, "localidade"));
		...
		if(elos != null && !elos.isEmpty()){
			...
			throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, "Elo");
		}
