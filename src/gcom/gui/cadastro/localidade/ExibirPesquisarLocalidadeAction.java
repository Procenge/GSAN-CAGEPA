...
public class ExibirPesquisarLocalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("pesquisarLocalidade");
		...
		String idGerenciaRegional = (String) httpServletRequest.getParameter("idGerenciaRegional");

		if(Util.verificarIdNaoVazio(idGerenciaRegional)){

			pesquisarActionForm.set("idGerenciaRegional", idGerenciaRegional);
			pesquisarActionForm.set("desabilitarGerenciaRegional", "1");
		}else if(Util.isVazioOuBranco(pesquisarActionForm.get("desabilitarGerenciaRegional"))){

			pesquisarActionForm.set("desabilitarGerenciaRegional", "2");
		}
		...
		Collection gerencias = fachada.pesquisar(filtroGerenciaRegional, GerenciaRegional.class.getName());
		...
		if(sessao.getAttribute("unidadesNegocios") == null){
			...
			if(colecaoUnidadeNegocio == null || colecaoUnidadeNegocio.isEmpty()){
				...
				sessao.setAttribute("unidadesNegocios", colecaoUnidadeNegocio);
			}
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisa") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaLocalidade", httpServletRequest.getParameter("caminhoRetornoTelaPesquisa"));
		}
