 ...
 * @since 31/10/2006
 */
public class ExibirManterGerenciaRegionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroGerenciaRegional filtroGerenciaRegional = (FiltroGerenciaRegional) sessao.getAttribute("filtroGerenciaRegional");
		...
		if(filtroGerenciaRegional != null && !filtroGerenciaRegional.equals("")){
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroGerenciaRegional, GerenciaRegional.class.getName());
			colecaoGerenciaRegional = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoGerenciaRegional != null && !colecaoGerenciaRegional.isEmpty()){
			...
			if(colecaoGerenciaRegional.size() == 1
				...
				if(httpServletRequest.getParameter("indicadorAtualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarGerenciaRegional");
					...
					sessao.setAttribute("gerenciaRegional", colecaoGerenciaRegional);
				}
			}else{
				httpServletRequest.setAttribute("colecaoGerenciaRegional", colecaoGerenciaRegional);
			}
