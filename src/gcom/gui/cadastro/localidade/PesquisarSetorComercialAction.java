 ...
 * @author Flávio
 */
public class PesquisarSetorComercialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("listaSetorComercial");
		...
		String descricaoMunicipio = (String) pesquisarActionForm.get("descricaoMunicipio");
		...
		if(descricao != null && !descricao.trim().equalsIgnoreCase("")){
			if(tipoPesquisaDescricao != null && tipoPesquisaDescricao.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				filtroSetorComercial.adicionarParametro(new ComparacaoTextoCompleto(FiltroSetorComercial.DESCRICAO, descricao));
			}else{
				filtroSetorComercial.adicionarParametro(new ComparacaoTexto(FiltroSetorComercial.DESCRICAO, descricao));
			}
			peloMenosUmParametroInformado = true;
		}
		if(descricaoMunicipio != null && !descricaoMunicipio.trim().equalsIgnoreCase("")){
			if(tipoPesquisaMunicipio != null && tipoPesquisaMunicipio.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				filtroSetorComercial.adicionarParametro(new ComparacaoTextoCompleto(FiltroSetorComercial.DESCRICAO_MUNICIPIO,
								descricaoMunicipio));
			}else{
				filtroSetorComercial.adicionarParametro(new ComparacaoTexto(FiltroSetorComercial.DESCRICAO_MUNICIPIO, descricaoMunicipio));
			}
			peloMenosUmParametroInformado = true;
		}
		...
		if(setorComerciais != null && !setorComerciais.isEmpty()){
			...
			throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, "setor comercial");
		}
