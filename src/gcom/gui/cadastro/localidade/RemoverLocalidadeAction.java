...
public class RemoverLocalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String[] selecaoLocalidade = filtrarLocalidadeActionForm.getLocalidadeSelectID();
		...
		if(selecaoLocalidade == null || selecaoLocalidade.length < 1){
			...
			fachada.removerLocalidade(selecaoLocalidade, usuario);
		}

		montarPaginaSucesso(httpServletRequest, selecaoLocalidade.length + " Localidade(s) removida(s) com sucesso.",
