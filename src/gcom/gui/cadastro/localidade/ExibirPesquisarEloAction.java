...
public class ExibirPesquisarEloAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idGerencia = (String) httpServletRequest.getParameter("idGerencia");
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisa") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaElo", httpServletRequest.getParameter("caminhoRetornoTelaPesquisa"));
		}
