...
public class AtualizarGerenciaRegionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Gerência Regional de código " + gerenciaRegional.getId().toString()
						+ " realizada com sucesso.", "Realizar outra Manutenção de Gerência Regional",
