 ...
 * @author Flávio
 */
public class ExibirPesquisarQuadraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("idSetorComercial") != null
						&& !httpServletRequest.getParameter("idSetorComercial").trim().equalsIgnoreCase("")){
		...
		if(httpServletRequest.getParameter("idLocalidade") != null
						&& !httpServletRequest.getParameter("idLocalidade").trim().equalsIgnoreCase("")){
		...
		if(httpServletRequest.getParameter("codigoSetorComercial") != null
						&& !httpServletRequest.getParameter("codigoSetorComercial").trim().equalsIgnoreCase("")){
		...
		sessao.setAttribute("tipoPesquisa", sessao.getAttribute("tipoPesquisa"));
		...
		// Utilizado para forçar o retorno dos sete parâmetros da tela
		if(httpServletRequest.getParameter("retornarSeteParametros") != null && sessao.getAttribute("retornarSeteParametros") == null){
			sessao.setAttribute("retornarSeteParametros", httpServletRequest.getParameter("retornarSeteParametros"));
		}
