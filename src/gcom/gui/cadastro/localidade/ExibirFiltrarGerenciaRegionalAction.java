 ...
 */
public class ExibirFiltrarGerenciaRegionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(filtrarGerenciaRegionalActionForm.getTipoPesquisa() == null
						|| filtrarGerenciaRegionalActionForm.getTipoPesquisa().equalsIgnoreCase("")){
			filtrarGerenciaRegionalActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
		}
