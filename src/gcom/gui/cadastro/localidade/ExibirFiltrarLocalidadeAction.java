...
public class ExibirFiltrarLocalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("colecaoGerenciaRegional") == null){
			...
			if(Util.isVazioOuBrancoOuZero(colecaoPesquisa)){
				...
				while(iterator.hasNext()){
					...
					gerenciaRegional.setNome(gerenciaRegional.getNome());
		...
		try{
			...
			if(!ConstantesSistema.NUMERO_NAO_INFORMADO_STRING.equals(indicadorConcessionaria)){
				...
				Collection colecaoConcessionaria = this.getFachada().pesquisar(filtroConcessionaria, Concessionaria.class.getName());

				if(Util.isVazioOuBrancoOuZero(colecaoConcessionaria)){
			...
			switch(Integer.parseInt(objetoConsulta)){
				...
				case 2:
					...
					if(idUnidadeNegocio != null && !idUnidadeNegocio.equals(ConstantesSistema.NUMERO_NAO_INFORMADO + "")){
						...
						filtroGerenciaRegional.adicionarParametro(new ParametroSimples(FiltroGerenciaRegional.ID, unidadeNegocio
		...
		&& httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")){
			...
			filtrarLocalidadeActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
			filtrarLocalidadeActionForm.setIdUnidadeNegocio("" + ConstantesSistema.NUMERO_NAO_INFORMADO);
			filtrarLocalidadeActionForm.setGerenciaID("" + ConstantesSistema.NUMERO_NAO_INFORMADO);

			sessao.setAttribute("indicadorAtualizar", "1");
		}

		if(filtrarLocalidadeActionForm.getIndicadorUso() == null || filtrarLocalidadeActionForm.getIndicadorUso().equalsIgnoreCase("")){
			filtrarLocalidadeActionForm.setIndicadorUso("3");
		}

		if(filtrarLocalidadeActionForm.getTipoPesquisa() == null || filtrarLocalidadeActionForm.getTipoPesquisa().equalsIgnoreCase("")){
			filtrarLocalidadeActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
		}
