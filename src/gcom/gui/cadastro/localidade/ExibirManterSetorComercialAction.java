...
public class ExibirManterSetorComercialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// PesquisarFiltrarSetorComercialActionForm pesquisarFiltrarSetorComercialActionForm =
		// (PesquisarFiltrarSetorComercialActionForm) actionForm;
		...
		if(colecaoPesquisa != null && !colecaoPesquisa.isEmpty()){
			if(atualizar != null && colecaoPesquisa.size() == 1){
				...
				retorno = actionMapping.findForward("atualizarSetorComercial");

			}else{
				retorno = actionMapping.findForward("manterSetorComercial");
