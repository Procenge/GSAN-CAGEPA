 ...
 * @date 20/11/2006
 */
public class ExibirFotoAnormalidadeEloAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		filtroImovelEloAnormalidade.adicionarParametro(new ParametroSimples(FiltroImovelEloAnormalidade.ID, imovelEloAnormalidade));
		Collection cImovelEloAnormalidade = fachada.pesquisar(filtroImovelEloAnormalidade, ImovelEloAnormalidade.class.getName());
