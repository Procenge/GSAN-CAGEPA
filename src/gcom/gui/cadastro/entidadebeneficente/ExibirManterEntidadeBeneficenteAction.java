...
public class ExibirManterEntidadeBeneficenteAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroEntidadeBeneficente filtro = (FiltroEntidadeBeneficente) sessao.getAttribute("filtroEntidadeBeneficente");
		...
		// aparecem na página
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtro, EntidadeBeneficente.class.getName());
		...
		if(colecaoEntidadeBeneficente != null && !colecaoEntidadeBeneficente.isEmpty()){
			...
			if(colecaoEntidadeBeneficente.size() == 1
				...
				if(httpServletRequest.getParameter("checkAtualizar") != null){
					retorno = actionMapping.findForward("atualizarEntidadeBeneficente");
