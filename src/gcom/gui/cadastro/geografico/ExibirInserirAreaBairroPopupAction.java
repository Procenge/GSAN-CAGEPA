 ...
 * @created 19/12/2006
 */
public class ExibirInserirAreaBairroPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("ultimaAlteracao") != null && !httpServletRequest.getParameter("ultimaAlteracao").equals("")){
