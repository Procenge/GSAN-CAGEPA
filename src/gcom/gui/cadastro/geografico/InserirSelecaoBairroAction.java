...
/**
 * Esta classe tem por finalidade incluir os bairros que foram selecionados pelo usuário na coleção
 * final
 * 
 * @author Raphael Rossiter
 * @date 02/05/2006
 */
public class InserirSelecaoBairroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(tipoRetorno != null && !tipoRetorno.trim().equalsIgnoreCase("")){
			...
			if(sessao.getAttribute("colecaoBairrosSelecionados") != null){
				...
				Collection colecaoBairrosSelecionados = (Collection) sessao.getAttribute("colecaoBairrosSelecionados");
				...
				if(selecionarBairroActionForm.getIdBairroSelecao() != null){
					...
					while(bairrosSelecionados.length > indexArray){
						...
						colecaoBairrosSelecionadosIterator = colecaoBairrosSelecionados.iterator();

						while(colecaoBairrosSelecionadosIterator.hasNext()){

							bairroInserir = (Bairro) colecaoBairrosSelecionadosIterator.next();
					...
					if(sessao.getAttribute("colecaoBairrosSelecionadosUsuario") != null){
						...
						Bairro bairro;
						Iterator iteratorColecaoBairrosSelecionadosUsuario = colecaoBairrosSelecionadosUsuario.iterator();
