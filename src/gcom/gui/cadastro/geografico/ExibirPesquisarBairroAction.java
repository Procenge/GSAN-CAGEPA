 ...
 * @date 28/06/2006
 */
public class ExibirPesquisarBairroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("consulta") != null){
			...
			if(httpServletRequest.getParameter("limparForm") == null && httpServletRequest.getParameter("novaPesquisa") == null
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null && !httpServletRequest.getParameter("tipoConsulta").equals("")){
			...
			if(httpServletRequest.getParameter("tipoConsulta").equals("municipio")){
				pesquisarActionForm.set("idMunicipio", httpServletRequest.getParameter("idCampoEnviarDados"));
				pesquisarActionForm.set("descricaoMunicipio", httpServletRequest.getParameter("descricaoCampoEnviarDados"));
			}
		}

		String idMunicipio = null;
		if(httpServletRequest.getParameter("idMunicipio") != null
						&& !httpServletRequest.getParameter("idMunicipio").trim().equalsIgnoreCase("")){
			idMunicipio = (String) httpServletRequest.getParameter("idMunicipio");
		}else{
			if(httpServletRequest.getAttribute("idMunicipio") != null && !httpServletRequest.getAttribute("idMunicipio").equals("")){
				idMunicipio = (String) httpServletRequest.getAttribute("idMunicipio");
			}
		}

		if(idMunicipio != null && !idMunicipio.trim().equalsIgnoreCase("") && httpServletRequest.getParameter("pesquisarMunicipio") == null
						&& httpServletRequest.getParameter("limparForm") == null){

			sessao.setAttribute("municipioRecebido", idMunicipio);
		}

		if(idMunicipio != null && !idMunicipio.equals("") && httpServletRequest.getParameter("limparForm") == null){
			...
			if(colecaoMunicipio != null && !colecaoMunicipio.isEmpty()){
				...
				pesquisarActionForm.set("idMunicipio", municipio.getId().toString());
				pesquisarActionForm.set("descricaoMunicipio", municipio.getNome());

				httpServletRequest.setAttribute("nomeCampo", "nomeBairro");
			}else{

				pesquisarActionForm.set("idMunicipio", "");
				pesquisarActionForm.set("descricaoMunicipio", "MUNICÍPIO INEXISTENTE");
		...
		if(httpServletRequest.getParameter("limparForm") != null && sessao.getAttribute("municipioRecebido") == null
			...
			httpServletRequest.setAttribute("nomeCampo", "idMunicipio");
		}else if(httpServletRequest.getParameter("limparForm") != null && sessao.getAttribute("municipioRecebido") != null
						&& httpServletRequest.getParameter("objetoConsulta") == null){
		 ...
		 */
		if(httpServletRequest.getParameter("novaPesquisa") != null && sessao.getAttribute("municipioRecebido") == null
						&& httpServletRequest.getParameter("objetoConsulta") == null){
			...
			httpServletRequest.setAttribute("nomeCampo", "idMunicipio");
		}else if(httpServletRequest.getParameter("novaPesquisa") != null && sessao.getAttribute("municipioRecebido") != null
						&& httpServletRequest.getParameter("objetoConsulta") == null){
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaBairro") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaBairro", httpServletRequest.getParameter("caminhoRetornoTelaPesquisaBairro"));
		}
		/*
