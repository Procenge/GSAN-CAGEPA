 ...
 * @date 02/05/2006
 */
public class PesquisarSelecionarBairroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Município
		if(selecionarBairroActionForm.getIdMunicipio() != null && !selecionarBairroActionForm.getIdMunicipio().equals("")){
			...
			filtroMunicipio.adicionarParametro(new ParametroSimples(FiltroMunicipio.ID, municipioJSP));
			...
			filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.MUNICIPIO_ID, municipioJSP));
		}

		// Bairro
		if(selecionarBairroActionForm.getNomeBairro() != null && !selecionarBairroActionForm.getNomeBairro().equals("")){

			String nomeBairroJSP = selecionarBairroActionForm.getNomeBairro();

			peloMenosUmParametroInformado = true;

			filtroBairro.adicionarParametro(new ComparacaoTexto(FiltroBairro.NOME, nomeBairroJSP));
		}
