...
public class ExibirInserirMunicipioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		filtroRegiaoDesenv.adicionarParametro(new ParametroSimples(FiltroRegiaoDesenvolvimento.INDICADOR_USO,
		...
		if(getParametroCompanhia(httpServletRequest) == SistemaParametro.INDICADOR_EMPRESA_DESO.shortValue()){
			InserirMunicipioActionForm municipioActionForm = (InserirMunicipioActionForm) actionForm;
			...
			if(municipioActionForm.getBanco() != null && !Integer.valueOf(municipioActionForm.getBanco()).equals(-1)){
				idBanco = Integer.valueOf(municipioActionForm.getBanco());
			}
