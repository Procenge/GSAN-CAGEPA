...
public class AtualizarMunicipioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		atualizarMunicipioActionForm.setFormValues(municipio, getParametroCompanhia(httpServletRequest));

		// atualiza na base de dados de Municipio
		fachada.atualizarMunicipio(municipio, usuarioLogado);

		// Monta a página de sucesso
		montarPaginaSucesso(httpServletRequest, "Município de código " + atualizarMunicipioActionForm.getCodigoMunicipio()
						+ " atualizado com sucesso.", "Realizar outra Manutenção de Município", "exibirFiltrarMunicipioAction.do?menu=sim");
