 ...
 * @date 20/12/2006
 */
public class InserirAreaBairroPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("inserirAreaBairroPopupAction");
		...
		String areaBairroNome = adicionarAreaBairroActionForm.getAreaBairroNome();
		...
		if(sessao.getAttribute("colecaoBairroArea") != null && !sessao.getAttribute("colecaoBairroArea").equals("")){
		...
		if(areaBairroNome == null || areaBairroNome.equals("")){
			throw new ActionServletException("atencao.campo_selecionado.obrigatorio", null, "Nome da Área de Bairro");
		}
		...
		if(distritoOperacionalID != null && !distritoOperacionalID.equalsIgnoreCase("-1")){
			...
			Collection colecaoPesquisa = fachada.pesquisar(filtroDistritoOperacional, DistritoOperacional.class.getName());

			if(colecaoPesquisa != null && !colecaoPesquisa.isEmpty()){
				distritoOperacional = (DistritoOperacional) Util.retonarObjetoDeColecao(colecaoPesquisa);
		...
		if(bairroAreaAtualizar != null){
			...
			if(colecaoBairroArea != null && !colecaoBairroArea.isEmpty()){
				...
				while(iteratorBairroArea.hasNext()){
					BairroArea bairroArea = (BairroArea) iteratorBairroArea.next();
					if(bairroArea.getNome().trim().equals(areaBairroNome.trim())
									&& !bairroArea.getNome().trim().equals(bairroAreaAtualizar.getNome().trim())){
