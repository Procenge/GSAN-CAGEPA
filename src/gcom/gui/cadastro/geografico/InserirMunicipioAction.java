...
public class InserirMunicipioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		inserirMunicipioActionForm.setFormValues(municipio, getParametroCompanhia(httpServletRequest));
		...
		montarPaginaSucesso(httpServletRequest, "Município de código " + inserirMunicipioActionForm.getCodigoMunicipio()
						+ " inserido com sucesso.", "Inserir outro Município", "exibirInserirMunicipioAction.do?menu=sim",
						"exibirAtualizarMunicipioAction.do?idRegistroInseridoAtualizar=" + idMunicipio, "Atualizar Município Inserido");
