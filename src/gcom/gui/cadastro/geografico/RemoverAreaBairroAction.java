 ...
 * @created 20/12/2006
 */
public class RemoverAreaBairroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("reloadPage") != null && sessao.getAttribute("reloadPage").equals("INSERIRBAIRRO")){
		...
		if(sessao.getAttribute("colecaoBairroAreaRemover") != null){
			colecaoBairroAreaRemover = (Collection) sessao.getAttribute("colecaoBairroAreaRemover");
		}else{
			colecaoBairroAreaRemover = new ArrayList();
		}

		if(ultimaAlteracao != null && !ultimaAlteracao.equalsIgnoreCase("") && sessao.getAttribute("colecaoBairroArea") != null){
