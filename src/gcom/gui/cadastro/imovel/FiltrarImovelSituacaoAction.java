 ...
 * @return
 */
public class FiltrarImovelSituacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirManterImovelSituacaoAction");
		...
		String idImovelSituacaoTipo = filtrarImovelSituacaoActionForm.getImovelSituacaoTipo();
		String idLigacaoAguaSituacao = filtrarImovelSituacaoActionForm.getLigacaoAguaSituacao();
		String idLigacaoEsgotoSituacao = filtrarImovelSituacaoActionForm.getLigacaoEsgotoSituacao();
		...
		if(idLigacaoAguaSituacao != null && !idLigacaoAguaSituacao.equals("-1")){
			peloMenosUmParametroInformado = true;
		...
		if(idLigacaoEsgotoSituacao != null && !idLigacaoEsgotoSituacao.equals("-1")){
			peloMenosUmParametroInformado = true;
			filtroImovelSituacao
							.adicionarParametro(new ParametroSimples(FiltroImovelSituacao.LIGACAO_ESGOTO_SITUACAO_ID, idLigacaoEsgotoSituacao));
		...
		filtroImovelSituacao.adicionarCaminhoParaCarregamentoEntidade("ligacaoAguaSituacao");
		filtroImovelSituacao.adicionarCaminhoParaCarregamentoEntidade("ligacaoEsgotoSituacao");

		Collection colecaoImovelSituacao = (Collection) fachada.pesquisar(filtroImovelSituacao, ImovelSituacao.class.getName());
		...
		httpServletRequest.setAttribute("filtroImovelSituacao", filtroImovelSituacao);
