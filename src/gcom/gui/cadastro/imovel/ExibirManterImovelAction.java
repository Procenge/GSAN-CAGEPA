...
public class ExibirManterImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		int totalRegistros = fachada.pesquisarQuantidadeImovel(idImovel, idLocalidade, codigoSetorComercial, numeroQuadra,
						idHidrometroHistInst, lote, subLote, codigoCliente, idMunicipio, cep, idBairro, idLogradouro, false, false, null,
						null).intValue();
		...
		imoveis = fachada.pesquisarImovel(idImovel, idLocalidade, codigoSetorComercial, numeroQuadra, idHidrometroHistInst, lote, subLote,
						codigoCliente, idMunicipio, cep, idBairro, idLogradouro, false, false, ((Integer) httpServletRequest
