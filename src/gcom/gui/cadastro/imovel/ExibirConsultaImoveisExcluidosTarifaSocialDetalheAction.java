...
public class ExibirConsultaImoveisExcluidosTarifaSocialDetalheAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idImovel = (String) httpServletRequest.getParameter("idRegistroAtualizacao");
		...
		if(imoveis != null && !imoveis.isEmpty()){
			...
			while(iterator.hasNext()){
				...
				if(imovelRelatorioHelper.getTarifasEconomias() != null && !imovelRelatorioHelper.getTarifasEconomias().isEmpty()){
				...
				if(imovelRelatorioHelper.getMatriculaImovel().toString().trim().equalsIgnoreCase(idImovel)){
					while(iteratorCliente.hasNext()){
						...
						if(imovelRelatorioHelperCliente.getClienteRelacaoTipo().trim().equalsIgnoreCase(
										ConstantesSistema.CLIENTE_RELACAO_TIPO_PROPRIETARIO_EXTENSO)){
