 ...
 */
public class RemoverEconomiaPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Cria variaveis
		Collection colecaoClientesImoveisEconomia = (Collection) sessao.getAttribute("colecaoClientesImoveisEconomia");
		...
		if(sessao.getAttribute("colecaoClientesImoveisEconomiaRemovidas") != null){
			colecaoClientesImoveisEconomiaRemovidas = (Collection) sessao.getAttribute("colecaoClientesImoveisEconomiaRemovidas");
		}else{
		...
		String[] clientesImoveis = economiaPopupActionForm.getIdRegistrosRemocao();
		...
		if(imovelEconomia != null && !imovelEconomia.equals("")){
			Collection clienteImovelEconomias = (Collection) imovelEconomia.getClienteImovelEconomias();
			Iterator clienteImovelEconomiaIterator = clienteImovelEconomias.iterator();

			while(clienteImovelEconomiaIterator.hasNext()){
				clienteImovelEconomia = (ClienteImovelEconomia) clienteImovelEconomiaIterator.next();
				for(int i = 0; i < clientesImoveis.length; i++){
					if(clienteImovelEconomia.getUltimaAlteracao().getTime() == Long.parseLong(clientesImoveis[i])){
						...
						if(clienteImovelEconomia.getId() != null && !clienteImovelEconomia.getId().equals("")){
							...
							retorno = actionMapping.findForward("exibirManterFimRelacaoClienteImovel");
							colecaoClientesImoveisEconomiaFimRelacao.add(clienteImovelEconomia);

							if(clienteImovelEconomia.getClienteRelacaoTipo().getId().shortValue() == ClienteRelacaoTipo.USUARIO
											.shortValue()){
							...
							sessao.setAttribute("colecaoClientesImoveisEconomiaFimRelacao", colecaoClientesImoveisEconomiaFimRelacao);
		...
		if(colecaoClientesImoveisEconomia != null && !colecaoClientesImoveisEconomia.equals("")){

			Iterator clienteImovelEconomiaIterator = colecaoClientesImoveisEconomia.iterator();
