 ...
 * @author Rodrigo
 */
public class ValidarLigacaoAguaEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		 ...
		 * !situacaoAgua.trim().equalsIgnoreCase(ConstantesSistema.NUMERO_NAO_INFORMADO + "")) {
		 ...
		 * if (tipoMedicao != null &&
		 * !tipoMedicao.trim().equalsIgnoreCase(ConstantesSistema.NUMERO_NAO_INFORMADO + "")) {
		 * peloMenosUmParametroInformado = true;
		 * filtroClienteImovel
