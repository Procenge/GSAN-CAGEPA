 ...
 */
public class RemoverInserirImovelClienteAction
				extends GcomAction {
						...
						if(!(colecaoClientesImoveisRemovidos.contains(clienteImovel))){
							if(imovel == null){
								...
								if(clienteImovel.getClienteRelacaoTipo().getId().shortValue() == Util.converterStringParaInteger(
												ConstantesSistema.CLIENTE_IMOVEL_TIPO_USUARIO.toString()).shortValue()){
									inserirImovelClienteActionForm.set("idClienteImovelUsuario", null);
									sessao.removeAttribute("idClienteImovelUsuario");

								}
								if(clienteImovel.getClienteRelacaoTipo().getId().shortValue() == Util.converterStringParaInteger(
												ConstantesSistema.CLIENTE_IMOVEL_TIPO_RESPONSAVEL.toString()).shortValue()){
								...
								if(this.getParametroCompanhia(httpServletRequest).toString().equals(
									...
									if(clienteImovel.getClienteRelacaoTipo().getId().shortValue() == Util.converterStringParaInteger(
										...
										inserirImovelClienteActionForm.set("idClienteImovelProprietario", null);
