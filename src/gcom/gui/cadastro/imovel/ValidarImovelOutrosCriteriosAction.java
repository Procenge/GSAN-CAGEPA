 ...
 * @author Rodrigo
 */
public class ValidarImovelOutrosCriteriosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		 ...
		 * ParametroSimples(FiltroGerenciaRegional.CEP,
		 * imovelOutrosCriteriosActionForm.getCEP()));
		 * Collection gerenciasCep = fachada.pesquisar(filtroGerenciaRegional,
