 ...
 */
public class CancelarImovelDoacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_CATEGORIA_INSERIR,
						new UsuarioAcaoUsuarioHelper(usuarioCancelamento, UsuarioAcao.USUARIO_ACAO_EFETUOU_OPERACAO));
		...
		montarPaginaSucesso(httpServletRequest, contadorImovelDoacaoCancelados + " Autorização(ões) para Doação Mensal do Imóvel "
						+ imovelDoacao.getImovel().getId().toString() + " cancelada(s) com sucesso.",
						"Cancelar outra Autorização para Doação Mensal", "exibirManterImovelDoacaoAction.do");
