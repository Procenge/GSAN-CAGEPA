...
public class ExibirLigacaoAguaEsgotoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("filtrarLigacaoAguaEsgoto");
		...
		Collection<LigacaoAguaSituacao> collectionsLigacaoAguaSituacao = fachada.pesquisar(filtroLigacaoAguaSituacao,
