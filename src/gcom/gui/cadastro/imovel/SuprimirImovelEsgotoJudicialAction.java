...
public class SuprimirImovelEsgotoJudicialAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Supressão de Esgoto Judicialmente efetuada com sucesso.",
						"Suprimir Ligação de Esgoto Judicialmente de outro Imóvel", "exibirSuprimirImovelEsgotoJudicialAction.do?menu=sim");
