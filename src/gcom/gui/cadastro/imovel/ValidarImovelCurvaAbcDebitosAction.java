 ...
 * @author Ivan Sérgio
 */
public class ValidarImovelCurvaAbcDebitosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer anoMesReferenciaInicial = Util.converterStringParaInteger(Util.formatarMesAnoParaAnoMes(imovelCurvaAbcDebitosActionForm
						.getReferenciaCobrancaInicial().replace("/", "")));

		Integer anoMesReferenciaFinal = Util.converterStringParaInteger(Util.formatarMesAnoParaAnoMes(imovelCurvaAbcDebitosActionForm
						.getReferenciaCobrancaFinal().replace("/", "")));
		...
		if(anoMesReferenciaInicial > anoMesReferenciaArrecadacao){
			throw new ActionServletException("atencao.adicionar_debito_ano_mes_referencia_invalido", null, "da Cobrança Inicial");
		}

		if(anoMesReferenciaFinal > anoMesReferenciaArrecadacao){
			throw new ActionServletException("atencao.adicionar_debito_ano_mes_referencia_invalido", null, "da Cobrança Final");
		}
