 ...
 */
public class AtualizarCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// ------------ REGISTRAR TRANSAÇÃO ----------------
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_CATEGORIA_ATUALIZAR,
		...
		Integer codigoCategoria = Util.obterInteger(categoriaActionForm.getIdCategoria());
		...
		montarPaginaSucesso(httpServletRequest, "Categoria de código " + categoria.getId() + " atualizada com sucesso.",
						"Realizar outra Manutenção de Categoria", "exibirManterCategoriaAction.do?menu=sim");
		return retorno;
	}
}