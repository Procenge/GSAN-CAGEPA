 ...
 */
public class ExibirAtualizarImovelPrincipalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarImovelPrincipal");
		...
		// Cria variaveis
		String idImovel = (String) atualizarImovelPrincipalActionForm.get("idImovel");
