 ...
 * @date 10/03/2006
 */
public class ConsultarRelacaoClienteImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest request,
		...
		if(form.getIdCliente() != null && !"".equals(form.getIdCliente())){
			retorno = actionMapping.findForward("cliente");
		}else if(form.getIdImovel() != null && !"".equals(form.getIdImovel())){
			retorno = actionMapping.findForward("imovel");
		}

		if(form.getPeriodoInicialDataInicioRelacao() != null && !form.getPeriodoFinalDataInicioRelacao().equals("")){
		...
		if(form.getPeriodoInicialDataFimRelacao() != null && !form.getPeriodoFinalDataFimRelacao().equals("")){
