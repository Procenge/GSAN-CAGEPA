 ...
 * @date 04/04/2006
 */
public class ExibirManterImovelSituacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("manterImovelSituacao");

		HttpSession sessao = httpServletRequest.getSession(false);

		// Recupera o filtro passado pelo FiltrarImovelSituacaoAction para
		// ser efetuada pesquisa
		FiltroImovelSituacao filtroImovelSituacao = (FiltroImovelSituacao) sessao.getAttribute("filtroImovelSituacao");

		// Aciona o controle de paginação para que sejam pesquisados apenas
		// os registros que aparecem na página
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroImovelSituacao, ImovelSituacao.class.getName());
		Collection colecaoImovelSituacao = (Collection) resultado.get("colecaoRetorno");
