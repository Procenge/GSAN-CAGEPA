 ...
 * @created 04/07/2006
 */
public class FiltrarImovelActionForm
	...
	private String nnRotaFiltro;

	private String nnSegmentoFiltro;
	...
	private String codigoHidrometroFiltro;

	private String quadraDescricaoFiltro;

	private String idHidrometroFiltro;

	private String hidrometroDescricaoFiltro;
	 ...
	 *            O atualizarFiltro a ser setado.
	 */
	...
	/**
	 * @param idClienteFiltro
	 *            O idClienteFiltro a ser setado.
	 */
	...
	/**
	 * @param idImovelFiltro
	 *            O idImovelFiltro a ser setado.
	 */
	...
	/**
	 * @param idLocalidadeFiltro
	 *            O idLocalidadeFiltro a ser setado.
	 */
	...
	/**
	 * @param idLogradouroFiltro
	 *            O idLogradouroFiltro a ser setado.
	 */
	 ...
	 *            O idMunicipioFiltro a ser setado.
	 */
	...
	/**
	 * @param idQuadraFiltro
	 *            O idQuadraFiltro a ser setado.
	 */
	...
	/**
	 * @param idSetorComercialFiltro
	 *            O idSetorComercialFiltro a ser setado.
	 */
	...
	/**
	 * @return Retorna o campo nnRotaFiltro.
	 */
	public String getNnRotaFiltro(){
	...
	/**
	 * @param nnRotaFiltro
	 *            O nnRotaFiltro a ser setado.
	 */
	public void setNnRotaFiltro(String nnRotaFiltro){

		this.nnRotaFiltro = nnRotaFiltro;
	}

	/**
	 * @return Retorna o campo nnSegmentoFiltro.
	 */
	public String getNnSegmentoFiltro(){

		return nnSegmentoFiltro;
	}

	/**
	 * @param nnSegmentoFiltro
	 *            O nnSegmentoFiltro a ser setado.
	 */
	public void setNnSegmentoFiltro(String nnSegmentoFiltro){

		this.nnSegmentoFiltro = nnSegmentoFiltro;
	}
	...
	/**
	 * @param localidadeDescricaoFiltro
	 *            O localidadeDescricaoFiltro a ser setado.
	 */
	...
	/**
	 * @param logradouroFiltro
	 *            O logradouroFiltro a ser setado.
	 */
	...
	/**
	 * @param matriculaFiltro
	 *            O matriculaFiltro a ser setado.
	 */
	...
	/**
	 * @param municipioFiltro
	 *            O municipioFiltro a ser setado.
	 */
	...
	/**
	 * @param nomeClienteFiltro
	 *            O nomeClienteFiltro a ser setado.
	 */
	...
	/**
	 * @param quadraDescricaoFiltro
	 *            O quadraDescricaoFiltro a ser setado.
	 */
	...
	/**
	 * @param setorComercialDescricaoFiltro
	 *            O setorComercialDescricaoFiltro a ser setado.
	 */
	public void setSetorComercialDescricaoFiltro(String setorComercialDescricaoFiltro){
	...
	/**
	 * @param cepDescricaoFiltro
	 *            O cepDescricaoFiltro a ser setado.
	 */
	...
	/**
	 * @return the codigoHidrometroFiltro
	 */
	public String getCodigoHidrometroFiltro(){

		return codigoHidrometroFiltro;
	}

	/**
	 * @param codigoHidrometroFiltro
	 *            the codigoHidrometroFiltro to set
	 */
	public void setCodigoHidrometroFiltro(String codigoHidrometroFiltro){

		this.codigoHidrometroFiltro = codigoHidrometroFiltro;
	}

	/**
	 * @return the idHidrometroFiltro
	 */
	public String getIdHidrometroFiltro(){

		return idHidrometroFiltro;
	}

	/**
	 * @param idHidrometroFiltro
	 *            the idHidrometroFiltro to set
	 */
	public void setIdHidrometroFiltro(String idHidrometroFiltro){

		this.idHidrometroFiltro = idHidrometroFiltro;
	}

	/**
	 * @return the hidrometroDescricaoFiltro
	 */
	public String getHidrometroDescricaoFiltro(){

		return hidrometroDescricaoFiltro;
	}

	/**
	 * @param hidrometroDescricaoFiltro
	 *            the hidrometroDescricaoFiltro to set
	 */
	public void setHidrometroDescricaoFiltro(String hidrometroDescricaoFiltro){

		this.hidrometroDescricaoFiltro = hidrometroDescricaoFiltro;
	}
