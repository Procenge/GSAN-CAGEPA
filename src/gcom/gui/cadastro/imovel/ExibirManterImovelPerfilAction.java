...
public class ExibirManterImovelPerfilAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroImovelPerfil filtroImovelPerfil = null;

		// Verifica se o filtro foi informado pela página de filtragem
		if(sessao.getAttribute("filtroImovelPerfilSessao") != null){
			filtroImovelPerfil = (FiltroImovelPerfil) sessao.getAttribute("filtroImovelPerfilSessao");
		}

		if((retorno != null) && (retorno.getName().equalsIgnoreCase("exibirManterImovelPerfil"))){
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroImovelPerfil, ImovelPerfil.class.getName());
			...
			if(colecaoImovelPerfil.size() == 1 && identificadorAtualizar != null && !identificadorAtualizar.equals("")){
				...
				sessao.setAttribute("idImovelPerfil", imovelPerfil.getId().toString());
