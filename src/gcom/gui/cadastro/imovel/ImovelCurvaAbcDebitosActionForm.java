 ...
 * @created 17/07/2007
 */
public class ImovelCurvaAbcDebitosActionForm
	...
	public void setIndicadorImovelMedicaoIndividualizada(String indicadorImovelMedicaoIndividualizada){
	...
	public void setIndicadorImovelParalizacaoFaturamentoCobranca(String indicadorImovelParalizacaoFaturamentoCobranca){
	...
	public void setIndicadorPagamentosNaoClassificados(String indicadorPagamentosNaoClassificados){
	...
	public void setIntervaloConsumoMinimoFixadoEsgotoFinal(String intervaloConsumoMinimoFixadoEsgotoFinal){
	...
	public void setIntervaloConsumoMinimoFixadoEsgotoInicial(String intervaloConsumoMinimoFixadoEsgotoInicial){
	...
	public void setIntervaloMesesCortadoSuprimidoFinal(String intervaloMesesCortadoSuprimidoFinal){
	...
	public void setIntervaloMesesCortadoSuprimidoInicial(String intervaloMesesCortadoSuprimidoInicial){
	...
	public void setAnoMesReferenciaArrecadacaoAtual(String anoMesReferenciaArrecadacaoAtual){
	...
	public void limparCamposPorEstado(){
		...
		this.setIdGerenciaRegional(null);
		this.setIdUnidadeNegocio(null);
