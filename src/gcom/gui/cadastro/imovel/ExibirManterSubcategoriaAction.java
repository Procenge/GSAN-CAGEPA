 ...
 */
public class ExibirManterSubcategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// FiltrarSubcategoriaActionForm filtrarSubcategoriaActionForm =
		// (FiltrarSubcategoriaActionForm) actionForm;
		...
		if(httpServletRequest.getAttribute("filtroSubcategoria") != null){
			filtroSubcategoria = (FiltroSubCategoria) httpServletRequest.getAttribute("filtroSubcategoria");
		}else{
		...
		// A pesquisa de subcategorias só será feita se o forward estiver direcionado para a página
		// de manterSubCategoria
		if(retorno.getName().equalsIgnoreCase("manterSubcategoria")){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroSubcategoria, Subcategoria.class.getName());
