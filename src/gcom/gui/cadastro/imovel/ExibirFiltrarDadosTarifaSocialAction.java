...
public class ExibirFiltrarDadosTarifaSocialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// (ImovelOutrosCriteriosActionForm) actionForm;
		...
		Collection<TarifaSocialExclusaoMotivo> colecaoExclusaoMotivo = fachada.pesquisar(filtroTarifaSocialExclusaoMotivo,
						TarifaSocialExclusaoMotivo.class.getName());
		if(colecaoExclusaoMotivo == null || colecaoExclusaoMotivo.isEmpty()){
			throw new ActionServletException("atencao.naocadastrado", null, "Motivo de Exclusão");
		}
		...
		Collection<TarifaSocialCartaoTipo> colecaoCartaoTipo = fachada.pesquisar(filtroTarifaSocialCartaoTipo, TarifaSocialCartaoTipo.class
						.getName());
		...
		Collection<RendaTipo> colecaoRendaTipo = fachada.pesquisar(filtroRendaTipo, RendaTipo.class.getName());
