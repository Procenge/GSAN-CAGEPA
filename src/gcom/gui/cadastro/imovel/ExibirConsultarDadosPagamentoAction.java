 ...
 * @created 28/06/2007
 */
public class ExibirConsultarDadosPagamentoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirConsultarDadosPagamentoAction");
		...
		if(httpServletRequest.getParameter("pagamentoHistorico") != null){
			...
			Collection<PagamentoHistorico> colecaoPagamentoHistorico = fachada.pesquisarPagamentoHistoricoPeloId(Integer
							.valueOf(idPagamentoHistorico));
			...
			if(pagamentoHistorico.getImovel() != null){
				...
				form.setMatriculaImovel(String.valueOf(pagamentoHistorico.getImovel().getId()));
				String imovelInscricao = fachada.pesquisarInscricaoImovel(pagamentoHistorico.getImovel().getId(), true);
			...
			if(pagamentoHistorico.getAnoMesReferenciaPagamento() != null && !pagamentoHistorico.getAnoMesReferenciaPagamento().equals("")){
			...
			if(pagamentoHistorico.getPagamentoSituacaoAnterior() != null && !pagamentoHistorico.getPagamentoSituacaoAnterior().equals("")){
			...
			if(pagamentoHistorico.getValorExcedente() != null && !pagamentoHistorico.getValorExcedente().equals("")){
			...
			if(pagamentoHistorico.getArrecadadorMovimentoItem() != null && !pagamentoHistorico.getArrecadadorMovimentoItem().equals("")){
				...
				form
								.setDataProcessamentoMovimento(Util.formatarData(pagamentoHistorico.getArrecadadorMovimentoItem()
												.getUltimaAlteracao()));
				form.setHoraProcessamentoMovimento(Util.formatarHoraSemData(pagamentoHistorico.getArrecadadorMovimentoItem()
								.getUltimaAlteracao()));
				...
				if(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento().getNumeroSequencialArquivo() != null
					...
					form.setSequencialArquivoMovimento(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento()
				...
				if(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento().getCodigoBanco() != null
					...
					form.setCodigoArrecadadorMovimento(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento()
				...
				if(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento().getNomeBanco() != null
					...
					form.setNomeArrecadadorMovimento(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento()
									.getNomeBanco());
				}else{
				...
				if(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento().getDescricaoIdentificacaoServico() != null
								&& !pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento()
												.getDescricaoIdentificacaoServico().equals("")){

					form.setServicoManutencao(pagamentoHistorico.getArrecadadorMovimentoItem().getArrecadadorMovimento()
			...
			Collection<Pagamento> colecaoPagamento = fachada.pesquisarPagamentoPeloId(Integer.valueOf(idPagamento));
			...
			if(pagamento.getImovel() != null && pagamento.getImovel().getId() != null){
				...
				form.setMatriculaImovel(pagamento.getImovel().getId().toString());
				String imovelInscricao = fachada.pesquisarInscricaoImovel(pagamento.getImovel().getId(), true);
				form.setInscricaoImovel(imovelInscricao);
			...
			if(pagamento.getArrecadadorMovimentoItem() != null && !pagamento.getArrecadadorMovimentoItem().equals("")){
				...
				if(pagamento.getArrecadadorMovimentoItem().getArrecadadorMovimento().getNumeroSequencialArquivo() != null
					...
					form.setSequencialArquivoMovimento(pagamento.getArrecadadorMovimentoItem().getArrecadadorMovimento()
									.getNumeroSequencialArquivo().toString());
				}else{
					form.setSequencialArquivoMovimento("");
				}
				...
				if(pagamento.getArrecadadorMovimentoItem().getArrecadadorMovimento().getCodigoBanco() != null
					...
					form.setCodigoArrecadadorMovimento(pagamento.getArrecadadorMovimentoItem().getArrecadadorMovimento().getCodigoBanco()
									.toString());
				}else{
					form.setCodigoArrecadadorMovimento("");
				}
				...
				if(pagamento.getArrecadadorMovimentoItem().getArrecadadorMovimento().getDescricaoIdentificacaoServico() != null
								&& !pagamento.getArrecadadorMovimentoItem().getArrecadadorMovimento().getDescricaoIdentificacaoServico()
												.equals("")){

					form.setServicoManutencao(pagamento.getArrecadadorMovimentoItem().getArrecadadorMovimento()
									.getDescricaoIdentificacaoServico());
				}else{
					form.setServicoManutencao("");
				}
	...
	private String filtrarArrecadacaoForma(ConsultarDadosPagamentoActionForm form, Fachada fachada, String codigo){
		...
		filtroArrecadacaoForma.adicionarParametro(new ParametroSimples(FiltroArrecadacaoForma.CODIGO_ARRECADACAO_FORMA, codigo));
