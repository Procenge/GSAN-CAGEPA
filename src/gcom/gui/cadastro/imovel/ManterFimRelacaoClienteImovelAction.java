 ...
 */
public class ManterFimRelacaoClienteImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirAtualizarEconomiaPopup");
		// Cria a sessão
		...
		Collection colecaoClientesImoveisEconomiaFimRelacao = (Collection) sessao.getAttribute("colecaoClientesImoveisEconomiaFimRelacao");
		// verifica se tem algum cliente imovel economia que precisa ser
		// atualizado com a data de termino da
		// relação e o motivo.
		if(colecaoClientesImoveisEconomiaFimRelacao != null && !colecaoClientesImoveisEconomiaFimRelacao.isEmpty()){
			Iterator clienteImovelEconomiaIterator = colecaoClientesImoveisEconomiaFimRelacao.iterator();
			...
			while(clienteImovelEconomiaIterator.hasNext()){
				...
				if(dataFimRelacao.before(clienteImovelEconomia.getDataInicioRelacao())){
			...
			clienteImovelEconomiaIterator = colecaoClientesImoveisEconomiaFimRelacao.iterator();

			while(clienteImovelEconomiaIterator.hasNext()){
				ClienteImovelEconomia clienteImovelEconomia = (ClienteImovelEconomia) clienteImovelEconomiaIterator.next();
				clienteImovelEconomia.setClienteImovelFimRelacaoMotivo(clienteImovelFimRelacao);
