 ...
 */
public class AtualizarEconomiaPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer areaContruidaFaixaForm = (new Integer(economiaPopupActionForm.getIdAreaConstruidaFaixa()));
		...
		imovelEconomia.setComplementoEndereco(economiaPopupActionForm.getComplementoEndereco());

		if(economiaPopupActionForm.getNumeroMorador() != null && !economiaPopupActionForm.getNumeroMorador().equalsIgnoreCase("")){
			imovelEconomia.setNumeroMorador(new Short(economiaPopupActionForm.getNumeroMorador().toString()));
		}else{
		...
		if(economiaPopupActionForm.getNumeroPontosUtilizacao() != null
			...
			imovelEconomia.setNumeroPontosUtilizacao(new Short(economiaPopupActionForm.getNumeroPontosUtilizacao().toString()));
		}else{
		...
		if(economiaPopupActionForm.getNumeroIptu() != null && !economiaPopupActionForm.getNumeroIptu().equals("")){
			...
			imovelEconomia.setNumeroIptu(new BigDecimal(economiaPopupActionForm.getNumeroIptu()));
		}else{
		...
		if(economiaPopupActionForm.getNumeroCelpe() != null && !economiaPopupActionForm.getNumeroCelpe().equals("")){
			...
			imovelEconomia.setNumeroCelpe(new Long(economiaPopupActionForm.getNumeroCelpe()));
		}else{
			imovelEconomia.setNumeroCelpe(null);
		}

		imovelEconomia.getClienteImovelEconomias().addAll(colecaoClientesImoveisEconomia);
