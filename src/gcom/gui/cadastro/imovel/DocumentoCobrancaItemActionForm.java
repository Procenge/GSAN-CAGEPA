 ...
 * @author Saulo Lima
 * @date 05/02/2009
 *       Novo atributo empresaNome
 */
public class DocumentoCobrancaItemActionForm
				extends ActionForm {
	...
	private String idCobrancaNegociacaoAtendimento;

	private String tipoDocumentoNegociacao;

	private String idRegistroAtendimentoNegociacao;

	private String emailNegociacao;

	private String habilitarReEnviarDocumento;
	...
	public String getTipoDocumentoNegociacao(){

		return tipoDocumentoNegociacao;
	}

	public void setTipoDocumentoNegociacao(String tipoDocumentoNegociacao){

		this.tipoDocumentoNegociacao = tipoDocumentoNegociacao;
	}

	public String getIdRegistroAtendimentoNegociacao(){

		return idRegistroAtendimentoNegociacao;
	}

	public void setIdRegistroAtendimentoNegociacao(String idRegistroAtendimentoNegociacao){

		this.idRegistroAtendimentoNegociacao = idRegistroAtendimentoNegociacao;
	}

	public String getEmailNegociacao(){

		return emailNegociacao;
	}

	public void setEmailNegociacao(String emailNegociacao){

		this.emailNegociacao = emailNegociacao;
	}

	public String getHabilitarReEnviarDocumento(){

		return habilitarReEnviarDocumento;
	}

	public void setHabilitarReEnviarDocumento(String habilitarReEnviarDocumento){

		this.habilitarReEnviarDocumento = habilitarReEnviarDocumento;
	}

	public String getIdCobrancaNegociacaoAtendimento(){

		return idCobrancaNegociacaoAtendimento;
	}

	public void setIdCobrancaNegociacaoAtendimento(String idCobrancaNegociacaoAtendimento){

		this.idCobrancaNegociacaoAtendimento = idCobrancaNegociacaoAtendimento;
	}
	...
	public void setDescricaoCobrancaAcaoSituacao(String descricaoCobrancaAcaoSituacao){
