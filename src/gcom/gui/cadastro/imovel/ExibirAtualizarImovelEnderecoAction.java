 ...
 */
public class ExibirAtualizarImovelEnderecoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarImovelEndereco");
		...
		if(!colecaoImovelEnnvioConta.isEmpty()){
			 ...
			 */
			if(inserirImovelLocalidadeActionForm.get("extratoResponsavel") != null
							&& !inserirImovelLocalidadeActionForm.get("extratoResponsavel").equals("")
							&& inserirImovelLocalidadeActionForm.get("extratoResponsavel").equals(ConstantesSistema.SIM.toString())){

				inserirImovelLocalidadeActionForm.set("extratoResponsavel", ConstantesSistema.SIM.toString());
			}else{
		 ...
		 * System.out.println(
		 * "imovel.getLogradouroBairro().getLogradouro().getMunicipio().getId().toString()="
		 ...
		 * 
		 * System.out.println("boolean="+(!(imovel.getLogradouroBairro().getLogradouro().getMunicipio
		 * ().getId().intValue() == (
