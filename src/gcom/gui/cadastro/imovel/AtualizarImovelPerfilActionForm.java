...
public class AtualizarImovelPerfilActionForm
	...
	public ImovelPerfil setFormValues(ImovelPerfil imovelPerfil){

		// Metodo usado para setar todos os valores do Form na base de dados
		imovelPerfil.setId(new Integer(getIdImovelPerfil()));
		imovelPerfil.setDescricao(getDescricaoImovelPerfil());
		imovelPerfil.setIndicadorGeracaoAutomatica(new Short(getIndicadorGeracaoAutomatica()));
		imovelPerfil.setUltimaAlteracao(new Date());
		imovelPerfil.setIndicadorUso(new Short(getIndicadorUso()));
