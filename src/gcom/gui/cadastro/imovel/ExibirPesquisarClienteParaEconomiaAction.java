 ...
 */
public class ExibirPesquisarClienteParaEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirEconomiaParaPesquisaCliente");
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaCliente") != null){
			httpServletRequest.setAttribute("caminhoRetornoTelaPesquisaCliente", httpServletRequest
