...
public class ExibirAlterarImovelInscricaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("exibirAlterarImovelInscricao");
		...
		if(objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("") && inscricaoTipo != null
			...
			switch(Integer.parseInt(objetoConsulta)){
				...
				case 1:
					...
					pesquisarLocalidade(inscricaoTipo, alterarImovelInscricaoActionForm, fachada, httpServletRequest);
				...
				case 2:
					...
					pesquisarSetorComercial(inscricaoTipo, alterarImovelInscricaoActionForm, fachada, httpServletRequest);
				...
				case 3:
					...
					pesquisarQuadra(inscricaoTipo, alterarImovelInscricaoActionForm, fachada, httpServletRequest);
	...
	private void pesquisarLocalidade(String inscricaoTipo, DynaValidatorForm alterarImovelInscricaoActionForm, Fachada fachada,
					HttpServletRequest httpServletRequest){

		FiltroLocalidade filtroLocalidade = new FiltroLocalidade();

		// Recebe o valor do campo localidadeOrigemID do formulário.
		localidadeIDOrigem = (String) alterarImovelInscricaoActionForm.get("localidadeOrigemID");
		...
		if(colecaoPesquisa == null || colecaoPesquisa.isEmpty() && !localidadeIDOrigem.equalsIgnoreCase("")){
			...
			// formulário
			if(alterarImovelInscricaoActionForm.get("localidadeOrigemID").equals(
							alterarImovelInscricaoActionForm.get("localidadeDestinoID"))){
				alterarImovelInscricaoActionForm.set("localidadeDestinoID", "");
			}
			alterarImovelInscricaoActionForm.set("localidadeOrigemID", "");
			alterarImovelInscricaoActionForm.set("nomeLocalidadeOrigem", "Localidade inexistente");
			...
			alterarImovelInscricaoActionForm.set("localidadeOrigemID", String.valueOf(objetoLocalidade.getId()));
			alterarImovelInscricaoActionForm.set("nomeLocalidadeOrigem", objetoLocalidade.getDescricao());
			if(alterarImovelInscricaoActionForm.get("localidadeDestinoID") == null
							|| alterarImovelInscricaoActionForm.get("localidadeDestinoID").equals("")
							|| alterarImovelInscricaoActionForm.get("localidadeOrigemID").equals(
											alterarImovelInscricaoActionForm.get("localidadeDestinoID"))){
				alterarImovelInscricaoActionForm.set("localidadeDestinoID", String.valueOf(objetoLocalidade.getId()));
				alterarImovelInscricaoActionForm.set("nomeLocalidadeDestino", objetoLocalidade.getDescricao());
			}
		...
		localidadeIDDestino = (String) alterarImovelInscricaoActionForm.get("localidadeDestinoID");
		...
		if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
			...
			// do formulário
			alterarImovelInscricaoActionForm.set("localidadeDestinoID", "");
			alterarImovelInscricaoActionForm.set("nomeLocalidadeDestino", "Localidade inexistente");
	...
	private void pesquisarSetorComercial(String inscricaoTipo, DynaValidatorForm alterarImovelInscricaoActionForm, Fachada fachada,
					HttpServletRequest httpServletRequest){
		...
		if(localidadeIDOrigem != null && !localidadeIDOrigem.trim().equalsIgnoreCase("")){
			...
			setorComercialCDOrigem = (String) alterarImovelInscricaoActionForm.get("setorComercialOrigemCD");
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()
							&& !alterarImovelInscricaoActionForm.get("setorComercialOrigemCD").equals("")){
				// Setor Comercial nao encontrado
				// Limpa os campos setorComercialOrigemCD,
				// nomeSetorComercialOrigem e setorComercialOrigemID do
				// formulário
				if(alterarImovelInscricaoActionForm.get("setorComercialOrigemCD").equals(
								alterarImovelInscricaoActionForm.get("setorComercialDestinoCD"))){
					alterarImovelInscricaoActionForm.set("setorComercialDestinoCD", "");
				}
				alterarImovelInscricaoActionForm.set("setorComercialOrigemCD", "");
				alterarImovelInscricaoActionForm.set("setorComercialOrigemID", "");
				alterarImovelInscricaoActionForm.set("nomeSetorComercialOrigem", "Setor comercial inexistente");
				...
				alterarImovelInscricaoActionForm.set("setorComercialOrigemCD", String.valueOf(objetoSetorComercial.getCodigo()));
				alterarImovelInscricaoActionForm.set("setorComercialOrigemID", String.valueOf(objetoSetorComercial.getId()));
				alterarImovelInscricaoActionForm.set("nomeSetorComercialOrigem", objetoSetorComercial.getDescricao());
				if(alterarImovelInscricaoActionForm.get("setorComercialDestinoCD") == null
								|| alterarImovelInscricaoActionForm.get("setorComercialDestinoCD").equals("")
								|| alterarImovelInscricaoActionForm.get("setorComercialDestinoCD").equals(
												alterarImovelInscricaoActionForm.get("setorComercialOrigemCD"))){
					alterarImovelInscricaoActionForm.set("setorComercialDestinoCD", String.valueOf(objetoSetorComercial.getCodigo()));
					alterarImovelInscricaoActionForm.set("setorComercialDestinoID", String.valueOf(objetoSetorComercial.getId()));
					alterarImovelInscricaoActionForm.set("nomeSetorComercialDestino", objetoSetorComercial.getDescricao());
				}
				httpServletRequest.setAttribute("corSetorComercialOrigem", "valor");
				// Verifica se qual a Empresa
			...
			if(!alterarImovelInscricaoActionForm.get("setorComercialOrigemCD").equals("")){
				alterarImovelInscricaoActionForm.set("setorComercialOrigemCD", "");
				alterarImovelInscricaoActionForm.set("nomeSetorComercialOrigem", "Informe a localidade da inscrição de origem.");
				httpServletRequest.setAttribute("corSetorComercialOrigem", "exception");
			}
		}
		// Recebe o valor do campo localidadeDestinoID do formulário.
		...
		if(localidadeIDDestino != null && !localidadeIDDestino.trim().equalsIgnoreCase("")){
			...
			setorComercialCDDestino = (String) alterarImovelInscricaoActionForm.get("setorComercialDestinoCD");
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				// formulário
				alterarImovelInscricaoActionForm.set("setorComercialDestinoCD", "");
				alterarImovelInscricaoActionForm.set("setorComercialDestinoID", "");
				alterarImovelInscricaoActionForm.set("nomeSetorComercialDestino", "Setor comercial inexistente");
			...
			alterarImovelInscricaoActionForm.set("setorComercialDestinoCD", "");
			alterarImovelInscricaoActionForm.set("nomeSetorComercialDestino", "Informe a localidade da inscrição de destino.");
			httpServletRequest.setAttribute("corSetorComercialDestino", "exception");
		}
	}

	private void pesquisarQuadra(String inscricaoTipo, DynaValidatorForm alterarImovelInscricaoActionForm, Fachada fachada,
					HttpServletRequest httpServletRequest){
		...
		setorComercialIDOrigem = (String) alterarImovelInscricaoActionForm.get("setorComercialOrigemID");
		...
		if(setorComercialCDOrigem != null && !setorComercialCDOrigem.trim().equalsIgnoreCase("") && setorComercialIDOrigem != null
			...
			quadraNMOrigem = (String) alterarImovelInscricaoActionForm.get("quadraOrigemNM");
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty() && !alterarImovelInscricaoActionForm.get("quadraOrigemNM").equals("")){
				...
				// Mensagem de tela
				alterarImovelInscricaoActionForm.set("quadraMensagemOrigem", "Quadra inexistente");
				...
				alterarImovelInscricaoActionForm.set("quadraOrigemNM", String.valueOf(objetoQuadra.getNumeroQuadra()));
				alterarImovelInscricaoActionForm.set("quadraOrigemID", String.valueOf(objetoQuadra.getId()));
				if(alterarImovelInscricaoActionForm.get("quadraDestinoNM") == null
					...
					alterarImovelInscricaoActionForm.set("quadraDestinoNM", String.valueOf(objetoQuadra.getNumeroQuadra()));
					alterarImovelInscricaoActionForm.set("quadraDestinoID", String.valueOf(objetoQuadra.getId()));
				}
			...
			if(!alterarImovelInscricaoActionForm.get("quadraOrigemNM").equals("")){
				...
				alterarImovelInscricaoActionForm.set("quadraOrigemNM", "");
				alterarImovelInscricaoActionForm.set("quadraMensagemOrigem", "Informe o setor comercial da inscrição de origem.");
				httpServletRequest.setAttribute("corQuadraOrigem", "exception");
			}
		}
		// Recebe os valores dos campos setorComercialOrigemCD e
		// setorComercialOrigemID do formulário.
		setorComercialCDDestino = (String) alterarImovelInscricaoActionForm.get("setorComercialDestinoCD");
		setorComercialIDDestino = (String) alterarImovelInscricaoActionForm.get("setorComercialDestinoID");
		...
		if(setorComercialCDDestino != null && !setorComercialCDDestino.trim().equalsIgnoreCase("") && setorComercialIDDestino != null
			...
			quadraNMDestino = (String) alterarImovelInscricaoActionForm.get("quadraDestinoNM");
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				// Mensagem de tela
				alterarImovelInscricaoActionForm.set("quadraMensagemDestino", "Quadra inexistente");
			...
			alterarImovelInscricaoActionForm.set("quadraDestinoNM", "");
			// Mensagem de tela
			alterarImovelInscricaoActionForm.set("quadraMensagemDestino", "Informe o setor comercial da inscrição.");
			httpServletRequest.setAttribute("corQuadraDestino", "exception");
		}
	}
}
