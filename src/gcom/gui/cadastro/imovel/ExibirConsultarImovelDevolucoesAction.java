 ...
 * @since 21/09/2006
 */
public class ExibirConsultarImovelDevolucoesAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((idImovelDevolucoesImovel != null && !idImovelDevolucoesImovel.equalsIgnoreCase(""))
			...
			// if( idImovelDevolucoesImovel != null && idImovelPrincipalAba != null
			// && idImovelPrincipalAba.equals(idImovelDevolucoesImovel)){
			...
			if(idImovelDevolucoesImovel != null && !idImovelDevolucoesImovel.equalsIgnoreCase("")){
				...
				if(idImovelPrincipalAba != null && !idImovelPrincipalAba.equalsIgnoreCase("")){
					...
					if(indicadorNovo != null && !indicadorNovo.equals("")){
						...
						// idImovelDevolucoesImovel = idImovelDevolucoesImovel;
			...
			if(imovel != null){
				...
				if(imovelNovoPesquisado){
					...
					filtroDevolucao.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.contaGeral");
					 ...
					 * "guiaDevolucao.guiaPagamento.debitoTipo");
					 */
					...
					filtroDevolucao.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.debitoACobrarGeral.debitoACobrarHistorico.debitoTipo");
					filtroDevolucao.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.debitoACobrarGeral.debitoACobrar.imovel");
					filtroDevolucao.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.debitoACobrarGeral.debitoACobrarHistorico.imovel");
					...
					Collection colecaoImoveisDevolucoes = fachada.pesquisar(filtroDevolucao, Devolucao.class.getName());
					...
					filtroDevolucaoHistorico.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.contaGeral");
					...
					filtroDevolucaoHistorico.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.guiaPagamentoGeral.guiaPagamento");
					filtroDevolucaoHistorico.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.guiaPagamentoGeral.guiaPagamentoHistorico");
					/*
					...
					filtroDevolucaoHistorico
									.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.debitoACobrarGeral.debitoACobrarHistorico.debitoTipo");
					filtroDevolucaoHistorico
									.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.debitoACobrarGeral.debitoACobrar.imovel");
					filtroDevolucaoHistorico
									.adicionarCaminhoParaCarregamentoEntidade("guiaDevolucao.debitoACobrarGeral.debitoACobrarHistorico.imovel");
					...
					Collection colecaoImoveisDevolucoesHistorico = fachada.pesquisar(filtroDevolucaoHistorico, DevolucaoHistorico.class
									.getName());
					...
					if(colecaoImoveisDevolucoes != null || colecaoImoveisDevolucoesHistorico != null){
						...
						if(colecaoImoveisDevolucoesHistorico != null){
							...
							while(colecaoDevolucaoHistoricoIterator.hasNext()){
								...
								if(devolucaoHistorico.getGuiaDevolucao() != null){
									...
									}else if(devolucaoHistorico.getGuiaDevolucao().getDocumentoTipo().getId().equals(
						...
						if(colecaoDevolucaoImovelConta != null && !colecaoDevolucaoImovelConta.isEmpty()){
							...
							sessao.setAttribute("colecaoDevolucaoImovelConta", colecaoDevolucaoImovelConta);
						...
						if(colecaoDevolucaoHistoricoImovelConta != null && !colecaoDevolucaoHistoricoImovelConta.isEmpty()){
							...
							sessao.setAttribute("colecaoDevolucaoHistoricoImovelConta", colecaoDevolucaoHistoricoImovelConta);
						...
						if(colecaoDevolucaoImovelGuiaPagamento != null && !colecaoDevolucaoImovelGuiaPagamento.isEmpty()){
							...
							sessao.setAttribute("colecaoDevolucaoImovelGuiaPagamento", colecaoDevolucaoImovelGuiaPagamento);
						...
						if(colecaoDevolucaoHistoricoImovelGuiaPagamento != null && !colecaoDevolucaoHistoricoImovelGuiaPagamento.isEmpty()){
							...
							sessao.setAttribute("colecaoDevolucaoHistoricoImovelGuiaPagamento",
						...
						if(colecaoDevolucaoImovelDebitoACobrar != null && !colecaoDevolucaoImovelDebitoACobrar.isEmpty()){
							...
							sessao.setAttribute("colecaoDevolucaoImovelDebitoACobrar", colecaoDevolucaoImovelDebitoACobrar);
						...
						if(colecaoDevolucaoHistoricoImovelDebitoACobrar != null && !colecaoDevolucaoHistoricoImovelDebitoACobrar.isEmpty()){
							...
							sessao.setAttribute("colecaoDevolucaoHistoricoImovelDebitoACobrar",
						...
						if(colecaoDevolucaoImovelDevolucaoValor != null && !colecaoDevolucaoImovelDevolucaoValor.isEmpty()){
							...
							sessao.setAttribute("colecaoDevolucaoImovelDevolucaoValor", colecaoDevolucaoImovelDevolucaoValor);
						...
						if(colecaoDevolucaoHistoricoImovelDevolucaoValor != null
							...
							sessao.setAttribute("colecaoDevolucaoHistoricoImovelDevolucaoValor",
				...
				httpServletRequest.setAttribute("idImovelDevolucoesImovelNaoEncontrado", "true");
