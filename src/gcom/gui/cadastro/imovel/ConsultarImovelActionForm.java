 ...
 * @date 26/06/2008
 *       Adição dos Atributos de Credito de Consumo nos Históricos de Medição
 */
public class ConsultarImovelActionForm
	...
	private String esgotamento;

	private String padraoConstrucao;

	private String numeroQuarto;

	private String numeroBanheiro;

	private String rendaFamiliarFaixa;

	private String numeroAdulto;

	private String numeroCrianca;

	private String numeroMoradorTrabalhador;
	...
	// Dados 2° Aba - Dados Complementares
	...
	private String dataValidadeTarifaConsumo;
	...
	private String situacoesCobrancaImovel;

	private String quantidadeCortes;

	private String quantidadeCortesAdministrativos;

	private String quantidadeSupressoes;
	...
	private String matriculaFuncionarioReligacao;

	private String nomeFuncionarioHintReligacao;
	...
	private String consumoCreditoAnterior;
	...
	private String consumoMinimoCreditadoMes;
	...
	private String numeroLeituraInstalacaoPoco;
	...
	private String descricaoRamalLocalInstalacaoEsgoto;
	...
	private String nomeFuncionarioHintPoco;

	private String consumoMedidoEsgoto;

	private String consumoCreditoAnteriorEsgoto;
	...
	private String consumoMinimoCreditadoEsgoto;
	...
	// Dados 11° Aba - Histórico de alteracao do imóvel
	private String idAlteracao;

	private String dataRealizacaoAlteracao;

	private String descricaoOperacaoAlteracao;

	private String usuarioOperacaoAlteracao;

	private String descricaoTabelaAlteracao;

	private String tipoAlteracao;

	private String campoTabelaAlteracao;

	private String conteudoAnteriorAlteracao;

	private String conteudoAtualAlteracao;

	private String idImovelHistoricoAlteracao;

	private String matriculaImovelHistoricoAlteracao;

	private String situacaoAguaHistoricoAlteracao;

	private String situacaoEsgotoHistoricoAlteracao;
	...
	public void setEnderecoImovelDadosCadastrais(String enderecoImovelDadosCadastrais){
	...
	public void setSituacaoEsgotoDadosCadastrais(String situacaoEsgotoDadosCadastrais){
	 ...
	 */
	public void setEsgotamento(String esgotamento){
	 ...
	 */
	public String getPadraoConstrucao(){
	 ...
	 */
	public void setPadraoConstrucao(String padraoConstrucao){
	 ...
	 */
	public String getNumeroBanheiro(){
	 ...
	 */
	public void setNumeroBanheiro(String numeroBanheiro){
	 ...
	 */
	public String getRendaFamiliarFaixa(){
	 ...
	 */
	public void setRendaFamiliarFaixa(String rendaFamiliarFaixa){
	 ...
	 */
	public void setNumeroAdulto(String numeroAdulto){
	 ...
	 */
	public String getNumeroCrianca(){
	 ...
	 */
	public void setNumeroCrianca(String numeroCrianca){
	 ...
	 */
	public String getNumeroMoradorTrabalhador(){
	 ...
	 */
	public void setNumeroMoradorTrabalhador(String numeroMoradorTrabalhador){
	...
	public void setAreaConstruidaDadosDadosCadastrais(String areaConstruidaDadosDadosCadastrais){
	...
	public void setCadastroOcorrenciaDadosCadastrais(String cadastroOcorrenciaDadosCadastrais){
	...
	public void setDistritoOperacionalDadosCadastrais(String distritoOperacionalDadosCadastrais){
	...
	public void setEloAnormalidadeDadosCadastrais(String eloAnormalidadeDadosCadastrais){
	...
	public void setFonteAbastecimentoDadosCadastrais(String fonteAbastecimentoDadosCadastrais){
	...
	public void setImovelCondominioDadosCadastrais(String imovelCondominioDadosCadastrais){
	...
	public void setImovelPrincipalDadosCadastrais(String imovelPrincipalDadosCadastrais){
	...
	public void setIndicadorImovelCondominioDadosCadastrais(String indicadorImovelCondominioDadosCadastrais){
	...
	public void setPavimentoCalcadaDadosCadastrais(String pavimentoCalcadaDadosCadastrais){
	...
	public void setVolumeReservatorioInferiorDadosCadastrais(String volumeReservatorioInferiorDadosCadastrais){
	...
	public void setVolumeReservatorioSuperiorDadosCadastrais(String volumeReservatorioSuperiorDadosCadastrais){
	...
	public void setNumeroMoradoresDadosCadastrais(String numeroMoradoresDadosCadastrais){
	...
	public void setNumeroPontosUtilizacaoDadosCadastrais(String numeroPontosUtilizacaoDadosCadastrais){
	...
	public void setEnderecoImovelDadosComplementares(String enderecoImovelDadosComplementares){
	...
	public void setSituacaoAguaDadosComplementares(String situacaoAguaDadosComplementares){
	...
	public void setSituacaoEsgotoDadosComplementares(String situacaoEsgotoDadosComplementares){

		this.situacaoEsgotoDadosComplementares = situacaoEsgotoDadosComplementares;
	}

	/**
	 * @return the situacoesCobrancaImovel
	 */
	public String getSituacoesCobrancaImovel(){

		return situacoesCobrancaImovel;
	}

	/**
	 * @param situacoesCobrancaImovel
	 *            the situacoesCobrancaImovel to set
	 */
	public void setSituacoesCobrancaImovel(String situacoesCobrancaImovel){

		this.situacoesCobrancaImovel = situacoesCobrancaImovel;
	}
	...
	public void setDescricaoAnormalidadeDadosComplementares(String descricaoAnormalidadeDadosComplementares){
	...
	public void setDescricaoOcorrenciaDadosComplementares(String descricaoOcorrenciaDadosComplementares){
	...
	public void setQuantidadeParcelamentosDadosComplementares(String quantidadeParcelamentosDadosComplementares){
	...
	public void setQuantidadeReparcelamentoConsecutivosDadosComplementares(String quantidadeReparcelamentoConsecutivosDadosComplementares){
	...
	public void setQuantidadeReparcelamentoDadosComplementares(String quantidadeReparcelamentoDadosComplementares){
	...
	public void setQuantidadeRetificacoesDadosComplementares(String quantidadeRetificacoesDadosComplementares){
	...
	public void setSituacaoCobrancaDadosComplementares(String situacaoCobrancaDadosComplementares){
	...
	public void setTarifaConsumoDadosComplementares(String tarifaConsumoDadosComplementares){

		this.tarifaConsumoDadosComplementares = tarifaConsumoDadosComplementares;
	}

	public String getDataValidadeTarifaConsumo(){

		return dataValidadeTarifaConsumo;
	}

	public void setDataValidadeTarifaConsumo(String dataValidadeTarifaConsumo){

		this.dataValidadeTarifaConsumo = dataValidadeTarifaConsumo;
	}
	...
	public String getConsumoCreditoAnterior(){

		return consumoCreditoAnterior;
	}

	public void setConsumoCreditoAnterior(String consumoCreditoAnterior){
	...
	public void setIdImovelAnaliseMedicaoConsumo(String idImovelAnaliseMedicaoConsumo){
	...
	public String getDescricaoRamalLocalInstalacaoEsgoto(){

		return descricaoRamalLocalInstalacaoEsgoto;
	}

	public void setDescricaoRamalLocalInstalacaoEsgoto(String descricaoRamalLocalInstalacaoEsgoto){

		this.descricaoRamalLocalInstalacaoEsgoto = descricaoRamalLocalInstalacaoEsgoto;
	}
	...
	public void setSituacaoAguaAnaliseMedicaoConsumo(String situacaoAguaAnaliseMedicaoConsumo){
	...
	public void setSituacaoEsgotoAnaliseMedicaoConsumo(String situacaoEsgotoAnaliseMedicaoConsumo){
	...
	public void setMatriculaImovelDadosCadastrais(String matriculaImovelDadosCadastrais){
	...
	public void setMatriculaImovelDadosComplementares(String matriculaImovelDadosComplementares){
	...
	public void setMatriculaImovelAnaliseMedicaoConsumo(String matriculaImovelAnaliseMedicaoConsumo){
	...
	public void setMatriculaImovelHistoricoFaturamento(String matriculaImovelHistoricoFaturamento){
	...
	public void setSituacaoAguaHistoricoFaturamento(String situacaoAguaHistoricoFaturamento){
	...
	public void setSituacaoEsgotoHistoricoFaturamento(String situacaoEsgotoHistoricoFaturamento){
	 ...
	 *            O dataVencimentoFinal a ser setado.
	 */
	 ...
	 *            O dataVencimentoInicial a ser setado.
	 */
	...
	/**
	 * @param tipoRelacaoCliente
	 *            O tipoRelacaoCliente a ser setado.
	 */
	...
	/**
	 * @param idImovelDebitos
	 *            O idImovelDebitos a ser setado.
	 */
	...
	/**
	 * @param matriculaImovelDebitos
	 *            O matriculaImovelDebitos a ser setado.
	 */
	...
	/**
	 * @param situacaoEsgotoDebitos
	 *            O situacaoEsgotoDebitos a ser setado.
	 */
	...
	/**
	 * @param situacaoaguaDebitos
	 *            O situacaoaguaDebitos a ser setado.
	 */
	...
	/**
	 * @param idImovelPagamentos
	 *            O idImovelPagamentos a ser setado.
	 */
	...
	/**
	 * @param matriculaImovelPagamentos
	 *            O matriculaImovelPagamentos a ser setado.
	 */
	...
	/**
	 * @param situacaoAguaPagamentos
	 *            O situacaoAguaPagamentos a ser setado.
	 */
	...
	/**
	 * @param situacaoEsgotoPagamentos
	 *            O situacaoEsgotoPagamentos a ser setado.
	 */
	...
	/**
	 * @param idImovelDocumentosCobranca
	 *            O idImovelDocumentosCobranca a ser setado.
	 */
	...
	/**
	 * @param matriculaImovelDocumentosCobranca
	 *            O matriculaImovelDocumentosCobranca a ser setado.
	 */
	public void setMatriculaImovelDocumentosCobranca(String matriculaImovelDocumentosCobranca){
	...
	/**
	 * @param situacaoAguaDocumentosCobranca
	 *            O situacaoAguaDocumentosCobranca a ser setado.
	 */
	public void setSituacaoAguaDocumentosCobranca(String situacaoAguaDocumentosCobranca){
	...
	/**
	 * @param situacaoEsgotoDocumentosCobranca
	 *            O situacaoEsgotoDocumentosCobranca a ser setado.
	 */
	public void setSituacaoEsgotoDocumentosCobranca(String situacaoEsgotoDocumentosCobranca){
	...
	/**
	 * @param idImovelParcelamentosDebitos
	 *            O idImovelParcelamentosDebitos a ser setado.
	 */
	...
	/**
	 * @param matriculaImovelParcelamentosDebitos
	 *            O matriculaImovelParcelamentosDebitos a ser setado.
	 */
	public void setMatriculaImovelParcelamentosDebitos(String matriculaImovelParcelamentosDebitos){
	...
	/**
	 * @param situacaoAguaParcelamentosDebitos
	 *            O situacaoAguaParcelamentosDebitos a ser setado.
	 */
	public void setSituacaoAguaParcelamentosDebitos(String situacaoAguaParcelamentosDebitos){
	...
	/**
	 * @param situacaoEsgotoParcelamentosDebitos
	 *            O situacaoEsgotoParcelamentosDebitos a ser setado.
	 */
	public void setSituacaoEsgotoParcelamentosDebitos(String situacaoEsgotoParcelamentosDebitos){
	...
	/**
	 * @param reparcelamento
	 *            O reparcelamento a ser setado.
	 */
	...
	/**
	 * @param reparcelamentoConsecutivo
	 *            O reparcelamentoConsecutivo a ser setado.
	 */
	...
	/**
	 * @param idImovelDevolucoesImovel
	 *            O idImovelDevolucoesImovel a ser setado.
	 */
	...
	/**
	 * @param idImovelRegistroAtendimento
	 *            O idImovelRegistroAtendimento a ser setado.
	 */
	...
	/**
	 * @param matriculaImovelDevolucoesImovel
	 *            O matriculaImovelDevolucoesImovel a ser setado.
	 */
	public void setMatriculaImovelDevolucoesImovel(String matriculaImovelDevolucoesImovel){
	...
	/**
	 * @param matriculaImovelRegistroAtendimento
	 *            O matriculaImovelRegistroAtendimento a ser setado.
	 */
	public void setMatriculaImovelRegistroAtendimento(String matriculaImovelRegistroAtendimento){
	...
	/**
	 * @param situacaoAguaDevolucoesImovel
	 *            O situacaoAguaDevolucoesImovel a ser setado.
	 */
	...
	/**
	 * @param situacaoAguaRegistroAtendimento
	 *            O situacaoAguaRegistroAtendimento a ser setado.
	 */
	public void setSituacaoAguaRegistroAtendimento(String situacaoAguaRegistroAtendimento){
	...
	/**
	 * @param situacaoEsgotoDevolucoesImovel
	 *            O situacaoEsgotoDevolucoesImovel a ser setado.
	 */
	public void setSituacaoEsgotoDevolucoesImovel(String situacaoEsgotoDevolucoesImovel){
	...
	/**
	 * @param situacaoEsgotoRegistroAtendimento
	 *            O situacaoEsgotoRegistroAtendimento a ser setado.
	 */
	public void setSituacaoEsgotoRegistroAtendimento(String situacaoEsgotoRegistroAtendimento){
	...
	/**
	 * @param jardimDadosCadastrais
	 *            O jardimDadosCadastrais a ser setado.
	 */
	...
	/**
	 * @param descricaoArrecadador
	 *            O descricaoArrecadador a ser setado.
	 */
	...
	/**
	 * @param sequencialAviso
	 *            O sequencialAviso a ser setado.
	 */
	...
	/**
	 * @param anoFabricacaoPoco
	 *            O anoFabricacaoPoco a ser setado.
	 */
	 ...
	 *            O capacidadeHidrometroPoco a ser setado.
	 */
	 ...
	 *            O diametroHidrometroPoco a ser setado.
	 */
	...
	/**
	 * @param indicadorCavaletePoco
	 *            O indicadorCavaletePoco a ser setado.
	 */
	...
	/**
	 * @param instalacaoHidrometroPoco
	 *            O instalacaoHidrometroPoco a ser setado.
	 */
	 ...
	 *            O localInstalacaoHidrometroPoco a ser setado.
	 */
	public void setLocalInstalacaoHidrometroPoco(String localInstalacaoHidrometroPoco){
	 ...
	 *            O marcaHidrometroPoco a ser setado.
	 */
	...
	/**
	 * @param numeroHidrometroPoco
	 *            O numeroHidrometroPoco a ser setado.
	 */
	...
	/**
	 * @param protecaoHidrometroPoco
	 *            O protecaoHidrometroPoco a ser setado.
	 */
	 ...
	 *            O tipoHidrometroPoco a ser setado.
	 */
	...
	/**
	 * @param tipoMedicaoPoco
	 *            O tipoMedicaoPoco a ser setado.
	 */
	...
	/**
	 * @param anormalidadeLeituraFaturadaPoco
	 *            O anormalidadeLeituraFaturadaPoco a ser setado.
	 */
	public void setAnormalidadeLeituraFaturadaPoco(String anormalidadeLeituraFaturadaPoco){
	...
	/**
	 * @param anormalidadeLeituraInformadaPoco
	 *            O anormalidadeLeituraInformadaPoco a ser setado.
	 */
	public void setAnormalidadeLeituraInformadaPoco(String anormalidadeLeituraInformadaPoco){
	...
	/**
	 * @param codigoFuncionarioPoco
	 *            O codigoFuncionarioPoco a ser setado.
	 */
	...
	/**
	 * @param consumoMedioHidrometroPoco
	 *            O consumoMedioHidrometroPoco a ser setado.
	 */
	...
	/**
	 * @param dtLeituraAnteriorPoco
	 *            O dtLeituraAnteriorPoco a ser setado.
	 */
	...
	/**
	 * @param dtLeituraFaturadaPoco
	 *            O dtLeituraFaturadaPoco a ser setado.
	 */
	...
	/**
	 * @param dtLeituraInformadaPoco
	 *            O dtLeituraInformadaPoco a ser setado.
	 */
	...
	/**
	 * @param leituraAnteriorPoco
	 *            O leituraAnteriorPoco a ser setado.
	 */
	...
	/**
	 * @param leituraAtualFaturadaPoco
	 *            O leituraAtualFaturadaPoco a ser setado.
	 */
	...
	/**
	 * @param leituraAtualInformadaPoco
	 *            O leituraAtualInformadaPoco a ser setado.
	 */
	...
	/**
	 * @param situacaoLeituraAtualPoco
	 *            O situacaoLeituraAtualPoco a ser setado.
	 */
	...
	/**
	 * @param anormalidadeConsumoEsgoto
	 *            O anormalidadeConsumoEsgoto a ser setado.
	 */
	 ...
	 *            O consumoFaturadoEsgoto a ser setado.
	 */
	...
	/**
	 * @param consumoMedidoEsgoto
	 *            O consumoMedidoEsgoto a ser setado.
	 */
	...
	/**
	 * @return Retorna o campo consumoCreditoAnteriorEsgoto.
	 */
	public String getConsumoCreditoAnteriorEsgoto(){

		return consumoCreditoAnteriorEsgoto;
	}

	/**
	 * @param consumoCreditoAnteriorEsgoto
	 *            O consumoCreditoAnteriorEsgoto a ser setado.
	 */
	public void setConsumoCreditoAnteriorEsgoto(String consumoCreditoAnteriorEsgoto){

		this.consumoCreditoAnteriorEsgoto = consumoCreditoAnteriorEsgoto;
	}
	...
	/**
	 * @param consumoMedioImovelEsgoto
	 *            O consumoMedioImovelEsgoto a ser setado.
	 */
	...
	/**
	 * @param consumoRateioEsgoto
	 *            O consumoRateioEsgoto a ser setado.
	 */
	...
	/**
	 * @param consumoTipoEsgoto
	 *            O consumoTipoEsgoto a ser setado.
	 */
	...
	/**
	 * @param diasConsumoEsgoto
	 *            O diasConsumoEsgoto a ser setado.
	 */
	...
	/**
	 * @param percentualVariacaoEsgoto
	 *            O percentualVariacaoEsgoto a ser setado.
	 */
	...
	/**
	 * @param divisaoEsgotoDadosCadastrais
	 *            O divisaoEsgotoDadosCadastrais a ser setado.
	 */
	...
	public void setEnderecoAnaliseMedicaoConsumo(String enderecoAnaliseMedicaoConsumo){
	...
	public String getConsumoMinimoCreditadoMes(){

		return consumoMinimoCreditadoMes;
	}

	public void setConsumoMinimoCreditadoMes(String consumoMinimoCreditadoMes){

		this.consumoMinimoCreditadoMes = consumoMinimoCreditadoMes;
	}

	public String getConsumoMinimoCreditadoEsgoto(){

		return consumoMinimoCreditadoEsgoto;
	}

	public void setConsumoMinimoCreditadoEsgoto(String consumoMinimoCreditadoEsgoto){

		this.consumoMinimoCreditadoEsgoto = consumoMinimoCreditadoEsgoto;
	}

	/**
	 * @return the idAlteracao
	 */
	...
	/**
	 * @return the dataRealizacaoAlteracao
	 */
	public String getDataRealizacaoAlteracao(){

		return dataRealizacaoAlteracao;
	}

	/**
	 * @param dataRealizacaoAlteracao
	 *            the dataRealizacaoAlteracao to set
	 */
	public void setDataRealizacaoAlteracao(String dataRealizacaoAlteracao){

		this.dataRealizacaoAlteracao = dataRealizacaoAlteracao;
	}

	/**
	 * @return the descricaoOperacaoAlteracao
	 */
	public String getDescricaoOperacaoAlteracao(){

		return descricaoOperacaoAlteracao;
	}

	/**
	 * @param descricaoOperacaoAlteracao
	 *            the descricaoOperacaoAlteracao to set
	 */
	public void setDescricaoOperacaoAlteracao(String descricaoOperacaoAlteracao){

		this.descricaoOperacaoAlteracao = descricaoOperacaoAlteracao;
	}

	/**
	 * @return the usuarioOperacaoAlteracao
	 */
	...
	/**
	 * @param usuarioOperacaoAlteracao
	 *            the usuarioOperacaoAlteracao to set
	 */
	...
	/**
	 * @return the descricaoTabelaAlteracao
	 */
	public String getDescricaoTabelaAlteracao(){

		return descricaoTabelaAlteracao;
	}

	/**
	 * @param descricaoTabelaAlteracao
	 *            the descricaoTabelaAlteracao to set
	 */
	public void setDescricaoTabelaAlteracao(String descricaoTabelaAlteracao){

		this.descricaoTabelaAlteracao = descricaoTabelaAlteracao;
	}
	...
	/**
	 * @return the campoTabelaAlteracao
	 */
	public String getCampoTabelaAlteracao(){

		return campoTabelaAlteracao;
	}

	/**
	 * @param campoTabelaAlteracao
	 *            the campoTabelaAlteracao to set
	 */
	public void setCampoTabelaAlteracao(String campoTabelaAlteracao){

		this.campoTabelaAlteracao = campoTabelaAlteracao;
	}

	/**
	 * @return the conteudoAnteriorAlteracao
	 */
	public String getConteudoAnteriorAlteracao(){

		return conteudoAnteriorAlteracao;
	}

	/**
	 * @param conteudoAnteriorAlteracao
	 *            the conteudoAnteriorAlteracao to set
	 */
	public void setConteudoAnteriorAlteracao(String conteudoAnteriorAlteracao){

		this.conteudoAnteriorAlteracao = conteudoAnteriorAlteracao;
	}

	/**
	 * @return the conteudoAtualAlteracao
	 */
	public String getConteudoAtualAlteracao(){

		return conteudoAtualAlteracao;
	}

	/**
	 * @param conteudoAtualAlteracao
	 *            the conteudoAtualAlteracao to set
	 */
	public void setConteudoAtualAlteracao(String conteudoAtualAlteracao){

		this.conteudoAtualAlteracao = conteudoAtualAlteracao;
	}

	public String getMatriculaImovelHistoricoAlteracao(){

		return matriculaImovelHistoricoAlteracao;
	}

	public void setMatriculaImovelHistoricoAlteracao(String matriculaImovelHistoricoAlteracao){

		this.matriculaImovelHistoricoAlteracao = matriculaImovelHistoricoAlteracao;
	}

	/**
	 * @return the situacaoAguaHistoricoAlteracao
	 */
	public String getSituacaoAguaHistoricoAlteracao(){

		return situacaoAguaHistoricoAlteracao;
	}

	/**
	 * @param situacaoAguaHistoricoAlteracao
	 *            the situacaoAguaHistoricoAlteracao to set
	 */
	public void setSituacaoAguaHistoricoAlteracao(String situacaoAguaHistoricoAlteracao){

		this.situacaoAguaHistoricoAlteracao = situacaoAguaHistoricoAlteracao;
	}

	/**
	 * @return the situacaoEsgotoHistoricoAlteracao
	 */
	public String getSituacaoEsgotoHistoricoAlteracao(){

		return situacaoEsgotoHistoricoAlteracao;
	}

	/**
	 * @param situacaoEsgotoHistoricoAlteracao
	 *            the situacaoEsgotoHistoricoAlteracao to set
	 */
	public void setSituacaoEsgotoHistoricoAlteracao(String situacaoEsgotoHistoricoAlteracao){

		this.situacaoEsgotoHistoricoAlteracao = situacaoEsgotoHistoricoAlteracao;
	}

	/**
	 * @return the idImovelHistoricoAlteracao
	 */
	public String getIdImovelHistoricoAlteracao(){

		return idImovelHistoricoAlteracao;
	}

	/**
	 * @param idImovelHistoricoAlteracao
	 *            the idImovelHistoricoAlteracao to set
	 */
	public void setIdImovelHistoricoAlteracao(String idImovelHistoricoAlteracao){

		this.idImovelHistoricoAlteracao = idImovelHistoricoAlteracao;
	}
	...
	public String getNomeFuncionarioHintPoco(){

		return nomeFuncionarioHintPoco;
	}

	public void setNomeFuncionarioHintPoco(String nomeFuncionarioHintPoco){

		this.nomeFuncionarioHintPoco = nomeFuncionarioHintPoco;
	}

	public String getDescricaoOpcaoEnvioConta(){

		return descricaoOpcaoEnvioConta;
	}

	public void setDescricaoOpcaoEnvioConta(String descricaoOpcaoEnvioConta){

		this.descricaoOpcaoEnvioConta = descricaoOpcaoEnvioConta;
	}
	...
	/**
	 * @return the matriculaFuncionarioReligacao
	 */
	public String getMatriculaFuncionarioReligacao(){

		return matriculaFuncionarioReligacao;
	}

	/**
	 * @param matriculaFuncionarioReligacao
	 *            the matriculaFuncionarioReligacao to set
	 */
	public void setMatriculaFuncionarioReligacao(String matriculaFuncionarioReligacao){

		this.matriculaFuncionarioReligacao = matriculaFuncionarioReligacao;
	}

	/**
	 * @return the nomeFuncionarioHintReligacao
	 */
	public String getNomeFuncionarioHintReligacao(){

		return nomeFuncionarioHintReligacao;
	}

	/**
	 * @param nomeFuncionarioHintReligacao
	 *            the nomeFuncionarioHintReligacao to set
	 */
	public void setNomeFuncionarioHintReligacao(String nomeFuncionarioHintReligacao){

		this.nomeFuncionarioHintReligacao = nomeFuncionarioHintReligacao;
	}

	/**
	 * @return the quantidadeCortes
	 */
	public String getQuantidadeCortes(){

		return quantidadeCortes;
	}

	/**
	 * @param quantidadeCortes
	 *            the quantidadeCortes to set
	 */
	public void setQuantidadeCortes(String quantidadeCortes){

		this.quantidadeCortes = quantidadeCortes;
	}

	/**
	 * @return the quantidadeCortesAdministrativos
	 */
	public String getQuantidadeCortesAdministrativos(){

		return quantidadeCortesAdministrativos;
	}

	/**
	 * @param quantidadeCortesAdministrativos
	 *            the quantidadeCortesAdministrativos to set
	 */
	public void setQuantidadeCortesAdministrativos(String quantidadeCortesAdministrativos){

		this.quantidadeCortesAdministrativos = quantidadeCortesAdministrativos;
	}

	/**
	 * @return the quantidadeSupressoes
	 */
	public String getQuantidadeSupressoes(){

		return quantidadeSupressoes;
	}

	/**
	 * @param quantidadeSupressoes
	 *            the quantidadeSupressoes to set
	 */
	public void setQuantidadeSupressoes(String quantidadeSupressoes){
	...
	public String getNumeroLeituraInstalacaoPoco(){

		return numeroLeituraInstalacaoPoco;
	}

	public void setNumeroLeituraInstalacaoPoco(String numeroLeituraInstalacaoPoco){

		this.numeroLeituraInstalacaoPoco = numeroLeituraInstalacaoPoco;
	}
