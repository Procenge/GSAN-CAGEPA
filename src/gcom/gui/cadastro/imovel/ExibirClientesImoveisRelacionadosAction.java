...
public class ExibirClientesImoveisRelacionadosAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("filtrarClientesImoveisRelacionados");
		...
		if((form.getIdImovelCondominio() != null) && !(form.getIdImovelCondominio().equals(""))){
			...
			if(coll != null && !coll.isEmpty()){
				...
				if(imovel.getIndicadorImovelCondominio().equals(new Short("1"))){
		 ...
		 * Collection<NomeConta> collectionsNomeConta = fachada.pesquisar(filtroNomeConta,
		 * NomeConta.class.getName() );
		...
		Collection<ClienteRelacaoTipo> collectionsClienteRelacaoTipo = fachada.pesquisar(filtroClienteRelacaoTipo, ClienteRelacaoTipo.class
						.getName());

		if(collectionsClienteRelacaoTipo == null || collectionsClienteRelacaoTipo.isEmpty()){
			throw new ActionServletException("atencao.naocadastrado", null, "Tipo da Relação");
		}
