...
public class FiltrarImovelCurvaAbcDebitosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(imovelCurvaAbcDebitosActionForm.getValorMinimoDebito() == null){
			...
			filtrar.exibirFiltrarImovelCurvaAbcDebitosDebito(actionMapping, actionForm, httpServletRequest, httpServletResponse);
		}
