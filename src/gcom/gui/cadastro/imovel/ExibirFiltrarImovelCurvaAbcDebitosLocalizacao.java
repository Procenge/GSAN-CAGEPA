...
public class ExibirFiltrarImovelCurvaAbcDebitosLocalizacao
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarImovelCurvaAbcDebitosLocalizacao");
		...
		if(imovelCurvaAbcDebitosActionForm.getClassificacao().equalsIgnoreCase("ESTADO")){
			...
			if(sessao.getAttribute("abaAtual") == "PARAMETROS"){
				...
				filtrar.exibirFiltrarImovelCurvaAbcDebitosLigacaoAguaEsgoto(actionMapping, actionForm, httpServletRequest,
								httpServletResponse);
				...
				filtrar.exibirFiltrarImovelCurvaAbcDebitosParametros(actionMapping, actionForm, httpServletRequest, httpServletResponse);
			}
			...
			if(sessao.getAttribute("colecaoGerenciasRegionais") == null){
				...
				if((colecaoGerenciasRegionais == null) || (colecaoGerenciasRegionais.size() == 0)){
					throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, GerenciaRegional.class.getName());
				}else{
					sessao.setAttribute("colecaoGerenciasRegionais", colecaoGerenciasRegionais);
				}
			}

			if(sessao.getAttribute("colecaoUnidadesNegocios") == null){
				...
				if(colecaoUnidadeNegocio == null || colecaoUnidadeNegocio.isEmpty()){
					...
					sessao.setAttribute("colecaoUnidadesNegocios", colecaoUnidadeNegocio);
				}
	...
	private void pesquisarLocalidade(String inscricaoTipo, ImovelCurvaAbcDebitosActionForm imovelCurvaAbcDebitosActionForm,
		...
		if(inscricaoTipo.equalsIgnoreCase("origem")){
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				imovelCurvaAbcDebitosActionForm.setNomeLocalidadeInicial("");
	...
	private void pesquisarSetorComercial(String inscricaoTipo, ImovelCurvaAbcDebitosActionForm imovelCurvaAbcDebitosActionForm,
					Fachada fachada, HttpServletRequest httpServletRequest){
		...
		if(inscricaoTipo.equalsIgnoreCase("origem")){
			...
			if(localidadeID != null && !localidadeID.trim().equalsIgnoreCase("")){
				...
				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					...
					imovelCurvaAbcDebitosActionForm.setCodigoSetorComercialInicial(String.valueOf(objetoSetorComercial.getCodigo()));
					imovelCurvaAbcDebitosActionForm.setIdSetorComercialInicial(String.valueOf(objetoSetorComercial.getId()));
					imovelCurvaAbcDebitosActionForm.setNomeSetorComercialInicial(objetoSetorComercial.getDescricao());

					// httpServletRequest.setAttribute("nomeCampo","quadraOrigemNM");
					// setorComercialOrigem

					// setorComercialDestino
					imovelCurvaAbcDebitosActionForm.setCodigoSetorComercialFinal(String.valueOf(objetoSetorComercial.getCodigo()));
					imovelCurvaAbcDebitosActionForm.setIdSetorComercialFinal(String.valueOf(objetoSetorComercial.getId()));
					imovelCurvaAbcDebitosActionForm.setNomeSetorComercialFinal(objetoSetorComercial.getDescricao());
				...
				imovelCurvaAbcDebitosActionForm.setCodigoSetorComercialInicial("");
				imovelCurvaAbcDebitosActionForm.setNomeSetorComercialInicial("Informe a localidade da inscrição de origem.");
