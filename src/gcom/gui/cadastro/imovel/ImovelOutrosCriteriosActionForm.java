 ...
 */
public class ImovelOutrosCriteriosActionForm
	...
	private String[] situacaoLigacaoAguaArray;

	private String[] situacaoLigacaoEsgotoArray;
	...
	private String exibirOrdenacaoNomeEndereco;
	...
	/**
	 * @param qtdContasFinal
	 *            O qtdContasFinal a ser setado.
	 */
	...
	/**
	 * @param qtdContasInicial
	 *            O qtdContasInicial a ser setado.
	 */
	...
	/**
	 * @param referenciaFaturaFinal
	 *            O referenciaFaturaFinal a ser setado.
	 */
	...
	/**
	 * @param referenciaFaturaInicial
	 *            O referenciaFaturaInicial a ser setado.
	 */
	...
	/**
	 * @param todosTipoDebito
	 *            O todosTipoDebito a ser setado.
	 */
	...
	public String getExibirOrdenacao(){

		return exibirOrdenacao;
	}

	public void setExibirOrdenacao(String exibirOrdenacao){

		this.exibirOrdenacao = exibirOrdenacao;
	}

	public String getExibirOrdenacaoNomeEndereco(){

		return exibirOrdenacaoNomeEndereco;
	}

	public void setExibirOrdenacaoNomeEndereco(String exibirOrdenacaoNomeEndereco){

		this.exibirOrdenacaoNomeEndereco = exibirOrdenacaoNomeEndereco;
	}

	public String getNomeRotaInicial(){

		return nomeRotaInicial;
	}

	public void setNomeRotaInicial(String nomeRotaInicial){

		this.nomeRotaInicial = nomeRotaInicial;
	}

	public String getNomeRotaFinal(){

		return nomeRotaFinal;
	}

	public void setNomeRotaFinal(String nomeRotaFinal){

		this.nomeRotaFinal = nomeRotaFinal;
	}

	public String[] getSituacaoLigacaoAguaArray(){

		return situacaoLigacaoAguaArray;
	}

	public void setSituacaoLigacaoAguaArray(String[] situacaoLigacaoAguaArray){

		this.situacaoLigacaoAguaArray = situacaoLigacaoAguaArray;
	}

	public String[] getSituacaoLigacaoEsgotoArray(){

		return situacaoLigacaoEsgotoArray;
	}
