 ...
 * @return
 */
public class ExibirFiltrarImovelSituacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("situacaoImovelFiltrar");
		...
		Collection<ImovelSituacaoTipo> colecaoImovelSituacaoTipo = fachada.pesquisar(filtroImovelSituacaoTipo, ImovelSituacaoTipo.class
						.getName());

		if(colecaoImovelSituacaoTipo.isEmpty()){
			throw new ActionServletException("Atencao.Sem_dados_para_selecao");
		}
		httpServletRequest.setAttribute("colecaoImovelSituacaoTipo", colecaoImovelSituacaoTipo);

		FiltroImovelSituacaoAguaLigacao filtroImovelSituacaoAguaLigacao = new FiltroImovelSituacaoAguaLigacao();

		Collection<LigacaoAguaSituacao> colecaoLigacaoAguaSituacao = fachada.pesquisar(filtroImovelSituacaoAguaLigacao,
		...
		Collection<LigacaoEsgotoSituacao> colecaoLigacaoEsgotoSituacao = fachada.pesquisar(filtroImovelSituacaoEsgotoLigacao,
