 ...
 */
public class RemoverEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Cria variaveis
		Collection colecaoImovelSubCategoriasCadastradas = (Collection) sessao.getAttribute("colecaoImovelSubCategoriasCadastradas");

		Collection colecaoImovelEconomiasModificadas = (Collection) sessao.getAttribute("colecaoImovelEconomiasModificadas");
		...
		if(httpServletRequest.getParameter("codigoImovelEconomia") != null
						&& !httpServletRequest.getParameter("codigoImovelEconomia").trim().equals("")){
			...
			while(imovelSubCategoriaIterator.hasNext()){
				...
				while(imovelEconomiaIterator.hasNext()){
					...
					if(imovelEconomia.getUltimaAlteracao().getTime() == Long.parseLong(codigoImovelEconomia)){
						...
						if(imovelEconomia.getId() == null || imovelEconomia.getId().equals("")){
						...
						if(imovelSubCategoria.getComp_id().getSubcategoria().getId().equals(
										imovelEconomia.getImovelSubcategoria().getComp_id().getSubcategoria().getId())){
							colecaoImovelEconomiaiNaoRemovidas.add(imovelEconomia);
							imovelEconomiaIterator.remove();
						}
					}
				...
				imovelSubCategoria.setImovelEconomias(new HashSet(colecaoImovelEconomiaiNaoRemovidas));
		...
		Iterator imoveisEconomiaModificadasIterator = colecaoImovelEconomiasModificadas.iterator();
		while(imoveisEconomiaModificadasIterator.hasNext()){
			ImovelEconomia imovelEconomiaModificada = (ImovelEconomia) imoveisEconomiaModificadasIterator.next();

			if(imovelEconomiaModificada.getUltimaAlteracao().getTime() == Long.parseLong(codigoImovelEconomia)){
		...
		sessao.setAttribute("colecaoImovelSubCategoriasCadastradas", colecaoImovelSubCategoriaNova);
