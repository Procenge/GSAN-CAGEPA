...
public class ExibirFiltrarImovelCurvaAbcDebitosParametros
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("filtrarImovelCurvaAbcDebitosParametros");
		...
		if(imovelCurvaAbcDebitosActionForm.getIndicadorImovelMedicaoIndividualizada() != null){
			httpServletRequest.setAttribute("indicadorImovelMedicaoIndividualizada", imovelCurvaAbcDebitosActionForm
		...
		if(imovelCurvaAbcDebitosActionForm.getIndicadorImovelParalizacaoFaturamentoCobranca() != null){
			httpServletRequest.setAttribute("indicadorImovelParalizacaoFaturamentoCobranca", imovelCurvaAbcDebitosActionForm
