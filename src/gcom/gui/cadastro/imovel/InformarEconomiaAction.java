...
public class InformarEconomiaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(colecaoImovelEconomiasModificadas != null && !colecaoImovelEconomiasModificadas.isEmpty()){
			// Cria variaveis
		...
		if(alteracao == 0){
			throw new ActionServletException("atencao.nao_atualizado_subcategoria_economia");
		}
		...
		montarPaginaSucesso(httpServletRequest,
						"Imóvel " + economiaActionForm.getIdImovel() + " com economia(s) informada(s) com sucesso.",
						"Informar outro(s) Imóvel(eis) Economia(s)", "exibirInformarEconomiaAction.do?menu=sim");
