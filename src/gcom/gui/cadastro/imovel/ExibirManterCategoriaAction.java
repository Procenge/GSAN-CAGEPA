 ...
 * @date 28/12/2006
 */
public class ExibirManterCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getAttribute("filtroCategoria") != null){
			filtroCategoria = (FiltroCategoria) httpServletRequest.getAttribute("filtroCategoria");
		}else{
			// Se o limite de registros foi atingido, a página de filtragem é chamada
			retorno = actionMapping.findForward("filtrarCategoria");
		}

		// A pesquisa de categorias só será feita se o forward estiver direcionado para a página de
		// manterCategoria
		if(retorno.getName().equalsIgnoreCase("manterCategoria")){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroCategoria, Categoria.class.getName());
