...
public class ExibirFiltrarImovelOutrosCriteriosLocalizarImoveis
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarImovelOutrosCriterios");
		...
		// Verifica qual o tipo de relatório pra exibir ou não a opção de ordenação
		String gerarRelatorio = (String) sessao.getAttribute("gerarRelatorio");
		if(!Util.isVazioOuBranco(gerarRelatorio) && gerarRelatorio.equals("RelatorioCadastroConsumidoresInscricao")){
			imovelOutrosCriteriosActionForm.setExibirOrdenacao("true");
		...
		if(!Util.isVazioOuBranco(gerarRelatorio) && gerarRelatorio.equals("RelatorioImoveisEndereco")){
			imovelOutrosCriteriosActionForm.setExibirOrdenacaoNomeEndereco("true");
		}else{
			imovelOutrosCriteriosActionForm.setExibirOrdenacaoNomeEndereco("false");
		}
		...
		if(cepId != null && !cepId.trim().equalsIgnoreCase("")){
			...
			filtroCep.adicionarParametro(new ParametroSimples(FiltroCep.CODIGO, cepId));
			...
			// pesquisa
			cepEncontrado = fachada.pesquisar(filtroCep, Cep.class.getName());
		...
		if(objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("") && inscricaoTipo != null
			...
			switch(Integer.parseInt(objetoConsulta)){
				...
				case 1:
					...
					pesquisarLocalidade(inscricaoTipo, imovelOutrosCriteriosActionForm, fachada, httpServletRequest);
				...
				case 2:
					...
					pesquisarSetorComercial(inscricaoTipo, imovelOutrosCriteriosActionForm, fachada, httpServletRequest);
				...
				case 3:
					...
					pesquisarQuadra(inscricaoTipo, imovelOutrosCriteriosActionForm, fachada, httpServletRequest);
				...
				case 4:
					...
					pesquisarRota(inscricaoTipo, imovelOutrosCriteriosActionForm, fachada, httpServletRequest);
		...
		if(sessao.getAttribute("colecaoGerenciasRegionais") == null){
			...
			Collection<GerenciaRegional> colecaoGerenciasRegionais = fachada.pesquisar(filtroGerenciaRegional, GerenciaRegional.class
							.getName());
		...
		httpServletRequest.setAttribute("ImovelOutrosCriteriosActionForm", imovelOutrosCriteriosActionForm);

		return retorno;
	}

	private void pesquisarLocalidade(String inscricaoTipo, ImovelOutrosCriteriosActionForm imovelOutrosCriteriosActionForm,
		...
		if(inscricaoTipo.equalsIgnoreCase("origem")){
			...
			localidadeID = (String) imovelOutrosCriteriosActionForm.getLocalidadeOrigemID();
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				imovelOutrosCriteriosActionForm.setLocalidadeOrigemID(String.valueOf(objetoLocalidade.getId()));
				imovelOutrosCriteriosActionForm.setNomeLocalidadeOrigem(objetoLocalidade.getDescricao());
				httpServletRequest.setAttribute("corLocalidadeOrigem", "valor");
				httpServletRequest.setAttribute("nomeCampo", "setorComercialOrigemCD");
				// destino
				imovelOutrosCriteriosActionForm.setLocalidadeDestinoID(String.valueOf(objetoLocalidade.getId()));
				imovelOutrosCriteriosActionForm.setNomeLocalidadeDestino(objetoLocalidade.getDescricao());
				httpServletRequest.setAttribute("corLocalidadeDestino", "valor");
			}
		}else{
			// Recebe o valor do campo localidadeDestinoID do formulário.
			localidadeID = (String) imovelOutrosCriteriosActionForm.getLocalidadeDestinoID();
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				// do formulário
				imovelOutrosCriteriosActionForm.setLocalidadeDestinoID("");
				imovelOutrosCriteriosActionForm.setNomeLocalidadeDestino("Localidade inexistente.");
	...
	private void pesquisarSetorComercial(String inscricaoTipo, ImovelOutrosCriteriosActionForm imovelOutrosCriteriosActionForm,
					Fachada fachada, HttpServletRequest httpServletRequest){
		...
		if(inscricaoTipo.equalsIgnoreCase("origem")){
			...
			if(localidadeID != null && !localidadeID.trim().equalsIgnoreCase("")){
				...
				setorComercialCD = (String) imovelOutrosCriteriosActionForm.getSetorComercialOrigemCD();
				...
				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					...
					imovelOutrosCriteriosActionForm.setSetorComercialOrigemID("");
					imovelOutrosCriteriosActionForm.setNomeSetorComercialOrigem("Setor comercial inexistente.");
					...
					imovelOutrosCriteriosActionForm.setSetorComercialDestinoID("");
				}else{
					SetorComercial objetoSetorComercial = (SetorComercial) Util.retonarObjetoDeColecao(colecaoPesquisa);
					// setorComercialOrigem
					imovelOutrosCriteriosActionForm.setSetorComercialOrigemCD(String.valueOf(objetoSetorComercial.getCodigo()));
					imovelOutrosCriteriosActionForm.setSetorComercialOrigemID(String.valueOf(objetoSetorComercial.getId()));
					imovelOutrosCriteriosActionForm.setNomeSetorComercialOrigem(objetoSetorComercial.getDescricao());
					httpServletRequest.setAttribute("nomeCampo", "quadraOrigemNM");
					// setorComercialOrigem

					// setorComercialDestino
					imovelOutrosCriteriosActionForm.setSetorComercialDestinoCD(String.valueOf(objetoSetorComercial.getCodigo()));
					imovelOutrosCriteriosActionForm.setSetorComercialDestinoID(String.valueOf(objetoSetorComercial.getId()));
					imovelOutrosCriteriosActionForm.setNomeSetorComercialDestino(objetoSetorComercial.getDescricao());
					// setorComercialDestino
				...
				imovelOutrosCriteriosActionForm.setSetorComercialOrigemCD("");
				imovelOutrosCriteriosActionForm.setNomeSetorComercialOrigem("Informe a localidade da inscrição de origem.");
				httpServletRequest.setAttribute("corSetorComercialOrigem", "exception");
			}
		}else{
			...
			if(localidadeID != null && !localidadeID.trim().equalsIgnoreCase("")){
				...
				setorComercialCD = (String) imovelOutrosCriteriosActionForm.getSetorComercialDestinoCD();
				...
				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					...
					imovelOutrosCriteriosActionForm.setSetorComercialDestinoCD("");
					imovelOutrosCriteriosActionForm.setSetorComercialDestinoID("");
					imovelOutrosCriteriosActionForm.setNomeSetorComercialDestino("Setor comercial inexistente.");
				...
				imovelOutrosCriteriosActionForm.setSetorComercialDestinoCD("");
				imovelOutrosCriteriosActionForm.setNomeSetorComercialDestino("Informe a localidade da inscrição de destino.");
				httpServletRequest.setAttribute("corSetorComercialDestino", "exception");
			}
		}
	...
	ImovelOutrosCriteriosActionForm imovelOutrosCriteriosActionForm, Fachada fachada, HttpServletRequest httpServletRequest){
		...
		if(inscricaoTipo.equalsIgnoreCase("origem")){
			...
			setorComercialID = (String) imovelOutrosCriteriosActionForm.getSetorComercialOrigemID();

			String idLocalidadeInicial = (String) imovelOutrosCriteriosActionForm.getLocalidadeOrigemID();
			...
			if(setorComercialCD != null && !setorComercialCD.trim().equalsIgnoreCase("") && setorComercialID != null
				...
				quadraNM = (String) imovelOutrosCriteriosActionForm.getQuadraOrigemNM();

				// coloca parametro no filtro
				filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.ID_LOCALIDADE, new Integer(idLocalidadeInicial)));
				...
				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					...
					imovelOutrosCriteriosActionForm.setQuadraOrigemNM(String.valueOf(objetoQuadra.getNumeroQuadra()));
					imovelOutrosCriteriosActionForm.setQuadraOrigemID(String.valueOf(objetoQuadra.getId()));

					imovelOutrosCriteriosActionForm.setQuadraDestinoNM(String.valueOf(objetoQuadra.getNumeroQuadra()));
					imovelOutrosCriteriosActionForm.setQuadraDestinoID(String.valueOf(objetoQuadra.getId()));
				...
				imovelOutrosCriteriosActionForm.setQuadraOrigemNM("");
				imovelOutrosCriteriosActionForm.setQuadraMensagemOrigem("Informe o setor comercial da inscrição de origem.");
				httpServletRequest.setAttribute("corQuadraOrigem", "exception");
			}
		}else{// QUADRA FINAL
			...
			// setorComercialOrigemID do formulário.
			setorComercialCD = (String) imovelOutrosCriteriosActionForm.getSetorComercialDestinoCD();
			setorComercialID = (String) imovelOutrosCriteriosActionForm.getSetorComercialDestinoID();

			String idLocalidadeFinal = (String) imovelOutrosCriteriosActionForm.getLocalidadeDestinoID();
			...
			if(setorComercialCD != null && !setorComercialCD.trim().equalsIgnoreCase("") && setorComercialID != null
				...
				quadraNM = (String) imovelOutrosCriteriosActionForm.getQuadraDestinoNM();

				// coloca parametro no filtro
				filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.ID_LOCALIDADE, new Integer(idLocalidadeFinal)));
				...
				imovelOutrosCriteriosActionForm.setQuadraDestinoNM("");
				// Mensagem de tela
				imovelOutrosCriteriosActionForm.setQuadraMensagemDestino("Informe o setor comercial da inscrição.");
				httpServletRequest.setAttribute("corQuadraDestino", "exception");
			}
		}
	...
	//
	private void pesquisarRota(String inscricaoTipo, ImovelOutrosCriteriosActionForm imovelOutrosCriteriosActionForm, Fachada fachada,
		...
		if(inscricaoTipo.equalsIgnoreCase("origem")){
			...
			if(setorComercialCD != null && !setorComercialCD.trim().equalsIgnoreCase("") && setorComercialID != null
				...
				String codigoRotaInicial = (String) imovelOutrosCriteriosActionForm.getCdRotaInicial();

				// coloca parametro no filtro
				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.LOCALIDADE_ID, new Integer(idLocalidadeInicial)));

				// Adiciona o id do setor comercial que está no formulário para
				// compor a pesquisa.
				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.SETOR_COMERCIAL_ID, setorComercialID));

				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.ID_ROTA, codigoRotaInicial));
				...
				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					imovelOutrosCriteriosActionForm.setCdRotaInicial("");
					// Mensagem de tela
					httpServletRequest.setAttribute("rotaNaoEncontradaInicial", "Mensagem");
					httpServletRequest.setAttribute("nomeCampo", "cdRotaInicial");

					// destino

					imovelOutrosCriteriosActionForm.setNomeRotaInicial("ROTA INEXISTENTE");
					imovelOutrosCriteriosActionForm.setCdRotaFinal("");
					imovelOutrosCriteriosActionForm.setNomeRotaFinal("");
				}else{
					Rota objetoRota = (Rota) Util.retonarObjetoDeColecao(colecaoPesquisa);
					imovelOutrosCriteriosActionForm.setCdRotaInicial(String.valueOf(objetoRota.getId()));
					imovelOutrosCriteriosActionForm.setNomeRotaInicial(String.valueOf(objetoRota.getDescricao()));

					imovelOutrosCriteriosActionForm.setCdRotaFinal(String.valueOf(objetoRota.getId()));
					imovelOutrosCriteriosActionForm.setNomeRotaFinal(String.valueOf(objetoRota.getDescricao()));

					httpServletRequest.setAttribute("nomeCampo", "cdRotaInicial");
				}
			}else{
				// Limpa o campo inicial do formulário
				imovelOutrosCriteriosActionForm.setCdRotaInicial("");
				httpServletRequest.setAttribute("rotaNaoEncontradaInicial", "Mensagem");
				imovelOutrosCriteriosActionForm.setNomeRotaInicial("Informe o setor comercial da inscrição de origem.");
			}
		}else{
			imovelOutrosCriteriosActionForm.setInscricaoTipo("destino");
			...
			if(setorComercialCD != null && !setorComercialCD.trim().equalsIgnoreCase("") && setorComercialID != null
				...
				String codigoRotaFinal = (String) imovelOutrosCriteriosActionForm.getCdRotaFinal();

				// coloca parametro no filtro
				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.LOCALIDADE_ID, new Integer(idLocalidadeFinal)));

				// Adiciona o id do setor comercial que está no formulário para
				// compor a pesquisa.
				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.SETOR_COMERCIAL_ID, setorComercialID));

				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.ID_ROTA, codigoRotaFinal));
				...
				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					imovelOutrosCriteriosActionForm.setCdRotaFinal("");
					// Mensagem de tela
					httpServletRequest.setAttribute("rotaNaoEncontradaFinal", "Mensagem");
					httpServletRequest.setAttribute("nomeCampo", "cdRotaFinal");

					// destino

					imovelOutrosCriteriosActionForm.setNomeRotaFinal("ROTA INEXISTENTE");
				}else{
					Rota objetoRota = (Rota) Util.retonarObjetoDeColecao(colecaoPesquisa);
					imovelOutrosCriteriosActionForm.setCdRotaFinal(String.valueOf(objetoRota.getId()));
					imovelOutrosCriteriosActionForm.setNomeRotaFinal(String.valueOf(objetoRota.getDescricao()));
				...
				imovelOutrosCriteriosActionForm.setCdRotaFinal("");
				httpServletRequest.setAttribute("rotaNaoEncontradaFinal", "Mensagem");
				imovelOutrosCriteriosActionForm.setNomeRotaInicial("Informe o setor comercial da inscrição de destino.");
			}
		}
