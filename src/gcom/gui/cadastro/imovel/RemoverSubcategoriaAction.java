 ...
 * @created 02/01/2006
 */
public class RemoverSubcategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		fachada.remover(ids, Subcategoria.class.getName(), operacaoEfetuada, colecaoUsuarios);

		// Monta a página de sucesso
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, ids.length + " Subcategoria(s) removida(s) com sucesso.",
							"Realizar outra Manutenção de Subcategoria", "exibirManterSubcategoriaAction.do");
		}
