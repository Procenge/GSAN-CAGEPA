 ...
 * @date 07/02/2007
 */
public class ExibirInserirClienteTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("inserirClienteTipo");
		...
		if(inserirClienteTipoActionForm.getEsferaPoder() == null || inserirClienteTipoActionForm.getEsferaPoder().equals("")){
