 ...
 * @date 30/10/2006
 */
public class ExibirAtualizarClienteTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarClienteTipo");
		...
		if(httpServletRequest.getParameter("reload") != null && !httpServletRequest.getParameter("reload").equals("")){

			// .......................................................

			if(atualizarClienteTipoActionForm.getTipoPessoa().equals("1")){
		...
		if(sessao.getAttribute("clienteTipoAtualizar") == null
						|| (sessao.getAttribute("clienteTipoAtualizar") != null && httpServletRequest.getParameter("idRegistroAtualizacao") != null)){
			...
			if(sessao.getAttribute("clienteTipo") != null){
				...
				sessao.setAttribute("idClienteTipo", clienteTipo.getId().toString());
				...
				if(httpServletRequest.getParameter("idRegistroAtualizacao") == null
					...
					idClienteTipo = (String) httpServletRequest.getParameter("idRegistroAtualizacao");
				...
				if(idClienteTipo != null){
					...
					httpServletRequest.setAttribute("colecaoClienteTipo", colecaoClienteTipo);

					clienteTipo = (ClienteTipo) colecaoClienteTipo.iterator().next();

				}

				if(idClienteTipo == null){
					if(sessao.getAttribute("idRegistroAtualizacao") != null){
						idClienteTipo = (String) sessao.getAttribute("idRegistroAtualizacao");
					}else{
						clienteTipo = (ClienteTipo) sessao.getAttribute("clienteTipo");
			...
			if(clienteTipo != null){
				...
				atualizarClienteTipoActionForm.setDescricao(clienteTipo.getDescricao());

				atualizarClienteTipoActionForm.setTipoPessoa("" + clienteTipo.getIndicadorPessoaFisicaJuridica());

				if(clienteTipo.getEsferaPoder() != null){
					atualizarClienteTipoActionForm.setEsferaPoder(clienteTipo.getEsferaPoder().getId().toString());
				}else{
					atualizarClienteTipoActionForm.setEsferaPoder("");
				}

				atualizarClienteTipoActionForm.setIndicadorUso(clienteTipo.getIndicadorUso().toString());
		...
		if(httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")){
			...
			if(sessao.getAttribute("idRegistroAtualizacao") != null && !sessao.getAttribute("idRegistroAtualizacao").equals("")){
				clienteTipoID = (String) sessao.getAttribute("idRegistroAtualizacao");
			}

			if((clienteTipoID == null) && (id == null)){

				ClienteTipo clienteTipo = (ClienteTipo) sessao.getAttribute("clienteTipo");
