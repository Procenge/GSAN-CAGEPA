...
public class FiltrarClienteOutrosCriteriosAction
				extends GcomAction {
	 ...
	 * @date 04/06/2008
	 *       Adição do Filtro de Inscrição Estadual
	 */
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		// Seta o mapeamento de retorno
		ActionForward retorno = actionMapping.findForward("gerarRelatorioCliente");
		...
		String nomeAbreviado = (String) pesquisarActionForm.get("nomeAbreviadoCliente");
		...
		String ramoAtividade = (String) pesquisarActionForm.get("ramoAtividade");
		...
		String dataNascimento = (String) pesquisarActionForm.get("dataNascimento");
		...
		String idMunicipioCliente = (String) pesquisarActionForm.get("idMunicipio");
		String codigoBairroCliente = (String) pesquisarActionForm.get("codigoBairro");
		String logradouroCliente = (String) pesquisarActionForm.get("idLogradouro");
		...
		if(id != null && !id.trim().equalsIgnoreCase("")){
			...
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.ID, id));
		}
		...
		if(inscricaoEstadual != null && !inscricaoEstadual.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.INSCRICAO_ESTADUAL, inscricaoEstadual));
		}
		if(nome != null && !nome.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ComparacaoTexto(FiltroCliente.NOME, nome));
		}
		if(idMunicipioCliente != null && !idMunicipioCliente.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimplesColecao(FiltroCliente.MUNICIPIO_ID, idMunicipioCliente));
		}
		if(codigoBairroCliente != null && !codigoBairroCliente.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimplesColecao(FiltroCliente.BAIRRO_CODIGO, codigoBairroCliente));
		}
		if(logradouroCliente != null && !logradouroCliente.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimplesColecao(FiltroCliente.LOGRADOURO, logradouroCliente));
		}
		...
		if(nomeAbreviado != null && !nomeAbreviado.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ComparacaoTexto(FiltroCliente.NOME_ABREVIADO, nomeAbreviado));
		}
		if(tipoCliente != null && !tipoCliente.equals(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO)) && !tipoCliente.equals("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.TIPOCLIENTE_ID, tipoCliente));
		}
		if(profissao != null && !profissao.equals(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO)) && !profissao.equals("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.PROFISSAO_ID, profissao));
		}
		if(matriculaImovel != null && !matriculaImovel.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimplesColecao(FiltroCliente.IMOVEL_ID, matriculaImovel));
		}
		if(email != null && !email.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ComparacaoTexto(FiltroCliente.EMAIL, email));
		}
		if(ramoAtividade != null && !ramoAtividade.equals(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO))
						&& !ramoAtividade.equals("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.RAMO_ATIVIDADE_ID, ramoAtividade));
		}
		if(dataEmissao != null && !dataEmissao.trim().equalsIgnoreCase("")){
			...
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.DATA_EMISSAO_RG, dataEmissaoParametro));
		}
		if(dataNascimento != null && !dataNascimento.trim().equalsIgnoreCase("")){
			...
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.DATA_NASCIMENTO, dataNascimentoParametro));
		}
		if(orgaoEmissor != null && !orgaoEmissor.equals(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO)) && !orgaoEmissor.equals("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.ORGAO_EXPEDIDOR_RG, orgaoEmissor));
		}
		if(idClienteResponsavel != null && !idClienteResponsavel.trim().equalsIgnoreCase("")){
			peloMenosUmParametroInformado = true;
			filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.CLIENTE_RESPONSAVEL_ID, idClienteResponsavel));
		}
		...
		Collection<Cliente> clientesNovos = fachada.pesquisarClienteOutrosCriterios(filtroCliente);
