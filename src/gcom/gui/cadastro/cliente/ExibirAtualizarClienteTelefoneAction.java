 ...
 * @author Luis Octavio
 */
public class ExibirAtualizarClienteTelefoneAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarClienteTelefone");
		...
		if(clienteActionForm.get("botaoClicado") == null || clienteActionForm.get("botaoClicado").equals("")){
			...
			if(idMunicipio != null && !idMunicipio.trim().equalsIgnoreCase("")){
				...
				if(municipios != null && !municipios.isEmpty()){
					...
					clienteActionForm.set("idMunicipio", "" + municipio.getId());
					clienteActionForm.set("descricaoMunicipio", municipio.getNome());
					...
					clienteActionForm.set("descricaoMunicipio", "Município Inexistente");
		...
		if(foneTipos == null || foneTipos.isEmpty()){
			...
			throw new ActionServletException("atencao.naocadastrado", null, "tipo de telefone");
		...
		if(clienteActionForm.get("botaoClicado") != null && !clienteActionForm.get("botaoClicado").equals("")){
			if((clienteActionForm.get("botaoClicado").equals("ADICIONAR"))
							&& (clienteActionForm.get("ddd") != null && !((String) clienteActionForm.get("ddd")).trim()
											.equalsIgnoreCase(""))
							&& (clienteActionForm.get("idTipoTelefone") != null && !((String) clienteActionForm.get("idTipoTelefone"))
											.trim().equalsIgnoreCase(""))
							&& (clienteActionForm.get("telefone") != null && !((String) clienteActionForm.get("telefone")).trim()
											.equalsIgnoreCase(""))){

				// Verificar se o usuário digitou um DDD que existe no sistema
				filtroMunicipio.limparListaParametros();

				filtroMunicipio.adicionarParametro(new ParametroSimples(FiltroMunicipio.DDD, (String) clienteActionForm.get("ddd")));
				...
				clienteFone.setTelefone((String) clienteActionForm.get("telefone"));

				if(clienteActionForm.get("ramal") != null && !((String) clienteActionForm.get("ramal")).trim().equalsIgnoreCase("")){
					clienteFone.setRamal((String) clienteActionForm.get("ramal"));
				}

				FoneTipo foneTipo = new FoneTipo();

				foneTipo.setId(new Integer(clienteActionForm.get("idTipoTelefone").toString()));
				foneTipo.setDescricao(clienteActionForm.get("textoSelecionado").toString());
