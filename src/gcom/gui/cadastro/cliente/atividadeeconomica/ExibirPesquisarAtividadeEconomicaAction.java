...
/**
 * [UC3152] Pesquisar Atividade Econômica
 * 
 * @author Anderson Italo
 * @date 27/06/2014
 */
public class ExibirPesquisarAtividadeEconomicaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atividadeEconomicaPesquisar");
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaAtividadeEconomica") != null){

			sessao.setAttribute("caminhoRetornoTelaPesquisaAtividadeEconomica",
