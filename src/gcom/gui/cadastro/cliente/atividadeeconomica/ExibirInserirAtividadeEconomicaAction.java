 ...
 * @date 29/06/2014
 */
public class ExibirInserirAtividadeEconomicaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("exibirInserirAtividadeEconomicaAction");

		Fachada fachada = Fachada.getInstancia();
		FiltroLigacaoEsgotoPerfil filtroLigacaoEsgotoPerfil = new FiltroLigacaoEsgotoPerfil(FiltroLigacaoEsgotoPerfil.ID);
		filtroLigacaoEsgotoPerfil.adicionarParametro(new ParametroSimples(FiltroLigacaoEsgotoPerfil.INDICADOR_USO, ConstantesSistema.SIM));
