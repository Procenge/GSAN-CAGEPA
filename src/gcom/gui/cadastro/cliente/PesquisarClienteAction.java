 ...
 */
public class PesquisarClienteAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer idTipoCliente = (Integer) pesquisarActionForm.get("idTipoCliente");
		...
		if(idTipoCliente != null && idTipoCliente.intValue() != ConstantesSistema.NUMERO_NAO_INFORMADO){
