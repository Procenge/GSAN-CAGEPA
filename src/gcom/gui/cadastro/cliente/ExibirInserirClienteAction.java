 ...
 * @date 28/06/2006
 */
public class ExibirInserirClienteAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		StatusWizard statusWizard = new StatusWizard("inserirClienteWizardAction", "inserirClienteAction", "cancelarInserirClienteAction",
		...
		if(this.getParametroCompanhia(httpServletRequest).toString().equals(SistemaParametro.INDICADOR_EMPRESA_DESO.toString())){
			statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(5, "ClienteResponsavelA.gif",
							"ClienteResponsavelD.gif", "exibirInserirClienteResponsavelAction", "inserirClienteResponsavelAction"));
		}

		// manda o statusWizard para a sessao
		sessao.setAttribute(ConstantesSistema.NOME_WIZARD_INSERIR_CLIENTE, statusWizard);
