 ...
 * @author Rodrigo
 */
public class ExibirAtualizarClienteEnderecoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarClienteEndereco");
		...
		Long enderecoCorrespondenciaSelecaoNovo = (Long) httpServletRequest.getAttribute("enderecoCorrespondenciaSelecao");

		if(enderecoCorrespondenciaSelecaoNovo != null){
			clienteActionForm.set("enderecoCorrespondenciaSelecao", enderecoCorrespondenciaSelecaoNovo);
		}
