 ...
 * @author Rodrigo
 */
public class InserirClienteTelefoneAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(colecaoFones != null && !colecaoFones.isEmpty()){
			...
			Long indicadorTelefonePadrao = (Long) clienteActionForm.get("indicadorTelefonePadrao");

			// Se o telefone padrão for escolhido então o objeto deve ser
			// alterado
			if(indicadorTelefonePadrao != null && indicadorTelefonePadrao.longValue() > 0){
				...
				// Mostra o erro
				throw new ActionServletException("atencao.telefone_principal.nao_selecionado");
			}
