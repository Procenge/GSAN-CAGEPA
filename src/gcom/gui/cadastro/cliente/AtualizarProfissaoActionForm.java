...
public class AtualizarProfissaoActionForm
	...
	public Profissao setFormValues(Profissao profissao){

		// Metodo usado para setar todos os valores do Form na base de dados
		profissao.setId(new Integer(getIdProfissao()));
		profissao.setDescricao(getDescricaoProfissao());
		profissao.setCodigo(new Integer(getCodigo()));
		profissao.setUltimaAlteracao(new Date());
		profissao.setIndicadorUso(new Short(getIndicadorUso()));
