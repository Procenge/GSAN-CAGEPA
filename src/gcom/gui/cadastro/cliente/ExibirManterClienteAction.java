 ...
 * @author rodrigo
 */
public class ExibirManterClienteAction
				extends GcomAction {
 ...
 indicadorContaBraille,
			...
			if(clientes.size() == 1
							&& httpServletRequest.getAttribute("atualizar") != null
				...
				httpServletRequest.setAttribute("idRegistroAtualizacao", cliente.getId().toString());
