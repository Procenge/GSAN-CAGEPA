 ...
 * @author Luis Octavio
 */
public class ExibirInserirClienteTelefoneAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirClienteTelefone");
		...
		if(clienteActionForm.get("botaoClicado") == null || clienteActionForm.get("botaoClicado").equals("")){
			...
			if(idMunicipio != null && !idMunicipio.trim().equalsIgnoreCase("")){
				...
				if(municipios != null && !municipios.isEmpty()){
					...
					httpServletRequest.setAttribute("nomeCampo", "telefone");
