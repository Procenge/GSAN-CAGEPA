 ...
 * @date 18/06/2007
 */
public class FiltrarClienteTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirManterClienteTipo");
		...
		String atualizar = filtrarClienteTipoActionForm.getAtualizar();
		...
		if(descricao != null && !descricao.trim().equalsIgnoreCase("")){
			...
			if(tipoPesquisa != null && tipoPesquisa.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				...
				filtroClienteTipo.adicionarParametro(new ComparacaoTextoCompleto(FiltroClienteTipo.DESCRICAO, descricao));
			}else{

				filtroClienteTipo.adicionarParametro(new ComparacaoTexto(FiltroClienteTipo.DESCRICAO, descricao));
			}
			/* Modificado por Eduardo Henrique - Comentado abaixo */
		...
		if(tipoPessoa != null && !tipoPessoa.trim().equalsIgnoreCase("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
		...
		if(esferaPoder != null && !esferaPoder.trim().equalsIgnoreCase("")){

			peloMenosUmParametroInformado = true;

			filtroClienteTipo.adicionarParametro(new ParametroSimples(FiltroClienteTipo.ESFERA_PODER, esferaPoder));
		...
		if(indicadorUso != null && !indicadorUso.trim().equalsIgnoreCase("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
			...
			filtroClienteTipo.adicionarParametro(new ParametroSimples(FiltroClienteTipo.INDICADOR_USO, indicadorUso));
