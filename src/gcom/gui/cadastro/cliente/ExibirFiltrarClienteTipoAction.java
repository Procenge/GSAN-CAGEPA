 ...
 */
public class ExibirFiltrarClienteTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(primeiraVez != null && !primeiraVez.equals("")){
			...
			filtrarClienteTipoActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
		...
		if(filtrarClienteTipoActionForm.getTipoPessoa().equals("1")){
		...
		if(sessao.getAttribute("voltar") != null && sessao.getAttribute("voltar").equals("filtrar")){
			...
			if(sessao.getAttribute("tipoPesquisa") != null){
				filtrarClienteTipoActionForm.setTipoPesquisa(sessao.getAttribute("tipoPesquisa").toString());
			}
		}
