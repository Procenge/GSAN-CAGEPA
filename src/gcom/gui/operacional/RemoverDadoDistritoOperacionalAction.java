...
public class RemoverDadoDistritoOperacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		int mesReferencia = Integer.parseInt(httpServletRequest.getParameter("dadoRemoverSelecao"));
		...
		DadoDistritoOperacional dadoDistritoOperacionalRemover = new DadoDistritoOperacional();
		dadoDistritoOperacionalRemover.setAnoMesReferencia(mesReferencia);
		dadosDistritoOperacional.remove(dadoDistritoOperacionalRemover);
