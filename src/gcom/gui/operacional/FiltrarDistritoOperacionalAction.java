...
public class FiltrarDistritoOperacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// filtroDistritoOperacional.adicionarCaminhoParaCarregamentoEntidade("sistemaAbastecimento.descricao");
		...
		if(descricao != null && !descricao.equalsIgnoreCase("")){
			...
			if(tipoPesquisa != null && tipoPesquisa.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				filtroDistritoOperacional.adicionarParametro(new ComparacaoTextoCompleto(FiltroDistritoOperacional.DESCRICAO, descricao));
			}else{
		...
		// ParametroSimples(FiltroDistritoOperacional.SETORABASTECIMENTO,
		// setorAbastecimento));
		// }
