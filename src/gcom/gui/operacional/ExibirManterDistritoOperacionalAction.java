...
public class ExibirManterDistritoOperacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroDistritoOperacional") != null){
			...
			filtroDistritoOperacional = (FiltroDistritoOperacional) sessao.getAttribute("filtroDistritoOperacional");

			if(Util.isVazioOrNulo(filtroDistritoOperacional.getColecaoCaminhosParaCarregamentoEntidades())){
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterDistritoOperacional"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroDistritoOperacional, DistritoOperacional.class.getName());
