 ...
 * @date 28/01/2011
 */
public class ExibirFiltrarLocalidadeDadoOperacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("filtrarLocalidadeDadoOperacional");
		...
		if(!Util.isVazioOuBranco(objetoConsulta)){
			...
			idLocalidade = pesquisarFiltrarLocalidadeDadoOperacionalActionForm.getIdLocalidade();
			...
			if(!Util.isVazioOuBranco(idLocalidade)){
				...
				if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
					...
					pesquisarFiltrarLocalidadeDadoOperacionalActionForm.setIdLocalidade("");
					pesquisarFiltrarLocalidadeDadoOperacionalActionForm.setDescricaoLocalidade("Localidade Inexistente.");
					httpServletRequest.setAttribute("nomeCampo", "idLocalidade");
				}else{
					httpServletRequest.setAttribute("corLocalidade", "valor");
					Localidade objetoLocalidade = (Localidade) Util.retonarObjetoDeColecao(colecaoPesquisa);
					pesquisarFiltrarLocalidadeDadoOperacionalActionForm.setIdLocalidade(String.valueOf(objetoLocalidade.getId()));
					pesquisarFiltrarLocalidadeDadoOperacionalActionForm.setDescricaoLocalidade(objetoLocalidade.getDescricao());
				}
			}
		}else{
			...
			pesquisarFiltrarLocalidadeDadoOperacionalActionForm.setIdLocalidade("");
			pesquisarFiltrarLocalidadeDadoOperacionalActionForm.setDescricaoLocalidade("");
			pesquisarFiltrarLocalidadeDadoOperacionalActionForm.setIndicadorUso(ConstantesSistema.TODOS.toString());
		}
