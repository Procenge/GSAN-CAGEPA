 ...
 * @date 27/01/2011
 */
public class FiltrarBaciaActionForm
				extends ActionForm {
	...
	private String tipoPesquisaDescricaoAbreviada;
	...
	/**
	 * @return the tipoPesquisaDescricao
	 */
	...
	/**
	 * @param tipoPesquisaDescricao
	 *            the tipoPesquisaDescricao to set
	 */
	...
	/**
	 * @return the tipoPesquisaDescricaoAbreviada
	 */
	public String getTipoPesquisaDescricaoAbreviada(){

		return tipoPesquisaDescricaoAbreviada;
	}

	/**
	 * @param tipoPesquisaDescricaoAbreviada
	 *            the tipoPesquisaDescricaoAbreviada to set
	 */
	public void setTipoPesquisaDescricaoAbreviada(String tipoPesquisaDescricaoAbreviada){

		this.tipoPesquisaDescricaoAbreviada = tipoPesquisaDescricaoAbreviada;
	}
}