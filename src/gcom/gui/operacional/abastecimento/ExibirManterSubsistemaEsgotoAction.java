...
/**
 * [UCXXXX] MANTER SUBSISTEMA DE ESGOTO
 * 
 * @author Ailton Sousa
 * @date 28/01/2011
 */

public class ExibirManterSubsistemaEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroSubsistemaEsgotoSessao") != null){
			filtroSubsistemaEsgoto = (FiltroSubsistemaEsgoto) sessao.getAttribute("filtroSubsistemaEsgotoSessao");
		}
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterSubsistemaEsgoto"))){
			...
			if(colecaoSubsistemaEsgoto.size() == 1 && identificadorAtualizar != null && !identificadorAtualizar.equals("")){
				...
				SubsistemaEsgoto subsistemaEsgoto = (SubsistemaEsgoto) colecaoSubsistemaEsgoto.iterator().next();
				sessao.setAttribute("idSubsistemaEsgoto", subsistemaEsgoto.getId().toString());
