...
public class AtualizarSubsistemaEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// validar formulário
		validarSubsistemaEsgoto(atualizarSubsistemaEsgotoActionForm);
		...
		atualizarSubsistemaEsgotoActionForm.setFormValues(subsistemaEsgoto);

		// atualiza na base de dados de Sistema Esgoto
		fachada.atualizarSubsistemaEsgoto(subsistemaEsgoto, usuarioLogado);

		// Monta a página de sucesso
		montarPaginaSucesso(httpServletRequest, "Subsistema de Esgoto de código " + subsistemaEsgoto.getCodigo() + " alterado com sucesso",
						"Realizar outra Manutenção de Sistema de Esgoto", "exibirFiltrarSubsistemaEsgotoAction.do?menu=sim");
	 ...
	 */
	private void validarSubsistemaEsgoto(AtualizarSubsistemaEsgotoActionForm form) throws ActionServletException{
