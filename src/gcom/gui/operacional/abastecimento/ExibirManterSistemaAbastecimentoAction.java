 ...
 * @date 01/02/2011
 */
public class ExibirManterSistemaAbastecimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroSistemaAbastecimento filtroSistemaAbastecimento = null;
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("exibirManterSistemaAbastecimento"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroSistemaAbastecimento, SistemaAbastecimento.class
							.getName());
			...
			if(colecaoSistemaAbastecimento.size() == 1 && identificadorAtualizar != null && !identificadorAtualizar.equals("")){
				...
				sessao.setAttribute("idRegistroAtualizacao", sistemaAbastecimento.getId());
