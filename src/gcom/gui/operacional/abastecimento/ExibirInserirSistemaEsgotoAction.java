 ...
 * @date 08/03/2007
 */
public class ExibirInserirSistemaEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(this.getParametroCompanhia(httpServletRequest).toString().equals(SistemaParametro.INDICADOR_EMPRESA_ADA.toString())){
			...
			Collection<DivisaoEsgoto> colecaoDivisaoEsgoto = fachada.pesquisar(filtroDivisaoEsgoto, DivisaoEsgoto.class.getName());
			...
			Collection<SistemaEsgotoTratamentoTipo> colecaoSistemaTratamentoTipo = fachada.pesquisar(filtroSistemaEsgotoTratamentoTipo,
