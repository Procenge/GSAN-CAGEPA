...
public class ExibirAtualizarProgramacaoAbastecimentoManutencaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		InformarProgramacaoAbastecimentoManutencaoActionForm form = (InformarProgramacaoAbastecimentoManutencaoActionForm) actionForm;
		...
		if(tipoOperacao != null && !tipoOperacao.equals("") && tipoOperacao.equals("A")){
			...
			Date dataInicio = Util.converteStringParaDate(form.getDataInicio(), false);
			Date dataFim = Util.converteStringParaDate(form.getDataFim(), false);

			// ..........................................Início
			Date horaMinInicio = null;

			// Obtém a hora
			String horaInicial = form.getHoraInicio().substring(0, 2);
			// Obtém os minutos
			String minutoInicial = form.getHoraInicio().substring(3, 5);
			...
			// Seta a hora
			data.set(Calendar.HOUR_OF_DAY, Integer.valueOf(horaInicial).intValue());
			data.set(Calendar.MINUTE, Integer.valueOf(minutoInicial).intValue());
			data.set(Calendar.SECOND, 0);
			data.set(Calendar.MILLISECOND, 0);

			horaMinInicio = data.getTime();

			Date horaInicio = horaMinInicio;

			// Fim....................................................................

			Date horaMinFim = null;

			// Obtém a hora
			String horaFinal = form.getHoraFim().substring(0, 2);
			// Obtém os minutos
			String minutoFinal = form.getHoraFim().substring(3, 5);

			data.setTime(dataFim);

			// Seta a hora
			data.set(Calendar.HOUR_OF_DAY, Integer.valueOf(horaFinal).intValue());
			data.set(Calendar.MINUTE, Integer.valueOf(minutoFinal).intValue());
			data.set(Calendar.SECOND, 0);
			data.set(Calendar.MILLISECOND, 0);

			horaMinFim = data.getTime();
			Date horaFim = horaMinFim;
			// ....................................................................
			...
			if(form.getTipoProgramacao().equals("A")){
				...
				AbastecimentoProgramacao abastecimentoProgramacao = this.retornaAbastecimentoProgramacao(indice, form);
				...
				ManutencaoProgramacao manutencaoProgramacao = this.retornaManutencaoProgramacao(indice, form);
			...
			if(form.getTipoProgramacao().equals("A")){
				AbastecimentoProgramacao abastecimentoProgramacao = this.retornaAbastecimentoProgramacao(form.getIndice(), form);
				...
				ManutencaoProgramacao manutencaoProgramacao = this.retornaManutencaoProgramacao(form.getIndice(), form);
			...
			for(Iterator iter = colecao.iterator(); iter.hasNext();){
				...
				if(form.getIndice() != index){
					...
					if(Util.verifcarIntervaloData(dataMontandaProgInicio, dataMontandaProgFim, dataMontandaInicio)
						...
						throw new ActionServletException("atencao.ja_existe_programacao_no_periodo", null, msg);
	 ...
	 * @param InformarProgramacaoAbastecimentoManutencaoActionForm
	 */
	private AbastecimentoProgramacao retornaAbastecimentoProgramacao(int indice, InformarProgramacaoAbastecimentoManutencaoActionForm form){
	 ...
	 * @param InformarProgramacaoAbastecimentoManutencaoActionForm
	 */
	private ManutencaoProgramacao retornaManutencaoProgramacao(int indice, InformarProgramacaoAbastecimentoManutencaoActionForm form){
