...
public class InserirSistemaEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Sistema de Esgoto de código " + codigoSistemaEsgoto + " inserido com sucesso.",
						"Inserir outro Sistema de Esgoto", "exibirInserirSistemaEsgotoAction.do?menu=sim",
						"exibirAtualizarSistemaEsgotoAction.do?idRegistroInseridoAtualizar=" + idSistemaEsgoto,
