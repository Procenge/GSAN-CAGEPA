 ...
 * @date 07/02/2011
 */
public class InserirSetorAbastecimentoActionForm
				extends ActionForm {
	...
	public SetorAbastecimento setFormValues(SetorAbastecimento setorAbastecimento){
		...
		setorAbastecimento.setDescricaoAbreviada(descricaoAbreviada);
		SistemaAbastecimento sistemaAbastecimentoSetor = new SistemaAbastecimento();
		sistemaAbastecimentoSetor.setId(Integer.parseInt(sistemaAbastecimento));
		setorAbastecimento.setSistemaAbastecimento(sistemaAbastecimentoSetor);
		DistritoOperacional distritoOperacionalSetor = new DistritoOperacional();
		distritoOperacionalSetor.setId(Integer.parseInt(distritoOperacional));
		setorAbastecimento.setDistritoOperacional(distritoOperacionalSetor);
	...
	public void validar(){
		...
		if(codigo == null){
			throw new ActionServletException("atencao.codigo_setor_abastecimento_nao_informado");
		}
		if(descricao == null){
			throw new ActionServletException("atencao.descricao_setor_abastecimento_nao_informado");
		}
		if(sistemaAbastecimento == null){
			throw new ActionServletException("atencao.sistema_abastecimento_setor_abastecimento_nao_informado");
		}
		if(zonaAbastecimento == null){
			throw new ActionServletException("atencao.zona_abastecimento_setor_abastecimento_nao_informado");
		}
	}
