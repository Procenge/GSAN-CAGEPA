 ...
 * @date 07/02/2011
 */
public class ExibirInserirSetorAbastecimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("exibirInserirSetorAbastecimentoAction");
		InserirSetorAbastecimentoActionForm inserirSetorAbastecimentoActionForm = (InserirSetorAbastecimentoActionForm) actionForm;
		...
		if(httpServletRequest.getParameter("consultaSistema") != null
						&& ConstantesSistema.NUMERO_NAO_INFORMADO != Short.parseShort(inserirSetorAbastecimentoActionForm
			...
			filtroDistritoOperacional.adicionarParametro(new ParametroSimples(FiltroDistritoOperacional.SISTEMA_ABASTECIMENTO_ID,
							inserirSetorAbastecimentoActionForm.getSistemaAbastecimento()));
