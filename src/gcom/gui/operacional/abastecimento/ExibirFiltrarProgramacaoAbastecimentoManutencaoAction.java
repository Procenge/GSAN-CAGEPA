 ...
 * @date 13/11/2006
 */
public class ExibirFiltrarProgramacaoAbastecimentoManutencaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(mesAnoReferencia != null && !mesAnoReferencia.equals("")){
			...
			if(!Util.validarMesAno(mesAnoReferencia)){
				...
				throw new ActionServletException("atencao.adicionar_debito_ano_mes_referencia_invalido", null, mesAnoReferencia);
			}
		}
	...
	private void pesquisarBairro(FiltrarProgramacaoAbastecimentoManutencaoActionForm form, HttpServletRequest httpServletRequest){
		...
		filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.CODIGO, new Integer(form.getBairro())));
	 ...
	 * @date 01/12/2006
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, FiltrarProgramacaoAbastecimentoManutencaoActionForm form){

		// Municipio
		if(form.getMunicipio() != null && !form.getMunicipio().equals("") && form.getNomeMunicipio() != null
		...
		// Bairro
		if(form.getBairro() != null && !form.getBairro().equals("") && form.getNomeBairro() != null && !form.getNomeBairro().equals("")){
