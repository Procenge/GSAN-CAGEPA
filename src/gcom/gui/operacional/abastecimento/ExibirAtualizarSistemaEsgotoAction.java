 ...
 * @date 16/03/2007
 */
public class ExibirAtualizarSistemaEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Código restrito ao Cliente ADA
		if(this.getParametroCompanhia(httpServletRequest).toString().equals(SistemaParametro.INDICADOR_EMPRESA_ADA.toString())){
			...
			filtroSistemaEsgotoTratamentoTipo.adicionarParametro(new ParametroSimples(FiltroSistemaEsgotoTratamentoTipo.INDICADOR_USO,
							ConstantesSistema.INDICADOR_USO_ATIVO));

			filtroSistemaEsgotoTratamentoTipo.setCampoOrderBy(FiltroSistemaEsgotoTratamentoTipo.NOME);

			Collection colecaoSistemaEsgotoTratamentoTipo = fachada.pesquisar(filtroSistemaEsgotoTratamentoTipo,
		...
		atualizarSistemaEsgotoActionForm.setCodigoSistemaEsgoto("");
		if(sistemaEsgoto.getCodigo() != null){
			atualizarSistemaEsgotoActionForm.setCodigoSistemaEsgoto(sistemaEsgoto.getCodigo().toString());
		}
		...
		if(this.getParametroCompanhia(httpServletRequest).toString().equals(SistemaParametro.INDICADOR_EMPRESA_ADA.toString())){
			...
			atualizarSistemaEsgotoActionForm.setDivisaoEsgoto("");

			atualizarSistemaEsgotoActionForm.setTipoTratamento("");
		}
		...
		GerenciaRegional gerenciaRegional = sistemaEsgoto.getGerenciaRegional();

		if(gerenciaRegional != null){
			Integer idGerenciaRegional = gerenciaRegional.getId();

			if(idGerenciaRegional != null){
				String idGerenciaRegionalStr = Integer.toString(idGerenciaRegional);
				atualizarSistemaEsgotoActionForm.setGerenciaRegionalID(idGerenciaRegionalStr);
			}
		}
