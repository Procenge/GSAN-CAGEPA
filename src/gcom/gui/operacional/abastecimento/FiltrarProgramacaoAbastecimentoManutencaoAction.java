 ...
 * @date 14/11/2006
 */
public class FiltrarProgramacaoAbastecimentoManutencaoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirInformarProgramacaoAbastecimentoManutencaoAction");
		...
		String areaBairro = form.getAreaBairro();
		...
		Collection colecaoProgramacaoAbastecimento = this.getFachada().consultarProgramacaoAbastecimento(idMunicipio, idBairro, areaBairro,
						mesAnoReferencia);

		Collection colecaoProgramacaoManutencao = this.getFachada().consultarProgramacaoManutencao(idMunicipio, idBairro, areaBairro,
						mesAnoReferencia);
	...
	private void pesquisarAreaBairro(Integer idArea, HttpServletRequest httpServletRequest){
		...
		filtroBairroArea.adicionarCaminhoParaCarregamentoEntidade("distritoOperacional.sistemaAbastecimento");
