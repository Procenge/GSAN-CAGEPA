 ...
 * @date 16/03/2007
 */
public class AtualizarSistemaEsgotoActionForm
	...
	// AtualizarSistemaEsgoto.
	public SistemaEsgoto setFormValues(SistemaEsgoto sistemaEsgoto){

		sistemaEsgoto.setCodigo(new Integer(getCodigoSistemaEsgoto()));
		...
		if(getTipoTratamento() != null && !getTipoTratamento().equals("")){
		...
		if(getGerenciaRegionalID() != null && !getGerenciaRegionalID().equals("")){
			int idGerenciaRegional = Integer.parseInt(getGerenciaRegionalID());

			GerenciaRegional gerenciaRegional = new GerenciaRegional();
			gerenciaRegional.setId(idGerenciaRegional);

			sistemaEsgoto.setGerenciaRegional(gerenciaRegional);
		}

		sistemaEsgoto.setIndicadorUso(Short.parseShort(getIndicadorUso()));
