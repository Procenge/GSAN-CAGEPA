 ...
 * @date 01/02/2011
 */
public class AtualizarSistemaAbastecimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		sistemaAbastecimentoId[0] = sistemaAbastecimento.getCodigo().toString();
		...
		if(form.getDescricaoAbreviada() != null && !form.getDescricaoAbreviada().equals("")){
			...
			sistemaAbastecimento.setDescricaoAbreviada(null);
		}
		...
		fachada.atualizarSistemaAbastecimento(sistemaAbastecimento, getUsuarioLogado(httpServletRequest));
