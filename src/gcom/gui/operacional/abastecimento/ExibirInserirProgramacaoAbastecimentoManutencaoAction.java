...
public class ExibirInserirProgramacaoAbastecimentoManutencaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(tipoOperacao != null && !tipoOperacao.equals("") && tipoOperacao.equals("I")){
			...
			Bairro bairro = this.consultarBairro(new Integer(form.getBairro()), municipio.getId());
	...
	private Bairro consultarBairro(Integer codigoBairro, Integer idMunicipio){
		...
		Collection colecaBairro = this.getFachada().pesquisar(filtroBairro, Bairro.class.getName());
