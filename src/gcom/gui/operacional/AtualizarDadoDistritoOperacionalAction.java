...
public class AtualizarDadoDistritoOperacionalAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		DadoDistritoOperacional dadoDistritoOperacionalAtualizar = null;
		for(DadoDistritoOperacional dadoDistritoOperacional : dadosDistritoOperacional){
			if(dadoDistritoOperacional.getAnoMesReferencia().intValue() == mesReferencia){
				dadoDistritoOperacionalAtualizar = dadoDistritoOperacional;
			}
		}

		manterDadoDistritoOperacionalActionForm.setFormValues(dadoDistritoOperacionalAtualizar);
		dadoDistritoOperacionalAtualizar.setUsuarioManutencao((Usuario) sessao.getAttribute(Usuario.USUARIO_LOGADO));
		dadoDistritoOperacionalAtualizar.setDistritoOperacional(distritoOperacional);
		dadoDistritoOperacionalAtualizar.setUltimaAlteracao(new Date());
