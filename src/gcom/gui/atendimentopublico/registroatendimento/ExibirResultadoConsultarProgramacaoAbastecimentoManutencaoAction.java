...
public class ExibirResultadoConsultarProgramacaoAbastecimentoManutencaoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("programacaoAbastecimentoManutencaoResultadoConsultar");
		...
		if(anoCalendario != null && !anoCalendario.equalsIgnoreCase("") && mesCalendario != null && !mesCalendario.equalsIgnoreCase("")){
			...
			calendario.set(new Integer(anoCalendario), new Integer(mesCalendario), 1);
		...
		resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setCodigoMunicipio(idMunicipio);

		resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setCodigoBairro(idBairro);

		resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setCodigoAreaBairro(areaBairro);
		...
		Collection colecaoProgramacaoAbastecimento = fachada.consultarProgramacaoAbastecimento(idMunicipio, idBairro, areaBairro,
						mesAnoReferencia);

		// Pesquisa o a Programacao de Manutencao
		Collection colecaoProgramacaoManutencao = fachada.consultarProgramacaoManutencao(idMunicipio, idBairro, areaBairro,
						mesAnoReferencia);
		...
		sessao.setAttribute("colecaoProgramacaoAbastecimento", colecaoProgramacaoAbastecimento);

		sessao.setAttribute("colecaoProgramacaoManutencao", colecaoProgramacaoManutencao);
		...
		if(colecaoProgramacaoAbastecimento != null && !colecaoProgramacaoAbastecimento.isEmpty()){
			...
			Iterator iteratorAbastecimento = colecaoProgramacaoAbastecimento.iterator();

			AbastecimentoProgramacao abastecimentoProgramacao = null;

			while(iteratorAbastecimento.hasNext()){

				abastecimentoProgramacao = (AbastecimentoProgramacao) iteratorAbastecimento.next();
				...
				if(dataInicio.compareTo(dataFim) != 0){
					...
					int qtdDias = gcom.util.Util.obterQuantidadeDiasEntreDuasDatas(dataInicio, dataFim);
					...
					while(i < qtdDias){
						...
						dataIntervalo = gcom.util.Util.adicionarNumeroDiasDeUmaData(dataInicio, i);
			...
			if(abastecimentoProgramacao.getSistemaAbastecimento() != null
				...
				filtroSistemaAbastecimento.adicionarParametro(new ParametroSimples(FiltroSistemaAbastecimento.ID, abastecimentoProgramacao
								.getSistemaAbastecimento().getId().toString()));

				Collection colecaoSistemaAbastecimento = fachada
								.pesquisar(filtroSistemaAbastecimento, SistemaAbastecimento.class.getName());
				...
				sessao.setAttribute("sistemaAbastecimento", sistemaAbastecimento.getDescricao());

				resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setSistemaAbastecimento(sistemaAbastecimento.getDescricao());

				resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setCodigoSistemaAbastecimento(sistemaAbastecimento.getId()
								.toString());

				sessao.setAttribute("codigoSistemaAbastecimento", sistemaAbastecimento.getId().toString());
			...
			if(abastecimentoProgramacao.getZonaAbastecimento() != null && abastecimentoProgramacao.getZonaAbastecimento().getId() != null){

				FiltroZonaAbastecimento filtroZonaAbastecimento = new FiltroZonaAbastecimento();

				filtroZonaAbastecimento.adicionarParametro(new ParametroSimples(FiltroZonaAbastecimento.ID, abastecimentoProgramacao
								.getZonaAbastecimento().getId().toString()));

				Collection colecaoZonaAbastecimento = fachada.pesquisar(filtroZonaAbastecimento, ZonaAbastecimento.class.getName());

				ZonaAbastecimento zonaAbastecimento = (ZonaAbastecimento) colecaoZonaAbastecimento.iterator().next();

				resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setZonaAbastecimento(zonaAbastecimento.getDescricao());

				resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setCodigoZonaAbastecimento(zonaAbastecimento.getId()
								.toString());

				sessao.setAttribute("codigoZonaAbastecimento", zonaAbastecimento.getId().toString());

				// Envia dados para recuperar em
				// ExibirResultadoDetalhadoProgramacaoAbastecimentoManutencaoAction

				sessao.setAttribute("zonaAbastecimento", abastecimentoProgramacao.getZonaAbastecimento().getDescricao().toString());
			...
			if(abastecimentoProgramacao.getMunicipio() != null && abastecimentoProgramacao.getMunicipio().getId() != null){

				FiltroMunicipio filtroMunicipio = new FiltroMunicipio();

				filtroMunicipio.adicionarParametro(new ParametroSimples(FiltroMunicipio.ID, abastecimentoProgramacao.getMunicipio().getId()
								.toString()));
				...
				resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setMunicipio(municipio.getNome());

				// Envia dados para recuperar em
				// ExibirResultadoDetalhadoProgramacaoAbastecimentoManutencaoAction

				sessao.setAttribute("municipio", municipio.getNome().toString());
			...
			if(abastecimentoProgramacao.getBairro() != null && abastecimentoProgramacao.getBairro().getId() != null){

				FiltroBairro filtroBairro = new FiltroBairro();

				filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.ID, abastecimentoProgramacao.getBairro().getId()
								.toString()));
				...
				resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setBairro(bairro.getNome());
			...
			if(abastecimentoProgramacao.getBairroArea() != null && abastecimentoProgramacao.getBairroArea().getId() != null){

				FiltroBairroArea filtroBairroArea = new FiltroBairroArea();

				filtroBairroArea.adicionarParametro(new ParametroSimples(FiltroBairro.ID, abastecimentoProgramacao.getBairroArea().getId()
								.toString()));

				Collection colecaoBairroArea = fachada.pesquisar(filtroBairroArea, BairroArea.class.getName());

				BairroArea bairroArea = (BairroArea) colecaoBairroArea.iterator().next();

				resultadoConsultarProgramacaoAbastecimentoManutencaoActionForm.setAreaBairro(bairroArea.getNome());

				// Envia dados para recuperar em
				// ExibirResultadoDetalhadoProgramacaoAbastecimentoManutencaoAction

				sessao.setAttribute("bairroArea", bairroArea.getNome().toString());
		...
		if(colecaoProgramacaoManutencao != null && !colecaoProgramacaoManutencao.isEmpty()){
			...
			Iterator iteratorManutencao = colecaoProgramacaoManutencao.iterator();
			...
			while(iteratorManutencao.hasNext()){
				...
				manutencaoProgramacao = (ManutencaoProgramacao) iteratorManutencao.next();
			...
			if(manutencaoProgramacao.getSistemaAbastecimento() != null && manutencaoProgramacao.getSistemaAbastecimento().getId() != null){

				FiltroSistemaAbastecimento filtroSistemaAbastecimento = new FiltroSistemaAbastecimento();

				filtroSistemaAbastecimento.adicionarParametro(new ParametroSimples(FiltroSistemaAbastecimento.ID, manutencaoProgramacao
								.getSistemaAbastecimento().getId().toString()));
				...
				sessao.setAttribute("sistemaAbastecimento", sistemaAbastecimento.getDescricao().toString());
			...
			if(manutencaoProgramacao.getZonaAbastecimento() != null && manutencaoProgramacao.getZonaAbastecimento().getId() != null){

				FiltroZonaAbastecimento filtroZonaAbastecimento = new FiltroZonaAbastecimento();

				filtroZonaAbastecimento.adicionarParametro(new ParametroSimples(FiltroZonaAbastecimento.ID, manutencaoProgramacao
								.getZonaAbastecimento().getId().toString()));
				...
				sessao.setAttribute("zonaAbastecimento", zonaAbastecimento.getDescricao().toString());
			...
			if(manutencaoProgramacao.getMunicipio() != null && manutencaoProgramacao.getMunicipio().getId() != null){

				FiltroMunicipio filtroMunicipio = new FiltroMunicipio();

				filtroMunicipio.adicionarParametro(new ParametroSimples(FiltroMunicipio.ID, manutencaoProgramacao.getMunicipio().getId()
								.toString()));
			...
			if(manutencaoProgramacao.getBairro() != null && manutencaoProgramacao.getBairro().getId() != null){

				FiltroBairro filtroBairro = new FiltroBairro();

				filtroBairro
								.adicionarParametro(new ParametroSimples(FiltroBairro.ID, manutencaoProgramacao.getBairro().getId()
												.toString()));
			...
			if(manutencaoProgramacao.getBairroArea() != null && manutencaoProgramacao.getBairroArea().getId() != null){

				FiltroBairroArea filtroBairroArea = new FiltroBairroArea();

				filtroBairroArea.adicionarParametro(new ParametroSimples(FiltroBairro.ID, manutencaoProgramacao.getBairroArea().getId()
								.toString()));
