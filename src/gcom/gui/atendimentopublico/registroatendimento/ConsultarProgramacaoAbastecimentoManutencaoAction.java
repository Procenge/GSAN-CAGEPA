 ...
 * @date 21/08/2006
 */
public class ConsultarProgramacaoAbastecimentoManutencaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirResultadoConsultarProgramacaoAbastecimentoManutencaoAction");
		...
		String idMunicipio = consultarProgramacaoAbastecimentoManutencaoActionForm.getMunicipio();

		sessao.setAttribute("idMunicipio", idMunicipio);

		String idBairro = consultarProgramacaoAbastecimentoManutencaoActionForm.getBairro();

		sessao.setAttribute("idBairro", idBairro);

		String areaBairro = consultarProgramacaoAbastecimentoManutencaoActionForm.getAreaBairro();

		sessao.setAttribute("areaBairro", areaBairro);

		String mesAnoReferencia = consultarProgramacaoAbastecimentoManutencaoActionForm.getMesAnoReferencia();
		...
		if((colecaoProgramacaoAbastecimento == null || colecaoProgramacaoAbastecimento.isEmpty())
						&& ((colecaoProgramacaoManutencao == null || colecaoProgramacaoManutencao.isEmpty()))){
			throw new ActionServletException("atencao.abastecimento_manutencao_sem_registro");
