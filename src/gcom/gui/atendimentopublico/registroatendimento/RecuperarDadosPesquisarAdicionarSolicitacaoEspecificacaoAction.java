 ...
 */
public class RecuperarDadosPesquisarAdicionarSolicitacaoEspecificacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaUnidadeOrganizacional") != null){
			...
			sessao.setAttribute("caminhoRetornoTelaPesquisaUnidadeOrganizacional", httpServletRequest
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaMensagemTipoSolicitacaoEspecificacao") != null){
			retorno = actionMapping.findForward("exibirPesquisarMensagemTipoSolicitacaoEspecificacao");
