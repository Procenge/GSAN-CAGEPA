 ...
 * @created 03/08/2006
 */
public class ExibirInserirEspecificacaoSituacaoImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Form
		InserirEspecificacaoSituacaoImovelActionForm inserirEspecificacaoSituacaoImovelActionForm = (InserirEspecificacaoSituacaoImovelActionForm) actionForm;
		...
		if(inserirEspecificacaoSituacaoImovelActionForm.getDeleteSituacaoCriterioImovel() != null
			...
			if((inserirEspecificacaoSituacaoImovelActionForm.getSituacaoLigacaoAgua() != null && !inserirEspecificacaoSituacaoImovelActionForm
							.getSituacaoLigacaoAgua().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO))
							|| (inserirEspecificacaoSituacaoImovelActionForm.getSituacaoLigacaoEsgoto() != null && !inserirEspecificacaoSituacaoImovelActionForm
											.getSituacaoLigacaoEsgoto().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO))
							|| (inserirEspecificacaoSituacaoImovelActionForm.getIndicadorHidrometroLigacaoAgua() != null && !inserirEspecificacaoSituacaoImovelActionForm
											.getIndicadorHidrometroLigacaoAgua().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO))
							|| (inserirEspecificacaoSituacaoImovelActionForm.getIndicadorHidrometroPoco() != null && !inserirEspecificacaoSituacaoImovelActionForm
											.getIndicadorHidrometroPoco().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO))){
				...
				especificacaoImovSitCriterio = getEspecificacaoImovSitCriterio(inserirEspecificacaoSituacaoImovelActionForm, sessao);
				...
				fachada.validarExibirInsercaoEspecificacaoImovSitCriterio(inserirEspecificacaoSituacaoImovelActionForm
								.getEspecificacaoImovelSituacaoCriterio(), especificacaoImovSitCriterio);

				// Seta componente na coleção
				setColecaoEspecificacaoImovSitCriterio(inserirEspecificacaoSituacaoImovelActionForm, especificacaoImovSitCriterio);
	 ...
	 */
	private void setColecaoEspecificacaoImovSitCriterio(
		...
		inserirEspecificacaoSituacaoImovelActionForm.setTamanhoColecao(inserirEspecificacaoSituacaoImovelActionForm
						.getEspecificacaoImovelSituacaoCriterio().size()
						+ "");
	}
	 ...
	 */
	private EspecificacaoImovSitCriterio getEspecificacaoImovSitCriterio(InserirEspecificacaoSituacaoImovelActionForm inserirActionForm,
					HttpSession sessao){
		...
		if(inserirActionForm.getIndicadorHidrometroPoco() != null
			...
			especificacaoImovSitCriterio.setIndicadorHidrometroPoco(new Short(inserirActionForm.getIndicadorHidrometroPoco()));
		}
		...
		if(inserirActionForm.getSituacaoLigacaoEsgoto() != null
			...
			LigacaoEsgotoSituacao ligacaoEsgotoSituacao = this.retornaLigacaoEsgotoSituacao(sessao, idSituacaoLigacaoEsgoto);
	...
	private void removeSituacaoCriterioImovel(InserirEspecificacaoSituacaoImovelActionForm inserirEspecificacaoSituacaoImovelActionForm){
		...
		for(Iterator iter = inserirEspecificacaoSituacaoImovelActionForm.getEspecificacaoImovelSituacaoCriterio().iterator(); iter
						.hasNext();){
	...
	private void consultaSelectObrigatorio(HttpSession sessao){
		...
		Collection colecaoSituacaoLigacaoAgua = (Collection) sessao.getAttribute("colecaoSituacaoLigacaoAgua");
		...
		Collection colecaoSituacaoLigacaoEsgoto = (Collection) sessao.getAttribute("colecaoSituacaoLigacaoEsgoto");
