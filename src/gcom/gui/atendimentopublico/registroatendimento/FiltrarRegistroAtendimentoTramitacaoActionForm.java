 ...
 * @date 08/01/2007
 */
public class FiltrarRegistroAtendimentoTramitacaoActionForm
	...
	private String indicadorOSProgramada;
	...
	/**
	 * @param validaLogradouro
	 *            O validaLogradouro a ser setado.
	 */
	...
	/**
	 * @param validaMunicipio
	 *            O validaMunicipio a ser setado.
	 */
	...
	/**
	 * @param validaUnidadeAtual
	 *            O validaUnidadeAtual a ser setado.
	 */
	...
	/**
	 * @param validaUnidadeSuperior
	 *            O validaUnidadeSuperior a ser setado.
	 */
	...
	/**
	 * @param selectedTipoSolicitacaoSize
	 *            O selectedTipoSolicitacaoSize a ser setado.
	 */
	...
	/**
	 * @param bairroDescricao
	 *            O bairroDescricao a ser setado.
	 */
	...
	/**
	 * @param indicadorTarifaSocial
	 *            O indicadorTarifaSocial a ser setado.
	 */
	...
	/**
	 * @param logradouroDescricao
	 *            O logradouroDescricao a ser setado.
	 */
	...
	/**
	 * @param municipioDescricao
	 *            O municipioDescricao a ser setado.
	 */
	 ...
	 *            O tipoSolicitacao a ser setado.
	 */
	...
	/**
	 * @param unidadeAtualDescricao
	 *            O unidadeAtualDescricao a ser setado.
	 */
	...
	/**
	 * @param unidadeAtualId
	 *            O unidadeAtualId a ser setado.
	 */
	...
	/**
	 * @param unidadeSuperiorDescricao
	 *            O unidadeSuperiorDescricao a ser setado.
	 */
	...
	/**
	 * @param unidadeSuperiorId
	 *            O unidadeSuperiorId a ser setado.
	 */
	...
	/**
	 * @param idRegistrosManutencaoTramite
	 *            O idRegistrosManutencaoTramite a ser setado.
	 */
	public void setIdRegistrosManutencaoTramite(String[] idRegistrosManutencaoTramite){

		this.idRegistrosManutencaoTramite = idRegistrosManutencaoTramite;
	}

	/**
	 * @return the indicadorOSProgramada
	 */
	public String getIndicadorOSProgramada(){

		return indicadorOSProgramada;
	}

	/**
	 * @param indicadorOSProgramada
	 *            the indicadorOSProgramada to set
	 */
	public void setIndicadorOSProgramada(String indicadorOSProgramada){

		this.indicadorOSProgramada = indicadorOSProgramada;
	}
