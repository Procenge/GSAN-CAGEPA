 ...
 * @date 23/02/2011
 */
public class ExibirFiltrarMensagemTipoSolicitacaoEspecificacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarMensagemTipoSolicitacaoEspecificacao");
