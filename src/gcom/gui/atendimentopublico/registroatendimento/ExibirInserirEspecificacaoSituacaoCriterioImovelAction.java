...
public class ExibirInserirEspecificacaoSituacaoCriterioImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(tipoOperacao != null && !tipoOperacao.equals("")){
			...
			if(form.getIndicadorHidrometroLigacaoAgua() != null
				...
				novaEspecificacaoImovSitCriterio.setIndicadorHidrometroLigacaoAgua(new Short(form.getIndicadorHidrometroLigacaoAgua()));
			}
			...
			if(form.getSituacaoLigacaoAgua() != null && !form.getSituacaoLigacaoAgua().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
