 ...
 */
public class ExibirInserirTipoSolicitacaoEspecificacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("limpaSessao") != null && !httpServletRequest.getParameter("limpaSessao").equals("")){
			...
			inserirTipoSolicitacaoEspecificacaoActionForm.setIndicadorFaltaAgua("");
			inserirTipoSolicitacaoEspecificacaoActionForm.setIndicadorTarifaSocial("");
			inserirTipoSolicitacaoEspecificacaoActionForm.setIdgrupoTipoSolicitacao("");
