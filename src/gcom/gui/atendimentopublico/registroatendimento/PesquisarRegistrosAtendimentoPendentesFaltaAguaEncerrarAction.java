 ...
 * @date 17/07/2006
 */
public class PesquisarRegistrosAtendimentoPendentesFaltaAguaEncerrarAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("pesquisarRegistrosAtendimentoPendentesFaltaAguaEncerrar");

		Fachada fachada = Fachada.getInstancia();

		PesquisarRegistrosAtendimentoPendentesFaltaAguaEncerrarActionForm form = (PesquisarRegistrosAtendimentoPendentesFaltaAguaEncerrarActionForm) actionForm;
		...
		RegistroAtendimentoFaltaAguaGeneralizadaHelper rasFaltaAguaGenerealizada = fachada
