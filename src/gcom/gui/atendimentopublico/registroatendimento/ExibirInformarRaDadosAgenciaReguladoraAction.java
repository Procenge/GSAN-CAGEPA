...
public class ExibirInformarRaDadosAgenciaReguladoraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("informarRaDadosAgenciaReguladora");
		...
		if(httpServletRequest.getParameter("pesquisarRa") != null){
			...
			if(!Util.isVazioOuBranco(prazoDias)){
				dataOrigem = Util.adicionarNumeroDiasDeUmaData(new Date(), prazoDias);
				form.setDataPrevisaoOriginal(Util.formatarData(dataOrigem));
			}else{
				form.setDataPrevisaoOriginal(Util.formatarData(""));
			}
		...
		Collection colecaoMotivoReclamacao = fachada.pesquisar(filtroAgenciaReguladoraMotReclamacao, AgenciaReguladoraMotReclamacao.class
						.getName());
	 ...
	 */
	private void setUnidades(InformarRaDadosAgenciaReguladoraActionForm form, ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosRA(InformarRaDadosAgenciaReguladoraActionForm form, ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosSolicitante(InformarRaDadosAgenciaReguladoraActionForm form,
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosEnderecoOcorrencia(InformarRaDadosAgenciaReguladoraActionForm form,
					ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
