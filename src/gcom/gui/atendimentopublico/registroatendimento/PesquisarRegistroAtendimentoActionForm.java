 ...
 * @date 12/06/2006
 */
public class PesquisarRegistroAtendimentoActionForm
				extends ValidatorActionForm {

	private static final long serialVersionUID = 1L;

	private String origemInserirRA;
	...
	public String getOrigemInserirRA(){

		return origemInserirRA;
	}

	public void setOrigemInserirRA(String origemInserirRA){

		this.origemInserirRA = origemInserirRA;
	}
