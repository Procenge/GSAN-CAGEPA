 ...
 * atendimento pendentes para um mesmo local de ocorrência (Aba nº 02 - Dados do local de
 * ocorrência)
 * 
 * @author Raphael Rossiter
 * @date 17/07/2006
 */
public class PesquisarRegitrosAtendimentoPendentesLocalOcorrenciaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("pesquisarRAsPendentesLocalOcorrencia");

		Fachada fachada = Fachada.getInstancia();

		PesquisarRegistrosAtendimentoPendentesLocalOcorrenciaActionForm form = (PesquisarRegistrosAtendimentoPendentesLocalOcorrenciaActionForm) actionForm;
		...
		RegistroAtendimentoPendenteLocalOcorrenciaHelper rasPendentes = fachada.pesquisarRAPendenteLocalOcorrencia(idEspecificacao,
