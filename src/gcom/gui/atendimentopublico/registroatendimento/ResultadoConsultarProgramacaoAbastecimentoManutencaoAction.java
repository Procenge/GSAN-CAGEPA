 ...
 * @date 05/09/2006
 */
public class ResultadoConsultarProgramacaoAbastecimentoManutencaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("programacaoAbastecimentoManutencaoResultadoDetalhado");

		HttpSession sessao = httpServletRequest.getSession(false);

		// Recebe a Colecao

		Collection colecaoProgramacaoAbastecimento = (Collection) sessao.getAttribute("colecaoProgramacaoAbastecimento");
		...
		if(colecaoProgramacaoAbastecimento != null && !colecaoProgramacaoAbastecimento.isEmpty()){
			...
			AbastecimentoProgramacao abastecimentoProgramacao = (AbastecimentoProgramacao) colecaoProgramacaoAbastecimento.iterator()
							.next();

			Date dataInicio = abastecimentoProgramacao.getDataInicio();

			Date dataFim = abastecimentoProgramacao.getDataFim();
