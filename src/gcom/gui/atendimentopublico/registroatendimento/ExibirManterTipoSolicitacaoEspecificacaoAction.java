 ...
 * @date 07/11/2006
 */
public class ExibirManterTipoSolicitacaoEspecificacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroSolicitacaoTipo filtroSolicitacaoTipo = (FiltroSolicitacaoTipo) sessao.getAttribute("filtroSolicitacaoTipo");
		...
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroSolicitacaoTipo, SolicitacaoTipo.class.getName());
		Collection colecaoTipoSolicitacao = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoTipoSolicitacao != null && !colecaoTipoSolicitacao.isEmpty()){
			...
			if(colecaoTipoSolicitacao.size() == 1
				...
				if(httpServletRequest.getParameter("atualizar") != null){
					...
					SolicitacaoTipo solicitacaoTipo = (SolicitacaoTipo) colecaoTipoSolicitacao.iterator().next();
					sessao.setAttribute("objetoSolicitacaoTipo", solicitacaoTipo);

				}else{
					httpServletRequest.setAttribute("colecaoTipoSolicitacao", colecaoTipoSolicitacao);
				}
			}else{
				httpServletRequest.setAttribute("colecaoTipoSolicitacao", colecaoTipoSolicitacao);
			}
