 ...
 * @created 11/08/2006
 */
public class ExibirConsultarRegistroAtendimentoOSAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if("sim".equalsIgnoreCase((String) httpServletRequest.getAttribute("botaoVoltar"))
						|| "sim".equalsIgnoreCase((String) httpServletRequest.getParameter("botaoVoltar"))){
			httpServletRequest.setAttribute("botaoVoltar", "sim");
		}

		ConsultarRegistroAtendimentoOSActionForm consultarRegistroAtendimentoOS = (ConsultarRegistroAtendimentoOSActionForm) actionForm;

		RegistroAtendimento registroAtendimento = pesquisarRegistroAtendimento(new Integer(consultarRegistroAtendimentoOS.getNumeroRA()));
