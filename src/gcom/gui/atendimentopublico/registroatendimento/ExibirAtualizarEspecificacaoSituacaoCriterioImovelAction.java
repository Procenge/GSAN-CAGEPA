...
public class ExibirAtualizarEspecificacaoSituacaoCriterioImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		AtualizarEspecificacaoSituacaoImovelActionForm form = (AtualizarEspecificacaoSituacaoImovelActionForm) actionForm;
		...
		if(tipoOperacao != null && !tipoOperacao.equals("")){
			...
			for(Iterator iter = form.getEspecificacaoImovelSituacaoCriterio().iterator(); iter.hasNext();){
				...
				if(idAtualizar.equals("" + index)){
					...
					if(form.getIndicadorHidrometroLigacaoAgua() != null
						...
						novaEspecificacaoImovSitCriterio.setIndicadorHidrometroLigacaoAgua(new Short(form
					...
					if(form.getIndicadorHidrometroPoco() != null
						...
						novaEspecificacaoImovSitCriterio.setIndicadorHidrometroPoco(new Short(form.getIndicadorHidrometroPoco()));
					}
					...
					this.getFachada().validarExibirInsercaoEspecificacaoImovSitCriterio(form.getEspecificacaoImovelSituacaoCriterio(),
					...
					especificacaoImovSitCriterio.setIndicadorHidrometroLigacaoAgua(novaEspecificacaoImovSitCriterio
									.getIndicadorHidrometroLigacaoAgua());

					especificacaoImovSitCriterio.setIndicadorHidrometroPoco(novaEspecificacaoImovSitCriterio.getIndicadorHidrometroPoco());

					especificacaoImovSitCriterio.setLigacaoAguaSituacao(novaEspecificacaoImovSitCriterio.getLigacaoAguaSituacao());

					especificacaoImovSitCriterio.setLigacaoEsgotoSituacao(novaEspecificacaoImovSitCriterio.getLigacaoEsgotoSituacao());
			...
			if(especificacaoImovSitCriterio.getIndicadorHidrometroLigacaoAgua() != null){
				form.setIndicadorHidrometroLigacaoAgua("" + especificacaoImovSitCriterio.getIndicadorHidrometroLigacaoAgua());
			}

			if(especificacaoImovSitCriterio.getIndicadorHidrometroPoco() != null){
				form.setIndicadorHidrometroPoco("" + especificacaoImovSitCriterio.getIndicadorHidrometroPoco());
			}
	...
	private void consultaSelectObrigatorio(HttpSession sessao){
		...
		if(colecaoSituacaoLigacaoAgua == null){
			...
			colecaoSituacaoLigacaoAgua = this.getFachada().pesquisar(filtroLigacaoAguaSituacao, LigacaoAguaSituacao.class.getName());
		...
		if(colecaoSituacaoLigacaoEsgoto == null){
			...
			colecaoSituacaoLigacaoEsgoto = this.getFachada().pesquisar(filtroLigacaoEsgotoSituacao, LigacaoEsgotoSituacao.class.getName());
