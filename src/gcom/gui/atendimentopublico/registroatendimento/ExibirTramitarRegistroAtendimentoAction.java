 ...
 * @date 16/08/2006
 */
public class ExibirTramitarRegistroAtendimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaoMotivoTramite = getFachada().pesquisarTabelaAuxiliar(filtro, MotivoTramite.class.getName());

		sessao.setAttribute("colecaoMotivoTramite", colecaoMotivoTramite);
		...
		if(tramitarRegistroAtendimentoActionForm.getValidaUnidadeDestino().equalsIgnoreCase("false")
			...
			if(tramitarRegistroAtendimentoActionForm.getNumeroRA() != null){
				registroAtendimentoHelper = fachada.obterDadosRegistroAtendimento(new Integer(tramitarRegistroAtendimentoActionForm
								.getNumeroRA()));
			}else{
		...
		if(Util.isVazioOuBranco(tramitarRegistroAtendimentoActionForm.getIndicadorTramiteApenasRA())){
			tramitarRegistroAtendimentoActionForm.setIndicadorTramiteApenasRA("1");
		}
	 ...
	 */
	private void setUnidades(TramitarRegistroAtendimentoActionForm tramitarRegistroAtendimentoActionForm,
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosRA(TramitarRegistroAtendimentoActionForm tramitarRegistroAtendimentoActionForm,
					ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
		...
		if(solicitacaoTipoEspecificacao != null){
			if(solicitacaoTipoEspecificacao.getSolicitacaoTipo() != null){
				...
				tramitarRegistroAtendimentoActionForm.setTipoSolicitacaoDescricao(solicitacaoTipoEspecificacao.getSolicitacaoTipo()
								.getDescricao());
				tramitarRegistroAtendimentoActionForm.setTipoSolicitacaoIndicadorTarifaSocial(solicitacaoTipoEspecificacao
	 ...
	 */
	private void setDadosEncerramento(TramitarRegistroAtendimentoActionForm tramitarRegistroAtendimentoActionForm,
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosSolicitante(TramitarRegistroAtendimentoActionForm tramitarRegistroAtendimentoActionForm,
					ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosEnderecoOcorrencia(TramitarRegistroAtendimentoActionForm tramitarRegistroAtendimentoActionForm,
					ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
