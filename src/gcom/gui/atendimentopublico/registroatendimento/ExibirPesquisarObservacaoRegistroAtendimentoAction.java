 ...
 * @date 14/03/2007
 */
public class ExibirPesquisarObservacaoRegistroAtendimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(form.getMatriculaImovel() != null && !form.getMatriculaImovel().equals("")){
			...
			String inscricaoImovel = this.getFachada().pesquisarInscricaoImovel(new Integer(form.getMatriculaImovel()), true);
