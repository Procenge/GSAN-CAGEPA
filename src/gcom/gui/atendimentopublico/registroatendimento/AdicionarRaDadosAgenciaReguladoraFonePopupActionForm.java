...
public class AdicionarRaDadosAgenciaReguladoraFonePopupActionForm
				extends ActionForm {
	...
	public RaDadosAgenciaReguladoraFone setFormValues(RaDadosAgenciaReguladoraFone raDadosAgenciaReguladoraFone){
		...
		foneTipo.setId(Integer.valueOf(getFoneTipo()));
		raDadosAgenciaReguladoraFone.setFoneTipo(foneTipo);

		raDadosAgenciaReguladoraFone.setIndicadoFonePadrao(Short.valueOf(getIndicadorFonePadrao()));
		raDadosAgenciaReguladoraFone.setDdd(Short.valueOf(getDdd()));
