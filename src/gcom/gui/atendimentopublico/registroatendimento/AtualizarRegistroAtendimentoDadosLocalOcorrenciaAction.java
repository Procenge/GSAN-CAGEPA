 ...
 * @date 10/08/2006
 */
public class AtualizarRegistroAtendimentoDadosLocalOcorrenciaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String pontoReferencia = atualizarRegistroAtendimentoActionForm.getPontoReferencia();
		...
		String idAreaBairro = atualizarRegistroAtendimentoActionForm.getIdBairroArea();
		String idlocalidade = atualizarRegistroAtendimentoActionForm.getIdLocalidade();
		String descricaoLocalidade = atualizarRegistroAtendimentoActionForm.getDescricaoLocalidade();
		...
		String numeroQuadra = atualizarRegistroAtendimentoActionForm.getNnQuadra();
		String idDivisaoEsgoto = atualizarRegistroAtendimentoActionForm.getIdDivisaoEsgoto();
		String idLocalOcorrencia = atualizarRegistroAtendimentoActionForm.getIdLocalOcorrencia();
		String idPavimentoRua = atualizarRegistroAtendimentoActionForm.getIdPavimentoRua();
		String idPavimentoCalcada = atualizarRegistroAtendimentoActionForm.getIdPavimentoCalcada();
		String descricaoLocalOcorrencia = atualizarRegistroAtendimentoActionForm.getDescricaoLocalOcorrencia();
		String imovelObrigatorio = atualizarRegistroAtendimentoActionForm.getImovelObrigatorio();
		String pavimentoRuaObrigatorio = atualizarRegistroAtendimentoActionForm.getPavimentoRuaObrigatorio();
		String pavimentoCalcadaObrigatorio = atualizarRegistroAtendimentoActionForm.getPavimentoCalcadaObrigatorio();
		...
		String indRuaLocalOcorrencia = atualizarRegistroAtendimentoActionForm.getIndRuaLocalOcorrencia();
		String indCalcadaLocalOcorrencia = atualizarRegistroAtendimentoActionForm.getIndCalcadaLocalOcorrencia();
		...
		ActionForward retornoAtencao = validarCamposEnter(atualizarRegistroAtendimentoActionForm, fachada, httpServletRequest,
						actionMapping, sessao, usuarioLogado);
		...
		if(retornoAtencao != null){
			...
			if(telaOpcaoConsulta != null && !telaOpcaoConsulta.equals("")){
				...
				if(colecaoEndereco != null && !colecaoEndereco.isEmpty()){
					...
					RegistroAtendimento ra = fachada.verificaExistenciaRAPendenteLocalOcorrencia(new Integer(
									atualizarRegistroAtendimentoActionForm.getEspecificacao()), idLogradouroBairro, idLogradouroCep);

					if(ra != null){
						httpServletRequest.setAttribute("atencao",
										"Existe RA - Registro de Atendimento de "
				...
				if(httpServletRequest.getAttribute("urlBotao") == null || httpServletRequest.getAttribute("urlBotao").equals("")){
					...
					retorno = registroAtendimentoFaltaAgua(actionMapping, httpServletRequest, atualizarRegistroAtendimentoActionForm,
									fachada, continua);
				}
			}else{
	...
	private ActionForward registroAtendimentoFaltaAgua(ActionMapping actionMapping, HttpServletRequest httpServletRequest,
					AtualizarRegistroAtendimentoActionForm atualizarRegistroAtendimentoActionForm, Fachada fachada, String continua){

		ActionForward retorno = null;

		// [SB0017] - Verifica Registro de Atendimento de Falta de água
		Integer idRegistroAtendimento = null;
		if(atualizarRegistroAtendimentoActionForm.getNumeroRA() != null && !atualizarRegistroAtendimentoActionForm.getNumeroRA().equals("")){
			idRegistroAtendimento = new Integer(atualizarRegistroAtendimentoActionForm.getNumeroRA());
		}
		Date dataAtendimento = null;
		if(atualizarRegistroAtendimentoActionForm.getDataAtendimento() != null
						&& !atualizarRegistroAtendimentoActionForm.getDataAtendimento().equals("")){
			FiltroRegistroAtendimento filtroRegistroAtendimento = new FiltroRegistroAtendimento();
			filtroRegistroAtendimento.adicionarParametro(new ParametroSimples(FiltroRegistroAtendimento.ID, new Integer(atualizarRegistroAtendimentoActionForm.getNumeroRA())));
			...
			if(colecaoRegistroAtendimento != null && !colecaoRegistroAtendimento.isEmpty()){
				RegistroAtendimento objetoRegistroAtendimento = (RegistroAtendimento) Util.retonarObjetoDeColecao(colecaoRegistroAtendimento);
				dataAtendimento = objetoRegistroAtendimento.getRegistroAtendimento();
			}
		}
		Integer idBairroArea = null;
		if(atualizarRegistroAtendimentoActionForm.getIdBairroArea() != null
						&& !atualizarRegistroAtendimentoActionForm.getIdBairroArea().equals("")){
			idBairroArea = new Integer(atualizarRegistroAtendimentoActionForm.getIdBairroArea());
		}
		...
		if(atualizarRegistroAtendimentoActionForm.getEspecificacao() != null
			...
			idEspecificacao = new Integer(atualizarRegistroAtendimentoActionForm.getEspecificacao());
		}
		Integer idBairro = null;
		if(atualizarRegistroAtendimentoActionForm.getIdBairro() != null && !atualizarRegistroAtendimentoActionForm.getIdBairro().equals("")){
			idBairro = new Integer(atualizarRegistroAtendimentoActionForm.getIdBairro());
		}

		Short indicadorFaltaAgua = null;
		if(atualizarRegistroAtendimentoActionForm.getIndFaltaAgua() != null
						&& !atualizarRegistroAtendimentoActionForm.getIndFaltaAgua().equals("")){
			indicadorFaltaAgua = new Short(atualizarRegistroAtendimentoActionForm.getIndFaltaAgua());
		}

		Integer indicadorMatricula = null;
		if(atualizarRegistroAtendimentoActionForm.getIndMatricula() != null
						&& !atualizarRegistroAtendimentoActionForm.getIndMatricula().equals("")){
			indicadorMatricula = new Integer(atualizarRegistroAtendimentoActionForm.getIndMatricula());
		}

		VerificarRAFaltaAguaHelper verificarRAFaltaAguaHelper = fachada.verificarRegistroAtendimentoFaltaAgua(idRegistroAtendimento,
						dataAtendimento, idBairroArea, idBairro, idEspecificacao, indicadorFaltaAgua, indicadorMatricula, continua);
		if(verificarRAFaltaAguaHelper != null && !verificarRAFaltaAguaHelper.equals("")){
			...
			if(verificarRAFaltaAguaHelper.getCasoUso1() != null
				...
				httpServletRequest.setAttribute("urlBotao", "exibirConsultarProgramacaoAbastecimentoManutencaoAction.do?idMunicipio="
								+ atualizarRegistroAtendimentoActionForm.getIdMunicipio() + "&codigoBairro="
								+ atualizarRegistroAtendimentoActionForm.getCdBairro() + "&areaBairro="
			...
			// Atendimento
			if(verificarRAFaltaAguaHelper.getCasoUso1() != null
							&& verificarRAFaltaAguaHelper.getCasoUso1().equals(VerificarRAFaltaAguaHelper.ENCERRAR_REGISTRO_ATENDIMENTO)){
				httpServletRequest.setAttribute("atencao", verificarRAFaltaAguaHelper.getMensagem());
				...
				httpServletRequest.setAttribute("urlBotao", "encerrarRegistroAtendimentoAction.do?numeroRA="
								+ atualizarRegistroAtendimentoActionForm.getNumeroRA() + "&numeroRAReferencia="
								+ verificarRAFaltaAguaHelper.getIdRAReferencia() + "& motivoEncerramentoId="
								+ verificarRAFaltaAguaHelper.getIdMotivoEncerramento());
			...
			if(verificarRAFaltaAguaHelper.getCasoUso1() != null
				...
				// Atendimento de Falta de água no Imóvel da área do Bairro
				httpServletRequest.setAttribute("urlBotao", "pesquisarRegitrosAtendimentoFaltaAguaImovelLocalOcorrenciaAction.do");
	...
	private ActionForward validarCamposEnter(AtualizarRegistroAtendimentoActionForm atualizarRegistroAtendimentoActionForm,
					Fachada fachada, HttpServletRequest httpServletRequest, ActionMapping actionMapping, HttpSession sessao,
		...
		ObterDadosIdentificacaoLocalOcorrenciaHelper habilitaGeograficoDivisaoEsgoto = fachada
						.habilitarGeograficoDivisaoEsgoto(new Integer(atualizarRegistroAtendimentoActionForm.getTipoSolicitacao()));
		...
		if(idImovel != null && !idImovel.equalsIgnoreCase("") && (inscricaoImovel == null || inscricaoImovel.equals(""))){
			ObterDadosIdentificacaoLocalOcorrenciaHelper dadosIdentificacaoLocalOcorrencia = fachada
							.obterDadosIdentificacaoLocalOcorrenciaAtualizar(
											new Integer(atualizarRegistroAtendimentoActionForm.getIdImovel()), new Integer(
															atualizarRegistroAtendimentoActionForm.getEspecificacao()), new Integer(
															atualizarRegistroAtendimentoActionForm.getTipoSolicitacao()), new Integer(
															atualizarRegistroAtendimentoActionForm.getNumeroRA()), true, usuarioLogado);
			...
			if(dadosIdentificacaoLocalOcorrencia.getImovel() != null){
				...
				fachada.verificarExistenciaRAImovelMesmaEspecificacao(dadosIdentificacaoLocalOcorrencia.getImovel().getId(), new Integer(
				...
				// Especificação
				fachada.verificarSituacaoImovelEspecificacao(dadosIdentificacaoLocalOcorrencia.getImovel(), new Integer(
								atualizarRegistroAtendimentoActionForm.getEspecificacao()));
				...
				if(!dadosIdentificacaoLocalOcorrencia.isInformarEndereco()){
					...
					if(retornoAtencao == null){
						...
						httpServletRequest.setAttribute("atencao", "O RA - Registro de Atendimento ficará bloqueado até "
		...
		if(codigoBairro != null && !codigoBairro.equalsIgnoreCase("")){
			...
			if((descricaoBairro == null || descricaoBairro.equals(""))){
				...
				if(colecaoBairro == null || colecaoBairro.isEmpty()){
					...
					this.pesquisarBairroArea(new Integer(atualizarRegistroAtendimentoActionForm.getIdBairro()), fachada, sessao);
