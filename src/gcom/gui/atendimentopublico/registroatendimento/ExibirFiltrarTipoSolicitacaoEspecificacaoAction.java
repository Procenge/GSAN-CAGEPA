 ...
 * @date 06/11/2006
 */
public class ExibirFiltrarTipoSolicitacaoEspecificacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarTipoSolicitacaoEspecificacao");
		...
		if(httpServletRequest.getParameter("limpaSessao") != null && !httpServletRequest.getParameter("limpaSessao").equals("")){
			...
			filtrarTipoSolicitacaoEspecificacaoActionForm.setIndicadorFaltaAgua("");
			filtrarTipoSolicitacaoEspecificacaoActionForm.setIndicadorTarifaSocial("");
			filtrarTipoSolicitacaoEspecificacaoActionForm.setIdgrupoTipoSolicitacao("");
			filtrarTipoSolicitacaoEspecificacaoActionForm.setIdServicoTipo("");
			filtrarTipoSolicitacaoEspecificacaoActionForm.setDescricaoServicoTipo("");
		}
		...
		if(!Util.isVazioOuBranco(objetoConsulta)){
			...
			if(objetoConsulta.equals("1") && !Util.isVazioOuBranco(idServicoTipoStr)){
				...
				if(!Util.isVazioOrNulo(colecaoServicoTipo)){
					...
					filtrarTipoSolicitacaoEspecificacaoActionForm.setDescricaoServicoTipo(descricao);
				}else{
					httpServletRequest.setAttribute("servicoTipoNaoEncontrado", "true");

					filtrarTipoSolicitacaoEspecificacaoActionForm.setIdServicoTipo("");
					filtrarTipoSolicitacaoEspecificacaoActionForm.setDescricaoServicoTipo("TIPO DE SERVICO INEXISTENTE");
				}
			}
		}else{
			if(sessao.getAttribute("") == null || sessao.getAttribute("").equals("")){
				...
				Collection colecaoSolicitacaoTipoGrupo = fachada
								.pesquisar(filtroSolicitacaoTipoGrupo, SolicitacaoTipoGrupo.class.getName());
			...
			filtrarTipoSolicitacaoEspecificacaoActionForm.setIndicadorFaltaAgua("3");
