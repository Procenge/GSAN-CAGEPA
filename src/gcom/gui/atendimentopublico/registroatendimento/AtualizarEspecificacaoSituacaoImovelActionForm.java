...
public class AtualizarEspecificacaoSituacaoImovelActionForm
				extends ActionForm {
	...
	private Collection<EspecificacaoImovSitCriterio> especificacaoImovelSituacaoCriterio = new ArrayList<EspecificacaoImovSitCriterio>();

	private Collection<EspecificacaoImovSitCriterio> especificacaoImovelSituacaoCriterioRemovidas = new ArrayList<EspecificacaoImovSitCriterio>();
	...
	public void setEspecificacaoImovelSituacaoCriterio(Collection<EspecificacaoImovSitCriterio> especificacaoImovelSituacaoCriterio){
	...
	public void setIndicadorHidrometroLigacaoAgua(String indicadorHidrometroLigacaoAgua){
