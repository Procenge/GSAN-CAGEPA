 ...
 * @created 14/08/2006
 */
public class ExibirConsultarRegistroAtendimentoSolicitanteAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistroAtendimento registroAtendimento = pesquisarRegistroAtendimento(new Integer(consultarRegistroAtendimentoSolicitante
						.getNumeroRA()));
		...
		if(solicitacaoTipoEspecificacao != null){
			...
			if(solicitacaoTipoEspecificacao.getSolicitacaoTipo() != null){
				consultarRegistroAtendimentoSolicitante
								.setIdTipoSolicitacao("" + solicitacaoTipoEspecificacao.getSolicitacaoTipo().getId());
				consultarRegistroAtendimentoSolicitante
								.setTipoSolicitacao(solicitacaoTipoEspecificacao.getSolicitacaoTipo().getDescricao());
			}
		...
		// Solicitantes do RA
		Collection<RegistroAtendimentoSolicitante> colecaoSolicitantes = fachada.obterRASolicitante(registroAtendimento.getId());
	...
	private RegistroAtendimento pesquisarRegistroAtendimento(Integer id){
		...
		filtroRegistroAtendimento.adicionarParametro(new ParametroSimples(FiltroRegistroAtendimento.ID, id));
