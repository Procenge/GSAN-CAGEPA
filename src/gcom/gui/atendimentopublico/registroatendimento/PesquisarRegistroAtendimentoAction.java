...
public class PesquisarRegistroAtendimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Numero RA
		if(pesquisarRegistroAtendimentoActionForm.getNumeroRA() != null && !pesquisarRegistroAtendimentoActionForm.getNumeroRA().equals("")){
		...
		if(pesquisarRegistroAtendimentoActionForm.getNumeroRAManual() != null
			...
			// pesquisarRegistroAtendimentoActionForm.getNumeroRAManual().split("-");
			String[] arrayNumeroRAManual = new String[2];
			arrayNumeroRAManual[0] = pesquisarRegistroAtendimentoActionForm.getNumeroRAManual().substring(0,
							pesquisarRegistroAtendimentoActionForm.getNumeroRAManual().length() - 1);
			arrayNumeroRAManual[1] = pesquisarRegistroAtendimentoActionForm.getNumeroRAManual().substring(
							pesquisarRegistroAtendimentoActionForm.getNumeroRAManual().length() - 1,
							pesquisarRegistroAtendimentoActionForm.getNumeroRAManual().length());
		...
		// Situação
		if(pesquisarRegistroAtendimentoActionForm.getSituacao() != null && !pesquisarRegistroAtendimentoActionForm.getSituacao().equals("")){
		...
		if(pesquisarRegistroAtendimentoActionForm.getPeriodoEncerramentoInicial() != null
			...
			if(pesquisarRegistroAtendimentoActionForm.getPeriodoEncerramentoFinal() != null
				...
				dataEncerramentoInicial = Util.formatarDataInicial(dataAtendimentoInicial);
