...
public class ExibirListarRaDadosAgenciaReguladoraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("listarRaDadosAgenciaReguladora"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroRaDadosAgenciaReguladora, RaDadosAgenciaReguladora.class
							.getName());
			...
			if(colecaoRaDadosAgenciaReguladora.size() == 1){
				...
				RaDadosAgenciaReguladora raDadosAgenciaReguladora = (RaDadosAgenciaReguladora) colecaoRaDadosAgenciaReguladora.iterator()
								.next();
