 ...
 * @created 04/08/2006
 */
public class InserirEspecificacaoSituacaoImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		especificacaoImovelSituacao.setDescricao(inserirEspecificacaoSituacaoImovelActionForm.getDescricaoEspecificacao());
		...
		montarPaginaSucesso(httpServletRequest, "Especificação Situação do Imóvel " + especificacaoImovelSituacao.getDescricao()
						+ " inserida com sucesso!", "Inserir outra Especificação Situação do Imóvel",
