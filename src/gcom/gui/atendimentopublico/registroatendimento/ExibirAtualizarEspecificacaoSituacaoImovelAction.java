...
public class ExibirAtualizarEspecificacaoSituacaoImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(form.getDeleteSituacaoCriterioImovel() != null && !form.getDeleteSituacaoCriterioImovel().equals("")){
			...
			if(idEspecificacao != null && !idEspecificacao.equals("")){
				...
				Collection colecao = fachada.pesquisar(filtro, EspecificacaoImovelSituacao.class.getName());
			...
			filtro.adicionarParametro(new ParametroSimples(FiltroEspecificacaoImovelSituacaoCriterio.ESPECIFICAO_SITUACAO_IMOVEL_ID,
							idEspecificacao));
			...
			Collection<EspecificacaoImovSitCriterio> colecaoEspecificacaoImovelSituacaoCriterio = fachada.pesquisar(filtro,
							EspecificacaoImovSitCriterio.class.getName());
