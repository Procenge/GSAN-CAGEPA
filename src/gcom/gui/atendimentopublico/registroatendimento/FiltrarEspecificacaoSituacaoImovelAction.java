...
public class FiltrarEspecificacaoSituacaoImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltrarEspecificacaoSituacaoImovelActionForm form = (FiltrarEspecificacaoSituacaoImovelActionForm) actionForm;
		...
		if(descricaoEspecificacao != null && !descricaoEspecificacao.trim().equals("")){
			...
			if(tipoPesquisa != null && tipoPesquisa.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				filtro.adicionarParametro(new ComparacaoTextoCompleto(FiltroEspecificacaoImovelSituacao.DESCRICAO, descricaoEspecificacao));
			}else{
				filtro.adicionarParametro(new ComparacaoTexto(FiltroEspecificacaoImovelSituacao.DESCRICAO, descricaoEspecificacao));
			}
