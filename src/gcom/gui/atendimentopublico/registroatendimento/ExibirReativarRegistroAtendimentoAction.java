...
public class ExibirReativarRegistroAtendimentoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(form.getValidaUnidadeAtendimento().equalsIgnoreCase("false") && form.getValidaUnidadeDestino().equalsIgnoreCase("false")){
			...
			if(form.getEspecificacaoId() == null || form.getEspecificacaoId().equals("")){
				...
				// [FS0002] Verificar existência de registro de atendimento para o imóvel com a
				// mesma especificação
				 ...
				 * nova parametrização do trâmite)
				 */
				...
				// Identificar tipo de geração da ordem de serviço (AUTOMÁTICA, OPCIONAL ou NÃO
				// GERAR)
				/*
	...
	/**
	 * [FS0002] Verificar existência de registro de atendimento para o imóvel com a mesma
	 * especificação
	 * 
	 * @param fachada
