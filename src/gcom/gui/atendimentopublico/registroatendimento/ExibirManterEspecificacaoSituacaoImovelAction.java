...
public class ExibirManterEspecificacaoSituacaoImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtro, EspecificacaoImovelSituacao.class.getName());
		...
		if(colecaoEspecificacaoSituacaoImovel.size() == 1 && identificadorAtualizar != null){
			...
			EspecificacaoImovelSituacao especificacaoImovelSituacao = (EspecificacaoImovelSituacao) colecaoEspecificacaoSituacaoImovel
							.iterator().next();
