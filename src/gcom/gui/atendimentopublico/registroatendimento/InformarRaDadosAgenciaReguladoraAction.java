...
public class InformarRaDadosAgenciaReguladoraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		fachada.informarDadosAgenciaReguladora(raDadosAgenciaReguladora, collectionRaDadosAgenciaReguladoraFone, usuarioLogado);

		// Monta a página de sucesso
		montarPaginaSucesso(httpServletRequest, "Reclamação do RA de código " + raDadosAgenciaReguladora.getRegistroAtendimento().getId()
						+ " inserido com sucesso.", "Voltar", "exibirInformarRaDadosAgenciaReguladoraAction.do?menu=sim");
