...
public class ExibirFiltrarRaDadosAgenciaReguladoraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaoMotivoEncerramentoAtendimento = fachada.pesquisar(filtroAtendimentoMotivoEncerramento,
		...
		FiltroAgenciaReguladoraMotRetorno filtroAgenciaReguladoraMotRetorno = new FiltroAgenciaReguladoraMotRetorno();

		filtroAgenciaReguladoraMotRetorno.setCampoOrderBy(FiltroAgenciaReguladoraMotRetorno.DESCRICAO);

		Collection colecaoMotivoRetornoAgencia = fachada.pesquisar(filtroAgenciaReguladoraMotRetorno, AgenciaReguladoraMotRetorno.class
						.getName());
