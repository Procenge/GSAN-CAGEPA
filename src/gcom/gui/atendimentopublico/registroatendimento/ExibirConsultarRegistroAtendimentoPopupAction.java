...
public class ExibirConsultarRegistroAtendimentoPopupAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Caso o registro atendimento esteja associado a uma área de bairro, obter os dados da área
		// do bairro
		...
		// Caso o registro atendimento tenha sido reiterado, exibir os dados da reiteração
		...
		// Caso o registro atendimento tenha sido reativado exibir os dados da reativação
