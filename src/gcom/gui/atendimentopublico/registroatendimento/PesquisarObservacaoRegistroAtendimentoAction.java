 ...
 * @date 14/03/2007
 */
public class PesquisarObservacaoRegistroAtendimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		PesquisarObservacaoRegistroAtendimentoActionForm form = (PesquisarObservacaoRegistroAtendimentoActionForm) actionForm;
		...
		colecaoRA = this.getFachada().pesquisarObservacaoRegistroAtendimento(matriculaImovel, periodoAtendimentoInicial,
						periodoAtendimentoFinal);

		if(colecaoRA == null || colecaoRA.isEmpty()){
			throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, "RA - Registro de Atendimento");
		}
