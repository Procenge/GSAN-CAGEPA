 ...
 * @created 11/08/2006
 */
public class ExibirConsultarRegistroAtendimentoTramiteDetalhadoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ConsultarRegistroAtendimentoTramiteActionForm consultarRegistroAtendimentoTramite = (ConsultarRegistroAtendimentoTramiteActionForm) actionForm;

		Collection<Tramite> colecaoTramite = null;

		FiltroTramite filtroTramite = new FiltroTramite();

		filtroTramite.adicionarParametro(new ParametroSimples(FiltroTramite.ID, new Integer(consultarRegistroAtendimentoTramite
						.getTramiteId())));
		...
		filtroTramite.adicionarCaminhoParaCarregamentoEntidade("motivoTramite");
		...
		if(colecaoTramite != null && !colecaoTramite.isEmpty()){
			...
			if(tramite.getMotivoTramite() != null && tramite.getMotivoTramite().getId() != null){
				consultarRegistroAtendimentoTramite.setMotivoTramite(tramite.getMotivoTramite().getDescricao());
			}
