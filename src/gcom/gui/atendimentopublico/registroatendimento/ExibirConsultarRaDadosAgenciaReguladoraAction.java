...
public class ExibirConsultarRaDadosAgenciaReguladoraAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("idRa") != null){
			...
			FiltroRaDadosAgenciaReguladora filtroRaDadosAgenciaReguladora = (FiltroRaDadosAgenciaReguladora) raDadosAgenciaReguladoraFiltro
							.retornaFiltro();
			...
			Collection colecaoRaDadosAgenciaReguladora = fachada.pesquisar(filtroRaDadosAgenciaReguladora, RaDadosAgenciaReguladora.class
							.getName());
		...
		Collection colecaoRaDadosAgenciaReguladoraFone = fachada.pesquisar(filtroRaDadosAgenciaReguladoraFone,
						RaDadosAgenciaReguladoraFone.class.getName());
		...
		if(raDadosAgenciaReguladora.getDescricaoReclamacao() != null && !raDadosAgenciaReguladora.getDescricaoReclamacao().equals("")){
		...
		if(raDadosAgenciaReguladora.getDataRetorno() != null && !raDadosAgenciaReguladora.getDataRetorno().equals("")){
		...
		if(raDadosAgenciaReguladora.getDescricaoRetorno() != null && !raDadosAgenciaReguladora.getDescricaoRetorno().equals("")){
			form.setDescricaoRetorno(raDadosAgenciaReguladora.getDescricaoRetorno());
		}

		// Dados do Contato para Agência

		if(raDadosAgenciaReguladora.getContato() != null && !raDadosAgenciaReguladora.getContato().equals("")){
			form.setNomeContato(raDadosAgenciaReguladora.getContato());
		}

		if(raDadosAgenciaReguladora.getEmailContato() != null && !raDadosAgenciaReguladora.getEmailContato().equals("")){
			form.setMailContato(raDadosAgenciaReguladora.getEmailContato());
		}

		if(raDadosAgenciaReguladora.getOrgaoContato() != null && !raDadosAgenciaReguladora.getOrgaoContato().equals("")){
			form.setNomeOrgaoContato(raDadosAgenciaReguladora.getOrgaoContato());
		}

		if(raDadosAgenciaReguladora.getDddContato() != null && !raDadosAgenciaReguladora.getDddContato().equals("")){
			form.setDddContato(Short.toString(raDadosAgenciaReguladora.getDddContato()));
		}

		if(raDadosAgenciaReguladora.getFoneContato() != null && !raDadosAgenciaReguladora.getFoneContato().equals("")){
			form.setTelefoneContato(raDadosAgenciaReguladora.getFoneContato());
		}

		if(raDadosAgenciaReguladora.getRamalContato() != null && !raDadosAgenciaReguladora.getFoneContato().equals("")){
			form.setRamalContato(raDadosAgenciaReguladora.getFoneContato());
		}

		if(raDadosAgenciaReguladora.getFaxContato() != null && !raDadosAgenciaReguladora.getFoneContato().equals("")){
	 ...
	 */
	private void setUnidades(ConsultarRaDadosAgenciaReguladoraActionForm form, ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosRA(ConsultarRaDadosAgenciaReguladoraActionForm form, ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosSolicitante(ConsultarRaDadosAgenciaReguladoraActionForm form,
	 ...
	 * @param registroAtendimentoHelper
	 */
	private void setDadosEnderecoOcorrencia(ConsultarRaDadosAgenciaReguladoraActionForm form,
					ObterDadosRegistroAtendimentoHelper registroAtendimentoHelper){
