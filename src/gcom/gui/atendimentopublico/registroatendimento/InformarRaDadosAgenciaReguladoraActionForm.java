...
public class InformarRaDadosAgenciaReguladoraActionForm
	...
	public void setNumeroRegistroAgenciaReguladora(String numeroRegistroAgenciaReguladora){
	...
	public RaDadosAgenciaReguladora setDadosAgenciaReguladora(RaDadosAgenciaReguladora raDadosAgenciaReguladora){
		...
		String numeroRADados = getNumeroRADados();
		if(numeroRADados != null && !numeroRADados.trim().equals("")){
			registroAtendimento.setId(new Integer(numeroRADados));
		...
		String numeroSituacaoRA = getNumeroSituacaoRA();
		if(numeroSituacaoRA != null && numeroSituacaoRA.trim().equals("")){
			raDadosAgenciaReguladora.setCodigoSituacaoArpe(new Short(numeroSituacaoRA));
		}
