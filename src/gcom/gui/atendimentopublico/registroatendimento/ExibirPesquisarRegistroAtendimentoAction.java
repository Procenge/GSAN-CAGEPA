 ...
 * @date 12/08/2006
 */
public class ExibirPesquisarRegistroAtendimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("origemInserirRA") != null && !"".equals(httpServletRequest.getParameter("origemInserirRA"))){
			httpServletRequest.setAttribute("origemInserirRA", true);
		}else{
			pesquisarRegistroAtendimentoActionForm.setOrigemInserirRA(null);
		}
		...
		if(httpServletRequest.getParameter("validaImovel") == null && httpServletRequest.getParameter("validaUnidadeAtendimento") == null
		...
		if(pesquisarRegistroAtendimentoActionForm.getLoginUsuario() != null
			...
			getUsuario(pesquisarRegistroAtendimentoActionForm, fachada, pesquisarRegistroAtendimentoActionForm.getLoginUsuario(), sessao);
		}
		...
		if(pesquisarRegistroAtendimentoActionForm.getBairroId() != null && !pesquisarRegistroAtendimentoActionForm.getBairroId().equals("")){
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaRegistroAtendimento") != null){
			...
			sessao.setAttribute("caminhoRetornoTelaPesquisaRegistroAtendimento", httpServletRequest
							.getParameter("caminhoRetornoTelaPesquisaRegistroAtendimento"));
	 ...
	 * @param fachada
	 */
	private void getImovel(PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm,
		...
		filtroImovel.adicionarParametro(new ParametroSimples(FiltroImovel.ID, pesquisarRegistroAtendimentoActionForm.getMatriculaImovel()));
	...
	private void getSolicitacaoTipoEspecificacaoCollection(HttpSession sessao, Fachada fachada,
					PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm){

		String[] solicitacaoTipo = (String[]) pesquisarRegistroAtendimentoActionForm.getTipoSolicitacao();
	 ...
	 * @param tipo
	 */
	private void getUnidade(PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm,
		...
		switch(tipo){
			case 1:
				...
				pesquisarRegistroAtendimentoActionForm.setUnidadeAtendimentoDescricao(getUnidadeDescricao(
								pesquisarRegistroAtendimentoActionForm, fachada, unidadeId));
			...
			case 2:
				...
				pesquisarRegistroAtendimentoActionForm.setUnidadeAtualDescricao(getUnidadeDescricao(pesquisarRegistroAtendimentoActionForm,
								fachada, unidadeId));
			...
			case 3:
				...
				pesquisarRegistroAtendimentoActionForm.setUnidadeSuperiorDescricao(getUnidadeDescricao(
								pesquisarRegistroAtendimentoActionForm, fachada, unidadeId));
	 ...
	 */
	private String getUnidadeDescricao(PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm, Fachada fachada,
					String unidadeId){
	 ...
	 * @param fachada
	 */
	private void getMunicipio(PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm,
					HttpServletRequest httpServletRequest){
		...
		filtroMunicipio
						.adicionarParametro(new ParametroSimples(FiltroMunicipio.ID, pesquisarRegistroAtendimentoActionForm
										.getMunicipioId()));
	 ...
	 * @param sessao
	 */
	private void getBairro(PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm,
					HttpServletRequest httpServletRequest){
		...
		filtroBairro
						.adicionarParametro(new ParametroSimples(FiltroBairro.CODIGO, pesquisarRegistroAtendimentoActionForm
										.getBairroCodigo()));
		filtroBairro.adicionarParametro(new ParametroSimples(FiltroBairro.MUNICIPIO_ID, pesquisarRegistroAtendimentoActionForm
						.getMunicipioId()));
	 ...
	 * @param fachada
	 */
	private void getLogradouro(PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm,
					HttpServletRequest httpServletRequest){
		...
		filtroLogradouro.adicionarParametro(new ParametroSimples(FiltroLogradouro.ID, pesquisarRegistroAtendimentoActionForm
						.getLogradouroId()));
	 ...
	 * @return Descrição da Unidade Filtrada
	 */
	private void getUsuario(PesquisarRegistroAtendimentoActionForm pesquisarRegistroAtendimentoActionForm, Fachada fachada,
					String idUsuario, HttpSession sessao){
