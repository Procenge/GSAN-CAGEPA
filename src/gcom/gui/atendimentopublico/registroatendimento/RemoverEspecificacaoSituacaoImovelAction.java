 ...
 * @date 08/11/2006
 */
public class RemoverEspecificacaoSituacaoImovelAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		this.getFachada().removerEspecificacaoSituacaoImovel(idsRegistrosRemocao, this.getUsuarioLogado(httpServletRequest),
						ultimaAlteracao);

		this.getSessao(httpServletRequest).removeAttribute("indicadorAtualizar");

		montarPaginaSucesso(httpServletRequest, idsRegistrosRemocao.length + " Especificação(ões) removida(s) com sucesso.",
