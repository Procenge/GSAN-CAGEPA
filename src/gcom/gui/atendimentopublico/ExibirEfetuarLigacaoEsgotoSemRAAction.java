 ...
 */
public class ExibirEfetuarLigacaoEsgotoSemRAAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((ligacaoEsgotoSemRAActionForm.getIdFuncionario() != null && !ligacaoEsgotoSemRAActionForm.getIdFuncionario().equals(""))
						&& (ligacaoEsgotoSemRAActionForm.getDescricaoFuncionario() == null || ligacaoEsgotoSemRAActionForm
										.getDescricaoFuncionario().equals(""))){

			FiltroFuncionario filtroFuncionario = new FiltroFuncionario();

			filtroFuncionario
							.adicionarParametro(new ParametroSimples(FiltroFuncionario.ID, ligacaoEsgotoSemRAActionForm.getIdFuncionario()));

			Collection colecaoFuncionario = getFachada().pesquisar(filtroFuncionario, Funcionario.class.getName());

			if(colecaoFuncionario == null || colecaoFuncionario.isEmpty()){

				ligacaoEsgotoSemRAActionForm.setIdFuncionario("");
				ligacaoEsgotoSemRAActionForm.setDescricaoFuncionario("FUNCIONÁRIO INEXISTENTE");
				...
				ligacaoEsgotoSemRAActionForm.setIdFuncionario(funcionario.getId().toString());
				ligacaoEsgotoSemRAActionForm.setDescricaoFuncionario(funcionario.getNome());
		...
		if(matriculaImovel != null && !matriculaImovel.trim().equals("")){
			...
			if(mensagemImovel == null){
				...
				// Inscrição Imóvel
				String inscricaoImovel = fachada.pesquisarInscricaoImovel(new Integer(matriculaImovel), true);
				...
				if(ligacaoEsgotoSemRAActionForm.getPerfilLigacao() != null && !ligacaoEsgotoSemRAActionForm.getPerfilLigacao().equals("")){
					...
					filtroLigacaoPercentualEsgoto.adicionarParametro(new ParametroSimples(FiltroLigacaoEsgotoPerfil.ID,
									ligacaoEsgotoSemRAActionForm.getPerfilLigacao()));
	 ...
	 * @date 22/08/2006
	 */
	private void pesquisarCliente(EfetuarLigacaoEsgotoSemRAActionForm ligacaoEsgotoSemRAActionForm, Integer matriculaImovel){
