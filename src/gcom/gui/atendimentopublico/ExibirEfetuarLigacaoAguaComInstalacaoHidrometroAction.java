 ...
 */
public class ExibirEfetuarLigacaoAguaComInstalacaoHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIdFuncionario() != null && !efetuarLigacaoAguaComInstalacaoHidrometroActionForm
						.getIdFuncionario().equals(""))
						&& (efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getDescricaoFuncionario() == null || efetuarLigacaoAguaComInstalacaoHidrometroActionForm
										.getDescricaoFuncionario().equals(""))){

			FiltroFuncionario filtroFuncionario = new FiltroFuncionario();

			filtroFuncionario.adicionarParametro(new ParametroSimples(FiltroFuncionario.ID,
							efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIdFuncionario()));

			Collection colecaoFuncionario = getFachada().pesquisar(filtroFuncionario, Funcionario.class.getName());

			if(colecaoFuncionario == null || colecaoFuncionario.isEmpty()){

				efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setIdFuncionario("");
				efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setDescricaoFuncionario("FUNCIONÁRIO INEXISTENTE");
				...
				efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setIdFuncionario(funcionario.getId().toString());
				efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setDescricaoFuncionario(funcionario.getNome());
		...
		if(httpServletRequest.getAttribute("veioEncerrarOS") != null
						|| (efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getVeioEncerrarOS() != null && efetuarLigacaoAguaComInstalacaoHidrometroActionForm
		...
		if(httpServletRequest.getAttribute("veioEncerrarOS") != null){
			...
			efetuarLigacaoAguaComInstalacaoHidrometroActionForm
							.setDataLigacao((String) httpServletRequest.getAttribute("dataEncerramento"));

			efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setDataInstalacao((String) httpServletRequest
		...
		}else if(efetuarLigacaoAguaComInstalacaoHidrometroActionForm.getIdOrdemServico() != null){
		...
		if(idOrdemServico != null && !idOrdemServico.trim().equals("")){
			...
			if(ordemServico != null){
				...
				if(servicoTipo != null && servicoTipo.getDebitoTipo() != null){
					...
					this.permitirAlteracaoValor(ordemServico.getServicoTipo(), efetuarLigacaoAguaComInstalacaoHidrometroActionForm);
					...
					if(ordemServico.getServicoNaoCobrancaMotivo() != null){
						efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setMotivoNaoCobranca(ordemServico.getServicoNaoCobrancaMotivo()
										.getId().toString());
					}

					if(ordemServico.getPercentualCobranca() != null){
						efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setPercentualCobranca(ordemServico.getPercentualCobranca()
										.toString());
					}
				...
				if(ordemServico.getDataExecucao() != null){
					efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setDataLigacao(Util.formatarData(ordemServico.getDataExecucao()));
					efetuarLigacaoAguaComInstalacaoHidrometroActionForm
			...
			if(hidrometro == null){
				...
				if(ordemServico != null){
					...
					if(httpServletRequest.getParameter("calculaValores") == null
									|| (httpServletRequest.getParameter("calculaValores") != null && !httpServletRequest.getParameter(
													"calculaValores").equals("S"))){

						// Valor Débito
						BigDecimal valorDebito = fachada.obterValorDebito(ordemServico.getServicoTipo().getId(), new Integer(
										matriculaImovel), hidrometro.getHidrometroCapacidade());
						...
						if(!temPermissaoQuantidadeParcelasExcedente || !temPermissaoPercentualCobrancaExcedente){
							efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setValorParcelas(Util.formataBigDecimal(valorDebito, 2,
											true));
						}
					}
				}
	 ...
	 * @date 27/11/2006
	 */
	private void pesquisarCliente(EfetuarLigacaoAguaComInstalacaoHidrometroActionForm efetuarLigacaoAguaComInstalacaoHidrometroActionForm,
		...
		if(colecaoClienteImovel != null && !colecaoClienteImovel.isEmpty()){
			...
			efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setClienteUsuario(cliente.getNome());
			efetuarLigacaoAguaComInstalacaoHidrometroActionForm.setCpfCnpjCliente(documento);
