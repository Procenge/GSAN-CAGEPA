...
public class EfetuarReligacaoAguaComInstalacaoRegistroMagneticoActionForm
	...
	private HidrometroInstalacaoHistorico hidrometroInstalacaoRegistroMagnetico;
	...
	private Collection<ServicoNaoCobrancaMotivo> colecaoNaoCobranca;
	...
	public void setHidrometroInstalacaoRegistroMagnetico(HidrometroInstalacaoHistorico hidrometroInstalacaoRegistroMagnetico){

		this.hidrometroInstalacaoRegistroMagnetico = hidrometroInstalacaoRegistroMagnetico;
	}

	public HidrometroInstalacaoHistorico getHidrometroInstalacaoRegistroMagnetico(){

		return hidrometroInstalacaoRegistroMagnetico;
	}

	public void setColecaoNaoCobranca(Collection<ServicoNaoCobrancaMotivo> colecaoNaoCobranca){

		this.colecaoNaoCobranca = colecaoNaoCobranca;
	}

	public Collection<ServicoNaoCobrancaMotivo> getColecaoNaoCobranca(){

		return colecaoNaoCobranca;
	}
