 ...
 * @date 17/01/2007
 */
public class ExibirEmitirSegundaViaContaInternetAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("acessoGeral") != null){
			...
			retorno = actionMapping.findForward("exibirEmitirSegundaViaContaInternetAcessoGeralAction");
		...
		if(sistemaParametro != null && sistemaParametro.getNomeAbreviadoEmpresa().equalsIgnoreCase("CAERN")){
