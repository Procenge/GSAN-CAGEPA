...
public class EfetuarSubstituicaoHidrometroAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Inserir na base de dados a instalação de hidrômetro e a atualização da substituição do
		// hidrômetro
		/*
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			...
			montarPaginaSucesso(httpServletRequest, "Substituição de Hidrômetro para " + tipoMedicaoAtual + " no imóvel " + matriculaImovel
							+ " efetuada com sucesso.", "Efetuar outra Substituição de Hidrômetro",
