 ...
 * @date 28/06/2006
 */
public class EfetuarRemanejamentoHidrometroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_REMANEJAMENTO_HIDROMETRO_EFETUAR,
		...
		hidrometroInstalacaoHistorico.setIndicadorExistenciaCavalete(new Short(cavalete));
		...
		if(ordemServico.getServicoTipo().getDebitoTipo() != null && ordemServico.getServicoNaoCobrancaMotivo() == null){
			...
			try{
				...
				ex.setUrlBotaoVoltar("/gsan/exibirEfetuarRemanejamentoHidrometroAction.do");
				throw ex;
			}
		}
