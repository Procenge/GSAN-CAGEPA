...
public class ExibirEfetuarInstalacaoHidrometroAction
	...
	/**
	 * Este caso de uso permite efetuar instalação de hidrômetro, sendo chamado pela funcionalidade
	 * que encerra
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((efetuarInstalacaoHidrometroActionForm.getIdFuncionario() != null && !efetuarInstalacaoHidrometroActionForm.getIdFuncionario()
			...
			if(colecaoFuncionario == null || colecaoFuncionario.isEmpty()){
				...
				efetuarInstalacaoHidrometroActionForm.setDescricaoFuncionario("FUNCIONÁRIO INEXISTENTE");
