 ...
 * @date 20/09/2006
 */
public class AcompanharRoteiroProgramacaoOrdemServicoActionForm
	...
	private String idOrdemServicoProgramacao;
	...
	public void setSequencialProgramacaoPrevisto(String sequencialProgramacaoPrevisto){
	...
	public String getIdOrdemServicoProgramacao(){

		return idOrdemServicoProgramacao;
	}

	public void setIdOrdemServicoProgramacao(String idOrdemServicoProgramacao){

		this.idOrdemServicoProgramacao = idOrdemServicoProgramacao;
	}

	public String getSubmitAutomatico(){

		return submitAutomatico;
	}

	public void setSubmitAutomatico(String submitAutomatico){

		this.submitAutomatico = submitAutomatico;
	}
