 ...
 * @date 07/03/2006
 */
public class ExibirManterTipoServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroTipoServico") != null){
			filtroTipoServico = (FiltroTipoServico) sessao.getAttribute("filtroTipoServico");
		}

		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterTipoServico"))){

			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroTipoServico, ServicoTipo.class.getName());
