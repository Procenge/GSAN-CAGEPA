 ...
 * @date 26/07/2006
 */
public class ExibirInserirTipoRetornoOrdemServicoReferidaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		sessao.setAttribute("colecaoServicoTipoReferencia", fachada.pesquisar(filtroServicoTipoReferencia, ServicoTipoReferencia.class
						.getName(), "SERVICO_TIPO_REFERENCIA"));
		...
		sessao.setAttribute("colecaoAtendimentoMotivoEncerramento", fachada.pesquisar(filtroAtendimentoMotivoEncerramento,
						AtendimentoMotivoEncerramento.class.getName(), "ATENDIMENTO_MOTIVO_ENCERRAMENTO"));
		...
		if(Util.validarNumeroMaiorQueZERO(form.getServicoTipoReferencia())){
			...
			ServicoTipoReferencia servicoTipoReferencia = (ServicoTipoReferencia) fachada.pesquisar(filtroServicoTipoReferencia,
							ServicoTipoReferencia.class.getName()).iterator().next();
		...
		if(Util.validarNumeroMaiorQueZERO(form.getAtendimentoMotivoEncerramento())){
			...
			AtendimentoMotivoEncerramento atendimentoMotivoEncerramento = (AtendimentoMotivoEncerramento) fachada.pesquisar(
							filtroAtendimentoMotivoEncerramento, AtendimentoMotivoEncerramento.class.getName()).iterator().next();
