 ...
 * @date 18/02/2011
 */
public class ReprogramarOrdemServicoActionForm
	...
	private String novaDataRoteiro;
	...
	public void setProgramadas(String programadas){
	...
	public String getDataFinalProgramacao(){

		return dataFinalProgramacao;
	}

	public void setDataFinalProgramacao(String dataFinalProgramacao){
	...
	public String getNovaDataRoteiro(){

		return novaDataRoteiro;
	}

	public void setNovaDataRoteiro(String novaDataRoteiro){

		this.novaDataRoteiro = novaDataRoteiro;
	}
