 ...
 * @date 28/07/2006
 */
public class InserirTipoRetornoOrdemServicoReferidaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO__TIPO_RETORNO_OS_REFERIDA_INSERIR,
		...
		montarPaginaSucesso(httpServletRequest, "Tipo de Retorno da OS Referida " + osReferidaRetornoTipo.getDescricao()
