 ...
 * @return
 */
public class PesquisarMaterialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirResultadoPesquisaMaterial");
		...
		String descricaoAbreviada = pesquisarMaterialActionForm.getDescricaoAbreviada();

		String unidadeMaterial = pesquisarMaterialActionForm.getUnidadeMaterial();
		...
		if(descricao != null && !descricao.trim().equalsIgnoreCase("")){
			...
			filtroMaterial.adicionarParametro(new ComparacaoTexto(FiltroMaterialUnidade.DESCRICAO, descricao));
		...
		if(descricaoAbreviada != null && !descricaoAbreviada.trim().equalsIgnoreCase("")){
			...
			filtroMaterial.adicionarParametro(new ComparacaoTexto(FiltroMaterialUnidade.DESCRICAO_ABREVIADA, descricaoAbreviada));
		...
		Collection colecaoMaterial = (Collection) fachada.pesquisar(filtroMaterial, Material.class.getName());

		if(colecaoMaterial == null || colecaoMaterial.isEmpty()){
			throw new ActionServletException("atencao.naocadastrado", null, "Material");
		}
