 ...
 * @date 28/07/2006
 */
public class ExibirPesquisarMaterialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection<MaterialUnidade> colecaoUnidadeMaterial = fachada.pesquisar(filtroMaterialUnidade, MaterialUnidade.class.getName());

		if(colecaoUnidadeMaterial == null || colecaoUnidadeMaterial.isEmpty()){
			throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, "Tabela Material Unidade");
		}
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaMaterial") != null){
			sessao
							.setAttribute("caminhoRetornoTelaPesquisaMaterial", httpServletRequest
			...
			sessao.setAttribute("caminhoRetornoMaterialTipoServico", httpServletRequest.getParameter("caminhoRetornoMaterialTipoServico"));
		}
