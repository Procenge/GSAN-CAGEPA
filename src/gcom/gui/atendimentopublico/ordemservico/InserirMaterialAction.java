 ...
 * @date 31/07/2006
 */
public class InserirMaterialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Material " + descricao + " inserido com sucesso.", "Inserir outro Material",
						"exibirInserirMaterialAction.do?menu=sim", "exibirAtualizarMaterialAction.do?idRegistroInseridoAtualizar="
