...
public class RemoverTipoServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		fachada.remover(ids, ServicoTipo.class.getName(), operacaoEfetuada, colecaoUsuarios);
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, ids.length + " Tipo(s) de Serviço removido(s) com sucesso.",
