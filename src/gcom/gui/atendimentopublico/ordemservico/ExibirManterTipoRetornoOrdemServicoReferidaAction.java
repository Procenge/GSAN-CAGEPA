 ...
 * @since 31/10/2006
 */
public class ExibirManterTipoRetornoOrdemServicoReferidaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(filtroOSReferidaRetornoTipo != null && !filtroOSReferidaRetornoTipo.equals("")){
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroOSReferidaRetornoTipo, OsReferidaRetornoTipo.class
							.getName());
			colecaoTipoRetornoOsReferida = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoTipoRetornoOsReferida != null && !colecaoTipoRetornoOsReferida.isEmpty()){
			...
			if(colecaoTipoRetornoOsReferida.size() == 1
				...
				if(sessao.getAttribute("atualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarTipoRetornoOrdemServicoReferida");
					OsReferidaRetornoTipo osReferidaRetornoTipo = (OsReferidaRetornoTipo) colecaoTipoRetornoOsReferida.iterator().next();
					sessao.setAttribute("osReferidaRetornoTipo", osReferidaRetornoTipo);
					sessao.setAttribute("filtrar", true);
				}else{
					httpServletRequest.setAttribute("colecaoTipoRetornoOsReferida", colecaoTipoRetornoOsReferida);
				}
			}else{
				httpServletRequest.setAttribute("colecaoTipoRetornoOsReferida", colecaoTipoRetornoOsReferida);
			}
