...
public class FiltrarMaterialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Unidade Material
		if(unidadeMaterial != null && !unidadeMaterial.trim().equals("")
						&& !unidadeMaterial.trim().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
