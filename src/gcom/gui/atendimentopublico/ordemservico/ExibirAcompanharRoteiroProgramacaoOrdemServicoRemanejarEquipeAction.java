...
public class ExibirAcompanharRoteiroProgramacaoOrdemServicoRemanejarEquipeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection<Equipe> colecao = fachada.recuperaEquipeDaOSProgramacaoPorDataRoteiro(new Integer(chaveOs), dataRoteiro);
		...
		if(colecaoEquipe == null || colecaoEquipe.isEmpty()){
			throw new ActionServletException("atencao.nao_ha_outras_equipes_para_remanejar");
		}
	...
	private Collection<Equipe> pesquisarEquipes(Integer idUnidadeLotacao, Integer idEquipe){
		...
		filtroEquipe.adicionarParametro(new ParametroSimplesDiferenteDe(FiltroEquipe.ID, idEquipe));
