...
public class AtualizarValorCobrancaServicoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Valor da Cobrança do Serviço " + descricaoTipoServico + " atualizado com sucesso.",
						"Realizar outra Manutenção Valor da Cobrança do Serviço", "exibirFiltrarValorCobrancaServicoAction.do?menu=sim");
