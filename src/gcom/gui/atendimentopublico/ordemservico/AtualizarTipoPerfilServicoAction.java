...
public class AtualizarTipoPerfilServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Perfil de Serviço " + atualizarTipoPerfilServicoActionForm.getDescricaoPerfil()
						+ " atualizado com sucesso.", "Realizar outra Manutenção de Perfil de Serviço",
