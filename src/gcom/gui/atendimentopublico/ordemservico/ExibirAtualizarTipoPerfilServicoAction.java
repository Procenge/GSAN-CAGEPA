...
public class ExibirAtualizarTipoPerfilServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((idEquipamentoEspecial != null && !idEquipamentoEspecial.equals(""))
						&& (httpServletRequest.getParameter("pesquisa") != null && httpServletRequest.getParameter("pesquisa").equals("S"))){
			...
			filtroTabelaAuxiliarAbreviada.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliarAbreviada.ID,
							atualizarTipoPerfilServicoActionForm.getEquipamentosEspeciais()));
			...
			if(colecaoEquipamentosEspeciais != null && !colecaoEquipamentosEspeciais.isEmpty()){
				...
				EquipamentosEspeciais equipamentosEspeciais = (EquipamentosEspeciais) colecaoEquipamentosEspeciais.iterator().next();
			...
			if(servicoPerfilTipo == null){
				...
				if(idServico != null && !idServico.equals("")){
					...
					filtroServicoPerfilTipo.adicionarParametro(new ParametroSimples(FiltroServicoPerfilTipo.ID, idServico));
			...
			if(servicoPerfilTipo.getEquipamentosEspeciais() != null && !servicoPerfilTipo.getEquipamentosEspeciais().equals("")){
				...
				atualizarTipoPerfilServicoActionForm.setDescricaoEquipamentoEspecial(servicoPerfilTipo.getEquipamentosEspeciais()
								.getDescricao());
			}
