...
public class AtualizarTipoPerfilServicoActionForm
	...
	public ServicoPerfilTipo setFormValues(ServicoPerfilTipo servicoPerfilTipo){
		...
		// Descrição
		servicoPerfilTipo.setId(Integer.valueOf(getIdTipoPerfilServico()));
		...
		// data da retirada
		servicoPerfilTipo.setIndicadorUso(Short.valueOf(getIndicadorUso()));
