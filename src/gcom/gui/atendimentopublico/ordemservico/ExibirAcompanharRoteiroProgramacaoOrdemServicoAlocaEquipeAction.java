...
public class ExibirAcompanharRoteiroProgramacaoOrdemServicoAlocaEquipeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		colecaoEquipesDaOrdemServico = new HashSet();
		...
		Integer idEquipePrincipal = this.retornaEquipePrincipalParaOs(dataRoteiro, idUnidadeLotacao, new Integer(chaveOs));
		...
		String[] array = (String[]) colecaoEquipesDaOrdemServico.toArray(new String[colecaoEquipesDaOrdemServico.size()]);
