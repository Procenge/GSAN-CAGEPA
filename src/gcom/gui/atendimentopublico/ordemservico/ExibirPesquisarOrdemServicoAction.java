 ...
 * @date 14/08/2006
 */
public class ExibirPesquisarOrdemServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("ordemServicoPesquisar");
		...
		String objetoConsultaOs = httpServletRequest.getParameter("objetoConsultaOs");
		...
		if((objetoConsultaOs == null || objetoConsultaOs.trim().equals(""))
						&& (httpServletRequest.getParameter("tipoConsulta") == null || httpServletRequest.getParameter("tipoConsulta")
										.equals(""))){
			...
			pesquisarOrdemServicoActionForm.setPeriodoGeracaoInicial(Util.formatarData(dataSugestao));
			pesquisarOrdemServicoActionForm.setPeriodoGeracaoFinal(Util.formatarData(dataAtual));
		}

		// [UC0443] - Pesquisar Registro Atendimento
		if(objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("1")){
		...
		if(objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("2")){
		...
		if(objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("3")){
		...
		if(objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("4")){
		...
		if((objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("5"))
						|| (objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("6"))
						|| (objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("7"))){

			// Faz a consulta de Cliente
			this.pesquisarUnidadeOrganizacional(pesquisarOrdemServicoActionForm, objetoConsultaOs);
		}

		// [UC0075] - Pesquisar Municipio
		if(objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("8")){
		...
		if(objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("9")){
		...
		if(idBairro != null && !idBairro.equals("")){
			this.montarAreaBairroPorId(httpServletRequest, new Integer(idBairro));
		}

		// [UC0004] - Pesquisar Logradouro
		if(objetoConsultaOs != null && !objetoConsultaOs.trim().equals("") && objetoConsultaOs.trim().equals("10")){
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null && !httpServletRequest.getParameter("tipoConsulta").equals("")){
			...
			if(httpServletRequest.getParameter("tipoConsulta").equals("registroAtendimento")){
				...
				pesquisarOrdemServicoActionForm.setDescricaoDocumentoCobranca(descricao);
				...
				pesquisarOrdemServicoActionForm.setDescricaoLogradouro(descricao);
		...
		if(pesquisarOrdemServicoActionForm.getSituacaoProgramacao() == null
						|| pesquisarOrdemServicoActionForm.getSituacaoProgramacao().equals("")){

			pesquisarOrdemServicoActionForm.setSituacaoProgramacao(ConstantesSistema.SET_ZERO.toString());
		}
	 ...
	 * @date 15/08/2006
	 */
	private void pesquisarImovel(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){

		// Filtra Imovel
		FiltroImovel filtroImovel = new FiltroImovel();
		filtroImovel.adicionarParametro(new ParametroSimples(FiltroImovel.ID, pesquisarOrdemServicoActionForm.getMatriculaImovel()));
		...
		if(colecaoImovel != null && !colecaoImovel.isEmpty()){
			...
			pesquisarOrdemServicoActionForm.setMatriculaImovel(imovel.getId().toString());
			pesquisarOrdemServicoActionForm.setInscricaoImovel(imovel.getInscricaoFormatada());

		}else{
			pesquisarOrdemServicoActionForm.setMatriculaImovel("");
			pesquisarOrdemServicoActionForm.setInscricaoImovel("Matrícula inexistente");
		}
	}
	 ...
	 * @date 15/08/2006
	 */
	private void pesquisarRegistroAtendimento(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){

		// Filtro para obter o localidade ativo de id informado
		FiltroRegistroAtendimento filtroRegistroAtendimento = new FiltroRegistroAtendimento();

		filtroRegistroAtendimento.adicionarParametro(new ParametroSimples(FiltroRegistroAtendimento.ID, new Integer(
		...
		if(colecaoRegistros != null && !colecaoRegistros.isEmpty()){
			...
			pesquisarOrdemServicoActionForm.setNumeroRA(registroAtendimento.getId().toString());
			pesquisarOrdemServicoActionForm.setDescricaoRA(registroAtendimento.getSolicitacaoTipoEspecificacao().getDescricao());
	 ...
	 * @date 21/08/2006
	 */
	private void pesquisarDocumentoCobranca(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){

		FiltroDocumentoCobranca filtroDocumentoCobranca = new FiltroDocumentoCobranca();

		filtroDocumentoCobranca.adicionarParametro(new ParametroSimples(FiltroDocumentoCobranca.ID, new Integer(
		...
		if(colecaoDocumentoCobranca != null && !colecaoDocumentoCobranca.isEmpty()){
			...
			pesquisarOrdemServicoActionForm.setDocumentoCobranca(cobrancaDocumento.getId().toString());
			pesquisarOrdemServicoActionForm.setDescricaoDocumentoCobranca(cobrancaDocumento.getDocumentoTipo().getDescricaoDocumentoTipo());

		}else{
			pesquisarOrdemServicoActionForm.setDocumentoCobranca("");
			pesquisarOrdemServicoActionForm.setDescricaoDocumentoCobranca("Documento Cobrança inexistente");
		}
	}
	 ...
	 * @date 15/08/2006
	 */
	private void pesquisarCliente(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){

		FiltroCliente filtroCliente = new FiltroCliente();

		filtroCliente.adicionarParametro(new ParametroSimples(FiltroCliente.ID, new Integer(pesquisarOrdemServicoActionForm
						.getCodigoCliente())));
		...
		if(colecaoCliente != null && !colecaoCliente.isEmpty()){
			...
			pesquisarOrdemServicoActionForm.setCodigoCliente(cliente.getId().toString());
			pesquisarOrdemServicoActionForm.setNomeCliente(cliente.getNome());

		}else{
			pesquisarOrdemServicoActionForm.setCodigoCliente("");
			pesquisarOrdemServicoActionForm.setNomeCliente("Cliente inexistente");
		}
	}
	 ...
	 * @date 15/08/2006
	 */
	private void pesquisarUnidadeOrganizacional(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm, String objetoConsultaOs){
		...
		if(objetoConsultaOs.equals("5")){
			idUnidade = new Integer(pesquisarOrdemServicoActionForm.getUnidadeGeracao());
		}else if(objetoConsultaOs.equals("6")){
			idUnidade = new Integer(pesquisarOrdemServicoActionForm.getUnidadeAtual());
		}else{
			idUnidade = new Integer(pesquisarOrdemServicoActionForm.getUnidadeSuperior());
		...
		if(colecaoUnidade != null && !colecaoUnidade.isEmpty()){
			...
			if(objetoConsultaOs.equals("5")){
				...
				pesquisarOrdemServicoActionForm.setUnidadeGeracao(unidadeOrganizacional.getId().toString());
				pesquisarOrdemServicoActionForm.setDescricaoUnidadeGeracao(unidadeOrganizacional.getDescricao());

			}else if(objetoConsultaOs.equals("6")){

				pesquisarOrdemServicoActionForm.setUnidadeAtual(unidadeOrganizacional.getId().toString());
				pesquisarOrdemServicoActionForm.setDescricaoUnidadeAtual(unidadeOrganizacional.getDescricao());
				...
				// Verifica se a pesquisa retornou algum objeto para a coleção
				if(colecaoUnidade != null && !colecaoUnidade.isEmpty()){
					pesquisarOrdemServicoActionForm.setUnidadeSuperior(unidadeOrganizacional.getId().toString());
					pesquisarOrdemServicoActionForm.setDescricaoUnidadeSuperior(unidadeOrganizacional.getDescricao());
				}else{
			...
			if(objetoConsultaOs.equals("5")){
				...
				pesquisarOrdemServicoActionForm.setUnidadeGeracao("");
				pesquisarOrdemServicoActionForm.setDescricaoUnidadeGeracao("Unidade de Geração inexistente");

			}else if(objetoConsultaOs.equals("6")){

				pesquisarOrdemServicoActionForm.setUnidadeAtual("");
				pesquisarOrdemServicoActionForm.setDescricaoUnidadeAtual("Unidade Atual inexistente");

			}else{

				pesquisarOrdemServicoActionForm.setUnidadeSuperior("");
				pesquisarOrdemServicoActionForm.setDescricaoUnidadeSuperior("Unidade Superior inexistente");
	 ...
	 * @date 16/08/2006
	 */
	private void pesquisarMunicipio(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){

		FiltroMunicipio filtroMunicipio = new FiltroMunicipio();

		filtroMunicipio.adicionarParametro(new ParametroSimples(FiltroMunicipio.ID, new Integer(pesquisarOrdemServicoActionForm
						.getMunicipio())));
		...
		if(colecaoMunicipio != null && !colecaoMunicipio.isEmpty()){
			...
			pesquisarOrdemServicoActionForm.setMunicipio(municipio.getId().toString());
			pesquisarOrdemServicoActionForm.setDescricaoMunicipio(municipio.getNome());

		}else{
			pesquisarOrdemServicoActionForm.setMunicipio("");
			pesquisarOrdemServicoActionForm.setDescricaoMunicipio("Município inexistente");
		}
	}
	 ...
	 * @date 16/08/2006
	 */
	private void pesquisarBairro(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){
		...
		if(colecaoBairro != null && !colecaoBairro.isEmpty()){
			...
			pesquisarOrdemServicoActionForm.setDescricaoBairro(bairro.getNome());

		}else{
			pesquisarOrdemServicoActionForm.setBairro("");
			pesquisarOrdemServicoActionForm.setDescricaoBairro("Bairro inexistente");
		}
	}
	 ...
	 * @date 16/08/2006
	 */
	private void pesquisarLogradouro(PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){

		FiltroLogradouro filtroLogradouro = new FiltroLogradouro();

		filtroLogradouro.adicionarParametro(new ParametroSimples(FiltroLogradouro.ID, new Integer(pesquisarOrdemServicoActionForm
						.getLogradouro())));
		...
		if(colecaoLogradouro != null && !colecaoLogradouro.isEmpty()){
			...
			pesquisarOrdemServicoActionForm.setLogradouro(logradouro.getId().toString());
			pesquisarOrdemServicoActionForm.setDescricaoLogradouro(logradouro.getNome());

		}else{
			pesquisarOrdemServicoActionForm.setLogradouro("");
			pesquisarOrdemServicoActionForm.setDescricaoLogradouro("Logradouro inexistente");
		}
	}
	 ...
	 * @date 16/08/2006
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, PesquisarOrdemServicoActionForm pesquisarOrdemServicoActionForm){
		...
		if(pesquisarOrdemServicoActionForm.getMatriculaImovel() != null && !pesquisarOrdemServicoActionForm.getMatriculaImovel().equals("")
						...
						&& !pesquisarOrdemServicoActionForm.getInscricaoImovel().equals("")){
		...
		if(pesquisarOrdemServicoActionForm.getDocumentoCobranca() != null
						...
						&& pesquisarOrdemServicoActionForm.getDescricaoDocumentoCobranca() != null
						&& !pesquisarOrdemServicoActionForm.getDescricaoDocumentoCobranca().equals("")){
		...
		if(pesquisarOrdemServicoActionForm.getUnidadeGeracao() != null && !pesquisarOrdemServicoActionForm.getUnidadeGeracao().equals("")
						...
						&& !pesquisarOrdemServicoActionForm.getDescricaoUnidadeGeracao().equals("")){
		...
		if(pesquisarOrdemServicoActionForm.getUnidadeAtual() != null && !pesquisarOrdemServicoActionForm.getUnidadeAtual().equals("")
						...
						&& !pesquisarOrdemServicoActionForm.getDescricaoUnidadeAtual().equals("")){
		...
		if(pesquisarOrdemServicoActionForm.getUnidadeSuperior() != null && !pesquisarOrdemServicoActionForm.getUnidadeSuperior().equals("")
						&& pesquisarOrdemServicoActionForm.getDescricaoUnidadeSuperior() != null
						&& !pesquisarOrdemServicoActionForm.getDescricaoUnidadeSuperior().equals("")){
		...
		if(pesquisarOrdemServicoActionForm.getMunicipio() != null && !pesquisarOrdemServicoActionForm.getMunicipio().equals("")
						...
						&& !pesquisarOrdemServicoActionForm.getDescricaoMunicipio().equals("")){
		...
		if(pesquisarOrdemServicoActionForm.getBairro() != null && !pesquisarOrdemServicoActionForm.getBairro().equals("")
						...
						&& !pesquisarOrdemServicoActionForm.getDescricaoBairro().equals("")){
		...
		if(pesquisarOrdemServicoActionForm.getLogradouro() != null && !pesquisarOrdemServicoActionForm.getLogradouro().equals("")
						...
						&& !pesquisarOrdemServicoActionForm.getDescricaoLogradouro().equals("")){
