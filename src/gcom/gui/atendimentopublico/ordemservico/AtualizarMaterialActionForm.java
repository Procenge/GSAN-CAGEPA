...
public class AtualizarMaterialActionForm
	...
	public void setCodigoMaterial(String codigoMterial){

		this.codigoMaterial = codigoMterial;
	}
	...
	public Material setFormValues(Material material){
		...
		material.setId(Integer.valueOf(getCodigoMaterial()));
		material.setDescricao(getDescricaoMaterial());
		material.setDescricaoAbreviada(getAbrevMaterial());
