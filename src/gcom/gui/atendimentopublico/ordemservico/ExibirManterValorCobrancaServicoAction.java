 ...
 * @date 30/10/2006
 */
public class ExibirManterValorCobrancaServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroServicoCobrancaValor, ServicoCobrancaValor.class.getName());
		Collection colecaoServicoCobrancaValor = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoServicoCobrancaValor != null && !colecaoServicoCobrancaValor.isEmpty()){
			...
			ServicoCobrancaValor servicoCobrancaValor1 = (ServicoCobrancaValor) colecaoServicoCobrancaValor.iterator().next();
			...
			if(colecaoServicoCobrancaValor.size() == 1
				...
				if(httpServletRequest.getParameter("atualizar") != null){
					retorno = actionMapping.findForward("atualizarValorCobrancaServico");
					ServicoCobrancaValor servicoCobrancaValor = (ServicoCobrancaValor) colecaoServicoCobrancaValor.iterator().next();
					sessao.setAttribute("objetoservicoCobrancaValor", servicoCobrancaValor);
