...
public class AtualizarMaterialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Material material = (Material) sessao.getAttribute("material");

		String[] idMaterial = new String[1];

		idMaterial[0] = material.getId().toString();

		// Atualiza a entidade com os valores do formulário.
		// Chama o SetFormValues que está no AtualizarMaterialActionForm
		// para montar o objeto que vai ser passado por parametro.
		atualizarMaterialActionForm.setFormValues(material);
		...
		montarPaginaSucesso(httpServletRequest, "Material " + atualizarMaterialActionForm.getDescricaoMaterial()
						+ " atualizado com sucesso.", "Realizar outra Manutenção do Material", "exibirFiltrarMaterialAction.do?menu=sim");
