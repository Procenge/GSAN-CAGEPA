 ...
 * @date 18/10/2006
 */
public class ExibirManterMaterialExecucaoOSAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("manterMaterialExecucaoOS");
		...
		if(numeroOS != null && !numeroOS.equalsIgnoreCase("")){
			...
			this.informarOrdemServicoAtividadeJaCadastrada(colecaoSessao, Util.converterStringParaInteger(numeroOS), Util
							.converterStringParaInteger(idAtividade), sessao, fachada);
		...
		if((form.getIdMaterialNaoProgramado() != null && !form.getIdMaterialNaoProgramado().equals(""))
			...
			filtroMaterial.adicionarParametro(new ParametroSimples(FiltroMaterial.ID, form.getIdMaterialNaoProgramado()));
		...
		if(adicionarMaterial != null && !adicionarMaterial.equalsIgnoreCase("")){
			...
			if(sessao.getAttribute("colecaoManterDadosAtividadesOrdemServicoHelper") != null){
				...
				this.informarOrdemServicoAtividade(colecaoManterDadosAtividadesOrdemServicoHelper, Util.converterStringParaInteger(form
								.getNumeroOS()), Util.converterStringParaInteger(form.getIdAtividade()), idMaterial, sessao, fachada);
			}else{

				this.informarOrdemServicoAtividade(null, Util.converterStringParaInteger(form.getNumeroOS()), Util
								.converterStringParaInteger(form.getIdAtividade()), idMaterial, sessao, fachada);
		...
		if(removerMaterial != null && !removerMaterial.equalsIgnoreCase("")){
			...
			this.removerMaterial(identificadorMaterial, Util.converterStringParaInteger(form.getIdAtividade()), colecaoSessao);
		...
		if(sessao.getAttribute("colecaoManterDadosAtividadesOrdemServicoHelper") != null){
			...
			this.atualizarQuantidadeMaterial(colecaoSessao, Util.converterStringParaInteger(form.getIdAtividade()), requestMap);
		}
	...
	private void informarOrdemServicoAtividadeJaCadastrada(Collection colecaoSessao, Integer numeroOS, Integer idAtividade,
		...
		if(colecaoSessao != null && !colecaoSessao.isEmpty()){
			...
			while(iteratorColecaoSessao.hasNext()){
				...
				if(manterDadosAtividadesOrdemServicoHelper.getOrdemServicoAtividade() != null
					...
					if(manterDadosAtividadesOrdemServicoHelper.getOrdemServicoAtividade().getId() != null){

						colecaoOsAtividadeMaterialExecucao = fachada
										.pesquisarOsAtividadeMaterialExecucao(manterDadosAtividadesOrdemServicoHelper
														.getOrdemServicoAtividade().getId());
					}

					if(colecaoOsAtividadeMaterialExecucao != null && !colecaoOsAtividadeMaterialExecucao.isEmpty()){

						manterDadosAtividadesOrdemServicoHelper.setColecaoOsAtividadeMaterialExecucao(colecaoOsAtividadeMaterialExecucao);
					}
			...
			if(!ordemServicoAtividadeInformada){
				...
				manterDadosAtividadesOrdemServicoHelper = this.gerarOrdemServicoAtividadeJaCadastrada(numeroOS, idAtividade, fachada);
	...
	private ManterDadosAtividadesOrdemServicoHelper gerarOrdemServicoAtividadeJaCadastrada(Integer numeroOS, Integer idAtividade,
					Fachada fachada){

		ManterDadosAtividadesOrdemServicoHelper manterDadosAtividadesOrdemServicoHelper = null;

		OrdemServicoAtividade ordemServicoAtividade = fachada.pesquisarOrdemServicoAtividade(numeroOS, idAtividade);
		...
		if(ordemServicoAtividade != null){
			...
			// Informando OsAtividadeMaterialExecucao
			Collection colecaoOsAtividadeMaterialExecucao = fachada.pesquisarOsAtividadeMaterialExecucao(ordemServicoAtividade.getId());
	...
	private void informarOrdemServicoAtividade(Collection colecaoSessao, Integer numeroOS, Integer idAtividade, Integer idMaterial,
					HttpSession sessao, Fachada fachada){
		...
		if(colecaoSessao != null && !colecaoSessao.isEmpty()){
			...
			while(iteratorColecaoSessao.hasNext()){
				...
				if(manterDadosAtividadesOrdemServicoHelper.getOrdemServicoAtividade() != null
					...
					Collection colecaoOsAtividadeMaterialExecucao = this.informarOsAtividadeMaterialExecucao(
									manterDadosAtividadesOrdemServicoHelper.getColecaoOsAtividadeMaterialExecucao(), numeroOS, idMaterial,
									fachada);
			...
			if(!ordemServicoAtividadeInformada){
				...
				// 1º Passo - Gerando o objeto
				manterDadosAtividadesOrdemServicoHelper = this.gerarOrdemServicoAtividade(numeroOS, idAtividade, idMaterial, fachada);
	...
	private ManterDadosAtividadesOrdemServicoHelper gerarOrdemServicoAtividade(Integer numeroOS, Integer idAtividade, Integer idMaterial,
					Fachada fachada){
		...
		// Informando OsAtividadeMaterialExecucao
		Collection colecaoOsAtividadeMaterialExecucaoHelper = this.informarOsAtividadeMaterialExecucao(null, numeroOS, idMaterial, fachada);

		manterDadosAtividadesOrdemServicoHelper.setColecaoOsAtividadeMaterialExecucao(colecaoOsAtividadeMaterialExecucaoHelper);
	...
	private Collection informarOsAtividadeMaterialExecucao(Collection colecaoOsAtividadeMaterialExecucao, Integer numeroOS,
		...
		if(colecaoOsAtividadeMaterialExecucao != null && !colecaoOsAtividadeMaterialExecucao.isEmpty()){
			...
			/*
			 * Caso já exista OsAtividadeMaterialExecucao informada, porém ainda não foi cadastrada
			 * nenhuma
	...
	private void removerMaterial(Integer identificacaoMaterial, Integer idAtividade, Collection colecaoSessao){
		...
		while(iteratorColecaoSessao.hasNext()){
			...
			if(manterDadosAtividadesOrdemServicoHelper.getOrdemServicoAtividade() != null
				...
				// Material
				Collection colecaoOSAtividadeMaterialExecucao = manterDadosAtividadesOrdemServicoHelper
	...
	private void atualizarQuantidadeMaterial(Collection colecaoSessao, Integer idAtividade, Map<String, String[]> requestMap){
		...
		while(iteratorColecaoSessao.hasNext()){
			...
			if(helper.getOrdemServicoAtividade() != null && helper.getOrdemServicoAtividade().getAtividade().getId().equals(idAtividade)){
				...
				if(colecaoOsAtividadeMaterialExecucao != null && !colecaoOsAtividadeMaterialExecucao.isEmpty()){
					...
					while(iteratorColecaoOsAtividadeMaterialExecucao.hasNext()){
						...
						if(requestMap.get("material" + osAtividadeMaterialExecucao.getMaterial().getId()) != null){

							quantidade = (requestMap.get("material" + +osAtividadeMaterialExecucao.getMaterial().getId()))[0];
