 ...
 * @date 04/08/2006
 */
public class ExibirInserirTipoServicoReferenciaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("tipoServicoReferenciaInserir");
		...
		String situacaoAntes = inserirTipoServicoReferenciaActionForm.getSituacaoOSAntes();

		String situacaoApos = inserirTipoServicoReferenciaActionForm.getSituacaoOSApos();
		...
		if(sessao.getAttribute("tipoServico") != null){
			...
			tipoServico = inserirTipoServicoReferenciaActionForm.getTipoServico();
		}

		if(tipoServico != null && !tipoServico.trim().equals("")){

			FiltroServicoTipo filtroServicoTipo = new FiltroServicoTipo();
			filtroServicoTipo.adicionarParametro(new ParametroSimples(FiltroServicoTipo.ID, tipoServico));
			...
			if(colecaoServicoTipo != null && !colecaoServicoTipo.isEmpty()){
				...
				inserirTipoServicoReferenciaActionForm.setSituacaoOSAntes(situacaoAntes);
				inserirTipoServicoReferenciaActionForm.setSituacaoOSApos(situacaoApos);
				inserirTipoServicoReferenciaActionForm.setNomeTipoServico(nomeTipoServico);
				...
				inserirTipoServicoReferenciaActionForm.setTipoServico(tipoServico);
				inserirTipoServicoReferenciaActionForm.setTipoServico("");

				inserirTipoServicoReferenciaActionForm.setNomeTipoServico("TIPO DE SERVIÇO INEXISTENTE");

				httpServletRequest.setAttribute("tipoServicoInexistente", "true");
			}
