...
public class ExibirManterMaterialAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroMaterial") != null){
			filtroMaterial = (FiltroMaterial) sessao.getAttribute("filtroMaterial");
		}
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterMaterial"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroMaterial, Material.class.getName());
