 ...
 * @date 01/08/2006
 */
public class ExibirPesquisarAtividadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaAtividade") != null){
			...
			sessao
							.setAttribute("caminhoRetornoAtividadeTipoServico", httpServletRequest
											.getParameter("caminhoRetornoAtividadeTipoServico"));
		}
		return retorno;
	}
