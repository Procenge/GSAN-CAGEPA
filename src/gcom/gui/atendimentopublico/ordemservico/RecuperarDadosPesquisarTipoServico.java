 ...
 */
public class RecuperarDadosPesquisarTipoServico
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaTipoDebito") != null){
			retorno = actionMapping.findForward("exibirPesquisarTipoDebito");
		...
		// Tipo Perfil Serviço
			...
			retorno = actionMapping.findForward("exibirPesquisarPerfilServico");
		...
		// Tipo Serviço Referência
			...
			retorno = actionMapping.findForward("exibirPesquisarServicoReferencia");
		...
		// Tipo Atividades Serviço
			...
			retorno = actionMapping.findForward("exibirPesquisarServicoAtividade");
		...
		// Tipo Mateial Serviço
			...
			retorno = actionMapping.findForward("exibirPesquisarServicoMaterial");
			sessao
