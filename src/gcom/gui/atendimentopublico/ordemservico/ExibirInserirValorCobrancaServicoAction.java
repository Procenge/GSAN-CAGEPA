 ...
 * @date 28/09/2006
 */
public class ExibirInserirValorCobrancaServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(cobrancaServicoActionForm.getTipoServico() != null && !cobrancaServicoActionForm.getTipoServico().equals("")){
			this.getServicoTipo(cobrancaServicoActionForm, httpServletRequest);
		}
		return retorno;
	}
	...
	private void getServicoTipo(InserirValorCobrancaServicoActionForm form, HttpServletRequest httpServletRequest){
		...
		if(colecaoServicoTipo != null && !colecaoServicoTipo.isEmpty()){
			...
			// throw new ActionServletException("atencao.valor_cobranca_tipo_servico_sem_debito",
			// null, servicoTipo.getDescricao());
			// }
		}else{
