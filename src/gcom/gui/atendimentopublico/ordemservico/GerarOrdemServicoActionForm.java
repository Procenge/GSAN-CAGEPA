 ...
 * @date 14/08/2006
 */
public class GerarOrdemServicoActionForm
	...
	private String[] idRegistrosRAGerarOrdemServico;

	private Collection colecaoCompleta;
	...
	public void setDescricaoOrdemServicoReferencia(String descricaoOrdemServicoReferencia){
	...
	public void setDescricaoPrioridadeServicoOriginal(String descricaoPrioridadeServicoOriginal){
	...
	public String[] getIdRegistrosRAGerarOrdemServico(){

		return idRegistrosRAGerarOrdemServico;
	}

	public void setIdRegistrosRAGerarOrdemServico(String[] idRegistrosRAGerarOrdemServico){

		this.idRegistrosRAGerarOrdemServico = idRegistrosRAGerarOrdemServico;
	}

	public Collection getColecaoCompleta(){

		return colecaoCompleta;
	}

	public void setColecaoCompleta(Collection colecaoCompleta){

		this.colecaoCompleta = colecaoCompleta;
	}
