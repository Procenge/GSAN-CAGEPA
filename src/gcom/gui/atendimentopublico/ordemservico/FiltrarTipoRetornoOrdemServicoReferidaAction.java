 ...
 * @date 05/08/2006
 */
public class FiltrarTipoRetornoOrdemServicoReferidaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirManterTipoRetornoOrdemServicoReferida");
		...
		String codigoTipoRetorno = filtrarTipoRetornoOrdemServicoReferidaActionForm.getCodigoTipoRetorno();

		String descricao = filtrarTipoRetornoOrdemServicoReferidaActionForm.getDescricao();

		String abreviatura = filtrarTipoRetornoOrdemServicoReferidaActionForm.getAbreviatura();

		String servicoTipoReferencia = filtrarTipoRetornoOrdemServicoReferidaActionForm.getServicoTipoReferencia();

		String deferimento = filtrarTipoRetornoOrdemServicoReferidaActionForm.getDeferimento();

		String trocaServico = filtrarTipoRetornoOrdemServicoReferidaActionForm.getTrocaServico();

		String situacao = filtrarTipoRetornoOrdemServicoReferidaActionForm.getSituacao();

		String atendimentoMotivoEncerramento = filtrarTipoRetornoOrdemServicoReferidaActionForm.getAtendimentoMotivoEncerramento();

		String indicadorUso = filtrarTipoRetornoOrdemServicoReferidaActionForm.getIndicadorUso();
		...
		if(codigoTipoRetorno != null && !codigoTipoRetorno.trim().equalsIgnoreCase("")){
			...
			filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.ID, codigoTipoRetorno));
		...
		if(descricao != null && !descricao.trim().equalsIgnoreCase("")){
			...
			filtroOSReferidaRetornoTipo.adicionarParametro(new ComparacaoTexto(FiltroOSReferidaRetornoTipo.DESCRICAO, descricao));
		...
		if(abreviatura != null && !abreviatura.trim().equalsIgnoreCase("")){
			...
			filtroOSReferidaRetornoTipo
							.adicionarParametro(new ComparacaoTexto(FiltroOSReferidaRetornoTipo.DESCRICAO_ABREVIADA, abreviatura));
		...
		if(deferimento != null && !deferimento.trim().equals("")){
			peloMenosUmParametroInformado = true;
			filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.INDICADOR_DEFERIMENTO,
							deferimento));
		...
		if(trocaServico != null && !trocaServico.trim().equals("")){
			peloMenosUmParametroInformado = true;
			filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.INDICADOR_TROCA_SERVICO,
							trocaServico));
		...
		if(situacao != null && !situacao.trim().equals("")){
			peloMenosUmParametroInformado = true;
			filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.ID, situacao));
		...
		if(atendimentoMotivoEncerramento != null
			...
			filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(
							FiltroOSReferidaRetornoTipo.ATENDIMENTO_MOTIVO_ENCERRAMENTO_ID, atendimentoMotivoEncerramento));
		...
		if(indicadorUso != null && !indicadorUso.trim().equals("")){
			peloMenosUmParametroInformado = true;
			filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.INDICADOR_USO, indicadorUso));
