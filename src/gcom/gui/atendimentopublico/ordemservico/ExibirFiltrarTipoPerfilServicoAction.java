 ...
 * @date 25/10/2006
 */
public class ExibirFiltrarTipoPerfilServicoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("filtrarTipoPerfilServico");
		...
		if((form.getIdEquipamentoEspecial() != null && !form.getIdEquipamentoEspecial().equals(""))){
