 ...
 * @date 08/08/2006
 */
public class ExibirPesquisarConsultarTipoServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("detalharConsultarTipoServicoAction");
	...
	private void getCarregarTela(HttpServletRequest httpServletRequest, Fachada fachada, ActionForm actionForm){
