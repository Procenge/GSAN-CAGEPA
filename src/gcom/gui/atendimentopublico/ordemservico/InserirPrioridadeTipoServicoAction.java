 ...
 * @date 11/08/2006
 */
public class InserirPrioridadeTipoServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String descricao = inserirPrioridadeTipoServicoActionForm.getDescricao();

		String descricaoAbreviada = inserirPrioridadeTipoServicoActionForm.getAbreviatura();

		String qtdHorasInicio = inserirPrioridadeTipoServicoActionForm.getQtdHorasInicio();

		String qtdHorasFim = inserirPrioridadeTipoServicoActionForm.getQtdHorasFim();
		...
		Integer idPrioridadeTipoServico = fachada.inserirPrioridadeTipoServico(servicoTipoPrioridade, usuarioLogado);

		montarPaginaSucesso(httpServletRequest, "Prioridade do Tipo de Serviço de código " + idPrioridadeTipoServico
						+ " inserido com sucesso.", "Inserir outra Prioridade do Tipo de Serviço",
