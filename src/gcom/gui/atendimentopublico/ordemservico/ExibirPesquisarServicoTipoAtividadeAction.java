 ...
 * @date 03/08/2006
 */
public class ExibirPesquisarServicoTipoAtividadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null && httpServletRequest.getParameter("tipoConsulta").trim().length() > 0){
