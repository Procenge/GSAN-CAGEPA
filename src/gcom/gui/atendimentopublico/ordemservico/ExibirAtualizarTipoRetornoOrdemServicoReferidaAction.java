 ...
 * @date 30/10/2006
 */
public class ExibirAtualizarTipoRetornoOrdemServicoReferidaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarTipoRetornoOrdemServicoReferida");
		...
		if(httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")){
			...
			if(sessao.getAttribute("idRegistroAtualizacao") != null && !sessao.getAttribute("idRegistroAtualizacao").equals("")){
				osReferidaRetornoTipoID = (String) sessao.getAttribute("idRegistroAtualizacao");
			}
			...
			if((osReferidaRetornoTipoID == null) && (id == null)){
				...
				OsReferidaRetornoTipo osReferidaRetornoTipo = (OsReferidaRetornoTipo) sessao.getAttribute("objetoOsReferidaRetornoTipo");

				atualizarTipoRetornoOrdemServicoReferidaActionForm.setCodigoTipoRetorno(osReferidaRetornoTipo.getId().toString());

				atualizarTipoRetornoOrdemServicoReferidaActionForm.setDescricao(osReferidaRetornoTipo.getDescricao());

				atualizarTipoRetornoOrdemServicoReferidaActionForm.setAbreviatura(osReferidaRetornoTipo.getDescricaoAbreviada());

				atualizarTipoRetornoOrdemServicoReferidaActionForm.setServicoTipoReferencia(osReferidaRetornoTipo
								.getServicoTipoReferencia().getId().toString());

				atualizarTipoRetornoOrdemServicoReferidaActionForm.setDeferimento("" + osReferidaRetornoTipo.getIndicadorDeferimento());

				atualizarTipoRetornoOrdemServicoReferidaActionForm.setTrocaServico("" + osReferidaRetornoTipo.getIndicadorTrocaServico());

				if(osReferidaRetornoTipo.getSituacaoOsReferencia() != null){
					atualizarTipoRetornoOrdemServicoReferidaActionForm.setSituacao("" + osReferidaRetornoTipo.getSituacaoOsReferencia());
				}else{
					atualizarTipoRetornoOrdemServicoReferidaActionForm.setSituacao("");
				}

				if(osReferidaRetornoTipo.getAtendimentoMotivoEncerramento() != null){

					atualizarTipoRetornoOrdemServicoReferidaActionForm.setAtendimentoMotivoEncerramento(osReferidaRetornoTipo
									.getAtendimentoMotivoEncerramento().getId().toString());

				}else{
					atualizarTipoRetornoOrdemServicoReferidaActionForm.setAtendimentoMotivoEncerramento("");
				}

				atualizarTipoRetornoOrdemServicoReferidaActionForm.setIndicadorUso("" + osReferidaRetornoTipo.getIndicadorUso());

				sessao.setAttribute("osReferidaRetornoTipoAtualizar", osReferidaRetornoTipo);
			...
			if(idOsReferidaRetornoTipo != null){
				...
				filtroOSReferidaRetornoTipo.adicionarCaminhoParaCarregamentoEntidade("situacaoOsReferencia");

				filtroOSReferidaRetornoTipo.adicionarCaminhoParaCarregamentoEntidade("atendimentoMotivoEncerramento");

				filtroOSReferidaRetornoTipo
								.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.ID, idOsReferidaRetornoTipo));

				Collection<OsReferidaRetornoTipo> colecaoOsReferidaRetornoTipo = fachada.pesquisar(filtroOSReferidaRetornoTipo,
				...
				httpServletRequest.setAttribute("colecaoOsReferidaRetornoTipo", colecaoOsReferidaRetornoTipo);

				OsReferidaRetornoTipo osReferidaRetornoTipo = (OsReferidaRetornoTipo) colecaoOsReferidaRetornoTipo.iterator().next();
				...
				httpServletRequest.setAttribute("idOsReferidaRetornoTipo", idOsReferidaRetornoTipo);
				sessao.setAttribute("osReferidaRetornoTipoAtualizar", osReferidaRetornoTipo);

			}

			httpServletRequest.setAttribute("colecaoOsReferidaRetornoTipoTela", sessao
							.getAttribute("colecaoOsReferidaRetornoTipoValorTela"));
		...
		if(sessao.getAttribute("colecaoOsReferidaRetornoTipoTela") == null){
			...
			if(sessao.getAttribute("objetoOsReferidaRetornoTipo") != null){
				...
				sessao.setAttribute("idOsReferidaRetornoTipo", osReferidaRetornoTipo.getId().toString());

				sessao.setAttribute("osReferidaRetornoTipo", osReferidaRetornoTipo);
				...
				if(httpServletRequest.getParameter("idRegistroAtualizacao") == null
								|| httpServletRequest.getParameter("idRegistroAtualizacao").equals("")){
					osReferidaRetornoTipo = (OsReferidaRetornoTipo) sessao.getAttribute("osReferidaRetornoTipo");
					idOsReferidaRetornoTipo = osReferidaRetornoTipo.getId().toString();

				}else{
					idOsReferidaRetornoTipo = (String) httpServletRequest.getParameter("idRegistroAtualizacao");
					sessao.setAttribute("idRegistroAtualizacao", idOsReferidaRetornoTipo);
				}
				...
				if(idOsReferidaRetornoTipo != null){
					...
					filtroOSReferidaRetornoTipo.adicionarParametro(new ParametroSimples(FiltroOSReferidaRetornoTipo.ID,
					...
					osReferidaRetornoTipo = (OsReferidaRetornoTipo) colecaoOsReferidaRetornoTipo.iterator().next();

				}

				if(idOsReferidaRetornoTipo == null){
					if(sessao.getAttribute("idRegistroAtualizacao") != null){
						idOsReferidaRetornoTipo = (String) sessao.getAttribute("idRegistroAtualizacao");
					}else{
						osReferidaRetornoTipo = (OsReferidaRetornoTipo) sessao.getAttribute("osReferidaRetornoTipo");
						idOsReferidaRetornoTipo = osReferidaRetornoTipo.getId().toString();
					}
				...
				Collection colecaoOsReferidaRetornoTipo = (Collection) fachada.pesquisar(filtroOSReferidaRetornoTipo,
								OsReferidaRetornoTipo.class.getName());
				...
				if(osReferidaRetornoTipo.getServicoTipoReferencia() != null){
					...
					atualizarTipoRetornoOrdemServicoReferidaActionForm.setServicoTipoReferencia("");
				}
		...
		httpServletRequest.setAttribute("colecaoOsReferidaRetornoTipoTela", sessao.getAttribute("colecaoOsReferidaRetornoTipoValorTela"));
	...
	private void getAtendimentoMotivoEncerramentoCollection(HttpSession sessao){
		...
		if(colecaoAtendimentoMotivoEncerramento != null && !colecaoAtendimentoMotivoEncerramento.isEmpty()){
			...
			throw new ActionServletException("atencao.naocadastrado", null, "Motivo de Encerramento do Atendimento");
		}
	}

	private void getServicoTipoReferenciaCollection(HttpSession sessao, Fachada fachada){
		...
		filtroServicoTipoReferencia.adicionarParametro(new ParametroSimples(FiltroServicoTipoReferencia.INDICADOR_USO,
						ConstantesSistema.INDICADOR_USO_ATIVO));
		...
		if(colecaoServicoTipoReferencia != null && !colecaoServicoTipoReferencia.isEmpty()){
			...
			throw new ActionServletException("atencao.naocadastrado", null, "Referência do Tipo de Serviço");
		}
	}
