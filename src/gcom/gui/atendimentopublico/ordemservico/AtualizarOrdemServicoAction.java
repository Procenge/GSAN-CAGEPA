 ...
 * @date 22/08/2006
 */
public class AtualizarOrdemServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(idServicoTipo != null && !idServicoTipo.equals("") && (descricaoServicoTipo == null || descricaoServicoTipo.equals(""))){
			...
			if(servicoTipo != null && !servicoTipo.equals("")){
				...
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Tipo Serviço");
			}
		}else if(idServicoTipo != null && !idServicoTipo.equals("")){
			ServicoTipo servicoTipo = new ServicoTipo();
			servicoTipo.setId(new Integer(idServicoTipo));
			ordemServico.setServicoTipo(servicoTipo);
		}
		...
		if(idOSReferencia != null && !idOSReferencia.equals("") && (descricaoOsReferencia == null || descricaoOsReferencia.equals(""))){
			...
			if(os != null && !os.equals("")){
				...
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Ordem Serviço Referência");
		...
		if(idServicoTipoReferencia != null && !idServicoTipoReferencia.equals("")
			...
			if(st != null && !st.equals("")){
				...
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Serviço Tipo Referência");
			}
		}
		...
		if(sessao.getAttribute("ehPopup") == null || sessao.getAttribute("ehPopup").equals("")){
			// Exibe a página de sucesso
			String mensagem = "";
			if(ordemServico.getRegistroAtendimento() != null && ordemServico.getRegistroAtendimento().getId() != null){
				mensagem = "Ordem de Serviço " + ordemServico.getId() + " para o RA - Registro de Atendimento número "
								+ ordemServico.getRegistroAtendimento().getId() + " atualizada com sucesso.";
			}else if(ordemServico.getCobrancaDocumento() != null){
				mensagem = "Ordem de Serviço " + ordemServico.getId() + " para o Documento de Cobrança número "
								+ ordemServico.getCobrancaDocumento().getId() + " atualizada com sucesso.";
			}else{
				mensagem = "Ordem de Serviço " + ordemServico.getId() + " atualizada com sucesso.";
			}
