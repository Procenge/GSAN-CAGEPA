 ...
 * @date 31/07/2006
 */
public class InserirTipoPerfilServicoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Perfil de Serviço " + inserirTipoPerfilServicoActionForm.getDescricaoPerfil()
						+ " inserido com sucesso.", "Inserir outro Perfil de Serviço", "exibirInserirTipoPerfilServicoAction.do?menu=sim",
						"exibirAtualizarTipoPerfilServicoAction.do?idRegistroInseridoAtualizar=" + idTipoPerfilServico,
						"Atualizar Perfil de Serviço Inserido");
