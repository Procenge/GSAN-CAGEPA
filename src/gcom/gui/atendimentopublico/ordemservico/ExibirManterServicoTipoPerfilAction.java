...
public class ExibirManterServicoTipoPerfilAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("manterTipoPerfilServico");
		...
		if(sessao.getAttribute("filtroServicoPerfilTipo") != null){
			filtroServicoPerfilTipo = (FiltroServicoPerfilTipo) sessao.getAttribute("filtroServicoPerfilTipo");
		}
