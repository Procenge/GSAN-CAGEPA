 ...
 */
public class ExibirEfetuarMudancaSituacaoFaturamentoLigacaoEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getAttribute("veioEncerrarOS") != null){
			...
			mudancaFaturamentoLigacaoAguaActionForm.setDataMudanca((String) httpServletRequest.getAttribute("dataEncerramento"));

			sessao.setAttribute("caminhoRetornoIntegracaoComercial", httpServletRequest.getAttribute("caminhoRetornoIntegracaoComercial"));

		}else if(mudancaFaturamentoLigacaoAguaActionForm.getIdOrdemServico() != null){
		...
		if(httpServletRequest.getAttribute("veioEncerrarOS") != null){
			...
			if(mudancaFaturamentoLigacaoAguaActionForm.getVeioEncerrarOS() != null
							&& !mudancaFaturamentoLigacaoAguaActionForm.getVeioEncerrarOS().equals("")){
				if(mudancaFaturamentoLigacaoAguaActionForm.getVeioEncerrarOS().toLowerCase().equals("true")){
					veioEncerrarOS = Boolean.TRUE;
				}else{
		...
		if(idOrdemServico != null && !idOrdemServico.trim().equals("")){
			...
			if(ordemServico != null){
				...
				if(tipoResultado != null){
					...
					}else if(tipoResultado.trim().equalsIgnoreCase("CORTADO")){
				...
				mudancaFaturamentoLigacaoAguaActionForm.setIdOrdemServico(idOrdemServico);
				mudancaFaturamentoLigacaoAguaActionForm.setNomeOrdemServico(ordemServico.getServicoTipo().getDescricao());
				...
				if(ordemServico.getServicoTipo() != null && ordemServico.getServicoTipo().getDebitoTipo() != null){
					mudancaFaturamentoLigacaoAguaActionForm.setIdTipoDebito(ordemServico.getServicoTipo().getDebitoTipo().getId()
									.toString());
					mudancaFaturamentoLigacaoAguaActionForm.setDescricaoTipoDebito(ordemServico.getServicoTipo().getDebitoTipo()
									.getDescricao());
					...
					valorDebito = this.calcularValores(httpServletRequest, ordemServico, mudancaFaturamentoLigacaoAguaActionForm);

					if(ordemServico.getServicoNaoCobrancaMotivo() != null){
						mudancaFaturamentoLigacaoAguaActionForm.setMotivoNaoCobranca(ordemServico.getServicoNaoCobrancaMotivo().getId()
										.toString());
					}
				...
				if(imovel != null){
					...
					mudancaFaturamentoLigacaoAguaActionForm.setMatriculaImovel(matriculaImovel);
					...
					mudancaFaturamentoLigacaoAguaActionForm.setSituacaoLigacaoAgua(situacaoLigacaoAgua);

					// Situação da Ligação de Esgoto
					String situacaoLigacaoEsgoto = imovel.getLigacaoEsgotoSituacao().getDescricao();
					mudancaFaturamentoLigacaoAguaActionForm.setSituacaoLigacaoEsgoto(situacaoLigacaoEsgoto);
					...
					if(colecaoClienteImovel != null && !colecaoClienteImovel.isEmpty()){
						...
						mudancaFaturamentoLigacaoAguaActionForm.setClienteUsuario(cliente.getNome());
						mudancaFaturamentoLigacaoAguaActionForm.setCpfCnpjCliente(documento);
				...
				if(dataExecucaoOdServico != null && !dataExecucaoOdServico.equals("")){
					mudancaFaturamentoLigacaoAguaActionForm.setDataMudanca(dataExecucaoOdServico);
				}

				// Carregando campo Volume Mínimo Fixado

				if(imovel.getQuantidadeEconomias() != null){
					mudancaFaturamentoLigacaoAguaActionForm.setQtdeEconomia(imovel.getQuantidadeEconomias().toString());
				}else{
					// Se entrar aqui é porque a Base está inconsistente.
					mudancaFaturamentoLigacaoAguaActionForm.setQtdeEconomia("1");
				}
