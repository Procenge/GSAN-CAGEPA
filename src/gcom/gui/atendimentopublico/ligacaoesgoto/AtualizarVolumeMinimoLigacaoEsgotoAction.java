 ...
 * @date 22/09/2006
 */
public class AtualizarVolumeMinimoLigacaoEsgotoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		 ...
		 */
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_VOLUME_MINIMO_LIGACAO_ESGOTO_ATUALIZAR,
						new UsuarioAcaoUsuarioHelper(usuario, UsuarioAcao.USUARIO_ACAO_EFETUOU_OPERACAO));

		Operacao operacao = new Operacao();
		operacao.setId(Operacao.OPERACAO_VOLUME_MINIMO_LIGACAO_ESGOTO_ATUALIZAR);
		...
		if(form.getConsumoMinimoFixado() != null && !form.getConsumoMinimoFixado().trim().equals("")){
			ligacaoEsgoto.setConsumoMinimo(new Integer(form.getConsumoMinimoFixado()));
		}
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			...
			montarPaginaSucesso(httpServletRequest, "Atualização do Volume Mínimo da Ligação de Esgoto " + ligacaoEsgoto.getId()
							+ " efetuada com Sucesso", "Atualizar o Volume Mínimo de outra Ligação de Esgoto",
							"exibirAtualizarVolumeMinimoLigacaoEsgotoAction.do?menu=sim",
							"exibirAtualizarVolumeMinimoLigacaoEsgotoAction.do?idOrdemServico=" + form.getIdOrdemServico(),
