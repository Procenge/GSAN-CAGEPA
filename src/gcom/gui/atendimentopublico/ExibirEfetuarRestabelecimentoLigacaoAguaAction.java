	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((efetuarRestabelecimentoLigacaoAguaActionForm.getIdFuncionario() != null && !efetuarRestabelecimentoLigacaoAguaActionForm
			...
			if(colecaoFuncionario == null || colecaoFuncionario.isEmpty()){
				...
				efetuarRestabelecimentoLigacaoAguaActionForm.setDescricaoFuncionario("FUNCIONÁRIO INEXISTENTE");
		...
		if(idOrdemServico != null && !idOrdemServico.trim().equals("")){
			...
			if(ordemServico != null){
				...
				efetuarRestabelecimentoLigacaoAguaActionForm.setNomeOrdemServico("ORDEM DE SERVIÇO INEXISTENTE");
			}
		}
