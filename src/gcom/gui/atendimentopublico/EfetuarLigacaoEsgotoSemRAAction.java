 ...
 */
public class EfetuarLigacaoEsgotoSemRAAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_LIGACAO_ESGOTO__SEM_RA_EFETUAR,
						new UsuarioAcaoUsuarioHelper(usuario, UsuarioAcao.USUARIO_ACAO_EFETUOU_OPERACAO));

		Operacao operacao = new Operacao();
		operacao.setId(Operacao.OPERACAO_LIGACAO_ESGOTO__SEM_RA_EFETUAR);
		...
		String idFuncionario = efetuarLigacaoEsgotoSemRAActionForm.getIdFuncionario();
		String dataLigacao = efetuarLigacaoEsgotoSemRAActionForm.getDataLigacao();
		String localInstalacaoRamal = efetuarLigacaoEsgotoSemRAActionForm.getLocalInstalacaoRamal();
		...
		if(matriculaImovel != null && !matriculaImovel.equals("")){
			...
			if(dataLigacao != null && !dataLigacao.equals("")){
				...
				if(ligacaoEsgoto.getDataLigacao().after(new Date())){
					throw new ActionServletException("atencao.data_menor_que_atual", null, "Ligação");
				}
			}
			...
			fachada.atualizarImovelExecucaoOrdemServicoLigacaoEsgoto(imovel, ligacaoEsgotoSituacao);

			fachada.inserir(ligacaoEsgoto);

			montarPaginaSucesso(httpServletRequest, "Ligação de Esgoto sem RA efetuada com Sucesso",
							"Efetuar outra Ligação de Esgoto sem RA", "exibirEfetuarLigacaoEsgotoSemRAAction.do?menu=sim");

			return retorno;
		}else{
			throw new ActionServletException("atencao.informe_campo_obrigatorio", null, "Matrícula Imóvel");
		}
	}
