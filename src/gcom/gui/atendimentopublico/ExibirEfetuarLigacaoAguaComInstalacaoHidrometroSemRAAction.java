 ...
 */
public class ExibirEfetuarLigacaoAguaComInstalacaoHidrometroSemRAAction
				extends GcomAction {
		...
		if(numeroHidrometro != null && !numeroHidrometro.trim().equals("")){
			...
			if(hidrometro == null){
				...
				if(ordemServico != null){
					...
					// Valor Débito
					BigDecimal valorDebito = fachada.obterValorDebito(ordemServico.getServicoTipo().getId(), new Integer(matriculaImovel),
									hidrometro.getHidrometroCapacidade());
