 ...
 */
public class InformarMelhoriasGcomAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		try{
			ServicosEmail.enviarMensagem(melhoriasGcomActionForm.getEmail(), envioEmail.getEmailReceptor(), envioEmail.getTituloMensagem(),
		...
		montarPaginaSucesso(httpServletRequest, "Mensagem enviada com sucesso.", "", "");
		return retorno;
	}
}
