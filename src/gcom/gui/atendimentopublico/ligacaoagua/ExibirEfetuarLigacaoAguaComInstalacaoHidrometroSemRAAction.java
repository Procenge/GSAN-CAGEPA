...
public class ExibirEfetuarLigacaoAguaComInstalacaoHidrometroSemRAAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("efetuarLigacaoAguaComInstalacaoHidrometroSemRA");
		...
		if(form.getMatriculaImovel() != null && !form.getMatriculaImovel().trim().equals("")){
			...
			String inscricao = fachada.pesquisarInscricaoImovel(Integer.valueOf(form.getMatriculaImovel()), true);
			...
			EfetuarLigacaoAguaComInstalacaoHidrometroSemRAHelper efetuarHelper = fachada.pesquisarEfetuarLigacaoAguaHidrometroSemRA(Integer
							.valueOf(form.getMatriculaImovel()));
			if(efetuarHelper != null){
				...
				form.setSituacaoLigacaoAgua(efetuarHelper.getSituacaoLigacaoAgua());
				form.setSituacaoLigacaoEsgoto(efetuarHelper.getSituacaoLigacaoEsgoto());
