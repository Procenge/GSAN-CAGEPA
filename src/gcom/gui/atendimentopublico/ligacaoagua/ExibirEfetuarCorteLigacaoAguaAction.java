 ...
 * @date 23/09/2006
 */
public class ExibirEfetuarCorteLigacaoAguaAction
				extends GcomAction {
		...
		if(idOrdemServico != null && !idOrdemServico.trim().equals("")){
			...
			if(ordemServico != null){
				...
				boolean temPermissaoPercentualCobrancaExcedente = this.getFachada().verificarPermissaoInformarPercentualCobrancaExcedente(
								usuarioLogado);
				boolean temPermissaoQuantidadeParcelasExcedente = this.getFachada()
	...
	private void pesquisarCliente(EfetuarCorteLigacaoAguaActionForm form, OrdemServico ordemServico){
		...
		// ParametroSimples(FiltroClienteImovel.IMOVEL_ID,
