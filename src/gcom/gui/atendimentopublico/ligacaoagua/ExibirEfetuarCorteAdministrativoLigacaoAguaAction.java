 ...
 */
public class ExibirEfetuarCorteAdministrativoLigacaoAguaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("efetuarCorteAdministrativoLigacaoAgua");
		...
		if((corteAdministrativoLigacaoAguaActionForm.getIdFuncionario() != null && !corteAdministrativoLigacaoAguaActionForm
						.getIdFuncionario().equals(""))
						&& (corteAdministrativoLigacaoAguaActionForm.getDescricaoFuncionario() == null || corteAdministrativoLigacaoAguaActionForm
										.getDescricaoFuncionario().equals(""))){

			FiltroFuncionario filtroFuncionario = new FiltroFuncionario();

			filtroFuncionario.adicionarParametro(new ParametroSimples(FiltroFuncionario.ID, corteAdministrativoLigacaoAguaActionForm
							.getIdFuncionario()));
			...
			if(colecaoFuncionario == null || colecaoFuncionario.isEmpty()){
				...
				corteAdministrativoLigacaoAguaActionForm.setIdFuncionario("");
				corteAdministrativoLigacaoAguaActionForm.setDescricaoFuncionario("FUNCIONÁRIO INEXISTENTE");
				...
				corteAdministrativoLigacaoAguaActionForm.setIdFuncionario(funcionario.getId().toString());
				corteAdministrativoLigacaoAguaActionForm.setDescricaoFuncionario(funcionario.getNome());
		...
		if(httpServletRequest.getAttribute("veioEncerrarOS") != null){
			...
			if(corteAdministrativoLigacaoAguaActionForm.getVeioEncerrarOS() != null
							&& !corteAdministrativoLigacaoAguaActionForm.getVeioEncerrarOS().equals("")){
				if(corteAdministrativoLigacaoAguaActionForm.getVeioEncerrarOS().toLowerCase().equals("true")){
					veioEncerrarOS = Boolean.TRUE;
				}else{
		...
		if(httpServletRequest.getAttribute("veioEncerrarOS") != null){
			...
			corteAdministrativoLigacaoAguaActionForm.setDataCorte((String) httpServletRequest.getAttribute("dataEncerramento"));
			sessao.setAttribute("caminhoRetornoIntegracaoComercial", httpServletRequest.getAttribute("caminhoRetornoIntegracaoComercial"));

		}else if(corteAdministrativoLigacaoAguaActionForm.getIdOrdemServico() != null){
		...
		if(idOrdemServico != null && !idOrdemServico.trim().equals("")){
			...
			if(ordemServico != null){
				...
				fachada.validarExibirCorteAdministrativoLigacaoAgua(ordemServico, veioEncerrarOS);
				sessao.setAttribute("ordemServico", ordemServico);
				corteAdministrativoLigacaoAguaActionForm.setVeioEncerrarOS("" + veioEncerrarOS);
				corteAdministrativoLigacaoAguaActionForm.setIdOrdemServico("" + ordemServico.getId());
				corteAdministrativoLigacaoAguaActionForm.setNomeOrdemServico(ordemServico.getServicoTipo().getDescricao());
				...
				if(imovel.getLigacaoAgua().getHidrometroInstalacaoHistorico() != null){
					corteAdministrativoLigacaoAguaActionForm.setHidrometro(imovel.getLigacaoAgua().getHidrometroInstalacaoHistorico()
									.getId().toString());
				}

				// Matricula Imovel
				String matriculaImovel = imovel.getId().toString();
				corteAdministrativoLigacaoAguaActionForm.setMatriculaImovel(matriculaImovel);

				// Inscrição Imóvel
				String inscricaoImovel = fachada.pesquisarInscricaoImovel(imovel.getId(), true);
				corteAdministrativoLigacaoAguaActionForm.setInscricaoImovel(inscricaoImovel);
				...
				corteAdministrativoLigacaoAguaActionForm.setSituacaoLigacaoAgua(situacaoLigacaoAgua);

				// Situação da Ligação de Esgoto
				String situacaoLigacaoEsgoto = imovel.getLigacaoEsgotoSituacao().getDescricao();
				corteAdministrativoLigacaoAguaActionForm.setSituacaoLigacaoEsgoto(situacaoLigacaoEsgoto);

				Date dataCorte = ordemServico.getDataExecucao();
				if(dataCorte != null && !dataCorte.equals("")){
					corteAdministrativoLigacaoAguaActionForm.setDataCorte("" + Util.formatarData(dataCorte));
				}

				if(imovel != null && imovel.getLigacaoAgua() != null && imovel.getLigacaoAgua().getCorteTipo() != null){
					corteAdministrativoLigacaoAguaActionForm.setTipoCorte("" + imovel.getLigacaoAgua().getCorteTipo().getId());
				}

				if(ordemServico.getServicoTipo().getDebitoTipo() != null){
					corteAdministrativoLigacaoAguaActionForm.setIdTipoDebito(ordemServico.getServicoTipo().getDebitoTipo().getId() + "");
					corteAdministrativoLigacaoAguaActionForm.setDescricaoTipoDebito(ordemServico.getServicoTipo().getDebitoTipo()
									.getDescricao());
				}else{
				...
				if(calculaValores != null && calculaValores.equals("S")){
					...
					qtdeParcelas = Integer.valueOf(corteAdministrativoLigacaoAguaActionForm.getQuantidadeParcelas());
					...
					if(taxaJurosFinanciamento != null){
						...
						valorDebito = valorDebito.multiply(new BigDecimal(corteAdministrativoLigacaoAguaActionForm.getPercentualCobranca())
					...
					// Valor Débito
					valorDebito = fachada.obterValorDebito(ordemServico.getServicoTipo().getId(), Integer.valueOf(matriculaImovel), Short
									.valueOf("3"));

					if(valorDebito != null){
						corteAdministrativoLigacaoAguaActionForm.setValorDebito(valorDebito + "");
					}else{
						corteAdministrativoLigacaoAguaActionForm.setValorDebito("0");
					}
				}
				...
				corteAdministrativoLigacaoAguaActionForm.setQtdeMaxParcelas(fachada.obterQuantidadeParcelasMaxima().toString());
	 ...
	 * @date 25/08/2006
	 */
	private void pesquisarCliente(EfetuarCorteAdministrativoLigacaoAguaActionForm corteAdministrativoLigacaoAguaActionForm){

		// Filtro para carregar o Cliente
		FiltroClienteImovel filtroClienteImovel = new FiltroClienteImovel();
		filtroClienteImovel.adicionarParametro(new ParametroSimples(FiltroClienteImovel.IMOVEL_ID, corteAdministrativoLigacaoAguaActionForm
						.getMatriculaImovel()));
		...
		if(colecaoClienteImovel != null && !colecaoClienteImovel.isEmpty()){
			...
			corteAdministrativoLigacaoAguaActionForm.setClienteUsuario(cliente.getNome());
			corteAdministrativoLigacaoAguaActionForm.setCpfCnpjCliente(documento);
