...
public class ExibirGerarCertidaoNegativaAction
				extends GcomAction {
	 ...
	 * @date 22/01/2008
	 */
	private void pesquisarImovel(GerarCertidaoNegativaActionForm form, String objetoConsulta, HttpServletRequest httpServletRequest){
		...
		if(colecaoImovel != null && !colecaoImovel.isEmpty()){
			...
			if(cliente.getClienteTipo().getIndicadorPessoaFisicaJuridica() == ClienteTipo.INDICADOR_PESSOA_JURIDICA){
