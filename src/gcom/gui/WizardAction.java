...
public class WizardAction
	 ...
	 */
	protected ActionForward redirecionadorWizard(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		if(httpServletRequest.getAttribute("confirmacao") != null
						&& ((String) httpServletRequest.getAttribute("confirmacao")).trim().equalsIgnoreCase("true")){
			...
			if(concluir != null && concluir.trim().equalsIgnoreCase("true")){
				...
				ActionErrors errors = actionForm.validate(actionMapping, httpServletRequest);
				...
				StatusWizardItem statusWizardItem = statusWizard.retornarItemWizard(Integer.parseInt(destino));

				proximoCaminhoAction = statusWizardItem.getCaminhoActionInicial();
			}

			try{
				return ((ActionForward) getClass().getMethod(proximoCaminhoAction,
								new Class[] {ActionMapping.class, ActionForm.class, HttpServletRequest.class, HttpServletResponse.class})
								.invoke(this, new Object[] {actionMapping, actionForm, httpServletRequest, httpServletResponse}));
	...
	/**
	 * < <Overload do redirecionadorWizard, para passar o nome do Wizard desejado para
	 ...
	 */
	protected ActionForward redirecionadorWizard(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse, String nomeStatusWizard){
