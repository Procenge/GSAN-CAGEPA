 ...
 * @date 21/12/2005
 */
public abstract class ControladorGcomAction
				extends GcomAction {
	 ...
	 * @throws Exception
	 */
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, ServletRequest request, ServletResponse response)
					throws Exception{
	 ...
	 * @throws Exception
	 */
	private ActionForward selecionarExibir(ActionMapping actionMapping, ActionForm actionForm, ServletRequest request,
	 ...
	 * @throws Exception
	 */
	public ActionForward telaSucesso(ActionMapping actionMapping, HttpServletRequest request, String mensagemPaginaSucesso,
					String labelPaginaSucesso, String caminhoFuncionalidade) throws Exception{
	...
	public ControladorGcomActionForm getControladorGcomActionForm(HttpServletRequest request, String nomeForm){
		...
		return (ControladorGcomActionForm) request.getSession().getAttribute(nomeForm);
	}
	 ...
	 * @throws Exception
	 */
	public abstract ActionForward exibir(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest request,
					HttpServletResponse response) throws Exception;
	 ...
	 * @throws Exception
	 */
	public abstract ActionForward processar(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest request,
					HttpServletResponse response) throws Exception;

	// /**
	// * Método responsável por preencher o formulario de apresentação a partir do objeto
	// selecionado
	// *
	// * @param obj
	// * @param actionForm
