...
/**
 * [UC0825] Pesquisar Processo
 * 
 * @author Cinthya Cavalcanti
 * @date 02/12/2011
 */
public class ExibirPesquisarProcessoAction
				extends GcomAction {

	/**
	 * [UC0825] Este caso de uso efetua pesquisa de Processo
	 * 
	 *@author Cinthya Cavalcanti
	 * @date 02/12/2011
	 * @param actionMapping
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirPesquisaProcesso");
		...
		if(httpServletRequest.getParameter("limparForm") != null && !httpServletRequest.getParameter("limparForm").equals("")){
			...
			pesquisarProcessoActionForm.setIdProcessoTipo("-1");
			pesquisarProcessoActionForm.setTipoPesquisa(ConstantesSistema.TIPO_PESQUISA_INICIAL.toString());
			pesquisarProcessoActionForm.setProcessoIniciadoPrecedente(httpServletRequest.getParameter("tipoConsulta"));
		}

		// Pesquisando Tipo de Processo
		FiltroProcessoTipo filtroProcessoTipo = new FiltroProcessoTipo();
		filtroProcessoTipo.adicionarParametro(new ParametroSimples(FiltroProcessoTipo.INDICADORUSO, ConstantesSistema.INDICADOR_USO_ATIVO));
		filtroProcessoTipo.setCampoOrderBy("descricao");

		Collection colecaoProcessoTipo = fachada.pesquisar(filtroProcessoTipo, ProcessoTipo.class.getName());
