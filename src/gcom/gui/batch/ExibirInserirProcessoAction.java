 ...
 * @created 22/07/2006
 */
public class ExibirInserirProcessoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		filtroProcessoTipo.adicionarParametro(new ParametroSimplesDiferenteDe(FiltroProcessoTipo.ID, ProcessoTipo.RELATORIO));
		filtroProcessoTipo.adicionarParametro(new ParametroSimplesDiferenteDe(FiltroProcessoTipo.INDICADORUSO,
						ConstantesSistema.INDICADOR_USO_DESATIVO));
		filtroProcessoTipo.setCampoOrderBy(FiltroProcessoTipo.DESCRICAO);

		Collection<ProcessoTipo> colecaoProcessoTipo = Fachada.getInstancia().pesquisar(filtroProcessoTipo, ProcessoTipo.class.getName());
