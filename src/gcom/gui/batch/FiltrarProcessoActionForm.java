 ...
 * @created 22/07/2006
 */
public class FiltrarProcessoActionForm
	...
	private String codigoGrupoProcesso;

	private String filtrarPorIP;

	/**
	 * FiltrarProcessoActionForm
	 * <p>
	 * Esse método Constroi uma instância de FiltrarProcessoActionForm.
	 * </p>
	 * 
	 * @author Marlos Ribeiro
	 * @since 18/01/2013
	 */
	public FiltrarProcessoActionForm() {

		this.filtrarPorIP = ConstantesSistema.NAO.toString();
	}
	...
	public void resetFormCustom(){
		...
		this.idUsuario = null;
		this.idUsuarioAcao = null;
		this.usuarioNaoEncontrada = "false";
		this.nomeUsuario = null;
		this.collUsuarioAcao = null;
		this.codigoGrupoProcesso = null;
		this.filtrarPorIP = ConstantesSistema.NAO.toString();
	}
	...
	/**
	 * @return the codigoGrupoProcesso
	 */
	public String getCodigoGrupoProcesso(){

		return codigoGrupoProcesso;
	}

	/**
	 * @param codigoGrupoProcesso
	 *            the codigoGrupoProcesso to set
	 */
	public void setCodigoGrupoProcesso(String codigoGrupoProcesso){

		this.codigoGrupoProcesso = codigoGrupoProcesso;
	}

	/**
	 * @return the filtrarPorIP
	 */
	public String getFiltrarPorIP(){
	...
	/**
	 * @param filtrarPorIP
	 *            the filtrarPorIP to set
	 */
	public void setFiltrarPorIP(String filtrarPorIP){

		this.filtrarPorIP = filtrarPorIP;
	}
}
