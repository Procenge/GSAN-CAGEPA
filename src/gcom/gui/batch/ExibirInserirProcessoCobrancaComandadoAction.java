 ...
 * @created 17/08/2006
 */
public class ExibirInserirProcessoCobrancaComandadoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirProcessoCobrancaComandado");
		 ...
		 * }
		 */
		httpServletRequest.setAttribute("anoMesFaturamento", Util.formatarAnoMesParaMesAno(fachada.pesquisarParametrosDoSistema()
						.getAnoMesFaturamento()));

		httpServletRequest.setAttribute("colecaoAcaoAtividadeCronograma", colecaoAcaoAtividadeCronograma);

		httpServletRequest.setAttribute("colecaoAcaoAtividadeComando", colecaoAcaoAtividadeComando);
