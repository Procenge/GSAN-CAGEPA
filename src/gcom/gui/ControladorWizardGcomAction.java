 ...
 * @date 21/12/2005
 */
public abstract class ControladorWizardGcomAction
	 ...
	 * @throws Exception
	 */
	public abstract ActionForward exibir(ActionMapping actionMapping, ActionForm actionForm, ServletRequest request,
	 ...
	 * @throws Exception
	 */
	public abstract ActionForward processar(ActionMapping actionMapping, ActionForm actionForm, ServletRequest request,
					ServletResponse response) throws Exception;
