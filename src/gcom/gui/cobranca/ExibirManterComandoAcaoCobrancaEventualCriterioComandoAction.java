 ...
 */
public class ExibirManterComandoAcaoCobrancaEventualCriterioComandoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirManterComandoAcaoCobrancaEventualCriterioComando");
		...
		if(idComandoSelecionado != null){
			if(cobrancaAcaoAtividadeComando.getCobrancaCriterio() != null){
				...
				cobrancaCriterio.setId(Integer.valueOf(idComandoSelecionado));
		...
		sessao.setAttribute("manterComandoAcaoCobrancaDetalhesActionForm", manterComandoAcaoCobrancaDetalhesActionForm);
		return retorno;
	}
