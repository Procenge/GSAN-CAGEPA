 ...
 */
public class ExibirPesquisarCriterioCobrancaLinhaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("pesquisarCriterioCobrancaLinha");
		...
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroCobrancaCriterioLinha, CobrancaCriterioLinha.class.getName());

		Collection<CobrancaCriterioLinha> colecaoCobCritLinha = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoCobCritLinha != null && !colecaoCobCritLinha.isEmpty()){
			...
			pesquisarCriterioCobrancaLinhaActionForm.setCriterioDescricao(" "
							+ colecaoCobCritLinha.iterator().next().getCobrancaCriterio().getDescricaoCobrancaCriterio());
			// sessao.setAttribute("descricaoCriterio",
			// colecaoCobCritLinha.iterator().next().getCobrancaCriterio().getDescricaoCobrancaCriterio());
		}else{
			throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, "Criterio Cobrança Linha");
		}
