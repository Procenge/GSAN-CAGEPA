 ...
 * @since 08/05/2006
 */
public class ExibirConsultarComandosAcaoCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirConsultarComandosAcaoCobranca");
		...
		if(carregando != null && !carregando.equals("")){
			if(sessao.getAttribute("consultarComandosAcaoCobrancaCronogramaActionForm") != null){
				...
				ConsultarComandosAcaoCobrancaCronogramaActionForm consultarComandosAcaoCobrancaCronogramaActionFormRecarregar = (ConsultarComandosAcaoCobrancaCronogramaActionForm) sessao
								.getAttribute("consultarComandosAcaoCobrancaCronogramaActionForm");

				consultarComandosAcaoCobrancaCronogramaActionForm
								.setTipoComando(consultarComandosAcaoCobrancaCronogramaActionFormRecarregar.getTipoComando());
