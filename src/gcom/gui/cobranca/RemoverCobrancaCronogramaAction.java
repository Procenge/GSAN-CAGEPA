 ...
 */
public class RemoverCobrancaCronogramaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, ids.length + " Cronograma(s) de Cobrança(s) removido(s) com sucesso",
							"Realizar outra manutenção de Cronograma de Cobrança", "exibirFiltrarCobrancaCronogramaAction.do?menu=sim");
		}
