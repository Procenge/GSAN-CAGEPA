 ...
 * @date 17/09/2012
 */
public class ExibirInformarMotivoRetiradaCobrancaAdministrativaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Motivo da Retirada
		Collection<ImovelCobrancaMotivoRetirada> colecaoMotivosRetirada = Fachada.getInstancia().consultarImovelCobrancaMotivoRetirada();
		httpServletRequest.setAttribute("colecaoMotivosRetirada", colecaoMotivosRetirada);
