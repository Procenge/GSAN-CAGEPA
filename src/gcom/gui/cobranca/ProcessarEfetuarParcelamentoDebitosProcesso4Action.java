 ...
 * @date 24/01/2006
 */
public class ProcessarEfetuarParcelamentoDebitosProcesso4Action
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(codigoImovel != null && !codigoImovel.trim().equals("")){
			...
			// fachada.verificarParcelamentoMesImovel(codigoImovel);
			...
			/*
			 * fachada.obterDebitoImovelOuCliente(1, codigoImovel, null, null, "000101", "999912",
			 * Util.converteStringParaDate("01/01/0001"),
			 * Util.converteStringParaDate("31/12/9999"), 1, 1, 1, 1, 1, 1, 1, null, null, null,
			 * null,
			 * indicadorNaoConsiderarPagamentoNaoClassificado, ConstantesSistema.SIM,
