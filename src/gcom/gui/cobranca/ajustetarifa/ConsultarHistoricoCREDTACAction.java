 ...
 * @date 19/09/2014
 */
public class ConsultarHistoricoCREDTACAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("consultarHistoricoCREDTAC");
		ConsultarHistoricoCREDTACActionForm formulario = (ConsultarHistoricoCREDTACActionForm) actionForm;
		...
		if(!parametroInformado){
			...
			sessao.setAttribute("idImovelAjusteTarifa", formulario.getIdImovel());
		}
