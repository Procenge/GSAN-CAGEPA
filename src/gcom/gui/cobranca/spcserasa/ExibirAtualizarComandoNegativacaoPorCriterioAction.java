 ...
 * @date 22/11/2006
 */
public class ExibirAtualizarComandoNegativacaoPorCriterioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarComandoNegativacaoPorCriterio");
		...
		if(httpServletRequest.getParameter("desfazer") == null){
			...
			if(httpServletRequest.getParameter("idComandoNegativacao") != null){
				idComandoNegativacao = (String) httpServletRequest.getParameter("idComandoNegativacao");
			}else if(httpServletRequest.getAttribute("idComandoNegativacao") != null){
				idComandoNegativacao = (String) httpServletRequest.getAttribute("idComandoNegativacao");
			}
			...
			if(sessao.getAttribute("atualizar") != null || httpServletRequest.getParameter("sucesso") != null){
				statusWizard = new StatusWizard("atualizarComandoNegativacaPorCriterioWizardAction",
								"atualizarComandoNegativacaoPorCriterioAction", "cancelarAtualizarComandoNegativacaoAction",
								"exibirFiltrarComandoNegativacaoPorCriterioAction",
								"exibirAtualizarComandoNegativacaoPorCriterioAction.do", idComandoNegativacao);
				sessao.removeAttribute("atualizar");
			}else{
				statusWizard = new StatusWizard("atualizarComandoNegativacaPorCriterioWizardAction",
								"atualizarComandoNegativacaoPorCriterioAction", "cancelarInserirComandoNegativacaoAction",
								"exibirManterComandoNegativacaoAction", "exibirAtualizarComandoNegativacaoPorCriterioAction.do",
			...
			statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "DadosGeraisPrimeiraAbaA.gif",
							"DadosGeraisPrimeiraAbaD.gif", "exibirAtualizarComandoNegativacaoDadosGeraisAction",
							"atualizarComandoNegativacaoDadosGeraisAction"));

			statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "DebitosA.gif", "DebitosD.gif",
							"exibirAtualizarComandoNegativacaoDadosDebitoAction", "atualizarComandoNegativacaoDadosDebitoAction"));
			statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(3, "ImovelPrimeiraAbaA.gif",
							"ImovelPrimeiraAbaD.gif", "exibirAtualizarComandoNegativacaoDadosImovelAction",
							"atualizarComandoNegativacaoDadosImovelAction"));
			statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(4, "LocalizacaoA.gif", "LocalizacaoD.gif",
							"exibirAtualizarComandoNegativacaoLocalizacaoAction", "atualizarComandoNegativacaoLocalizacaoAction"));
		...
		if(idComandoNegativacao != null && !idComandoNegativacao.equals("")){
			...
			ParametrosComandoNegativacaoHelper parametrosComandoNegativacaoHelper = fachada.pesquisarParametrosComandoNegativacao(Integer
			...
			form.setUltimaAlteracaoNegComando(parametrosComandoNegativacaoHelper.getUltimaAlteracaoNegComando());
			if(parametrosComandoNegativacaoHelper.getIdNagativacaoCriterio() != null){
				form.setIdNegativacaoCriterio(parametrosComandoNegativacaoHelper.getIdNagativacaoCriterio().toString());
			}
			// Dados Gerais
		...
		httpServletRequest.setAttribute("AtualizarComandoNegativacaoPorCriterioActionForm", form);

		return retorno;
	}

	private void setDadosLocalizacao(AtualizarComandoNegativacaoPorCriterioActionForm form,
		...
		if(parametrosComandoNegativacaoHelper.getColecaoEloPolo() != null){
			String[] idsEloPolo = new String[parametrosComandoNegativacaoHelper.getColecaoEloPolo().size()];
		...
		if(parametrosComandoNegativacaoHelper.getIdLocInicial() != null){
			form.setIdLocalidadeInicial("" + parametrosComandoNegativacaoHelper.getIdLocInicial());
		...
		if(parametrosComandoNegativacaoHelper.getIdLocFinal() != null){
			form.setIdLocalidadeFinal("" + parametrosComandoNegativacaoHelper.getIdLocFinal());
		...
		if(parametrosComandoNegativacaoHelper.getCodSetComInicial() != null){
			form.setCodigoSetorComercialInicial(parametrosComandoNegativacaoHelper.getCodSetComInicial().toString());
		...
		if(parametrosComandoNegativacaoHelper.getCodSetComFinal() != null){
			form.setCodigoSetorComercialFinal(parametrosComandoNegativacaoHelper.getCodSetComFinal().toString());
			form.setSetorComercialDescricaoFinal(parametrosComandoNegativacaoHelper.getSetComFinal().toString());
		}
	}

	private void setDadosImovel(AtualizarComandoNegativacaoPorCriterioActionForm form,
					ParametrosComandoNegativacaoHelper parametrosComandoNegativacaoHelper){
		...
		if(parametrosComandoNegativacaoHelper.getNomeCliente() != null){
			...
			form.setDescricaoCliente(parametrosComandoNegativacaoHelper.getNomeCliente());
		}

		// Tipo de Relação com o Cliente
		if(parametrosComandoNegativacaoHelper.getTipoRelClie() != null){

			form.setTipoRelacao(parametrosComandoNegativacaoHelper.getTipoRelClie());
		}
		...
		if(parametrosComandoNegativacaoHelper.getColecaoSitLigacaoAgua() != null){
			String[] idsSitLigacaoAgua = new String[parametrosComandoNegativacaoHelper.getColecaoSitLigacaoAgua().size()];
			Iterator colecaoSitLigacaoAgua = parametrosComandoNegativacaoHelper.getColecaoSitLigacaoAgua().iterator();
			int qtdSitLigacaoAgua = 0;
			while(colecaoSitLigacaoAgua.hasNext()){
				LigacaoAguaSituacao sitLigacaoAgua = (LigacaoAguaSituacao) colecaoSitLigacaoAgua.next();
				idsSitLigacaoAgua[qtdSitLigacaoAgua] = sitLigacaoAgua.getId().toString();
				qtdSitLigacaoAgua++;
			}
		...
		if(parametrosComandoNegativacaoHelper.getColecaoSitLigacaoEsgoto() != null){
			String[] idsSitLigacaoEsgoto = new String[parametrosComandoNegativacaoHelper.getColecaoSitLigacaoEsgoto().size()];
			Iterator colecaoSitLigacaoEsgoto = parametrosComandoNegativacaoHelper.getColecaoSitLigacaoEsgoto().iterator();
			int qtdSitLigacaoEsgoto = 0;
			while(colecaoSitLigacaoEsgoto.hasNext()){
				LigacaoEsgotoSituacao sitLigacaoEsgoto = (LigacaoEsgotoSituacao) colecaoSitLigacaoEsgoto.next();
				idsSitLigacaoEsgoto[qtdSitLigacaoEsgoto] = sitLigacaoEsgoto.getId().toString();
				qtdSitLigacaoEsgoto++;
			}
	...
	private void setDadosDebitos(AtualizarComandoNegativacaoPorCriterioActionForm form,
					ParametrosComandoNegativacaoHelper parametrosComandoNegativacaoHelper){
	...
	private void setDadosGerais(HttpSession sessao, AtualizarComandoNegativacaoPorCriterioActionForm form,
		...
		if(parametrosComandoNegativacaoHelper.getIdNegativador() != null){
			form.setNegativadorId(parametrosComandoNegativacaoHelper.getIdNegativador().toString());
			form.setNomeNegativador(parametrosComandoNegativacaoHelper.getNegativador());
		}
		...
		if(parametrosComandoNegativacaoHelper.getColecaoTitularNegativacao() != null
						&& !parametrosComandoNegativacaoHelper.getColecaoTitularNegativacao().isEmpty()){
