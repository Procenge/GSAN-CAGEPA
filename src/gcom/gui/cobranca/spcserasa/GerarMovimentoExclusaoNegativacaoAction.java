 ...
 * @date 18/12/2007
 */
public class GerarMovimentoExclusaoNegativacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if("1".equals(gmenActionForm.getOpcao())){
			...
			Collection collection = Fachada.getInstancia().gerarArquivoTXTMovimentoExclusaoNegativacao(
							new Integer(gmenActionForm.getCodigoMovimento()));
			gmenActionForm.setCollMovimento(collection);
		}
