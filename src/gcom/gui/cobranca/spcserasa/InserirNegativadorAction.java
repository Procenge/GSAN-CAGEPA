 ...
 */
public class InserirNegativadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Negativador " + codigoNegativador + " inserido com sucesso.", "Inserir outro Negativador",
