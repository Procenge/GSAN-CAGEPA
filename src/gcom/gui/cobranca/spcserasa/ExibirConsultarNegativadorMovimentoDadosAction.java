...
public class ExibirConsultarNegativadorMovimentoDadosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((idNegativadorMovimento != null && !idNegativadorMovimento.equals(""))
						...
						&& (httpServletRequest.getParameter("reload") == null || httpServletRequest.getParameter("reload")
										.equalsIgnoreCase(""))){
			exibirNegativadorMovimento(idNegativadorMovimento, consultarNegativadorMovimentoActionForm, fachada, sessao,
		...
		if(consultarNegativadorMovimentoActionForm.getIdNegativador() == null
						|| "".equals(consultarNegativadorMovimentoActionForm.getIdNegativador())){
		...
		// na tela
		Integer totalRegistros = Integer.valueOf(collNegativadorMovimentoReg.size());
		...
		collNegativadorMovimentoReg = Fachada.getInstancia().pesquisarNegativadorMovimentoRegistroAceito(negativadorMovimentoHelper,
	...
	private void exibirNegativadorMovimento(String idNegativadorMovimento,
					ConsultarNegativadorMovimentoActionForm consultarNegativadorMovimentoActionForm, Fachada fachada, HttpSession sessao,
		...
		filtroNegativadorMovimento.adicionarParametro(new ParametroSimples(FiltroNegativadorRegistroTipo.ID, idNegativadorMovimento));
		...
		Collection<NegativadorMovimento> collectionNegativadorMovimento = fachada.pesquisar(filtroNegativadorMovimento,
						NegativadorMovimento.class.getName());

		// Caso a pesquisa tenha retornado o NegativadorMovimento
		if(collectionNegativadorMovimento != null && !collectionNegativadorMovimento.isEmpty()){

			// Recupera da coleção o NegativadorMovimento que vai ser atualizado
			negativadorMovimento = (NegativadorMovimento) Util.retonarObjetoDeColecao(collectionNegativadorMovimento);
			...
			if(negativadorMovimento.getNumeroSequencialEnvio() != null && !negativadorMovimento.getNumeroSequencialEnvio().equals("")){

				consultarNegativadorMovimentoActionForm.setNumeroSequencialEnvio("" + negativadorMovimento.getNumeroSequencialEnvio());
			}else{
			...
			if(negativadorMovimento.getCodigoMovimento() != -1){
				...
				consultarNegativadorMovimentoActionForm.setCodigoMovimento("" + negativadorMovimento.getCodigoMovimento());
			}else{
			...
			if(negativadorMovimento.getNumeroRegistrosEnvio() != null && !negativadorMovimento.getNumeroRegistrosEnvio().equals("")){
				...
				consultarNegativadorMovimentoActionForm.setNumeroRegistrosEnvio("" + negativadorMovimento.getNumeroRegistrosEnvio());
			}else{
			...
			if(negativadorMovimento.getValorTotalEnvio() != null && !negativadorMovimento.getValorTotalEnvio().equals("")){
				...
				consultarNegativadorMovimentoActionForm.setValorTotalEnvio("" + negativadorMovimento.getValorTotalEnvio());
			}else{
				consultarNegativadorMovimentoActionForm.setValorTotalEnvio("");
			}

			if(negativadorMovimento.getDataProcessamentoEnvio() != null && !negativadorMovimento.getDataProcessamentoEnvio().equals("")){
			...
			if(negativadorMovimento.getDataProcessamentoRetorno() != null && !negativadorMovimento.getDataProcessamentoRetorno().equals("")){

				Date dataRetorno = Util.formatarDataSemHora(negativadorMovimento.getDataProcessamentoRetorno());
				consultarNegativadorMovimentoActionForm.setDataRetorno(Util.formatarData(dataRetorno));

				String horaRetorno = Util.formatarHoraSemData(negativadorMovimento.getDataProcessamentoRetorno());
				consultarNegativadorMovimentoActionForm.setHoraRetorno(horaRetorno);
			}else{
