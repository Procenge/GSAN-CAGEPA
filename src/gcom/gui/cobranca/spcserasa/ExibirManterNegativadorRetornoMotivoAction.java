...
public class ExibirManterNegativadorRetornoMotivoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterNegativadorRetornoMotivo"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroNegativadorRetornoMotivo, NegativadorRetornoMotivo.class
							.getName());
			...
			if(collectionNegativadorRetornoMotivo.size() == 1 && checkAtualizar != null && !checkAtualizar.equals("")){
				...
				NegativadorRetornoMotivo negativadorRetornoMotivo = (NegativadorRetornoMotivo) collectionNegativadorRetornoMotivo
								.iterator().next();
