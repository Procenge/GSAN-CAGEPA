...
public class ExibirAtualizarNegativadorRegistroTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((idNegativadorRegistroTipo != null && !idNegativadorRegistroTipo.equals(""))
						...
						&& (httpServletRequest.getParameter("reload") == null || httpServletRequest.getParameter("reload")
										.equalsIgnoreCase(""))){
			exibirNegativadorRegistroTipo(idNegativadorRegistroTipo, atualizarNegativadorRegistroTipoActionForm, fachada, sessao,
							httpServletRequest);
	...
	private void exibirNegativadorRegistroTipo(String idNegativadorRegistroTipo,
					AtualizarNegativadorRegistroTipoActionForm atualizarNegativadorRegistroTipoActionForm, Fachada fachada,
		...
		filtroNegativadorRegistroTipo.adicionarParametro(new ParametroSimples(FiltroNegativadorRegistroTipo.ID, idNegativadorRegistroTipo));

		filtroNegativadorRegistroTipo.adicionarCaminhoParaCarregamentoEntidade("negativador.cliente");

		Collection<NegativadorRegistroTipo> collectionNegativadorRegistroTipo = fachada.pesquisar(filtroNegativadorRegistroTipo,
		...
		if(collectionNegativadorRegistroTipo != null && !collectionNegativadorRegistroTipo.isEmpty()){
			...
			negativadorRegistroTipo = (NegativadorRegistroTipo) Util.retonarObjetoDeColecao(collectionNegativadorRegistroTipo);

			// Seta no form os dados de NegativadorRegistroTipo
			if(negativadorRegistroTipo.getNegativador() != null && !negativadorRegistroTipo.getNegativador().equals("")){

				atualizarNegativadorRegistroTipoActionForm.setIdNegativador("" + negativadorRegistroTipo.getNegativador());

				atualizarNegativadorRegistroTipoActionForm.setNegativadorCliente(""
								+ negativadorRegistroTipo.getNegativador().getCliente().getNome());
			}else{
				atualizarNegativadorRegistroTipoActionForm.setNegativadorCliente("");
			}

			if(negativadorRegistroTipo.getCodigoRegistro() != null && !negativadorRegistroTipo.getCodigoRegistro().equals("")){

				atualizarNegativadorRegistroTipoActionForm.setCodigoRegistro("" + negativadorRegistroTipo.getCodigoRegistro());

			}else{
				atualizarNegativadorRegistroTipoActionForm.setCodigoRegistro("");
			}

			if(negativadorRegistroTipo.getDescricaoRegistroTipo() != null && !negativadorRegistroTipo.getDescricaoRegistroTipo().equals("")){

				atualizarNegativadorRegistroTipoActionForm
								.setDescricaoRegistroTipo("" + negativadorRegistroTipo.getDescricaoRegistroTipo());

			}else{
				atualizarNegativadorRegistroTipoActionForm.setDescricaoRegistroTipo("");
			}

			atualizarNegativadorRegistroTipoActionForm.setTime(Long.toString(negativadorRegistroTipo.getUltimaAlteracao().getTime()));
