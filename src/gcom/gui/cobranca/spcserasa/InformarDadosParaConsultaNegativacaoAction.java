 ...
 * @date 21/02/2008
 */
public class InformarDadosParaConsultaNegativacaoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("consultarResumoNegativacaoParametros");
		...
		StatusWizard statusWizard = new StatusWizard("consultaNegativacaoWizardAction", "exibirInformarDadosConsultaNegativacaoAction",
						"cancelarConsultarResumoNegativacaoAction", "exibirInformarDadosConsultaNegativacaoAction",
		...
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "ParametrosPrimeiraAbaA.gif",
						"ParametrosPrimeiraAbaD.gif", "exibirDadosGeracaoConsultaNegativacaoAction", ""));
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "ResumoUltimaAbaA.gif", "ResumoUltimaAbaD.gif",
		...
		if(form.getIdNegativador() != null && !form.getIdNegativador().equals("")){
			...
			Collection colecaoNegativadorPesquisa = fachada.pesquisar(filtroNegativador, Negativador.class.getName());

			if(colecaoNegativadorPesquisa != null && !colecaoNegativadorPesquisa.isEmpty()){
				Negativador negativador = (Negativador) Util.retonarObjetoDeColecao(colecaoNegativadorPesquisa);
				nomeNegativador = negativador.getCliente().getNome();
		...
		if(!dadosConsultaNegativacaoHelper.getColecaoCobrancaGrupo().isEmpty()){ // cobrancaGrupo !=
			// null
			...
			//
			// Iterator colecaoCobrancaGrupoIterator =
			// dadosConsultaNegativacaoHelper.getColecaoCobrancaGrupo().iterator();
			// while(colecaoCobrancaGrupoIterator.hasNext()){
			// CobrancaGrupo cobrancaGrupoObjeto = (CobrancaGrupo)
			// colecaoCobrancaGrupoIterator.next();
			//
		...
		if(!dadosConsultaNegativacaoHelper.getColecaoGerenciaRegional().isEmpty()){ // gerenciaRegional
			// != null
		...
		if(!dadosConsultaNegativacaoHelper.getColecaoUnidadeNegocio().isEmpty()){ // unidadeNegocio
			// != null
		...
		if(!dadosConsultaNegativacaoHelper.getColecaoImovelPerfil().isEmpty()){ // imovelPerfil !=
			// null
		...
		if(!dadosConsultaNegativacaoHelper.getColecaoEsferaPoder().isEmpty()){ // esferaPoder !=
			// null
		...
		// retorno = actionMapping.findForward("exibirConsultarResumoNegativ");
		return retorno;
	}
	// FIM ESFERA DE PODER
	// ////////////////////////////////////////////////////////////////////////////////
