...
public class ExibirAtualizarNegativadorExclusaoMotivoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(colecaoCobrancaDebitoSituacao == null){
			...
			colecaoCobrancaDebitoSituacao = fachada.pesquisar(filtroCobrancaDebitoSituacao, CobrancaDebitoSituacao.class.getName());

			if(colecaoCobrancaDebitoSituacao == null || colecaoCobrancaDebitoSituacao.isEmpty()){
				throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, "COBRANCA DEBITO SITUACAO");
			}else{
		...
		if((idNegativadorExclusaoMotivo != null && !idNegativadorExclusaoMotivo.equals(""))
						...
						&& (httpServletRequest.getParameter("reload") == null || httpServletRequest.getParameter("reload")
										.equalsIgnoreCase(""))){
			exibirNegativadorExclusaoMotivo(idNegativadorExclusaoMotivo, atualizarNegativadorExclusaoMotivoActionForm, fachada, sessao,
							httpServletRequest);
	...
	private void exibirNegativadorExclusaoMotivo(String idNegativadorExclusaoMotivo,
					AtualizarNegativadorExclusaoMotivoActionForm atualizarNegativadorExclusaoMotivoActionForm, Fachada fachada,
		...
		Collection<NegativadorExclusaoMotivo> collectionNegativadorExclusaoMotivo = fachada.pesquisar(filtroNegativadorExclusaoMotivo,
		...
		if(collectionNegativadorExclusaoMotivo != null && !collectionNegativadorExclusaoMotivo.isEmpty()){
			...
			negativadorExclusaoMotivo = (NegativadorExclusaoMotivo) Util.retonarObjetoDeColecao(collectionNegativadorExclusaoMotivo);

			// Seta no form os dados de NegativadorExclusaoMotivo
			if(negativadorExclusaoMotivo.getNegativador() != null && !negativadorExclusaoMotivo.getNegativador().equals("")){

				atualizarNegativadorExclusaoMotivoActionForm.setIdNegativador("" + negativadorExclusaoMotivo.getNegativador());

				atualizarNegativadorExclusaoMotivoActionForm.setNegativadorCliente(""
								+ negativadorExclusaoMotivo.getNegativador().getCliente().getNome());
			}else{
				atualizarNegativadorExclusaoMotivoActionForm.setNegativadorCliente("");
			}
			...
			if(negativadorExclusaoMotivo.getCodigoExclusaoMotivo() != 0){
				...
				atualizarNegativadorExclusaoMotivoActionForm.setCodigoMotivo("" + negativadorExclusaoMotivo.getCodigoExclusaoMotivo());
			...
			if(negativadorExclusaoMotivo.getIndicadorUso() != 0){
				...
				atualizarNegativadorExclusaoMotivoActionForm.setIndicadorUso("" + negativadorExclusaoMotivo.getIndicadorUso());
			...
			if(negativadorExclusaoMotivo.getCobrancaDebitoSituacao() != null
				...
				atualizarNegativadorExclusaoMotivoActionForm.setIdCobrancaDebitoSituacao("-1");
			}

			atualizarNegativadorExclusaoMotivoActionForm.setTime(Long.toString(negativadorExclusaoMotivo.getUltimaAlteracao().getTime()));
