 ...
 */
public class AtualizarNegativadorRetornoMotivoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer idNegativadorRetornoMotivo = Integer.valueOf(form.getIdNegativadorRetornoMotivo());
		...
		// ------------ REGISTRAR TRANSAÇÃO ----------------
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_ATUALIZAR_NEGATIVADOR_RETORNO_MOTIVO,
		...
		filtroNegativadorRetornoMotivo.adicionarParametro(new ParametroSimples(FiltroNegativadorRetornoMotivo.ID,
						idNegativadorRetornoMotivo));
		filtroNegativadorRetornoMotivo.adicionarCaminhoParaCarregamentoEntidade("negativador");

		Collection<NegativadorRetornoMotivo> collNegativadorRetornoMotivo = Fachada.getInstancia().pesquisar(
		...
		if(indicadorRegistroAceito == ConstantesSistema.INDICADOR_REGISTRO_ACEITO){
			...
			collNegativadorRetornoMotivo = Fachada.getInstancia().pesquisar(filtroNegativadorRetornoMotivo,
		...
		negativadorRetornoMotivo.adicionarUsuario(usuario, UsuarioAcao.USUARIO_ACAO_EFETUOU_OPERACAO);
		...
		montarPaginaSucesso(httpServletRequest, "Motivo de retorno do registro do negativador " + descricaoRetornoMotivo
						+ " atualizado com sucesso.", "Realizar outra manutenção de motivo de retorno do registro do negativador",
