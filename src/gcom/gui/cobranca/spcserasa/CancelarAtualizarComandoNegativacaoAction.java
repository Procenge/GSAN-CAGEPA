...
/**
 * Esta classe tem por finalidade cancelar todas as atividades referentes ao processo de atualização
 * de um
 ...
 * @date 28/01/2008
 */
public class CancelarAtualizarComandoNegativacaoAction
				extends GcomAction {
