 ...
 */
public class FiltrarComandoNegativacaoTipoCriterioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((form.getGeracaoComandoDataInicial() != null && !form.getGeracaoComandoDataInicial().equals(""))
			...
			comandoNegativacaoTipoCriterioHelper.setGeracaoComandoDataInicial(Util.converteStringParaDate(form
		...
		if((form.getExecucaoComandoDataInicial() != null && !form.getExecucaoComandoDataInicial().equals(""))
			...
			comandoNegativacaoTipoCriterioHelper.setExecucaoComandoDataInicial(Util.converteStringParaDate(form
							.getExecucaoComandoDataInicial()));
			comandoNegativacaoTipoCriterioHelper.setExecucaoComandoDataFinal(Util
							.converteStringParaDate(form.getExecucaoComandoDataFinal()));
		}
		...
		if((form.getReferenciaDebitoDataInicial() != null && !form.getReferenciaDebitoDataInicial().equals(""))
			...
			if(referenciaDebitoDataFinal < referenciaDebitoDataInicial){
				throw new ActionServletException("atencao.referencia_final_menor_referencia_inicial");
			}
		...
		if((form.getVencimentoDebitoDataInicial() != null && !form.getVencimentoDebitoDataInicial().equals(""))
			...
			comandoNegativacaoTipoCriterioHelper.setVencimentoDebitoDataInicial(Util.converteStringParaDate(form
							.getVencimentoDebitoDataInicial()));
			comandoNegativacaoTipoCriterioHelper.setVencimentoDebitoDataFinal(Util.converteStringParaDate(form
		...
		// Collection collComandoNegativacao =
		// fachada.pesquisarComandoNegativacaoTipoCriterio(comandoNegativacaoTipoCriterioHelper);
		...
		// Fachada fachada = Fachada.getInstancia();
		// Collection collNegativacaoCriterio =
		// fachada.pesquisarComandoNegativacaoTipoCriterio(comandoNegativacaoTipoCriterioHelper);
