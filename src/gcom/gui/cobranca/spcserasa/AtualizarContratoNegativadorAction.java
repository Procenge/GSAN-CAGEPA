 ...
 * @created 26/12/2007
 */
public class AtualizarContratoNegativadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// ------------ REGISTRAR TRANSAÇÃO ----------------
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_ATUALIZAR_CONTRATO_NEGATIVADOR,
		...
		if(atualizarContratoNegativadorActionForm.getDataContratoFim() != null
			...
			if(dataContratoInicio.after(dataContratoFim)){
				...
				throw new ActionServletException("atencao.data.inicio.nao.superior.data.corrente", null, dataInicio);
			}
		...
		if(atualizarContratoNegativadorActionForm.getDataContratoEncerramento() != null
			...
			if(dataContratoInicio.after(dataContratoEncerramento)){
				String dataInicio = Util.formatarData(dataContratoInicio);
				throw new ActionServletException("atencao.data.encerramento.intervalo.invalido", null, dataInicio);
			}
		...
		if(idContratoMotivoCancelamento != null && !idContratoMotivoCancelamento.equals("-1")){
			...
			contratoMotivoCancelamento.setId(Integer.valueOf(idContratoMotivoCancelamento));
		...
		montarPaginaSucesso(httpServletRequest, "Contrato do Negativador de código " + negativadorContrato.getId()
						+ " atualizado com sucesso.", "Realizar outra Manutenção de Contrato do Negativador",
