...
public class ExibirManterNegativadorExclusaoMotivoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterNegativadorExclusaoMotivo"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroNegativadorExclusaoMotivo,
			...
			if(collectionNegativadorExclusaoMotivo.size() == 1 && identificadorAtualizar != null){
				...
				NegativadorExclusaoMotivo negativadorExclusaoMotivo = (NegativadorExclusaoMotivo) collectionNegativadorExclusaoMotivo
								.iterator().next();
