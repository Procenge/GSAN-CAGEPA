 ...
 * @date 07/01/2008
 */
public class InserirNegativadorRegistroTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// ------------ REGISTRAR TRANSAÇÃO ----------------
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_INSERIR_NEGATIVADOR_REGISTRO_TIPO,
		...
		if(inserirNegativadorRegistroTipoActionForm.getIdNegativador() != null
						&& !inserirNegativadorRegistroTipoActionForm.getIdNegativador().equals("-1")){

			Negativador negativador = new Negativador();
			negativador.setId(new Integer(inserirNegativadorRegistroTipoActionForm.getIdNegativador()));
		...
		if(inserirNegativadorRegistroTipoActionForm.getCodigoRegistro() != null
						&& !inserirNegativadorRegistroTipoActionForm.getCodigoRegistro().equals("")){

			String codigoRegistroTipo = inserirNegativadorRegistroTipoActionForm.getCodigoRegistro();

			if(!codigoRegistroTipo.equalsIgnoreCase("H") && !codigoRegistroTipo.equalsIgnoreCase("D")
							&& !codigoRegistroTipo.equalsIgnoreCase("T")){
		...
		if(inserirNegativadorRegistroTipoActionForm.getDescricaoRegistroTipo() != null
						&& !inserirNegativadorRegistroTipoActionForm.getDescricaoRegistroTipo().equals("")){
		...
		negativadorRegistroTipo.adicionarUsuario(usuario, UsuarioAcao.USUARIO_ACAO_EFETUOU_OPERACAO);
		...
		if(negativadorRegistroTipo != null){
			...
			idNegativadorRegistroTipo = (Integer) fachada.inserir(negativadorRegistroTipo);
		}else{
			throw new ActionServletException("atencao.informar.linha.criterio.cobranca");
		}

		// dúvida, os 2 ultimos parametros.
		montarPaginaSucesso(httpServletRequest, "Tipo do Registro do Negativador " + idNegativadorRegistroTipo + " inserido com sucesso.",
						"Inserir outro Tipo do Registro do Negativador", "exibirInserirNegativadorRegistroTipoAction.do?menu=sim",
						"exibirAtualizarNegativadorRegistroTipoAction.do?idRegistroAtualizacao=" + idNegativadorRegistroTipo,
						"Atualizar Tipo de Registro do Negativador Inserido");
