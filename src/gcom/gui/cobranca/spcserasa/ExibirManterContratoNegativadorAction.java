...
public class ExibirManterContratoNegativadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterContratoNegativador"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroNegativadorContrato, NegativadorContrato.class.getName());
