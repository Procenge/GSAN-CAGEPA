 ...
 */
public class ExibirConsultarComandoNegativacaoTipoCriterioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("comandoNegativacaoTipoCriterioHelper") != null){
			comandoNegativacaoTipoCriterioHelper = (ComandoNegativacaoTipoCriterioHelper) sessao
							.getAttribute("comandoNegativacaoTipoCriterioHelper");
		}
		...
		// tela
		Integer totalRegistros = Integer.valueOf(collNegativacaoCriterio.size());
		...
		collNegativacaoCriterio = Fachada.getInstancia().pesquisarComandoNegativacaoTipoCriterio(comandoNegativacaoTipoCriterioHelper,
