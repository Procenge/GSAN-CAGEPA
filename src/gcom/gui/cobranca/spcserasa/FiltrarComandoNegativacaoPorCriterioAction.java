 ...
 */
public class FiltrarComandoNegativacaoPorCriterioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((!form.getDataGeracaoComandoInicial().equals("") && form.getDataGeracaoComandoInicial() != null)
						&& (!form.getDataGeracaoComandoFinal().equals("") && form.getDataGeracaoComandoFinal() != null)){
