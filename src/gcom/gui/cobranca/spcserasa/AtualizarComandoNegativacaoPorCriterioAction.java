 ...
 * @date 13/12/2007
 */
public class AtualizarComandoNegativacaoPorCriterioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		negativacaoComando.setIndicadorSimulacao(Short.valueOf(form.getSimular()));
		negativacaoComando.setIndicadorComandoCriterio(Short.valueOf("1"));
		...
		usuario.setId(Integer.valueOf(form.getUsuario()));
		negativacaoComando.setUsuario(usuario);
		Negativador negativador = new Negativador();
		if(form.getNegativadorId() != null){
			negativador.setId(Integer.valueOf(form.getNegativadorId()));
		}
		...
		if(form.getIdComandoSimulado() != null && !form.getIdComandoSimulado().equals("")){
			...
			negComandoSimulacao.setId(Integer.valueOf(form.getIdComandoSimulado()));
		...
		if(form.getIdNegativacaoCriterio() != null){
			negativacaoCriterio.setId(Integer.valueOf(form.getIdNegativacaoCriterio()));
		}
		...
		if(form.getIdLocalidadeInicial() != null && !form.getIdLocalidadeInicial().equals("")){
			...
			localidade.setId(Integer.valueOf(form.getIdLocalidadeInicial()));
			negativacaoCriterio.setLocalidadeInicial(localidade);
		}
		if(form.getIdLocalidadeFinal() != null && !form.getIdLocalidadeFinal().equals("")){
			Localidade localidade = new Localidade();
			localidade.setId(Integer.valueOf(form.getIdLocalidadeFinal()));
		...
		if(form.getCodigoSetorComercialInicial() != null && !form.getCodigoSetorComercialInicial().equals("")){
			negativacaoCriterio.setCodigoSetorComercialInicial(Integer.valueOf(form.getCodigoSetorComercialInicial()));
		}
		if(form.getCodigoSetorComercialFinal() != null && !form.getCodigoSetorComercialFinal().equals("")){
			negativacaoCriterio.setCodigoSetorComercialFinal(Integer.valueOf(form.getCodigoSetorComercialFinal()));
		}
		if(form.getReferenciaInicial() != null && !form.getReferenciaInicial().equals("")){
			...
			if(form.getReferenciaFinal() != null && !form.getReferenciaFinal().equals("")){
				dataReferenciaInicial = Util
.subtrairNumeroAnosDeUmaData(Util.converteStringParaDate("01/" + form.getReferenciaFinal()), 5);
			}else{
		...
		if(form.getDataVencimentoInicial() != null && !form.getDataVencimentoInicial().equals("")){
			...
			if(form.getDataVencimentoFinal() != null && !form.getDataVencimentoFinal().equals("")){
				dataVencimentoDebitoInicial = Util.subtrairNumeroAnosDeUmaData(Util.converteStringParaDate(form.getDataVencimentoFinal()),
								5);
			}else{
		...
		if(form.getQtdMaximaInclusao() != null && !form.getQtdMaximaInclusao().equals("")){
			negativacaoCriterio.setQuantidadeMaximaInclusoes(Integer.valueOf(form.getQtdMaximaInclusao()));
		}
		if(form.getImovSitEspecialCobranca() != null && !form.getImovSitEspecialCobranca().equals("")){
			negativacaoCriterio.setIndicadorNegativacaoImovelParalisacao(Short.valueOf(form.getImovSitEspecialCobranca()));
		}else{
		...
		if(form.getImovSitCobranca() != null && !form.getImovSitCobranca().equals("")){
			negativacaoCriterio.setIndicadorNegativacaoImovelSituacaoCobranca(Short.valueOf(form.getImovSitCobranca()));
		}else{
			negativacaoCriterio.setIndicadorNegativacaoImovelSituacaoCobranca(ConstantesSistema.INDICADOR_USO_ATIVO);
		}
		if(form.getContasRevisao() != null && !form.getContasRevisao().equals("")){
			negativacaoCriterio.setIndicadorNegativacaoContaRevisao(Short.valueOf(form.getContasRevisao()));
		}else{
		...
		if(form.getGuiasPagamento() != null && !form.getGuiasPagamento().equals("")){
			negativacaoCriterio.setIndicadorNegativacaoGuiaPagamento(Short.valueOf(form.getGuiasPagamento()));
		}else{
		...
		if(form.getParcelaAtraso() != null && !form.getParcelaAtraso().equals("")){
			negativacaoCriterio.setIndicadorParcelamentoAtraso(Short.valueOf(form.getParcelaAtraso()));
		}else{
		...
		if(form.getDiasAtrasoParcelamento() != null && !form.getDiasAtrasoParcelamento().equals("")){
			negativacaoCriterio.setNumeroDiasParcelamentoAtraso(Integer.valueOf(form.getDiasAtrasoParcelamento()));
		}
		if(form.getCartaParcelamentoAtraso() != null && !form.getCartaParcelamentoAtraso().equals("")){
			negativacaoCriterio.setIndicadorNegativacaoRecebimentoCartaParcelamento(Short.valueOf(form.getCartaParcelamentoAtraso()));
		}else{
		...
		if(form.getDiasAtrasoRecebimentoCarta() != null && !form.getDiasAtrasoRecebimentoCarta().equals("")){
			negativacaoCriterio.setNumeroDiasAtrasoRecebimentoCartaParcelamento(Short.valueOf(form.getDiasAtrasoRecebimentoCarta()));
		}
		if(form.getIdCliente() != null && !form.getIdCliente().equals("")){
			...
			if(form.getTipoRelacao() != null && !form.getTipoRelacao().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
				...
				relacaoTipo.setId(Integer.valueOf(form.getTipoRelacao()));
		...
		if(form.getNumeroContasInicial() != null && !form.getNumeroContasInicial().equals("")){
			negativacaoCriterio.setQuantidadeMinimaContas(Integer.valueOf(form.getNumeroContasInicial()));
		}else{
			negativacaoCriterio.setQuantidadeMinimaContas(0);
		}
		if(form.getNumeroContasFinal() != null && !form.getNumeroContasFinal().equals("")){
			negativacaoCriterio.setQuantidadeMaximaContas(Integer.valueOf(form.getNumeroContasFinal()));
		}else{
		...
		montarPaginaSucesso(httpServletRequest, "Comando Negativação atualizado com sucesso.", "Manter outro Comando Negativação",
						"exibirFiltrarComandoNegativacaoPorCriterioAction.do?menu=sim");

		return retorno;
	}

	private void validarDadosLocalizacao(AtualizarComandoNegativacaoPorCriterioActionForm form, Fachada fachada){
	...
	private void validarDadosImovel(AtualizarComandoNegativacaoPorCriterioActionForm form, Fachada fachada){
	...
	private void validarDadosDebito(AtualizarComandoNegativacaoPorCriterioActionForm form, Fachada fachada){
		...
		if(form.getDataVencimentoInicial() != null && !form.getDataVencimentoInicial().equals("") && form.getDataVencimentoFinal() != null
			...
			if(Util.compararData(vencimentoDebInicial, vencimentoDebFinal) == 1){
				throw new ActionServletException(// Data Final do Período é anterior à Data Inicial
								// do Período
		...
		if(form.getNumeroContasInicial() != null && !form.getNumeroContasInicial().equals("") && form.getNumeroContasFinal() != null
			...
			Integer contaInicial = Integer.valueOf(form.getNumeroContasInicial());
			Integer contaFinal = Integer.valueOf(form.getNumeroContasFinal());
