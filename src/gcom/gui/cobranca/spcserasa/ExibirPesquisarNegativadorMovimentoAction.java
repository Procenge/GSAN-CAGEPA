 ...
 * @date 27/12/2007
 */
public class ExibirPesquisarNegativadorMovimentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaNegativadorMovimento") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaNegativadorMovimento", httpServletRequest
							.getParameter("caminhoRetornoTelaPesquisaNegativadorMovimento"));
		}
