 ...
 * @created 03/01/2008
 */
public class FiltrarNegativadorExclusaoMotivoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(filtrarNegativadorExclusaoMotivoActionForm.getIdNegativador() != null
						&& !filtrarNegativadorExclusaoMotivoActionForm.getIdNegativador().equals("-1")){
		...
		if(codigoMotivo != null && !codigoMotivo.equalsIgnoreCase("")){
			...
			filtroNegativadorExclMotivo.adicionarParametro(new ParametroSimples(FiltroNegativadorExclusaoMotivo.CODIGO_EXCLUSAO_MOTIVO,
							codigoMotivo));

			Collection collNegativadorExclusaoMotivo = fachada.pesquisar(filtroNegativadorExclMotivo, NegativadorExclusaoMotivo.class
							.getName());
		...
		if(descricaoExclusaoMotivo != null && !descricaoExclusaoMotivo.equalsIgnoreCase("")){
			filtroNegativadorExclusaoMotivo.adicionarParametro(new ParametroSimples(
							FiltroNegativadorExclusaoMotivo.DESCRICAO_EXCLUSAO_MOTIVO, descricaoExclusaoMotivo));
			peloMenosUmParametroInformado = true;
