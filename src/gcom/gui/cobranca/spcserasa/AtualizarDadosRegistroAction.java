 ...
 * @created 08/01/2008
 */
public class AtualizarDadosRegistroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(negativadorMovimentoReg == null){
			...
			negativadorMovimentoReg.setId(Integer.valueOf(form.getIdNegativadorMovimentoReg()));
		}
		...
		if(!"-1".equals(form.getIndicadorCorrecao()) && form.getIndicadorCorrecao() != null){
			...
			Short indicadorCorrecao = Short.valueOf(form.getIndicadorCorrecao());
