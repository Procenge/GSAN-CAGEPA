 ...
 * @created 07/01/2008
 */
public class FiltrarNegativadorRegistroTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(filtrarNegativadorRegistroTipoActionForm.getIdNegativador() != null
						&& !filtrarNegativadorRegistroTipoActionForm.getIdNegativador().equals("-1")){
		...
		if(idNegativador != null && !idNegativador.equals("-1")){
			filtroNegativadorRegistroTipo.adicionarParametro(new ParametroSimples(FiltroNegativadorRegistroTipo.NEGATIVADOR_ID,
							idNegativador));
		...
		if(codigoRegistro != null && !codigoRegistro.equalsIgnoreCase("")){
			...
			filtroNegativadorRegTipo
							.adicionarParametro(new ParametroSimples(FiltroNegativadorRegistroTipo.CODIGO_REGISTRO, codigoRegistro));
		...
		if(descricaoRegistroTipo != null && !descricaoRegistroTipo.equalsIgnoreCase("")){
			filtroNegativadorRegistroTipo.adicionarParametro(new ParametroSimples(FiltroNegativadorRegistroTipo.DESCRICAO_REGISTRO_TIPO,
							descricaoRegistroTipo));
			peloMenosUmParametroInformado = true;
