 ...
 * @created 20/12/2007
 */
public class RemoverContratoNegativadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, ids.length + " Contrato(os) de Negativador(es) removido(s) com sucesso.",
							"Realizar outra manutenção de Contrato de Negativador", "exibirFiltrarContratoNegativadorAction.do?desfazer=S");
		}
