 ...
 * @date 23/01/2008
 */
public class ConsultarNegativadorMovimentoRegGenericoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("reload") == null || httpServletRequest.getParameter("reload").equalsIgnoreCase("")
			...
			if(httpServletRequest.getParameter("idRegistro") != null){
				idNegativadorMovimentoReg = httpServletRequest.getParameter("idRegistro");
				...
				idNegativadorMovimentoReg = (String) sessao.getAttribute("idRegistro");
				httpServletRequest.setAttribute("voltar", "filtrar");
			}else if(httpServletRequest.getParameter("idRegistro") != null){
				idNegativadorMovimentoReg = httpServletRequest.getParameter("idRegistro");
		...
		if((idNegativadorMovimentoReg != null && !idNegativadorMovimentoReg.equals(""))
			...
			filtroNegativadorMovimentoReg.adicionarParametro(new ParametroSimples(FiltroNegativadorMovimentoReg.ID,
							idNegativadorMovimentoReg));

			filtroNegativadorMovimentoReg.adicionarCaminhoParaCarregamentoEntidade("negativadorRegistroTipo");
			...
			Collection<NegativadorMovimentoReg> collectionNegativadorMovimentoReg = fachada.pesquisar(filtroNegativadorMovimentoReg,
			...
			if(collectionNegativadorMovimentoReg != null){
				...
				negativadorMovimentoReg = (NegativadorMovimentoReg) Util.retonarObjetoDeColecao(collectionNegativadorMovimentoReg);
