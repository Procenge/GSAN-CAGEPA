 ...
 * @created 03/01/2008
 */
public class FiltrarNegativadorResultadoSimulacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// -------------------------------------------------------------------------
		String id = null;
		if(form.getIdComando() != null && !form.getIdComando().equals("-1")){
			id = form.getIdComando();
		}else{
			throw new ActionServletException("atencao.required", null, "Comando");
		}
		...
		if(negativadorResultadoSimulacao != null && negativadorResultadoSimulacao.getNegativacaoComando() != null){
			if(negativadorResultadoSimulacao.getNegativacaoComando().getIndicadorSimulacao() == 2){
				throw new ActionServletException("atencao.comando_nao_corresponde_simulacao");
			}
			...
			if(negativadorResultadoSimulacao.getNegativacaoComando().getDataHoraRealizacao() == null){
				throw new ActionServletException("atencao.simulacao_nao_realizada",
								"exibirFiltrarNegativadorResultadoSimulacaoAction.do?menu=sim", new Exception());
			}
