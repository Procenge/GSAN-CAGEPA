 ...
 * @date 13/12/2007
 */
public class ConcluirInserirComandoNegativacaoPorCriterioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		negativador.setId(Integer.valueOf(form.getIdNegativador()));
		...
		montarPaginaSucesso(httpServletRequest, "Comando Negativação de código " + idNegativadorComando + " inserido com sucesso.",
