 ...
 * @created 24/12/2007
 */
public class RemoverNegativadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, ids.length + " Negativador(es) removido(s) com sucesso.",
							"Realizar outra manutenção de Negativador", "exibirFiltrarNegativadorAction.do?desfazer=S");
		}
