...
public class ExibirManterNegativadorRegistroTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Verifica se o filtro foi informado pela página de filtragem de Negativador Exclusao
		// Motivo
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterNegativadorRegistroTipo"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroNegativadorRegistroTipo, NegativadorRegistroTipo.class
							.getName());
			...
			if(collectionNegativadorRegistroTipo.size() == 1 && identificadorAtualizar != null){
				...
				NegativadorRegistroTipo negativadorRegistroTipo = (NegativadorRegistroTipo) collectionNegativadorRegistroTipo.iterator()
								.next();
