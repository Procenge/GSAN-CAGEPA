 ...
 * @created 08/01/2008
 */
public class AtualizarNegativadorRegistroTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// ------------ REGISTRAR TRANSAÇÃO ----------------
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_ATUALIZAR_NEGATIVADOR_REGISTRO_TIPO,
		...
		filtroNegativadorRegistroTipo.adicionarParametro(new ParametroSimples(FiltroNegativadorRegistroTipo.ID, negativadorRegistroTipo
						.getId()));

		Collection<NegativadorRegistroTipo> collNegativadorRegistroTipo = Fachada.getInstancia().pesquisar(filtroNegativadorRegistroTipo,
		...
		montarPaginaSucesso(httpServletRequest, " Tipo do Registro do Negativador de código " + negativadorRegistroTipo.getId()
						+ " atualizado com sucesso.", "Realizar outra Manutenção do Tipo do Registro do Negativador",
