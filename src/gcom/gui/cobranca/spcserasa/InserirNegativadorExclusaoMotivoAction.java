 ...
 * @date 18/12/2007
 */
public class InserirNegativadorExclusaoMotivoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// ------------ REGISTRAR TRANSAÇÃO ----------------
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_INSERIR_NEGATIVADOR_EXCLUSAO_MOTIVO,
		...
		if(inserirNegativadorExclusaoMotivoActionForm.getIdNegativador() != null
						&& !inserirNegativadorExclusaoMotivoActionForm.getIdNegativador().equals("")){

			Negativador negativador = new Negativador();
			negativador.setId(new Integer(inserirNegativadorExclusaoMotivoActionForm.getIdNegativador()));
		...
		if(inserirNegativadorExclusaoMotivoActionForm.getCodigoMotivo() != null
						&& !inserirNegativadorExclusaoMotivoActionForm.getCodigoMotivo().equals("")){
			...
			filtroNegativadorExclusaoMotivo.adicionarParametro(new ParametroSimples(FiltroNegativadorExclusaoMotivo.CODIGO_EXCLUSAO_MOTIVO,
							codigoExclusaoMotivo));
			filtroNegativadorExclusaoMotivo.adicionarParametro(new ParametroSimples(FiltroNegativadorExclusaoMotivo.NEGATIVADOR_ID,
							negativadorExclusaoMotivo.getNegativador().getId()));
		...
		if(inserirNegativadorExclusaoMotivoActionForm.getDescricaoExclusaoMotivo() != null
						&& !inserirNegativadorExclusaoMotivoActionForm.getDescricaoExclusaoMotivo().equals("")){
		...
		if(inserirNegativadorExclusaoMotivoActionForm.getIdCobrancaDebitoSituacao() != null
						&& !inserirNegativadorExclusaoMotivoActionForm.getIdCobrancaDebitoSituacao().equals("")){

			CobrancaDebitoSituacao cobrancaDebitoSituacao = new CobrancaDebitoSituacao();
			cobrancaDebitoSituacao.setId(new Integer(inserirNegativadorExclusaoMotivoActionForm.getIdCobrancaDebitoSituacao()));
			negativadorExclusaoMotivo.setCobrancaDebitoSituacao(cobrancaDebitoSituacao);

		}else{
			throw new ActionServletException("atencao.required", null, "Cobrança Débito Situação");
		}
		...
		if(negativadorExclusaoMotivo != null){
			...
			idNegativadorExclusaoMotivo = (Integer) fachada.inserir(negativadorExclusaoMotivo);
		}else{
		...
		negativadorExclusaoMotivo.adicionarUsuario(usuario, UsuarioAcao.USUARIO_ACAO_EFETUOU_OPERACAO);
		registradorOperacao.registrarOperacao(negativadorExclusaoMotivo);
		// ------------ REGISTRAR TRANSAÇÃO ----------------

		montarPaginaSucesso(httpServletRequest, "Motivo da Exclusão do Negativador" + idNegativadorExclusaoMotivo
						+ " inserido com sucesso.", "Inserir outro Motivo da Exclusão do Negativador",
						"exibirInserirNegativadorExclusaoMotivoAction.do?menu=sim",
						"exibirAtualizarNegativadorExclusaoMotivoAction.do?idRegistroAtualizacao=" + idNegativadorExclusaoMotivo,
						"Atualizar Motivo da Exclusão do Negativador Inserido");
