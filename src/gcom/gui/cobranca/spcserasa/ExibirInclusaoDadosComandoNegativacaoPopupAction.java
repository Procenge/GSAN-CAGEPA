...
public class ExibirInclusaoDadosComandoNegativacaoPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("idComandoNegativacao") != null){
			...
			idComandoNegativacao = Integer.valueOf(httpServletRequest.getParameter("idComandoNegativacao"));
