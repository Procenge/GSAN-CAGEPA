 ...
 */
public class ExibirConsultarComandoNegativacaoTipoMatriculaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// tela
		Integer totalRegistros = Integer.valueOf(collNegativacaoComando.size());
		...
		collNegativacaoComando = Fachada.getInstancia().pesquisarComandoNegativacaoTipoMatricula(comandoNegativacaoHelper,
