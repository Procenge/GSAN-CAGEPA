 ...
 * @date 26/10/2006
 */
public class ExibirDadosGeracaoConsultaNegativacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirDadosGeracaoConsultaNegativacao");
		...
		DadosConsultaNegativacaoHelper dadosConsultaNegativacaoHelper = (DadosConsultaNegativacaoHelper) sessao
						.getAttribute("dadosConsultaNegativacaoHelper");
		...
		Integer totalQuantidadeInclusoesNeg = Integer.valueOf(0);
		...
		Integer totalQuantidadeInclusoes = Integer.valueOf(0);
		...
		while(itcolecaoResumoNegativacao.hasNext()){
			...
			BigDecimal percentQTD = new BigDecimal((totalQuantidadeInclusoes.doubleValue() * 100)
							/ totalQuantidadeInclusoesNeg.doubleValue());
		...
		// \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
		// Pesquisa os dados do resumo da Negociacao agrupando por idNegociador - Situação da
		// negativacao.
		Collection<NegativacaoHelper> colecaoResumoNegativacaoConfirmadas = fachada.consultarResumoNegativacao(
						dadosConsultaNegativacaoHelper, 3);
		...
		Integer totalQuantidadeInclusoesConfirmadas = Integer.valueOf(0);
		...
		// Pesquisa os dados do resumo da Negociacao agrupando por cobrancaDebitoSituacao
		Collection<NegativacaoHelper> colecaoResumoNegativacaoIncluidasConfirmadas = fachada.consultarResumoNegativacao(
						dadosConsultaNegativacaoHelper, 5);

		Iterator itcolecaoResumoNegativacaoIncluidasConfirmadas = colecaoResumoNegativacaoIncluidasConfirmadas.iterator();
		Integer totalQuantidadeInclusoesIncluidasConfirmadas = Integer.valueOf(0);
		...
		while(itcolecaoResumoNegativacaoIncluidasConfirmadas.hasNext()){
			...
			// Calculo dos Percentuais
			BigDecimal percentQTD = new BigDecimal((totalQuantidadeInclusoesIncluidasConfirmadas.doubleValue() * 100)
							/ totalQuantidadeInclusoesConfirmadas.doubleValue());
			retumoTotaisIncluidasConfirmadas.setPercentualQtd(percentQTD);
			BigDecimal percentValores = new BigDecimal((valorTotalInclusoesIncluidasConfirmadas.doubleValue() * 100)
							/ valorTotalInclusoesConfirmadas.doubleValue());
		...
		// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// R E F E R E N T E A N E G A T I V A C O E S I N C L U I D A S E N A O C O N F I R M A D A
		// S
		// \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
		// Pesquisa os dados do resumo da Negociacao agrupando por idNegociador - Situação da
		// negativacao.
		Collection<NegativacaoHelper> colecaoResumoNegativacaoNaoConfirmadas = fachada.consultarResumoNegativacao(
						dadosConsultaNegativacaoHelper, 4);
		...
		Integer totalQuantidadeInclusoesNaoConfirmadas = Integer.valueOf(0);
		...
		// Pesquisa os dados do resumo da Negociacao agrupando por cobrancaDebitoSituacao
		Collection<NegativacaoHelper> colecaoResumoNegativacaoIncluidasNaoConfirmadas = fachada.consultarResumoNegativacao(
						dadosConsultaNegativacaoHelper, 6);
		Iterator itcolecaoResumoNegativacaoIncluidasNaoConfirmadas = colecaoResumoNegativacaoIncluidasNaoConfirmadas.iterator();
		Integer totalQuantidadeInclusoesIncluidasNaoConfirmadas = Integer.valueOf(0);
		...
		while(itcolecaoResumoNegativacaoIncluidasNaoConfirmadas.hasNext()){
			NegativacaoHelper retumoTotaisIncluidasNaoConfirmadas = (NegativacaoHelper) itcolecaoResumoNegativacaoIncluidasNaoConfirmadas
							.next();
			...
			// Calculo dos Percentuais
			BigDecimal percentQTD = new BigDecimal((totalQuantidadeInclusoesIncluidasNaoConfirmadas.doubleValue() * 100)
							/ totalQuantidadeInclusoesNaoConfirmadas.doubleValue());
			retumoTotaisIncluidasNaoConfirmadas.setPercentualQtd(percentQTD);
			BigDecimal percentValores = new BigDecimal((valorTotalInclusoesIncluidasNaoConfirmadas.doubleValue() * 100)
							/ valorTotalInclusoesNaoConfirmadas.doubleValue());
