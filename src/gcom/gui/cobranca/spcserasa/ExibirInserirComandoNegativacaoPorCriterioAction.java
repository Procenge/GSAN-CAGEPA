 ...
 * @date 06/11/2007
 */
public class ExibirInserirComandoNegativacaoPorCriterioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		StatusWizard statusWizard = new StatusWizard(
						"inserirComandoNegativacaPorCriterioWizardAction",
						"concluirInserirComandoNegativacaoPorCriterioAction",
						"cancelarInserirComandoNegativacaoAction",
						"exibirInserirComandoNegativacaoTipoComandoAction.do?menu=sim",
						"",
						"inserirComandoNegativacaPorCriterioWizardAction.do?action=exibirInserirComandoNegativacaoDadosGeraisAction&menu=sim",
						"");

		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "DadosGeraisPrimeiraAbaA.gif",
						"DadosGeraisPrimeiraAbaD.gif", "exibirInserirComandoNegativacaoDadosGeraisAction",
		...
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "DebitosA.gif", "DebitosD.gif",
						"exibirInserirComandoNegativacaoDadosDebitoAction", "inserirComandoNegativacaoDadosDebitoAction"));
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(3, "ImovelPrimeiraAbaA.gif", "ImovelPrimeiraAbaD.gif",
						"exibirInserirComandoNegativacaoDadosImovelAction", "inserirComandoNegativacaoDadosImovelAction"));
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(4, "LocalizacaoA.gif", "LocalizacaoD.gif",
						"exibirInserirComandoNegativacaoLocalizacaoAction", "inserirComandoNegativacaoLocalizacaoAction"));
