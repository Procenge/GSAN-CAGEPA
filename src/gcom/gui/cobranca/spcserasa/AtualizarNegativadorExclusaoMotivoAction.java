 ...
 * @created 04/01/2008
 */
public class AtualizarNegativadorExclusaoMotivoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// ------------ REGISTRAR TRANSAÇÃO ----------------
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_ATUALIZAR_NEGATIVADOR_EXCLUSAO_MOTIVO,
		...
		if(descricaoExclusaoMotivo != null && !descricaoExclusaoMotivo.equals("")){
			...
			throw new ActionServletException("atencao.required", null, "Descrição Exclusão Motivo");
		}
		...
		if(idCobrancaDebitoSituacao != null && !idCobrancaDebitoSituacao.equals("-1")){
			...
			cobrancaDebitoSituacao.setId(Integer.valueOf(idCobrancaDebitoSituacao));
		...
		filtroNegativadorExclusaoMotivo.adicionarParametro(new ParametroSimples(FiltroNegativadorExclusaoMotivo.ID,
						negativadorExclusaoMotivo.getId()));

		Collection<NegativadorExclusaoMotivo> collNegativadorExclusaoMotivo = Fachada.getInstancia().pesquisar(
		...
		montarPaginaSucesso(httpServletRequest, "negativador Exclusao Motivo de código " + negativadorExclusaoMotivo.getId()
						+ " atualizado com sucesso.", "Realizar outra Manutenção de Negativador Exclusao Motivo",
