 ...
 * @since 08/05/2006
 */
public class FiltrarComandosAcaoCobrancaCronogramaActionForm
				extends ActionForm {
	...
	/**
	 * @param periodoReferenciaCobrancaFinal
	 *            O periodoReferenciaCobrancaFinal a ser setado.
	 */
	...
	/**
	 * @param periodoReferenciaCobrancaInicial
	 *            O periodoReferenciaCobrancaInicial a ser setado.
	 */
	...
	/**
	 * @param periodoPrevisaoComandoFinal
	 *            O periodoPrevisaoComandoFinal a ser setado.
	 */
	...
	/**
	 * @param periodoPrevisaoComandoInicial
	 *            O periodoPrevisaoComandoInicial a ser setado.
	 */
	public void setPeriodoPrevisaoComandoInicial(String periodoPrevisaoComandoInicial){
	...
	/**
	 * @param intervalorValorDocumentosFinal
	 *            O intervalorValorDocumentosFinal a ser setado.
	 */
	public void setIntervaloQuantidadeDocumentosFinal(String intervalorValorDocumentosFinal){
	...
	/**
	 * @param intervalorValorDocumentosInicial
	 *            O intervalorValorDocumentosInicial a ser setado.
	 */
	public void setIntervaloQuantidadeDocumentosInicial(String intervalorValorDocumentosInicial){
	...
	/**
	 * @param situacaoCronograma
	 *            O situacaoCronograma a ser setado.
	 */
