 ...
 * @since 19/04/2006
 */
public class PesquisarResolucaoDiretoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("pesquisarResolucaoDiretoriaAction");
		...
		if(collectionResolucaoDiretoria == null || collectionResolucaoDiretoria.isEmpty()){
			...
			throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, "resolução de diretoria");
		} /*
		 * else if (collectionResolucaoDiretoria.size() >
		...
		if(DataInicioVigencia != null && DataFimVigencia != null){
			if(!DataInicioVigencia.equals("") && !DataFimVigencia.equals("")){
				...
				if(DataInicioVigencia.after(DataFimVigencia) || Util.datasIguais(DataInicioVigencia, DataFimVigencia)){
					...
					throw new ActionServletException("atencao.termino_maior_inicio_vigencia");
				}
