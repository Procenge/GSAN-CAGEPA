 ...
 * @since 08/03/2006
 */
public class ExibirPesquisarComandoAcaoCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirPesquisarComandoAcaoCobrancaAction");
		...
		if(httpServletRequest.getParameter("limparForm") != null){
			...
			pesquisarComandoAcaoCobrancaActionForm.setCobrancaAtividade(null);
			pesquisarComandoAcaoCobrancaActionForm.setCobrancaAcao(null);
			pesquisarComandoAcaoCobrancaActionForm.setPeriodoExecucaoComandoInicial(null);
			pesquisarComandoAcaoCobrancaActionForm.setPeriodoExecucaoComandoFinal(null);
			pesquisarComandoAcaoCobrancaActionForm.setPeriodoGeracaoComandoInicial(null);
			pesquisarComandoAcaoCobrancaActionForm.setPeriodoGeracaoComandoFinal(null);
			pesquisarComandoAcaoCobrancaActionForm.setUsuario(null);
			pesquisarComandoAcaoCobrancaActionForm.setIdUsuario(null);
			pesquisarComandoAcaoCobrancaActionForm.setTituloComando(null);
			pesquisarComandoAcaoCobrancaActionForm.setTipoPesquisa(null);

			// pesquisarComandoAcaoCobrancaActionForm.setLimparFormulario("");
		}
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null && !httpServletRequest.getParameter("tipoConsulta").equals("")){
			...
			pesquisarComandoAcaoCobrancaActionForm.setIdUsuario(httpServletRequest.getParameter("idCampoEnviarDados"));
			pesquisarComandoAcaoCobrancaActionForm.setUsuario(httpServletRequest.getParameter("descricaoCampoEnviarDados"));
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaAcaoCobranca") != null
						&& !httpServletRequest.getParameter("caminhoRetornoTelaPesquisaAcaoCobranca").equals("")){
		...
		if(httpServletRequest.getParameter("acaoCobrancaSelecionada") != null
						&& !httpServletRequest.getParameter("acaoCobrancaSelecionada").equals("")){
			sessao.setAttribute("acaoCobrancaSelecionada", httpServletRequest.getParameter("acaoCobrancaSelecionada"));
		}
