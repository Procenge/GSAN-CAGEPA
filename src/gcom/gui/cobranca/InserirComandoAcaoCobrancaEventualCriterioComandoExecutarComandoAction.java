 ...
 * @since 24/01/2006
 */
public class InserirComandoAcaoCobrancaEventualCriterioComandoExecutarComandoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("inserirComandoAcaoCobrancaEventualCriterioComandoActionForm") != null){
			inserirComandoAcaoCobrancaEventualCriterioComandoActionForm = (InserirComandoAcaoCobrancaEventualCriterioComandoActionForm) sessao
		...
		/*
		 * Collection colecaoCobrancaAcaoAtividadeComando =fachada.executarComandoAcaoCobranca(
		 * inserirComandoAcaoCobrancaEventualCriterioComandoActionForm
		 * .getPeriodoInicialConta(),inserirComandoAcaoCobrancaEventualCriterioComandoActionForm
		 ...
		 * idComando, this.getUsuarioLogado(httpServletRequest),
		...
		// fachada.consultarCobrancaAtividade(inserirComandoAcaoCobrancaEventualCriterioComandoActionForm.getCobrancaAtividade());
