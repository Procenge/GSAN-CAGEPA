 ...
 * @date 01/09/2008
 */
public class ExibirManterComandoAcaoCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirManterComandoAcaoCobranca");
		...
		if((colecaoAtividadesEventuaisAcaoCobrancaComandadas == null || colecaoAtividadesEventuaisAcaoCobrancaComandadas.isEmpty())
						&& (colecaoAtividadeCronogramaAcaoCobrancaComandadas == null || colecaoAtividadeCronogramaAcaoCobrancaComandadas
										.isEmpty())){
			throw new ActionServletException("atencao.nao.atividade.cobranca.comandadas");
		}
