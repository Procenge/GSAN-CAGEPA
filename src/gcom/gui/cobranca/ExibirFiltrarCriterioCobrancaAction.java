 ...
 * @date 17/04/2006
 */
public class ExibirFiltrarCriterioCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("filtrarCriterioCobranca");
		...
		if(limpar != null && !limpar.equals("")){
			...
			criterioCobrancaFiltrarActionForm.setOpcaoAcaoImovelDebitoContasAntigas("");
			criterioCobrancaFiltrarActionForm.setOpcaoAcaoImovelDebitoMesConta("");
