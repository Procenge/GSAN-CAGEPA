 ...
 * Execuar o Comando, qdo o usuário clica no botão para executar estando na tela de
 * comandar_acao_cobranca_eventual_inserir_processo2.jsp
 * 
 * @author Rafael Santos
 * @since 24/01/2006
 */
public class InserirComandoAcaoCobrancaEventualExecutarComandoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		 ...
		 * 
		 * fachada.executarComandoAcaoCobranca(inserirComandoAcaoCobrancaEventualCriterioRotaActionForm
		 * .getPeriodoInicialConta(),inserirComandoAcaoCobrancaEventualCriterioRotaActionForm.
		 ...
		 * 
		 * fachada.consultarCobrancaAtividade(inserirComandoAcaoCobrancaEventualCriterioRotaActionForm
