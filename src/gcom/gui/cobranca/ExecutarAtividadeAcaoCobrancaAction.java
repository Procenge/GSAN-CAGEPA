 ...
 */
public class ExecutarAtividadeAcaoCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// verifica se o usuário selecionou alguma atividade de ação de cobrança na página para
		// executar
		...
		fachada.executarAcaoAtividadeCobranca(idsAtividadesCobrancaCronograma, idsAtividadesCobrancaEventuais, usuarioLogado);

		// monta a página de sucesso
		montarPaginaSucesso(httpServletRequest, "Atividade(s) de ação de cobrança executada(s) com sucesso.",
						"Executar outra(s) atividade(s) de ação de cobrança", "exibirExecutarAtividadeAcaoCobrancaAction.do");
