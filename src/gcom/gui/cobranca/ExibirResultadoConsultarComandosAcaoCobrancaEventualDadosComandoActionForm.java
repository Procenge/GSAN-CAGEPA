 ...
 * @since 11/05/2006
 */
public class ExibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoActionForm
				extends ActionForm {
	...
	private String programaCobranca;
	...
	/**
	 * @param criterioUtilizado
	 *            O criterioUtilizado a ser setado.
	 */
	 ...
	 *            O quantidadeDocumentos a ser setado.
	 */
	...
	/**
	 * @param quantidedeItensDocumentos
	 *            O quantidedeItensDocumentos a ser setado.
	 */
	...
	/**
	 * @param valorDocumentos
	 *            O valorDocumentos a ser setado.
	 */
	 ...
	 *            O idCobrancaAcaoAtividadeComando a ser setado.
	 */
	...
	public String getProgramaCobranca(){

		return programaCobranca;
	}

	public void setProgramaCobranca(String programaCobranca){
	...
	public void limpar(){
		...
		localidadeInicial = "";
		localidadeFinal = "";
		descricaoLocalidadeFinal = "";
		descricaoLocalidadeInicial = "";
		setorComercialInicial = "";
		descricaoSetorComercialInicial = "";
		setorComercialFinal = "";
		descricaoSetorComercialFinal = "";
		quadraInicial = "";
		quadraFinal = "";
		rotaInicial = "";
		rotaFinal = "";
		...
		horaRealizacao = "";
		dataRealizacao = "";
		periodoReferenciaContasInicial = "";
		periodoReferenciaContasFinal = "";
		periodoVencimentoContasInicial = "";
		periodoVencimentoContasFinal = "";
		valorDocumentos = "";
		quantidadeDocumentos = "";
		quantidadeItensDocumentos = "";
		situacaoComando = "";
