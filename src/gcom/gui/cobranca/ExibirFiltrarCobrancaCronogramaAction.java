...
public class ExibirFiltrarCobrancaCronogramaAction
				extends GcomAction {

	/**
	 * Action responsável pela exibição da tela de filtragem dos Cronogramas de Cobrança
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarCobrancaCronograma");
		...
		if(colecaoCobrancaGrupo.isEmpty()){
			throw new ActionServletException("atencao.naocadastrado", null, "grupo de cobranca");
		}else{
