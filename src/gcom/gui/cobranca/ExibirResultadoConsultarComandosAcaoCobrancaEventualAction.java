 ...
 * @since 10/05/2006
 */
public class ExibirResultadoConsultarComandosAcaoCobrancaEventualAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroCobrancaAcaoAtividadeComando") != null){
			filtroCobrancaAcaoAtividadeComando = (FiltroCobrancaAcaoAtividadeComando) sessao
							.getAttribute("filtroCobrancaAcaoAtividadeComando");
			...
			if(colecaoCobrancaAcaoAtividadeComando == null || colecaoCobrancaAcaoAtividadeComando.isEmpty()){
				throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, "Comando Ação de Cobrança - Eventual");
			}
