 ...
 */
public class FiltrarComandosAcaoCobrancaEventualAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroCobrancaAcaoAtividadeComando filtroCobrancaAcaoAtividadeComando = fachada.construirFiltroCobrancaAcaoAtividadeEventual(
						filtrarComandosAcaoCobrancaEventualActionForm.getGrupoCobranca(), filtrarComandosAcaoCobrancaEventualActionForm
										.getAcaoCobranca(), filtrarComandosAcaoCobrancaEventualActionForm.getAtividadeCobranca(),
						...
						filtrarComandosAcaoCobrancaEventualActionForm.getSituacaoComando(), filtrarComandosAcaoCobrancaEventualActionForm
										.getIndicadorCriterio(), filtrarComandosAcaoCobrancaEventualActionForm.getGerenciaRegional(),
						...
						filtrarComandosAcaoCobrancaEventualActionForm.getQuadraInicial(),
						filtrarComandosAcaoCobrancaEventualActionForm.getQuadraFinal(),
						filtrarComandosAcaoCobrancaEventualActionForm.getRotaInicial(), filtrarComandosAcaoCobrancaEventualActionForm
										.getRotaFinal(), filtrarComandosAcaoCobrancaEventualActionForm.getIdCliente(),
						filtrarComandosAcaoCobrancaEventualActionForm.getClienteRelacaoTipo(),
						filtrarComandosAcaoCobrancaEventualActionForm.getCriterioCobranca(), filtrarComandosAcaoCobrancaEventualActionForm
										.getUnidadeNegocio());

		sessao.setAttribute("filtroCobrancaAcaoAtividadeComando", filtroCobrancaAcaoAtividadeComando);
