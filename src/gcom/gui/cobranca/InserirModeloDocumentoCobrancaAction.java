...
public class InserirModeloDocumentoCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(form.getDescricaoCI() != null){
			...
			documentoTipoLayout.setDescricaoCIControleDocumento("");
		}

		DocumentoTipo documentoTipo = new DocumentoTipo();
		documentoTipo.setId(Integer.valueOf(form.getDocumentoTipoId()));
		...
		Integer idModeloDocumentoCobranca = (Integer) fachada.inserirDocumentoTipoLayout(documentoTipoLayout,
						colecaoDocumentoLayoutAssinatura, usuarioLogado);

		montarPaginaSucesso(httpServletRequest, "Modelo do Documento de Cobrança " + idModeloDocumentoCobranca + " inserido com sucesso.",
						"Inserir outro Modelo do Documento de Cobrança", "exibirInserirModeloDocumentoCobrancaAction.do",
						"exibirAtualizarModeloDocumentoCobrancaAction.do?idDocumentoLayout=" + idModeloDocumentoCobranca + "&desfazer=S",
						"Atualizar Modelo do Documento de Cobrança inserido");
