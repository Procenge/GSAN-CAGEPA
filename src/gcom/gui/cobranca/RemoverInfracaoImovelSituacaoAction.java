...
public class RemoverInfracaoImovelSituacaoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, idQt.toString() + " Infração Imovel Situação(oes) removida(s) com sucesso.",
							"Realizar outra manutenção de Infracao Imovel Situação",
