...
/**
 * Action form responsável pelas propiedades do caso de uso de pesquisar as
 * ações de cobrança.
 * 
...
public class PesquisarAcaoCobrancaActionForm
	...
	private String idCobrancaEstagio;
	...
	/**
	 * @return the idTipoDocumentoGerado
	 */
	...
	/**
	 * @param idTipoDocumentoGerado
	 *            the idTipoDocumentoGerado to set
	 */
	...
	/**
	 * @return the descricaoServicoTipo
	 */
	 ...
	 *            the descricaoServicoTipo to set
	 */
	...
	/**
	 * @return the idCobrancaEstagio
	 */
	public String getIdCobrancaEstagio(){

		return idCobrancaEstagio;
	}

	/**
	 * @param idCobrancaEstagio
	 *            the idCobrancaEstagio to set
	 */
	public void setIdCobrancaEstagio(String idCobrancaEstagio){

		this.idCobrancaEstagio = idCobrancaEstagio;
	}
