 ...
 */
public class InserirAtividadeCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_INSERIR_ATIVIDADE_COBRANCA,
		...
		montarPaginaSucesso(httpServletRequest, "Atividade de Cobranca " + id + " inserida com sucesso.",
						"Inserir outra Atividade de Cobranca", "exibirInserirAtividadeCobrancaAction.do?menu=sim",
						"exibirAtualizarAtividadeCobrancaAction.do?idRegistroAtualizar=" + id, "Atualizar Atividade de Cobranca Inserida");
