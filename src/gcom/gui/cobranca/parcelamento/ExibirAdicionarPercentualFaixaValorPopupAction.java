...
public class ExibirAdicionarPercentualFaixaValorPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("primeiraVez") != null && httpServletRequest.getParameter("primeiraVez").equals("S")){
