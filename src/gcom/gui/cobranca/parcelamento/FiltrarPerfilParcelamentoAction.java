 ...
 * @created 11/05/2006
 */
public class FiltrarPerfilParcelamentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(idResolucaoDiretoria != null && !idResolucaoDiretoria.equalsIgnoreCase("")){
		...
		if(idImovelSituacaoTipo != null && !idImovelSituacaoTipo.equalsIgnoreCase("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
		...
		if(idImovelPerfil != null && !idImovelPerfil.equalsIgnoreCase("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
			filtroParcelamentoPerfil.adicionarCaminhoParaCarregamentoEntidade("imovelPerfil");
			filtroParcelamentoPerfil.adicionarParametro(new ParametroSimples(FiltroParcelamentoPerfil.IMOVEL_PERFIL_ID, idImovelPerfil));
			peloMenosUmParametroInformado = true;

		}

		if(idSubcategoria != null && !idSubcategoria.equalsIgnoreCase("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
