...
public class ExibirManterPerfilParcelamentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("filtroParcelamentoPerfil") != null){
			filtroParcelamentoPerfil = (FiltroParcelamentoPerfil) sessao.getAttribute("filtroParcelamentoPerfil");
		}
		...
		if((retorno != null) && (retorno.getName().equalsIgnoreCase("manterPerfilParcelamento"))){
			...
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroParcelamentoPerfil, ParcelamentoPerfil.class.getName());
