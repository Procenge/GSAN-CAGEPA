 ...
 */
public class ExibirValorAtualizacaoConsultarPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirValorAtualizacaoConsultarPopup");
		...
		if(multa != null){
			if(Util.verificaSeBigDecimal(multa)){
				...
				valorAtualizacaoConsultarActionForm.setMulta(Util.formatarMoedaReal(new BigDecimal(multa)));
			}
		}
		if(juros != null){
			if(Util.verificaSeBigDecimal(juros)){
				...
				valorAtualizacaoConsultarActionForm.setJuros(Util.formatarMoedaReal(new BigDecimal(juros)));
			}
		...
		if(atualizacao != null){
			if(Util.verificaSeBigDecimal(atualizacao)){
				...
				valorAtualizacaoConsultarActionForm.setAtualizacao(Util.formatarMoedaReal(new BigDecimal(atualizacao)));
			}
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaConsultaAcrescimos") != null){
			sessao.setAttribute("caminhoRetornoTelaConsultaAcrescimos", httpServletRequest
