 ...
 * @since 02/03/2006
 */
public class ExibirInserirCriterioCobrancaLinhaConsultarPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirInserirCriterioCobrancaLinhaConsultarPopupAction");
		...
		if(idCriterioCobranca != null && !idCriterioCobranca.equals("")){
			...
			if(colecaoCobrancaCriterio != null && !colecaoCobrancaCriterio.isEmpty()){
				...
				inserirCriterioCobrancaLinhaConsultarPopupActionForm.setDescricaoCobrancaCriterio(cobrancaCriterio
			...
			filtroCobrancaCriterioLinha.setCampoOrderBy(FiltroCobrancaCriterioLinha.ID_IMOVEL_PERFIL,
			...
			if(colecaoCobrancaCriterioLinha == null || colecaoCobrancaCriterioLinha.isEmpty()){
				throw new ActionServletException("atencao.pesquisa.nenhum_registro_tabela", null, "Tabela Cobrança Critério Linha");
			}
