...
public class ExibirConsultarParametrosComandoNegativacaoPopupAction
				extends GcomAction {
	...
	private ConsultarParametrosComandoNegativacaoActionForm setFormDadosGerais(ConsultarParametrosComandoNegativacaoActionForm form,
		...
		if(parametrosComandoNegativacaoHelper.getQtdInclusoes() != null && !parametrosComandoNegativacaoHelper.getQtdInclusoes().equals("")){
