 ...
 * @date 17/04/2006
 */
public class GerarMovimentoCobrancaBancariaBancoActionForm
				extends ValidatorActionForm {

	private static final long serialVersionUID = 1L;

	private String opcaoMovimentoCobrancaBancaria;
	...
	public String getOpcaoMovimentoCobrancaBancaria(){

		return opcaoMovimentoCobrancaBancaria;
	}

	public void setOpcaoMovimentoCobrancaBancaria(String opcaoMovimentoCobrancaBancaria){

		this.opcaoMovimentoCobrancaBancaria = opcaoMovimentoCobrancaBancaria;
	}
	...
	public void reset(ActionMapping actionMapping, HttpServletRequest httpServletRequest){
		...
		opcaoMovimentoCobrancaBancaria = null;
		idGrupoFaturamento = "";
