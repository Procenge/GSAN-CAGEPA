 ...
 *       Não utilizar campos periodoInicialConta, periodoFinalConta, periodoVencimentoContaInicial,
 *       periodoVencimentoContaFinal.
 */
public class ExibirInserirComandoAcaoCobrancaEventualCriterioComandoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirInserirComandoAcaoCobrancaEventualCriterioComando");
		...
		/*
		 * if( (anoMesContaInicial != null && !anoMesContaInicial.equals("")) && (anoMesContaFinal
		 * != null && !anoMesContaFinal.equals("")) ){
		 ...
		 * throw new ActionServletException(//Referência Final do Período é anterior à Referência
		 * Inicial do Período
		 ...
		 * periodoFinal.set(Calendar.YEAR,new Integer(anoFinal).intValue());
		 * if(periodoInicial.compareTo(periodoFinal) > 0){
		 * throw new ActionServletException(//Data Final do Período é anterior à Data Inicial do
		 * Período
		...
		if(idCobrancaAcao != null && !idCobrancaAcao.equals("")){
			...
			if(colecaoCobrancaAcao != null && !colecaoCobrancaAcao.isEmpty()){
				...
				inserirComandoAcaoCobrancaEventualCriterioComandoActionForm.setDescricaoAcaoCobranca(cobrancaAcao
								.getDescricaoCobrancaAcao());
			}

			FiltroCobrancaCriterio filtroCobrancaCriterio = new FiltroCobrancaCriterio();
			// filtroCobrancaCriterio.adicionarParametro(new
			// ParametroSimples(FiltroCobrancaCriterio.ID_COBRANCA_ACAO,idCobrancaAcao));
			...
			if(colecaoCriterioCobranca == null || colecaoCriterioCobranca.isEmpty()){
				throw new ActionServletException("atencao.pesquisa.nenhum_registro_tabela", null, "Tabela Cobrança Critério");
			}
		...
		if(sessao.getAttribute("inserirComandoAcaoCobrancaEventualCriterioComandoActionForm") == null) sessao.setAttribute(
