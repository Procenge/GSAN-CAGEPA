 ...
 * @since 24/03/2006
 */
public class ExcluirComandoAtividadeCronogramaAcaoCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, idsCobrancaAcaoAtividadeCronograma.length
						+ " Comando(s) de Ação de Cobrança removidos com sucesso", "Manter outro Comando de Ação de Cobrança",
