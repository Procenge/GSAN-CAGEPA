 ...
 * @date 13/09/2007
 */
public class RemoverAcaoCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		fachada.removerAcaoCobranca(selecaoCobrancaAcao, usuario);

		sessao.removeAttribute("colecaoCobrancaAcao");

		montarPaginaSucesso(httpServletRequest, selecaoCobrancaAcao.length + " Ações de Cobrança removida(s) com sucesso.",
						"Realizar outra manutenção de Ação de Cobrança", "exibirFiltrarAcaoCobrancaAction.do?menu=sim");
