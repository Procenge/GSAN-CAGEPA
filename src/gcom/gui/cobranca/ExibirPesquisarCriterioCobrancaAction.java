 ...
 */
public class ExibirPesquisarCriterioCobrancaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirPesquisarCriterioCobrancaAction");
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaCriterioCobranca") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaCriterioCobranca", httpServletRequest
