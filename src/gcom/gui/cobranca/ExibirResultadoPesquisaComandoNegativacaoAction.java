...
public class ExibirResultadoPesquisaComandoNegativacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(comandoNegativacaoHelper != null){
			...
			sessao.setAttribute("numeroPaginasPesquisaPrimeiraPaginacao", httpServletRequest
							.getAttribute("numeroPaginasPesquisaPrimeiraPaginacao"));
