 ...
 * @date 31/03/2014
 */
public class ExibirFiltrarImoveisComDebitosPrescritosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirFiltrarImoveisComDebitosPrescritos");

		FiltrarImoveisComDebitosPrescritosActionForm form = (FiltrarImoveisComDebitosPrescritosActionForm) actionForm;
		Fachada fachada = Fachada.getInstancia();
		HttpSession sessao = httpServletRequest.getSession(false);

		// Atribui a Situação da Marcação do Débito Prescrito o valor padrão
		if(form.getIndicadorSituacaoDebitoPrescrito() == null){

			form.setIndicadorSituacaoDebitoPrescrito(ConstantesSistema.TODOS.toString());
		}
		...
		// Pesquisar Comando
		if(!Util.isVazioOuBranco(objetoConsulta) && (objetoConsulta.trim().equals("13"))){

			this.pesquisarComandoPrescricao(form, fachada, httpServletRequest);
		}

		// Pesquisar Imóvel
		if(!Util.isVazioOuBranco(objetoConsulta) && (objetoConsulta.trim().equals("12"))){
	...
	private void pesquisarImovel(FiltrarImoveisComDebitosPrescritosActionForm form, Fachada fachada, HttpServletRequest httpServletRequest){
	...
	private void pesquisarComandoPrescricao(FiltrarImoveisComDebitosPrescritosActionForm form, Fachada fachada,
		 ...
		 * PRESCRICAO_COMANDO)
		 */
		PrescricaoComando prescricaoComando = (PrescricaoComando) fachada.pesquisar(Util.obterInteger(form.getIdPrescricaoComando()),
						PrescricaoComando.class);

		if(prescricaoComando != null && prescricaoComando.getIndicadorSimulacao().equals(ConstantesSistema.NAO)
						&& prescricaoComando.getDataRealizacao() != null){

			form.setTituloPrescricaoComando(prescricaoComando.getTitulo());
			form.setIdPrescricaoComando(prescricaoComando.getId().toString());
		}else{

			form.setTituloPrescricaoComando("Comando inexistente");
			form.setIdPrescricaoComando(null);
		}
	 ...
	 * @date 31/03/2014
	 */
	private void pesquisarLocalidade(FiltrarImoveisComDebitosPrescritosActionForm form, String objetoConsulta){
	 ...
	 * @date 31/03/2014
	 */
	private void pesquisarLocalidadeElo(FiltrarImoveisComDebitosPrescritosActionForm form, String objetoConsulta){
	 ...
	 * @date 31/03/2014
	 */
	private void pesquisarSetorComercial(FiltrarImoveisComDebitosPrescritosActionForm form, String objetoConsulta){
	 ...
	 * @date 31/03/2014
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, FiltrarImoveisComDebitosPrescritosActionForm form){
		...
		// Comando
		if(!Util.isVazioOuBranco(form.getIdPrescricaoComando()) && !Util.isVazioOuBranco(form.getTituloPrescricaoComando())){

			httpServletRequest.setAttribute("comandoEncontrado", "true");
		}
	 ...
	 * @date 31/03/2014
	 */
	private void pesquisarQuadra(FiltrarImoveisComDebitosPrescritosActionForm form, String objetoConsulta,
					HttpServletRequest httpServletRequest){
	 ...
	 * @date 14/02/2014
	 */
	private void pesquisarCliente(FiltrarImoveisComDebitosPrescritosActionForm form, String objetoConsulta){
	 ...
	 * @date 31/03/2014
	 */
	private void pesquisarSubCategoria(HttpServletRequest httpServletRequest, FiltrarImoveisComDebitosPrescritosActionForm form){
