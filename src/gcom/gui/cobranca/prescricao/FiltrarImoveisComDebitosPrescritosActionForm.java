 ...
 * @date 31/03/2014
 */
public class FiltrarImoveisComDebitosPrescritosActionForm
				extends ValidatorActionForm {

	private static final long serialVersionUID = 1L;

	private String idPrescricaoComando;

	private String tituloPrescricaoComando;

	private String indicadorSituacaoDebitoPrescrito;
	...
	public String getIndicadorSituacaoDebitoPrescrito(){

		return indicadorSituacaoDebitoPrescrito;
	}

	public void setIndicadorSituacaoDebitoPrescrito(String indicadorSituacaoDebitoPrescrito){

		this.indicadorSituacaoDebitoPrescrito = indicadorSituacaoDebitoPrescrito;
	}
	...
	/**
	 * @return the idPrescricaoComando
	 */
	public String getIdPrescricaoComando(){

		return idPrescricaoComando;
	}

	/**
	 * @param idPrescricaoComando
	 *            the idPrescricaoComando to set
	 */
	public void setIdPrescricaoComando(String idPrescricaoComando){

		this.idPrescricaoComando = idPrescricaoComando;
	}

	/**
	 * @return the tituloPrescricaoComando
	 */
	public String getTituloPrescricaoComando(){

		return tituloPrescricaoComando;
	}

	/**
	 * @param tituloPrescricaoComando
	 *            the tituloPrescricaoComando to set
	 */
	public void setTituloPrescricaoComando(String tituloPrescricaoComando){

		this.tituloPrescricaoComando = tituloPrescricaoComando;
	}
