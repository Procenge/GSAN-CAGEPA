...
public class InserirAcaoCobrancaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, "Ação de Cobrança " + acaoCobrancaActionForm.getDescricaoAcao() + " inserida com sucesso.",
						"Inserir outra Ação de Cobrança", "exibirInserirAcaoCobrancaAction.do?menu=sim",
