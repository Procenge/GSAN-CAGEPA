 ...
 * @since 19/04/2006
 */
public class ExibirPesquisarResolucaoDiretoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirPesquisarResolucaoDiretoria");
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaResolucaoDiretoria") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaUsuario", httpServletRequest
