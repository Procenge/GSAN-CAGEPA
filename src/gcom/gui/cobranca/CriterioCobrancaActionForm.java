 ...
 * @date 29/05/2006
 */
public class CriterioCobrancaActionForm
	...
	// private String stLigacaoAguaID;

	// private String stLigacaoEsgotoID;

	private String diasParaVencimento;
	...
	private String qtdDiasVencMaxima;

	private String qtdDiasCortado;

	private String indicadorConsiderarApenasDebitoTitularAtual;

	private String idClienteRelacaoTipo;

	public String getQtdDiasVencMinima(){

		return qtdDiasVencMinima;
	}

	public void setQtdDiasVencMinima(String qtdDiasVencMinima){

		this.qtdDiasVencMinima = qtdDiasVencMinima;
	}

	public String getQtdDiasVencMaxima(){

		return qtdDiasVencMaxima;
	}

	public void setQtdDiasVencMaxima(String qtdDiasVencMaxima){

		this.qtdDiasVencMaxima = qtdDiasVencMaxima;
	}
	...
	public void setOpcaoAcaoImovelDebitoMesConta(String opcaoAcaoImovelDebitoMesConta){
	...
	public void setOpcaoAcaoInquilinoDebitoMesConta(String opcaoAcaoInquilinoDebitoMesConta){
	...
	public void setOpcaoAcaoImovelDebitoContasAntigas(String opcaoAcaoImovelDebitoContasAntigas){
	...
	public void setPercentualQuantidadeMinimoPagoParceladoCancelado(String percentualQuantidadeMinimoPagoParceladoCancelado){
	...
	public void setPercentualValorMinimoPagoParceladoCancelado(String percentualValorMinimoPagoParceladoCancelado){
	...
	public void setQuantidadeMinimaParcelasAtraso(String quantidadeMinimaParcelasAtraso){
	...
	/*
	 * public String getStLigacaoAguaID() {
	 * return stLigacaoAguaID;
	 * }
	 * public void setStLigacaoAguaID(String stLigacaoAguaID) {
	 * this.stLigacaoAguaID = stLigacaoAguaID;
	 * }
	 * public String getStLigacaoEsgotoID() {
	 * return stLigacaoEsgotoID;
	 * }
	 * public void setStLigacaoEsgotoID(String stLigacaoEsgotoID) {
	 * this.stLigacaoEsgotoID = stLigacaoEsgotoID;
	 * }
	 */

	public String getDiasParaVencimento(){

		return diasParaVencimento;
	}

	public void setDiasParaVencimento(String diasParaVencimento){
	...
	public String getComCpf(){

		return comCpf;
	}

	public void setComCpf(String comCpf){

		this.comCpf = comCpf;
	}

	public String getComTelefone(){

		return comTelefone;
	}

	public void setComTelefone(String comTelefone){
	...
	public void setQtdDiasCortado(String qtdDiasCortado){

		this.qtdDiasCortado = qtdDiasCortado;
	}
