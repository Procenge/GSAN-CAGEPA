...
/**
 * Action responsável por exibir o popup de adicionar tabela no inserir operação e atualizar
 * operação
 * 
 * @author Pedro Alexandre
 * @date 05/05/2006
 */
public class ExibirAdicionarOperacaoTabelaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(limpaForm != null && limpaForm.equalsIgnoreCase("true")){
			...
			if(idTabela != null && !idTabela.equals("")){
				...
				if(colecaoTabela != null && !colecaoTabela.isEmpty()){
					...
					adicionarOperacaoTabelaActionForm.setDescricaoTabela(tabela.getDescricaoTabela());
		...
		// Seta a flag para indicar queo popupvai ser fechado
