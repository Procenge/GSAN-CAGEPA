 ...
 * @date 24/02/2006
 */
public class EfetuarAlteracaoSenhaPorMatriculaAction
				extends GcomAction {
		...
		if(form.getLogin() != null){
			...
			if(!colecaoUsuario.isEmpty()){
				...
				try{
					...
					// form.getDataNascimento().trim().equals(Util.formatarData(usuario.getDataNascimento()))){
				...
				throw new ActionServletException("atencao.login_nao_existente", null, "" + form.getLogin() + "");
			}
		}

		// montando página de sucesso
		montarPaginaSucesso(httpServletRequest, "Senha padrão para o login: " + form.getLogin() + " gerada com sucesso.",
