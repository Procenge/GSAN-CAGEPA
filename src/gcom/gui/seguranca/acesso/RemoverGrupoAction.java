 ...
 * @date 29/06/2006
 */
public class RemoverGrupoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(idsRegistrosRemocao == null || idsRegistrosRemocao.length < 1){
			...
			fachada.removerGrupo(idsRegistrosRemocao);
		}

		// Monta a página de sucesso
		montarPaginaSucesso(httpServletRequest, idsRegistrosRemocao.length + " Grupo(s) removido(s) com sucesso.",
						"Realizar outra manutenção de grupo", "exibirManterGrupoAction.do?menu=sim");
