 ...
 */
public class ExibirPesquisarUnidadeEmpresaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(colecaoUnidadesNiveis != null && !colecaoUnidadesNiveis.isEmpty()){
			...
			throw new ActionServletException("atencao.naocadastrado", null, "Unidade Nível");
		}
		...
		if(idUnidadeSuperior != null && !idUnidadeSuperior.equals("")){
			...
			Collection colecaoUnidadeSuperior = fachada.pesquisar(filtroUnidadeEmpresa, UnidadeOrganizacional.class.getName());
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaUnidadeEmpresa") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaUnidadeEmpresa", httpServletRequest
