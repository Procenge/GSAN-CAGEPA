 ...
 * @date 26/06/2006
 */
public class ExibirManterGrupoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroGrupo, Grupo.class.getName());
		colecaoGrupo = (Collection) resultado.get("colecaoRetorno");
		retorno = (ActionForward) resultado.get("destinoActionForward");

		// Collection coll = fachada.pesquisar(new FiltroGrupo(), Grupo.class.getName());
