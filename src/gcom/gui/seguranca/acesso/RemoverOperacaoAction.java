 ...
 * @date 02/08/2006
 */
public class RemoverOperacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		montarPaginaSucesso(httpServletRequest, idsRegistrosRemocao.length + " Operação(ões) excluída(s) com sucesso.",
						"Manter outra Operação", "exibirFiltrarOperacaoAction.do?menu=sim");
