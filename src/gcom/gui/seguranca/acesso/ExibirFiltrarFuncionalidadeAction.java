...
public class ExibirFiltrarFuncionalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("funcionalidadeFiltrar");
		...
		if(httpServletRequest.getParameter("limpar") != null){
			filtrarfuncionalidadeActionForm.setApenasFuncionalidade(null);
		}
