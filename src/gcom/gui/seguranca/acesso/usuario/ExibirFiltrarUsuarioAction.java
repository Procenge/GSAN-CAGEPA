...
public class ExibirFiltrarUsuarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(primeiraVez != null && !primeiraVez.equals("")){
			...
			Collection colecaoUsuarioTipo = Fachada.getInstancia().pesquisar(filtroUsuarioTipo, UsuarioTipo.class.getName());
			...
			filtroUsuarioAbrangencia.adicionarParametro(new ParametroSimples(FiltroUsuarioAbrangencia.INDICADOR_USO,
							ConstantesSistema.INDICADOR_USO_ATIVO));

			Collection colecaoUsuarioAbrangencia = Fachada.getInstancia().pesquisar(filtroUsuarioAbrangencia,
			...
			Collection colecaoUsuarioSituacao = Fachada.getInstancia().pesquisar(new FiltroUsuarioSituacao(),
		...
		if(form.getIdLotacao() != null && !form.getIdLotacao().equals("")){
			...
			Collection colecaoLotacao = Fachada.getInstancia().pesquisar(filtroUnidadeEmpresa, UnidadeOrganizacional.class.getName());
			if(colecaoLotacao != null && !colecaoLotacao.isEmpty()){
				UnidadeOrganizacional unidadeEmpresa = (UnidadeOrganizacional) colecaoLotacao.iterator().next();
		...
		if(form.getIdElo() != null && !form.getIdElo().equals("")){
			...
			Collection colecaoElo = Fachada.getInstancia().pesquisar(filtroLocalidade, Localidade.class.getName());
