 ...
 * @date 06/05/2006
 */
public class ExibirInserirSituacaoUsuarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(inserirSituacaoUsuarioActionForm.getIndicadorUsoSistema() == null || !inserirSituacaoUsuarioActionForm.equals("")){
			inserirSituacaoUsuarioActionForm.setIndicadorUsoSistema("1");
		}

		// Seta o mapeamento de retorno
		ActionForward retorno = actionMapping.findForward("inserirSituacaoUsuario");
