 ...
 * @date 02/05/2006
 */
public class ExibirAtualizarUsuarioAcessosUsuarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarUsuarioAcessoUsuario");
		...
		if(onLoad != null && !onLoad.equals("")){
			if(form.getIdElo() != null
							...
							&& (usuarioParaAtualizar.getLocalidadeElo() == null || (usuarioParaAtualizar.getLocalidadeElo() != null
											&& usuarioParaAtualizar.getLocalidadeElo().getId() != null && !form.getIdElo().equals(
											usuarioParaAtualizar.getLocalidadeElo().getId().toString())))){

				FiltroLocalidade filtroLocalidade = new FiltroLocalidade();
				filtroLocalidade.adicionarParametro(new ParametroSimples(FiltroLocalidade.ID, form.getIdElo()));
				...
				if(coll != null && !coll.isEmpty()){
					...
					if(l.getLocalidade() != null && !l.getId().equals(l.getLocalidade().getId())){
			...
			if(form.getIdLocalidade() != null
							...
							&& (usuarioParaAtualizar.getLocalidade() == null || (usuarioParaAtualizar.getLocalidade() != null
											&& usuarioParaAtualizar.getLocalidade().getId() != null && !form.getIdLocalidade().equals(
											usuarioParaAtualizar.getLocalidade().getId().toString())))){
				...
				if(form.getIdLocalidade() != null && !form.getIdLocalidade().equals("")){
					form.setLocalidadeNaoEncontrada("false");
					form.setIdLocalidade("" + usuarioParaAtualizar.getLocalidade().getId());
