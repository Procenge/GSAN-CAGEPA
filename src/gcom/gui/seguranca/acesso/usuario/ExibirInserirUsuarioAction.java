 ...
 * @author Sávio Luiz
 */
public class ExibirInserirUsuarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirUsuario");
		...
		StatusWizard statusWizard = new StatusWizard("inserirUsuarioWizardAction", "concluirInserirUsuarioAction",
		...
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "DadosGeraisPrimeiraAbaA.gif",
						"DadosGeraisPrimeiraAbaD.gif", "exibirInserirUsuarioDadosGeraisAction", "inserirUsuarioDadosGeraisAction"));
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "AcessosUsuarioUltimaAbaA.gif",
						"AcessosUsuarioUltimaAbaD.gif", "exibirInserirUsuarioAcessosUsuarioAction", "inserirUsuarioAcessosUsuarioAction"));
