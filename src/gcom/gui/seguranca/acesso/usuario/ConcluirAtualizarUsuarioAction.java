 ...
 * @date 09/05/2006
 */
public class ConcluirAtualizarUsuarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// usuario.adicionarUsuario(getUsuarioLogado(httpServletRequest),
		// UsuarioAcao.USUARIO_ACAO_EFETUOU_OPERACAO);
		...
		if(form.getSituacao() != null && !form.getSituacao().equalsIgnoreCase("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
			...
			throw new ActionServletException("atencao.required", null, "Situação");
		}
		...
		montarPaginaSucesso(httpServletRequest, "Usuário de Login " + usuarioParaAtualizar.getLogin() + " atualizado com sucesso.",
						"Realizar outra Manutenção de Usuário", "exibirFiltrarUsuarioAction.do?menu=sim");
