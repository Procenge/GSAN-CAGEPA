 ...
 * @since 31/03/2006
 */
public class ExibirFiltrarAbrangenciaUsuarioAction
				extends GcomAction {
	 ...
	 * FiltrarResolucaoDiretoriaActionForm filtrarResolucaoDiretoriaActionForm =
	 * (FiltrarResolucaoDiretoriaActionForm) actionForm;
	 ...
	 * filtrarResolucaoDiretoriaActionForm.setDataInicio((String)
	 * sessao.getAttribute("dataInicio"));
