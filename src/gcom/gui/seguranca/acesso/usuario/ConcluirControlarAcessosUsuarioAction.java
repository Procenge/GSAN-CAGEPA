 ...
 * @date 09/05/2006
 */
public class ConcluirControlarAcessosUsuarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String[] idsPermissoesEspeciais = controlarAcessoUsuarioActionForm.getPermissoesEspeciais();

		String permissoesCheckBoxVazias = controlarAcessoUsuarioActionForm.getPermissoesCheckBoxVazias();

		Fachada.getInstancia().atualizarControleAcessoUsuario(idsPermissoesEspeciais, funcionalidadesMap, usuarioParaAtualizar, idsGrupos,
						permissoesCheckBoxVazias);
