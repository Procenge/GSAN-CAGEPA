...
public class ExibirAtualizarUsuarioDadosGeraisAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(usuarioParaAtualizar != null){
			...
			if("".equals(form.getIdFuncionario())){
				if(usuarioParaAtualizar.getFuncionario() != null){
					if(usuarioParaAtualizar.getFuncionario().getId() != null) form.setIdFuncionario(usuarioParaAtualizar.getFuncionario()
									.getId().toString());
					if(usuarioParaAtualizar.getFuncionario().getNome() != null) form.setNomeFuncionario(usuarioParaAtualizar
									.getFuncionario().getNome());
				}
			}else if(form.getIdFuncionario() != null
							&& (usuarioParaAtualizar.getFuncionario() == null || (usuarioParaAtualizar.getFuncionario() != null
											&& usuarioParaAtualizar.getFuncionario().getId() != null && !form.getIdFuncionario().equals(
											usuarioParaAtualizar.getFuncionario().getId().toString())))){
			...
			// && usuarioParaAtualizar.getUsuarioTipo().getIndicadorFuncionario() ==
			// UsuarioTipo.INDICADOR_FUNCIONARIO) {
			...
			// if (usuarioParaAtualizar.getFuncionario().getUnidadeOrganizacional().getDescricao()
			// != null)
			...
			if("".equals(form.getIdLotacao())){
				...
				if(usuarioParaAtualizar != null && usuarioParaAtualizar.getUsuarioTipo() != null
					...
					if(usuarioParaAtualizar.getFuncionario() != null){
						...
						if(usuarioParaAtualizar.getFuncionario().getNome() != null) form.setNome(usuarioParaAtualizar.getFuncionario()
										.getNome());

						if(usuarioParaAtualizar.getFuncionario().getUnidadeOrganizacional() != null
										&& (form.getIdLotacao() == null || form.getIdLotacao().equals(""))){
							if(usuarioParaAtualizar.getFuncionario().getUnidadeOrganizacional().getId() != null) form
											.setIdLotacao(usuarioParaAtualizar.getFuncionario().getUnidadeOrganizacional().getId()
															.toString());
							if(usuarioParaAtualizar.getFuncionario().getUnidadeOrganizacional().getDescricao() != null) form
											.setNomeLotacao(usuarioParaAtualizar.getFuncionario().getUnidadeOrganizacional().getDescricao());
						}
					}

				}else if(usuarioParaAtualizar.getUnidadeOrganizacional() != null){
					if(usuarioParaAtualizar.getUnidadeOrganizacional().getId() != null) form.setIdLotacao(usuarioParaAtualizar
									.getUnidadeOrganizacional().getId().toString());
					if(usuarioParaAtualizar.getUnidadeOrganizacional().getDescricao() != null) form.setNomeLotacao(usuarioParaAtualizar
									.getUnidadeOrganizacional().getDescricao());
				}
			}else if(form.getIdLotacao() != null
							&& !form.getIdLotacao().equals("")
							&& ((usuarioParaAtualizar.getUnidadeOrganizacional() == null) || (usuarioParaAtualizar
				...
				if(usuarioParaAtualizar.getUnidadeOrganizacional() != null && !usuarioParaAtualizar.getUnidadeOrganizacional().equals("")){
					form.setNomeLotacao(usuarioParaAtualizar.getUnidadeOrganizacional().getDescricao());
				}
			}

			if(usuarioParaAtualizar.getNomeUsuario() != null) form.setNome(usuarioParaAtualizar.getNomeUsuario());
			if(usuarioParaAtualizar.getDataCadastroInicio() != null) form.setDataInicial(Util.formatarData(usuarioParaAtualizar
							.getDataCadastroInicio()));
			if(usuarioParaAtualizar.getDataCadastroFim() != null) form.setDataFinal(Util.formatarData(usuarioParaAtualizar
							.getDataCadastroFim()));

			if(usuarioParaAtualizar.getDataNascimento() != null) form.setDataNascimento(Util.formatarData(usuarioParaAtualizar
							.getDataNascimento()));

		}

		if(usuarioParaAtualizar.getLogin() != null) form.setLogin(usuarioParaAtualizar.getLogin());
		if(usuarioParaAtualizar.getDescricaoEmail() != null) form.setEmail(usuarioParaAtualizar.getDescricaoEmail());
		// }
		...
		if(usuarioParaAtualizar != null){
			...
			if(usuarioParaAtualizar.getUsuarioAbrangencia() != null && usuarioParaAtualizar.getUsuarioAbrangencia().getId() != null) form
							.setAbrangencia(usuarioParaAtualizar.getUsuarioAbrangencia().getId().toString());
			if(usuarioParaAtualizar.getGerenciaRegional() != null && usuarioParaAtualizar.getGerenciaRegional().getId() != null) form
							.setGerenciaRegional(usuarioParaAtualizar.getGerenciaRegional().getId().toString());

			if(usuarioParaAtualizar.getUnidadeNegocio() != null && usuarioParaAtualizar.getUnidadeNegocio().getId() != null) form
							.setUnidadeNegocio(usuarioParaAtualizar.getUnidadeNegocio().getId().toString());

			if("".equals(form.getIdElo())){
				if(usuarioParaAtualizar.getLocalidadeElo() != null){
					if(usuarioParaAtualizar.getLocalidadeElo().getId() != null) form.setIdElo(usuarioParaAtualizar.getLocalidadeElo()
									.getId().toString());
					if(usuarioParaAtualizar.getLocalidadeElo().getDescricao() != null) form.setNomeElo(usuarioParaAtualizar
			...
			if("".equals(form.getIdLocalidade())){
				if(usuarioParaAtualizar.getLocalidade() != null){
					if(usuarioParaAtualizar.getLocalidade().getId() != null) form.setIdLocalidade(usuarioParaAtualizar.getLocalidade()
									.getId().toString());
					if(usuarioParaAtualizar.getLocalidade().getDescricao() != null) form.setNomeLocalidade(usuarioParaAtualizar
									.getLocalidade().getDescricao());
				}
			}

			if(usuarioParaAtualizar.getUsuarioSituacao() != null && usuarioParaAtualizar.getUsuarioSituacao().getId() != null) form
							.setSituacao(usuarioParaAtualizar.getUsuarioSituacao().getId().toString());
		}
		...
		if(sessao.getAttribute("collUsuarioAbrangencia") == null || sessao.getAttribute("collUsuarioAbrangencia").equals("")){
			...
			if(colecaoUsuarioGrupo != null && !colecaoUsuarioGrupo.isEmpty()){
				...
				colecaoUsuarioAbrangencia = Fachada.getInstancia().pesquisar(new FiltroUsuarioAbrangencia(),
				...
				while(mesmoNivel){
					Collection colecaoUsuarioAbrangenciaPorSuperior = Fachada.getInstancia().pesquisarUsuarioAbrangenciaPorSuperior(
									usuarioAbrangenciaParaPesquisa, idUsuarioAbrangencia);
				...
				if(!achouUsuarioAbrangencia){
					...
					filtroUsuarioAbrangencia.adicionarParametro(new ParametroSimples(FiltroUsuarioAbrangencia.ID, usuarioParaAtualizar
									.getUsuarioAbrangencia().getId()));
					Collection colecaoUsuarioAbrangenciaAdicionar = Fachada.getInstancia().pesquisar(filtroUsuarioAbrangencia,
									UsuarioAbrangencia.class.getName());
			...
			if(colecaoUsuarioGrupo != null && !colecaoUsuarioGrupo.isEmpty()){
				...
				colecaoGrupo = Fachada.getInstancia().pesquisar(new FiltroGrupo(), Grupo.class.getName());
			}else{
		...
		if(sessao.getAttribute("collUnidadeNegocio") == null || sessao.getAttribute("collUnidadeNegocio").equals("")){
		...
		if(sessao.getAttribute("collUsuarioSituacao") == null || sessao.getAttribute("collUsuarioSituacao").equals("")){
			...
			Collection colecaoUsuarioSituacao = Fachada.getInstancia().pesquisar(filtroUsuarioSituacao, UsuarioSituacao.class.getName());
