...
/**
 * Classe reponsável por efetuar a exibição da tela de atualização do usuário
 * 
 * @author Sávio Luiz
 */
public class ExibirAtualizarUsuarioAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("desfazer") == null){
			...
			if(httpServletRequest.getParameter("idRegistroAtualizacao") != null){
				idUsuario = (String) httpServletRequest.getParameter("idRegistroAtualizacao");
			}else{
				idUsuario = (String) httpServletRequest.getAttribute("idRegistroAtualizacao");
			}
			...
			if(httpServletRequest.getAttribute("atualizar") != null){
				statusWizard = new StatusWizard("atualizarUsuarioWizardAction", "concluirAtualizarUsuarioAction",
								"cancelarAtualizarUsuarioAction", "exibirFiltrarUsuarioAction", "exibirAtualizarUsuarioAction.do",
								idUsuario);
				...
				statusWizard = new StatusWizard("atualizarUsuarioWizardAction", "concluirAtualizarUsuarioAction",
								"cancelarAtualizarUsuarioAction", "exibirManterUsuarioAction", "exibirAtualizarUsuarioAction.do", idUsuario);
			}

			statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "DadosGeraisPrimeiraAbaA.gif",
							"DadosGeraisPrimeiraAbaD.gif", "exibirAtualizarUsuarioDadosGeraisAction", "atualizarUsuarioDadosGeraisAction"));
			statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "AcessosUsuarioUltimaAbaA.gif",
							"AcessosUsuarioUltimaAbaD.gif", "exibirAtualizarUsuarioAcessosUsuarioAction",
		...
		filtroUsuario.adicionarCaminhoParaCarregamentoEntidade("funcionario.empresa");
		...
		// caso o usuário que esteja efetuando a inserção não seja do grupo de administradores
		...
		if(colecaoUsuarioGrupo == null || colecaoUsuarioGrupo.isEmpty()){
			...
			// se a unidade de lotacao do usuario que estiver efetuando seja diferente da unidade de
			// lotação informada
			if(usuario.getUnidadeOrganizacional() != null && usuario.getUnidadeOrganizacional().getId() != null){
				...
				// se o nivel da unidade de lotação do usuário que estiver efetuando a inserção seja
				// maior ou
				// igual ao nivel de unidade de lotação informada
				if(unidadeEmpresaUsuario != null){
					...
					// ou a unidade superior da unidade de lotação informada seja diferente da
					// unidade de lotação do usuário

					// enquanto o nivel superior da unidade de lotação não esteja no mesmo nivel da
					// unidade de lotação do usuário
