 ...
 * @date 03/07/2006
 */
public class AtualizarGrupoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Fachada.getInstancia().atualizarGrupo(grupo, grupoFuncionalidades);

		// Monta a tela de sucesso
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, "Grupo " + grupo.getDescricao() + " atualizado com sucesso.", "Manter outro grupo",
