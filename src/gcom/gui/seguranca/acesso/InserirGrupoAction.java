 ...
 * @date 28/06/2006
 */
public class InserirGrupoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Fachada.getInstancia().inserirGrupo(grupo, grupoFuncionalidades);

		// Monta página de sucesso
		montarPaginaSucesso(httpServletRequest, "Grupo de descrição " + grupo.getDescricao() + " inserido com sucesso!",
						"Inserir outro grupo", "exibirInserirGrupoAction.do?menu=sim",
						"exibirAtualizarGrupoAction.do?idRegistroAtualizacao=" + grupo.getId(), "Atualizar grupo inserido");
