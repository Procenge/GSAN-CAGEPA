 ...
 * @date 12/05/2006
 */
public class ExibirManterFuncionalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroFuncionalidade filtroFuncionalidade = (FiltroFuncionalidade) sessao.getAttribute("filtroFuncionalidade");
		filtroFuncionalidade.adicionarCaminhoParaCarregamentoEntidade(FiltroFuncionalidade.MODULO);

		// Aciona o controle de paginação para que sejam pesquisados apenas
		// os registros que aparecem na página
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroFuncionalidade, Funcionalidade.class.getName());
		Collection colecaoFuncionalidade = (Collection) resultado.get("colecaoRetorno");
		retorno = (ActionForward) resultado.get("destinoActionForward");

		String apenasFuncionalidade = (String) httpServletRequest.getAttribute("apenasFuncionalidade");
		...
		if(colecaoFuncionalidade != null && !colecaoFuncionalidade.isEmpty()){
			...
			if(colecaoFuncionalidade.size() == 1
				...
				if(httpServletRequest.getParameter("atualizar") != null){
					retorno = actionMapping.findForward("atualizarFuncionalidade");
