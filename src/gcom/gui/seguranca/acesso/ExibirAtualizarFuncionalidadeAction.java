 ...
 * @date 15/05/2006
 */
public class ExibirAtualizarFuncionalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarFuncionalidade");
		...
		if(httpServletRequest.getParameter("idFuncionalidade") != null && !httpServletRequest.getParameter("idFuncionalidade").equals("")){
		...
		Collection<Modulo> colecaoModulo = fachada.pesquisar(filtroModulo, Modulo.class.getName());

		if(colecaoModulo == null || colecaoModulo.isEmpty()){
			throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, "Tabela Modulo");
		}
		...
		if(sessao.getAttribute("colecaoFuncionalidadeTela") == null){
			...
			if(sessao.getAttribute("objetoFuncionalidade") != null){
				...
				Funcionalidade funcionalidade = (Funcionalidade) sessao.getAttribute("objetoFuncionalidade");
				sessao.setAttribute("idFuncionalidade", funcionalidade.getId().toString());

				atualizarFuncionalidadeActionForm.setIdFuncionalidade(funcionalidade.getId().toString());
				atualizarFuncionalidadeActionForm.setDescricao(funcionalidade.getDescricao());
				atualizarFuncionalidadeActionForm.setDescricaoAbreviada(funcionalidade.getDescricaoAbreviada());
				atualizarFuncionalidadeActionForm.setCaminhoMenu(funcionalidade.getCaminhoMenu());
				atualizarFuncionalidadeActionForm.setCaminhoUrl(funcionalidade.getCaminhoUrl());
				atualizarFuncionalidadeActionForm.setModulo(funcionalidade.getModulo().getId().toString());
				atualizarFuncionalidadeActionForm.setIndicadorPontoEntrada("" + funcionalidade.getIndicadorPontoEntrada());

				atualizarFuncionalidadeActionForm.setNumeroOrdemMenu(funcionalidade.getNumeroOrdemMenu().toString());
				...
				Collection colecaoFuncionalidadeTela = fachada.pesquisar(filtroFuncionalidadeDependencia, FuncionalidadeDependencia.class
								.getName());

				if(colecaoFuncionalidadeTela != null && !colecaoFuncionalidadeTela.isEmpty()){
					sessao.setAttribute("colecaoFuncionalidadeTela", colecaoFuncionalidadeTela);
				}
				...
				if(httpServletRequest.getParameter("idFuncionalidade") == null
					...
					funcionalidadeID = (String) httpServletRequest.getParameter("idFuncionalidade");
				...
				filtroFuncionalidade.adicionarParametro(new ParametroSimples(FiltroFuncionalidade.ID, funcionalidadeID));

				Collection<Funcionalidade> colecaoFuncionalidade = fachada.pesquisar(filtroFuncionalidade, Funcionalidade.class.getName());

				if(colecaoFuncionalidade == null || colecaoFuncionalidade.isEmpty()){
					throw new ActionServletException("atencao.atualizacao.timestamp");
				}

				httpServletRequest.setAttribute("colecaoFuncionalidade", colecaoFuncionalidade);
				...
				atualizarFuncionalidadeActionForm.setNumeroOrdemMenu("" + funcionalidade.getNumeroOrdemMenu());
		...
		if(httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")){
			...
			if(funcionalidadeID != null){
				...
				httpServletRequest.setAttribute("funcionalidadeID", funcionalidadeID);
				sessao.setAttribute("funcionalidadeAtualizar", funcionalidade);
			}
		...
		httpServletRequest.setAttribute("colecaoFuncionalidadeTela", sessao.getAttribute("colecaoFuncionalidadeTela"));
