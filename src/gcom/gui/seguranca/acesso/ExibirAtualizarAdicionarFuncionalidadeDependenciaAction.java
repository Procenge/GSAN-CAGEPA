...
public class ExibirAtualizarAdicionarFuncionalidadeDependenciaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirAtualizarAdicionarFuncionalidadeDependenciaAction");
		...
		if(httpServletRequest.getParameter("funcionalidadeID") != null){
			idFuncionalidade = (String) httpServletRequest.getParameter("funcionalidadeID");
		}else{
