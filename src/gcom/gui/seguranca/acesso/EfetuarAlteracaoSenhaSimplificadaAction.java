 ...
 * @date 12/07/2006
 */
public class EfetuarAlteracaoSenhaSimplificadaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		try{
			...
			if(senha.trim().equals(usuarioLogado.getSenha())){
				fachada.efetuarAlteracaoSenha(usuarioLogado, dataNascimentoString, usuarioLogado.getCpf(), lembreteSenha, novaSenha,
								confirmacaoNovaSenha);
			}else{
				throw new ActionServletException("atencao.senha.invalida", null, "Senha Inexistente");
			}
