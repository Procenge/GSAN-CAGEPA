...
public class ExibirPesquisarFuncionalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("funcionalidadePesquisar");
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaFuncionalidade") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaFuncionalidade", httpServletRequest
							.getParameter("caminhoRetornoTelaPesquisaFuncionalidade"));
		}
