 ...
 * @date 25/04/2006
 */
public class ExibirInserirFuncionalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("funcionalidadeInserir");
		...
		if(inserirFuncionalidadeActionForm.getIndicadorPontoEntrada() == null || !inserirFuncionalidadeActionForm.equals("")){
			inserirFuncionalidadeActionForm.setIndicadorPontoEntrada("1");
		}
		...
		if(sessao.getAttribute("colecaoFuncionalidade") != null){
			Collection colecaoPopUp = (Collection) sessao.getAttribute("colecaoFuncionalidade");
			colecaoFuncionalidade.addAll(colecaoPopUp);
			sessao.removeAttribute("colecaoFuncionalidade");
			sessao.setAttribute("colecaoFuncionalidadeTela", colecaoFuncionalidade);
		}
