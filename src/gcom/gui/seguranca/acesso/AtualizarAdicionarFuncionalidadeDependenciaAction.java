 ...
 * @date 03/05/2006
 */
public class AtualizarAdicionarFuncionalidadeDependenciaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("atualizarFuncionalidadeDependenciaAction");
		...
		String idFuncionalidade = atualizarAdicionarFuncionalidadeDependenciaActionForm.getComp_id();
		...
		if(idFuncionalidade != null && !idFuncionalidade.equalsIgnoreCase("")){
			...
			if(colecaoFuncionalidadeDependencia != null && !colecaoFuncionalidadeDependencia.isEmpty()){
				...
				while(iterator.hasNext()){
					...
					if(funcionalidade.getComp_id().getFuncionalidadeId().equals(new Integer(idFuncionalidade))){
						// Esta funcionalidade é igual a principal
						throw new ActionServletException("atencao.funcionalidade.igual_principal");
					}

					if(funcionalidade.getComp_id().getFuncionalidadeDependenciaId().equals(new Integer(idFuncionalidade))){
