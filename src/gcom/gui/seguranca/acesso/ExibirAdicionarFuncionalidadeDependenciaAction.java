...
public class ExibirAdicionarFuncionalidadeDependenciaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(((String) sessao.getAttribute("funcionalidade")).equalsIgnoreCase("inserir")){
			retorno = actionMapping.findForward("inserirAdicionarFuncionalidadeDependenciaAction");
		}else{
			retorno = actionMapping.findForward("atualizarAdicionarFuncionalidadeDependenciaAction");
		}
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null
						&& httpServletRequest.getParameter("tipoConsulta").equals("funcionalidade")){

			idFuncionalidade = httpServletRequest.getParameter("idCampoEnviarDados");
		...
		if(idFuncionalidade != null && !idFuncionalidade.equals("")){
			...
			if(colecaoFuncionalidade != null && !colecaoFuncionalidade.isEmpty()){
				...
				httpServletRequest.setAttribute("funcionalidadeDependenciaEncontrada", "true");
				...
				httpServletRequest.setAttribute("funcionalidadeDependenciaNaoEncontrada", "exception");

				adicionarFuncionalidadeDependenciaActionForm.setDescricaoFuncionalidade("FUNCIONALIDADE INEXISTENTE");
			}
