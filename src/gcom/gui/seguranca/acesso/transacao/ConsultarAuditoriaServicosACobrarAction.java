...
public class ConsultarAuditoriaServicosACobrarAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("consultarAuditoriaServicosACobrar");

		ConsultarAuditoriaServicosACobrarActionForm form = (ConsultarAuditoriaServicosACobrarActionForm) actionForm;
		...
		if(idUsuario != null && !idUsuario.equals("")){
			colecao = (Collection) fachada.consultarServicosACobrarUsuario(new Integer(idUsuario.trim()), dateInicial, dateFinal);
		}

		// Parte do código que trata se foi escolhido o funcionário
		if(idFuncionario != null && !idFuncionario.equals("")){
			colecao = (Collection) fachada.consultarServicosACobrarFuncionario(new Integer(idFuncionario.trim()),
