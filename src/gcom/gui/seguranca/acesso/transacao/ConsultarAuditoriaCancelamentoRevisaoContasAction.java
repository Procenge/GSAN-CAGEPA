...
public class ConsultarAuditoriaCancelamentoRevisaoContasAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("consultarAuditoriaCancelamentoRevisaoContas");

		ConsultarAuditoriaCancelamentoRevisaoContasActionForm form = (ConsultarAuditoriaCancelamentoRevisaoContasActionForm) actionForm;
		...
		if(idUsuario != null && !idUsuario.equals("")){
			colecao = (Collection) fachada.pesquisarAuditoriaRevisaoCancelamentoContaUsuario(new Integer(idUsuario), dataInicialInt,
							dataFinalInt);
		}

		// Parte do código que trata se foi escolhido o funcionário
		if(idFuncionario != null && !idFuncionario.equals("")){
			colecao = (Collection) fachada.pesquisarAuditoriaRevisaoCancelamentoContaFuncionario(new Integer(idFuncionario),
