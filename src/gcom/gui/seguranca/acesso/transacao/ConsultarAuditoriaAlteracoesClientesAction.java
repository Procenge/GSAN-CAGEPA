...
public class ConsultarAuditoriaAlteracoesClientesAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("consultarAuditoriaAlteracoesClientes");
		...
		if(idUsuario != null && !idUsuario.equals("")){
			colecao = (Collection) fachada.consultarAlteracoesClientesUsuario(new Integer(idUsuario), dateInicial, dateFinal);
		}

		// Parte do código que trata se foi escolhido o funcionário
		if(idFuncionario != null && !idFuncionario.equals("")){
			colecao = (Collection) fachada.consultarAlteracoesClientesFuncionario(new Integer(idFuncionario),
