 ...
 */
public class PesquisarColunaTabelaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirResultadoPesquisaColunaTabelaAction");
		...
		if(nome != null && !nome.trim().equalsIgnoreCase("")){
			...
			filtroTabelaColuna.adicionarParametro(new ComparacaoTexto(FiltroTabelaColuna.COLUNA, nome));
		...
		if(codigo != null && !codigo.trim().equalsIgnoreCase("")){
			...
			filtroTabelaColuna.adicionarParametro(new ParametroSimples(FiltroTabelaColuna.ID, codigo));
