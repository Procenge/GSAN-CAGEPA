 ...
 * @date 14/06/2006
 */
public class ExibirInserirGrupoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		StatusWizard statusWizard = new StatusWizard("inserirGrupoWizardAction", "inserirGrupoAction", "cancelarInserirGrupoAction",
						"exibirInserirGrupoAction.do");
		...
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "DadosGeraisPrimeiraAbaA.gif",
						"DadosGeraisPrimeiraAbaD.gif", "exibirInserirGrupoDadosGeraisAction", "inserirGrupoDadosGeraisAction"));
		...
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "AcessosGrupoUltimaAbaA.gif",
						"AcessosGrupoUltimaAbaD.gif", "exibirInserirGrupoAcessosGrupoAction", "inserirGrupoAcessosGrupoAction"));
