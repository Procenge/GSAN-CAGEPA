 ...
 * @date 05/05/2006
 */
public class InserirOperacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String indicadorAuditoriaString = inserirOperacaoActionForm.getIndicadorAuditoria();
		...
		montarPaginaSucesso(httpServletRequest, "Operação inserida com sucesso.", "Inserir outra operação",
