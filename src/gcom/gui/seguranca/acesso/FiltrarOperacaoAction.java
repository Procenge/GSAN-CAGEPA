 ...
 * @date 12/05/2006
 */
public class FiltrarOperacaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer idTipoOperacao = Util.obterInteger(filtrarOperacaoActionForm.getIdTipoOperacao());
		...
		sessao.setAttribute("filtrarOperacaoActionForm", filtrarOperacaoActionForm);
