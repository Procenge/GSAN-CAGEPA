 ...
 */
public class TestarEnvioEmailActionForm
	...
	public final void setServidorSMTP(String servidorSMTP){
	...
	public final void setRemetente(String remetente){
	...
	public final FormFile getAnexo(){

		return anexo;
	}

	public final void setAnexo(FormFile anexo){
