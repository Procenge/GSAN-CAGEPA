 ...
 * @date 13/06/2007
 */
public class GerarIntegracaoContabilidadeCaernAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		fachada.gerarIntegracaoContabilidadeCaern(idLancamentoOrigem, anoMes, dataLancamento);

		// montando página de sucesso
		montarPaginaSucesso(httpServletRequest, "Gerando a Integração para a Contabilidade.", "Gerar Integração para a Contabilidade",
						"/exibirGerarIntegracaoContabilidadeAction.do");
