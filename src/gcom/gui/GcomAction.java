...
public class GcomAction
	 ...
	 * @date 27/06/2008
	 *       Corrigido o set da variável Destino, pois estava setando "null" (string) causando
	 *       problemas no parse do número da página do wizard
	 */
	protected ActionForward montarPaginaConfirmacaoWizard(String chaveMensagem, HttpServletRequest request, ActionMapping actionMapping,
	...
	protected ActionForward montarPaginaConfirmacaoWizard(Map<String, String[]> mensagens, HttpServletRequest request,
		...
		// Constroi a mensagem de confirmação
	...
	/**
	 * Método montarPaginaConfirmacaoWizard com o parametro nomeStatusWizard que será informado nos
	 * casos
	 * onde a funcionalidade tem um nome específico para o wizard.
	 * 
	...
	protected ActionForward montarPaginaConfirmacaoWizard(String chaveMensagem, String nomeStatusWizard, HttpServletRequest request,
		...
		// Na tela de confirmação (confirmar.jsp) caso o statusWizard não seja encontrado, buscar
	...
	/**
	 * Monta a página de confirmação com um Link que abrirá um Popup
	 * 
	 ...
	 * @author Saulo Lima
	 * @date 05/02/2009
	 *       Levantar exceção caso pesquisa não retorne nenhum resultado.
	 * @param request
	 *            Request do Action
	 * @param actionForward
	 ...
	 * Controla o mecanismo de paginação trabalhando com os parâmetros do
	 * paginador no jsp. A pesquisa é feita através deste método e só é
	 * retornado os dados da página sendo apresentada. Deve ser também passado
	 * a quantidade máxima de registros por página.
	 * 
	 ...
	 *            Quantidade máximda de registros por página
	 * @return Um Map contendo dois atributos: a chave "colecaoRetorno" com a
	 *         coleção pesquisada e a chave "destinoActionForward" com o
	 *         actionForward que deve ser retornado
	 */
	...
	/**
	 * Retorna o paramentro para diferenciar a companhia que o sistema está rodando <br>
	 * <br>
	...
	/**
	 * Método usado para impressão direta do jsp, sem precisar gerar pdf.
	 * 
