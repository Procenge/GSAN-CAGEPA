...
public class EmissaoHistogramaEsgotoEconomiaDadosInformarActionForm
	...
	private LinkedHashMap<String, Collection<ConsumoFaixaCategoria>> linkedHashMapConsumoFaixaCategoria = new LinkedHashMap<String, Collection<ConsumoFaixaCategoria>>();
	...
	public void setColecaoConsumoFaixaCategoria(Collection<ConsumoFaixaCategoria> colecaoConsumoFaixaCategoria){
	...
	public void reset(ActionMapping mapping, HttpServletRequest request){
		...
		this.eloPolo = null;
		this.nomeEloPolo = null;
		this.localidade = null;
		this.nomeLocalidade = null;
		this.setorComercial = null;
		this.nomeSetorComercial = null;
		this.quadra = null;
		this.nomeQuadra = null;
		this.consumo = null;
		this.poco = null;
		this.volumoFixoEsgoto = null;
		...
		this.perfilLigacaoEsgoto = null;

		// Parte do Popup
		// this.subTituloFaixaConsumo = null;
		// this.limiteInferiorFaixa = null;
		// this.limiteSuperiorFaixa = null;
		// this.tipoConsumoCategoria = null;
	}
}