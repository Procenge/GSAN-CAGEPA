...
public class ValidarSituacaoEspecialFaturamentoInserirAtualizarAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(helperParaSeremInseridos != null && !helperParaSeremInseridos.isEmpty()){
			// Atualizar Imoveis
			fachada.atualizarFaturamentoSituacaoTipo(new Integer(situacaoEspecialFaturamentoActionForm.getIdFaturamentoSituacaoTipo()),
							helperParaSeremInseridos,
							usuarioLogado, helperParaSeremRemovidos);
		...
		montarPaginaSucesso(httpServletRequest, "" + helperParaSeremInseridos.size()
