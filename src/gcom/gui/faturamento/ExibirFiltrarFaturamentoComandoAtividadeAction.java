 ...
 */
public class ExibirFiltrarFaturamentoComandoAtividadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		httpServletRequest.getSession().removeAttribute("filtroFaturamentoAtividadeCronograma");
		...
		Collection faturamentoGrupos = Fachada.getInstancia().pesquisar(filtroFaturamentoGrupo, FaturamentoGrupo.class.getName());
