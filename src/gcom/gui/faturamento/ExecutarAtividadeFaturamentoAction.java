 ...
 */
public class ExecutarAtividadeFaturamentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// recupera o form
		ExecutarAtividadeFaturamentoActionForm executarAtividadeFaturamentoActionForm = (ExecutarAtividadeFaturamentoActionForm) actionForm;
		...
		// Recupera o array de ids de atividades de faturamento do cronograma do form
		String[] idsFaturamentoAtividadeCronograma = executarAtividadeFaturamentoActionForm.getIdsFaturamentoAtividadeCronograma();

		// [FS0004] Verifica a seleção de atividade para execução
		if(idsFaturamentoAtividadeCronograma == null || idsFaturamentoAtividadeCronograma.equals("")){
		...
		montarPaginaSucesso(httpServletRequest, "Atividade(s) de faturamento executada(s) com sucesso.",
						"Executar outra(s) atividade(s) de faturamento", "exibirExecutarAtividadeFaturamentoAction.do");
