...
public class CalcularPrestacaoDebitoACobrarAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ArrayList valores = fachada.calcularValorPrestacao(taxaJutosFinanciamento, numeroPrestacoes, valorTotalServico, valorEntrada,
						percentualAbatimento, inserirDebitoACobrarActionForm.getIdTipoDebito(), null, imovel, usuario);
