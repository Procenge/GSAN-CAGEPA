 ...
 * @date 29/03/2006
 */
public class ExibirExecutarAtividadeFaturamentoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirExecutarAtividadeFaturamento");
		...
		// tela
		Integer totalRegistros = fachada.pesquisarFaturamentoAtividadeCronogramaComandadaNaoRealizadaCount();
		...
		Collection<ExecutarAtividadeFaturamentoHelper> colecaoExecutarAtividadeFaturamento = fachada
						.obterAtividadesFaturamentoCronogramaComandada(((Integer) httpServletRequest.getAttribute("numeroPaginasPesquisa")));

		sessao.setAttribute("colecaoExecutarAtividadeFaturamento", colecaoExecutarAtividadeFaturamento);
