 ...
 */
public class InserirDebitoACobrarActionForm
				extends ActionForm {
	...
	private String anoMesCobrancaDebito;

	private String numerosDiasSuspensao;
	 ...
	 *            The percentualAbatimento to set.
	 */
	 ...
	 *            The taxaJurosFinanciamento to set.
	 */
	...
	/**
	 * @param valorTotalSercioAParcelar
	 *            The valorTotalSercioAParcelar to set.
	 */
	...
	/**
	 * @param valorTotalServicoAParcelar
	 *            The valorTotalServicoAParcelar to set.
	 */
	public void setValorTotalServicoAParcelar(String valorTotalServicoAParcelar){
	...
	/**
	 * @param nomeRegistroAtendimento
	 *            O nomeRegistroAtendimento a ser setado.
	 */
	...
	/**
	 * @param inscricaoImovelInformada
	 *            O inscricaoImovelInformada a ser setado.
	 */
	...
	/**
	 * @return Retorna o campo anoMesCobrancaDebito.
	 */
	 ...
	 *            O anoMesInicioCobranca a ser setado.
	 */
	public void setAnoMesCobrancaDebito(String anoMesCobrancaDebito){

		this.anoMesCobrancaDebito = anoMesCobrancaDebito;
	}

	public String getNumerosDiasSuspensao(){

		return numerosDiasSuspensao;
	}

	public void setNumerosDiasSuspensao(String numerosDiasSuspensao){

		this.numerosDiasSuspensao = numerosDiasSuspensao;
	}
