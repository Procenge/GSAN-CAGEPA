...
public class AtualizarComandoAtividadeFaturamentoDadosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(faturamentoAtividadeCronograma.getFaturamentoAtividade().getId().equals(FaturamentoAtividade.FATURAR_GRUPO)
			...
			if(dataVencimentoGrupoBase != null && dataVencimentoGrupoJSP != null && !dataVencimentoGrupoJSP.equalsIgnoreCase("")){

				try{
					dataVencimentoGrupo = formatoData.parse(dataVencimentoGrupoJSP);

					String mesDataVencimentoGrupo = dataVencimentoGrupoJSP.substring(3, 5);
					String anoDataVencimentoGrupo = dataVencimentoGrupoJSP.substring(6, 10);
					...
					// else
					// if((!mesDataVencimentoGrupo.equalsIgnoreCase(mesDataVencimentoGrupoBase))
					// || (!anoDataVencimentoGrupo.equalsIgnoreCase(anoDataVencimentoGrupoBase))){
					// throw new
					// ActionServletException("atencao.faturamento_data_vencimento_mes_ano_diferente");
					// }
				}catch(ParseException ex){
