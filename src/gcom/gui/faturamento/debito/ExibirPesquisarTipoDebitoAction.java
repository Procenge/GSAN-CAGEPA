 ...
 */
public class ExibirPesquisarTipoDebitoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// se essa variavel tiver algum valor, isso indica que apenas do Tipo de Financimento
		// SERVIÇO deve ser carregado na colecao
		...
		}else if(sessao.getAttribute("tipoFinanciamentoServico") != null && !sessao.getAttribute("tipoFinanciamentoServico").equals("")){
		...
		if((httpServletRequest.getParameter("limparForm") != null && httpServletRequest.getParameter("limparForm").equalsIgnoreCase("1"))
		...
		if(colecaoLancamentoItemContabil == null || colecaoLancamentoItemContabil.isEmpty()){
			...
			// a coleção pesquisada no request para a página de pesquisar item de lançamento
			// contábil
