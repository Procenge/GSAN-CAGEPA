...
/**
 * Exibe a pesquisa de Debito Tipo Valor Localidade
 * 
 * @author Ado Rocha
 * @date 29/04/2014
 */
public class ExibirPesquisarDebitoTipoValorLocalidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		PesquisarDebitoTipoValorLocalidadeActionForm form = (PesquisarDebitoTipoValorLocalidadeActionForm) actionForm;
		ActionForward retorno = actionMapping.findForward("exibirDebitoTipoValorLocalidadePopup");
		...
		if("inserir".equals(form.getMethod())){
			if(!erro){
				form.setMethod(null);
				Collection colecaoDebitoTipoValorLocalidade = (Collection) sessao.getAttribute("colecaoDebitoTipoValorLocalidade");
	 ...
	 * @date 29/04/2014
	 */
	private void pesquisarLocalidade(PesquisarDebitoTipoValorLocalidadeActionForm form, HttpServletRequest httpServletRequest){
