 ...
 * @date 09/03/2007
 */
public class ExibirInserirTipoDebitoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String debitoValorLocalidade = (String) httpServletRequest.getParameter("debitoValorLocalidade");

		if(atualizarIdLocalidade != null && !atualizarIdLocalidade.equals("") && debitoValorLocalidade != null
						&& !debitoValorLocalidade.equals("")){
			...
			for(Iterator iter = form.getDebitoTipoValorLocalidade().iterator(); iter.hasNext();){
				...
				if(atualizarIdLocalidade.equals(dtvl.getLocalidade().getId().toString())){
					dtvl.setValorDebitoTipo((Util.formatarMoedaRealparaBigDecimal(debitoValorLocalidade)));
				}
