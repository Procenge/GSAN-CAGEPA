 ...
 * @date 13/03/2007
 */
public class ExibirManterTipoDebitoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroDebitoTipo filtroDebitoTipo = (FiltroDebitoTipo) sessao.getAttribute("filtroDebitoTipo");

		// Aciona o controle de paginação para que sejam pesquisados apenas
		// os registros que aparecem na página
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroDebitoTipo, DebitoTipo.class.getName());
		Collection colecaoDebitoTipo = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoDebitoTipo != null && !colecaoDebitoTipo.isEmpty()){
			...
			if(colecaoDebitoTipo.size() == 1
				...
				if(httpServletRequest.getParameter("atualizar") != null){
					retorno = actionMapping.findForward("atualizarTipoDebitoAction");
