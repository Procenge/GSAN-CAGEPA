 ...
 * @created 25/04/2006
 */
public class InserirDebitoACobrarPopupAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer idDebitoACobrar = fachada.inserirDebitoACobrar(numeroPrestacoes, debitoACobrar, valorTotalServico, imovel,
						percentualAbatimento, valorEntrada, usuarioLogado, false, null, null, null);
		...
		if(sessao.getAttribute("colecaoDebitoACobrarExtrato") != null){
			colecaoDebitosACobrar = (Collection<DebitoACobrar>) sessao.getAttribute("colecaoDebitoACobrarExtrato");
		}else{
		...
		sessao.setAttribute("colecaoDebitoACobrarExtrato", colecaoDebitosACobrar);
