 ...
 */
public class FiltrarTipoDebitoActionForm
	...
	private String valorLimiteDebitoInicial;

	private String valorLimiteDebitoFinal;
	...
	/**
	 * @return Returns the tipoPesquisa.
	 */
	...
	/**
	 * @return Retorna o campo valorLimiteDebitoFinal.
	 */
	public String getValorLimiteDebitoFinal(){

		return valorLimiteDebitoFinal;
	}

	/**
	 * @param valorLimiteDebitoFinal
	 *            O valorLimiteDebitoFinal a ser setado.
	 */
	public void setValorLimiteDebitoFinal(String valorLimiteDebitoFinal){

		this.valorLimiteDebitoFinal = valorLimiteDebitoFinal;
	}

	/**
	 * @return Retorna o campo valorLimiteDebitoInicial.
	 */
	public String getValorLimiteDebitoInicial(){

		return valorLimiteDebitoInicial;
	}

	/**
	 * @param valorLimiteDebitoInicial
	 *            O valorLimiteDebitoInicial a ser setado.
	 */
	public void setValorLimiteDebitoInicial(String valorLimiteDebitoInicial){

		this.valorLimiteDebitoInicial = valorLimiteDebitoInicial;
	}
