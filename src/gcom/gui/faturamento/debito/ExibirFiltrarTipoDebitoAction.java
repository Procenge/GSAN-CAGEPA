 ...
 * @date 13/03/2007
 */
public class ExibirFiltrarTipoDebitoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarTipoDebito");

		FiltrarTipoDebitoActionForm form = (FiltrarTipoDebitoActionForm) actionForm;

		Fachada fachada = Fachada.getInstancia();

		form.setIndicadorGeracaoDebitoAutomatica("3");
		form.setIndicadorGeracaoDebitoConta("3");
		form.setIndicadorUso("3");
		form.setTipoPesquisa("1");
		form.setIndicadorIncidenciaJurosMora("3");
		form.setIndicadorIncidenciaMulta("3");
