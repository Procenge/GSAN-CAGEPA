 ...
 * @date 13/03/2006
 */
public class ExibirPesquisarDebitoACobrarAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// PesquisarDebitoACobrarActionForm pesquisarDebitoACobrarActionForm =
		// (PesquisarDebitoACobrarActionForm)actionForm;
		...
		if(idImovel != null && !idImovel.trim().equalsIgnoreCase("")){
			...
			// Caso o imóvel informado não tenha sido cadastrado no sistema, levantaa exceção para o
			// usuário indicando que o
		...
		// [FS0005] Caso não exista nenhuma situação de débito a cobrar no sistema, levanta a
		// exceção para o usuário indicando que
		...
		// [FS0005] Caso não exista nenhum tipo de débito de débito a cobrar no sistema, levanta a
		// exceção para o usuário indicando que
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaDebitoACobrar") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaDebitoACobrar", httpServletRequest
