 ...
 * @date 26/01/2014
 */
public class AtualizarComandoSimulacaoFaturamentoActionForm
				extends ValidatorActionForm {

	private static final long serialVersionUID = 1L;

	private String idFaturamentoSimulacaoComando;
	...
	public String getIdFaturamentoSimulacaoComando(){

		return idFaturamentoSimulacaoComando;
	}

	public void setIdFaturamentoSimulacaoComando(String idFaturamentoSimulacaoComando){

		this.idFaturamentoSimulacaoComando = idFaturamentoSimulacaoComando;
	}
}
