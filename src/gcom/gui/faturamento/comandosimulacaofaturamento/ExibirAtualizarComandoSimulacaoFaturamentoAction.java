 ...
 * @date 26/01/2014
 */
public class ExibirAtualizarComandoSimulacaoFaturamentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarComandoSimulacaoFaturamento");

		HttpSession sessao = httpServletRequest.getSession(false);

		AtualizarComandoSimulacaoFaturamentoActionForm form = (AtualizarComandoSimulacaoFaturamentoActionForm) actionForm;

		Fachada fachada = Fachada.getInstancia();

		String idFaturamentoSimulacaoComando = null;

		if(sessao.getAttribute("filtrarApenasUmComando") == null
						|| (httpServletRequest.getParameter("idRegistroAtualizacao") != null && !httpServletRequest.getParameter(
										"idRegistroAtualizacao").equals(""))){

			sessao.removeAttribute("faturamentoSimulacaoComandoSelecionado");
		}
		...
		// Verifica se não clicou no botão desfazer
		if(httpServletRequest.getParameter("desfazer") == null && objetoConsulta == null){

			FaturamentoSimulacaoComando faturamentoSimulacaoComando = null;

			if(sessao.getAttribute("filtrarApenasUmComando") != null){

				faturamentoSimulacaoComando = (FaturamentoSimulacaoComando) sessao
								.getAttribute("faturamentoSimulacaoComandoSelecionado");

				sessao.setAttribute("faturamentoSimulacaoComandoAtualizar", faturamentoSimulacaoComando);
				sessao.removeAttribute("faturamentoSimulacaoComandoSelecionado");
				sessao.setAttribute("idRegistroAtualizacao", faturamentoSimulacaoComando.getId().toString());
				idFaturamentoSimulacaoComando = faturamentoSimulacaoComando.getId().toString();

			}else{

				idFaturamentoSimulacaoComando = null;

				if(sessao.getAttribute("filtrarApenasUmComando") != null){

					faturamentoSimulacaoComando = (FaturamentoSimulacaoComando) sessao
									.getAttribute("faturamentoSimulacaoComandoSelecionado");
					idFaturamentoSimulacaoComando = (String) sessao.getAttribute("idRegistroAtualizacao");
				}else{

					if(httpServletRequest.getParameter("idRegistroAtualizacao") != null){

						idFaturamentoSimulacaoComando = (String) httpServletRequest.getParameter("idRegistroAtualizacao");
						sessao.setAttribute("idRegistroAtualizacao", idFaturamentoSimulacaoComando);
					}else{
					...
					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.LOCALIDADE_INICIAL);
					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.LOCALIDADE_FINAL);

					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.SETOR_COMERCIAL_INICIAL);
					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.SETOR_COMERCIAL_FINAL);

					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.QUADRA_INICIAL);
					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.QUADRA_FINAL);

					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.ROTA_INICIAL);
					filtroFaturamentoSimulacaoComando
									.adicionarCaminhoParaCarregamentoEntidade(FiltroFaturamentoSimulacaoComando.ROTA_FINAL);
					...
					Collection<FaturamentoSimulacaoComando> colecaoFaturamentoSimulacaoComando = fachada.pesquisar(
									filtroFaturamentoSimulacaoComando, FaturamentoSimulacaoComando.class.getName());

					if(Util.isVazioOrNulo(colecaoFaturamentoSimulacaoComando)){

						throw new ActionServletException("atencao.atualizacao.timestamp");
					}

					faturamentoSimulacaoComando = (FaturamentoSimulacaoComando) colecaoFaturamentoSimulacaoComando.iterator().next();
					idFaturamentoSimulacaoComando = faturamentoSimulacaoComando.getId().toString();
				}
			...
			FiltroFaturamentoSimulacaoComando filtroFaturamentoSimulacaoComando = new FiltroFaturamentoSimulacaoComando();
			filtroFaturamentoSimulacaoComando.adicionarParametro(new ParametroSimples(FiltroFaturamentoSimulacaoComando.ID, Util
							.obterInteger(idFaturamentoSimulacaoComando)));
			filtroFaturamentoSimulacaoComando.adicionarParametro(new ParametroNaoNulo(FiltroFaturamentoSimulacaoComando.DATA_REALIZACAO));
			...
			if(!Util.isVazioOrNulo(colecaoFaturamentoSimulacaoComando)){
				...
				throw new ActionServletException("atencao.faturamento_simulacao_comando_ja_executado");
			}

			form.setIdFaturamentoSimulacaoComando(idFaturamentoSimulacaoComando);

			if(faturamentoSimulacaoComando.getFaturamentoGrupo() != null){

				form.setIdFaturamentoGrupo(faturamentoSimulacaoComando.getFaturamentoGrupo().getId().toString());
			}else{

				form.setIdFaturamentoGrupo("");
			}

			if(faturamentoSimulacaoComando.getGerenciaRegional() != null){

				form.setIdGerenciaRegional(faturamentoSimulacaoComando.getGerenciaRegional().getId().toString());
			}else{
			...
			if(faturamentoSimulacaoComando.getUnidadeNegocio() != null){
				...
				form.setIdUnidadeNegocio(faturamentoSimulacaoComando.getUnidadeNegocio().getId().toString());
			}else{

				form.setIdUnidadeNegocio("");
			}

			if(faturamentoSimulacaoComando.getLocalidadeInicial() != null){

				form.setIdLocalidadeInicial(faturamentoSimulacaoComando.getLocalidadeInicial().getId().toString());
				form.setIdLocalidadeFinal(faturamentoSimulacaoComando.getLocalidadeFinal().getId().toString());
				form.setDescricaoLocalidadeInicial(faturamentoSimulacaoComando.getLocalidadeInicial().getDescricao());
				form.setDescricaoLocalidadeFinal(faturamentoSimulacaoComando.getLocalidadeFinal().getDescricao());
			...
			if(faturamentoSimulacaoComando.getSetorComercialInicial() != null){
				...
				form.setCodigoSetorComercialInicial(String.valueOf(faturamentoSimulacaoComando.getSetorComercialInicial().getCodigo()));
				form.setCodigoSetorComercialFinal(String.valueOf(faturamentoSimulacaoComando.getSetorComercialFinal().getCodigo()));
				form.setDescricaoSetorComercialInicial(faturamentoSimulacaoComando.getSetorComercialInicial().getDescricao());
				form.setDescricaoSetorComercialFinal(faturamentoSimulacaoComando.getSetorComercialFinal().getDescricao());
			...
			if(faturamentoSimulacaoComando.getQuadraInicial() != null){

				form.setNumeroQuadraInicial(String.valueOf(faturamentoSimulacaoComando.getQuadraInicial().getNumeroQuadra()));
				form.setNumeroQuadraFinal(String.valueOf(faturamentoSimulacaoComando.getQuadraFinal().getNumeroQuadra()));
			}else{
			...
			if(faturamentoSimulacaoComando.getRotaInicial() != null){

				form.setCodigoRotaInicial(faturamentoSimulacaoComando.getRotaInicial().getCodigo().toString());
				form.setCodigoRotaFinal(faturamentoSimulacaoComando.getRotaFinal().getCodigo().toString());
				form.setDescricaoRotaInicial(faturamentoSimulacaoComando.getRotaInicial().getDescricao());
				form.setDescricaoRotaFinal(faturamentoSimulacaoComando.getRotaFinal().getDescricao());
				httpServletRequest.setAttribute("rotaInicialEncontrada", "true");
				httpServletRequest.setAttribute("rotaFinalEncontrada", "true");
			}else{

				form.setCodigoRotaInicial("");
				form.setCodigoRotaFinal("");
				form.setDescricaoRotaInicial("");
				form.setDescricaoRotaFinal("");
			}

			if(faturamentoSimulacaoComando.getLoteInicial() != null){

				form.setLoteInicial(faturamentoSimulacaoComando.getLoteInicial().toString());
				form.setLoteFinal(faturamentoSimulacaoComando.getLoteFinal().toString());
			}else{
			...
			form.setIndicadorCriterioTipoConsumoAgua(faturamentoSimulacaoComando.getCodigoTipoConsumoAgua().toString());
			form.setIndicadorCriterioTipoConsumoEsgoto(faturamentoSimulacaoComando.getCodigoTipoConsumoEsgoto().toString());

			if(faturamentoSimulacaoComando.getConsumoTarifa() != null){

				form.setIdConsumoTarifa(faturamentoSimulacaoComando.getConsumoTarifa().getId().toString());
			}else{

				form.setIdConsumoTarifa("");
			}

			form.setTituloComando(faturamentoSimulacaoComando.getDescricaoTitulo());
		}
	 ...
	 * @date 17/12/2013
	 */
	private void pesquisarLocalidade(AtualizarComandoSimulacaoFaturamentoActionForm form, String objetoConsulta){
	 ...
	 * @date 17/12/2013
	 */
	private void pesquisarSetorComercial(AtualizarComandoSimulacaoFaturamentoActionForm form, String objetoConsulta){
	 ...
	 * @date 17/12/2013
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, AtualizarComandoSimulacaoFaturamentoActionForm form){
	 ...
	 * @date 17/12/2013
	 */
	private void pesquisarQuadra(AtualizarComandoSimulacaoFaturamentoActionForm form, String objetoConsulta,
	 ...
	 * @date 22/12/2013
	 */
	private void pesquisarRota(AtualizarComandoSimulacaoFaturamentoActionForm form, String objetoConsulta, HttpServletRequest request){
