 ...
 * @date 17/12/2013
 */
public class InserirComandoSimulacaoFaturamentoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		InserirComandoSimulacaoFaturamentoActionForm formulario = (InserirComandoSimulacaoFaturamentoActionForm) actionForm;
		...
		fachada.inserirComandoSimulacaoFaturamento(comandoHelper);

		montarPaginaSucesso(httpServletRequest, "Comando de Simulação de Faturamento inserido com sucesso.",
						"Inserir outro Comando de Simulação de Faturamento", "exibirInserirComandoSimulacaoFaturamentoAction.do?menu=sim");
