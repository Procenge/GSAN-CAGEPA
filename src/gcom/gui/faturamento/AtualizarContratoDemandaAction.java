...
public class AtualizarContratoDemandaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ContratoDemanda contratoDemanda = (ContratoDemanda) sessao.getAttribute("contratoDemandaAtualizar");
		...
		montarPaginaSucesso(httpServletRequest, "Contrato de Demanda de código " + contratoDemanda.getId().toString()
						+ " atualizado com sucesso.", "Realizar outra Manutenção de Contrato de Demanda",
