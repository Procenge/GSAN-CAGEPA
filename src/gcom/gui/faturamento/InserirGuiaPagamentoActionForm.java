...
public class InserirGuiaPagamentoActionForm
				extends ActionForm {
	...
	// GuiaPagamento Prestação
	private Collection<GuiaPagamentoPrestacao> guiaPagamentoPrestacoes = new ArrayList<GuiaPagamentoPrestacao>();
	...
	/**
	 * @return the guiaPagamentoPrestacoes
	 */
	public Collection<GuiaPagamentoPrestacao> getGuiaPagamentoPrestacoes(){
	 ...
	 *            the guiaPagamentoPrestacoes to set
	 */
	public void setGuiaPagamentoPrestacoes(Collection<GuiaPagamentoPrestacao> guiaPagamentoPrestacoes){

		this.guiaPagamentoPrestacoes = guiaPagamentoPrestacoes;
	}

	public String getDuploClique(){

		return duploClique;
	}

	public void setDuploClique(String duploClique){
	...
	/**
	 * @return the numeroContratoParcelOrgaoPublico
	 */
	...
	/**
	 * @param numeroContratoParcelOrgaoPublico
	 *            the numeroContratoParcelOrgaoPublico to set
	 */
