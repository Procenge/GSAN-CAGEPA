...
public class PesquisarSelecionarRotaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		filtroRota.setCampoOrderBy(FiltroRota.FATURAMENTO_GRUPO_ID, FiltroRota.GERENCIA_REGIONAL_ID, FiltroRota.LOCALIDADE_ID,
		...
		if(pesquisarActionForm.get("idGrupoFaturamento") != null){
			...
			String grupoFaturamentoJSP = (String) pesquisarActionForm.get("idGrupoFaturamento");

			if(!grupoFaturamentoJSP.equalsIgnoreCase(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO))){
				peloMenosUmParametroInformado = true;

				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.FATURAMENTO_GRUPO_ID, grupoFaturamentoJSP));
			}
		}
		...
		if(pesquisarActionForm.get("idGerenciaRegional") != null){
			...
			String gerenciaRegionalJSP = (String) pesquisarActionForm.get("idGerenciaRegional");

			if(!gerenciaRegionalJSP.equalsIgnoreCase(String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO))){
				peloMenosUmParametroInformado = true;

				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.GERENCIA_REGIONAL_ID, gerenciaRegionalJSP));
			}
		}
		...
		if(pesquisarActionForm.get("idLocalidade") != null){
			...
			if(!localidadeJSP.equalsIgnoreCase(String.valueOf(""))){
				...
				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.LOCALIDADE_ID, localidadeJSP));
			}
		}
		...
		if(pesquisarActionForm.get("numeroSetorComercial") != null){
			...
			setorComercialJSP = (String) pesquisarActionForm.get("numeroSetorComercial");
			...
			if(!setorComercialJSP.equalsIgnoreCase(String.valueOf(""))){
				...
				pesquisarSetorComercial(localidadeJSP, setorComercialJSP, fachada);

				peloMenosUmParametroInformado = true;

				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.SETOR_COMERCIAL_CODIGO, setorComercialJSP));
			}
		}
		...
		if(pesquisarActionForm.get("idRota") != null){
			...
			if(!rotaJSP.equalsIgnoreCase(String.valueOf(""))){
				...
				filtroRota.adicionarParametro(new ParametroSimples(FiltroRota.CODIGO_ROTA, rotaJSP));
			}
		}
	 ...
	 * @param fachada
	 */
	private void pesquisarSetorComercial(String localidadeID, String setorComercialCD, Fachada fachada){
