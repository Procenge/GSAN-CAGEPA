 ...
 * @since 12/09/2007
 */
public class ExibirGerarRelatorioVolumesFaturadosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirGerarRelatorioVolumesFaturados");
		...
		if(httpServletRequest.getParameter("menu") != null && !httpServletRequest.getParameter("menu").equals("")){
			...
			if(idLocalidade != null && !idLocalidade.equals("")){
				...
				if(colecaoLocalidades != null && !colecaoLocalidades.isEmpty()){
					...
					gerarRelatorioVolumesFaturadosActionForm.setIdLocalidade(localidade.getId().toString());
					gerarRelatorioVolumesFaturadosActionForm.setNomeLocalidade(localidade.getDescricao());
					httpServletRequest.setAttribute("nomeCampo", "mesAno");

				}else{
					gerarRelatorioVolumesFaturadosActionForm.setIdLocalidade("");
					gerarRelatorioVolumesFaturadosActionForm.setNomeLocalidade("Localidade Inexistente");
