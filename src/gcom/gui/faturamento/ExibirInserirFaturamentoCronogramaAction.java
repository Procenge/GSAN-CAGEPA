 ...
 */
public class ExibirInserirFaturamentoCronogramaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirFaturamentoCronograma");

		// Mudar isso quando tiver esquema de segurança
		HttpSession sessao = httpServletRequest.getSession(false);

		// limpa sessao
		sessao.removeAttribute("FaturamentoActionForm");

		FaturamentoActionForm faturamentoActionForm = new FaturamentoActionForm();

		Fachada fachada = Fachada.getInstancia();

		// FiltroFaturamentoGrupoCronogramaMensal filtroFaturamentoGrupoMensal = new
