 ...
 * @date 07/02/2007
 */
public class ExibirInserirTipoCreditoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("exibirInserirTipoCredito");
		...
		if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
			...
			throw new ActionServletException("atencao.pesquisa.nenhum_registro_tabela", null, "Tipo do Lançamento do Item Contábi");
		}else{
		...
		// filtroLancamentoItemContabil.adicionarParametro(new
		// ParametroSimples(FiltroLancamentoItemContabil.ID,
		// ConstantesSistema.INDICADOR_USO_ATIVO));

		sessao.setAttribute("colecaoTipoLancamentoContabil", fachada.pesquisar(filtroLancamentoItemContabil, LancamentoItemContabil.class
						.getName(), "Tipo do Lançamento do Item Contábil"));

		httpServletRequest.setAttribute("colecaoTipoLancamentoContabil", colecaoPesquisa);
