 ...
 */
public class ExibirFiltrarTipoCreditoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaoTipoLancamentoContabil = fachada.pesquisar(filtroLancamentoItemContabil, LancamentoItemContabil.class.getName());

		if(colecaoTipoLancamentoContabil != null && !colecaoTipoLancamentoContabil.isEmpty()){
			sessao.setAttribute("colecaoTipoLancamentoContabil", colecaoTipoLancamentoContabil);
		}else{
			throw new ActionServletException("atencao.naocadastrado", null, "CreditoTipo");
		}
