 ...
 * @since 31/10/2006
 */
public class ExibirManterTipoCreditoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroCreditoTipo filtroCreditoTipo = (FiltroCreditoTipo) sessao.getAttribute("filtroTipoCredito");

		// Aciona o controle de paginação para que sejam pesquisados apenas
		// os registros que aparecem na página
		Collection colecaoCreditoTipo = new ArrayList();
		if(filtroCreditoTipo != null && !filtroCreditoTipo.equals("")){
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroCreditoTipo, CreditoTipo.class.getName());
			colecaoCreditoTipo = (Collection) resultado.get("colecaoRetorno");
		...
		if(colecaoCreditoTipo != null && !colecaoCreditoTipo.isEmpty()){
			...
			if(colecaoCreditoTipo.size() == 1
				...
				if(httpServletRequest.getParameter("atualizar") != null){
					retorno = actionMapping.findForward("exibirAtualizarTipoCredito");
