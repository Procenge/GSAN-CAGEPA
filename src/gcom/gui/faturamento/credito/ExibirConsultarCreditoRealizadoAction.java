 ...
 */
public class ExibirConsultarCreditoRealizadoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirConsultarCreditoRealizado");
		...
		if(tipoConsulta.equalsIgnoreCase("conta")){
			...
			if(idConta != null && !idConta.equalsIgnoreCase("")){
				...
				// remove a coleção de créditos realizados histórico
			...
			if(idConta != null && !idConta.equalsIgnoreCase("")){
				...
				filtroConta.adicionarParametro(new ParametroSimples(FiltroConta.ID, new Integer(idConta)));
			...
			if(sessao.getAttribute("colecaoContaCreditosRealizados") == null){
				...
				// seta o código da conta no filtro
				filtroCreditoRealizado.adicionarParametro(new ParametroSimples(FiltroCreditoRealizado.CONTA_ID, conta.getId()));

				// pesquisa a coleção de créditos realizados
				colecaoContaCreditosRealizados = fachada.pesquisar(filtroCreditoRealizado, CreditoRealizado.class.getName());

				// seta a coleção de créditos realizados na sessão
				sessao.setAttribute("colecaoContaCreditosRealizados", colecaoContaCreditosRealizados);
			}
			// ====================================================================
			...
			if(sessao.getAttribute("colecaoContaCreditosRealizadosHistorico") == null){
				...
				// carrega o tipo de crédito
				filtroCreditoRealizadoHistorico.adicionarCaminhoParaCarregamentoEntidade("creditoTipo");

				// seta o código da conta histórico no filtro
				filtroCreditoRealizadoHistorico.adicionarParametro(new ParametroSimples(FiltroCreditoRealizadoHistorico.CONTA_HISTORICO_ID,
								contaHistorico.getId()));

				// pesquisa a coleção de créditos realizados histórico
				colecaoContaCreditosRealizadosHistorico = fachada.pesquisar(filtroCreditoRealizadoHistorico,
								CreditoRealizadoHistorico.class.getName());

				// seta a coleção de créditos realizados histórico na sessão
				sessao.setAttribute("colecaoContaCreditosRealizadosHistorico", colecaoContaCreditosRealizadosHistorico);
			}
			// ====================================================================
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaConsultaCreditoRealizado") != null){
			sessao.setAttribute("caminhoRetornoTelaConsultaCreditoRealizado", httpServletRequest
