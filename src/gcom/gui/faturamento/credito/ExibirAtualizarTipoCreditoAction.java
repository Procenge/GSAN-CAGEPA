 ...
 * @date 30/10/2006
 */
public class ExibirAtualizarTipoCreditoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarTipoCredito");
		...
		if(sessao.getAttribute("colecaoCreditoTipoTela") == null){
			...
			if(sessao.getAttribute("objetoTipoCredito") != null){
				...
				CreditoTipo creditoTipo = (CreditoTipo) sessao.getAttribute("objetoTipoCredito");

				sessao.setAttribute("idTipoCredito", creditoTipo.getId().toString());

				sessao.setAttribute("creditoTipo", creditoTipo);

				atualizarTipoCreditoActionForm.setCodigo(creditoTipo.getId().toString());

				atualizarTipoCreditoActionForm.setDescricao(creditoTipo.getDescricao());

				atualizarTipoCreditoActionForm.setAbreviatura(creditoTipo.getDescricaoAbreviada());

				atualizarTipoCreditoActionForm.setTipoLancamentoContabil(creditoTipo.getLancamentoItemContabil().getId().toString());

				atualizarTipoCreditoActionForm.setIndicadorgeracaoAutomaica("" + creditoTipo.getIndicadorGeracaoAutomatica());

				String valorAux = Util.formatarMoedaReal(creditoTipo.getValorLimite());
				atualizarTipoCreditoActionForm.setValorLimiteCredito("" + valorAux);

				atualizarTipoCreditoActionForm.setIndicativoUso("" + creditoTipo.getIndicadorUso());
				...
				if(httpServletRequest.getParameter("idRegistroAtualizacao") == null
								|| httpServletRequest.getParameter("idRegistroAtualizacao").equals("")){
					creditoTipo = (CreditoTipo) sessao.getAttribute("objetoCreditoTipo");
				}else{
					idTipoCredito = (String) httpServletRequest.getParameter("idRegistroAtualizacao");
				...
				if(idTipoCredito != null){
					...
					filtroCreditoTipo.adicionarParametro(new ParametroSimples(FiltroCreditoTipo.ID, idTipoCredito));
				...
				if(idTipoCredito == null){
					if(sessao.getAttribute("idRegistroAtualizacao") != null){
						idTipoCredito = (String) sessao.getAttribute("idRegistroAtualizacao");
					}else{
						creditoTipo = (CreditoTipo) sessao.getAttribute("creditoTipo");
		...
		if(httpServletRequest.getParameter("desfazer") != null && httpServletRequest.getParameter("desfazer").equalsIgnoreCase("S")){
			...
			if(sessao.getAttribute("idRegistroAtualizacao") != null && !sessao.getAttribute("idRegistroAtualizacao").equals("")){
				creditoTipoID = (String) sessao.getAttribute("idRegistroAtualizacao");
			}
			...
			if((creditoTipoID == null) && (id == null)){
				...
				CreditoTipo creditoTipo = (CreditoTipo) sessao.getAttribute("objetoCreditoTipo");
		...
		httpServletRequest.setAttribute("colecaoCreditoTipoTela", sessao.getAttribute("colecaoCreditoTipoValorTela"));
