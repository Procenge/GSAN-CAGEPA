...
public class InserirSelecaoRotaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("colecaoRotasSelecionadas") != null){
			...
			Collection colecaoRotasSelecionadas = (Collection) sessao.getAttribute("colecaoRotasSelecionadas");
			...
			if(pesquisarActionForm.get("idRotaSelecao") != null){
				...
				while(rotasSelecionadas.length > indexArray){
					...
					colecaoRotasSelecionadasIterator = colecaoRotasSelecionadas.iterator();

					while(colecaoRotasSelecionadasIterator.hasNext()){

						rotaInserir = (Rota) colecaoRotasSelecionadasIterator.next();
				...
				if(sessao.getAttribute("colecaoRotasSelecionadasUsuario") != null){
					Collection colecaoRotasSelecionadasUsuarioSessao = (Collection) sessao.getAttribute("colecaoRotasSelecionadasUsuario");

					colecaoRotasSelecionadasUsuarioSessao.addAll(colecaoRotasSelecionadasUsuario);
				}else{
					sessao.setAttribute("colecaoRotasSelecionadasUsuario", colecaoRotasSelecionadasUsuario);
				}
