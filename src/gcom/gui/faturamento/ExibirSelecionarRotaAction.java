...
public class ExibirSelecionarRotaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Seta o retorno
		ActionForward retorno = actionMapping.findForward("exibirSelecionarRota");
		...
		if(httpServletRequest.getParameter("limparForm") != null){
			pesquisarActionForm.set("idGrupoFaturamento", String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO));
			pesquisarActionForm.set("idGerenciaRegional", String.valueOf(ConstantesSistema.NUMERO_NAO_INFORMADO));
		...
		Collection colecaoFaturamentoGrupo = fachada
						.pesquisarFaturamentoGrupoComCronogramaMensalParaMesCorrenteSemGupoSelecionado(grupoSelecionado);
		...
		if(objetoConsulta != null && !objetoConsulta.trim().equalsIgnoreCase("")){
			...
			switch(Integer.parseInt(objetoConsulta)){
				...
				case 1:
					...
					pesquisarLocalidade(pesquisarActionForm, fachada, httpServletRequest);
				...
				case 2:
					...
					pesquisarSetorComercial(pesquisarActionForm, fachada, httpServletRequest);
				...
				case 3:
					...
					SetorComercial setorComercial = pesquisarSetorComercial(pesquisarActionForm, fachada, httpServletRequest);
		...
		if(httpServletRequest.getParameter("tipoConsulta") != null){
			...
			if(tipoConsulta.equalsIgnoreCase("localidade")){
				pesquisarActionForm.set("idLocalidade", String.valueOf(httpServletRequest.getParameter("idCampoEnviarDados")));
				pesquisarActionForm
								.set("descricaoLocalidade", String.valueOf(httpServletRequest.getParameter("descricaoCampoEnviarDados")));
			}else{
				pesquisarActionForm.set("numeroSetorComercial", String.valueOf(httpServletRequest.getParameter("idCampoEnviarDados")));
	 ...
	 */
	private void pesquisarLocalidade(DynaValidatorForm pesquisarActionForm, Fachada fachada, HttpServletRequest httpServletRequest){
		...
		if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
			...
			pesquisarActionForm.set("idLocalidade", String.valueOf(objetoLocalidade.getId()));
			pesquisarActionForm.set("descricaoLocalidade", objetoLocalidade.getDescricao());
	 ...
	 * @param httpServletRequest
	 */
	private SetorComercial pesquisarSetorComercial(DynaValidatorForm pesquisarActionForm, Fachada fachada,
		...
		if(localidadeID == null || localidadeID.trim().equalsIgnoreCase("")){
			...
			pesquisarActionForm.set("descricaoSetorComercial", "Informe a localidade.");
			...
			String setorComercialCD = (String) pesquisarActionForm.get("numeroSetorComercial");
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				pesquisarActionForm.set("numeroSetorComercial", String.valueOf(objetoSetorComercial.getCodigo()));
				pesquisarActionForm.set("idSetorComercial", String.valueOf(objetoSetorComercial.getId()));
				pesquisarActionForm.set("descricaoSetorComercial", objetoSetorComercial.getDescricao());
	 ...
	 * @param httpServletRequest
	 */
	private Rota pesquisarRota(DynaValidatorForm pesquisarActionForm, Fachada fachada, HttpServletRequest httpServletRequest,
		...
		if(setorComercial == null){
			...
			if(colecaoPesquisa == null || colecaoPesquisa.isEmpty()){
				...
				pesquisarActionForm.set("idRota", "");
				pesquisarActionForm.set("descricaoRota", "Rota inexistente.");
				httpServletRequest.setAttribute("corRotaMensagem", "exception");

				httpServletRequest.setAttribute("nomeCampo", "idRota");

			}else{
				objetoRota = (Rota) Util.retonarObjetoDeColecao(colecaoPesquisa);

				pesquisarActionForm.set("idRota", String.valueOf(objetoRota.getCodigo()));
				pesquisarActionForm.set("descricaoRota", objetoRota.getLeituraTipo().getDescricao());
