...
public class FiltrarFaturamentoCronogramaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("retornarFiltroFaturamentoCronograma");
		 ...
		 * ParametroSimples(FiltroFaturamentoGrupo.ANO_MES_REFERENCIA,
		 * ano+mes));
		 */
		...
		if(parametroInformado){
			sessao.setAttribute("filtroFaturamentoGrupoCronogramaMensal", filtroFaturamentoGrupoCronogramaMensal);
		}else{
