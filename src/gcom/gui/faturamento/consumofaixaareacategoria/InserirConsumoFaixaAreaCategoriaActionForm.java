...
public class InserirConsumoFaixaAreaCategoriaActionForm
	...
	public ConsumoFaixaAreaCategoria setFormValues(ConsumoFaixaAreaCategoria consumoFaixaAreaCategoria){
		...
		if(getCategoria() != null && !getCategoria().equals("")){
			...
			categoria.setId(Integer.parseInt(getCategoria()));
			consumoFaixaAreaCategoria.setCategoria(categoria);
		}

		consumoFaixaAreaCategoria.setUltimaAlteracao(new Date());
		consumoFaixaAreaCategoria.setIndicadorUso(ConstantesSistema.INDICADOR_USO_ATIVO);
