 ...
 */
public class ExibirManterFaturamentoCronogramaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("manterFaturamentoCronograma");
		...
		// FiltroFaturamentoGrupoCronogramaMensal filtroFaturamentoGrupoCronogramaMensal = new
		...
		// if(httpServletRequest.getAttribute("anoMes") != null &&
		// !httpServletRequest.getAttribute("anoMes").toString().trim().equalsIgnoreCase("")){
		// filtroFaturamentoGrupoCronogramaMensal.adicionarParametro(new
		// ParametroSimples(FiltroFaturamentoGrupoCronogramaMensal.ANO_MES_REFERENCIA,
		...
		Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroFaturamentoGrupoCronogramaMensal,
		...
		// String faturamentoGrupoCronogramaMensail1 = ((FaturamentoGrupoCronogramaMensal)
		// a).getAnoMesReferencia().toString();
		// String faturamentoGrupoCronogramaMensail2 = ((FaturamentoGrupoCronogramaMensal)
		// b).getAnoMesReferencia().toString();
		//	
		...
		if(faturamentoGrupoCronogramaMensais.isEmpty()){
			...
			if(faturamentoGrupoCronogramaMensais.size() == 1 && identificadorAtualizar != null && !identificadorAtualizar.trim().equals("")){
				...
				sessao.setAttribute("faturamentoGruposCronogramaMensais", faturamentoGrupoCronogramaMensais);
