...
public class AtualizarComandoAtividadeFaturamentoRotasAction
				extends GcomAction {
		...
		if(sessao.getAttribute("colecaoRotasSelecionadasUsuario") != null){
			...
			if(!colecaoRotasSelecionadasUsuario.isEmpty()){
				...
				if(colecaoFaturamentoAtividadeCronogramaRotaHabilitadas == null
								|| colecaoFaturamentoAtividadeCronogramaRotaHabilitadas.isEmpty()){
					throw new ActionServletException("atencao.pesquisa.nenhuma.rota_habilitada_selecionada");
				}
