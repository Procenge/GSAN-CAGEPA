		...
		if(httpServletRequest.getParameter("objetoConsulta") != null
			...
			if(idDebitoTipo != null && !idDebitoTipo.trim().equals("")){
				...
				if(debitoTipo != null){
					...
					// [FS0008] - Verificar Existência de débito acobrar para o registro de
					// atendimento
					...
					// Inclui no valor total do serviço o valor padrão do débito tipo
			...
			if(httpServletRequest.getParameter("objetoConsulta") != null
				...
				if(idOrdemServico != null && !idOrdemServico.trim().equals("")){
					...
					if(colecaoOrdemServico != null && !colecaoOrdemServico.isEmpty()){
						...
						if(ordemServico.getRegistroAtendimento() != null){
							// Registro de Atendimento da Ordem de Serviço não está associado a um
							// imóvel
						...
						if(ordemServico.getServicoTipo().getDebitoTipo() != null){
							...
							// Caso OS com debito tipo: sugere o valor do serviço.
							if(ordemServico.getServicoTipo().getValor() != null){
								...
								// exibe o valor do serviço
								inserirDebitoACobrarActionForm.setValorTotalServico(Util.formatarMoedaReal(ordemServico.getServicoTipo()
												.getValor()));
								// habilita o campo apenas se o usuário tiver permissão especial,
								// caso contrário o campo permanece desabilitado.
			...
			if(httpServletRequest.getParameter("objetoConsulta") != null
				...
				if(idImovelInformado != null && !idImovelInformado.trim().equals("")){
					...
					if(colecaoImovel != null && !colecaoImovel.isEmpty()){
						...
						// [UC0183][FS0018] – Validar existência do imóvel
			...
			if(idImovel != null && !idImovel.equals("")){
				...
				// [FS0003 - Verificar situação ligação de água e esgoto]
				if(imovelPesquisado != null && !imovelPesquisado.isEmpty()){
					Imovel imovel = imovelPesquisado.iterator().next();
				...
				if(imovelPesquisado != null && !imovelPesquisado.isEmpty()){
					...
					/*
					 * Sugere a data do Início de Cobrança como sendo a
					 * "data referência" do grupo de faturamento do qual o
					 * imóvel faz parte.
