 ...
 */
public class InserirSubCategoriaConsumoTarifaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirInserirSubCategoriaConsumoTarifa");
		...
		String idCategoria = inserirSubCategoriaConsumoTarifaActionForm.getSlcCategoria();

		String idSubCategoria = inserirSubCategoriaConsumoTarifaActionForm.getSlcSubCategoria();
		...
		if(sessao.getAttribute("colecaoConsumoTarifaCategoria") != null){
			...
			colecaoConsumoTarifaCategoria = (Collection) sessao.getAttribute("colecaoConsumoTarifaCategoria");
			...
			if(colecaoCategoriaSemHelper.contains(consumoTarifaCategoria)){
				...
				colecaoConsumoTarifaCategoria.add(new CategoriaFaixaConsumoTarifaHelper(numeroFaixasCategoria, consumoTarifaCategoria));
			}
		}else{
			...
			sessao.setAttribute("colecaoConsumoTarifaCategoria", colecaoConsumoTarifaCategoria);
		}
		...
		// Consumo mínimo
		consumoTarifaCategoria.setNumeroConsumoMinimo(new Integer(inserirSubCategoriaConsumoTarifaActionForm.getConsumoMinimo()));

		// Tarifa mínima
		consumoTarifaCategoria.setValorTarifaMinima(Util.formatarMoedaRealparaBigDecimal(inserirSubCategoriaConsumoTarifaActionForm
