 ...
 */
public class ExcluirCategoriaConsumoTarifaSubCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("manter") == null){
			retorno = actionMapping.findForward("inserirConsumoTarifaSubCategoria");
			...
			if(sessao.getAttribute("colecaoConsumoTarifaCategoria") != null){
				...
				while(colecaoConsumoTarifaCategoriaIterator.hasNext()){
					CategoriaFaixaConsumoTarifaHelper categoriaFaixaConsumoTarifaHelper = (CategoriaFaixaConsumoTarifaHelper) colecaoConsumoTarifaCategoriaIterator
									.next();
					if(obterTimestampIdObjeto(categoriaFaixaConsumoTarifaHelper.getConsumoTarifaCategoria()) == Long
			...
			retorno = actionMapping.findForward("manterConsumoTarifaExistenteAction");
			...
			if(sessao.getAttribute("colecaoCategoria") != null){
				colecaoConsumoTarifaCategoria = (Collection) sessao.getAttribute("colecaoCategoria");
				Iterator colecaoConsumoTarifaCategoriaIterator = colecaoConsumoTarifaCategoria.iterator();
