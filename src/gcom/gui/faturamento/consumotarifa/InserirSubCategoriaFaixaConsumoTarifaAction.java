 ...
 */
public class InserirSubCategoriaFaixaConsumoTarifaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("inserirSubCategoriaFaixaConsumoTarifa");
		...
		String consumoM = inserirSubCategoriaFaixaConsumoTarifaActionForm.getLimiteSuperiorFaixa();
		if(consumoM.equalsIgnoreCase("99999999")){
			retorno = actionMapping.findForward("inserirSubCategoriaConsumoTarifa");
		}

		Integer consumoMin = new Integer((String) inserirSubCategoriaFaixaConsumoTarifaActionForm.getLimiteSuperiorFaixa());
		...
		consumoTarifaFaixa.setNumeroConsumoFaixaIFim(new Integer(inserirSubCategoriaFaixaConsumoTarifaActionForm.getLimiteSuperiorFaixa()));
		consumoTarifaFaixa.setValorConsumoTarifa(Util.formatarMoedaRealparaBigDecimal(inserirSubCategoriaFaixaConsumoTarifaActionForm
						.getValorM3Faixa()));
