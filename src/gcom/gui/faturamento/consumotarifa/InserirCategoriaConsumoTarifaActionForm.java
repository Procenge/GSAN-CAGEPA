...
public class InserirCategoriaConsumoTarifaActionForm
	...
	private String indicadorTarifaEsgotoPropria;
	...
	public String getValorTarifaMinimaEsgoto(){

		return valorTarifaMinimaEsgoto;
	}

	public void setValorTarifaMinimaEsgoto(String valorTarifaMinimaEsgoto){

		this.valorTarifaMinimaEsgoto = valorTarifaMinimaEsgoto;
	}

	public String getIndicadorTarifaEsgotoPropria(){

		return indicadorTarifaEsgotoPropria;
	}

	public void setIndicadorTarifaEsgotoPropria(String indicadorTarifaEsgotoPropria){

		this.indicadorTarifaEsgotoPropria = indicadorTarifaEsgotoPropria;
	}
