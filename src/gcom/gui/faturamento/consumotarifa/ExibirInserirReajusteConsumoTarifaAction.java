 ...
 */
public class ExibirInserirReajusteConsumoTarifaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirReajusteConsumoTarifa");
		...
		for(int i = 0; i < ids.length; i++){
			...
			Collection colecaoConsumoTarifaVigencia = (Collection) fachada.pesquisar(filtroConsumoTarifaVigencia,
