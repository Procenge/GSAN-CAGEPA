 ...
 * @date 07/12/2006
 */
public class AssociarTarifaConsumoImoveisActionForm
	...
	/**
	 * @param tarifaAnteriorHidden
	 *            O tarifaAnteriorHidden a ser setado.
	 */
	...
	public void setTarifaEspecial(String tarifaEspecial){

		this.tarifaEspecial = tarifaEspecial;
	}

	public String getDataValidadeTarifaEspecial(){

		return dataValidadeTarifaEspecial;
	}
