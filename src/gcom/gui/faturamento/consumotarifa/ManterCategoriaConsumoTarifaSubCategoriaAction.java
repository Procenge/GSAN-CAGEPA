 ...
 */
public class ManterCategoriaConsumoTarifaSubCategoriaAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirManterCategoriaConsumoTarifaSubCategoria");
		...
		String idSubCategoria = inserirCategoriaConsumoTarifaActionForm.getSlcSubCategoria();
		...
		Collection colecaoSubCategoriaPesquisadas = fachada.pesquisar(filtroSubCategoria, Subcategoria.class.getName());

		Subcategoria subcategoriaSelected = (Subcategoria) Util.retonarObjetoDeColecao(colecaoSubCategoriaPesquisadas);
			...
			if(this.existeNaColecao(consumoTarifaHelper, httpServletRequest)){
				...
				if(novaCategoria != null && novaCategoria.equals("sim") && !"sim".equals(trava)){
					...
					while(iteratorColecaoCategoria.hasNext()){
						...
						if(helper.getConsumoTarifaCategoria().getSubCategoria().getId().equals(
										consumoTarifaHelper.getConsumoTarifaCategoria().getSubCategoria().getId())){
	...
	private boolean existeNaColecao(CategoriaFaixaConsumoTarifaHelper categoriaFaixaConsumoTarifaHelperForm,
		...
		if(colecaoCategoria != null){
			while(itera.hasNext()){
				...
				if(categoriaHelper.getConsumoTarifaCategoria().getCategoria().getId().intValue() == categoriaFaixaConsumoTarifaHelperForm
								.getConsumoTarifaCategoria().getCategoria().getId().intValue()
								&& categoriaHelper.getConsumoTarifaCategoria().getSubCategoria().getId().intValue() == categoriaFaixaConsumoTarifaHelperForm
												.getConsumoTarifaCategoria().getSubCategoria().getId().intValue()){
