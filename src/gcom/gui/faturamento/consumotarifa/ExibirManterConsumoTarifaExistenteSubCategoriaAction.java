 ...
 * @since 18/07/2006
 */
public class ExibirManterConsumoTarifaExistenteSubCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("manterConsumoTarifaExistenteSubCategoriaAction");
		...
		if((idVigencia != null) && (!idVigencia.equals(""))){
						...
						for(Iterator it = colecaoFaturamentoAtividadeCronograma.iterator(); it.hasNext();){
							...
							if(colecaoRetornoFaturamentoAtividadeCronograma != null
								...
								httpServletRequest.setAttribute("caminhoActionConclusao",
												"/gsan/exibirManterConsumoTarifaExistenteSubCategoriaAction.do?idVigencia=" + ids[i]
																+ "&recarregar=false");
			...
			filtroConsumoTarifaCategoria.setCampoOrderBy(FiltroConsumoTarifaCategoria.CATEGORIA_ID);
			...
			while(iterator.hasNext()){
				...
				categoriaFaixaConsumoTarifaHelper.setColecaoFaixas(consumoTarifaCategoria.getConsumoTarifaFaixas());
