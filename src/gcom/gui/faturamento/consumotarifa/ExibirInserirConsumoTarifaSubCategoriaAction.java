 ...
 */
public class ExibirInserirConsumoTarifaSubCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirConsumoTarifaSubCategoria");
		...
		if((sessao.getAttribute("Vigencia") != null) && (!sessao.getAttribute("Vigencia").equals(""))){
		...
		if(inserirConsumoTarifaSubCategoriaActionForm.getSlcDescTarifa() != null
			...
			filtroConsumoTarifaVigencia.adicionarParametro(new ParametroSimples(FiltroConsumoTarifaVigencia.CONSUMO_TARIFA,
			...
			Collection vigencias = fachada.pesquisar(filtroConsumoTarifaVigencia, ConsumoTarifaVigencia.class.getName());
