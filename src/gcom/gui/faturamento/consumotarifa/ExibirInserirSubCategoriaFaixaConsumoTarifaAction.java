 ...
 */
public class ExibirInserirSubCategoriaFaixaConsumoTarifaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if((httpServletRequest.getParameter("parametro4") != null) && (!httpServletRequest.getParameter("parametro4").equals(""))){
			String subCategoriaSelected = (String) httpServletRequest.getParameter("parametro4");
		...
		if((httpServletRequest.getParameter("limpaFaixa") != null) && (httpServletRequest.getParameter("limpaFaixa").equals("1"))){
			sessao.removeAttribute("InserirSubCategoriaFaixaConsumoTarifaActionForm");
		}
