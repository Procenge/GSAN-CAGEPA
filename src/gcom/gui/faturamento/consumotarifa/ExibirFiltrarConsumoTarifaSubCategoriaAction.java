 ...
 */
public class ExibirFiltrarConsumoTarifaSubCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarConsumoTarifaSubCategoria");
		...
		if(filtrarConsumoTarifaActionForm.getAtualizarFiltro() == null){
			...
			httpServletRequest.setAttribute("nomeCampo", "descTarifa");
		}
