 ...
 * @author Tiago Moreno
 */
public class InserirConsumoTarifaSubCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String slcDescTarifa = inserirConsumoTarifaSubCategoriaActionForm.getSlcDescTarifa();
		...
		fachada.informarConsumoTarifaSubcategoria(consumoTarifa, consumoTarifaVigencia, colecaoConsumoTarifaCategoria);

		if(consumoTarifa.getDescricao() == null){
			String idConsumo = inserirConsumoTarifaSubCategoriaActionForm.getSlcDescTarifa();
			...
			montarPaginaSucesso(httpServletRequest, consumoSelect.getDescricao() + " de vigência "
							+ gcom.util.Util.formatarData(consumoTarifaVigencia.getDataVigencia()) + " informada com sucesso.",
							"Informar outra Tarifa de Consumo por Subcategoria", "exibirInserirConsumoTarifaSubCategoriaAction.do?menu=sim");
			...
			montarPaginaSucesso(httpServletRequest, consumoTarifa.getDescricao() + " de vigência "
							...
							"Inserir outra Tarifa de Consumo", "exibirInserirConsumoTarifaSubCategoriaAction.do?menu=sim");
		}
