 ...
 */
public class ManterConsumoTarifaExistenteSubCategoriaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ConsumoTarifaVigencia consumoTarifaVigencia = (ConsumoTarifaVigencia) gcom.util.Util.retonarObjetoDeColecao((Collection) sessao
						.getAttribute("colecaoVigencia"));

		consumoTarifaVigencia.setId(consumoTarifaVigencia.getId());
		consumoTarifaVigencia.setDataVigencia(gcom.util.Util.converteStringParaDate(dataVigencia));
		...
		while(iteratorColecaoCategoriaFaixaConsumoTarifaHelper.hasNext()){
			...
			if(requestMap.get("ValorConMinimo."
				...
				consumoMinimo = (requestMap.get("ValorConMinimo."
								+ categoriaFaixaConsumoTarifaHelper.getConsumoTarifaCategoria().getSubCategoria().getDescricao()))[0];
			...
			if(requestMap.get("ValorTarMin."
				...
				categoriaFaixaConsumoTarifaHelper.getConsumoTarifaCategoria().setValorTarifaMinima(
								Util.formatarMoedaRealparaBigDecimal(tarifaMinima));
			}
...
.getAttribute("colecaoCategoria"),
		...
		montarPaginaSucesso(httpServletRequest, consumoTarifaVigencia.getConsumoTarifa().getDescricao() + " de vigência "
						...
						"Atualizar outra tarifa de consumo", "exibirFiltrarConsumoTarifaSubCategoriaAction.do?menu=sim");
