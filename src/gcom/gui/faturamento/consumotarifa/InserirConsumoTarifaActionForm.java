 ...
 */
public class InserirConsumoTarifaActionForm
	...
	private String inTarifaEsgotoPropria;
	...
	public String getSlcCalculoTipo(){

		return slcCalculoTipo;
	}

	public void setSlcCalculoTipo(String slcCalculoTipo){

		this.slcCalculoTipo = slcCalculoTipo;
	}

	public String getInTarifaEsgotoPropria(){

		return inTarifaEsgotoPropria;
	}

	public void setInTarifaEsgotoPropria(String inTarifaEsgotoPropria){

		this.inTarifaEsgotoPropria = inTarifaEsgotoPropria;
	}
