...
public class CategoriaFaixaConsumoTarifaHelper {
	...
	public boolean equals(Object other){
		...
		return ((this.getConsumoTarifaCategoria().getCategoria().getId().equals(castOther.getConsumoTarifaCategoria().getCategoria()
						.getId())));
	}

	public CategoriaFaixaConsumoTarifaHelper(Integer quantidadesFaixa, ConsumoTarifaCategoria consumoTarifaCategoria) {
