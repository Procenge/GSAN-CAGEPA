 ...
 */
public class ExcluirCategoriaFaixaConsumoSubCategoriaTarifaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessaoFaixa != null){
			colecaoFaixa = (Collection) sessaoFaixa.getAttribute("colecaoFaixa");
			...
			while(colecaoFaixaIterator.hasNext()){
				...
				if(consumoTarifaFaixa.getUltimaAlteracao().getTime() == Long.parseLong(posicaoExcluir)){
