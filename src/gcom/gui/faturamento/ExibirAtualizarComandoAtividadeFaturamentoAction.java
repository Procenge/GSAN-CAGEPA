 ...
 * @author rodrigo
 */
public class ExibirAtualizarComandoAtividadeFaturamentoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirAtualizarComandoAtividadeFaturamento");
		...
		if(sessao.getAttribute("faturamentoAtividadeCronograma") != null){
			...
			sessao.setAttribute("faturamentoGrupoId", faturamentoAtividadeCronograma.getFaturamentoGrupoCronogramaMensal()
		...
		if(httpServletRequest.getParameter("faturamentoAtividadeCronogramaID") != null){
			faturamentoAtividadeCronogramaId = (String) httpServletRequest.getParameter("faturamentoAtividadeCronogramaID");
		}

		StatusWizard statusWizard = new StatusWizard("atualizarComandoAtividadeFaturamentoWizardAction",
						"atualizarComandoAtividadeFaturamentoAction", "cancelarAtualizarComandoAtividadeFaturamentoAction",
						...
						"exibirAtualizarComandoAtividadeFaturamentoAction.do?faturamentoAtividadeCronogramaID="
										+ faturamentoAtividadeCronogramaId, faturamentoAtividadeCronogramaId);
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(1, "ComandoA.gif", "ComandoD.gif",
						"exibirAtualizarComandoAtividadeFaturamentoDadosAction", "atualizarComandoAtividadeFaturamentoDadosAction"));
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(2, "RotasA.gif", "RotasD.gif",
						"exibirAtualizarComandoAtividadeFaturamentoRotasAction", "atualizarComandoAtividadeFaturamentoRotasAction"));
		statusWizard.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(3, "ConclusaoA.gif", "ConclusaoD.gif",
