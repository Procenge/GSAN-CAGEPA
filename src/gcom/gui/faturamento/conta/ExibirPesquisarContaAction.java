 ...
 * @date 02/03/2006
 */
public class ExibirPesquisarContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// PesquisarContaActionForm pesquisarContaActionForm = (PesquisarContaActionForm)
		// actionForm;
		...
		// [FS0005] Caso não exista nenhuma situação de conta no sistema, levanta a exceção para o
		// usuário indicando que
		...
		if(httpServletRequest.getParameter("caminhoRetornoTelaPesquisaConta") != null){
			sessao.setAttribute("caminhoRetornoTelaPesquisaConta", httpServletRequest.getParameter("caminhoRetornoTelaPesquisaConta"));
		}
