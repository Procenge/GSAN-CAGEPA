...
public class ManterContaActionForm
				extends ActionForm {
	...
	private String anoMesReferenciaContaInicio;

	private String anoMesReferenciaContaFim;

	private String dataPagamentoContaInicio;

	private String dataPagamentoContaFim;

	private String inContasRevisao;

	private String[] motivosRevisaoDisponiveis;
	...
	public String getAnoMesReferenciaContaInicio(){

		return anoMesReferenciaContaInicio;
	}

	public void setAnoMesReferenciaContaInicio(String anoMesReferenciaContaInicio){

		this.anoMesReferenciaContaInicio = anoMesReferenciaContaInicio;
	}

	public String getAnoMesReferenciaContaFim(){

		return anoMesReferenciaContaFim;
	}

	public void setAnoMesReferenciaContaFim(String anoMesReferenciaContaFim){

		this.anoMesReferenciaContaFim = anoMesReferenciaContaFim;
	}

	public String getDataPagamentoContaInicio(){

		return dataPagamentoContaInicio;
	}

	public void setDataPagamentoContaInicio(String dataPagamentoContaInicio){

		this.dataPagamentoContaInicio = dataPagamentoContaInicio;
	}

	public String getDataPagamentoContaFim(){

		return dataPagamentoContaFim;
	}

	public void setDataPagamentoContaFim(String dataPagamentoContaFim){
	...
	public String[] getMotivosRevisaoDisponiveis(){

		return motivosRevisaoDisponiveis;
	}

	public void setMotivosRevisaoDisponiveis(String[] motivosRevisaoDisponiveis){
