...
public class InserirDiaVencimentoAlternativoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Short novoDiaVencimento = new Short(informarVencimentoAlternativoActionForm.getNovoDiaVencimento());
		Usuario usuarioLogado = (Usuario) sessao.getAttribute(Usuario.USUARIO_LOGADO);

		// [FS0001] - Verificar Existência de RA
		if(!Util.isVazioOuBranco(informarVencimentoAlternativoActionForm.getIdImovel())){
			try{
				fachada.verificarExistenciaRegistroAtendimento(Integer.valueOf(informarVencimentoAlternativoActionForm.getIdImovel()),
				...
				e.setUrlBotaoVoltar("exibirInformarVencimentoAlternativoAction.do?menu=sim");
		...
		fachada.inserirVencimentoAlternativo(vencimentoAlternativo, imovel, cliente, novoDiaVencimento, usuarioLogado);

		sessao.removeAttribute("colecaoNovoDiaVencimento");
		sessao.removeAttribute("imovel");
		sessao.removeAttribute("vencimentoAlternativo");
		montarPaginaSucesso(httpServletRequest, "Vencimento Alternativo para o imóvel "
						+ informarVencimentoAlternativoActionForm.getIdImovel() + " inserido com sucesso.",
						"Informar outro Vencimento Alternativo", "exibirInformarVencimentoAlternativoAction.do?menu=sim");
