...
public class ExibirColocarRevisaoContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		fachada.verificarExistenciaRegistroAtendimento(Util.obterInteger(idImovel), "atencao.conta_existencia_registro_atendimento",
		...
		if(sessao.getAttribute("colecaoContaImovel") != null){
			...
			fachada.verificarContasRevisao((Collection) sessao.getAttribute("colecaoContaImovel"), contaSelected);
		}
