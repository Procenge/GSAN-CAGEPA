...
public class FiltrarContaMotivoCancelamentoActionForm
				extends ActionForm {
	...
	public String getDescricaoMotivoCancelamentoConta(){
		...
		return descricaoMotivoCancelamentoConta;
	}
	...
	public void setIndicadorAtualizar(String atualizar){

		this.indicadorAtualizar = atualizar;
	}
