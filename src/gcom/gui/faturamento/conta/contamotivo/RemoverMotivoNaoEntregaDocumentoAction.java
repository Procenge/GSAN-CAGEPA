...
public class RemoverMotivoNaoEntregaDocumentoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, ids.length + " Motivo(s) de não entrega de documento removido(s) com sucesso",
							"Realizar outra Manutenção de Motivo de não entrega de documento",
