...
public class RemoverContaMotivoInclusaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		operacao.setId(Operacao.OPERACAO_CONTA_MOTIVO_INCLUSAO_REMOVER);
		...
		fachada.remover(ids, ContaMotivoInclusao.class.getName(), operacaoEfetuada, colecaoUsuarios);

		// Monta a página de sucesso
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			montarPaginaSucesso(httpServletRequest, ids.length + " Motivo(s) de inclusao de conta removido(s) com sucesso", "", "");
		}
