 ...
 */
public class ExibirInserirMensagemContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirInserirMensagemContaAction");
		...
		String idLocalidade = inserirMensagemContaActionForm.getLocalidade();

		String idGerenciaRegional = inserirMensagemContaActionForm.getGerenciaRegional();
		...
		// FiltroSetorComercial filtroSetorComercial = new FiltroSetorComercial();
		// filtroSetorComercial.adicionarParametro(new
		// ParametroSimples(FiltroSetorComercial.ID_LOCALIDADE, idLocalidade));
		// filtroSetorComercial.adicionarCaminhoParaCarregamentoEntidade("localidade");
		// filtroSetorComercial.adicionarParametro(new
		// ParametroSimples(FiltroSetorComercial.CODIGO_SETOR_COMERCIAL, idSetorComercial));
		//			
		// Collection colecaoSetor = fachada.pesquisar(filtroSetorComercial,
