...
public class RetirarDebitoCobradoConjuntoContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection<DebitoTipo> debitosTipoRetirar = new ArrayList<DebitoTipo>();
		Collection<Integer> idsDebitosTipoRetirar = new ArrayList<Integer>();

		if(sessao.getAttribute("debitosTipoRetirar") != null){
			debitosTipoRetirar = (Collection<DebitoTipo>) sessao.getAttribute("debitosTipoRetirar");

			for(DebitoTipo debitoTipo : debitosTipoRetirar){

				idsDebitosTipoRetirar.add(debitoTipo.getId());
			}
		}else{
		...
		if(sessao.getAttribute("colecaoImovel") != null){
			...
			String contaSelected = retirarDebitoCobradoActionForm.getContaSelected();
			...
			if(codigoCliente != null){
				...
				fachada.retificarConjuntoContaCliente(codigoCliente, relacaoTipo, anoMes, contaMotivoRetificacao, idsDebitosTipoRetirar,
				...
				fachada.retificarConjuntoConta(idGrupoFaturamento, anoMes, contaMotivoRetificacao, idsDebitosTipoRetirar, usuarioLogado,
								dataVencimentoContaInicio, dataVencimentoContaFim, anoMesFim, colecaoContasSelecionadas);
			}else{

				fachada.retificarConjuntoConta(colecaoImovel, anoMes, contaMotivoRetificacao, idsDebitosTipoRetirar, usuarioLogado,
								dataVencimentoContaInicio, dataVencimentoContaFim, anoMesFim, colecaoContasSelecionadas);
			}
