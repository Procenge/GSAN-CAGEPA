...
public class ExibirAdicionarCreditoRealizadoContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String pAcesso = httpServletRequest.getParameter("pRemPhad");

		if(Util.isNaoNuloBrancoZero(pAcesso) && pAcesso.equals("1")){
		...
		if(sessao.getAttribute("colecaoAdicionarCreditoTipo") == null){
			...
			Collection colecaoAdicionarCreditoTipo = fachada.pesquisar(filtroCreditoTipo, CreditoTipo.class.getName());
		...
		Collection<CreditoOrigem> colecaoAdicionarCreditoOrigem = new ArrayList<CreditoOrigem>();

		if(StringUtils.isNotBlank(adicionarCreditoRealizadoContaActionForm.getCreditoTipoID())
						&& StringUtils.isNumeric(adicionarCreditoRealizadoContaActionForm.getCreditoTipoID())){

			colecaoAdicionarCreditoOrigem = fachada.listarCreditoOrigem(
							Integer.valueOf(adicionarCreditoRealizadoContaActionForm.getCreditoTipoID()), null);

		}

		adicionarCreditoRealizadoContaActionForm.setCreditoOrigemID(adicionarCreditoRealizadoContaActionForm.getCreditoOrigemID());
