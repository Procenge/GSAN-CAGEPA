 ...
 */
public class AtualizarMensagemContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_CONTA_MENSAGEM_ATUALIZAR,
		...
		if(colecaoContaMensagem != null && !colecaoContaMensagem.isEmpty()){
			...
			String indicadorUsoStr = null;

			for(Iterator iter = colecaoContaMensagem.iterator(); iter.hasNext();){
				...
				indicadorUsoStr = atualizarMensagemContaActionForm.getIndicadorUso();
				indicadorUso = Short.valueOf(indicadorUsoStr);

				contaMensagem.setIndicadorUso(indicadorUso);
		...
		montarPaginaSucesso(httpServletRequest, "Mensagem da Conta com referência " + anoMes + " atualizada com sucesso.",
						"Realizar outra Manutenção de Mensagem da Conta", "exibirFiltrarMensagemContaAction.do?menu=sim");
