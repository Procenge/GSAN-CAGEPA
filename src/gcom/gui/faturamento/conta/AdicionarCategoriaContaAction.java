...
public class AdicionarCategoriaContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirAdicionarCategoriaConta");
		...
		AdicionarCategoriaContaActionForm adicionarCategoriaContaActionForm = (AdicionarCategoriaContaActionForm) actionForm;
		...
		if(idCategoria == null || idCategoria.equalsIgnoreCase("")){
			throw new ActionServletException("atencao.campo_texto.obrigatorio", null, "categoria");
		}
		...
		if(sistemaParametro.getNomeAbreviadoEmpresa().equalsIgnoreCase(SistemaParametro.EMPRESA_CAERN)){
			...
			if(idSubcategoria == null || idSubcategoria.equalsIgnoreCase("")){
				throw new ActionServletException("atencao.campo_texto.obrigatorio", null, "subcategoria");
			}
	...
	private void adicionarCategoria(String idCategoria, String qtdEconomias, HttpSession sessao, HttpServletRequest httpServletRequest){
		...
		Collection colecaoCategoriaSelected = Fachada.getInstancia().pesquisar(filtroCategoria, Categoria.class.getName());
		...
		if(sessao.getAttribute("colecaoCategoria") == null){
			...
			// [FS0009] - Verificar categoria já existente
				...
				throw new ActionServletException("atencao.adicionar_categoria_ja_existente");
			}
		}
	}

	private void adicionarSubCategoria(String idSubcategoria, String qtdEconomias, HttpSession sessao, HttpServletRequest httpServletRequest){
		...
		Collection colecaoSubCategoriaSelected = Fachada.getInstancia().pesquisar(filtroSubCategoria, Subcategoria.class.getName());
		...
		if(sessao.getAttribute("colecaoSubcategoria") == null){
			...
			if(!colecaoSubcategoria.contains(subcategoriaSelected)){
				...
				Collections.sort((List) colecaoSubcategoria, new Comparator() {
					...
					public int compare(Object a, Object b){
						...
						int comparacaoCategoria = subcategoria1.getCategoria().getDescricao().compareTo(
										subcategoria2.getCategoria().getDescricao());

						if(comparacaoCategoria == 0){

							return subcategoria1.getDescricao().compareTo(subcategoria2.getDescricao());
			...
			// [FS0009] - Verificar subcategoria já existente
				...
				throw new ActionServletException("atencao.adicionar_subcategoria_ja_existente");
			}
		}
	}
