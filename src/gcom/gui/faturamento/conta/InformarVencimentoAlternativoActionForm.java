...
public class InformarVencimentoAlternativoActionForm
	...
	// private String novoDiaVencimentoCalendario;
	...
	// public String getNovoDiaVencimentoCalendario() {
	// return novoDiaVencimentoCalendario;
	// }
	//
	// public void setNovoDiaVencimentoCalendario(String novoDiaVencimentoCalendario) {
	// this.novoDiaVencimentoCalendario = novoDiaVencimentoCalendario;
	// }
