...
public class ExibirAlterarClienteResponsavelConjuntoContaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Verifica se o tipoConsulta é diferente de nulo ou vazio esse tipo consulta vem do
		// cliente_pesquisar.jsp. È feita essa verificação pois pode ser que ainda não tenha feito a
		// pesquisa de cliente.
		if(httpServletRequest.getParameter("tipoConsulta") != null && !httpServletRequest.getParameter("tipoConsulta").equals("")){

			// Verifica se o tipo da consulta de cliente é de cliente
