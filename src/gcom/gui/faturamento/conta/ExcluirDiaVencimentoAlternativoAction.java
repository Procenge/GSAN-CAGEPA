...
public class ExcluirDiaVencimentoAlternativoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		fachada.excluirVencimentoAlternativo(vencimentoAlternativo, imovel, usuarioLogado);
		...
		montarPaginaSucesso(httpServletRequest, "Vencimento Alternativo para o imóvel "
						+ informarVencimentoAlternativoActionForm.getIdImovel() + " removido com sucesso.",
