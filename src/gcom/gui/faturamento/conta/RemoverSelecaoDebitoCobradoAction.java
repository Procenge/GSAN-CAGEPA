...
public class RemoverSelecaoDebitoCobradoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String debitoSelected = httpServletRequest.getParameter("colecaoDebitoCobrardoRemover");

		if(debitoSelected != null && !debitoSelected.equals("")){

		String[] arrayIdentificadores = debitoSelected.split(",");
		for(int i = 0; i < arrayIdentificadores.length; i++){

			String dadosDebitos = arrayIdentificadores[i];

			long debitoCobradoUltimaAlteracaoLong = Long.parseLong(dadosDebitos);
