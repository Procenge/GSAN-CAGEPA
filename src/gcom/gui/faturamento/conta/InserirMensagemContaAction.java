 ...
 */
public class InserirMensagemContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RegistradorOperacao registradorOperacao = new RegistradorOperacao(Operacao.OPERACAO_CONTA_MENSAGEM_INSERIR,
		...
		if(referenciaFaturamento != null && !referenciaFaturamento.trim().equals("")){
			if(Util.validarAnoMes(referenciaFaturamento)){
				new ActionServletException("atencao.ano_mes_invalido", null, referenciaFaturamento);
			}
		}
		...
		// Collection colecaoSC = fachada.pesquisar(filtroSetorComercial,
		...
		//			
		// }
		contaMensagem.setIndicadorUso(ConstantesSistema.INDICADOR_USO_ATIVO);
		...
		// } else {
		fachada.inserirMensagemConta(contaMensagem, setorComercial);
		// }

		// Integer i = (Integer) fachada.inserirMensagemConta(contaMensagem,
		// contaMensagem.getSetorComercial().getId());

		montarPaginaSucesso(httpServletRequest, "Mensagem da Conta com referência " + referenciaFaturamento + " incluída com sucesso.",
						"Inserir outra Mensagem de Conta", "exibirInserirMensagemContaAction.do?menu=sim");

		// montarPaginaSucesso(httpServletRequest, "Mensagem da Conta com referência " +
		// referenciaFaturamento +" incluída com sucesso.",
