...
public class ExibirAdicionarCategoriaContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("colecaoAdicionarCategoria") == null){
			...
			Collection colecaoAdicionarCategoria = fachada.pesquisar(filtroCategoria, Categoria.class.getName());
		...
		if(idCategoria != null && !idCategoria.equalsIgnoreCase("")){
			...
			Collection colecaoAdicionarSubCategoria = fachada.pesquisar(filtroSubCategoria, Subcategoria.class.getName());

			if(colecaoAdicionarSubCategoria == null || colecaoAdicionarSubCategoria.isEmpty()){

				sessao.removeAttribute("colecaoSubCategoria");

				throw new ActionServletException("atencao.pesquisa.nenhum_registro_tabela", null, "SUBCATEGORIA");
			}
