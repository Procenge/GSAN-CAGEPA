 ...
 */
public class ExibirVisualizarMensagemContaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("visualizarMensagemConta");
		...
		if(colecaoMensagem != null && !colecaoMensagem.isEmpty()){
			...
			throw new ActionServletException("atencao.mensagem_nao_encontrada");
		}
