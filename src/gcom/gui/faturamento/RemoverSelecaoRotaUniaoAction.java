...
public class RemoverSelecaoRotaUniaoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(sessao.getAttribute("colecaoFaturamentoAtividadeCronogramaRotaUniao") != null){
			...
			if(inserirComandoAtividadeFaturamentoActionForm.getIdRotaSelecao() != null){
				...
				// sessão
				String[] rotasSelecionadas = inserirComandoAtividadeFaturamentoActionForm.getIdRotaSelecao();

				while(rotasSelecionadas.length > indexArray){
					rotaID = new Integer(rotasSelecionadas[indexArray]);

					colecaoFaturamentoAtividadeCronogramaRotaUniaoIterator = colecaoFaturamentoAtividadeCronogramaRotaUniao.iterator();
					...
					while(colecaoFaturamentoAtividadeCronogramaRotaUniaoIterator.hasNext()){
						...
						if(faturamentoAtivCronRota.getRota().getId().equals(rotaID)){
							colecaoFaturamentoAtividadeCronogramaRotaUniao.remove(faturamentoAtivCronRota);
							break;
						}
					}
