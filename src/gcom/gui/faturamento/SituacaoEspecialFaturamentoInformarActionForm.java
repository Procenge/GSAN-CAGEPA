 ...
 */
public class SituacaoEspecialFaturamentoInformarActionForm
				extends ActionForm {
	...
	private String nomeQuadraOrigem;

	private String enderecoArquivoDownload;

	public String getNomeQuadraOrigem(){

		return nomeQuadraOrigem;
	}

	public void setNomeQuadraOrigem(String nomeQuadraOrigem){

		this.nomeQuadraOrigem = nomeQuadraOrigem;
	}
