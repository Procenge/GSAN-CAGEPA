...
public class GerarRelatorioEvolucaoContasAReceberContabilAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		try{
			retorno = processarExibicaoRelatorio(relatorioEvolucaoContasAReceberContabil, tipoRelatorio, httpServletRequest,
	...
	public boolean verificarReferenciaContabil(String anoMesReferenciaContabil, SistemaParametro sistemaParametro){
		...
		if(verificacao){
			...
			throw new ActionServletException("atencao.referencia_contabil.ano_mes.inferior", null, anoMesSistema.substring(0, 2) + "/"
