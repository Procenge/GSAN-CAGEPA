...
public class GerarRelatorioSaldoContasAReceberContabilAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		relatorioSaldoContasAReceberContabil.addParametro("mesAno", mesAnoInteger);
		...
		relatorioSaldoContasAReceberContabil.addParametro("tipoFormatoRelatorio", tipoRelatorio != null ? Integer.valueOf(tipoRelatorio)
						: TarefaRelatorio.TIPO_PDF);

		try{

			retorno = processarExibicaoRelatorio(relatorioSaldoContasAReceberContabil, tipoRelatorio, httpServletRequest,
	 ...
	 */
	public boolean verificarReferenciaContabil(String anoMesReferenciaContabil, SistemaParametro sistemaParametro){
 ...
 + anoMesReferenciaContabil.substring(0, 2), sistemaParametro
		...
		if(verificacao){
			String anoMesSistema = Util.formatarAnoMesSemBarraParaMesAnoComBarra(getFachada().pesquisarParametrosDoSistema()
