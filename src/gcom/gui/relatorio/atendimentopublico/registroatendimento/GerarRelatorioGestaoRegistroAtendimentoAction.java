...
import gcom.relatorio.atendimentopublico.RelatorioGestaoRegistroAtendimentoAnalitico;
import gcom.relatorio.atendimentopublico.RelatorioGestaoRegistroAtendimentoSintetico;
 ...
 * @date 25/03/2011
 */
public class GerarRelatorioGestaoRegistroAtendimentoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(formulario.getTipoPesquisa() != null){

			if(formulario.getTipoPesquisa().equals("1")){

				RelatorioGestaoRegistroAtendimentoAnalitico relatorio = new RelatorioGestaoRegistroAtendimentoAnalitico(
								(Usuario) (httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));

				relatorio.addParametro("filtroRA", filtroRA);
				relatorio.addParametro("tipoRelatorio", Integer.valueOf(formulario.getTipoPesquisa()));
				...
				RelatorioGestaoRegistroAtendimentoSintetico relatorio = new RelatorioGestaoRegistroAtendimentoSintetico(
								(Usuario) (httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));
