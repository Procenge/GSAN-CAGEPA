 ...
 * @date 17/03/2011
 */
public class ExibirGerarRelatorioResumoRegistroAtendimentoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirGerarRelatorioResumoRegistroAtendimento");
	...
	private void getSolicitacaoTipoEspecificacao(HttpSession sessao, Fachada fachada,
					GerarRelatorioResumoRegistroAtendimentoActionForm formulario){
	 ...
	 * @param tipo
	 */
	private void getUnidade(GerarRelatorioResumoRegistroAtendimentoActionForm formulario, HttpServletRequest httpServletRequest, int tipo){
