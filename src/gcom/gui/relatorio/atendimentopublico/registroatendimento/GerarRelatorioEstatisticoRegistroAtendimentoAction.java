...
import gcom.relatorio.atendimentopublico.RelatorioEstatisticoRegistroAtendimento;
 ...
 * @date 31/08/2012
 */
public class GerarRelatorioEstatisticoRegistroAtendimentoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioEstatisticoRegistroAtendimentoHelper helper = new RelatorioEstatisticoRegistroAtendimentoHelper(periodoAtendimentoInicial,
		...
		Fachada.getInstancia().validarCamposObrigatoriosHalperRA(helper);

		int qtdRegistros = Fachada.getInstancia().constularQuantidadeRA(helper);

		if(qtdRegistros == 0){
			throw new ActionServletException("atencao.relatorio.vazio");
		}

		RelatorioEstatisticoRegistroAtendimento relatorio = new RelatorioEstatisticoRegistroAtendimento((Usuario) (httpServletRequest
						.getSession(false)).getAttribute("usuarioLogado"));

		relatorio.addParametro(RelatorioEstatisticoRegistroAtendimento.FILTRO_INFORMADO, helper);
		relatorio.addParametro(RelatorioEstatisticoRegistroAtendimento.FORMATO_RELATORIO, TarefaRelatorio.TIPO_PDF);
