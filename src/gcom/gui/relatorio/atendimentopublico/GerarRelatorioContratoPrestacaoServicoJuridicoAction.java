 ...
 */
public class GerarRelatorioContratoPrestacaoServicoJuridicoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(!colecaoClienteImovel.isEmpty()){
			...
			if(clienteImovel.getCliente() != null && clienteImovel.getCliente().getCnpj() == null
				 ...
				 * actionMapping2.setType(
				 * "gcom.gui.relatorio.atendimentopublico.GerarRelatorioContratoPrestacaoServicoJuridicoAction"
				 * );
				 * //actionMapping.set
				...
				relatorioContratoPrestacaoServico.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
				retorno = processarExibicaoRelatorio(relatorioContratoPrestacaoServico, tipoRelatorio, httpServletRequest,
