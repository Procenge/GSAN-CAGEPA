 ...
 * @date 13/02/2007
 */
public class GerarRelatorioMedicaoConsumoLigacaoAguaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioMedicaoConsumoLigacaoAgua relatorioMedicaoConsumoLigacaoAgua = new RelatorioMedicaoConsumoLigacaoAgua(
		...
		relatorioMedicaoConsumoLigacaoAgua.addParametro("sitLigacaoEsgoto", consultarImovelActionForm
		...
		relatorioMedicaoConsumoLigacaoAgua.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioMedicaoConsumoLigacaoAgua, tipoRelatorio, httpServletRequest,
