 ...
 */
public class GerarRelatorioContratoPrestacaoServicoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		idImovel = gerarContratoPrestacaoServicoActionForm.getIdImovel();
		...
		// caso tenha vindo da tela de sucesso de Inserir Registro de Atendimento
		if(sessao.getAttribute("numeroImovel") != null){
			idImovel = (String) sessao.getAttribute("numeroImovel");
		...
		// verifica se passa o id do imovel ou do registro de atendimento, para o relatório, de
		...
		relatorioContratoPrestacaoServico.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		retorno = processarExibicaoRelatorio(relatorioContratoPrestacaoServico, tipoRelatorio, httpServletRequest, httpServletResponse,
						actionMapping);
