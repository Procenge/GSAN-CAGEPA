 ...
 * @date 11/02/2009
 *       Correcao de tratamento para emissao da RA
 */
public class GerarRelatorioRegistroAtendimentoViaClienteConsultarAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(httpServletRequest.getParameter("idRegistroAtendimento") != null){
			idRegistroAtendimento = httpServletRequest.getParameter("idRegistroAtendimento");
		}else{
		...
		relatorioConsultarRegistroAtendimentoViaCliente.addParametro("idRegistroAtendimento", new Integer(idRegistroAtendimento));
		if(tipoRelatorio == null){
			tipoRelatorio = TarefaRelatorio.TIPO_PDF + "";
		}

		relatorioConsultarRegistroAtendimentoViaCliente.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		retorno = processarExibicaoRelatorio(relatorioConsultarRegistroAtendimentoViaCliente, tipoRelatorio, httpServletRequest,
