 ...
 */
public class GerarRelatorioFaixasFalsasLeituraAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(qtdeRegistros.intValue() == 0){
			throw new ActionServletException("atencao.nenhuma_faixa_falsa_encontrada", null, anoMesReferenciaString);
		}

		// Fim da parte que vai mandar os parametros para o relatório
		String tipoRelatorio = httpServletRequest.getParameter("tipoRelatorio");

		RelatorioFaixasFalsasLeitura relatorioFaixasFalsasLeitura = new RelatorioFaixasFalsasLeitura((Usuario) (httpServletRequest
						.getSession(false)).getAttribute("usuarioLogado"));

		relatorioFaixasFalsasLeitura.addParametro("anoMesReferencia", anoMesReferencia);
		relatorioFaixasFalsasLeitura.addParametro("qtdeRegistros", qtdeRegistros);

		if(tipoRelatorio == null){
			tipoRelatorio = TarefaRelatorio.TIPO_PDF + "";
		}

		relatorioFaixasFalsasLeitura.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		retorno = processarExibicaoRelatorio(relatorioFaixasFalsasLeitura, tipoRelatorio, httpServletRequest, httpServletResponse,
						actionMapping);
