 ...
 */
public class GerarRelatorioSubcategoriaManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroSubCategoria filtroSubcategoria = (FiltroSubCategoria) sessao.getAttribute("filtroSubcategoria");
		...
		String codigoPesquisar = (String) filtrarSubcategoriaActionForm.getCodigoSubcategoria();
		...
		if(filtrarSubcategoriaActionForm.getIndicadorUso() != null && !filtrarSubcategoriaActionForm.getIndicadorUso().equals("")){

			indicadorDeUso = new Short(filtrarSubcategoriaActionForm.getIndicadorUso());
		}

		// seta os parametros que serão mostrados no relatório
		subcategoriaParametros.setCategoria(categoria);
		subcategoriaParametros.setCodigo(codigo);
		subcategoriaParametros.setDescricao(filtrarSubcategoriaActionForm.getDescricao());
		subcategoriaParametros.setIndicadorUso(indicadorDeUso);

		// Fim da parte que vai mandar os parametros para o relatório
		String tipoRelatorio = httpServletRequest.getParameter("tipoRelatorio");

		RelatorioManterSubcategoria relatorio = new RelatorioManterSubcategoria((Usuario) (httpServletRequest.getSession(false))
