 ...
 */
public class GerarRelatorioCategoriaManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroCategoria filtroCategoria = (FiltroCategoria) sessao.getAttribute("filtroCategoria");
		...
		RelatorioManterCategoria relatorioManterCategoria = new RelatorioManterCategoria((Usuario) (httpServletRequest.getSession(false))
		...
		relatorioManterCategoria.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		retorno = processarExibicaoRelatorio(relatorioManterCategoria, tipoRelatorio, httpServletRequest, httpServletResponse,
						actionMapping);
