...
public class GerarRelatorioLogradouroManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection logradouros = (Collection) sessao.getAttribute("logradourosRelatorio");
		...
		String idLogradouroPesquisar = (String) pesquisarActionForm.get("idLogradouro");
		...
		if(idTitulo != null && !idTitulo.equals("")){
			...
			filtroLogradouroTitulo.adicionarParametro(new ParametroSimples(FiltroLogradouroTitulo.ID, idTitulo));
			filtroLogradouroTitulo.adicionarParametro(new ParametroSimples(FiltroLogradouroTitulo.INDICADORUSO,
							ConstantesSistema.INDICADOR_USO_ATIVO));

			Collection logradourosTitulos = fachada.pesquisar(filtroLogradouroTitulo, LogradouroTitulo.class.getName());

			if(logradourosTitulos != null && !logradourosTitulos.isEmpty()){
				// Titulo do Logradouro Foi Encontrado
				Iterator logradouroTituloIterator = logradourosTitulos.iterator();

				logradouroTitulo = (LogradouroTitulo) logradouroTituloIterator.next();
		...
		if(idTipo != null && !idTipo.equals("")){
			...
			filtroLogradouroTipo.adicionarParametro(new ParametroSimples(FiltroLogradouroTipo.ID, idTitulo));
			filtroLogradouroTipo.adicionarParametro(new ParametroSimples(FiltroLogradouroTipo.INDICADORUSO,
							ConstantesSistema.INDICADOR_USO_ATIVO));

			Collection logradourosTipos = fachada.pesquisar(filtroLogradouroTipo, LogradouroTipo.class.getName());
		...
		logradouroParametros.setId(idLogradouro == null ? null : new Integer(idLogradouro));
		logradouroParametros.setNome("" + pesquisarActionForm.get("nomeLogradouro"));
		...
		relatorioManterLogradouro.addParametro("logradouroParametros", logradouroParametros);

		if(!Util.isVazioOuBranco((String) pesquisarActionForm.get("idBairro"))){
			String idBairro = (String) pesquisarActionForm.get("idBairro");
			relatorioManterLogradouro.addParametro("idBairro", Short.valueOf(idBairro));
		}
		...
		relatorioManterLogradouro.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterLogradouro, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
