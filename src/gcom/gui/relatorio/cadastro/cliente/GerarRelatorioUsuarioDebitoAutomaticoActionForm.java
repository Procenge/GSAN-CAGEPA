 ...
 * @date 24/02/2011
 */
public class GerarRelatorioUsuarioDebitoAutomaticoActionForm
				extends ActionForm {
	...
	private String codigoBancoFinal;
	...
	public String getCodigoBancoFinal(){

		return codigoBancoFinal;
	}

	public void setCodigoBancoFinal(String codigoBancoFinal){

		this.codigoBancoFinal = codigoBancoFinal;
	}
