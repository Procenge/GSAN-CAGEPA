...
public class ExibirGerarRelatorioImoveisFaturasAtrasoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirGerarRelatorioImoveisFaturasAtraso");
	 ...
	 * @date 28/11/2007
	 */
	private void pesquisarSetorComercial(GerarRelatorioImoveisFaturasAtrasoActionForm form, String objetoConsulta){
	 ...
	 * @date 28/11/2007
	 */
	private void pesquisarUnidadeNegocio(HttpServletRequest httpServletRequest, GerarRelatorioImoveisFaturasAtrasoActionForm form){
	 ...
	 * @date 28/11/2007
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, GerarRelatorioImoveisFaturasAtrasoActionForm form){
