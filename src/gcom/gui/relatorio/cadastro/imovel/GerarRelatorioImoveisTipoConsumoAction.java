...
public class GerarRelatorioImoveisTipoConsumoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltrarRelatorioImoveisTipoConsumoHelper filtro = new FiltrarRelatorioImoveisTipoConsumoHelper();
		...
		// Tipos de Consumo
		if(form.getTiposConsumo() != null && form.getTiposConsumo().length > 0){
		...
		RelatorioImoveisTipoConsumo relatorio = new RelatorioImoveisTipoConsumo(this.getUsuarioLogado(httpServletRequest));
