...
public class ExibirGerarRelatorioImoveisSituacaoLigacaoAguaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		GerarRelatorioImoveisSituacaoLigacaoAguaActionForm form = (GerarRelatorioImoveisSituacaoLigacaoAguaActionForm) actionForm;

		// Setando default ordenar por Gerência Regional primeira vez
		if(Util.isVazioOuBranco(form.getIndicadorOrdenacao())){
			form.setIndicadorOrdenacao("1");
		}
	 ...
	 * @date 28/11/2007
	 */
	private void pesquisarLocalidade(GerarRelatorioImoveisSituacaoLigacaoAguaActionForm form, String objetoConsulta){
	 ...
	 * @date 28/11/2007
	 */
	private void pesquisarSetorComercial(GerarRelatorioImoveisSituacaoLigacaoAguaActionForm form, String objetoConsulta){
	 ...
	 * @date 28/11/2007
	 */
	private void pesquisarUnidadeNegocio(HttpServletRequest httpServletRequest, GerarRelatorioImoveisSituacaoLigacaoAguaActionForm form){
	 ...
	 * @date 28/11/2007
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, GerarRelatorioImoveisSituacaoLigacaoAguaActionForm form){
