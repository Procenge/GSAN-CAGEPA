 ...
 * @date 02/01/2008
 */
public class GerarRelatorioImoveisAtivosNaoMedidosAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltrarRelatorioImoveisAtivosNaoMedidosHelper filtro = new FiltrarRelatorioImoveisAtivosNaoMedidosHelper();
		...
		RelatorioImoveisAtivosNaoMedidos relatorio = new RelatorioImoveisAtivosNaoMedidos(this.getUsuarioLogado(httpServletRequest));
