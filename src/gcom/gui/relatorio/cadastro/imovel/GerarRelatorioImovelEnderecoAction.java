...
public class GerarRelatorioImovelEnderecoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioImovelEndereco relatorio = new RelatorioImovelEndereco((Usuario) (httpServletRequest.getSession(false))
		...
		// Tipo de empresa
		Short tipoEmpresa = getParametroCompanhia(httpServletRequest);
		relatorio.addParametro("tipoEmpresa", tipoEmpresa);
