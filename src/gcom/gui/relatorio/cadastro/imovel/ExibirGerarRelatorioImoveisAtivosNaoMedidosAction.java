 ...
 * @date 02/01/2008
 */
public class ExibirGerarRelatorioImoveisAtivosNaoMedidosAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		GerarRelatorioImoveisAtivosNaoMedidosActionForm form = (GerarRelatorioImoveisAtivosNaoMedidosActionForm) actionForm;
	 ...
	 * @date 02/01/2008
	 */
	private void pesquisarLocalidade(GerarRelatorioImoveisAtivosNaoMedidosActionForm form, String objetoConsulta){
	 ...
	 * @date 02/01/2008
	 */
	private void pesquisarSetorComercial(GerarRelatorioImoveisAtivosNaoMedidosActionForm form, String objetoConsulta){
	 ...
	 * @date 02/01/2008
	 */
	private void pesquisarUnidadeNegocio(HttpServletRequest httpServletRequest, GerarRelatorioImoveisAtivosNaoMedidosActionForm form){
	 ...
	 * @date 02/01/2008
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, GerarRelatorioImoveisAtivosNaoMedidosActionForm form){
