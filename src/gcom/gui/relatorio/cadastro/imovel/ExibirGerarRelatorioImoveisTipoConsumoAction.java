...
public class ExibirGerarRelatorioImoveisTipoConsumoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		GerarRelatorioImoveisTipoConsumoActionForm form = (GerarRelatorioImoveisTipoConsumoActionForm) actionForm;
	 ...
	 * @date 02/08/2007
	 */
	private void pesquisarLocalidade(GerarRelatorioImoveisTipoConsumoActionForm form, String objetoConsulta){
	 ...
	 * @date 02/01/2007
	 */
	private void pesquisarSetorComercial(GerarRelatorioImoveisTipoConsumoActionForm form, String objetoConsulta){
	 ...
	 * @date 02/01/2008
	 */
	private void pesquisarUnidadeNegocio(HttpServletRequest httpServletRequest, GerarRelatorioImoveisTipoConsumoActionForm form){
	 ...
	 * @date 02/01/2008
	 */
	private void setaRequest(HttpServletRequest httpServletRequest, GerarRelatorioImoveisTipoConsumoActionForm form){
	...
	private void pesquisarConsumoTipo(HttpServletRequest httpServletRequest){
		...
		filtroConsumoTipo.adicionarParametro(new ParametroSimples(FiltroQuadra.INDICADORUSO, ConstantesSistema.INDICADOR_USO_ATIVO));
