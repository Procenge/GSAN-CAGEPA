...
public class ExibirGerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		GerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoActionForm form = (GerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoActionForm) actionForm;
		...
		if(form.getReferenciaFaturasDiaInicial() != null && !form.getReferenciaFaturasDiaInicial().equals("")){
			...
			int referenciaFaturaDiaInicial = Util.formatarMesAnoComBarraParaAnoMes(form.getReferenciaFaturasDiaInicial());
	 ...
	 * @date 08/01/2008
	 */
	private void pesquisarLocalidade(GerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoActionForm form, String objetoConsulta){
	 ...
	 * @date 08/01/2008
	 */
	private void pesquisarSetorComercial(GerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoActionForm form, String objetoConsulta){
