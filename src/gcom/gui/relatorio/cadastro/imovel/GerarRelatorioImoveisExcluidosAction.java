...
import gcom.relatorio.cadastro.imovel.FiltrarRelatorioImoveisExcluidosHelper;
import gcom.relatorio.cadastro.imovel.RelatorioImoveisExcluidos;
 ...
 * @date 31/01/2013
 */
public class GerarRelatorioImoveisExcluidosAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirGerarRelatorioImoveisExcluidosAction");

		// Form
		GerarRelatorioImoveisExcluidosActionForm form = (GerarRelatorioImoveisExcluidosActionForm) actionForm;

		FiltrarRelatorioImoveisExcluidosHelper filtro = new FiltrarRelatorioImoveisExcluidosHelper();
		...
		RelatorioImoveisExcluidos relatorio = new RelatorioImoveisExcluidos(this.getUsuarioLogado(httpServletRequest));

		relatorio.addParametro("filtrarRelatorioImoveisExcluidosHelper", filtro);
