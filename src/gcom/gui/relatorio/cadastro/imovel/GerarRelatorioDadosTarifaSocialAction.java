...
import gcom.relatorio.cadastro.imovel.RelatorioDadosTarifaSocial;
...
public class GerarRelatorioDadosTarifaSocialAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(idGerenciaRegional != null && !idGerenciaRegional.equals("")
			...
			if(gerenciasRegionais != null && !gerenciasRegionais.isEmpty()){
				...
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Gerencia Regional");
			}
		}else{
		...
		if(numeroQuadraOrigem != null && !numeroQuadraOrigem.equals("")){
			...
			filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.NUMERO_QUADRA, numeroQuadraOrigem));
		...
		if(numeroQuadraDestino != null && !numeroQuadraDestino.equals("")){
			...
			filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.NUMERO_QUADRA, numeroQuadraDestino));
			filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.INDICADORUSO, ConstantesSistema.INDICADOR_USO_ATIVO));
		...
		String idSetorComercialOrigem = (String) imovelOutrosCriteriosActionForm.getSetorComercialOrigemID();

		SetorComercial setorComercialOrigem = null;

		if(idSetorComercialOrigem != null && !idSetorComercialOrigem.equals("")){
			FiltroSetorComercial filtroSetorComercial = new FiltroSetorComercial();

			filtroSetorComercial.adicionarParametro(new ParametroSimples(FiltroSetorComercial.ID, idSetorComercialOrigem));
			...
			if(colecaoSetoresComerciais != null && !colecaoSetoresComerciais.isEmpty()){
				...
				setorComercialOrigem = (SetorComercial) setorComercialIterator.next();
		...
		String idSetorComercialDestino = (String) imovelOutrosCriteriosActionForm.getSetorComercialDestinoID();

		SetorComercial setorComercialDestino = null;

		if(idSetorComercialDestino != null && !idSetorComercialDestino.equals("")){
			FiltroSetorComercial filtroSetorComercial = new FiltroSetorComercial();

			filtroSetorComercial.adicionarParametro(new ParametroSimples(FiltroSetorComercial.ID, idSetorComercialDestino));
			filtroSetorComercial.adicionarParametro(new ParametroSimples(FiltroSetorComercial.INDICADORUSO,
							ConstantesSistema.INDICADOR_USO_ATIVO));
			...
			if(colecaoSetoresComerciais != null && !colecaoSetoresComerciais.isEmpty()){
				...
				setorComercialDestino = (SetorComercial) setorComercialIterator.next();
		...
		if(idSituacaoLigacaoEsgoto != null && !idSituacaoLigacaoEsgoto.equals("")
			...
			filtroLigacaoEsgotoSituacao.adicionarParametro(new ParametroSimples(FiltroLigacaoEsgotoSituacao.ID, idSituacaoLigacaoEsgoto));
		...
		if(idImovelPerfil != null && !idImovelPerfil.equals("") && !idImovelPerfil.equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"")){
			...
			if(colecaoImoveisPerfis != null && !colecaoImoveisPerfis.isEmpty()){
				...
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Perfil do Imóvel");
			}
		...
		if(idSubCategoria != null && !idSubCategoria.equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"") && !idSubCategoria.equals("")){
		...
		if(areaConstruidaInicialPesquisado != null && !areaConstruidaInicialPesquisado.equals("")){
			areaConstruidaInicial = new BigDecimal(areaConstruidaInicialPesquisado);
		}
		...
		if(idPocoTipo != null && !idPocoTipo.equals(ConstantesSistema.NUMERO_NAO_INFORMADO+"") && !idPocoTipo.equals("")){
		...
		if(idTipoSituacaoFaturamento != null && !idTipoSituacaoFaturamento.equals("")
			...
			Collection colecaoFaturamentosSituacoesTipo = fachada.pesquisar(filtroFaturamentoSituacaoTipo, FaturamentoSituacaoTipo.class
							.getName());
		...
		if(idTipoSituacaoCobranca != null && !idTipoSituacaoCobranca.equals("")
			...
			Collection colecaoCobrancasSituacoesTipo = fachada.pesquisar(filtroCobrancaSituacaoTipo, CobrancaSituacaoTipo.class.getName());
		...
		if(idCadastroOcorrencia != null && !idCadastroOcorrencia.equals("")){
			...
			filtroCadastroOcorrencia.adicionarParametro(new ParametroSimples(FiltroCadastroOcorrencia.ID, idCadastroOcorrencia));
			...
			if(colecaoCadastrosOcorrencias != null && !colecaoCadastrosOcorrencias.isEmpty()){
				...
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Ocorrência de Cadastro");
			}
		...
		if(idTarifaConsumo != null && !idTarifaConsumo.equals("") && !idTarifaConsumo.equals(ConstantesSistema.NUMERO_NAO_INFORMADO + "")){
		...
		if(indicadorSituacaoImovelTarifaSocialPesquisado != null && !indicadorSituacaoImovelTarifaSocialPesquisado.equals("")){
		...
		if(dataImplantacaoInicialPesquisada != null && !dataImplantacaoInicialPesquisada.equals("")){
		...
		if(dataImplantacaoFinalPesquisada != null && !dataImplantacaoFinalPesquisada.equals("")){
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		...
		if(dataExclusaoInicialPesquisada != null && !dataExclusaoInicialPesquisada.equals("")){
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		...
		if(dataExclusaoFinalPesquisada != null && !dataExclusaoFinalPesquisada.equals("")){
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		...
		String idExclusaoMotivo = (String) imovelOutrosCriteriosActionForm.getIdMotivoExclusao();

		TarifaSocialExclusaoMotivo tarifaSocialExclusaoMotivo = null;

		if(idExclusaoMotivo != null && !idExclusaoMotivo.equals("") && !idExclusaoMotivo.equals("-1")){
			...
			filtroTarifaSocialExclusaoMotivo
							.adicionarParametro(new ParametroSimples(FiltroTarifaSocialExclusaoMotivo.ID, idExclusaoMotivo));

			Collection colecaoTarifasSociaisExclusoesMotivos = fachada.pesquisar(filtroTarifaSocialExclusaoMotivo,
							TarifaSocialExclusaoMotivo.class.getName());

			if(colecaoTarifasSociaisExclusoesMotivos != null && !colecaoTarifasSociaisExclusoesMotivos.isEmpty()){
				// O Motivo de Exclusão da Tarifa Social foi encontrado
				Iterator tarifaSocialExclusaoMotivoIterator = colecaoTarifasSociaisExclusoesMotivos.iterator();

				tarifaSocialExclusaoMotivo = (TarifaSocialExclusaoMotivo) tarifaSocialExclusaoMotivoIterator.next();

			}else{
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Motivo de Exclusão da Tarifa Social");
			}
		...
		if(dataValidadeCartaoInicialPesquisada != null && !dataValidadeCartaoInicialPesquisada.equals("")){
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		...
		if(dataValidadeCartaoFinalPesquisada != null && !dataValidadeCartaoFinalPesquisada.equals("")){
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		...
		if(numeroMesesAdesaoInicialPesquisado != null && !numeroMesesAdesaoInicialPesquisado.equals("")){
			numeroMesesAdesaoInicial = new Short(numeroMesesAdesaoInicialPesquisado);
		}

		Short numeroMesesAdesaoFinal = null;
		String numeroMesesAdesaoFinalPesquisado = imovelOutrosCriteriosActionForm.getMesFimAdesao();

		if(numeroMesesAdesaoFinalPesquisado != null && !numeroMesesAdesaoFinalPesquisado.equals("")){
			numeroMesesAdesaoFinal = new Short(numeroMesesAdesaoFinalPesquisado);
		}

		// Tipo do Cartão da Tarifa Social

		String idCartaoTipo = (String) imovelOutrosCriteriosActionForm.getTarifaSocialCartaoTipoId();

		TarifaSocialCartaoTipo tarifaSocialCartaoTipo = null;

		if(idCartaoTipo != null && !idCartaoTipo.equals("") && !idCartaoTipo.equals("-1")){
			FiltroTarifaSocialCartaoTipo filtroTarifaSocialCartaoTipo = new FiltroTarifaSocialCartaoTipo();

			filtroTarifaSocialCartaoTipo.adicionarParametro(new ParametroSimples(FiltroTarifaSocialCartaoTipo.ID, idCartaoTipo));

			Collection colecaoTarifasSociaisCartoesTipos = fachada.pesquisar(filtroTarifaSocialCartaoTipo, TarifaSocialCartaoTipo.class
							.getName());

			if(colecaoTarifasSociaisCartoesTipos != null && !colecaoTarifasSociaisCartoesTipos.isEmpty()){
				// O Tipo do Cartão da Tarifa Social foi encontrado
				Iterator tarifaSocialCartaoTipoIterator = colecaoTarifasSociaisCartoesTipos.iterator();

				tarifaSocialCartaoTipo = (TarifaSocialCartaoTipo) tarifaSocialCartaoTipoIterator.next();
		...
		if(idRendaTipo != null && !idRendaTipo.equals("") && !idRendaTipo.equals("-1")){
			FiltroRendaTipo filtroRendaTipo = new FiltroRendaTipo();

			filtroRendaTipo.adicionarParametro(new ParametroSimples(FiltroRendaTipo.ID, idRendaTipo));

			Collection colecaoRendasTipos = fachada.pesquisar(filtroRendaTipo, RendaTipo.class.getName());

			if(colecaoRendasTipos != null && !colecaoRendasTipos.isEmpty()){
				// O Tipo da Renda da Tarifa Social foi encontrado
				Iterator rendaTipoIterator = colecaoRendasTipos.iterator();

				rendaTipo = (RendaTipo) rendaTipoIterator.next();
		...
		if(valorRendaFamiliarInicialPesquisada != null && !valorRendaFamiliarInicialPesquisada.equals("")){
			valorRendaFamiliarInicial = Util.formatarMoedaRealparaBigDecimal(valorRendaFamiliarInicialPesquisada);
		}
		...
		if(valorRendaFamiliarFinalPesquisada != null && !valorRendaFamiliarFinalPesquisada.equals("")){
			valorRendaFamiliarFinal = Util.formatarMoedaRealparaBigDecimal(valorRendaFamiliarFinalPesquisada);
		}
		...
		if(consumoCelpeInicialPesquisado != null && !consumoCelpeInicialPesquisado.equals("")){
		...
		if(consumoCelpeFinalPesquisado != null && !consumoCelpeFinalPesquisado.equals("")){
		...
		if(dataRecadastramentoInicialPesquisada != null && !dataRecadastramentoInicialPesquisada.equals("")){
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		...
		if(dataRecadastramentoFinalPesquisada != null && !dataRecadastramentoFinalPesquisada.equals("")){
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
		...
		// Intervalo do Número de Recadastramentos
		...
		if(numeroRecadastramentosInicialPesquisado != null && !numeroRecadastramentosInicialPesquisado.equals("")){
			numeroRecadastramentosInicial = new Short(numeroRecadastramentosInicialPesquisado);
		}
		...
		if(numeroRecadastramentosFinalPesquisado != null && !numeroRecadastramentosFinalPesquisado.equals("")){
		...
		ligacaoAguaParametrosFinal.setNumeroConsumoMinimoAgua(consumoFixadoAguaFinal == null ? null : new Integer(consumoFixadoAguaFinal));
		ligacaoEsgotoParametrosInicial
						.setConsumoMinimo(consumoFixadoEsgotoInicial == null ? null : new Integer(consumoFixadoEsgotoInicial));
		...
		consumoHistoricoParametrosInicial.setConsumoMedio(mediaMinimaImovelInicial == null ? null : new Integer(mediaMinimaImovelInicial));
		 ...
		 * @date 25/04/2008
		 * Para evitar que a consulta seja passada com entidades "vazias", e assim lançar
		 * nullPointerException
		 */

		LogradouroCep logradouroCep = new LogradouroCep();
		if(cep != null && cep.getCepId() != null && logradouro != null && logradouro.getId() != null){
		...
		tarifaSocialDadoEconomiaInicial.setDataImplantacao(dataImplantacaoInicial);
		tarifaSocialDadoEconomiaInicial.setDataExclusao(dataExclusaoInicial);
		tarifaSocialDadoEconomiaInicial.setTarifaSocialExclusaoMotivo(tarifaSocialExclusaoMotivo);
		tarifaSocialDadoEconomiaInicial.setQuantidadeRecadastramento(numeroRecadastramentosInicial);
		tarifaSocialDadoEconomiaInicial.setDataRecadastramento(dataRecadastramentoInicial);
		...
		tarifaSocialDadoEconomiaFinal.setDataImplantacao(dataImplantacaoFinal);
		tarifaSocialDadoEconomiaFinal.setDataExclusao(dataExclusaoFinal);
		tarifaSocialDadoEconomiaFinal.setQuantidadeRecadastramento(numeroRecadastramentosFinal);
		tarifaSocialDadoEconomiaFinal.setDataRecadastramento(dataRecadastramentoFinal);
		...
		RelatorioDadosTarifaSocial relatorioDadosTarifaSocial = new RelatorioDadosTarifaSocial((Usuario) (httpServletRequest
						.getSession(false)).getAttribute("usuarioLogado"));

		relatorioDadosTarifaSocial.addParametro("imoveisRelatoriosHelper", imoveisRelatoriosHelper);
		relatorioDadosTarifaSocial.addParametro("imovelParametrosInicial", imovelParametrosInicial);
		relatorioDadosTarifaSocial.addParametro("imovelParametrosFinal", imovelParametrosFinal);
		relatorioDadosTarifaSocial.addParametro("clienteImovelParametros", clienteImovelParametros);
		relatorioDadosTarifaSocial.addParametro("municipio", municipio);
		relatorioDadosTarifaSocial.addParametro("bairro", bairro);
		relatorioDadosTarifaSocial.addParametro("medicaoHistoricoParametrosInicial", medicaoHistoricoParametrosInicial);
		relatorioDadosTarifaSocial.addParametro("medicaoHistoricoParametrosFinal", medicaoHistoricoParametrosFinal);
		relatorioDadosTarifaSocial.addParametro("consumoHistoricoParametrosInicial", consumoHistoricoParametrosInicial);
		relatorioDadosTarifaSocial.addParametro("consumoHistoricoParametrosFinal", consumoHistoricoParametrosFinal);
		relatorioDadosTarifaSocial.addParametro("gerenciaRegional", gerenciaRegional);
		relatorioDadosTarifaSocial.addParametro("categoria", categoria);
		relatorioDadosTarifaSocial.addParametro("subcategoria", subcategoria);
		relatorioDadosTarifaSocial.addParametro("cobrancaSituacao", cobrancaSituacao);
		relatorioDadosTarifaSocial.addParametro("indicadorMedicao", indicadorMedicao);
		relatorioDadosTarifaSocial.addParametro("indicadorSituacaoImovelTarifaSocial", indicadorSituacaoImovelTarifaSocial);
		relatorioDadosTarifaSocial.addParametro("tarifaSocialDadoEconomiaInicial", tarifaSocialDadoEconomiaInicial);
		relatorioDadosTarifaSocial.addParametro("tarifaSocialDadoEconomiaFinal", tarifaSocialDadoEconomiaFinal);
		...
		relatorioDadosTarifaSocial.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));

		try{
			retorno = processarExibicaoRelatorio(relatorioDadosTarifaSocial, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
