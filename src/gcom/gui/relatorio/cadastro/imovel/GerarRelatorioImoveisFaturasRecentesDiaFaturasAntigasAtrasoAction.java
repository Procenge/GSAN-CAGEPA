 ...
 * @date 08/01/2008
 */
public class GerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltrarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoHelper filtro = new FiltrarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoHelper();
		...
		if(form.getReferenciaFaturasDiaFinal() != null && !form.getReferenciaFaturasDiaFinal().equals("")){
		...
		RelatorioImoveisFaturasRecentesDiaFaturasAntigasAtraso relatorio = new RelatorioImoveisFaturasRecentesDiaFaturasAntigasAtraso(this
