...
public class GerarRelatorioImoveisConsumoMedioAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltrarRelatorioImoveisConsumoMedioHelper filtro = new FiltrarRelatorioImoveisConsumoMedioHelper();

		// Referencia
		if(form.getReferencia() != null && !form.getReferencia().equals("")){

			filtro.setReferencia(Util.formatarMesAnoComBarraParaAnoMes(form.getReferencia()));
		}
		...
		if(form.getConsumoMedioAguaInicial() != null && !form.getConsumoMedioAguaInicial().equals("")){

			filtro.setConsumoMedioAguaInicial(new Integer(form.getConsumoMedioAguaInicial()));
		}

		// Consumo Medio Agua Final
		if(form.getConsumoMedioAguaFinal() != null && !form.getConsumoMedioAguaFinal().equals("")){

			filtro.setConsumoMedioAguaFinal(new Integer(form.getConsumoMedioAguaFinal()));
		}

		// Consumo Medio Esgoto Inicial
		if(form.getConsumoMedioEsgotoInicial() != null && !form.getConsumoMedioEsgotoInicial().equals("")){

			filtro.setConsumoMedioEsgotoInicial(new Integer(form.getConsumoMedioEsgotoInicial()));
		}

		// Consumo Medio Esgoto Final
		if(form.getConsumoMedioEsgotoFinal() != null && !form.getConsumoMedioEsgotoFinal().equals("")){
		...
		RelatorioImoveisConsumoMedio relatorio = new RelatorioImoveisConsumoMedio(this.getUsuarioLogado(httpServletRequest));
