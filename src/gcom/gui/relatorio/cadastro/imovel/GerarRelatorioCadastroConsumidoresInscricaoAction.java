...
public class GerarRelatorioCadastroConsumidoresInscricaoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(codigoSetorComercialDestino != null && !codigoSetorComercialDestino.equals("")){
			...
			setorComercialDestino = fachada.pesquisarObjetoSetorComercialRelatorio(new Integer(codigoSetorComercialDestino), new Integer(
							idLocalidadeDestino));
		...
		RelatorioCadastroConsumidoresInscricao relatorio = new RelatorioCadastroConsumidoresInscricao((Usuario) (httpServletRequest
		...
		// cliente tipo ID
		relatorio.addParametro("clienteTipoID", imovelOutrosCriteriosActionForm.getIdClienteTipo());
		...
		relatorio.addParametro("situacaoAgua", imovelOutrosCriteriosActionForm.getSituacaoLigacaoAguaArray());
		...
		relatorio.addParametro("situacaoLigacaoEsgoto", imovelOutrosCriteriosActionForm.getSituacaoLigacaoEsgotoArray());
		...
		relatorio.addParametro("intervaloPercentualEsgotoFinal", imovelOutrosCriteriosActionForm.getIntervaloPercentualEsgotoFinal());
		// indicador Medicao
		...
		relatorio.addParametro("intervaloMediaMinimaImovelInicial", imovelOutrosCriteriosActionForm.getIntervaloMediaMinimaImovelInicio());
		// intervalo Media Minima Imovel Final
		relatorio.addParametro("intervaloMediaMinimaImoveFinal", imovelOutrosCriteriosActionForm.getIntervaloMediaMinimaImovelFinal());
		// intervalo Media Minima Hidrometro Inicial
		relatorio.addParametro("intervaloMediaMinimaHidrometroInicial", imovelOutrosCriteriosActionForm
						.getIntervaloMediaMinimaHidrometroInicio());
		// intervalo Media Minima Hidrometro Final
		relatorio.addParametro("intervaloMediaMinimaHidrometroFinal", imovelOutrosCriteriosActionForm
		...
		relatorio.addParametro("quantidadeEconomiasInicial", imovelOutrosCriteriosActionForm.getQuantidadeEconomiasInicial());
		// quantidade Economias Final
		relatorio.addParametro("quantidadeEconomiasFinal", imovelOutrosCriteriosActionForm.getQuantidadeEconomiasFinal());
		...
		relatorio.addParametro("tipoSituacaoFaturamentoID", imovelOutrosCriteriosActionForm.getTipoSituacaoEspecialFaturamento());
		// tipo Situacao Especial Cobranca ID
		relatorio.addParametro("tipoSituacaoEspecialCobrancaID", imovelOutrosCriteriosActionForm.getTipoSituacaoEspecialCobranca());
		// situacao Cobranca ID
		relatorio.addParametro("situacaoCobrancaID", imovelOutrosCriteriosActionForm.getSituacaoCobranca());
		// dia Vencimento Alternativo
		relatorio.addParametro("diaVencimentoAlternativo", imovelOutrosCriteriosActionForm.getDiaVencimentoAlternativo());
		// ocorrencia Cadastro
		...
		relatorio.addParametro("rotaInicial", imovelOutrosCriteriosActionForm.getCdRotaInicial());
		relatorio.addParametro("rotaFinal", imovelOutrosCriteriosActionForm.getCdRotaFinal());
		...
		relatorio.addParametro("segmentoInicial", imovelOutrosCriteriosActionForm.getSegmentoInicial());
		relatorio.addParametro("segmentoFinal", imovelOutrosCriteriosActionForm.getSegmentoFinal());
		relatorio.addParametro("subloteInicial", imovelOutrosCriteriosActionForm.getSubloteInicial());
		relatorio.addParametro("subloteFinal", imovelOutrosCriteriosActionForm.getSubloteFinal());
		relatorio.addParametro("indicadorOrdenacao", imovelOutrosCriteriosActionForm.getIndicadorOrdenacao());
