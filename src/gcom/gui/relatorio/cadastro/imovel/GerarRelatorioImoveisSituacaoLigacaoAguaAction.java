...
public class GerarRelatorioImoveisSituacaoLigacaoAguaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltrarRelatorioImoveisSituacaoLigacaoAguaHelper filtro = new FiltrarRelatorioImoveisSituacaoLigacaoAguaHelper();
		...
		if(form.getIndicadorOrdenacao() != null && !form.getIndicadorOrdenacao().equals("")){

			filtro.setIndicadorOrdenacao(form.getIndicadorOrdenacao());
		}

		String tipoRelatorio = httpServletRequest.getParameter("tipoRelatorio");

		RelatorioImoveisSituacaoLigacaoAgua relatorio = new RelatorioImoveisSituacaoLigacaoAgua(this.getUsuarioLogado(httpServletRequest));
