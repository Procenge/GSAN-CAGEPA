 ...
 */
public class GerarRelatorioQuadraManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idLocalidade = (String) filtrarQuadraActionForm.getLocalidadeID();
		String nomeLocalidade = (String) filtrarQuadraActionForm.getLocalidadeNome();
		...
		if(idLocalidade != null && !idLocalidade.equals("")){
			if(nomeLocalidade != null && !nomeLocalidade.equals("")){
				...
				if(localidades != null && !localidades.isEmpty()){
					...
					Localidade localidadePesquisa = (Localidade) localidadeIterator.next();
		...
		String idSetorComercial = (String) filtrarQuadraActionForm.getSetorComercialCD();
		String nomeSetorComercial = (String) filtrarQuadraActionForm.getSetorComercialNome();
		...
		if(idSetorComercial != null && !idSetorComercial.equals("")){
			if(nomeSetorComercial != null && !nomeSetorComercial.equals("")){
				...
				Collection setoresComerciais = fachada.pesquisar(filtroSetorComercial, SetorComercial.class.getName());
				...
				if(setoresComerciais != null && !setoresComerciais.isEmpty()){
					...
					SetorComercial setorComercialPesquisa = (SetorComercial) setorComercialIterator.next();

					setorComercial.setCodigo(setorComercialPesquisa.getCodigo());
					setorComercial.setDescricao(setorComercialPesquisa.getDescricao());
		...
		String quadraNMPesquisar = (String) filtrarQuadraActionForm.getQuadraNM();
		...
		if(filtrarQuadraActionForm.getIndicadorUso() != null && !filtrarQuadraActionForm.getIndicadorUso().equals("")){

			indicadorDeUso = new Short(filtrarQuadraActionForm.getIndicadorUso());
		}
		...
		if(quadraNM != null){
			quadraParametros.setNumeroQuadra(Integer.parseInt(quadraNM));
		}else{
			quadraParametros.setNumeroQuadra(-1);
		}
		...
		RelatorioManterQuadra relatorioManterQuadra = new RelatorioManterQuadra((Usuario) (httpServletRequest.getSession(false))
						.getAttribute("usuarioLogado"));

		relatorioManterQuadra.addParametro("filtroQuadra", filtroQuadra);
		relatorioManterQuadra.addParametro("quadraParametros", quadraParametros);
		...
		relatorioManterQuadra.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterQuadra, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
