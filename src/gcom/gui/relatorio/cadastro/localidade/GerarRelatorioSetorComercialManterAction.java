...
public class GerarRelatorioSetorComercialManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idMunicipio = (String) pesquisarAtualizarSetorComercialActionForm.getMunicipioID();
		...
		String idLocalidade = (String) pesquisarAtualizarSetorComercialActionForm.getLocalidadeID();
		...
		String codigoSetorComercialPesquisar = (String) pesquisarAtualizarSetorComercialActionForm.getSetorComercialCD();

		if(codigoSetorComercialPesquisar != null && !codigoSetorComercialPesquisar.equals("")){
			codigoSetorComercial = Integer.parseInt(codigoSetorComercialPesquisar);
		}

		Short indicadorDeUso = null;

		if(pesquisarAtualizarSetorComercialActionForm.getIndicadorUso() != null
						&& !pesquisarAtualizarSetorComercialActionForm.getIndicadorUso().equals("")){

			indicadorDeUso = new Short("" + pesquisarAtualizarSetorComercialActionForm.getIndicadorUso());
		}

		String nomeSetorComercial = "";

		if(pesquisarAtualizarSetorComercialActionForm.getSetorComercialNome() != null){
			nomeSetorComercial = pesquisarAtualizarSetorComercialActionForm.getSetorComercialNome();
		}
		...
		RelatorioManterSetorComercial relatorioManterSetorComercial = new RelatorioManterSetorComercial((Usuario) (httpServletRequest
						.getSession(false)).getAttribute("usuarioLogado"));

		relatorioManterSetorComercial.addParametro("filtroSetorComercial", filtroSetorComercial);
		relatorioManterSetorComercial.addParametro("setorComercialParametros", setorComercialParametros);
		...
		relatorioManterSetorComercial.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterSetorComercial, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
