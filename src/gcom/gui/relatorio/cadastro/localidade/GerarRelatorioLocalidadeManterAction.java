...
public class GerarRelatorioLocalidadeManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroLocalidade filtroLocalidade = (FiltroLocalidade) sessao.getAttribute("filtroLocalidade");
		...
		String idLocalidadePesquisar = (String) filtrarLocalidadeActionForm.getLocalidadeID();

		if(idLocalidadePesquisar != null && !idLocalidadePesquisar.equals("")){
			idLocalidade = idLocalidadePesquisar;
		}

		String idGerenciaRegional = (String) filtrarLocalidadeActionForm.getGerenciaID();
		...
		if(filtrarLocalidadeActionForm.getIndicadorUso() != null && !filtrarLocalidadeActionForm.getIndicadorUso().equals("")){

			indicadorDeUso = new Short("" + filtrarLocalidadeActionForm.getIndicadorUso());
		}

		// seta os parametros que serão mostrados no relatório

		localidadeParametros.setId(idLocalidade == null ? null : new Integer(idLocalidade));
		localidadeParametros.setDescricao("" + filtrarLocalidadeActionForm.getLocalidadeNome());
		...
		relatorioManterLocalidade.addParametro("filtroLocalidade", filtroLocalidade);
		relatorioManterLocalidade.addParametro("localidadeParametros", localidadeParametros);
		...
		relatorioManterLocalidade.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterLocalidade, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
