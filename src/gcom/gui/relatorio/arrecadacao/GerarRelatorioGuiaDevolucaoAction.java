 ...
 * @date 06/10/2006
 */
public class GerarRelatorioGuiaDevolucaoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioGuiaDevolucao relatorioGuiaDevolucao = new RelatorioGuiaDevolucao((Usuario) (httpServletRequest.getSession(false))
		...
		relatorioGuiaDevolucao.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioGuiaDevolucao, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
