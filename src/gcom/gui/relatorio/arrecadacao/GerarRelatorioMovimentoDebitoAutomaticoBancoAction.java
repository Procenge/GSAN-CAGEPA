 ...
 */
public class GerarRelatorioMovimentoDebitoAutomaticoBancoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Collection colecaoGerarMovimentoDebitoAutomatico = (Collection) sessao.getAttribute("colecaogerarMovimentoDebitoAutomatico");
		...
		try{
			...
			relatorioMovimentoDebitoAutomaticoBanco.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
			retorno = processarExibicaoRelatorio(relatorioMovimentoDebitoAutomaticoBanco, tipoRelatorio, httpServletRequest,
