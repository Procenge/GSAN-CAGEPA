 ...
 * @date 23/02/2006
 */
public class FiltrarRelatorioControleDocumentosArrecadacaoActionForm
				extends ActionForm {

	private static final long serialVersionUID = 1L;

	public static String SINTETICO = "sintetico";

	public static String ANALITICO = "analitico";
	...
	private String indicadorTipo = ANALITICO;
