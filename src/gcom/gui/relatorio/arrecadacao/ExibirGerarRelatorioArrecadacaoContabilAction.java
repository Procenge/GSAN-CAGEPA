 ...
 */
public class ExibirGerarRelatorioArrecadacaoContabilAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirGerarRelatorioArrecadacaoContabil");
		...
		if(form.get("relatorio") == null || form.get("relatorio").equals("")){
			form.set("relatorio", "RelatorioClassificacaoContabil-Geral.rpt");
		}
