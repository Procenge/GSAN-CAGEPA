...
import gcom.relatorio.cobranca.RelatorioContasAReceberCorrigidoCategorias;
 ...
 * @author André Lopes
 */
public class GerarRelatorioContasAReceberCorrigidoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioContasAReceberCorrigidoCategorias relatorio = new RelatorioContasAReceberCorrigidoCategorias(
		...
		relatorio.addParametro("opcaoTotalizador", form.getOpcaoTotalizacao());
		relatorio.addParametro("unidadeNegocio", form.getUnidadeNegocio());
		relatorio.addParametro("gerenciaRegional", form.getGerencialRegional());
