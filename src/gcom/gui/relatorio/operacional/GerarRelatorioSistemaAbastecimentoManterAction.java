...
import gcom.gui.operacional.abastecimento.FiltrarSistemaAbastecimentoActionForm;
 ...
 * @date 09/02/2011
 */
public class GerarRelatorioSistemaAbastecimentoManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(form.getCodigo() != null && !form.getCodigo().equals("")){
			sistemaAbastecimentoParametros.setCodigo(new Integer("" + form.getCodigo()));
		}

		if(form.getDescricao() != null && !form.getDescricao().equals("")){
			sistemaAbastecimentoParametros.setDescricao(form.getDescricao());
		}
		...
		if(form.getIndicadorUso() != null && !form.getIndicadorUso().equals("")){
			sistemaAbastecimentoParametros.setIndicadorUso(new Short("" + form.getIndicadorUso()));
		}
		...
		relatorioManterSistemaAbastecimento.addParametro("filtroSistemaAbastecimento", filtroSistemaAbastecimento);
		relatorioManterSistemaAbastecimento.addParametro("sistemaAbastecimentoParametros", sistemaAbastecimentoParametros);
		...
		relatorioManterSistemaAbastecimento.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterSistemaAbastecimento, tipoRelatorio, httpServletRequest,
