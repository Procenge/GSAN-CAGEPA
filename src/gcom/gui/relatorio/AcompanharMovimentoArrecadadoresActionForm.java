 ...
 * @since 30/03/2006
 */
public class AcompanharMovimentoArrecadadoresActionForm
				extends ActionForm {
	...
	private String codArrecadador;

	private String idConcessionaria;

	public String getCodArrecadador(){

		return codArrecadador;
	}

	public void setCodArrecadador(String codArrecadador){

		this.codArrecadador = codArrecadador;
	}
	 ...
	 *            O idFormaArrecadacao a ser setado.
	 */
