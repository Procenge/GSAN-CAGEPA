...
public class GerarRelatorioQuadroMetasAcumuladoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// Form
		EmissaoRelatorioQuadroMetasAcumuladoActionForm form = (EmissaoRelatorioQuadroMetasAcumuladoActionForm) actionForm;
		...
		// Gerência Regional
		if((opcaoTotalizacao == 6 || opcaoTotalizacao == 10) && form.getGerenciaRegional() != null
		...
		// Unidade de Negocio
		if(opcaoTotalizacao == 10 && form.getUnidadeNegocio() != null
		...
		// Localidade
		if(opcaoTotalizacao == 16 && form.getLocalidade() != null && !form.getLocalidade().equals("")){
			filtro.setLocalidade(new Integer(form.getLocalidade()));
		}

		String tipoRelatorio = httpServletRequest.getParameter("tipoRelatorio");

		RelatorioQuadroMetasAcumulado relatorio = new RelatorioQuadroMetasAcumulado(this.getUsuarioLogado(httpServletRequest));
