...
public class GerarRelatorioResumoFaturamentoSituacaoEspecialAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		try{
			...
			relatorioResumoFaturamentoSituacaoEspecial.addParametro("resumoFaturamentoSituacaoEspecialConsultaFinalHelper",
							resumoFaturamentoSituacaoEspecialConsultaFinalHelper);

			relatorioResumoFaturamentoSituacaoEspecial.addParametro("resumoCobrancaSituacaoEspecialConsultaFinalHelper",
							resumoCobrancaSituacaoEspecialConsultaFinalHelper);

			if(resumoFaturamentoSituacaoEspecialConsultaFinalHelper != null){
				relatorioResumoFaturamentoSituacaoEspecial.addParametro("nomeRelatorio", "FATURAMENTO");
			}else{
				relatorioResumoFaturamentoSituacaoEspecial.addParametro("nomeRelatorio", "COBRANÇA");
			}
			...
			relatorioResumoFaturamentoSituacaoEspecial.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
			retorno = processarExibicaoRelatorio(relatorioResumoFaturamentoSituacaoEspecial, tipoRelatorio, httpServletRequest,
