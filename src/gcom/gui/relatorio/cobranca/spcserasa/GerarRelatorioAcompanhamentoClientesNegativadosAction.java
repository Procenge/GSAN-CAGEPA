 ...
 */
public class GerarRelatorioAcompanhamentoClientesNegativadosAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// periodoEnvioNegativacaoInicio = (Date)
		// sessao.getAttribute("periodoEnvioNegativacaoInicio");
		// }
		...
		if(!Util.isVazioOuBranco(form.getTituloComando())){
		...
		// if (arrayCobrancaGrupo == null || (arrayCobrancaGrupo.length == 1 &&
		// arrayCobrancaGrupo[0].equalsIgnoreCase(""))) {
		...
		// if (arrayGerenciaRegional == null || (arrayGerenciaRegional.length == 1 &&
		// arrayGerenciaRegional[0].equalsIgnoreCase(""))) {
	...
	private DadosConsultaNegativacaoHelper validarGeracaoRelatorio(String idNegativador, Date periodoEnvioNegativacaoInicio,
					Date periodoEnvioNegativacaoFim, String tituloComando, Integer idEloPolo, Integer idLocalidade,
		...
		if(!Util.isVazioOuBranco(idNegativador)){
		...
		if(!Util.isVazioOuBranco(idEloPolo)){
		...
		if(!Util.isVazioOuBranco(idQuadra)){
	 ...
	 * @param form
	 */
	private void validarFormulario(InformarDadosConsultaNegativacaoActionForm form){

		if(Util.isVazioOuBranco(form.getIdNegativador())){
			throw new ActionServletException("atencao.informe_campo", null, "Negativador");
		}

		this.validarDatas(form.getPeriodoEnvioNegativacaoInicio(), form.getPeriodoEnvioNegativacaoFim());
	}
	...
	private void validarDatas(String periodoInicio, String periodoFim) throws ActionServletException{
		...
		}else if(!Util.isVazioOuBranco(periodoInicio) && Util.isVazioOuBranco(periodoFim)){

			// Só informou o período inicial
