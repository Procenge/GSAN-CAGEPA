...
import gcom.gui.cobranca.spcserasa.FiltrarContratoNegativadorActionForm;
import gcom.relatorio.ExibidorProcessamentoTarefaRelatorio;
import gcom.relatorio.RelatorioVazioException;
import gcom.relatorio.cobranca.spcserasa.RelatorioManterNegativadorContrato;
 ...
 */
public class GerarRelatorioNegativadorContratoManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		relatorioManterNegativadorContrato.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterNegativadorContrato, tipoRelatorio, httpServletRequest,
