 ...
 */
public class GerarRelatorioNegativadorRegistroTipoManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		relatorioManterNegativadorRegistroTipo.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterNegativadorRegistroTipo, tipoRelatorio, httpServletRequest,
