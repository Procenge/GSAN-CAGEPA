 ...
 */
public class GerarRelatorioNegativadorManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String codigoImovel = "";
		if(form.getCodigoImovel() != null && !form.getCodigoImovel().equalsIgnoreCase("")){
		...
		if(codigoCliente != null && !codigoCliente.equals("")){
			...
			filtroNegativador.adicionarParametro(new ParametroSimples(FiltroNegativador.NEGATIVADOR_CLIENTE, codigoCliente));
		...
		if(codigoImovel != null && !codigoImovel.equalsIgnoreCase("")){
			FiltroNegativador filtroNegativador = new FiltroNegativador();

			filtroNegativador.adicionarParametro(new ParametroSimples(FiltroNegativador.NEGATIVADOR_IMOVEL, codigoImovel));
			...
			if(collNegativador != null && !collNegativador.isEmpty()){
				...
				if(negativadorPesquisa.getImovel() != null){
		...
		RelatorioManterNegativador relatorioManterNegativador = new RelatorioManterNegativador((Usuario) (httpServletRequest
		...
		relatorioManterNegativador.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterNegativador, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
