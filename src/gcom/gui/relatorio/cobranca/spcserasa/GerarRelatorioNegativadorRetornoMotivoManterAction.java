 ...
 */
public class GerarRelatorioNegativadorRetornoMotivoManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		relatorioManterNegativadorRetornoMotivo.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterNegativadorRetornoMotivo, tipoRelatorio, httpServletRequest,
