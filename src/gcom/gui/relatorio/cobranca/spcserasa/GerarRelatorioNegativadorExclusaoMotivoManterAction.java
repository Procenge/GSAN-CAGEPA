 ...
 */
public class GerarRelatorioNegativadorExclusaoMotivoManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		relatorioManterNegativadorExclusaoMotivo.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterNegativadorExclusaoMotivo, tipoRelatorio, httpServletRequest,
