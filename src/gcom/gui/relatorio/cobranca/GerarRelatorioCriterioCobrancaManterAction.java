...
public class GerarRelatorioCriterioCobrancaManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltroCobrancaCriterio filtroCobrancaCriterio = (FiltroCobrancaCriterio) sessao.getAttribute("filtroCobrancaCriterio");
		...
		String descricaoPesquisar = (String) criterioCobrancaFiltrarActionForm.getDescricaoCriterio();
		...
		String dataInicioPesquisar = (String) criterioCobrancaFiltrarActionForm.getDataInicioVigencia();
		...
		String numeroAnosPesquisar = (String) criterioCobrancaFiltrarActionForm.getNumeroAnoContaAntiga();
		...
		String situacaoEspecialCobrancaPesquisar = (String) criterioCobrancaFiltrarActionForm.getOpcaoAcaoImovelSitEspecial();

		if(situacaoEspecialCobrancaPesquisar != null && !situacaoEspecialCobrancaPesquisar.equals("")
						&& !situacaoEspecialCobrancaPesquisar.equals("3")){

			situacaoEspecialCobranca = new Short(situacaoEspecialCobrancaPesquisar);
		...
		String situacaoCobrancaPesquisar = (String) criterioCobrancaFiltrarActionForm.getOpcaoAcaoImovelSit();

		if(situacaoCobrancaPesquisar != null && !situacaoCobrancaPesquisar.equals("") && !situacaoCobrancaPesquisar.equals("3")){
		...
		String contasRevisaoPesquisar = (String) criterioCobrancaFiltrarActionForm.getOpcaoContasRevisao();

		if(contasRevisaoPesquisar != null && !contasRevisaoPesquisar.equals("") && !contasRevisaoPesquisar.equals("3")){
		...
		String imovelDebitoContaMesPesquisar = (String) criterioCobrancaFiltrarActionForm.getOpcaoAcaoImovelDebitoMesConta();

		if(imovelDebitoContaMesPesquisar != null && !imovelDebitoContaMesPesquisar.equals("") && !imovelDebitoContaMesPesquisar.equals("3")){
		...
		String inquilinoDebitoContaMesPesquisar = (String) criterioCobrancaFiltrarActionForm.getOpcaoAcaoInquilinoDebitoMesConta();

		if(inquilinoDebitoContaMesPesquisar != null && !inquilinoDebitoContaMesPesquisar.equals("")
		...
		String imovelDebitoContasAntigasPesquisar = (String) criterioCobrancaFiltrarActionForm.getOpcaoAcaoImovelDebitoContasAntigas();

		if(imovelDebitoContasAntigasPesquisar != null && !imovelDebitoContasAntigasPesquisar.equals("")
		...
		String indicadorUsoPesquisar = (String) criterioCobrancaFiltrarActionForm.getIndicadorUso();

		if(indicadorUsoPesquisar != null && !indicadorUsoPesquisar.equals("") && !indicadorUsoPesquisar.equals("3")){
		...
		RelatorioManterCriterioCobranca relatorioManterCriterioCobranca = new RelatorioManterCriterioCobranca((Usuario) (httpServletRequest
						.getSession(false)).getAttribute("usuarioLogado"));
		relatorioManterCriterioCobranca.addParametro("filtroCobrancaCriterio", filtroCobrancaCriterio);
		relatorioManterCriterioCobranca.addParametro("cobrancaCriterioParametros", cobrancaCriterioParametros);
		...
		relatorioManterCriterioCobranca.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterCriterioCobranca, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
