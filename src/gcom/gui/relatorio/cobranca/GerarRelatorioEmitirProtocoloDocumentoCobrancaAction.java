 ...
 * @date 15/05/2007
 */
public class GerarRelatorioEmitirProtocoloDocumentoCobrancaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioEmitirProtocoloDocumentoCobranca relatorioEmitirProtocoloDocumentoCobranca = new RelatorioEmitirProtocoloDocumentoCobranca(
		...
		if(sessao.getAttribute("cobrancaAcaoAtividadeCronograma") != null){
			...
			String primeiroTitulo = "COBRANÇA: "
							+ Util.formatarAnoMesParaMesAno(cobrancaAcaoAtividadeCronograma.getCobrancaAcaoCronograma()
											.getCobrancaGrupoCronogramaMes().getAnoMesReferencia()) + "    " + "DATA DA REALIZAÇÃO: "
							+ Util.formatarData(cobrancaAcaoAtividadeCronograma.getRealizacao()) + "    " + "HORA DA REALIZAÇÃO: "
							+ Util.formatarHoraSemData(cobrancaAcaoAtividadeCronograma.getRealizacao());
			relatorioEmitirProtocoloDocumentoCobranca.addParametro("grupo", cobrancaAcaoAtividadeCronograma.getCobrancaAcaoCronograma()
							.getCobrancaGrupoCronogramaMes().getCobrancaGrupo().getDescricao());
			relatorioEmitirProtocoloDocumentoCobranca.addParametro("primeiroTitulo", primeiroTitulo);
			relatorioEmitirProtocoloDocumentoCobranca.addParametro("acaoCobranca", "RESUMO DAS ORDENS DE COBRANÇA EMITIDAS "
			...
			String primeiroTitulo = "DATA DA REALIZAÇÃO: " + form.getDataRealizacao() + "    " + "HORA DA REALIZAÇÃO: "
							+ form.getHoraRealizacao();
			relatorioEmitirProtocoloDocumentoCobranca.addParametro("primeiroTitulo", primeiroTitulo);
			relatorioEmitirProtocoloDocumentoCobranca.addParametro("acaoCobranca", "RESUMO DAS ORDENS DE COBRANÇA EMITIDAS "
							+ form.getAcaoCobranca() + " - EVENTUAL");
		}
		...
		try{
			...
			retorno = processarExibicaoRelatorio(relatorioEmitirProtocoloDocumentoCobranca, tipoRelatorio, httpServletRequest,
