...
public class GerarRelatorioEmitirHistogramaEsgotoEconomiaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(form.getVolumoFixoEsgoto() != null && !form.getVolumoFixoEsgoto().equals("")){
			...
			filtro.setVolumoFixoEsgoto(Short.valueOf(form.getVolumoFixoEsgoto()));
		}

		String tipoRelatorio = httpServletRequest.getParameter("tipoRelatorio");

		RelatorioHistogramaEsgotoEconomia relatorio = new RelatorioHistogramaEsgotoEconomia(this.getUsuarioLogado(httpServletRequest));
