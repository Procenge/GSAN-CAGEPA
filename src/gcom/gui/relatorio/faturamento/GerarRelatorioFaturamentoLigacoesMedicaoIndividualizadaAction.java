...
public class GerarRelatorioFaturamentoLigacoesMedicaoIndividualizadaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		Integer indicadorRateio = null;

		if(!Util.isVazioOuBranco(sessao.getAttribute("indicadorRateio"))){
			indicadorRateio = Integer.valueOf((String) sessao.getAttribute("indicadorRateio"));
		}

		Collection colecaoFaturamentoLigacoesMedicaoIndividualizadaHelper = fachada
						.pesquisarFaturamentoLigacoesMedicaoIndividualizadaRelatorio(filtroMedicaoHistoricoSql,
										"" + sistemaParametro.getAnoMesFaturamento(), indicadorRateio);

		// Parte que vai mandar o relatório para a tela
		// cria uma instância da classe do relatório
		RelatorioFaturamentoLigacoesMedicaoIndividualizada relatorioFaturamentoLigacoesMedicaoIndividualizada = new RelatorioFaturamentoLigacoesMedicaoIndividualizada(
						(Usuario) (httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));

		relatorioFaturamentoLigacoesMedicaoIndividualizada.addParametro("colecaoFaturamentoLigacoesMedicaoIndividualizadaHelper",
		...
		relatorioFaturamentoLigacoesMedicaoIndividualizada.addParametro("anoMesFaturamentoGrupo", Util
		...
		try{
			retorno = processarExibicaoRelatorio(relatorioFaturamentoLigacoesMedicaoIndividualizada, tipoRelatorio, httpServletRequest,
