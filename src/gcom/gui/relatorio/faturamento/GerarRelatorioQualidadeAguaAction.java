 ...
 */
public class GerarRelatorioQualidadeAguaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioQualidadeAgua relatorioQualidadeAgua = new RelatorioQualidadeAgua((Usuario) (httpServletRequest.getSession(false))
						.getAttribute("usuarioLogado"));

		relatorioQualidadeAgua.addParametro("filtroQualidadeAgua", filtroQualidadeAgua);
		relatorioQualidadeAgua.addParametro("qualidadeParametros", qualidadeParametros);
		...
		relatorioQualidadeAgua.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioQualidadeAgua, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
