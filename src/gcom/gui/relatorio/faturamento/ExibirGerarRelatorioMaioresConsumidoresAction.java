 ...
 * @since 12/11/2013
 */
public class ExibirGerarRelatorioMaioresConsumidoresAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirGerarMaioresConsumidores");
		// Flag indicando que o usuário fez uma consulta a partir da tecla Enter
		String objetoConsulta = httpServletRequest.getParameter("objetoConsulta");
		GerarRelatorioMaioresConsumidoresActionForm form = (GerarRelatorioMaioresConsumidoresActionForm) actionForm;
	...
	private void pesquisarLocalidade(GerarRelatorioMaioresConsumidoresActionForm form, HttpServletRequest httpServletRequest){
	...
	private void preencherForm(GerarRelatorioMaioresConsumidoresActionForm form, String localidade, String nomeLocalidade){
