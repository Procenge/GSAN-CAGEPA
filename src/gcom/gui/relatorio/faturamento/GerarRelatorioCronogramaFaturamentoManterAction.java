...
public class GerarRelatorioCronogramaFaturamentoManterAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		String idGrupoFaturamento = (String) pesquisarActionForm.get("idGrupoFaturamento");
		...
		if(mesAnoPesquisar != null && !mesAnoPesquisar.equals("")){
			...
			filtroFaturamentoAtividadeCronograma.adicionarParametro(new ParametroSimples(
							FiltroFaturamentoAtividadeCronograma.FATURAMENTO_GRUPO_CRONOGRAMA_MENSAL_ANO_MES_REFERENCIA, anoMes));
		}

		// seta os parametros que serão mostrados no relatório

		if(faturamentoGrupo != null){
			faturamentoGrupoCronogramaMensalParametros.setFaturamentoGrupo(faturamentoGrupo);
		}
		...
		relatorioManterCronogramaFaturamento.addParametro("filtroFaturamentoAtividadeCronograma", filtroFaturamentoAtividadeCronograma);
		relatorioManterCronogramaFaturamento.addParametro("faturamentoGrupoCronogramaMensalParametros",
		...
		relatorioManterCronogramaFaturamento.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioManterCronogramaFaturamento, tipoRelatorio, httpServletRequest,
