...
public class GerarRelatorioResumoFaturamentoAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioResumoFaturamento relatorioResumoFaturamento = new RelatorioResumoFaturamento((Usuario) (httpServletRequest
		...
		relatorioResumoFaturamento.addParametro("tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		try{
			retorno = processarExibicaoRelatorio(relatorioResumoFaturamento, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
