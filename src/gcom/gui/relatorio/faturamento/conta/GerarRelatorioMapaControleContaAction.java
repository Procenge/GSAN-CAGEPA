...
public class GerarRelatorioMapaControleContaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		FiltrarMapaControleContaRelatorioActionForm filtrarMapaControleContaRelatorioActionForm = (FiltrarMapaControleContaRelatorioActionForm) sessao
						.getAttribute("filtrarMapaControleContaRelatorioActionForm");
		...
		RelatorioMapaControleConta relatorioMapaControleConta = new RelatorioMapaControleConta((Usuario) (httpServletRequest
		...
		try{
			retorno = processarExibicaoRelatorio(relatorioMapaControleConta, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
