...
public class GerarRelatorioResumoContaLocalidadeAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		RelatorioResumoContaLocalidade relatorioResumoContaLocalidade = new RelatorioResumoContaLocalidade((Usuario) (httpServletRequest
		...
		relatorioResumoContaLocalidade.addParametro("idGrupoFaturamento", filtrarMapaControleContaRelatorioActionForm
						.getIdGrupoFaturamento());
		relatorioResumoContaLocalidade.addParametro("idLocalidade", filtrarMapaControleContaRelatorioActionForm.getIdLocalidade());
		relatorioResumoContaLocalidade.addParametro("idSetorComercial", filtrarMapaControleContaRelatorioActionForm.getIdSetorComercial());
		...
		try{
			retorno = processarExibicaoRelatorio(relatorioResumoContaLocalidade, tipoRelatorio, httpServletRequest, httpServletResponse,
							actionMapping);
