...
public class ExibirGerarRelatorioImoveisLigacaoCortadaComConsumoAction
				extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
					HttpServletResponse httpServletResponse){

		ActionForward retorno = actionMapping.findForward("exibirGerarRelatorioImoveisLigacaoCortadaComConsumo");
		...
		Collection colecaoClienteTipoEspecial = fachada.pesquisar(new ClienteTipoEspecial());

		if(!colecaoClienteTipoEspecial.isEmpty()){
			sessao.setAttribute("colecaoClienteTipoEspecial", colecaoClienteTipoEspecial);
		}else{
			throw new ActionServletException("erro.naocadastrado", null, "cliente tipo especial");
		}
