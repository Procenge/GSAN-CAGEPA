...
public class GerarRelatorioEmitirHistogramaAguaEconomiaAction
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		filtro.setLinkedHashMapConsumoFaixaCategoria(linkedHashMapConsumoFaixaCategoria);
		...
		if(form.getConsumo() != null && !form.getConsumo().equals("")){
			...
			filtro.setConsumo(Short.valueOf(form.getConsumo()));
		}

		// Indicador Poco
		if(form.getPoco() != null && !form.getPoco().equals("")){

			filtro.setPoco(Short.valueOf(form.getPoco()));
		}

		// Indicador Volume
		if(form.getVolumoFixoAgua() != null && !form.getVolumoFixoAgua().equals("")){

			filtro.setVolumoFixoAgua(Short.valueOf(form.getVolumoFixoAgua()));
		}

		String tipoRelatorio = httpServletRequest.getParameter("tipoRelatorio");

		RelatorioHistogramaAguaEconomia relatorio = new RelatorioHistogramaAguaEconomia(this.getUsuarioLogado(httpServletRequest));
