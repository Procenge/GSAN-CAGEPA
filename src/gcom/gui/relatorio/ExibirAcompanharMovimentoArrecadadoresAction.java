 ...
 * @since 02/04/2007
 */
public class ExibirAcompanharMovimentoArrecadadoresAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("exibirAcompanharMovimentoArrecadadores");
		...
		String codArrecadador = acompanharMovimentoArrecadadoresActionForm.getCodArrecadador();
