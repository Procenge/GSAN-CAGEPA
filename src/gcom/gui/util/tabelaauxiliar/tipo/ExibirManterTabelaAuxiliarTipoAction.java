 ...
 */
public class ExibirManterTabelaAuxiliarTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("manterTabelaAuxiliarTipo");
		...
		// auxiliar abreviada
		if(httpServletRequest.getAttribute("filtroTabelaAuxiliarTipo") != null){
			filtroTabelaAuxiliarTipo = (FiltroTabelaAuxiliarTipo) httpServletRequest.getAttribute("filtroTabelaAuxiliarTipo");
			...
			if(fachada.registroMaximo(TabelaAuxiliar.class) > ConstantesSistema.NUMERO_MAXIMO_REGISTROS_MANUTENCAO){
				...
				// é chamada
				retorno = actionMapping.findForward("filtrarTabelaAuxiliarTipo");
		...
		if(retorno.getName().equalsIgnoreCase("manterTabelaAuxiliarTipo")){
			...
			filtroTabelaAuxiliarTipo.setCampoOrderBy(FiltroTabelaAuxiliarTipo.ID);

			// Pesquisa de tabelas auxiliares
			tabelasAuxiliaresTipos = fachada.pesquisarTabelaAuxiliar(filtroTabelaAuxiliarTipo, pacoteNomeObjeto);
			...
			sessao.setAttribute("tabelasAuxiliaresTipos", tabelasAuxiliaresTipos);
		...
		sessao.setAttribute("funcionalidadeTabelaAuxiliarTipoManter", funcionalidadeTabelaAuxiliarTipoManter);
