 ...
 */
public class FiltrarTabelaAuxiliarTipoAction
				extends Action {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(descricao != null && !descricao.trim().equalsIgnoreCase("")){
			filtroTabelaAuxiliarTipo.adicionarParametro(new ComparacaoTexto(FiltroTabelaAuxiliarTipo.DESCRICAO, descricao));
		}
