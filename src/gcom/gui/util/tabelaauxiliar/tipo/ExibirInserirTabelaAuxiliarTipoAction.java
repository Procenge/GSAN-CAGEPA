 ...
 */
public class ExibirInserirTabelaAuxiliarTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirTabelaAuxiliarTipo");
		...
		tipos = fachada.pesquisarTabelaAuxiliar(filtroTabelaAuxiliar, pacoteNomeObjeto);
		...
		sessao.setAttribute("funcionalidadeTabelaAuxiliarTipoInserir", funcionalidadeTabelaAuxiliarTipoInserir);
