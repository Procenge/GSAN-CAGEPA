 ...
 */
public class ExibirFiltrarTabelaAuxiliarTipoAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarTabelaAuxiliarTipo");
		...
		tipos = fachada.pesquisarTabelaAuxiliar(filtroTabelaAuxiliarTipo, pacoteNomeObjeto);
