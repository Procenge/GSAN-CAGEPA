 ...
 */
public class FiltrarTabelaAuxiliarAction
				extends Action {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("retornarFiltroTabelaAuxiliar");
		...
		httpServletRequest.setAttribute("filtroTabelaAuxiliar", filtroTabelaAuxiliar);
