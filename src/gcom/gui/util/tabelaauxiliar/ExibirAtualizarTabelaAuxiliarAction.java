 ...
 * @author rodrigo
 */
public class ExibirAtualizarTabelaAuxiliarAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarTabelaAuxiliar");
		...
		filtroTabelaAuxiliar.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliar.ID, id));
		...
		Collection tabelasAuxiliares = fachada.pesquisarTabelaAuxiliar(filtroTabelaAuxiliar, pacoteNomeObjeto);
		...
		Iterator iteratorTabelaAuxiliar = tabelasAuxiliares.iterator();

		// A tabela auxiliar que será atualizada
		TabelaAuxiliar tabelaAuxiliar = (TabelaAuxiliar) iteratorTabelaAuxiliar.next();
