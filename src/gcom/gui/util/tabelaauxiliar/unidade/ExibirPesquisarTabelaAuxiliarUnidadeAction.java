 ...
 * @date 02/08/2006
 */
public class ExibirPesquisarTabelaAuxiliarUnidadeAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("pesquisarTabelaAuxiliarUnidade");
		...
		// tela requisitada
		DadosTelaTabelaAuxiliarUnidade dados = DadosTelaTabelaAuxiliarUnidade.obterDadosTelaTabelaAuxiliarAbreviada(tela);
