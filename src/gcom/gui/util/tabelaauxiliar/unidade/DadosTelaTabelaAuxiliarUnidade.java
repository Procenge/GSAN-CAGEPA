 ...
 * @date 02/08/2006
 */
public class DadosTelaTabelaAuxiliarUnidade
				extends DadosTelaTabelaAuxiliarAbreviada {
	 ...
	 * @return
	 */
	public static DadosTelaTabelaAuxiliarUnidade obterDadosTelaTabelaAuxiliarAbreviada(String nome){
		...
		if(!telas.containsKey(nome)){
			...
			try{
				...
				DadosTelaTabelaAuxiliarUnidade dadosTela = new DadosTelaTabelaAuxiliarUnidade(configuracaoTela[1],
								(TabelaAuxiliarUnidade) Class.forName(configuracaoTela[0]).newInstance(), configuracaoTela[2], nome);
	...
	static{
		...
		configuracaoParametrosTelas.put("material", new String[] {Material.class.getName(), "Material", Funcionalidade.TELA_MATERIAL});
	 ...
	 *            Descrição do parâmetro
	 */
	protected DadosTelaTabelaAuxiliarUnidade(String titulo, TabelaAuxiliar tabela, String funcionalidadeTabelaAux,
