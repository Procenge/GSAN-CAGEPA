 ...
 */
public class AtualizarTabelaAuxiliarIndicadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		TabelaAuxiliarIndicador tabelaAuxiliarIndicador = (TabelaAuxiliarIndicador) sessao.getAttribute("tabelaAuxiliarIndicador");

		String tela = (String) sessao.getAttribute("tela");

		String indicadorNegocio = null;

		if(tela.equalsIgnoreCase("quadraPerfil")){ // Indica que a atualização é da Perfil de Quadra
		...
		if(form.getIndicadorUso() != null){
			tabelaAuxiliarIndicador.setIndicadorUso(new Short(form.getIndicadorUso()));
		}
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			...
			montarPaginaSucesso(httpServletRequest, ((String) sessao.getAttribute("titulo")) + " "
							+ tabelaAuxiliarIndicador.getId().toString() + " atualizado(a) com sucesso.", "Realizar outra manutenção de "
