 ...
 */
public class ExibirFiltrarTabelaAuxiliarIndicadorAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarTabelaAuxiliarIndicador");
		...
		sessao.setAttribute("funcionalidadeTabelaAuxiliarIndicadorInserir", dados.getFuncionalidadeTabelaAuxInserir());
