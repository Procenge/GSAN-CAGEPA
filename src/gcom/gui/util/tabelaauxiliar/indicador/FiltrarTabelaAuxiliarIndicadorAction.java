 ...
 */
public class FiltrarTabelaAuxiliarIndicadorAction
				extends Action {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("retornarFiltroTabelaAuxiliarIndicador");
		...
		String indicadorNegocio = (String) pesquisarActionForm.get("indicadorNegocio");
		...
		if(descricao != null && !descricao.trim().equalsIgnoreCase("")){
			...
			filtroTabelaAuxiliarIndicador.adicionarParametro(new ComparacaoTexto(FiltroTabelaAuxiliarIndicador.DESCRICAO, descricao));
		}
		...
		if(indicadorUso != null && !indicadorUso.trim().equalsIgnoreCase("")){
			...
			filtroTabelaAuxiliarIndicador
							.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliarIndicador.INDICADORUSO, indicadorUso));
		}
		...
		httpServletRequest.setAttribute("filtroTabelaAuxiliarIndicador", filtroTabelaAuxiliarIndicador);
