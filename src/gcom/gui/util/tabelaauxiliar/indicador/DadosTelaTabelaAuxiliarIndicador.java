...
import gcom.gui.util.tabelaauxiliar.faixa.DadosTelaTabelaAuxiliarFaixaReal;
 ...
 */
public class DadosTelaTabelaAuxiliarIndicador
	 ...
	 *            Descrição do parâmetro
	 */
	protected DadosTelaTabelaAuxiliarIndicador(String titulo, TabelaAuxiliarAbstrata tabela, String funcionalidadeTabelaAux,
	...
	public static DadosTelaTabelaAuxiliar obterDadosTelaTabelaAuxiliar(String nome){
		...
		if(!telas.containsKey(nome)){
			...
			try{
				...
				DadosTelaTabelaAuxiliarIndicador dadosTela = new DadosTelaTabelaAuxiliarIndicador(configuracaoTela[1],
								(TabelaAuxiliarIndicador) Class.forName(configuracaoTela[0]).newInstance(), configuracaoTela[2], nome);
			...
			return (DadosTelaTabelaAuxiliarIndicador) telas.get(nome);
		}
	}
	...
	static{
		...
		configuracaoParametrosTelas.put("quadraPerfil",
						new String[] {QuadraPerfil.class.getName(), "Perfil Quadra", Funcionalidade.TELA_QUADRA_PERFIL});
	...
	/**
	 * @param nomeParametroFuncionalidade
	 *            The nomeParametroFuncionalidade to set.
	 */
	 ...
	 *            The funcionalidadeTabelaAux to set.
	 */
