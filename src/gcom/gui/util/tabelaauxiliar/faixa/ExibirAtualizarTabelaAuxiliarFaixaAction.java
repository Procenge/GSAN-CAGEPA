 ...
 */
public class ExibirAtualizarTabelaAuxiliarFaixaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("atualizarTabelaAuxiliarFaixa");
		...
		Collection tabelasAuxiliaresFaixas = fachada.pesquisarTabelaAuxiliar(filtroTabelaAuxiliarFaixa, pacoteNomeObjeto);
		...
		Iterator iteratorTabelaAuxiliarFaixa = tabelasAuxiliaresFaixas.iterator();

		// A tabela auxiliar faixa que será atualizada
		TabelaAuxiliarFaixa tabelaAuxiliarFaixa = (TabelaAuxiliarFaixa) iteratorTabelaAuxiliarFaixa.next();
