 ...
 */
public class ExibirManterTabelaAuxiliarFaixaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("manterTabelaAuxiliarFaixa");
		...
		// auxiliar faixa
		if(httpServletRequest.getAttribute("filtroTabelaAuxiliarFaixa") != null){
			filtroTabelaAuxiliarFaixa = (FiltroTabelaAuxiliarFaixa) httpServletRequest.getAttribute("filtroTabelaAuxiliarFaixa");
		}else{
			...
			if(fachada.registroMaximo(TabelaAuxiliarFaixa.class) > ConstantesSistema.NUMERO_MAXIMO_REGISTROS_MANUTENCAO){
				...
				// é chamada
				retorno = actionMapping.findForward("filtrarTabelaAuxiliarFaixa");
		...
		if(retorno.getName().equalsIgnoreCase("manterTabelaAuxiliarFaixa")){
			...
			filtroTabelaAuxiliarFaixa.setCampoOrderBy(FiltroTabelaAuxiliarFaixa.ID);
			// Pesquisa de tabelas auxiliares
			tabelasAuxiliaresFaixas = fachada.pesquisarTabelaAuxiliar(filtroTabelaAuxiliarFaixa, pacoteNomeObjeto);
			...
			sessao.setAttribute("tabelasAuxiliaresFaixas", tabelasAuxiliaresFaixas);
		...
		sessao.setAttribute("funcionalidadeTabelaAuxiliarFaixaManter", funcionalidadeTabelaAuxiliarFaixaManter);
		sessao.setAttribute("tamMaxCampoFaixaInicial", new Integer(tamMaxCampoFaixaInicial));
		sessao.setAttribute("tamMaxCampoFaixaFinal", new Integer(tamMaxCampoFaixaFinal));
