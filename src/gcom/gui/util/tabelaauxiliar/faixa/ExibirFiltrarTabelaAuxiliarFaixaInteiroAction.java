 ...
 */
public class ExibirFiltrarTabelaAuxiliarFaixaInteiroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarTabelaAuxiliarFaixaInteiro");
		...
		String titulo = null;
		int tamMaxCampoMaior = 8;
		int tamMaxCampoMenor = 8;
		...
		sessao.setAttribute("tamMaxCampoMenor", new Integer(tamMaxCampoMenor));
		sessao.setAttribute("tamMaxCampoMenor", new Integer(tamMaxCampoMenor));
