 ...
 */
public class ExibirInserirTabelaAuxiliarFaixaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirTabelaAuxiliarFaixa");
		...
		sessao.setAttribute("funcionalidadeTabelaAuxiliarFaixaInserir", funcionalidadeTabelaAuxiliarFaixaInserir);
		...
		httpServletRequest.setAttribute("tamMaxCampoFaixaFinal", new Integer(tamMaxCampoFaixaFinal));
