 ...
 */
public class InserirTabelaAuxiliarFaixaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		TabelaAuxiliarFaixa tabelaAuxiliarFaixa = (TabelaAuxiliarFaixa) sessao.getAttribute("tabelaAuxiliarFaixa");

		// Seta faixa inicial informada
		tabelaAuxiliarFaixa.setFaixaInicial(tabelaAuxiliarFaixaActionForm.getFaixaInicial());

		// Seta faixa final faixa informada
		tabelaAuxiliarFaixa.setFaixaFinal(tabelaAuxiliarFaixaActionForm.getFaixaFinal());
