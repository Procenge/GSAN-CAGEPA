 ...
 */
public class ExibirFiltrarTabelaAuxiliarFaixaRealAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("filtrarTabelaAuxiliarFaixaReal");
		...
		String titulo = null;
		int tamMaxCampoVolumeMaior = 9;
		int tamMaxCampoVolumeMenor = 9;
		...
		sessao.setAttribute("tamMaxCampoVolumeMaior", new Integer(tamMaxCampoVolumeMaior));
		sessao.setAttribute("tamMaxCampoVolumeMenor", new Integer(tamMaxCampoVolumeMenor));
