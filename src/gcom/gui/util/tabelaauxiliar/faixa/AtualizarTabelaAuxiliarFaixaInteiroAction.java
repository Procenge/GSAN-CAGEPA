 ...
 * @author gcom
 */
public class AtualizarTabelaAuxiliarFaixaInteiroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		if(form.getMenorFaixa() != null && !form.getMenorFaixa().trim().equalsIgnoreCase("") && form.getMaiorFaixa() != null
			...
			if(new Integer(form.getMenorFaixa()).intValue() > new Integer(form.getMaiorFaixa())){
		...
		if(form.getIndicadorUso() != null){
			tabelaAuxiliarFaixaInteiro.setIndicadorUso(new Short(form.getIndicadorUso()));
		}
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			...
			montarPaginaSucesso(httpServletRequest, ((String) sessao.getAttribute("titulo")) + " "
							+ tabelaAuxiliarFaixaInteiro.getId().toString() + " atualizado(a) com sucesso.",
							"Realizar outra manutenção de " + ((String) sessao.getAttribute("titulo")), ((String) sessao
											.getAttribute("funcionalidadeTabelaAuxiliarFaixaInteiroFiltrar")));

		}

		// Remove os objetos da sessão
		sessao.removeAttribute("funcionalidadeTabelaAuxiliarFaixaInteiroManter");
