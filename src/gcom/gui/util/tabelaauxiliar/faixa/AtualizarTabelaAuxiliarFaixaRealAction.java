 ...
 */
public class AtualizarTabelaAuxiliarFaixaRealAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		TabelaAuxiliarFaixaReal tabelaAuxiliarFaixaReal = (TabelaAuxiliarFaixaReal) sessao.getAttribute("tabelaAuxiliarFaixaReal");
		...
		if(form.getIndicadorUso() != null){
			tabelaAuxiliarFaixaReal.setIndicadorUso(new Short(form.getIndicadorUso()));
		}
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			...
			montarPaginaSucesso(httpServletRequest, ((String) sessao.getAttribute("titulo")) + " "
							+ tabelaAuxiliarFaixaReal.getId().toString() + " atualizado(a) com sucesso.", "Realizar outra manutenção de "
