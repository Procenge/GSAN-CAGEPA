 ...
 */
public class ExibirInserirTabelaAuxiliarFaixaInteiroAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("inserirTabelaAuxiliarFaixaInteiro");
		...
		int tamMaxCampoFaixaCompleta = 8;
		...
		sessao.setAttribute("funcionalidadeTabelaAuxiliarFaixaInteiroInserir", dados.getFuncionalidadeTabelaFaixaInteiroInserir());
		sessao.setAttribute("nomeParametroFuncionalidade", dados.getNomeParametroFuncionalidade());

		// Adiciona o objeto no request
		httpServletRequest.setAttribute("tamMaxCampoMenorFaixa", new Integer(tamMaxCampoMenorFaixa));
		httpServletRequest.setAttribute("tamMaxCampoMaiorFaixa", new Integer(tamMaxCampoMaiorFaixa));
