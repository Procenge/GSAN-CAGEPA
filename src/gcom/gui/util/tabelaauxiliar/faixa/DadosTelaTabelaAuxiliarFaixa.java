 ...
 */
public class DadosTelaTabelaAuxiliarFaixa
		...
		if(!telas.containsKey(nome)){
			...
			try{
				...
				DadosTelaTabelaAuxiliarFaixaReal dadosTela = new DadosTelaTabelaAuxiliarFaixaReal(configuracaoTela[1],
								(TabelaAuxiliarFaixa) Class.forName(configuracaoTela[0]).newInstance(), configuracaoTela[2], nome,
								configuracaoTela[3]);
	...
	static{
		...
		configuracaoParametrosTelas
						.put(
										"piscinaVolumeFaixa",
										new String[] {PiscinaVolumeFaixa.class.getName(), "Faixa Volume Piscina", Funcionalidade.TELA_PISCINA_VOLUME_FAIXA});

		configuracaoParametrosTelas
						.put(
										"reservatorioVolumeFaixa",
										new String[] {ReservatorioVolumeFaixa.class.getName(), "Faixa Volume Reservatorio", Funcionalidade.TELA_RESERVATORIO_VOLUME_FAIXA});
	 ...
	 *            Descrição do parâmetro
	 */
	protected DadosTelaTabelaAuxiliarFaixa(String titulo, TabelaAuxiliarAbstrata tabela, String funcionalidadeTabelaAux,
	...
	public String getFuncionalidadeTabelaFaixaFiltrar(){
		...
		return Funcionalidade.TABELA_AUXILIAR_FAIXA_FILTRAR + funcionalidadeTabelaAux;
	}
