 ...
 */
public class InserirTabelaAuxiliarFaixaRealAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		TabelaAuxiliarFaixaReal tabelaAuxiliarFaixaReal = (TabelaAuxiliarFaixaReal) sessao.getAttribute("tabela");

		BigDecimal volumeMenorFaixa = null;

		if(form.getVolumeMenorFaixa() != null && !form.getVolumeMenorFaixa().trim().equalsIgnoreCase("")){
		...
		if(form.getVolumeMaiorFaixa() != null && !form.getVolumeMaiorFaixa().trim().equalsIgnoreCase("")){
			...
			if(volumeMaiorFaixa != null && volumeMenorFaixa != null){
		...
		tabelaAuxiliarFaixaReal.setIndicadorUso(ConstantesSistema.INDICADOR_USO_ATIVO);

		FiltroTabelaAuxiliarFaixaReal filtroTabelaAuxiliarFaixaReal = new FiltroTabelaAuxiliarFaixaReal();

		filtroTabelaAuxiliarFaixaReal.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliarFaixaReal.VOLUME_MENOR_FAIXA,
						tabelaAuxiliarFaixaReal.getVolumeMenorFaixa()));

		filtroTabelaAuxiliarFaixaReal.adicionarParametro(new ParametroSimples(FiltroTabelaAuxiliarFaixaReal.VOLUME_MAIOR_FAIXA,
						tabelaAuxiliarFaixaReal.getVolumeMaiorFaixa()));

		Collection colecaoTabelaAuxiliarFaixaReal = fachada.pesquisar(filtroTabelaAuxiliarFaixaReal, tabelaAuxiliarFaixaReal.getClass()
						.getName());
