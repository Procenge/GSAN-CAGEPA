 ...
 */
public class DadosTelaTabelaAuxiliarFaixaInteiro
	...
	public static DadosTelaTabelaAuxiliar obterDadosTelaTabelaAuxiliar(String nome){
		...
		if(!telas.containsKey(nome)){
			...
			try{
				...
				DadosTelaTabelaAuxiliarFaixaInteiro dadosTela = new DadosTelaTabelaAuxiliarFaixaInteiro(configuracaoTela[1],
								(TabelaAuxiliarFaixaInteiro) Class.forName(configuracaoTela[0]).newInstance(), configuracaoTela[2], nome);
			...
			return (DadosTelaTabelaAuxiliarFaixaInteiro) telas.get(nome);
		}
	}
	 ...
	 *            Descrição do parâmetro
	 */
	protected DadosTelaTabelaAuxiliarFaixaInteiro(String titulo, TabelaAuxiliarAbstrata tabela, String funcionalidadeTabelaAux,
	...
	public String getFuncionalidadeTabelaFaixaInteiroManter(){
		...
		return Funcionalidade.TABELA_AUXILIAR_FAIXA_INTEIRO_MANTER + funcionalidadeTabelaAux;
	}
	...
	public String getFuncionalidadeTabelaFaixaInteiroFiltrar(){
		...
		return Funcionalidade.TABELA_AUXILIAR_FAIXA_INTEIRO_FILTRAR + funcionalidadeTabelaAux;
	}
	...
	public String getFuncionalidadeTabelaFaixaInteiroInserir(){
		...
		return Funcionalidade.TABELA_AUXILIAR_FAIXA_INTEIRO_INSERIR + funcionalidadeTabelaAux;
	}
