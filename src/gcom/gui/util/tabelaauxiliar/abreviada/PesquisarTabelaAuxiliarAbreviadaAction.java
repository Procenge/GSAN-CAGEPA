...
public class PesquisarTabelaAuxiliarAbreviadaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		ActionForward retorno = actionMapping.findForward("retornoPesquisaTabelaAuxiliarAbreviada");

		// Mudar isso quando tiver esquema de segurança
		HttpSession sessao = httpServletRequest.getSession(false);

		// Pega o parametro passado no request
		DadosTelaTabelaAuxiliar dados = (DadosTelaTabelaAuxiliarAbreviada) sessao.getAttribute("dados");
		...
		if(descricao != null && !descricao.equalsIgnoreCase("")){
			...
			if(tipoPesquisa != null && tipoPesquisa.equals(ConstantesSistema.TIPO_PESQUISA_COMPLETA.toString())){
				...
				filtroTabelaAuxiliarAbreviada.adicionarParametro(new ComparacaoTextoCompleto(FiltroTabelaAuxiliarAbreviada.DESCRICAO,
								descricao));
			}else{
				filtroTabelaAuxiliarAbreviada.adicionarParametro(new ComparacaoTexto(FiltroTabelaAuxiliarAbreviada.DESCRICAO, descricao));
			}
		}
		...
		TabelaAuxiliarAbreviada tabelaAuxiliarAbreviada = (TabelaAuxiliarAbreviada) dados.getTabelaAuxiliar();

		// Faz a busca das empresas
		colecaoTabelaAuxiliarAbreviada = fachada.pesquisar(filtroTabelaAuxiliarAbreviada, tabelaAuxiliarAbreviada.getClass().getName());

		if(colecaoTabelaAuxiliarAbreviada == null || colecaoTabelaAuxiliarAbreviada.isEmpty()){
			// Nenhum municipio cadastrado
			throw new ActionServletException("atencao.pesquisa.nenhumresultado", null, dados.getTitulo());
		}else{
			Map resultado = controlarPaginacao(httpServletRequest, retorno, filtroTabelaAuxiliarAbreviada, tabelaAuxiliarAbreviada
							.getClass().getName());
