 ...
 */
public class AtualizarTabelaAuxiliarAbreviadaAction
				extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		TabelaAuxiliarAbreviada tabelaAuxiliarAbreviada = (TabelaAuxiliarAbreviada) sessao.getAttribute("tabelaAuxiliarAbreviada");
		...
		tabelaAuxiliarAbreviada.setDescricaoAbreviada(tabelaAuxiliarAbreviadaActionForm.getDescricaoAbreviada().toUpperCase());
		...
		if(retorno.getName().equalsIgnoreCase("telaSucesso")){
			...
			montarPaginaSucesso(httpServletRequest, ((String) sessao.getAttribute("titulo")) + " "
							+ tabelaAuxiliarAbreviada.getId().toString() + " atualizado(a) com sucesso.", "Realizar outra manutenção de "
