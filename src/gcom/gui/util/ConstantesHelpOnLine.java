...
/**
 * Classe que recupera do arquivo .properties as url do help para exibição
 * online
 * 
 * @author isilva
 * @date 12/05/2010
 */
public class ConstantesHelpOnLine {
	
	public static String TEXTO_INFORMADO = "";

	// Nome do Arquivo de propriedades
	private final static String NOME_ARQUIVO_PROPRIEDADES;

	// guarda as constantes contidas no
	// helponline.properties juntamente com seus valores
	private static Properties propriedades = null;

	// inicialização estática
	static {
		// Nome do Arquivo de propriedades
		NOME_ARQUIVO_PROPRIEDADES = "/helponline.properties";
		loadResources();
	}
	...
	public static String get(String key) {
		...
		String retorno = TEXTO_INFORMADO;
