 ...
 * @date 26/02/2015
 */
public class TransferenciaDebitosItem
	...
	/** persistent field */
	private TransferenciaDebitos transferenciaDebitos;

	private Cliente clienteOrigem;

	private ClienteRelacaoTipo clienteRelacaoTipoOrigem;
	...
	/** default constructor */
	public TransferenciaDebitosItem() {
	...
	public TransferenciaDebitos getTransferenciaDebitos(){

		return this.transferenciaDebitos;
	}

	public void setTransferenciaDebitos(TransferenciaDebitos transferenciaDebitos){

		this.transferenciaDebitos = transferenciaDebitos;
	}
	...
	public ClienteRelacaoTipo getClienteRelacaoTipoOrigem(){

		return clienteRelacaoTipoOrigem;
	}

	public void setClienteRelacaoTipoOrigem(ClienteRelacaoTipo clienteRelacaoTipoOrigem){

		this.clienteRelacaoTipoOrigem = clienteRelacaoTipoOrigem;
	}
