...
public class NegativacaoCriterioLigacaoAguaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("negativacaoCriterio", getNegativacaoCriterio()).append("ligacaoAguaSituacao",
						getLigacaoAguaSituacao()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getNegativacaoCriterio(), castOther.getNegativacaoCriterio()).append(
						this.getLigacaoAguaSituacao(), castOther.getLigacaoAguaSituacao()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getNegativacaoCriterio()).append(getLigacaoAguaSituacao()).toHashCode();
	}
