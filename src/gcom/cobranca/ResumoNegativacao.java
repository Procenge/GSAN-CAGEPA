...
public class ResumoNegativacao
	...
	public ResumoNegativacao(Integer id, short indicadorNegativacaoConfirmada, int codigoSetorcomercial, int numeroQuadra,
								int quantidadeInclusoes, BigDecimal valorDebito, BigDecimal valorPendente, BigDecimal valorPago,
								BigDecimal valorParcelado, BigDecimal valorCancelado, Date ultimaAlteracao,
								GerenciaRegional gerenciaRegional, Localidade localidade, Quadra quadra, ImovelPerfil imovelPerfil,
								gcom.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacao, SetorComercial setorComercial,
								gcom.cobranca.CobrancaGrupo cobrancaGrupo, gcom.cobranca.NegativacaoComando negativacaoComando,
								ClienteTipo clienteTipo, UnidadeNegocio unidadeNegocio, EsferaPoder esferaPoder, Categoria categoria,
	...
	/** minimal constructor */
	public ResumoNegativacao(Integer id, short indicadorNegativacaoConfirmada, int codigoSetorcomercial, int numeroQuadra,
								int quantidadeInclusoes, BigDecimal valorDebito, Date ultimaAlteracao, GerenciaRegional gerenciaRegional,
								Localidade localidade, Quadra quadra, ImovelPerfil imovelPerfil,
								gcom.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacao, SetorComercial setorComercial,
								gcom.cobranca.CobrancaGrupo cobrancaGrupo, gcom.cobranca.NegativacaoComando negativacaoComando,
								ClienteTipo clienteTipo, UnidadeNegocio unidadeNegocio, EsferaPoder esferaPoder, Categoria categoria) {
