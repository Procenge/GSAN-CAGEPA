...
public class CobrancaDebitoSituacao
	...
	public static final Integer PAGO = Integer.valueOf(2);

	public static final Integer PARCELADO = Integer.valueOf(3);

	public static final Integer CANCELADO = Integer.valueOf(4);

	public static final Integer SEM_DEBITOS = Integer.valueOf(5);

	public static final Integer EXECUTADO = Integer.valueOf(6);

	public static final Integer EXCLUIDO = Integer.valueOf(7);
	...
	/**
	 * @param cobrancaDocumentoItems
	 *            O cobrancaDocumentoItems a ser setado.
	 */
