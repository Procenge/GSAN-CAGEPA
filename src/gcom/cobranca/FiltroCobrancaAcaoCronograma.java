...
public class FiltroCobrancaAcaoCronograma
				extends Filtro
	...
	public final static String PROGRAMA_COBRANCA_ID = "programaCobranca.id";

	public final static String PROGRAMA_COBRANCA = "programaCobranca";

	public final static String COBRANCA_GRUPO_CRONOGRAMA_MES_GRUPO_ID = "cobrancaGrupoCronogramaMes.cobrancaGrupo.id";

	public final static String COBRANCA_GRUPO_CRONOGRAMA_MES_GRUPO_MES_REFERENCIA = "cobrancaGrupoCronogramaMes.cobrancaGrupo.anoMesReferencia";
