...
public class NegativacaoCriterioImovelPerfilPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("negativacaoCriterio", getNegativacaoCriterio()).append("imovelPerfil", getImovelPerfil())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getNegativacaoCriterio(), castOther.getNegativacaoCriterio()).append(this.getImovelPerfil(),
						castOther.getImovelPerfil()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getNegativacaoCriterio()).append(getImovelPerfil()).toHashCode();
	}
