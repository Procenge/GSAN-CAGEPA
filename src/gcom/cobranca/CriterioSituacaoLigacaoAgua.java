...
public class CriterioSituacaoLigacaoAgua
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarCaminhoParaCarregamentoEntidade(FiltroCriterioSituacaoLigacaoAgua.COBRANCA_CRITERIO);
		filtro.adicionarCaminhoParaCarregamentoEntidade(FiltroCriterioSituacaoLigacaoAgua.LIGACAO_AGUA_SITUACAO);
		filtro.adicionarParametro(new ParametroSimples(FiltroCriterioSituacaoLigacaoAgua.COBRANCA_CRITERIO_ID, this.getComp_id()
						.getCobrancaCriterio().getId()));
		filtro.adicionarParametro(new ParametroSimples(FiltroCriterioSituacaoLigacaoAgua.LIGACAO_AGUA_SITUACAO_ID, this.getComp_id()
