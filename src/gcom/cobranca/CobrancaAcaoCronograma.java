...
public class CobrancaAcaoCronograma
	...
	private gcom.cobranca.CobrancaEstagio cobrancaEstagio;
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaAcaoCronograma.adicionarCaminhoParaCarregamentoEntidade("programacaoCobranca");
		filtroCobrancaAcaoCronograma.adicionarParametro(new ParametroSimples(FiltroCobrancaAcaoCronograma.ID, this.getId()));

		return filtroCobrancaAcaoCronograma;
	}

	/** full constructor */
	public CobrancaAcaoCronograma(Date ultimaAlteracao, gcom.cobranca.CobrancaAcao cobrancaAcao,
									gcom.cobranca.CobrancaGrupoCronogramaMes cobrancaGrupoCronogramaMes,
									gcom.cobranca.programacobranca.ProgramaCobranca programaCobranca) {
	 ...
	 * @param id
	 */
	public CobrancaAcaoCronograma(Integer id) {
	...
	public void setCobrancaGrupoCronogramaMes(gcom.cobranca.CobrancaGrupoCronogramaMes cobrancaGrupoCronogramaMes){
	...
	public gcom.cobranca.CobrancaEstagio getCobrancaEstagio(){

		return cobrancaEstagio;
	}

	public void setCobrancaEstagio(gcom.cobranca.CobrancaEstagio cobrancaEstagio){
