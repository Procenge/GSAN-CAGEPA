...
public class NegativadorRegistroTipo
	...
	// Modelo Antigo SPC
	public static final Integer ID_SPC_HEADER_SP = new Integer(1);

	public static final Integer ID_SPC_TRAILLER_SP = new Integer(2);

	public static final Integer ID_SPC_DETALHE_CONSUMIDOR_SP = new Integer(3);

	public static final Integer ID_SPC_DETALHE_SPC_SP = new Integer(4);

	// Modelo Novo SPC
	public static final Integer ID_SPC_DETALHE_CONSUMIDOR_NOME_SP = new Integer(8);

	public static final Integer ID_SPC_DETALHE_CONSUMIDOR_ENDERECO_SP = new Integer(9);

	public static final Integer ID_SPC_DETALHE_OCORRENCIA_SPC_SP = new Integer(10);

	// SPC BRASIL
	public static final Integer ID_SPC_HEADER_BR = new Integer(11);

	public static final Integer ID_SPC_TRAILLER_BR = new Integer(12);

	public static final Integer ID_SPC_DETALHE_CONSUMIDOR_BR = new Integer(13);

	public static final Integer ID_SPC_DETALHE_SPC_BR = new Integer(14);
	...
	/** full constructor */
	public NegativadorRegistroTipo(Integer id, String descricaoRegistroTipo, String codigoRegistro, Date ultimaAlteracao,
									gcom.cobranca.Negativador negativador, Set negativadorMovimentoReg) {
