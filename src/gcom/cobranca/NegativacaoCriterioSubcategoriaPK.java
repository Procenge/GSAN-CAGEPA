...
public class NegativacaoCriterioSubcategoriaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("negativacaoCriterio", getNegativacaoCriterio()).append("subcategoria", getSubcategoria())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getNegativacaoCriterio(), castOther.getNegativacaoCriterio()).append(this.getSubcategoria(),
						castOther.getSubcategoria()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getNegativacaoCriterio()).append(getSubcategoria()).toHashCode();
	}
