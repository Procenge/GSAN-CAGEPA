...
public class NegativacaoComando
	...
	/** full constructor */
	public NegativacaoComando(Integer id, short indicadorComandoCriterio, Date dataPrevista, Date dataHoraComando, Date dataHoraRealizacao,
								Integer quantidadeInclusoes, BigDecimal valorDebito, Integer quantidadeItensIncluidos,
	...
	/** minimal constructor */
	public NegativacaoComando(Integer id, short indicadorComandoCriterio, Date dataPrevista, short indicadorSimulacao, Usuario usuario,
								Set negativacaoCriterios) {
	...
	/**
	 * @param idComandoSimulacao
	 *            O idComandoSimulacao a ser setado.
	 */
