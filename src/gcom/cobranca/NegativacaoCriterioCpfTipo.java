...
public class NegativacaoCriterioCpfTipo
	...
	/** full constructor */
	public NegativacaoCriterioCpfTipo(Integer id, Short numeroOrdemSelecao, short indicadorCoincidente, Date ultimaAlteracao,
										gcom.cobranca.NegativacaoCriterio negativacaoCriterio, CpfTipo cpfTipo) {
	...
	public int hashCode(){
		...
		return new HashCodeBuilder().append(getCpfTipo().getId()).toHashCode();
	}
