 ...
 * @author gcom
 */
public class CriterioSituacaoCobrancaPK
				extends ObjetoGcom {
	...
	public boolean equals(Object other){
		...
		if(!(other instanceof CriterioSituacaoCobrancaPK)) return false;
		CriterioSituacaoCobrancaPK castOther = (CriterioSituacaoCobrancaPK) other;
		return new EqualsBuilder().append(this.getCobrancaCriterio(), castOther.getCobrancaCriterio()).append(this.getCobrancaSituacao(),
						castOther.getCobrancaSituacao()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getCobrancaCriterio()).append(getCobrancaSituacao()).toHashCode();
	}
