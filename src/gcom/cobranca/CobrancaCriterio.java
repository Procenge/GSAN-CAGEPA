...
public class CobrancaCriterio
	...
	public static final int INDICADOR_TELEFONE_SIM = 1;

	public static final int INDICADOR_TELEFONE_NAO = 2;

	public static final int INDICADOR_TELEFONE_AMBOS = 3;

	public static final int INDICADOR_COM_CPF_CNPJ_SIM = 1;

	public static final int INDICADOR_COM_CPF_CNPJ_NAO = 2;

	public static final int INDICADOR_COM_CPF_CNPJ_AMBOS = 3;
	...
	private Integer qtdDiasCortado;
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaCriterio.adicionarParametro(new ParametroSimples(FiltroCobrancaCriterio.ID, this.getId()));
	...
	/**
	 * @param percentualQuantidadeMinimoPagoParceladoCancelado
	 *            O percentualQuantidadeMinimoPagoParceladoCancelado a ser setado.
	 */
	public void setPercentualQuantidadeMinimoPagoParceladoCancelado(BigDecimal percentualQuantidadeMinimoPagoParceladoCancelado){
	...
	/**
	 * @param percentualValorMinimoPagoParceladoCancelado
	 *            O percentualValorMinimoPagoParceladoCancelado a ser setado.
	 */
	public void setPercentualValorMinimoPagoParceladoCancelado(BigDecimal percentualValorMinimoPagoParceladoCancelado){
	...
	/**
	 * @param valorLimitePrioridade
	 *            O valorLimitePrioridade a ser setado.
	 */
	...
	public String getDescricaoParaRegistroTransacao(){
		...
		if(this.getId() != null && this.getDescricaoCobrancaCriterio() != null){
			retorno = this.getId() + " - " + this.getDescricaoCobrancaCriterio();
		}else{
			retorno = null;
		}
	...
	public Short getIndicadorComCpf(){

		return indicadorComCpf;
	}

	public void setIndicadorComCpf(Short indicadorComCpf){

		this.indicadorComCpf = indicadorComCpf;
	}

	public Short getIndicadorComTelefone(){

		return indicadorComTelefone;
	}
	...
	public void setQtdDiasCortado(Integer qtdDiasCortado){
