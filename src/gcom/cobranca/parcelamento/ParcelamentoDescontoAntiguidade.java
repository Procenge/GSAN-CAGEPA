...
public class ParcelamentoDescontoAntiguidade
	...
	public Filtro retornaFiltro(){
		...
		filtroParcelamentoDescontoAntiguidade.adicionarParametro(new ParametroSimples(FiltroParcelamentoDescontoAntiguidade.ID, this
						.getId()));
	...
	/**
	 * @param percentualDescontoAtivo
	 *            O percentualDescontoAtivo a ser setado.
	 */
