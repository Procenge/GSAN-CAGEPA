...
public class Parcelamento
	...
	public Parcelamento(Date parcelamento, Integer anoMesReferenciaFaturamento, BigDecimal valorConta, BigDecimal valorServicosACobrar,
						...
						BigDecimal valorDebitoAtualizado, BigDecimal valorDescontoAcrescimos, BigDecimal valorEntrada,
						BigDecimal valorJurosParcelamento, Short numeroPrestacoes, BigDecimal valorPrestacao,
						BigDecimal valorDescontoAntiguidade, Short indicadorDebitoACobrar, BigDecimal valorDescontoInatividade,
						BigDecimal percentualDescontoAcrescimos, Short indicadorAcrescimosImpontualdade, BigDecimal valorGuiaPapagamento,
						BigDecimal percentualDescontoAntiguidade, BigDecimal percentualDescontoInatividade, Integer codigoSetorComercial,
						Integer numeroQuadra, Date ultimaAlteracao, BigDecimal valorCreditoARealizar, BigDecimal valorParcelamentosACobrar,
						Short indicadorRestabelecimento, Short indicadorContasRevisao, Short indicadorGuiasPagamento,
						Short indicadorCreditoARealizar, BigDecimal taxaJuros,
						gcom.cobranca.parcelamento.ParcelamentoTipo parcelamentoTipo,
						gcom.cobranca.parcelamento.ParcelamentoSituacao parcelamentoSituacao, RegistroAtendimento registroAtendimento,
						Imovel imovel, LigacaoEsgotoSituacao ligacaoEsgotoSituacao,
						gcom.cobranca.parcelamento.ParcelamentoPerfil parcelamentoPerfil, ImovelPerfil imovelPerfil,
						CobrancaForma cobrancaForma, Quadra quadra, Localidade localidade,
						ParcelamentoMotivoDesfazer parcelamentoMotivoDesfazer, LigacaoAguaSituacao ligacaoAguaSituacao,
						Funcionario funcionario, Short indicadorConfirmacaoParcelamento, Cliente cliente, Usuario usuario,
						ResolucaoDiretoria resolucaoDiretoria, BigDecimal valorDescontoSancao) {
	...
	public Parcelamento(Integer id, BigDecimal valorEntrada) {
	...
	/** minimal constructor */
	public Parcelamento(gcom.cobranca.parcelamento.ParcelamentoTipo parcelamentoTipo,
						gcom.cobranca.parcelamento.ParcelamentoSituacao parcelamentoSituacao, RegistroAtendimento registroAtendimento,
						Imovel imovel, LigacaoEsgotoSituacao ligacaoEsgotoSituacao,
						gcom.cobranca.parcelamento.ParcelamentoPerfil parcelamentoPerfil, ImovelPerfil imovelPerfil,
						CobrancaForma cobrancaForma, Quadra quadra, Localidade localidade,
						ParcelamentoMotivoDesfazer parcelamentoMotivoDesfazer, LigacaoAguaSituacao ligacaoAguaSituacao,
						Funcionario funcionario, Short indicadorConfirmacaoParcelamento) {
	...
	public ParcelamentoTermoTestemunhas getParcelamentoTermoTestemunhas(){

		return parcelamentoTermoTestemunhas;
	}

	public void setParcelamentoTermoTestemunhas(ParcelamentoTermoTestemunhas parcelamentoTermoTestemunhas){
