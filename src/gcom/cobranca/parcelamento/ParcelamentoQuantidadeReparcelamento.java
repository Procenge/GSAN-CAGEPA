...
public class ParcelamentoQuantidadeReparcelamento
	...
	public Filtro retornaFiltro(){
		...
		filtroParcelamentoQuantidadeReparcelamento.adicionarParametro(new ParametroSimples(FiltroParcelamentoQuantidadeReparcelamento.ID,
						this.getId()));
		return filtroParcelamentoQuantidadeReparcelamento;
	}

	/** full constructor */
	public ParcelamentoQuantidadeReparcelamento(Short quantidadeMaximaReparcelamento, Date ultimaAlteracao,
