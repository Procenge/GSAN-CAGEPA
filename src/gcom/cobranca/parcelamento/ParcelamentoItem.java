 ...
 * @author Saulo Lima
 * @date 25/06/2009
 *       Inclusão do número da prestação para Guia de Pagamento
 */
public class ParcelamentoItem
	...
	/** full constructor */
	// public ParcelamentoItem(Date ultimaAlteracao, CreditoARealizarHistorico
	// creditoARealizarHistorico, DebitoACobrarHistorico
	// debitoACobrarHistorico, gcom.cobranca.parcelamento.Parcelamento parcelamento, DebitoACobrar
	// debitoACobrar, DocumentoTipo documentoTipo, Conta
	// conta, ContaHistorico contaHistorico, GuiaPagamento guiaPagamento, CreditoARealizar
	// creditoARealizar) {
	public ParcelamentoItem(Date ultimaAlteracao, CreditoARealizarHistorico creditoARealizarHistorico,
							DebitoACobrarHistorico debitoACobrarHistorico, Parcelamento parcelamento,
							DebitoACobrarGeral debitoACobrarGeral, DocumentoTipo documentoTipo, ContaGeral contaGeral,
							ContaHistorico contaHistorico, GuiaPagamentoGeral guiaPagamentoGeral, Short numeroPrestacao,
							CreditoARealizarGeral creditoARealizarGeral) {
	...
	/** minimal constructor */
	// public ParcelamentoItem(CreditoARealizarHistorico creditoARealizarHistorico,
	// DebitoACobrarHistorico debitoACobrarHistorico,
	// gcom.cobranca.parcelamento.Parcelamento parcelamento, DebitoACobrar debitoACobrar,
	// DocumentoTipo documentoTipo, Conta conta, Quadra quadra,
	// ContaHistorico contaHistorico, GuiaPagamento guiaPagamento, CreditoARealizar
	// creditoARealizar) {
	public ParcelamentoItem(CreditoARealizarHistorico creditoARealizarHistorico, DebitoACobrarHistorico debitoACobrarHistorico,
							Parcelamento parcelamento, DebitoACobrarGeral debitoACobrarGeral, DocumentoTipo documentoTipo,
							ContaGeral contaGeral, ContaHistorico contaHistorico, Quadra quadra, GuiaPagamentoGeral guiaPagamentoGeral,
							Short numeroPrestacao, CreditoARealizarGeral creditoARealizarGeral) {
