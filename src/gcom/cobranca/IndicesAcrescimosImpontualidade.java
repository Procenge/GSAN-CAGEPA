...
public class IndicesAcrescimosImpontualidade
	...
	public Filtro retornaFiltro(){
		...
		filtroIndicesAcrescimosImpontualidade.adicionarParametro(new ParametroSimples(FiltroIndicesAcrescimosImpontualidade.ID, this
						.getId()));
	...
	/** full constructor */
	public IndicesAcrescimosImpontualidade(Integer anoMesReferencia, BigDecimal percentualMulta, BigDecimal percentualJurosMora,
											BigDecimal fatorAtualizacaoMonetaria, Date ultimaAlteracao) {
