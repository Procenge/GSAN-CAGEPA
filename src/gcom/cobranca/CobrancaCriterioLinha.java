...
public class CobrancaCriterioLinha
	...
	/** nullable persistent field */
	private Integer quantidadeMaximaContas;
	...
	private Integer quantidadeDiasVencimentoInicial;

	private Integer quantidadeDiasVencimentoFinal;

	public Integer getQuantidadeDiasVencimentoInicial(){

		return quantidadeDiasVencimentoInicial;
	}

	public void setQuantidadeDiasVencimentoInicial(Integer quantidadeDiasVencimentoInicial){

		this.quantidadeDiasVencimentoInicial = quantidadeDiasVencimentoInicial;
	}

	public Integer getQuantidadeDiasVencimentoFinal(){

		return quantidadeDiasVencimentoFinal;
	}

	public void setQuantidadeDiasVencimentoFinal(Integer quantidadeDiasVencimentoFinal){

		this.quantidadeDiasVencimentoFinal = quantidadeDiasVencimentoFinal;
	}

	/** full constructor */
	public CobrancaCriterioLinha(BigDecimal valorMinimoDebito, Short quantidadeMinimaContas, BigDecimal valorMaximoDebito,
									BigDecimal valorMinimoDebitoDebitoAutomatico, Integer quantidadeMaximaContas,
									Short quantidadeMinimaContasDebitoAutomatico, BigDecimal valorMinimoContaMes, Date ultimaAlteracao,
									gcom.cobranca.CobrancaCriterio cobrancaCriterio, ImovelPerfil imovelPerfil, Categoria categoria,
									Short situacaoMedicao, LigacaoAguaSituacao ligacaoAguaSituacao,
									LigacaoEsgotoSituacao ligacaoEsgotoSituacao, Integer diasParaVencimento, Date dataLimite,
									Integer referenciaDebitoInicial, Integer referenciaDebitoFinal) {
	...
	public Integer getQuantidadeMaximaContas(){

		return this.quantidadeMaximaContas;
	}

	public void setQuantidadeMaximaContas(Integer quantidadeMaximaContas){
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaCriterioLinha.adicionarParametro(new ParametroSimples(FiltroCobrancaCriterioLinha.ID, this.getId()));
	...
	public void setQuantidadeMinimaContasParcelamento(Short quantidadeMinimaContasParcelamento){
