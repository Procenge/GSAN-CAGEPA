...
public class ResumoPendencia {
	...
	public ResumoPendencia(Integer id, Date ultimaAlteracao, Integer anoMesReferencia, Integer codigoSetorComercial, Integer numeroQuadra,
							Short indicadorHidrometro, Integer anoMesReferenciaDocumento, Integer quantidadeLigacoes,
							Integer quantidadeDocumentos, BigDecimal valorDebito, GerenciaRegional gerenciaRegional, Localidade localidade,
							SetorComercial setorComercial, Rota rota, Quadra quadra, ImovelPerfil imovelPerfil,
							LigacaoAguaSituacao ligacaoAguaSituacao, LigacaoEsgotoSituacao ligacaoEsgotoSituacao, Categoria categoria,
							EsferaPoder esferaPoder, DocumentoTipo documentoTipo, FinanciamentoTipo financiamentoTipo,
	 ...
	 *            O anoMesReferenciaDocumento a ser setado.
	 */
	...
	/**
	 * @param indicadorHidrometro
	 *            O indicadorHidrometro a ser setado.
	 */
