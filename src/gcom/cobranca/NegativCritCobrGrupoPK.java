...
public class NegativCritCobrGrupoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("negativacaoCriterio", getNegativacaoCriterio())
						.append("cobrancaGrupo", getCobrancaGrupo()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getNegativacaoCriterio(), castOther.getNegativacaoCriterio()).append(
						this.getCobrancaGrupo(), castOther.getCobrancaGrupo()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getNegativacaoCriterio()).append(getCobrancaGrupo()).toHashCode();
	}
