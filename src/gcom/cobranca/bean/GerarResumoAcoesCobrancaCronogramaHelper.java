 ...
 * Armazena a data da situação do débito do imte do documento de cobrança refrente a situação do
 ...
 * @since 18/10/2006
 */
public class GerarResumoAcoesCobrancaCronogramaHelper
	 ...
	 *            O idSituacaoDebito a ser setado.
	 */
	 ...
	 *            O quantidadeOcorrenciaSituacaoDebito a ser setado.
	 */
	public void setQuantidadeOcorrenciaSituacaoDebito(int quantidadeOcorrenciaSituacaoDebito){
	 ...
	 *            O valorItemCobrado a ser setado.
	 */
	 ...
	 * @param dataSituacaoDebito
	 */
	public GerarResumoAcoesCobrancaCronogramaHelper(int quantidadeOcorrenciaSituacaoDebito, BigDecimal valorItemCobrado,
													int idSituacaoDebito, Date dataSituacaoDebito) {
