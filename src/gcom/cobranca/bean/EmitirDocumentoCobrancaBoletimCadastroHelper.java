...
public class EmitirDocumentoCobrancaBoletimCadastroHelper
	...
	private Localidade localidadeImovel;

	private Municipio municipioImovel;
	...
	/**
	 * @param idFonteAbastecimento
	 *            O idFonteAbastecimento a ser setado.
	 */
	 ...
	 *            O idPavimentoCalcada a ser setado.
	 */
	 ...
	 *            O numeroPontosUtilizacao a ser setado.
	 */
	 ...
	 *            O volumeReservatorioInferior a ser setado.
	 */
	 ...
	 *            O volumeReservatorioSuperior a ser setado.
	 */
	...
	public EmitirDocumentoCobrancaBoletimCadastroHelper(Integer idDocumentoCobranca, Integer idLocalidade, Integer codigoSetorComercial,
														int numeroQuadra, short lote, short subLote, Integer idImovel,
														Integer idCobrancaGrupo, Integer idLigacaoAguaSituacao,
														Integer idLigacaoEsgotoSituacao, Short numeroMorador, BigDecimal areaConstruida,
														Integer idLogradouro, Integer codigoCep, Integer codigoBairro, Integer referencia,
														String numeroImovel, String complemento, Integer volumeReservatorioInferior,
														Integer volumeReservatorioSuperior, Integer volumePiscina, Short jardim,
														Integer idPavimentoRua, Integer idPavimentoCalcada, Short numeroPontosUtilizacao,
														Integer idImovelPerfil, Integer idDespejo, Integer idPoco,
														Integer idFonteAbastecimento, BigDecimal numeroIptu, Long numeroCelpe,
														String nomeBairro) {
	...
	public void setLocalidadeImovel(Localidade localidadeImovel){

		this.localidadeImovel = localidadeImovel;
	}

	public Municipio getMunicipioImovel(){

		return municipioImovel;
	}

	public void setMunicipioImovel(Municipio municipioImovel){
