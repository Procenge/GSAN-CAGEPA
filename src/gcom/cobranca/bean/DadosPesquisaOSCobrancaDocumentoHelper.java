 ...
 * @since 14/05/2007
 */
public class DadosPesquisaOSCobrancaDocumentoHelper
	 ...
	 */
	public DadosPesquisaOSCobrancaDocumentoHelper(Integer idOrdemServico, short situacaoOrdemServico, Date dataFiscalizacaoSituacao,
													Date dataEncerramento, Integer idDocumento, Date dataEmissao,
													BigDecimal valorDocumento, BigDecimal percentualValorMinimoCobrancaCriterio,
													BigDecimal percentualQuantidadeMinimaCobrancaCriterio,
													BigDecimal valorLimitePrioridadeCobrancaCriterio, Integer idFiscalizacao,
													Short indicadorExecucaoMotivoEncerramento, Integer idImovel, Integer idLocalidade) {
	...
	public void setIndicadorExecucaoMotivoEncerramento(Short indicadorExecucaoMotivoEncerramento){
