...
public class GerarAtividadeAcaoCobrancaHelper {
	...
	// private ArrayList<Integer> imovelIds = new ArrayList<Integer>();
	...
	public GerarAtividadeAcaoCobrancaHelper(int quantidadeDocumentosCobranca, int quantidadeItensCobradosDocumentos,
											BigDecimal valorDocumentosCobranca) {
