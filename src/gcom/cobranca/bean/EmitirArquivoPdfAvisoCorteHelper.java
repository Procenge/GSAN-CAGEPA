...
public class EmitirArquivoPdfAvisoCorteHelper
	 ...
	 */
	public EmitirArquivoPdfAvisoCorteHelper(Integer idCobrancaDocumento, Integer idLocalidade, String descricaoLocalidade,
	...
	public String getDataTextoClienteFormatada(){
		...
		String dataTextoClienteFormatada = null;
	...
	public String getValorDocumentoFormatado(){
		...
		if(Util.isNaoNuloBrancoZero(getValorDocumento())){
			valorDocumentoFormatado = Util.completarStringComValorEsquerda(Util.formataBigDecimal(getValorDocumento(), 2, true), "*", 10);
		}
