 ...
 * @date 21/09/2007
 */
public class IndicadoresParcelamentoHelper
	...
	private Integer indicadorCobrancaBancaria;
	 ...
	 *            O indicadorAcrescimosImpotualidade a ser setado.
	 */
	public void setIndicadorAcrescimosImpotualidade(Integer indicadorAcrescimosImpotualidade){
	 ...
	 *            O indicadorCreditoARealizar a ser setado.
	 */
	 ...
	 *            O indicadorDebitosACobrar a ser setado.
	 */
	 ...
	 *            O indicadorGuiasPagamento a ser setado.
	 */
	 ...
	 *            O indicadorNotasPromissorias a ser setado.
	 */
	...
	public Integer getIndicadorCobrancaBancaria(){

		return indicadorCobrancaBancaria;
	}

	public void setIndicadorCobrancaBancaria(Integer indicadorCobrancaBancaria){
