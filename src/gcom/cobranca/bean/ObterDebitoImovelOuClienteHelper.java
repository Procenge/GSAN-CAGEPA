...
public class ObterDebitoImovelOuClienteHelper {
	...
	private Integer idBoletoBancario;
	...
	/**
	 * @param colecaoContasValores
	 *            The colecaoContasValores to set.
	 */
	...
	/**
	 * @param colecaoCreditoARealizar
	 *            The colecaoCreditoARealizar to set.
	 */
	...
	/**
	 * @param colecaoDebitoACobrar
	 *            The colecaoDebitoACobrar to set.
	 */
	...
	/**
	 * @param colecaoGuiasPagamentoValores
	 *            The colecaoGuiasPagamentoValores to set.
	 */
	...
	/**
	 * @param colecaoContasValoresImovel
	 *            O colecaoContasValoresImovel a ser setado.
	 */
	public void setColecaoContasValoresImovel(Collection<ContaValoresHelper> colecaoContasValoresImovel){
	...
	public void setColecaoDebitoCreditoParcelamentoHelper(Collection<DebitoCreditoParcelamentoHelper> colecaoDebitoCreditoParcelamentoHelper){

		this.colecaoDebitoCreditoParcelamentoHelper = colecaoDebitoCreditoParcelamentoHelper;
	}

	public void setIdBoletoBancario(Integer idBoletoBancario){

		this.idBoletoBancario = idBoletoBancario;
	}

	public Integer getIdBoletoBancario(){
