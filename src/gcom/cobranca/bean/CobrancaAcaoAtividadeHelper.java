 ...
 * @date 04/07/2007
 */
public class CobrancaAcaoAtividadeHelper
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getCobrancaAcao().getId(), castOther.getCobrancaAcao().getId()).append(
						this.getCobrancaAtividade().getId(), castOther.getCobrancaAtividade().getId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(this.getCobrancaAcao().getId()).append(this.getCobrancaAtividade().getId()).toHashCode();
	}
