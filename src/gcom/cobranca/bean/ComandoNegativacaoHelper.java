...
public class ComandoNegativacaoHelper {
	...
	/**
	 * @param tipoPesquisaIdentificacaoCI
	 *            O tipoPesquisaIdentificacaoCI a ser setado.
	 */
	...
	public ComandoNegativacaoHelper(String tituloComando, Short tipoPesquisaTituloComando, Short indicadorComandoSimulado,
									Date geracaoComandoInicio, Date geracaoComandoFim, Date execucaoComandoInicio, Date execucaoComandoFim,
									Integer idUsuarioResponsavel, Integer idComandoNegativacao, Integer quantidadeInclusoes,
	...
	public ComandoNegativacaoHelper(String tituloComando, Short tipoPesquisaTituloComando, Short indicadorComandoSimulado,
									Date geracaoComandoInicio, Date geracaoComandoFim, Date execucaoComandoInicio, Date execucaoComandoFim,
									Integer idUsuarioResponsavel, Integer idComandoNegativacao, Integer quantidadeInclusoes,
									String nomeUsuarioResponsavel, String nomeClienteNegativador) {
	...
	/**
	 * @param execucaoComandoFim
	 *            O execucaoComandoFim a ser setado.
	 */
	...
	/**
	 * @param execucaoComandoInicio
	 *            O execucaoComandoInicio a ser setado.
	 */
	...
	/**
	 * @param geracaoComandoFim
	 *            O geracaoComandoFim a ser setado.
	 */
	...
	/**
	 * @param geracaoComandoInicio
	 *            O geracaoComandoInicio a ser setado.
	 */
	...
	/**
	 * @param indicadorComandoSimulado
	 *            O indicadorComandoSimulado a ser setado.
	 */
	...
	/**
	 * @param tipoPesquisaTituloComando
	 *            O tipoPesquisaTituloComando a ser setado.
	 */
	 ...
	 *            O idComandoNegativacao a ser setado.
	 */
	...
	/**
	 * @param nomeUsuarioResponsavel
	 *            O nomeUsuarioResponsavel a ser setado.
	 */
	...
	/**
	 * @param quantidadeInclusoes
	 *            O quantidadeInclusoes a ser setado.
	 */
	...
	public String getIndicadorComandoSimuladoString(){
		...
		if(getIndicadorComandoSimulado() != null && getIndicadorComandoSimulado().equals(ConstantesSistema.SIM)){
	...
	/**
	 * @param nomeClienteNegativador
	 *            O nomeClienteNegativador a ser setado.
	 */
