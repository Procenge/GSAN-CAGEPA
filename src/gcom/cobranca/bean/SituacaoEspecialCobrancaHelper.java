...
public class SituacaoEspecialCobrancaHelper {
	...
	public OrgaoExterno getIdOrgaoExterno(){

		return orgaoExterno;
	}

	public void setIdOrgaoExterno(OrgaoExterno idOrgaoExterno){

		this.orgaoExterno = idOrgaoExterno;
	}
	...
	public void setMesAnoReferenciaCobrancaFinal(String mesAnoReferenciaCobrancaFinal){
	...
	public void setMesAnoReferenciaCobrancaInicial(String mesAnoReferenciaCobrancaInicial){
	...
	public void setMotivoSituacaoEspecialCobranca(String motivoSituacaoEspecialCobranca){
	...
	public void setQuantidadeImoveisCOMSituacaoEspecialCobranca(String quantidadeImoveisCOMSituacaoEspecialCobranca){
	...
	public void setQuantidadeImoveisSEMSituacaoEspecialCobranca(String quantidadeImoveisSEMSituacaoEspecialCobranca){
