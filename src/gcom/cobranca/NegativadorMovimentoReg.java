...
@ControleAlteracao()
public class NegativadorMovimentoReg
				extends ObjetoTransacao
				implements Serializable {

	public static final int ATRIBUTOS_EXCLUIR_NEGATIVACAO_ONLINE = 1132; // Operacao.OPERACAO_EXCLUIR_NEGATIVACAO_ONLINE

	public static final Integer INDICADOR_ACEITO = 1;

	public static final Integer INDICADOR_NAO_ACEITO = 2;
	...
	private Short indicadorItemAtualizado = ConstantesSistema.NAO;
	...
	/** full constructor */
	public NegativadorMovimentoReg(Integer id, String conteudoRegistro, Date ultimaAlteracao, Integer codigoExclusaoTipo,
									Short indicadorAceito, Short indicadorCorrecao, BigDecimal valorDebito, Date dataSituacaoDebito,
									Integer codigoSetorComercial, Integer numeroQuadra, String numeroCpf, String numeroCnpj, Quadra quadra,
									Localidade localidade, Imovel imovel,
									gcom.cobranca.NegativadorExclusaoMotivo negativadorExclusaoMotivo, ImovelPerfil imovelPerfil,
									gcom.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacao,
									gcom.cobranca.NegativadorMovimentoReg negativadorMovimentoRegInclusao,
									gcom.cobranca.NegativacaoCriterio negativacaoCriterio, Usuario usuario, Cliente cliente,
									Categoria categoria, gcom.cobranca.NegativadorRegistroTipo negativadorRegistroTipo,
									gcom.cobranca.NegativadorMovimento negativadorMovimento, Set negativadorMovimentoReg) {
	...
	/** minimal constructor */
	public NegativadorMovimentoReg(Integer id, Short indicadorAceito, Short indicadorCorrecao, Quadra quadra, Localidade localidade,
									Imovel imovel, gcom.cobranca.NegativadorExclusaoMotivo negativadorExclusaoMotivo,
									ImovelPerfil imovelPerfil, gcom.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacao,
									gcom.cobranca.NegativadorMovimentoReg negativadorMovimentoRegInclusao,
									gcom.cobranca.NegativacaoCriterio negativacaoCriterio, Usuario usuario, Cliente cliente,
									Categoria categoria, gcom.cobranca.NegativadorRegistroTipo negativadorRegistroTipo,
									gcom.cobranca.NegativadorMovimento negativadorMovimento, Set negativadorMovimentoReg) {
