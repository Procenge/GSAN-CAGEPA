...
public class CriterioSituacaoCobranca
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroCriterioSituacaoCobranca.COBRANCA_CRITERIO_ID, this.getComp_id()
						.getCobrancaCriterio().getId()));
		filtro.adicionarParametro(new ParametroSimples(FiltroCriterioSituacaoCobranca.COBRANCA_SITUACAO_ID, this.getComp_id()
