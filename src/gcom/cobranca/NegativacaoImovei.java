...
public class NegativacaoImovei
	...
	/** full constructor */
	public NegativacaoImovei(Integer id, Date ultimaAlteracao, short indicadorExcluido, Date dataExclusao, Imovel imovel,
								gcom.cobranca.NegativacaoComando negativacaoComando) {
	...
	public NegativacaoImovei(Integer id) {

		this.id = id;
	}

	/** minimal constructor */
	public NegativacaoImovei(Integer id, Date ultimaAlteracao, short indicadorExcluido, Imovel imovel,
								gcom.cobranca.NegativacaoComando negativacaoComando) {
