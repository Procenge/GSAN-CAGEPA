...
public class ResumoCobrancaAcao
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("rcbaId", getId()).toString();
	}
	...
	/**
	 * @param cobrancaAcaoCronograma
	 *            O cobrancaAcaoCronograma a ser setado.
	 */
	...
	/**
	 * @param indicadorCronogramaComando
	 *            O indicadorCronogramaComando a ser setado.
	 */
	...
	/**
	 * @param indicadorLimite
	 *            O indicadorLimite a ser setado.
	 */
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getAnoMesReferencia(), castOther.getAnoMesReferencia()).append(
						this.getCobrancaAcaoCronograma(), castOther.getCobrancaAcaoCronograma()).isEquals();
	}
