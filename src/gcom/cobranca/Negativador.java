...
public class Negativador
	...
	public static final Integer NEGATIVADOR_SPC_SAO_PAULO = new Integer(1);
	...
	/** full constructor */
	public Negativador(Integer id, Short codigoAgente, String numeroInscricaoEstadual, Short indicadorUso, Date ultimaAlteracao,
						Imovel imovel, Cliente cliente, Set negativacaoComandos, Set negativadorExclusaoMotivos, Set negativadorContratos,
						Set negativadorRegistroTipos, Set negativadorMovimentos) {
	...
	/** minimal constructor */
	public Negativador(Integer id, Short codigoAgente, Short indicadorUso, Date ultimaAlteracao, Imovel imovel, Cliente cliente,
						Set negativacaoComandos, Set negativadorExclusaoMotivos, Set negativadorContratos, Set negativadorRegistroTipos,
						Set negativadorMovimentos) {
