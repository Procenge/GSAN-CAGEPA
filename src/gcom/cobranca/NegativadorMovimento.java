...
public class NegativadorMovimento
	...
	/** full constructor */
	public NegativadorMovimento(Integer id, short codigoMovimento, Date dataEnvio, Date dataProcessamentoEnvio, Date dataRetorno,
								Date dataProcessamentoRetorno, Integer numeroSequencialEnvio, Integer numeroSequencialRetorno,
								Integer numeroRegistrosEnvio, Integer numeroRegistrosRetorno, BigDecimal valorTotalEnvio,
								Date ultimaAlteracao, gcom.cobranca.Negativador negativador,
								gcom.cobranca.NegativacaoComando negativacaoComando, Set negativadorMovimentoReg) {
	...
	/** minimal constructor */
	public NegativadorMovimento(Integer id, short codigoMovimento, Date dataProcessamentoEnvio, gcom.cobranca.Negativador negativador,
								gcom.cobranca.NegativacaoComando negativacaoComando, Set negativadorMovimentoReg) {
