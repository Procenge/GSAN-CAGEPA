...
public class CobrancaAtividadeComandoRotaPK
				extends ObjetoGcom {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("cobrancaAcaoAtividadeComandoId", getCobrancaAcaoAtividadeComandoId()).append("rotaId",
						getRotaId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getCobrancaAcaoAtividadeComandoId(), castOther.getCobrancaAcaoAtividadeComandoId()).append(
						this.getRotaId(), castOther.getRotaId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getCobrancaAcaoAtividadeComandoId()).append(getRotaId()).toHashCode();
	}
