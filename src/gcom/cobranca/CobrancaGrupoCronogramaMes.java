...
public class CobrancaGrupoCronogramaMes
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaGrupoCronogramaMes.adicionarCaminhoParaCarregamentoEntidade("programaCobranca");
		filtroCobrancaGrupoCronogramaMes.adicionarParametro(new ParametroSimples(FiltroCobrancaGrupoCronogramaMes.ID, this.getId()));
