...
public class CriterioSituacaoLigacaoEsgoto
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarCaminhoParaCarregamentoEntidade(FiltroCriterioSituacaoLigacaoEsgoto.COBRANCA_CRITERIO);
		filtro.adicionarCaminhoParaCarregamentoEntidade(FiltroCriterioSituacaoLigacaoEsgoto.LIGACAO_ESGOTO_SITUACAO);
		filtro.adicionarParametro(new ParametroSimples(FiltroCriterioSituacaoLigacaoEsgoto.COBRANCA_CRITERIO_ID, this.getComp_id()
						.getCobrancaCriterio().getId()));
		filtro.adicionarParametro(new ParametroSimples(FiltroCriterioSituacaoLigacaoEsgoto.LIGACAO_ESGOTO_SITUACAO_ID, this.getComp_id()
