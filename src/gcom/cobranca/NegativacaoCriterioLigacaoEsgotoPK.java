...
public class NegativacaoCriterioLigacaoEsgotoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("negativacaoCriterio", getNegativacaoCriterio()).append("ligacaoEsgotoSituacao",
						getLigacaoEsgotoSituacao()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getNegativacaoCriterio(), castOther.getNegativacaoCriterio()).append(
						this.getLigacaoEsgotoSituacao(), castOther.getLigacaoEsgotoSituacao()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getNegativacaoCriterio()).append(getLigacaoEsgotoSituacao()).toHashCode();
	}
