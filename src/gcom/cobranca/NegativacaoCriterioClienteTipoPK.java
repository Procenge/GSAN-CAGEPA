...
public class NegativacaoCriterioClienteTipoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("negativacaoCriterio", getNegativacaoCriterio()).append("clienteTipo", getClienteTipo())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getNegativacaoCriterio(), castOther.getNegativacaoCriterio()).append(this.getClienteTipo(),
						castOther.getClienteTipo()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getNegativacaoCriterio()).append(getClienteTipo()).toHashCode();
	}
