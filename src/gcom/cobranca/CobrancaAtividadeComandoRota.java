...
public class CobrancaAtividadeComandoRota
	...
	/** full constructor */
	public CobrancaAtividadeComandoRota(gcom.cobranca.CobrancaAtividadeComandoRotaPK comp_id, Date ultimaAlteracao, Rota rota,
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaAtividadeComandoRota.adicionarParametro(new ParametroSimples(
						FiltroCobrancaAtividadeComandoRotas.COMP_ID_COBRANCA_ACAO_ATIVIDADE_COMANDO_ID, cobrancaAcaoAtividadeComando
										.getId()));

		filtroCobrancaAtividadeComandoRota.adicionarParametro(new ParametroSimples(FiltroCobrancaAtividadeComandoRotas.COMP_ID_ROTA_ID,
						rota.getId()));
