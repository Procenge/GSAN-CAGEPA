...
@ControleAlteracao()
public class CobrancaSituacaoTipo
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaSituacaoTipo.adicionarParametro(new ParametroSimples(FiltroCobrancaSituacaoTipo.ID, this.getId()));
		return filtroCobrancaSituacaoTipo;
	}
