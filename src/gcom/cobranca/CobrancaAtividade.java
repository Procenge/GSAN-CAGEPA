...
public class CobrancaAtividade
				extends ObjetoTransacao {

	private static final long serialVersionUID = 1L;

	// Constantes de atividades de cobrança >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
	public final static Integer EMITIR = Integer.valueOf(1);

	public final static Integer SIMULAR = Integer.valueOf(2);

	public final static Integer ENCERRAR = Integer.valueOf(3);

	public final static Integer ATIVO_CRONOGRAMA = Integer.valueOf(1);
	...
	public final static Integer INDICADOR_CRITERIO_POR_ROTA = 1;

	public final static Integer INDICADOR_CRITERIO_POR_COMANDO = 2;

	public final static Integer INDICADOR_CRITERIO_POR_CRONOGRAMA = 3;
	...
	/** full constructor */
	public CobrancaAtividade(String descricaoCobrancaAtividade, Short indicadorComando, Short indicadorExecucao, Short indicadorUso,
								Date ultimaAlteracao, gcom.cobranca.CobrancaAtividade cobrancaAtividadePredecessora) {
	...
	/** minimal constructor */
	public CobrancaAtividade(gcom.cobranca.CobrancaAtividade cobrancaAtividadePredecessora) {
	...
	public void setCobrancaAtividadePredecessora(gcom.cobranca.CobrancaAtividade cobrancaAtividadePredecessora){
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaAtividade.adicionarParametro(new ParametroSimples(FiltroCobrancaAtividade.ID, this.getId()));
