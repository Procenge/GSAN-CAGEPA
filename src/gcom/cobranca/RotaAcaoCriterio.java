...
public class RotaAcaoCriterio
	...
	public Filtro retornaFiltro(){
		...
		filtroRotaAcaoCriterio.adicionarParametro(new ParametroSimples(FiltroRotaAcaoCriterio.COBRANCA_ACAO_ID, cobrancaAcao.getId()));
