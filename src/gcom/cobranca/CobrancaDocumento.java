...
public class CobrancaDocumento
	...
	private Set<CobrancaDocumentoItem> cobrancaDocumentoItems;
	 ...
	 */
	public CobrancaDocumento(Integer id, int numeroSequenciaDocumento, Date emissao, BigDecimal valorDesconto, Integer numeroQuadra,
								BigDecimal valorDocumento, BigDecimal valorTaxa, Integer codigoSetorComercial, Date ultimaAlteracao,
								DocumentoEmissaoForma documentoEmissaoForma, CobrancaAcaoAtividadeComando cobrancaAcaoAtividadeComando,
								Imovel imovel, Empresa empresa, DocumentoTipo documentoTipo, ImovelPerfil imovelPerfil, Quadra quadra,
								Localidade localidade, CobrancaAcaoAtividadeCronograma cobrancaAcaoAtividadeCronograma,
								MotivoNaoEntregaDocumento motivoNaoEntregaDocumento, CobrancaCriterio cobrancaCriterio,
								CobrancaAcao cobrancaAcao, BigDecimal valorAcrescimos) {
	...
	/** full constructor */
	public CobrancaDocumento(int numeroSequenciaDocumento, Date emissao, BigDecimal valorDesconto, Integer numeroQuadra,
								BigDecimal valorDocumento, BigDecimal valorTaxa, Integer codigoSetorComercial, Date ultimaAlteracao,
								gcom.cobranca.DocumentoEmissaoForma documentoEmissaoForma,
								gcom.cobranca.CobrancaAcaoAtividadeComando cobrancaAcaoAtividadeComando, Imovel imovel, Empresa empresa,
								gcom.cobranca.DocumentoTipo documentoTipo, ImovelPerfil imovelPerfil, Quadra quadra, Localidade localidade,
	...
	/** minimal constructor */
	public CobrancaDocumento(int numeroSequenciaDocumento, gcom.cobranca.DocumentoEmissaoForma documentoEmissaoForma,
								gcom.cobranca.CobrancaAcaoAtividadeComando cobrancaAcaoAtividadeComando, Imovel imovel, Empresa empresa,
								gcom.cobranca.DocumentoTipo documentoTipo, ImovelPerfil imovelPerfil, Quadra quadra, Localidade localidade,
								gcom.cobranca.CobrancaAcaoAtividadeCronograma cobrancaAcaoAtividadeCronograma,
	...
	public Date getDataValidade(){
		...
		if(dataValidade != null && this.getCobrancaAcao() != null && this.getCobrancaAcao().getNumeroDiasValidade() != null){
	 ...
	 *            O cobrancaAcaoSituacao a ser setado.
	 */
	...
	/**
	 * @param dataSituacaoAcao
	 *            O dataSituacaoAcao a ser setado.
	 */
	...
	public Set<CobrancaDocumentoItem> getCobrancaDocumentoItems(){

		return cobrancaDocumentoItems;
	}

	public void setCobrancaDocumentoItems(Set<CobrancaDocumentoItem> cobrancaDocumentoItems){
	...
	public Filtro retornaFiltro(){
		...
		filtroCobrancaDocumento.adicionarCaminhoParaCarregamentoEntidade("cobrancaAcao");
		...
		filtroCobrancaDocumento.adicionarParametro(new ParametroSimples(FiltroCobrancaDocumento.ID, this.getId()));

		return filtroCobrancaDocumento;
	}
	...
	public String getDataSituacaoAcaoFormatada(){

		return Util.formatarData(dataSituacaoAcao);
	}
