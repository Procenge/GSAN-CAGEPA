...
/**
 * FiltroCampanhaSituacaoLigacao
 * 
 * @author Hiroshi
 * @date 06/09/2013
 */
public class FiltroCampanhaSituacaoLigacao
				extends Filtro
				implements Serializable {

	private static final long serialVersionUID = 1L;

	public FiltroCampanhaSituacaoLigacao(String campoOrderBy) {

		this.campoOrderBy = campoOrderBy;
	}

	/**
	 * Construtor da classe FiltroCampanhaSituacaoLigacao
	 */
	public FiltroCampanhaSituacaoLigacao() {
