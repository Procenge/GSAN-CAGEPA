 ...
 * @date 05/09/2013
 */
public class FiltroCampanhaCadastroFone
				extends Filtro
				implements Serializable {

	private static final long serialVersionUID = 1L;

	public FiltroCampanhaCadastroFone(String campoOrderBy) {
	 ...
	 */
	public FiltroCampanhaCadastroFone() {
	...
	public final static String CAMPANHA_CADASTRO_ID = "campanhaCadastro.id";
