...
public class LancamentoResumo
	...
	/** full constructor */
	public LancamentoResumo(Integer id, int anoMesReferencia, BigDecimal valorResumo, Date ultimaAlteracao, SetorComercial setorComercial,
							gcom.financeiro.LancamentoResumoValorTipo lancamentoResumoValorTipo, Localidade localidade,
	...
	/** minimal constructor */
	public LancamentoResumo(Integer id, int anoMesReferencia, SetorComercial setorComercial,
							gcom.financeiro.LancamentoResumoValorTipo lancamentoResumoValorTipo, Localidade localidade,
							GerenciaRegional gerenciaRegional, Categoria categoria) {
	...
	public void setLancamentoResumoValorTipo(gcom.financeiro.LancamentoResumoValorTipo lancamentoResumoValorTipo){
