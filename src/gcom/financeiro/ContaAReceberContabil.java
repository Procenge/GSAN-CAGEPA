...
public class ContaAReceberContabil
	...
	/** full constructor */
	public ContaAReceberContabil(Integer id, int anoMesReferencia, int numeroSequenciaTipoLancamento,
									int numeroSequenciaItemTipoLancamento, BigDecimal valorItemLancamento, LancamentoItem lancamentoItem,
									GerenciaRegional gerenciaRegional, Localidade localidade, LancamentoTipo lancamentoTipo,
									UnidadeNegocio unidadeNegocio, Categoria categoria, LancamentoItemContabil lancamentoItemContabil) {
