...
public class LancamentoTipoItemPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("lancamentoTipoId", getLancamentoTipoId())
						.append("lancamentoItemId", getLancamentoItemId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getLancamentoTipoId(), castOther.getLancamentoTipoId()).append(this.getLancamentoItemId(),
						castOther.getLancamentoItemId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getLancamentoTipoId()).append(getLancamentoItemId()).toHashCode();
	}
