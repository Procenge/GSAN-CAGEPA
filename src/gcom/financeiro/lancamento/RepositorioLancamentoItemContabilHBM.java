 ...
 * @version 1.0
 */
public class RepositorioLancamentoItemContabilHBM
				implements IRepositorioLancamentoItemContabil {
	...
	public Collection<LancamentoItemContabil> pesquisarLancamentoItemContabil() throws ErroRepositorioException{
		...
		try{
			...
			String consulta = "select lancamentoItemContabil " + "from LancamentoItemContabil lancamentoItemContabil ";
