...
public class LancamentoTipo
	...
	public final static Integer CREDITOS_A_REALIZAR_POR_COBRANCA_INDEVIDA_CANCELADO = new Integer(56);
	...
	/** nullable persistent field */
	private gcom.financeiro.lancamento.LancamentoTipo lancamentoTipoIncrementoValor;

	/** nullable persistent field */
	private gcom.financeiro.lancamento.LancamentoTipo lancamentoTipoDecrementoValor;

	private Set<LancamentoTipoItem> lancamentoTipoItems;

	/** full constructor */
	public LancamentoTipo(String descricao, String descricaoAbreviada, Short indicadorImpressao, Short codigoTipoContabil,
							Short indicadorTotal, Date ultimaAlteracao, gcom.financeiro.lancamento.LancamentoTipo lancamentoTipo) {
	...
	/** minimal constructor */
	public LancamentoTipo(gcom.financeiro.lancamento.LancamentoTipo lancamentoTipo) {
	...
	/**
	 * @return the numeroSequenciaImpressao
	 */
	...
	/**
	 * @param numeroSequenciaImpressao
	 *            the numeroSequenciaImpressao to set
	 */
	...
	/**
	 * @return the lancamentoTipoIncrementoValor
	 */
	public gcom.financeiro.lancamento.LancamentoTipo getLancamentoTipoIncrementoValor(){

		return lancamentoTipoIncrementoValor;
	}

	/**
	 * @param lancamentoTipoIncrementoValor
	 *            the lancamentoTipoIncrementoValor to set
	 */
	public void setLancamentoTipoIncrementoValor(gcom.financeiro.lancamento.LancamentoTipo lancamentoTipoIncrementoValor){

		this.lancamentoTipoIncrementoValor = lancamentoTipoIncrementoValor;
	}

	/**
	 * @return the lancamentoTipoDecrementoValor
	 */
	public gcom.financeiro.lancamento.LancamentoTipo getLancamentoTipoDecrementoValor(){

		return lancamentoTipoDecrementoValor;
	}

	/**
	 * @param lancamentoTipoDecrementoValor
	 *            the lancamentoTipoDecrementoValor to set
	 */
	public void setLancamentoTipoDecrementoValor(gcom.financeiro.lancamento.LancamentoTipo lancamentoTipoDecrementoValor){

		this.lancamentoTipoDecrementoValor = lancamentoTipoDecrementoValor;
	}

	/**
	 * @return the lancamentoTipoItems
	 */
	public Set<LancamentoTipoItem> getLancamentoTipoItems(){

		return lancamentoTipoItems;
	}

	/**
	 * @param lancamentoTipoItems
	 *            the lancamentoTipoItems to set
	 */
	public void setLancamentoTipoItems(Set<LancamentoTipoItem> lancamentoTipoItems){

		this.lancamentoTipoItems = lancamentoTipoItems;
	}
