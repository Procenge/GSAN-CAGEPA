...
public class LancamentoResumoContaHistoricoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("lancamentoResumo", getLancamentoResumo()).append("contaHistorico", getContaHistorico())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getLancamentoResumo(), castOther.getLancamentoResumo()).append(this.getContaHistorico(),
						castOther.getContaHistorico()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getLancamentoResumo()).append(getContaHistorico()).toHashCode();
	}
