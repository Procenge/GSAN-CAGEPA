...
public class ResumoFaturamento
	...
	public static final short CANCELAMENTOS_POR_REFATURAMENTO_SEQUENCIA_TIPO_LANCAMENTO_2 = 1050;
	...
	/** full constructor */
	public ResumoFaturamento(Integer anoMesReferencia, BigDecimal valorItemFaturamento, Short sequenciaTipoLancamento,
								Short sequenciaItemTipoLancamento, Date ultimaAlteracao, LancamentoItemContabil lancamentoItemContabil,
								LancamentoTipo lancamentoTipo, LancamentoItem lancamentoItem, Localidade localidade,
	...
	public ResumoFaturamento(Integer anoMesReferencia, BigDecimal valorItemFaturamento, Short sequenciaTipoLancamento,
								Short sequenciaItemTipoLancamento, Date ultimaAlteracao, LancamentoItemContabil lancamentoItemContabil,
								LancamentoTipo lancamentoTipo, LancamentoItem lancamentoItem, Localidade localidade,
								GerenciaRegional gerenciaRegional, Categoria categoria, UnidadeNegocio unidadeNegocio, Date dataEvento) {
	...
	/** minimal constructor */
	public ResumoFaturamento(LancamentoItemContabil lancamentoItemContabil, LancamentoTipo lancamentoTipo, LancamentoItem lancamentoItem,
	...
	public ResumoFaturamento(Integer anoMesReferencia, BigDecimal valorItemFaturamento, Localidade localidade,
								GerenciaRegional gerenciaRegional, Categoria categoria) {
	...
	public ResumoFaturamento(Integer anoMesReferencia, BigDecimal valorItemFaturamento, Localidade localidade,
								GerenciaRegional gerenciaRegional, Categoria categoria, UnidadeNegocio unidadeNegocio) {
	...
	/** constructor para [UC0155] encerrar faturamento do mês */
	public ResumoFaturamento(Integer anoMesReferencia, BigDecimal valorItemFaturamento, Short sequenciaItemTipoLancamento,
								LancamentoItemContabil lancamentoItemContabil, Localidade localidade, GerenciaRegional gerenciaRegional,
								Categoria categoria) {
