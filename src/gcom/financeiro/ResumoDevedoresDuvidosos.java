...
public class ResumoDevedoresDuvidosos
	...
	public ResumoDevedoresDuvidosos(int anoMesReferenciaContabil, Integer anoMesReferenciaArrecadacao, Short sequencialTipoLancamento,
									Short sequencialItemTipoLancamento, BigDecimal valorBaixado, Date ultimaAlteracao,
									GerenciaRegional gerenciaRegional, Localidade localidade, Categoria categoria,
									LancamentoItemContabil lancamentoItemContabil, LancamentoTipo lancamentoTipo,
	...
	public ResumoDevedoresDuvidosos(BigDecimal valorBaixado, Localidade localidade, GerenciaRegional gerenciaRegional, Categoria categoria) {
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroResumoDevedoresDuvidosos.ID, this.getId()));
