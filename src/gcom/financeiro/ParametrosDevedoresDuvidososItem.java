...
public class ParametrosDevedoresDuvidososItem
	...
	public void setParametrosDevedoresDuvidosos(ParametrosDevedoresDuvidosos parametrosDevedoresDuvidosos){
	...
	public Filtro retornaFiltro(){
		...
		filtro.adicionarParametro(new ParametroSimples(FiltroParametrosDevedoresDuvidososItem.ID, this.getId()));
