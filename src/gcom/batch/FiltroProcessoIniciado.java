...
public class FiltroProcessoIniciado
				extends Filtro
	...
	public final static String TIPO_PROCESSO = "processo.processoTipo";

	public final static String ID_USUARIO = "usuario.id";

	public static final String CODIGO_GRUPO = "codigoGrupoProcesso";
