...
public class BatchMarcarItensRemuneraveisCobrancaAdministrativaMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchMarcarItensRemuneraveisCobrancaAdministrativaMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorCobranca().marcarItensRemuneraveisCobrancaAdministrativa(
