 ...
 * @date 22/01/2007
 */
public class BatchInserirResumoAcoesCobrancaCronogramaMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorCobranca().inserirResumoAcoesCobrancaCronograma((Object[]) ((Object[]) objectMessage.getObject())[0],
