	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				System.out.println("....................Consultar Negativadores para Exclusão ");
				...
				this.getControladorSpcSerasa().gerarMovimentoExclusaoNegativacao((Integer) ((Object[]) objectMessage.getObject())[0],
								idNegat, (Usuario) ((Object[]) objectMessage.getObject())[1]);
