 ...
 * @created 27/03/2007
 */
public class TarefaBatchExecutarComandoNegativacao
				extends TarefaBatch {
	...
	public Object executar() throws TarefaException{
		...
		// não é mais executado a tarefa batch de negativação, é executada a partir da acao de
		// cobrança
		// 15/08/2011 - Thiago Toscano, Isaac Silva
		//
		...
		// ParametroSimples(FiltroNegativadorMovimento.NEGATIVACAO_COMANDO, nComando.getId()));
		...
		// NegativadorMovimentoReg.getNumeroProximoRegistro(), neg, nContrato, nComando, nCriterio,
		// negMovimento,
		// null);
		//
		// }
		...
		// new Object[] {id, nCriterio, neg, nComando, nContrato, negMovimento,
		// this.getIdFuncionalidadeIniciada()});
		// }
		// }else{
		// enviarMensagemControladorBatch(ConstantesJNDI.BATCH_EXECUTAR_COMANDO_NEGATIVACAO_MDB,
		// new Object[] {0, nCriterio, neg, nComando, nContrato, negMovimento,
		// this.getIdFuncionalidadeIniciada()});
		// }
