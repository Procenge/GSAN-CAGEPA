 ...
 * @created 26/02/2014
 */
public class BatchComandarPrescricaoDebitosMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchComandarPrescricaoDebitosMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorCobranca().comandarPrescricaoDebitosComandoUsuario(
								(Integer) ((Object[]) objectMessage.getObject())[0],
								(Object[]) ((Object[]) objectMessage.getObject())[1]);
