...
public class UnidadeProcessamento
	...
	public static final int EMPRESA = 12;
	...
	/** full constructor */
	/*
	 * public UnidadeProcessamento(String descricaoUnidadeProcessamento, Date ultimaAlteracao, short
	 * indicadorUso, String descricaoAbreviada,
	 * Set unidadesIniciadas, Set processosFuncionalidades) {
	 ...
	 *//** minimal constructor */
	/*
	 * public UnidadeProcessamento(short indicadorUso, Set unidadesIniciadas, Set
	 * processosFuncionalidades) {
	 * this.indicadorUso = indicadorUso;
	 * this.unidadesIniciadas = unidadesIniciadas;
	 * this.processosFuncionalidades = processosFuncionalidades;
	 * }
