 ...
 * @date 21/08/2006
 */
public class VerificadorProcessosIniciados
				implements Job {

	private static final Logger LOGGER = Logger.getLogger(VerificadorProcessosIniciados.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException{
		...
		try{
			...
			if(agendadorAtivo == null || agendadorAtivo.equals("1")){
				LOGGER.debug("Verificando novos processos...");
