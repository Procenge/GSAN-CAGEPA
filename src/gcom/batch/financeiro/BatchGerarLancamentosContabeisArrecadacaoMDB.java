 ...
 * @date 23/05/2007
 */
public class BatchGerarLancamentosContabeisArrecadacaoMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorFinanceiro().gerarLancamentoContabeisArrecadacao((Integer) ((Object[]) objectMessage.getObject())[0],
