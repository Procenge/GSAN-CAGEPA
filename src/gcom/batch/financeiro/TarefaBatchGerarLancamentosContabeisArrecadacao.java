...
public class TarefaBatchGerarLancamentosContabeisArrecadacao
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarLancamentosContabeisArrecadacao(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_LANCAMENTOS_CONTABEIS_ARRECADACAO_MDB,
							new Object[] {anoMesArrecadacao, idLocalidade, this.getIdFuncionalidadeIniciada()});
