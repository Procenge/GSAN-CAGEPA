 ...
 * @author pedro
 */
public class TarefaBatchGerarResumoDevedoresDuvidosos
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoDevedoresDuvidosos(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_DEVEDORES_DUVIDOSOS_MDB,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoDevedoresDuvidososBatch", this);
	}
