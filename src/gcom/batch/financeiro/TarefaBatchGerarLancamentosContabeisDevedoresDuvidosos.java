 ...
 * @author pedro
 */
public class TarefaBatchGerarLancamentosContabeisDevedoresDuvidosos
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarLancamentosContabeisDevedoresDuvidosos(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_LANCAMENTOS_CONTABEIS_DEVEDORES_DUVIDOSOS_MDB,
							new Object[] {anoMesReferenciaContabil, idLocalidade, this.getIdFuncionalidadeIniciada()});
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarLancamentosContabeisDevedoresDuvidososBatch", this);
	}
