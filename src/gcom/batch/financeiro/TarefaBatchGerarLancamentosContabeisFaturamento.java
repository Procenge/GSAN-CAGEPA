...
public class TarefaBatchGerarLancamentosContabeisFaturamento
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarLancamentosContabeisFaturamento(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_LANCAMENTOS_CONTABEIS_FATURAMENTO_MDB,
							new Object[] {anoMesFaturamento, idLocalidade, this.getIdFuncionalidadeIniciada()});
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarLancamentosContabeisFaturamentoBatch", this);
	}
