 ...
 * @date 08/06/2007
 */
public class BatchGerarResumoDevedoresDuvidososMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorFinanceiro().gerarResumoDevedoresDuvidosos((Integer) ((Object[]) objectMessage.getObject())[0],
