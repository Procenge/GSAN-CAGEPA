 ...
 * @date 23/05/2007
 */
public class BatchGerarLancamentosContabeisFaturamentoMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorFinanceiro().gerarLancamentosContabeisFaturamento((Integer) ((Object[]) objectMessage.getObject())[0],
