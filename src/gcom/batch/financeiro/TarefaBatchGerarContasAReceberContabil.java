 ...
 * @created 04/10/2007
 */
public class TarefaBatchGerarContasAReceberContabil
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarContasAReceberContabil(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_CONTAS_A_RECEBER_CONTABIL_MDB, new Object[] {idLocalidade, this
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarContasAReceberContabilBatch", this);
	}
