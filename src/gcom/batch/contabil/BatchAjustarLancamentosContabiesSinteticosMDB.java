...
public class BatchAjustarLancamentosContabiesSinteticosMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchAjustarLancamentosContabiesSinteticosMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				// Ajustar os Lancamentos Sinteticos. Este ajuste consiste em retirar os itens
				// duplicados
				this.getControladorContabil().ajustarLancamentosContabeisSinteticos((Integer) ((Object[]) objectMessage.getObject())[0]);
