 ...
 * @date 21/03/2007
 */
public class TarefaBatchGerarHistoricoParaEncerrarArrecadacaoMes
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarHistoricoParaEncerrarArrecadacaoMes(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_HISTORICO_PARA_ENCERRAR_ARRECADACAO_MES_MDB,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarHistoricoParaEncerrarArrecadacaoMesBatch", this);
	}
