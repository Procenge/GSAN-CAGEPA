 ...
 * @date 21/03/2007
 */
public class TarefaBatchGerarHistoricoConta
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarHistoricoConta(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_HISTORICO_CONTA_MDB,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarHistoricoContaBatch", this);
	}
