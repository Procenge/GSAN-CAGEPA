 ...
 * @date 20/12/2006
 */
public class BatchEncerrarArrecadacaoMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchEncerrarArrecadacaoMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorArrecadacao().encerrarArrecadacao((Integer) ((Object[]) objectMessage.getObject())[0]);

				idUnidadeIniciada = getControladorBatch().iniciarUnidadeProcessamentoBatch(
								(Integer) ((Object[]) objectMessage.getObject())[0], UnidadeProcessamento.FUNCIONALIDADE,
								(Integer) ((Object[]) objectMessage.getObject())[0]);

				// TODO substituir a espera da thread pela atualização forçada do cache de
				// parametros [OC1079426]
				Thread.sleep(300000);
