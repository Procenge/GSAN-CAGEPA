 ...
 * @created 11/03/2012
 */
public class BatchGerarEnviarRelatorioResumoMovimentoArrecadacaoMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarEnviarRelatorioResumoMovimentoArrecadacaoMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorArrecadacao().gerarEnviarRelatorioResumoArrecadacao((Integer) ((Object[]) objectMessage.getObject())[0]);
