...
public class TarefaBatchEncerrarArrecadacaoMes
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchEncerrarArrecadacaoMes(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_ENCERRAR_ARRECADACAO_MES_MDB, new Object[] {Collections
							.singletonList(idLocalidade), this.getIdFuncionalidadeIniciada()});
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("EncerrarArrecadacaoMesBatch", this);
	}
