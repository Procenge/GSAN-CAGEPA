 ...
 * @date 15/04/2014
 */
public class BatchGerarQuadroComparativoFatEArrecMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarQuadroComparativoFatEArrecMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorArrecadacao().gerarQuadroComparativoFaturamentoEArrecadacao(
