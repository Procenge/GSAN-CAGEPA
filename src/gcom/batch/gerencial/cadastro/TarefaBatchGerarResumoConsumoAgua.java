 ...
 * @created 26/04/2007
 */
public class TarefaBatchGerarResumoConsumoAgua
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoConsumoAgua(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out.println("Localidade GERAR RESUMO CONSUMO AGUA" + (idSetor)
							+ "*********************************************************");

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_CONSUMO_AGUA_MDB, new Object[] {idSetor, this
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoConsumoAguaBatch", this);
	}
