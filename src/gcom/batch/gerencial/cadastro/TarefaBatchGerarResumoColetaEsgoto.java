 ...
 * @created 04/10/2007
 */
public class TarefaBatchGerarResumoColetaEsgoto
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoColetaEsgoto(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out
							.println("Setor GERAR RESUMO COLETA ESGOTO" + (idSetor)
											+ "*********************************************************");

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_COLETA_ESGOTO_MDB, new Object[] {idSetor, this
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoColetaEsgotoBatch", this);
	}
