...
public class BatchGerarResumoHistogramaAguaEsgotoMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorGerencialCadastro().gerarResumoHistograma((Integer) ((Object[]) objectMessage.getObject())[0],
