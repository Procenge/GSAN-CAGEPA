 ...
 * @created 23/07/2007
 */
public class TarefaBatchGerarResumoMetas
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoMetas(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_METAS_MDB, new Object[] {idSetor, dataInicial, dataFinal, this
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoMetasBatch", this);
	}
