 ...
 * @created 26/04/2007
 */
public class TarefaBatchGerarResumoHistogramaAguaEsgoto
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoHistogramaAguaEsgoto(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out.println("GERAR RESUMO HISTOGRAMA AGUA ESGOTO: SETOR COMERCIAL " + (idSetor)
							+ "*********************************************************");

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_HISTOGRAMA_AGUA_ESGOTO,
