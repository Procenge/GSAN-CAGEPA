...
public class BatchGerarResumoMetasMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorGerencialCadastro().gerarResumoMetas((Integer) ((Object[]) objectMessage.getObject())[0],
								(Date) ((Object[]) objectMessage.getObject())[1], (Date) ((Object[]) objectMessage.getObject())[2],
