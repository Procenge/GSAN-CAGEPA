 ...
 * @created 23/07/2007
 */
public class TarefaBatchGerarResumoMetasAcumulado
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoMetasAcumulado(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_METAS_ACUMULADO_MDB,
							new Object[] {idSetor, anoMesArrecadacao, this.getIdFuncionalidadeIniciada()});
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoMetasAcumuladoBatch", this);
	}
