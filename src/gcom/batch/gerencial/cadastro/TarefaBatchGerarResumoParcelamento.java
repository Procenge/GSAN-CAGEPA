 ...
 * @date 24/04/2007
 */
public class TarefaBatchGerarResumoParcelamento
				extends TarefaBatch {
	...
	public TarefaBatchGerarResumoParcelamento(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_PARCELAMENTO_MDB, new Object[] {idLocalidade, this
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoParcelamentoBatch", this);
	}
