 ...
 * @date 24/04/2007
 */
public class TarefaBatchGerarResumoInstalacoesHidrometros
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoInstalacoesHidrometros(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_INSTALACOES_HIDROMETROS_MDB,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoInstalacoesHidrometrosBatch", this);
	}
