 ...
 * @Alteracao 27/07/2007 - Troca do parametro PARM_AMREFERENCIAARRECADACAO para
 *            PARM_AMREFERENCIAFATURAMENTO
 */
public class TarefaBatchGerarResumoLeituraAnormalidade
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoLeituraAnormalidade(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_LEITURA_ANORMALIDADE_MDB,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoLeituraAnormalidadeBatch", this);
	}
}
