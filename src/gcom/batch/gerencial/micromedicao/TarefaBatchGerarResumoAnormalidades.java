 ...
 * @date 01/02/2007
 */
public class TarefaBatchGerarResumoAnormalidades
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoAnormalidades(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_ANORMALIDADES_MDB,
						new Object[] {this
