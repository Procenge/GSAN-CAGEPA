 ...
 * @date 04/06/2007
 */
public class TarefaBatchGerarResumoArrecadacao
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoArrecadacao(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_ARRECADACAO_MDB,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoArrecadacaoBatch", this);
	}
}
