 ...
 * @created 24/07/2007
 */
public class TarefaBatchGerarResumoPendencia
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoPendencia(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out.println("LOCALIDADE GERAR RESUMO PENDENCIA" + (idSetor)
							+ "*********************************************************");

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_RESUMO_PENDENCIA, new Object[] {idSetor, this
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarResumoPendencia", this);
	}
