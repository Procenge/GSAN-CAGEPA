...
/**
 * Tarefa que manda para batch Verificar Anormalidades de Consumo nos Movimentos do Faturamento
 * 
 * @author Hugo Lima
 * @created 11/01/2012
 */
public class TarefaBatchVerificarAnormalidadesConsumo
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchVerificarAnormalidadesConsumo(Usuario usuario, int idFuncionalidadeIniciada) {

		super(usuario, idFuncionalidadeIniciada);
	}

	@Deprecated
	public TarefaBatchVerificarAnormalidadesConsumo() {
	...
	public Object executar() throws TarefaException{
		...
		ArrayList<Rota> listaRotas = new ArrayList<Rota>();
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("VerificarAnormalidadesConsumoBatch", this);
	}
