 ...
 */
public class TarefaBatchGerarArquivoTextoParaLeiturista
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarArquivoTextoParaLeiturista(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		Collection colecaoRotas = (Collection) getParametro("colecaoRotas");

		enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_ARQUIVO_TEXTO_PARA_LEITURISTA,
						new Object[] {colecaoRoteirosEmpresa, colecaoRotas, anoMesFaturamento, faturamentoGrupo, this
