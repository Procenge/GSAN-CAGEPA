 ...
 * @created 20/07/2006
 */
public class TarefaBatchEfetuarRateioConsumo
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchEfetuarRateioConsumo(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out.println("Rota EFETUAR RATEIO CONSUMO" + ((Rota) array[1]).getId()
							+ "*********************************************************");

			// ((FaturamentoAtivCronRota)array[0]).setRota(((Rota)array[1]));

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_EFETUAR_RATEIO_CONSUMO_MDB, new Object[] {Collections
