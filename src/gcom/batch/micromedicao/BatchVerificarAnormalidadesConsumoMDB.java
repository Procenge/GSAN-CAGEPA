...
public class BatchVerificarAnormalidadesConsumoMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchVerificarAnormalidadesConsumoMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorMicromedicao().verificarAnormalidadesConsumo((Collection) ((Object[]) objectMessage.getObject())[0],
