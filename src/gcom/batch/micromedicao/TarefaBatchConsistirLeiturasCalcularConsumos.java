 ...
 * @created 20/07/2006
 */
public class TarefaBatchConsistirLeiturasCalcularConsumos
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchConsistirLeiturasCalcularConsumos(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out.println("Rota CONSISTIR LEITURAS" + ((Rota) array[1]).getId()
							+ "*********************************************************");

			// ((FaturamentoAtivCronRota)array[0]).setRota(((Rota)array[1]));

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_CONSISTIR_LEITURAS_CALCULAR_CONSUMOS_MDB,
							new Object[] {faturamentoGrupo, sistemaParametro, Collections.singletonList((Rota) array[1]), this
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("ConsistirLeiturasCalcularConsumosBatch", this);
	}
