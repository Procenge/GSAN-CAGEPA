...
public class BatchProcessarArquivoDadosLeituraAnormalidadeMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchProcessarArquivoDadosLeituraAnormalidadeMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				Integer idFaturamentoGrupo = (Integer) ((Object[]) objectMessage.getObject())[0];
				File arquivoLeitura = (File) ((Object[]) objectMessage.getObject())[1];
