 ...
 * @date 26/08/2008
 *       Alteração para Adição da Data Prevista de Atividade Leitura
 */
public class TarefaBatchGerarDadosParaLeitura
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarDadosParaLeitura(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		Date dataPrevistaAtividadeLeitura = (Date) getParametro("dataPrevistaAtividade");
		...
		enviarMensagemControladorBatch(
						...
						new Object[] {colecaoRotas, anoMesFaturamentoGrupo, idFaturamentoGrupo, this.getIdFuncionalidadeIniciada(), dataPrevistaAtividadeLeitura});
