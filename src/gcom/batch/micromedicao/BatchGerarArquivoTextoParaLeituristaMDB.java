 ...
 * @date 13/09/2007
 */
public class BatchGerarArquivoTextoParaLeituristaMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				Integer anoMesFaturamento = (Integer) ((Object[]) objectMessage.getObject())[2];
				...
				this.getControladorMicromedicao().gerarArquivoTextoParaLeiturista(colecaoRoteirosEmpresa, colecaoRotas, anoMesFaturamento,
								faturamentoGrupo, idFuncionalidadeIniciada.intValue());
