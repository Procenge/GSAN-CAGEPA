...
public class FiltroFuncionalidadeIniciada
				extends Filtro
	...
	public final static String PROCESSO_INICIADO_IP = "processoIniciado.ip";

	public final static String PROCESSO_INICIADO = "processoIniciado";
	...
	public final static String PROCESSO_FUNCIONALIDADE = "processoFuncionalidade";

	public final static String FUNCIONALIDADE = "processoFuncionalidade.funcionalidade";


	public final static String PROCESSO_PROCESSO_ID = "processoIniciado.processo.id";

	public final static String PROCESSO_PROCESSO_IP = "processoIniciado.ip";
