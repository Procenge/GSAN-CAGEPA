 ...
 * @date 15/08/2012
 */
public class BatchGerarIntegracaoContabilMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarIntegracaoContabilMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorIntegracaoPiramide().gerarIntegracaoContabil((Integer) ((Object[]) objectMessage.getObject())[0]);
