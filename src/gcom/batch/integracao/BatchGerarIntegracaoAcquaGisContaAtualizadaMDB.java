...
/**
 * Classe que executa a rotina de Gerar Integração Dados Conta Atualizada.
 * 
 * @author Josenildo Neves
 * @date 28/06/2013
 */
public class BatchGerarIntegracaoAcquaGisContaAtualizadaMDB
				implements MessageDrivenBean, MessageListener {

	private static final Logger LOGGER = Logger.getLogger(BatchGerarIntegracaoAcquaGisContaAtualizadaMDB.class);

	private static final long serialVersionUID = 1L;

	public BatchGerarIntegracaoAcquaGisContaAtualizadaMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				Integer idLocalidade = (Integer) ((Object[]) objectMessage.getObject())[1];
				this.getControladorIntegracaoAcquaGis().gerarIntegracaoAcquaGisDadosContaAtualizada(idFuncionalidadeIniciada, idLocalidade);
	 ...
	 */
	private ControladorIntegracaoAcquaGisLocal getControladorIntegracaoAcquaGis(){
