 ...
 * @date 15/08/2012
 */
public class BatchGerarIntegracaoContabilAjusteTempMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarIntegracaoContabilAjusteTempMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorIntegracaoPiramide().gerarIntegracaoContabilAjusteTemp(
