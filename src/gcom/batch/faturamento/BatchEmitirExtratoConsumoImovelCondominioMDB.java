...
public class BatchEmitirExtratoConsumoImovelCondominioMDB
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorFaturamento().emitirExtratoConsumoImovelCondominio(

				(String) ((Object[]) objectMessage.getObject())[0], (String) ((Object[]) objectMessage.getObject())[1],
