 ...
 * @created 20/07/2006
 */
public class TarefaBatchGerarTaxaEntregaContaOutroEndereco
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarTaxaEntregaContaOutroEndereco(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out.println("Rota TAXA ENTREGA" + ((Rota) array[1]).getId()
							+ "*********************************************************");

			// ((FaturamentoAtivCronRota)array[0]).setRota(((Rota)array[1]));

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_TAXA_ENTREGA_OUTRO_ENDERECO_MDB, new Object[] {Collections
							.singletonList((Rota) array[1]), anoMesFaturamento, this.getIdFuncionalidadeIniciada()});
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarTaxaEntregaContaOutroEnderecoBatch", this);
	}
