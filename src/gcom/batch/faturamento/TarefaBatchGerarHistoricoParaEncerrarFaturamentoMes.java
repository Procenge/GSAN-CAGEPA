 ...
 * @date 22/03/2007
 */
public class TarefaBatchGerarHistoricoParaEncerrarFaturamentoMes
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarHistoricoParaEncerrarFaturamentoMes(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_GERAR_HISTORICO_PARA_ENCERRAR_FATURAMENTO_MES_MDB,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("GerarHistoricoParaEncerrarFaturamentoMesBatch", this);
	}
