 ...
 * Envia para batch Declaração Anual Quitação Débitos
 * 
 * @author Carlos Chrystian Ramos
 * @date 24/04/2013
 */
public class BatchGerarDeclaracaoAnualQuitacaoDebitosMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarDeclaracaoAnualQuitacaoDebitosMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorFaturamento().gerarDeclaracaoAnualQuitacaoDebitos(
