 ...
 * @created 15/06/2007
 */
public class TarefaBatchEmitirContasOrgaoPublico
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchEmitirContasOrgaoPublico(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		enviarMensagemControladorBatch(
						...
						new Object[] {anoMesFaturamento, faturamentoGrupo, this.getIdFuncionalidadeIniciada(), tipoConta, idEmpresa, indicadorEmissaoExtratoFaturamento});
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("EmitirContasOrgaoPublicoBatch", this);
	}
