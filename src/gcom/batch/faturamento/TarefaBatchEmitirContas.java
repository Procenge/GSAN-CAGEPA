 ...
 * @date 03/11/2008
 */
public class TarefaBatchEmitirContas
				extends TarefaBatch {
	...
	public Object executar() throws TarefaException{
		...
		Collection colecaoIdsEmpresas = (Collection) getParametro(ConstantesSistema.COLECAO_UNIDADES_PROCESSAMENTO_BATCH);
		...
		while(iteratorEmpresas.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_EMITIR_CONTAS_MDB,
							new Object[] {idEmpresa, anoMesFaturamentoGrupo, faturamentoGrupo, this.getUsuario(), this
											.getIdFuncionalidadeIniciada()});
		}

		return null;

		// O código anterior foi apenas comentado!
