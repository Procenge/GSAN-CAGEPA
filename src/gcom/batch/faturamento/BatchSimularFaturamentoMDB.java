...
public class BatchSimularFaturamentoMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchSimularFaturamentoMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorFaturamento().simularFaturamento((Integer) ((Object[]) objectMessage.getObject())[0],
								(Integer) ((Object[]) objectMessage.getObject())[1],
								(FaturamentoSimulacaoComando) ((Object[]) objectMessage.getObject())[2],
