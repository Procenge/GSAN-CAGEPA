 ...
 * @date 08/10/2008
 */
public class BatchRegistrarFaturamentoImediatoMDB
	 ...
	 * 
	 */
	public BatchRegistrarFaturamentoImediatoMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			try{
				...
				Integer atividade = (Integer) ((Object[]) objectMessage.getObject())[4];
				...
				this.getControladorFaturamento().registrarFaturamentoImediatoGrupoFaturamento(colecaoRotasFaturamentoImediato,
								grupoFaturamento, anoMesCorrente, idFuncionalidadeIniciada, atividade);
