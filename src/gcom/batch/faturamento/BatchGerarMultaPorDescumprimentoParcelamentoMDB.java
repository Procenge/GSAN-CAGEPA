 ...
 * @created 04/02/2012
 */
public class BatchGerarMultaPorDescumprimentoParcelamentoMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarMultaPorDescumprimentoParcelamentoMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				this.getControladorFaturamento().gerarMultaPorDescumprimentoParcelamento(
