 ...
 * @date 05/01/2007
 */
public class TarefaBatchEncerrarFaturamentoMes
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchEncerrarFaturamentoMes(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_ENCERRAR_FATURAMENTO_MES_MDB, new Object[] {Collections
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("EncerrarFaturamentoMesBatch", this);
	}
