 ...
 * @created 20/07/2006
 */
public class TarefaBatchFaturarGrupoFaturamento
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchFaturarGrupoFaturamento(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		while(iterator.hasNext()){
			...
			System.out.println("Rota FATURAR GRUPO" + ((Rota) array[1]).getId()
							+ "*********************************************************");

			enviarMensagemControladorBatch(ConstantesJNDI.BATCH_FATURAR_GRUPO_FATURAMENTO_MDB, new Object[] {Collections
							.singletonList((FaturamentoAtivCronRota) array[0]), faturamentoGrupo, anoMesFaturamentoGrupo, atividade, this
