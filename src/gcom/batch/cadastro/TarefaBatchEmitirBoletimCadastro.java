 ...
 * @created 30/05/2007
 */
public class TarefaBatchEmitirBoletimCadastro
				extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchEmitirBoletimCadastro(Usuario usuario, int idFuncionalidadeIniciada) {
	...
	public Object executar() throws TarefaException{
		...
		enviarMensagemControladorBatch(ConstantesJNDI.BATCH_EMITIR_BOLETIM_CADASTRO_MDB,
						new Object[] {comandoAtividadeAcaoCobranca, comandoAtividadeAcaoComando, dataAtual, acaoCobranca, this
