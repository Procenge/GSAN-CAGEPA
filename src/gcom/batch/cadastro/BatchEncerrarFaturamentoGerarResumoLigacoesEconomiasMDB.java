...
public class BatchEncerrarFaturamentoGerarResumoLigacoesEconomiasMDB
				implements MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchEncerrarFaturamentoGerarResumoLigacoesEconomiasMDB() {
	...
	public void onMessage(Message message){
		...
		if(message instanceof ObjectMessage){
			...
			try{
				...
				this.getControladorMicromedicao().encerrarFaturamentoGerarResumoLigacoesEconomias(
