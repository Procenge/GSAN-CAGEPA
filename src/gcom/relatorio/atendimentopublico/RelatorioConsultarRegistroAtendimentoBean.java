...
public class RelatorioConsultarRegistroAtendimentoBean
	...
	private String dddTelefoneSolicitante;

	private String ramalTelefoneSolicitante;

	/**
	 * Construtor de RelatorioConsultarRegistroAtendimentoBean
	 */
	public RelatorioConsultarRegistroAtendimentoBean(String numeroRA, String situacaoRA, String indicadorAssociado,
														String numeroRAAssociado, String situacaoRAAssociado, String tipoSolicitacao,
														String especificacao, String dataAtendimento, String dataPrevista,
														String meioSolicitacao, String unidadeAtendimento, String unidadeAtual,
														String observacao, String matriculaImovel, String inscricaoImovel,
														String enderecoOcorrencia, String pontoReferencia, String municipio, String bairro,
														String areaBairro, String localidadeSetorQuadra, String divisaoEsgoto,
														String localOcorrencia, String pavimentoRua, String pavimentoCalcada,
														String descricaoLocalOcorrencia, String codigoCliente, String nomeCliente,
														String unidadeSolicitante, String codigoFuncionario, String nomeFuncionario,
														String nomeSolicitante, String quantidade, String dataReiteracao,
														String motivoEncerramento, String numeroRAReferencia, String situacaoRAReferencia,
														String dataEncerramento, String unidadeEncerramento, String usuarioEncerramento,
														String parecerEncerramento, String rota, String sequencialRota,
														String clienteProprietario, String tipoPessoa, String numeroCpfCnpj,
														String numeroRG, String orgaoExpedidorRG, String unidadeFederacaoRG,
														String dddTelefoneSolicitante, String ramalTelefoneSolicitante) {
		...
		this.dddTelefoneSolicitante = dddTelefoneSolicitante;
		this.ramalTelefoneSolicitante = ramalTelefoneSolicitante;
	}
	...
	public String getClienteProprietario(){

		return clienteProprietario;
	}

	public void setClienteProprietario(String clienteProprietario){
	...
	/**
	 * @return the dddTelefoneSolicitante
	 */
	public String getDddTelefoneSolicitante(){

		return dddTelefoneSolicitante;
	}

	/**
	 * @param dddTelefoneSolicitante
	 *            the dddTelefoneSolicitante to set
	 */
	public void setDddTelefoneSolicitante(String dddTelefoneSolicitante){

		this.dddTelefoneSolicitante = dddTelefoneSolicitante;
	}

	/**
	 * @return the ramalTelefoneSolicitante
	 */
	public String getRamalTelefoneSolicitante(){

		return ramalTelefoneSolicitante;
	}

	/**
	 * @param ramalTelefoneSolicitante
	 *            the ramalTelefoneSolicitante to set
	 */
	public void setRamalTelefoneSolicitante(String ramalTelefoneSolicitante){
