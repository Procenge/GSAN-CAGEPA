 ...
 */
public class RelatorioConsultarRegistroAtendimentoViaCliente
	...
	public Object executar() throws TarefaException{
		...
		// Dados Gerais
						...
						(registroAtendimentoHelper.getRegistroAtendimento().getLocalidade() == null ? "---" : Util
										...
										+ (registroAtendimentoHelper.getRegistroAtendimento().getQuadra() == null ? "---" : Util
														.adicionarZerosEsquedaNumero(tamanhoNumeroQuadra, ""
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_CONSULTAR_REGISTRO_ATENDIMENTO_VIA_CLIENTE, parametros, ds,
						tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.CONSULTAR_REGISTRO_ATENDIMENTO_VIA_CLIENTE, idFuncionalidadeIniciada, null);
