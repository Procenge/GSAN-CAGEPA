 ...
 * @date 14/02/2007
 */
public class RelatorioMedicaoConsumoLigacaoAgua
	...
	private Collection<RelatorioMedicaoConsumoLigacaoAguaBean> inicializarBeanRelatorio(Collection<MedicaoHistorico> dadosRelatorio,
					Collection<ImovelMicromedicao> dadosRelatorio2){
	...
	public Object executar() throws TarefaException{
		...
		Collection<RelatorioMedicaoConsumoLigacaoAguaBean> colecaoBean = this.inicializarBeanRelatorio(colecaoMedicaoHistorico,
						colecaoimoveisMicromedicao);
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_MEDICAO_CONSUMO_LIGACAO_AGUA, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MEDICAO_CONSUMO_LIGACAO_AGUA, idFuncionalidadeIniciada, null);
