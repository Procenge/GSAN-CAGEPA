 ...
 */
public class RelatorioAcompanhamentoExecucaoOS
	...
	public RelatorioAcompanhamentoExecucaoOS(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_ACOMPANHAMENTO_EXECUCAO_OS);
	}
	...
	public Object executar() throws TarefaException{
		...
		Collection colecaoOSRelatorioAcompanhamentoExecucaoHelper = fachada.pesquisarOSGerarRelatorioAcompanhamentoExecucao(origemServico,
		...
		if(colecaoOSRelatorioAcompanhamentoExecucaoHelper != null && !colecaoOSRelatorioAcompanhamentoExecucaoHelper.isEmpty()){
			...
			Iterator colecaoOSRelatorioAcompanhamentoExecucaoHelperIterator = colecaoOSRelatorioAcompanhamentoExecucaoHelper.iterator();
			...
			while(colecaoOSRelatorioAcompanhamentoExecucaoHelperIterator.hasNext()){
				...
				if(osRelatorioAcompanhamentoExecucaoHelper.getIdServicoTipo() != null){
					tipoServico = osRelatorioAcompanhamentoExecucaoHelper.getIdServicoTipo().toString() + " - "
									+ osRelatorioAcompanhamentoExecucaoHelper.getDescricaoServicoTipo();
				}

				// Id do RA
				String idRA = "";
				if(osRelatorioAcompanhamentoExecucaoHelper.getIdRegistroAtendimento() != null){
					idRA = osRelatorioAcompanhamentoExecucaoHelper.getIdRegistroAtendimento().toString();
				}

				// Matrícula do Imóvel
				String idImovel = "";
				if(osRelatorioAcompanhamentoExecucaoHelper.getIdImovel() != null){
					idImovel = osRelatorioAcompanhamentoExecucaoHelper.getIdImovel().toString();
				}

				// Origem
				String origem = "";
				if(osRelatorioAcompanhamentoExecucaoHelper.getIdUnidadeAtendimento() != null){
					origem = osRelatorioAcompanhamentoExecucaoHelper.getIdUnidadeAtendimento().toString() + " - "
									+ osRelatorioAcompanhamentoExecucaoHelper.getNomeUnidadeAtendimento();
				}

				// Data Solicitação
				String dataSolicitacao = "";

				if(osRelatorioAcompanhamentoExecucaoHelper.getDataSolicitacao() != null){
					dataSolicitacao = Util.formatarData(osRelatorioAcompanhamentoExecucaoHelper.getDataSolicitacao());
				}

				// Data da Programação
				String dataProgramacao = "";

				if(osRelatorioAcompanhamentoExecucaoHelper.getDataProgramacao() != null){
					dataProgramacao = Util.formatarData(osRelatorioAcompanhamentoExecucaoHelper.getDataProgramacao());
				}

				// Data de Encerramento
				String dataEncerramento = "";

				if(osRelatorioAcompanhamentoExecucaoHelper.getDataEncerramento() != null){
					dataEncerramento = Util.formatarData(osRelatorioAcompanhamentoExecucaoHelper.getDataEncerramento());
				}
				...
				if(osRelatorioAcompanhamentoExecucaoHelper.getDataEncerramentoRA() == null){
					...
					if(osRelatorioAcompanhamentoExecucaoHelper.getDataSolicitacao() != null){
						...
						// de nulo
						if(osRelatorioAcompanhamentoExecucaoHelper.getHorasPrazo() != null){

							Date dataAtual = new Date();
							int horasPrazo = osRelatorioAcompanhamentoExecucaoHelper.getHorasPrazo().intValue();
							Date dataPrevista = Util.adicionarNumeroHorasAUmaData(osRelatorioAcompanhamentoExecucaoHelper
											.getDataSolicitacao(), horasPrazo);

							// Verifica se a data atual é posterior a data
							// prevista
							if(Util.compararData(dataAtual, dataPrevista) == 1){
								diasAtraso = "" + Util.obterQuantidadeDiasEntreDuasDatas(dataPrevista, dataAtual);
							}
						}
					}
				}
				...
				if(colecaoOSRelatorioAcompanhamentoExecucaoHelperIterator.hasNext()){

					relatorioBean = new RelatorioAcompanhamentoExecucaoOSBean(

					// Número OS
									osRelatorioAcompanhamentoExecucaoHelper.getIdOrdemServico().toString(),

									// Unidade Atual
									osRelatorioAcompanhamentoExecucaoHelper.getNomeUnidadeAtual(),

									// Situação da OS
									osRelatorioAcompanhamentoExecucaoHelper.getSituacaoOS(),
									...
									// Endereço
									osRelatorioAcompanhamentoExecucaoHelper.getEndereco(),
									...
									// Equipe
									osRelatorioAcompanhamentoExecucaoHelper.getNomeEquipe(),
		...
		parametros.put("P_SITUACAO_OS", situacaoOS);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_ACOMPANHAMENTO_EXECUCAO_OS, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.ACOMPANHAMENTO_EXECUCAO_OS, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		String idEquipeProgramacao = (String) getParametro("idEquipeProgramacao");
		String idEquipeExecucao = (String) getParametro("idEquipeExecucao");
		String idLocalidade = (String) getParametro("idEquipeExecucao");

		retorno = fachada.pesquisarOSGerarRelatorioAcompanhamentoExecucaoCount(origemServico, situacaoOS, idsServicosTipos,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioAcompanhamentoExecucaoOS", this);
	}
}