 ...
 */
public class RelatorioNumeracaoRAManual
	...
	public Object executar() throws TarefaException{
		...
		if(colecaoNumeracao != null && !colecaoNumeracao.isEmpty()){

			// coloca a coleção de parâmetros da analise no iterator
			Iterator colecaoNumeracaoIterator = colecaoNumeracao.iterator();

			// laço para criar a coleção de parâmetros da analise
			while(colecaoNumeracaoIterator.hasNext()){

				String numeracao = (String) colecaoNumeracaoIterator.next();
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_NUMERACAO_RA_MANUAL, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.NUMERACAO_RA_MANUAL, idFuncionalidadeIniciada, null);
