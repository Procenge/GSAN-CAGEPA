 ...
 * @created 12/12/2007
 */
public class RelatorioRelacaoOrdensServicoEncerradasPendentes
	...
	public RelatorioRelacaoOrdensServicoEncerradasPendentes(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_RELACAO_ORDENS_SERVICO_ENCERRADAS_PENDENTES);
	}
	...
	public Object executar() throws TarefaException{
		...
		if(colecaoDadosHelper != null && !colecaoDadosHelper.isEmpty()){
			...
			while(iColecaoDados.hasNext()){
				...
				RelacaoOrdensServicoEncerradasPendentesHelper helper = (RelacaoOrdensServicoEncerradasPendentesHelper) iColecaoDados.next();
			...
			retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_RELACAO_ORDENS_SERVICO_ENCERRADAS_PENDENTES, parametros, ds,
							tipoFormatoRelatorio);

			// Grava o relatório no sistema
			try{
				persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_RELACAO_OS_ENCERRADAS_PENDENTES, idFuncionalidadeIniciada, null);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioRelacaoOrdensServicoEncerradasPendentes", this);
	}
}