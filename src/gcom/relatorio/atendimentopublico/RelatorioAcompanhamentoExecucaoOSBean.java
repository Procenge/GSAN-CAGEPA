 ...
 * @date 07/11/2006
 */
public class RelatorioAcompanhamentoExecucaoOSBean
				implements RelatorioBean, Comparable<RelatorioAcompanhamentoExecucaoOSBean> {
	...
	public RelatorioAcompanhamentoExecucaoOSBean(String idOS, String unidadeAtual, String situacao, String tipoServico, String idRA,
													String endereco, String origem, String dataSolicitacao, String dataProgramacao,
													String dataEncerramento, String equipe, String diasAtraso, String total,
													String totalGeral, String idImovel) {
	...
	public int compareTo(RelatorioAcompanhamentoExecucaoOSBean o){

		int retorno = retornaStringParaComparacao(getTipoServico()).compareTo(retornaStringParaComparacao(o.getTipoServico()));

		if(retorno == 0){
			retorno = retornaStringParaComparacao(getEquipe()).compareTo(retornaStringParaComparacao(o.getEquipe()));
			if(retorno == 0){
				retorno = retornaStringParaComparacao(getSituacao()).compareTo(retornaStringParaComparacao(o.getSituacao()));
			}
		}
	...
	private String retornaStringParaComparacao(String string){
