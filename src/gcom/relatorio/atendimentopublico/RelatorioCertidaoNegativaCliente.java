 ...
 * @created 29/01/2008
 */
public class RelatorioCertidaoNegativaCliente
	...
	public RelatorioCertidaoNegativaCliente(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_CERTIDAO_NEGATIVA_CLIENTE);
	}
	...
	public Object executar() throws TarefaException{
		...
		Collection<RelatorioCertidaoNegativaClienteBean> colecao = fachada.pesquisarRelatorioCertidaoNegativaCliente(idsClientes,
						clienteInformado);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_CERTIDAO_NEGATIVA_CLIENTE, parametros, ds, tipoFormatoRelatorio);
