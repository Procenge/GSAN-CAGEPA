...
public class RelatorioDataSource
	...
	public Object getFieldValue(JRField field) throws JRException{
		...
		try{
			...
			Method getMethod = lineItemClass.getDeclaredMethod(resolverNomeCampo(field.getName()), paramTypes);
	...
	private String resolverNomeCampo(String nomeCampo){
		...
		if(!nomeCampo.startsWith("get")){
			...
			nomeCampo = "get" + nomeCampo.substring(0, 1).toUpperCase() + nomeCampo.substring(1, nomeCampo.length());
