 ...
 * @date 02/01/2008
 */
public class FiltrarRelatorioImoveisAtivosNaoMedidosHelper
	...
	private Integer[] idsSituacaoAguaImovelAtivo;
	...
	/**
	 * @return the idsSituacaoAguaImovelAtivo
	 */
	public Integer[] getIdsSituacaoAguaImovelAtivo(){

		return idsSituacaoAguaImovelAtivo;
	}

	/**
	 * @param idsSituacaoAguaImovelAtivo
	 *            the idsSituacaoAguaImovelAtivo to set
	 */
	public void setIdsSituacaoAguaImovelAtivo(Integer[] idsSituacaoAguaImovelAtivo){

		this.idsSituacaoAguaImovelAtivo = idsSituacaoAguaImovelAtivo;
	}
