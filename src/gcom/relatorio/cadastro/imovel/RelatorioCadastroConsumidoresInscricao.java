 ...
 */
public class RelatorioCadastroConsumidoresInscricao
	...
	public RelatorioCadastroConsumidoresInscricao(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_CADASTRO_CONSUMIDORES_INSCRICAO);
	}
	...
	public Object executar() throws TarefaException{
		...
		Collection imoveisRelatoriosHelper = fachada.gerarRelatorioCadastroConsumidoresInscricao(imovelCondominioID, imovelPrincipalID,
		...
		if(imoveisRelatoriosHelper != null && !imoveisRelatoriosHelper.isEmpty()){
			...
			while(imovelRelatorioIterator.hasNext()){
				...
				// Código da Gerência Regional
								...
								// Inscrição do Imóvel composto do número da
								// quadra, lote e sublote
								imovelRelatorioHelper.getInscricaoSemLocalidade() == null ? "" : imovelRelatorioHelper
												.getInscricaoSemLocalidade(),
								...
								imovelRelatorioHelper.getTipoPavimentoCalcada() != null ? imovelRelatorioHelper.getTipoPavimentoCalcada()
												: "",

								// Tipo Pavimento Rua
								imovelRelatorioHelper.getTipoPavimentoRua() != null ? imovelRelatorioHelper.getTipoPavimentoRua() : "",

								// Tipo de Despejo
								imovelRelatorioHelper.getTipoDespejo(),

								// Volume do Reservatório Superior
								imovelRelatorioHelper.getVolumeReservatorioSuperior() == null ? "0" : imovelRelatorioHelper
												.getVolumeReservatorioSuperior().toString(),

								// Volume do Reservatório Inferior
								imovelRelatorioHelper.getVolumeReservatorioInferior() == null ? "0" : imovelRelatorioHelper
												.getVolumeReservatorioInferior().toString(),

								// Volume da Piscina
								imovelRelatorioHelper.getVolumePiscina() == null ? "0" : imovelRelatorioHelper.getVolumePiscina()
												.toString(),
								...
								// Rota
								imovelRelatorioHelper.getCodigoRota() == null ? "" : Integer
												.toString(imovelRelatorioHelper.getCodigoRota()),
								...
								// Segmento
								imovelRelatorioHelper.getSegmento() == null ? "" : imovelRelatorioHelper.getSegmento().toString());

				relatorioBean.setTipoFaturamento(imovelRelatorioHelper.getTipoFaturamento() == null ? "" : imovelRelatorioHelper
								.getTipoFaturamento());

				relatorioBean.setQuantidadeEconomia(imovelRelatorioHelper.getQuantidadeEconomia() == null ? "" : imovelRelatorioHelper
								.getQuantidadeEconomia()
								+ "");

				relatorioBean.setDescricaoAbreviadaCategoria(imovelRelatorioHelper.getDescricaoAbreviadaCategoria() == null ? ""
								: imovelRelatorioHelper.getDescricaoAbreviadaCategoria());

				relatorioBean.setIdLogradouro(imovelRelatorioHelper.getIdLogradouro() == null ? "" : imovelRelatorioHelper
								.getIdLogradouro());
		...
		parametros.put("gerenciaRegional", gerenciaRegional == null ? "" : gerenciaRegional.getNome());
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_CADASTRO_CONSUMIDORES_INSCRICAO, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.CADASTRO_CONSUMIDORES_INSCRICAO, idFuncionalidadeIniciada, null);
