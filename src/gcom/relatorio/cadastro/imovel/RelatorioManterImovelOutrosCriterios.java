 ...
 */
public class RelatorioManterImovelOutrosCriterios
	...
	public RelatorioManterImovelOutrosCriterios(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_IMOVEL_OUTROS_CRITERIOS_MANTER);
	}
	...
	public Object executar() throws TarefaException{
		...
		Collection imoveisRelatoriosHelper = fachada.gerarRelatorioImovelOutrosCriterios(imovelCondominioID, imovelPrincipalID,
		...
		if(imoveisRelatoriosHelper != null && !imoveisRelatoriosHelper.isEmpty()){
			...
			while(imovelRelatorioIterator.hasNext()){
				...
				if(imovelRelatorioHelper.getSubcategoriaQtdEconomia() != null){
					...
					String[] subCategoriaQtdEconomia = imovelRelatorioHelper.getSubcategoriaQtdEconomia();
					int i = 0;
					while(i < imovelRelatorioHelper.getSubcategoriaQtdEconomia().length){

						// Concatenar as categorias com suas
						// respectivas
						// quantidades de economias

						imovelSubcategoriaImprimir = imovelSubcategoriaImprimir + subCategoriaQtdEconomia[i];
				...
				// Código da Gerência Regional
								...
								imovelRelatorioHelper.getIdUnidadeNegocio() == null ? "" : "" + imovelRelatorioHelper.getIdUnidadeNegocio(),

								// Nome Unidade de Negócio
								imovelRelatorioHelper.getNomeUnidadeNegocio() == null ? "" : imovelRelatorioHelper.getNomeUnidadeNegocio(),
								...
								imovelRelatorioHelper.getInscricaoImovel() == null ? "" : imovelRelatorioHelper.getInscricaoImovel(),

								// Matrícula do Imóvel
								"" + imovelRelatorioHelper.getMatriculaImovel(),

								// Código do Cliente Usuário
								imovelRelatorioHelper.getClienteUsuarioId() == null ? "" : "" + imovelRelatorioHelper.getClienteUsuarioId(),

								// Nome do Cliente Usuário
								imovelRelatorioHelper.getClienteUsuarioNome() == null ? "" : imovelRelatorioHelper.getClienteUsuarioNome(),

								// Código do Cliente Responsável
								imovelRelatorioHelper.getClienteResponsavelId() == null ? "" : ""
												+ imovelRelatorioHelper.getClienteResponsavelId(),

								// Nome do Cliente Responsável
								imovelRelatorioHelper.getClienteResponsavelNome() == null ? "" : imovelRelatorioHelper
								...
								imovelRelatorioHelper.getIndicadorImovelCondominio() == 1 ? "SIM" : "NÃO",

								// Matrícula Imóvel Condomínio
								imovelRelatorioHelper.getMatriculaImovelCondominio() == null ? "" : ""
												+ imovelRelatorioHelper.getMatriculaImovelCondominio(),

								// Matrícula Imóvel Principal
								imovelRelatorioHelper.getMatriculaImovelPrincipal() == null ? "" : ""
												+ imovelRelatorioHelper.getMatriculaImovelPrincipal(),

								// Perfil Imóvel
								imovelRelatorioHelper.getPerfilImovel() == null ? "" : imovelRelatorioHelper.getPerfilImovel(),
								...
								imovelRelatorioHelper.getVolumeReservatorioSuperior() == null ? (imovelRelatorioHelper
												.getVolumeReservatorioSuperiorMenorFaixa() == null ? "" : Util
												.formatarMoedaReal(imovelRelatorioHelper.getVolumeReservatorioSuperiorMenorFaixa()))
												+ " a "
												+ (imovelRelatorioHelper.getVolumeReservatorioSuperiorMaiorFaixa() == null ? "" : Util
																.formatarMoedaReal(imovelRelatorioHelper
																				.getVolumeReservatorioSuperiorMaiorFaixa())) + " m³" : Util
												.formatarMoedaReal(imovelRelatorioHelper.getVolumeReservatorioInferior())
												+ " m³",

								// Volume do Reservatório Inferior
								imovelRelatorioHelper.getVolumeReservatorioInferior() == null ? (imovelRelatorioHelper
												.getVolumeReservatorioInferiorMenorFaixa() == null ? "" : Util
												.formatarMoedaReal(imovelRelatorioHelper.getVolumeReservatorioInferiorMenorFaixa()))
												+ " a "
												+ (imovelRelatorioHelper.getVolumeReservatorioInferiorMaiorFaixa() == null ? "" : Util
																.formatarMoedaReal(imovelRelatorioHelper
																				.getVolumeReservatorioInferiorMaiorFaixa())) + " m³" : Util
												.formatarMoedaReal(imovelRelatorioHelper.getVolumeReservatorioInferior())
												+ " m³",

								// Volume da Piscina
								imovelRelatorioHelper.getVolumePiscina() == null ? (imovelRelatorioHelper.getVolumePiscinaMenorFaixa() == null ? ""
												: Util.formatarMoedaReal(imovelRelatorioHelper.getVolumePiscinaMenorFaixa()))
												+ " a "
												+ (imovelRelatorioHelper.getVolumePiscinaMaiorFaixa() == null ? "" : Util
																.formatarMoedaReal(imovelRelatorioHelper.getVolumePiscinaMaiorFaixa()))
												+ " m³"
												: Util.formatarMoedaReal(imovelRelatorioHelper.getVolumePiscina()) + " m³",

								// Média de Consumo do Imóvel
								imovelRelatorioHelper.getConsumoMedioImovel() == null ? "" : ""
												+ imovelRelatorioHelper.getConsumoMedioImovel(),

								// Área Construída
								imovelRelatorioHelper.getAreaConstruidaImovel() == null ? imovelRelatorioHelper
												.getAreaConstruidaMenorFaixa()
												+ " a " + imovelRelatorioHelper.getAreaConstruidaMaiorFaixa() + " m²" : Util
												.formatarMoedaReal(imovelRelatorioHelper.getAreaConstruidaImovel())
												+ " m²",

								// Número de Moradores
								imovelRelatorioHelper.getNumeroMoradores() == 0 ? "" : "" + imovelRelatorioHelper.getNumeroMoradores(),

								// Pontos de Utilização
								imovelRelatorioHelper.getNumeroPontosUtilzacao() == 0 ? "" : ""
												+ imovelRelatorioHelper.getNumeroPontosUtilzacao(),

								// Tipo do Poço
								imovelRelatorioHelper.getDescricaoTipoPoco() == null ? "" : imovelRelatorioHelper.getDescricaoTipoPoco(),

								// Jardim
								imovelRelatorioHelper.getJardim(),

								// Data da Ligação de Água
								imovelRelatorioHelper.getDataLigacaoAgua() == null ? "" : dataFormatada.format(imovelRelatorioHelper
												.getDataLigacaoAgua()),

								// Diâmetro da Ligação de Água
								imovelRelatorioHelper.getDiametroLigacaoAgua() == null ? "" : imovelRelatorioHelper
												.getDiametroLigacaoAgua(),

								// Material da Ligação de Água
								imovelRelatorioHelper.getMaterialLigacaoAgua() == null ? "" : imovelRelatorioHelper
												.getMaterialLigacaoAgua(),

								// Consumo Mínimo Fixado de Água
								imovelRelatorioHelper.getConsumoMinimoFixadoAgua() == null ? "" : ""
												+ imovelRelatorioHelper.getConsumoMinimoFixadoAgua(),

								// Data da Ligação de Esgoto
								imovelRelatorioHelper.getDataLigacaoEsgoto() == null ? "" : dataFormatada.format(imovelRelatorioHelper
												.getDataLigacaoEsgoto()),

								// Diâmetro da Ligação de Esgoto
								imovelRelatorioHelper.getDiametroLigacaoEsgoto() == null ? "" : imovelRelatorioHelper
												.getDiametroLigacaoEsgoto(),

								// Material da Ligação de Esgoto
								imovelRelatorioHelper.getMaterialLigacaoEsgoto() == null ? "" : imovelRelatorioHelper
												.getMaterialLigacaoEsgoto(),

								// Percentual da Coleta de Água
								imovelRelatorioHelper.getPercentualAguaConsumidaColetada() == null ? "" : imovelRelatorioHelper
												.getPercentualAguaConsumidaColetada().toString(),

								// Percentual de Esgoto
								imovelRelatorioHelper.getPercentual() == null ? "" : imovelRelatorioHelper.getPercentual().toString(),

								// Consumo Mínimo Fixado de Esgoto
								imovelRelatorioHelper.getConsumoMinimoFixadoLigacaoEsgoto() == null ? "" : ""
												+ imovelRelatorioHelper.getConsumoMinimoFixadoLigacaoEsgoto(),

								// Início dos Dados do Hidrômetro Instalado na
								// Ligação de Água
								// Número
								imovelRelatorioHelper.getNumeroHidrometroAgua() == null ? "" : imovelRelatorioHelper
												.getNumeroHidrometroAgua(),

								// Ano de Fabricação
								imovelRelatorioHelper.getAnoFabricaocaHidrometroAgua() == 0 ? "" : ""
												+ imovelRelatorioHelper.getAnoFabricaocaHidrometroAgua(),

								// Capacidade
								imovelRelatorioHelper.getCapacidadeHidrometroAgua() == null ? "" : imovelRelatorioHelper
												.getCapacidadeHidrometroAgua(),

								// Marca
								imovelRelatorioHelper.getMarcaHidrometroAgua() == null ? "" : imovelRelatorioHelper
												.getMarcaHidrometroAgua(),

								// Diâmetro
								imovelRelatorioHelper.getDiametroHidrometroAgua() == null ? "" : imovelRelatorioHelper
												.getDiametroHidrometroAgua(),

								// Tipo
								imovelRelatorioHelper.getTipoHidrometroAgua() == null ? "" : imovelRelatorioHelper.getTipoHidrometroAgua(),

								// Data de Instalação
								imovelRelatorioHelper.getDataInstalacaoHidrometroAgua() == null ? "" : dataFormatada
												.format(imovelRelatorioHelper.getDataInstalacaoHidrometroAgua()),

								// Local de Instalação
								imovelRelatorioHelper.getLocalInstalacaoHidrometroAgua() == null ? "" : imovelRelatorioHelper
												.getLocalInstalacaoHidrometroAgua(),

								// Tipo de Proteção
								imovelRelatorioHelper.getTipoProtecaoHidrometroAgua() == null ? "" : imovelRelatorioHelper
												.getTipoProtecaoHidrometroAgua(),

								// Indicador da Existência de Cavalete
								imovelRelatorioHelper.getIndicadorExistenciaCavaleteAgua() == 0 ? "" : ""
												+ imovelRelatorioHelper.getIndicadorExistenciaCavaleteAgua(),
								...
								// do Poço
								// Número
								imovelRelatorioHelper.getNumeroHidrometroPoco() == null ? "" : imovelRelatorioHelper
												.getNumeroHidrometroPoco(),

								// Ano de Fabricação
								imovelRelatorioHelper.getAnoFabricacaoHidrometroPoco() == 0 ? "" : ""
												+ imovelRelatorioHelper.getAnoFabricacaoHidrometroPoco(),

								// Capacidade
								imovelRelatorioHelper.getCapacidadeHidrometroPoco() == null ? "" : imovelRelatorioHelper
												.getCapacidadeHidrometroPoco(),

								// Marca
								imovelRelatorioHelper.getMarcaHidrometroPoco() == null ? "" : imovelRelatorioHelper
												.getMarcaHidrometroPoco(),

								// Diâmetro
								imovelRelatorioHelper.getDiametroHidrometroPoco() == null ? "" : imovelRelatorioHelper
												.getDiametroHidrometroPoco(),

								// Tipo
								imovelRelatorioHelper.getTipoHidrometroPoco() == null ? "" : imovelRelatorioHelper.getTipoHidrometroPoco(),

								// Data de Instalação
								imovelRelatorioHelper.getDataInstalacaoHidrometroPoco() == null ? "" : dataFormatada
												.format(imovelRelatorioHelper.getDataInstalacaoHidrometroPoco()),

								// Local de Instalação
								imovelRelatorioHelper.getLocalInstalacaoHidrometroPoco() == null ? "" : imovelRelatorioHelper
												.getLocalInstalacaoHidrometroPoco(),

								// Tipo de Proteção
								imovelRelatorioHelper.getTipoProtecaoHidrometroPoco() == null ? "" : imovelRelatorioHelper
												.getTipoProtecaoHidrometroPoco(),

								// Indicador da Existência de Cavalete
								imovelRelatorioHelper.getIndicadorExistenciaCavaletePoco() == 0 ? "" : ""
												+ imovelRelatorioHelper.getIndicadorExistenciaCavaletePoco(),

								// Rota
								imovelRelatorioHelper.getIdRota() == null ? "" : Integer.toString(imovelRelatorioHelper.getIdRota()),

								// Número Sequencial Rota
								imovelRelatorioHelper.getNumeroSequencialRota() == null ? "" : imovelRelatorioHelper
		...
		parametros.put("gerenciaRegional", gerenciaRegional == null ? "" : gerenciaRegional.getNomeAbreviado());
		...
		parametros.put("cep", imovelParametrosInicial.getLogradouroCep().getCep() == null ? "" : imovelParametrosInicial.getLogradouroCep()
						.getCep().getCodigo() == null ? "" : "" + imovelParametrosInicial.getLogradouroCep().getCep().getCodigo());

		parametros.put("idLogradouro", imovelParametrosInicial.getLogradouroCep().getLogradouro() == null ? "" : imovelParametrosInicial
						.getLogradouroCep().getLogradouro().getId() == null ? "" : ""
						+ imovelParametrosInicial.getLogradouroCep().getLogradouro().getId());

		parametros.put("nomeLogradouro", imovelParametrosInicial.getLogradouroCep().getLogradouro() == null ? "" : imovelParametrosInicial
						.getLogradouroCep().getLogradouro().getNome());

		parametros.put("idCliente", clienteImovelParametros.getCliente() == null ? ""
						: clienteImovelParametros.getCliente().getId() == null ? "" : "" + clienteImovelParametros.getCliente().getId());

		parametros.put("nomeCliente", clienteImovelParametros.getCliente() == null ? "" : clienteImovelParametros.getCliente().getNome());
		...
		parametros.put("indicadorMedicao", indicadorMedicao == null ? "" : indicadorMedicao.equals("comMedicao") ? "COM MEDIÇÃO"
						: "SEM MEDIÇÃO");
		...
		parametros.put("qtdeEconomiaInicial", imovelParametrosInicial.getQuantidadeEconomias().equals(new Short("0")) ? null : ""
						+ imovelParametrosInicial.getQuantidadeEconomias());
		parametros.put("qtdeEconomiaFinal", imovelParametrosFinal.getQuantidadeEconomias().equals(new Short("0")) ? null : ""
		...
		parametros.put("areaConstruidaInicial", imovelParametrosInicial.getAreaConstruida().equals(new BigDecimal("0")) ? null : ""
						+ imovelParametrosInicial.getAreaConstruida());
		parametros.put("areaConstruidaFinal", imovelParametrosFinal.getAreaConstruida().equals(new BigDecimal("0")) ? null : ""
		...
		parametros.put("ocorrenciaCadastro", imovelParametrosInicial.getCadastroOcorrencia() == null ? "" : imovelParametrosInicial
						.getCadastroOcorrencia().getDescricao());
		parametros.put("tarifaConsumo", imovelParametrosInicial.getConsumoTarifa() == null ? "" : imovelParametrosInicial
						.getConsumoTarifa().getDescricao());

		RelatorioDataSource ds = new RelatorioDataSource((List) relatorioBeans);

		// exporta o relatório em pdf e retorna o array de bytes
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_IMOVEL_OUTROS_CRITERIOS_MANTER, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MANTER_IMOVEL_OUTROS_CRITERIOS, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		Integer quantidade = fachada.obterQuantidadadeRelacaoImoveisDebitos(imovelCondominioID, imovelPrincipalID, situacaoAgua,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioManterImovelOutrosCriterios", this);
	}
