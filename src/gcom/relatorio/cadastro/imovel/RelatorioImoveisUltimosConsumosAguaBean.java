 ...
 * @date 18/12/2007
 */
public class RelatorioImoveisUltimosConsumosAguaBean
	...
	public RelatorioImoveisUltimosConsumosAguaBean(RelatorioImoveisUltimosConsumosAguaHelper helper) {
		...
		this.rota = Util.adicionarZerosEsquedaNumero(3, helper.getRota() != null ? helper.getRota().toString() : "0")
						+ "."
						+ Util.adicionarZerosEsquedaNumero(3, helper.getSequencialRota() != null ? helper.getSequencialRota().toString()
										: "0");
