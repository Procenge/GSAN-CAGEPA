 ...
 * @created 03/12/2007
 */
public class RelatorioImoveisSituacaoLigacaoAguaBean
	...
	public RelatorioImoveisSituacaoLigacaoAguaBean(RelatorioImoveisSituacaoLigacaoAguaHelper helper) {
		 ...
		 * adicionado verificação de verificar se Rota e Sequencial não estão nulos.
		 */
		String idRotaStr = "0";
		...
		String sequencialRotaStr = "0";
		Integer sequencialRota = helper.getSequencialRota();

		if(sequencialRota != null){
			sequencialRotaStr = Integer.toString(sequencialRota);
		}

		this.rota = Util.adicionarZerosEsquedaNumero(3, idRotaStr) + "." + Util.adicionarZerosEsquedaNumero(3, sequencialRotaStr);
