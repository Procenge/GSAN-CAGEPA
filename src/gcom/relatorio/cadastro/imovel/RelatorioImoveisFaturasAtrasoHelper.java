 ...
 * @date 30/11/2007
 */
public class RelatorioImoveisFaturasAtrasoHelper
	...
	public void setQuantidadeFaturasAtraso(Long quantidadeFaturasAtraso){

		this.quantidadeFaturasAtraso = quantidadeFaturasAtraso;
	}

	public void setValorFaturasAtraso(BigDecimal valorFaturasAtraso){

		this.valorFaturasAtraso = valorFaturasAtraso;
	}

	public Long getQuantidadeFaturasAtraso(){

		return quantidadeFaturasAtraso;
	}

	public BigDecimal getValorFaturasAtraso(){
