...
public class RelatorioDadosTarifaSocial
	...
	public Object executar() throws TarefaException{
		...
		parametros.put("indicadorMedicao", indicadorMedicao == null ? "" : indicadorMedicao.equals(new Short("0")) ? "SEM MEDIÇÃO"
						: "COM MEDIÇÃO");
		...
		if(!Util.isVazioOuBranco(indicadorSituacaoImovelTarifaSocial)){
			if(indicadorSituacaoImovelTarifaSocial == 1){
				...
				parIndicadoSituacaoImovelTarifaSocial = "Excluído";
			}else{
				parIndicadoSituacaoImovelTarifaSocial = "Ativo ou Excluído";
			}
		}
