 ...
 * @date 30/11/2007
 */
public class FiltrarRelatorioImoveisFaturasAtrasoHelper
	...
	private BigDecimal valorFaturasAtrasoInicial;

	private BigDecimal valorFaturasAtrasoFinal;
	...
	public void setQuantidadeFaturasAtrasoInicial(Integer quantidadeFaturasAtrasoInicial){
	...
	public void setReferenciaFaturasAtrasoInicial(Integer referenciaFaturasAtrasoInicial){

		this.referenciaFaturasAtrasoInicial = referenciaFaturasAtrasoInicial;
	}

	public BigDecimal getValorFaturasAtrasoFinal(){

		return valorFaturasAtrasoFinal;
	}

	public void setValorFaturasAtrasoFinal(BigDecimal valorFaturasAtrasoFinal){

		this.valorFaturasAtrasoFinal = valorFaturasAtrasoFinal;
	}

	public BigDecimal getValorFaturasAtrasoInicial(){

		return valorFaturasAtrasoInicial;
	}

	public void setValorFaturasAtrasoInicial(BigDecimal valorFaturasAtrasoInicial){
