 ...
 * @created 17/12/2007
 */
public class RelatorioImoveisConsumoMedio
	...
	public Object executar() throws TarefaException{
		...
		Collection<RelatorioImoveisConsumoMedioHelper> colecao = fachada.pesquisarRelatorioImoveisConsumoMedio(filtro);
		...
		if(colecao != null && !colecao.isEmpty()){
			...
			while(colecaoIterator.hasNext()){
				...
				RelatorioImoveisConsumoMedioHelper helper = (RelatorioImoveisConsumoMedioHelper) colecaoIterator.next();

				relatorioImoveisConsumoMedioBean = new RelatorioImoveisConsumoMedioBean(helper);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_IMOVEIS_CONSUMO_MEDIO, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.IMOVEIS_CONSUMO_MEDIO, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		retorno = Fachada.getInstancia().pesquisarTotalRegistroRelatorioImoveisConsumoMedio(
