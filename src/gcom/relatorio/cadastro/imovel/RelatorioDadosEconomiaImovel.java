...
public class RelatorioDadosEconomiaImovel
	...
	public Object executar() throws TarefaException{
		...
		Collection imoveisRelatoriosHelper = fachada.gerarRelatorioDadosEconomiaImovel(imovelCondominioID, imovelPrincipalID, situacaoAgua,
		...
		if(imoveisRelatoriosHelper != null && !imoveisRelatoriosHelper.isEmpty()){
			...
			while(imovelRelatorioIterator.hasNext()){
				...
				Iterator subcategoriaIterator = imovelRelatorioHelper.getSubcategorias().iterator();

				while(subcategoriaIterator.hasNext()){

					ImovelSubcategoriaHelper imovelSubcategoriaHelper = (ImovelSubcategoriaHelper) subcategoriaIterator.next();

					if(imovelSubcategoriaHelper.getColecaoImovelEconomia() == null
									|| imovelSubcategoriaHelper.getColecaoImovelEconomia().isEmpty()){
						...
						// Código da Gerência Regional
										...
										"" + imovelSubcategoriaHelper.getQuantidadeEconomias(),
						...
						Iterator imovelEconomiaIterator = imovelSubcategoriaHelper.getColecaoImovelEconomia().iterator();

						while(imovelEconomiaIterator.hasNext()){

							ImovelEconomiaHelper imovelEconomiaHelper = (ImovelEconomiaHelper) imovelEconomiaIterator.next();

							if(imovelEconomiaHelper.getClienteImovelEconomiaHelper() == null){
								...
								// Código da Gerência Regional
												...
												// Complemento Endereço
												imovelEconomiaHelper.getComplementoEndereco() == null ? "" : imovelEconomiaHelper
																.getComplementoEndereco(),

												// Pontos de Utilização
												imovelEconomiaHelper.getNumeroPontosUtilizacao() == 0 ? "" : ""
																+ imovelEconomiaHelper.getNumeroPontosUtilizacao(),

												// Número de Moradores
												imovelEconomiaHelper.getNumeroMoradores() == 0 ? "" : ""
																+ imovelEconomiaHelper.getNumeroMoradores(),

												// Número IPTU
												imovelEconomiaHelper.getNumeroIptu() == null ? "" : imovelEconomiaHelper.getNumeroIptu()
																.toString(),

												// Número Contrato Celpe
												imovelEconomiaHelper.getNumeroContratoCelpe() == null ? "" : imovelEconomiaHelper
																.getNumeroContratoCelpe().toString(),

												// Área Construída
												imovelEconomiaHelper.getAreaConstruidaImovelEconomia() == null ? "" : Util
																.formatarMoedaReal(imovelEconomiaHelper.getAreaConstruidaImovelEconomia()),
								...
								Iterator clienteImovelEconomiaIterator = imovelEconomiaHelper.getClienteImovelEconomiaHelper().iterator();
								...
								while(clienteImovelEconomiaIterator.hasNext()){
									...
									// Código da Gerência Regional
													...
													imovelRelatorioHelper.getDescricaoGerenciaRegional() == null ? ""
																	: imovelRelatorioHelper.getDescricaoGerenciaRegional(),
													...
													// Pontos de Utilização
													imovelEconomiaHelper.getNumeroPontosUtilizacao() != null ? imovelEconomiaHelper
																	.getNumeroPontosUtilizacao() == 0 ? "" : ""
																	+ imovelEconomiaHelper.getNumeroPontosUtilizacao() : "",

													// Número de Moradores
													imovelEconomiaHelper.getNumeroMoradores() != null ? imovelEconomiaHelper
																	.getNumeroMoradores() == 0 ? "" : ""
																	+ imovelEconomiaHelper.getNumeroMoradores() : "",

													// Número IPTU
													imovelEconomiaHelper.getNumeroIptu() == null ? "" : imovelEconomiaHelper
													...
													// Nome Cliente
													clienteImovelEconomiaHelper.getClienteNome(),

													// Tipo Relação
													clienteImovelEconomiaHelper.getRelacaoTipo(),

													// CPF / CNPJ
													clienteImovelEconomiaHelper.getCpf() == null ? clienteImovelEconomiaHelper.getCnpj() == null ? ""
																	: clienteImovelEconomiaHelper.getCnpj()
																	: clienteImovelEconomiaHelper.getCpf(),

													// Data Início Relação
													clienteImovelEconomiaHelper.getRelacaoDataInicio(),

													// Data Fim Relação
													clienteImovelEconomiaHelper.getRelacaoDataFim(),

													// Motivo Fim Relação
													clienteImovelEconomiaHelper.getMotivoFimRelacao()
		...
		Collections.sort((List) relatorioBeans, new Comparator() {
			...
			public int compare(Object a, Object b){
				...
				String chaveRegistro1 = ((RelatorioDadosEconomiaImovelBean) a).getNomeClienteUsuario() == null ? ((RelatorioDadosEconomiaImovelBean) a)
								.getMatricula()
								+ ((RelatorioDadosEconomiaImovelBean) a).getSubcategoria() + " "
								: ((RelatorioDadosEconomiaImovelBean) a).getIdSetorComercial()
												+ ((RelatorioDadosEconomiaImovelBean) a).getIdLocalidade()
												+ ((RelatorioDadosEconomiaImovelBean) a).getIdGerenciaRegional()
												+ ((RelatorioDadosEconomiaImovelBean) a).getMatricula()
												+ ((RelatorioDadosEconomiaImovelBean) a).getSubcategoria()
												+ ((RelatorioDadosEconomiaImovelBean) a).getNomeClienteUsuario()
												+ ((RelatorioDadosEconomiaImovelBean) a).getNomeCliente()
												+ ((RelatorioDadosEconomiaImovelBean) a).getTipoRelacao();
				String chaveRegistro2 = ((RelatorioDadosEconomiaImovelBean) b).getNomeClienteUsuario() == null ? ((RelatorioDadosEconomiaImovelBean) b)
								.getMatricula()
								+ ((RelatorioDadosEconomiaImovelBean) b).getSubcategoria() + " "
								: ((RelatorioDadosEconomiaImovelBean) b).getIdSetorComercial()
												+ ((RelatorioDadosEconomiaImovelBean) b).getIdLocalidade()
												+ ((RelatorioDadosEconomiaImovelBean) b).getIdGerenciaRegional()
												+ ((RelatorioDadosEconomiaImovelBean) b).getMatricula()
												+ ((RelatorioDadosEconomiaImovelBean) b).getSubcategoria()
												+ ((RelatorioDadosEconomiaImovelBean) b).getNomeClienteUsuario()
												+ ((RelatorioDadosEconomiaImovelBean) b).getNomeCliente()
												+ ((RelatorioDadosEconomiaImovelBean) b).getTipoRelacao();
		...
		parametros.put("idSetorComercialOrigem", imovelParametrosInicial.getSetorComercial().getCodigo() == 0 ? "" : ""
						+ imovelParametrosInicial.getSetorComercial().getCodigo());
		parametros.put("idSetorComercialDestino", imovelParametrosFinal.getSetorComercial().getCodigo() == 0 ? "" : ""
		...
		parametros.put("tipoRelacao", clienteImovelParametros.getClienteRelacaoTipo() == null ? "" : clienteImovelParametros
						.getClienteRelacaoTipo().getDescricao());

		parametros.put("tipoCliente", clienteImovelParametros.getCliente().getClienteTipo() == null ? "" : clienteImovelParametros
		...
		// .getNomeConta());
		parametros.put("situacaoLigacaoAgua", imovelParametrosInicial.getLigacaoAguaSituacao() == null ? "" : imovelParametrosInicial
						.getLigacaoAguaSituacao().getDescricao());
		parametros.put("situacaoLigacaoEsgoto", imovelParametrosInicial.getLigacaoEsgotoSituacao() == null ? "" : imovelParametrosInicial
		...
		parametros.put("tipoPoco", imovelParametrosInicial.getPocoTipo() != null ? imovelParametrosInicial.getPocoTipo().getDescricao()
						: "");
		parametros.put("tipoSituacaoEspecialFaturamento",
						imovelParametrosInicial.getFaturamentoSituacaoTipo() != null ? imovelParametrosInicial.getFaturamentoSituacaoTipo()
										.getDescricao() : "");
		parametros.put("tipoSituacaoEspecialCobranca", imovelParametrosInicial.getCobrancaSituacaoTipo() != null ? imovelParametrosInicial
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_DADOS_ECONOMIA_IMOVEL, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.DADOS_ECONOMIA_IMOVEL, idFuncionalidadeIniciada, null);
