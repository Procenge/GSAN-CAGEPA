 ...
 * @created 03/12/2007
 */
public class RelatorioImoveisFaturasAtrasoBean
	...
	public RelatorioImoveisFaturasAtrasoBean(RelatorioImoveisFaturasAtrasoHelper helper) {
		...
		if(helper.getRota() != null){
			rota = helper.getRota().toString();
		}
		if(helper.getSequencialRota() != null){
			sequenciaRota = helper.getSequencialRota().toString();
		}

		this.rota = Util.adicionarZerosEsquedaNumero(3, rota) + "." + Util.adicionarZerosEsquedaNumero(3, sequenciaRota);
		...
		this.quantidadeFaturasAtraso = Util.agruparNumeroEmMilhares(helper.getQuantidadeFaturasAtraso().intValue());

		this.referenciaFaturasAtrasoInicial = Util.formatarMesAnoReferencia(helper.getReferenciaFaturasAtrasoInicial());

		this.referenciaFaturasAtrasoFinal = Util.formatarMesAnoReferencia(helper.getReferenciaFaturasAtrasoFinal());

		this.valorFaturasAtraso = Util.formatarMoedaReal(helper.getValorFaturasAtraso());
	}
