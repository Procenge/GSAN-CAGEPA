 ...
 */
public class RelatorioManterBairro
	...
	public Object executar() throws TarefaException{
		...
		if(bairros != null && !bairros.isEmpty()){
			...
			while(bairroIterator.hasNext()){
				...
				relatorioBean = new RelatorioManterBairroBean("" + bairro.getCodigo(), bairro.getNome(), bairro.getMunicipio().getNome(),
								bairro.getCodigoBairroPrefeitura(), "" + bairro.getIndicadorUso());
		...
		parametros.put("nomeMunicipio", bairroParametros.getMunicipio().getNome() == null ? "" : bairroParametros.getMunicipio().getNome());

		parametros.put("codigoBairro", bairroParametros.getCodigo() == 0 ? "" : "" + bairroParametros.getCodigo());

		parametros.put("nomeBairro", bairroParametros.getNome());

		String indicadorUso = "";

		if(bairroParametros.getIndicadorUso() != null && !bairroParametros.getIndicadorUso().equals("")){
			if(bairroParametros.getIndicadorUso().equals(new Short("1"))){
				indicadorUso = "Ativo";
			}else if(bairroParametros.getIndicadorUso().equals(new Short("2"))){
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_BAIRRO_MANTER, parametros, ds, tipoFormatoRelatorio);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		retorno = Fachada.getInstancia().totalRegistrosPesquisa((FiltroBairro) getParametro("filtroBairro"), Bairro.class.getName());
