 ...
 */
public class RelatorioManterSubcategoria
	...
	public Object executar() throws TarefaException{
		...
		filtroSubCategoria.setCampoOrderBy(FiltroSubCategoria.CATEGORIA_ID, FiltroSubCategoria.CODIGO);
		...
		if(subcategoriaParametros.getCategoria() != null){
			parametros.put("categoria", subcategoriaParametros.getCategoria().getDescricao());
		}else{
		...
		if(subcategoriaParametros.getIndicadorUso() != null && !subcategoriaParametros.getIndicadorUso().equals("")){
			if(subcategoriaParametros.getIndicadorUso().equals(new Short("1"))){
				indicadorUso = "Ativo";
			}else if(subcategoriaParametros.getIndicadorUso().equals(new Short("2"))){
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_SUBCATEGORIA_MANTER, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MANTER_SUBCATEGORIA, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		retorno = Fachada.getInstancia().totalRegistrosPesquisa((FiltroSubCategoria) getParametro("filtroSubcategoria"),
