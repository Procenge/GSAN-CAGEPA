...
public class RelatorioManterTarifaSocial
	...
	public Object executar() throws TarefaException{
		...
		if(tarifasSociais != null && !tarifasSociais.isEmpty()){
			...
			while(tarifaSocialIterator.hasNext()){
				...
				TarifaSocialCartaoTipo tarifaSocial = (TarifaSocialCartaoTipo) tarifaSocialIterator.next();

				String indicadorValidade = "";

				if(tarifaSocial.getIndicadorValidade() != null
								&& tarifaSocial.getIndicadorValidade().equals(TarifaSocialCartaoTipo.INDICADOR_EXISTENCIA_VALIDADE_SIM)){
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_TARIFA_SOCIAL_MANTER, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MANTER_TARIFA_SOCIAL, idFuncionalidadeIniciada, null);
