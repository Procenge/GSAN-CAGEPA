...
public class RelatorioManterLocalidade
	...
	public Object executar() throws TarefaException{
		...
		if(localidades != null && !localidades.isEmpty()){
			...
			Collections.sort((List) localidades, new Comparator() {
				...
				public int compare(Object a, Object b){
					...
					String descricao1 = ((Localidade) a).getDescricao();
					String descricao2 = ((Localidade) b).getDescricao();
			...
			while(localidadeIterator.hasNext()){
				...
				String nomeAbreviadoUnidadeNegocio = "";

				UnidadeNegocio unidadeNegocio = localidade.getUnidadeNegocio();
				if(unidadeNegocio != null){
					nomeAbreviadoUnidadeNegocio = unidadeNegocio.getNomeAbreviado();
				}
		...
		parametros.put("idLocalidade", localidadeParametros.getId() == null ? "" : "" + localidadeParametros.getId());

		parametros.put("gerenciaRegional", localidadeParametros.getGerenciaRegional() == null ? "" : localidadeParametros
		...
		if(ConstantesSistema.INDICADOR_USO_ATIVO.equals(localidadeParametros.getIndicadorUso())){
			indicadorUso = "Ativo";
		}else if(ConstantesSistema.INDICADOR_USO_DESATIVO.equals(localidadeParametros.getIndicadorUso())){
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_LOCALIDADE_MANTER, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MANTER_LOCALIDADE, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		retorno = Fachada.getInstancia().totalRegistrosPesquisa((FiltroLocalidade) getParametro("filtroLocalidade"),
