 ...
 * @date 23/03/2012
 */
public class RelatorioArquivoAgenciaVirtualLogradouro
				extends TarefaRelatorio {

	public RelatorioArquivoAgenciaVirtualLogradouro(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_LOGRADOUROS);
	}

	public RelatorioArquivoAgenciaVirtualLogradouro() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_LOGRADOUROS, idFuncionalidadeIniciada,
							nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioAgenciaVirtualLogradouros", this);
	}
}
