...
package gcom.relatorio.agenciavirtual;
 ...
 * @date 23/03/2012
 */
public class RelatorioArquivoAgenciaVirtualQuitacaoDebitos
				extends TarefaRelatorio {

	public RelatorioArquivoAgenciaVirtualQuitacaoDebitos(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_QUITACAO_DEBITOS);
	}

	public RelatorioArquivoAgenciaVirtualQuitacaoDebitos() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_QUITACAO_DEBITOS,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioAgenciaVirtualQuitacaoDebitos", this);
	}
}
