 ...
 * @date 23/03/2012
 */
public class RelatorioArquivoAgenciaVirtualImoveis
				extends TarefaRelatorio {

	public RelatorioArquivoAgenciaVirtualImoveis(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_IMOVEIS);
	}

	public RelatorioArquivoAgenciaVirtualImoveis() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_IMOVEIS, idFuncionalidadeIniciada,
							nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioAgenciaVirtualImoveis", this);
	}
}
