 ...
 * @date 23/03/2012
 */
public class RelatorioArquivoAgenciaVirtualDebitos
				extends TarefaRelatorio {

	public RelatorioArquivoAgenciaVirtualDebitos(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_DEBITOS);
	}

	public RelatorioArquivoAgenciaVirtualDebitos() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_ARQUIVO_AGENCIA_VIRTUAL_DEBITOS, idFuncionalidadeIniciada,
							nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioAgenciaVirtualDebitos", this);
	}
}
