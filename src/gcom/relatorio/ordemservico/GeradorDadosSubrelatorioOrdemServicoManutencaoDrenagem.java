...
public class GeradorDadosSubrelatorioOrdemServicoManutencaoDrenagem
				extends GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios {

	private static String TITULO_TIPO_SERVICO = "Manutenção de Drenagem";

	public GeradorDadosSubrelatorioOrdemServicoManutencaoDrenagem() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_MANUTENCAO_DRENAGEM);
