...
public class GeradorDadosSubrelatorioOrdemServicoHidrometria
				extends GeradorDadosRelatorioOrdemServico {

	private static String TITULO_TIPO_SERVICO = "Hidrometria";

	public GeradorDadosSubrelatorioOrdemServicoHidrometria() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_HIDROMETRIA);
