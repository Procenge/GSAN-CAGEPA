...
public class GeradorDadosSubrelatorioOrdemServicoReparosAsfalto
				extends GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios {

	private static String TITULO_TIPO_SERVICO = "Reparos - Asfalto";

	public GeradorDadosSubrelatorioOrdemServicoReparosAsfalto() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_REPAROS_ASFALTO);
	...
	public void validarTipoAssinaturaRodape(DadosRelatorioOrdemServico dadosRelatorio) throws GeradorRelatorioOrdemServicoException{
		...
		dadosRelatorio.setTipoAssinaturaRodape(GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios.TIPO_ASSINATURA_ENCARREGADO_MONITOR_CARROPLACA);
	}
