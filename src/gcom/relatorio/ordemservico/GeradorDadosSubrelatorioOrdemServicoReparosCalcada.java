...
public class GeradorDadosSubrelatorioOrdemServicoReparosCalcada
				extends GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios {

	private static String TITULO_TIPO_SERVICO = "Reparos - Calçada";

	public GeradorDadosSubrelatorioOrdemServicoReparosCalcada() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_REPAROS_CALCADA);
