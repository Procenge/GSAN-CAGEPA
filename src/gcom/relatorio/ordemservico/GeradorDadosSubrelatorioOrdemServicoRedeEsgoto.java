...
public class GeradorDadosSubrelatorioOrdemServicoRedeEsgoto
				extends GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios {

	private static String TITULO_TIPO_SERVICO = "Rede de Esgoto";

	public GeradorDadosSubrelatorioOrdemServicoRedeEsgoto() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_REDE_ESGOTO);
