 ...
 * @author isilva
 */
public abstract class GeradorDadosRelatorioOrdemServicoEstrutura
	 ...
	 * Construtor padrão
	 */
	public GeradorDadosRelatorioOrdemServicoEstrutura() {
	...
	public List<DadosRelatorioOrdemServico> gerarDados(OrdemServico os) throws GeradorRelatorioOrdemServicoException{
		...
		dadosRelatorio.setExibirCodigoBarras("true");
	...
	/**
	 * Verificar se o relatório estrutura exibirá o rodapé e o código de barras.
	 * 
