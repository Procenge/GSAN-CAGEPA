...
public class GeradorDadosSubrelatorioOrdemServicoLigacaoEsgoto
				extends GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios {

	private static String TITULO_TIPO_SERVICO = "Ligação de Esgoto";

	public GeradorDadosSubrelatorioOrdemServicoLigacaoEsgoto() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_LIGACAO_ESGOTO);
