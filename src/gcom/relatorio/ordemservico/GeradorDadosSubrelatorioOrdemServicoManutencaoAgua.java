...
public class GeradorDadosSubrelatorioOrdemServicoManutencaoAgua
				extends GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios {

	private static String TITULO_TIPO_SERVICO = "Manutenção de Água";

	public GeradorDadosSubrelatorioOrdemServicoManutencaoAgua() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_MANUTENCAO_AGUA);
