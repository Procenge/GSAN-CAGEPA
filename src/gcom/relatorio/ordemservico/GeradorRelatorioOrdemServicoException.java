 ...
 * @author gmatos
 */
public class GeradorRelatorioOrdemServicoException
				extends Exception {
	 ...
	 */
	public GeradorRelatorioOrdemServicoException(String mensagem, Exception excecaoCausa) {
	 ...
	 */
	public GeradorRelatorioOrdemServicoException(String mensagem) {
	 ...
	 *            Descrição do parâmetro
	 */
	public GeradorRelatorioOrdemServicoException(String mensagem, Exception excecaoCausa, String... parametroMensagem) {
