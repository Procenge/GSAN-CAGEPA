...
public class GeradorDadosSubrelatorioOrdemServicoManutencaoEsgoto
				extends GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios {

	private static String TITULO_TIPO_SERVICO = "Manutenção de Esgoto";

	public GeradorDadosSubrelatorioOrdemServicoManutencaoEsgoto() {

		super();
		addParametro(ConstantesSistema.NOME_SUBRELATORIO_ORDEM_SERVICO, ConstantesRelatorios.SUBRELATORIO_ORDEM_SERVICO_MANUTENCAO_ESGOTO);
	...
	public void validarTipoAssinaturaRodape(DadosRelatorioOrdemServico dadosRelatorio) throws GeradorRelatorioOrdemServicoException{
		...
		dadosRelatorio.setTipoAssinaturaRodape(GeradorDadosRelatorioOrdemServicoBaseComSubrelatorios.TIPO_ASSINATURA_ENCARREGADO_MONITOR_CARRO);
	}
}
