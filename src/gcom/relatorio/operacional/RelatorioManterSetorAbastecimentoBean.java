 ...
 * @date 09/02/2011
 */
public class RelatorioManterSetorAbastecimentoBean
	...
	public RelatorioManterSetorAbastecimentoBean(String codigo, String descricao, String descricaoAbreviada, String unidade,
													String localidade, String zonaAbastecimento) {

		super();
		this.codigo = codigo;
		this.descricao = descricao;
		this.descricaoAbreviada = descricaoAbreviada;
		this.unidadeOperacional = unidade;
