 ...
 * @created 19/11/2007
 */
public class RelatorioRelacaoSinteticaFaturas
	...
	private List<RelatorioRelacaoSinteticaFaturasBean> montarRelatorioSintetico(Collection colecaoFaturasHelper){
		...
		while(iterator.hasNext()){
			...
			RelatorioRelacaoSinteticaFaturasBean relatorio = new RelatorioRelacaoSinteticaFaturasBean(codigoCliente, nomeCliente,
							valorTotalFatura);
	...
	public Object executar() throws TarefaException{
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_RELACAO_SINTETICA_FATURAS, parametros, ds, tipoFormatoRelatorio);
