 ...
 */
public class RelatorioVolumesFaturadosResumido
	...
	public RelatorioVolumesFaturadosResumido(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_VOLUMES_FATURADOS_RESUMIDO);
	}
	...
	public Object executar() throws TarefaException{
		...
		Collection colecaoVolumesFaturadosRelatorioHelper = fachada.pesquisarDadosRelatorioVolumesFaturadosResumido(idLocalidade, anoMes,
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_VOLUMES_FATURADOS_RESUMIDO, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.VOLUMES_FATURADOS_RESUMIDO, idFuncionalidadeIniciada, null);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioVolumesFaturadosResumido", this);
	}
}