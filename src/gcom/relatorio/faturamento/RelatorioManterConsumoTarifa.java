 ...
 * @created 11/05/2007
 */
public class RelatorioManterConsumoTarifa
	...
	public Object executar() throws TarefaException{
		...
		if(colecaoConsumoTarifaRelatorioHelper != null && !colecaoConsumoTarifaRelatorioHelper.isEmpty()){
			...
			while(colecaoConsumoTarifaRelatorioHelperIterator.hasNext()){
				...
				consumoTarifaRelatorioHelper = (ConsumoTarifaRelatorioHelper) colecaoConsumoTarifaRelatorioHelperIterator.next();

				// Validade
				String validade = "";

				if(consumoTarifaRelatorioHelper.getDataValidadeInicial() != null
								&& ((!consumoTarifaRelatorioHelper.getDataValidadeInicial().equals(dataVigenciaInicialAnterior)) || (!idConsumoTarifaAnterior
												.equals(consumoTarifaRelatorioHelper.getIdConsumoTarifa().toString())))){
					...
					Date dataValidadeFinal = fachada.pesquisarDataFinalValidadeConsumoTarifa(consumoTarifaRelatorioHelper
									.getIdConsumoTarifa(), consumoTarifaRelatorioHelper.getDataValidadeInicial());
				...
				if(consumoTarifaRelatorioHelper.getCategoria() != null
								&& !categoriaAnterior.equals(consumoTarifaRelatorioHelper.getCategoria())){
				...
				// Consumo Mínimo
				// Inclui mais um bean com o valor do consumo minimo, a data de validade e a
				// categoria
