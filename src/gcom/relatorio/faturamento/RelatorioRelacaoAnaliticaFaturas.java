 ...
 * @created 27/08/2007
 */
public class RelatorioRelacaoAnaliticaFaturas
	...
	private List<RelatorioRelacaoAnaliticaFaturasBean> montarRelatorioAnalitico(Collection colecaoFaturasHelper){
		...
		while(iterator.hasNext()){
			...
			while(iteraItens.hasNext()){
				...
				RelatorioRelacaoAnaliticaFaturasBean relatorio = new RelatorioRelacaoAnaliticaFaturasBean(codigoCliente, nomeCliente,
								matricula, inscricao, categoria, qtdEconomias, leituraAnterior, leituraAtual, media, consumoFaturado,
								dataLeitura, dataVencimento, consumoAgua, rateioAgua, valorAgua, consumoEsgoto, rateioEsgoto, valorEsgoto,
								debitoCobrado, creditoRealizado, totalConta, valorTotalFatura, endereco);
	...
	public Object executar() throws TarefaException{
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_RELACAO_ANALITICA_FATURAS, parametros, ds, tipoFormatoRelatorio);
