 ...
 * @date 20/01/2009
 *       Alteração no relatório para buscar os 6 últimos meses de volume.
 */
public class RelatorioVolumesFaturados
	...
	public RelatorioVolumesFaturados(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_VOLUMES_FATURADOS);
	}
	...
	public Object executar() throws TarefaException{
		...
		// AnoMes de Referencia e 5 meses posteriores a data solicitada

		Integer anoMesInformado = anoMes;
		Integer anoMes1 = Util.subtrairMesDoAnoMes(anoMes, 1);
		Integer anoMes2 = Util.subtrairMesDoAnoMes(anoMes, 2);
		Integer anoMes3 = Util.subtrairMesDoAnoMes(anoMes, 3);
		Integer anoMes4 = Util.subtrairMesDoAnoMes(anoMes, 4);
		Integer anoMes5 = Util.subtrairMesDoAnoMes(anoMes, 5);

		Collection colecaoVolumesFaturadosRelatorioHelper = fachada.pesquisarDadosRelatorioVolumesFaturados(idLocalidade, anoMes,
						anoMesInformado, anoMes1, anoMes2, anoMes3, anoMes4, anoMes5);

		// se a coleção de parâmetros da analise não for vazia
		if(colecaoVolumesFaturadosRelatorioHelper != null && !colecaoVolumesFaturadosRelatorioHelper.isEmpty()){

			// coloca a coleção de parâmetros da analise no iterator
			Iterator colecaoVolumesFaturadosRelatorioHelperIterator = colecaoVolumesFaturadosRelatorioHelper.iterator();
			...
			Integer mesAnoInformadoTotalQuadra = new Integer("0");
			...
			Integer mesAnoInformadoTotalSetorComercial = new Integer("0");
			...
			Integer mesAnoInformadoTotalLocalidade = new Integer("0");
			...
			String variacaoInformadoTotalQuadra = "";
			String variacaoInformadoTotalSetorComercial = "";
			String variacaoInformadoTotalLocalidade = "";
			...
			boolean peloMenosUmDadoMesAnoInformadoQuadra = false;
			...
			boolean peloMenosUmDadoMesAnoInformadoSetorComercial = false;
			...
			boolean peloMenosUmDadoMesAnoInformadoLocalidade = false;
			...
			while(colecaoVolumesFaturadosRelatorioHelperIterator.hasNext()){
				...
				if(idQuadraAnterior == null){
					idQuadraAnterior = volumesFaturadosRelatorioHelper.getIdQuadra();
				}

				if(idSetorComercialAnterior == null){
					idSetorComercialAnterior = volumesFaturadosRelatorioHelper.getIdSetorComercial();
				}

				if(idLocalidadeAnterior == null){
					idLocalidadeAnterior = volumesFaturadosRelatorioHelper.getIdLocalidade();
				}
				...
				if(volumesFaturadosRelatorioHelper.getIdLocalidade() != null){
					localidade = volumesFaturadosRelatorioHelper.getIdLocalidade() + " - "
									+ volumesFaturadosRelatorioHelper.getNomeLocalidade();
					...
					if(!idLocalidadeAnterior.equals(volumesFaturadosRelatorioHelper.getIdLocalidade())){
				...
				if(volumesFaturadosRelatorioHelper.getIdSetorComercial() != null){
					idSetorComercial = volumesFaturadosRelatorioHelper.getIdSetorComercial().toString();
					setorComercial = volumesFaturadosRelatorioHelper.getCodigoSetorComercial() + " - "
									+ volumesFaturadosRelatorioHelper.getNomeSetorComercial();
					...
					if(!idSetorComercialAnterior.equals(volumesFaturadosRelatorioHelper.getIdSetorComercial())){
				...
				if(volumesFaturadosRelatorioHelper.getNumeroQuadra() != null){
					idQuadra = volumesFaturadosRelatorioHelper.getIdQuadra().toString();
					numeroQuadra = volumesFaturadosRelatorioHelper.getNumeroQuadra().toString();
					...
					if(!idQuadraAnterior.equals(volumesFaturadosRelatorioHelper.getIdQuadra())){
						zerarQuadra = true;
					}
				}
				...
				if(zerarQuadra){
					...
					mesAnoInformadoTotalQuadra = new Integer("0");
					...
					peloMenosUmDadoMesAnoInformadoQuadra = false;
				...
				if(zerarSetorComercial){
					...
					mesAnoInformadoTotalSetorComercial = new Integer("0");
					...
					variacaoInformadoTotalSetorComercial = "";
					...
					peloMenosUmDadoMesAnoInformadoSetorComercial = false;
				...
				if(zerarLocalidade){
					...
					mesAnoInformadoTotalLocalidade = new Integer("0");
					...
					variacaoInformadoTotalLocalidade = "";
					...
					peloMenosUmDadoMesAnoInformadoLocalidade = false;
				...
				if(volumesFaturadosRelatorioHelper.getIdImovel() != null){
					idImovel = volumesFaturadosRelatorioHelper.getIdImovel().toString();
				}
				...
				if(volumesFaturadosRelatorioHelper.getNomeUsuario() != null){
					nomeUsuario = volumesFaturadosRelatorioHelper.getNomeUsuario();
				}
				...
				if(volumesFaturadosRelatorioHelper.getIdSituacaoAgua() != null){
					situacaoAgua = volumesFaturadosRelatorioHelper.getIdSituacaoAgua().toString();
				}
				...
				if(volumesFaturadosRelatorioHelper.getIdSituacaoEsgoto() != null){
					situacaoEsgoto = volumesFaturadosRelatorioHelper.getIdSituacaoEsgoto().toString();
				}
				...
				if(volumesFaturadosRelatorioHelper.getMediaConsumo() != null){
					media = volumesFaturadosRelatorioHelper.getMediaConsumo().toString();
					mediaConsumo = volumesFaturadosRelatorioHelper.getMediaConsumo();
					mediaTotalQuadra = mediaTotalQuadra + mediaConsumo;
					mediaTotalSetorComercial = mediaTotalSetorComercial + mediaConsumo;
				...
				if(volumesFaturadosRelatorioHelper.getConsumoMesAno1() != null){
					consumoMesAno1 = volumesFaturadosRelatorioHelper.getConsumoMesAno1().toString();
					...
					mesAno1TotalQuadra = mesAno1TotalQuadra + volumesFaturadosRelatorioHelper.getConsumoMesAno1();
					mesAno1TotalSetorComercial = mesAno1TotalSetorComercial + volumesFaturadosRelatorioHelper.getConsumoMesAno1();
					mesAno1TotalLocalidade = mesAno1TotalLocalidade + volumesFaturadosRelatorioHelper.getConsumoMesAno1();

					// Calcula a variação
					if(mediaConsumo != null && !mediaConsumo.equals(new Integer("0"))){
						variacao1 = Util.formatarMoedaReal(new BigDecimal(volumesFaturadosRelatorioHelper.getConsumoMesAno1()).divide(
										new BigDecimal(mediaConsumo), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
				...
				if(mesAno1TotalQuadra != null){
					...
					if(mediaTotalQuadra != null && !mediaTotalQuadra.equals(new Integer("0"))){
						variacao1TotalQuadra = Util.formatarMoedaReal(new BigDecimal(mesAno1TotalQuadra).divide(
										new BigDecimal(mediaTotalQuadra), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno1TotalSetorComercial != null){
					...
					if(mediaTotalSetorComercial != null && !mediaTotalSetorComercial.equals(new Integer("0"))){
						variacao1TotalSetorComercial = Util.formatarMoedaReal(new BigDecimal(mesAno1TotalSetorComercial).divide(
										new BigDecimal(mediaTotalSetorComercial), 4, BigDecimal.ROUND_HALF_UP).subtract(
										new BigDecimal("1.00")).multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno1TotalLocalidade != null){
					...
					if(mediaTotalLocalidade != null && !mediaTotalLocalidade.equals(new Integer("0"))){
						variacao1TotalLocalidade = Util.formatarMoedaReal(new BigDecimal(mesAno1TotalLocalidade).divide(
										new BigDecimal(mediaTotalLocalidade), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(volumesFaturadosRelatorioHelper.getConsumoMesAno2() != null){
					consumoMesAno2 = volumesFaturadosRelatorioHelper.getConsumoMesAno2().toString();
					...
					// Soma os valores aos totalizadores de cada grupo
					mesAno2TotalQuadra = mesAno2TotalQuadra + volumesFaturadosRelatorioHelper.getConsumoMesAno2();
					mesAno2TotalSetorComercial = mesAno2TotalSetorComercial + volumesFaturadosRelatorioHelper.getConsumoMesAno2();
					mesAno2TotalLocalidade = mesAno2TotalLocalidade + volumesFaturadosRelatorioHelper.getConsumoMesAno2();

					// Calcula a variação
					if(mediaConsumo != null && !mediaConsumo.equals(new Integer("0"))){
						variacao2 = Util.formatarMoedaReal(new BigDecimal(volumesFaturadosRelatorioHelper.getConsumoMesAno2()).divide(
										new BigDecimal(mediaConsumo), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno2TotalQuadra != null){
					...
					if(mediaTotalQuadra != null && !mediaTotalQuadra.equals(new Integer("0"))){
						variacao2TotalQuadra = Util.formatarMoedaReal(new BigDecimal(mesAno2TotalQuadra).divide(
										new BigDecimal(mediaTotalQuadra), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno2TotalSetorComercial != null){
					...
					if(mediaTotalSetorComercial != null && !mediaTotalSetorComercial.equals(new Integer("0"))){
						variacao2TotalSetorComercial = Util.formatarMoedaReal(new BigDecimal(mesAno2TotalSetorComercial).divide(
										new BigDecimal(mediaTotalSetorComercial), 4, BigDecimal.ROUND_HALF_UP).subtract(
										new BigDecimal("1.00")).multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno2TotalLocalidade != null){
					...
					if(mediaTotalLocalidade != null && !mediaTotalLocalidade.equals(new Integer("0"))){
						variacao2TotalLocalidade = Util.formatarMoedaReal(new BigDecimal(mesAno2TotalLocalidade).divide(
										new BigDecimal(mediaTotalLocalidade), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(volumesFaturadosRelatorioHelper.getConsumoMesAno3() != null){
					consumoMesAno3 = volumesFaturadosRelatorioHelper.getConsumoMesAno3().toString();
					...
					// Soma os valores aos totalizadores de cada grupo
					mesAno3TotalQuadra = mesAno3TotalQuadra + volumesFaturadosRelatorioHelper.getConsumoMesAno3();
					mesAno3TotalSetorComercial = mesAno3TotalSetorComercial + volumesFaturadosRelatorioHelper.getConsumoMesAno3();
					mesAno3TotalLocalidade = mesAno3TotalLocalidade + volumesFaturadosRelatorioHelper.getConsumoMesAno3();

					// Calcula a variação
					if(mediaConsumo != null && !mediaConsumo.equals(new Integer("0"))){
						variacao3 = Util.formatarMoedaReal(new BigDecimal(volumesFaturadosRelatorioHelper.getConsumoMesAno3()).divide(
										new BigDecimal(mediaConsumo), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno3TotalQuadra != null){
					...
					if(mediaTotalQuadra != null && !mediaTotalQuadra.equals(new Integer("0"))){
						variacao3TotalQuadra = Util.formatarMoedaReal(new BigDecimal(mesAno3TotalQuadra).divide(
										new BigDecimal(mediaTotalQuadra), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno3TotalSetorComercial != null){
					...
					if(mediaTotalSetorComercial != null && !mediaTotalSetorComercial.equals(new Integer("0"))){
						variacao3TotalSetorComercial = Util.formatarMoedaReal(new BigDecimal(mesAno3TotalSetorComercial).divide(
										new BigDecimal(mediaTotalSetorComercial), 4, BigDecimal.ROUND_HALF_UP).subtract(
										new BigDecimal("1.00")).multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno3TotalLocalidade != null){
					...
					if(mediaTotalLocalidade != null && !mediaTotalLocalidade.equals(new Integer("0"))){
						variacao3TotalLocalidade = Util.formatarMoedaReal(new BigDecimal(mesAno3TotalLocalidade).divide(
										new BigDecimal(mediaTotalLocalidade), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(volumesFaturadosRelatorioHelper.getConsumoMesAno4() != null){
					consumoMesAno4 = volumesFaturadosRelatorioHelper.getConsumoMesAno4().toString();
					...
					// Soma os valores aos totalizadores de cada grupo
					mesAno4TotalQuadra = mesAno4TotalQuadra + volumesFaturadosRelatorioHelper.getConsumoMesAno4();
					mesAno4TotalSetorComercial = mesAno4TotalSetorComercial + volumesFaturadosRelatorioHelper.getConsumoMesAno4();
					mesAno4TotalLocalidade = mesAno4TotalLocalidade + volumesFaturadosRelatorioHelper.getConsumoMesAno4();

					// Calcula a variação
					if(mediaConsumo != null && !mediaConsumo.equals(new Integer("0"))){
						variacao4 = Util.formatarMoedaReal(new BigDecimal(volumesFaturadosRelatorioHelper.getConsumoMesAno4()).divide(
										new BigDecimal(mediaConsumo), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno4TotalQuadra != null){
					...
					if(mediaTotalQuadra != null && !mediaTotalQuadra.equals(new Integer("0"))){
						variacao4TotalQuadra = Util.formatarMoedaReal(new BigDecimal(mesAno4TotalQuadra).divide(
										new BigDecimal(mediaTotalQuadra), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno4TotalSetorComercial != null){
					...
					if(mediaTotalSetorComercial != null && !mediaTotalSetorComercial.equals(new Integer("0"))){
						variacao4TotalSetorComercial = Util.formatarMoedaReal(new BigDecimal(mesAno4TotalSetorComercial).divide(
										new BigDecimal(mediaTotalSetorComercial), 4, BigDecimal.ROUND_HALF_UP).subtract(
										new BigDecimal("1.00")).multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno4TotalLocalidade != null){
					...
					if(mediaTotalLocalidade != null && !mediaTotalLocalidade.equals(new Integer("0"))){
						variacao4TotalLocalidade = Util.formatarMoedaReal(new BigDecimal(mesAno4TotalLocalidade).divide(
										new BigDecimal(mediaTotalLocalidade), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(volumesFaturadosRelatorioHelper.getConsumoMesAno5() != null){
					consumoMesAno5 = volumesFaturadosRelatorioHelper.getConsumoMesAno5().toString();
					...
					// Soma os valores aos totalizadores de cada grupo
					mesAno5TotalQuadra = mesAno5TotalQuadra + volumesFaturadosRelatorioHelper.getConsumoMesAno5();
					mesAno5TotalSetorComercial = mesAno5TotalSetorComercial + volumesFaturadosRelatorioHelper.getConsumoMesAno5();
					mesAno5TotalLocalidade = mesAno5TotalLocalidade + volumesFaturadosRelatorioHelper.getConsumoMesAno5();

					// Calcula a variação
					if(mediaConsumo != null && !mediaConsumo.equals(new Integer("0"))){
						variacao5 = Util.formatarMoedaReal(new BigDecimal(volumesFaturadosRelatorioHelper.getConsumoMesAno5()).divide(
										new BigDecimal(mediaConsumo), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno5TotalQuadra != null){
					...
					if(mediaTotalQuadra != null && !mediaTotalQuadra.equals(new Integer("0"))){
						variacao5TotalQuadra = Util.formatarMoedaReal(new BigDecimal(mesAno5TotalQuadra).divide(
										new BigDecimal(mediaTotalQuadra), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno5TotalSetorComercial != null){
					...
					if(mediaTotalSetorComercial != null && !mediaTotalSetorComercial.equals(new Integer("0"))){
						variacao5TotalSetorComercial = Util.formatarMoedaReal(new BigDecimal(mesAno5TotalSetorComercial).divide(
										new BigDecimal(mediaTotalSetorComercial), 4, BigDecimal.ROUND_HALF_UP).subtract(
										new BigDecimal("1.00")).multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAno5TotalLocalidade != null){
					...
					if(mediaTotalLocalidade != null && !mediaTotalLocalidade.equals(new Integer("0"))){
						variacao5TotalLocalidade = Util.formatarMoedaReal(new BigDecimal(mesAno5TotalLocalidade).divide(
										new BigDecimal(mediaTotalLocalidade), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				// Consumo e Variação Mês/Ano Informado
				String consumoMesAnoInformado = "";
				String variacaoInformado = "";

				if(volumesFaturadosRelatorioHelper.getConsumoMesAnoInformado() != null){
					consumoMesAnoInformado = volumesFaturadosRelatorioHelper.getConsumoMesAnoInformado().toString();

					peloMenosUmDadoMesAnoInformadoQuadra = true;
					peloMenosUmDadoMesAnoInformadoSetorComercial = true;
					peloMenosUmDadoMesAnoInformadoLocalidade = true;

					// Soma os valores aos totalizadores de cada grupo
					mesAnoInformadoTotalQuadra = mesAnoInformadoTotalQuadra + volumesFaturadosRelatorioHelper.getConsumoMesAnoInformado();
					mesAnoInformadoTotalSetorComercial = mesAnoInformadoTotalSetorComercial
									+ volumesFaturadosRelatorioHelper.getConsumoMesAnoInformado();
					mesAnoInformadoTotalLocalidade = mesAnoInformadoTotalLocalidade
									+ volumesFaturadosRelatorioHelper.getConsumoMesAnoInformado();

					// Calcula a variação
					if(mediaConsumo != null && !mediaConsumo.equals(new Integer("0"))){
						variacaoInformado = Util.formatarMoedaReal(new BigDecimal(volumesFaturadosRelatorioHelper
										.getConsumoMesAnoInformado()).divide(new BigDecimal(mediaConsumo), 4, BigDecimal.ROUND_HALF_UP)
										.subtract(new BigDecimal("1.00")).multiply(new BigDecimal("100.00")));
					}

				}

				// Calcula a variação dos totalizadores de cada grupo
				if(mesAnoInformadoTotalQuadra != null){

					if(mediaTotalQuadra != null && !mediaTotalQuadra.equals(new Integer("0"))){
						variacaoInformadoTotalQuadra = Util.formatarMoedaReal(new BigDecimal(mesAnoInformadoTotalQuadra).divide(
										new BigDecimal(mediaTotalQuadra), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				if(mesAnoInformadoTotalSetorComercial != null){

					if(mediaTotalSetorComercial != null && !mediaTotalSetorComercial.equals(new Integer("0"))){
						variacaoInformadoTotalSetorComercial = Util.formatarMoedaReal(new BigDecimal(mesAnoInformadoTotalSetorComercial)
										.divide(new BigDecimal(mediaTotalSetorComercial), 4, BigDecimal.ROUND_HALF_UP).subtract(
														new BigDecimal("1.00")).multiply(new BigDecimal("100.00")));
					}

				}

				if(mesAnoInformadoTotalLocalidade != null){

					if(mediaTotalLocalidade != null && !mediaTotalLocalidade.equals(new Integer("0"))){
						variacaoInformadoTotalLocalidade = Util.formatarMoedaReal(new BigDecimal(mesAnoInformadoTotalLocalidade).divide(
										new BigDecimal(mediaTotalLocalidade), 4, BigDecimal.ROUND_HALF_UP).subtract(new BigDecimal("1.00"))
										.multiply(new BigDecimal("100.00")));
					}
				...
				// Cria as variáveis para caso não exista nenhum consumo para um totalizador setor
				// vazio
				...
				String mesAnoInformadoTotalQuadraFormatado = "";
				...
				String mesAnoInformadoTotalSetorComercialFormatado = "";
				...
				String mesAnoInformadoTotalLocalidadeFormatado = "";
				...
				if(peloMenosUmDadoMesAnoInformadoQuadra){
					mesAnoInformadoTotalQuadraFormatado = mesAnoInformadoTotalQuadra.toString();
				}else{
					variacaoInformadoTotalQuadra = "";
				}

				// Verifica se deve ser alterado o valor dos totalizadores de setor comercial de 0
				// para vazio
				...
				if(peloMenosUmDadoMesAnoInformadoSetorComercial){
					mesAnoInformadoTotalSetorComercialFormatado = mesAnoInformadoTotalSetorComercial.toString();
				}else{
					variacaoInformadoTotalSetorComercial = "";
				}

				// Verifica se deve ser alterado o valor dos totalizadores de localidade de 0 para
				// vazio
				...
				if(peloMenosUmDadoMesAnoInformadoLocalidade){
					mesAnoInformadoTotalLocalidadeFormatado = mesAnoInformadoTotalLocalidade.toString();
				}else{
					variacaoInformadoTotalLocalidade = "";
				}
				...
				// Localidade
								...
								// Consumo do Mês/Ano Informado
								consumoMesAnoInformado,

								// Variação do Mês/Ano Informado
								variacaoInformado,
								...
								// Consumo do Mês/Ano Informado
								mesAnoInformadoTotalQuadraFormatado,
								...
								// Consumo do Mês/Ano Informado
								mesAnoInformadoTotalSetorComercialFormatado,
								...
								// Consumo do Mês/Ano Informado
								mesAnoInformadoTotalLocalidadeFormatado,
		...
		parametros.put("mesAnoInformado", Util.formatarAnoMesParaMesAno(anoMesInformado));

		// cria uma instância do dataSource do relatório
		RelatorioDataSource ds = new RelatorioDataSource(relatorioBeans);

		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_VOLUMES_FATURADOS, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.VOLUMES_FATURADOS, idFuncionalidadeIniciada, null);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioVolumesFaturados", this);
	}
}