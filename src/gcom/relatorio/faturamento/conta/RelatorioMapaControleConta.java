...
public class RelatorioMapaControleConta
	...
	private Collection<RelatorioMapaControleContaBean> inicializarBeanRelatorio(Collection colecaoMapaControleConta){
		...
		while(iter.hasNext()){
			...
			if(mapaControleContaRelatorioHelper.getIdEmpresa() != null){
				...
				RelatorioMapaControleContaBean relatorioMapaControleContaBean = new RelatorioMapaControleContaBean(""
								+ mapaControleContaRelatorioHelper.getIdEmpresa(), mapaControleContaRelatorioHelper.getNomeEmpresa(), ""
								+ mapaControleContaRelatorioHelper.getIdLocalidade(), ""
								+ mapaControleContaRelatorioHelper.getCodigoSetor(), mapaControleContaRelatorioHelper
								.getDescricaoTipoConta(), mapaControleContaRelatorioHelper.getSequencialInicial() == null ? "" : ""
								+ mapaControleContaRelatorioHelper.getSequencialInicial(), mapaControleContaRelatorioHelper
								.getSequencialFinal() == null ? "" : "" + mapaControleContaRelatorioHelper.getSequencialFinal(), ""
								+ mapaControleContaRelatorioHelper.getQtdeContas(), Util.formatarMoedaReal(mapaControleContaRelatorioHelper
								.getValor()), Util.formatarMoedaReal(valorTotalPorEmpresa));
				...
				RelatorioMapaControleContaBean relatorioMapaControleContaBean = new RelatorioMapaControleContaBean(""
								...
								.getSequencialFinal() == null ? "" : "" + mapaControleContaRelatorioHelper.getSequencialFinal(), ""
								+ mapaControleContaRelatorioHelper.getQtdeContas(), Util.formatarMoedaReal(mapaControleContaRelatorioHelper
								.getValor()), Util.formatarMoedaReal(valorTotalPorEmpresaNull));
	...
	public Object executar() throws TarefaException{
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_MAPA_CONTROLE_CONTA, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MAPA_CONTROLE_CONTA, idFuncionalidadeIniciada, null);
