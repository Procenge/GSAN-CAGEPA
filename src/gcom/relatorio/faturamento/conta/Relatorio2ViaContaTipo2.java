...
public class Relatorio2ViaContaTipo2
	...
	private Collection<Relatorio2ViaContaTipo2Bean> inicializarBeanRelatorio(Collection colecaoEmitirContaHelper){
		...
		while(iter.hasNext()){
				...
				if((totalLinhasRelatorio == NUMERO_MAX_lINHAS_DETAIL_PRIMEIRA_PAGINA)
					...
					Relatorio2ViaContaTipo2Bean relatorio2ViaContaTipo2Bean = new Relatorio2ViaContaTipo2Bean(
									...
									emitirContaHelper.getNomeGerenciaRegional(), emitirContaHelper.getMesAnoFormatado(), emitirContaHelper
													.getNumeroIndiceTurbidez(), emitirContaHelper.getNumeroCloroResidual(),
									emitirContaHelper.getRepresentacaoNumericaCodBarraFormatada(), emitirContaHelper
									...
									emitirContaHelper.getIdFaturamentoGrupo().toString(), emitirContaHelper.getIdEmpresa().toString(), ""
													+ totalPaginasRelatorio, emitirContaHelper.getIdConta().toString(), codigoRota,
									emitirContaHelper.getDatasVencimento(), emitirContaHelper.getConsumoMedio(), mesAno1, mesAno2, mesAno3,
									mesAno4, mesAno5, mesAno6, consumo1, consumo2, consumo3, consumo4, consumo5, consumo6,
									emitirContaHelper.getCategoriaImovel(), emitirContaHelper.getNumeroHidrometro(), emitirContaHelper
													.getContaSemCodigoBarras(), emitirContaHelper.getMsgConta(), emitirContaHelper
													.getMsgLinha1Conta(), emitirContaHelper.getMsgLinha2Conta(), emitirContaHelper
													.getMsgLinha3Conta(), emitirContaHelper.getMsgLinha4Conta(), emitirContaHelper
													.getMsgLinha5Conta(), emitirContaHelper.getValorMedioTurbidez(), emitirContaHelper
													.getPadraoTurbidez(), emitirContaHelper.getValorMedioPh(), emitirContaHelper
													.getValorMedioCor(), emitirContaHelper.getValorMedioCloro(), emitirContaHelper
													.getValorMedioFluor(), emitirContaHelper.getValorMedioFerro(), emitirContaHelper
													.getValorMedioColiformesTotais(), emitirContaHelper.getValorMedioColiformesfecais(),
									emitirContaHelper.getPadraoPh(), emitirContaHelper.getPadraoCor(), emitirContaHelper.getPadraoCloro(),
									emitirContaHelper.getPadraoFluor(), emitirContaHelper.getPadraoFerro(), emitirContaHelper
													.getPadraoColiformesTotais(), emitirContaHelper.getPadraoColiformesfecais(),
									emitirContaHelper.getEnderecoLinha2(), emitirContaHelper.getEnderecoLinha3(), emitirContaHelper
													.getIdFaturamentoGrupo().toString());
			...
			if(totalLinhasRelatorio != NUMERO_MAX_lINHAS_DETAIL_PRIMEIRA_PAGINA
				...
				Relatorio2ViaContaTipo2Bean relatorio2ViaContaTipo2Bean = new Relatorio2ViaContaTipo2Bean(indicadorPrimeiraPagina,
								colecaoDetail, emitirContaHelper.getDescricaoLocalidade(), emitirContaHelper.getMatriculaImovelFormatada(),
								dataVencimentoFormatada, emitirContaHelper.getNomeCliente(), emitirContaHelper.getEnderecoImovel(), Util
												.formatarAnoMesParaMesAno(emitirContaHelper.getAmReferencia()), emitirContaHelper
												.getInscricaoImovel(), emitirContaHelper.getIdClienteResponsavel(), emitirContaHelper
												.getEnderecoClienteResponsavel(), emitirContaHelper.getDescricaoLigacaoAguaSituacao(),
								emitirContaHelper.getDescricaoLigacaoEsgotoSituacao(), emitirContaHelper.getLeituraAnterior(),
								emitirContaHelper.getLeituraAtual(), emitirContaHelper.getConsumoFaturamento(), emitirContaHelper
												.getDiasConsumo(), emitirContaHelper.getConsumoMedioDiario(), emitirContaHelper
												.getDataLeituraAnterior(), emitirContaHelper.getDataLeituraAtual(), emitirContaHelper
												.getDescricaoTipoConsumo(),
								emitirContaHelper.getDescricaoAnormalidadeConsumo(),
								emitirContaHelper.getQuantidadeEconomiaConta(),
								emitirContaHelper.getConsumoEconomia(),
								emitirContaHelper.getCodigoAuxiliarString(),
								...
								emitirContaHelper.getIdFaturamentoGrupo().toString(), emitirContaHelper.getIdEmpresa().toString(), ""
												+ totalPaginasRelatorio, emitirContaHelper.getIdConta().toString(), codigoRota,
								emitirContaHelper.getDatasVencimento(), emitirContaHelper.getConsumoMedio(), mesAno1, mesAno2, mesAno3,
								mesAno4, mesAno5, mesAno6, consumo1, consumo2, consumo3, consumo4, consumo5, consumo6, emitirContaHelper
												.getCategoriaImovel(), emitirContaHelper.getNumeroHidrometro(), emitirContaHelper
												.getContaSemCodigoBarras(), emitirContaHelper.getMsgConta(), emitirContaHelper
												.getMsgLinha1Conta(), emitirContaHelper.getMsgLinha2Conta(), emitirContaHelper
												.getMsgLinha3Conta(), emitirContaHelper.getMsgLinha4Conta(), emitirContaHelper
												.getMsgLinha5Conta(), emitirContaHelper.getValorMedioTurbidez(), emitirContaHelper
	...
	public Object executar() throws TarefaException{
		...
		// Collection colecaoEmitirContaHelper = fachada.emitir2ViaContas(idsConta,
		// cobrarTaxaEmissaoConta, contaSemCodigoBarrasPesquisa);
		...
		Collection<Relatorio2ViaContaTipo2Bean> colecaoBean = this.inicializarBeanRelatorio(dadosRelatorio);
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_2_VIA_CONTA_TIPO_2, parametros, ds, tipoFormatoRelatorio);
