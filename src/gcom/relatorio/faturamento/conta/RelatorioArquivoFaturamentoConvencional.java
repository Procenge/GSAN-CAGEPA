 ...
 * Arquivo TXT gerado com as contas emitidas pelo faturamento
 * 
 * @author Luciano Galvao
 * @date 28/06/2012
 */
public class RelatorioArquivoFaturamentoConvencional
				extends TarefaRelatorio {

	public RelatorioArquivoFaturamentoConvencional(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_ARQUIVO_FATURAMENTO_CONVENCIONAL);
	}

	public RelatorioArquivoFaturamentoConvencional() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_ARQUIVO_FATURAMENTO_CONVENCIONAL, idFuncionalidadeIniciada,
							nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioArquivoFaturamentoConvencional", this);
	}
}
