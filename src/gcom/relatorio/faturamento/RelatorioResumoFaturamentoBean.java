...
public class RelatorioResumoFaturamentoBean
	...
	public RelatorioResumoFaturamentoBean(BigDecimal[] valorItemFaturamento, String descricaoTipoLancamento,
	...
	public BigDecimal getSomaValoresItemFaturamento(){
		...
		return this.getValorItemFaturamento4().add(getValorItemFaturamento5());
	}
	...
	public BigDecimal getValorItemFaturamento4(){
		...
		return this.getValorItemFaturamento1().add(getValorItemFaturamento2()).add(getValorItemFaturamento3());
	}
