...
public class RelatorioResumoFaturamento
	...
	@Deprecated
	public RelatorioResumoFaturamento() {
	...
	private Collection<RelatorioResumoFaturamentoBean> inicializarBeanRelatorio(Collection listaCamposConsultaRelatorio){
		...
		while(iterator.hasNext()){
			...
			RelatorioResumoFaturamentoBean relatorioResumoFaturamentoBean = new RelatorioResumoFaturamentoBean(
							resumoFaturamentoRelatorioHelper.getValorItemFaturamento(), resumoFaturamentoRelatorioHelper
											.getDescricaoTipoLancamento(), resumoFaturamentoRelatorioHelper.getDescricaoItemLancamento(),
							resumoFaturamentoRelatorioHelper.getDescricaoItemContabil(), resumoFaturamentoRelatorioHelper
											.getIndicadorImpressao(), resumoFaturamentoRelatorioHelper.getIndicadorTotal(),
							resumoFaturamentoRelatorioHelper.getLancamentoTipo(), resumoFaturamentoRelatorioHelper
											.getLancamentoTipoSuperior(), false, resumoFaturamentoRelatorioHelper.getDescricaoGerencia(),
							resumoFaturamentoRelatorioHelper.getGerencia(), resumoFaturamentoRelatorioHelper.getDescricaoLocalidade(),
							resumoFaturamentoRelatorioHelper.getLocalidade(), resumoFaturamentoRelatorioHelper
											.getDescLancamentoTipoSuperior(),
							resumoFaturamentoRelatorioHelper.getDescricaoUnidadeNegocio(), resumoFaturamentoRelatorioHelper
											.getUnidadeNegocio());
	...
	public Object executar() throws TarefaException{
		...
		Collection dadosRelatorio = fachada.consultarResumoFaturamentoRelatorio(opcaoTotalizacao, mesAno, codigoGerencia, codigoLocalidade,
						unidadeNegocio);
		...
		try{
			persistirRelatorioConcluido(retorno, Relatorio.RESUMO_FATURAMENTO, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		totalRegistrosRel = fachada.consultarQtdeRegistrosResumoFaturamentoRelatorio(mesAno, idLocalidade, idGerencia, opcaoTotalizacao);
