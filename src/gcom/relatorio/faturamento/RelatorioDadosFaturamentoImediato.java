 ...
 * @date 23/08/2011
 */
public class RelatorioDadosFaturamentoImediato
				extends TarefaRelatorio {

	public RelatorioDadosFaturamentoImediato(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_DADOS_FATURAMENTO_IMEDIATO);
	}

	public RelatorioDadosFaturamentoImediato() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.GERAR_DADOS_FATURAMENTO_IMEDIATO, idFuncionalidadeIniciada, nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioDadosFaturamentoImediato", this);
	}
}
