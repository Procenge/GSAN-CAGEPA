 ...
 * @created 12/04/2007
 */
public class RelatorioFaixasFalsasLeitura
	...
	public Object executar() throws TarefaException{
		...
		Collection colecaoDadosRelatorioFaixasFalsasLeitura = fachada.pesquisarImovelFaixaFalsa(anoMesReferencia);
		...
		if(colecaoDadosRelatorioFaixasFalsasLeitura != null && !colecaoDadosRelatorioFaixasFalsasLeitura.isEmpty()){
			...
			while(colecaoDadosRelatorioFaixasFalsasLeituraIterator.hasNext()){
				...
				if(faixasFalsasLeituraRelatorioHelper.getIdGrupoFaturamento() != null){
					grupoFaturamento = faixasFalsasLeituraRelatorioHelper.getIdGrupoFaturamento().toString() + " - "
									+ faixasFalsasLeituraRelatorioHelper.getDescricaoGrupoFaturamento();
				}
				...
				if(faixasFalsasLeituraRelatorioHelper.getIdEmpresa() != null){
					empresa = faixasFalsasLeituraRelatorioHelper.getIdEmpresa().toString() + " - "
									+ faixasFalsasLeituraRelatorioHelper.getNomeEmpresa();
				}
				...
				if(faixasFalsasLeituraRelatorioHelper.getIdLocalidade() != null){
					localidade = faixasFalsasLeituraRelatorioHelper.getIdLocalidade().toString() + " - "
									+ faixasFalsasLeituraRelatorioHelper.getNomeLocalidade();
				}
				...
				if(faixasFalsasLeituraRelatorioHelper.getIdSetorComercial() != null){
					setorComercial = faixasFalsasLeituraRelatorioHelper.getCodigoSetorComercial().toString() + " - "
									+ faixasFalsasLeituraRelatorioHelper.getNomeSetorComercial();
				...
				if(faixasFalsasLeituraRelatorioHelper.getFaixaFalsaInferior() != null
								...
								&& faixasFalsasLeituraRelatorioHelper.getFaixaFalsaSuperior() != null
								&& (faixasFalsasLeituraRelatorioHelper.getFaixaFalsaInferior().intValue() <= faixasFalsasLeituraRelatorioHelper
												.getLeituraAtual().intValue() && faixasFalsasLeituraRelatorioHelper.getLeituraAtual()
												.intValue() <= faixasFalsasLeituraRelatorioHelper.getFaixaFalsaSuperior())){
				...
				if(faixasFalsasLeituraRelatorioHelper.getNumeroQuadra() != null){
					...
					String quadraFormatada = Util.adicionarZerosEsquedaNumero(3, faixasFalsasLeituraRelatorioHelper.getNumeroQuadra()
									.toString());
					String loteFormatado = Util.adicionarZerosEsquedaNumero(4, faixasFalsasLeituraRelatorioHelper.getLote().toString());
					String subloteFormatado = Util.adicionarZerosEsquedaNumero(3, faixasFalsasLeituraRelatorioHelper.getSublote()
									.toString());
				...
				if(faixasFalsasLeituraRelatorioHelper.getFaixaCorretaInferior() != null){
					faixaCorreta = formato.format(faixasFalsasLeituraRelatorioHelper.getFaixaCorretaInferior()) + " A "
									+ formato.format(faixasFalsasLeituraRelatorioHelper.getFaixaCorretaSuperior());
				}

				// Faixa Falsa
				String faixaFalsa = "";
				if(faixasFalsasLeituraRelatorioHelper.getFaixaFalsaInferior() != null){
					faixaFalsa = formato.format(faixasFalsasLeituraRelatorioHelper.getFaixaFalsaInferior()) + " A "
									+ formato.format(faixasFalsasLeituraRelatorioHelper.getFaixaFalsaSuperior());
				}
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_FAIXAS_FALSAS_LEITURA, parametros, ds, tipoFormatoRelatorio);
