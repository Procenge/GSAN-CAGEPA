...
public class RelatorioAnaliseConsumo
	...
	private Collection<RelatorioAnaliseConsumoBean> inicializarBeanRelatorio(
					Collection<RelatorioAnaliseConsumoHelper> colecaoAnaliseConsumoHelper, String mesAnoFaturamento){

		Fachada fachada = Fachada.getInstancia();

		Collection<RelatorioAnaliseConsumoBean> retorno = new ArrayList<RelatorioAnaliseConsumoBean>();

		Iterator<RelatorioAnaliseConsumoHelper> iter = colecaoAnaliseConsumoHelper.iterator();
		while(iter.hasNext()){
	...
	public Object executar() throws TarefaException{
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_ANALISE_CONSUMO, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.ANALISE_CONSUMO, idFuncionalidadeIniciada, null);
		}catch(ControladorException e){
			e.printStackTrace();
