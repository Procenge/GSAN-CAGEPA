 ...
 * @date 07/06/2010
 */
public class RelatorioNegativacaoSpcSerasa
				extends TarefaRelatorio {

	public RelatorioNegativacaoSpcSerasa(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_NEGATIVACAO_SPC_SERASA);
	}

	public RelatorioNegativacaoSpcSerasa() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_NEGATIVACAO_SPC_SERASA, idFuncionalidadeIniciada, nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioNegativacaoSpcSerasa", this);
	}
}
