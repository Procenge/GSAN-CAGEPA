...
public class GeradorRelatorioParcelamentoException
				extends Exception {
	...
	/**
	 * Construtor da classe GeradorRelatorioResolucaoDiretoriaException
	 * 
	 * @param mensagem
	 ...
	 */
	public GeradorRelatorioParcelamentoException(String mensagem, Exception excecaoCausa) {
	 ...
	 */
	public GeradorRelatorioParcelamentoException(String mensagem) {
	 ...
	 *            Descrição do parâmetro
	 */
	public GeradorRelatorioParcelamentoException(String mensagem, Exception excecaoCausa, String... parametroMensagem) {
