 ...
 * @date 30/12/2011
 */
public class RelatorioOrdemCorteArquivoTxt
				extends TarefaRelatorio {

	public RelatorioOrdemCorteArquivoTxt(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_ORDEM_CORTE_ARQUIVO_TXT);
	}

	public RelatorioOrdemCorteArquivoTxt() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_ORDEM_CORTE_ARQUIVO_TXT, idFuncionalidadeIniciada, nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioGerarOrdemCorteArquivoTxt", this);
	}
}
