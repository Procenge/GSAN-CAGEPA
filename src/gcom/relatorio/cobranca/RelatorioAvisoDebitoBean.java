...
public class RelatorioAvisoDebitoBean
	...
	private ArrayList<Object> arrayRelatorioAvisoDebitoDetail1Bean;
	...
	private ArrayList<Object> arrayRelatorioAvisoDebitoDetail2Bean;
	...
	public RelatorioAvisoDebitoBean(EmitirAvisoCobrancaHelper emitirAvisoCobrancaHelper1,
		...
		if(emitirAvisoCobrancaHelper1 != null){
			...
			this.arrayRelatorioAvisoDebitoDetail1Bean = new ArrayList<Object>();
			this.arrayRelatorioAvisoDebitoDetail1Bean.addAll(this.gerarDetail(emitirAvisoCobrancaHelper1.getMesAno(),
							emitirAvisoCobrancaHelper1.getVencimento(), emitirAvisoCobrancaHelper1.getValor()));
			this.arrayJRDetail1 = new JRBeanCollectionDataSource(this.arrayRelatorioAvisoDebitoDetail1Bean);
		...
		if(emitirAvisoCobrancaHelper2 != null){
			...
			this.representacaoNumericaCodBarraSemDigito2 = emitirAvisoCobrancaHelper2.getRepresentacaoNumericaCodBarraSemDigito() != null ? emitirAvisoCobrancaHelper2
							...
							: "000000";
			this.arrayRelatorioAvisoDebitoDetail2Bean = new ArrayList<Object>();
			this.arrayRelatorioAvisoDebitoDetail2Bean.addAll(this.gerarDetail(emitirAvisoCobrancaHelper2.getMesAno(),
							emitirAvisoCobrancaHelper2.getVencimento(), emitirAvisoCobrancaHelper2.getValor()));
			this.arrayJRDetail2 = new JRBeanCollectionDataSource(this.arrayRelatorioAvisoDebitoDetail2Bean);
	...
	public ArrayList<Object> getArrayRelatorioAvisoDebitoDetail1Bean(){

		return arrayRelatorioAvisoDebitoDetail1Bean;
	}

	public void setArrayRelatorioAvisoDebitoDetail1Bean(ArrayList<Object> arrayRelatorioAvisoDebitoDetail1Bean){

		this.arrayRelatorioAvisoDebitoDetail1Bean = arrayRelatorioAvisoDebitoDetail1Bean;
	}
	...
	public ArrayList<Object> getArrayRelatorioAvisoDebitoDetail2Bean(){

		return arrayRelatorioAvisoDebitoDetail2Bean;
	}

	public void setArrayRelatorioAvisoDebitoDetail2Bean(ArrayList<Object> arrayRelatorioAvisoDebitoDetail2Bean){

		this.arrayRelatorioAvisoDebitoDetail2Bean = arrayRelatorioAvisoDebitoDetail2Bean;
	}
	...
	private Collection<Object> gerarDetail(Collection<String> collMesAno, Collection<String> collVencimento,
		...
		for(int i = 0; i < linhasMesAno.length; i++){
			...
			Object relatorio = new RelatorioAvisoDebitoDetailBean(linhaMesAno, linhaVencimento, linhaValor);
