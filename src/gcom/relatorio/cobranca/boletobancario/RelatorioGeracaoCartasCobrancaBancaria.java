...
package gcom.relatorio.cobranca.boletobancario;
 ...
 * @date 23/08/2011
 */
public class RelatorioGeracaoCartasCobrancaBancaria
				extends TarefaRelatorio {

	public RelatorioGeracaoCartasCobrancaBancaria(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_GERACAO_CARTAS_COBRANCA_BANCARIA);
	}

	public RelatorioGeracaoCartasCobrancaBancaria() {
	...
	public Object executar() throws TarefaException{
		...
		try{
			...
			this.persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_GERACAO_CARTA_COBRANCA_BANCARIA, idFuncionalidadeIniciada,
							nomeArquivo);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioGeracaoCartasCobrancaBancaria", this);
	}
}
