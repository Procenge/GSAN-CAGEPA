...
public class RelatorioExtratoDebitoClienteBean
	...
	public RelatorioExtratoDebitoClienteBean(String indicadorPrimeiraPagina, Collection colecaoDetail) {
		...
		this.arrayJRDetail = new JRBeanCollectionDataSource(this.arrayRelatorioExtratoDebitoClienteDetailBean);
	}
	...
	/**
	 * @param arrayRelatorioExtratoDebitoClienteDetailBean
	 *            O arrayRelatorioExtratoDebitoClienteDetailBean a ser setado.
	 */
	public void setArrayRelatorioExtratoDebitoClienteDetailBean(ArrayList arrayRelatorioExtratoDebitoClienteDetailBean){
	...
	/**
	 * @param indicadorPrimeiraPagina
	 *            O indicadorPrimeiraPagina a ser setado.
	 */
