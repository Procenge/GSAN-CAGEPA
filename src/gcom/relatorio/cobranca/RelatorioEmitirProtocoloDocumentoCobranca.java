 ...
 * @date 05/10/06
 */
public class RelatorioEmitirProtocoloDocumentoCobranca
	...
	private Collection<RelatorioEmitirProtocoloDocumentoCobrancaBean> inicializarBeanRelatorio(
		...
		while(iterator.hasNext()){
			...
			ProtocoloDocumentoCobrancaRelatorioHelper helper = (ProtocoloDocumentoCobrancaRelatorioHelper) iterator.next();
			...
			RelatorioEmitirProtocoloDocumentoCobrancaBean bean = new RelatorioEmitirProtocoloDocumentoCobrancaBean(empresa, idLocalidade,
							localidade, setor, quantidadeDocumento, valorDocumento, seqInicial, seqFinal, idGerencia, gerencia);
	...
	public Object executar() throws TarefaException{
		...
		Collection<RelatorioEmitirProtocoloDocumentoCobrancaBean> colecaoBean = this.inicializarBeanRelatorio(dadosRelatorio);
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_EMITIR_PROTOCOLO_DOCUMENTO_COBRANCA, parametros, ds,
						tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.EMITIR_PROTOCOLO_DOCUMENTO_COBRANCA, idFuncionalidadeIniciada, null);
