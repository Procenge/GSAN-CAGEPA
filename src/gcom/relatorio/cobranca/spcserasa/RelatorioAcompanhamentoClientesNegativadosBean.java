...
public class RelatorioAcompanhamentoClientesNegativadosBean
	...
	public RelatorioAcompanhamentoClientesNegativadosBean(	String nomeCliente,
															String matricula,
															String cpfCnpj,
															...
															BigDecimal valorParceladoTotalLoc, BigDecimal valorParceladoEntradaTotalLoc,
															...
															BigDecimal valorParceladoCanceladoTotalLoc, BigDecimal valorParcelado) {
		...
		this.arrayJRDadosParcelamento = new JRBeanCollectionDataSource(
						this.arrayRelatorioAcompanhamentoClientesNegativadosDadosParcelamentoBean);
		...
		this.arrayJRParametrosSelecionados = new JRBeanCollectionDataSource(
						this.arrayRelatorioAcompanhamentoClientesNegativadosParametrosSelecionadosBean);
	...
	/**
	 * @param valorCancelado
	 *            O valorCancelado a ser setado.
	 */
	...
	/**
	 * @param motivosEncerramento
	 *            O motivosEncerramento a ser setado.
	 */
	...
	public void setNumeroPrestacoesCobradasNaoPagasTotalLoc(Integer numeroPrestacoesCobradasNaoPagasTotalLoc){
	...
	public void setNumeroPrestacoesCobradasPagasTotalLoc(Integer numeroPrestacoesCobradasPagasTotalLoc){
	...
	public void setNumeroPrestacoesNaoCobradasTotalLoc(Integer numeroPrestacoesNaoCobradasTotalLoc){
	...
	public void setValorParceladoCanceladoTotalLoc(BigDecimal valorParceladoCanceladoTotalLoc){
	...
	public void setValorParceladoCobradoNaoPagoTotalLoc(BigDecimal valorParceladoCobradoNaoPagoTotalLoc){
	...
	public void setValorParceladoCobradoPagoTotalLoc(BigDecimal valorParceladoCobradoPagoTotalLoc){
	...
	public void setValorParceladoEntradaPagoTotalLoc(BigDecimal valorParceladoEntradaPagoTotalLoc){
	...
	public void setValorParceladoNaoCobradoTotalLoc(BigDecimal valorParceladoNaoCobradoTotalLoc){
	...
	public void setValorParceladoEntradaTotalLoc(BigDecimal valorParceladoEntradaTotalLoc){
	...
	public void setArrayJRDadosParcelamento(JRBeanCollectionDataSource arrayJRDadosParcelamento){
	...
	public void setIndicadorExisteDadosParcelamento(String indicadorExisteDadosParcelamento){
	...
	public void setArrayJRParametrosSelecionados(JRBeanCollectionDataSource arrayJRParametrosSelecionados){
