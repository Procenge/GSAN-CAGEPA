 ...
 * @created 27/06/2007
 */
public class RelatorioAvisoDeDebito
	...
	public Object executar() throws TarefaException{
		...
		List colecaoEmitirReavisoDeDebitoHelper = (ArrayList) getParametro("colecaoEmitirReavisoDeDebitoHelper");
		...
		if(colecaoEmitirReavisoDeDebitoHelper != null && !colecaoEmitirReavisoDeDebitoHelper.isEmpty()){
			...
			Iterator itera = colecaoEmitirReavisoDeDebitoHelper.iterator();
			...
			while(!flagTerminou){
				...
				for(int i = 0; i < quantidadeRegistros; i++){
					...
					if(emitirReavisoDeDebitoHelperPrimeiraConta != null && emitirReavisoDeDebitoHelperSegundaConta != null){
						...
						relatorioReavisoDeDebitoBean = new RelatorioReavisoDeDebitoBean(emitirReavisoDeDebitoHelperPrimeiraConta,
				...
				retorno = gerarRelatorio(ConstantesRelatorios.REAVISO_DE_DEBITO, parametros, ds, tipoFormatoRelatorio);
		...
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.RELATORIO_AVISO_DEBITO, idFuncionalidadeIniciada, null);
