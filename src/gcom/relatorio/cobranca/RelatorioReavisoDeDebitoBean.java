 ...
 * @date 26/07/2007
 */
public class RelatorioReavisoDeDebitoBean
	...
	public RelatorioReavisoDeDebitoBean(ReavisoDeDebitoHelper reavisoDeDebitoHelper1, ReavisoDeDebitoHelper reavisoDeDebitoHelper2) {

		this.arrayRelatorioReavisoDeDebitoDetail1Bean = new ArrayList();
		this.arrayRelatorioReavisoDeDebitoDetail1Bean.addAll(this.gerarDetail(reavisoDeDebitoHelper1
						.getColecaoReavisoDeDebitoLinhasDescricaoDebitosHelper(), 1));
		...
		this.arrayRelatorioReavisoDeDebitoDetail2Bean.addAll(this.gerarDetail(reavisoDeDebitoHelper2
						.getColecaoReavisoDeDebitoLinhasDescricaoDebitosHelper(), 2));
	...
	public void setArrayRelatorioReavisoDeDebitoDetail1Bean(ArrayList arrayRelatorioReavisoDeDebitoDetail1Bean){
	...
	public void setArrayRelatorioReavisoDeDebitoDetail2Bean(ArrayList arrayRelatorioReavisoDeDebitoDetail2Bean){
	...
	private Collection gerarDetail(Collection colecaoDescricaoDebitos, int tipoRelatorio){
		...
		if(colecaoDescricaoDebitos != null && !colecaoDescricaoDebitos.isEmpty()){
			...
			while(iterator.hasNext()){
				...
				ReavisoDeDebitoLinhasDescricaoDebitosHelper linhasDescricaoDebitosHelper = (ReavisoDeDebitoLinhasDescricaoDebitosHelper) iterator
								.next();

				Object relatorio = null;

				if(tipoRelatorio == 1){
					relatorio = new RelatorioReavisoDeDebitoDetail1Bean(linhasDescricaoDebitosHelper.getMesAno(),
									linhasDescricaoDebitosHelper.getOrigem(), linhasDescricaoDebitosHelper.getVencimento(),
									linhasDescricaoDebitosHelper.getValor());

				}else{
					relatorio = new RelatorioReavisoDeDebitoDetail2Bean(linhasDescricaoDebitosHelper.getMesAno(),
									linhasDescricaoDebitosHelper.getOrigem(), linhasDescricaoDebitosHelper.getVencimento(),
									linhasDescricaoDebitosHelper.getValor());
