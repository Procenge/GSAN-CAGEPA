 ...
 * @date 15/09/2014
 */
public class RelatorioCertidaoNegativaComEfeitoPositivaModelo4
				extends TarefaRelatorio {

	private static final long serialVersionUID = 1L;

	public RelatorioCertidaoNegativaComEfeitoPositivaModelo4(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_CERTIDAO_NEGATIVA_COM_EFEITO_POSITIVA_MODELO_4);
	}

	@Deprecated
	public RelatorioCertidaoNegativaComEfeitoPositivaModelo4() {
	...
	public Object executar() throws TarefaException{
		...
		parametros.put("inscricaoImovel", inscricaoImovel);
		parametros.put("nomeCliente", clienteUsuarioImovel.getNome());
		parametros.put("codigoCliente", clienteUsuarioImovel.getId().toString());
		parametros.put("enderecoImovel", enderecoFormatado);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_CERTIDAO_NEGATIVA_COM_EFEITO_POSITIVA_MODELO_4, parametros, ds,
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioCertidaoNegativaComEfeitoPositivaModelo4", this);
	}
}