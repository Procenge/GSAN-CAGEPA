...
public class RelatorioOrdemCorteModelo4Bean
	...
	private String nomeLocalidade1;

	private String nomeMunicipio1;
	...
	private String nomeLocalidade2;

	private String nomeMunicipio2;

	public RelatorioOrdemCorteModelo4Bean(EmitirDocumentoOrdemCorteModelo4e5Helper helper1, EmitirDocumentoOrdemCorteModelo4e5Helper helper2) {
		...
		if(helper1 != null){
			...
			this.nomeLocalidade1 = helper1.getNomeLocalidade();
			this.nomeMunicipio1 = helper1.getNomeMunicipioFormatado();
		...
		if(helper2 != null){
			...
			this.nomeLocalidade2 = helper2.getNomeLocalidade();
			this.nomeMunicipio2 = helper2.getNomeMunicipioFormatado();
	...
	private List<Object> gerarDetail(Collection<CobrancaDocumentoItemHelper> itemConta){
		...
		for(int i = 1; i <= 15; i++){
			...
			if(iter.hasNext()){
				...
				// Add Branco para ter um total de 15.
				collStringConta.add(" ");
				collStringValor.add(" ");
	...
	public String getNomeLocalidade1(){

		return nomeLocalidade1;
	}

	public void setNomeLocalidade1(String nomeLocalidade1){

		this.nomeLocalidade1 = nomeLocalidade1;
	}

	public String getNomeMunicipio1(){

		return nomeMunicipio1;
	}

	public void setNomeMunicipio1(String nomeMunicipio1){

		this.nomeMunicipio1 = nomeMunicipio1;
	}

	public String getNomeLocalidade2(){

		return nomeLocalidade2;
	}

	public void setNomeLocalidade2(String nomeLocalidade2){

		this.nomeLocalidade2 = nomeLocalidade2;
	}

	public String getNomeMunicipio2(){

		return nomeMunicipio2;
	}

	public void setNomeMunicipio2(String nomeMunicipio2){

		this.nomeMunicipio2 = nomeMunicipio2;
	}
