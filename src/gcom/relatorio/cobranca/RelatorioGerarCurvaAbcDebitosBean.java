 ...
 * @date 03/09/2007
 */
public class RelatorioGerarCurvaAbcDebitosBean
	...
	public String getDescricaoClassificacao(){
		...
		if(this.classificacao.trim().equalsIgnoreCase("REGIONAL")){
			...
			retorno = this.idGerenciaRegional + " - " + this.nomeGerenciaRegional + " - " + this.nomeLocalidade;
		}else{
			retorno = this.idGerenciaRegional + " - " + this.nomeGerenciaRegional + " - " + this.nomeLocalidade + " - "
							+ this.codigoSetorComercial + " - " + this.nomeSetorComercial;
		}
	...
	public String getReferenciaCobranca(){
		...
		if(this.getReferenciaCobrancaInicial() != null && !this.getReferenciaCobrancaInicial().equals("")
						&& this.getReferenciaCobrancaFinal() != null && !this.getReferenciaCobrancaInicial().equals("")){
