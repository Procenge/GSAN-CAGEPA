 ...
 * @date 27/08/2007
 */
public class RelatorioGerarIndicesAcrescimosImpontualidadeBean
	...
	public RelatorioGerarIndicesAcrescimosImpontualidadeBean(IndicesAcrescimosImpontualidade indicesAcrescimosImpontualidade) {

		this.mesAnoReferencia = Util.formatarAnoMesParaMesAno(indicesAcrescimosImpontualidade.getAnoMesReferencia());
		this.percentualMulta = Util.formatarMoedaReal(indicesAcrescimosImpontualidade.getPercentualMulta());
		this.percentualJurosMora = Util.formatarMoedaReal(indicesAcrescimosImpontualidade.getPercentualJurosMora());
		this.fatorAtualizacaoMonetaria = Util.formatarMoedaReal(indicesAcrescimosImpontualidade.getFatorAtualizacaoMonetaria());
