 ...
 * @created 28/09/2007
 */
public class RelatorioGerarIndicesAcrescimosImpontualidade
	...
	public RelatorioGerarIndicesAcrescimosImpontualidade(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_GERAR_INDICE_ACRESCIMOS_IMPONTUALIDADE);
	}
	...
	public Object executar() throws TarefaException{
		...
		if(colecaoIndicesAcrescimosImpontualidade != null && !colecaoIndicesAcrescimosImpontualidade.isEmpty()){
			...
			while(itera.hasNext()){
				IndicesAcrescimosImpontualidade indicesAcrescimosImpontualidade = (IndicesAcrescimosImpontualidade) itera.next();
				...
				relatorioBeans.add(relatorioGerarIndicesAcrescimosImpontualidadeBean);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_GERAR_INDICE_ACRESCIMOS_IMPONTUALIDADE, parametros, ds,
						tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.GERAR_INDICES_ACRESCIMOS_IMPONTUALIDADE, idFuncionalidadeIniciada, null);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioGerarIndicesAcrescimosImpontualidade", this);
