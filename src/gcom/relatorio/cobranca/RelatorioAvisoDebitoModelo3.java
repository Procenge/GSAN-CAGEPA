...
public class RelatorioAvisoDebitoModelo3
				extends TarefaRelatorio {

	public RelatorioAvisoDebitoModelo3(Usuario usuario) {

		super(usuario, ConstantesRelatorios.RELATORIO_AVISO_DEBITO_MODELO3);
	}

	public RelatorioAvisoDebitoModelo3() {
	...
	public Object executar() throws TarefaException{
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_AVISO_DEBITO_MODELO3, parametros, ds, tipoFormatoRelatorio);
