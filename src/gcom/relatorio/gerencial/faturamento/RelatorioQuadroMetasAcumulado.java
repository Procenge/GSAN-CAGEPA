 ...
 * @created 20/12/2007
 */
public class RelatorioQuadroMetasAcumulado
	...
	public Object executar() throws TarefaException{
		...
		FiltrarRelatorioQuadroMetasAcumuladoHelper filtro = (FiltrarRelatorioQuadroMetasAcumuladoHelper) getParametro("filtrarRelatorioQuadroMetasAcumuladoHelper");
		...
		Collection<QuadroMetasAcumuladoHelper> colecao = fachada.pesquisarRelatorioQuadroMetasAcumulado(filtro);
		...
		if(colecao != null && !colecao.isEmpty()){
			...
			while(colecaoIterator.hasNext()){
				...
				QuadroMetasAcumuladoHelper helper = (QuadroMetasAcumuladoHelper) colecaoIterator.next();

				relatorioQuadroMetasAcumuladoBean = new RelatorioQuadroMetasAcumuladoBean(helper);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_QUADRO_METAS_ACUMULADO, parametros, ds, tipoFormatoRelatorio);
