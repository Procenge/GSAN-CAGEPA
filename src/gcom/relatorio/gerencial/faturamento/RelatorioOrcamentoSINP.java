 ...
 * @created 22/11/2007
 */
public class RelatorioOrcamentoSINP
	...
	public Object executar() throws TarefaException{
		...
		FiltrarRelatorioOrcamentoSINPHelper filtro = (FiltrarRelatorioOrcamentoSINPHelper) getParametro("filtrarRelatorioOrcamentoSINPHelper");
		...
		Collection<OrcamentoSINPHelper> colecao = fachada.pesquisarRelatorioOrcamentoSINP(filtro);
		...
		if(colecao != null && !colecao.isEmpty()){
			...
			while(colecaoIterator.hasNext()){
				...
				OrcamentoSINPHelper helper = (OrcamentoSINPHelper) colecaoIterator.next();

				relatorioOrcamentoSINPBean = new RelatorioOrcamentoSINPBean(helper);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_ORCAMENTO_SINP, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.ORCAMENTO_SINP, idFuncionalidadeIniciada, null);
