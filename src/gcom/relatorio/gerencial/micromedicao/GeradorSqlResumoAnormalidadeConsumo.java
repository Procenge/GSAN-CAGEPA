...
public class GeradorSqlResumoAnormalidadeConsumo
				extends GeradorSqlResumoAnormalidadeLeitura {

	public GeradorSqlResumoAnormalidadeConsumo(InformarDadosGeracaoRelatorioConsultaHelper dadosFiltroHelper) {

		super(dadosFiltroHelper);
	}

	@Override
	protected String getNomeCampoAnomaliaSomatorio(){

		return "REAC_QTDLIGACAO";
	}

	@Override
	protected String getNomeCampoAnormalidadeDescricao(){

		return "CSAN_DSCONSUMOANORMALIDADE";
	}
	...
	protected String getNomeTabelaResumoAnormalidade(){
		...
		return "RESUMO_ANORMALIDADE_CONSUMO";
	}
