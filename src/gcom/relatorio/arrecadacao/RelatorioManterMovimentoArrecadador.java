...
public class RelatorioManterMovimentoArrecadador
	...
	public RelatorioManterMovimentoArrecadador(Usuario usuario) {
		...
		super(usuario, ConstantesRelatorios.RELATORIO_MOVIMENTO_ARRECADADOR_MANTER);
	}
	 ...
	 * @author Saulo Lima
	 * @date 06/01/2009
	 *       Alteração para verificar se o Ano/Mês Referência da Conta está nulo.
	 * @param bairros
	...
	public Object executar() throws TarefaException{
		...
		// getParametro("filtroArrecadadorMovimento");
		// ArrecadadorMovimento arrecadadorMovimentoParametrosInicial = (ArrecadadorMovimento)
		// getParametro("arrecadadorMovimentoParametrosInicial");
		// ArrecadadorMovimento arrecadadorMovimentoParametrosFinal = (ArrecadadorMovimento)
		// getParametro("arrecadadorMovimentoParametrosFinal");
		Arrecadador arrecadadorParametros = (Arrecadador) getParametro("arrecadadorParametros");
		// String movimentoAbertoFechado = (String) getParametro("movimentoAbertoFechado");
		// String itemEmOcorrencia = (String) getParametro("itemEmOcorrencia");
		// String itemNaoAceito = (String) getParametro("itemNaoAceito");
		...
		String idConcessionaria = (String) getParametro("idConcessionaria");
		...
		// filtroArrecadadorMovimento.setCampoOrderBy(
		// FiltroArrecadadorMovimento.BANCO,
		// FiltroArrecadadorMovimento.DATA_GERACAO);

		Collection colecaoArrecadadorMovimento = fachada.filtrarMovimentoArrecadadorParaRelatorio(codigoBanco, codigoRemessa,
						descricaoIdentificacaoServico, numeroSequencialArquivo, dataGeracaoInicio, dataGeracaoFim, ultimaAlteracaoInicio,
						ultimaAlteracaoFim, descricaoOcorrencia, indicadorAceitacao, indicadorAbertoFechado, idConcessionaria);

		// se a coleção de parâmetros da analise não for vazia
		if(colecaoArrecadadorMovimento != null && !colecaoArrecadadorMovimento.isEmpty()){
			// coloca a coleção de parâmetros da analise no iterator
			Iterator colecaoArrecadadorMovimentoIterator = colecaoArrecadadorMovimento.iterator();
			...
			while(colecaoArrecadadorMovimentoIterator.hasNext()){
				 ...
				 */
				Integer numeroRegistrosOcorrencia = fachada.obterNumeroRegistrosEmOcorrenciaPorMovimentoArrecadadores(arrecadadorMovimento,
								ConstantesSistema.OK);
				 ...
				 * (NÃO))
				 */
				Integer numeroRegistrosNaoAceitos = fachada.obterNumeroRegistrosNaoAceitosPorMovimentoArrecadadores(arrecadadorMovimento,
								ConstantesSistema.REGISTROS_NAO_ACEITOS);

				// Pesquisa a coleção de itens do movimento arrecadador
				Collection colecaoItensArrecadadorMovimento = fachada.consultarItensMovimentoArrecadador(arrecadadorMovimento, null, null,
								null);

				if(colecaoItensArrecadadorMovimento != null && !colecaoItensArrecadadorMovimento.isEmpty()){

					Collections.sort((List) colecaoItensArrecadadorMovimento, new Comparator() {

						public int compare(Object a, Object b){

							String chave1 = ((ArrecadadorMovimentoItemHelper) a).getIdentificacao();
							String chave2 = ((ArrecadadorMovimentoItemHelper) b).getIdentificacao();
					...
					Iterator colecaoItensArrecadadorMovimentoIterator = colecaoItensArrecadadorMovimento.iterator();

					while(colecaoItensArrecadadorMovimentoIterator.hasNext()){

						ArrecadadorMovimentoItemHelper arrecadadorMovimentoItemHelper = (ArrecadadorMovimentoItemHelper) colecaoItensArrecadadorMovimentoIterator
										.next();
						...
						// Verifica o Tipo do Movimento Arrecador e seta os valores de acordo com
						// cada tipo
						if(arrecadadorMovimentoItemHelper.getRegistroHelperCodigoB() != null){
							...
							if(arrecadadorMovimentoItemHelper.getRegistroHelperCodigoF().getAnoMesReferenciaConta() != null
											&& !arrecadadorMovimentoItemHelper.getRegistroHelperCodigoF().getAnoMesReferenciaConta()
															.equals("")){
								anoMes = Util.formatarAnoMesParaMesAno(arrecadadorMovimentoItemHelper.getRegistroHelperCodigoF()
							...
							// arrecadadorMovimentoItemHelper.getRegistroHelperCodigoG().getIdAgenciaContaDigito();
						...
						// Dados do Movimento:
										...
										// Código Arrecadador
										arrecadadorMovimento.getCodigoBanco() == null ? "" : arrecadadorMovimento.getCodigoBanco()
														.toString(),
										...
										// Remessa
										arrecadadorMovimento.getCodigoRemessa() == null ? "" : arrecadadorMovimento.getCodigoRemessa()
														.toString(),
										...
										// Data Geração
										arrecadadorMovimento.getDataGeracao() == null ? "" : Util.formatarData(arrecadadorMovimento
														.getDataGeracao()),

										// Data Processamento
										arrecadadorMovimento.getUltimaAlteracao() == null ? "" : Util
														.formatarDataComHora(arrecadadorMovimento.getUltimaAlteracao()),

										// Valor Movimento
										arrecadadorMovimento.getValorTotalMovimento() == null ? "" : Util
										...
										arrecadadorMovimentoItemHelper.getIdentificacao(),
										...
										// Data Pagamento
										arrecadadorMovimentoItemHelper.getRegistroHelperCodigoG() == null ? "" : Util
														.formatarData(arrecadadorMovimentoItemHelper.getRegistroHelperCodigoG()
																		.getDataPagamento()),
										...
										// Código Barras
										arrecadadorMovimentoItemHelper.getRegistroHelperCodigoG() == null ? ""
														: arrecadadorMovimentoItemHelper.getRegistroHelperCodigoG().getCodigoBarras(),

										// Forma Arrecadação
										arrecadadorMovimentoItemHelper.getRegistroHelperCodigoG() == null ? ""
														: arrecadadorMovimentoItemHelper.getRegistroHelperCodigoG().getFormaArrecadacao(),
										...
										// Total de Registros
										arrecadadorMovimento.getNumeroRegistrosMovimento() == null ? "" : arrecadadorMovimento
														.getNumeroRegistrosMovimento().toString(),

										// Número de Movimentos em Ocorrência
										numeroRegistrosOcorrencia == null ? "" : numeroRegistrosOcorrencia.toString(),

										// Número de Movimentos Não Aceitos
										numeroRegistrosNaoAceitos == null ? "" : numeroRegistrosNaoAceitos.toString());

						/*
						 * Pesquisa os pagamentos para este arrecadadorMovimentoItem e caso exista,
						 * recupera a quantidade de parcelas pagas
						 */
						...
						filtroPagamento.adicionarParametro(new ParametroSimples(FiltroPagamento.ARRECADADOR_MOVIMENTO_ITEM_ID,
										arrecadadorMovimentoItemHelper.getId()));
						Collection colecaoPagamento = fachada.pesquisar(filtroPagamento, Pagamento.class.getName());
						if(colecaoPagamento != null && !colecaoPagamento.isEmpty()){
							...
							numeroPrestacao = String
											.valueOf((pagamento.getNumeroPrestacao() != null ? pagamento.getNumeroPrestacao() : ""));
						}
						relatorioBean.setNumeroPrestacao(numeroPrestacao);
		...
		if(descricaoIdentificacaoServico != null && !descricaoIdentificacaoServico.equals("")){
			if(descricaoIdentificacaoServico.equals(ConstantesSistema.DEBITO_AUTOMATICO)){
				identificaoServico = "DÉBITO AUTOMATICO";
			}else if(descricaoIdentificacaoServico.equals(ConstantesSistema.CODIGO_DE_BARRAS)){
		...
		if(ultimaAlteracaoInicio != null){
			...
			parametros.put("periodoProcessamentoInicial", Util.formatarData(ultimaAlteracaoInicio));
		...
		if(ultimaAlteracaoFim != null){
			...
			parametros.put("periodoProcessamentoFinal", Util.formatarData(ultimaAlteracaoFim));
		...
		if(indicadorAceitacao != null && !indicadorAceitacao.equals("")){
			...
			}else if(indicadorAceitacao.equals("" + ConstantesSistema.SEM_ITENS)){
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_MOVIMENTO_ARRECADADOR_MANTER, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MANTER_MOVIMENTO_ARRECADADOR, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		retorno = Fachada.getInstancia().filtrarMovimentoArrecadadoresRelatorioCount(codigoBanco, codigoRemessa,
						descricaoIdentificacaoServico, numeroSequencialArquivo, dataGeracaoInicio, dataGeracaoFim, ultimaAlteracaoInicio,
						ultimaAlteracaoFim, descricaoOcorrencia, indicadorAceitacao, indicadorAbertoFechado, idConcessionaria);
	...
	public void agendarTarefaBatch(){
		...
		AgendadorTarefas.agendarTarefa("RelatorioManterMovimentoArrecadador", this);
	}
