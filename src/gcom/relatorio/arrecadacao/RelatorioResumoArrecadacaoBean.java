...
public class RelatorioResumoArrecadacaoBean
	...
	public RelatorioResumoArrecadacaoBean(BigDecimal[] valorItemArrecadacao, String descricaoTipoRecebimento,
											String descricaoTipoLancamento, String descricaoItemLancamento, String descricaoItemContabil,
											Short indicadorImpressao, Short indicadorTotal, Integer lancamentoTipo,
											Integer lancamentoTipoSuperior, boolean tipoLancamentoSemItem, String descricaoGerencia,
											String gerencia, String descricaoLocalidade, String localidade,
											String descLancamentoTipoSuperior, String descricaoUnidadeNegocio, String unidadeNegocio,
											Integer codigoSetorComercial, String descricaoSetorComercial) {
	...
	public BigDecimal getValorItemArrecadacao4(){
		...
		return this.getValorItemArrecadacao1().add(getValorItemArrecadacao2()).add(getValorItemArrecadacao3());
	}
	...
	public BigDecimal getSomaValoresItemArrecadacao(){
		...
		return this.getValorItemArrecadacao4().add(getValorItemArrecadacao5());

	}

	public void setSomaValoresItemArrecadacao(BigDecimal somaValoresItemArrecadacao){
