 ...
 */
public class RelatorioMovimentoDebitoAutomaticoBanco
	...
	public Object executar() throws TarefaException{
		...
		if(colecaoMovimentoDebitoAutomaticoBanco != null && !colecaoMovimentoDebitoAutomaticoBanco.isEmpty()){
			// coloca a coleção de parâmetros do Movimento Debito Automatico
			// Banco no iterator
			Iterator movimentoDebitoAutomaticoBancoIterator = colecaoMovimentoDebitoAutomaticoBanco.iterator();
			...
			while(movimentoDebitoAutomaticoBancoIterator.hasNext()){
				...
				relatorioMovimentoDebitoAutomaticoBancoBean = new RelatorioMovimentoDebitoAutomaticoBancoBean(""
								+ gerarMovimentoDebitoAutomaticoBancoHelper.getBanco().getId(), gerarMovimentoDebitoAutomaticoBancoHelper
								.getBanco().getDescricao(), ""
								+ gerarMovimentoDebitoAutomaticoBancoHelper.getArrecadadorMovimento().getNumeroSequencialArquivo(), ""
								+ gerarMovimentoDebitoAutomaticoBancoHelper.getArrecadadorMovimento().getNumeroRegistrosMovimento(), Util
								.formatarMoedaReal(gerarMovimentoDebitoAutomaticoBancoHelper.getArrecadadorMovimento()
												.getValorTotalMovimento()), gerarMovimentoDebitoAutomaticoBancoHelper.getDescricaoEmail(),
								gerarMovimentoDebitoAutomaticoBancoHelper.getSituacaoEnvioEmail());
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_MOVIMENTO_DEBITO_AUTOMATICO_BANCO, parametros, ds,
						tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.MOVIMENTO_DEBITO_AUTOMATICO_BANCO, idFuncionalidadeIniciada, null);
