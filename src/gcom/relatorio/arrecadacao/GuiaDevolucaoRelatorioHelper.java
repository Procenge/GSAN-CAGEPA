...
public class GuiaDevolucaoRelatorioHelper {
	...
	public GuiaDevolucaoRelatorioHelper(Integer sequencial, BigDecimal valorDevolucao, Integer idRegistroAtendimento, String observacao,
										Integer idMatriculaImovel, Integer idCliente, String nomeCliente, String cpfCliente,
										String cnpjCliente, String identidadeCliente, String orgaoExpedidor, String unidadeFederacao,
										String funcionarioAnalista, String funcionarioAutorizador, String usuario, Date dataValidade) {
	...
	public String getMatriculaFormatada(){
		...
		matriculaFormatada = matriculaFormatada.substring(0, 8) + "." + matriculaFormatada.substring(8, 9);
