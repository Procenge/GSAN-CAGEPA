...
public class RelatorioResumoArrecadacao
	...
	private Collection<RelatorioResumoArrecadacaoBean> inicializarBeanRelatorio(Collection listaCamposConsultaRelatorio){
		...
		while(iterator.hasNext()){
			ResumoArrecadacaoRelatorioHelper resumoArrecadacaoRelatorioHelper = (ResumoArrecadacaoRelatorioHelper) iterator.next();

			RelatorioResumoArrecadacaoBean relatorioResumoArrecadacaoBean = new RelatorioResumoArrecadacaoBean(
							resumoArrecadacaoRelatorioHelper.getValorItemArrecadacao(), resumoArrecadacaoRelatorioHelper
											.getDescricaoTipoRecebimento(), resumoArrecadacaoRelatorioHelper.getDescricaoTipoLancamento(),
							resumoArrecadacaoRelatorioHelper.getDescricaoItemLancamento(), resumoArrecadacaoRelatorioHelper
											.getDescricaoItemContabil(), resumoArrecadacaoRelatorioHelper.getIndicadorImpressao(),
							resumoArrecadacaoRelatorioHelper.getIndicadorTotal(), resumoArrecadacaoRelatorioHelper.getLancamentoTipo(),
							resumoArrecadacaoRelatorioHelper.getLancamentoTipoSuperior(), false, resumoArrecadacaoRelatorioHelper
											.getDescricaoGerencia(), resumoArrecadacaoRelatorioHelper.getGerencia(),
							resumoArrecadacaoRelatorioHelper.getDescricaoLocalidade(), resumoArrecadacaoRelatorioHelper.getLocalidade(),
							resumoArrecadacaoRelatorioHelper.getDescLancamentoTipoSuperior(), resumoArrecadacaoRelatorioHelper
											.getDescricaoUnidadeNegocio(), resumoArrecadacaoRelatorioHelper.getUnidadeNegocio(),
							resumoArrecadacaoRelatorioHelper.getCodigoSetorComercial(), resumoArrecadacaoRelatorioHelper
	...
	public Object executar() throws TarefaException{
		...
		Integer idSetorComercial = (Integer) getParametro("idSetorComercial");
		...
		Collection dadosRelatorio = fachada.consultarResumoArrecadacaoRelatorio(opcaoTotalizacao, mesAno, codigoGerencia, codigoLocalidade,
						unidadeNegocio, idSetorComercial);
		...
		for(Iterator<RelatorioResumoArrecadacaoBean> iter = colecaoBean.iterator(); iter.hasNext();){
			...
			// Se o indicador total estiver setado então a linha de
			// detalhe aparecerá no relatório como 'TOTAL'
			// if (bean.getIndicadorTotal() != null && bean.getIndicadorTotal().equals(new
			// Short("1"))
			// && bean.getDescricaoItemContabil() != null) {
			// bean.setDescricaoItemContabil("TOTAL");
			// }
		...
		retorno = this.gerarRelatorio(ConstantesRelatorios.RELATORIO_RESUMO_ARRECADACAO, parametros, ds, tipoFormatoRelatorio);

		// ------------------------------------
		// Grava o relatório no sistema
		try{
			persistirRelatorioConcluido(retorno, Relatorio.RESUMO_ARRECADACAO, idFuncionalidadeIniciada, null);
	...
	public int calcularTotalRegistrosRelatorio(){
		...
		totalRegistrosRel = fachada.consultarQtdeRegistrosResumoArrecadacaoRelatorio(opcaoTotalizacao, mesAno, idGerencia, idLocalidade,
						idSetorComercial);
