...
public class RelatorioOperacao
	...
	private Collection<RelatorioOperacaoBean> inicializarBeanRelatorio(Collection dadosRelatorio){
		...
		while(iterator.hasNext()){
			...
			Collection tabelaLinhaColunaAlteracoes = Fachada.getInstancia().pesquisar(filtroTabelaLinhaColunaAlteracao,
	...
	public Object executar() throws TarefaException{
		...
		Integer idOperacao = (Integer) getParametro("idOperacao");
		...
		Date horaInicial = (Date) getParametro("horaInicial");
		Date horaFinal = (Date) getParametro("horaFinal");
		...
		Collection dadosRelatorio = null;
		// Collection dadosRelatorio =
		// Fachada.getInstancia().pesquisarUsuarioAlteracaoDasOperacoesEfetuadasHqlRelatorio(idUsuarioAcao,
		// idOperacao, idUsuario,dataInicial, dataFinal, horaInicial, horaFinal, idTabela,
		// idTabelaColuna, id1);
