...
public class RelatorioEvolucaoContasAReceberContabilHelper {
	...
	public RelatorioEvolucaoContasAReceberContabilHelper(String tipoGrupo, String descricaoGrupo, int ordemGrupo,
															String descricaoElementoGrupo, int sequenciaTipoLancamento,
															String descricaoLancamento, String idCategoriaTipo, BigDecimal valorItem) {
