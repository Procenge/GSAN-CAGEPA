...
public class RelatorioResumoDevedoresDuvidososBean
	...
	public RelatorioResumoDevedoresDuvidososBean(BigDecimal[] valorItemDevedoresDuvidosos, String descricaoTipoLancamento,
													String descricaoItemLancamento, String descricaoItemContabil, Short indicadorImpressao,
													Short indicadorTotal, Integer lancamentoTipo, Integer lancamentoTipoSuperior,
													boolean tipoLancamentoSemItem, String descricaoGerencia, String gerencia,
													String descricaoLocalidade, String localidade, String descLancamentoTipoSuperior,
													String descricaoUnidadeNegocio, String unidadeNegocio) {
	...
	public BigDecimal getSomaValoresItemDevedoresDuvidosos(){
		...
		return this.getValorItemDevedoresDuvidosos4().add(getValorItemDevedoresDuvidosos5());
	}
	...
	public BigDecimal getValorItemDevedoresDuvidosos4(){
		...
		return this.getValorItemDevedoresDuvidosos1().add(getValorItemDevedoresDuvidosos2()).add(getValorItemDevedoresDuvidosos3());
	}
