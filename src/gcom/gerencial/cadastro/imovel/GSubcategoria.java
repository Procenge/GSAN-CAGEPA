...
public class GSubcategoria
	...
	/** full constructor */
	public GSubcategoria(int codigo, String descricao, Short indicadorUso, Date ultimaAlteracao, GCategoria gCategoria,
							Set unResumoColetaEsgotos, Set unResumoConsumoAguas, Set unResumoFaturamentos, Set unResumoArrecadacao,
							Set unResumoLigacaoEconomias, Set rgResumoLigacaoEconomias) {
	...
	/** minimal constructor */
	public GSubcategoria(int codigo, String descricao, GCategoria gCategoria, Set unResumoColetaEsgotos, Set unResumoConsumoAguas,
							Set unResumoFaturamentos, Set unResumoArrecadacao, Set unResumoLigacaoEconomias, Set rgResumoLigacaoEconomias) {
