 ...
 */
public class RepositorioGerencialImovelHBM
				implements IRepositorioGerencialImovel {
	...
	public Collection pesquisarObterQuantidadeEconomiasCategoria(Integer imovel) throws ErroRepositorioException{
		...
		try{
			consulta = "select c.id, c.descricao, c.consumoEstouro, "
							...
							+ "group by c.id, c.descricao, c.consumoEstouro, c.vezesMediaEstouro, isb.comp_id.imovel.id, c.consumoAlto, c.mediaBaixoConsumo, c.vezesMediaAltoConsumo, c.porcentagemMediaBaixoConsumo,c.descricaoAbreviada,c.numeroConsumoMaximoEc, c.indicadorCobrancaAcrescimos "
	...
	public Collection obterSubCategoriasPorCategoria(Integer idCategoria) throws ErroRepositorioException{
		...
		try{
			...
			String hql = "select new ImovelSubCategoria(" + "imovelSubCategoria.id, " + "imovelSubCategoria.quantidadeEconomias, "
							+ "subCimovelSubCategoriaategoria.ultimaAlteracao) " + "from ImovelSubCategoria imovelSubCategoria "
