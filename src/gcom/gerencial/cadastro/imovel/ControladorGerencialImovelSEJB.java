 ...
 */
public class ControladorGerencialImovelSEJB
	 ...
	 * Collection<GCategoria> colecaoCategoriasImovel =
	 * this.obterQuantidadeEconomiasCategoria(idImovel);
	 ...
	 * } else if (quantidadeCategoria ==
	 * categoriaImovel.getQuantidadeEconomiasCategoria().intValue()) {
	 * colecaoCategoriasComMaiorQtdEconomias.add(categoriaImovel);
	 * }
	 * }
	 * }
	 ...
	 */
	/*
	 * public ImovelSubcategoria obterPrincipalSubcategoria(Integer idCategoria) throws
	 ...
	 */
	/*
	 * public Collection obterQuantidadeEconomiasCategoria(Integer imovel) throws
	 * ControladorException {
	 * Collection colecaoCategoria = new ArrayList();
	 * Collection colecaoImovelSubCategoriaArray = null;
	 * try {
	 * colecaoImovelSubCategoriaArray =
	 * gRepositorioImovel.pesquisarObterQuantidadeEconomiasCategoria(imovel);
	 * } catch (ErroRepositorioException ex) {
	 * throw new ControladorException("erro.sistema", ex);
	 * }
