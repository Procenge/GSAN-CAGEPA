...
public class UnResumoIndicadorLigacaoEconomiaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("id", getId()).append("idMesAno", getIdMesAno()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getId(), castOther.getId()).append(this.getIdMesAno(), castOther.getIdMesAno()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getId()).append(getIdMesAno()).toHashCode();
	}
