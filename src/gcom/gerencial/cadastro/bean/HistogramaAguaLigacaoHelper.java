...
public class HistogramaAguaLigacaoHelper {
	...
	public HistogramaAguaLigacaoHelper(Integer anoMesReferencia, Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idElo,
										...
										Integer idSituacaoLigacaoAgua, Short idConsumoReal, Short idExistenciaHidrometro,
										Short idExistenciaPoco, Short idExistenciaVolumeFixoAgua, Integer quantidadeConsumo) {
	...
	public HistogramaAguaLigacao gerarHistogramaAguaLigacao(){

		HistogramaAguaLigacao retorno = new HistogramaAguaLigacao();
