...
public class ResumoMetasHelper {
	...
	public void setQuantidadeLigacoesAtivasDebito3M(Integer quantidadeLigacoesAtivasDebito3M){
	...
	public void setQuantidadeLigacoesConsumoAte5M3(Integer quantidadeLigacoesConsumoAte5M3){
	...
	public void setQuantidadeLigacoesConsumoMedio(Integer quantidadeLigacoesConsumoMedio){
	 ...
	 */
	public ResumoMetasHelper(Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idLocalidade, Integer idElo,
								Integer idSetorComercial, Integer idRota, Integer idQuadra, Integer codigoSetorComercial,
								Integer numeroQuadra, Integer idImovelPerfil, Integer idSituacaoLigacaoAgua,
								Integer idSituacaoLigacaoEsgoto, Integer idPerfilLigacaoAgua, Integer idPerfilLigacaoEsgoto,
								Date dataLigacao, Date dataSupressao, Date dataCorte, Date dataReligacao, Date dataRestabelecimentoAgua,
								Integer idHidrometroInstalado) {
	...
	public boolean equals(Object obj){
		...
		if(!(obj instanceof ResumoMetasHelper)){
			...
			return propriedadesIguais(this.idGerenciaRegional, resumoTemp.idGerenciaRegional)
							...
							&& propriedadesIguais(this.idRota, resumoTemp.idRota) && propriedadesIguais(this.idQuadra, resumoTemp.idQuadra)
							...
							&& propriedadesIguais(this.codigoGrupoSubcategoria, resumoTemp.getCodigoGrupoSubcategoria());
		}
	}
	...
	public void setarTipoData(Date dataInicial, Date dataFinal){
		...
		int i = 0;
		if(this.dataLigacao != null && (this.dataLigacao.after(dataInicial) && this.dataLigacao.before(dataFinal))){
			tiposDataAux[i] = INIDCADOR_DATA_LIGACAO;
			i++;
		}
		if(this.dataSupressao != null && (this.dataSupressao.after(dataInicial) && this.dataSupressao.before(dataFinal))){
			tiposDataAux[i] = INIDCADOR_DATA_SUPRESSAO;
			i++;
		}
		if(this.dataCorte != null && (this.dataCorte.after(dataInicial) && this.dataCorte.before(dataFinal))){
			tiposDataAux[i] = INIDCADOR_DATA_CORTE;
			i++;
		}
		if(this.dataReligacao != null && (this.dataReligacao.after(dataInicial) && this.dataReligacao.before(dataFinal))){
			tiposDataAux[i] = INIDCADOR_DATA_RELIGACAO;
			i++;

		}
		if(this.dataRestabelecimentoAgua != null
						&& (this.dataRestabelecimentoAgua.after(dataInicial) && this.dataRestabelecimentoAgua.before(dataFinal))){
