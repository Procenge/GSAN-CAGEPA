...
public class HistogramaEsgotoEconomiaHelper {
	...
	public HistogramaEsgotoEconomiaHelper(Integer anoMesReferencia, Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idElo,
											...
											Integer idPerfilImovel, Integer idEsferaPoder, Integer idSituacaoLigacaoEsgoto,
											Short idConsumoReal, Short idExistenciaHidrometro, Short idExistenciaPoco,
											Short idExistenciaVolumeFixoEsgoto, Short percentualEsgoto, Integer quantidadeConsumo,
	...
	public HistogramaEsgotoEconomia gerarHistogramaEsgotoEconomia(){

		HistogramaEsgotoEconomia retorno = new HistogramaEsgotoEconomia();
		...
		retorno.setIndicadorVolumeFixadoEsgoto(((this.getIdExistenciaVolumeFixoEsgoto()) != null) ? this.getIdExistenciaVolumeFixoEsgoto()
						.shortValue() : null);
		retorno.setPercentualEsgoto(((this.getPercentualEsgoto()) != null) ? this.getPercentualEsgoto().shortValue() : null);
