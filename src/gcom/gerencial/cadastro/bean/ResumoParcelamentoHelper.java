...
public class ResumoParcelamentoHelper {
	...
	public void setVlDebitosACobrarParcelamentos(BigDecimal vlDebitosACobrarParcelamentos){
	...
	public void setVlDebitosACobrarReligSancoes(BigDecimal vlDebitosACobrarReligSancoes){
	 ...
	 */
	public ResumoParcelamentoHelper(Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idElo, Integer idLocalidade,
									...
									Integer consumoTarifa, Short indicadorHidrometro, Short numeroParcelamentoConsecutivos) {
	...
	public boolean equals(Object obj){
		...
		if(!(obj instanceof ResumoParcelamentoHelper)){
			...
			return propriedadesIguais(this.idGerenciaRegional, resumoTemp.idGerenciaRegional)
							...
							&& propriedadesIguais(this.numeroParcelamentoConsecutivos.intValue(), resumoTemp.numeroParcelamentoConsecutivos
											.intValue());
		}
	}
	...
	public void setNumeroParcelamentoConsecutivos(Short numeroParcelamentoConsecutivos){
