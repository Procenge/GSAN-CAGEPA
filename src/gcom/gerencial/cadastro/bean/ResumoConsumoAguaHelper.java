...
public class ResumoConsumoAguaHelper {
	...
	public void setQuantidadeConsumoAguaExcedente(Integer quantidadeConsumoAguaExcedente){
	 ...
	 */
	public ResumoConsumoAguaHelper(Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idLocalidade, Integer idElo,
									...
									Integer idTipoConsumo, Integer qtdConsumoAgua) {
		...
		this.quantidadeConsumoAgua = qtdConsumoAgua;
	}
