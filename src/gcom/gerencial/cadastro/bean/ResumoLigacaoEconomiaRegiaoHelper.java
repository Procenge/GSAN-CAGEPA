...
public class ResumoLigacaoEconomiaRegiaoHelper {
	...
	public ResumoLigacaoEconomiaRegiaoHelper(Integer idRegiao, Integer idMicrorregiao, Integer idMunicipio, Integer idBairro,
												...
												Integer idPerfilLigacaoEsgoto, Integer idIndicadorHidrometro,
												Integer idIndicadorHidrometroPoco, Integer idIndicadorVolumeMinimoAguaFixado,
												Integer idIndicadorVolumeMinimoEsgotoFixado, Integer idIndicadorPoco) {
	...
	public void setIdIndicadorVolumeMinimoAguaFixado(Integer idIndicadorVolumeMinimoAguaFixado){
	...
	public void setIdIndicadorVolumeMinimoEsgotoFixado(Integer idIndicadorVolumeMinimoEsgotoFixado){
	 ...
	 * @date 16/04/2007
	 * @param object
	 *            Objeto a ser comparado com essa instancia
	 * @return
	 */
	...
	public boolean equals(Object object){
		...
		if(object instanceof ResumoLigacaoEconomiaRegiaoHelper){
			...
			return propriedadesIguais(rsmTemp.getIdRegiao(), this.getIdRegiao())
							...
							&& propriedadesIguais(rsmTemp.getIdIndicadorVolumeMinimoAguaFixado(), this
											.getIdIndicadorVolumeMinimoAguaFixado())
							&& propriedadesIguais(rsmTemp.getIdIndicadorVolumeMinimoEsgotoFixado(), this
