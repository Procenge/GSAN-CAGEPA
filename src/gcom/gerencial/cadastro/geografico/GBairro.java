...
public class GBairro
	...
	/** full constructor */
	public GBairro(int codigoBairro, String nomeBairro, Integer codigoBairroPrefeitura, Short indicadorUso, Date ultimaAlteracao,
					GMunicipio gMunicipio, Set unResumoLigacaoEconomiasRegiao) {
