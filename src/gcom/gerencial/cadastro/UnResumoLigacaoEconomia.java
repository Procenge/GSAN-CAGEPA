...
public class UnResumoLigacaoEconomia
	...
	/** full constructor */
	public UnResumoLigacaoEconomia(int referencia, GGerenciaRegional gGerenciaRegional,
									gcom.gerencial.cadastro.localidade.GUnidadeNegocio gUnidadeNegocio, GLocalidade gLocalidade,
									GLocalidade gLocalidadeElo, GSetorComercial gSetorComercial, GRota gRota, GQuadra gQuadra,
									int codigoSetorComercial, int numeroQuadra, GImovelPerfil gImovelPerfil, GEsferaPoder gEsferaPoder,
									...
									short indicadorHidrometro, short indicadorHidrometroPoco, short indicadorVolumeFixadoagua,
									short indicadorVolumeFixadoEsgoto, short indicadorPoco, GConsumoTarifa gerConsumoTarifa,
									int quantidadeLigacoes, int quantidadeEconomias) {
