...
public class RgResumoLigacaoEconomia
	...
	/** full constructor */
	public RgResumoLigacaoEconomia(int referencia, short indicadorHidrometro, short volumeFixadoAgua, short indicadorVolumeFixadoEsgoto,
									short indicadorPoco, int quantidadeLigacoes, int quantidadeEconomias, Date ultimaAlteracao,
									GMunicipio gMunicipio, GSubcategoria gSubcategoria, GClienteTipo gClienteTipo,
									GLigacaoAguaSituacao gLigacaoAguaSituacao, GLigacaoEsgotoSituacao gLigacaoEsgotoSituacao,
									GLigacaoEsgotoPerfil gLigacaoEsgotoPerfil, GRegiao gRegiao, GBairro gBairro,
									GLigacaoAguaPerfil gLigacaoAguaPerfil, GEsferaPoder gEsferaPoder, GMicrorregiao gMicrorregiao,
									GCategoria gCategoria, GImovelPerfil gImovelPerfil) {
