...
public class UnResumoConsumoAgua
	...
	/** full constructor */
	public UnResumoConsumoAgua(int referencia, GGerenciaRegional gGerenciaRegional, GUnidadeNegocio gUnidadeNegocio,
								GLocalidade gLocalidade, GLocalidade gLocalidadeElo, GSetorComercial gSetorComercial, GRota gRota,

								GQuadra gQuadra, int codigoSetorComercial, int numeroQuadra, GImovelPerfil gImovelPerfil,
								...
								GConsumoTipo gConsumoTipo, int consumoAgua, int quantidadeLigacoes, int quantidadeEconomias,
