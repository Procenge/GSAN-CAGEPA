...
public class GSetorComercial
	...
	/** full constructor */
	public GSetorComercial(int codigo, String descricao, Short indicadorUso, Date ultimaAlteracao,
							gcom.gerencial.cadastro.localidade.GLocalidade gLocalidade, Set unResumoColetaEsgotos,
							Set unResumoConsumoAguas, Set unResumoFaturamentos, Set UnResumoArrecadacao, Set unResumoLigacaoEconomias,
							Set gRotas, Set gQuadras) {
	...
	/** minimal constructor */
	public GSetorComercial(int codigo, String descricao, gcom.gerencial.cadastro.localidade.GLocalidade gLocalidade,
							Set unResumoColetaEsgotos, Set unResumoConsumoAguas, Set unResumoFaturamentos, Set UnResumoArrecadacao,
							Set unResumoLigacaoEconomias, Set gRotas, Set gQuadras) {
