...
public class GQuadra
	...
	/** full constructor */
	public GQuadra(int numeroQuadra, Short indicadorRedeAgua, Short indicadorRedeEsgoto, Short numeroRotaSequencia, Date dataImplantacao,
					Short indicadorUso, Date ultimaAlteracao, gcom.gerencial.cadastro.localidade.GSetorComercial gSetorComercial,
					GRota gRota, Set unResumoColetaEsgotos, Set unResumoConsumoAguas, Set unResumoFaturamentos, Set unResumoArrecadacao,
					Set unResumoLigacaoEconomias) {
	...
	/** minimal constructor */
	public GQuadra(int numeroQuadra, gcom.gerencial.cadastro.localidade.GSetorComercial gSetorComercial, GRota gRota,
					Set unResumoColetaEsgotos, Set unResumoConsumoAguas, Set unResumoFaturamentos, Set unResumoArrecadacao,
					Set unResumoLigacaoEconomias) {
