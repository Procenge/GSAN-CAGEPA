...
public class UnResumoIndicadorLigacaoEconomia
	...
	/** full constructor */
	public UnResumoIndicadorLigacaoEconomia(gcom.gerencial.cadastro.UnResumoIndicadorLigacaoEconomiaPK comp_id, int anoMesReferencia,
											String anoReferencia, String mesReferencia, int codigoSetorComercial, int numeroQuadra,
											short indicadorHidrometro, short indicadorVolumeFixadoAgua, short indicadorVolumeFixadoEsgoto,
											short indicadorPoco, short indicadorHidrometroPoco, int quantidadeLigacoesAtivasAgua,
											int quantidadeLigacoesAtivasAguaMesAno, int quantidadeLigacoesAtivasEsgoto,
											int quantidadeLigacoesAtivasEsgotoMesAno, int quantidadeEconomiasTotaisAgua,
											int quantidadeEconomiasTotaisAguaMesAno, int quantidadeEconomiasTotaisEsgoto,
											int quantidadeEconomiasTotaisEsgotoMesAno, int quantidadeClientesAguaPotenciaisFactiveis,
											int quantidadeClientesAguaLigadosCortados, int quantidadeClientesAguaSuprimidos,
											int quantidadeEconomiasAguaPotenciaisFactiveis, int quantidadeEconomiasAguaLigadosCortados,
											int quantidadeEconomiasAguaSuprimidos, int quantidadeClientesEsgotoPotenciaisFactiveis,
											int quantidadeClientesEsgotoLigados, int quantidadeClientesEsgotoLigadosForaUso,
											int quantidadeEconomiasEsgotoPotenciaisFactiveis, int quantidadeEconomiasEsgotoLigados,
											int quantidadeEconomiasEsgotoLigadosForaUso, Date ultimaAlteracao,
											...
											GLocalidade gerLocalidade, GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil,
											GConsumoTarifa gerConsumoTarifa, GEsferaPoder gerEsferaPoder, GCategoria gerCategoria,
											GRota gerRota) {
