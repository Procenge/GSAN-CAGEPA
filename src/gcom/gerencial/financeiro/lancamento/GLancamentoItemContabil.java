...
public class GLancamentoItemContabil
	...
	/** persistent field */
	private Set unResumoFaturamentoOutros;
	...
	public GLancamentoItemContabil(String grupocontabil, String descricaoAbreviado, Short sequenciaImpressao, Date ultimaAlteracao,
									Set unResumoArrecadacaoCreditos, Set unResumoArrecadacaoOutros, Set unResumoFaturamentoOutros,
									Set unResumoFaturamentoCreditos) {
		...
		this.unResumoFaturamentoOutros = unResumoFaturamentoOutros;
		this.unResumoFaturamentoCreditos = unResumoFaturamentoCreditos;
	}
	...
	/** minimal constructor */
	public GLancamentoItemContabil(String grupocontabil, String descricaoAbreviado, Date ultimaAlteracao, Set unResumoArrecadacaoCreditos,
									Set unResumoArrecadacaoOutros, Set unResumoFaturamentoOutros, Set unResumoFaturamentoCreditos) {
	...
	public Set getUnResumoArrecadacaoCreditos(){
		...
		return this.unResumoArrecadacaoCreditos;
	}
	...
	public Set getUnResumoArrecadacaoOutros(){
		...
		return this.unResumoArrecadacaoOutros;
	}
	...
	public Set getUnResumoFaturamentoOutros(){

		return this.unResumoFaturamentoOutros;
	}

	public void setUnResumoFaturamentoOutros(Set unResumoFaturamentoOutros){

		this.unResumoFaturamentoOutros = unResumoFaturamentoOutros;
	}

	public Set getUnResumoFaturamentoCreditos(){

		return this.unResumoFaturamentoCreditos;
	}

	public void setUnResumoFaturamentoCreditos(Set unResumoFaturamentoCreditos){
