...
public class UnResumoArrecadacaoOutroPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("resumoArrecadacao", getResumoArrecadacao()).append("financiamentoTipo",
						getFinanciamentoTipo()).append("lancamentoItemContabil", getLancamentoItemContabil()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getResumoArrecadacao(), castOther.getResumoArrecadacao()).append(
						this.getFinanciamentoTipo(), castOther.getFinanciamentoTipo()).append(this.getLancamentoItemContabil(),
						castOther.getLancamentoItemContabil()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getResumoArrecadacao()).append(getFinanciamentoTipo()).append(getLancamentoItemContabil())
						.toHashCode();
	}
