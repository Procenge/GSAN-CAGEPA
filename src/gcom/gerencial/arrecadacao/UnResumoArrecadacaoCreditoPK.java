...
public class UnResumoArrecadacaoCreditoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("resumoArrecadacao", getResumoArrecadacao()).append("creditoOrigem", getCreditoOrigem())
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getResumoArrecadacao(), castOther.getResumoArrecadacao()).append(this.getCreditoOrigem(),
	...
	public int hashCode(){
		...
		return new HashCodeBuilder().append(getResumoArrecadacao()).append(getCreditoOrigem()).append(getLancamentoItemContabil())
						.toHashCode();
	}
