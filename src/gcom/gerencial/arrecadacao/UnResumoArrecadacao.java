...
public class UnResumoArrecadacao
	...
	/** full constructor */
	public UnResumoArrecadacao(int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, int quantidadeContas,
								short indicadorRecebidasNomes, BigDecimal valorAgua, BigDecimal valorEsgoto, Date ultimaAlteracao,
								BigDecimal valorNaoIdentificado, Integer creditoOrigemIdCredito,
								BigDecimal valorDocumentosRecebidosCredito, Integer lancamentoItemIdCredito,
								BigDecimal valorDocumentosRecebidosOutros, Integer financiamentoTipoIdOutros,
								Integer lancamentoItemIdOutros, BigDecimal valorImpostos,
								gcom.gerencial.arrecadacao.GArrecadacaoForma gerArrecadacaoForma,
								gcom.gerencial.arrecadacao.GArrecadador gerArrecadador, GGerenciaRegional gerGerenciaRegional,
								GSetorComercial gerSetorComercial, GSubcategoria gerSubcategoria, GDocumentoTipo gerDocumentoTipo,
								GLigacaoAguaPerfil gerLigacaoAguaPerfil, GPagamentoSituacao gerPagamentoSituacao,
								GEpocaPagamento gerEpocaPagamento, GEsferaPoder gerEsferaPoder, GClienteTipo gerClienteTipo,
								GLigacaoAguaSituacao gerLigacaoAguaSituacao, GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidade,
								GLocalidade gerLocalidadeElo, GCategoria gerCategoria, GImovelPerfil gerImovelPerfil, GRota gerRota,
	...
	public UnResumoArrecadacao(int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, int quantidadeContas,
								short indicadorRecebidasNomes, BigDecimal valorAgua, BigDecimal valorEsgoto, Date ultimaAlteracao,
								BigDecimal valorNaoIdentificado, gcom.gerencial.arrecadacao.GArrecadacaoForma gerArrecadacaoForma,
								gcom.gerencial.arrecadacao.GArrecadador gerArrecadador, GGerenciaRegional gerGerenciaRegional,
								GSetorComercial gerSetorComercial, GSubcategoria gerSubcategoria, GDocumentoTipo gerDocumentoTipo,
								GLigacaoAguaPerfil gerLigacaoAguaPerfil, GPagamentoSituacao gerPagamentoSituacao,
								GEpocaPagamento gerEpocaPagamento, GEsferaPoder gerEsferaPoder, GClienteTipo gerClienteTipo,
	...
	public UnResumoArrecadacao(int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, int quantidadeContas,
								short indicadorRecebidasNomes, BigDecimal valorAgua, BigDecimal valorEsgoto, Date ultimaAlteracao,
								BigDecimal valorNaoIdentificado, GSubcategoria gerSubcategoria, GClienteTipo gerClienteTipo,
								GLigacaoAguaSituacao gerLigacaoAguaSituacao, GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidade,
								GLocalidade gerLocalidadeElo, GQuadra gerQuadra, GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao,
								GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil, GGerenciaRegional gerGerenciaRegional,
								GSetorComercial gerSetorComercial, GDocumentoTipo gerDocumentoTipo,
								GPagamentoSituacao gerPagamentoSituacao, GLigacaoAguaPerfil gerLigacaoAguaPerfil,
								GEpocaPagamento gerEpocaPagamento, GEsferaPoder gerEsferaPoder, GCategoria gerCategoria,
								GImovelPerfil gerImovelPerfil, GRota gerRota, BigDecimal valorImpostos, short indicadorHidrometro,
