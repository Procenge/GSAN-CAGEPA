...
public interface IRepositorioGerencialArrecadacao {
	 ...
	 */
	public List getImoveisResumoArrecadacaoAguaEsgoto(int idLocalidade, int anoMesReferenciaPagamento) throws ErroRepositorioException;

	/**
	 * [UC0553 - Gerar Resumo da Arrecadacao - Outro]
	 * 
	 * @author Ivan Sérgio
	 * @date 22/05/2007
	 * @param idResumoArrecadacaoAguaEsgoto
	 *            idLocalidade
	 *            idImovel
	 * @return list
	 * @throws ErroRepositorioException
