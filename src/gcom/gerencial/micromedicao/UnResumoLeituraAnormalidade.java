...
public class UnResumoLeituraAnormalidade
	...
	/** full constructor */
	public UnResumoLeituraAnormalidade(int referencia, GGerenciaRegional gerGerenciaRegional, GUnidadeNegocio gerUnidadeNegocio,
										GLocalidade gerLocalidadeElo, GLocalidade gerLocalidade, int setorcomercial,
										gcom.gerencial.micromedicao.GRota gerRota, int quadra, GImovelPerfil gerImovelPerfil,
										GEsferaPoder gerEsferaPoder, GClienteTipo gerClienteTipo,
										GLigacaoAguaSituacao gerLigacaoAguaSituacao, GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao,
										GCategoria gerCategoria, GSubcategoria gerSubcategoria, GLigacaoAguaPerfil gerLigacaoAguaPerfil,
										GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil, GMedicaoTipo gerMedicaoTipo,
										int idLeituraAnormalidade, GSetorComercial gerSetorComercial, GQuadra gerQuadra,
										int quantidadeLeituras, GEmpresa gerEmpresa, GLeituraSituacao gerLeituraSituacao) {
