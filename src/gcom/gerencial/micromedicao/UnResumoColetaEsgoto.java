...
public class UnResumoColetaEsgoto
	...
	/** full constructor */
	public UnResumoColetaEsgoto(int referencia, int quantidadeEconomias, int volumeEsgoto, Date ultimaAlteracao, int quantidadeLigacoes,
								int volumeExcedente, int codigoSetorComercial, int numeroQuadra, GSubcategoria gSubcategoria,
								GClienteTipo gClienteTipo, GLigacaoAguaSituacao gLigacaoAguaSituacao, GUnidadeNegocio gUnidadeNegocio,
								GLocalidade gLocalidade, GLocalidade gLocalidadeElo, GQuadra gQuadra,
								GLigacaoEsgotoSituacao gLigacaoEsgotoSituacao, GLigacaoEsgotoPerfil gLigacaoEsgotoPerfil,
								GGerenciaRegional gGerenciaRegional, GSetorComercial gSetorComercial,
								GLigacaoAguaPerfil gLigacaoAguaPerfil, GEsferaPoder gEsferaPoder, GCategoria gCategoria,
								GImovelPerfil gImovelPerfil, gcom.gerencial.micromedicao.GRota gRota) {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("receId", getReceId()).toString();
	}
	...
	public void setIndicadorMedidoFonteAlternativa(Short indicadorMedidoFonteAlternativa){
