...
public class ResumoInstalacaoHidrometroHelper {
	...
	public ResumoInstalacaoHidrometroHelper(Integer idQuadra, Integer idPrincipalCategoria, Integer idPrincipalSubCategoria,
											Integer idEsferaPoder, Integer idTipoClienteResponsavel, Integer idPerfilLigacaoAgua,
											Integer idPerfilLigacaoEsgoto, Integer qtdHidrometroInstaladoPoco,
											Integer qtdHidrometroInstaladoRamal, Integer qtdHidrometroRetiradoPoco,
											Integer qtdHidrometroRetiradoRamal, Integer qtdHidrometroSubstituidoPoco,
											Integer qtdHidrometroSubstituidoRamal, Integer qtdHidrometroRemanejadoPoco,
											Integer qtdHidrometroRemanejadoRamal, Integer idLigacaoAguaSituacao,
											Integer idLigacaoEsgotoSituacao, Integer idPerfilImovel,
											Integer qtdHidrometroAtualmenteInstaladosRamal, Integer qtdHidrometroAtualmenteInstaladosPoco,
											Integer numeroQuadra, Integer idRota) {
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdQuadra(), castOther.getIdQuadra()).append(this.getIdPrincipalCategoria(),
						castOther.getIdPrincipalCategoria()).append(this.getIdPrincipalSubCategoria(),
						castOther.getIdPrincipalSubCategoria()).append(this.getIdEsferaPoder(), castOther.getIdEsferaPoder()).append(
						this.getIdTipoClienteResponsavel(), castOther.getIdTipoClienteResponsavel()).append(this.getIdPerfilLigacaoAgua(),
						castOther.getIdPerfilLigacaoAgua()).append(this.getIdLigacaoAguaSituacao(), castOther.getIdLigacaoAguaSituacao())
						.append(this.getIdLigacaoEsgotoSituacao(), castOther.getIdLigacaoEsgotoSituacao()).append(
										this.getIdPerfilLigacaoEsgoto(), castOther.getIdPerfilLigacaoEsgoto()).append(
										this.getIdPerfilImovel(), castOther.getIdPerfilImovel()).isEquals();
	}
	...
	public void setQtdHidrometroSubstituidoRamal(Integer qtdHidrometroSubstituidoRamal){
	...
	public void setQtdHidrometroRemanejadosRamal(Integer qtdHidrometroRemanejadosRamal){
	...
	public void setQtdHidrometroAtualmenteInstaladosPoco(Integer qtdHidrometroAtualmenteInstaladosPoco){
	...
	public void setQtdHidrometroAtualmenteInstaladosRamal(Integer qtdHidrometroAtualmenteInstaladosRamal){
