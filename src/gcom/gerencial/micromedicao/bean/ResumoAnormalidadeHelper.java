...
public class ResumoAnormalidadeHelper {
	...
	public int hashCode(){
		...
		this.getIdImovel() + "sdf" + this.getIdGerenciaRegional() + "sdf" + this.getIdLocalidade() + "sdf" + this.getIdSetorComercial()
						+ "sdf" + this.getIdRota() + "sdf" + this.getIdQuadra() + "sdf" + this.getCodigoSetorComercial() + "sdf"
						+ this.getNumeroQuadra() + "sdf" + this.getIdPerfilImovel() + "sdf" + this.getIdSituacaoLigacaoAgua() + "sdf"
						+ this.getIdSituacaoLigacaoEsgoto() + "sdf" + this.getIdCategoria() + "sdf" + this.getIdEsfera() + "sdf";
	...
	public ResumoAnormalidadeHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade, Integer idSetorComercial,
									...
									Integer idCategoria, Integer idEsfera, Integer idUnidadeNegocio) {
	...
	public void setIdLeituraAnormalidadeFaturada(Integer idLeituraAnormalidadeFaturada){
	...
	public void setDescricaoLeituraAnormalidadeFaturada(String descricaoLeituraAnormalidadeFaturada){

		this.descricaoLeituraAnormalidadeFaturada = descricaoLeituraAnormalidadeFaturada;
	}

	public Integer getEloLocalidade(){

		return eloLocalidade;
	}

	public void setEloLocalidade(Integer eloLocalidade){
