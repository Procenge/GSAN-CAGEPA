...
import gcom.gerencial.cadastro.imovel.*;
...
import gcom.gerencial.micromedicao.hidrometro.*;
 ...
 * @created 19/04/2006
 */
public class ControladorGerencialMicromedicaoSEJB
	...
	public void ejbCreate() throws CreateException{
		...
		repositorioGerencial = RepositorioGerencialMicromedicaoHBM.getInstancia();
		repositorioGerencialMicromedicao = RepositorioGerencialMicromedicaoHBM.getInstancia();
	...
	private ControladorGerencialImovelLocal getControladorGerencialImovel(){
		...
		try{
			...
			localHome = (ControladorGerencialImovelLocalHome) locator.getLocalHome(ConstantesJNDI.CONTROLADOR_GERENCIAL_IMOVEL_SEJB);
			// guarda a referencia de um objeto capaz de fazer chamadas à
			// objetos remotamente
			local = localHome.create();
	 ...
	 */
	public void gerarResumoAnormalidadeLeitura(int idFuncionalidadeIniciada, int referenciaFaturamento) throws ControladorException{
		...
		// colecaoSistemaParametro.iterator().next();
		...
		idUnidadeIniciada = getControladorBatch().iniciarUnidadeProcessamentoBatch(idFuncionalidadeIniciada,
						UnidadeProcessamento.LOCALIDADE, referenciaFaturamento);
		...
		try{
			...
			List<ResumoAnormalidadeHelper> listaSimplificada = new ArrayList();
			
			boolean existeResumoAnormalidadeLeitura = this.repositorioGerencial
							.verificaExistenciaDadosParaAnoMesRefFaturamentoResumoAnormalidadeLeitura(referenciaFaturamento + "");

			if(existeResumoAnormalidadeLeitura){

				this.getControladorAcesso().registrarLogExecucaoProcesso(idFuncionalidadeIniciada,
								ConstantesAplicacao.get("atencao.resumo_mes_ja_gerado") + referenciaFaturamento + ".");
				...
				List colecaoRetorno = this.repositorioGerencial.getResumoAnormalidadeHelper(referenciaFaturamento + "");
				...
				List listResumoAnormalidade = new ArrayList();

				Iterator iteratorColecaotRetorno = colecaoRetorno.iterator();
				...
				while(iteratorColecaotRetorno.hasNext()){
					...
					objeto = (Object[]) iteratorColecaotRetorno.next();
					...
					if(objeto[0] != null){
						resumoAnormalidadeHelper.setIdImovel(objeto[0] != null ? (Integer) objeto[0] : null);
						resumoAnormalidadeHelper.setIdLigacaoAgua(objeto[1] != null ? (Integer) objeto[1] : null);
						resumoAnormalidadeHelper.setIdLeituraAnormalidadeFaturada(objeto[2] != null ? (Integer) objeto[2] : null);
						resumoAnormalidadeHelper.setIdGerenciaRegional(objeto[3] != null ? (Integer) objeto[3] : null);
						resumoAnormalidadeHelper.setIdLocalidade(objeto[4] != null ? (Integer) objeto[4] : null);
						resumoAnormalidadeHelper.setIdSetorComercial(objeto[5] != null ? (Integer) objeto[5] : null);
						resumoAnormalidadeHelper.setCodigoSetorComercial(objeto[6] != null ? (Integer) objeto[6] : null);
						resumoAnormalidadeHelper.setIdQuadra(objeto[7] != null ? (Integer) objeto[7] : null);
						resumoAnormalidadeHelper.setNumeroQuadra(objeto[8] != null ? (Integer) objeto[8] : null);
						resumoAnormalidadeHelper.setIdRota(objeto[9] != null ? (Integer) objeto[9] : null);
						resumoAnormalidadeHelper.setIdPerfilImovel(objeto[10] != null ? (Integer) objeto[10] : null);
						resumoAnormalidadeHelper.setIdSituacaoLigacaoAgua(objeto[11] != null ? (Integer) objeto[11] : null);
						resumoAnormalidadeHelper.setIdSituacaoLigacaoEsgoto(objeto[12] != null ? (Integer) objeto[12] : null);
						resumoAnormalidadeHelper.setIdEsfera(objeto[13] != null ? (Integer) objeto[13] : null);
						resumoAnormalidadeHelper.setIdMedicaoTipo(objeto[14] != null ? (Integer) objeto[14] : null);
						resumoAnormalidadeHelper.setDescricaoLeituraAnormalidadeFaturada(objeto[15] != null ? (String) objeto[15] : null);
						resumoAnormalidadeHelper.setEloLocalidade(objeto[16] != null ? (Integer) objeto[16] : null);
						resumoAnormalidadeHelper.setIdUnidadeNegocio(objeto[17] != null ? (Integer) objeto[17] : null);
						...
						objectImovel = this.repositorioGerencial.pesquisarImovelPorIdLigacaoAgua((Integer) objeto[1]);

						resumoAnormalidadeHelper.setIdImovel(objectImovel[0] != null ? (Integer) objectImovel[0] : null);
						resumoAnormalidadeHelper.setIdGerenciaRegional(objectImovel[1] != null ? (Integer) objectImovel[1] : null);
						resumoAnormalidadeHelper.setIdLocalidade(objectImovel[2] != null ? (Integer) objectImovel[2] : null);
						resumoAnormalidadeHelper.setIdSetorComercial(objectImovel[3] != null ? (Integer) objectImovel[3] : null);
						resumoAnormalidadeHelper.setCodigoSetorComercial(objectImovel[4] != null ? (Integer) objectImovel[4] : null);
						resumoAnormalidadeHelper.setIdQuadra(objectImovel[5] != null ? (Integer) objectImovel[5] : null);
						resumoAnormalidadeHelper.setNumeroQuadra(objectImovel[6] != null ? (Integer) objectImovel[6] : null);
						resumoAnormalidadeHelper.setIdRota(objectImovel[7] != null ? (Integer) objectImovel[7] : null);
						resumoAnormalidadeHelper.setIdPerfilImovel(objectImovel[8] != null ? (Integer) objectImovel[8] : null);
						resumoAnormalidadeHelper.setIdEsfera(objectImovel[9] != null ? (Integer) objectImovel[9] : null);

						resumoAnormalidadeHelper.setIdLigacaoAgua(objeto[1] != null ? (Integer) objeto[1] : null);
						resumoAnormalidadeHelper.setIdLeituraAnormalidadeFaturada(objeto[2] != null ? (Integer) objeto[2] : null);
						resumoAnormalidadeHelper.setIdSituacaoLigacaoAgua(objectImovel[10] != null ? (Integer) objectImovel[10] : null);
						resumoAnormalidadeHelper.setIdSituacaoLigacaoEsgoto(objectImovel[11] != null ? (Integer) objectImovel[11] : null);
						resumoAnormalidadeHelper.setIdMedicaoTipo(objeto[14] != null ? (Integer) objeto[14] : null);
						resumoAnormalidadeHelper.setDescricaoLeituraAnormalidadeFaturada(objeto[15] != null ? (String) objeto[15] : null);
						resumoAnormalidadeHelper.setEloLocalidade(objeto[16] != null ? (Integer) objeto[16] : null);
						resumoAnormalidadeHelper.setIdUnidadeNegocio(objeto[17] != null ? (Integer) objeto[17] : null);
				...
				for(int i = 0; i < listResumoAnormalidade.size(); i++){
					...
					if(obj instanceof ResumoAnormalidadeHelper){
						...
						if(categoria != null) irleh.setIdCategoria(categoria.getId());
						...
						if(listaSimplificada.contains(irleh)){
							...
							ResumoAnormalidadeHelper jaCadastrado = (ResumoAnormalidadeHelper) listaSimplificada.get(posicao);
				...
				Localidade eloLocalidade = null;
				UnidadeNegocio unidadeNegocio = null;

				Iterator iteratorListaSimplificada = listaSimplificada.iterator();
				while(iteratorListaSimplificada.hasNext()){
					resumoAnormalidadeLeitura = new ResumoAnormalidadeLeitura();
					resumoAnormalidadeHelper = (ResumoAnormalidadeHelper) iteratorListaSimplificada.next();
					...
					if(resumoAnormalidadeHelper.getIdGerenciaRegional() != null){
						...
						gerenciaRegional.setId(resumoAnormalidadeHelper.getIdGerenciaRegional());
					}

					localidade = null;
					if(resumoAnormalidadeHelper.getIdLocalidade() != null){
						localidade = new Localidade();
						localidade.setId(resumoAnormalidadeHelper.getIdLocalidade());
					}

					setorComercial = null;
					if(resumoAnormalidadeHelper.getIdSetorComercial() != null){
						setorComercial = new SetorComercial();
						setorComercial.setId(resumoAnormalidadeHelper.getIdSetorComercial());
					}
					...
					if(resumoAnormalidadeHelper.getIdImovel() != null){
						...
						imovelPerfil.setId(resumoAnormalidadeHelper.getIdPerfilImovel());
					}
					...
					if(resumoAnormalidadeHelper.getIdSituacaoLigacaoAgua() != null){
						...
						ligacaoAguaSituacao.setId(resumoAnormalidadeHelper.getIdSituacaoLigacaoAgua());
					}
					...
					if(resumoAnormalidadeHelper.getIdSituacaoLigacaoEsgoto() != null){
						...
						ligacaoEsgotoSituacao.setId(resumoAnormalidadeHelper.getIdSituacaoLigacaoEsgoto());
					}
					...
					if(resumoAnormalidadeHelper.getIdMedicaoTipo() != null){
						...
						medicaoTipo.setId(resumoAnormalidadeHelper.getIdMedicaoTipo());
					}
					...
					if(resumoAnormalidadeHelper.getIdLeituraAnormalidadeFaturada() != null){
						...
						leituraAnormalidade.setId(resumoAnormalidadeHelper.getIdLeituraAnormalidadeFaturada());
						leituraAnormalidade.setDescricao(resumoAnormalidadeHelper.getDescricaoLeituraAnormalidadeFaturada());
					}
					...
					eloLocalidade = null;
					if(resumoAnormalidadeHelper.getIdLocalidade() != null){
						eloLocalidade = new Localidade();
						eloLocalidade.setId(resumoAnormalidadeHelper.getEloLocalidade());
					}

					unidadeNegocio = null;
					if(resumoAnormalidadeHelper.getIdUnidadeNegocio() != null){
						unidadeNegocio = new UnidadeNegocio();
						unidadeNegocio.setId(resumoAnormalidadeHelper.getIdUnidadeNegocio());
					}

					// atribui os valores no objeto resumo anormalidade
					resumoAnormalidadeLeitura.setAnoMesReferencia(referenciaFaturamento);
					...
					resumoAnormalidadeLeitura.setLigacaoAguaSituacao(ligacaoAguaSituacao);
					resumoAnormalidadeLeitura.setLigacaoEsgotoSituacao(ligacaoEsgotoSituacao);
					resumoAnormalidadeLeitura.setCategoria(categoria);
					resumoAnormalidadeLeitura.setMedicaoTipo(medicaoTipo);
					resumoAnormalidadeLeitura.setLeituraAnormalidade(leituraAnormalidade);
					resumoAnormalidadeLeitura.setQuantidadeMedicao(resumoAnormalidadeHelper.getQuantidadeImovel());
					resumoAnormalidadeLeitura.setEsferaPoder(esferaPoder);
					resumoAnormalidadeLeitura.setNumeroQuadra(resumoAnormalidadeHelper.getNumeroQuadra());
					resumoAnormalidadeLeitura.setCodigoSetorComercial(resumoAnormalidadeHelper.getCodigoSetorComercial());
					resumoAnormalidadeLeitura.setUltimaAlteracao(new Date());
					resumoAnormalidadeLeitura.setEloLocalidade(eloLocalidade);
					resumoAnormalidadeLeitura.setUnidadeNegocio(unidadeNegocio);
	 ...
	 * @throws ErroRepositorioException
	 */
	public void gerarResumoAnormalidadeConsumo(int idFuncionalidadeIniciada, int referenciaFaturamento) throws ControladorException{
		...
		try{
			...
			boolean existeResumoAnormalidadeConsumo = this.repositorioGerencial
							.verificaExistenciaDadosParaAnoMesRefFaturamentoResumoAnormalidadeConsumo(referenciaFaturamento + "");

			if(existeResumoAnormalidadeConsumo){
				...
				//
				// Collection colecaoSistemaParametro =
				// getControladorUtil().pesquisar(filtroSistemaParametro,
				// SistemaParametro.class.getName());
				//
				// SistemaParametro sistemaParametro = (SistemaParametro)
				// colecaoSistemaParametro.iterator().next();

				List imoveisResumoAnormalidadeConsumo = this.repositorioGerencial.getResumoAnormalidadeConsumoHelper(referenciaFaturamento
								+ "");
				...
				for(int i = 0; i < imoveisResumoAnormalidadeConsumo.size(); i++){
					Object obj = imoveisResumoAnormalidadeConsumo.get(i);
					...
					ResumoAnormalidadeConsumoHelper irleh = new ResumoAnormalidadeConsumoHelper((Integer) retorno[0], (Integer) retorno[1],
									(Integer) retorno[2], (Integer) retorno[3], (Integer) retorno[4], (Integer) retorno[5],
									(Integer) retorno[6], (Integer) retorno[7], (Integer) retorno[8], (Integer) retorno[9],
									(Integer) retorno[10], (Integer) retorno[11], (Integer) retorno[12], (Integer) retorno[13],
					...
					if(listaSimplificada.contains(irleh)){
						int posicao = listaSimplificada.indexOf(irleh);
						ResumoAnormalidadeConsumoHelper jaCadastrado = (ResumoAnormalidadeConsumoHelper) listaSimplificada.get(posicao);
						jaCadastrado.setQuantidadeImovel(jaCadastrado.getQuantidadeImovel() + 1);
					}else{
						listaSimplificada.add(irleh);
					}
				...
				for(int i = 0; i < listaSimplificada.size(); i++){
					ResumoAnormalidadeConsumoHelper irleh = (ResumoAnormalidadeConsumoHelper) listaSimplificada.get(i);

					Integer anoMesReferencia = referenciaFaturamento;
					...
					if(irleh.getIdSituacaoLigacaoEsgoto() != null){
						ligacaoEsgotoSituacao = new LigacaoEsgotoSituacao();
						ligacaoEsgotoSituacao.setId(irleh.getIdSituacaoLigacaoEsgoto());
					}
					...
					eloLocalidade = null;
					if(irleh.getEloLocalidade() != null){
						eloLocalidade = new Localidade();
						eloLocalidade.setId(irleh.getEloLocalidade());
					}

					unidadeNegocio = null;
					if(irleh.getIdUnidadeNegocio() != null){
						unidadeNegocio = new UnidadeNegocio();
						unidadeNegocio.setId(irleh.getIdUnidadeNegocio());
					}

					ResumoAnormalidadeConsumo resumoAnormalidadeConsumo = new ResumoAnormalidadeConsumo(anoMesReferencia,
									codigoSetorComercial, numeroQuadra, quantidadeImovel, gerenciaRegional, localidade, setorComercial,
									rota, quadra, imovelPerfil, ligacaoAguaSituacao, ligacaoEsgotoSituacao, categoria, esferaPoder,
									consumoAnormalidade, ligacaoTipo, eloLocalidade, unidadeNegocio);
	...
	public List consultarResumoAnormalidadeLeitura(InformarDadosGeracaoRelatorioConsultaHelper informarDadosGeracaoRelatorioConsultaHelper,
		...
		try{
			// [FS0001] Verificar existência de dados para o ano/mês de referência retornado
			String resumo = ResumoAnormalidadeLeitura.class.getName();
			Integer countResumoPendencia = repositorioGerencialCobranca.verificarExistenciaAnoMesReferenciaResumo(
			...
			if(countResumoPendencia == null || countResumoPendencia == 0){
				...
				throw new ControladorException("atencao.pesquisa.nenhum_resultado_processo");
			}

			List retorno = this.repositorioGerencialMicromedicao.consultarResumoAnormalidadeLeitura(
							informarDadosGeracaoRelatorioConsultaHelper, tipoLigacao);
	...
	public Integer consultarTotalResumoSemAnormalidade(int opcaoTotalizacao,
					...
					RelatorioResumoAnormalidadeLeituraBean bean) throws ControladorException{

		try{

			Integer retorno = this.repositorioGerencialMicromedicao.consultarTotalResumoSemAnormalidade(opcaoTotalizacao,
	 ...
	 * @throws ControladorException
	 */
	public void gerarResumoInstalacoesHidrometros(Integer anoMesReferenciaFaturamento, Integer idSetorComercial,
		...
		try{
			...
			Collection colecaoResumoInstalacaoHidrometro = null;

			// [FS0001 - Verificar existência de dados para o ano/mês de
			// referência da arrecadação]
			boolean flagExisteDados = repositorioGerencialMicromedicao
							.verificarExistenciaResumoInstalacaoHidrometroParaAnoMesReferenciaArrecadacao(anoMesReferenciaFaturamento,
											idSetorComercial);
			...
			Integer codigoSetorComercial = (Integer) dadosSetorComercial[6];
			...
			if(colecaoResumoInstalacaoHidrometroHelper != null && !colecaoResumoInstalacaoHidrometroHelper.isEmpty()){
				...
				colecaoResumoInstalacaoHidrometro = gerarResumoInstalacoesHidrometrosRegional(gSetorComercial,
								colecaoResumoInstalacaoHidrometroHelper, anoMesReferenciaFaturamento);
	 ...
	 * @throws ControladorException
	 */
	private Collection gerarResumoInstalacoesHidrometrosRegional(GSetorComercial gSetorComercial,
					Collection<ResumoInstalacaoHidrometroHelper> colecaoResumoInstalacaoHidrometroHelper,
					Integer anoMesReferenciaFaturamento) throws ErroRepositorioException, ControladorException{

		Collection colecaoInserirResumoInstalacaoHidrometro = new ArrayList();
		...
		for(ResumoInstalacaoHidrometroHelper resumoInstalacaoHidrometroHelper : colecaoResumoInstalacaoHidrometroHelper){
			...
			Integer idGSubcategoria = resumoInstalacaoHidrometroHelper.getIdPrincipalSubCategoria();
			...
			Integer idGClienteTipo = resumoInstalacaoHidrometroHelper.getIdTipoClienteResponsavel();
			...
			Integer idGLigacaoAguaSituacao = resumoInstalacaoHidrometroHelper.getIdLigacaoAguaSituacao();
			...
			Integer idGLigacaoAguaPerfil = resumoInstalacaoHidrometroHelper.getIdPerfilLigacaoAgua();
			...
			Integer idGLigacaoEsgotoSituacao = resumoInstalacaoHidrometroHelper.getIdLigacaoEsgotoSituacao();
			...
			Integer idGLigacaoEsgotoPerfil = resumoInstalacaoHidrometroHelper.getIdPerfilLigacaoEsgoto();
			...
			Integer idGEsferaPoder = resumoInstalacaoHidrometroHelper.getIdEsferaPoder();
			...
			Integer idGCategoria = resumoInstalacaoHidrometroHelper.getIdPrincipalCategoria();
			...
			Integer idGImovelPerfil = resumoInstalacaoHidrometroHelper.getIdPerfilImovel();
			...
			UnResumoInstalacaoHidrometro resumoInstalacaoHidrometro = new UnResumoInstalacaoHidrometro(anoMesReferenciaFaturamento,
							gSetorComercial.getCodigo(), gQuadra.getNumeroQuadra(), qtdHidrometrosInstaladosRamal,
							qtdHidrometrosSubstituidosRamal, new Date(), qtdHidrometrosRemanejadosRamal, qtdHidrometrosRetiradosRamal,
							qtdHidrometrosDadosAtualizados, gSubcategoria, gClienteTipo, gLigacaoAguaSituacao, gUnidadeNegocio,
							gLocalidade, gElo, gQuadra, gLigacaoEsgotoSituacao, gLigacaoEsgotoPerfil, gGerenciaRegional, gSetorComercial,
							gLigacaoAguaPerfil, gEsferaPoder, gCategoria, gImovelPerfil, gRota, qtdHidrometrosInstaladosPoco,
							qtdHidrometrosSubstituidosPoco, qtdHidrometrosRemanejadosPoco, qtdHidrometrosRetiradosPoco,
							qtdHidrometroAtualmenteInstaladosRamal, qtdHidrometroAtualmenteInstaladosPoco);
	 ...
	 * @throws ControladorException
	 */
	private void gerarResumoInstalacoesHidrometrosRegiao(GQuadra gQuadra,
					Collection<ResumoInstalacaoHidrometroHelper> colecaoResumoInstalacaoHidrometroHelper,
					Integer anoMesReferenciaFaturamento) throws ErroRepositorioException, ControladorException{
	...
	private Collection<ResumoInstalacaoHidrometroHelper> gerarColecaoResumoInstalacaoHidrometroHelperPorQuadra(
		...
		Collection<Object[]> colecaoDadosImoveis = this.repositorioGerencialMicromedicao
						.pesquisarDadosImovelResumoInstalacaoHidrometroPorQuadra(gSetorComercial.getId(), dataInicio, dataFim);

		List<ResumoInstalacaoHidrometroHelper> colecaoRetorno = new ArrayList();
		...
		if(colecaoDadosImoveis != null && !colecaoDadosImoveis.isEmpty()){
			...
			for(Object[] dadosImovel : colecaoDadosImoveis){
				...
				ResumoInstalacaoHidrometroHelper resumoInstalacaoHidrometroHelper = new ResumoInstalacaoHidrometroHelper(idQuadra,
								idPrincipalCategoria, idPrincipalSubCategoria, idEsferaPoder, idTipoClienteResponsavel,
								idPerfilLigacaoAgua, idPerfilLigacaoEsgoto, qtdHidrometroInstaladoPoco, qtdHidrometroInstaladoRamal,
								qtdHidrometroRetiradoPoco, qtdHidrometroRetiradoRamal, qtdHidrometroSubstituidoPoco,
								qtdHidrometroSubstituidoRamal, qtdHidrometroRemanejadoPoco, qtdHidrometroRemanejadoRamal,
								idLigacaoAguaSituacao, idLigacaoEsgotoSituacao, idPerfilImovel, qtdHidrometroAtualmenteInstaladosRamal,
								qtdHidrometroAtualmenteInstaladosPoco, numeroQuadra, idRota);
				...
				if(colecaoRetorno.contains(resumoInstalacaoHidrometroHelper)){
					...
					jaCadastrado
									.setQtdHidrometroInstaladoRamal(jaCadastrado.getQtdHidrometroInstaladoRamal()
													+ qtdHidrometroInstaladoRamal);
					jaCadastrado.setQtdHidrometroSubstituidoPoco(jaCadastrado.getQtdHidrometroSubstituidoPoco()
									+ qtdHidrometroSubstituidoPoco);
					jaCadastrado.setQtdHidrometroSubstituidoRamal(jaCadastrado.getQtdHidrometroSubstituidoRamal()
									+ qtdHidrometroSubstituidoRamal);
					...
					jaCadastrado.setQtdHidrometroAtualmenteInstaladosRamal(jaCadastrado.getQtdHidrometroAtualmenteInstaladosRamal()
									+ qtdHidrometroAtualmenteInstaladosRamal);
					jaCadastrado.setQtdHidrometroAtualmenteInstaladosPoco(jaCadastrado.getQtdHidrometroAtualmenteInstaladosPoco()
	...
	public Collection<Integer> pesquisarIdsSetorComercialParaGerarResumoInstalacaoHidrometro(Integer anoMesFaturamento)
		...
		try{
			return repositorioGerencialMicromedicao.pesquisarIdsSetorComercialParaGerarResumoInstalacaoHidrometro(anoMesFaturamento);
		}catch(ErroRepositorioException ex){
			throw new ControladorException("erro.sistema", ex);
		}
	}
	 ...
	 * 
	 * @author Ivan Sérgio
	 * @date 26/04/2007, 28/05/2007, 21/06/2007, 27/07/2007, 15/08/2007
	...
	public void gerarResumoLeituraAnormalidade(int idSetorComercial, int anoMesLeitura, int idFuncionalidadeIniciada)
		...
		try{
			List imoveisResumoLeituraAnormalidade = this.repositorioGerencialMicromedicao.getImoveisResumoLeituraAnormalidade(
							idSetorComercial, anoMesLeitura);

			List<UnResumoLeituraAnormalidadeHelper> listaSimplificada = new ArrayList();
			List<UnResumoLeituraAnormalidade> listaResumoLeituraAnormalidade = new ArrayList();
			...
			List imoveisResumoLeituraAnormalidadeComplementar = null;
			...
			for(int i = 0; i < imoveisResumoLeituraAnormalidade.size(); i++){
				...
				if(obj instanceof Object[]){
					...
					// processado
					helper.setIdPerfilLigacaoAgua((Integer) retorno[1]); // Perfil da Ligação da
					// Água
					helper.setIdPerfilLigacaoEsgoto((Integer) retorno[2]); // Perfil da Ligação de
					// Esgoto
					...
					obj2 = imoveisResumoLeituraAnormalidadeComplementar.get(0);
					retorno2 = (Object[]) obj2;
					...
					helper.setIdEsfera(repositorioGerencialCadastro.pesquisarEsferaPoderClienteResponsavelImovel(idImovel));
					// Pesquisamos o tipo de cliente responsavel do imovel
					helper.setIdTipoClienteResponsavel(repositorioGerencialCadastro.pesquisarTipoClienteClienteResponsavelImovel(idImovel));

					helper.setIdSituacaoLigacaoAgua((Integer) retorno2[10]); // Situacao Ligacao
					// Agua
					helper.setIdSituacaoLigacaoEsgoto((Integer) retorno2[11]); // Situacao Ligacao
					// Esgoto
					...
					helper.setCodigoSetorComercial((Integer) retorno2[12]); // Codigo Setor
					// Comercial
					...
					if(helper.getIdEsfera().equals(0)){
						...
						clienteTemp = this.getControladorImovel().consultarClienteUsuarioImovel(imovel);
						if(clienteTemp != null){
					...
					if(listaSimplificada.contains(helper)){
						...
						jaCadastrado = (UnResumoLeituraAnormalidadeHelper) listaSimplificada.get(posicao);

						// Incrementamos as Leituras
						jaCadastrado.setQuantidadeLeitura(jaCadastrado.getQuantidadeLeitura() + 1);
					}else{
						// Incrementamos as Leituras
						helper.setQuantidadeLeitura(helper.getQuantidadeLeitura() + 1);
			...
			for(int i = 0; i < listaSimplificada.size(); i++){
				helper = (UnResumoLeituraAnormalidadeHelper) listaSimplificada.get(i);
				...
				resumoLeituraAnormalidade = new UnResumoLeituraAnormalidade(anoMesReferencia, gerenciaRegional, unidadeNegocio, elo,
								localidade, setorComercial, rota, quadra, imovelPerfil, esferaPoder, clienteTipo, ligacaoAguaSituacao,
								ligacaoEsgotoSituacao, gCategoria, gSubcategoria, ligacaoAguaPerfil, ligacaoEsgotoPerfil, medicaoTipo,
								leituraAnormalidade, codigoSetorComercial, numeroQuadra, quantidadeLeitura, empresa, situacaoLeitura);
			...
			this.getControladorBatch().inserirColecaoObjetoParaBatchGerencial((Collection) listaResumoLeituraAnormalidade);
	...
	public void gerarResumoHidrometros(Integer idHidrometroMarca, int idFuncionalidadeIniciada) throws ControladorException{
		...
		// -------------------------
		idUnidadeIniciada = getControladorBatch().iniciarUnidadeProcessamentoBatch(idFuncionalidadeIniciada,
						UnidadeProcessamento.HIDROMETRO_MARCA, idHidrometroMarca);
		...
		try{
			...
			while(!flagTerminou){
				...
				Collection hidrometros = this.repositorioGerencialMicromedicao.getHidrometrosResumoHidrometro(idHidrometroMarca, indice,
								qtRegistros);
				...
				List<ResumoHidrometroHelper> listaSimplificada = new ArrayList();
				List<UnResumoHidrometro> listaResumoHidrometro = new ArrayList();

				Iterator imoveisHidrometrosIterator = hidrometros.iterator();
				...
				while(imoveisHidrometrosIterator.hasNext()){
					...
					if(obj instanceof Object[]){
						...
						System.out.println("HidrometroMarca " + idHidrometroMarca);
						// // Codigo do
						// // imovel que
						// // esta sendo
						// // processado
						...
						// ResumoHidrometroHelper helper = (ResumoHidrometroHelper)
						// listaSimplificada
						// .get(count);

						// Montamos todo o agrupamento necessario
						// Mes ano de referencia
						Integer anoMesReferencia = this.getControladorUtil().pesquisarParametrosDoSistema().getAnoMesFaturamento();
						...
						UnResumoHidrometro resumoHidrometro = new UnResumoHidrometro(null, anoMesReferencia.intValue(),
										numeroAnoFabricacao, indicadorMacro, helper.getCount(), new Date(), hidrometroMarcaG,
										hidrometroSituacao, hidrometroLocalArmazenagem, hidrometroTipo, hidrometroDiametro,
				...
				if(listaResumoHidrometro != null && !listaResumoHidrometro.isEmpty()){
					getControladorBatch().inserirColecaoObjetoParaBatchGerencial((Collection) listaResumoHidrometro);
				}
	...
	public List consultarResumoAnormalidadeConsumo(InformarDadosGeracaoRelatorioConsultaHelper informarDadosGeracaoRelatorioConsultaHelper,
		...
		try{
			...
			List retorno = this.repositorioGerencialMicromedicao.consultarResumoAnormalidadeConsumo(
							informarDadosGeracaoRelatorioConsultaHelper, tipoLigacao);
