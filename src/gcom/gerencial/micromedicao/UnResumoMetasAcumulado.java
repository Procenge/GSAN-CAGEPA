...
public class UnResumoMetasAcumulado
	...
	/** full constructor */
	public UnResumoMetasAcumulado(Integer id, int anoMesReferencia, int codigoSetorComercial, int numeroQuadra,
									int quantidadeLigacoesCadastradas, int quantidadeLigacoesCortadas, int quantidadeLigacoesSuprimidas,
									int quantidadeLigacoesAtivas, int quantidadeLigacoesAtivasDebito3m,
									int quantidadeLigacoesConsumoMedido, int quantidadeLigacoesConsumoNaoMedido,
