...
public class UnResumoMeta
	...
	/** full constructor */
	public UnResumoMeta(Integer id, int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, int quantidadeLigacoesCadastradas,
						int quantidadeLigacoesCortadas, int quantidadeLigacoesSuprimidas, int quantidadeLigacoesAtivas,
						int quantidadeLigacoesAtivasDebito3m, int quantidadeLigacoesConsumoMedido, int quantidadeLigacoesConsumoNaooMedido,
						int quantidadeLigacoesConsumoAte5m3, int quantidadeLigacoesConsumoMedia, int quantidadeEconomias,
						Date ultimaAlteracao, GGerenciaRegional gerGerenciaRegional, GSetorComercial gerSetorComercial,
						GSubcategoria gerSubcategoria, GLigacaoAguaPerfil gerLigacaoAguaPerfil, GEsferaPoder gerEsferaPoder,
						GClienteTipo gerClienteTipo, GLigacaoAguaSituacao gerLigacaoAguaSituacao, GUnidadeNegocio gerUnidadeNegocio,
						GLocalidade gerLocalidade, GLocalidade GLocalidadeElo, GCategoria gerCategoria, GImovelPerfil gerImovelPerfil,
						gcom.gerencial.micromedicao.GRota gerRota, GQuadra gerQuadra, GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao,
