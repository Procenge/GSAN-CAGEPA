 ...
 * @created 19/04/2006
 */
public interface ControladorGerencialMicromedicaoLocal
	...
	/**
	 * [UC0344] Consultar Total de Resumo de sem Anormalidade
	 * 
	 * @param informarDadosGeracaoRelatorioConsultaHelper
	 * @return
	 * @throws ControladorException
	 ...
	 * @throws ControladorException
	 */
	public void gerarResumoInstalacoesHidrometros(Integer anoMesReferenciaArrecadacao, Integer idSetorComercial,
	 ...
	 * @date 26/04/2007
	 */
	public void gerarResumoLeituraAnormalidade(int idLocalidade, int anoMesLeitura, int idFuncionalidadeIniciada)
					throws ControladorException;
