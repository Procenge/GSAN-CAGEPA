...
public class UnResumoPendencia
	...
	/** full constructor */
	public UnResumoPendencia(Integer id, int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, Date ultimaAlteracao,
								int indicadorVolumeFixadoAgua, int indicadorVolumeFixadoEsgoto, int anoMesReferenciaDocumento,
								short indicadorHidrometro, short indicadorVencido, int quantidadeLigacoes, int quantidadeDocumentos,
								BigDecimal valorPendenteAgua, BigDecimal valorPendenteEsgoto, BigDecimal valorPendenteDebitos,
								BigDecimal valorPendenteCreditos, BigDecimal valorPendenteImpostos, GGerenciaRegional gerGerenciaRegional,
								GSetorComercial gerSetorComercial, GSubcategoria gerSubcategoria, GLigacaoAguaPerfil gerLigacaoAguaPerfil,
								GEsferaPoder gerEsferaPoder, GClienteTipo gerClienteTipo, GLigacaoAguaSituacao gerLigacaoAguaSituacao,
								GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidade, GLocalidade GLocalidadeElo,
								GCategoria gerCategoria, GImovelPerfil gerImovelPerfil, GRota gerRota, GQuadra gerQuadra,
	...
	public UnResumoPendencia(Integer id, int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, Date ultimaAlteracao,
								int indicadorVolumeFixadoAgua, int indicadorVolumeFixadoEsgoto, int anoMesReferenciaDocumento,
								short indicadorHidrometro, short indicadorVencido, int quantidadeLigacoes, int quantidadeDocumentos,
								GGerenciaRegional gerGerenciaRegional, GSetorComercial gerSetorComercial, GSubcategoria gerSubcategoria,
								GLigacaoAguaPerfil gerLigacaoAguaPerfil, GEsferaPoder gerEsferaPoder, GClienteTipo gerClienteTipo,
								GLigacaoAguaSituacao gerLigacaoAguaSituacao, GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidade,
								GLocalidade GLocalidadeElo, GCategoria gerCategoria, GImovelPerfil gerImovelPerfil, GRota gerRota,
