...
public class ResumoCobrancaSituacaoEspecialConsultaMotivoHelper {
	...
	private BigDecimal cobrancaEstimado;

	private String valorCobrancaEstimadoFormatado;
	...
	public BigDecimal getCobrancaEstimado(){

		return cobrancaEstimado;
	}

	public void setCobrancaEstimado(BigDecimal cobrancaEstimado){

		this.cobrancaEstimado = cobrancaEstimado;
	}
	...
	public ResumoCobrancaSituacaoEspecialConsultaMotivoHelper(Integer idMotivo, String motivoDescricao, Integer anoMesInicio,
																Integer anoMesFim, Integer qtParalisada) {
	...
	public String getValorCobrancaEstimadoFormatado(){

		return valorCobrancaEstimadoFormatado;
	}

	public void setValorCobrancaEstimadoFormatado(String valorCobrancaEstimadoFormatado){

		this.valorCobrancaEstimadoFormatado = valorCobrancaEstimadoFormatado;
	}
