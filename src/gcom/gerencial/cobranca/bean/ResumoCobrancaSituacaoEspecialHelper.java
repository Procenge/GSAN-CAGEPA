...
public class ResumoCobrancaSituacaoEspecialHelper {
	...
	public boolean equals(Object obj){
		...
		if(obj instanceof ResumoCobrancaSituacaoEspecialHelper){
			...
			if(objeto.getIdGerenciaRegional() != null){
				...
				// se o atributo no obj for null e nesse objeto for diferente de null, entao retorna
				// falso
	...
	public int hashCode(){
		...
		this.getIdGerenciaRegional() + "sdf" + this.getIdLocalidade() + "sdf" + this.getIdSetorComercial() + "sdf" + this.getIdRota()
						+ "sdf" + this.getIdQuadra() + "sdf" + this.getCodigoSetorComercial() + "sdf" + this.getNumeroQuadra() + "sdf"
						+ this.getIdPerfilImovel() + "sdf" + this.getIdSituacaoLigacaoAgua() + "sdf" + this.getIdSituacaoLigacaoEsgoto()
						+ "sdf" + this.getIdCategoria() + "sdf" + this.getIdEsfera() + "sdf" + this.getIdEspecialCobranca() + "sdf"
						+ this.getIdMotivoSituacaoEspecialCobranca() + "sdf" + this.getAnoMesFinalSituacaoEspecial() + "sdf"
	...
	/**
	 * @param anoMesFinalSituacaoEspecial
	 *            O anoMesFinalSituacaoEspecial a ser setado.
	 */
	 ...
	 *            O anoMesInicioSituacaoEspecial a ser setado.
	 */
	...
	/**
	 * @param idEspecialCobranca
	 *            O idEspecialCobranca a ser setado.
	 */
	...
	/**
	 * @param idMotivoSituacaoEspecialCobranca
	 *            O idMotivoSituacaoEspecialCobranca a ser setado.
	 */
	public void setIdMotivoSituacaoEspecialCobranca(Integer idMotivoSituacaoEspecialCobranca){
	...
	/**
	 * @param quantidadeImovel
	 *            O quantidadeImovel a ser setado.
	 */
	...
	public ResumoCobrancaSituacaoEspecialHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade,
												...
												Integer idSituacaoLigacaoEsgoto, Integer idCategoria, Integer idEsfera,
												Integer idEspecialCobranca, Integer idMotivoSituacaoEspecialCobranca,
	...
	// Integer idSetorComercial, Integer idRota, Integer idQuadra, Integer codigoSetorComercial,
	// Integer numeroQuadra, Integer idPerfilImovel, Integer idSituacaoLigacaoAgua,
	// Integer idSituacaoLigacaoEsgoto, Integer idEsfera, Integer idEspecialCobranca,
	// Integer idMotivoSituacaoEspecialCobranca, Integer anoMesInicioSituacaoEspecial,
	// Integer anoMesFinalSituacaoEspecial, Integer idUnidadeNegocio) {
	//
	// // TODO Auto-generated constructor stub
	// this.idImovel = idImovel;
	// this.idGerenciaRegional = idGerenciaRegional;
