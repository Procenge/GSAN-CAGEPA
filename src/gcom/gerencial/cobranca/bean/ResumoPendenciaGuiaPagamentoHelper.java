...
public class ResumoPendenciaGuiaPagamentoHelper {
	...
	public int hashCode(){
		...
		this.getIdGuiaPagamento() + "sdf" + this.getIdGerenciaRegional() + "sdf" + this.getIdLocalidade() + "sdf"
						+ this.getIdSetorComercial() + "sdf" + this.getCodigoSetorComercial() + "sdf" + this.getIdRota() + "sdf"
						+ this.getIdQuadra() + "sdf" + this.getNumeroQuadra() + "sdf" + this.getIdPerfilImovel() + "sdf"
						+ this.getIdSituacaoLigacaoAgua() + "sdf" + this.getIdSituacaoLigacaoEsgoto() + "sdf" + this.getIdCategoria()
						+ "sdf" + this.getIdEsferaPoder() + "sdf" + this.getIndicadorExistenciaHidrometro() + "sdf" + this.getIdImovel()
						+ "sdf" + this.getIdDocumentoTipo() + "sdf" + this.getIdFinanciamentoTipo() + "sdf";
	 ...
	 *            O indicadorExistenciaHidrometro a ser setado.
	 */
	 ...
	 *            O quantidadeLigacoes a ser setado.
	 */
	 ...
	 *            O idFinanciamentoTipo a ser setado.
	 */
	...
	/**
	 * @param indicadorVencido
	 *            O indicadorVencido a ser setado.
	 */
	 ...
	 * @param valorPendente
	 */
	public ResumoPendenciaGuiaPagamentoHelper(Integer idImovel, Integer idGuiaPagamento, Integer idGerenciaRegional, Integer idLocalidade,
												...
												Integer indicadorExistenciaHidrometro, Integer idDocumentoTipo, Integer idFinanciamentoTipo) {
