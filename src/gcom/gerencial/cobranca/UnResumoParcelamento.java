...
public class UnResumoParcelamento
	...
	/** full constructor */
	public UnResumoParcelamento(int anoMesReferencia, int setorComercial, int quadra, int quantidadeContas, BigDecimal valorContas,
								BigDecimal valorGuias, BigDecimal valorCreditos, BigDecimal valorDescricaoAcrescimo, int quantidadeGuias,
								BigDecimal valorDescricaoInatividade, BigDecimal valorAcrescimoImpontualidade, Date ultimaAlteracao,
								short quantidadeParcelamentos, BigDecimal valorDescricaoAntiguidade, GSubcategoria gerSubcategoria,
								...
								GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidadeElo, GLocalidade gerLocalidade,
								GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil, GEsferaPoder gerEsferaPoder, GCategoria gerCategoria,
								GRota gerRota, BigDecimal valorJurosParcelamento, BigDecimal valorEntrada,
								BigDecimal valorDebitosCobrarParcelamentos, BigDecimal valorDebitosCobrarTotal,
								BigDecimal valorDebitosCobrarAcrescimos, BigDecimal valorDebitosCobrarReligadosSancoes,
								Integer quantidadeTotalParcelas, Integer quantidadeMediaParcelas, GConsumoTarifa gerConsumoTarifa,
								Short indicadorHidrometro, Integer quantidadeReparcelamentos) {
	...
	/** minimal constructor */
	public UnResumoParcelamento(int anoMesReferencia, int setorComercial, int quadra, int quantidadeContas, BigDecimal valorContas,
								BigDecimal valorGuias, BigDecimal valorServicosIndiretos, BigDecimal valorCreditos,
								BigDecimal valorDescricaoAcrescimo, int quantidadeGuias, BigDecimal valorTotalParcelado,
								BigDecimal valorDescricaoInatividade, BigDecimal valorFinanciado, BigDecimal valorAcrescimoImpontualidade,
								Date ultimaAlteracao, short quantidadeParcelamentos, BigDecimal valorSancoes,
								BigDecimal valorDescricaoAntiguidade, GSubcategoria gerSubcategoria, GClienteTipo gerClienteTipo,
								GLigacaoAguaSituacao gerLigacaoAguaSituacao, GQuadra gerQuadra,
								GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao, GGerenciaRegional gerGerenciaRegional,
								GSetorComercial gerSetorComercial, GLigacaoAguaPerfil gerLigacaoAguaPerfil, GImovelPerfil gerImovelPerfil,
	...
	public void setGerCategoria(gcom.gerencial.cadastro.imovel.GCategoria gerCategoria){
	...
	public void setGerClienteTipo(gcom.gerencial.cadastro.cliente.GClienteTipo gerClienteTipo){
	...
	public void setGerEsferaPoder(gcom.gerencial.cadastro.cliente.GEsferaPoder gerEsferaPoder){
	...
	public void setGerGerenciaRegional(gcom.gerencial.cadastro.localidade.GGerenciaRegional gerGerenciaRegional){
	...
	public void setGerImovelPerfil(gcom.gerencial.cadastro.imovel.GImovelPerfil gerImovelPerfil){
	...
	public void setGerLigacaoAguaPerfil(gcom.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaPerfil gerLigacaoAguaPerfil){
	...
	public void setGerLigacaoAguaSituacao(gcom.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaSituacao gerLigacaoAguaSituacao){
	...
	public void setGerLigacaoEsgotoPerfil(gcom.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil){
	...
	public void setGerLigacaoEsgotoSituacao(gcom.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao){
	...
	public void setGerLocalidadeElo(gcom.gerencial.cadastro.localidade.GLocalidade gerLocalidadeElo){
	...
	public void setGerSetorComercial(gcom.gerencial.cadastro.localidade.GSetorComercial gerSetorComercial){
	...
	public void setGerSubcategoria(gcom.gerencial.cadastro.imovel.GSubcategoria gerSubcategoria){
	...
	public void setGerUnidadeNegocio(gcom.gerencial.cadastro.localidade.GUnidadeNegocio gerUnidadeNegocio){
	...
	public void setValorQuantidadeServicosIndiretos(Short valorQuantidadeServicosIndiretos){
	...
	public void setValorDebitosCobrarAcrescimos(BigDecimal valorDebitosCobrarAcrescimos){
	...
	public void setValorDebitosCobrarParcelamentos(BigDecimal valorDebitosCobrarParcelamentos){
	...
	public void setValorDebitosCobrarReligadosSancoes(BigDecimal valorDebitosCobrarReligadosSancoes){
