...
public class UnResumoRegistroAtendimento
	...
	/** full constructor */
	public UnResumoRegistroAtendimento(Integer id, int referencia, Date ultimaAlteracao, int registrosGerados, Integer setorComercial,
										int registrosPendentesNoPrazo, int registrosPendentesForaPrazo, Integer Quadra,
										int registrosBloqueados, int registrosEncerradosNoPrazo, int registrosEncerradosForaPrazo,
										int indicadorAtendimentoOnline, GMeioSolicitacao gerMeioSolicitacao, GSubcategoria gerSubcategoria,
										...
										GSolicitacaoTipo gerSolicitacaoTipo, GQuadra gerQuadra,
										...
										GImovelPerfil gerImovelPerfil, GRota gerRota) {
