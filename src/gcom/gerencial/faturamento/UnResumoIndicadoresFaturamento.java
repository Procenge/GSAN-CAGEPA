...
public class UnResumoIndicadoresFaturamento
	...
	/** full constructor */
	public UnResumoIndicadoresFaturamento(Integer id, int anoMesReferencia, String anoReferencia, String mesReferencia,
											int codigoSetorComercial, int numeroQuadra, int quantidadeContasEmitidas,
											int quantidadeContasRetificadas, int quantidadeContasCanceladas, int quantidadeContasIncluidas,
											...
											int volumeIncluidoEsgoto, BigDecimal valorFaturadoAgua, BigDecimal valorCanceladoAgua,
											BigDecimal valorIncluidoAgua, BigDecimal valorFaturadoEsgoto, BigDecimal valorCanceladoEsgoto,
											BigDecimal valorIncluidoEsgoto, BigDecimal valorDocumentosFaturadosCredito,
											BigDecimal valorCanceladoCredito, BigDecimal valorIncluidoCredito,
											BigDecimal valorDocumentosFaturadosOutros, BigDecimal valorCanceladoOutros,
											BigDecimal valorIncluidoOutros, BigDecimal valorAcrescimoImpontualidade,
											int quantidadeContasEmitidasMesAno, int quantidadeContasRetificadasMesAno,
											int quantidadeContasCanceladasMesAno, int quantidadeContasIncluidasMesAno,
											int quantidadeEconomiasFaturadasMesAno, int volumeFaturadoAguaMesAno,
											int volumeCanceladoAguaMesAno, int volumeIncluidoAguaMesAno, int volumeFaturadoEsgotoMesAno,
											int volumeCanceladoEsgotoMesAno, int volumeIncluidoEsgotoMesAno,
											BigDecimal valorFaturadoAguaMesAno, BigDecimal valorCanceladoAguaMesAno,
											BigDecimal valorIncluidoAguaMesAno, BigDecimal valorFaturadoEsgotoMesAno,
											BigDecimal valorCanceladoEsgotoMesAno, BigDecimal valorIncluidoEsgotoMesAno,
											BigDecimal valorDocumentosFaturadosCreditoMesAno, BigDecimal valorCanceladoCreditoMesAno,
											BigDecimal valorIncluidoCreditoMesAno, BigDecimal valorDocumentosFaturadosOutrosMesAno,
											BigDecimal valorCanceladoOutrosMesAno, BigDecimal valorIncluidoOutrosMesAno,
											BigDecimal valorArrastos, BigDecimal valorParcelamento, int quantidadeGuiasCanceladas,
											Date ultimaAlteracao, GSubcategoria gerSubcategoria, GClienteTipo gerClienteTipo,
											GLigacaoAguaSituacao gerLigacaoAguaSituacao, GCreditoOrigem gerCreditoOrigem,
											...
											GLigacaoAguaPerfil gerLigacaoAguaPerfil, GFinanciamentoTipo gerFinanciamentoTipo,
											GImovelPerfil gerImovelPerfil, GLancamentoItemContabil gerLancamentoItemContabil,
											GUnidadeNegocio gerUnidadeNegocio, GCreditoTipo gerCreditoTipo, GLocalidade gerLocalidade,
											GLocalidade gerLocalidadeElo, GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil,
											GDocumentoTipo gerDocumentoTipo, GEsferaPoder gerEsferaPoder, GDebitoTipo gerDebitoTipo,
											GCategoria gerCategoria, GRota gerRota) {
