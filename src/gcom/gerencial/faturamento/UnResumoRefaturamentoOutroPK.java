...
public class UnResumoRefaturamentoOutroPK
	...
	/** full constructor */
	public UnResumoRefaturamentoOutroPK(Integer idResumoRefaturamentoAguaEsgoto, Integer idDocumentoTipo, Integer idFinanciamentoTipo,
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("idResumoRefaturamentoAguaEsgoto", getIdResumoRefaturamentoAguaEsgoto()).append(
						"idDocumentoTipo", getIdDocumentoTipo()).append("idFinanciamentoTipo", getIdFinanciamentoTipo()).append(
						"idLancamentoItemContabil", getIdLancamentoItemContabil()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdResumoRefaturamentoAguaEsgoto(), castOther.getIdResumoRefaturamentoAguaEsgoto())
						.append(this.getIdDocumentoTipo(), castOther.getIdDocumentoTipo()).append(this.getIdFinanciamentoTipo(),
										castOther.getIdFinanciamentoTipo()).append(this.getIdLancamentoItemContabil(),
										castOther.getIdLancamentoItemContabil()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdResumoRefaturamentoAguaEsgoto()).append(getIdDocumentoTipo()).append(
						getIdFinanciamentoTipo()).append(getIdLancamentoItemContabil()).toHashCode();
	}
