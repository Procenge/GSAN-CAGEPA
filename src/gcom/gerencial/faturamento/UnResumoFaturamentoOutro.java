...
public class UnResumoFaturamentoOutro
	...
	public UnResumoFaturamentoOutro(UnResumoFaturamento unResumoFaturamento, GDocumentoTipo gDocumentoTipo,
									GFinanciamentoTipo gFinanciamentoTipo, GLancamentoItemContabil gLancamentoItemContabil,
									BigDecimal valorDocumentosFaturados, int quantidadeDocumentosFaturados, Date ultimaAlteracao) {
	...
	/** full constructor */
	public UnResumoFaturamentoOutro(gcom.gerencial.faturamento.UnResumoFaturamentoOutroPK comp_id, BigDecimal valorDocumentosFaturados,
									int quantidadeDocumentosFaturados, Date ultimaAlteracao,
									GLancamentoItemContabil gLancamentoItemContabil,
									gcom.gerencial.faturamento.UnResumoFaturamento unResumoFaturamento, GDocumentoTipo gDocumentoTipo,
									GFinanciamentoTipo gFinanciamentoTipo) {
	...
	/** minimal constructor */
	public UnResumoFaturamentoOutro(gcom.gerencial.faturamento.UnResumoFaturamentoOutroPK comp_id, BigDecimal valorDocumentosFaturados,
									short quantidadeDocumentosFaturados, Date ultimaAlteracao) {
