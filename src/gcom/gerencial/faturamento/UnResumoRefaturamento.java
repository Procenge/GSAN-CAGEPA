...
public class UnResumoRefaturamento
	...
	public UnResumoRefaturamento(int anoMesReferencia, GGerenciaRegional gGerenciaRegional, GUnidadeNegocio gUnidadeNegocio,
	...
	/** full constructor */
	public UnResumoRefaturamento(Integer id, int anoMesReferencia, int codigoSetorcomercial, int numeroQuadra,
									...
									GLigacaoAguaSituacao gerLigacaoAguaSituacao, GLocalidade gerLocalidade, GLocalidade gerLocalidadeElo,
									GCategoria gerCategoria, GImovelPerfil gerImovelPerfil, GQuadra gerQuadra, GRota gerRota,
									GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao, GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil,
									Set unResumoRefaturamentoOutros, Set unResumoRefaturamentoCreditos) {
