...
public class ResumoFaturamentoOutrosHelper {
	...
	public boolean equals(Object obj){
		...
		return new EqualsBuilder().append(this.getIdGerenciaRegional(), resumoTemp.getIdGerenciaRegional()).append(
						...
						.append(this.getIdSubCategoria(), resumoTemp.getIdSubCategoria()).append(this.getIdFinanciamentoTipo(),
										...
										this.getIndicadorHidrometro(), resumoTemp.getIndicadorHidrometro()).append(this.getConsumoTarifa(),
										resumoTemp.getConsumoTarifa()).append(this.getGrupoFaturamento(), resumoTemp.getGrupoFaturamento())
						.isEquals();
	}
	...
	public ResumoFaturamentoOutrosHelper(Integer idImovel, Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idElo,
	...
	public ResumoFaturamentoOutrosHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade, Integer idSetorComercial,
