...
public class ResumoFaturamentoAguaEsgotoHelper {
	...
	public boolean equals(Object obj){
		...
		return new EqualsBuilder().append(this.getIdGerenciaRegional(), resumoTemp.getIdGerenciaRegional()).append(
						...
						.append(this.getIdSubCategoria(), resumoTemp.getIdSubCategoria()).append(this.getConsumoTarifa(),
										resumoTemp.getConsumoTarifa()).append(this.getGrupoFaturamento(), resumoTemp.getGrupoFaturamento())
						.append(this.getIndicadorHidrometro().intValue(), resumoTemp.getIndicadorHidrometro().intValue()).isEquals();
	}
	...
	public ResumoFaturamentoAguaEsgotoHelper(Integer idImovel, Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idElo,
	...
	public ResumoFaturamentoAguaEsgotoHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade, Integer idSetorComercial,
