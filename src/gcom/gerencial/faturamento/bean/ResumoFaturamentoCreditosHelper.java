...
public class ResumoFaturamentoCreditosHelper {
	...
	public boolean equals(Object obj){
		...
		return new EqualsBuilder().append(this.getIdGerenciaRegional(), resumoTemp.getIdGerenciaRegional()).append(
						this.getIdUnidadeNegocio(), resumoTemp.getIdUnidadeNegocio()).append(this.getIdElo(), resumoTemp.getIdElo())
						.append(this.getIdLocalidade(), resumoTemp.getIdLocalidade()).append(this.getIdSetorComercial(),
										resumoTemp.getIdSetorComercial()).append(this.getIdRota(), resumoTemp.getIdRota()).append(
										this.getIdQuadra(), resumoTemp.getIdQuadra()).append(this.getCodigoSetorComercial(),
										resumoTemp.getCodigoSetorComercial()).append(this.getNumeroQuadra(), resumoTemp.getNumeroQuadra())
						.append(this.getIdPerfilImovel(), resumoTemp.getIdPerfilImovel()).append(this.getIdEsfera(),
										resumoTemp.getIdEsfera()).append(this.getIdTipoClienteResponsavel(),
										resumoTemp.getIdTipoClienteResponsavel()).append(this.getIdSituacaoLigacaoAgua(),
										resumoTemp.getIdSituacaoLigacaoAgua()).append(this.getIdSituacaoLigacaoEsgoto(),
										resumoTemp.getIdSituacaoLigacaoEsgoto()).append(this.getIdPerfilLigacaoAgua(),
										resumoTemp.getIdPerfilLigacaoAgua()).append(this.getIdPerfilLigacaoEsgoto(),
										resumoTemp.getIdPerfilLigacaoEsgoto()).append(this.getIdCategoria(), resumoTemp.getIdCategoria())
						.append(this.getIdSubCategoria(), resumoTemp.getIdSubCategoria()).append(this.getCreditoOrigem(),
										resumoTemp.getCreditoOrigem()).append(this.getLictId(), resumoTemp.getLictId()).append(
										this.getTipoCredito(), resumoTemp.getTipoCredito()).append(this.getIndicadorHidrometro(),
										resumoTemp.getIndicadorHidrometro()).append(this.getConsumoTarifa(), resumoTemp.getConsumoTarifa())
						.append(this.getGrupoFaturamento(), resumoTemp.getGrupoFaturamento()).isEquals();
	}
	 ...
	 *            O idSituacaoLigacaoAgua a ser setado.
	 */
	 ...
	 *            O idSituacaoLigacaoEsgoto a ser setado.
	 */
	...
	public int hashCode(){
		...
		String retorno = this.getIdGerenciaRegional() + "sdf" + this.getIdUnidadeNegocio() + "sdf" + this.getIdLocalidade() + "sdf"
						+ this.getIdElo() + "sdf" + this.getIdSetorComercial() + "sdf" + this.getIdRota() + "sdf" + this.getIdQuadra()
						+ "sdf" + this.getCodigoSetorComercial() + "sdf" + this.getNumeroQuadra() + "sdf" + this.getIdPerfilImovel()
						+ "sdf" + this.getIdSituacaoLigacaoAgua() + "sdf" + this.getIdSituacaoLigacaoEsgoto() + "sdf"
						+ this.getIdPerfilLigacaoAgua() + "sdf" + this.getIdPerfilLigacaoEsgoto() + "sdf" + this.getIdEsfera() + "sdf";
		return retorno.hashCode();
	}

	public ResumoFaturamentoCreditosHelper(Integer idImovel, Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idElo,
											...
											Integer idSituacaoLigacaoAgua, Integer idSituacaoLigacaoEsgoto, Integer idPerfilLigacaoAgua,
	...
	public ResumoFaturamentoCreditosHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade, Integer idSetorComercial,
											Integer idRota, Integer idQuadra, Integer codigoSetorComercial, Integer numeroQuadra,
											Integer idPerfilImovel, Integer idSituacaoLigacaoAgua, Integer idSituacaoLigacaoEsgoto,
											Integer idEsfera) {
		...
		this.idSituacaoLigacaoAgua = idSituacaoLigacaoAgua;
		this.idSituacaoLigacaoEsgoto = idSituacaoLigacaoEsgoto;
		if(idEsfera != null && idEsfera.intValue() != 0) this.idEsfera = idEsfera;
	}
