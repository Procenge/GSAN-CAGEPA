...
public class ResumoFaturamentoSituacaoEspecialHelper {
	...
	public int hashCode(){
		...
		this.getIdGerenciaRegional() + "sdf" + this.getIdLocalidade() + "sdf" + this.getIdSetorComercial() + "sdf" + this.getIdRota()
						...
						+ "sdf" + this.getIdCategoria() + "sdf" + this.getIdEsfera() + "sdf" + this.getIdEspecialFaturamento() + "sdf"
						+ this.getIdMotivoSituacaoEspecialFatauramento() + "sdf" + this.getAnoMesFinalSituacaoEspecial() + "sdf"
	...
	/**
	 * @param idEspecialFaturamento
	 *            O idEspecialFaturamento a ser setado.
	 */
	...
	/**
	 * @param idMotivoSituacaoEspecialFatauramento
	 *            O idMotivoSituacaoEspecialFatauramento a ser setado.
	 */
	public void setIdMotivoSituacaoEspecialFatauramento(Integer idMotivoSituacaoEspecialFatauramento){
	...
	public ResumoFaturamentoSituacaoEspecialHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade,
													...
													Integer idSituacaoLigacaoAgua, Integer idSituacaoLigacaoEsgoto, Integer idCategoria,
													Integer idEsfera, Integer idEspecialFaturamento,
													Integer idMotivoSituacaoEspecialFatauramento, Integer anoMesInicioSituacaoEspecial,
