...
public class ResumoFaturamentoImpostosHelper {
	...
	public boolean equals(Object obj){
		...
		return new EqualsBuilder().append(this.getIdGerenciaRegional(), resumoTemp.getIdGerenciaRegional()).append(
						...
						.append(this.getIdSubCategoria(), resumoTemp.getIdSubCategoria()).append(this.getIndicadorHidrometro().intValue(),
										resumoTemp.getIndicadorHidrometro().intValue()).append(this.getImpostoTipo(),
										resumoTemp.getImpostoTipo()).append(this.getConsumoTarifa(), resumoTemp.getConsumoTarifa()).append(
										this.getGrupoFaturamento(), resumoTemp.getGrupoFaturamento()).isEquals();
	}
	...
	public ResumoFaturamentoImpostosHelper(Integer idImovel, Integer idGerenciaRegional, Integer idUnidadeNegocio, Integer idElo,
	...
	public ResumoFaturamentoImpostosHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade, Integer idSetorComercial,
