 ...
 * @date 20/05/2006
 */
public class ResumoFaturamentoSituacaoEspecialConsultaUnidadeNegocioHelper {
	...
	public ResumoFaturamentoSituacaoEspecialConsultaUnidadeNegocioHelper(Integer idUnidadeNegocio,
 String dsUnidadeNegocio,
