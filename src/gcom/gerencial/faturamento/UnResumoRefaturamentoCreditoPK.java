...
public class UnResumoRefaturamentoCreditoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("IdResumoRefaturamentoAguaEsgoto", getIdResumoRefaturamentoAguaEsgoto()).append(
						"IdCreditoOrigem", getIdCreditoOrigem()).append("idLancamentoItemContabil", getIdLancamentoItemContabil())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getIdResumoRefaturamentoAguaEsgoto(), castOther.getIdResumoRefaturamentoAguaEsgoto())
						.append(this.getIdCreditoOrigem(), castOther.getIdCreditoOrigem()).append(this.getIdLancamentoItemContabil(),
										castOther.getIdLancamentoItemContabil()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getIdResumoRefaturamentoAguaEsgoto()).append(getIdCreditoOrigem()).append(
						getIdLancamentoItemContabil()).toHashCode();
	}
