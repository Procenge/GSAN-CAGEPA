...
public class UnResumoFaturamentoOutroPK
	...
	/** full constructor */
	public UnResumoFaturamentoOutroPK(Integer resumoFaturamento, Integer documentoTipo, Integer financiamentoTipo,
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("resumoFaturamento", getResumoFaturamento()).append("documentoTipo", getDocumentoTipo())
						.append("financiamentoTipo", getFinanciamentoTipo()).append("lancamentoItemContabil", getLancamentoItemContabil())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getResumoFaturamento(), castOther.getResumoFaturamento()).append(this.getDocumentoTipo(),
						castOther.getDocumentoTipo()).append(this.getFinanciamentoTipo(), castOther.getFinanciamentoTipo()).append(
						this.getLancamentoItemContabil(), castOther.getLancamentoItemContabil()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getResumoFaturamento()).append(getDocumentoTipo()).append(getFinanciamentoTipo()).append(
						getLancamentoItemContabil()).toHashCode();
	}
