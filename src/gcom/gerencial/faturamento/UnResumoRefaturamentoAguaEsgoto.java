...
public class UnResumoRefaturamentoAguaEsgoto
	...
	public UnResumoRefaturamentoAguaEsgoto(int anoMesReferencia, GGerenciaRegional gGerenciaRegional, GUnidadeNegocio gUnidadeNegocio,
											...
											GEsferaPoder gEsferaPoder, GClienteTipo gClienteTipo,
											...
											GLigacaoEsgotoPerfil gLigacaoEsgotoPerfil, int quantidadeContasRetificadas,
											int quantidadeContasCanceladas, BigDecimal valorCanceladoAgua, BigDecimal valorCanceladoEsgoto,
											int volumeCanceladoAgua, int volumeCanceladoEsgoto, int quantidadeContasIncluidas,
											BigDecimal valorIncluidoAgua, BigDecimal valorIncluidoEsgoto, int volumeIncluidoAgua,
											int volumeIncluidoEsgoto, Date ultimaAlteracao, GLocalidade gerLocalidadeElo, GRota gerRota) {
	...
	/** full constructor */
	public UnResumoRefaturamentoAguaEsgoto(Integer id, int anoMesReferencia, int codigoSetorcomercial, int numeroQuadra,
											int quantidadeContasRetificadas, BigDecimal valorCanceladoAgua, int quantidadeContasCanceladas,
											int volumeCanceladoAgua, int quantidadeContasIncluidas, BigDecimal valorCanceladoEsgoto,
											int volumeCanceladoEsgoto, BigDecimal valorIncluidoAgua, int volumeIncluidoAgua,
											BigDecimal valorIncluidoEsgoto, int volumeIncluidoEsgoto, Date ultimaAlteracao,
											GGerenciaRegional gerGerenciaRegional, GSubcategoria gerSubcategoria,
											GSetorComercial gerSetorComercial, GLigacaoAguaPerfil gerLigacaoAguaPerfil,
											GClienteTipo gerClienteTipo, GEsferaPoder gerEsferaPoder, GUnidadeNegocio gerUnidadeNegocio,
											GLigacaoAguaSituacao gerLigacaoAguaSituacao, GLocalidade gerLocalidade,
											GLocalidade gerLocalidadeElo, GCategoria gerCategoria, GImovelPerfil gerImovelPerfil,
											GQuadra gerQuadra, GRota gerRota, GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao,
											GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil, Set unResumoRefaturamentoOutros,
	...
	public void setGerFinanciamentoTipoOutros(GFinanciamentoTipo gerFinanciamentoTipoOutros){
	...
	public void setGerLancamentoItemContabilCredito(GLancamentoItemContabil gerLancamentoItemContabilCredito){
	...
	public void setGerLancamentoItemContabilOutros(GLancamentoItemContabil gerLancamentoItemContabilOutros){
	...
	public void setQuantidadeDocumentosFaturadosCredito(Integer quantidadeDocumentosFaturadosCredito){
	...
	public void setQuantidadeDocumentosFaturadosOutros(Integer quantidadeDocumentosFaturadosOutros){
