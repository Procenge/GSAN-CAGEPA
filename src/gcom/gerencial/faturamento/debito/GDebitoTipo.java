...
public class GDebitoTipo
	...
	/** full constructor */
	public GDebitoTipo(Integer id, String descricaoDebitoTipo, String descricaoAbreviado, Short indicadorUso, Date ultimaAlteracao,
						BigDecimal Valorlimite, short indicadorGeracaoAutomatica, short indicadorGeracaoConta,
						GLancamentoItemContabil gerLancamentoItemContabil, GFinanciamentoTipo gerFinanciamentoTipo) {
	...
	/** minimal constructor */
	public GDebitoTipo(Integer id, Date ultimaAlteracao, short indicadorGeracaoAutomatica, short indicadorGeracaoConta,
						GLancamentoItemContabil gerLancamentoItemContabil, GFinanciamentoTipo gerFinanciamentoTipo) {
