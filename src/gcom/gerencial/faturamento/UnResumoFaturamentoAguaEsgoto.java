...
public class UnResumoFaturamentoAguaEsgoto
	...
	public UnResumoFaturamentoAguaEsgoto(int referencia, GGerenciaRegional gGerenciaRegional, GUnidadeNegocio gUnidadeNegocio,
											...
											int quantidadeEconomiasFaturadas, Date ultimaAlteracao, GLocalidade gerLocalidadeElo,
											GRota gerRota, GEmpresa gerEmpresa) {
	...
	public UnResumoFaturamentoAguaEsgoto(int referencia, GGerenciaRegional gGerenciaRegional, GUnidadeNegocio gUnidadeNegocio,
											...
											BigDecimal valorDocumentosFaturadosOutros, Short quantidadeDocumentosFaturadosOutros,
	...
	public UnResumoFaturamentoAguaEsgoto(int referencia, GGerenciaRegional gGerenciaRegional, GUnidadeNegocio gUnidadeNegocio,
											...
											BigDecimal valorDocumentosFaturadosOutros, Short quantidadeDocumentosFaturadosOutros,
											Date ultimaAlteracao, GLocalidade gerLocalidadeElo, GRota gerRota, GEmpresa gerEmpresa,
											Integer quantidadeFinanciamentoIncluido, Integer quantidadeFinanciamentoCancelado,
											BigDecimal valorFinanciamentoIncluido, BigDecimal valorFinanciamentoCancelado) {
	...
	// CONSTRUTOR FULL
	public UnResumoFaturamentoAguaEsgoto(int referencia, int codigoSetorComercial, int numeroQuadra, int volumeFaturadoagua,
											BigDecimal valorFaturadoEsgoto, BigDecimal valorFaturadoAgua, int volumeFaturadoEsgoto,
											int quantidadeContasEmitidas, Date ultimaAlteracao, GSubcategoria gSubcategoria,
											GClienteTipo gClienteTipo, GLigacaoAguaSituacao gLigacaoAguaSituacao,
											GUnidadeNegocio gUnidadeNegocio, GLocalidade gLocalidade, GLocalidade gLocalidadeElo,
											GQuadra gQuadra, GLigacaoEsgotoSituacao gLigacaoEsgotoSituacao,
											...
											GPagamentoSituacao gPagamentoSituacao, GLigacaoAguaPerfil gLigacaoAguaPerfil,
											GEpocaPagamento gEpocaPagamento, GEsferaPoder gEsferaPoder, GCategoria gCategoria,
											GImovelPerfil gImovelPerfil, GRota gRota, Set unResumoArrecadacaoCreditos,
	...
	public void setQuantidadeFinanciamentoCancelado(Integer quantidadeFinanciamentoCancelado){
	...
	public void setQuantidadeFinanciamentoIncluido(Integer quantidadeFinanciamentoIncluido){
