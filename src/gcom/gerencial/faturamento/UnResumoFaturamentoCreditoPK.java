...
public class UnResumoFaturamentoCreditoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("resumoFaturamento", getResumoFaturamento()).append("creditoOrigem", getCreditoOrigem())
						.append("lancamentoItemContabil", getLancamentoItemContabil()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getResumoFaturamento(), castOther.getResumoFaturamento()).append(this.getCreditoOrigem(),
						castOther.getCreditoOrigem()).append(this.getLancamentoItemContabil(), castOther.getLancamentoItemContabil())
						.isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getResumoFaturamento()).append(getCreditoOrigem()).append(getLancamentoItemContabil())
						.toHashCode();
	}
