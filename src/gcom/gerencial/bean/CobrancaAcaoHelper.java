...
public class CobrancaAcaoHelper {
	 ...
	 */
	public void setColecaoCobrancaAcaoSituacao(Collection colecaoCobrancaAcaoSituacao){
	...
	public CobrancaAcaoHelper(Integer id, String descricao, Date realizacaoEmitir, Date realizacaoEncerrar,
								int somatorioQuantidadesDocumentos, BigDecimal somatorioValoresDocumentos) {
	...
	public void setSomatorioQuantidadesDocumentos(int somatorioQuantidadesDocumentos){
	...
	public void setSomatorioValoresDocumentos(BigDecimal somatorioValoresDocumentos){
