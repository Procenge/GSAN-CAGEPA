...
public class InformarDadosGeracaoResumoAcaoConsultaEventualHelper {
	...
	private Collection colecaoCobrancaAcao;
	...
	public void setColecaoLigacaoEsgotoSituacao(Collection colecaoLigacaoEsgotoSituacao){
	...
	public String getFormatarDataEmissaoInicial(){
		...
		String dataEmissaoInicialString = Util.formatarData(this.dataInicialEmissao);
	...
	public String getFormatarDataEmissaoFinal(){
		...
		String dataEmissaoFinalString = Util.formatarData(this.dataFinalEmissao);
	...
	public Collection getColecaoCobrancaAcao(){

		return colecaoCobrancaAcao;
	}

	public void setColecaoCobrancaAcao(Collection colecaoCobrancaAcao){
