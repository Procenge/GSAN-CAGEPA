...
public class OperacaoTabelaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("operacaoId", getOperacaoId()).append("tabelaId", getTabelaId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getOperacaoId(), castOther.getOperacaoId()).append(this.getTabelaId(),
						castOther.getTabelaId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getOperacaoId()).append(getTabelaId()).toHashCode();
	}
