...
public class GrupoFuncionalidadeOperacaoPK
				extends ObjetoGcom {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("grupoId", getGrupoId()).append("operacaoId", getOperacaoId()).append("funcionalidadeId",
						getFuncionalidadeId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getGrupoId(), castOther.getGrupoId())
						.append(this.getOperacaoId(), castOther.getOperacaoId()).append(this.getFuncionalidadeId(),
										castOther.getFuncionalidadeId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getGrupoId()).append(getOperacaoId()).append(getFuncionalidadeId()).toHashCode();
	}
