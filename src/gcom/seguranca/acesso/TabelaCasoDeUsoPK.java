...
public class TabelaCasoDeUsoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("tabelaId", getTabelaId()).append("casoDeUsoId", getCasoDeUsoId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getTabelaId(), castOther.getTabelaId()).append(this.getCasoDeUsoId(),
						castOther.getCasoDeUsoId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getTabelaId()).append(getCasoDeUsoId()).toHashCode();
	}
