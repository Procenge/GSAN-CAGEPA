...
public class GrupoAcessoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("grupId", getGrupId()).append("grupIdacesso", getGrupIdacesso()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getGrupId(), castOther.getGrupId()).append(this.getGrupIdacesso(),
						castOther.getGrupIdacesso()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getGrupId()).append(getGrupIdacesso()).toHashCode();
	}
