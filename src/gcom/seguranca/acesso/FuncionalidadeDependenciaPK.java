...
public class FuncionalidadeDependenciaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("funcionalidadeDependenciaId", getFuncionalidadeDependenciaId()).append("funcionalidadeId",
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getFuncionalidadeDependenciaId(), castOther.getFuncionalidadeDependenciaId()).append(
						this.getFuncionalidadeId(), castOther.getFuncionalidadeId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getFuncionalidadeDependenciaId()).append(getFuncionalidadeId()).toHashCode();
	}
