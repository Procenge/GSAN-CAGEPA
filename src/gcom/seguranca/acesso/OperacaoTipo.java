...
public class OperacaoTipo
	...
	public static Integer PESQUISAR = new Integer(1);

	/** constantes que indica o codigo do REMOVER */
	public static Integer REMOVER = new Integer(2);

	/** constantes que indica o codigo do ATUALIZAR */
	public static Integer ATUALIZAR = new Integer(3);

	/** constantes que indica o codigo do INSERIR */
	public static Integer INSERIR = new Integer(4);
	...
	/**
	 * @param indicadorAtualiza
	 *            O indicadorAtualiza a ser setado.
	 */
