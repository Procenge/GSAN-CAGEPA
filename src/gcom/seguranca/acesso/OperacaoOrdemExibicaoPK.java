...
public class OperacaoOrdemExibicaoPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("operacaoId", getOperacaoId()).append("tabelaColunaId", getTabelaColunaId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getOperacaoId(), castOther.getOperacaoId()).append(this.getTabelaColunaId(),
						castOther.getTabelaColunaId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getOperacaoId()).append(getTabelaColunaId()).toHashCode();
	}
