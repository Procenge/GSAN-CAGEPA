...
public class UsuarioGrupoRestricao
	...
	public Filtro retornaFiltro(){
		...
		filtroUsuarioGrupoRestricao
						.adicionarParametro(new ParametroSimples(FiltroUsuarioGrupoRestricao.USUARIO_ID, comp_id.getUsuarioId()));
		filtroUsuarioGrupoRestricao.adicionarParametro(new ParametroSimples(FiltroUsuarioGrupoRestricao.FUNCIONALIDADE_ID, comp_id
						.getFuncionalidadeId()));
		filtroUsuarioGrupoRestricao.adicionarParametro(new ParametroSimples(FiltroUsuarioGrupoRestricao.GRUPO_ID, comp_id.getGrupoId()));
		filtroUsuarioGrupoRestricao.adicionarParametro(new ParametroSimples(FiltroUsuarioGrupoRestricao.OPERACAO_ID, comp_id
						.getOperacaoId()));
	...
	public UsuarioGrupoRestricao(gcom.seguranca.acesso.usuario.UsuarioGrupoRestricaoPK comp_id,
									gcom.seguranca.acesso.GrupoFuncionalidadeOperacao grupoFuncionalidadeOperacao,
