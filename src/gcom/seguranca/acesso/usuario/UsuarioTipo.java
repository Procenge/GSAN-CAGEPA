...
public class UsuarioTipo
	...
	public static final short INDICADOR_TERCEIRIZADO = new Short("2");
	...
	/** full constructor */
	public UsuarioTipo(String descricao, Short indicadorUso, Date ultimaAlteracao) {
	...
	public boolean equals(Object arg){
		...
		if(!(arg instanceof UsuarioTipo)){
			return false;
		}
		return this.id.intValue() == ((UsuarioTipo) arg).getId().intValue();
	}
