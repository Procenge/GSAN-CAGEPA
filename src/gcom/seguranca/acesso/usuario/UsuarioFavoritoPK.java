...
public class UsuarioFavoritoPK
	...
	/**
	 * @param funcionalidadeId
	 *            O funcionalidadeId a ser setado.
	 */
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("usurId", getUsuarioId()).append("fncdId", getFuncionalidadeId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getUsuarioId(), castOther.getUsuarioId()).append(this.getFuncionalidadeId(),
						castOther.getFuncionalidadeId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getUsuarioId()).append(getFuncionalidadeId()).toHashCode();
	}
