...
public class UsuarioPermissaoEspecial
	...
	public Filtro retornaFiltro(){
		...
		FiltroUsuarioPemissaoEspecial filtroUsuarioPermissaoEspecial = new FiltroUsuarioPemissaoEspecial();

		filtroUsuarioPermissaoEspecial.adicionarCaminhoParaCarregamentoEntidade("comp_id");
		filtroUsuarioPermissaoEspecial.adicionarCaminhoParaCarregamentoEntidade("usuario");
		filtroUsuarioPermissaoEspecial.adicionarCaminhoParaCarregamentoEntidade("permissaoEspecial");
		filtroUsuarioPermissaoEspecial.adicionarParametro(new ParametroSimples(FiltroUsuarioPemissaoEspecial.PERMISSAO_ESPECIAL_ID,
						permissaoEspecial.getId()));
		filtroUsuarioPermissaoEspecial.adicionarParametro(new ParametroSimples(FiltroUsuarioPemissaoEspecial.USUARIO_ID, usuario.getId()));
		return filtroUsuarioPermissaoEspecial;
	}
	...
	public UsuarioPermissaoEspecial(gcom.seguranca.acesso.usuario.UsuarioPermissaoEspecialPK comp_id,
									gcom.seguranca.acesso.usuario.Usuario usuario, gcom.seguranca.acesso.PermissaoEspecial permissaoEspecial) {
