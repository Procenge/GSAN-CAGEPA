...
public class UsuarioPermissaoEspecialPK
				extends ObjetoGcom {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("usuarioId", getUsuarioId()).append("permissaoEspecialId", getPermissaoEspecialId())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getUsuarioId(), castOther.getUsuarioId()).append(this.getPermissaoEspecialId(),
						castOther.getPermissaoEspecialId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getUsuarioId()).append(getPermissaoEspecialId()).toHashCode();
	}
