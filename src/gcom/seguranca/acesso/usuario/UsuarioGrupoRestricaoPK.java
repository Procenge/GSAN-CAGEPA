...
public class UsuarioGrupoRestricaoPK
				extends ObjetoGcom {
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("grupoId", getGrupoId()).append("usuarioId", getUsuarioId()).append("funcionalidadeId",
						getFuncionalidadeId()).append("operacaoId", getOperacaoId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getGrupoId(), castOther.getGrupoId()).append(this.getUsuarioId(), castOther.getUsuarioId())
						.append(this.getFuncionalidadeId(), castOther.getFuncionalidadeId()).append(this.getOperacaoId(),
										castOther.getOperacaoId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getGrupoId()).append(getUsuarioId()).append(getFuncionalidadeId()).append(getOperacaoId())
						.toHashCode();
	}
