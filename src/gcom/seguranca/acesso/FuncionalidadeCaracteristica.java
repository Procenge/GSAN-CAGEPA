 ...
 * @author rodrigo
 */
public class FuncionalidadeCaracteristica
	 ...
	 *            Descrição do parâmetro
	 * @param tituloFuncionalidade
	 *            Descrição do parâmetro
	 * @param moduloId
	 *            Descrição do parâmetro
	 * @param caminhoMenu
	 *            Descrição do parâmetro
	 * @param funcionalidadesDependentes
	 *            Descrição do parâmetro
	 * @param pontoEntrada
	 *            Descrição do parâmetro
	 */
	public FuncionalidadeCaracteristica(int especificacao, String caminhoFuncionalidade, String tituloFuncionalidade, Integer moduloId,
										String caminhoMenu, String[] funcionalidadesDependentes, boolean pontoEntrada) {
	 ...
	 */
	public FuncionalidadeCaracteristica(int especificacao, String caminhoFuncionalidade, String tituloFuncionalidade, Integer moduloId,
										String caminhoMenu, String[] funcionalidadesDependentes, Class classe, boolean pontoEntrada) {
	 ...
	 * @param pontoEntrada
	 *            Descrição do parâmetro
	 * @param caminhoFuncionalidadePaiOperacao
	 *            Descrição do parâmetro
	 */
	public FuncionalidadeCaracteristica(int especificacao, String caminhoFuncionalidade, String tituloFuncionalidade, Integer moduloId,
										String caminhoMenu, String[] funcionalidadesDependentes, boolean pontoEntrada,
	...
	public FuncionalidadeCaracteristica(int especificacao, String caminhoFuncionalidade, String tituloFuncionalidade, Integer moduloId,
										String caminhoMenu, String[] funcionalidadesDependentes, boolean pontoEntrada,
										String caminhoFuncionalidadePaiOperacao, Class classe) {
	 ...
	 * 
	 * @param caminhoFuncionalidade
	 *            O novo valor de caminhoFuncionalidade
	 */
	 ...
	 * 
	 * @param tituloFuncionalidade
	 *            O novo valor de tituloFuncionalidade
	 */
	 ...
	 * 
	 * @param tipoFuncionalidadeId
	 *            O novo valor de tipoFuncionalidade
	 */
