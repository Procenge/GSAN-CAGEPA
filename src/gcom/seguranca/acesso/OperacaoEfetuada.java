...
public class OperacaoEfetuada
	...
	public void setTabelaLinhaAlteracaoPrincipal(TabelaLinhaAlteracao tabelaLinhaAlteracaoPrincipal){
		...
		if(objetoTransacao != null){
			...
			if(atributos != null && getDadosAdicionais() == null){
				...
				for(int i = 0; i < atributos.length; i++){
					...
					dadosAdicionais += labels[i] + ":" + (valor == null ? "" : valorFormatado) + "$";
				}
	...
	public String getDescricaoArgumento(){

		String descricao = "";
		if(getArgumento() != null){
			descricao = getArgumento().getDescricao();
		}
		return descricao;
	}
