...
public class TabelaLinhaColunaAlteracao
	...
	/** full constructor */
	public TabelaLinhaColunaAlteracao(String conteudoColunaAnterior, String conteudoColunaAtual, Date ultimaAlteracao,
	...
	/** minimal constructor */
	public TabelaLinhaColunaAlteracao(gcom.seguranca.transacao.TabelaColuna tabelaColuna,
										gcom.seguranca.transacao.TabelaLinhaAlteracao tabelaLinhaAlteracao) {
	...
	private String formatarConteudo(Object conteudo){
		...
		if(conteudo != null){
			if(conteudo instanceof Date){
				// retorno = Util.formatarData((Date)conteudo);
				retorno = Util.formatarDataComHora((Date) conteudo);
			}else if(conteudo instanceof Short && tabelaColuna != null && tabelaColuna.getColuna() != null
