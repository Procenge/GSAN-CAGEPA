...
public class ArrecadacaoForma
	 ...
	 * Description of the Field
	 */
	public final static Integer ARRECADACAO_ELETRONICA = new Integer("2");
	 ...
	 * Description of the Field
	 */
	public final static Integer COBRANCA_BANCARIA = new Integer("14");
	...
	public Filtro retornaFiltro(){
		...
		filtroArrecadacaoForma.adicionarParametro(new ParametroSimples(FiltroArrecadacaoForma.CODIGO, this.getId()));
		return filtroArrecadacaoForma;
	}
}
