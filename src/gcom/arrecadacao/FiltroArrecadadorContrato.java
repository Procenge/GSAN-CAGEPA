...
public class FiltroArrecadadorContrato
				extends Filtro
	...
	public final static String CODIGO_CONVENIO_BOLETO_BANCARIO = "codigoConvenioBoletoBancario";

	public final static String CODIGO_CONVENIO = "codigoConvenio";

	public final static String CODIGO_CONVENIO_DEBITO_AUTOMATICO = "codigoConvenioDebitoAutomatico";

	public final static String CODIGO_CONVENIO_FICHA_COMPENSACAO = "codigoConvenioFichaCompensacao";

	public final static String CODIGO_CONVENIO_PARCELAMENTO_RESP = "codigoConvenioParcelamentoResposavel";

	public final static String CONTA_BANCARIA_DEPOSITO_ARRECADACAO_BOLETO = "contaBancariaDepositoArrecadacaoBoleto";
