...
public class GuiaDevolucao
	...
	public GuiaDevolucao(Date dataEmissao, Date dataValidade, BigDecimal valorDevolucao, Date ultimaAlteracao,
							...
							RegistroAtendimento registroAtendimento, Imovel imovel, DocumentoTipo documentoTipo, ContaGeral contageral,
							OrdemServico ordemServico, Localidade localidade, CreditoTipo creditoTipo, GuiaPagamentoGeral guiaPagamentoGeral) {
	...
	public GuiaDevolucao(Date dataEmissao, Date dataValidade, BigDecimal valorDevolucao, Date ultimaAlteracao,
							...
							DebitoCreditoSituacao debitoCreditoSituacaoAnterior, DebitoCreditoSituacao debitoCreditoSituacaoAtual,
							RegistroAtendimento registroAtendimento, Imovel imovel, DocumentoTipo documentoTipo, ContaGeral contaGeral,
							OrdemServico ordemServico, Localidade localidade, CreditoTipo creditoTipo,
							GuiaPagamentoGeral guiaPagamentoGeral,
							Integer anoMesReferenciaGuiaDevolucao, DebitoTipo debitoTipo, DebitoACobrar debitoACobrar,
							Funcionario funcionarioAnalista, Funcionario funcionarioAutorizador, Usuario usuario) {
	...
	/** minimal constructor */
	public GuiaDevolucao(LancamentoItemContabil lancamentoItemContabil, Cliente cliente,
							DebitoCreditoSituacao debitoCreditoSituacaoAnterior, DebitoCreditoSituacao debitoCreditoSituacaoAtual,
							RegistroAtendimento registroAtendimento, Imovel imovel, DocumentoTipo documentoTipo, ContaGeral contaGeral,
							OrdemServico ordemServico, Localidade localidade, CreditoTipo creditoTipo, GuiaPagamentoGeral guiaPagamentoGeral) {
	...
	public void setAnoMesReferenciaGuiaDevolucao(Integer anoMesReferenciaGuiaDevolucao){
	...
	/**
	 * @param funcionarioAnalista
	 *            O funcionarioAnalista a ser setado.
	 */
	...
	/**
	 * @param funcionarioAutorizador
	 *            O funcionarioAutorizador a ser setado.
	 */
	...
	public Filtro retornaFiltro(){
		...
		FiltroGuiaDevolucao filtro = new FiltroGuiaDevolucao();
		filtro.adicionarParametro(new ParametroSimples(FiltroGuiaDevolucao.ID, this.getId()));
