...
public class Agencia
				implements Serializable, Comparable<Agencia> {
	...
	/** full constructor */
	public Agencia(String codigoAgencia, String nomeAgencia, String numeroTelefone, String numeroRamal, String numeroImovel,
					String complementoEndereco, Date ultimaAlteracao, String numeroFax, String email, Bairro bairro,
					LogradouroCep logradouroCep, LogradouroBairro logradouroBairro, gcom.arrecadacao.banco.Banco banco,
					Logradouro logradouro, EnderecoReferencia enderecoReferencia, Cep cep) {
	...
	/** minimal constructor */
	public Agencia(String nomeAgencia, String numeroTelefone, String numeroRamal, Bairro bairro, gcom.arrecadacao.banco.Banco banco,
					Logradouro logradouro, EnderecoReferencia enderecoReferencia, Cep cep) {
	 ...
	 *            O logradouroBairro a ser setado.
	 */
	...
	public String getEnderecoFormatado(){
		...
		if(this.getLogradouroCep() != null && this.getLogradouroCep().getLogradouro() != null
						&& !this.getLogradouroCep().getLogradouro().getId().equals(Integer.parseInt("0"))){
	...
	public Filtro retornaFiltro(){
		...
		filtroAgencia.adicionarParametro(new ParametroSimples(FiltroAgencia.ID, this.getId()));
	...
	public String getDescricaoComId(){
		...
		if(this.getId().compareTo(10) == -1){
			descricaoComId = "0" + getId() + " - " + getNomeAgencia();
		}else{
			descricaoComId = getId() + " - " + getNomeAgencia();
		}

		return descricaoComId;
	}

	public int compareTo(Agencia obj){

		int retorno = 0;

		final String codigoAgenciaStr1 = this.getCodigoAgencia();
		final String codigoAgenciaStr2 = obj.getCodigoAgencia();

		Integer codigoAgenciaInt1 = null;
		Integer codigoAgenciaInt2 = null;

		try{
			codigoAgenciaInt1 = Integer.parseInt(codigoAgenciaStr1);
		}catch(NumberFormatException ex){
			//
		}

		try{
			codigoAgenciaInt2 = Integer.parseInt(codigoAgenciaStr2);
		}catch(NumberFormatException ex){
			//
		}

		if(codigoAgenciaInt1 == null && codigoAgenciaInt2 != null){
			// menor
			retorno = -1;
		}else if(codigoAgenciaInt1 != null && codigoAgenciaInt2 == null){
			// maior
			retorno = 1;
		}else if(codigoAgenciaInt1 == null && codigoAgenciaInt2 == null){
			// igual
			...
			retorno = codigoAgenciaInt1.compareTo(codigoAgenciaInt2);
		}
	...
	public String getDescricaoComCodigo(){
		...
		return getCodigoAgencia() + " - " + getNomeAgencia();
	}
	...
	public String getDescricaoParaRegistroTransacao(){
		...
		if(this.getCodigoAgencia() != null && this.getCodigoAgencia() != null){

			retorno = this.getCodigoAgencia().toString() + " - " + this.getNomeAgencia();
		}else{
