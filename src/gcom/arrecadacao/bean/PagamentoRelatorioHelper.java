...
public class PagamentoRelatorioHelper {
	...
	private Integer numeroPrestacaoGuia;
	 ...
	 */
	public void setDescricaoSituacaoPagamentoAtual(String descricaoSituacaoPagamentoAtual){
	 ...
	 * @author Saulo Lima
	 * @date 13/01/2009
	 *       Pegar o valor da Guia de Pagamento Prestacao
	 */
	public BigDecimal getValorTotalDocumento(){
		...
		if(this.getValorDocumento() != null){
			...
			if(this.getValorEsgoto() != null){
				valorTotalDocumento = valorTotalDocumento.add(this.getValorEsgoto());
			}

			// Valor dos débitos
			if(this.getDebitos() != null){
				valorTotalDocumento = valorTotalDocumento.add(this.getDebitos());
			}

			// Valor dos créditos
			if(this.getValorCreditos() != null){
				valorTotalDocumento = valorTotalDocumento.subtract(this.getValorCreditos());
			}
		...
		}else if(this.getValorDebito() != null && this.numeroPrestacaoDebito != null && this.numeroPrestacaoCobradas != null){
			BigDecimal retornoDivisao = new BigDecimal("0.00");
			BigDecimal retornoMultiplicacao = new BigDecimal("0.00");

			retornoDivisao = Util.dividirArredondando(this.valorDebito, new BigDecimal(this.numeroPrestacaoDebito));

			retornoMultiplicacao = retornoDivisao.multiply(new BigDecimal(this.numeroPrestacaoCobradas));

			valorTotalDocumento = this.valorDebito.subtract(retornoMultiplicacao);

			// Verifica se o pagamento é de Guia de Pagamento
		}else if(this.getValorDebito() != null){
			valorTotalDocumento = this.valorDebito;
		}

		valorTotalDocumento = valorTotalDocumento.setScale(2, BigDecimal.ROUND_HALF_UP);
	 ...
	 *            O descricaoDocumentoTipo a ser setado.
	 */
	...
	/**
	 * @param descricaoSituacaoPagamentoAnterior
	 *            O descricaoSituacaoPagamentoAnterior a ser setado.
	 */
	public void setDescricaoSituacaoPagamentoAnterior(String descricaoSituacaoPagamentoAnterior){
	...
	public Integer getNumeroPrestacaoGuia(){

		return numeroPrestacaoGuia;
	}

	public void setNumeroPrestacaoGuia(Integer numeroPrestacaoGuia){
