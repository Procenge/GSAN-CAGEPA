 ...
 */
public class RegistroHelperCodigoF
	...
	private String indicadorPagamentoGuia;

	private String identificacaoGuia;
	...
	public void setDigitoVerificadoAnoMesConta(String digitoVerificadoAnoMesConta){
	...
	public String getIndicadorPagamentoGuia(){

		return indicadorPagamentoGuia;
	}

	public void setIndicadorPagamentoGuia(String indicadorPagamentoGuia){

		this.indicadorPagamentoGuia = indicadorPagamentoGuia;
	}

	public String getIdentificacaoGuia(){

		return identificacaoGuia;
	}

	public void setIdentificacaoGuia(String identificacaoGuia){
