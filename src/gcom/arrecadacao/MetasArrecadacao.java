...
public class MetasArrecadacao
	...
	/** full constructor */
	public MetasArrecadacao(Integer id, BigDecimal metaFaturamento, BigDecimal metaPendencia, BigDecimal valorArrecadacaoGlobal,
							Date ultimaAlteracao, UnidadeNegocio unidadeNegocio, GerenciaRegional gerenciaRegional, Localidade localidade) {
	...
	/**
	 * @param metaFaturamento
	 *            O metaFaturamento a ser setado.
	 */
	...
	/**
	 * @param valorArrecadacaoGlobal
	 *            O valorArrecadacaoGlobal a ser setado.
	 */
