...
public class ResumoArrecadacao {
	...
	public static final short RECEBIMENTOS_CLASSIFICADOS_SEQUENCIA_TIPO_LANCAMENTO = 2000;

	public static final short RECEBIMENTOS_MESES_SEQUENCIA_TIPO_LANCAMENTO = 2400;
	...
	/**
	 * @param recebimentoTipo
	 *            O recebimentoTipo a ser setado.
	 */
	...
	/**
	 * @param sequenciaItemTipoLancamento
	 *            O sequenciaItemTipoLancamento a ser setado.
	 */
	...
	/**
	 * @param sequenciaTipoLancamento
	 *            O sequenciaTipoLancamento a ser setado.
	 */
	...
	/**
	 * @param valorItemArrecadacao
	 *            O valorItemArrecadacao a ser setado.
	 */
	...
	public ResumoArrecadacao(Integer id, Integer anoMesReferencia, Short sequenciaTipoLancamento, Short sequenciaItemTipoLancamento,
								BigDecimal valorItemArrecadacao, Date ultimaAlteracao, LancamentoItemContabil lancamentoItemContabil,
								LancamentoTipo lancamentoTipo, LancamentoItem lancamentoItem, Localidade localidade,
								GerenciaRegional gerenciaRegional, Categoria categoria, RecebimentoTipo recebimentoTipo) {
