...
public class AcrescimoImpontualidadeDesconto
				extends ObjetoTransacao {

	/** nullable persistent field */
	private Integer id;

	private Date dtPagamentoInicial;

	private Date dtPagamentoFinal;
	...
	private Date dtVencimentoFinal;
	...
	public Date getDtPagamentoInicial(){

		return dtPagamentoInicial;
	}

	public void setDtPagamentoInicial(Date dtPagamentoInicial){

		this.dtPagamentoInicial = dtPagamentoInicial;
	}

	public Date getDtPagamentoFinal(){

		return dtPagamentoFinal;
	}

	public void setDtPagamentoFinal(Date dtPagamentoFinal){

		this.dtPagamentoFinal = dtPagamentoFinal;
	}
	...
	public Date getDtVencimentoFinal(){

		return dtVencimentoFinal;
	}

	public void setDtVencimentoFinal(Date dtVencimentoFinal){
