...
public class PagamentosDevolucoesHelper {
	...
	private String valorTotalPagamentosHistorico;

	private String valorTotalDevolucoes;

	private String valorTotalDevolucoesHistorico;
	...
	public String getValorTotalPagamentosHistorico(){

		return valorTotalPagamentosHistorico;
	}

	public void setValorTotalPagamentosHistorico(String valorTotalPagamentosHistorico){

		this.valorTotalPagamentosHistorico = valorTotalPagamentosHistorico;
	}

	public String getValorTotalDevolucoesHistorico(){

		return valorTotalDevolucoesHistorico;
	}

	public void setValorTotalDevolucoesHistorico(String valorTotalDevolucoesHistorico){

		this.valorTotalDevolucoesHistorico = valorTotalDevolucoesHistorico;
	}

	/**
	 * @param colecaoMovimentarDevolucoes
	 *            O colecaoMovimentarDevolucoes a ser setado.
	 */
	public void setColecaoMovimentarDevolucoes(Collection colecaoMovimentarDevolucoes){
	...
	/**
	 * @param colecaoMovimentarPagamentos
	 *            O colecaoMovimentarPagamentos a ser setado.
	 */
	public void setColecaoMovimentarPagamentos(Collection colecaoMovimentarPagamentos){
	 ...
	 *            O valorTotalDevolucoes a ser setado.
	 */
	 ...
	 *            O valorTotalPagamentos a ser setado.
	 */
