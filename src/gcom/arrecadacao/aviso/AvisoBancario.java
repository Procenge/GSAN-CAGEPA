...
@ControleAlteracao()
public class AvisoBancario
				extends ObjetoTransacao {

	private static final long serialVersionUID = 1L;

	/** AVISO_BANCARIO_REMOVER */
	// Operacao.OPERACAO_AVISO_BANCARIO_REMOVER;
	public static final int OPERACAO_AVISO_BANCARIO_REMOVER = 2;

	/** AVISO_BANCARIO_ATUALIZAR */
	// Operacao.OPERACAO_AVISO_BANCARIO_ATUALIZAR;
	public static final int OPERACAO_AVISO_BANCARIO_ATUALIZAR = 3;

	/** AVISO_BANCARIO_INSERIR */
	// Operacao.OPERACAO_AVISO_BANCARIO_INSERIR;
	public static final int OPERACAO_AVISO_BANCARIO_INSERIR = 4;

	/** identifier field */
	@ControleAlteracao(funcionalidade = {OPERACAO_AVISO_BANCARIO_INSERIR, OPERACAO_AVISO_BANCARIO_REMOVER})
	private Integer id;

	/** persistent field */
	@ControleAlteracao(funcionalidade = OPERACAO_AVISO_BANCARIO_ATUALIZAR)
	...
	@ControleAlteracao(funcionalidade = OPERACAO_AVISO_BANCARIO_ATUALIZAR)
	private BigDecimal valorPagamentoClassificado;

	@ControleAlteracao(funcionalidade = OPERACAO_AVISO_BANCARIO_ATUALIZAR)
	private BigDecimal valorPagamentoNaoClassificado;
	...
	/** full constructor */
	public AvisoBancario(Date dataLancamento, BigDecimal valorContabilizado, int anoMesReferenciaArrecadacao, Short indicadorCreditoDebito,
							int numeroDocumento, BigDecimal valorDevolucao, BigDecimal valorArrecadacao, Short numeroSequencial,
							BigDecimal valorRealizado, Date dataPrevista, Date dataRealizada, BigDecimal valorPrevisto,
							Date ultimaAlteracao, ContaBancaria contaBancaria, Arrecadador arrecadador,
	...
	/** minimal constructor */
	public AvisoBancario(Date dataLancamento, BigDecimal valorContabilizado, int anoMesReferenciaArrecadacao, Short indicadorCreditoDebito,
							int numeroDocumento, ContaBancaria contaBancaria, Arrecadador arrecadador,
							ArrecadadorMovimento arrecadadorMovimento) {
	...
	/**
	 * @param valorArrecadacaoCalculado
	 *            O valorArrecadacaoCalculado a ser setado.
	 */
	...
	/**
	 * @param valorArrecadacaoInformado
	 *            O valorArrecadacaoInformado a ser setado.
	 */
	 ...
	 *            O valorDevolucaoCalculado a ser setado.
	 */
	...
	/**
	 * @param valorDevolucaoInformado
	 *            O valorDevolucaoInformado a ser setado.
	 */
	...
	public BigDecimal getValorPagamentoClassificado(){

		return valorPagamentoClassificado;
	}

	public void setValorPagamentoClassificado(BigDecimal valorPagamentoClassificado){

		this.valorPagamentoClassificado = valorPagamentoClassificado;
	}

	public BigDecimal getValorPagamentoNaoClassificado(){

		return valorPagamentoNaoClassificado;
	}

	public void setValorPagamentoNaoClassificado(BigDecimal valorPagamentoNaoClassificado){

		this.valorPagamentoNaoClassificado = valorPagamentoNaoClassificado;
	}

	@Override
	public String getDescricaoParaRegistroTransacao(){

		return getId() + " - Aviso Bancario";
	}
}
