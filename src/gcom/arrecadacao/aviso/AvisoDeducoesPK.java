...
public class AvisoDeducoesPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("deducaoTipoId", getDeducaoTipoId()).append("avisoBancarioId", getAvisoBancarioId())
						.toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getDeducaoTipoId(), castOther.getDeducaoTipoId()).append(this.getAvisoBancarioId(),
						castOther.getAvisoBancarioId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getDeducaoTipoId()).append(getAvisoBancarioId()).toHashCode();
	}
