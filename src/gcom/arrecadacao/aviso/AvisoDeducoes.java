...
public class AvisoDeducoes
	...
	/** full constructor */
	public AvisoDeducoes(gcom.arrecadacao.aviso.AvisoDeducoesPK comp_id, BigDecimal valorDeducao, Date ultimaAlteracao,
							DeducaoTipo deducaoTipo, gcom.arrecadacao.aviso.AvisoBancario avisoBancario) {
	...
	public boolean equals(Object other){
		...
		if(!(other instanceof AvisoDeducoes)) return false;
