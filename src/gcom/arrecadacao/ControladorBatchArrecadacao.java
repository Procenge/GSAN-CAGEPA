...
public class ControladorBatchArrecadacao
			...
			try{
				switch(objectMessage.getIntProperty("nomeMetodo")){
					...
					case (MetodosBatch.GERAR_MOVIMENTO_DEBITO_AUTOMATICO_BANCO):{
						this.getControladorArrecadacao().gerarMovimentoDebitoAutomaticoBanco(
										(Map<Banco, Collection<DebitoAutomaticoMovimento>>) ((Object[]) objectMessage.getObject())[0],
					...
					case (MetodosBatch.REGERAR_MOVIMENTO_DEBITO_AUTOMATICO_BANCO):{
						this.getControladorArrecadacao().regerarArquivoTxtMovimentoDebitoAutomatico(
										(ArrecadadorMovimento) ((Object[]) objectMessage.getObject())[0],
					...
					case (MetodosBatch.GERAR_RELATORIO_ACOMPANHAMENTO_MOVIMENTO_ARRECADADORES):{
						this.getControladorArrecadacao().gerarResumoAcompanhamentoMovimentoArrecadadores(
										(Usuario) ((Object[]) objectMessage.getObject())[0],
										(String) ((Object[]) objectMessage.getObject())[1],
										(Arrecadador) ((Object[]) objectMessage.getObject())[2],
										(ArrecadacaoForma) ((Object[]) objectMessage.getObject())[3],
										(Concessionaria) ((Object[]) objectMessage.getObject())[4]);
						break;
