...
public class FiltroGuiaDevolucao
				extends Filtro
	 ...
	 * Description of the Field
	 */
	public final static String GUIA_DEVOLUCAO_CONTA_DEBITO_CREDITO_SITUACAO_ATUAL_ID = "contaGeral.conta.debitoCreditoSituacaoAtual.id";

	/**
	 * Description of the Field
	 */
	public final static String GUIA_DEVOLUCAO_GUIA_PAGAMENTO_CLIENTE_ID = "guiaPagamentoGeral.guiaPagamento.cliente.id";

	/**
	 * Description of the Field
	 */
	public final static String GUIA_DEVOLUCAO_GUIA_PAGAMENTO_DEBITO_CREDITO_SITUACAO_ATUAL_ID = "guiaPagamentoGeral.guiaPagamento.debitoCreditoSituacaoAtual.id";
