...
public class DebitoAutomatico
	...
	public static final int ATRIBUTOS_DEBITO_AUTOMATICO_EXCLUIR = 282255;

	/** identifier field */
	private Integer id;

	/** nullable persistent field */
	@ControleAlteracao(funcionalidade = {ATRIBUTOS_DEBITO_AUTOMATICO_EXCLUIR})
	...
	/** full constructor */
	public DebitoAutomatico(String identificacaoClienteBanco, Date dataOpcaoDebitoContaCorrente, Date dataInclusaoNovoDebitoAutomatico,
							Date dataExclusao, Date ultimaAlteracao, Agencia agencia, Imovel imovel) {
	...
	public Filtro retornaFiltro(){
		...
		filtroDebitoAutomatico.adicionarParametro(new ParametroSimples(FiltroDebitoAutomatico.ID, getId()));
		filtroDebitoAutomatico.adicionarCaminhoParaCarregamentoEntidade(FiltroDebitoAutomatico.IMOVEL);
		filtroDebitoAutomatico.adicionarCaminhoParaCarregamentoEntidade(FiltroDebitoAutomatico.AGENCIA);

		return filtroDebitoAutomatico;
	}
