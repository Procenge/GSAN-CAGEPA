...
public class DebitoAutomaticoRetornoCodigo
				implements Serializable {

	public final static Integer DEBITADO = Integer.valueOf(0);

	public final static Integer EFETUADO_EM_DATA_DIVERSA_FERIADO_NA_PRACA = Integer.valueOf(31);
	...
	/**
	 * @param descricaoDebitoAutomaticoRetornoCodigo
	 *            The descricaoDebitoAutomaticoRetornoCodigo to set.
	 */
