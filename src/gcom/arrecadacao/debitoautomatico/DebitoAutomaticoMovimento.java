...
public class DebitoAutomaticoMovimento
				implements Serializable {

	private static final long serialVersionUID = 1L;

	/** Gerar Movimento de Débito Automático. */
	public static final String GERAR_MOVIMENTO_DE_DEBITO_AUTOMATICO = "CNTA";

	/** Gerar Movimento de Débito Automático Prefeitura. */
	public static final String GERAR_MOVIMENTO_DE_DEBITO_AUTOMATICO_PREFEITURA = "GPAG";
	...
	private DebitoAutomaticoMovimentoCancelamentoMotivo debitoAutomaticoMovimentoCancelamentoMotivo;
	...
	/** full constructor */
	public DebitoAutomaticoMovimento(Date dataVencimento, BigDecimal valorDebito, Date processamento, Date envioBanco, Date retornoBanco,
										Date ultimaAlteracao, Integer numeroSequenciaArquivoEnviado,
	...
	public void setDebitoAutomaticoRetornoCodigo(
					gcom.arrecadacao.debitoautomatico.DebitoAutomaticoRetornoCodigo debitoAutomaticoRetornoCodigo){
	...
	public void setDebitoAutomaticoMovimentoCancelamentoMotivo(
					DebitoAutomaticoMovimentoCancelamentoMotivo debitoAutomaticoMovimentoCancelamentoMotivo){

		this.debitoAutomaticoMovimentoCancelamentoMotivo = debitoAutomaticoMovimentoCancelamentoMotivo;
	}

	public DebitoAutomaticoMovimentoCancelamentoMotivo getDebitoAutomaticoMovimentoCancelamentoMotivo(){

		return debitoAutomaticoMovimentoCancelamentoMotivo;
	}
