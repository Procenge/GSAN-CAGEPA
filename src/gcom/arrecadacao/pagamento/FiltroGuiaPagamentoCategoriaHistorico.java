...
public class FiltroGuiaPagamentoCategoriaHistorico
				extends Filtro
				implements Serializable {

	private static final long serialVersionUID = 3664174549054241391L;

	/**
	 * Constructor for the FiltroGuiaPagamento object
	 */
	public FiltroGuiaPagamentoCategoriaHistorico() {

	}

	/**
	 * Constructor for the FiltroGuiaPagamentoCategoriaHistorico object
	 */
	public FiltroGuiaPagamentoCategoriaHistorico(String campoOrderBy) {
	...
	public final static String GUIA_PAGAMENTO_ID = "comp_id.guiaPagamentoId";
