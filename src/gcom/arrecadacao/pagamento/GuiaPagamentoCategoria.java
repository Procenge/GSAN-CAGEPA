...
public class GuiaPagamentoCategoria
	...
	public Filtro retornaFiltro(){
		...
		filtroGuiaPagamentoCategoria.adicionarParametro(new ParametroSimples(FiltroGuiaPagamentoCategoria.ID, this.getComp_id()));
		...
		filtroGuiaPagamentoCategoria.adicionarCaminhoParaCarregamentoEntidade("lancamentoItemContabil");
	 ...
	 *            TODO
	 */
	public GuiaPagamentoCategoria(gcom.arrecadacao.pagamento.GuiaPagamentoCategoriaPK comp_id, Integer quantidadeEconomia,
									BigDecimal valorCategoria, gcom.arrecadacao.pagamento.GuiaPagamento guiaPagamento, Categoria categoria,
									Date ultimaAlteracao, LancamentoItemContabil lancamentoItemContabil) {
