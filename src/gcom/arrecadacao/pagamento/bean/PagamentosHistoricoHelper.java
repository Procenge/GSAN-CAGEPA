 ...
 * @date 13/03/2013
 */
public class PagamentosHistoricoHelper
	...
	private boolean creditoARealizarHistorico;

	private boolean creditoARealizar;
	...
	public boolean isCreditoARealizarHistorico(){

		return creditoARealizarHistorico;
	}

	public void setCreditoARealizarHistorico(boolean creditoARealizarHistorico){

		this.creditoARealizarHistorico = creditoARealizarHistorico;
	}

	public boolean isCreditoARealizar(){

		return creditoARealizar;
	}

	public void setCreditoARealizar(boolean creditoARealizar){
