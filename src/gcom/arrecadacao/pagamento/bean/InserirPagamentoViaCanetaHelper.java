 ...
 * @date 16/02/2006
 */
public class InserirPagamentoViaCanetaHelper
	...
	public String getCodigoBarraFormatado(){
		...
		if(codigoBarra != null && !codigoBarra.trim().equalsIgnoreCase("") && codigoBarra.length() == 44){
			return codigoBarra.substring(0, 11) + " " + codigoBarra.substring(11, 22) + " " + codigoBarra.substring(22, 33) + " "
							+ codigoBarra.substring(33, 44);
		}else{
			return "";
		}
	}
