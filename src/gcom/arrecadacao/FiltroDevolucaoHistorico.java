...
public class FiltroDevolucaoHistorico
				extends Filtro
	 ...
	 * Description of the Field
	 */
	public final static String DEVOLUCAO_GUIA_DEVOLUCAO_CONTA_CLIENTE_CONTAS_CLIENTE_RELACAO_TIPO_ID = "guiaDevolucao.contaGeral.conta.clienteContas.clienteRelacaoTipo.id";

	/**
	 * Description of the Field
	 */
	public final static String DEVOLUCAO_GUIA_DEVOLUCAO_CONTA_CLIENTE_CONTAS_CLIENTE_ID = "guiaDevolucao.contaGeral.conta.clienteContas.cliente.id";
	 ...
	 * Description of the Field
	 */
	public final static String DEVOLUCAO_GUIA_DEVOLUCAO_GUIA_PAGAMENTO_CLIENTE_GUIA_PAGAMENTO_CLIENTE_RELACAO_TIPO_ID = "guiaDevolucao.guiaPagamentoGeral.guiaPagamento.clientesGuiaPagamento.clienteRelacaoTipo.id";

	/**
	 * Description of the Field
	 */
	public final static String DEVOLUCAO_GUIA_DEVOLUCAO_GUIA_PAGAMENTO_CLIENTE_GUIA_PAGAMENTO_CLIENTE_ID = "guiaDevolucao.guiaPagamentoGeral.guiaPagamento.clientesGuiaPagamento.cliente.id";

	/**
	 * Description of the Field
	 */
	public final static String DEVOLUCAO_GUIA_DEVOLUCAO_GUIA_PAGAMENTO_CLIENTE_GUIA_PAGAMENTO_GUIA_PAGAMENTO_ID = "guiaDevolucao.guiaPagamentoGeral.guiaPagamento.clientesGuiaPagamento.guiaPagamento.id";
	 ...
	 * Description of the Field
	 */
	public final static String DEVOLUCAO_SITUACAO_ATUAL_DESCRICAO = "devolucaoSituacaoAtual.descricao";

	/**
	 * Description of the Field
	 */
	public final static String DEVOLUCAO_SITUACAO_ANTERIOR_DESCRICAO = "devolucaoSituacaoAnterior.descricao";
	 ...
	 * Description of the Field
	 */
	public final static String GUIA_DEVOLUCAO_CONTA_ID = "guiaDevolucao.contaGeral.conta.id";

	/**
	 * Description of the Field
	 */
	public final static String GUIA_DEVOLUCAO_GUIA_PAGAMENTO_ID = "guiaDevolucao.guiaPagamentoGeral.guiaPagamento.id";

	/**
	 * Description of the Field
	 */
	public final static String GUIA_DEVOLUCAO_DEBITO_A_COBRAR_ID = "guiaDevolucao.debitoACobrarGeral.debitoACobrar.id";
