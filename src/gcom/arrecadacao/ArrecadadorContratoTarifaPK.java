...
public class ArrecadadorContratoTarifaPK
	...
	public String toString(){
		...
		return new ToStringBuilder(this).append("arrecadadorContratoId", getArrecadadorContratoId()).append("arrecadacaoFormaId",
						getArrecadacaoFormaId()).toString();
	}
	...
	public boolean equals(Object other){
		...
		return new EqualsBuilder().append(this.getArrecadadorContratoId(), castOther.getArrecadadorContratoId()).append(
						this.getArrecadacaoFormaId(), castOther.getArrecadacaoFormaId()).isEquals();
	}

	public int hashCode(){

		return new HashCodeBuilder().append(getArrecadadorContratoId()).append(getArrecadacaoFormaId()).toHashCode();
	}
