...
function drawTreeNode(node) {
	...
	if (IsLine[i] == true ){
	    document.writeln("<td nowrap><img src='imagens/tree_linevertical.gif' border=0 width=16 height=22></td>");
	} else{
	    document.writeln("<td nowrap><img src='imagens/tree_blank.gif' border=0 width=16 height=22></td>");
	}
    }
	...
	if (node.numChildren == 0) {
		...
		document.writeln("<td nowrap><img src='imagens/tree_linemiddlenode.gif' border=0 width=16 height=22></td>");
	    } else {
		document.writeln("<td nowrap><img src='imagens/tree_linelastnode.gif' border=0 width=16 height=22></td>");
	    }
	} else {
	    // a turner
	    if (node.expand) {
		...
		if (IsLine[IsLineCount-1]) {
		    // not the end
		    document.writeln("<td nowrap><a href='#' onClick='return "+this.name+".toggle(\""+node.idnum+"\")'><img name='"+node.idnum+"Toggle' src='imagens/tree_handledownmiddle.gif' border=0 width=16 height=22></a></td>");
		} else {
		    // the last one
		    document.writeln("<td nowrap><a href='#' onClick='return "+this.name+".toggle(\""+node.idnum+"\")'><img name='"+node.idnum+"Toggle' src='imagens/tree_handledownlast.gif' border=0 width=16 height=22></a></td>");
		}
	    } else {
		// node is closed adjust the handle appropriately
		if (IsLine[IsLineCount-1]) {
		    // not the end
		    document.writeln("<td nowrap><a href='#' onClick='return "+this.name+".toggle(\""+node.idnum+"\")'><img name='"+node.idnum+"Toggle' src='imagens/tree_handlerightmiddle.gif' border=0 width=16 height=22></a></td>");
		} else {
		    // the last one
		    document.writeln("<td nowrap><a href='#' onClick='return "+this.name+".toggle(\""+node.idnum+"\")'><img name='"+node.idnum+"Toggle' src='imagens/tree_handlerightlast.gif' border=0 width=16 height=22></a></td>");
		}
	    }
	}
    }
	...
	if (node.icon != "null") {
	    ...
	    if (node.numChildren == 0 ) {
		// leaf
		document.writeln("<td nowrap><a href='#' onClick='return "+this.name+".select(\""+node.idnum+"\")'><img src='imagens/tree_document.gif' border=0 width=19 height=22></td></a>");
	    } else {
		document.writeln("<td nowrap><a href='#' onClick='return "+this.name+".select(\""+node.idnum+"\")'><img src='imagens/tree_folder.gif' border=0 width=19 height=22></td></a>");
	    }
	}
    }
...
function toggleTreeNode(idnum) {
    ...
    var imgsrc = null;
    if (node.expand) {
	imgsrc = srcbase + "imagens/tree_handledownlast.gif";
    } else {
	imgsrc = srcbase + "imagens/tree_handlerightlast.gif";
    }
    for (var i=0; i<parent.numChildren-1 ; i++) {
	if (parent.chilren[i] == node) {
	    if (node.expand) {
		imgsrc = srcbase + "imagens/tree_handledownmiddle.gif";
	    } else {
		imgsrc = srcbase + "imagens/tree_handlerightmiddle.gif";
	    }
	    break;
	}
    }
