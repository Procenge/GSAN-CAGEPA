...
<!-- Begin
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
    	...
    	var form = document.forms[0];
      	...
      	if (tipoConsulta == 'arrecadador') {
        	form.codArrecadador.value = codigoRegistro;
	...
	function validarForm(form){
		...
		&& testarCampoValorZero(document.forms[0].codArrecadador, 'Arrecadador')) { 		
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="4" property="codArrecadador"
						tabindex="1" size="4" onkeyup="javascript:limparArrecadadorTecla();"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirAcompanharMovimentoArrecadadoresAction.do', 'codArrecadador', 'Arrecadador');" />
					<a
				...
				<tr>
					...
					<td colspan="2" align="right">
 					  <gcom:controleAcessoBotao name="Button" value="Gerar" onclick="javascript:validarForm(document.forms[0]);" url="gerarRelatorioAcompanhamentoMovimentoArrecadadoresAction.do" />
					</td>
				</tr>
			</table>
			</td>
