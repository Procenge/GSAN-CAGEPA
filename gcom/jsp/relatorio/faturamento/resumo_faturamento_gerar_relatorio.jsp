			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Relátorio Resumo de Faturamento</td>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td align="left"><html:text
						...
						onkeypress="validaEnter(event, 'exibirGerarRelatorioResumoFaturamentoAction.do', 'codigoLocalidade');" />
				...
				<tr>
					...
					<c:if test="${empty requestScope.codigoLocalidade}" var="testeCor">
						<script>
							document.GerarRelatorioResumoFaturamentoActionForm.descricaoLocalidade.style.color = '#FF0000';
						</script>
					</c:if>
					
					<c:if test="${!testeCor}">
						<script>
							document.GerarRelatorioResumoFaturamentoActionForm.descricaoLocalidade.style.color = '#000000';
						</script>
					</c:if>
