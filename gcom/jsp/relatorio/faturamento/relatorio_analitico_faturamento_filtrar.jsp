  ...
  <tr>
    ...
    <td width="625" valign="top" class="centercoltext">
	  ...
	  <table width="100%" border="0">
        ...
        <tr>
        	...
        	<td><html:text property="valorMinimoConta" maxlength="13"
						size="14" onkeyup="formataValorMonetario(this, 13)"
        ...
        <tr>
          ...
          <td width="70%">
          	<html:radio property="indicadorLocalidadeInformatizada" value ="1" onclick="chamarReloadPagina('removerAnaliticoRelatorioRegistroAction.do?habilitaBotao=N')"/>Sim &nbsp;&nbsp;
          	<html:radio property="indicadorLocalidadeInformatizada" value ="2" onclick="chamarReloadPagina('removerAnaliticoRelatorioRegistroAction.do?habilitaBotao=S')"/>Não &nbsp;&nbsp;
          	<html:radio property="indicadorLocalidadeInformatizada" value ="3" onclick="chamarReloadPagina('removerAnaliticoRelatorioRegistroAction.do?habilitaBotao=S')"/>Ambos
          </td>
        </tr>
        <tr>
    ...
    <tr>
	 ...
	 <tr>
        ...
        <tr>
        <td colspan="3">
			<html:text property="quadraFiltro" size="5" maxlength="5" tabindex="1" 
...
<!-- relatorio_analitico_faturamento_filtrar.jsp -->
</html:html>