...
<html:javascript staticJavascript="false"
	formName="GerarRelatorioFaturamentoTarifaSocialForm" />

<script language="JavaScript">

function validarForm(form){
	
	if(form.P_AM_FATURAMENTO.value == '') {
		alert('Informe o Mês e Ano');
		form.P_AM_FATURAMENTO.focus();
		return false;
	} else {
		if(validaMesAno(form.P_AM_FATURAMENTO) == true) {
			if(form.ehRelatorioBatch.value == 2) {
				form.target = "_blank";				
			}
			if(form.P_LC_IM.value == '') {
				form.P_LC_IM.value = '-1';
			}
			form.submit();
			form.target = "";
		}		
...
<html:form action="/gerarRelatorioFaturamentoTarifaSocial"
	...
	<input type="hidden" name="relatorio" value="RelatorioFaturamentoTarifaSocial.rpt"/>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relatório de Faturamento de Tarifa Social</td>
			...
			<table width="100%" border="0">
				...
				<tr>
		          ...
		          <td width="70%">
		          	<html:text property="P_AM_FATURAMENTO" size="7"  maxlength="7" 
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="3"
						property="P_LC_IM" size="4" tabindex="3"
						onblur="javascript:verificaNumero(this);"
						onkeypress="javascript:return validaEnter(event, 'exibirGerarRelatorioFaturamentoTarifaSocialAction.do', 'P_LC_IM');" />
					<a
			...
			<table width="100%" border="0">
				<tr>
					<td valign="top"><input name="button" type="button"
						...
						onclick="window.location.href='/gsan/exibirGerarRelatorioFaturamentoTarifaSocialAction.do?menu=sim'">&nbsp;</td>
					<td valign="top">
