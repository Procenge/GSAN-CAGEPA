...
<html:javascript staticJavascript="false"
	formName="GerarRelatorioFichaFaturamentoForm" />
...
<html:form action="/gerarRelatorioFichaFaturamento"
	name="GerarRelatorioFichaFaturamentoForm"
	...
	<input type="hidden" name="relatorio" value="RelatorioFichaDeFaturamento.rpt"/>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relatório Ficha de Faturamento</td>
			...
			<table width="100%" border="0">
				<tr>
					<td valign="top"><input name="button" type="button"
						...
						onclick="window.location.href='/gsan/exibirGerarRelatorioFichaFaturamentoAction.do?menu=sim'">&nbsp;</td>
					<td valign="top">
