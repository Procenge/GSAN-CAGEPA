...
function limparBorrachaOrigem(tipo){
		var form = document.forms[0];
		form.action="/gsan/exibirGerarRelatorioMaioresDevedoresAction.do";
...
<html:form action="/gerarRelatorioMaioresDevedoresAction.do"
	name="GerarRelatorioMaioresDevedoresActionForm"
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Relátorio dos Maiores Devedores</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para gerar o relat&oacute;rio dos maiores devedores, informe os dados abaixo:</td>
				</tr>
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="3"
							onkeypress="javascript:validaEnterComMensagem(event,'exibirGerarRelatorioMaioresDevedoresAction.do?objetoConsulta=1','localidade','Localidade'); return isCampoNumerico(event);"
							 />
