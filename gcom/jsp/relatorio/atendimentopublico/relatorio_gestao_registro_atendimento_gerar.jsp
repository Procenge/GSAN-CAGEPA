...
<html:javascript staticJavascript="false"  formName="GerarRelatorioGestaoRegistroAtendimentoActionForm"/>
...
<SCRIPT LANGUAGE="JavaScript">
	function reload() {
		...
		form.action = '/gsan/exibirGerarRelatorioGestaoRegistroAtendimentoAction.do';
		form.submit();
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    if (tipoConsulta == 'unidadeSuperior') {
		      ...
		      form.action = 'exibirGerarRelatorioGestaoRegistroAtendimentoAction.do';
		      form.submit();
	    }
	}
	...
	function limparForm(){
		...
		window.location.href = '/gsan/exibirGerarRelatorioGestaoRegistroAtendimentoAction.do?menu=sim';
	}
	...
	function validaForm(){
		var form = document.forms[0];
		if(validateGerarRelatorioGestaoRegistroAtendimentoActionForm(form)){
...
<html:form action="/gerarRelatorioGestaoRegistroAtendimentoAction.do" 
		   name="GerarRelatorioGestaoRegistroAtendimentoActionForm" 
		   type="gcom.gui.relatorio.atendimentopublico.registroatendimento.GerarRelatorioGestaoRegistroAtendimentoActionForm"
		   method="post">
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg">Gerar Relat&oacute;rio Gestão de RA - Registro de Atendimento</td>
			...
			<tr> 
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong> 
                  <label> </label>
				  <html:radio property="tipoPesquisa" value="0" tabindex="1"/>
 				  Sintético
                  <label> &nbsp;&nbsp;
				  <html:radio property="tipoPesquisa" value="1" tabindex="2"/>
 				  Analítico</label>
                  </strong></span></td>
              </tr>
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong> 
                  <label> </label>
				  <html:radio property="situacao" value="0" onclick="javascript: reload();" tabindex="3"/>
 				  Todos
                  <label> &nbsp;&nbsp;
				  <html:radio property="situacao" value="1" onclick="javascript: reload();" tabindex="4"/>
 				  Pendentes</label>
                  <label> &nbsp;&nbsp;
				  <html:radio property="situacao" value="2" onclick="javascript: reload();" tabindex="5"/>
				  Encerrados</label>
				  <label> &nbsp;&nbsp;
				  <html:radio property="situacao" value="501" onclick="javascript: reload();" tabindex="6"/>
				  Reiterados</label>
				  </strong></span></td>
              </tr>
              <tr>
	            ...
	            <td colspan="6"><span class="style2"><strong> 
                  <label> 
				  <html:radio property="situacao" value="3" onclick="javascript: reload();" tabindex="7"/>
				  Sem Local de Ocorr&ecirc;ncia</label>
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <html:radio property="situacao" value="500" onclick="javascript: reload();" tabindex="8"/>
                ...
                <td colspan="6" align="right">
                	<div align="left">
						...
						<html:text property="unidadeSuperiorId" 
							...
							maxlength="8"
							tabindex="17"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirGerarRelatorioGestaoRegistroAtendimentoAction.do', 'unidadeSuperiorId','Unidade Superior');"/>
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong> 
					<logic:equal name="GerarRelatorioGestaoRegistroAtendimentoActionForm" property="situacao" value="2">
					...
					<logic:notEqual name="GerarRelatorioGestaoRegistroAtendimentoActionForm" property="situacao" value="2">
						<html:text property="periodoAtendimentoInicial" 
							size="11" 
							maxlength="10" 
							tabindex="11" 
							onkeyup="mascaraData(this, event);replicaDataAtendimento();"/>
						<a href="javascript:abrirCalendario('GerarRelatorioGestaoRegistroAtendimentoActionForm', 'periodoAtendimentoInicial');">
						<img border="0" 
							src="<bean:message 
									key='caminho.imagens'/>calendario.gif" 
									width="16" 
						...
						a <html:text property="periodoAtendimentoFinal" 
							...
							tabindex="12" 
							onkeyup="mascaraData(this, event)"/>
						<a href="javascript:abrirCalendario('GerarRelatorioGestaoRegistroAtendimentoActionForm', 'periodoAtendimentoFinal');">
						<img border="0" 
							src="<bean:message 
								key='caminho.imagens'/>calendario.gif" 
								width="16" 
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong> 
					<logic:equal name="GerarRelatorioGestaoRegistroAtendimentoActionForm" property="situacao" value="1">
					...
					<logic:notEqual name="GerarRelatorioGestaoRegistroAtendimentoActionForm" property="situacao" value="1">
						<html:text property="periodoEncerramentoInicial" 
							size="11" 
							maxlength="10" 
							tabindex="13" 
							onkeyup="mascaraData(this, event);replicaDataEncerramento();"/>
						<a href="javascript:abrirCalendario('GerarRelatorioGestaoRegistroAtendimentoActionForm', 'periodoEncerramentoInicial');">
						<img border="0" 
							src="<bean:message 
									key='caminho.imagens'/>calendario.gif" 
									width="16" 
						...
						a <html:text property="periodoEncerramentoFinal" 
							...
							tabindex="14" 
							onkeyup="mascaraData(this, event)"/>
						<a href="javascript:abrirCalendario('GerarRelatorioGestaoRegistroAtendimentoActionForm', 'periodoEncerramentoFinal');">
						<img border="0" 
							src="<bean:message 
									key='caminho.imagens'/>calendario.gif" 
									width="16" 
...
<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioGestaoRegistroAtendimentoAction.do&left=500&top=660" />
