...
<SCRIPT LANGUAGE="JavaScript">
	function reload() {
		...
		form.action = '/gsan/exibirGerarRelatorioRAComProcessoAdmJudAction.do';
		form.submit();
	}
	...
	function limparForm(){
		...
		window.location.href = '/gsan/exibirGerarRelatorioRAComProcessoAdmJudAction.do?menu=sim';
	}
	/* Clear Especificação */
...
<html:form action="/gerarRelatorioRAComProcessoAdmJudAction.do" 
		   name="GerarRelatorioRAComProcessoAdmJudActionForm" 
		   type="gcom.gui.relatorio.atendimentopublico.registroatendimento.GerarRelatorioRAComProcessoAdmJudActionForm"
		   method="post">
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg">Gerar Relatório de RA com Processo Adm Jud - Registro de Atendimento</td>
      ...
      <table width="100%" border="0">
			<tr> 
                <td height="24" colspan="7" bordercolor="#000000" class="style1">Para 
                  gerar o Relatório de RA com Processo Adm Jud - Registro de Atendimento, informe os dados abaixo:</td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td colspan="6" align="right"><div align="left"><span class="style2"><strong> 
					<html:text property="unidadeSuperiorId" size="6" maxlength="8"
							   onkeypress="javascript:limparUnidadeAtendimento();validaEnterComMensagem(event, 'exibirGerarRelatorioRAComProcessoAdmJudAction.do?validaUnidadeSuperior=true', 'unidadeSuperiorId','Unidade Superior');"/>
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong>
					<html:text property="unidadeAtendimentoId" size="6" maxlength="8"
							   onkeypress="javascript:limparUnidadeSuperior();validaEnterComMensagem(event, 'exibirGerarRelatorioRAComProcessoAdmJudAction.do?validaUnidadeAtendimento=true', 'unidadeAtendimentoId','Unidade Atendimento');" tabindex="28"/>
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong>
					<html:text property="loginUsuario" 
						...
						onkeypress="javascript:pesquisaEnterSemUpperCase(event, 'exibirGerarRelatorioRAComProcessoAdmJudAction.do', 'loginUsuario');" tabindex="7"/>
              ...
              <tr> 
                ...
                <td colspan="6" align="right"><div align="left"><span class="style2"><strong> 
					<html:text property="unidadeAtualId" size="6" maxlength="8"
							   onkeypress="javascript:validaEnterComMensagem(event, 'exibirGerarRelatorioRAComProcessoAdmJudAction.do?validaUnidadeAtual=true', 'unidadeAtualId','Unidade Atual');" tabindex="29"/>
...
<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioRAComProcessoAdmJudAction.do&left=500&top=400"/>
