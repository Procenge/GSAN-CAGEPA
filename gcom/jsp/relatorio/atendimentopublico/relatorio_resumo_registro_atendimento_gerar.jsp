...
<html:javascript staticJavascript="false"  formName="GerarRelatorioResumoRegistroAtendimentoActionForm"/>
...
<SCRIPT LANGUAGE="JavaScript">
	function reload() {
		...
		form.action = '/gsan/exibirGerarRelatorioResumoRegistroAtendimentoAction.do';
		form.submit();
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    if (tipoConsulta == 'unidadeSuperior') {
		      ...
		      form.action = 'exibirGerarRelatorioResumoRegistroAtendimentoAction.do';
		      form.submit();
	    }
	}
	...
	function limparForm(){
		...
		window.location.href = '/gsan/exibirGerarRelatorioResumoRegistroAtendimentoAction.do?menu=sim';
	}
	...
	function validaForm(){
		var form = document.forms[0];
		if(validateGerarRelatorioResumoRegistroAtendimentoActionForm(form)){
...
<html:form action="/gerarRelatorioResumoRegistroAtendimentoAction.do" 
		   name="GerarRelatorioResumoRegistroAtendimentoActionForm" 
		   type="gcom.gui.relatorio.atendimentopublico.Registroatendimento.GerarRelatorioResumoRegistroAtendimentoActionForm"
		   method="post">
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg">Gerar Relat&oacute;rio Resumo RA - Registro de Atendimento</td>
      ...
      <table width="100%" border="0">
			<tr> 
                ...
                <td colspan="6" align="right">
                	<div align="left">
						...
						<html:text property="unidadeSuperiorId" 
							...
							maxlength="8"
							tabindex="14"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirGerarRelatorioResumoRegistroAtendimentoAction.do', 'unidadeSuperiorId','Unidade Superior');"/>
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong> 
					<logic:equal name="GerarRelatorioResumoRegistroAtendimentoActionForm" property="situacao" value="2">
					...
					<logic:notEqual name="GerarRelatorioResumoRegistroAtendimentoActionForm" property="situacao" value="2">
						<html:text property="periodoAtendimentoInicial" 
							size="11" 
							maxlength="10" 
							tabindex="8" 
							onkeyup="mascaraData(this, event);replicaDataAtendimento();"/>
						<a href="javascript:abrirCalendario('GerarRelatorioResumoRegistroAtendimentoActionForm', 'periodoAtendimentoInicial');">
						<img border="0" 
							src="<bean:message 
									key='caminho.imagens'/>calendario.gif" 
									width="16" 
						...
						a <html:text property="periodoAtendimentoFinal" 
							...
							tabindex="9" 
							onkeyup="mascaraData(this, event)"/>
						<a href="javascript:abrirCalendario('GerarRelatorioResumoRegistroAtendimentoActionForm', 'periodoAtendimentoFinal');">
						<img border="0" 
							src="<bean:message 
								key='caminho.imagens'/>calendario.gif" 
								width="16" 
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong> 
					<logic:equal name="GerarRelatorioResumoRegistroAtendimentoActionForm" property="situacao" value="1">
					...
					<logic:notEqual name="GerarRelatorioResumoRegistroAtendimentoActionForm" property="situacao" value="1">
						<html:text property="periodoEncerramentoInicial" 
							size="11" 
							maxlength="10" 
							tabindex="10" 
							onkeyup="mascaraData(this, event);replicaDataEncerramento();"/>
						<a href="javascript:abrirCalendario('GerarRelatorioResumoRegistroAtendimentoActionForm', 'periodoEncerramentoInicial');">
						<img border="0" 
							src="<bean:message 
									key='caminho.imagens'/>calendario.gif" 
									width="16" 
						...
						a <html:text property="periodoEncerramentoFinal" 
							...
							tabindex="11" 
							onkeyup="mascaraData(this, event)"/>
						<a href="javascript:abrirCalendario('GerarRelatorioResumoRegistroAtendimentoActionForm', 'periodoEncerramentoFinal');">
						<img border="0" 
							src="<bean:message 
									key='caminho.imagens'/>calendario.gif" 
									width="16" 
...
<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioResumoRegistroAtendimentoAction.do&left=500&top=610" />
