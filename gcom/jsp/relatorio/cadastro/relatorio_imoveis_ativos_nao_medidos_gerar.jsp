...
<script language="JavaScript">
	...
	function validarForm() {
		...
		if (validateGerarRelatorioImoveisAtivosNaoMedidosActionForm(form) && campoObrigatorio()) {
			if (validarCampos()) {
				toggleBox('demodiv',1);
			}
		}
...
<html:form action="/gerarRelatorioImoveisAtivosNaoMedidosAction.do"
	...
	type="gcom.gui.relatorio.cadastro.GerarRelatorioImoveisAtivosNaoMedidosActionForm"
	method="post">
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(1);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=1','localidadeInicial','Localidade Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(2);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=2','setorComercialInicial','Setor Comercial Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=3','localidadeFinal','Localidade Final');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							size="3"
							onkeypress="validaEnterDependencia(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=4', document.forms[0].setorComercialFinal, document.forms[0].localidadeFinal.value, 'Localidade Final');"
							tabindex="8"/>
