...
<script language="JavaScript">
				...
				if( msg != ""){
					...
					if( msg != ""){
						...
						if( msg != ""){
							...
							msg = verificarAtributosInicialFinal(form.consumoMedioEsgotoInicial,form.consumoMedioEsgotoFinal,"Consumo de Médio de Esgoto");
							if( msg != ""){
								alert(msg);
								return false;
							}
	...
	function verificarAtributosInicialFinal(campoInicio, campoFim, nomeCampo){
		...
		if (campoInicio.value.length > 0 && campoFim.value.length < 1){
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(1);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisConsumoMedioAction.do?objetoConsulta=1','localidadeInicial','Localidade Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(2);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisConsumoMedioAction.do?objetoConsulta=2','setorComercialInicial','Setor Comercial Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisConsumoMedioAction.do?objetoConsulta=3','localidadeFinal','Localidade Final');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							size="3"
							onkeypress="limparDestino(2);validaEnterDependencia(event, 'exibirGerarRelatorioImoveisConsumoMedioAction.do?objetoConsulta=4', document.forms[0].setorComercialFinal, document.forms[0].localidadeFinal.value, 'Localidade Final');"
							tabindex="8"/>
				...
				<tr>
					...
					<td colsan="3">						
						<html:text maxlength="5"
							...
							size="5" onkeyup="javascript:replicarCampo( document.forms[0].consumoMedioAguaFinal, document.forms[0].consumoMedioAguaInicial );"/>
						<strong>a</strong>
						<html:text maxlength="5"
							tabindex="1"
				...
				<tr>
					...
					<td colsan="3">						
						<html:text maxlength="5"
							...
							size="5" onkeyup="javascript:replicarCampo( document.forms[0].consumoMedioEsgotoFinal, document.forms[0].consumoMedioEsgotoInicial );"/>
						<strong>a</strong>
						<html:text maxlength="5"
							tabindex="1"
