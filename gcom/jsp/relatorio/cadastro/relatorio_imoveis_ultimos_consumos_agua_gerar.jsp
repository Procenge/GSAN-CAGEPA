...
<html:form action="/gerarRelatorioImoveisUltimosConsumosAguaAction.do"
	...
	type="gcom.gui.relatorio.cadastro.GerarRelatorioImoveisUltimosConsumosAguaActionForm"
	method="post">
	    ...
	    <td width="149" valign="top" class="leftcoltext">
	      <div align="center">
			...
			<table width="100%" border="0">
				...
				<tr>
					<td>
						<strong>Unidade de Neg&oacute;cio:<font color="#FF0000">*</font></strong>
					</td>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							size="3"
							onkeypress="limparDestino(2);validaEnterDependencia(event, 'exibirGerarRelatorioImoveisUltimosConsumosAguaAction.do?objetoConsulta=4', document.forms[0].setorComercialFinal, document.forms[0].localidadeFinal.value, 'Localidade Final');"
							tabindex="8"/>
