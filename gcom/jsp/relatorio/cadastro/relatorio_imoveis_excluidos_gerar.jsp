...
<html:javascript staticJavascript="false"  formName="GerarRelatorioImoveisExcluidosActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm() {
		...
		//if (validateGerarRelatorioImoveisExcluidosActionForm(form) && campoObrigatorio()) {
			if (validarCampos()) {
				toggleBox('demodiv',1);
			}
		//}
	...
	function campoObrigatorio(){
		...
		if(form.gerenciaRegional.value == "-1" && form.unidadeNegocio.value == "-1"){
	...
	function chamarPopup(url, tipo, objeto, codigoObjeto, altura, largura, msg,campo){
  	...
  	function reloadForm(){
  		...
  		form.action='exibirGerarRelatorioImoveisExcluidosAction.do';
	    form.submit();
  	}
  	...
  	function limpar(){
		...
		form.sequencialRotaFinal.value = "";
  		...
  		form.action='exibirGerarRelatorioImoveisExcluidosAction.do?menu=sim';
	    form.submit();
  	}
...
<html:form action="/gerarRelatorioImoveisExcluidosAction.do"
	name="GerarRelatorioImoveisExcluidosActionForm"
	type="gcom.gui.relatorio.cadastro.GerarRelatorioImoveisExcluidosActionForm"
	method="post">
...
<table width="770" border="0" cellspacing="4" cellpadding="0">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio  de Im&oacute;veis Excluidos</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(1);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisExcluidosAction.do?objetoConsulta=1','localidadeInicial','Localidade Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(2);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisExcluidosAction.do?objetoConsulta=2','setorComercialInicial','Setor Comercial Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisExcluidosAction.do?objetoConsulta=3','localidadeFinal','Localidade Final');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							size="3"
							onkeypress="validaEnterDependencia(event, 'exibirGerarRelatorioImoveisExcluidosAction.do?objetoConsulta=4', document.forms[0].setorComercialFinal, document.forms[0].localidadeFinal.value, 'Localidade Final');"
							tabindex="8"/>
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioImoveisExcluidosAction.do" />
