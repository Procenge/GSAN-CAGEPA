...
<script language="JavaScript">
	...
	function validarCampos(){
		...
		msg = verificarAtributosInicialFinal(form.referenciaFaturasDiaInicial,form.referenciaFaturasDiaFinal,"Referência de Faturas em Dia",msg);
		msg = verificarAtributosInicialFinal(form.referenciaFaturasAtrasoInicial,form.referenciaFaturasAtrasoFinal,"Referência de Faturas em Atraso",msg);
