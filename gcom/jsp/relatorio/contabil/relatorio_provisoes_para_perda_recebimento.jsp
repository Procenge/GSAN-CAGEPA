...
<html:javascript staticJavascript="false"  formName="GerarRelatorioProvisaoParaPerdasRecebimentoDynaActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(form.pnValorMinimo.value ==null && form.pnValorMinimo.values ==''){
			alert("O campo Valor Mínimo deve ser informado !");
			form.pnValorMinimo.focus();
			return false;
		}
			
		
		if(form.pnValorMaximo.value ==null && form.pnValorMaximo.values ==''){
			alert("O campo Valor Máximo deve ser informado !");
			form.pnValorMaximo.focus();
			return false;
		}
		
		if(form.pnDiasMinimo.value ==null && form.pnDiasMinimo.values ==''){
			alert("O campo Dias Mínimo deve ser informado !");
			form.pnDiasMinimo.focus();
			return false;
		}
		
		if(form.pnDiasMaximo.value ==null && form.pnDiasMaximo.values ==''){
			alert("O campo Dias Máximo deve ser informado !");
			form.pnDiasMaximo.focus();
			return false;
		}
	...
	function limpar(){
  		...
  		form.pnValorMinimo.value = '';
  		form.pnValorMaximo.value = '';
  		form.pnDiasMinimo.value = '';
  		form.pnDiasMaximo.value = '';
  		form.psCodCategoria.value = "-1";
...
<html:form action="/gerarRelatorioProvisaoParaPerdasRecebimentoAction.do"
...
<%@ include file="/jsp/util/menu.jsp" %>
	...
	<input type="hidden" name="relatorio" value="RelatorioProvisoesParaPerdaRecebimentos.rpt"/>
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio de Provisões para Perdas de Recebimento</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Ano: </strong><font color="#FF0000">*</font></td>					
					<td >						
						<html:text maxlength="4" property="psNumeroAno" size="6" onkeypress="javascript:return isCampoNumerico(event); "/>
					</td>
				</tr>
				<tr>
					<td><strong>Mês: </strong><font color="#FF0000">*</font></td>					
					<td >						
						<html:text maxlength="2" property="psNumeroMes" size="4" onkeypress="javascript:return isCampoNumerico(event); "/>
					</td>
				</tr>
				<tr>
					<td><strong>Valor Mínimo do débito: </strong><font color="#FF0000">*</font></td>						
					<td>						
						<html:text maxlength="13" property="pnValorMinimo" size="13" onkeydown="FormataMoeda(this,10,event)" onkeypress="return maskKeyPress(event)" />
						
					</td>
				</tr>
			  	<tr>
					<td><strong>Valor Máximo do débito: </strong><font color="#FF0000">*</font></td>						
					<td>						
						<html:text maxlength="13" property="pnValorMaximo" size="13" onkeydown="FormataMoeda(this,10,event)" onkeypress="return maskKeyPress(event)" />
						
					</td>
				</tr>
				<tr>
					<td><strong>Mínimo de Dias de Atraso: </strong><font color="#FF0000">*</font></td>					
					<td>						
						<html:text maxlength="3" property="pnDiasMinimo" size="3" onkeypress="return isCampoNumerico(event); "/>
					</td>
				</tr>
				<tr>
					<td><strong>Máximo de Dias de Atraso: </strong><font color="#FF0000">*</font></td>					
					<td>						
						<html:text maxlength="3" property="pnDiasMaximo" size="3" onkeypress="return isCampoNumerico(event); "/>
					</td>
				</tr>
				<tr> 
                	<td>
                    ...
                    <td><strong> 
						<html:select property="psCodCategoria">
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:validaEnterComMensagem(event,'exibirGerarRelatorioRelAgAction.do?objetoConsulta=1','psCodLocalidade','Localidade'); return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td>
						<html:text maxlength="4" 
							...
							size="4"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioRelAgAction.do?objetoConsulta=8','psCodMunicipio','Município');"/> 
