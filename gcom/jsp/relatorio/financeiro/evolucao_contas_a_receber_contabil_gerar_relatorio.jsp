			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td align="left">
						...
						onkeypress="validaEnter(event, 'exibirGerarRelatorioEvolucaoContasAReceberContabilAction.do', 'codigoLocalidade');" />
				...
				<tr>
					...
					<td align="left"><strong> 
						...
						<c:if test="${empty requestScope.codigoLocalidade}" var="testeCor">
							<script>
								document.GerarRelatorioEvolucaoContasAReceberContabilActionForm.descricaoLocalidade.style.color = '#FF0000';
							</script>
						</c:if>
						
						<c:if test="${!testeCor}">
							<script>
								document.GerarRelatorioEvolucaoContasAReceberContabilActionForm.descricaoLocalidade.style.color = '#000000';
							</script>
						</c:if>
