...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="GerarRelatorioPosicaoContasAReceberContabilActionForm" />
<script>

	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {

	    var form = document.GerarRelatorioPosicaoContasAReceberContabilActionForm;
	...
	function validarForm(){
		...
		for(i=0; i < form.indicadorTipoCategoria.length; i++) {
			if (form.indicadorTipoCategoria[i].checked) {
				opcaoCategoria = form.indicadorTipoCategoria[i].value;
			}
		}

		if (opcaoCategoria == '') {

			alert('Preencha o tipo do relatório');
			return false;
		}
...
<html:form action="/gerarRelatorioPosicaoContasAReceberContabilAction.do"
	name="GerarRelatorioPosicaoContasAReceberContabilActionForm"
	type="gcom.gui.relatorio.financeiro.GerarRelatorioPosicaoContasAReceberContabilActionForm"
	method="post">
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Relatório Posição de Contas a Receber Contábil</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="3">Para gerar o relatório de posição de contas a receber contábil, informe os dados abaixo:</td>
				</tr>
				...
				<tr>
					...
					<td align="left">
						...
						onkeypress="validaEnter(event, 'exibirGerarRelatorioPosicaoContasAReceberContabilAction.do', 'codigoLocalidade');" />
				...
				<tr>
					...
					<td align="left"><strong> 
						...
						<c:if test="${empty requestScope.codigoLocalidade}" var="testeCor">
							<script>
								document.GerarRelatorioPosicaoContasAReceberContabilActionForm.descricaoLocalidade.style.color = '#FF0000';
							</script>
						</c:if>
						
						<c:if test="${!testeCor}">
							<script>
								document.GerarRelatorioPosicaoContasAReceberContabilActionForm.descricaoLocalidade.style.color = '#000000';
							</script>
						</c:if>
				...
				<tr>
					...
					<td>
						<html:radio property="indicadorTipoCategoria" value="5" tabindex="5">
							<strong> Geral </strong> 
						</html:radio>
						<html:radio property="indicadorTipoCategoria" value="6" tabindex="5">
							<strong> Particular </strong> 
						</html:radio>
						<html:radio property="indicadorTipoCategoria" value="4" tabindex="5">
	...
	<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioPosicaoContasAReceberContabilAction.do"/> 
