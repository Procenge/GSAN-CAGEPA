...
function validarForm(){
	...
	var form = document.GerarRelatorioResumoDevedoresDuvidososActionForm; 
	    ...
	    if (validateGerarRelatorioResumoDevedoresDuvidososActionForm(form) && validaMesAno(form)){
...
<html:form action="/gerarRelatorioResumoDevedoresDuvidososAction.do"
	...
	<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioResumoDevedoresDuvidososAction.do"/> 
