...
<html:javascript staticJavascript="false"  formName="GerarRelatorioRecebimentoContaPublicoArrecadacaoDynaForm"/>
...
<script language="JavaScript">
	...
	function validaCamposObrigatorios(){
		...
		if(document.forms[0].mesAnoRelatorio.value==""){
		...
		if(document.forms[0].mesAnoRelatorio.value!=""){
			...
			semErro=retorno=verificaAnoMes(document.forms[0].mesAnoRelatorio);
		}
...
<body leftmargin="5" topmargin="5" onload="javascript:setarFoco('${requestScope.mesAnoRelatorio}');" >

<html:form action="/gerarRelatorioRecebimentoContaPubArrecadacaoAction.do"
...
<input type="hidden" name="relatorio" value="<bean:write name="relatorio" />"/>
			...
			<table width="100%" border="0">
				...
				<tr> 
                	<td><strong>Mês/Ano:</strong><font color="#FF0000">*</font>
                		<strong>
                			<input type="text" name="mesAnoRelatorio" 
                				size="7" 
                  				maxlength="7" 
