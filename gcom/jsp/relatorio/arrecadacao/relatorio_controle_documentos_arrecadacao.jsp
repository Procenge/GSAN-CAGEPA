...
<html:javascript staticJavascript="false"  formName="AcompanharMovimentoArrecadadoresActionForm" dynamicJavascript="true" />
...
<!-- Begin
	...
	function validarForm(form){
		...
		if(verificaAnoMes(document.forms[0].mesAnoReferencia)
...
<html:form action="/gerarRelatorioControleDocumentosArrecadacaoAction"
	name="FiltrarRelatorioControleDocumentosArrecadacaoActionForm"
	type="gcom.gui.relatorio.arrecadacao.FiltrarRelatorioControleDocumentosArrecadacaoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar relatório Controle de documentos da Arrecadação</td>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3">
						<strong> <!--  
						<label> <html:radio value="sintetico" 
						property="indicadorTipo" /> Sintético </label> --> 
						<label> 
							<html:radio value="analitico" property="indicadorTipo" /> Analítico 
						</label> 
						</strong>
					</td>
				</tr>
				...
				<tr>
					<td><input name="Submit22"
						...
						onclick="window.location.href='/gsan/exibirGerarRelatorioControleDocumentosArrecadacaoAction.do?menu=sim';">
					<td colspan="2" align="right">
 					  <gcom:controleAcessoBotao name="Button" value="Gerar" onclick="javascript:validarForm(document.forms[0]);" url="gerarRelatorioControleDocumentosArrecadacaoAction.do" />
					</td>
				</tr>
			</table>
			</td>
...
<!-- relatorio_controle_documentos_arrecadacao.jsp -->
</html:html>
