...
<head>
 ...
 <html:javascript staticJavascript="false"  formName="SuprimirImovelEsgotoJudicialActionForm" />
 ...
 <script>
	...
	function validarForm(form) {
		if(confirm("Confirma Supressão Judicial do Imovel?")){
	  		if(validateSuprimirImovelEsgotoJudicialActionForm(form)) {
	...
	//Funcao que recupera os dados do popup
	 function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		form.action='exibirSuprimirImovelEsgotoJudicialAction.do?idImovel=' + codigoRegistro;
		submeterFormPadrao(form);
	 }
...
<div id="formDiv">
<html:form action="/efetuarSuprimirImovelEsgotoJudicialAction.do" name="SuprimirImovelEsgotoJudicialActionForm" type="gcom.gui.cadastro.imovel.SuprimirImovelEsgotoJudicialActionForm" enctype="multipart/form-data" method="post" focus="idImovel">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Suprimir Esgoto  Judicialmente</td>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">Para suprimir esgoto  judicialmente do im&oacute;vel, informe os dados abaixo:</td>
				</tr>
				<tr>
					...
					<td><html:text maxlength="9" property="idImovel" size="10" tabindex="1"
						onkeypress="validaEnterComMensagem(event, 'exibirSuprimirImovelEsgotoJudicialAction.do', 'idImovel', 'Matrícula do Imóvel');"
					...
					<logic:notPresent name="corInscricao">
						<logic:empty name="SuprimirImovelEsgotoJudicialActionForm" property="idImovel">
							<html:text property="inscricaoImovel" size="30" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
						<logic:notEmpty name="SuprimirImovelEsgotoJudicialActionForm" property="idImovel">
							<html:text property="inscricaoImovel" size="30" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:notEmpty>
					</logic:notPresent>
				...
				<tr>
					<td>
						<strong>
							<font color="#FF0000">
								<input name="btLimpar" class="bottonRightCol" value="Limpar" type="button" onclick="window.location.href='/gsan/exibirSuprimirImovelEsgotoJudicialAction.do?menu=sim';">
					...
					<td align="right">
						<gcom:controleAcessoBotao name="Button" value="Suprimir" tabindex="7" onclick="javascript:validarForm(document.forms[0]);" url="efetuarSuprimirImovelEsgotoJudicialAction.do" />
					</td>
				</tr>
			</table>
			<p>&nbsp;</p>
