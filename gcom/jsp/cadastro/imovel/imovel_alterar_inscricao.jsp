...
function checarValorCampo(valorCampo, tipo){
...
<html:form action="/exibirTotalizadoresAlterarImovelInscricaoAction" method="post">
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" >
        ...
        <tr>
            ...
            <td>
				<html:text maxlength="3" property="localidadeOrigemID" size="3" onkeypress="limpar(7);validaEnterComMensagem(event, 'exibirAlterarImovelInscricaoAction.do?objetoConsulta=1&inscricaoTipo=origem','localidadeOrigemID','Código da localidade de origem');" 
					onkeyup="replicaDados(document.forms[0].localidadeOrigemID, document.forms[0].localidadeDestinoID);checarValorCampo(document.forms[0].localidadeOrigemID.value,1);javascript:verificaNumeroInteiro(this);" tabindex="1" />
        ...
        <tr>
           ...
           <td>
			   ...
			   onkeyup="replicaDados(document.forms[0].setorComercialOrigemCD, document.forms[0].setorComercialDestinoCD);checarValorCampo(document.forms[0].setorComercialOrigemCD.value,2);javascript:verificaNumeroInteiro(this);" tabindex="2" />
			   <a	href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do?indicadorUsoTodos=1', 'setorComercialOrigem', 'idLocalidade', document.AlterarImovelInscricaoActionForm.localidadeOrigemID.value, 275, 480, 'Informe a Localidade da inscrição de origem');"><img
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0"
						width="23" height="21" title="Pesquisar"></a> 
        ...
        <tr>
            ...
            <td><html:text maxlength="22" property="quadraOrigemNM" size="4" tabindex="3" onkeypress="limpar(11);" onkeyup="replicaDados(document.forms[0].quadraOrigemNM, document.forms[0].quadraDestinoNM);checarValorCampo(document.forms[0].quadraOrigemNM.value,3);javascript:verificaNumeroInteiro(this);"/>
            <html:hidden property="quadraOrigemID"/></td>
        </tr>
        <tr>
           <td><strong>Lote:</strong></td>
           <td><html:text maxlength="4" property="loteOrigem" size="3" tabindex="4" onkeyup="replicaDados(document.forms[0].loteOrigem, document.forms[0].loteDestino);javascript:verificaNumeroInteiro(this);"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td>
				...
				<html:text maxlength="3" property="localidadeDestinoID" size="3" onkeypress="limpar(9);validaEnterComMensagem(event, 'exibirAlterarImovelInscricaoAction.do?objetoConsulta=1&inscricaoTipo=destino','localidadeDestinoID','Código da localidade de destino');" 
					onkeyup="checarValorCampo(document.forms[0].localidadeDestinoID.value,6);javascript:verificaNumeroInteiro(this);" tabindex="5"/>
        ...
        <tr>
            ...
            <td>
				...
				<html:text maxlength="3" property="setorComercialDestinoCD" size="3" onkeypress="limpar(10); validaEnterDependenciaComMensagem(event, 'exibirAlterarImovelInscricaoAction.do?objetoConsulta=2&inscricaoTipo=destino', document.forms[0].setorComercialDestinoCD, document.forms[0].localidadeDestinoID.value, 'localidade da inscrição de destino', 'Setor comercial de destino');" 
					onkeyup="checarValorCampo(document.forms[0].setorComercialDestinoCD.value,7);javascript:verificaNumeroInteiro(this);" tabindex="6"/>
				<a	href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do?indicadorUsoTodos=1', 'setorComercialDestino', 'idLocalidade', document.AlterarImovelInscricaoActionForm.localidadeDestinoID.value, 275, 480, 'Informe a Localidade da inscrição de destino');"><img
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0"
						width="23" height="21" title="Pesquisar"></a> 
        ...
        <tr>
            <td><strong>Quadra:</strong></td>
            <td><html:text maxlength="22" property="quadraDestinoNM" size="3" tabindex="7" onkeyup="checarValorCampo(document.forms[0].quadraDestinoNM.value,8);javascript:verificaNumeroInteiro(this);"/>
            <html:hidden property="quadraDestinoID"/></td>
        </tr>
        <tr>
            <td><strong>Lote:</strong></td>
            <td><html:text maxlength="4" property="loteDestino" size="3" tabindex="8" onkeyup="javascript:verificaNumeroInteiro(this);" /></td>
        </tr>
        <tr>
			<td></td>
        ...
        <tr>
			...
			<td align="right">
			<gcom:controleAcessoBotao name="Button" value="Alterar"
							  onclick="validarForm(document.AlterarImovelInscricaoActionForm);" url="exibirTotalizadoresAlterarImovelInscricaoAction.do"/>
			<!-- 
