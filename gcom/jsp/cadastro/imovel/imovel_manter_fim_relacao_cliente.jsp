...
<logic:present name="reloadPage">
 <body leftmargin="5" topmargin="5" onload="chamarSubmitComUrl('atualizarImovelWizardAction.do?action=exibirAtualizarImovelClienteAction'); window.close();">
</logic:present>

<logic:notPresent name="reloadPage">
 <body leftmargin="5" topmargin="5" onload="resizePageSemLink(640,300);">
</logic:notPresent>
