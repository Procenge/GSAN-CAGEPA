...
<link rel="stylesheet"
	...
	<html:javascript staticJavascript="false"  formName="InserirImovelPerfilActionForm"
...
<html:form action="/inserirImovelPerfilAction.do"
	...
	method="post"
	onsubmit="return InserirImovelPerfilActionForm(this);">
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Inserir Perfil do Imóvel</td>
		...
		<table width="100%" border="0">
			<tr>
				<td colspan="2">Para inserir o(s) perfil(s) do(s) imóvel(is), informe os dados abaixo:</td>
			</tr>
			<tr>
