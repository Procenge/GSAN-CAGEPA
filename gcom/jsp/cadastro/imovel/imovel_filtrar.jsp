    ...
    function validateFiltrarImovelActionForm(form) {
      ...
      return true;
       ...
       return testarCampoValorZero(document.FiltrarImovelActionForm.matriculaFiltro, 'Matrícula') &&
	      ...
	      testarCampoValorZero(document.FiltrarImovelActionForm.codigoHidrometroFiltro, 'Hidrômetro')&&
...
function pesquisaEnter(tecla) {
  ...
  if(form.idLocalidadeFiltro.value != '' || form.idLocalidadeFiltro.value != '' || form.codigoHidrometroFiltro
  ...
  function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
    ...
    if (tipoConsulta == 'hidrometro') {
      	form.codigoHidrometroFiltro.value = codigoRegistro;
      	form.hidrometroDescricaoFiltro.value = descricaoRegistro;
	    form.hidrometroDescricaoFiltro.style.color = '#000000';
	    form.codigoHidrometroFiltro.focus();
    }
...
function limparDescricaoSetorComercial(){
    ...
    verificarDigitosSetorComercial();
	 ...
	 function limparHidrometro() {
	    var form = document.forms[0];
	        form.codigoHidrometroFiltro.value = "";
	        form.hidrometroDescricaoFiltro.value = "";
    }
...
function setaMaiusculo(){
	var form = document.forms[0];
	form.codigoHidrometroFiltro.value = form.codigoHidrometroFiltro.value.toUpperCase();
}
</script>
</head>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2"><html:text maxlength="10"
						property="matriculaFiltro" size="10" tabindex="1" /></td>
				</tr>
				<tr>
					...
					<td colspan="2" width="81%" height="24"><html:text maxlength="3"
						...
						onkeypress="javascript:limparDescricaoLocalidade();limparPesquisaQuadra();limparPesquisaSetorComercial(); validaEnter(event, 'exibirFiltrarImovelAction.do', 'idLocalidadeFiltro');" />
					<a
				...
				<tr>
					...
					<td colspan="2" height="24"><html:text maxlength="3"
						...
						onkeypress="javascript:habilitaMunicipio();limparPesquisaBairro();limparPesquisaQuadra();return validaEnterDependencia(event, 'exibirFiltrarImovelAction.do', this, document.forms[0].idLocalidadeFiltro.value, 'Localidade');"
				...
				<tr>
					...
					<td colspan="2" height="24"><html:text maxlength="5"
						property="idQuadraFiltro" tabindex="3" size="4"
						onkeypress="javascript:limparDescricaoQuadra();return validaEnterDependencia(event, 'exibirFiltrarImovelAction.do', this, document.forms[0].idLocalidadeFiltro.value, 'Setor Comercial');" />
					      <a href="javascript:abrirPopupDependencia('exibirPesquisarQuadraAction.do?idSetorComercialFiltro='+document.forms[0].idSetorComercialFiltro.value+'&tipo=Quadra',document.forms[0].idSetorComercialFiltro.value,'Setor Comercial', 400, 800);">
					...
					<a href="javascript:limparPesquisaQuadra();document.forms[0].idQuadraFiltro.focus();"> <img
				...
				<tr>
					...
					<td>
						<html:text property="codigoHidrometroFiltro" size="10" maxlength="10" style="text-transform: none;" 		
						onkeypress="javascript:form.hidrometroDescricaoFiltro.value = '' ;return pesquisaEnter(event, 'exibirConsultarHistoricoInstalacaoHidrometroInformarAction.do','codigoHidrometroFiltro');" onkeyup= "javascript:setaMaiusculo();" onblur = "javascript:setaMaiusculo();" /> 
						...
						<logic:present name="idHidrometroNaoEncontrado">						
							<logic:equal name="idHidrometroNaoEncontrado" value="exception">
								...
								<html:text property="hidrometroDescricaoFiltro" size="50" maxlength="50" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />
														
							</logic:equal>							
							<logic:notEqual name="idHidrometroNaoEncontrado" value="exception">
								
								<html:text property="hidrometroDescricaoFiltro" size="50" maxlength="50" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
							
							</logic:notEqual>						
						</logic:present>	
						
						<logic:notPresent name="idHidrometroNaoEncontrado">						
							<logic:empty name="FiltrarImovelActionForm" property="codigoHidrometroFiltro">
							
								<html:text property="hidrometroDescricaoFiltro" value="" size="50"	maxlength="50" readonly="true"	style="background-color:#EFEFEF; border:0; color: #ff0000" />
							
							</logic:empty>							
							<logic:notEmpty name="FiltrarImovelActionForm" property="codigoHidrometroFiltro">
							
								<html:text property="hidrometroDescricaoFiltro" value="" size="50"	maxlength="50" readonly="true"	style="background-color:#EFEFEF; border:0; color: #000000" />
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="4" property="loteFiltro"
						size="4" tabindex="5" /></td>
				</tr>
				<tr>
					<td height="24"><strong>Sublote:</strong></td>
					<td colspan="2"><html:text maxlength="3" property="subLoteFiltro"
						size="4" tabindex="6" /></td>
				</tr>
				<tr>
					<td><strong>Cliente:</strong></td>
					<td colspan="2" height="24"><html:text maxlength="9"
						property="idClienteFiltro" tabindex="6" size="10"
						onkeypress="javascript:validaEnter(event, 'exibirFiltrarImovelAction.do', 'idClienteFiltro');" />
					<a
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="4" tabindex="7"
						...
						onkeypress="limparPesquisaBairro();limparPesquisaLogradouro();limparPesquisaCep();javascript:validaEnter(event, 'exibirFiltrarImovelAction.do', 'idMunicipioFiltro');" />
					<a
				...
				<tr>
					...
					<td height="24" colspan="2"><html:text maxlength="4"
						...
						onkeypress="javascript:limparPesquisaBairroDescricao();limparPesquisaLogradouro();limparPesquisaCep();return validaEnterDependencia(event, 'exibirFiltrarImovelAction.do', this, document.forms[0].idMunicipioFiltro.value, 'Município');" />
					<a
				...
				<tr>
					...
					<td colspan="2"><html:text property="idLogradouroFiltro" size="9"
						...
						onkeypress="javascript:limparPesquisaLogradouroDescricao();limparPesquisaCep();validaEnter(event, 'exibirFiltrarImovelAction.do', 'idLogradouroFiltro');" />
					<a
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="8" property="cepFiltro"
						size="8" tabindex="10"
						onkeypress="javascript:limparPesquisaCepDescricao();validaEnter(event, 'exibirFiltrarImovelAction.do', 'cepFiltro');" />
				...
				<tr>
					...
					<td colspan="2" height="24" align="right"><gcom:controleAcessoBotao
