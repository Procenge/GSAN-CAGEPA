...
function limparForm(){
	...
	form.action = 'exibirInserirImovelCheckListDocumentacaoAction.do?limparForm=OK';
	form.submit();
}
...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
  ...
  var form = document.ImovelCheckListDocumentacaoForm;
   ...
   if (tipoConsulta == 'imovel') {
    ...
    form.action = 'exibirInserirImovelCheckListDocumentacaoAction.do'
    submeterFormPadrao(form);
  }
...
<html:form action="/inserirImovelCheckListDocumentacaoAction.do" method="post"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Check List de Documentação do Imóvel</td>
		...
		<p>&nbsp;</p>
			<table width="100%" border="0">
				...
				<td colspan="4">
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
						<tr>
							<td align="center"><strong>Para inserir um check list, informe os dados abaixo:</strong></td>
						</tr>
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0">
								<tr>
									...
									<td width="75%" colspan="3"><html:text
										...
										'exibirInserirImovelCheckListDocumentacaoAction.do?indicadorNovo=OK',
			...
			<table width="100%" border="0">
					<td><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirImovelCheckListDocumentacaoAction.do?desfazer=S"/>'">
					<input name="Button" type="button" class="bottonRightCol"
						value="Cancelar" align="left"
						onclick="window.location.href='/gsan/telaPrincipal.do'"></td>
					<td align="right"><input name="Button" type="button"
						class="bottonRightCol" value="Inserir" onclick="javascript:validaForm();" align="right"></td>
				</tr>
			</table>
			<p>&nbsp;</p>
		</tr>
