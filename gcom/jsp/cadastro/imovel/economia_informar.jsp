...
function desfazer(){
	...
	if (form.matriculaImovel.value == '' || form.matriculaImovel.value == null){
		form.idImovel.value= '';
		window.location.href='/gsan/exibirInformarEconomiaAction.do?menu=sim';
		
		}else{
		 window.location.href='/gsan/exibirInformarEconomiaAction.do?tipoConsulta=1';
		 	}	
}
  </script>
</head>
							...
							<tr>
								...
								<table width="100%" bgcolor="#90c7fc">
									...
									<tr bgcolor="#FFFFFF">
										<td>
										<div align="center"><a
											href="javascript:abrirPopup('exibirInserirEconomiaPopupAction.do?codigoImovelSubCategoria=<bean:write name="imovelSubCategoria" property="comp_id.subcategoria.id"/>',710,440);">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							...
							<td align="right">
							<div align="right"><gcom:controleAcessoBotao name="Button"
								value="Concluir"
