			...
			<table border="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td width="11%">
							<html:text property="codigoImovel" size="8"
							maxlength="8"
							style="border: 0pt none ; background-color: rgb(239, 239, 239); color: rgb(0, 0, 0);"
							readonly="true" />
						</td>
						
						<td width="12%"><strong>Inscrição:</strong></td>
						<td width="45%"><html:text property="matriculaImovel"
							maxlength="25" size="25" readonly="true"
					...
					<tr>
						...
						<td colspan="3" align="right">
							<logic:present name="ativo" scope="request">
							  <div align="left">		
									<html:text property="idEscritorio" size="10" maxlength="10" tabindex="2"
										onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirImovelSituacaoCobrancaAction.do?objetoConsulta=1&idImovel='+form.codigoImovel.value, 'idEscritorio','Escritório de Advocacia');" />
									...
									<logic:present name="escritorioEncontrado">
										<logic:equal name="escritorioEncontrado" value="exception">
											<html:text property="nomeEscritorio" maxlength="40" size="35" readonly="true"
												style="background-color:#EFEFEF; border:0; color: #ff0000" />
										</logic:equal>
										<logic:notEqual name="escritorioEncontrado" value="exception">
											<html:text property="nomeEscritorio" maxlength="25" size="35" readonly="true"
								...
								<a href="javascript:limpaEscritorio()">  
									<img src="imagens/limparcampo.gif" border="0" height="21" width="23">
								</a>
							  </div>
							</logic:present>	
							...
							<logic:notPresent name="ativo" scope="request">
								<div align="left">
									<html:text property="idEscritorio" size="10" maxlength="10" disabled="true" /> 
										<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar" border="0" height="21" width="23"> 
									<html:text property="nomeEscritorio" maxlength="40" size="35" disabled="true"
										style="background-color:#EFEFEF; border:0; color: #000000" />
										<img src="imagens/limparcampo.gif" border="0" height="21" width="23">
								</div>
							</logic:notPresent>
					...
					<tr>
						...
						<td colspan="3" align="right">
							<logic:present name="ativo" scope="request">	
							  <div align="left">	
									<html:text property="idAdvogado" size="10" maxlength="10" tabindex="3"
										onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirImovelSituacaoCobrancaAction.do?objetoConsulta=1&idImovel='+form.codigoImovel.value, 'idAdvogado','Advogado');" />
									...
									<logic:present name="advogadoEncontrado">
										<logic:equal name="advogadoEncontrado" value="exception">
											<html:text property="nomeAdvogado" maxlength="40" size="35" readonly="true"
												style="background-color:#EFEFEF; border:0; color: #ff0000" />
										</logic:equal>
							...
							<logic:notPresent name="ativo" scope="request">
								<div align="left">
									<html:text property="idAdvogado" size="10" maxlength="10" disabled="true" /> 
										<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar" border="0" height="21" width="23">
									<html:text property="nomeAdvogado" maxlength="40" size="35" disabled="true"
										style="background-color:#EFEFEF; border:0; color: #000000"/>
										<img src="imagens/limparcampo.gif" border="0" height="21" width="23">
								</div>
							</logic:notPresent>
					...
					<tr>
						<td><strong>Data da Implantação:<font color="#ff0000">*</font> <font
					...
					<tr>
						...
						<td colspan="3" align="right">
						<div align="left">
							<html:text property="idClienteAlvo" size="10" maxlength="10"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirImovelSituacaoCobrancaAction.do?objetoConsulta=1&idImovel='+form.codigoImovel.value, 'idClienteAlvo','Cliente Alvo');" /> <a
							href="javascript:setCliente(3);javascript:abrirPopup('exibirPesquisarClienteAction.do');" >
							<img src="imagens/pesquisa.gif" title="Pesquisar Cliente" border="0" height="21" width="23"></a> 
							<html:text property="nomeClienteAlvo" maxlength="40" size="40"
							readonly="true" onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirImovelSituacaoCobrancaAction.do?objetoConsulta=1', 'idClienteAlvo','Cliente Alvo');"
							style="border: 0pt none ; background-color: rgb(239, 239, 239); color: rgb(0, 0, 0);" />
							<a href="javascript:limpaCliente();"><img src="imagens/limparcampo.gif" border="0" height="21" width="23"></a>
						</div>
						</td>
					</tr>
					<tr>
						<td colspan="4"><strong>Intervalo de Referência dos Débitos
						vinculados à Situação de Cobrança: </strong></td>
					</tr>
					<tr>
						<td><strong>Mês e Ano de Referência da Cobrança Inicial</strong><strong>:<font
							color="#ff0000">*</font></strong></td>
						<td colspan="3" align="right">
						<div align="left">
						<logic:present name="bloqueiaAnoMes" scope="request">
						<html:text property="anoMesReferenciaInicio" tabindex="4"
							size="7" maxlength="7" value="" disabled="true" onkeyup="mascaraAnoMes(this, event);" />
						</logic:present>
					...
					<tr>
						<td><strong>Mês e Ano de Referência da Cobrança Final</strong><strong>:<font
							color="#ff0000">*</font></strong></td>
						<td colspan="3" align="right">
						<div align="left">
						<logic:present name="bloqueiaAnoMes" scope="request">
						<html:text property="anoMesReferenciaFim" tabindex="5"
							size="7" maxlength="7" value="" disabled="true" onkeyup="mascaraAnoMes(this, event);"/>
						</logic:present>
						<logic:notPresent name="bloqueiaAnoMes" scope="request">
						<html:text property="anoMesReferenciaFim" tabindex="5"
					...
					<tr>
						<td><input name="Submit2" class="bottonRightCol" value="Voltar"
							type="button" onclick="javascript:history.back();"></td>
						<td colspan="3" align="right"><input name="Submit2"
							class="bottonRightCol" value="Concluir" type="button"
