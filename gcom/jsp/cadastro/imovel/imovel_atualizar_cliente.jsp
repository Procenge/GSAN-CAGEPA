			...
			<table width="100%" border="0">
					...
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td><html:text maxlength="9" property="idCliente" size="9"
								onkeypress="javascript:validaEnter(event, 'atualizarImovelWizardAction.do?action=exibirAtualizarImovelClienteAction', 'idCliente');" /></td>
							<td>
				...
				<tr>
					...
					<td><html:text property="dataInicioClienteImovelRelacao"
						...
						onkeypress="mascaraData(this, event); " /> <a
