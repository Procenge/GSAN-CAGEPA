...
function validarAreaConstruida(){
	...
	if(form.areaConstruidaInicial.value > form.areaConstruidaFinal.value){
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<div align="left"><strong><logic:present
						...
						<logic:equal name="parametroGerarRelatorio"
							...
							<html:text
								property="quantidadeEconomiasInicial" size="4" disabled="true"
					...
					<div align="left"><strong><logic:present
						...
						<logic:notEqual name="parametroGerarRelatorio"
							...
							<logic:notEqual name="parametroGerarRelatorio"
								...
								<logic:equal name="parametroGerarRelatorio"
									value="BoletimCadastro">
									<html:text property="numeroPontosInicial" size="4" disabled="true"
										onkeyup="javascript:carregaNumeroPontos();" maxlength="4" /> a <html:text
										property="numeroPontosFinal" size="4" maxlength="4" disabled="true"/>
								</logic:equal>
								<logic:notEqual name="parametroGerarRelatorio"
									value="BoletimCadastro">
								<html:text property="numeroPontosInicial" size="4"
					...
					<div align="left"><strong> <logic:present
						...
						<logic:notEqual name="parametroGerarRelatorio"
							...
							<logic:notEqual name="parametroGerarRelatorio"
								...
								<logic:equal name="parametroGerarRelatorio"
								value="BoletimCadastro">
									<html:text property="numeroMoradoresInicial" size="4" disabled="true"
										onkeyup="javascript:carregaNumeroMoradores()" maxlength="4" /> a <html:text
										property="numeroMoradoresFinal" size="4" maxlength="4" disabled="true"/>
								</logic:equal>
								<logic:notEqual name="parametroGerarRelatorio"
								value="BoletimCadastro">
								<html:text property="numeroMoradoresInicial" size="4"
				...
				<tr>
					...
					<div align="left"><strong> <logic:present
						...
						<html:text property="areaConstruidaFinal" maxlength="10" size="10"
								...
								disabled="true" />
							<html:select property="areaConstruidaFaixa" disabled="true" />
						</logic:equal>
						<logic:notEqual name="parametroGerarRelatorio"
							value="RelatorioCadastroConsumidoresInscricao">
							<logic:equal name="parametroGerarRelatorio"
						...
						<html:text property="areaConstruidaFinal" maxlength="10" size="10"
							...
							<logic:notEqual name="parametroGerarRelatorio"
								...
								<logic:equal name="parametroGerarRelatorio"
									value="BoletimCadastro">
								<html:text maxlength="10" size="10" style="text-align: right;"
											property="areaConstruidaInicial" disabled="true"
										...
										<html:select onchange="javascript:validarAreaConstruidaCombo();"
											property="areaConstruidaFaixa" disabled="true">
											<html:option value="-1">&nbsp;</html:option>
				...
				<tr>
					...
					<div align="left"><strong><logic:present
						...
						<logic:equal name="parametroGerarRelatorio"
							value="RelatorioCadastroConsumidoresInscricao">
							<html:select property="tipoPoco" disabled="true" />
						</logic:equal>
						<logic:notEqual name="parametroGerarRelatorio"
							value="RelatorioCadastroConsumidoresInscricao">
							<logic:equal name="parametroGerarRelatorio"
