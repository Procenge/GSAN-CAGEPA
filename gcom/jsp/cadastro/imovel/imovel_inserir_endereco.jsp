					...
					<logic:present name="colecaoEnderecos">
						...
						<logic:empty name="colecaoEnderecos">
							<input type="button" class="bottonRightCol" value="Adicionar"
								id="botaoEndereco"
								onclick="javascript:abrirPopup('exibirInserirEnderecoAction.do?tipoPesquisaEndereco=imovel&operacao=1', 570, 700);">
				...
				cor = "#FFFFFF";%>
										<tr bgcolor="#cbe5fe">
											...
											<td>
												...
												<a href="javascript:abrirPopup('exibirInserirEnderecoAction.do?exibirEndereco=OK&tipoPesquisaEndereco=imovel&operacao=1', 570, 700)"><bean:write name="endereco" property="enderecoFormatado"/></a>
