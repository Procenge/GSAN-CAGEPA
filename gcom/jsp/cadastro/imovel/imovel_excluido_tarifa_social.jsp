               ...
               <tr>
                 <td> <%--<div style="width: 100%; height: 100%; overflow: auto;">--%>
  	             ...
  	             <table width="100%">
					<tr>
                     <td>
                        <input name="button" type="button" class="bottonRightCol" value="Novo Filtro" onclick="window.location.href='<html:rewrite page="/exibirFiltrarImovelOutrosCriterios.do?gerarRelatorio=consultarTarifaExcluida&limpar=S"/>'" align="left" style="width: 80px;">
        	   		 </td>
		      	     <td align="right">
