			...
			<table width="100%" border="0">
					...
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0">
								...
								<tr>									
									<td height="10">								 
										<div class="style9"><strong>Foto do imóvel:</strong></div>									
									</td>									
									<td>										
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
						...
						<tr>
							<td align="center">
							<div class="style9"><strong>Opção de Envio de Conta </strong></div>
			...
			%>
						...
						<tr>
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								<tr bgcolor="#79bbfd">
									<td align="center"><span class="font-size:9px"> <a
										href="javascript:extendeTabela('DadosConsumoFaixaArea',true);" /><b>Consumo por Faixa de Área e Categoria do Imóvel</b></a></span></td>
								</tr>
							</table>
							</div>
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								<tr bgcolor="#79bbfd">
									<td align="center"><span class="font-size:9px"> <a
										href="javascript:extendeTabela('DadosConsumoFaixaArea',false);" /><b>Consumo por Faixa de Área e Categoria do Imóvel</b></a></span></td>
								</tr>
								<tr>
									<td>
						...
						<tr>
							...
							<div class="style9"><html:text
								...
								<td>
									<img width="25" height="25" border="0" onmouseover="this.T_BGCOLOR='whitesmoke';this.T_LEFT=true;return escape('Número de Adultos: <% if(request.getSession().getAttribute("numeroAdulto") != null){request.getSession().getAttribute("numeroAdulto");} %>	 <br>Número de Crianças: <% if(request.getSession().getAttribute("numeroCrianca") != null){request.getSession().getAttribute("numeroCrianca");}  %>	<br>Número de Morador Trabalhador: <% if(request.getSession().getAttribute("numeroMoradorTrabalhador")!= null){request.getSession().getAttribute("numeroMoradorTrabalhador");} %>	<br>')" src="/gsan/imagens/informacao.gif"/>
								</td>
						</tr>						
						...
						<tr>
							...
							<td align="left"><strong>Quadra do Imóvel:</strong></td>
							<td align="left"><html:text
