...
<html:form name="InserirContratoDemandaConsumoActionForm" type="gcom.gui.cadastro.imovel.InserirContratoDemandaConsumoActionForm" 
action="/inserirContratoDemandaConsumoAction.do" method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Contrato de Demanda de Consumo</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td>Para Inserir um Contrato de Demanda de Consumo, informe os dados abaixo:</td>
					<td align="right"></td>
				</tr>
			</table>
			...
			<table>
				<tr>
					...
					onkeyup="validaEnterImovel(event, 'exibirInserirContratoDemandaConsumoAction.do?consultarImovel=1', 'idImovel');" 
					...
					<a href="exibirInserirContratoDemandaConsumoAction.do?menu=sim"> 
				...
				<tr>
					<td>
						...
						<html:text name="InserirContratoDemandaConsumoActionForm" property="inscricaoImovel" readonly="true" style="background-color:#EFEFEF; border:0"></</html:text>
					</td>
				</tr>
				<tr>
					<td>
						...
						<html:text name="InserirContratoDemandaConsumoActionForm" property="ligacaoAguaSituacao" readonly="true" style="background-color:#EFEFEF; border:0"></</html:text>
					</td>
				</tr>
				<tr>
					<td>
						...
						<html:text name="InserirContratoDemandaConsumoActionForm" property="ligacaoEsgotoSituacao" readonly="true" style="background-color:#EFEFEF; border:0"></</html:text>
					</td>
				</tr>
				<tr>
					<td>
						...
						<html:text size="50" name="InserirContratoDemandaConsumoActionForm" property="enderecoImovel" readonly="true" style="background-color:#EFEFEF; border:0"></</html:text>
					</td>
				</tr>
				<tr>
					<td>
						<strong>Tarifa de Consumo Atual:</strong>
					
						<html:text name="InserirContratoDemandaConsumoActionForm" property="tarifaConsumoAtual" readonly="true" style="background-color:#EFEFEF; border:0"></</html:text>
					</td>
				</tr>
			</table>
			<table>
				<tr>
					...
					<td>
						<html:text name="InserirContratoDemandaConsumoActionForm" property="numeroContrato" maxlength="8" size="8" onkeypress="return isCampoNumerico(event);">
						</</html:text>
					</td>
				</tr>
				<tr>
					...
					<td>
						<html:text name="InserirContratoDemandaConsumoActionForm" property="mesAnoFaturamentoInicial" maxlength="7" size="7" 
				...
				<tr>
					...
					<td>
						<html:text name="InserirContratoDemandaConsumoActionForm" property="mesAnoFaturamentoFinal" maxlength="7" size="7" 
						onkeyup="mascaraAnoMes(this, event);" onblur="verificaAnoMesMensagemPersonalizada(this,'Referência inválida');">
						</</html:text>
					</td>
				</tr>
			...
			<td colspan="2">
				<input type="button" name="Button"
					...
					onClick="javascript:window.location.href='/gsan/exibirInserirContratoDemandaConsumoAction.do?menu=sim'"
					style="width: 80px" />&nbsp; 
				<input type="button" name="Button"
			...
			<td align="right">
				<gcom:controleAcessoBotao name="Button"
					...
					url="inserirContratoDemandaConsumoAction.do" />
			</td>
		</tr>
			</table>
			</td>
