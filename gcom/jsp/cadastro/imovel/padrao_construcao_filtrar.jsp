...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	...
	<html:javascript staticJavascript="false"  formName="FiltrarPadraoConstrucaoActionForm"/>
...
<script language="JavaScript">
	...
	function setaFocus(){
		var form = document.FiltrarPadraoConstrucaoActionForm;
		form.descricaoPadraoConstrucao.focus();
	}
	...
	function validarForm() {
      ...
      form.action = 'filtrarPadraoConstrucaoAction.do';
	  if(validateFiltrarPadraoConstrucaoActionForm(form)){	
...
<html:form action="/filtrarPadraoConstrucaoAction"
	name="FiltrarPadraoConstrucaoActionForm"
	type="gcom.gui.cadastro.imovel.FiltrarPadraoConstrucaoActionForm"
	method="post"
	onsubmit="return FiltrarPadraoConstrucaoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Padrão de Construção</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar o(s) padrão(ões) de construção, informe os dados abaixo:</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="descricaoPadraoConstrucao" size="20" maxlength="20"
						tabindex="1" /></td>
				</tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left"
						onclick="window.location.href='/gsan/exibirFiltrarPadraoConstrucaoAction.do?menu=sim'">
					</td>
