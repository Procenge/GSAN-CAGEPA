...
<%@ page import="gcom.cadastro.imovel.bean.ConsultarClienteRelacaoClienteImovelHelper" %>
			...
			<tr>
				...
				<table width="100%" bgcolor="#90c7fc" class="fontePequena">
					...
					<bean:define id="coll" 
                     ...
                     <bean:define id="colecaoClienteEnderecos" 
                     name="colecaoClienteEnderecos" 
                     type="Collection"/>
                     
                     <bean:define id="colecaoImovel" 
                     name="colecaoImovel" 
                     type="Collection"/>
						...
						<logic:iterate name="collClienteImovel" id="consultarClienteRelacaoClienteImovelHelper" type="ConsultarClienteRelacaoClienteImovelHelper">
							<%if (cor.equalsIgnoreCase("#cbe5fe")) {
								...
								<td>
								<logic:notEmpty name="consultarClienteRelacaoClienteImovelHelper"
									property="clienteImovel.indicadorNomeConta">

									<logic:equal name="consultarClienteRelacaoClienteImovelHelper"
										property="clienteImovel.indicadorNomeConta" value="<%="" + ConstantesSistema.SIM%>">
										<div align="center"><input type="checkbox" title="Indicador de Nome na Conta" 
											checked="checked" disabled="disabled"></div>
									</logic:equal>

									<logic:equal name="consultarClienteRelacaoClienteImovelHelper"
										property="clienteImovel.indicadorNomeConta" value="<%="" + ConstantesSistema.NAO%>">
										<div align="center"><input type="checkbox" title="Indicador de Nome na Conta"
								...
								<td>
								<logic:notEmpty name="consultarClienteRelacaoClienteImovelHelper" property="clienteImovel.imovel">

									<logic:notEmpty name="consultarClienteRelacaoClienteImovelHelper"
										property="clienteImovel.imovel.indicadorEmissaoExtratoFaturamento">
							...
							<td colspan="2">
							  <bean:write name="consultarClienteRelacaoClienteImovelHelper" property="nomeClienteUsuario" />
							</td>
							<td colspan="7">
						...
						<tr>
			                 <td colspan="6"><strong>Quantidade de imóveis:&nbsp;<%=colecaoImovel.size()%></strong>
			                 </td>
			            </tr>
					</logic:present>
				</table>
