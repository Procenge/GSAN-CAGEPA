...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	...
	<html:javascript staticJavascript="false"  formName="FiltrarImovelPerfilActionForm"/>
...
<script language="JavaScript">
	...
	function setaFocus(){
		var form = document.FiltrarImovelPerfilActionForm;
		form.descricaoImovelPerfil.focus();
	}
	...
	function validarForm() {
      ...
      form.action = 'filtrarImovelPerfilAction.do';
...
<html:form action="/filtrarImovelPerfilAction"
	...
	method="post"
	onsubmit="return FiltrarImovelPerfilActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Perfil do Imóvel</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar o(s) perfil(s) do(s) Imóvel(is), informe os dados abaixo:</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="descricaoImovelPerfil" size="20" maxlength="20"
						tabindex="1" /></td>
				</tr>
