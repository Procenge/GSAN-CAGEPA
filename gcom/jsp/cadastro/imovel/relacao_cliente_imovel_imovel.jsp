...
<table width="770" border="0" cellspacing="4" cellpadding="0">
	<tr>
			...
			<tr>
				...
				<table width="100%" bgcolor="#90c7fc" class="fontePequena">
					...
					<tr>
						...
						<div align="center"><strong>Indicadores</strong></div>
						</td>
						<td rowspan="2" bgcolor="#90c7fc" width="9%">
						...
						<td rowspan="2" bgcolor="#90c7fc" width="20%">
						<div align="center"><strong>Motivo do Término da Relação</strong></div>
						</td>
					</tr>

					<tr bordercolor="#FFFFFF" bgcolor="#90c7fc">
						<td bordercolor="#000000" bgcolor="#cbe5fe" width="5%">
						<div align="center"><strong>Nome</strong></div>
						</td>
						<td bordercolor="#000000" bgcolor="#cbe5fe" width="5%">
						<div align="center"><strong>Extrato</strong></div>
						</td>
						<td bordercolor="#000000" bgcolor="#cbe5fe" width="9%">
					...
					<logic:present name="collClienteImovel">
						<logic:iterate name="collClienteImovel" id="clienteImovel" type="ClienteImovel">
							...
							<tr align="left" bgcolor="#cbe5fe" height="18">
								...
								<td>
								<logic:notEmpty name="clienteImovel" property="indicadorNomeConta">
									<logic:equal name="clienteImovel" property="indicadorNomeConta" value="<%="" + ConstantesSistema.SIM%>">
										<div align="center"><input type="checkbox" title="Indicador de Nome na Conta" 
											checked="checked" disabled="disabled"></div>
									</logic:equal>

									<logic:equal name="clienteImovel" property="indicadorNomeConta" value="<%="" + ConstantesSistema.NAO%>">
										<div align="center"><input type="checkbox" title="Indicador de Nome na Conta"
								...
								<td>
								<logic:notEmpty name="clienteImovel" property="imovel">
									<logic:notEmpty name="clienteImovel" property="imovel.indicadorEmissaoExtratoFaturamento">
										<logic:equal name="clienteImovel" property="imovel.indicadorEmissaoExtratoFaturamento" value="<%="" + ConstantesSistema.SIM%>">
											<div align="center"><input type="checkbox" title="Indicador de Extrato para Responsável" 
												checked="checked" disabled="disabled"></div>
										</logic:equal>

										<logic:equal name="clienteImovel" property="imovel.indicadorEmissaoExtratoFaturamento" value="<%="" + ConstantesSistema.NAO%>">
											<div align="center"><input type="checkbox" title="Indicador de Extrato para Responsável"
												disabled="disabled"></div>
										</logic:equal>
									</logic:notEmpty>
			...
			<tr>
				...
				<table width="100%" bgcolor="#90c7fc" class="fontePequena">
					...
					<tr>
						...
						<div align="center"><strong>Dados Grupo de Usuários por Categoria</strong></div>
						</td>
					</tr>
					<tr>
						<td rowspan="2" bgcolor="#90c7fc" width="15%">
						...
						<div align="center"><strong>Comprimento</strong></div>
						</td>
						<td rowspan="2" bgcolor="#90c7fc" width="12%">
						<div align="center"><strong>Número de Andares</strong></div>
						</td>
						<td rowspan="2" bgcolor="#90c7fc" width="12%">
						<div align="center"><strong>Comprimento do Andar</strong></div>
						</td>
						<td rowspan="2" bgcolor="#90c7fc" width="12%">
						<div align="center"><strong>Área Construida</strong></div>
						</td>
					</tr>
					<tr bordercolor="#FFFFFF" bgcolor="#90c7fc">
						<td bordercolor="#000000" bgcolor="#cbe5fe" width="11%">
						<div align="center"><strong>Frente</strong></div>
						</td>
						<td bordercolor="#000000" bgcolor="#cbe5fe" width="10%">
						<div align="center"><strong>Lado</strong></div>
						</td>
						<td bordercolor="#000000" bgcolor="#cbe5fe" width="10%">
						<div align="center"><strong>Testada</strong></div>
						</td>
					</tr>
					<%cor = "#cbe5fe";%>
					<logic:present name="collImovelConsumoFaixaAreaCategoria">
						<logic:iterate name="collImovelConsumoFaixaAreaCategoria" id="imovelConsumoFaixaAreaCategoria">
							<%if (cor.equalsIgnoreCase("#cbe5fe")) {
							cor = "#FFFFFF";%>
							<tr align="left" bgcolor="#FFFFFF" height="18">
							<%} else {
							...
							<%}%>
								<td>
								<div align="center"><bean:write name="imovelConsumoFaixaAreaCategoria"
									property="categoria.descricao" /></div>
								</td>
								<td>
								<div align="center"><bean:write name="imovelConsumoFaixaAreaCategoria"
									property="comp_id.consumoFaixaAreaCategoria.id" /></div>
								</td>
								<td>
								<div align="center"><bean:write name="imovelConsumoFaixaAreaCategoria"
									property="comprimentoFrente" /></div>
								</td>
								<td>
								<div align="center"><bean:write name="imovelConsumoFaixaAreaCategoria"
									property="comprimentoLado" /></div>
								</td>
								<td>
								<div align="center">
									<logic:notEmpty name="imovelConsumoFaixaAreaCategoria" property="comprimentoTestada">
								...
								<td>
								<div align="center">
									<logic:notEmpty name="imovelConsumoFaixaAreaCategoria" property="numeroAndares">
								...
								<td>
								<div align="center">
									<logic:notEmpty name="imovelConsumoFaixaAreaCategoria" property="comprimentoAndar">
		...
		<table>
			<tr>
				<td><input name="adicionar" class="bottonRightCol"
