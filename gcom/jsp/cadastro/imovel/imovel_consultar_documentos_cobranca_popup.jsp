...
<script language="JavaScript">
	function email(){
		this.aa = new Array("emailNegociacao", "E-mail inválido.", new Function ("varName", " return this[varName];"));
	}

	function required(){
		this.aa = new Array("emailNegociacao", "É necessário informar o e-mail para o re-envio do documento da negociação.", new Function ("varName", " return this[varName];"));
	}
...
<!-- ============================================================================================================================== -->
      ...
      <tr>
      	<td colspan="4" height="10">
      		<table width="100%" align="center" bgcolor="#99CCFF" border="0">
				<tr>
					<td><strong>Empresa Responsável:</strong></td>
				</tr>
				<tr bgcolor="#cbe5fe">
      ...
      <tr>
      	<td colspan="5">
			...
			<tr> 
				<td height="10" width="155"><strong>Parecer da Entrega/Devolução:</strong></td>
		        <td>
			...
			<tr> 
				<td height="10" width="155"><strong>Situação do Documento:</strong></td>
		        <td>
      ...
      <logic:notEmpty name="DocumentoCobrancaItemActionForm" property="tipoDocumentoNegociacao">
	      <tr>
	          <td colspan="3">
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
					<tr>
						<td><strong>Negociação de Débito:</strong></td>
					</tr>
					<tr bgcolor="#cbe5fe">
						<td width="100%" align="center">
							<table width="100%" border="0">
