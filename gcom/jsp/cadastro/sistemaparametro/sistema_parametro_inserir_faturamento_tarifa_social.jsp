...
function IntegerValidations () {
	...
	this.aj = new Array("numeroMaximoTiposDebitoEmissaoDocumento", "Nr. Máximo de Tipos de Débito por Documento.", new Function ("varName", " return this[varName];"));	
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text maxlength="40" property="tituloPagina" size="40" /></td>
				</tr>
				<tr>
					<td width="40%" align="left"><strong>Máximo de Tipos de Débito por Documento:</strong></td>
					<td><html:text maxlength="2" property="numeroMaximoTiposDebitoEmissaoDocumento" size="4" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
