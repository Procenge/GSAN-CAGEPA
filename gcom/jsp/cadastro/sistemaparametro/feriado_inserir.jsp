...
<script language="JavaScript">
	 ...
	 function bloquearMunicipio(){
		...
		if(form.indicadorTipoFeriado[0].checked ||form.indicadorTipoFeriado[1].checked){
...
<body leftmargin="5" topmargin="5" onload="javascript:setarFoco('${requestScope.nomeCampo}');bloquearMunicipio();">
			...
			<tr>
				...
				<tr>
					...
					<td width="70%" colspan="2" >  
						...
						<html:radio onkeyup="javascript:bloquearMunicipio();" onclick="javascript:bloquearMunicipio();" property="indicadorTipoFeriado" value="3" tabindex="3" />Estadual
