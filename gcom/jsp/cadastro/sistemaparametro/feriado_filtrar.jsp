...
<body leftmargin="5" topmargin="5" onload="verificarChecado('${indicadorAtualizar}');setaFocus();bloquearMunicipio();">
			...
			<table width="100%" border="0">
				<tr>
					...
					<td width="70%" colspan="2" >  
						...
						<html:radio  property="indicadorTipoFeriado" onkeyup="javascript:bloquearMunicipio();" 
									onclick="javascript:bloquearMunicipio();"value="4" tabindex="4" />Estadual
						<html:radio  property="indicadorTipoFeriado" onkeyup="javascript:bloquearMunicipio();" 
