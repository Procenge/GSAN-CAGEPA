...
<table width="770" border="0" cellspacing="4" cellpadding="0">
									...
									<pg:item>
										...
										<%}%>
											...
											<td width="17%" align="center">
											  ...
											  <logic:equal name="feriado" property="tipoFeriado" value ="3">
											    <a href="/gsan/exibirAtualizarFeriadoAction.do?tipoFeriado=1&idFeriado=<bean:write name="feriado" property="id"/>">Estadual</a>
											  </logic:equal>
											</td>
	...
	<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioFeriadoManterAction.do" />
