		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					FEBRABAN:</strong></td>
					<td><html:text maxlength="4" property="codigoEmpresaFebraban"
				...
				<tr>
					...
					<td width="87%"><html:text property="percentualEntradaMinima"
						size="5" maxlength="6"
						onkeyup="javascript:formataValorMonetario(this, 6);" /> <font
						size="1"> &nbsp; </font></td>
				</tr>
				<tr>
					<td width="40%" align="left"><strong>Máximo de Parcelas para um
					Financiamento:</strong></td>
					<td><html:text maxlength="5" property="maximoParcelas" size="5"
						onkeyup="javascript:verificaNumeroInteiro(this);" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					para Financiamento:</strong></td>
					<td><html:text maxlength="6" property="percentualTaxaFinanciamento"
						size="5" onkeyup="javascript:formataValorMonetario(this, 5);" /></td>
				</tr>
				<tr>
					<td width="40%" align="left"><strong>Número Máximo para Parcela de
					Crédito:</strong></td>
					<td><html:text maxlength="3" property="numeroMaximoParcelaCredito"
				...
				<tr>
					...
					<td><html:text maxlength="5" property="percentualCalculoIndice"
						size="5" onkeyup="javascript:formataValorMonetario(this, 5);" /></td>
				</tr>
				<tr>
					<td><strong></strong></td>
