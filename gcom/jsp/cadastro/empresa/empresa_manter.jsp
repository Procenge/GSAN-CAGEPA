										...
										<pg:item>
											...
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="empresa" property="id"/>"></div>
												</td>
												<td width="18%">
												<div align="center"><bean:write name="empresa"
													property="id" /></div>
												</td>
												
												<td width="45%"
												 align="center"><html:link
													href="/gsan/exibirAtualizarEmpresaAction.do?manter=sim"
													paramId="codigoEmpresa" paramProperty="id"
													paramName="empresa"
													title="<%="" + empresa.getDescricao()%>">
													<bean:write name="empresa" property="descricao" />
												</html:link></td>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit
										...
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarEmpresaAction.do?limpar=S"/>'"
