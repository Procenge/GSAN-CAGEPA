...
<html:javascript staticJavascript="false"  formName="FiltrarEmpresaActionForm" />
...
function validarForm(form){
	...
	if (validateFiltrarEmpresaActionForm(form)) {
...
<html:form action="/filtrarEmpresaAction"   
	name="FiltrarEmpresaActionForm"
  	type="gcom.gui.cadastro.empresa.FiltrarEmpresaActionForm"
  	method="post"
  	focus="codigoEmpresa">
		...
		<td width="655" valign="top" class="centercoltext">
            ...
            <table width="100%" border="0">
              <tr>
	           <td width="100%" colspan=2>
		          <table width="100%">
		          	<tr>
		          		<td>Para Filtrar a(s) empresa(s), informe os dados abaixo: </td>
              ...
              <tr>
                ...
                <td><strong>
                  	<html:text property="codigoEmpresa" maxlength="4" size="9" />
                </strong></td>
              </tr>

			  <tr>
				<td width="20%"><strong>Nome:</strong></td>
				<td width="80%"><html:text maxlength="40" property="nomeEmpresa" size="40" tabindex="6" /></td>
			  </tr>
			  <tr>
				<td>&nbsp;</td>
				<td valign="top">
			...
			<tr>
				<td>
					...
					onclick="window.location.href='<html:rewrite page="/exibirFiltrarEmpresaAction.do?desfazer=S"/>'">
				</td>
				<td align="right"></td>
				<td align="right">
					<gcom:controleAcessoBotao name="Button" value="Filtrar"
											  onclick="javascript:validarForm(document.forms[0]);" 
											  url="filtrarEmpresaAction.do" />
				</td>
			</tr>
