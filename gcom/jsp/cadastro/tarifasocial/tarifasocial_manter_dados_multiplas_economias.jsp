...
function verificarExclusao(idTarifaSocial, count) {
	...
	if (form.idRegistrosRemocao.checked) {
		...
		form.idRegistrosRemocao.checked = true;
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				...
				<tr>
					<td height="200">
					<div style="width: 100%; height: 100%; overflow: auto;"><logic:present
						name="colecaoTarifaSocialHelper">
						<% int count = 0; %>
							...
							<table width="100%">
									...
									<table width="100%" bgcolor="#99CCFF">
										...
										<tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
											...
											<div align="left"><logic:present name="tarifaSocialHelper"
												property="tarifaSocialDadoEconomia.tarifaSocialExclusaoMotivo">${tarifaSocialHelper.clienteImovelEconomia.cliente.nome}</logic:present><logic:notPresent
												...
												<logic:present name="pesquisaImovel" scope="session"><a
														href="javascript:abrirPopup('exibirMotivoRevisaoTarifaSocialAction.do?idTarifaSocial=${tarifaSocialHelper.tarifaSocialDadoEconomia.id}', 190, 440);">${tarifaSocialHelper.clienteImovelEconomia.cliente.nome}</a></logic:present>
												<logic:notPresent name="pesquisaImovel" scope="session">
												<a
													href="javascript:abrirPopup('exibirAtualizarDadosTarifaSocialAction.do?idTarifaSocial=${tarifaSocialHelper.tarifaSocialDadoEconomia.id}' , 700, 600);">${tarifaSocialHelper.clienteImovelEconomia.cliente.nome}</a>
											</logic:notPresent></logic:notPresent></div>
											</td>
								...
								&nbsp;
									...
									&nbsp;
										...
										<tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
											<td align="right"><logic:present name="tarifaSocialHelper"
												property="clienteImovelEconomia.cliente.rg">
												<bean:write name="tarifaSocialHelper"
													property="clienteImovelEconomia.cliente.rg" />
											</logic:present> <logic:present name="tarifaSocialHelper"
												property="clienteImovelEconomia.cliente.rg">
										&nbsp;
									</logic:present></td>
											<td align="left"><logic:present name="tarifaSocialHelper"
										...
										&nbsp;
											...
											<td>
											<div align="right"><logic:present name="tarifaSocialHelper"
