	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				...
				<tr>
					<td width="80"><strong>RA - Registro de Atendimento:</strong></td>
