...
<!--
    ...
    function caracteresespeciais () {
     this.aa = new Array("registroAtendimento", " RA - Registro de Atendimento deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    }

    function required () {
     this.ab = new Array("registroAtendimento", "Informe RA - Registro de Atendimento.", new Function ("varName", " return this[varName];"));
	 this.ac = new Array("nomeRegistroAtendimento", "Pesquise RA - Registro de Atendimento.", new Function ("varName", " return this[varName];"));     
    }
...
<html:form action="/inserirTarifaSocialWizardAction" method="post"
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">				
				<tr>
					<td width="80"><strong>RA - Registro de Atendimento:<font color="#FF0000">*</font><font
