		   ...
		   <td width="19%"><strong>Localidade:</strong></td>
			...
			<a href="javascript:limparPesquisaSetorComercial();limparPesquisaQuadra();"> <img src="<bean:message key="caminho.imagens"/>limparcampo.gif" border="0" title="Apagar"/></a>
                 ...
                 <tr>
                   ...
                   <td height="24"><html:text maxlength="5" property="idQuadra" size="5" onkeypress="javascript:return validaEnterDependencia(event, 'exibirFiltrarImovelAction.do', this, document.forms[0].idSetorComercial.value, 'Setor Comercial');"/>
