  ...
  <tr>
   ...
   <tr>
     ...
     <tr>
	  ...
	  <td>
			<html:radio property="indicadorRedeAguaAux" value="1" tabindex="5" onclick="verificarMarcacao(1, 'Agua');habilitacaoSistemaAbastecimento(document.forms[0].indicadorRedeAguaAux);"/><strong>Sem Rede de Água
   ...
   <tr>
	...
	<tr>
        ...
        <td>
			...
			onkeyup="limpar(11);"onkeypress="validaEnterComMensagem(event, 'exibirAtualizarQuadraAction.do?objetoConsulta=6', 'setorCensitarioID','Setor Censitário');"/>
