		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2"><html:text property="nomeAbreviado" size="6" maxlength="6"
						tabindex="2" /></td>
				</tr>
					...
					<td>
						<logic:present name="voltar">
							<logic:equal name="voltar" value="filtrar">
								...
								value="Voltar" align="left" tabindex="14"
						...
						<input name="Button" type="button" class="bottonRightCol" value="Desfazer" align="left" tabindex="15"
						onclick="window.location.href='<html:rewrite page="/exibirAtualizarGerenciaRegionalAction.do?desfazer=S"/>'">
						<input name="Button" type="button" class="bottonRightCol" value="Cancelar" align="left" tabindex="16"
