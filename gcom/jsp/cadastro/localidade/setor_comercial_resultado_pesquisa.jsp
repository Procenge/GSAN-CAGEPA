  ...
  <tr>
    <td width="630" valign="top" class="centercoltext"> <table height="100%">
      ...
      <table width="100%" border="0" bgcolor="#90c7fc">
        <tr align="left" >
          ...
          <td width="34%" align="center"><strong>Descrição</strong></td>
	...
	<%--Esquema de paginação--%>
        ...
        <td align="center">
		   <logic:equal name="tipoPesquisa" value="setorComercialOrigem">
				...
				<logic:notEqual name="setorComercial" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
					...
					<logic:notEmpty name="caminhoRetornoTelaPesquisaSetorComercial">
						<div align="center">
					...
					<logic:empty name="caminhoRetornoTelaPesquisaSetorComercial">
	            ...
	            <logic:equal name="setorComercial" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
					...
					<logic:notEmpty name="caminhoRetornoTelaPesquisaSetorComercial">
						<div align="center">
							<a href="javascript:enviarDadosParametros('<bean:write name="caminhoRetornoTelaPesquisaSetorComercial"/>','<bean:write name="setorComercial" property="codigo"/>', '<bean:write name="setorComercial" property="descricao"/>', 'setorComercialOrigem');">
								<bean:write name="setorComercial" property="codigo"/> 
							</a>
						</div>
					</logic:notEmpty>
           ...
           <logic:equal name="tipoPesquisa" value="setorComercialDestino">
	            ...
	            <logic:equal name="setorComercial" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
					...
					<logic:notEmpty name="caminhoRetornoTelaPesquisaSetorComercial">
						<div align="center">
							<a href="javascript:enviarDadosParametros('<bean:write name="caminhoRetornoTelaPesquisaSetorComercial"/>','<bean:write name="setorComercial" property="codigo"/>', '<bean:write name="setorComercial" property="descricao"/>', 'setorComercialDestino');">
								<bean:write name="setorComercial" property="codigo"/>
							</a>
						</div>
					</logic:notEmpty>
           ...
           <logic:notEqual name="tipoPesquisa" value="setorComercialOrigem">
             ...
             <logic:notEqual name="tipoPesquisa" value="setorComercialDestino">
				...
				<logic:notEqual name="tipoPesquisa" value="selecionarRotas">
					...
					<logic:notEmpty name="caminhoRetornoTelaPesquisaSetorComercial">
					<!-- Inicio popup pesquisar Rota -->
					<logic:equal name="caminhoRetornoTelaPesquisaSetorComercial" value="exibirPesquisarRotaAction">
					...
					<logic:notEqual name="setorComercial" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
						...
						<logic:notPresent name="consulta">
							<a href="javascript:enviarDadosParametros('exibirPesquisarRotaAction', '<bean:write name="setorComercial" property="codigo"/>', '<bean:write name="setorComercial" property="descricao"/>', 'setorComercial');">
								<bean:write name="setorComercial" property="codigo"/>
							</a>
						</logic:notPresent>
		            </logic:notEqual>
		...
		<!-- Fim popup pesquisar Rota -->
						...
						<logic:equal name="caminhoRetornoTelaPesquisaSetorComercial" value="exibirPesquisarImovelAction">
							<logic:notEqual name="setorComercial" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
								<logic:present name="consulta">
									<a href="javascript:enviarIdParaInserir(${setorComercial.id})"> 
										<bean:write name="setorComercial" property="codigo" /> 
						...
						<logic:equal name="caminhoRetornoTelaPesquisaSetorComercial" value="exibirPesquisarServicoTipoTramiteAction">
							<logic:notEqual name="setorComercial" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
								<logic:present name="consulta">
									<a href="javascript:enviarIdParaInserir(${setorComercial.id})"> 
										<bean:write name="setorComercial" property="codigo" /> 
								...
								<logic:notPresent name="consulta">
									<a href="javascript:enviarDadosParametros('exibirPesquisarServicoTipoTramiteAction', '<bean:write name="setorComercial" property="codigo"/>', '<bean:write name="setorComercial" property="descricao"/>', 'setorComercial');">
										<bean:write name="setorComercial" property="codigo"/>
									</a>
								</logic:notPresent>
				            </logic:notEqual>
