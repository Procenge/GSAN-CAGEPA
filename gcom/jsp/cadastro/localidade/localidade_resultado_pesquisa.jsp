			...
			<logic:notEqual name="tipoPesquisa" value="destino">
				...
				<logic:notEqual name="tipoPesquisa" value="selecionarRotas">
					...
					<logic:notEmpty name="caminhoRetornoTelaPesquisaLocalidade">
						...
						<logic:equal name="caminhoRetornoTelaPesquisaLocalidade" value="exibirPesquisarServicoTipoTramiteAction">
							<logic:notEqual name="localidade" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
					           	  <logic:present name="consulta">
										<a href="javascript:enviarIdParaInserir(${localidade.id})"> <bean:write
											name="localidade" property="descricao" /> 
								  ...
								  <logic:notPresent name="consulta">
							           <a href="javascript:enviarDadosParametros('exibirPesquisarServicoTipoTramiteAction', '<bean:write name="localidade" property="id"/>', '<bean:write name="localidade" property="descricao"/>', 'localidade');">
									      <bean:write name="localidade" property="descricao"/>
									   </a>
								  </logic:notPresent>
				            </logic:notEqual>
...
<!-- alteração para o popup de pesquisar rota  -->
					<logic:equal name="caminhoRetornoTelaPesquisaLocalidade" value="exibirPesquisarRotaAction">
							<logic:notEqual name="localidade" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
					           	  <logic:present name="consulta">
										<a href="javascript:enviarIdParaInserir(${localidade.id})"> <bean:write
											name="localidade" property="descricao" /> 
								  ...
								  <logic:notPresent name="consulta">
							           <a href="javascript:enviarDadosParametros('exibirPesquisarRotaAction', '<bean:write name="localidade" property="id"/>', '<bean:write name="localidade" property="descricao"/>', 'localidade');">
									      <bean:write name="localidade" property="descricao"/>
									   </a>
								  </logic:notPresent>	
				            </logic:notEqual>
...
<!-- FIM: alteração para o popup de pesquisar rota  -->

					<logic:equal name="caminhoRetornoTelaPesquisaLocalidade" value="exibirPesquisarUnidadeNegocioAction">
							<logic:notEqual name="localidade" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">            
					           	  <logic:present name="consulta">
										<a href="javascript:enviarIdParaInserir(${localidade.id})"> <bean:write
											name="localidade" property="descricao" /> 
								  ...
								  <logic:notPresent name="consulta">
							           <a href="javascript:enviarDadosParametros('exibirPesquisarUnidadeNegocioAction', '<bean:write name="localidade" property="id"/>', '<bean:write name="localidade" property="descricao"/>', 'localidade');">
									      <bean:write name="localidade" property="descricao"/>
									   </a>
								  </logic:notPresent>	
				            </logic:notEqual>
                    ...
                    <logic:equal name="caminhoRetornoTelaPesquisaLocalidade" value="exibirSituacaoEspecialFaturamentoInformarAction">
                       <logic:equal name="tipoPesquisa" value="origemPopup" >
                          <logic:notEqual name="localidade" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">  
                             <a href="javascript:enviarDadosParametros('exibirSituacaoEspecialFaturamentoInformarAction', '<bean:write name="localidade" property="id"/>', '<bean:write name="localidade" property="descricao"/>', 'localidadeOrigem');">
                                <bean:write name="localidade" property="descricao"/>
                             </a>
                          </logic:notEqual>
                       ...
                       <logic:equal name="tipoPesquisa" value="destinoPopup" >
                          <logic:notEqual name="localidade" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">  
                             <a href="javascript:enviarDadosParametros('exibirSituacaoEspecialFaturamentoInformarAction', '<bean:write name="localidade" property="id"/>', '<bean:write name="localidade" property="descricao"/>', 'localidadeDestino');">
                                <bean:write name="localidade" property="descricao"/>
                             </a>
                          </logic:notEqual>
