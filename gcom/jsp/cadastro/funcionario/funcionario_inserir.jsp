...
<html:javascript staticJavascript="false"
	formName="InserirFuncionarioActionForm" />
<script language="JavaScript"
...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		testarCampoValorZero(document.InserirFuncionarioActionForm.descricaoCargo, 'Descrição Cargo') && 
...
<html:form action="/inserirFuncionarioAction.do" method="post"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Funcionario</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para inserir um funcionario, informe os dados
					abaixo:</td>
				</tr>
				<tr>
					<td width="162"><strong>Matrícula:<font color="#FF0000">*</font></strong></td>
					<td><strong> <html:text property="matricula" size="8" maxlength="8"
						style="text-transform: none;" onkeyup="javascript:verificaNumeroInteiro(this);"/> </strong></td>
				</tr>
				<tr>
					<td width="162"><strong>Nome:<font color="#FF0000">*</font></strong></td>
					<td><strong> <html:text property="nome" size="60" maxlength= "70" /> </strong></td>
				</tr>
				<tr>
