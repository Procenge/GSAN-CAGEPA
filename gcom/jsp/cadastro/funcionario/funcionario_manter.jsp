		...
		<tr>
			...
			if (cont % 2 == 0) {%>
											...
											<tr bgcolor="#cbe5fe">
												...
												<logic:present name="funcionario" property="unidadeOrganizacional">
												<td width="29%">
												<div align="center"><bean:write name="funcionario"
													property="unidadeOrganizacional.descricao" /></div>												
												</logic:present>
												<logic:notPresent name="funcionario" property="unidadeOrganizacional">								
															<td></td>		
												</logic:notPresent>
											</tr>
										</pg:item>
