...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		testarCampoValorZero(document.FiltrarFuncionarioActionForm.descricaoCargo, 'Descrição Cargo') && 
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Funcionario</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para manter o(s) funcionario(s), informe os dados
					abaixo:</td>
