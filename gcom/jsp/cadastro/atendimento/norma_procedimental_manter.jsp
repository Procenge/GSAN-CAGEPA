...
<%@page import="gcom.cadastro.atendimento.NormaProcedimental"%>
...
<html:form action="/removerNormaProcedimentalAction"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Norma Procedimental</td>
				...
				<tr>
					<td colspan="7" height="23">
						<font style="font-size: 10px;" color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
							<strong>Norma Procedimental(ais) Cadastrada(s):</strong> 
						</font>
					</td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="q" />
									<%int cont = 0;%>
									<logic:iterate name="colecaoNormaProcedimental" id="NormaProcedimental"
										type="NormaProcedimental">
										<pg:item>
											<%cont = cont + 1;
											if (cont % 2 == 0) {%>
											<tr bgcolor="#FFFFFF">
											...
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="NormaProcedimental" property="id"/>"></div>
												</td>
												<td width="18%">
												<div align="center"><bean:write name="NormaProcedimental"
													property="id" /></div>
												</td>
												
												<td width="80%"
												 align="center"><html:link
													href="/gsan/exibirAtualizarNormaProcedimentalAction.do?manter=sim"
													paramId="codigoNormaProcedimental" paramProperty="id"
													paramName="NormaProcedimental"
													title="<%="" + NormaProcedimental.getDescricao()%>">
													<bean:write name="NormaProcedimental" property="descricao" />
												</html:link></td>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit
										...
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarNormaProcedimentalAction.do?limpar=S"/>'"
