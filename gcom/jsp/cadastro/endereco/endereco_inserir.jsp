...
<logic:equal name="flagReload" value="false">
  <logic:present name="objetoCep">
		<body leftmargin="5" topmargin="5" onload="resizePageSemLink(510, 560); setarFoco('${requestScope.nomeCampo}');">
  </logic:present>
  <logic:notPresent name="objetoCep">
		<body leftmargin="5" topmargin="5" onload="resizePageSemLink(510, 450); setarFoco('${requestScope.nomeCampo}');">
  </logic:notPresent>
</logic:equal>
...
<logic:equal name="flagReload" value="true">
	...
	<logic:equal name="flagRedirect" value="cliente">
		<logic:equal name="flagOperacao" value="1">
			<body leftmargin="5" topmargin="5" onload="chamarReload('inserirClienteWizardAction.do?action=exibirInserirClienteEnderecoAction');resizePageSemLink(510, 450); document.InserirEnderecoActionForm.reset();setarFoco('${requestScope.nomeCampo}');">
		</logic:equal>
		<logic:equal name="flagOperacao" value="2">
			<body leftmargin="5" topmargin="5" onload="chamarReload('atualizarClienteWizardAction.do?action=exibirAtualizarClienteEnderecoAction');resizePageSemLink(510, 450); document.InserirEnderecoActionForm.reset();setarFoco('${requestScope.nomeCampo}');">
		</logic:equal>
	</logic:equal>
	...
	<logic:equal name="flagRedirect" value="imovel">
		...
		<logic:present name="fecharPopup">
			...
			<logic:equal name="flagOperacao" value="1">
				<body leftmargin="5" topmargin="5" onload="chamarReload('inserirImovelWizardAction.do?action=exibirInserirImovelEnderecoAction');window.close();">
			</logic:equal>
			<logic:equal name="flagOperacao" value="2">
				<body leftmargin="5" topmargin="5" onload="chamarReload('atualizarImovelWizardAction.do?action=exibirAtualizarImovelEnderecoAction');window.close();;">
			</logic:equal>
		...
		<logic:notPresent name="fecharPopup">
			...
			<logic:equal name="flagOperacao" value="1">
				<body leftmargin="5" topmargin="5" onload="chamarReload('inserirImovelWizardAction.do?action=exibirInserirImovelEnderecoAction');resizePageSemLink(510, 450); document.InserirEnderecoActionForm.reset();setarFoco('${requestScope.nomeCampo}');">
			</logic:equal>
			<logic:equal name="flagOperacao" value="2">
				<body leftmargin="5" topmargin="5" onload="chamarReload('atualizarImovelWizardAction.do?action=exibirAtualizarImovelEnderecoAction');resizePageSemLink(510, 450); document.InserirEnderecoActionForm.reset();setarFoco('${requestScope.nomeCampo}');">
			</logic:equal>
    ...
    <td width="470" valign="top" class="centercoltext"> <table height="100%">
      ...
      <table width="100%" border="0">
        ...
        <tr>
          ...
          <td><html:text maxlength="5" property="numero" size="5" onkeypress="return isCampoNumerico(event);"/>
          </td>
        </tr>
        <tr>
