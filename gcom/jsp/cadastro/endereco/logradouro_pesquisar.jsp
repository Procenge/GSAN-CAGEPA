...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(590, 520); setarFoco('${requestScope.nomeCampo}');">
    ...
    <td width="542" valign="top" class="centercoltext"> <table height="100%">
      ...
      <table width="100%" border="0">
        ...
        <tr>
          ...
          <td colspan="3"><html:text property="nome" style="width: 250;" maxlength="30"/></td>
        </tr>
        <tr>
				<td>&nbsp;</td>
