...
<!-- Begin
 ...
 var bCancel = false;
    ...
    function caracteresespeciais  () {
     ...
     this.ac = new Array("nomePopularLogradouro", "Nome Popular possui caracteres especiais.", new Function ("varName", " return this[varName];"));
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Logradouro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text maxlength="4" property="idMunicipioFiltro" size="4"
						tabindex="1" onkeyup="javascript:limpaNomeMunicipio();"
						onkeypress="javascript:return validaEnter(event, 'exibirFiltrarLogradouroAction.do', 'idMunicipioFiltro');" />
					<a
				...
				<TR>
					...
					<TD><html:text property="idBairro" size="5" maxlength="4"
						tabindex="2" onkeyup="limpaNomeBairro();" 
						onkeypress="validaEnterDependencia(event, 'exibirFiltrarLogradouroAction.do', document.forms[0].idBairro, document.forms[0].idMunicipioFiltro.value, 'Município');" />
					<a
						href="javascript:chamarPopup('exibirPesquisarBairroAction.do?idMunicipio='+document.forms[0].idMunicipioFiltro.value+'&indicadorUsoTodos=1', 'bairro', 'idMunicipioFiltro', document.forms[0].idMunicipioFiltro.value, 275, 480, 'Informe o Município.');">
					<img width="23" height="21" border="0"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
						...
						<logic:empty name="PesquisarActionForm" property="idBairro">
							<html:text property="nomeBairro" size="45" value=""
								readonly="true"
								style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
				...
				<tr>
					...
					<td width="80%"><html:text maxlength="9" property="idLogradouro"
						size="10" tabindex="3" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><html:select property="idTitulo" tabindex="5"
						style="width:200px;">
						<html:option value="-1">&nbsp;</html:option>
				...
				<tr>
					...
					<td width="80%"><html:text maxlength="40" property="nomeLogradouro"
						size="40" tabindex="6" /></td>
				</tr>
				<tr>
				<td>&nbsp;</td>
				...
				<tr>
					...
					<td width="80%"><html:text maxlength="40"
						property="nomePopularLogradouro" size="40" tabindex="7" /></td>
				</tr>
				<tr>
				<td>&nbsp;</td>
				...
				<tr>
					...
					<td><html:text maxlength="8" property="cep" size="9" tabindex="8"
						onkeyup="javascript:limpaNomeCEP();"
						onkeypress="javascript:return validaEnter(event, 'exibirFiltrarLogradouroAction.do', 'cep');" />
					<a href="javascript:abrirPopup('exibirPesquisarCepAction.do?indicadorUsoTodos=1');"> <img
						...
						name="cepNaoEncontrado" scope="request">
						<html:text maxlength="40" property="retornoCep" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #ff0000"
							size="40" />
					</logic:present> <logic:notPresent name="cepNaoEncontrado"
						scope="request">
						<html:text maxlength="40" property="retornoCep" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000"
							size="40" />
