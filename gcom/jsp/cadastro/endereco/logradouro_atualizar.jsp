		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="85%" colspan="2"><html:text maxlength="30" property="nome" size="30"
						tabindex="3" /></td>
				</tr>
				<tr>
					<td width="15%"><strong>Nome Popular:</strong></td>
					<td width="85%" colspan="2"><html:text maxlength="30" property="nomePopular" size="30"
						tabindex="4" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="4" property="idMunicipio" size="4"
						tabindex="5"
						onkeypress="return validaEnter(event, 'exibirAtualizarLogradouroAction.do?removerColecaoBairro=OK&removerColecaoCep=OK', 'idMunicipio');"/>
					<a
				...
				<tr>
					...
					<td><html:text maxlength="4" property="codigoBairro" size="4"
						tabindex="6"
						onkeypress="javascript:return validaEnterDependencia(event, 'exibirAtualizarLogradouroAction.do', this,document.forms[0].idMunicipio.value,'Município');" />
