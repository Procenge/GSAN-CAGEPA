...
function validatePesquisarActionForm(form) {
	if (bCancel)
		...
		&& testarCampoValorZero(document.PesquisarActionForm.inscricaoEstadual, 'Inscrição Estadual')
...
function caracteresespeciais () {
	...
	this.ai = new Array("inscricaoEstadual", "Inscrição Estadual possui caracteres especiais.", new Function ("varName", " return this[varName];"));
}
...
function IntegerValidations () {
	...
	this.ai = new Array("inscricaoEstadual", "Inscrição Estadual deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
}
...
<body leftmargin="5" topmargin="5"
	onload="window.focus();javascript:resizePageSemLink(800, 475);javascript:setarFoco('${requestScope.nomeCampo}');">
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
    		...
    		<table width="100%" border="0">
				...
				<tr>
					<td height="28"><strong> Inscrição Estadual: </strong>
					</td>
					<td><html:text property="inscricaoEstadual" size="14" maxlength="14" tabindex="6"/>
					<font size="1"> &nbsp; </font></td>					
				</tr>
				<tr>
					<td height="28"><strong>CEP:</strong></td>
					<td>
						<html:text maxlength="8" property="cepClienteEndereco" size="9" tabindex="7" />
					</td>
				</tr>
				<tr>
					<td><strong>Munic&iacute;pio:</strong></td>
					<td>
						<html:text maxlength="4" property="idMunicipioCliente" size="4" tabindex="8"
				...
				<tr>
					...
					<td>
						<html:text maxlength="4" property="codigoBairroCliente" tabindex="9" size="4"
						...
						<a href="javascript:redirecionarSubmit('exibirPesquisarBairroAction.do?caminhoRetornoTelaPesquisaBairro=exibirPesquisarClienteAction&tipo=sembairro&idMunicipio='+document.forms[0].idMunicipioCliente.value);">
							<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif"
				...
				<tr>
					...
					<td width="18%">
						<html:text property="idLogradouroCliente" size="9" maxlength="9" tabindex="10"
				...
				<tr>
					<td height="24" colspan="3" width="80%">
						...
						<logic:present name="caminhoRetornoTelaPesquisaCliente">
							<input type="button" class="bottonRightCol" value="Voltar" onclick="redirecionarSubmit('${caminhoRetornoTelaPesquisaCliente}.do')"/>
						</logic:present>
					</td>
					<td>
						
						<input type="button" name="Button" class="bottonRightCol" tabindex="11" value="Pesquisar"
