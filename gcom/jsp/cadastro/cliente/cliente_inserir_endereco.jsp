								...
								<logic:present name="colecaoEnderecos">
									...
									<logic:iterate name="colecaoEnderecos" id="endereco" scope="session">
										...
										<%}%>
											...
											<td width="81%">
												<a href="javascript:passarParametros('exibirInserirEnderecoAction.do?exibirEndereco=OK&tipoPesquisaEndereco=cliente&operacao=1&objetoSelecionado=<%= "" + GcomAction.obterTimestampIdObjeto(endereco) %>')"><bean:write name="endereco" property="enderecoFormatado"/></a>
											</td>
										</tr>
									</logic:iterate>
