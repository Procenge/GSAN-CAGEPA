			...
			<td valign="top" class="centercoltext">
    			...
    			<table width="100%" border="0">
					...
					<tr>
						...
						<td width="76%">
							<html:text maxlength="4" property="idMunicipio" size="4" tabindex="2"
								onkeypress="javascript: validaEnter(event,'inserirClienteWizardAction.do?action=exibirInserirClienteTelefoneAction','idMunicipio');" />
					...
					<tr>
						...
						<td><html:text maxlength="2" property="ddd" size="2" tabindex="3"/></td>
					</tr>
					<tr>
						<td height="24">
