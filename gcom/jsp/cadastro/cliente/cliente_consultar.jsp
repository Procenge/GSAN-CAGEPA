...
function abrirManterCliente() {
	var form = document.forms[0];
	
	if (form.codigoCliente.value == '') {
		alert('Código do cliente inválido');
	} else {
		abrirPopup('exibirAtualizarClienteAction.do?idRegistroAtualizacao=' + form.codigoCliente.value , 400, 800);
	}
		...
		<tr>
						...
						<logic:present name="desabilitarPesquisaCliente">
							<tr bgcolor="#cbe5fe">
								...
								<table border="0" width="100%">
									...
									<tr>
									 <td colspan="2">
									  <a href="javascript:abrirManterCliente();">
											<strong>Manter Cliente</strong>
									  </a>
									 </td>
					...
					<table style="width: 100%;" border="0">
						...
						<logic:equal name="indicadorTipoCliente" value="1" scope="request">
							...
							<tr>
								...
								<td>
									<html:text property="dataNascimentoCliente" size="20" readonly="true"
									style="background-color:#cbe5fe; border:0; color: #000000" />
								</td>
							...
							<tr>
								...
								<div class="style9">
									<html:text property="profissaoCliente" 	size="30" readonly="true" style="background-color:#cbe5fe; border:0; color: #000000" />
								</div>
								</td>
							</tr>
							<tr>
						...
						<logic:notEqual name="indicadorTipoCliente" value="1"
							...
							<tr>
								<td align="left" height="10" width="18%">
								<div class="style9"><strong>Inscrição Estadual:</strong></div>
								</td>
								<td><html:text property="inscricaoEstadualCliente" size="20" readonly="true" style="background-color:#cbe5fe; border:0; color: #000000" />
								<font size="1"> &nbsp; </font></td>					
							</tr>
							<tr>
								<td height="24%" align="left"><strong>Estado:</strong></td>
								<td><html:text property="siglaUnidadeFederacao" size="4" readonly="true" style="background-color:#cbe5fe; border:0; color: #000000" /></td>					
							</tr>
						</logic:notEqual>
			...
			if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<td width="15%" align="left"><%=(((ClienteFone) telefone).getIndicadorTelefonePadrao() != null && ((ClienteFone) telefone).getIndicadorTelefonePadrao()
					      ...
					      <logic:present name="exibirBotaoVoltar" scope="request">
					      	<logic:equal name="exibirBotaoVoltar" scope="request" value="S">
					      		<input name="Submit24" class="bottonRightCol" value="Voltar" type="button" onclick="javascript:history.back();">&nbsp;&nbsp;
					      	</logic:equal>
					      </logic:present>
