...
function caracteresespeciais () {
	...
	this.ab = new Array("inscricaoEstadual", "Inscrição Estadual possui caracteres especiais.", new Function ("varName", " return this[varName];"));
}
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				<tr>
					<td>Para adicionar um cliente pessoa jur&iacute;dica, informe os dados abaixo:</td>
				<td align="right"></td>
    			</tr>
    		</table>
