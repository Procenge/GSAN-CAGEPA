...
<script language="JavaScript">
	...
	function reload() {
		var form = document.AtualizarClienteTipoActionForm;
		form.action = "/gsan/exibirAtualizarClienteTipoAction.do?reload=true";
		form.submit();
	}  
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td align="right">
					  <gcom:controleAcessoBotao name="Button" value="Atualizar" onclick="javascript:validaForm(document.forms[0]);" url="atualizarClienteTipoAction.do"/>
