...
function checkDadosAdcionais(valor) {
	var form = document.forms[0]; 
	form.indDadosAdicionais.checked = valor == '1';
}
...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}');checkDadosAdcionais('<%= session.getAttribute("checkDadosAdcionais") %>');">
<div id="formDiv">
<html:form
		...
		<td width="655" valign="top" class="centercoltext">
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				<tr>
					<td>
						...
						<html:checkbox property="indDadosAdicionais" tabindex="1" value="true"></html:checkbox>
					<td align="right"></td>
    			</tr>
    		...
    		<table width="100%" border="0">
				<tr>
                    ...
                    <td>
						<!-- <input type="checkbox" id="indMulta" name="indMulta" tabindex="1" value="1"/> -->
                ...
                <tr>
                    ...
                    <td>
						<!-- <input type="checkbox" id="indJuros" name="indJuros" tabindex="2" value="1"/> -->
                ...
                <tr>
                    ...
                    <td>
						<!-- <input type="checkbox" id="indCorrecao" name="indCorrecao" tabindex="3" value="1"/> -->
                ...
                <tr>
                    ...
                    <td>
						<html:select property="banco" tabindex="5" onchange="javascript:pesquisaColecaoReload('inserirClienteWizardAction.do?action=exibirInserirClienteResponsavelAction','banco');">
                ...
                <tr>
                    ...
                    <td>
						<html:text maxlength="12" property="contaBancaria" size="12" tabindex="6" onkeypress="return isCampoNumerico(event);"/>
                    </td>
                </tr>
...
<script>
document.getElementById('botaoConcluir').onclick = function() { botaoAvancarTelaEspera('/gsan/inserirClienteWizardAction.do?concluir=true&action=inserirClienteResponsavelAction'); }
</script>
