...
function caracteresespeciais () {
     ...
     this.al = new Array("inscricaoEstadual", "Inscrição Estadual possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    ...
    function IntegerValidations () {
     ...
     this.al = new Array("idLogradouro", "Código do Logradouro deve somente conter dígitos.", new Function ("varName", " return this[varName];"));
     this.am = new Array("inscricaoEstadual", "Inscrição Estadual deve somente conter dígitos.", new Function ("varName", " return this[varName];"));
    }
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><strong> Inscrição Estadual: </strong>
					</td>
					<td><logic:present name="pessoaFisica" scope="request">
						<html:text property="inscricaoEstadual" size="14" maxlength="14" readonly="true" />
						</logic:present>
						<logic:notPresent name="pessoaFisica" scope="request">
							<html:text property="inscricaoEstadual" size="14" maxlength="14" />
						</logic:notPresent>
					<font size="1"> &nbsp; </font>
					</td>														
				</tr>
