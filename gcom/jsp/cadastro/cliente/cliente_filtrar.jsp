...
var bCancel = false; 
    ...
    function IntegerValidations () { 
     ...
     this.ab = new Array("rgClienteFiltro", "RG deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		...
		<tr>
	        ...
	        <table bordercolor="#000000" width="100%" cellspacing="0">
				...
				<tr>
					...
					<td width="27%"><html:text name="FiltrarClienteActionForm" property="inscricaoEstadualClienteFiltro" size="14" maxlength="14" />
					<font size="1"> &nbsp; </font></td>					
				</tr>
				<tr>
					<td height="30">
				...
				<logic:present scope="session" name="indicadorExibirCampoContaBraille">
					<tr height="30">
						<td>
							<strong>Conta Impressa em Braille?</strong>
						</td>
						<td>
							<html:radio name="FiltrarClienteActionForm" property="indicadorContaBraille"
								value="<%=ConstantesSistema.SIM.toString()%>" />
							<strong>Sim</strong> 
							<html:radio name="FiltrarClienteActionForm" property="indicadorContaBraille"
								value="<%=ConstantesSistema.NAO.toString()%>" />
							<strong>Não</strong>
							<html:radio name="FiltrarClienteActionForm" property="indicadorContaBraille" value="<%=ConstantesSistema.TODOS.toString()%>"/>
							<strong>Todos</strong>
						</td>
					</tr>
				</logic:present>
