...
<form action="/gsan/testeCelularAction.do"
           method="post"
          ...
          <td valign="top" class="centercoltext">
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td class="parabg">Teste de Dados do Celular</td>
            ...
            <table width="100%" border="0" >
              <tr>
                  <td colspan="2">Informe o arquivo:</td>
                </tr>
                <tr>
            ...
            <gcom:controleAcessoBotao name="Button" value="Importar"
							  onclick="javascript:validarForm(document.forms[0]);" url="testeCelularAction.do"/>
					<!--
