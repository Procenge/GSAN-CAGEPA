...
function remover(objeto){
	...
	if (CheckboxNaoVazio(objeto)){
		if (confirm ("Confirma remoção?")) {
			document.forms[0].action = "/gsan/removerUnidadeOperacionalAction.do"
...
<html:form action="/removerUnidadeOperacionalAction" 
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="4" height="23">
						...
						<strong>Distritos Operacionais cadastradas:</strong>
						</font>
					</td>
					<td align="right"></td>
				</tr>
				...
				<tr>
					<td>
						...
						<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
							...
							<pg:param name="pg"/>
							<pg:param name="q"/>
							<logic:present name="colecaoUnidadeOperacional">
								<%int cont = 0;%>
								<logic:iterate name="colecaoUnidadeOperacional" id="unidadeOperacional" type="UnidadeOperacional">
									<pg:item>
										<%cont = cont + 1;
										if (cont % 2 == 0) {%>
										<tr bgcolor="#cbe5fe">
										...
										<%}%>
											<td width="46" align="center">
												...
												value="<bean:write name="unidadeOperacional" property="id"/>"/>
											</td>
											<td width="20%" align="center">
												<a href="/gsan/exibirAtualizarUnidadeOperacionalAction.do?idUnidadeOperacional=<%=""+ unidadeOperacional.getId()%>"><bean:write name="unidadeOperacional" property="codigoUnidadeOperacional"/></a>
											</td>
											<td width="70%" align="left">
												<bean:write name="unidadeOperacional" property="descricao"/>
											</td>
										</tr>
									</pg:item>
								</logic:iterate>
...
<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioUnidadeOperacionalManterAction.do" />
