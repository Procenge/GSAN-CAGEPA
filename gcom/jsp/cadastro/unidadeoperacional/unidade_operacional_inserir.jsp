...
<link rel="stylesheet"
	...
	type="text/css">
	<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="InserirUnidadeOperacionalActionForm"
...
<script language="JavaScript">
	...
	function validarForm() {
	    var form = document.forms[0];
		  if(validateInserirUnidadeOperacionalActionForm(form)){	     
  	...
  	function limparForm() {
		var form = document.forms[0];
		form.codigoUnidadeOperacional.value = "";
		...
		form.fax.value = "";
		form.email.value = "";
		form.descricaoTipoInstalacao.value = "";
...
<html:form action="/inserirUnidadeOperacionalAction.do"
	name="InserirUnidadeOperacionalActionForm"
	type="gcom.gui.cadastro.unidadeoperacional.InserirUnidadeOperacionalActionForm"
	method="post"
	onsubmit="return validateInserirUnidadeOperacionalActionForm(this);">
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0">
			<tr>
				<td colspan="2">Para adicionar o Distrito Operacional, informe os dados abaixo:</td>
			</tr>
			<tr>
			  ...
			  <td  width="60%" colspan="2"><strong><b><span class="style2"> <html:text
				  property="codigoUnidadeOperacional" size="3" maxlength="3" tabindex="1"/> </span></b></strong></td>
			</tr>	
			...
			<tr>
			  ...
			  <td  width="60%" colspan="2"><strong><b><span class="style2"> <html:text
				  property="descricao" size="40" maxlength="30" tabindex="2"/> </span></b></strong></td>
			</tr>
			...
			<tr>
			  ...
			  <td  width="60%" colspan="2"><strong><b><span class="style2"> <html:text
				  property="descricaoAbreviada" size="10" maxlength="6" tabindex="3"/> </span></b></strong></td>
			</tr>
			...
			<tr>
			  ...
			  <td  width="60%" colspan="2">
			  			<html:select property="sistemaAbastecimento" tabindex="4" style="width:200px;">
			...
			<tr>
                    ...
                    <td width="70%" height="24" colspan="2">
                   		<html:text maxlength="3" property="localidade" size="3" onkeypress="javascript:limparPesquisaDescricaoLocalidade(); return validaEnter(event, 'exibirInserirUnidadeOperacionalAction.do', 'localidade');" tabindex="5"/>
					...
					<logic:present name="colecaoEnderecos">
						...
						<logic:empty name="colecaoEnderecos">
							<input type="button" class="bottonRightCol" value="Adicionar"
								id="botaoEndereco"
								onclick="javascript:abrirPopup('exibirInserirEnderecoAction.do?tipoPesquisaEndereco=unidadeOperacional&operacao=1', 570, 700);" tabindex="6">
						...
						<logic:notEmpty name="colecaoEnderecos">
							<input type="button" class="bottonRightCol" value="Adicionar"
								id="botaoEndereco"
								onclick="javascript:abrirPopup('exibirInserirEnderecoAction.do?tipoPesquisaEndereco=unidadeOperacional&operacao=1', 570, 700);"
								disabled tabindex="6">
				...
				cor = "#FFFFFF";%>
										<tr bgcolor="#cbe5fe">
											...
											<td width="50" align="center"><a
												href="javascript:removerEndereco('removerInserirUnidadeOperacionalColecaoEnderecoAction.do?enderecoRemoverSelecao=<%=""+endereco.getUltimaAlteracao().getTime()%>');"><img
												border="0"
												src="<bean:message key="caminho.imagens"/>Error.gif" /></a>
											</td>
											<td>
											
												<a href="javascript:abrirPopup('exibirInserirEnderecoAction.do?exibirEndereco=OK&tipoPesquisaEndereco=unidadeOperacional&operacao=1', 570, 700)"><bean:write name="endereco" property="enderecoFormatado"/></a>
			...
			<tr>
					    <td  width="40%"class="style3"><strong>Descrição do tipo de Instalação:</strong></td>
			  			<td  width="60%" colspan="2"><strong><b><span class="style2"> 
			  				<html:text property="descricaoTipoInstalacao" size="40" maxlength="30" tabindex="11"/>
			  				 </span></b></strong></td>
			</tr>
				...
				<table width="100%">
						...
						<tr>
							  ...
							  <td align="right"><input type="button" name="Button" class="bottonRightCol"
									value="Inserir" onclick="validarForm();" tabindex="15"/>
							  </td>
						</tr>
				</table>
