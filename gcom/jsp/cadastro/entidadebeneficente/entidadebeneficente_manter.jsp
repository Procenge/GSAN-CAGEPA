...
<html:form action="/removerEntidadeBeneficenteAction"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter EntidadeBeneficente</td>
				...
				<tr>
					<td colspan="7" height="23">
						<font style="font-size: 10px;" color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
							<strong>Entidades Beneficentes:</strong> 
						</font>
					</td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="q" />
									<%int cont = 0;%>
									<logic:iterate name="colecaoEntidadeBeneficente" id="entidadeBeneficente"
										type="EntidadeBeneficente">
										<pg:item>
											<%cont = cont + 1;
											if (cont % 2 == 0) {%>
											<tr bgcolor="#FFFFFF">
											...
											<tr bgcolor="#cbe5fe">
												...
												<td width="45%"
												 align="center"><html:link
													href="/gsan/exibirAtualizarEntidadeBeneficenteAction.do"
													paramId="idEntidadeBeneficente" paramProperty="id"
													paramName="entidadeBeneficente"
													title="<%="" + entidadeBeneficente.getId()%>">
													<bean:write name="entidadeBeneficente" property="cliente.nome" />
												</html:link></td>
												
												
												<td width="30%">
												<div align="center"><bean:write name="entidadeBeneficente"
													property="debitoTipo.descricao" /></div>
												</td>
												
												<td width="8%">
												<div align="center"><bean:write name="entidadeBeneficente"
													property="indicadorUsoDesc" /></div>
												</td>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit
										...
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarEntidadeBeneficenteAction.do?limpar=S"/>'"
