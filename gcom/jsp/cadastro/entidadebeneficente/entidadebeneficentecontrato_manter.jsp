						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="13%">
									<div align="center"><strong>Data Início do Contrato</strong></div>
									</td>
									<td width="13%">
									<div align="center"><strong>Data Início do Contrato</strong></div>
									</td>									
									<td width="16%">
									<div align="center"><strong>Percentual de Remuneração</strong></div>
									</td>
									<td width="16%">
									<div align="center"><strong>Valor Mínima para Doação</strong></div>
									</td>									
								</tr>
