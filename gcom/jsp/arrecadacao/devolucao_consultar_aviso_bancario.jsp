													...
													<logic:present name="colecaoDevolucaoAvisoBancarioConta"
														...
														<logic:iterate name="colecaoDevolucaoAvisoBancarioConta"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="13.7%">${devolucao.devolucaoSituacaoAtual.descricaoAbreviada}&nbsp;</td>
															</tr>
														</logic:iterate>
													</logic:present>
													...
													<logic:present name="colecaoDevolucaoHistoricoAvisoBancarioConta"
														...
														<logic:iterate name="colecaoDevolucaoHistoricoAvisoBancarioConta"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="13.7%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAtual.descricaoAbreviada}</font>&nbsp;</td>
															...
															<logic:iterate
																...
																<tr bgcolor="#cbe5fe">
																	...
																	<td width="11.4%" align="center"><bean:write name="devolucao"
																		property="dataDevolucao" formatKey="date.format" />&nbsp;</td>
																	<td width="17.1%">${devolucao.devolucaoSituacaoAnterior.descricaoAbreviada}&nbsp;</td>
															...
															<logic:iterate
																...
																<tr bgcolor="#cbe5fe">
																	...
																	<td width="11.4%" align="center"><font color="#ff0000" ><bean:write name="devolucaoHistorico"
																		property="dataDevolucao" formatKey="date.format" /></font>&nbsp;</td>
																	<td width="17.1%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAnterior.descricaoAbreviada}</font>&nbsp;</td>
