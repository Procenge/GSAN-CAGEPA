		...
		<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc" class="fontePequena">
								...
								<logic:present name="colecaoPagamentosMovimentoArrecadadorConta"
									...
									<logic:iterate
										name="colecaoPagamentosMovimentoArrecadadorConta" id="pagamento" >
										<%cont = cont + 1;
			if (cont % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
											<%} else {
			...
			%>
												...
												<logic:notEmpty name="pagamento" property="conta">
													<logic:notEmpty name="pagamento" property="conta.id">
														<logic:notEmpty name="pagamento" property="conta.referencia">
															<a
																href="javascript:abrirPopup('exibirConsultarContaAction.do?tipoConsulta=conta&contaID=<bean:write name="pagamento" property="conta.id" />' , 600, 800);">${pagamento.conta.formatarAnoMesParaMesAno}</a>
														</logic:notEmpty>
													</logic:notEmpty>
												</logic:notEmpty> 
								...
								<logic:present
									...
									<logic:iterate
										name="colecaoPagamentosHistoricoMovimentoArrecadadorConta" id="pagamentoHistorico" >
										<%cont = cont + 1;
			if (cont % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
											<%} else {
			...
			%>
										<tr bgcolor="#cbe5fe">
											...
											<td width="12%" align="center"><%--<logic:notEmpty
												...
												</logic:notEmpty>--%> <logic:present name="pagamentoHistorico" property="anoMesReferenciaArrecadacao">
												<bean:define name="pagamentoHistorico" property="anoMesReferenciaArrecadacao" id ="anoMesReferenciaPagamento"/>
												<font color="#ff0000"><%=Util.formatarAnoMesParaMesAno((Integer) anoMesReferenciaPagamento)%></font>
											</logic:present></td>
											<td width="12%" align="right"><logic:notEmpty
												name="pagamentoHistorico" property="conta">
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc" class="fontePequena">
								...
								<logic:present
									...
									<logic:iterate
										name="colecaoPagamentosMovimentoArrecadadorGuiaPagamento" id="pagamento" >
										<%contad = contad + 1;
			if (contad % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
											<%} else {%>
										<tr bgcolor="#cbe5fe">
											...
											<td width="15%" align="center">
											  <logic:notEmpty name="pagamento" property="guiaPagamentoGeral" >	
												<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">												
													<a href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<bean:write name="pagamento" property="guiaPagamentoGeral.guiaPagamento.id" />')">
														${pagamento.guiaPagamentoGeral.guiaPagamento.id}</a>&nbsp;																	
												</logic:notEmpty>
												<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico">																									
														${pagamento.guiaPagamentoGeral.guiaPagamentoHistorico.id}&nbsp;																	
												</logic:notEmpty>
											  </logic:notEmpty>
											...
											<td width="10%" align="right">
												<logic:notEmpty name="pagamento" property="guiaPagamentoGeral">
													<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">
														<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento.valorDebito">
															<bean:write name="pagamento" property="guiaPagamentoGeral.guiaPagamento.valorDebito" formatKey="money.format" />&nbsp;
														</logic:notEmpty>
													</logic:notEmpty>
													<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico">
														<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico.valorDebito">
															<bean:write name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico.valorDebito" formatKey="money.format" />&nbsp;
														</logic:notEmpty>
													</logic:notEmpty>
												</logic:notEmpty>	
											</td>
								...
								<logic:present
									...
									<logic:iterate
										name="colecaoPagamentosHistoricoMovimentoArrecadadorGuiaPagamento" id="pagamentoHistorico" >
										<%contad = contad + 1;
			if (contad % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
											<%} else {%>
										<tr bgcolor="#cbe5fe">
											...
											<td width="15%" align="center">
											  <logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral">
											  	<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento">												
													<a
														href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<bean:write name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento.id" />')"><font
														color="#ff0000">${pagamentoHistorico.guiaPagamentoGeral.guiaPagamento.id}</font></a>&nbsp;
												</logic:notEmpty>	
												<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico">												
													<font color="#ff0000">${pagamentoHistorico.guiaPagamentoGeral.guiaPagamento.id}</font>&nbsp;
												</logic:notEmpty>																		
											  </logic:notEmpty>
											...
											<td width="10%" align="right">
											  <logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral">
												<font color="#ff0000">
												<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento">													
													<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento.valorDebito">
													 
														<bean:write name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento.valorDebito" formatKey="money.format" /> 
																&nbsp;
													</logic:notEmpty>
												</logic:notEmpty>
												<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico">													
													<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico.valorDebito">
														...
														<bean:write name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico.guiaPagamento.valorDebito" formatKey="money.format" /> 
																&nbsp;
													</logic:notEmpty>
												</logic:notEmpty>
												</font>	
			...
			if (contad % 2 == 0) {%>
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="15%" align="center">
											  <logic:notEmpty name="pagamento" property="guiaPagamentoGeral">
												<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">
													<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento.documentoTipo">
														<a
															href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<bean:write name="pagamento" property="guiaPagamentoGeral.guiaPagamento.id" />')">
															${pagamento.guiaPagamentoGeral.guiaPagamento.documentoTipo.descricaoDocumentoTipo}</a>&nbsp;
													</logic:notEmpty>
												</logic:notEmpty>
												<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico">
													<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico.documentoTipo">														
															${pagamento.guiaPagamentoGeral.guiaPagamentoHistorico.documentoTipo.descricaoDocumentoTipo}&nbsp;
													</logic:notEmpty>
												</logic:notEmpty>
											   </logic:notEmpty>
											    <logic:empty name="pagamento" property="guiaPagamentoGeral">													
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="15%" align="center">
												<logic:notEmpty name="pagamentoHistorico" 	property="guiaPagamentoGeral">
													...
													<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico">												
														<font color="#ff0000">${pagamentoHistorico.guiaPagamentoGeral.guiaPagamentoHistorico.id}</font>&nbsp;
													</logic:notEmpty>
												</logic:notEmpty>
												<logic:empty name="pagamentoHistorico" 	property="guiaPagamentoGeral">
													${pagamentoHistorico.debitoTipo.descricao}
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc" class="fontePequena">
								...
								<logic:present
									...
									<logic:iterate
										name="colecaoPagamentosMovimentoArrecadadorDebitoACobrar" id="pagamento" >
										<%contador = contador + 1;
			if (contador % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
											<%} else {
			...
			%>
								...
								<logic:present
									...
									scope="request">
									<logic:iterate
										name="colecaoPagamentosHistoricoMovimentoArrecadadorDebitoACobrar" 	id="pagamentoHistorico" >
										<%contador = contador + 1;
			if (contador % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
											<%} else {
											...
											<td width="16%" align="center"><logic:notEmpty
												...
												<logic:notEmpty name="pagamentoHistorico"
													...
													<a
														...
														color="#ff0000">${pagamento.debitoACobrar.debitoTipo.descricao}</font>&nbsp;</a>
												</logic:notEmpty>
