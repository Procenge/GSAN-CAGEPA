		...
		<tr>
			...
			<table width="100%" border="0">
					...
					<tr>
					 <td colspan="3">
					  <table width="100%" bgcolor="#90c7fc">
					   <tr bgcolor="#79bbfd">
						 <td width="30%" bgcolor="#79bbfd"><strong>Valor Pagamento</strong></td>
						 <td width="60%"><strong>Indicador Expurgado</strong>
					   </tr>
					  </table>
					  </td>
					 </tr>
				...
				<tr>
					 ...
					 <td align="right">
						<gcom:controleAcessoBotao name="botaoFiltrar" value="Concluir"
