...
<%@ page import="gcom.arrecadacao.pagamento.bean.InserirPagamentoManualHelper"%>>
   ...
   function validarForm(form) {
    ...
    function FloatValidations () {
     ...
     function IntegerValidations () { 
       ...
       this.ag = new Array("numeroPrestacao", "Número da prestação deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    } 
...
//Vivianne Sousa - 15/08/06
	...
	function validaRequiredGuiaPagamento () {
		...
		if((form.idTipoDebito.value == null || form.idTipoDebito.value == "")
		&& ((form.idGuiaPagamento.value != null || form.idGuiaPagamento.value != "") 
...
function verificarImovel(){
 ...
 function adicionarPagamento(form){
 	...
 	if (validarForm(form)){
 		form.action = "/gsan/inserirPagamentosWizardAction.do?informarPagamento=OK&destino=2&action=exibirInserirPagamentosTipoInclusaoManualAction";
 		submeterFormPadrao(form);
 	}	
 }
      ...
      <table width="100%" border="0" dwcopytype="CopyTableRow">
        ...
        <tr>
         ...
         <tr> 
          ...
          <td> 
            <strong> 
              <html:text property="numeroPrestacao" size="3" maxlength="3" style="text-align:right;"/>
            </strong> 
          </td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td> 
            <strong> 
              <html:text property="valorPagamento" size="12" maxlength="12" 
              onkeyup="formataValorMonetario(this, 12)"style="text-align:right;"/>
            </strong> 
          </td>
        </tr>
					...
					<td colspan="2">
						...
						<tr>
							<td>
								...
								<tr bgcolor="#99CCFF">
									...
									<td width="12%">
										<div align="center"><strong>Nº Parcelas</strong></div>
									</td>
									<td width="12%">
						...
						<tr>
							<td>
								...
								<logic:present name="colecaoPagamentoInserirHelper">
								
									<INPUT TYPE="hidden" ID="pagamentoInformado" VALUE="OK">

									<logic:iterate name="colecaoPagamentoInserirHelper" id="pagamentoHelper"
									type="InserirPagamentoManualHelper">
										...
										<td align="center" width="10%" valign="middle">
											<a href="javascript:removerPagamento(<%="" + pagamentoHelper.getIdPagamentoMemoria().toString() %>)">
												<img src="<bean:message key='caminho.imagens'/>Error.gif" border="0" >
											</a>
										</td>
										
										<td width="30%"><bean:write name="pagamentoHelper"
										property="pagamento.documentoTipo.descricaoAbreviado" /></td>
										<td width="12%" align="center">
											<logic:present name="pagamentoHelper" property="pagamento.numeroPrestacao">
												<bean:write name="pagamentoHelper" property="pagamento.numeroPrestacao" />
											</logic:present>
										</td>
										
										<logic:present name="pagamentoHelper" property="pagamento.imovel">
											<td width="12%" align="center"><bean:write name="pagamentoHelper"
											property="pagamento.imovel.id" /></td>
										
										</logic:present>
										
										<logic:notPresent name="pagamentoHelper" property="pagamento.imovel">
											
											<td width="12%"></td>
										
										</logic:notPresent>
										
										<logic:present name="pagamentoHelper" property="pagamento.cliente">
											
											<td width="12%" align="center"><bean:write name="pagamentoHelper"
											property="pagamento.cliente.id" /></td>
										
										</logic:present>
										
										<logic:notPresent name="pagamentoHelper" property="pagamento.cliente">
											
											<td width="12%"></td>
										
										</logic:notPresent>
										
										<logic:present name="pagamentoHelper" property="pagamento.anoMesReferenciaPagamento">
											
											<td width="12%" align="center"><%= "" + Util.formatarAnoMesParaMesAno(pagamentoHelper.getPagamento().getAnoMesReferenciaPagamento()) %></td>
										
										</logic:present>
										
										<logic:notPresent name="pagamentoHelper" property="pagamento.anoMesReferenciaPagamento">
											
											<td width="12%"></td>
										
										</logic:notPresent>
										
										<logic:present name="pagamentoHelper" property="pagamento.debitoTipo">
											
											<td width="12%" align="center"><bean:write name="pagamentoHelper"
											property="pagamento.debitoTipo.id" /></td>
										
										</logic:present>
										
										<logic:notPresent name="pagamentoHelper" property="pagamento.debitoTipo">
											
											<td width="12%"></td>
										
										</logic:notPresent>
										
										<td width="12%" align="right"><bean:write name="pagamentoHelper"
										property="pagamento.valorPagamento" formatKey="money.format"/></td>
