...
<body leftmargin="5" topmargin="5" onload="javascript:desabilitarCodigoBarra();desabilitarCodigoBarra();limparCodigosBarras();">
<div id="formDiv">
<html:form
    ...
    <td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" dwcopytype="CopyTableRow">
        ...
        <tr> 
          ...
          <td colspan="3"> 
            <strong> 
               <html:text tabindex="0" property="codigoBarraPorLeituraOtica" size="44" maxlength="44" onkeypress="return isCampoNumerico(event);" onkeyup="adicionarCodigoDeBarraLeituraOtica()" />
            </strong> 
          </td>
        </tr>
        <tr>
