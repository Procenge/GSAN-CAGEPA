			...
			<table width="100%" border="0" style="fonteReduzida">
											...
											<td width="15%" align="center">
											  <logic:notEmpty name="pagamento" property="guiaPagamentoGeral">
													<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">
															<a href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<%="" + pagamento.getGuiaPagamentoGeral().getId() %>')"><font color="#ff0000">${pagamento.guiaPagamentoGeral.id}/${pagamento.numeroPrestacao}</font></a>&nbsp;
													</logic:notEmpty>
				...
				if (contad % 2 == 0) {%>
												...
												<tr bgcolor="#cbe5fe">
													...
													<td width="15%" align="center">
													  <logic:notEmpty name="pagamento" property="guiaPagamentoGeral">														  	
														<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">															
															<a href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<%="" + pagamento.getGuiaPagamentoGeral().getGuiaPagamento().getId() %>')"><font color="#ff0000">${pagamento.guiaPagamentoGeral.id}/${pagamento.numeroPrestacao}</font></a>&nbsp;																															
														</logic:notEmpty>
														<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico">
															<font color="#ff0000">${pagamento.guiaPagamentoGeral.id}/${pagamento.numeroPrestacao}</font>&nbsp;																														
														</logic:notEmpty>
				...
				%>
										<tr bgcolor="#cbe5fe">
											...
											${pagamento.debitoACobrar.valorRestanteCobrado}&nbsp;</td>
											<td width="12%" align="right"><bean:write name="pagamento"
												property="valorPagamento" formatKey="money.format" />&nbsp;
											</td>
				...
				%>
										<tr bgcolor="#cbe5fe">
											...
											${pagamentoHistorico.debitoACobrar.valorRestanteCobrado} </font>
											&nbsp;</td>
											<td width="12%" align="right"><font color="#ff0000"> <bean:write
												name="pagamentoHistorico" property="valorPagamento"
												formatKey="money.format" /> </font> &nbsp;</td>
