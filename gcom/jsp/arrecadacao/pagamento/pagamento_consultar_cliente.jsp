						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc" class="fontePequena">
								<tr bordercolor="#000000">
									...
									<td width="10%" bgcolor="#90c7fc" align="center" rowspan="2"><strong>Mês/Ano Conta</strong></td>
									...
									<td width="28%" bgcolor="#90c7fc" align="center" colspan="2"><strong>Situação</strong></td>
								</tr>
								<tr>
