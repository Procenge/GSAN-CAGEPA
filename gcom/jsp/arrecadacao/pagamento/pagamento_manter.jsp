	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						<tr bordercolor="#FFFFFF" bgcolor="#99CCFF">
							...
							Banc&aacute;rio</strong> </font></div>
							</td>
							...
							<div align="center"><font color="#000000" style="font-size:9px"
								face="Verdana, Arial, Helvetica, sans-serif"> <strong>Situa&ccedil;&atilde;o</strong>
							</font></div>
							</td>
						</tr>
						...
						<tr bordercolor="#FFFFFF" bgcolor="#cbe5fe">
							...
							Lan&ccedil;amento</strong> </font></div>
							</td>
			...
			%>
					...
					<table width="100%">
						<tr>
							<td><gcom:controleAcessoBotao name="Button" value="Remover"
