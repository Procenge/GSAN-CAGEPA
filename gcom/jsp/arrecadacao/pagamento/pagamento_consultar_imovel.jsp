            ...
            %>
												...
												<td width="14%" align="center"><logic:notEmpty
													...
													<logic:notEmpty name="pagamento" property="conta.id">
														<logic:notEmpty name="pagamento"
															...
															<a
																href="javascript:abrirPopup('exibirConsultarContaAction.do?tipoConsulta=conta&contaID=<%="" + pagamento.getConta().getId() %>' , 600, 800);">${pagamento.conta.formatarAnoMesParaMesAno}</a>
														</logic:notEmpty>
													</logic:notEmpty>
												...
												<logic:iterate name="colecaoPagamentosImovelConta"
													...
													<%	}%>
														...
														<td width="19%" align="right">
															<logic:notEmpty name="pagamento" property="conta">
																<logic:notEmpty name="pagamento" property="conta.valorTotal">
                ...
                %>
													<tr bgcolor="#cbe5fe">
														...
														<td width="19%" align="right">
															<logic:notEmpty name="pagamentoHistorico" property="conta">
																<logic:notEmpty name="pagamentoHistorico" property="conta.valorTotal">
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc" class="fontePequena">
								<tr bordercolor="#000000">
									...
									<td width="15%" align="center" rowspan="2"><strong>Nr. Documento</strong></td>
														...
														<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">
															<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacao">
																<logic:iterate name="pagamento" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacao" id="prestacoes">
																     <% if (((GuiaPagamentoPrestacao) prestacoes).getComp_id().getNumeroPrestacao() != null && pagamento.getNumeroPrestacao() != null && ((GuiaPagamentoPrestacao) prestacoes).getComp_id().getNumeroPrestacao().intValue() == pagamento.getNumeroPrestacao().intValue() && "nao".equals(valorObtido)) { %>																     <%=	pagamento.getGuiaPagamentoGeral().getGuiaPagamento().obterValorFormatadoPrestacaoGuia(pagamento.getNumeroPrestacao().shortValue()) %>
																     <% valorObtido = "sim";
																     	} %>									    		
																</logic:iterate>																
															</logic:notEmpty>
															<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacaoHistorico">
																<logic:iterate name="pagamento" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacaoHistorico" id="prestacoesHistorico">
																    <% if (((GuiaPagamentoPrestacaoHistorico) prestacoesHistorico).getComp_id().getNumeroPrestacao() != null && pagamento.getNumeroPrestacao() != null && ((GuiaPagamentoPrestacaoHistorico) prestacoesHistorico).getComp_id().getNumeroPrestacao().intValue() == pagamento.getNumeroPrestacao().intValue() && "nao".equals(valorObtido)) { %>
												...
												<td width="15%" align="center">
													<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral">
													  <logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento">
														<a
															href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<%="" + pagamentoHistorico.getGuiaPagamentoGeral().getId() %>')">
													...
													<logic:empty name="pagamentoHistorico" property="guiaPagamentoGeral">
												  	...
												  	<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento">
														<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacao">
															<logic:iterate name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacao" id="prestacoes">
																<% if (((GuiaPagamentoPrestacao) prestacoes).getComp_id().getNumeroPrestacao() != null && pagamentoHistorico.getNumeroPrestacao() != null && ((GuiaPagamentoPrestacao) prestacoes).getComp_id().getNumeroPrestacao().intValue() == pagamentoHistorico.getNumeroPrestacao().intValue() && "nao".equals(valorObtido)) { %>
														...
														<logic:notEmpty name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacaoHistorico">
															<logic:iterate name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacaoHistorico" id="prestacoesHistorico">
																<% if (((GuiaPagamentoPrestacaoHistorico) prestacoesHistorico).getComp_id().getNumeroPrestacao() !=null && pagamentoHistorico.getNumeroPrestacao() != null && ((GuiaPagamentoPrestacaoHistorico) prestacoesHistorico).getComp_id().getNumeroPrestacao().intValue() == pagamentoHistorico.getNumeroPrestacao().intValue() && "nao".equals(valorObtido)) { %>
													...
													<tr bgcolor="#cbe5fe">
														...
														<td width="15%" align="center">
															<logic:notEmpty name="pagamento" property="guiaPagamentoGeral">
																<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">
																	<a
																		href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<%="" + pagamento.getGuiaPagamentoGeral().getId() %>')">
																		${pagamento.guiaPagamentoGeral.id}/${pagamento.numeroPrestacao}</a>&nbsp;
																</logic:notEmpty>
																<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamentoHistorico">
																		${pagamento.guiaPagamentoGeral.id}/${pagamento.numeroPrestacao}&nbsp;
																</logic:notEmpty>
														...
														<td width="15%" align="right">
															<logic:notEmpty name="pagamento" property="guiaPagamentoGeral">
																...
																<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento">
																	<logic:notEmpty name="pagamento" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacao">
																		<logic:iterate name="pagamento" property="guiaPagamentoGeral.guiaPagamento.guiasPagamentoPrestacao" id="prestacoes">
																		     <% if (((GuiaPagamentoPrestacao) prestacoes).getComp_id().getNumeroPrestacao() != null && pagamento.getNumeroPrestacao() != null && ((GuiaPagamentoPrestacao) prestacoes).getComp_id().getNumeroPrestacao().intValue() == pagamento.getNumeroPrestacao().intValue() && "nao".equals(valorObtido)) { %>
            ...
            %>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc" class="fontePequena">
								<tr bordercolor="#000000">
									...
									<td width="15%" align="center" rowspan="2"><strong>Parc.</strong>
									</td>
									<td width="32%" align="center" colspan="2"><strong>Situação</strong>
									</td>
								</tr>
                ...
                if (contador % 2 == 0) {%>
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="17%" align="center"><logic:notEmpty
												name="pagamento" property="debitoACobrar">
												<a
													href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=<bean:write name="pagamento" property="debitoACobrar.imovel.id" />&debitoID=<bean:write name="pagamento" property="debitoACobrar.id" />', 560, 660);">
                ...
                if (contador % 2 == 0) {%>
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="17%" align="center"><logic:notEmpty
												...
												<a
													href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=<bean:write name="pagamentoHistorico" property="debitoACobrar.imovel.id" />&debitoID=<bean:write name="pagamentoHistorico" property="debitoACobrar.id" />', 560, 660);">
												<font color="#ff0000">
												${pagamentoHistorico.debitoACobrar.debitoTipo.descricao} </font>
												&nbsp;</a>
											...
											<td width="16%" align="right"><bean:write name="pagamentoHistorico" property="numeroPrestacao" /></td>
                ...
                if (contador % 2 == 0) {%>
												...
												<a
													...
													<td width="16%" align="right"><bean:write name="pagamento" property="numeroPrestacao" /></td>
                ...
                if (contador % 2 == 0) {%>
												...
												<tr bgcolor="#cbe5fe">
													...
													<td width="19%" align="center"><logic:notEmpty
														name="pagamentoHistorico" property="debitoACobrar">
														<a
															href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=<bean:write name="pagamentoHistorico" property="debitoACobrar.imovel.id" />&debitoID=<bean:write name="pagamentoHistorico" property="debitoACobrar.id" />', 560, 660);">
														<font color="#ff0000">
														...
														property="debitoACobrar">${pagamentoHistorico.debitoTipo.descricao} </logic:empty></td>
													<td width="17%" align="right"><logic:notEmpty
														name="pagamentoHistorico" property="debitoACobrar">
														<logic:notEmpty name="pagamentoHistorico"
															property="debitoACobrar.valorRestanteCobrado">
															<font color="#ff0000"> <bean:write
				...
				<tr>
					<td colspan="2"><input type="button" name="ButtonCancelar" class="bottonRightCol" value="Cancelar" onClick="javascript:window.location.href='/gsan/telaPrincipal.do'">
