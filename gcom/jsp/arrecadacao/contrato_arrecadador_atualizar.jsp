...
function validarForm(form){
		if(validateAtualizarContratoArrecadadorActionForm(form) && validaTodosPeriodos(form)){
...
function recuperarDadosCincoParametros(codigoRegistro, descricaoRegistro1, descricaoRegistro2, descricaoRegistro3, tipoConsulta) {
    ...
    function validaFormaArrecadacao() {
		...
		form.action = 'exibirAtualizarContratoArrecadadorAction.do?adicionarFormaArrecadacao=1&idFormaArrecadacao='+form.idFormaArrecadacao.value+'&valorTarifa='+form.valorTarifa.value+'&percentualTarifa='+form.percentualTarifa.value+'&qtdDiasFloat='+form.qtdDiasFloat.value;
		form.submit();
	} 

    function remover(objeto){
    	if (confirm ("Confirma remoção?")) {
    		redirecionarSubmit('exibirAtualizarContratoArrecadadorAction.do?removerArrecadacaoForma=1');
    	}
    }
...
</script><html:javascript staticJavascript="false"  formName="AtualizarContratoArrecadadorActionForm" />
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para atualizar o contrato de arrecadador, informe os dados abaixo:</td>
				</tr>

				<tr>
					<td width="32%" class="style3"><strong>Arrecadador:<font color="#FF0000">*</font></strong></td>
					<td width="68%" colspan="2"><html:select property="idClienteCombo" tabindex="1" style="width:200px;" disabled="true">
						<html:option value="-1"> &nbsp; </html:option>
						<html:options collection="colecaoClienteArrecadador" property="id" labelProperty="nome" />
				  </html:select></td>
				</tr>
				
				<logic:present name="indicadorConcessionaria">
					<tr>
						<td width="32%" class="style3"><strong>Concessionária:</strong></td>
						<td width="68%" colspan="2">
							<strong><b><span class="style2"> 
						  		<html:text
									property="concessionaria.nome" size="60" tabindex="2"
									disabled="true"/></span></b>
							</strong>
					  </td>
					</tr>
				</logic:present>
				...
				<tr>
					...
					<td><strong> <html:text property="idCliente" size="10" maxlength="10" tabindex="3" onkeyup="javascript:verificaNumeroInteiro(this);"
						onkeypress="javascript:return validaEnter(event, 'exibirAtualizarContratoArrecadadorAction.do?objetoConsulta=1', 'idCliente');" />
					...
					<logic:present name="existeCliente">
						...
						<logic:notEmpty name="AtualizarContratoArrecadadorActionForm"
							property="idCliente">
				...
				<tr>
              	...
              	<tr>
					<td width="32%" class="style3"><strong>Código do Convênio - Código de Barras:<font
						color="#FF0000"></font></strong></td>
					<td width="68%" colspan="2"><strong><b><span class="style2"> 
					  <html:text
						property="idConvenio" size="15" maxlength="20" tabindex="5" />
				  </span></b></strong></td>
				</tr>
				...
				<tr>
					...
					<html:radio property="indicadorCobranca" value="1" tabindex="6" /> <strong>Cobra ISS 
					<html:radio property="indicadorCobranca" value="2" tabindex="7" />Não Cobra ISS
				...
				<tr>
					...
					<a
						href="javascript:abrirCalendario('AtualizarContratoArrecadadorActionForm', 'dtInicioContrato');">
					<img border="0"
				...
				<tr>
					...
					<td width="68%" colspan="2">
							<html:select property="idContratoMotivoCancelamento" tabindex="1" style="width:325px;" >
								<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>"> &nbsp; </html:option>
								<html:options collection="colecaoFiltroMotivoCancelamento" property="id" labelProperty="descricaoMotivoCancelContrato"/>
				  			</html:select></td>
							...
							<tr>	
								...
								<td>
									<strong>
										<b>
											<span class="style2"> 
								  				<html:text property="qtdDiasFloat" size="9" maxlength="9" tabindex="4" onkeyup="javascript:verificaNumeroInteiro(this);"/> 
							  				</span>
							  			</b>
							  		</strong>
							  	</td>
