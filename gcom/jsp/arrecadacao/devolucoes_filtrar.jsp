		...
		<tr>
			...
			<table width="100%">
				<tr>
					...
					<td><html:text property="idImovel" size="8" maxlength="8"
				...
				<tr>
					...
					<td align="right">
					  <gcom:controleAcessoBotao name="Button" value="Filtrar" onclick="javascript:validarForm(document.forms[0]);" url="filtrarDevolucaoAction.do" tabindex="16" />
