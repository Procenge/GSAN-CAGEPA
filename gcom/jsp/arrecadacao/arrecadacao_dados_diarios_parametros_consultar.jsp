...
<html:form action="/consultarDadosDiariosArrecadacaoWizardAction" 
	...
	method="post">
	<%String nuPagina = (String) session.getAttribute("nuPaginaParametro"); %>
	<jsp:include
			...
			<td valign="top" class="centercoltext">
				...
				<table width="100%" border="0">
		            ...
		            <tr> 
		                  ...
		                  <td> 
		                     <html:text name="FiltrarDadosDiariosArrecadacaoActionForm" property="setorComercialDescricaoFiltro" size="30" readonly="true" style="background-color:#EFEFEF; border:0; text-align: left;"/>
						  </td>
		            </tr>
		            <tr> 
		                  <td>
