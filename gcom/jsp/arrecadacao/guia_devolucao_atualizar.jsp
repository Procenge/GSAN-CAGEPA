...
//Recebe os dados do(s) popup(s)
   ...
   function validarForm(form) {
     ...
     if(validateAtualizarGuiaDevolucaoActionForm(form)) {
     	if (testarCampoValorZero(document.AtualizarGuiaDevolucaoActionForm.idRegistroAtendimento, 'RA - Registro de Atendimento') &&
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>RA - Registro de Atendimento:<font color="#FF0000">*</font></strong></td>
					<td colspan="2">
				...
				<tr>
					...
					<td align="right">
					  <gcom:controleAcessoBotao name="Button" value="Atualizar" onclick="javascript:validarForm(document.forms[0]);" url="atualizarGuiaDevolucaoAction.do"/>
