...
<script language="JavaScript">
   ...
   function pesquisarConta(idImovel){
	...
	function pesquisarDebitoACobrar(idImovel){
   	...
   	function verificarTipoDocumentoAssociadoAImovel(form) {
      	...
      	form.idRegistroAtendimento.focus();
   		alert('Não há Imóvel associado ao RA - Registro de Atendimento ' + form.idRegistroAtendimento.value + '. Não é possível selecionar este tipo de documento.');
   	...
   	function validarForm(form) {
    	...
    	if(validateInserirGuiaDevolucaoActionForm(form)) {
     		...
     		if (testarCampoValorZero(document.InserirGuiaDevolucaoActionForm.idRegistroAtendimento, 'RA - Registro de Atendimento') &&
	...
	function IntegerValidations () {
    	this.am = new Array("idRegistroAtendimento", "RA - Registro de Atendimento deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
				...
				<tr>
					...
					<td colspan="2">
						<div>
							...
							<a href="javascript:javascript:tipoFuncionario=1;habilitarPesquisa(document.forms[0].idFuncionarioAnalista,'exibirPesquisarFuncionarioAction.do');">
								<img width="23" 
									height="21"
									src="<bean:message key="caminho.imagens"/>pesquisa.gif"
									alt="Pesquisar" 
