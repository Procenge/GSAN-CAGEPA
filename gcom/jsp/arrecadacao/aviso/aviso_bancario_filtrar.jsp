...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		if(validateFiltrarAvisoBancarioActionForm(form)){
			...
			} else if (form.tipoServico.value != <%=ConstantesSistema.NUMERO_NAO_INFORMADO_STRING%> && form.cdConvenio.value == ""){
				alert("É necessário informar o código do convênio.");			
			}	
			else {
    			form.submit();
    		}
   ...
   function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	...
	function habDesConvenio(){
		var form = document.forms[0];
		
		if(form.tipoServico.value == "-1"){
			form.cdConvenio.value = "";
			form.cdConvenio.disabled = true;
		} else {
			form.cdConvenio.disabled = false;
		}
	}

</script>
</head>
<body leftmargin="5" topmargin="5" onload="javascript:setarFoco('${requestScope.nomeCampo}'); habDesConvenio();">
...
<table width="770" border="0" cellspacing="4" cellpadding="0">
	<tr>
		...
		<td valign="top" class="centercoltext">
			...
			<table width="100%" border="0">
				<logic:equal name="indEmpresaTrabalhaConcessionaria" value="<%="" + ConstantesSistema.SIM%>" scope="session">
					<tr>
						<td><strong>Concessionária:</strong></td>
						<td>						
								<html:select property="idConcessionaria" style="width: 230px;">
				...
				<tr>
					...
					<td width="70%"><html:text maxlength="3" property="arrecadadorCodAgente"
						size="3" tabindex="1"
						onkeypress="validaEnterComMensagem(event, 'exibirFiltrarAvisoBancarioAction.do?objetoConsulta=1', 'arrecadadorCodAgente', 'Arrecadador');" />
					<a
					...
					<img width="23" height="21" border="0"
						...
						<logic:equal name="idArrecadadorNaoEncontrado" value="exception">
							<html:text property="arrecadadorNomeCliente" size="40"
						...
						name="idArrecadadorNaoEncontrado">
						<logic:empty name="FiltrarAvisoBancarioActionForm"
							property="arrecadadorCodAgente">
							<html:text property="arrecadadorNomeCliente" value="" size="40"
								maxlength="40" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
						<logic:notEmpty name="FiltrarAvisoBancarioActionForm"
							property="arrecadadorCodAgente">
							<html:text property="arrecadadorNomeCliente" size="40"
								maxlength="40" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
						...
						href="javascript:limparArrecadador(document.FiltrarAvisoBancarioActionForm);">
					<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						border="0" title="Apagar Arrecadador" /></a></td>

				</tr>
				
				<tr>
						<td HEIGHT="30"><strong>Convênio:</strong></td>
						<td>
							<html:select property="tipoServico" style="width: 200px;" tabindex="4" onchange="habDesConvenio()">
								<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
								...
								<html:option value="<%=ConstantesSistema.COBRANCA_BANCARIA%>">COBRANÇA BANCÁRIA</html:option>
							</html:select>
							<html:text maxlength="20" property="cdConvenio"	size="20" tabindex="1" />
						</td>												
					</tr>


				<tr>
					<td width="30%"><strong>Per&iacute;odo de Lan&ccedil;amento do Aviso:</strong></td>

					<td width="70%"><strong> <INPUT TYPE="hidden" ID="DATA_ATUAL"
						value="${requestScope.dataAtual}" /><html:text property="dataLancamentoInicio" size="10"
						maxlength="10" tabindex="2"
						onkeyup="mascaraData(this, event); replicarCampo(document.forms[0].dataLancamentoFim,this);"  onfocus="replicarCampo(document.forms[0].dataLancamentoFim,this);"/>
					<a
						href="javascript:abrirCalendarioReplicando('FiltrarAvisoBancarioActionForm', 'dataLancamentoInicio', 'dataLancamentoFim');" >
					<img border="0"
					...
					a</strong> <html:text property="dataLancamentoFim" size="10"
						...
						href="javascript:abrirCalendario('FiltrarAvisoBancarioActionForm', 'dataLancamentoFim')">
					<img border="0"
						src="<bean:message key="caminho.imagens"/>calendario.gif"
						width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a>
					dd/mm/aaaa</td>
				...
				<tr>
					...
					<td width="70%"><strong> <html:text maxlength="7"
							property="periodoArrecadacaoInicio" size="7" tabindex="7"
							onkeyup="mascaraAnoMes(this, event);
							replicarCampo(document.forms[0].periodoArrecadacaoFim,this);" /> <strong> a</strong>
							<html:text maxlength="7" property="periodoArrecadacaoFim"
									size="7" tabindex="8" onkeyup="mascaraAnoMes(this, event);" /> </strong>
					mm/aaaa</td>
			   </tr>
			   <tr>
				  <td colspan="2" height="5"></td>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0">
								...
								<tr>
									...
									<td width="70%"><strong> <html:text
										property="dataPrevisaoCreditoDebitoInicio" size="10"
										maxlength="10" tabindex="9" onkeyup="mascaraData(this, event);
										replicarCampo(document.forms[0].dataPrevisaoCreditoDebitoFim,this);" onfocus="replicarCampo(document.forms[0].dataPrevisaoCreditoDebitoFim,this);" /> <a
										href="javascript:abrirCalendarioReplicando('FiltrarAvisoBancarioActionForm', 'dataPrevisaoCreditoDebitoInicio', 'dataPrevisaoCreditoDebitoFim');">
									<img border="0"
										src="<bean:message key="caminho.imagens"/>calendario.gif"
										width="20" border="0" align="absmiddle"
										alt="Exibir Calendário" /></a> a</strong> <html:text
										property="dataPrevisaoCreditoDebitoFim" size="10"
										maxlength="10" tabindex="10" onkeyup="mascaraData(this, event);" /> <a
										href="javascript:abrirCalendario('FiltrarAvisoBancarioActionForm', 'dataPrevisaoCreditoDebitoFim')">
									<img border="0"
										src="<bean:message key="caminho.imagens"/>calendario.gif"
										width="20" border="0" align="absmiddle"
					...
					<td colspan="2">
					  <table width="100%" align="center" bgcolor="#90c7fc">
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0">
								<tr>
									<td width="30%"><strong>Per&iacute;odo de Realiza&ccedil;&atilde;o do
									Cr&eacute;dito/D&eacute;bito:</strong></td>
									<td width="70%"><strong> <html:text
										property="dataRealizacaoCreditoDebitoInicio" size="10"
										maxlength="10" tabindex="13" onkeyup="mascaraData(this, event);
										replicarCampo(document.forms[0].dataRealizacaoCreditoDebitoFim,this);" onfocus="replicarCampo(document.forms[0].dataRealizacaoCreditoDebitoFim,this);" /> <a
										href="javascript:abrirCalendarioReplicando('FiltrarAvisoBancarioActionForm', 'dataRealizacaoCreditoDebitoInicio', 'dataRealizacaoCreditoDebitoFim') ;">
									<img border="0"
										src="<bean:message key="caminho.imagens"/>calendario.gif"
										width="20" border="0" align="absmiddle"
										alt="Exibir Calendário" /></a> a</strong> <html:text
										property="dataRealizacaoCreditoDebitoFim" size="10"
										maxlength="10" tabindex="14" onkeyup="mascaraData(this, event);" /> <a
										href="javascript:abrirCalendario('FiltrarAvisoBancarioActionForm', 'dataRealizacaoCreditoDebitoFim')">
									<img border="0"
										src="<bean:message key="caminho.imagens"/>calendario.gif"
										width="20" border="0" align="absmiddle"
										alt="Exibir Calendário" /></a> dd/mm/aaaa</td>
								...
								<tr>
									...
									<td width="70%">
										<html:text property="intervaloValorRealizadoInicio" size="14" maxlength="14" tabindex="15" onkeyup="formataValorMonetario(this, 14);replicarCampo(document.forms[0].intervaloValorRealizadoFim,this);" style="text-align: right;"/> 
										<strong> a</strong> 
