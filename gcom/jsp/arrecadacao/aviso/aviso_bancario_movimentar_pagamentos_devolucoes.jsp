...
function removerPagamentos(){
   ...
   if(verificarPagamentosSelecinados()){
...
function verificarDevolucoesSelecinadas(){

	var devolucoes = document.forms[0].idRegistrosRemocaoDevolucao;
	var numDevolucoes = devolucoes.length;
	var devolucoesSelelcionadas = false;
	
	if(numDevolucoes != "" && numDevolucoes >0){
		for(i=0; i<numDevolucoes; i++){
			if(devolucoes[i].checked == true){
				devolucoesSelelcionadas = true;			
			}
		}
	}else{		
		if(devolucoes.checked == false){
			devolucoesSelelcionadas = false;	
		}else{
			devolucoesSelelcionadas = true;
		}		
	}		
	return devolucoesSelelcionadas;	
}

function verificarPagamentosSelecinados(){

	var pagamentos = document.forms[0].idRegistrosRemocaoPagamento;
	var numPagamentos = pagamentos.length;
	var pagamentosSelecionados = false;
	
	if(numPagamentos != "" && numPagamentos >0){
		for(i=0; i<numPagamentos; i++){
			if(pagamentos[i].checked == true){
				pagamentosSelecionados = true;			
			}
		}
	}else{
		if(pagamentos.checked == false){
			pagamentosSelecionados = false;	
		}else{
			pagamentosSelecionados = true;
		}		
	}			
  			...
  			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<%	}	%>												
								...
								<div align="center"><logic:notEmpty name="helper" property="tipoDebito">
					...
					<table width="100%" bgcolor="#99CCFF">
					  <tr>
					   ...
					   <td width="17%" bgcolor="#90c7fc">
						  <div align="right">
						    <bean:write name="pagamentoHelper" property="valorTotal" />
						  </div>
					   </td>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
					  <tr>
					   ...
					   <td width="17%" bgcolor="#90c7fc">
						  <div align="right">
						    <bean:write name="devolucaoHelper" property="valorTotal" />
						  </div>
					   </td>
