...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}');extendeImovel();">
			...
			<td width="625" valign="top" class="centercoltext">
				...
				<table width="100%" border="0">
					...
					<tr>
						...
						<td width="432">
						    <html:text property="banco" size="4" maxlength="3" tabindex="1" onkeypress="validaEnterComMensagem(event, 'exibirFiltrarMovimentoArrecadadoresAction.do', 'banco', 'Arrecadador');" />
				...
				<tr>
					...
					<tr>
									...
									<td width="403"><html:text property="idImovel" maxlength="9"
										size="9"
										onkeypress="validaEnterComMensagem(event, 'exibirFiltrarMovimentoArrecadadoresAction.do', 'idImovel', 'Matrícula do Imóvel')" />
									<a
									...
									<logic:notPresent name="corInscricao">
										...
										<logic:empty name="FiltrarMovimentoArrecadadoresActionForm" property="idImovel">
											<html:text property="inscricaoImovel" size="30" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000"/>
										</logic:empty>
										<logic:notEmpty name="FiltrarMovimentoArrecadadoresActionForm" property="idImovel">
											<html:text property="inscricaoImovel" size="30" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
										</logic:notEmpty>
									...
									<a href="javascript:limparImovel();" tabindex="1"> 
					...
					<tr>
						...
						<td><html:text property="nsa" size="7" maxlength="6" tabindex="5" /></td>
					</tr>
										...
										<table width="100%" border="0">
											<tr>
												...
												<td>
													...
													<strong>a</strong> 
													<html:text property="dataGeracaoMovimentoFim" size="11" maxlength="10" tabindex="8" onkeyup="mascaraData(this, event);" /> 
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataGeracaoMovimentoFim')">
						...
						<td colspan="4">
							<table width="100%">
								<tr>
									...
									<td align="right">
										<gcom:controleAcessoBotao name="botaoFiltrar" value="Filtrar" onclick="javascript:validarForm(document.forms[0]);" url="filtrarMovimentoArrecadadoresAction.do" tabindex="16" /> 
