...
//	chamarPopup('exibirPesquisarImovelAction.do', 'imovel', null, null, 275, 480, '',document.forms[0].matriculaImovel);
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3"><html:text property="matriculaImovel" size="9" maxlength="9" tabindex="1"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirPesquisarItensMovimentoArrecadadorAction.do', 'matriculaImovel','Matrícula do Imovel');" />
					<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
						width="23" height="21" name="imagem"
						onclick="pesquisaImovel();"
						alt="Pesquisar"> <logic:present name="idImovelNaoEncontrado">
				...
				<tr>
					<td rowspan="2"><strong>Itens:</strong></td>
					<td width="25%">
