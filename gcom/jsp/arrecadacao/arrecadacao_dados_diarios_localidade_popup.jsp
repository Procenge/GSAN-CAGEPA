		...
		-->
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
						...
						<% if (cor.equalsIgnoreCase("#cbe5fe")) {
								...
								<%}%>
							<td height="17">
								<logic:present name="arrecadacaoDadosDiarios" property="localidade">
							      <div align="left">
							        <a href="javascript:abrirPopup('exibirConsultarDadosDiariosSetorComercialAction.do?referencia=<bean:write name="arrecadacaoDadosDiarios" property="anoMesReferenciaArrecadacao" />&idGerencia=<bean:write name="arrecadacaoDadosDiarios" property="gerenciaRegional.id" />&idEloPopup=<bean:write name="arrecadacaoDadosDiarios" property="localidade.localidade.id" />&idUnidadeNegocio=<bean:write name="arrecadacaoDadosDiarios" property="unidadeNegocio.id" />&idLocalidade=<bean:write name="arrecadacaoDadosDiarios" property="localidade.id" />&idSetorComercial=<bean:write name="arrecadacaoDadosDiarios" property="setorComercial.id" />', 475, 600);">
							        	<bean:write name="arrecadacaoDadosDiarios" property="localidade.descricao" />
							        </a>
								  </div>
								</logic:present>
							</td>
							<td>
								<logic:present name="arrecadacaoDadosDiarios" property="valorPagamentos">
							      <div align="right">
							      	<a href="javascript:abrirPopup('exibirConsultarDadosDiariosValoresDiariosAction.do?mostraUnidadeGerencia=1&referencia=<bean:write name="arrecadacaoDadosDiarios" property="anoMesReferenciaArrecadacao" />&idGerencia=<bean:write name="arrecadacaoDadosDiarios" property="gerenciaRegional.id" />&idEloPopup=<bean:write name="arrecadacaoDadosDiarios" property="localidade.localidade.id" />&idLocalidade=<bean:write name="arrecadacaoDadosDiarios" property="localidade.id" />', 475, 600);">
