...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) 
{
    ...
    if (tipoConsulta == 'setorComercial') {
        form.setorComercialCodigoFiltro.value = codigoRegistro;
...
function limparPesquisaSetorComercial() {
    ...
    form.setorComercialCodigoFiltro.value = "";
...
function controleUnidade(){
	var form = document.FiltrarDadosDiariosArrecadacaoActionForm;
	if(form.unidadeNegocioId.value > 0){
		form.localidade.disabled = true;
		form.idElo.disabled = true;
	}
	else
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td><html:select property="unidadeNegocioId" tabindex="2"
								onchange="controleUnidade(this.value);">
								<option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</option>
								<logic:notEmpty name="colecaoUnidadeNegocio">
									<logic:iterate name="colecaoUnidadeNegocio"
										id="colecaoUnidadeNegocio">
										<option
											value="<bean:write name="colecaoUnidadeNegocio" property="id"/>">
										<bean:write name="colecaoUnidadeNegocio"
											property="nomeAbreviado" /> - <bean:write
											name="colecaoUnidadeNegocio" property="nome" /></option>
									</logic:iterate>
								</logic:notEmpty>
							</html:select></td>
						</tr>
						...
						<tr>
							<td width="26%"><strong>Elo Pólo:</strong></td>
							<td width="74%"><html:text property="idElo" size="5"
								...
								onchange="controleEloLocalidade(this.value);" /> <a
						...
						<tr>
							...
							<td colspan="2" height="24"><html:text maxlength="3"
								property="setorComercialCodigoFiltro" tabindex="2" size="3"
								onkeypress="javascript:return validaEnterDependencia(event, 'exibirFiltrarDadosDiariosArrecadacaoAction.do', this, document.forms[0].localidade.value, 'Localidade');"
								onkeyup="javascript:limparDescricaoSetorComercial();" /> <a
								href="javascript:abrirPopupDependencia('exibirPesquisarSetorComercialAction.do?idLocalidade='+document.forms[0].localidade.value+'&tipo=SetorComercial&indicadorUsoTodos=1',document.forms[0].localidade.value,'Localidade', 400, 800);">
							<img width="23" height="21" border="0"
								...
								name="idSetorComercialNaoEncontrada">
								<logic:empty name="FiltrarDadosDiariosArrecadacaoActionForm"
									property="setorComercialCodigoFiltro">
									<html:text property="setorComercialDescricaoFiltro" value=""
										size="40" maxlength="30" readonly="true"
										style="background-color:#EFEFEF; border:0; color: #ff0000" />
								</logic:empty>
								<logic:notEmpty name="FiltrarDadosDiariosArrecadacaoActionForm"
									property="setorComercialCodigoFiltro">
									<html:text property="setorComercialDescricaoFiltro" size="40"
										maxlength="30" readonly="true"
										style="background-color:#EFEFEF; border:0; color: #000000" />
								...
								href="javascript:limparPesquisaSetorComercial();">
				...
				<tr>
					...
					<td align="right"><html:hidden
						name="FiltrarDadosDiariosArrecadacaoActionForm"
						property="localidadeDoElo" /> <gcom:controleAcessoBotao
