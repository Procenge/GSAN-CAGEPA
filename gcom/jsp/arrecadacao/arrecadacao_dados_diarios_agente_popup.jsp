				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
						...
						<tr bordercolor="#FFFFFF" bgcolor="#90c7fc">
							...
							<td>
								<div align="center" class="style9"><strong>Quantidade de Documentos</strong></div>
							</td>
							
							<td>
								<div align="center" class="style9"><strong>Valor Despesa Bancária</strong></div>
							</td>
						...
						<% if (cor.equalsIgnoreCase("#cbe5fe")) {
							...
							<% 
								Integer quantidadeDocumentos = ((ArrecadacaoDadosDiariosHelper)arrecadacaoDadosDiarios).getQuantidadePagamentos();
							%>								
							<td>
							<div align="center"><%= quantidadeDocumentos %></div>
							
							</td>
							<% 
								BigDecimal valorPorArrecadador =  ((ArrecadacaoDadosDiariosHelper)arrecadacaoDadosDiarios).getValorDespesaBancaria();
							%>								
							<td>
							<div align="right"><%= Util.formatarMoedaReal(valorPorArrecadador) %></div>
							</td>
