								...
								%>
															<tr bgcolor="#cbe5fe">
																...
																<td width="14.6%" align="center"><bean:write name="devolucao"
																	property="dataDevolucao" formatKey="date.format" />&nbsp;</td>
																<td width="16.9%">${devolucao.devolucaoSituacaoAnterior.descricaoAbreviada}&nbsp;</td>
														...
														<logic:iterate name="colecaoDevolucaoHistoricoClienteConta"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="14.6%" align="center"><font color="#ff0000" ><bean:write name="devolucaoHistorico"
																	property="dataDevolucao" formatKey="date.format" /></font>&nbsp;</td>
																<td width="16.9%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAnterior.descricaoAbreviada}</font>&nbsp;</td> 
														...
														<logic:iterate name="colecaoDevolucaoClienteGuiaPagamento"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="11.5%" align="center"><bean:write name="devolucao"
																	property="dataDevolucao" formatKey="date.format" />&nbsp;</td>
																<td width="17%">${devolucao.devolucaoSituacaoAnterior.descricaoAbreviada}&nbsp;</td>
																<td width="13.5%">${devolucao.devolucaoSituacaoAtual.descricaoAbreviada}&nbsp;</td>
															</tr>
														</logic:iterate>
													</logic:present>
														...
														<logic:iterate name="colecaoDevolucaoHistoricoClienteGuiaPagamento"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="11.5%" align="center"><font color="#ff0000" ><bean:write name="devolucaoHistorico"
																	property="dataDevolucao" formatKey="date.format" /></font>&nbsp;</td>
																<td width="17%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAnterior.descricaoAbreviada}</font>&nbsp;</td>
																<td width="13.5%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAtual.descricaoAbreviada}</font>&nbsp;</td>
															</tr>
														</logic:iterate>
													</logic:present>								
									...
									<logic:iterate name="colecaoDevolucaoClienteDebitoACobrar"
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="18%" align="center"><a
												href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=<bean:write name="devolucao" property="guiaDevolucao.debitoACobrar.imovel.id" />&debitoID=<bean:write name="devolucao" property="guiaDevolucao.debitoACobrar.id" />',560,660);">${devolucao.guiaDevolucao.debitoACobrar.debitoTipo.descricao}&nbsp;</a></td>
											<td width="14%" align="right">${devolucao.guiaDevolucao.debitoACobrar.valorRestanteCobrado}&nbsp;</td>
								...
								<logic:present name="colecaoDevolucaoHistoricoClienteDebitoACobrar"
									...
									<logic:iterate name="colecaoDevolucaoHistoricoClienteDebitoACobrar"
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="18%" align="center"><a
												href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=<bean:write name="devolucaoHistorico" property="guiaDevolucao.debitoACobrar.imovel.id" />&debitoID=<bean:write name="devolucaoHistorico" property="guiaDevolucao.debitoACobrar.id" />',560,660);"><font color="#ff0000" >${devolucaoHistorico.guiaDevolucao.debitoACobrar.debitoTipo.descricao}</font>&nbsp;</a></td>
											<td width="14%" align="right"><font color="#ff0000" >${devolucaoHistorico.guiaDevolucao.debitoACobrar.valorRestanteCobrado}</font>&nbsp;</td>
														...
														<logic:iterate name="colecaoDevolucaoClienteDebitoACobrar"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="12.9%" align="center"><bean:write name="devolucao"
																	property="dataDevolucao" formatKey="date.format" />&nbsp;</td>
																<td width="16.6%">${devolucao.devolucaoSituacaoAnterior.descricaoAbreviada}&nbsp;</td>
																<td width="13.5%">${devolucao.devolucaoSituacaoAtual.descricaoAbreviada}&nbsp;</td>
															</tr>
														</logic:iterate>
													</logic:present>
														...
														<logic:iterate name="colecaoDevolucaoHistoricoClienteDebitoACobrar"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="12.9%" align="center"><font color="#ff0000" ><bean:write name="devolucaoHistorico"
																	property="dataDevolucao" formatKey="date.format" /></font>&nbsp;</td>
																<td width="16.6%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAnterior.descricaoAbreviada}</font>&nbsp;</td>
																<td width="13.5%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAtual.descricaoAbreviada}</font>&nbsp;</td>
															</tr>
														</logic:iterate>
													</logic:present>
								...
								<logic:present name="colecaoDevolucaoClienteDevolucaoValor"
									...
									<logic:iterate name="colecaoDevolucaoClienteDevolucaoValor"
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="10%" align="center"><bean:write name="devolucao"
												property="dataDevolucao" formatKey="date.format" />&nbsp;</td>
											<td width="15%">${devolucao.devolucaoSituacaoAnterior.descricaoAbreviada}&nbsp;</td>
											<td width="15%">${devolucao.devolucaoSituacaoAtual.descricaoAbreviada}&nbsp;</td>
										</tr>
									</logic:iterate>
								</logic:present>
								...
								<logic:present name="colecaoDevolucaoHistoricoClienteDevolucaoValor"
									...
									<logic:iterate name="colecaoDevolucaoHistoricoClienteDevolucaoValor"
										...
										<tr bgcolor="#cbe5fe">
											...
											<td width="10%" align="center"><font color="#ff0000" ><bean:write name="devolucaoHistorico"
												property="dataDevolucao" formatKey="date.format" /></font>&nbsp;</td>
											<td width="15%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAnterior.descricaoAbreviada}</font>&nbsp;</td>
											<td width="15%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAtual.descricaoAbreviada}</font>&nbsp;</td>
										</tr>
									</logic:iterate>
								</logic:present>
														...
														<logic:iterate name="colecaoDevolucaoClienteDevolucaoValor"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="11.6%" align="center"><bean:write name="devolucao"
																	property="dataDevolucao" formatKey="date.format" />&nbsp;</td>
																<td width="15.9%">${devolucao.devolucaoSituacaoAnterior.descricaoAbreviada}&nbsp;</td>
																<td width="12.5%">${devolucao.devolucaoSituacaoAtual.descricaoAbreviada}&nbsp;</td>
															</tr>
														</logic:iterate>
													</logic:present>
														...
														<logic:iterate name="colecaoDevolucaoHistoricoClienteDevolucaoValor"
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="11.6%" align="center"><font color="#ff0000" ><bean:write name="devolucaoHistorico"
																	property="dataDevolucao" formatKey="date.format" /></font>&nbsp;</td>
																<td width="15.9%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAnterior.descricaoAbreviada}</font>&nbsp;</td>
																<td width="12.5%"><font color="#ff0000" >${devolucaoHistorico.devolucaoSituacaoAtual.descricaoAbreviada}</font>&nbsp;</td>
															</tr>
														</logic:iterate>
													</logic:present>
