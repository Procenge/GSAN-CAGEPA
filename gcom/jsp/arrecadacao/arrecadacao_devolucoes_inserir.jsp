...
function limparForm(tipo){alert(tipo);
    var form = document.InserirDevolucoesActionForm;
			...
			<table border="0" width="100%">
				<tr>
					...
					<td colspan="2" align="right">
					 <gcom:controleAcessoBotao name="Button" value="Inserir" onclick="javascript:validarForm(document.forms[0]);" url="inserirDevolucoesAction.do"/>
