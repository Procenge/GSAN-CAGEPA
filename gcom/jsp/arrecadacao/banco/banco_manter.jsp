...
<html:form action="/removerBancoAction"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Banco</td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Bancos cadastrados:</strong></font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#99CCFF">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="pg" />
									<pg:param name="q" />
									<logic:present name="colecaoBanco">
										<%int cont = 0;%>
										<logic:iterate name="colecaoBanco" id="banco"
											scope="request">
											<pg:item>
												<%cont = cont + 1;
			if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<div align="center"><input type="checkbox"
														name="idRegistrosRemocao" value="<bean:write name="banco" property="id"/>"></div>
													</td>
													
													<td width="10%" align="center"><bean:write name="banco" property="id"/></td>

													<td width="7%" align="center">
													<html:link
														page="/exibirAtualizarBancoAction.do"
														paramName="banco" paramProperty="id"
														paramId="idBanco"><bean:write name="banco" property="descricao"/>
													</html:link></td>
													
													<td width="27%">
													<div align="center"><bean:write name="banco" property="descricaoAbreviada"/></div>
													</td>


													<html:link
														href="/gsan/exibirManterBancoAction.do"
														paramId="banco" paramProperty="id" paramName="banco">
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="233"><font color="#FF0000"> <html:submit
								...
								onClick="javascript:window.location.href='/gsan/exibirFiltrarBancoAction.do?paginacao=sim'">
						</tr>
					</table>
					</td>
				</tr>
