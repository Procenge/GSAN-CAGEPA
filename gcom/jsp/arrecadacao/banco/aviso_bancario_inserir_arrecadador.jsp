					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td><html:text tabindex="1" property="codigoArrecadador"	size="3" maxlength="3"
									onkeypress="validaEnterComMensagem(event, 'exibirInserirAvisoBancarioWizardAction.do?action=exibirProcessoUmInserirAvisoBancarioAction' ,'codigoArrecadador','Arrecadador');" />
								<logic:present  name="montarPopUp">
									<a href="javascript:redirecionarSubmit('exibirPesquisarArrecadadorAction.do?caminhoRetornoTelaPesquisaArrecadador=exibirInserirAvisoBancarioAction&montarPopup=true');">
								</logic:present>
								<logic:notPresent name="montarPopUp">
...
<!-- aviso_bancario_inserir_arrecadador.jsp -->
</html:form>
</html:html>
