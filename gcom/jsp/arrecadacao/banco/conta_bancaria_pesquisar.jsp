...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(490, 280);setarFoco('numeroConta');">
				...
				<tr>
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td width="78%" colspan="3"><html:select property="idBanco"
								size="1" style="width:300" onchange="selecionarAgencias();">
								<html:option value="-1">&nbsp;</html:option>
								<html:options collection="collectionBanco"
