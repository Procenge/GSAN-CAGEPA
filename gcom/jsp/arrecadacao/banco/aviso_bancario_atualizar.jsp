...
<logic:iterate name="avisoDeducoes" id="aDeducoes" indexId="i">
		...
		alert('Informe Valor da Dedução <bean:write name="aDeducoes" property="deducaoTipo.descricaoAbreviada" />.');
		return;
	}
</logic:iterate>
</logic:present>
...
<html:form action="/AtualizarAvisoBancarioAction" method="post"
	...
	<html:hidden property="tipoAviso"/>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3" class="style1"><html:text size="9" maxlength="9"
							name="AvisoBancarioActionForm" property="numeroDocumento" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="style1"><strong>Arrecadação:</strong></td>
						<td class="style1">
						</td>
					</tr>
					...
					<tr>
						...
						<td class="style1">
							<strong>VL Informado:</strong>
							<html:text size="14" maxlength="14" name="AvisoBancarioActionForm" property="valorArrecadacao" onkeyup="formataValorMonetario(this, 14);controleBotaoDeducao(document.forms[0]);" style="text-align:right;"></html:text>
						</td>
						<logic:equal name="AvisoBancarioActionForm" property="tipoAviso" value="1">
							<td class="style1">
								<strong>VL Acertos:</strong>
								<html:text property="valorAcertosArrecadacao" disabled="true" style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Calculado:</strong>
								<html:text property="valorCalculadoArrecadacao" disabled="true" style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Diferença:</strong>
								<html:text property="valorDiferencaArrecadacao" disabled="true" style="text-align:right;"></html:text>
							</td>
						</logic:equal>
						<logic:equal name="AvisoBancarioActionForm" property="tipoAviso" value="2">
							<td class="style1">
								<strong>VL Acertos:</strong>
								<html:text property="valorAcertosArrecadacao" disabled="true" value="0,00" style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Calculado:</strong>
								<html:text property="valorCalculadoArrecadacao" disabled="true" value="0,00"  style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Diferença:</strong>
								<html:text property="valorDiferencaArrecadacao" disabled="true" value="0,00"  style="text-align:right;"></html:text>
							</td>
						</logic:equal>
					</tr>
					<tr>
						...
						<td colspan="3" align="left">
							<html:text property="situacaoAvisoCredito" size="11" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
						</td>
				  	</tr>
					...
					<tr>
						<td class="style1"><strong>Devolução:</strong></td>
						<td>
						</td>
					</tr>
					...
					<tr>
							...
							<strong>VL Informado:</strong>
								<html:text size="14"
									maxlength="14" name="AvisoBancarioActionForm" property="valorDevolucao" onkeyup="formataValorMonetario(this, 14)" style="text-align:right;">
								</html:text>
							</td>
						...
						<logic:equal name="AvisoBancarioActionForm" property="tipoAviso" value="2">
							...
							<td class="style1">
								<strong>VL Acertos:</strong>
								<html:text property="valorAcertosDevolucao" disabled="true" style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Calculado:</strong>
								<html:text property="valorCalculadoDevolucao" disabled="true" style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Diferença:</strong>
								<html:text property="valorDiferencaDevolucao" disabled="true" style="text-align:right;"></html:text>
							</td>
						</logic:equal>
						<logic:equal name="AvisoBancarioActionForm" property="tipoAviso" value="1">
							<td class="style1">
								<strong>VL Acertos:</strong>
								<html:text property="valorAcertosDevolucao" disabled="true" value="0,00" style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Calculado:</strong>
								<html:text property="valorCalculadoDevolucao" disabled="true" value="0,00"  style="text-align:right;"></html:text>
							</td>
							<td class="style1">
								<strong>VL Diferença:</strong>
								<html:text property="valorDiferencaDevolucao" disabled="true" value="0,00"  style="text-align:right;"></html:text>
							</td>
						</logic:equal>
					</tr>
				  	<tr>
						<td ><strong>Situação:</strong></td>
						<td colspan="3" align="left">
							<html:text property="situacaoAvisoDebito" size="11" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
						</td>
				  	</tr>
				...
				<table border="0" width="100%">
					<tr>
						...
						<td align="right" width="313">
						  <gcom:controleAcessoBotao name="Atualizar" value="Atualizar" onclick="javascript:atualizar(document.forms[0]);" url="atualizarAvisoBancarioAction.do"/>
