			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<logic:present name="acao" scope="session">
						<td class="parabg">Efetuar Análise dos Aviso Bancário</td>
					</logic:present>
				...
				<pg:pager isOffset="true" index="half-full" maxIndexPages="10" export="currentPageNumber=pageNumber;pageOffset" maxPageItems="10" items="${sessionScope.totalRegistros}">
					...
					<tr bordercolor="#000000">
						...
						<div align="center"><strong>Situação</strong></div>
						 ...
						 <logic:present name="acao"> 
						<td rowspan="2" bgcolor="#90c7fc" width="5%">
						<div align="center"><strong>Nº NSA</strong></div>
						</td>
						<td rowspan="2" bgcolor="#90c7fc" width="10%">
						<div align="center"><strong>Nº Aviso Bancário</strong></div>
						</td>							
						 </logic:present> 					
					</tr>
					<tr bordercolor="#99ccff">
						<td bgcolor="#cbe5fe" width="10%">
	...
	%>
					...
					DÉBITO
							...
							.formatarMoedaReal(((gcom.arrecadacao.aviso.bean.AvisoBancarioHelper) avisoBancario)
									...
									<div align="left"><bean:write name="avisoBancario"
										property="situacao" />&nbsp;</div>
									</td>						
									
								    <logic:present name="acao"> 
									<td>
									<div align="center">													
										<bean:write name="avisoBancario" property="avisoBancario.arrecadadorMovimento.numeroSequencialArquivo" />&nbsp;								
									</div>
									</td>
									<td>
									<div align="center">									
										<bean:write name="avisoBancario" property="avisoBancario.numeroDocumento" />&nbsp;								
									</div>
									</td>
								   </logic:present> 
			...
			<table width="100%">
				<tr>
					<td valign="top">
						<logic:notPresent name="acao" scope="session">
						  <gcom:controleAcessoBotao name="button" value="Remover" onclick="javascript:abrirRemover();" url="ExcluirAvisoBancarioAction.do" align="left"/>
