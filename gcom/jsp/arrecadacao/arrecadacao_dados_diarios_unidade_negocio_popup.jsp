				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
						...
						<tr bordercolor="#FFFFFF" bgcolor="#90c7fc">
							<td width="60%">
							<div align="center" class="style9"><strong>Unidade Negócio</strong></div>
							</td>
							<td width="30%">
						...
						<% if (cor.equalsIgnoreCase("#cbe5fe")) {
							...
							<td height="17">
							      <div align="left">
							      <a href="javascript:abrirPopup('exibirConsultarDadosDiariosEloAction.do?referencia=<%=((ArrecadacaoDadosDiarios)arrecadacaoDadosDiarios).getAnoMesReferenciaArrecadacao()%>&idUnidadeNegocio=<%=((ArrecadacaoDadosDiarios)arrecadacaoDadosDiarios).getUnidadeNegocio().getId()%>&idGerencia=<%=((ArrecadacaoDadosDiarios)arrecadacaoDadosDiarios).getGerenciaRegional().getId()%>', 475, 600);">
							      	<%=((ArrecadacaoDadosDiarios)arrecadacaoDadosDiarios).getUnidadeNegocio().getNome()%>  
							      </a>
							...
							<td>
								<logic:present name="arrecadacaoDadosDiarios" property="valorPagamentos">
							      <div align="right">
								      <a href="javascript:abrirPopup('exibirConsultarDadosDiariosValoresDiariosAction.do?referencia=<%=((ArrecadacaoDadosDiarios)arrecadacaoDadosDiarios).getAnoMesReferenciaArrecadacao()%>&idUnidadeNegocio=<%=((ArrecadacaoDadosDiarios)arrecadacaoDadosDiarios).getUnidadeNegocio().getId()%>', 475, 600);">
								      <%=Util.formatarMoedaReal(((ArrecadacaoDadosDiarios)arrecadacaoDadosDiarios).getValorPagamentos())%>
								      </a>
