...
<body leftmargin="5" topmargin="5" 
		onload="javascript:resizePageSemLink(810, 320);setarFoco('${requestScope.nomeCampo}');">
...
<html:form action="/pesquisarArrecadadorAction" method="post"
	...
	<logic:present name="montarPopup">
		<input type="hidden" name="montarPopup" value="<bean:write name='montarPopup'/>"/>
	</logic:present>
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td>
						<strong>Caixa de Empresa:</strong>
					</td>
					<td>
						<span class="style2">
							<html:radio property="indicadorCaixaEmpresa" value="<%= ""+ConstantesSistema.SIM %>"/><strong>Sim</strong>
							<html:radio property="indicadorCaixaEmpresa" value="<%= ""+ConstantesSistema.NAO %>"/><strong>Não</strong>
							<html:radio	property="indicadorCaixaEmpresa" value=""/><strong>Todos</strong>
						</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
			          	<input type="button" class="bottonRightCol" value="Limpar" onclick="document.forms[0].reset();limparForm();"/>
							&nbsp;&nbsp;			          			
			          	<input type="button" name="Button" class="bottonRightCol"tabindex="5" value="Pesquisar"	onClick="javascript:validarForm(document.forms[0])" />
<%-- 			         <input type="button" class="bottonRightCol" value="Voltar" onclick="redirecionarSubmit('${caminhoRetornoTelaPesquisaArrecadador}.do?montarPopup=<bean:write name="montarPopup"/>')"/> --%>
			         </td>
			      </tr>
