				...
				cor = "#cbe5fe";%>
										<tr bgcolor="#cbe5fe">
											...
											<td width="10%" align="left"><logic:notEmpty name="devolucao"
												...
												<bean:write name="devolucao"
													property="devolucaoSituacaoAtual.descricaoAbreviada" />
											</logic:notEmpty></td>
										</tr>
									</pg:item>
								</logic:iterate>
							...
							<table width="100%" border="0">
								<tr>
									<td valign="top">
									  ...
									  <gcom:controleAcessoBotao name="Remover" value="Remover" onclick="javascript:verficarSelecao(idRegistrosRemocao, 'checkbox');" url="removerDevolucaoAction.do"/>
