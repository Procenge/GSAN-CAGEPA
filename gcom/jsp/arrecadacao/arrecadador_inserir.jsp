			...
			<table width="100%" border="0">
				...
				<tr>
				  ...
				  <html:text property="idAgente" size="4"
						maxlength="3" onkeyup="javascript:verificaNumeroInteiro(this);" /> </strong></td>
				</tr>
				<tr>
					<td><strong>Cliente:<font color="#FF0000">*</font></strong></td>
					<td><strong> <html:text property="idCliente" size="10"	maxlength="10" onkeyup="javascript:verificaNumeroInteiro(this);" 
				...
				<tr>
					...
					<td><strong><html:text property="idImovel" size="10" maxlength="10" onkeyup="javascript:verificaNumeroInteiro(this);"
				...
				<tr>
					...
					<td><strong> <html:text property="inscricaoEstadual" size="20"
						maxlength="20" onkeyup="javascript:verificaNumeroInteiro(this);"/> </strong></td>
				</tr>
