...
<logic:equal name="testeInserir" value="false" scope="request">
	<body leftmargin="5" topmargin="5" onload="resizePageSemLink(640,600);">
</logic:equal>
				...
				cor = "#FFFFFF";%>
								<tr bgcolor="#FFFFFF">
									...
									<div align="center"><bean:write name="movimento"
										property="arrecadadorMovimento.codigoBanco" /></div>
									</td>
									...
									<td>
										<div>
												...
												<logic:notEmpty	name="caminhoRetornoTelaPesquisaMovimentoArrecadador">
													<a
														href="javascript:enviarDadosSeisParametrosCaminhoRetorno('<bean:write name="caminhoRetornoTelaPesquisaMovimentoArrecadador"/>', '<bean:write name="movimento" property="arrecadadorMovimento.id"/>', '<bean:write name="movimento" property="arrecadadorMovimento.codigoBanco"/>', '<bean:write name="movimento" property="arrecadadorMovimento.codigoRemessa"/>', '<bean:write name="movimento" property="arrecadadorMovimento..descricaoIdentificacaoServico"/>', '<bean:write name="movimento" property="arrecadadorMovimento.numeroSequencialArquivo"/>' ,'movimentoArrecadador');">
													<bean:write name="movimento" property="arrecadadorMovimento.nomeBanco" /></a>
												</logic:notEmpty>
												
												<logic:empty name="caminhoRetornoTelaPesquisaMovimentoArrecadador">
													<a
													href="javascript:enviarDadosSeisParametros('<bean:write name="movimento" property="arrecadadorMovimento.id"/>', '<bean:write name="movimento" property="arrecadadorMovimento.codigoBanco"/>', '<bean:write name="movimento" property="arrecadadorMovimento.codigoRemessa"/>', '<bean:write name="movimento" property="arrecadadorMovimento.descricaoIdentificacaoServico"/>', '<bean:write name="movimento" property="arrecadadorMovimento.numeroSequencialArquivo"/>', 'movimentoArrecadador');">
													<bean:write name="movimento" property="arrecadadorMovimento.nomeBanco" /> </a>
												</logic:empty> 
									...
									<div><logic:equal name="movimento"
										property="arrecadadorMovimento.codigoRemessa" value="1">
											ENVIO
										</logic:equal> <logic:equal name="movimento"
										property="arrecadadorMovimento.codigoRemessa" value="2">
											RETORNO
										</logic:equal></div>
									</td>
									<td>
									<div align="center"><bean:write name="movimento"
										property="arrecadadorMovimento.numeroSequencialArquivo" /></div>
									</td>
									<td>
									<div><bean:write name="movimento"
										property="arrecadadorMovimento.descricaoIdentificacaoServico" /></div>
									</td>

									<td>
									<div align="center"><bean:write name="movimento"
										format="dd/MM/yyyy" property="arrecadadorMovimento.dataGeracao" /></div>
									</td>
								</tr>
							</pg:item>
						</logic:iterate>
