	...
	function verificaNumero(valor){
		if(!valor.value == ""){
			if (!validaCampoInteiroPositivo(valor.value)){									
				alert("inscrição estadual deve conter apenas números");
				verificaNumeroInteiro(valor);
				}
			}
		}
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><strong> <html:text property="inscricaoEstadual" size="20"
						maxlength="20" onblur="javascript:verificaNumero(this);"/>
					</strong></td>
				</tr>
				...
				<tr>
					...
					<td>
						<span class="style2">
							...
							<html:radio property="indicadorCaixaEmpresa" value="<%= ""+ConstantesSistema.ZERO %>"/><strong>Todos</strong>
						</span>
					</td>
				</tr>
				...
				<tr>
					...
					<td><html:radio property="indicadorUso" tabindex="2" value="<%= ""+ConstantesSistema.SIM.toString() %>"/><strong>Ativo</strong>
						<html:radio	property="indicadorUso" tabindex="3" value="<%= ""+ConstantesSistema.NAO.toString() %>"/><strong>Inativo</strong>
