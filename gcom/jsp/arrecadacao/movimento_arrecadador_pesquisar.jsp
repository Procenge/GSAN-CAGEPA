...
<script language="JavaScript">
	...
	function limparForm(){
		...
		if (form.identificadorServicoSelecionado.value == '') {
			form.identificacaoServico[3].checked = true;
		}
	}
	...
	function atualizarRadios() {
		...
		if (form.identificadorServicoSelecionado.value == '<%=ConstantesSistema.COBRANCA_BANCARIA%>') {
			form.identificacaoServico[1].disabled = true;	
			form.identificacaoServico[2].disabled = true;
			form.identificacaoServico[3].disabled = true;
		} else if (form.identificadorServicoSelecionado.value == '<%=ConstantesSistema.CODIGO_DE_BARRAS%>') {
			form.identificacaoServico[0].disabled = true;	
			form.identificacaoServico[2].disabled = true;
			form.identificacaoServico[3].disabled = true;
		} else if (form.identificadorServicoSelecionado.value == '<%=ConstantesSistema.DEBITO_AUTOMATICO%>') {
			form.identificacaoServico[0].disabled = true;	
			form.identificacaoServico[1].disabled = true;
			form.identificacaoServico[3].disabled = true;
		} 
...
<body onload="atualizarRadios();resizePageSemLink(665, 440);javascript:setarFoco('${requestScope.nomeCampo}');">
<html:form action="/pesquisarMovimentoArrecadadorAction"
	...
	<html:hidden property="identificadorServicoSelecionado"/>	
...
<html:text property="arrecadadorNome" size="40"
				...
				<tr>
					...
					<td colspan="3"><strong>
						<html:radio property="identificacaoServico" value="<%=ConstantesSistema.COBRANCA_BANCARIA%>"  /> Cobrança Bancária 
						<html:radio property="identificacaoServico" value="<%=ConstantesSistema.CODIGO_DE_BARRAS%>" /> Código de Barras 
						<br/>
						<html:radio property="identificacaoServico" value="<%=ConstantesSistema.DEBITO_AUTOMATICO%>" /> Débito Automático
						<html:radio property="identificacaoServico" value="" /> Todos
					</strong></td>
				</tr>
				<tr>
