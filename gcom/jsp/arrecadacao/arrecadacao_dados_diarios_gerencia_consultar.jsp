...
<html:form action="/consultarDadosDiariosArrecadacaoWizardAction" 
	...
	method="post">
	<%String nuPagina = (String) session.getAttribute("nuPaginaGerencia"); %>
	<jsp:include
                ...
                <table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
	                ...
	                Map<Integer,Map<BigDecimal,Collection>> map = 
	                	(Map<Integer,Map<BigDecimal,Collection>>)
			                	session.getAttribute("dadosArrecadacaoUnidadeNegocio");
	                
	                BigDecimal valorTotal = (BigDecimal)session.getAttribute("valordadosArrecadacaoUnidadeNegocio");
							...
							while(iteratorColecaoArrecadacaoDadosDiarios.hasNext()){
								...
								if (arrecadacaoDadosDiarios.getGerenciaRegional() != null )
								{
				        	        ...
				        	        <tr bordercolor="#FFFFFF" bgcolor="#90c7fc""> 
					                	<td  width="38%"> <div align="center" class="style9"><strong>Ger&ecirc;ncia</strong></div></td>
									...
									<tr bgcolor="#cbe5fe">
									<%}%>
					                  <td height="17"><a href="javascript:abrirPopup('exibirConsultarDadosDiariosUnidadeNegocioAction.do?referencia=<%=arrecadacaoDadosDiarios.getAnoMesReferenciaArrecadacao()%>&idGerencia=<%=arrecadacaoDadosDiarios.getGerenciaRegional().getId()%>', 475, 600);"><%=arrecadacaoDadosDiarios.getGerenciaRegional().getNomeAbreviado()%> &nbsp; - &nbsp; <%=arrecadacaoDadosDiarios.getGerenciaRegional().getNome()%> </a></td>
