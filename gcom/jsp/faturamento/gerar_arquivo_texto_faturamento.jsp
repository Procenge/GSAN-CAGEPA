...
<script language="JavaScript">
    ...
    function validarForm(){
       var form = document.GerarArquivoTextoFaturamentoActionForm;
       var retorno = validateGerarArquivoTextoFaturamentoActionForm(form);
       if (retorno == true){
	  ...
	  <table width="100%" border="0">
        ...
        <tr>
          ...
          <td align="right"><gcom:controleAcessoBotao name="Button"
						...
						url="GerarArquivoTextoFaturamentoAction.do" />
		  </td>
    <%--  <td align="right">
            <input type="button" name="Button" class="bottonRightCol" value="Gerar" onClick="javascript:validarForm();"/>
          </td>  --%>
        </tr>
      </table>
      <p>&nbsp;</p>
