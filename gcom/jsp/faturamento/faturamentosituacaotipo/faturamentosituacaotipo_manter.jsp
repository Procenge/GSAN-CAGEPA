...
<html:form action="/removerFaturamentoSituacaoTipoAction"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Tipo de Situação do Faturamento</td>
				...
				<tr>
					<td colspan="7" height="23">
						<font style="font-size: 10px;" color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
							<strong>Faturamento Situação Tipo:</strong> 
						</font>
					</td>
				</tr>
				<tr>
										...
										<pg:item>
											...
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="faturamentoSituacaoTipo" property="id"/>"></div>
												</td>
												
												<td width="45%"
												 align="center"><html:link
													href="/gsan/exibirAtualizarFaturamentoSituacaoTipoAction.do"
													paramId="idFaturamentoSituacaoTipo" paramProperty="id"
													paramName="faturamentoSituacaoTipo"
													title="<%="" + faturamentoSituacaoTipo.getId()%>">
												...
												<td width="30%">
												<div align="center">
												<logic:equal value="1" name="faturamentoSituacaoTipo" property="indicadorUso">
													Ativo
												</logic:equal>
												<logic:notEqual value="1" name="faturamentoSituacaoTipo" property="indicadorUso">
													Inativo
												</logic:notEqual>
