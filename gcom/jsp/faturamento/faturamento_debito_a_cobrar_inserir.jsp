...
///    this.am = new Array("codigoImovel", "Matrícula do Imóvel deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    ...
    this.an = new Array("registroAtendimento", "RA - Registro de Atendimento deve somente conter números positivos.", new Function ("varName", " return this[varName];"));        
...
function validarForm(form, inserir){
		...
		if(form.idImovel != null){
		  if(form.ordemServico.value == "" && form.registroAtendimento.value == '' && form.idImovel.value == ""){
			  alert("Informe RA - Registro de Atendimento, Ordem de Serviço ou Imóvel");
			  form.registroAtendimento.focus();
			  condicao = false;
		  }
		}else{
		  if(form.ordemServico.value == "" && form.registroAtendimento.value == ''){
			  alert("Informe RA - Registro de Atendimento ou Ordem de Serviço");
			  form.registroAtendimento.focus();
			  condicao = false;
		  }
		}
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Prazo de Suspensão de Lançamento:<strong></strong></strong></td>
					<td colspan="3" align="right">
