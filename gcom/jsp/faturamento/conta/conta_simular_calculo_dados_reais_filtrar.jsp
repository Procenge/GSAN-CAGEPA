	    ...
	    <td width="149" valign="top" class="leftcoltext">
	      <div align="center">
			...
			<table width="100%" border="0">
				...
				<tr>
	                <td>
	                	<strong>Per&iacute;odo de Referência do Faturamento:<font color="#FF0000">*</font></strong>
	                </td>
				...
				<tr>
					...
					<td>
	  					...
	  					<html:text maxlength="9" 
							...
							onkeypress="validaEnterComMensagem(event, 'exibirSimularCalculoContaDadosReaisFiltrarAction.do?objetoConsulta=1','idImovel','Imóvel');"
							/>	
