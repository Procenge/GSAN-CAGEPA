	...
	<td width="750" valign="top" class="centercoltext">
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr bordercolor="#000000">
		  ...
		  <td width="10%" align="center" bgcolor="#90c7fc"><strong>Valor da Conta</strong></td>
		  <td width="10%" align="center" bgcolor="#90c7fc"><strong>Consumo de Água</strong></td>
		  <td width="10%" align="center" bgcolor="#90c7fc"><strong>Esgoto Coletado</strong></td>
		  <td width="10%" align="center" bgcolor="#90c7fc"><strong>Crédito de Consumo</strong></td>
					...
					<logic:iterate name="colecaoContasImovel" id="conta" type="Conta">
					  <pg:item>
						...
						<%}%>
						  ...
						  <td width="10%">
							<div align="center">
							  <logic:present name="conta" property="creditoConsumo">
                				<bean:write name="conta" property="creditoConsumo" />
			  				  </logic:present>
			  				  <logic:notPresent name="conta" property="creditoConsumo">
								&nbsp;
			  				  </logic:notPresent>								
							</div>
						  </td>
