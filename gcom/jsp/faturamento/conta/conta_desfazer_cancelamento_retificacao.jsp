	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2" height="10"><strong>Matrícula do Imóvel:</strong><font
						color="#FF0000">*</font></td>
					<td width="67%" colspan="2" align="left"><html:text property="idImovel"
						maxlength="9" size="9"
					...
					<logic:present name="corImovel">
						...
						<logic:empty name="DesfazerCancelamentoRetificacaoContaActionForm"
							property="idImovel">
							<html:text property="inscricaoImovel" size="25" value=""
								readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:empty>
						<logic:notEmpty
							name="DesfazerCancelamentoRetificacaoContaActionForm"
							property="idImovel">
							<html:text property="inscricaoImovel" size="25" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:notEmpty>
								...
								<logic:iterate name="contas" id="conta">
									<%
										...
										<div align="center"><logic:notEmpty name="conta"
											property="anoMesReferenciaConta">
											<a
										...
										<logic:iterate name="contas" id="conta">
											<%
												...
												<div align="center"><logic:notEmpty name="conta"
													property="anoMesReferenciaConta">
													<a
														href="javascript:abrirPopup('exibirConsultarContaAction.do?contaID=<bean:write name="conta" property="id" />&tipoConsulta=contaHistorico', 600, 800);">
