...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="AdicionarDebitoCobradoContaActionForm"/>
...
<logic:present name="reloadPage">
	...
	<logic:equal name="reloadPageURL" value="INSERIRCONTA">
		<body leftmargin="5" topmargin="5" onload="window.focus(); resizePageSemLink(480, 280); chamarSubmitComUrl('exibirInserirContaAction.do?reloadPage=1'); self.close();">
	</logic:equal>
	
	<logic:notEqual name="reloadPageURL" value="INSERIRCONTA">
		<body leftmargin="5" topmargin="5" onload="window.focus(); resizePageSemLink(480, 280); chamarSubmitComUrl('exibirRetificarContaAction.do?reloadPage=1'); self.close();">
	</logic:notEqual>
  ...
  <tr>
    <td width="442" valign="top" class="centercoltext"> 
      ...
      <table width="100%" border="0">
        <tr>
          <td colspan="4">Preencha os campos abaixo para inserir um débito na conta:</td>
          <td align="right"></td>
        </tr>
        </table>
      <table width="100%" border="0">
        <tr>
          <td width="100" height="20"><strong>Tipo de Débito:<font color="#FF0000">*</font></strong></td>
          <td colspan="3">
          
          	<html:select property="debitoTipoID">
          		<html:option value="<%= ""+ConstantesSistema.NUMERO_NAO_INFORMADO %>">&nbsp;</html:option>
				<logic:present name="colecaoAdicionarDebitoTipo">
					<html:options collection="colecaoAdicionarDebitoTipo" labelProperty="descricao" property="id"/>
				</logic:present>
			</html:select>
        ...
        <tr>
          ...
          <td colspan="3"><html:text property="mesAnoDebito" size="8" maxlength="7" tabindex="2" onkeyup="mascaraAnoMes(this, event);"/>
          &nbsp;mm/aaaa
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3"><html:text property="valorDebito" size="15" tabindex="4" style="text-align: right;" onkeyup="formataValorMonetario(this, 11)"/>
          </td>
        </tr>
        <tr>
