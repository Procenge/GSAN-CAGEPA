 ...
 function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
  ...
  function validarForm(form){
	...
	if (form.idMotivoRetificacao.value == -1){
		...
		form.action = "/gsan/retirarDebitoCobradoConjuntoContaAction.do";
		form.submit();
		window.opener.location.href='exibirManterContaConjuntoImovelAction.do';
	    window.close();	
	}
  ...
  function remover(objetoRemocao){
		redirecionarSubmit("exibirRetirarDebitoCobradoConjuntoContaAction.do?removerTipoDebito=" + objetoRemocao);
}	  
			...
			<table width="100%" border="0" align="center">
				...
				<tr>
					...
					<td colspan="3"><html:text property="idTipoDebito" maxlength="4"
						size="4"
						onkeypress="validaEnterComMensagem(event, 'exibirRetirarDebitoCobradoConjuntoContaAction.do','idTipoDebito','Tipo de Débito');"
						onkeyup="" /> <a
					...
					<tr>
						...
						%>
											<td width="10%" align="center">
												<a href="javascript:if(confirm('Confirma remoção?')){remover(<%="" + debitoTipo.getClass().getMethod("getId", (Class[]) null).invoke(debitoTipo, (Object[]) null) %>);}" alt="Remover"><img src="<bean:message key='caminho.imagens'/>Error.gif" width="14" height="14" border="0"></a>
											</td>
