...
function bloquearLSQLS(){
	...
	if(form.codigoCliente.value != "" ){
		...
		form.tipoRelacao.readOnly = false;
...
<body leftmargin="5" topmargin="5" onload="bloquearLSQLS();bloquearLocalidadeDestino();verificarBotao();">
<html:form action="/filtrarImovelInserirManterContaAction"
	...
	focus="codigoCliente" enctype="multipart/form-data">
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="3"><html:text property="codigoCliente" maxlength="9"
						size="9" tabindex="1" onkeypress="validaEnterComMensagem(event, 'exibirFiltrarImovelInserirManterContaAction.do','codigoCliente','Cliente');"
					...
					</logic:notPresent> <a href="javascript:limparPesquisaCliente('cliente');"> <img
						border="0"
				...
				<tr>
					...
					<div align="left"><strong> <html:select property="tipoRelacao" tabindex="2">
						<html:option
				...
				<tr>
					...
					<td colspan="3"><html:text maxlength="3" property="localidadeOrigemID" size="3"
						onkeypress="limpar(7);validaEnterComMensagem(event, 'exibirFiltrarImovelInserirManterContaAction.do?objetoConsulta=1&inscricaoTipo=origem','localidadeOrigemID','Código da localidade de origem');"
						onkeyup="bloquearLocalidadeDestino();replicaDados(document.forms[0].localidadeOrigemID, document.forms[0].localidadeDestinoID);verificarBotao();"
						tabindex="4" /> <a
						href="javascript:chamarPopup('exibirPesquisarLocalidadeAction.do?indicadorUsoTodos=1', 'origem', null, null, 275, 480, '');"><img
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0"
						width="23" height="21" title="Pesquisar"></a> <logic:present
					...
					</logic:notPresent> <a href="javascript:limparLocalidade(1);verificarBotao();"> <img
						src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						border="0" title="Apagar" /> </a></td>
				</tr>
				<tr>
					<td><strong>Setor Comercial :</strong></td>
					<td colspan="3"><html:text maxlength="3" property="setorComercialOrigemCD"
						size="3"
						onkeypress="limpar(8); validaEnterDependenciaComMensagem(event, 'exibirFiltrarImovelInserirManterContaAction.do?objetoConsulta=2&inscricaoTipo=origem', document.forms[0].setorComercialOrigemCD, document.forms[0].localidadeOrigemID.value, 'localidade da inscrição inicial', 'Setor comercial inicial');"
						onkeyup="replicaDados(document.forms[0].setorComercialOrigemCD, document.forms[0].setorComercialDestinoCD);verificarBotao();"
						tabindex="4" /> <a
						href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do', 'setorComercialOrigem', 'idLocalidade', document.FiltrarImovelContaActionForm.localidadeOrigemID.value, 275, 480, 'Informe a Localidade da inscrição inicial');"><img
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0"
						width="23" height="21" title="Pesquisar"></a> <logic:present
					...
					</logic:notPresent> <a href="javascript:limpar(2);verificarBotao();"> <img
						src="<bean:message key="caminho.imagens"/>limparcampo.gif"
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="5" property="quadraOrigemNM" size="4"
						tabindex="5" onkeypress="limpar(12);"
					...
					<td align="right" class="style1"><input name="quadra"
						class="bottonRightCol" value="Quadra" type="button"
				...
				<tr>
					...
					<td colspan="3"><html:text maxlength="4" property="loteOrigem" size="4"
						tabindex="6"
						onkeyup="replicaDados(document.forms[0].loteOrigem, document.forms[0].loteDestino);" /></td>
				</tr>
				<tr>
					<td height="24"><strong>Sublote:</strong></td>
					<td colspan="3"><html:text maxlength="3" property="subLoteOrigem"
						size="4" tabindex="7" onkeyup="replicaDados(document.forms[0].subLoteOrigem, document.forms[0].subLoteDestino);"/></td>
				</tr>
				<tr>
					<td colspan="4">
					<hr>
				...
				<tr>
						<!--onkeypress="limpar(9);validaEnterComMensagem(event, 'exibirFiltrarImovelInserirManterContaAction.do?objetoConsulta=1&inscricaoTipo=destino','localidadeDestinoID','Código da localidade final');"
						onkeyup="verificarBotao();"
						href="javascript:chamarPopup('exibirPesquisarLocalidadeAction.do?indicadorUsoTodos=1', 'destino', null, null, 275, 480, '');"
						 href="javascript:limparLocalidade(2);verificarBotao();"-->
					<td><strong>Localidade:</strong></td>
					<td colspan="3" height="24"><html:text maxlength="3" property="localidadeDestinoID"
						size="3" tabindex="8" onkeypress="limpar(13);"/> <a><img
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0"
						width="23" height="21" title="Pesquisar"></a> <logic:present
					...
					</logic:notPresent> <a> <img
						src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						border="0" title="Apagar" /> </a></td>
				</tr>
				<tr>
					<td><strong>Setor Comercial :</strong></td>
					<td colspan="3"><html:text maxlength="3" property="setorComercialDestinoCD"
						size="3" onkeyup="verificarBotao();"
						onkeypress="limpar(10); validaEnterDependenciaComMensagem(event, 'exibirFiltrarImovelInserirManterContaAction.do?objetoConsulta=2&inscricaoTipo=destino', document.forms[0].setorComercialDestinoCD, document.forms[0].localidadeDestinoID.value, 'localidade da inscrição final', 'Setor comercial final');"
						tabindex="9" /> <a
						href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do', 'setorComercialDestino', 'idLocalidade', document.FiltrarImovelContaActionForm.localidadeDestinoID.value, 275, 480, 'Informe a Localidade da inscrição final');"><img
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0"
						width="23" height="21" title="Pesquisar"></a> <logic:present
					...
					</logic:notPresent> <a href="javascript:limpar(4);verificarBotao();"> <img
						src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						border="0" title="Apagar" /> </a> <html:hidden
				...
				<tr>
					<td><strong>Quadra:</strong></td>
					<td colspan="3"><html:text maxlength="5" property="quadraDestinoNM" size="4"
						tabindex="10" /> <html:hidden property="quadraDestinoID" onkeyup="verificarBotao();"/></td>
				</tr>
				<tr>
					<td><strong>Lote:</strong></td>
					<td colspan="3"><html:text maxlength="4" property="loteDestino" size="4"
						tabindex="11" /></td>
				</tr>
				<tr>
					<td height="24"><strong>Sublote:</strong></td>
					<td colspan="3"><html:text maxlength="3" property="subLoteDestino"
						size="4" tabindex="12" /></td>
				</tr>
                	...
                	<tr bgcolor="#cbe5fe"> 
                  	    ...
                  	    <table width="100%" border="0">
						 	<tr>
								...
								<td><html:text maxlength="4" property="codigoRotaOrigem"
									size="5" tabindex="14" 
									onkeyup="replicaDados(document.forms[0].codigoRotaOrigem, document.forms[0].codigoRotaDestino);bloquearLSQLS();"
									onkeypress="limpar(15);"/></td>																								
						  	</tr>
						  
						  	<tr>
								<td height="10"><strong>Seq. da Rota:</strong></td>
								<td><html:text maxlength="6" property="sequencialRotaOrigem"
									size="7" tabindex="15" 
									onkeyup="replicaDados(document.forms[0].sequencialRotaOrigem, document.forms[0].sequencialRotaDestino);bloquearLSQLS();"/></td>																								
						  	</tr>
            	  ...
            	  <td colspan="4"> 
                	...
                	<tr bgcolor="#cbe5fe"> 
                  	    ...
                  	    <table width="100%" border="0">
						 	<tr>
								<td height="10" width="120"><strong>Rota:</strong></td>
								<td><html:text maxlength="4" property="codigoRotaDestino"
									size="5" tabindex="16" onkeypress="limpar(17);"
									onkeyup="bloquearLSQLS();"/></td>																								
						  	</tr>
						  
						  	<tr>
								<td height="10"><strong>Seq. da Rota:</strong></td>
								<td><html:text maxlength="6" property="sequencialRotaDestino"
									size="7" tabindex="17" 
									onkeyup="bloquearLSQLS();"/></td>																								
						  	</tr>
				...
				<tr>
				<td height="10" width="120"><strong>Arquivo:</strong></td>
				<td>
					...
					<logic:notEmpty  name="arquivo" scope="session">
						...
						<logic:notEmpty  name="FiltrarImovelContaActionForm" property="enderecoArquivoDownload">
						<br/><a href="exibirFiltrarImovelInserirManterContaAction.do?download=true"><bean:write name="FiltrarImovelContaActionForm" property="arquivoDownload"></bean:write> </a>
						</logic:notEmpty>
						<logic:empty  name="FiltrarImovelContaActionForm" property="enderecoArquivoDownload">
						<br/><bean:write name="FiltrarImovelContaActionForm" property="arquivoDownload"></bean:write>
						</logic:empty>
						<html:hidden property="arquivoDownload"/>
				</td>
				</tr>		
				<tr>
