	  ...
	  <table width="100%" border="0">
        ...
        <tr> 
		  ...
		  <logic:present name="situacaoConta"> 
              ...
              <html:option value="<%=DebitoCreditoSituacao.INCLUIDA.toString() %>">INCLUIDA</html:option> 
              <html:option value="<%=DebitoCreditoSituacao.NORMAL.toString() %>">NORMAL</html:option> 
              <html:option value="<%=DebitoCreditoSituacao.RETIFICADA.toString() %>">RETIFICADA</html:option> 
            </html:select>
