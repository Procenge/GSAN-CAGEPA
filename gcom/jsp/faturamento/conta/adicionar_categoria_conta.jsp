...
<logic:present name="reloadPage">
	...
	<logic:equal name="reloadPageURL" value="INSERIRCONTA">
		<body leftmargin="5" topmargin="5" onload="window.focus(); resizePageSemLink(480, 250); chamarSubmitComUrl('exibirInserirContaAction.do?reloadPage=1'); window.close();">
	</logic:equal>
	
	<logic:equal name="reloadPageURL" value="RETIFICARCONTA">
		<body leftmargin="5" topmargin="5" onload="window.focus(); resizePageSemLink(480, 250); chamarSubmitComUrl('exibirRetificarContaAction.do?reloadPage=1'); window.close();">
	</logic:equal>
	
	<logic:equal name="reloadPageURL" value="SIMULARCALCULOCONTA">
		<body leftmargin="5" topmargin="5" onload="window.focus(); resizePageSemLink(550, 270); chamarSubmitComUrl('exibirSimularCalculoContaAction.do'); window.close();">
	</logic:equal>
...
<logic:notPresent name="reloadPage">
	<body leftmargin="5" topmargin="5" onload="resizePageSemLink(550, 270);">
</logic:notPresent>
    ...
    <td width="512" valign="top" class="centercoltext"> 
      ...
      <table width="100%" border="0">
        ...
        <tr>
          ...
          <td><html:text property="qtdEconomia" size="6" maxlength="4" style="text-align: right;" tabindex="2"/></td>
        </tr>
        </table>
