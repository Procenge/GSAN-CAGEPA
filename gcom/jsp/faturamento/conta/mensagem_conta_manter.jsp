		...
		<tr>
			...
			<table width="100%">
				<tr>
					...
					<table border="0" width="100%" bgcolor="#99ccff">
						...
						<tr>
							...
							<td bgcolor="#99ccff" align="center"><strong>Ref. do
							Faturamento</strong></td>
							<td bgcolor="#99ccff" width="25%" align="center"><strong>Mensagem da Conta</strong></td>
							...
							<td bgcolor="#99ccff" align="center"><strong>Indicador de Uso</strong></td>
						</tr>
						<%String cor = "#FFFFFF";%>
				...
				cor = "#FFFFFF";%>
										<tr bgcolor="#cbe5fe">
											<%}%>
											<logic:equal name="contaM" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
											<td>
											<div align="center"><strong> <input name="idRegistrosRemocao"
												value="<bean:write name="contaM" property="id" />"
												type="checkbox" disabled="disabled"> </strong></div>
											</td>
											</logic:equal>

											<logic:notEqual name="contaM" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
											<td>
											<div align="center"><strong> <input name="idRegistrosRemocao"
												value="<bean:write name="contaM" property="id" />"
											...
											<logic:equal name="contaM" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
											<td align="left"><div align="center">INATIVO</div></td>
											</logic:equal>

											<logic:notEqual name="contaM" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
											<td align="left"><div align="center">ATIVO</div></td>
											</logic:notEqual>
										</tr>
									</pg:item>
								</logic:iterate>
