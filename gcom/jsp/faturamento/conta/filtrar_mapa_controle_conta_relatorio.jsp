...
<html:form
  action="/gerarRelatorioMapaControleContaAction"
  method="post"
    ...
    <td width="625" valign="top" class="centercoltext">
	  ...
	  <table width="100%" border="0">
		...
		<tr>
			<td width="10%"></td>
			<td width="90%"><strong> 
				<html:radio property="indicadorFichaCompensacao" value="2"/><strong>Conta
				<html:radio	property="indicadorFichaCompensacao" value="1"/>Boletim Bancário</strong>
			</strong></td>
		</tr>                
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>
          	<input type="button" name="Button" class="bottonRightCol" value="Limpar" onclick="window.location.href='<html:rewrite page="/exibirFiltrarMapaControleContaRelatorioAction.do?menu=sim"/>'">
          </td>
          <td><div align="right">
