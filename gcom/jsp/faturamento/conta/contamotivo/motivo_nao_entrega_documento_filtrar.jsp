...
<html:form action="/filtrarMotivoNaoEntregaDocumentoAction"
	name="FiltrarMotivoNaoEntregaDocumentoActionForm"
	type="gcom.gui.faturamento.conta.contamotivo.FiltrarMotivoNaoEntregaDocumentoActionForm"
	method="post" >
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Motivo de Não Entrega de Documento</td>
			...
			<table width="100%" border="0">
					...
					<table width="100%" border="0">
						<tr>
							<td>Para filtrar um Motivo de Não Entrega de Documento, informe
					os dados abaixo:</td>
				...
				<tr>
					...
					<input type="button" onClick="javascript:window.location.href='/gsan/exibirFiltrarMotivoNaoEntregaDocumentoAction.do?menu=sim'"
