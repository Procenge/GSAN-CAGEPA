...
<html:javascript staticJavascript="false"
	formName="InserirContaMotivoCancelamentoActionForm" />

<script language="JavaScript">
  
	function validaForm() {
	  	var form = document.forms[0];
	  	form.action = "/gsan/inserirContaMotivoCancelamentoAction.do";
...
<html:form action="/inserirContaMotivoCancelamentoAction"
	name="InserirContaMotivoCancelamentoActionForm"
	type="gcom.gui.faturamento.conta.contamotivo.InserirContaMotivoCancelamentoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Motivo de Cancelamento de Conta</td>
			...
			<table width="100%" border="0">
				<tr>
					<td height="10" colspan="3">Para adicionar um motivo de cancelamento, informe
					os dados abaixo:</td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="descricaoMotivoCancelamentoConta" size="50" maxlength="50" /> </span></td>
				</tr>
				<td></td>
				...
				<tr>
					<td align="left"><input name="Button" type="button"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirContaMotivoCancelamentoAction.do?menu=sim"/>'">
