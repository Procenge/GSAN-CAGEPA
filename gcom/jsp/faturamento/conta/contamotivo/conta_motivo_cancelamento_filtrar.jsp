...
<html:javascript staticJavascript="false"
	formName="FiltrarContaMotivoCancelamentoActionForm"
...
<html:form action="/filtrarContaMotivoCancelamentoAction"
	name="FiltrarContaMotivoCancelamentoActionForm"
	type="gcom.gui.faturamento.conta.contamotivo.FiltrarContaMotivoCancelamentoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Motivo de Cancelamento de Conta</td>
			...
			<table width="100%" border="0">
					...
					<table width="100%" border="0">
						<tr>
							<td>Para filtrar um motivo de cancelamento de conta, informe os dados abaixo:</td>
