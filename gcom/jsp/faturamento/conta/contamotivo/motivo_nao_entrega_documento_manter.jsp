...
<html:form action="/removerMotivoNaoEntregaDocumentoAction"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Motivo Não Entrega Documento</td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Motivos de Documentos não Entregues Cadastrados:</strong></font></td>
				</tr>
				<tr>
										...
										if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<td width="37%" align="center"><html:link
														page="/exibirAtualizarMotivoNaoEntregaDocumentoAction.do"
														paramName="contaMotivo" paramProperty="id"
														paramId="idRegistroAtualizacao">${contaMotivo.descricao}
													</html:link></td>
													
													<html:link href="/gsan/exibirManterMotivoNaoEntregaDocumentoAction.do"
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="233"><font color="#FF0000"> <html:submit
								...
								onClick="javascript:window.location.href='/gsan/exibirFiltrarMotivoNaoEntregaDocumentoAction.do?paginacao=sim'">
						</tr>
					</table>
					</td>
				</tr>
