...
<html:form action="/removerContaMotivoRetificacaoAction"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Conta Motivo Retificação</td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Motivos de retificacão de Contas Cadastrados:</strong></font></td>
				</tr>
				<tr>
							...
							<table width="100%" bgcolor="#99CCFF">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<logic:present name="colecao">
										<%int cont = 0;%>
										<logic:iterate name="colecao" id="contaMotivo"
											scope="session">
											<pg:item>
												<%cont = cont + 1;
										if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<td width="37%" align="center"><html:link
														page="/exibirAtualizarContaMotivoRetificacaoAction.do"
														paramName="contaMotivo" paramProperty="id"
														paramId="idRegistroAtualizacao">${contaMotivo.descricaoMotivoRetificacaoConta}
													</html:link></td>
													
													<html:link href="/gsan/exibirManterContaMotivoRetificacaoAction.do"
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="233"><font color="#FF0000"> <html:submit
								...
								onClick="javascript:window.location.href='/gsan/exibirFiltrarContaMotivoRetificacaoAction.do?paginacao=sim'">
						</tr>
					</table>
					</td>
				</tr>
