...
<html:form action="/removerContaMotivoInclusaoAction"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Conta Motivo Inclusao</td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Motivos de Inclusao de Contas Cadastrados:</strong></font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#99CCFF">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="pg" />
									<pg:param name="q" />
									<logic:present name="colecaoContaMotivoInclusao">
										<%int cont = 0;%>
										<logic:iterate name="colecaoContaMotivoInclusao" id="contaMotivo"
											scope="session">
											<pg:item>
												<%cont = cont + 1;
										if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<td width="37%" align="center"><html:link
														page="/exibirAtualizarContaMotivoInclusaoAction.do"
														paramName="contaMotivo" paramProperty="id"
														paramId="idRegistroAtualizacao">${contaMotivo.descricaoMotivoInclusaoConta}
													</html:link></td>
													
													<html:link href="/gsan/exibirManterContaMotivoInclusaoAction.do"
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="233"><font color="#FF0000"> <html:submit
								...
								onClick="javascript:window.location.href='/gsan/exibirFiltrarContaMotivoInclusaoAction.do?paginacao=sim'">
						</tr>
					</table>
					</td>
				</tr>
