...
<html:javascript staticJavascript="false"
	formName="InserirContaMotivoRevisaoActionForm" />

<script language="JavaScript">
  
	function validaForm() {
	  	var form = document.forms[0];
	  	form.action = "/gsan/inserirContaMotivoRevisaoAction.do";
...
<html:form action="/inserirContaMotivoRevisaoAction"
	name="InserirContaMotivoRevisaoActionForm"
	type="gcom.gui.faturamento.conta.contamotivo.InserirContaMotivoRevisaoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Motivo de Revisao de Conta</td>
			...
			<table width="100%" border="0">
				<tr>
					<td height="10" colspan="3">Para adicionar um motivo de Revisao, informe
					os dados abaixo:</td>
				</tr>
				...
				<tr>
					<td align="left"><input name="Button" type="button"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirContaMotivoRevisaoAction.do?menu=sim"/>'">
