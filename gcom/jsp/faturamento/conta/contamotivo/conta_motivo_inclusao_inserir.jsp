...
<html:javascript staticJavascript="false"
	formName="InserirContaMotivoInclusaoActionForm" />

<script language="JavaScript">
  
	function validaForm() {
	  	var form = document.forms[0];
	  	form.action = "/gsan/inserirContaMotivoInclusaoAction.do";
...
<html:form action="/inserirContaMotivoInclusaoAction"
	name="InserirContaMotivoInclusaoActionForm"
	type="gcom.gui.faturamento.conta.contamotivo.InserirContaMotivoInclusaoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Motivo de Inclusão de Conta</td>
			...
			<table width="100%" border="0">
				<tr>
					<td height="10" colspan="3">Para adicionar um motivo de inclusão, informe
					os dados abaixo:</td>
				</tr>
				...
				<tr>
					<td align="left"><input name="Button" type="button"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirContaMotivoInclusaoAction.do?menu=sim"/>'">
