...
<html:javascript staticJavascript="false"
	formName="InserirContaMotivoRetificacaoActionForm" />

<script language="JavaScript">
  
	function validaForm() {
	  	var form = document.forms[0];
	  	form.action = "/gsan/inserirContaMotivoRetificacaoAction.do";
...
<html:form action="/inserirContaMotivoRetificacaoAction"
	name="InserirContaMotivoRetificacaoActionForm"
	type="gcom.gui.faturamento.conta.contamotivo.InserirContaMotivoRetificacaoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Motivo de Retificacao de Conta</td>
			...
			<table width="100%" border="0">
				<tr>
					<td height="10" colspan="3">Para adicionar um motivo de Retificacao, informe
					os dados abaixo:</td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="descricaoMotivoRetificacaoConta" size="35" maxlength="35" /> </span></td>
				</tr>
				<td></td>
				...
				<tr>
					<td align="left"><input name="Button" type="button"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirContaMotivoRetificacaoAction.do?menu=sim"/>'">
