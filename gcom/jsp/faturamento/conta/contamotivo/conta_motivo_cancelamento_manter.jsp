...
<html:form action="/removerContaMotivoCancelamentoAction"
	name="ManutencaoRegistroActionForm"
	type="gcom.gui.ManutencaoRegistroActionForm" method="post" scope="session"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Conta Motivo Cancelamento</td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Motivos de Cancelamento de Contas Cadastrados:</strong></font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#99CCFF">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="pg" />
									<pg:param name="q" />
									<logic:present name="colecaoContaMotivoCancelamento">
										<%int cont = 0;%>
										<logic:iterate name="colecaoContaMotivoCancelamento" id="contaMotivo"
											scope="session">
											<pg:item>
												<%cont = cont + 1;
										if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<div align="center"><input type="checkbox"
														name="idRegistrosRemocao" value="${contaMotivo.id}"></div>
													</td>
													<td width="12%" align="center">${contaMotivo.id}</td>
													<td width="37%" align="center"><html:link
														page="/exibirAtualizarContaMotivoCancelamentoAction.do"
														paramName="contaMotivo" paramProperty="id"
														paramId="idRegistroAtualizacao">${contaMotivo.descricaoMotivoCancelamentoConta}
													</html:link></td>
													
													<html:link href="/gsan/exibirManterContaMotivoCancelamentoAction.do"
														paramId="codigo" paramProperty="id"
														paramName="contaMotivo">
													</html:link>
												</tr>
											</pg:item>
										</logic:iterate>
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="233"><font color="#FF0000"> <html:submit
								...
								onClick="javascript:window.location.href='/gsan/exibirFiltrarContaMotivoCancelamentoAction.do?paginacao=sim'">
						</tr>
					</table>
					</td>
				</tr>
