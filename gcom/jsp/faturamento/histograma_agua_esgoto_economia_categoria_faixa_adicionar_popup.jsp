...
<script language="JavaScript">
	...
	function validaLimite(){
		...
		if(form.limiteSuperiorFaixa.value == ""){
			...
			if( ((valorCampo*1) < (form.limiteInferiorFaixa.value*1)) || valorCampo == form.limiteInferiorFaixa.value){
				if(msg == ""){
					msg = "Faixa inválida";
					form.limiteSuperiorFaixa.focus();
				}else{
...
<html:form action="/exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do"
