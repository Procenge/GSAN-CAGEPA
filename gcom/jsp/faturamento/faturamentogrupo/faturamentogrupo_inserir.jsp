...
<div id="formDiv">
<html:form 	action="/inserirFaturamentoGrupoAction" enctype="multipart/form-data"
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<tr>
				<td colspan="2">Para adicionar um grupo de faturamento, informe os dados
				abaixo:</td>
			</tr>	
			<tr>
					<td>
						<strong>Código:<font color="#FF0000">*</font></strong>
					</td>
					<td><strong> <html:text property="idFaturamentoGrupo" size="5" maxlength="5" onkeypress="return isCampoNumerico(event);"></html:text> </strong></td>
				</tr>				
			<tr>
