...
<html:javascript staticJavascript="false"  formName="FiltrarFaturamentoGrupoActionForm" />
            ...
            <table width="100%" border="0">
              <tr>
	           <td width="100%" colspan=2>
		          <table width="100%">
		          	<tr>
		          		<td>Para Filtrar o(s) grupo(s) de faturamento, informe os dados abaixo: </td>
	          ...
	          <tr>
					...
					<td><strong> <html:text property="idFaturamentoGrupo" size="5" maxlength="5"></html:text> </strong></td>
				</tr>
              <tr>
			  ...
			  <tr>
				...
				<tr>
					<td><strong>O vencimento do grupo é igual ao ano/mês do faturamento?</strong></td>
					<td><html:radio property="indicadorVencimentoMesFatura" value="<%=ConstantesSistema.SIM.toString()%>" /><strong>Sim</strong>
					<html:radio property="indicadorVencimentoMesFatura" value="<%=ConstantesSistema.NAO.toString()%>" /><strong> Não</strong>
					<html:radio property="indicadorVencimentoMesFatura"	value="<%=ConstantesSistema.TODOS.toString()%>" /><strong>Todos</strong></td>
				</tr>
				<tr>
			...
			<tr>
				...
				<td align="right">
					<gcom:controleAcessoBotao name="Button" value="Filtrar"
											  ...
											  url="filtrarFaturamentoGrupoAction.do" />
				</td>
			</tr>
