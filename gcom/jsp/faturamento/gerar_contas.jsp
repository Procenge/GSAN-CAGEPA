...
<script language="JavaScript">
	function validarForm(){
	   ...
	   if(form.uploadPicture.value != '') {
	  	 	if(confirm('Confirma gerar contas?')){
	    	   form.submit();
		   	}
	   }else{
		  if(form.uploadPicture.value == ''){
...
<form action="/gsan/gerarContasAction.do"
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Gerar Contas</td>
		...
		<table width="100%" border="0">
			...
			<tr>
				<td colspan="2">Para gerar contas, informe os dados abaixo:</td>
			</tr>
			...
			<tr>
				<td align="left">
					<input name="Button" 
						...
						value="Desfazer" 
						align="left"
						onclick="window.location.href='<html:rewrite page="/exibirGerarContasAction.do?menu=sim"/>'">
						&nbsp;
