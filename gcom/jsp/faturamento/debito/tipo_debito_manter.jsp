		...
		<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								...
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<div align="center"><strong>Indicador de Geração do Débito

									Automática</strong></div>
									...
									<div align="center"><strong>Indicador de Incid&ecirc;ncia de Multa</strong></div>

									</td>
									
									<td width="16%">

									<div align="center"><strong>Indicador de Incid&ecirc;ncia de Juros Mora</strong></div>
			...
			if (cont % 2 == 0) {%>
											...
											<tr bgcolor="#cbe5fe">
												...
												<td width="28%" align="center"><html:link
											...
											NÃO
												...
												<td width="16%" align="center"><logic:equal
											...
											<td width="15%" align="center"><logic:equal
													name="debitoTipo" property="indicadorIncidenciaMulta"
													value="1">
											SIM
											</logic:equal> <logic:equal name="debitoTipo"
													property="indicadorIncidenciaMulta" value="2">
											NÃO
											</logic:equal></td>

											<td width="16%" align="center"><logic:equal
													name="debitoTipo" property="indicadorIncidenciaJurosMora"
													value="1">
											SIM
											</logic:equal> <logic:equal name="debitoTipo"
													property="indicadorIncidenciaJurosMora" value="2">
											NÃO
											</logic:equal></td>
							...
							<table width="100%" border="0">
								...
								<tr>
									...
									<td><font color="#FF0000"><gcom:controleAcessoBotao
