...
<html:javascript staticJavascript="false"  formName="PesquisarDebitoTipoValorLocalidadeActionForm"/>
...
<script>
	...
	function whenOnload() {
		if (${requestScope.close != null}) {
			...
			enviarDadosQuatroParametros(a, b, c, 'debitoValorLocalidade'); 
		}
	}
...
<html:form
  action="/exibirPesquisarDebitoTipoValorLocalidadeAction"
  name="PesquisarDebitoTipoValorLocalidadeActionForm"
  type="gcom.gui.faturamento.debito.PesquisarDebitoTipoValorLocalidadeActionForm"
  method="post"
>
<input type="hidden" name="method" value="${"PesquisarDebitoTipoValorLocalidadeActionForm.method"}" />
    		...
    		<table height="100%">
      		...
      		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        		<tr> 
          			...
          			<td class="parabg">Adicionar Atividades do Tipo de Débito Valor Localidade</td>
      		...
      		<table width="100%" border="0">
        		<tr> 
          			<td colspan="3">Preencha os campos para inserir um atividades do tipo de Débito Valor Localidade:</td>
        		</tr>
       			<tr>
					...
					<td colspan="2" width="81%" height="24"><html:text maxlength="3"
						...
						onkeypress="javascript:validaEnter(event, 'exibirPesquisarDebitoTipoValorLocalidadeAction.do?objetoConsulta=1', 'idLocalidadeFiltro');" />
					<a
					...
					<logic:notPresent name="localidadeEncontrado">
						<logic:empty name="PesquisarDebitoTipoValorLocalidadeActionForm"
							property="idLocalidadeFiltro">
							<html:text property="localidadeDescricaoFiltro" value=""
								size="40" maxlength="30" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
						<logic:notEmpty name="PesquisarDebitoTipoValorLocalidadeActionForm"
							property="idLocalidadeFiltro">
							<html:text property="localidadeDescricaoFiltro" size="40"
								maxlength="30" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
