					...
					<logic:iterate name="colecaoDebitosACobrar" id="debitoACobrar" type="DebitoACobrar">
					  <pg:item>
						...
						<%}%>
						 <td width="20%">
						   <div>
						      <a href="javascript:enviarDadosCincoParametros('<bean:write name="debitoACobrar" property="id"/>', '<bean:write name="debitoACobrar" property="valorDebito"/>', '<bean:write name="debitoACobrar" property="valorRestanteCobrado"/>', '<bean:write name="debitoACobrar" property="debitoTipo.id"/>', 'debitoACobrar');">
						  ...
						  <td width="10%">
							<div align="center">
							  <logic:present name="debitoACobrar" property="numeroPrestacaoCobradas">
                				<bean:write name="debitoACobrar" property="numeroPrestacaoCobradas" />/<bean:write name="debitoACobrar" property="numeroPrestacaoDebito" /> 
			  				  </logic:present>
						  ...
						  <td width="10%">
							<div align="right">
							  <logic:present name="debitoACobrar" property="valorRestanteCobrado">
                				<bean:write name="debitoACobrar" property="valorRestanteCobrado" formatKey="money.format"/>
			  				  </logic:present>
			  				  <logic:notPresent name="debitoACobrar" property="valorRestanteCobrado">
								&nbsp;
			  				  </logic:notPresent>								
							</div>
						  </td>
