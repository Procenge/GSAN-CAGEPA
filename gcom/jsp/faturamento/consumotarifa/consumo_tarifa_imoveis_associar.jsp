...
function limpar(tipo){
	...
	//savio
     ...
     case 1:
		   ...
		   form.tarifaAnteriorHidden.value = "-1";
...
function validarForm(form){
	...
	if(form.tarifaAtual.value == '-1' && form.tarifaEspecial.value == '-1'){
		alert('Informe Tarifa Atual ou Tarifa Especial');
		obrigatorio = true;
		}
	if(form.tarifaEspecial.value != '-1' && form.dataValidadeTarifaEspecial.value == '') {
		alert('Informe a Data de Validade da Tarifa de Consumo Especial');
		obrigatorio = true;
	}
	...
	if (!obrigatorio && validateAssociarTarifaConsumoImoveisActionForm(form)){
		...
		if(form.tarifaAtual.value == '-1' && form.tarifaEspecial.value == '-1'){
			alert('Informe Tarifa Atual ou Tarifa Especial');
		} else if(form.tarifaEspecial.value != '-1' && form.dataValidadeTarifaEspecial.value == '') {
			alert('Informe a Data de Validade da Tarifa de Consumo Especial');
		} else {
			...
			<table width="100%" border="0">				
				<tr>
					...
					<td><logic:notEqual parameter="bloquear" value="matricula">
						<html:text maxlength="9" property="idImovel" size="9"
							...
							onkeyup="limparQuantidadeImoveisAtualizados();bloquearLSQLS();limparMatricula();" tabindex="1" />
						<a
						...
						<html:text maxlength="9" property="idImovel" size="9"
							...
							onkeyup="limparQuantidadeImoveisAtualizados();bloquearLSQLS();document.forms[0].inscricaoImovel.value = '';" />
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="3"
						...
						href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do', 'setorComercialOrigem', 'idLocalidade', document.AssociarTarifaConsumoImoveisActionForm.localidadeOrigemID.value, 275, 480, 'Informe Localidade Inicial',document.forms[0].setorComercialOrigemCD);
						         limparOrigem(2);"><img
						width="23" height="21" border="0" style="cursor:hand;"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
					...
					</a> <html:hidden property="setorComercialOrigemID" />
				...
				<tr>
					...
					<td colspan="2" width="432">
						<html:text maxlength="5" property="quadraOrigemNM" size="4"
						...
						tabindex="4" onblur="replicarQuadra();" /> 
											
						<a href="javascript:chamarPopup('exibirPesquisarQuadraAction.do', 'quadraOrigem', 'idSetorComercial', document.AssociarTarifaConsumoImoveisActionForm.setorComercialOrigemCD.value, 275, 480, 'Informe Setor Comercial Inicial', document.forms[0].quadraOrigemNM);">
						...
						<logic:present name="corQuadraOrigem">
							<logic:equal name="corQuadraOrigem" value="exception">
								<span style="color:#ff0000" id="msgQuadraOrigem">
									<bean:write name="AssociarTarifaConsumoImoveisActionForm" property="quadraMensagemOrigem" /></span>
							</logic:equal>
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="3"
						...
						href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do', 'setorComercialDestino', 'idLocalidade', document.AssociarTarifaConsumoImoveisActionForm.localidadeDestinoID.value, 275, 480, 'Informe Localidade Final',form.documents[0].setorComercialDestinoCD);
						         limparDestino(2);"><img
						width="23" height="21" border="0" style="cursor:hand;"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
						title="Pesquisar Localidade" /></a> <logic:present
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="5" property="quadraDestinoNM"
						size="4"
						...
						<a href="javascript:chamarPopup('exibirPesquisarQuadraAction.do', 'quadraDestino', 'idSetorComercial', document.AssociarTarifaConsumoImoveisActionForm.setorComercialDestinoCD.value, 275, 480, 'Informe Setor Comercial Final', document.forms[0].quadraDestinoNM);">
				          	<img border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0"/>
				        </a>
				...
				<logic:notEqual scope="session" parameter="bloquear" value="todos">
					...
					<tr>
						<td width="183"><strong>Quadra:</strong></td>
						<td colspan="2" width="432"><html:text maxlength="5"
					...
					<tr>
						...
						<td colspan="2"><html:text maxlength="5"
							...
							tabindex="9" onkeyup="desabilitaIntervaloDiferente(3);" /> 
				...
				<tr>
					<td><strong>Tarifa Especial:<font color="#FF0000"></font></strong></td>
					<td colspan="1" align="left"><logic:present
						name="liberarBotaoInserir" scope="request">
						<html:select property="tarifaEspecial">
							<html:option value="-1">&nbsp;</html:option>
							<html:options collection="colecaoConsumoTarifa"
								labelProperty="descricao" property="id" />
						</html:select>
						...
						scope="request">
						<html:select property="tarifaEspecial" disabled="true">
							<html:option value="-1">&nbsp;</html:option>
							<html:options collection="colecaoConsumoTarifa"
								labelProperty="descricao" property="id" />
						</html:select>
				...
				<tr>
					<td height="27"><strong> Data de Validade da Tarifa Especial:</strong></td>
					<td><html:text maxlength="10" onkeyup="mascaraData(this, event);" onfocus="" property="dataValidadeTarifaEspecial" size="10" />
					<a
						href="javascript:abrirCalendario('AssociarTarifaConsumoImoveisActionForm', 'dataValidadeTarifaEspecial')">
					<img border="0"
