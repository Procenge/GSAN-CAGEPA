			...
			switch (form.elements[i].id){
				...
				case "ValorConMinimo.":
					...
					if (form.elements[i].value.length < 1){
						...
						alert("Consumo M�nimo deve somente conter n�meros positivos.");
						form.elements[i].focus();
						camposValidos = false;
					}
					else if (!testarCampoValorZero(form.elements[i], "Consumo M�nimo")){
						form.elements[i].focus();
						camposValidos = false;
					}
					break;
				...
				case "ValorTarMin.":
					...
					if (value.length < 1){
						alert("Informe Tarifa M�nima.");
						form.elements[i].focus();
						camposValidos = false;
					}
					else if (isNaN(value) || value < 0){
						alert("Tarifa M�nima deve somente conter n�meros positivos.");
						form.elements[i].focus();
						camposValidos = false;
					}
					else if (!testarCampoValorZeroDecimal(form.elements[i], "Tarifa M�nima")){
						form.elements[i].focus();
						camposValidos = false;
					}
					break;
...
function abrirCategoria(){
  	...
  	if (form.descTarifa.value == ''){
  		alert ('Informe Descri��o da Tarifa.');
