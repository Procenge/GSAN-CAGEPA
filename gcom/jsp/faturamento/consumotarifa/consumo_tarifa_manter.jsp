...
function facilitador(objeto){
 ...
 function novoFiltro(){
 	...
 	function validarForm(objeto){ 
	   ...
	   var acumulador = 0;
	    ...
	    if (ids == null || ids.length <= 0){
	      alert('Selecione pelo menos uma Tarifa para Reajuste.');
	      return false;
	    } 
	...
	function  remover(){
		if(CheckboxNaoVazio(document.ManutencaoRegistroActionForm.idRegistrosRemocao) && confirm('Confirma exclusão ?')){
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%">
				...
				<tr>
				<td>
					<gcom:controleAcessoBotao name="Button2" value="Reajustar"
