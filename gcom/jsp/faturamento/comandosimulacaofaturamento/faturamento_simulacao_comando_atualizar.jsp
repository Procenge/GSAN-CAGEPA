...
<html:javascript staticJavascript="false"  formName="AtualizarComandoSimulacaoFaturamentoActionForm"/>
...
<script language="JavaScript">
	...
	function validarFormulario(){
		...
		if(validateAtualizarComandoSimulacaoFaturamentoActionForm(form)
			&& validarCampos()){
			
			form.action = "/gsan/atualizarComandoSimulacaoFaturamentoAction.do";
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'localidadeOrigem') {
	  		...
	  		if (form.idLocalidadeFinal.value != form.idLocalidadeInicial.value){
				...
				form.action = 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=1';
			  	form.submit();
			}
		}
		...
		if (tipoConsulta == 'localidadeDestino') {
			...
			if (form.idLocalidadeFinal.value != form.idLocalidadeInicial.value){
				...
				form.action = 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=3';
			  	form.submit();
			}
		}
	}
	...
	function recuperarDadosQuatroParametros(idRegistro, descricaoRegistro, codigoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'setorComercialOrigem') {
			...
			if (form.codigoSetorComercialFinal.value != form.codigoSetorComercialInicial.value){
		  	...
		  	form.action = 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=2';
		  	form.submit();
		}
		...
		if (tipoConsulta == 'setorComercialDestino') {
			...
			if (form.codigoSetorComercialFinal.value != form.codigoSetorComercialInicial.value){
		  	...
		  	form.action = 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=4';
		  	form.submit();
		}
		...
		if (tipoConsulta == 'quadraOrigem') {
			...
			form.action = 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=5';
		  	form.submit();
	  	}
		...
		if (tipoConsulta == 'quadraDestino') {
			...
			form.action = 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=6';
		  	form.submit();
	  	}
	...
	function desfazer(){
		...
		form.action = 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?desfazer=S';
		form.submit();
	}
</script>
...
<html:form action="/exibirAtualizarComandoSimulacaoFaturamentoAction.do"
	name="AtualizarComandoSimulacaoFaturamentoActionForm"
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Comando de Simulação de Faturamento</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">Para atualizar o comando de simulação de faturamento, informe os dados abaixo:</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(3);validaEnter(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=1', 'idLocalidadeInicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(2);validaEnterDependencia(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=2', document.forms[0].codigoSetorComercialInicial, document.forms[0].idLocalidadeInicial.value, 'Localidade Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="4" 
							...
							onkeypress="javascript:limparOrigem(5);validaEnterDependencia(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=5', document.forms[0].numeroQuadraInicial, document.forms[0].codigoSetorComercialInicial.value, 'Setor Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="5" 
							...
							onkeypress="javascript:limparOrigem(7);validaEnterDependencia(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=7', document.forms[0].codigoRotaInicial, document.forms[0].codigoSetorComercialInicial.value, 'Setor Comercial Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="validaEnter(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=3', 'idLocalidadeFinal');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="codigoSetorComercialFinal"
							size="3"
							onblur="javascript:verificarBloqueioCampos(1);"
							onkeypress="validaEnterDependencia(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=4', document.forms[0].codigoSetorComercialFinal, document.forms[0].idLocalidadeFinal.value, 'Localidade Final');"
							/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="4" 
							...
							onkeypress="javascript:validaEnterDependencia(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=6', document.forms[0].numeroQuadraFinal, document.forms[0].codigoSetorComercialFinal.value, 'Setor Comercial Final');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="5" 
							...
							size="5"
							onblur="javascript:verificarBloqueioCampos(2);"
							onkeypress="javascript:validaEnterDependencia(event, 'exibirAtualizarComandoSimulacaoFaturamentoAction.do?objetoConsulta=8', document.forms[0].codigoRotaFinal, document.forms[0].codigoSetorComercialFinal.value, 'Setor Comercial Final');"/>
				...
				<tr>
					<td height="24" >
						...
						<logic:present name="filtrarApenasUmComando" scope="session">
							<input type="button" name="ButtonReset" class="bottonRightCol" 
								value="Voltar" 
								onClick="javascript:window.location.href='/gsan/exibirFiltrarComandoSimulacaoFaturamentoAction.do'">
						</logic:present>
						
						<logic:notPresent name="filtrarApenasUmComando" scope="session">
			          	...
			          	<input type="button" 
			          		...
			          		value="Desfazer" 
			          		onclick="javascript:window.location.href='/gsan/exibirAtualizarComandoSimulacaoFaturamentoAction.do?desfazer=S'"
			          		/>
					...
					<td align="right">
						...
						<gsan:controleAcessoBotao name="Button" 
							...
							url="atualizarComandoSimulacaoFaturamentoAction.do" />
					</td>
