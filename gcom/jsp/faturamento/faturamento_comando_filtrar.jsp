...
<html:form
  action="/filtrarComandoAtividadeFaturamentoAction"
  method="post"
    ...
    <td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg">Filtrar Comando de Atividade de Faturamento</td>
	  ...
	  <table width="100%" border="0">
        <tr>
        	<td width="100%" colspan=2>
	        	<table width="100%" border="0">
		          	<tr>
		          		<td>Para filtrar o(s) comando(s) de atividade de faturamento, informe os dados abaixo:</td>
		          		<td align="right"><input type="checkbox" name="atualizar" value="1" checked="checked"/><strong>Atualizar</strong>
						</td>
						<td align="right"></td>
		          	</tr>
		          </table>
        ...
        <tr>
          <td>
          	<input type="button" name="Button" class="bottonRightCol" value="Limpar" onclick="window.location.href='<html:rewrite page="/exibirFiltrarFaturamentoComandoAtividadeAction.do?menu=sim"/>'">
          </td>
          <td><div align="right">
