...
function validarForm(form){
	...
	var ATIVIDADE_GERAR_FATURAMENTO_IMEDIATO_ID = document.getElementById("ATIVIDADE_GERAR_FATURAMENTO_IMEDIATO_ID").value;
	...
	else if (objVencimentoGrupo != null && objVencimentoGrupo.value == ""){
		alert("Informe Vencimento do Grupo");
	...
	else if (objVencimentoGrupo != null && !verificaData(form.vencimentoGrupo)){
		objVencimentoGrupo.focus();
	}		
	else if ((objAtividadeFaturamento.value == ATIVIDADE_FATURAR_GRUPO_ID)||(objAtividadeFaturamento.value == ATIVIDADE_GERAR_FATURAMENTO_IMEDIATO_ID)){
		var objVencimentoGrupo = returnObject(form, "vencimentoGrupo");
...
<input type="hidden" id="ATIVIDADE_GERAR_FATURAMENTO_IMEDIATO_ID" value="<%= "" + FaturamentoAtividade.GERAR_FATURAMENTO_IMEDIATO%>">
											...
											<td width="9%" align="center">
												<logic:present name="rota" property="setorComercial">
													<logic:present name="rota" property="setorComercial.localidade">
														<logic:present name="rota" property="setorComercial.localidade.unidadeNegocio">
...
<!-- faturamento_comando_atividade_inserir.jsp -->
</html:html>