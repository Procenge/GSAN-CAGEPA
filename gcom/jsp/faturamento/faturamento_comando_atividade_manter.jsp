			            ...
			            <table width="590" bgcolor="#99CCFF">
							...
							<%}%>
								...
								<td align="center" width="70">
									<%="" + Util.formatarAnoMesParaMesAno(faturamentoAtividadeCronograma.getFaturamentoGrupoCronogramaMensal().getAnoMesReferencia())%>
								</td>
								<td width="160">
						...
						<table width="100%">
							<tr>
							  ...
							  onclick="verficarSelecao(faturamentoAtividadeCronogramaID);" url="removerComandoAtividadeFaturamentoAction.do"/>
								<!--
									<input name="button" type="button" class="bottonRightCol" value="Voltar Filtro"	onclick="window.location.href='<html:rewrite page="/exibirFiltrarFaturamentoComandoAtividadeAction.do?limpar=S"/>'" align="left" style="width: 80px;">
