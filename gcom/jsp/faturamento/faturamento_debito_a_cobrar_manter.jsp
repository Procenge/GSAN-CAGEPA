...
function verficarSelecao(objeto, tipoObjeto){
       ...
       if (selecionado.length < 1) {
		 ...
		 if (confirm ("Confirma cancelamentooo?")) {
						...
						<tr>
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bgcolor="#90c7fc">
									...
									<td align="center" width="8%" bgcolor="#90c7fc"><strong>Grupo
									...
									<td width="10%" bgcolor="#90c7fc">
									<div align="center"><strong>Prazo Susp.</strong></div>
									</td>
								...
								<%if(((Collection) session.getAttribute("colecaoDebitosACobrar")).size() 
										...
										<logic:iterate name="colecaoDebitosACobrar" id="debitoacobrar"
											...
											<logic:notEqual name="debitoacobrar" property="numeroPrestacaoDebito" 
												...
												<%if (cor.equalsIgnoreCase("#FFFFFF")) {
													...
													<tr bgcolor="#FFFFFF">
														...
														<td align="right" width="9%">
															...
															+ Util.formatarMoedaReal(debitoacobrar.getValorDebito())%></div>
														</td>
														...
														<td width="9%">
															<div align="center" class="style9">
																...
																<c:choose>
																	...
																	<c:when test="${not empty debitoacobrar.numeroPrestacaoDebitoTemp}">
																	
																		<c:out value="${debitoacobrar.numeroPrestacaoDebitoTemp}"/>
																	
																	</c:when>
																	<c:otherwise>
																	
																		<c:out value="${debitoacobrar.numeroPrestacaoDebito}"/>
														...
														<td width="9%">
															<div align="center" class="style9">
																...
																<c:choose>
																	...
																	<c:when test="${not empty debitoacobrar.numeroPrestacaoCobradasTemp}">
																	
																		<c:out value="${debitoacobrar.numeroPrestacaoCobradasTemp}"/>
																	
																	</c:when>
																	<c:otherwise>
																	
																		<c:out value="${debitoacobrar.numeroPrestacaoCobradas}"/>
														...
														<td align="right" width="6%">
															<div align="right" class="style9"><bean:write name="debitoacobrar" property="numeroDiasSuspensao" /></div>
														</td>
											...
											value="<%=""+ debitoacobrar.getNumeroPrestacaoCobradas()%>">
												...
												<%if (cor.equalsIgnoreCase("#FFFFFF")) {
													...
													<tr bgcolor="#FFFFFF">
														...
														<td width="9%">
															<div align="center" class="style9"><bean:write name="debitoacobrar" property="numeroPrestacaoDebito" /></div>
														</td>
