		...
		<td width="625" valign="top" class="centercoltext">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Consumo por Faixa de Área e Categoria</td>
					<td width="11"><img border="0"
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="4" height="23">
						...
						<strong>Consumo por Faixa de Área e Categoria cadastrados:</strong>
						</font>
					</td>
				</tr>
	  		</table>
							...
							<tr>
								...
								<td align="right" valign="top">
			                     	<a href="javascript:toggleBox('demodiv',1);">
			                             <img align="right" border="0" src="<bean:message key='caminho.imagens'/>print.gif"  title="Imprimir Consumo por Faixa de Área e Categoria do Imóvel"/>
			                             </a>
			                     </td>
							</tr>
						</table>
