...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateEmissaoHistogramaEsgotoEconomiaDadosInformarActionForm(form) && 
			...
			validaQtdeConsumoFaixa()){
  			...
  			form.action='gerarArquivoHistogramaAguaEsgotoEconomia.do';
	...
	function limparSemOpcaoTotalizacao(){
  		...
  		form.action='exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?menu=sim';
	    form.submit();
	...
	*/
	...
	function adcionarConsumo() {
		abrirPopup('exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?acao=I', 300, 600);
	}
	...
	function removerConsumo(id){
		...
		if (where_to == true) {
		    ...
		    form.action='exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?acao=R&idRemover='+id;
		    form.submit();
 		}
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    //Consumo Medido e Consumo Não Medido
    		...
    		form.action='exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?acao=A';
	    	form.submit();
	...
	function limparSetorComercial() {
  	...
  	function reloadForm(){
  		...
  		form.action='exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do';
	    form.submit();
  	}
  	...
  	function mudarTabelaConsumoFaixaCategoria(){
  		...
  		form.action='exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?acao=M';
	    form.submit();
  	}
...
<html:form action="/gerarArquivoHistogramaAguaEsgotoEconomia.do"
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Arquivo Texto Histograma Agua / Esgoto Economia</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr height="40">
					<td colspan="3">Para gerar o arquivo, informe os dados abaixo:</td>
				</tr>
				
              	<tr> 
                	<td><strong>Tipo de Arquivo:</strong><font color="#FF0000">*</font></td>
                	<td colspan="6">
                		<strong>
                			
                			<html:radio property="tipoArquivo" value="1"/>Agua
					  		<html:radio property="tipoArquivo" value="2"/>Esgoto
   					  		<html:radio property="tipoArquivo" value=""/>Ambos
				...
				<tr>
					<td><strong>Elo P&oacute;lo:</strong></td>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="eloPolo" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?objetoConsulta=1','eloPolo','Elo Pólo');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?objetoConsulta=2','localidade','Localidade');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?objetoConsulta=3','setorComercial','Setor Comercial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="5"
							...
							tabindex="3" 
							size="5"
							onkeypress="javascript:return validaEnterDependencia(event, 'exibirGerarArquivoTextoHistogramaAguaEsgotoEconomia.do?objetoConsulta=4', this, document.forms[0].setorComercial.value, 'Setor Comercial');" />
				...
				<tr>
              	...
              	<tr> 
                	<td><strong>Situação da Ligação de Agua / Esgoto</strong></td>
				...
				<tr>
					...
					<td align="right">
						<input type="button" 
							name="Button" 
							class="bottonRightCol" 
							value="Gerar Arquivo Histograma Agua / Esgoto" 
