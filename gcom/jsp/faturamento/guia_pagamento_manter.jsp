		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Guia de Pagamento</td>
					<td width="11"><img border="0"
			...
			<p>&nbsp;</p>
				...
				<tr>
					<td colspan="4">Para manter a guia de pagamento, informe os dados
					abaixo:</td>
					<td align="right"></td>
				</tr>
				</table>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0">
								...
								<tr bordercolor="#000000">
									...
									<td width="25%" bgcolor="#90c7fc" align="center"><strong>Tipo do Documento</strong></td>
									<td width="10%" bgcolor="#90c7fc" align="center"><strong>Prestação</strong></td>
									<td width="15%" bgcolor="#90c7fc" align="center"><strong>Emissão</strong></td>
									<td width="15%" bgcolor="#90c7fc" align="center"><strong>Vencimento</strong></td>
									<td width="15%" bgcolor="#90c7fc" align="right"><strong>Valor do Débito&nbsp;</strong></td>
									<td width="15%" bgcolor="#90c7fc" align="center"><strong>Situação</strong></td>
								</tr>
											...
											<logic:present name="guiasPagamentos">
												...
												<logic:iterate name="guiasPagamentos" id="guiaPagamento" >
													<%--<pg:item>--%>
														...
														<tr bgcolor="#FFFFFF">
															<%}%>
															<td width="5%"><div align="center"><input type="checkbox" name="idRegistrosRemocao" value='<bean:write name="guiaPagamento" property="id" />' /></div></td>
															<td width="25%" align="left">
																<a href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<bean:write name="guiaPagamento" property="idGuiaPagamento" />', 600, 900);">
																<bean:write name="guiaPagamento" property="descricaoDocumentoTipo" />&nbsp;
																</a>
															</td>
															<td width="10%" align="center"><bean:write name="guiaPagamento" property="numeroPrestacao" /> / <bean:write name="guiaPagamento" property="numeroPrestacaoTotal" /></td>
															<td width="15%" align="center"><bean:write name="guiaPagamento" property="dataEmissao" formatKey="date.format" /></td>
															<td width="15%" align="center"><bean:write name="guiaPagamento" property="dataVencimento" formatKey="date.format" /></td>
															<td width="15%" align="right"><bean:write name="guiaPagamento" property="valorTotalPorPrestacao" formatKey="money.format" /></td>
															<td width="15%" align="center"><bean:write name="guiaPagamento" property="descricaoDebitoCreditoSituacao"  /></td>
														</tr>
													<%--</pg:item>--%>
												</logic:iterate>
											</logic:present>
				...
				<tr>
					...
					<table width="100%">
						<tr>
							...
							<td  align="right">
							<gcom:controleAcessoBotao name="Button" value="Cancelar Guia(s) de Pagamento"
				...
				<tr>
					...
					<table width="100%">
						...
						style="width:200px"
						/>
						<!--<gcom:controleAcessoBotao name="Button" value="Imprimir Guia(s) de Pagamento"
