...
<SCRIPT LANGUAGE="JavaScript">
	...
	function validaNumeroDocumento() {
		...
		if ((form.numeroDocumento1 != null && form.numeroDocumento1.value != '')
			...
			if (form.idCodigo1[form.idCodigo1.selectedIndex] == null
					|| form.idCodigo1[form.idCodigo1.selectedIndex].value == '-1'
					|| form.qtTentativas1.value == ''
					|| form.qtTentativas1.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento2 != null && form.numeroDocumento2.value != '')
			...
			if (form.idCodigo2[form.idCodigo2.selectedIndex] == null
					|| form.idCodigo2[form.idCodigo2.selectedIndex].value == '-1'
					|| form.qtTentativas2.value == ''
					|| form.qtTentativas2.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento3 != null && form.numeroDocumento3.value != '')
			...
			if (form.idCodigo3[form.idCodigo3.selectedIndex] == null
					|| form.idCodigo3[form.idCodigo3.selectedIndex].value == '-1'
					|| form.qtTentativas3.value == ''
					|| form.qtTentativas3.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento4 != null && form.numeroDocumento4.value != '')
			...
			if (form.idCodigo4[form.idCodigo4.selectedIndex] == null
					|| form.idCodigo4[form.idCodigo4.selectedIndex].value == '-1'
					|| form.qtTentativas4.value == ''
					|| form.qtTentativas4.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento5 != null && form.numeroDocumento5.value != '')
			...
			if (form.idCodigo5[form.idCodigo5.selectedIndex] == null
					|| form.idCodigo5[form.idCodigo5.selectedIndex].value == '-1'
					|| form.qtTentativas5.value == ''
					|| form.qtTentativas5.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento6 != null && form.numeroDocumento6.value != '')
			...
			if (form.idCodigo6[form.idCodigo6.selectedIndex] == null
					|| form.idCodigo6[form.idCodigo6.selectedIndex].value == '-1'
					|| form.qtTentativas6.value == ''
					|| form.qtTentativas6.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento7 != null && form.numeroDocumento7.value != '')
			...
			if (form.idCodigo7[form.idCodigo7.selectedIndex] == null
					|| form.idCodigo7[form.idCodigo7.selectedIndex].value == '-1'
					|| form.qtTentativas7.value == ''
					|| form.qtTentativas7.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento8 != null && form.numeroDocumento8.value != '')
			...
			if (form.idCodigo8[form.idCodigo8.selectedIndex] == null
					|| form.idCodigo8[form.idCodigo8.selectedIndex].value == '-1'
					|| form.qtTentativas8.value == ''
					|| form.qtTentativas8.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento9 != null && form.numeroDocumento9.value != '')
			...
			if (form.idCodigo9[form.idCodigo9.selectedIndex] == null
					|| form.idCodigo9[form.idCodigo9.selectedIndex].value == '-1'
					|| form.qtTentativas9.value == ''
					|| form.qtTentativas9.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento10 != null && form.numeroDocumento10.value != '')
			...
			if (form.idCodigo10[form.idCodigo10.selectedIndex] == null
					|| form.idCodigo10[form.idCodigo10.selectedIndex].value == '-1'
					|| form.qtTentativas10.value == ''
					|| form.qtTentativas10.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento11 != null && form.numeroDocumento11.value != '')
			...
			if (form.idCodigo11[form.idCodigo11.selectedIndex] == null
					|| form.idCodigo11[form.idCodigo11.selectedIndex].value == '-1'
					|| form.qtTentativas11.value == ''
					|| form.qtTentativas11.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento12 != null && form.numeroDocumento12.value != '')
			...
			if (form.idCodigo12[form.idCodigo12.selectedIndex] == null
					|| form.idCodigo12[form.idCodigo12.selectedIndex].value == '-1'
					|| form.qtTentativas12.value == ''
					|| form.qtTentativas12.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento13 != null && form.numeroDocumento13.value != '')
			...
			if (form.idCodigo13[form.idCodigo13.selectedIndex] == null
					|| form.idCodigo13[form.idCodigo13.selectedIndex].value == '-1'
					|| form.qtTentativas13.value == ''
					|| form.qtTentativas13.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento14 != null && form.numeroDocumento14.value != '')
			...
			if (form.idCodigo14[form.idCodigo14.selectedIndex] == null
					|| form.idCodigo14[form.idCodigo14.selectedIndex].value == '-1'
					|| form.qtTentativas14.value == ''
					|| form.qtTentativas14.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento15 != null && form.numeroDocumento15.value != '')
			...
			if (form.idCodigo15[form.idCodigo15.selectedIndex] == null
					|| form.idCodigo15[form.idCodigo15.selectedIndex].value == '-1'
					|| form.qtTentativas15.value == ''
					|| form.qtTentativas15.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento16 != null && form.numeroDocumento16.value != '')
			...
			if (form.idCodigo16[form.idCodigo16.selectedIndex] == null
					|| form.idCodigo16[form.idCodigo16.selectedIndex].value == '-1'
					|| form.qtTentativas16.value == ''
					|| form.qtTentativas16.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento17 != null && form.numeroDocumento17.value != '')
			...
			if (form.idCodigo17[form.idCodigo17.selectedIndex] == null
					|| form.idCodigo17[form.idCodigo17.selectedIndex].value == '-1'
					|| form.qtTentativas17.value == ''
					|| form.qtTentativas17.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento18 != null && form.numeroDocumento18.value != '')
			...
			if (form.idCodigo18[form.idCodigo18.selectedIndex] == null
					|| form.idCodigo18[form.idCodigo18.selectedIndex].value == '-1'
					|| form.qtTentativas18.value == ''
					|| form.qtTentativas18.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento19 != null && form.numeroDocumento19.value != '')
			...
			if (form.idCodigo19[form.idCodigo19.selectedIndex] == null
					|| form.idCodigo19[form.idCodigo19.selectedIndex].value == '-1'
					|| form.qtTentativas19.value == ''
					|| form.qtTentativas19.value == '0') {
				return false;
			}
		}
		...
		if ((form.numeroDocumento20 != null && form.numeroDocumento20.value != '')
			...
			if (form.idCodigo20[form.idCodigo20.selectedIndex] == null
					|| form.idCodigo20[form.idCodigo20.selectedIndex].value == '-1'
					|| form.qtTentativas20.value == ''
					|| form.qtTentativas20.value == '0') {
				return false;
			}
		}
		return true;
	...
	function ocultar() {
		var form = document.forms[0];
		var select = form.responsavelEntrega;
		var input = form.idResponsavelEntrega;
		var desc = form.descricaoResponsavelEntrega
		if (select.value != "") {
			input.value = "";
			desc.value = "";
			input.disabled = true;
...
<body leftmargin="5" topmargin="5"
	onload="javascript:setarFoco('${requestScope.nomeCampo}'); ocultar();">
				...
				<td width="625" valign="top" bgcolor="#003399" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Informar Documentos Não Entregues
								(Devolvidos)</td>
					...
					<table width="100%" border="0">
						...
						<tr>
							<td height="25"><strong>Data da Devolução:<font
									color="#FF0000">*</font></strong></td>
							<td align="right">
								<div align="left">
									<html:text property="dataDevolucao" size="10" maxlength="10"
										tabindex="1" onkeyup="mascaraData(this, event);" />
									<img border="0"
						...
						<tr>
							...
							<td><html:text property="idResponsavelEntrega" size="8"
								...
								href="javascript:abrirPopup('exibirPesquisarClienteAction.do?menu=sim');">
							...
							</a> <logic:present name="funcionalidadeEncontrada">
									...
									<logic:notEqual name="funcionalidadeEncontrada"
										value="exception">
										<html:text property="descricaoResponsavelEntrega" size="40"
								...
								</logic:notPresent> <a href="javascript:limparDescricaoResponsavelEntrega()"> <img
									border="0" title="Apagar"
									src="<bean:message key='caminho.imagens'/>limparcampo.gif" />
							</a></td>
							<td><strong>Ou:</strong> <html:select
									property="responsavelEntrega" tabindex="3" style="width: 150 "
									onchange="ocultar();">
									<html:option value="">&nbsp;</html:option>
									<html:option value="CORREIO">CORREIO</html:option>
									<html:option value="LEITURA TERCEIRIZADA">LEITURA TERCEIRIZADA</html:option>
									<html:option value="FUNCIONARIO - FISCAL">FUNCIONARIO - FISCAL</html:option>
									<html:option value="FUNCIONARIO - MOTORISTA">FUNCIONARIO - MOTORISTA</html:option>
						...
						<tr>
							...
							<td colspan="2" align="left"><html:select
									property="tipoDocumento" tabindex="3"
							...
							<td colspan="4">
								<table bgcolor="#99ccff" width="100%">
									...
									<tbody>
										...
										<logic:present name="exibirTabela" scope="request">
											<td width="12%" align="center"><html:text
													property="matricula1" size="9" maxlength="9" tabindex="5" /></td>
										</logic:present>
										<logic:notPresent name="exibirTabela" scope="request">
											<td width="12%" align="center"><html:text
													property="numeroDocumento1" size="9" maxlength="9"
													tabindex="5" /></td>
										</logic:notPresent>

										<td width="28%" align="center"><html:select
												property="idCodigo1" tabindex="6">
												<html:option
													value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
										...
										<logic:present name="exibirTabela" scope="request">
											<td width="12%" align="center"><html:text
													property="matricula2" size="9" maxlength="9" tabindex="8" /></td>
										</logic:present>
										<logic:notPresent name="exibirTabela" scope="request">
											<td width="12%" align="center"><html:text
													property="numeroDocumento2" size="9" maxlength="9"
													tabindex="8" /></td>
										</logic:notPresent>

										<td width="28%" align="center"><html:select
												property="idCodigo2" tabindex="9">
												<html:option
													value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
												<html:options collection="colecaoMotivosNaoEntrega"
										...
										<td width="10%" align="center"><html:text
												property="qtTentativas2" size="1" maxlength="1"
												tabindex="10" /></td>
										<tr>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula3" size="9" maxlength="9" tabindex="11" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
											...
											<td width="28%" align="center"><html:select
													property="idCodigo3" tabindex="12">
													<html:option
														value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
													<html:options collection="colecaoMotivosNaoEntrega"
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas3" size="1" maxlength="1"
													tabindex="13" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula4" size="9" maxlength="9" tabindex="14" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
											...
											<td width="28%" align="center"><html:select
													property="idCodigo4" tabindex="15">
													<html:option
														value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
													<html:options collection="colecaoMotivosNaoEntrega"
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas4" size="1" maxlength="1"
													tabindex="16" /></td>
										</tr>
										<tr>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula5" size="9" maxlength="9" tabindex="17" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
											...
											<td width="28%" align="center"><html:select
													property="idCodigo5" tabindex="18">
													<html:option
														value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
													<html:options collection="colecaoMotivosNaoEntrega"
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas5" size="1" maxlength="1"
													tabindex="19" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula6" size="9" maxlength="9" tabindex="20" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
											...
											<td width="28%" align="center"><html:select
													property="idCodigo6" tabindex="21">
													<html:option
														value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
													<html:options collection="colecaoMotivosNaoEntrega"
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas6" size="1" maxlength="1"
													tabindex="22" /></td>
										</tr>
										<tr>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula7" size="9" maxlength="9" tabindex="23" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
											...
											<td width="28%" align="center"><html:select
													property="idCodigo7" tabindex="24">
													<html:option
														value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
													<html:options collection="colecaoMotivosNaoEntrega"
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas7" size="1" maxlength="1"
													tabindex="25" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula8" size="9" maxlength="9" tabindex="26" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
											...
											<td width="28%" align="center"><html:select
													property="idCodigo8" tabindex="27">
													<html:option
														value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
													<html:options collection="colecaoMotivosNaoEntrega"
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas8" size="1" maxlength="1"
													tabindex="28" /></td>
										</tr>
										<tr>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula9" size="9" maxlength="9" tabindex="29" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
											...
											<td width="28%" align="center"><html:select
													property="idCodigo9" tabindex="30">
													<html:option
														value="<%=""
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
													<html:options collection="colecaoMotivosNaoEntrega"
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas9" size="1" maxlength="1"
													tabindex="31" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula10" size="9" maxlength="9"
														tabindex="32" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas10" size="1" maxlength="1"
													tabindex="34" /></td>
										</tr>
										<tr>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula11" size="9" maxlength="9"
														tabindex="35" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas11" size="1" maxlength="1"
													tabindex="37" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula12" size="9" maxlength="9"
														tabindex="38" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas12" size="1" maxlength="1"
													tabindex="40" /></td>
										</tr>
										<tr>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula13" size="9" maxlength="9"
														tabindex="41" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas13" size="1" maxlength="1"
													tabindex="43" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula14" size="9" maxlength="9"
														tabindex="44" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas14" size="1" maxlength="1"
													tabindex="46" /></td>
										</tr>
										<tr>
											<%-- FIM SETIMA LINHA--%>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula15" size="9" maxlength="9"
														tabindex="47" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas15" size="1" maxlength="1"
													tabindex="49" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula16" size="9" maxlength="9"
														tabindex="50" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas16" size="1" maxlength="1"
													tabindex="52" /></td>
										</tr>
										<tr>
											<%-- FIM OITAVA LINHA--%>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula17" size="9" maxlength="9"
														tabindex="53" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas17" size="1" maxlength="1"
													tabindex="55" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula18" size="9" maxlength="9"
														tabindex="56" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas18" size="1" maxlength="1"
													tabindex="58" /></td>
										</tr>
										<tr>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula19" size="9" maxlength="9"
														tabindex="59" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="8%" align="center"><html:text
													property="qtTentativas19" size="1" maxlength="1"
													tabindex="61" /></td>
											...
											<logic:present name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
														property="matricula20" size="9" maxlength="9"
														tabindex="62" /></td>
											</logic:present>
											<logic:notPresent name="exibirTabela" scope="request">
												<td width="12%" align="center"><html:text
									...
									+ ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
											...
											<td width="10%" align="center"><html:text
													property="qtTentativas20" size="1" maxlength="1"
													tabindex="64" /></td>
										</tr>
