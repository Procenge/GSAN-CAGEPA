...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="IndiceAcrescimosImpontualidadeForm" dynamicJavascript="false" />
...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}');desabilitaCalcular();">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text property="mesAnoReferencia"	size="9" onblur="loadPagina('nao');" onkeyup="mascaraAnoMes(this, event);" maxlength="7" tabindex="1"/></td>
				</tr>
				<tr> 
                    <td><strong>Percentual Multa:<font color="#FF0000">*</font></strong></td>
				     <td width="25%"><html:text maxlength="6" property="percentualMulta" onkeyup="formataValorMonetario(this, 6)" size="6" tabindex="2"/>
				     </td>
              </tr>
              <tr> 
                    <td><strong>Percentual Juros de Mora:<font color="#FF0000">*</font></strong></td>
				     <td width="25%"><html:text maxlength="6" property="percentualJurosMora" onkeyup="formataValorMonetario(this, 6)" size="6" tabindex="3"/>
				     </td>
              </tr>
              
              <logic:present name="exibirCalcularFatorCorrecao" scope="session">
	              <tr> 
	                    <td><strong>Percentual Fator Atualização Monetária:<font color="#FF0000">*</font></strong></td>
					     <td width="25%"><html:text maxlength="6" property="percentualAtualizacaoMonetaria" onkeyup="formataValorMonetario(this, 6);document.forms[0].fatorCorrecao.value='';desabilitaCalcular();" size="6" tabindex="4" />
					     &nbsp;<input name="botaoCalcular" type="button"
									class="bottonRightCol" value="Calcular" onclick="loadPagina('sim');">
					     </td>
	              </tr>
	              
	              <tr> 
	                    <td><strong>Fator de Correção Calculado:</strong></td>
					     <td width="25%"><html:text maxlength="6" property="fatorCorrecao" size="6" readonly="true"/>
					     </td>
	              </tr>
              </logic:present>
              
              <logic:notPresent name="exibirCalcularFatorCorrecao" scope="session">
	               <tr> 
	                    <td><strong>Fator de Correção Calculado:<font color="#FF0000">*</font></strong></td>
					     <td width="25%"><html:text maxlength="6" property="fatorCorrecao" size="6"/>
					     </td>
	               </tr>
              </logic:notPresent>
				...
				<td colspan="2">
					<table width="100%" border="0">
						<tr>
							...
							<td valign="top">
							  <div align="right">
							    <gcom:controleAcessoBotao name="botaoInformar" value="Informar" onclick="validarForm(document.forms[0]);" url="informarIndiceAcrescimosImpontualidadeAction.do" tabindex="5"/>
