	...
	<tr>
		...
		<table width="100%" border="0" bgcolor="#79bbfd" align="center"
			...
			<tr bgcolor="#79bbfd" height="18">
				<td align="center" class="style11"><strong>Comandos de Ação de Cobrança Eventuais</strong></td>
			</tr>
		</table>
				...
				cor = "#cbe5fe";%>
										<tr bgcolor="#cbe5fe">
											...
											<logic:notEmpty	name="caminhoRetornoTelaPesquisaAcaoCobranca">
												<a href="javascript:enviarDadosParametrosFecharPopup('<bean:write name="caminhoRetornoTelaPesquisaAcaoCobranca"/>','<bean:write name="cobrancaAcaoAtividadeComando" property="id"/>', '<bean:write name="cobrancaAcaoAtividadeComando" property="descricaoTitulo"/>', 'cobrancaAcaoAtividadeComando');">
											...
											<logic:empty name="caminhoRetornoTelaPesquisaAcaoCobranca">
												<a href="javascript:enviarDados('<bean:write name="cobrancaAcaoAtividadeComando" property="id"/>', '<bean:write name="cobrancaAcaoAtividadeComando" property="descricaoTitulo"/>', 'cobrancaAcaoAtividadeComando');">
