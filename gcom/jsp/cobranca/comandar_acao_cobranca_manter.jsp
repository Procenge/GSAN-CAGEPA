	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="8">
						<strong>Atividades de A&ccedil;&atilde;o de Cobran&ccedil;a do Cronograma Comandadas</strong>
					</td>
				</tr>
				<tr>
					<td colspan="2">
					...
					<table width="100%" bgcolor="#99CCFF">
						<tr bordercolor="#90c7fc">
							...
							<td width="26%" colspan="2" bgcolor="#90c7fc">
				...
				cor = "#cbe5fe";%>
								<tr bgcolor="#cbe5fe">
									...
									<td width="6%">
									  <div align="center">
									  	<strong> 
									  	  <input type="checkbox" name="idCobrancaAcaoAtividadeCronograma" id="1" value="<bean:write	name="cobrancaAcaoAtividadeCronograma" property="id" />" />
										</strong>
									  </div>
									</td>
									...
									<td width="7%">
									  <div align="center">
									    ...
									    <logic:notEmpty name="cobrancaAcaoAtividadeCronograma" property="cobrancaAcaoCronograma.cobrancaGrupoCronogramaMes.cobrancaGrupo" >  
									...
									<td width="13%">
									  <div align="center">
										<bean:write name="cobrancaAcaoAtividadeCronograma" format="dd/MM/yyyy" property="comando" />
									  </div>
									</td>
									<td width="13%">
									  <div align="center">
										<bean:write name="cobrancaAcaoAtividadeCronograma" format="HH:mm:ss" property="comando" />
									  </div>
									</td>
									<td width="13%">
									  <div align="center">
										<bean:write name="cobrancaAcaoAtividadeCronograma" format="dd/MM/yyyy" property="dataPrevista" />
									  </div>
									</td>
								</tr>
							</logic:iterate>
				...
				<tr bordercolor="#cbe5fe">
					<td colspan="8" bgcolor="#cbe5fe">
					  <div align="left">
					    <gcom:controleAcessoBotao name="Button2" value="Remover" onclick="javascript:excluirComandoAtividadeCronogramaAcaoCobranca(idCobrancaAcaoAtividadeCronograma, 'checkbox');" url="excluirComandoAtividadeCronogramaAcaoCobrancaAction.do"/>
				...
				<tr>
					<td>
					  <strong>Atividades de A&ccedil;&atilde;o de Cobran&ccedil;a Eventuais Comandadas</strong>
					</td>
				</tr>
			...
			%></div>
				...
				<tr bordercolor="#cbe5fe">
					...
					<div align="left">
					  <gcom:controleAcessoBotao name="Button2" value="Remover" onclick="javascript:excluirComandoAtividadeEventualCobranca(idCobrancaAcaoAtividadeComando, 'checkbox');" url="excluirComandoAtividadeEventualAcaoCobrancaAction.do"/>
