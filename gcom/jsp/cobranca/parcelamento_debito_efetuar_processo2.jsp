...
// Faz as validações do formulário
	...
	function limpaRadioButton(nomeCampo) {
		// Este método está causando falha no pareclamento, o evento correto é o botão de Limpar EP/NB 
	    /*
	...
	function selecionarDebitos() {
		...
		// Caso só tenha 1 elemento, docLength será 'undefined' 
		if (typeof docLength == 'undefined') {
		...
		// Caso só tenha mais de 1 elemento
		} else {
...
<% } %>
			...
			<table width="100%" border="0">
					...
					<table width="100%" bgcolor="#99CCFF">
						<logic:empty name="colecaoContaValores" scope="session">
							<tr bgcolor="#90c7fc">
								...
								<td align="center" width="62"><strong>Mês/Ano</strong></td>
								<td align="center" width="90"><strong>Vencimento</strong></td>
								<td align="center" width="80"><strong>Valor Conta</strong></td>
								<td align="center" width="80"><strong>Acrésc. Impont.</strong></td>
								
								<logic:equal name="pIndicadorPossuiDividaAtiva" value="<%="" + ConstantesSistema.SIM%>" scope="session">
									<td align="center" width="160">
										<table bgcolor="#99CCFF" width="100%">
											<tr align="center" bgcolor="#90c7fc">
												<td align="center" width="100%" colspan="2"><strong>Sucumbência</strong></td>
											</tr>
											<tr bgcolor="#90c7fc">
												<td align="center" width="50%" bgcolor="#cbe5fe"><strong>Valor</strong></td>
												<td align="center" width="50%" bgcolor="#cbe5fe"><strong>Acrésc.</strong></td>
											</tr>
										</table>
									</td>
								</logic:equal>
									...
									<td align="center" width="160">
										<table bgcolor="#99CCFF" width="100%">
											...
											<tr bgcolor="#cbe5fe">
												...
												<td align="center" width="50%"><strong>Acrésc.</strong></td>
											</tr>
										</table>
									</td>
								</logic:equal>								
					...
					<td colspan="3" height="23">
						<font color="#000000" style="font-size:10px" face="Verdana, Arial, Helvetica, sans-serif"> 
							<strong>EP-Entrada de Parcelamento; NB-Conta Paga e Ainda N&atilde;o Baixada; 
								<logic:equal name="pIndicadorPossuiDividaAtiva" value="<%="" + ConstantesSistema.SIM%>" scope="session">
									<br>SC-Integra a base de cálculo do valor de Sucumbência
								</logic:equal>
							</strong>
						</font><br>
						...
						<font color="#0000ff" style="font-size:10px" face="Verdana, Arial, Helvetica, sans-serif"> 
							Contas em Cobrança Bancária
						</font><br>
						<font color="#000000" style="font-size:10px" face="Verdana, Arial, Helvetica, sans-serif"> 
							<logic:equal name="pIndicadorPossuiDividaAtiva" value="<%="" + ConstantesSistema.SIM%>" scope="session">
								N-Normal; A-Inscrita em Dívida Ativa; E-Execução Fiscal 
							</logic:equal>
					...
					<table width="100%" bgcolor="#99CCFF">
						<logic:empty name="colecaoGuiaPagamentoValores" scope="session">
							<tr bgcolor="#90c7fc">
								...
								<td align="center" width="20"><strong>&nbsp;</strong></td>
								<td align="center" width="80"><strong>Número da Guia</strong></td>
								<td align="center" width="30"><strong>Prest.</strong></td>
								<td align="center" width="80"><strong>Data de Emissão</strong></td>
								<td align="center" width="80"><strong>Data de Vencimento</strong></td>
								<td align="center" width="70"><strong>Valor</strong></td>
								<td align="center" width="70"><strong>Acrésc. por Impont.</strong></td>
				...
				<tr>
					<td colspan="4" height="23"><strong>Débitos A Cobrar:</strong></td>
				</tr>
				<% cont = 0;%>
				<tr>
					<td colspan="4">
					<table width="100%" bgcolor="#99CCFF">
						<logic:empty name="colecaoDebitoACobrarValores" scope="session">
							<tr bgcolor="#90c7fc">
								...
								<td align="center" width="15%"><strong>Tipo do Débito</strong></td>
								<td align="center" width="10%"><strong>Mês/Ano Referência</strong></td>
								<td align="center" width="15%"><strong>Mês/Ano Cobrança </strong></td>
								<td align="center" width="15%"><strong>Parcelas a cobrar</strong></td>
								<td align="center" width="20%"><strong>Valor a cobrar</strong></td>
								<td align="center" width="15%"><strong>Dias Suspensão Lançamento</strong></td>
							</tr>
						</logic:empty>
						<logic:notEmpty name="colecaoDebitoACobrarValores" scope="session">
							...
							<tr bgcolor="#90c7fc">
								...
								<td align="center" width="15%"><strong>Parcelas a cobrar</strong></td>
								<td align="center" width="20%"><strong>Valor a cobrar</strong></td>
								<td align="center" width="15%"><strong>Dias Suspensão Lançamento</strong>
								</td>
							</tr>
							<tr>
