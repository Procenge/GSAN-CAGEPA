					...
					<table width="100%" bgcolor="#99CCFF">
						<logic:empty name="colecaoGuiaPagamentoValores" scope="session">
							<tr bgcolor="#90c7fc">
								...
								<td align="center" width="15%"><strong>Número da Guia</strong></td>
								<td align="center" width="10%"><strong>Prest.</strong></td>
								<td align="center" width="15%"><strong>Data de Emissão</strong></td>
								<td align="center" width="15%"><strong>Data de Vencimento</strong></td>
								<td align="center" width="20%"><strong>Valor</strong></td>
								<td align="center" width="15%"><strong>Acrésc. por Impont.</strong></td>
							</tr>
						</logic:empty>
						<logic:notEmpty name="colecaoGuiaPagamentoValores" scope="session">
							...
							<tr bgcolor="#90c7fc">
								...
								<td align="center" width="15%"><strong>Data de Vencimento</strong></td>
								<td align="center" width="20%"><strong>Valor</strong></td>
								<td align="center" width="15%"><strong>Acrésc. por Impont.</strong>
								</td>
							</tr>
							<tr>
