...
<table width="770" border="0" cellspacing="4" cellpadding="0">
  <tr>
	...
	<td>
        ...
        <tr>
        	<td>
				<gcom:controleAcessoBotao name="Button" value="Remover" onclick="verficarSelecao(cobrancaAcaoSelectID)" url="removerAcaoCobrancaAction.do" align="left"/>
				<input name="Button" type="button" class="bottonRightCol" value="Voltar Filtro" onclick="window.location.href='/gsan/exibirFiltrarAcaoCobrancaAction.do?desfazer=N'" align="left" style="width: 80px;"> 
			</td>
