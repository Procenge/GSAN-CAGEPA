 ...
 var bCancel = false;
    ...
    function validateCobrancaActionForm(form) {
      ...
      return true;
       ...
       return validaGrupo() && validaMesAno(form.mesAno);
   }
    ...
    <td width="625" valign="top" class="centercoltext">
	  ...
	  <table width="100%" border="0">
        ...
        <tr>
          ...
          <td width="90%"><html:select property="idGrupoCobranca">
        ...
        <tr>
          ...
          <td align="right">
            <gcom:controleAcessoBotao name="Button" value="Filtrar" onclick="javascript:chamarFiltrar();" url="filtrarCobrancaCronogramaAction.do"/>
