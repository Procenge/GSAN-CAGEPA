					...
					<td colspan="3" align="right">
						<table border="0">
							<tr>
								...
								<td align="right">						
								  <gcom:controleAcessoBotao name="Button322" value="Concluir" onclick="concluircomando(idComando, 'radio');" url="manterComandoAcaoCobrancaEventualCriterioComandoConcluirAction.do"/>
