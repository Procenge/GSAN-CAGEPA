...
function duplicarLocalidade(){
	...
	formulario.setorComercialOrigemCD.readOnly = false;
	formulario.setorComercialDestinoCD.readOnly = false;
...
<form action="/exibirFiltrarComandosAcaoCobrancaEventualAction"
	name="FiltrarComandosAcaoCobrancaEventualActionForm" method="post"><%@ include
	...
	<tr>
		...
		<table width="100%" border="0" dwcopytype="CopyTableRow">
			...
			<tr>
				...
				<div align="left"><html:text maxlength="6"
					property="criterioCobranca" size="6" tabindex="5"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
					onkeypress="validaEnter(event, 'exibirFiltrarComandosAcaoCobrancaEventualAction.do','criterioCobranca');" />
				<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
					...
					alt="Pesquisar"> <strong> <logic:present name="corCriterioCobranca">
					...
					<logic:empty name="FiltrarComandosAcaoCobrancaEventualActionForm"
						...
						<html:text property="nomeCriterioCobranca" value="" size="40"
							maxlength="40" readonly="true"
							name="FiltrarComandosAcaoCobrancaEventualActionForm"
							style="background-color:#EFEFEF; border:0; color: #ff0000" />
					</logic:empty>
					...
					onclick="limparCriterioCobranca()" name="imagem"></strong></div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="right" colspan="4">
					<div align="left">
						...
						property="localidadeOrigemID" size="3" tabindex="9"
						name="FiltrarComandosAcaoCobrancaEventualActionForm"
			...
			<tr>
				...
				<td align="right" colspan="4">
				<div align="left"><html:text maxlength="3" tabindex="10"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
				...
				<a href="javascript:limparOrigem(2);"> <img
				src="<bean:message key="caminho.imagens"/>limparcampo.gif"
				border="0" title="Apagar" /></a> <html:hidden property="setorComercialOrigemID"
					name="FiltrarComandosAcaoCobrancaEventualActionForm" /></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td align="right" colspan="4">
				<div align="left">
						<html:text maxlength="4" tabindex="11"
						property="rotaInicial" size="4"
						onchange="limparRotaQuadra(this)" 
						name="FiltrarComandosAcaoCobrancaEventualActionForm"/> 
			...
			<tr>
				...
				<td width="37%" align="left" colspan="4"><html:text maxlength="3"
					property="localidadeDestinoID" size="3" tabindex="12"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
				...
				<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
					...
					alt="Pesquisar"> <logic:present name="corLocalidadeDestino">
			...
			<tr>
				...
				<td align="left" colspan="4"><html:text maxlength="3"
					...
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
					onkeyup="javascript:validarExistenciaSetorComercialInicial();habilitarQuadraRota();"
					onkeypress="validaEnterDependenciaComMensagem(event, 'exibirFiltrarComandosAcaoCobrancaEventualAction.do?objetoConsulta=2&inscricaoTipo=destino&validarCriterio=naoAcao', document.forms[0].setorComercialDestinoCD, document.forms[0].localidadeDestinoID.value, 'Localidade Final', 'Setor Comercial Final');"
					onfocus="validarLocalidade();" /> <img
					src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23"
					height="21" style="cursor:hand;" name="imagem"
					onclick="javascript:pesquisarSetorComercial('setorComercialDestinoCD');;"
					alt="Pesquisar"> <logic:present name="corSetorComercialDestino">
			...
			<tr>
				...
				<div align="left"><strong>
						<html:text maxlength="4" tabindex="14"
			...
			<tr>
				...
				<td colspan="4"><strong> <html:text maxlength="9"
					property="idCliente" size="9" tabindex="15"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
					onkeyup="javaScript:validarCliente(1);desabilitarLocalidadeCobrancaAcao();"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
					onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarComandosAcaoCobrancaEventualAction.do?objetoConsulta=3&inscricaoTipo=destino&validarCriterio=naoAcao', 'idCliente', 'Cliente');" />
				<a
				...
				</logic:present> <logic:notPresent name="codigoClienteNaoEncontrado"
					scope="request">
			...
			<tr>
				...
				<td colspan="4"><strong> <html:text maxlength="10" tabindex="17"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
					property="periodoComandoInicial" size="10"
					onkeyup="javascript:mascaraData(this, event);duplicaPeriodoComando();" />
				<a
					href="javascript:abrirCalendarioReplicando('FiltrarComandosAcaoCobrancaEventualActionForm', 'periodoComandoInicial',
					'periodoComandoFinal')">
				<img border="0"
					src="<bean:message key='caminho.imagens'/>calendario.gif"
					width="20" border="0" align="middle" alt="Exibir Calendário" /></a>
				<strong> a</strong> <html:text maxlength="10"
					name="FiltrarComandosAcaoCobrancaEventualActionForm" tabindex="18"
					property="periodoComandoFinal" size="10"
					onkeyup="javascript:mascaraData(this, event);" /> <a
					href="javascript:abrirCalendario('FiltrarComandosAcaoCobrancaEventualActionForm', 'periodoComandoFinal')">
				<img border="0"
					src="<bean:message key='caminho.imagens'/>calendario.gif"
					width="20" border="0" align="middle" alt="Exibir Calendário" /></a>
				</strong></td>
			...
			<tr>
				...
				<td colspan="4"><strong> <html:text maxlength="10" tabindex="19"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
				...
				<a
					href="javascript:abrirCalendarioReplicando('FiltrarComandosAcaoCobrancaEventualActionForm', 'periodoRealizacaoComandoInicial',
					'periodoRealizacaoComandoFinal')">
				<img border="0"
					src="<bean:message key='caminho.imagens'/>calendario.gif"
					width="20" border="0" align="middle" alt="Exibir Calendário" /></a>
				<strong> a</strong> <html:text maxlength="10" tabindex="20"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
					property="periodoRealizacaoComandoFinal" size="10"
					onkeyup="javascript:mascaraData(this, event);" /> <a
					href="javascript:abrirCalendario('FiltrarComandosAcaoCobrancaEventualActionForm', 'periodoRealizacaoComandoFinal')">
				<img border="0"
					src="<bean:message key='caminho.imagens'/>calendario.gif"
					width="20" border="0" align="middle" alt="Exibir Calendário" /></a>
				</strong></td>
			...
			<tr>
				...
				Contas:</strong></td>
				<td colspan="4"><strong><strong> <html:text maxlength="7" tabindex="21"
					name="FiltrarComandosAcaoCobrancaEventualActionForm"
					...
					maxlength="7" name="FiltrarComandosAcaoCobrancaEventualActionForm" tabindex="22"
			...
			<tr>
				...
				<table border="0" align="right">
					<tr>
						...
						<td align="right">
						  <gcom:controleAcessoBotao name="concluir" value="Filtrar" onclick="javascript:filtrar();" url="filtrarComandosAcaoCobrancaEventualAction.do" tabindex="38"/>
						  <%-- <input name="concluir" type="button" tabindex="38" class="bottonRightCol" onClick="javascript:filtrar();" value="Filtrar" />--%>
						</td>
					</tr>
				</table>
				</td>
