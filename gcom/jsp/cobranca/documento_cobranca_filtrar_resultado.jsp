							...
							<logic:iterate name="colecaoDocumentoCobranca"
								...
								<%	}	%>
										...
										<td width="70" align="center">
											...
											<logic:notPresent name="ehPopup">
											   <html:link href="/gsan/exibirApresentarItensDocumentoCobrancaAction.do" 
													...
													${cobrancaDocumentoHelper.cobrancaDocumento.numeroSequenciaDocumento}
											   </html:link>
										...
										<td width="95" align="left">
											${cobrancaDocumentoHelper.cobrancaDocumento.documentoEmissaoForma.descricaoDocumentoEmissaoForma}
										</td>
