...
//});
 ...
 function caracteresespeciais () { 
     ...
     this.ac = new Array("numeroPrestacacoesDescumpridasConsecutivas", "Número de Prestações Descumpridas Consecutivas para Cobrança de Multa possui caracteres especiais.", new Function ("varName", " return this[varName];"));
  }
 ...
 function InteiroZeroPositivoValidations () {
     ...
     this.ad = new Array("numeroPrestacacoesDescumpridasConsecutivas", "Número de Prestações Descumpridas Consecutivas para Cobrança de Multa deve Somente Conter Números Positivos ou Zero.", new Function ("varName", " return this[varName];"));
 }
		...
		<td valign="top" class="centercoltext">
			...
			<table width="100%" border="0">
				...
				<tr>
              	...
              	<tr> 
                	<td><strong> Percentual de Desconto sobre os Acréscimos por Impontualidade:</strong></td>
                	<td>
					...
					<table width="100%" border="0" bgcolor="90c7fc">
						...
						<logic:empty name="collectionParcelamentoDescontoAntiguidade" scope="session">
							<tr bordercolor="#000000" bgcolor="#90c7fc">
								...
								<td rowspan="2" width="25%" align="center"><strong>Qtde. Mínima Meses de Débito</strong></td>
						...
						<logic:notEmpty name="collectionParcelamentoDescontoAntiguidade" scope="session">
							...
							<%} else {%>
								...
								<tr bordercolor="#000000" bgcolor="#90c7fc">
									<td rowspan="2" align="center" width="10%"><strong>Remover</strong></td>
									<td rowspan="2" width="23%" align="center"><strong>Qtde. Mínima Meses de Débito</strong></td>
									<td colspan="3"align="center"><strong>Percentual de Desconto</strong></td>
								</tr>
								<tr  bgcolor="#cbe5fe">
