...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="GerarMovimentoCobrancaBancariaBancoActionForm"/>
<script>
<!--

var bCancel = false; 

   function validateGerarMovimentoCobrancaBancariaBancoActionForm(form) {
...
function recuperarDadosSeisParametros(codigoRegistro, descricaoRegistro1, descricaoRegistro2, descricaoRegistro3, descricaoRegistro4, tipoConsulta) { 
	var form = document.GerarMovimentoCobrancaBancariaBancoActionForm;
...
function chamaPopup(){
var form = document.GerarMovimentoCobrancaBancariaBancoActionForm;
 if(form.opcaoMovimentoCobrancaBancaria[1].checked){
...
var form = document.GerarMovimentoCobrancaBancariaBancoActionForm;
 if(form.opcaoMovimentoCobrancaBancaria[0].checked){
...
var form = document.GerarMovimentoCobrancaBancariaBancoActionForm;
form.action = 'exibirGerarMovimentoCobrancaBancariaBancoAction.do?limpaColecao=1';
form.submit();
}
...
var mensagem = '';
	...
	if(mensagem != ''){
		...
		form.action = 'exibirGerarMovimentoCobrancaBancariaBancoAction.do?criaColecaoBanco=true';
...
var form = document.GerarMovimentoCobrancaBancariaBancoActionForm;
form.reset();
form.action = 'exibirGerarMovimentoCobrancaBancariaBancoAction.do?menu=sim';
form.submit();
...
<html:form action="/gerarMovimentoCobrancaBancariaBancoAction"
	name="GerarMovimentoCobrancaBancariaBancoActionForm"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Movimento de Cobrança Bancária </td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">
					<p>Para gerar o movimento de cobrança bancária, informe os dados
					abaixo:</p>
					<p>&nbsp;</p>
					</td>
				</tr>
				<tr>
					<td colspan="2"><strong> 
					<html:radio
						property="opcaoMovimentoCobrancaBancaria" value="1"
						onclick="habilitaDesabilitaCampos();" />
					&nbsp; Gerar Movimento de
					Cobrança Bancária </strong></td>
				</tr>
				

				<tr>
					<td width="25%"><strong>Mês/ano de Faturamento:</strong></td>
				...
				<tr>
					...
					<table width="100%" cellpadding="0" cellspacing="0">
						...
						<logic:present name="boletoBancarioMovimentacaoBancosMap">
							<tr>
								...
								<table width="100%" bgcolor="#99CCFF">
									...
									<%int cont = 0;%>
									<logic:iterate name="boletoBancarioMovimentacaoBancosMap"
										id="boletoBancarioMovimentacaoBanco">
										<%cont = cont + 1;
							if (cont % 2 == 0) {%>
										<tr bgcolor="#cbe5fe">
											<%} else {
										...
										<tr bgcolor="#FFFFFF">
											...
											<div align="center"><input type="checkbox" checked
												...
												value="<bean:write name="boletoBancarioMovimentacaoBanco" property="key.id" />" /></div>
											</td>
											<td width="12%" align="center"><bean:write name="boletoBancarioMovimentacaoBanco"
												property="key.id" /></td> 
												
											<td width="50%"><bean:write name="boletoBancarioMovimentacaoBanco"
												property="key.descricao" /></td>
											<td align="center" width="30%"><%=((Collection)((Map.Entry)boletoBancarioMovimentacaoBanco).getValue()).size()%>
											</td>
											</tr>										
									</logic:iterate>
								</table>
				...
				<tr>
					<td colspan="2"><strong> <html:radio
						property="opcaoMovimentoCobrancaBancaria" value="2"
						onclick="habilitaCamposReGerarMovimento();" /> &nbsp;Regerar
					Arquivo TXT do Movimento de Cobrança Bancária </strong></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td valign="top">
					  <div align="right">
					    ...
					    <gcom:controleAcessoBotao name="botaoGerar" value="Gerar" onclick="javascript:gerar();" url="gerarMovimentoCobrancaBancariaBancoAction.do" tabindex="7"/>
					  </div>
					</td>
				</tr>
				<tr>
