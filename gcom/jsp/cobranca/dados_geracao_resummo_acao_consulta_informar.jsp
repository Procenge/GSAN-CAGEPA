	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="unidadeNegocio" size="4" maxlength="4" tabindex="5" onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaAction.do?pesquisarUnidadeNegocio=OK', 'unidadeNegocio', 'Unidade Negócio');"/>
			...
			<logic:notPresent name="corUnidadeNegocio">
				...
				<logic:empty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="unidadeNegocio">
				...
				<logic:notEmpty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="unidadeNegocio">
					<html:text property="descricaoUnidadeNegocio" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="quadra" size="4" maxlength="5" tabindex="8" onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaAction.do?pesquisarQuadra=OK', this, document.forms[0].setorComercial.value, 'Setor Comercial', 'Quadra');"/>
