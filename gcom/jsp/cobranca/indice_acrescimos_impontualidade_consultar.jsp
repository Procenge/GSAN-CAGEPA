		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Consultar Índice Acréscimos Impontualidade</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">
					<p>Para consultar os índices, informe os dados abaixo:</p>
					<p>&nbsp;</p>
					</td>
				</tr>
				<tr>
				...
				<td colspan="2">
					<table width="100%" border="0">
						<tr>
							<td valign="top">
							  <div align="right">
							    <gcom:controleAcessoBotao name="botaoInformar" value="Consultar" onclick="validarForm(document.forms[0]);" url="gerarIndicesAcrescimosImpontualidadeAction.do" tabindex="5"/>
