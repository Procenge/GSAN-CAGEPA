					...
					<tr>
						...
						<div align="left">
							...
							<input name="BaixarListaImoveis" type="button"
								...
								onclick="window.location.href='exibirComandosAcaoCobrancaCronogramaDadosComandoAction.do?idCobrancaAcaoAtividadeCronogramaListaImoveis=<%= request.getAttribute("idCobrancaAcaoAtividadeCronogramaListaImoveis") %>'"/>							
						</div>
						</td>
						</logic:present>
