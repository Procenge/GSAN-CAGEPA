				...
				<td>
					...
					<logic:iterate name="colecaoGuiaPagamento" id="guiaPagamentoValoresHelper" type="GuiaPagamentoValoresHelper">
						...
						<td align="center" width="5%">
							...
							value="<%="" + guiaPagamentoValoresHelper.getIdGuiaPagamento().intValue() %>">
						</td>
						<td width="35%" align="left">
							<a href="javascript:abrirPopup('exibirConsultarGuiaPagamentoAction.do?guiaPagamentoId=<%="" + guiaPagamentoValoresHelper.getIdGuiaPagamento().intValue() %>', 600, 800);">
								<logic:iterate name="guiaPagamentoValoresHelper" property="guiaPagamento.guiasPagamentoPrestacao" id="prestacao">
						...
						<td width="20%">
							<div align="right">
								...
								<%="" + Util.formatarMoedaReal(guiaPagamentoValoresHelper.getValorTotalPrestacao()).trim()%>
