  ...
  <td width="625" valign="top" class="centercoltext">
            ...
            <table width="100%" border="0" >
                ...
                <tr>
                  ...
                  <td>
                    <html:select property="idGrupoCobranca">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
               ...
               <tr> 
                 ...
                 <!-- ______________________  -->  
                   <% String cor = "#cbe5fe";%>
			       <logic:notEmpty name="acoesCobranca">
			       <logic:iterate name="acoesCobranca" id="acaoCobranca">
		         <!-- ______________________  -->      
				                        ...
				                        <logic:iterate name="atividadesCobranca" id="atividadeCobranca">
				                          <%	if (cor.equalsIgnoreCase("#FFFFFF")){	%>
											...
											<%}%>
				                              ...
				                              <%
				                              if(!((CobrancaAtividade)atividadeCobranca).getId().equals(CobrancaAtividade.ENCERRAR)){
				                              %>  
				                                  <input type="text" maxlength="8" name="qtd_a<bean:write name="acaoCobranca" property="id"/>n<bean:write name="atividadeCobranca" property="id"/>" size="8" id="quantidadeMaximaDocumentos" />
				                              <%
				                              } else {
				                            	  out.println("&nbsp;");
				                              }
				                              ...
				                              <td width="25%" align="center">
				                                  <input type="text" maxlength="10" name="a<bean:write name="acaoCobranca" property="id"/>n<bean:write name="atividadeCobranca" property="id"/>" size="10" id="data" onkeypress="validaDataCompleta(this, event)" />
			...
			<table width="100%">
				<tr height="3">
                 ...
                 <tr>
                   ...
                   <td align="right">
                     <gcom:controleAcessoBotao name="adicionar" value="Inserir" onclick="javascript:validarForm(document.forms[0]);" url="inserirCobrancaCronogramaAction.do"/>
