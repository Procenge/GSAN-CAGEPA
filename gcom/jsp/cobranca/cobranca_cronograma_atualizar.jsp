											...
											<%}%>
				                              ...
				                              %>  
				                                  <input type="text" maxlength="8" name="qtd_a<bean:write name="acaoCobranca" property="id"/>n<bean:write name="atividadeCobranca" property="cobrancaAtividade.id"/>"
 				                                      value="<bean:write name="atividadeCobranca" property="quantidadeMaximaDocumentos" />" size="8" id="quantidadeMaximaDocumentos" />
				                              <%
				                              } else {
				                            	  out.println("&nbsp;");
				                              }
				...
				<tr>
					<td colspan="2" align="right">
						<input type="button" class="bottonRightCol" value="Adicionar Ação de Cobrança"
					      onClick="javascript:abrirPopup('exibirAdicionarAcaoCobrancaCronogramaPopupAction.do?limpar=sim&reload=S&adicionar=S', 400, 800);">
					</td>
				</tr>
				<tr>
				   <td colspan="3"><hr></td>
                 ...
                 <tr>
                   ...
                   <td align="right">
                     <gcom:controleAcessoBotao name="botaoAtualizar" value="Atualizar" onclick="javascript:validarForm();" url="atualizarCobrancaCronogramaAction.do"/>
