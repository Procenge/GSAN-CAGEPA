...
function validaTodosRadioButton(){
	...
	if(validaRadioButton(form.icEmpresaObrigatoria,"Empresa Obrigatória") != ""){
		mensagem = mensagem + validaRadioButton(form.icEmpresaObrigatoria,"Empresa Obrigatória")+"\n";
	}
...
function desfazer(){
	...
	form.negativador.value = '';
	form.icClienteUsuarioSemCPFCNPJ[0].checked = false;
	form.icClienteUsuarioSemCPFCNPJ[1].checked = false;
	form.icEnderecoSemCEP[0].checked = false;
	form.icEnderecoSemCEP[1].checked = false;
	...
	form.icEmpresaObrigatoria[0].checked = false;
	form.icEmpresaObrigatoria[1].checked = false;
	form.icEmpresaObrigatoria.value = '';	
...
function verificarExibirRD(){
	...
	var form = document.forms[0];
	form.action = 'exibirInserirAcaoCobrancaAction.do';
	form.submit();
}
			...
			<table width="100%" border="0">
              ...
              <tr> 
                ...
                <td width="25%">
                    <html:select property="idAcaoPredecessora" tabindex="3" onchange="habilitaNumeroDiasAcaoPredecessora();">
							...
							<logic:present name="colecaoAcaoPredecessora">
              ...
              <tr> 
               ...
               <tr> 
					 ...
					 <td>
	                  		<html:text property="numeroDiasVencimento" size="8"
             ...
             <tr> 
                ...
                <td width="25%">
                    <html:select property="idTipoDocumentoGerado" tabindex="6" onchange="verificarExibirRD()" tabindex="6">
							<html:option value="">&nbsp;</html:option>
              ...
              <tr> 
	            ...
	            <td width="40%">
               		<html:text maxlength="4" 
               			...
               			size="4" 
               			tabindex="9"
					 	onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirAcaoCobrancaAction.do', 'idCobrancaCriterio', 'Critério de Cobrança');document.forms[0].descricaoCobrancaCriterio.value = '';" />
              ...
              <tr> 
	            ...
	            <td>
	               <html:text maxlength="4" property="idServicoTipo" size="4" tabindex="10"
					 onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirAcaoCobrancaAction.do', 'idServicoTipo', 'Tipo de Serviço');document.forms[0].descricaoServicoTipo.value = '';" />
						...
						<logic:notEmpty name="AcaoCobrancaActionForm" property="idServicoTipo">
							<html:text property="descricaoServicoTipo" size="38" maxlength="30" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:notEmpty>
             ...
             <logic:equal name="AcaoCobrancaActionForm" property="idTipoDocumentoGerado" value="37">
             <tr> 
              ...
              <logic:notEqual name="AcaoCobrancaActionForm" property="idTipoDocumentoGerado" value="37">
              <tr> 
             ...
             <tr> 
				   ...
				   <td>
	                	<html:select property="acaoCobrancaEfeito"  tabindex="15">
	                		<html:option value="">&nbsp;</html:option>
	                		<logic:present name="colecaoAcaoCobrancaEfeito">
...
<tr> 
                  <td width="45%"><strong>Empresa Obrigatória:<font color="#FF0000">*</font></strong></td>

                  <td><html:radio property="icEmpresaObrigatoria" value="1" tabindex="38"/> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="icEmpresaObrigatoria" value="2" tabindex="39"/> 
                      <strong>N&atilde;o</strong></td>
                 </tr>                 
					...
					<table width="100%" border="0">
						<tr>
							<td valign="top"><input name="button" type="button"
								...
								onClick="window.location.href='/gsan/telaPrincipal.do'" tabindex="39"></td>
							<td valign="top">
							  <div align="right">
							    <gcom:controleAcessoBotao name="botaoInserir" value="Inserir" onclick="validarForm(document.forms[0]);" url="inserirAcaoCobrancaAction.do" tabindex="38"/>
