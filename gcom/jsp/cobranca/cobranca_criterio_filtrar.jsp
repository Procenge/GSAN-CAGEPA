				...
				<tr>
					...
					<table width="100%" border="0">
						...
						<tr>
		                 	...
		                 	<td>
		                 		<html:radio property="comCpf" value="1">
		                 			 <strong>
		                 			 	Sim
		                 			 </strong>
		                 		</html:radio>                 	
		                 	...
		                 	<td>
		                 		<html:radio property="comCpf" value="2">
		                 			<strong>
		                 				Não
		                 			</strong>
		                 		</html:radio>
		                 	...
		                 	<td>
		                 		<html:radio property="comCpf" value="3">
		                 			<strong>
		                 				Ambos
		                 			</strong>
		                 		</html:radio>                 	
		                ...
		                <tr>
		                 	...
		                 	<td>
		                 		<html:radio property="comTelefone" value="1">
		                 			<strong>
		                 			 	Sim
		                 			</strong>                 		
		                 		</html:radio>                 	
		                 	...
		                 	<td>
		                 		<html:radio property="comTelefone" value="2">
		                 			<strong>
		                 				Não
		                 			</strong>
		                 		</html:radio>   
		                 	...
		                 	<td>
		                 		<html:radio property="comTelefone" value="3">
		                 			<strong>
		                 				Ambos
		                 			</strong>
		                 		</html:radio>                 	
