...
<script language="JavaScript">
  ...
  function abrirPopUPRegistroContaHistorico(idContaHistorico,tipoConta){     
  		abrirPopup('exibirConsultarContaAction.do?contaHistoricoID='+idContaHistorico+'&'+'tipoConsulta='+tipoConta, 410, 790);
  }
...
<table width="750" border="0" cellspacing="5" cellpadding="0">
	<tr>
		...
		<table width="707" border="0" cellpadding="0" cellspacing="5">
  <tr> 
    <td width="697" valign="top" class="centercoltext"> <table height="100%">
        <tr> 
          <td></td>
        </tr>
      </table>
								...
								<logic:iterate name="collNegativadorMovimentoRegItem" id="negativadorMovimentoRegItem">
									<pg:item>
										...
										<tr bgcolor="#cbe5fe">
											...
											<logic:present name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico.referencia" >
											 <a href="javascript:abrirPopUPRegistroContaHistorico('<bean:write name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico.id"/>','contaHistorico');
												">
												<bean:write name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico.referencia"  />
												</a>
											</logic:present>
											</logic:present>
											</logic:present>												 
