	...
	<tr>
			...
			<!--Início Tabela Reference a Páginação da Tela de Processo-->
              ...
              <table width="100%" border="0">
                ...
                <tr> 
                  <td colspan="2"><strong></strong> <div align="left"> 
                      ...
                      <tr bordercolor="#FFFFFF" bgcolor="#79BBFD"> 
                        <td width="45%" height="36"><div align="center"><strong>Identifica&ccedil;&atilde;o da CI </strong></div></td>
                ...
                e Hora de Execu&ccedil;&atilde;o do Comando</strong></div></td>
                        <td width="14%"><div align="center"><strong>Usu&aacute;rio 
                    Respons&aacute;vel</strong></div>                          <div align="center"></div></td>
		...
		<%-- Fim do esquema de paginação --%>
                ...
                <tr> 
                  ...
                  <td align="right"><div align="right"><strong> </strong><img src="<bean:message key="caminho.imagens"/>print.gif" width="28" height="26"></div>
