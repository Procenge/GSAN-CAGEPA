			...
			if (comparaData("01/"+form.referenciaInicial.value, ">", "01/" + form.referenciaFinal.value )){
			  ...
			  alert('Data Final do Período é anterior à Data Inicial do Período.');			
				...
				alert("Data Final do Período de Vencimento Débito posterior à Data corrente " + DATA_ATUAL + ".");
			  	return false;					
			}else if(obterNumerosSemVirgulaEPonto(form.valorDebitoInicial.value) > obterNumerosSemVirgulaEPonto(form.valorDebitoFinal.value)){
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg">Inserir Comando de Negativação - Por Critério - Dados Débitos</td>
	  ...
	  <tr>
		...
		<td><html:text property="referenciaInicial" 
				size="8" maxlength="7" onkeyup="mascaraAnoMes(this, event);" onblur="validaMesAno(document.forms[0].referenciaInicial);"/>a <html:text property="referenciaFinal" 
				size="8" maxlength="7" onkeyup="mascaraAnoMes(this, event);" onblur="validaMesAno(document.forms[0].referenciaFinal);"/> 
				mm/aaaa</td>
	  </tr>
	  <tr>
		...
		a <html:text property="dataVencimentoFinal" size="10"
			maxlength="10" tabindex="3" onkeyup="mascaraData(this, event);" onblur="validarPeriodoVencimento(document.forms[0].dataVencimentoFinal);"/> <a
	  ...
	  <tr>
		...
		<td><html:text property="numeroContasInicial" 
				size="9" maxlength="9" />a <html:text property="numeroContasFinal"
	  ...
	  <tr>
		...
		<td><html:text property="diasAtrasoParcelamento" size="10" maxlength="10" /></td>
	  </tr>         
       <tr>
 	  ...
 	  <tr>
		...
		<td><html:text property="diasAtrasoRecebimentoCarta" size="10" maxlength="10" /></td>
	  </tr>                    
      <tr>
         <td colspan="3"><hr></td>
      </tr>
...
<script>
document.getElementById('botaoConcluir').onclick = function() { botaoAvancarTelaEspera('/gsan//inserirComandoNegativacaPorCriterioWizardAction.do?concluir=true&action=inserirComandoNegativacaoDadosDebitoAction'); }
</script>
