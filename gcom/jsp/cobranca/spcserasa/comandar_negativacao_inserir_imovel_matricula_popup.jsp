...
<logic:present name="reloadPage">
	<body leftmargin="5" topmargin="5" onload="chamarSubmitComUrl('exibirInserirComandoNegativacaoMatriculaImovelAction.do'); window.close();">
</logic:present>

<logic:notPresent name="reloadPage">
	<body leftmargin="5" topmargin="5" onload="resizePageSemLink(660, 610)">
</logic:notPresent>
	    	...
	    	<td width="590" valign="top" class="centercoltext">
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#90c7fc" border="0">
						...
						<tr bordercolor="#000000">
							<td width="36%" bgcolor="#90c7fc"><div align="center" class="style9"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> <strong>Número da Guia</strong> </font></div></td>
							<td width="11%" bgcolor="#90c7fc"><div align="center" class="style9"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> <strong>Prestaç&atilde;o</strong> </font></div></td>
							...
							<td width="27%" bgcolor="#90c7fc"><div align="center" class="style9"><font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> <strong>Valor da Prestaç&atilde;o</strong> </font></div></td>
						</tr>
						<%cor = "#cbe5fe";%>
				...
				cor = "#cbe5fe";%>
								<tr bgcolor="#cbe5fe">
									...
									<a href="javascript:redirecionarSubmit('exibirConsultarGuiaPagamentoAction.do?caminhoRetornoTelaConsultaGuiaPagamento=exibirAdicionarMatriculaImovelNegativacaoAction&guiaPagamentoId=
											<bean:define name="guiapagamentohelper" property="idGuiaPagamento" id="idGuiaPagamento" />
											<bean:write name="guiapagamentohelper" property="idGuiaPagamento" />', 600, 800);">
