            ...
            <table width="100%" border="0">
              ...
              <tr> 
                ...
                <td align="right"><div align="left">
                  ...
                  <img border="0" src="imagens/pesquisa.gif" width="23" height="21">
                  </a>
                  <strong></strong>
              ...
              <tr>
                <td><strong> <font color="#FF0000"> 
                  <input type="button" name="Submit22" class="bottonRightCol" value="Desfazer" onclick="javaScript:window.location.href='exibirGerarMovimentoExclusaoNegativacaoAction.do';">
                  <input type="button" name="Submit23" class="bottonRightCol" value="Cancelar" onclick="window.location.href='/gsan/telaPrincipal.do'">
                  </font></strong></td>
