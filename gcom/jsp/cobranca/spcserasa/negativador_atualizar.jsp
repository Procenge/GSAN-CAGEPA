...
function IntegerValidations () {
	this.aa = new Array("codigoAgente", "Codigo Agente deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
}
...
function validaCampos(){
	...
	// UC0656 Inserir Negativador
	// Saulo Lima 5.6.2008
//	if (form.okAgente.value != 'true' && form.codigoAgente.value != ''){
              ...
              <tr>
                ...
                <td><strong>
              	...
              	<tr>
					...
					<td colspan="3">
						<html:text property="codigoImovel" maxlength="9" size="9" onkeypress="return isCampoNumerico(event);" onkeyup="validaEnterImovel(event, 'exibirAtualizarNegativadorAction.do?reexibir=true', 'codigoImovel');" />
