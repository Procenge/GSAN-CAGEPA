	...
	<td width="610" valign="top" class="centercoltext">
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:validaEnter(event, 'inserirComandoNegativacaPorCriterioWizardAction.do?action=exibirInserirComandoNegativacaoLocalizacaoAction', 'idLocalidadeInicial');" 
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:validaEnterDependencia(event, 'inserirComandoNegativacaPorCriterioWizardAction.do?action=exibirInserirComandoNegativacaoLocalizacaoAction', this, document.forms[0].idLocalidadeInicial.value, 'Localidade');"
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:validaEnter(event, 'inserirComandoNegativacaPorCriterioWizardAction.do?action=exibirInserirComandoNegativacaoLocalizacaoAction', 'idLocalidadeFinal');" 
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:return validaEnterDependencia(event, 'inserirComandoNegativacaPorCriterioWizardAction.do?action=exibirInserirComandoNegativacaoLocalizacaoAction', this, document.forms[0].idLocalidadeFinal.value, 'Localidade');"
