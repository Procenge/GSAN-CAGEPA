        ...
        <tr> 
          <td height="364"> 
            <table width="100%" border="0" dwcopytype="CopyTableRow">
              ...
              <tr>
                <td><strong>Data de Geração do Movimento:</strong></td>
              ...
              <tr>
                ...
                <td colspan="2"><html:text property="descricaoCodigoEnvio" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>   
              <tr>
