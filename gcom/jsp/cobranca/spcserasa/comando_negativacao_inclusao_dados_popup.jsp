...
<html:form action="/exibirInclusaoDadosComandoNegativacaoPopupAction" 
	name="ConsultarDadosInclusoesNegativacaoComandoActionForm" method="post"
		...
		<td width="690" valign="top" class="centercoltext">
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td>
						<html:text property="quantidadeInclusoes"  size="5" maxlength="5" readonly="true" 
						style="background-color:#EFEFEF; border:0; color: #000000;" />
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="quantidadeItensIncluidos"  size="5" maxlength="5" readonly="true" 
						style="background-color:#EFEFEF; border:0; color: #000000;" />
					</td>
				</tr>
