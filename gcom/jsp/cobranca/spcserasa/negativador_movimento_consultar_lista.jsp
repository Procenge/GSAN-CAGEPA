									...
									<pg:item>
										...
										<tr bgcolor="#cbe5fe">
											...
											<div align="center">
											 ...
											 <a href="/gsan/exibirConsultarNegativadorMovimentoDadosAction.do?idRegistroAtualizacao=<bean:write name="negativadorMovimento" property="id"/>
											 ">
					...
					<tr>
						<td colspan="4">
							<div align="left">
								<strong>
									<font color="#FF0000">
										<input type="submit" name="Submit223" class="bottonRightCol" value="Voltar Filtro" onClick="javascript:window.location.href='/gsan/exibirFiltrarNegativadorMovimentoAction.do?desfazer=S'"/>
									</font>
								</strong>
							</div>
						</td>
