	...
	<td width="610" valign="top" class="centercoltext">
	  ...
	  <tr>
		...
		<html:text property="idCliente" size="8"
			...
			onkeypress="validaEnterComMensagem(event, 'inserirComandoNegativacaPorCriterioWizardAction.do?action=exibirInserirComandoNegativacaoDadosImovelAction', 'idCliente','Cliente');" />
