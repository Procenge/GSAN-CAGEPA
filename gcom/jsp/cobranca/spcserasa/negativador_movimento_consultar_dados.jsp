...
<p>&nbsp;</p>
            <table width="100%" border="0" >
              ...
              <tr>
                ...
                <td><strong><strong><strong><strong><strong><strong><b><span class="style4">
                  <logic:notEmpty name="ConsultarNegativadorMovimentoActionForm" property="numeroRegistrosEnvio">
	                  <logic:notEmpty name="ConsultarNegativadorMovimentoActionForm" property="totalRegistrosAceitos">
	                  ...
	                  <logic:empty name="ConsultarNegativadorMovimentoActionForm" property="totalRegistrosAceitos">
		                  <input type="text" value="" size="9" maxlength="9" readonly="true" style="background-color:#EFEFEF; border:0" />
	                  </logic:empty>
                  </logic:notEmpty>

                  <logic:empty name="ConsultarNegativadorMovimentoActionForm" property="numeroRegistrosEnvio">
	                  <input type="text" value="" size="9" maxlength="9" readonly="true" style="background-color:#EFEFEF; border:0" />
                  </logic:empty>
                </span></b></strong></strong></strong></strong></strong></strong></td>
              </tr>
              ...
              <tr>
                <td colspan="2"><table width="100%" border="0">
                  ...
                  <tr bordercolor="#000000">
                    <td width="20%" bgcolor="#90c7fc"><div align="center"><strong>N&uacute;mero do Registro </strong></div></td>
                    <td width="31%" bgcolor="#90c7fc"><div align="center"><strong>Tipo do Registro</strong> </div></td>
                    <td width="20%" bgcolor="#90c7fc"><div align="center"><strong>Indicador</strong><strong> de Aceito </strong></div></td>
                    <td width="19%" bgcolor="#90c7fc"><div align="center"><strong>Indicador</strong><strong> de Corre&ccedil;&atilde;o </strong><strong> </strong></div></td>
                    <td width="10%" bgcolor="#90c7fc"><div align="center"><strong>Imovel</strong></div></td>
                    </tr>                    
									...
									<pg:item>
										...
										<tr bgcolor="#cbe5fe">
											...
											<td>
												<div align="center">
													<a
													href="javascript:abrirPopUPRegistro('<bean:write name="negativadorMovimentoReg" property="id"/>');">
											...
											<td align="center">	
                                                &nbsp;
												<logic:present name="negativadorMovimentoReg" property="imovel">
