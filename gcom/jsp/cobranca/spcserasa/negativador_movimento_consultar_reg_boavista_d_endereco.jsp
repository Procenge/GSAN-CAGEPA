          ...
          <td height="364"> 
            <table width="100%" border="0" dwcopytype="CopyTableRow">
              ...
              <tr>
                ...
                <td colspan="2">
					<html:text property="descricaoTipoEndereco" disabled="true" style="background-color:#EFEFEF; border:0" size="40" maxlength="40"/>
				</td>
              </tr>                         
              ...
              <tr>
                ...
                <td colspan="2">
					<html:text property="endereco" disabled="true" style="background-color:#EFEFEF; border:0" size="60" maxlength="60"/>
				</td>
              </tr>       
              ...
              <tr>
                ...
                <td colspan="2">
                	<html:text property="cep" disabled="true" style="background-color:#EFEFEF; border:0" size="10" maxlength="10"/>
                 </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="2">
                	<html:text property="cidade" disabled="true" style="background-color:#EFEFEF; border:0" size="60" maxlength="60"/>
                </td>
              </tr>                 
              ...
              <tr>
                ...
                <td colspan="2">
                	<html:text property="unidadeFederacao" disabled="true" style="background-color:#EFEFEF; border:0" size="2" maxlength="2"/>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="2">
                	<html:text property="foneNumero" disabled="true" style="background-color:#EFEFEF; border:0" size="20" maxlength="20"/>
                </td>
