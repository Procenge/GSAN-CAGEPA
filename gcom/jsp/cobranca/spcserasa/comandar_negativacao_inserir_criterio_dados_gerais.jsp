      ...
      <tr>
		...
		<td colspan="2">
			<html:text property="usuario" size="9" maxlength="9"
				onkeypress="validaEnter(event, 'inserirComandoNegativacaPorCriterioWizardAction.do?action=exibirInserirComandoNegativacaoDadosGeraisAction&pesquisarUsuario=ok', 'usuario');" />
