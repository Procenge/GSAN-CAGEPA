      ...
      <tr>
		...
		<td colspan="2">
			<html:text property="usuario" size="9" maxlength="9"
				onkeypress="validaEnter(event, 'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoDadosGeraisAction&pesquisarUsuario=ok', 'usuario');" />
