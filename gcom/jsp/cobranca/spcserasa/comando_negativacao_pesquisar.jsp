	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr> 	
                     <td width="30%"> <strong>Usuário Responsável:</strong> </td>
                     <td width="70%">
						...
						<a href="javascript:abrirPopup('exibirUsuarioPesquisar.do?caminhoRetornoTelaPesquisaUsuario=exibirPesquisarComandoNegativacaoAction', 400, 750);" title="Pesquisar"><img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23" height="21" border="0"></a>
						<!-- 
						<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23"	height="21" 
						     style="cursor:hand;" name="imagem"	onclick="redirecionarSubmit('exibirUsuarioPesquisar.do?caminhoRetornoTelaPesquisaUsuario=exibirPesquisarComandoNegativacaoAction', 400, 750);"
							 alt="Pesquisar"> -->
