	...
	<td width="610" valign="top" class="centercoltext">
	  ...
	  <tr>
		...
		<html:text property="idCliente" size="8"
			...
			onkeypress="validaEnterComMensagem(event, 'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoDadosImovelAction', 'idCliente','Cliente');" />
      ...
      <tr>
        <td HEIGHT="30" width="35%"><strong>Tipo de Relação:</strong></td>
        <td>
      ...
      <tr>
      	<td HEIGHT="30" width="35%"><strong>Imóvel com Sit. Especial de Cobrança:<font color="#FF0000">*</font></strong></td>
        <td>
           <logic:present name="desabilitar">
            ...
            <logic:notPresent name="desabilitar">
			  <html:radio property="imovSitEspecialCobranca" value="1" tabindex="1" /><strong>Sim
			  <html:radio property="imovSitEspecialCobranca" value="2" tabindex="2" />Não</strong>
			</logic:notPresent>
		</td>
      </tr> 
      <tr>
      	<td HEIGHT="30" width="35%"><strong>Imóvel com Sit. de Cobrança:<font color="#FF0000">*</font></strong></td>
        <td>
      ...
      <tr> 
        <td width="35%"><strong>Situação da Ligação de Esgoto:</strong></td>
        <td colspan="6"><span class="style2"><strong>
         <logic:notPresent name="desabilitar">
      ...
      <tr> 
        <td width="35%"><strong>Subcategoria:</strong></td>
        <td colspan="6"><span class="style2"><strong>
         <logic:notPresent name="desabilitar">
      ...
      <tr> 
        <td width="35%"><strong>Perfil Imóvel:</strong></td>
        <td colspan="6"><span class="style2"><strong>
          <logic:notPresent name="desabilitar">
      ...
      <tr> 
        <td width="35%"><strong>Tipo de Cliente:</strong></td>
        <td colspan="6"><span class="style2"><strong>
          <logic:notPresent name="desabilitar">        
