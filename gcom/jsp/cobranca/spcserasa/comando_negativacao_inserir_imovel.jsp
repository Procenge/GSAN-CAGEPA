      ...
      <tr>
		...
		<td>
			<html:text property="usuario" size="9" maxlength="9"
				onkeypress="validaEnter(event, 'exibirInserirComandoNegativacaoMatriculaImovelAction.do', 'usuario');" />
         ...
         <td colspan="3">
			...
			<table width="100%" border="0">
	      	<tr>
	      		...
	      		<td align="right">
	      		    <input type="button" class="bottonRightCol" value="Adicionar" tabindex="3" id="botaoEndereco" onclick="javascript:abrirPopup('exibirAdicionarMatriculaImovelNegativacaoAction.do?limparForm=ok', 295, 450);">	      							      		
	      		</td>
	      	</tr>
		 	</table>
		 </td>
				...
				<table width="100%" align="center" bgcolor="#99CCFF">
					...
					<logic:iterate name="colecaoDadosNegativacaoPorImovelHelper" id="helper"
						...
						<%}%>
							...
							<td width="50%">
							   <a href="javascript:abrirPopup('exibirAdicionarMatriculaImovelNegativacaoAction.do?idCliente='+<bean:write name="helper" property="idCliente" />+'&matriculaImovel='+<bean:write name="helper" property="idImovel" />, 500, 800);">
