...
<p>&nbsp;</p>
            <table width="100%" border="0" >
                ...
                <tr> 
                  <td width="24%"><strong>Negativador:<strong><font color="#FF0000">*</font></strong></strong></td>
                  <td><select name="idNegativador">
					<option value="">&nbsp;</option>
                ...
                <tr> 
                  ...
                  <td class="style1"><input type="file" style="textbox" name="uploadPicture"
					size="50" />
				  </td>
                </tr>
                <tr> 
                  ...
                  <td class="style1"> <table>
                      <tr> 
                        <td width="500" align="right"><div align="left"><strong><font color="#FF0000">*</font></strong> 
                  ...
                  <td class="style1"> <table>
                      <tr> 
                        <td width="500" align="right">                 
                          <input name="Registrar" type="button" class="bottonRightCol" id="Registrar" value="Registrar" onclick="javascript:validarForm();"></td>
                        <td>&nbsp;</td>
                      </tr>
                    </table></td>
                </tr>
