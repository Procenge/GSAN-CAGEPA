								...
								<logic:iterate name="collectionComandoNegativacao" id="comandoNegativacao" type="ComandoNegativacaoHelper">
									<pg:item>
										...
										<%}%>
											<td width="18%">
											<div align="center"><a
												href="javascript:enviarDados('<bean:write name="comandoNegativacao" property="idComandoNegativacao"/>', '<bean:write name="comandoNegativacao" property="tituloComando"/>', 'comandoNegativacao');">
												<bean:write name="comandoNegativacao" property="tituloComando"/> </a></div>
											</td>
											<td width="10%" align="center">
