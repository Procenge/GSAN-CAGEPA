            ...
            <table width="100%" border="0">
              ...
              <tr>
                ...
                <td><strong><b><span class="style4">              
                 <input type="text" name="nomeNegativador" value="<bean:write name="nomeNegativador" scope="session" />" readonly="readonly" size="50" maxlength="50" >
              ...
              <tr>
                ...
                <td><strong><b><span class="style4">
                <input type="text" name="dataProcessamento" value="<bean:write name="dataProcessamento" scope="session" />" readonly="readonly" size="10" maxlength="10">
                 </span></b></strong></td>
              </tr>
              <tr>
                <td colspan="2"><strong>Hora do Procesamento: </strong></td>
                <td><strong><b><span class="style4">                
                  <input type="text" name="horaProcessamento" value="<bean:write name="horaProcessamento" scope="session" />" readonly="readonly" size="8" maxlength="8">
                </span></b></strong></td>
              </tr>
              <tr>
                <td colspan="2"><strong>N&uacute;mero Seq&uuml;encial do Arquivo: </strong></td>
                <td><strong><b><span class="style4">               
                   <input type="text" name="numeroSequencialArquivo" value="<bean:write name="numeroSequencialArquivo" scope="session" />" readonly="readonly" size="10" maxlength="10">
                </span></b></strong></td>
              </tr>
              <tr>
                ...
                <td><strong><b><span class="style4">    
                 ...
                 <input type="text" name="numeroRegistros" value="<bean:write name="numeroRegistros" scope="session" />" readonly="readonly" size="10" maxlength="10">
                </span></b></strong></td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td align="right">
				<input name="Button" type="button" class="bottonRightCol" 	value="Encerrar" align="left"
