              ...
              <table width="100%" border="0" dwcopytype="CopyTableRow">
                ...
                <tr>
                  ...
                  <td colspan="2"><strong><b><span class="style4">
                    <html:text property="codigoCliente" maxlength="9" size="9" onkeyup="return validaEnterCliente(event, 'exibirFiltrarComandoNegativacaoTipoCriterioAction.do', 'codigoCliente'); " />
                ...
                <tr>
                  ...
                  <td colspan="2"><strong>
                    <logic:present name="colecaoEloPoloFinal">  
                    	<html:select property="idEloPolo" tabindex="7" disabled="false" onchange="desabilitarGrupoCobranca();" multiple="true" size="3">
							 <selected><html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option> </selected>
							<logic:present name="colecaoEloPoloFinal">
								<html:options collection="colecaoEloPoloFinal" labelProperty="descricao" property="id"/>
							</logic:present>
						</html:select>
                	</logic:present>
                  </strong></td>
                ...
                <tr>
                  ...
                  <td colspan="2"><strong><b><span class="style4">
                    <html:text property="codigoLocalidadeInicial" maxlength="3" size="4" 
                    	onkeypress="javascript:validaEnterLocalidadeInicial(event, 'exibirFiltrarComandoNegativacaoTipoCriterioAction.do', 'codigoLocalidadeInicial'); " 
                ...
                <tr>
                  ...
                  <td colspan="2"><strong><b><span class="style4">
				  	<html:text property="codigoSetorComercialInicial" maxlength="3" size="4" onkeypress="javascript:validaEnterSetorComercialInicial(event, 'exibirFiltrarComandoNegativacaoTipoCriterioAction.do', 'codigoSetorComercialInicial'); " 
                ...
                <tr>
                	<td><STRONG>Localidade Final:</STRONG></td>
                  	<td colspan="2"><strong><b><span class="style4">
						...
						onkeypress="javascript:validaEnterLocalidadeFinal(event, 'exibirFiltrarComandoNegativacaoTipoCriterioAction.do', 'codigoLocalidadeFinal'); "
                ...
                <tr>
                  ...
                  <td colspan="2"><strong><b><span class="style4">
						<html:text property="codigoSetorComercialFinal" maxlength="3" size="4" onkeypress="javascript:validaEnterSetorComercialFinal(event, 'exibirFiltrarComandoNegativacaoTipoCriterioAction.do', 'codigoSetorComercialFinal'); " 
                ...
                <tr>
                  ...
                  <td colspan="2">
					...
					a <html:text property="geracaoComandoDataFinal" size="10"
						maxlength="10" tabindex="3" onkeyup="mascaraData(this, event);" onblur="validarPeriodoVencimento(document.forms[0].geracaoComandoDataFinal);"/> 
                ...
                <tr>
                  ...
                  <td colspan="2">
					...
					a <html:text property="execucaoComandoDataFinal" size="10"
						maxlength="10" tabindex="3" onkeyup="mascaraData(this, event);" onblur="validarPeriodoVencimento(document.forms[0].execucaoComandoDataFinal);"/> 
                ...
                <tr>
                  ...
                  <td colspan="2">
					...
					size="8" maxlength="7" onkeyup="mascaraAnoMes(this, event);" onblur="validaMesAno(document.forms[0].referenciaDebitoDataInicial);"/>a 
					<html:text property="referenciaDebitoDataFinal" 
					size="8" maxlength="7" onkeyup="mascaraAnoMes(this, event);" onblur="validaMesAno(document.forms[0].referenciaDebitoDataFinal);"/> mm/aaaa
				  </td>
				</td>
                </tr>
                ...
                <tr>
                  ...
                  <td colspan="2">
					...
					a <html:text property="vencimentoDebitoDataFinal" size="10"
						maxlength="10" tabindex="3" onkeyup="mascaraData(this, event);" onblur="validarPeriodoVencimento(document.forms[0].vencimentoDebitoDataFinal);"/> 
                ...
                <tr>
                  ...
                  <td colspan="2">
                  	<html:text property="valorDebitoInicial" 
						size="13" maxlength="13" onkeyup="formataValorMonetario(this, 13)"/>a 
