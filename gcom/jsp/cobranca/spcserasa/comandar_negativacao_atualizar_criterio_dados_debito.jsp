  ...
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
	  ...
	  <tr>
		...
		<a
			href="javascript:abrirCalendarioReplicando('AtualizarComandoNegativacaoPorCriterioActionForm', 'dataVencimentoInicial', 'dataVencimentoFinal');" >
		<img border="0"
	  ...
	  <tr>
		...
		<td><html:text property="numeroContasInicial" 
				size="10" maxlength="10" />a <html:text property="numeroContasFinal"
