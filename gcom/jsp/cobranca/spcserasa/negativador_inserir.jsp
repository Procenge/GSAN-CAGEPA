              ...
              <tr>
                ...
                <td><strong>
              	...
              	<tr>
					...
					<td colspan="3">
						<html:text property="codigoImovel" maxlength="9" size="9" onkeypress="return isCampoNumerico(event);" onkeyup="validaEnterImovel(event, 'exibirInserirNegativadorAction.do', 'codigoImovel');" />
