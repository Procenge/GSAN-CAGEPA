        ...
        <tr> 
          <td height="364"> 
            <table width="100%" border="0" dwcopytype="CopyTableRow">
              ...
              <tr>
                <td><strong>Código do Operação:</strong></td>
                <td colspan="2">
					<html:text property="codigoOperacao" disabled="true" style="background-color:#EFEFEF; border:0" size="2" maxlength="2"/>
					<html:text property="operacao" disabled="true" style="background-color:#EFEFEF; border:0" size="10" maxlength="10"/>
				</td>
              </tr>                            
              ...
              <tr>
                <td><strong>Tipo da Ocorrência:</strong></td>
                <td colspan="2">
					<html:text property="tipoOcorrencia" disabled="true" style="background-color:#EFEFEF; border:0" size="2" maxlength="2"/>
				</td>
              </tr>                         
              ...
              <tr>
                ...
                <td colspan="2">
					<html:text property="contrato" disabled="true" style="background-color:#EFEFEF; border:0" size="22" maxlength="22"/>
				</td>
              </tr>       
              
              <tr>
                <td><strong>Documento Avalista: </strong></td>
                <td colspan="2">
              ...
              <tr>
                <td><strong>Opção de Carta com Boleto para o Devedor: </strong></td>
                <td colspan="2">
                	<html:text property="codigoOpcaoCartaComBoletoParaDevedor" disabled="true" style="background-color:#EFEFEF; border:0" size="1" maxlength="1"/>
                	<html:text property="descricaoOpcaoCartaComBoletoParaDevedor" disabled="true" style="background-color:#EFEFEF; border:0" size="62" maxlength="62"/>
                </td>
              </tr>                 
              
              <tr>
                <td><strong>Opção de Carta com Boleto para o Avalista: </strong></td>
                <td colspan="2">
                	<html:text property="codigoOpcaoCartaComBoletoParaAvalista" disabled="true" style="background-color:#EFEFEF; border:0" size="1" maxlength="1"/>
                	<html:text property="descricaoOpcaoCartaComBoletoParaAvalista" disabled="true" style="background-color:#EFEFEF; border:0" size="62" maxlength="62"/>
                </td>
              </tr>  
              
              <tr>
                <td><strong>Data de Vencimento do Débito: </strong></td>
                <td colspan="2">
                	<html:text property="foneNumero" disabled="true" style="background-color:#EFEFEF; border:0" size="10" maxlength="10"/>
                	(DDMMAAAA)
                </td>
              ...
              <tr>
                <td><strong>Valor de Cobrança:</strong></td>

                <td>
                	<html:text property="valorCobranca" disabled="true" style="background-color:#EFEFEF; border:0" size="15" maxlength="15"/>
                </td>
              </tr>              
