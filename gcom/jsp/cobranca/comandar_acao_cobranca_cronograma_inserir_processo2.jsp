...
<html:javascript staticJavascript="false" formName="InserirComandoAcaoCobrancaCronogramaActionForm" />
...
function concluir(){
	...
	if (validateInserirComandoAcaoCobrancaCronogramaActionForm(formulario)){ 	 
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" cellpadding="0"cellspacing="3">
				...
				<tr>
					<td><strong>Refer&ecirc;ncia da Cobran&ccedil;a: </strong></td>
					<td colspan="2"><strong><strong> <html:text
						property="referenciaCobranca" size="30" maxlength="30"
						readonly="true"
						style="background-color:#EFEFEF; border:0; color: #000000" /> </strong></strong></td>
				</tr>
			   ...
			   <tr>
				...
				<tr>
					...
					<td colspan="2">
						<html:select name="InserirComandoAcaoCobrancaCronogramaActionForm" 
									 property="empresa">
						  <html:option value="">&nbsp;</html:option>
				...
				<tr>
					...
					<td align="right">
					  <gcom:controleAcessoBotao name="Button" value="Concluir" tabindex="5" onclick="concluir();" url="inserirComandoAcaoCobrancaCronogramaAction.do"/>			
