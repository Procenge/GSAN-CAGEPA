...
<logic:present name="adicionar">
	<body leftmargin="5" topmargin="5" onload="resizePageSemLink(710, 500); chamarSubmitComUrl('exibirAtualizarCobrancaCronogramaAction.do?reloadPage=1');">
</logic:present>
<logic:notPresent name="adicionar">
	<body leftmargin="5" topmargin="5" onload="resizePageSemLink(710, 500);setarFoco('${requestScope.nomeCampo}');">
</logic:notPresent>
				                ...
				                <td height="0">
				                  <table width="100%" bgcolor="#99CCFF">
				                    ...
				                    <tr bordercolor="#000000">
				                      ...
				                      <td width="28%" bgcolor="#90c7fc" align="center"><div align="center"><strong>Predecessora</strong></div></td>
				                      ...
				                      <logic:notEmpty name="colecaoCobrancaAtiviade">
				                        <logic:iterate name="colecaoCobrancaAtiviade" id="atividadeCobranca">
				                          <tr bgcolor="#FFFFFF">
				                              ...
				                              %>  
				                                  <input type="text" maxlength="8" name="qtd_a<bean:write name="cobrancaAcaoEscolhida" property="id"/>n<bean:write name="atividadeCobranca" property="id"/>" size="8" id="quantidadeMaximaDocumentos" />
				                              <%
				                              } else {
				                            	  out.println("&nbsp;");
				                              }
