...
function jogarPopup(tipo){
	...
	//Tiago Moreno
		case 1:
		  if (form.idGerenciaRegional.value == "-1" && form.localidadeOrigemID.value == ""){
		  	chamaPopupImovel();
		  }
		  break;
		case 2:
		  if (form.idGerenciaRegional.value == "-1" && form.idImovel.value == ""){
...
function bloquearELSQ(){
	...
	if(form.idGerenciaRegional.value != "<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>" ){
...
function bloquearESLSQ(){
	...
	if(form.idUnidadeNegocio.value != "<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>" ){
...
function desabilitaSeImovelDiferente(){
	var form = document.FiltrarDocumentosCobrancaActionForm;
	if(form.localidadeOrigemID.value != form.localidadeDestinoID.value){
		form.setorComercialOrigemCD.disabled = 1;
		form.setorComercialDestinoCD.disabled = 1;
		form.setorComercialOrigemCD.value = '';
		form.setorComercialDestinoCD.value = '';
		form.quadraOrigemNM.disabled = 1;
		form.quadraDestinoNM.disabled = 1;
		form.quadraOrigemNM.value = '';
		form.quadraDestinoNM.value = '';		
	}else if(form.localidadeOrigemID.value == form.localidadeDestinoID.value || form.localidadeOrigemID.value){
		form.setorComercialOrigemCD.disabled = 0;
		form.setorComercialDestinoCD.disabled = 0;
		form.quadraOrigemNM.disabled = 0;
		form.quadraDestinoNM.disabled = 0;
	}
}
...
<!-- Begin 
   ...
   function validarFormSubmit(){
     var form = document.FiltrarDocumentosCobrancaActionForm;
     	if (validateFiltrarDocumentosCobrancaActionForm(form) && testarCampoValorZeroDecimal(form.valorInicial, 'Valor Inicial') && testarCampoValorZeroDecimal(form.valorFinal, 'Valor Final')){
     		form.submit();
     	}
	}
/*
...
<!-- abrirPopup('/gsan/exibirInserirReajusteConsumoTarifaAction.do?id_r=' + document.forms[0].idRegistrosRemocao, 350, 610); -->
	...
	<logic:present name="ehPopup">
		<body leftmargin="5" topmargin="5" onload="resizePageSemLink(630, 500);bloquearM2();desabilitaSeImovelDiferente();">
	</logic:present>

	<logic:notPresent name="ehPopup">
		<body leftmargin="5" topmargin="5" onload="bloquearM2();desabilitaSeImovelDiferente();">
	</logic:notPresent>
	...
	<logic:notPresent name="ehPopup">
		...
		<logic:present name="ehPopup">
			...
			<table bordercolor="#000000" width="100%" cellspacing="0" id="table1">
				...
				<tr>
					<td colspan="4">Para filtrar documentos de cobran&ccedil;a no
				...
				<tr>
					<td><strong>Número Seq. do Documento:</strong></td>
					
					<td>
						<html:text maxlength="9" 
							property="numeroSequencialDocumento" 
							size="9"/>
					</td>
				</tr>
				...
				<tr>
						...
						<td>
							...
							<html:text maxlength="3" 
								...
								onkeyup="replicaDados(document.FiltrarDocumentosCobrancaActionForm.localidadeOrigemID, document.FiltrarDocumentosCobrancaActionForm.localidadeDestinoID);desabilitaSeImovelDiferente();limparBorrachaOrigem(4, this);bloquearM();limpaCampoSeVazio(document.forms[0].localidadeOrigemID,'limparBorrachaOrigem(1, this);')"
								disabled="true" /> 
				...
				<tr>
					...
					<td>
						<html:text maxlength="3" 
							...
							disabled="true" 
							onkeyup="replicaDados(document.FiltrarDocumentosCobrancaActionForm.setorComercialOrigemCD, document.FiltrarDocumentosCobrancaActionForm.setorComercialDestinoCD);limparBorrachaOrigem(5, this);limpaCampoSeVazio(document.forms[0].setorComercialOrigemCD,'limparBorrachaOrigem(2, this);');" />
				...
				<tr>
					...
					<td width="432">
						<html:text maxlength="5" 
							...
							disabled="true" 
							onkeyup="replicaDados(document.FiltrarDocumentosCobrancaActionForm.quadraOrigemNM, document.FiltrarDocumentosCobrancaActionForm.quadraDestinoNM);limparBorrachaOrigem(6, this);limpaCampoSeVazio(document.FiltrarDocumentosCobrancaActionForm.quadraOrigemNM,'limparBorrachaOrigem(3, this);');" />
				...
				<tr>
					...
					<td>
						<html:text maxlength="3" 
							...
							disabled="true"
							onkeyup="desabilitaSeImovelDiferente();limparBorrachaOrigem(7, this);limpaCampoSeVazio(document.FiltrarDocumentosCobrancaActionForm.localidadeDestinoID,'limparBorrachaDestino(1);');" />
				...
				<tr>
					...
					<td>
						<html:text maxlength="3" 
							...
							disabled="true"
							onkeyup="limparBorrachaOrigem(8, this);limpaCampoSeVazio(document.FiltrarDocumentosCobrancaActionForm.setorComercialDestinoCD,'limparBorrachaDestino(2);');" />
				...
				<tr>
					...
					<td>
						<html:text maxlength="5" 
							...
							disabled="true"
							onkeyup="limparBorrachaOrigem(9, this);limpaCampoSeVazio(document.FiltrarDocumentosCobrancaActionForm.quadraDestinoNM,'limparBorrachaDestino(3);');" />
				...
				<logic:notEqual scope="session" parameter="bloquear" value="todos">
					<tr>
						...
						<td>
							<html:text maxlength="3" 
								...
								onkeypress="validaEnter(event, 'exibirFiltrarDocumentosCobrancaAction.do?objetoConsulta=1&inscricaoTipo=origem&bloquear=matricula', 'localidadeOrigemID');" 
								onclick="validarLocalidade()"  
								onkeyup="replicaDados(document.FiltrarDocumentosCobrancaActionForm.localidadeOrigemID, document.FiltrarDocumentosCobrancaActionForm.localidadeDestinoID);desabilitaSeImovelDiferente();limparBorrachaOrigem(4, this);bloquearM();limpaCampoSeVazio(document.FiltrarDocumentosCobrancaActionForm.localidadeOrigemID,'limparBorrachaOrigem(1, this);')" />
					...
					<tr>
						...
						<td>
							<html:text maxlength="3" property="setorComercialOrigemCD"
								...
								onkeyup="replicaDados(document.FiltrarDocumentosCobrancaActionForm.setorComercialOrigemCD, document.FiltrarDocumentosCobrancaActionForm.setorComercialDestinoCD);limparBorrachaOrigem(5, this);limpaCampoSeVazio(document.FiltrarDocumentosCobrancaActionForm.setorComercialOrigemCD,'limparBorrachaOrigem(2, this);');" />
					...
					<tr>
						<td><strong>Quadra:</strong></td>
						<td><html:text maxlength="5" property="quadraDestinoNM" size="5"
							onkeypress="validaEnterDependencia(event, 'exibirFiltrarDocumentosCobrancaAction.do?objetoConsulta=3&inscricaoTipo=destino&bloquear=matricula', document.FiltrarDocumentosCobrancaActionForm.quadraDestinoNM, document.FiltrarDocumentosCobrancaActionForm.setorComercialDestinoCD.value, 'setor comercial da inscrição de destino');"
							onkeyup="limparBorrachaOrigem(9, this);limpaCampoSeVazio(document.FiltrarDocumentosCobrancaActionForm.quadraDestinoNM,'limparBorrachaDestino(3);');" />
				...
				<tr>
					...
					<td colspan="3"><strong> <html:text property="dataEmissaoInicio"
						size="10"
						onkeyup="mascaraData(this, event); replicaDados(document.FiltrarDocumentosCobrancaActionForm.dataEmissaoInicio, document.FiltrarDocumentosCobrancaActionForm.dataEmissaoFim);"
						maxlength="10" /> <a
			...
			<table width="100%">
				<tr>
					...
					<td colspan="3">
					<div align="right">
					  <gcom:controleAcessoBotao name="Submit23" value="Consultar" onclick="validarFormSubmit();" url="filtrarDocumentosCobrancaAction.do"/>
