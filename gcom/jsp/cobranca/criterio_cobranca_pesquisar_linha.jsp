...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(790,450);">
				...
				<tr>
					...
					<table width="100%" bgcolor="#90c7fc">
						...
						<tr bgcolor="#90c7fc">
							...
							<div align="center"><strong>Qtde. Minima dias vencto</strong></div>
							</td>
							<td width="21%" bgcolor="#90c7fc">
							<div align="center"><strong>Qtde. Maxima dias vencto</strong></div>
							</td>
						</tr>
						<%String cor = "#cbe5fe";%>
						<logic:present name="colecaoCobCritLinha" scope="session">
							...
							<%}%>
									...
									<td>
									<div align="center"><bean:write name="linha"
										property="quantidadeDiasVencimentoInicial" /></div>
									</td>
									<td>
									<div align="center"><bean:write name="linha"
										property="quantidadeDiasVencimentoFinal" /></div>
									</td>
								</tr>
							</logic:iterate>
						</logic:present>
