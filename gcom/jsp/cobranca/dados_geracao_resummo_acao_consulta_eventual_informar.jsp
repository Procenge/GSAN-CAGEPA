...
<!--
    ...
    function caracteresespeciais () { 
     ...
     this.ae = new Array("unidadeNegocio", "Unidade de Negócio possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    } 
    ...
    function IntegerValidations () { 
     ...
     this.ad = new Array("unidadeNegocio", "Unidade de Negócio deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    } 
  ...
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
	  ...
	  <tr>
        ...
        <td>
			<html:text property="dataInicialEmissao" size="11" maxlength="10" tabindex="1" onkeyup="mascaraData(this, event);replicarCampo(document.forms[0].dataFinalEmissao,document.forms[0].dataInicialEmissao);"/> <a
       ...
       <tr>
        ...
        <td>
           <html:hidden property="idCobrancaAcaoAtividadeComando"/>
			...
			<a href="javascript:abrirPopup('exibirPesquisarComandoAcaoCobrancaAction.do?limparForm=OK', 400, 750);" title="Pesquisar"><img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23" height="21" border="0"></a><a href="javascript:limparTitulo();">
      ...
      <tr>
      	<td HEIGHT="30"><strong>Ação de Cobrança:</strong></td>
        <td>
			<html:select property="cobrancaAcao" style="width: 200px;height: 100px" tabindex="15" multiple="true">
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="unidadeNegocio" size="4" maxlength="4" tabindex="5" onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaEventualAction.do?pesquisarUnidadeNegocio=OK', 'unidadeNegocio', 'Unidade Negócio');"/>
			<a href="javascript:gerenciadorHabilitacaoImagemPesquisa('UnidadeNegocio')" title="Pesquisar"><img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23" height="21" border="0"></a>
			...
			<logic:notPresent name="corUnidadeNegocio">
				...
				<logic:empty name="InformarDadosGeracaoResumoAcaoConsultaEventualActionForm" property="unidadeNegocio">
				...
				<logic:notEmpty name="InformarDadosGeracaoResumoAcaoConsultaEventualActionForm" property="unidadeNegocio">
					<html:text property="descricaoUnidadeNegocio" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
        	...
        	<a href="javascript:gerenciadorHabilitacaoImagemLimpar('UnidadeNegocio')" title="Apagar"><img src="<bean:message key='caminho.imagens'/>limparcampo.gif" border="0"></a>
		</td>
      </tr>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="quadra" size="4" maxlength="5" tabindex="8" onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaEventualAction.do?pesquisarQuadra=OK', this, document.forms[0].setorComercial.value, 'Setor Comercial', 'Quadra');"/>
