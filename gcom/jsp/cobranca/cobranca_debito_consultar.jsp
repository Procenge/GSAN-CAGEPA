...
function caracteresespeciais () { 
	...
	this.ag = new Array("codigoClienteSuperior", "Código do Cliente Superior possui caracteres especiais.", new Function ("varName", " return this[varName];"));	
} 
...
function IntegerValidations () { 
	...
	this.ac = new Array("codigoClienteSuperior", "Código do Cliente Superior deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
} 
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3">
						<html:text property="codigoImovel" maxlength="9" size="9" onkeyup="validaEnterImovel(event, 'exibirConsultarDebitoAction.do', 'codigoImovel');" />
				...
				<tr>
					...
					<td colspan="3">
						<html:text property="codigoClienteSuperior" maxlength="9" size="9" onkeyup="return validaEnterClienteSuperior(event, 'exibirConsultarDebitoAction.do', 'codigoClienteSuperior'); " />
						...
						<logic:notPresent name="corClienteSuperior">
							<logic:empty name="ConsultarDebitoActionForm" property="codigoClienteSuperior">
								<html:text property="nomeClienteSuperior" size="38" value="" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:empty>
				...
				<tr>
					...
					<td colspan="3" align="right">
					<div align="left">
					<html:text property="referenciaInicial" maxlength="7" size="7" onkeyup="mascaraAnoMes(this, event);replicarCampo(document.forms[0].referenciaFinal,this);" />
					<strong> a</strong> 
					<html:text property="referenciaFinal" maxlength="7" size="7" onkeyup="mascaraAnoMes(this, event);" />
					mm/aaaa</div>
				...
				<tr>
					...
					<html:text property="dataVencimentoInicial" size="10"
						maxlength="10" onkeyup="mascaraData(this, event);replicarCampo(document.forms[0].dataVencimentoFinal,this);" /> <a href="javascript:abrirCalendario('ConsultarDebitoActionForm', 'dataVencimentoInicial')">
					<img border="0"
				...
				<tr>
					...
					<td colspan="2" align="right">
						...
						<gcom:controleAcessoBotao name="Button" value="Consultar" onclick="javascript:validarForm(document.forms[0]);" url="consultarDebitoAction.do"/>				
