			...
			if( msg != ""){
				...
				if( msg != ""){
					...
					if (form.indicadorSimulacao[0].checked == false && form.indicadorSimulacao[1].checked == false) {
						...
						msg = "É necessário informar Simulação.";
					}
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Comandar Prescrição do Débito</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">Para comandar a prescrição de débitos, informe os dados abaixo:</td>
				</tr>
				...
				<tr>
					<td>
						<strong>Descrição da solicitacao:</strong>
						<font color="#FF0000">*</font>
					</td>
				...
				<tr>
					<td><strong>Simulação:</strong><font color="#FF0000">*</font></td>
					...
					<logic:present name="temPermissaoComandarPrescricaoDebitos">
						<td>
							...
							<html:radio property="indicadorSimulacao" value="<%=""+ConstantesSistema.NAO%>" /> <strong>Não</strong>
						</td>
					</logic:present>
					...
					<logic:notPresent name="temPermissaoComandarPrescricaoDebitos">
						<td>
							<html:radio property="indicadorSimulacao" value="<%=""+ConstantesSistema.SIM%>" /> <strong>Sim</strong>
							<html:radio property="indicadorSimulacao" disabled="true" value="<%=""+ConstantesSistema.NAO%>" /> <strong>Não</strong>
						</td>
					</logic:notPresent>
				</tr>
