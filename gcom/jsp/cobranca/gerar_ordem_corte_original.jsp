...
<script language="JavaScript">
	function validarForm(){
	   ...
	   if(form.uploadPicture.value != '') {
	  	 	if(confirm('Confirma gerar ordem de corte?')){
	    	   form.submit();
		   	}
	   }else{
		  if(form.uploadPicture.value == ''){
...
<form action="/gsan/gerarOrdemCorteOriginalAction.do"
...
<table width="770" border="0" cellspacing="4" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0">
			...
			<tr>
				<td colspan="2">Para gerar ordem de corte, informe os dados abaixo:</td>
			</tr>
			...
			<tr>
				<td align="left">
					<input name="Button" 
						...
						value="Desfazer" 
						align="left"
						onclick="window.location.href='<html:rewrite page="/exibirGerarOrdemCorteOriginalAction.do?menu=sim"/>'">
						&nbsp;
				...
				<td align="right">
					<gcom:controleAcessoBotao name="Button" 
				  		...
				  		url="gerarOrdemCorteOriginalAction.do"/>
