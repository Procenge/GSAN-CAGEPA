...
<script language="JavaScript">
	function validarForm(){
	   ...
	   if(form.uploadPicture.value != '') {
	  	 	if(confirm('Confirma gerar avisos de debito?')){
	    	   form.submit();
		   	}
	   }else{
		  if(form.uploadPicture.value == ''){
...
<form action="/gsan/gerarAvisoDeDebitoAction.do"
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Gerar Avisos de Débitos</td>
		...
		<table width="100%" border="0">
			...
			<tr>
				<td colspan="2">Para gerar os avisos de débitos, informe os dados abaixo:</td>
			</tr>
