...
function imprimirCertidaoPositiva(){
	...
	function imprimir(escolha){
		var form = document.forms[0];
		if(escolha){
			toggleBoxCaminho('demodiv',1,'gerarRelatorioCertidaoNegativaAction.do?enderecoFormatado=${requestScope.enderecoFormatado}&valorDebitos=<bean:write name="valorTotalComAcrescimo"/>');
		}
	}
	...
	function gerarRelatorioAvisoEOrdemCorteIndividual() {
		...
		if (form.codigoImovel.value != null && form.codigoImovel.value != "") {
			form.action = 'gerarRelatorioAvisoEOrdemCorteIndividualAction.do?imovel='+form.codigoImovel.value;
			form.submit();
		} 
	}
...
<logic:present name="ehPopup">
	<body leftmargin="5" topmargin="5"
		onload="resizePageSemLink(680, 700);">
</logic:present>
											...
											<table width="100%" align="center" bgcolor="#90c7fc"
												...
												<tr bordercolor="#000000">
													...
													<td width="10%" bgcolor="#90c7fc">
														<div align="center" class="style9"><font color="#000000"
															style="font-size:9px"
															face="Verdana, Arial, Helvetica, sans-serif"> <strong>Dias Suspensão Lançamento
															</strong> </font></div>
													</td>
													...
													<logic:notEmpty name="colecaoGuiaPagamentoValores">
														...
														<%}%>
															...
															<td>
																<div align="right" class="style9">
																	<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 
																		<%=request.getAttribute("valorGuiaPagamento")%>
																	</font>
																</div>
															</td>
														</tr>
										...
										<tr>
											...
											<table width="100%" align="center" bgcolor="#90c7fc"
												...
												<tr bgcolor="#FFFFFF">
													...
													<div align="right" class="style9">
														<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">
															<bean:write name="valorTotalSemAcrescimo"/>
														</font>
													</div>
													</td>
													<td>
													<div align="right" class="style9"><font color="#000000"
														style="font-size:9px"
														face="Verdana, Arial, Helvetica, sans-serif"> 
														<bean:write name="valorTotalComAcrescimo"/>
													</font></div>
													</td>
												</tr>
											</table>
