...
<%@ page import="gcom.cobranca.CobrancaSituacao" %>
...
<%@page import="gcom.gui.cobranca.CriterioCobrancaActionForm"%>

<bean:define property="idsCobrancaSituacao" id="idsSituacaoCobranca" name="CriterioCobrancaActionForm"/>
<bean:define property="idsSituacaoLigacaoAgua" id="idsLigacaoAguaSituacao" name="CriterioCobrancaActionForm"/>
<bean:define property="idsSituacaoLigacaoEsgoto" id="idsLigacaoEsgotoSituacao" name="CriterioCobrancaActionForm"/>
...
function validaTodosRadioButton(){
	...
	if(form.valorLimitePrioridade.value != 0,00){
	...
	if(form.percentualValorMinimoPagoParceladoCancelado.value != 0,00){
	...
	if(form.percentualQuantidadeMinimoPagoParceladoCancelado.value != 0,00){
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<td colspan="2">
					<table width="100%" cellpadding="0" cellspacing="0">
						...
						<logic:present name="colecaoCobrancaCriterioLinha">
                            ...
                            <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de &Aacute;gua:</strong></td>                 
                 	<td colspan="2">
                 	<logic:present name="desabilita">
	                 	...
	                 	<table bgcolor="FFFFFF">
	                 		<logic:iterate name="colecaoSituacaoLigacaoAgua" id="ligacaoAguaSituacao" type="LigacaoAguaSituacao">
	                 			<% 
	                 				boolean achouSituacaoLigacaoAgua = false;
	                 				String[] ids = (String[])idsLigacaoAguaSituacao;
	                 				for (int i = 0 ; i < ids.length; i++) {
	                 					if (ligacaoAguaSituacao.getId().equals(new Integer(ids[i]))) {
	                 						achouSituacaoLigacaoAgua = true;
	                 					}
	                 				}
	                 			
	                 				if (achouSituacaoLigacaoAgua) {
	                 			%>
	                 				<tr bgcolor="C0C0C0">
	                 					<td>
	                 						<font color="FFFFFF"> <bean:write name="ligacaoAguaSituacao" property="descricao"/> </font>
	                 					</td>
	                 				</tr>
	                 			<% } else { %>
	                 				<tr>
               ...
               <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de Esgoto:</strong></td>                 
                 	<td colspan="2">
                 	<logic:present name="desabilita">                 	
                 		<div style="width: 100%; height: 100px; overflow: auto;" >
	                 	<table bgcolor="FFFFFF">
	                 		<logic:iterate name="colecaoSituacaoLigacaoEsgoto" id="ligacaoEsgotoSituacao" type="LigacaoEsgotoSituacao">
	                 			<% 
	                 				boolean achouSituacaoLigacaoEsgoto = false;
	                 				String[] ids = (String[])idsLigacaoEsgotoSituacao;
	                 				for (int i = 0 ; i < ids.length; i++) {
	                 					if (ligacaoEsgotoSituacao.getId().equals(new Integer(ids[i]))) {
	                 						achouSituacaoLigacaoEsgoto = true;
	                 					}
	                 				}
	                 			
	                 				if (achouSituacaoLigacaoEsgoto) {
	                 			%>
	                 				<tr bgcolor="C0C0C0">
	                 					<td>
	                 						<font color="FFFFFF"> <bean:write name="ligacaoEsgotoSituacao" property="descricao"/> </font>
	                 					</td>
	                 				</tr>
	                 			<% } else { %>
	                 				<tr>
                 ...
                 <tr>
					<td colspan="2"><strong>Indicador de Uso:<font color="#FF0000"></font><font color="#FF0000">*</font></strong>&nbsp;
					<html:radio
				...
				<tr>
					...
					<table width="100%" border="0" bgcolor="#99CCFF">
						...
						<tr> 
                  <td><strong>Data de In&iacute;cio de Vig&ecirc;ncia do Crit&eacute;rio:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
				     <td width="40%">
				     <logic:present name="desabilita">
              ...
              <tr> 
                <td><p><strong>N&uacute;mero de Anos para Determinar Conta Antiga:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></p></td>
                <td width="40%">
                  <logic:present name="desabilita">
              ...
              <tr> 
	                  <td><strong>Valor Limite para Prioridade:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
               		 <logic:present name="desabilita">
               		 <td>
                 ...
                 <tr>
		             ...
		             <tr> 
		             <td width="2%">&nbsp;</td>
	                  <td width="48%"><strong>  Percentual Valor:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
                  ...
                  <tr> 
                 	 <td width="2%">&nbsp;</td>
	                  <td width="48%"><strong>  Percentual Quantidade de Itens:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
					 <logic:present name="desabilita">
					 <td>
		          ...
		          <tr> 
	                  ...
	                  <td width="48%"><strong>  Quantidade dias cortado:</strong></td>					   
					   <td>
					     <logic:present name="desabilita">
	                  		<html:text property="qtdDiasCortado" size="6" maxlength="6" tabindex="6" style="text-align:right;" disabled="true" />
				  	   </logic:present>
				  	   
				  	    <logic:notPresent name="desabilita">
	                  		<html:text property="qtdDiasCortado" size="6" maxlength="6" tabindex="6" style="text-align:right;" />
				  	   </logic:notPresent>				  	  
				  	  </td>
			      </tr> 
              ...
              <tr> 
                ...
                <table width="100%" border="0">
                 ...
                 <tr>
                  <td width="65%"><strong>Emiss&atilde;o da A&ccedil;&atilde;o para Im&oacute;vel 
                        com Situação Especial de Cobran&ccedil;a:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
                  <logic:present name="desabilita">
                 ...
                 <tr> 
                  ...
                  <logic:notPresent name="desabilita">
                     <td><html:radio property="opcaoAcaoImovelSit" value="1" tabindex="9" onclick="javascript:habilitarSelectComCor(document.forms[0].opcaoAcaoImovelSit, document.forms[0].idsCobrancaSituacao, -1)" /> 
                      <strong>Sim</strong></td>
                  <td><html:radio property="opcaoAcaoImovelSit" value="2" tabindex="10" onclick="javascript:habilitarSelectComCor(document.forms[0].opcaoAcaoImovelSit, document.forms[0].idsCobrancaSituacao, -1)"/> 
                      <strong>N&atilde;o</strong></td>
                  </logic:notPresent>                  
                 </tr>
                 <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de cobran&ccedil;a:</strong></td>                 
                 	...
                 	<div style="width: 100%; height: 100px; overflow: auto;" >
                 	<table bgcolor="FFFFFF">
                 		<logic:iterate name="colecaoCobrancaSituacao" id="cobrancaSituacao" type="CobrancaSituacao">
                 			<% 
                 				boolean achouSituacaoCobranca = false;
                 				String[] ids = (String[])idsSituacaoCobranca;
                 				for (int i = 0 ; i < ids.length; i++) {
                 					if (cobrancaSituacao.getId().equals(new Integer(ids[i]))) {
                 						achouSituacaoCobranca = true;
                 					}
                 				}
                 			
                 				if (achouSituacaoCobranca) {
                 			%>
                 				<tr bgcolor="C0C0C0">
                 					<td>
                 						<font color="FFFFFF"> <bean:write name="cobrancaSituacao" property="descricao"/> </font>
                 					</td>
                 				</tr>
                 			<% } else { %>
                 				<tr>
               ...
               <tr>
                 	<td><strong>Com CPF:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td>
                 	
                    <logic:present name="desabilita">
                 	<td><html:radio property="comCpf" value="1" disabled="true"><strong>Sim</strong></html:radio></td>     	
                 	<td><html:radio property="comCpf" value="2" disabled="true"><strong>Não</strong></html:radio></td>
                 	<td><html:radio property="comCpf" value="3" disabled="true"><strong>Ambos</strong></html:radio></td>
                 	</logic:present>   
                 	
                 	<logic:notPresent name="desabilita">  
                 	<td><html:radio property="comCpf" value="1"><strong>Sim</strong></html:radio></td>     	
                 	<td><html:radio property="comCpf" value="2"><strong>Não</strong></html:radio></td>
                 	<td><html:radio property="comCpf" value="3"><strong>Ambos</strong></html:radio></td>        	
                 	</logic:notPresent>  
                 	
               	</tr>
                
                <tr>
                 	<td><strong>Com Telefone:<font color="#FF0000"></font><font color="#FF0000">*</font></strong></td> 
                 	               	
                 	<logic:present name="desabilita">
                 	<td><html:radio property="comTelefone" value="1" disabled="true"><strong>Sim</strong></html:radio></td>
                 	<td><html:radio property="comTelefone" value="2" disabled="true"><strong>Não</strong></html:radio></td>   
                 	<td><html:radio property="comTelefone" value="3" disabled="true"><strong>Ambos</strong></html:radio></td>     		
                    </logic:present> 	
