...
<body leftmargin="5" topmargin="5">
	<html:form action="/removerInfracaoImovelSituacaoAction.do"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Situação Infração Imóvel</td>
				...
				<td colspan="5">
					<table width="100%" bgcolor="#99CCFF">
						...
						<pg:pager isOffset="true" index="half-full" maxIndexPages="10" export="currentPageNumber=pageNumber;pageOffset" maxPageItems="10" items="${sessionScope.totalRegistros}">
							<pg:param name="pg" />
							<pg:param name="q" />
								<logic:present name="colecaoInfracaoImovelSituacao">
									<%int cont = 0;%>
									<logic:iterate name="colecaoInfracaoImovelSituacao" id="item">
										<pg:item>
											<%cont = cont + 1;
											  if (cont % 2 == 0) {%>
											<tr bgcolor="#cbe5fe">
											...
											<%}%>
												<logic:equal name="item" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
													...
													<td width="34%">
														<a href="exibirAtualizarInfracaoImovelSituacaoAction.do?manter=sim&idRegistroAtualizacao=<bean:write name="item" property="id" />">
												...
												<logic:notEqual name="item" property="indicadorUso" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
													<td width="7%">
														<div align="center"><input type="checkbox" name="idRegistrosRemocao" value="<bean:write name="item" property="id"/>" /></div> </td>
													<td width="12%">
														<div align="center"><bean:write name="item" property="id" /></div> </td>
													<td width="34%">
														<a href="exibirAtualizarInfracaoImovelSituacaoAction.do?manter=sim&idRegistroAtualizacao=<bean:write name="item" property="id" />">
						...
						<tr>
							<td valign="top">
								...
								<input  name="button"
										...
										value="Voltar Filtro"
										onclick="window.location.href='/gsan/exibirFiltrarInfracaoImovelSituacaoAction.do'"
										align="left" 
										style="width: 80px;"></td>
							<td valign="top">
								<div align="right"></div>
