		...
		<table width="100%" border="0">
			<tr>
				...
				<table width="100%" border="0">
					...
					<tr>
						<td height="24"><strong>Quadra Inicial:</strong></td>
						<td colspan="3"><strong><strong> <html:text maxlength="4" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"
					name="ExibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoActionForm"
					property="quadraInicial" size="4"/>  </strong></strong></td>
					</tr>
					<tr>
						<td height="24"><strong>Quadra Final:</strong></td>
						<td colspan="3"><strong><strong> <html:text maxlength="4" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"
					name="ExibirResultadoConsultarComandosAcaoCobrancaEventualDadosComandoActionForm"
					property="quadraFinal" size="4"/>  </strong></strong></td>
					</tr>
					<tr>
						...
						<div align="left">
							...
							<input name="Button2" type="button"
								...
								onclick="window.location.href='<html:rewrite page="/gerarRelatorioEmitirProtocoloDocumentoCobranca.do"/>'"/>
								 -->
							<input name="BaixarListaImoveis" type="button"
								class="bottonRightCol" value="Baixar Lista de Imóveis"
								onclick="window.location.href='exibirComandosAcaoCobrancaEventualDadosComandoAction.do?idCobrancaAcaoAtividadeEventualListaImoveis=<%= request.getAttribute("idCobrancaAcaoAtividadeEventualListaImoveis") %>'"/>
						</div>
						</td>
						</logic:present>
