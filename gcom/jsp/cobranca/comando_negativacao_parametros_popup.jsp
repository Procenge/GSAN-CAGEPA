...
<body leftmargin="5" topmargin="5" onload="window.focus();">
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<td><html:radio property="indicadorSimularNegativacao"
												value="<%=ConstantesSistema.SIM.toString()%>" /><strong>Sim
											<html:radio property="indicadorSimularNegativacao"
												value="<%=ConstantesSistema.NAO.toString()%>" />Não </strong>
											</td>
										</tr>
														...
														<tr bgcolor="#FFFFFF">
															...
															<td width="20%" align="center"><logic:equal
																...
																<input type="checkbox" name="negativacaoCriterioCpfTipo"
																	property="indicadorCoincidente" checked="true" />
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<html:hidden property="indicadorGuiaPagamento" value="<%=ConstantesSistema.NAO.toString()%>"/>
										<!-- <tr>
										...
										<tr>
											...
											<td><html:radio property="indicadorRecCartaAtraso"
												value="<%=ConstantesSistema.SIM.toString()%>" /><strong>Recebeu
											<html:radio property="indicadorRecCartaAtraso"
												value="<%=ConstantesSistema.NAO.toString()%>" />Não Recebeu
											</strong></td>
										</tr>
