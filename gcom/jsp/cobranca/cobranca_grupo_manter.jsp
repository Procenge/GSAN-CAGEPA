...
<%@page import="gcom.cobranca.CobrancaGrupo"%>
...
<html:form action="/removerCobrancaGrupoAction"
				...
				<tr>
					<td colspan="7" height="23">
						<font style="font-size: 10px;" color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
							<strong>Grupos de Cobrança Cadastrados:</strong> 
						</font>
					</td>
				</tr>
				<tr>
										...
										<pg:item>
											...
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="cobrancaGrupo" property="id"/>"></div>
												</td>
												<td width="18%">
												<div align="center"><bean:write name="cobrancaGrupo"
													property="id" /></div>
												</td>
												
												<td width="45%"
												 align="center"><html:link
													href="/gsan/exibirAtualizarCobrancaGrupoAction.do?manter=sim"
													paramId="id" paramProperty="id"
													paramName="cobrancaGrupo"
													title="<%="" + cobrancaGrupo.getDescricao()%>">
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit
										...
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarCobrancaGrupoAction.do?limpar=S"/>'"
