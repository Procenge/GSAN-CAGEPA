...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false" 
	formName="ConsultarHistoricoMedicaoIndividualizadaActionForm" />
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="598" border="0">
				<tr>
					<td>Para consultar o hist&oacute;rico de
					medi&ccedil;&atilde;o individualizada, informe os dados abaixo:</td>
				   <td align="right"></td>								
				</tr>
				</table>
				<table width="598" border="0">
				<tr>
					<td class="style1"><strong>Matr&iacute;cula do Im&oacute;vel
					Condom&iacute;nio:</strong><strong><font color="#FF0000">*</font></strong></td>
					<td class="style1" colspan="2">
					<div align="left"><html:text property="codigoImovel" maxlength="9"
						size="9"
						onkeypress="validaEnter(event, 'exibirConsultarHistoricoMedicaoIndividualizadaAction.do?pesquisaImovel=OK', 'codigoImovel');" />
					<a
				...
				<tr>
					<td width="220" class="style1"><strong>M&ecirc;s/Ano do
					Faturamento:</strong><strong><font color="#FF0000">*</font></strong></td>
					<td width="310" class="style1"><html:text property="mesAno"
						size="10" maxlength="7"
						onkeyup="javascript:mascaraAnoMes(this, event);" /> mm/aaaa</td>

					<td width="65" align="left" class="style1">
					<gcom:controleAcessoBotao name="Button" value="Consultar"
							  onclick="javascript:consultar();" url="exibirConsultarHistoricoMedicaoIndividualizadaAction.do"/>
<!-- 
			...
			<table width="590" border="0" bgcolor="#79bbfd" align="center"
									...
									<logic:iterate name="dadosImovel" id="imovel">
										<tr bgcolor="#FFFFFF">
											...
											<div align="center"><bean:write name="imovel"
												property="enderecoFormatado" /></div>
											</td>
										</tr>
									</logic:iterate>
								</logic:present>
							...
							<logic:iterate name="dadosImovel" id="imovel">
								<tr bgcolor="#FFFFFF">
									...
									<logic:present 	name="imovel"
										...
										<bean:define name="imovel"
											property="ligacaoAguaSituacao" id="ligacaoAguaSituacao" /> <bean:write
											name="ligacaoAguaSituacao" property="descricao" />
									</logic:present>	
										</div>
									</td>
									<td height="17">
									...
									<bean:define name="imovel"
										property="ligacaoEsgotoSituacao" id="ligacaoEsgotoSituacao" />
									...
									<div align="center">
										<logic:present name="imovel"
										property="ligacaoAgua">
										<bean:define name="imovel"
										property="ligacaoAgua" id="ligacaoAgua" /> 
										<logic:present name="ligacaoAgua" property="hidrometroInstalacaoHistorico">
										<bean:define
										name="ligacaoAgua" property="hidrometroInstalacaoHistorico"
										id="hidrometroInstalacaoHistorico" /> 
										<logic:present name="hidrometroInstalacaoHistorico" property="rateioTipo">
										<bean:define
										name="hidrometroInstalacaoHistorico" property="rateioTipo"
										id="rateioTipo" /> 
										
										<bean:write name="rateioTipo"
										property="descricao" />
										</logic:present>
										</logic:present>
										</logic:present>
									...
									<td height="17">
									<div align="center"><html:text readonly="true"
										style="background-color:#FFFFFF; border:0; text-align:center"
										property="quantidadeImoveisVinculados" /></div>
									</td>
								</tr>
							</logic:iterate>
						</logic:present>
			...
			<p>&nbsp;</p>
			<table width="590" border="0" bgcolor="#79bbfd"  align="center" cellpadding="0"
				cellspacing="0">
				<!--header da tabela interna -->
				<tr bgcolor="#79bbfd" height="18">
					<td align="center" class="style11"><strong>Hist&oacute;rico de
					Medi&ccedil;&atilde;o Individualizada</strong></td>
				</tr>
			</table>	
				...
				<tr>
					...
					<table width="590" bgcolor="#90c7fc">
						<tr bgcolor="#90c7fc">
							...
							<td width="11%">
							<div align="center"><strong>Cons.&Aacute;gua Medido </strong></div>
							</td>
							<td width="11%">
			...
			%>
						<logic:present
							name="colecaoConsultarHistoricoMedicaoIndividualizada"
							scope="session">
							<logic:iterate
								name="colecaoConsultarHistoricoMedicaoIndividualizada"
								id="consultarHistoricoMedicaoIndividualizadaHelper">
				...
				if (cor.equalsIgnoreCase("#cbe5fe")) {
					...
					cor = "#cbe5fe";%>
								<tr bgcolor="#cbe5fe">
									<%}%>
									<td width="11%">
									<div align="center"><b><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="matriculaImovel" /></b></div>
									</td>
									<td width="37%">
									<div align="left"><b><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="nomeClienteUsuario" /></b></div>
									</td>
									<td width="9%">
									<div align="center"><b><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="tipoConsumo" /></b></div>
									</td>
									<td width="11%">
									<div align="center"><b><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="consumoAguaMedido" /></b></div>
									</td>
									<td width="11%">
									<div align="center"><b><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="consumoRateio" /></b></div>
									</td>
									<td width="11%">
									<div align="center"><b><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="consumoAguaFaturado" /></b></div>
									</td>
									<td width="10%">
									<div align="center"><b><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="consumoEsgoto" /></b></div>
									</td>
								</tr>
								<%} else {
					...
					cor = "#FFFFFF";%>
								<tr bgcolor="#FFFFFF">
									...
									<div align="center"><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="matriculaImovel" /></div>
									</td>
									<td width="37%">
									<div align="left"><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="nomeClienteUsuario" /></div>
									</td>
									<td width="9%">
									<div align="center"><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="tipoConsumo" /></div>
									</td>
									<td width="11%">
									<div align="center"><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="consumoAguaMedido" /></div>
									</td>
									<td width="11%">
									<div align="center"><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="consumoRateio" /></div>
									</td>
									<td width="11%">
									<div align="center"><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
										property="consumoAguaFaturado" /></div>
									</td>
									<td width="10%">
									<div align="center"><bean:write
										name="consultarHistoricoMedicaoIndividualizadaHelper"
			...
			<table border="0">
				<tr>
					<td align="left"><input type="button" name="limpar"
