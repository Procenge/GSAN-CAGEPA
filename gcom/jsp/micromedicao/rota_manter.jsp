					...
					<td>
						<table width="100%" bgcolor="#90c7fc">
							...
							<tr>
								...
								<td align="center" width="12%" bgcolor="#90c7fc"><strong>Grupo de Faturamento</strong></td>
								<td align="center" width="27%" bgcolor="#90c7fc"><strong>Agente Comercial</strong></td>
								<td align="center" width="27%" bgcolor="#90c7fc"><strong>Empresa de Leitura</strong></td>
							</tr>
									...
									<%}%>
											...
											<td width="27%">
												<div>
													<logic:notEqual name="rota" property="indicadorUso"
														value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
														 <logic:empty name="rota" property="leiturista.cliente">
														    <bean:write name="rota" property="leiturista.funcionario.nome"/>
														 </logic:empty>
														 <logic:notEmpty name="rota" property="leiturista.cliente">
														    <bean:write name="rota" property="leiturista.cliente.nome" />
														 </logic:notEmpty>  &nbsp;
													</logic:notEqual> 
													<logic:equal name="rota" property="indicadorUso"
														value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
														<font color="#CC0000"><logic:empty name="rota" property="leiturista.cliente">
														    <bean:write name="rota" property="leiturista.funcionario.nome"/>
														 </logic:empty>
														 <logic:notEmpty name="rota" property="leiturista.cliente">
														    <bean:write name="rota" property="leiturista.cliente.nome" />
