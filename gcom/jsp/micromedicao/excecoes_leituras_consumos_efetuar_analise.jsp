...
function gerarRelatorio(tipo){
	...
	if(tipo == "pdf"){
		...
		if (idRegistrosImovel.length > 0){
			form.action = "gerarRelatorioAnaliseConsumoExcelAction.do?idRegistrosImovel=" + idRegistrosImovel +
			"&paginaCorrente=" + paginaCorrente;
		}
		else{
			form.action = "gerarRelatorioAnaliseConsumoExcelAction.do?paginaCorrente=" + paginaCorrente;
		}
	}
...
<input type="hidden" name="caminhoReload"
	value="exibirManterAnaliseExcecoesConsumosAction.do" /> 
...
<table width="770" border="0" cellspacing="4" cellpadding="0">
  <tr>
   <td width="130"  valign="top" class="leftcoltext">
               	...
               	<tr>
                    ...
                    <pg:pager isOffset="true" index="half-full" maxIndexPages="10"
                      ...
                      <logic:iterate name="colecaoImovelMedicao" id="imovelMicromedicao">
						...
						<td width="10%">				
							<div align="center">			
									<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">${imovelMicromedicao.imovel.id}</font></div>
						</td>
            ...
            <table width="100%" border="0">
				<tr>
  	             ...
  	             <table width="100%">
					<tr>
						<tr align="right">
                        <td align="left"><input type="button" name="" value="Relatório Análise de Consumo PDF" class="bottonRightCol" style="width:290px;"
									onclick="gerarRelatorio('pdf');"/></td>
                         
        		         <td align="right">
        		          <logic:equal name="indicadorImovelCondominio" value="1" scope="session">	        		         
								  <input type="button" name="" value="Relatório Fat. de Medição Individualizada" class="bottonRightCol"  style="width:290px;"
							...
							<tr align="right">
                               ...
                               <input name="button" type="button" class="bottonRightCol" value="Voltar Filtro" onclick="window.location.href='<html:rewrite page="/exibirFiltrarExcecoesLeiturasConsumosAction.do?nomeCaminhoMapping=efetuarAnaliseExcecoesLeiturasConsumos"/>'" align="left" style="width: 80px;">
								...
								<td align="right"><input type="button" name="" value="Relatório Análise de Consumo XLS" class="bottonRightCol" style="width:290px;"
									onclick="gerarRelatorio('xls');"/></td>
							</tr>
    ...
    <jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioFaturamentoLigacoesMedicaoIndividualizadaAction.do" />
