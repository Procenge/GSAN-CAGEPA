						...
						<tr>
							...
							<table width="100%" bgcolor="#90c7fc">
								...
								<logic:present name="colecaoImoveisASerVinculados">
									<%int cont = 0;%>
									<logic:iterate name="colecaoImoveisASerVinculados"
										id="clienteImovel">
			                          ...
			                          <tr bgcolor="#cbe5fe">
										...
										<tr bgcolor="#FFFFFF">
											...
											<td width="11%" align="center"><bean:write name="clienteImovel"
												property="imovel.id" /></td>
											<td width="50%" align="left"><bean:write name="clienteImovel"
												property="cliente.nome" /></td>
											<td width="10%" align="left">
											<div align="center"><bean:write name="clienteImovel"
												property="imovel.subLote" /></div>
											</td>
											<td width="17%" align="left">
											<div align="left"><bean:write name="clienteImovel"
												property="imovel.complementoEndereco" /></div>
											</td>
										</tr>
									</logic:iterate>
								</logic:present>
