...
<script language="JavaScript">
	function validarForm(){
	   ...
	   if(form.uploadPicture.value != '') {
	  	 	if(confirm('Confirma gerar dados para leitura?')){
	    	   form.submit();
		   	}
	   }else{
		  if(form.uploadPicture.value == ''){
...
<form action="/gsan/gerarDadosParaLeituraAction.do"
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Gerar Dados Para Leitura</td>
		...
		<table width="100%" border="0">
			...
			<tr>
				<td colspan="2">Para gerar os dados para leitura, informe os dados abaixo:</td>
			</tr>
			...
			<tr>
				<td align="left">
					<input name="Button" 
						...
						value="Desfazer" 
						align="left"
						onclick="window.location.href='<html:rewrite page="/exibirGerarAvisoDeDebitoAction.do?menu=sim"/>'">
						&nbsp;
