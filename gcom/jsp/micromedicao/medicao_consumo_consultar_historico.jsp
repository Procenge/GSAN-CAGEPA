...
<table width="770" border="0" cellspacing="4" cellpadding="0">
  <tr>
   ...
   <br>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td height="4" bgcolor="#cbe5fe" colspan="7"></td>
		</tr>
        <tr bordercolor="#000000" > 
          <td colspan="7" bgcolor="#79bbfd" height="20"> <div align="center">
        ...
        <tr bordercolor="#000000"> 
          <td width="14%" bgcolor="#90c7fc"><div align="center">
          	<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">
          	<strong> M&ecirc;s 
          ...
          <td width="14%" bgcolor="#90c7fc" align="center">
          	<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">
          	<strong>Crédito de Consumo</strong></font>
          </td>
          <td width="14%" bgcolor="#90c7fc" align="center">
          	<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">
          ...
          <td width="21%" bgcolor="#90c7fc" align="center">
          	<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">
          	<strong>Tipo de 
              Consumo</strong></font>
          </td>
			   ...
			   <%int cont2=0;%>
			    <logic:notEmpty name="imoveisMicromedicao">
					...
					<logic:iterate name="imoveisMicromedicao" id="imovelMicromedicao">
				          ...
				          <td width="14%" align="center">
				          	<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">
				          	${imovelMicromedicao.medicaoHistorico.consumoMinimoCreditado} &nbsp;</font>
				          </td>
				          <td width="14%" align="center">
				          	<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif">
