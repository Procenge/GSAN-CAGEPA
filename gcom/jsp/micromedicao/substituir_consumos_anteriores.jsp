...
<html:form 
	action="/substituirConsumosAnterioresAction" 
            ...
            <table width="100%" border="0" >
					...
					<td colspan="2">
						<table width="100%">
						 <tr>
								...
								<td>
								<html:text maxlength="9" property="idImovelSubstituirConsumo"
												size="10"
 			  ...
 			  <tr>
 			  	<td colspan="2">
					<table width="100%">
					<tr>
		                <td width="183"><strong>Endere&ccedil;o(s) do Imóvel<font color="#FF0000">*</font></strong></td>
...
<!-- ************************************************************************ -->
					<table width="100%" bgcolor="#99CCFF" >
				        ...
				        <tr bordercolor="#90c7fc"> 
				         <td width="62" rowspan="2" bgcolor="#90c7fc" align="center"><div align="center"><strong>M&ecirc;s 
				             de Refer&ecirc;ncia</strong></div></td>
				
				         <td colspan="3" bgcolor="#90c7fc" align="center"><div align="center"><strong>Dados 
				             de &Aacute;gua</strong></div></td>
				         <td colspan="3" bgcolor="#90c7fc" align="center"><div align="center"><strong>Dados 
				             de Esgoto</strong></div></td>
				       </tr>
				       <tr bordercolor="#90c7fc"> 
				         <td width="60" height="35" bgcolor="#cbe5fe" align="center"> <div align="center"><strong>Consumo 
				             Fatur. M&ecirc;s</strong></div></td>
				         <td width="60" bgcolor="#cbe5fe" align="center"><div align="center"><strong>Tipo 
				             do Consumo</strong></div></td>
				
				         <td width="91" bgcolor=#cbe5fe align="center"><div align="center"><strong>Anormalidade 
				             de Consumo</strong></div></td>
				         <td width="82" bgcolor="#cbe5fe" align="center"><div align="center"><strong>Consumo 
				             Fatur. M&ecirc;s</strong></div></td>
				         <td width="88" bgcolor="#cbe5fe" align="center"><div align="center"><strong>Tipo 
				             do Consumo</strong></div></td>
				         <td width="145" bgcolor="#cbe5fe" align="center"><div align="center"><strong>Anormalidade 
				             de Consumo</strong></div></td>
				       </tr>
				          ...
				          <td colspan="7" height="150">
							   ...
							   <%int cont=0;%>
							    <logic:notEmpty name="colecaoConsumoHistorico">
									...
									<logic:iterate name="colecaoConsumoHistorico" id="imovelMicromedicao" scope="session">
							              <%
						                      cont = cont+1;
						                   if (cont%2==0){%>
						                     	<tr bgcolor="#cbe5fe">
						                  ...
						                  <td width="63">
							                 <logic:notEmpty name="imovelMicromedicao" property="consumoHistorico">
							                   <div align="center">${imovelMicromedicao.consumoHistorico.mesAno} &nbsp;</div>
						                  	 </logic:notEmpty>
							                 <logic:empty name="imovelMicromedicao" property="consumoHistoricoEsgoto">
							                   <div align="center">${imovelMicromedicao.consumoHistoricoEsgoto.mesAno} &nbsp;</div>
						                  	 </logic:empty>
						                  </td>
						                  <td width="60"><div align="center"> 
							                  <logic:notEmpty name="imovelMicromedicao" property="consumoHistorico">
							                      <input name="agua${imovelMicromedicao.consumoHistorico.id}" type="text" size="5" maxlength="6"
							                      value="${imovelMicromedicao.consumoHistorico.numeroConsumoFaturadoMes}" id="valor">
							                  </logic:notEmpty>
						                    </div></td>
						                  <td width="62"><div align="center">${imovelMicromedicao.consumoHistorico.consumoTipo.descricaoAbreviada} &nbsp;</div></td>
						                  <td width="98"><div align="center">${imovelMicromedicao.consumoHistorico.consumoAnormalidade.descricaoAbreviada} &nbsp;</div></td>
						                  <td width="83"><div align="center"> 
						                  	  <logic:notEmpty name="imovelMicromedicao" property="consumoHistoricoEsgoto">
												  <input name="esgoto${imovelMicromedicao.consumoHistoricoEsgoto.id}" type="text" size="4" maxlength="4"
							                      value="${imovelMicromedicao.consumoHistoricoEsgoto.numeroConsumoFaturadoMes}" id="valor">		                  	  
						                  	  </logic:notEmpty>
						                  	  <logic:empty name="imovelMicromedicao" property="consumoHistoricoEsgoto">
						                  	  	 &nbsp;
						                  	  </logic:empty>
						                  ...
						                  <td width="88"><div align="center">${imovelMicromedicao.consumoHistoricoEsgoto.consumoTipo.descricaoAbreviada} &nbsp;</div></td>
						                  <td width="142"><div align="center">${imovelMicromedicao.consumoHistoricoEsgoto.consumoAnormalidade.descricaoAbreviada} &nbsp; </div></td>
						                </tr>
							      	</logic:iterate>
						      </logic:notEmpty>
						     </table>
							 ...
							 <tr>
						      <td align="left">
						       <logic:notPresent name="peloMenu">
			        		     ...
			        		     <input type="button" value="Desfazer" onclick="document.forms[0].reset();" 
