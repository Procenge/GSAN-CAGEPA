...
<script language="JavaScript">
	...
	function limparLeiturista(form) {
 	...
 	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
    	...
    	if (tipoConsulta == 'localidade') {
			...
			form.action = 'exibirAtualizarRoteiroEmpresaAction.do?reloadPage=false&localidadeAlterada=Sim';
			submeterFormPadrao(form);       	
    	} else 
		...
		if (tipoConsulta == 'leiturista') {
	        ...
	        if (grupo != '' && localidade != ''){ 
	        	form.action = 'exibirAtualizarRoteiroEmpresaAction.do?grupoAlterado=Sim&reloadPage=false';
				submeterFormPadrao(form);
			}	
	    } 
   }
	...
	function carregarQuadras(){
	    var form = document.forms[0];
		form.action = 'exibirAtualizarRoteiroEmpresaAction.do?carregarQuadras=Sim&reloadPage=false';
...
<p>&nbsp;</p>
			...
			<table width="100%" border="0">
              ...
              <tr>
					<td width="130"><strong>Agente Comercial:<font color="#FF0000">*</font></strong></td>
			 ...
			 <tr> 
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="3" tabindex="4" property="idLocalidade"
						size="3"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirAtualizarRoteiroEmpresaAction.do?reloadPage=false&localidadeAlterada=Sim', 'idLocalidade', 'Localidade');" />
