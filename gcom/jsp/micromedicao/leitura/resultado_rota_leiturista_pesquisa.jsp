			...
			<td width="630" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" bgcolor="#90c7fc">
					<tr align="left">
						...
						<td width="17%" align="center"><strong>Setor Comercial</strong></td>
						<td width="13%" align="center"><strong>Grupo Faturamento</strong></td>
					</tr>
					...
					<pg:pager isOffset="true" index="half-full" maxIndexPages="10" export="currentPageNumber=pageNumber;pageOffset" 
						...
						<logic:iterate name="rotas" id="rota">
							<pg:item>
								<%
								cont++;
								bgcolor = (cont % 2 == 0)? "#CBE5FE" : "#FFFFFF";
								%>
								
								<tr bgcolor="<%=bgcolor %>">
									<td width="13%" align="center">
										<div align="center">
											<a href="javascript:enviarDados('<bean:write name="rota" property="id"/>',
									...
									<td width="17%" align="center">
										<logic:present name="rota" property="setorComercial">
											<bean:define name="rota" property="setorComercial" id="setorComercial" />
											<bean:write name="setorComercial" property="codigo" />
										</logic:present>							
									</td>
									<td width="20%" align="center">
										<logic:present name="rota" property="faturamentoGrupo">
											<bean:define name="rota" property="faturamentoGrupo" id="faturamentoGrupo" />
