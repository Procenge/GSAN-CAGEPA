...
<html:form action="/pesquisarLeituristaAction"
	...
	<table width="550" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Pesquisar Agente Comercial</td>
					<td width="11"><img border="0"
      ...
      <table width="100%" border="0">
        <tr> 
          <td colspan="2">Preencha os campos para pesquisar um Agente Comercial:</td>
          <td align="right"></td>
        </tr>
       </table>
       ...
       <table width="100%" border="0">
        ...
        <tr>
			...
			<a href="javascript:redirecionarSubmit('exibirPesquisarFuncionarioAction.do?caminhoRetornoTelaPesquisaFuncionario=exibirPesquisarLeituristaAction');">
