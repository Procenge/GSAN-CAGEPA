...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		if(testarCampoValorZero(document.InformarLeituraFiscalizacaoActionForm.dataLeituraFiscalizacao, 'Data da Leitura') && 
			testarCampoValorZero(document.InformarLeituraFiscalizacaoActionForm.matriculaLeituristaFiscalizacao, 'Matrícula Agente Comercial') /*&& 
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr>
											<td width="200"><strong>Matrícula Agente Comercial:</strong></td>
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr>
											<td width="200"><strong>Matrícula Agente Comercial:<font color="#FF0000">*</font></strong></td>
