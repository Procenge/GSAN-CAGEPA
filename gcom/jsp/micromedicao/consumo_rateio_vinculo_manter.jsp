...
function verficarSelecao(objeto, tipoObjeto,botao){
       ...
       if (selecionado.length < 1) {
         alert('Nenhum registro selecionado.');
			...
			if(botao == 1){
				javascript:abrirPopup('exibirAtualizarTipoRateioPopupAction.do?MatriculaImovel='+selecionado, 250, 600);
			}else if(botao == 2){
				javascript:abrirPopup('exibirEstabelecerVinculoPopupAction.do?MatriculaImovel='+selecionado, 500, 665);		
			}else if(botao == 3){
