				...
				<tr>
					...
					<table width="100%" bgcolor="#90c7fc">
						...
						<tr bgcolor="#90c7fc">
							...
							<td width="10%">
							<div align="center"><strong>Leitura de Corte</strong></div>
							</td>						
							<td>
						...
						<c:forEach items="${requestScope.hidrometrosInstalacaoHistorico}"
                            ...
                            <%}%>
 										<td>
								<div align="center"><a
									href="consultarHistoricoInstalacaoHidrometroPopupAction.do?codigoHidrometro=${hidrometroInstalacaoHistorico.hidrometro.numero}">${hidrometroInstalacaoHistorico.hidrometro.numero}&nbsp;</a>
								</div>
								</td>
								<td>
								...
								<td>
								<div align="center">${hidrometroInstalacaoHistorico.numeroLeituraCorte}&nbsp;</div>
								</td>								
								<td>
