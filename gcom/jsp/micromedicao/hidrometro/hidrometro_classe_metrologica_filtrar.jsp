...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	...
	<html:javascript staticJavascript="false"  formName="FiltrarHidrometroClasseMetrologicaActionForm"/>
...
<script language="JavaScript">
	...
	function setaFocus(){
		var form = document.FiltrarHidrometroClasseMetrologicaActionForm;
		form.descricaoClasseMetrologicaHidrometro.focus();
	}
	...
	function validarForm() {
      ...
      form.action = 'filtrarHidrometroClasseMetrologicaAction.do';
	  if(validateFiltrarHidrometroClasseMetrologicaActionForm(form)){	
...
<html:form action="/filtrarHidrometroClasseMetrologicaAction"
	name="FiltrarHidrometroClasseMetrologicaActionForm"
	type="gcom.gui.micromedicao.hidrometro.FiltrarHidrometroClasseMetrologicaActionForm"
	method="post"
	onsubmit="return FiltrarHidrometroClasseMetrologicaActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Classe Metrologica do Hidrômetro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar a(s) classe(s) metrologica(s) do hidrômetro, informe os dados abaixo:</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="descricaoClasseMetrologicaHidrometro" size="20" maxlength="20"
						tabindex="1" /></td>
				</tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left"
						onclick="window.location.href='/gsan/exibirFiltrarHidrometroClasseMetrologicaAction.do?menu=sim'">
					</td>
