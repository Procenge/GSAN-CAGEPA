...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
    ...
    if (tipoConsulta == 'hidrometroLocalArmazenagemDestino') {
    ...
    else if (tipoConsulta == 'hidrometroLocalArmazenagemOrigem') {
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2"> 
						<table width="100%" border="0">
							<tr>
								<td> 
									Para filtrar a(s) movimentações de hidr&ocirc;metros(s), informe os dados abaixo:
								</td>
								<td align="right"></td>			
							</tr>
						</table>
				...
				<tr>
         		...
         		<tr>
					...
					<td>
						...
						<a href="javascript:abrirPopup('exibirPesquisarTabelaAuxiliarAbreviadaAction.do?tela=hidrometroLocalArmazenagemOrigem', 250, 495);">
				...
				<tr>
					...
					<td>
						...
						<a href="javascript:abrirPopup('exibirPesquisarTabelaAuxiliarAbreviadaAction.do?tela=hidrometroLocalArmazenagemDestino', 250, 495);">
						<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" border="0"
							width="23" height="21" style="cursor:hand;" alt="Pesquisar"></a>
						<logic:present name="corLocalArmazenagem">
							<logic:equal name="corLocalArmazenagem" value="exception">
