					...
					<table width="100%" bgcolor="#90c7fc">
						...
						<c:forEach items="${requestScope.hidrometrosInstalacaoHistorico}"
                            ...
                            <%}%>
								<td>
								<div align="center"><a
									href="consultarHistoricoInstalacaoHidrometroPopupAction.do?codigoImovel=${hidrometroInstalacaoHistorico.imovel.id}${hidrometroInstalacaoHistorico.ligacaoAgua.id}">
