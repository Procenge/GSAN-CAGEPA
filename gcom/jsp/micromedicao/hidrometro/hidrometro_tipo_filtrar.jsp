...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	...
	<html:javascript staticJavascript="false"  formName="FiltrarHidrometroTipoActionForm"/>
...
<script language="JavaScript">
	...
	function setaFocus(){
		var form = document.FiltrarHidrometroTipoActionForm;
		form.descricaoTipoHidrometro.focus();
	}
	...
	function validarForm() {
      ...
      form.action = 'filtrarHidrometroTipoAction.do';
	  if(validateFiltrarHidrometroTipoActionForm(form)){	
...
<html:form action="/filtrarHidrometroTipoAction"
	name="FiltrarHidrometroTipoActionForm"
	type="gcom.gui.micromedicao.hidrometro.FiltrarHidrometroTipoActionForm"
	method="post"
	onsubmit="return FiltrarHidrometroTipoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Tipo do Hidrômetro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar o(s) tipo(s) do hidrômetro, informe os dados abaixo:</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="descricaoTipoHidrometro" size="35" maxlength="20"
						tabindex="1" /></td>
				</tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left"
						onclick="window.location.href='/gsan/exibirFiltrarHidrometroTipoAction.do?menu=sim'">
					</td>
