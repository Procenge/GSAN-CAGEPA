...
<link rel="stylesheet"
	...
	<html:javascript staticJavascript="false"  formName="InserirHidrometroDiametroActionForm"
...
<html:form action="/inserirHidrometroDiametroAction.do"
	...
	method="post"
	onsubmit="return InserirHidrometroDiametroActionForm(this);">
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Inserir Diametro do Hidrômetro</td>
		...
		<table width="100%" border="0">
			<tr>
				<td colspan="2">Para inserir o diametro do(s) hidrômetro(s), informe os dados abaixo:</td>
			</tr>
			<tr>
