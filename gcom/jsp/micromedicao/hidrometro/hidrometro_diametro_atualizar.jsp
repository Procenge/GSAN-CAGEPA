...
<html:javascript staticJavascript="false" formName="AtualizarHidrometroDiametroActionForm" dynamicJavascript="true" />
...
<script language="JavaScript">
    ...
    function validarForm() {
	    ...
	    if(validateAtualizarHidrometroDiametroActionForm(form)){	
...
<html:form action="/atualizarHidrometroDiametroAction.do"	name="AtualizarHidrometroDiametroActionForm"
	type="gcom.gui.micromedicao.hidrometro.AtualizarHidrometroDiametroActionForm"	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Diametro de Hidrômetro</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para atualizar o Diametro do Hidrômetro, informe os dados abaixo:</td>
				</tr>
				
				<tr>
					<td width="162"><strong>Identificador:<font color="#FF0000">*</font></strong></td>
					<td><html:hidden property="idHidrometroDiametro"/> 
						<bean:write name="AtualizarHidrometroDiametroActionForm" property="idHidrometroDiametro" /></td>
				</tr>
				...
				<tr>
				  ...
				  <td  width="70%" colspan="2"><strong><b><span class="style2"> 
				  		<html:text  property="descricaoDiametroHidrometro" size="35" maxlength="20" tabindex="1"/></span></b></strong>
				  		</td>
				</tr>	
			...
			<table width="100%">
				<tr>
					<td width="40%" align="left">
						...
						onclick="window.location.href='/gsan/exibirAtualizarHidrometroDiametroAction.do?desfazer=S&reloadPage=1&idHidrometroDiametro=${idHidrometroDiametro}';">
