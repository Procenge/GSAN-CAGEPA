...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	...
	<html:javascript staticJavascript="false"  formName="FiltrarHidrometroMotivoBaixaActionForm"/>
...
<script language="JavaScript">
	...
	function setaFocus(){
		var form = document.FiltrarHidrometroMotivoBaixaActionForm;
		form.descricaoMotivoBaixaHidrometro.focus();
	}
	...
	function validarForm() {
      ...
      form.action = 'filtrarHidrometroMotivoBaixaAction.do';
	  if(validateFiltrarHidrometroMotivoBaixaActionForm(form)){	
...
<html:form action="/filtrarHidrometroMotivoBaixaAction"
	name="FiltrarHidrometroMotivoBaixaActionForm"
	type="gcom.gui.micromedicao.hidrometro.FiltrarHidrometroMotivoBaixaActionForm"
	method="post"
	onsubmit="return FiltrarHidrometroMotivoBaixaActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Motivo Baixa do Hidrômetro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar o(s) motivo(s) da(s) baixa(s) do hidrômetro, informe os dados abaixo:</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="descricaoMotivoBaixaHidrometro" size="35" maxlength="20"
						tabindex="1" /></td>
				</tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left"
						onclick="window.location.href='/gsan/exibirFiltrarHidrometroMotivoBaixaAction.do?menu=sim'">
					</td>
