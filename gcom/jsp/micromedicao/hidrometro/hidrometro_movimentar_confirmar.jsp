...
<!-- ============================================================================================================================== -->
			...
			<table width="100%" border="0">
				<tr> 
					<td>Para movimentar o(s) hidrômetros(s), informe os dados abaixo:</td>
				</tr>
			</table>
			...
			<table width="100%" border="0">
				<tr> 
			  	...
			  	<tr> 
		        	<td height="10" width="200"><strong>Local de Armazenagem Destino:<font color="#FF0000">*</font></strong></td>
		          	<td colspan="2">
						<html:text 
							property="idLocalArmazenagemDestino" 
							size="5" 
							maxlength="3" 
							tabindex="1" 
							onkeypress="validaEnterComMensagem(event, 'exibirConfirmarMovimentarHidrometroAction.do?objetoConsulta=1&pesquisar=true', 'idLocalArmazenagemDestino', 'Local de Armazenamento Destino');"
						/>
						<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23" height="21" style="cursor:hand;" onclick="abrirPopup('exibirPesquisarTabelaAuxiliarAbreviadaAction.do?tela=hidrometroLocalArmazenagem', 250, 495);" alt="Pesquisar">
				...
				<tr> 
			  	...
			  	<tr> 
					<td height="10" width="200"><strong>Parecer:</strong></td>
		          	<td colspan="2">
						<html:text property="parecer" size="50" tabindex="5" maxlength="50"/>
					</td>
				</tr>
				<tr> 
					<td height="10">&nbsp;</td>
			  	...
			  	<tr>
		      		...
		      		<td colspan="3" align="right">
						<input type="button" class="bottonRightCol" value="Movimentar" tabindex="6" onclick="validarForm(document.forms[0]);" style="width: 90px">
					</td>
		      	</tr>
