...
<html:javascript staticJavascript="false" formName="AtualizarHidrometroMotivoBaixaActionForm" dynamicJavascript="true" />
...
<script language="JavaScript">
    ...
    function validarForm() {
	    ...
	    if(validateAtualizarHidrometroMotivoBaixaActionForm(form)){	
...
<html:form action="/atualizarHidrometroMotivoBaixaAction.do"	name="AtualizarHidrometroMotivoBaixaActionForm"
	type="gcom.gui.micromedicao.hidrometro.AtualizarHidrometroMotivoBaixaActionForm"	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Motivo da Baixa de Hidrômetro</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para atualizar o Motivo da Baixa do Hidrômetro, informe os dados abaixo:</td>
				</tr>
				
				<tr>
					<td width="162"><strong>Identificador:<font color="#FF0000">*</font></strong></td>
					<td><html:hidden property="idHidrometroMotivoBaixa"/> 
						<bean:write name="AtualizarHidrometroMotivoBaixaActionForm" property="idHidrometroMotivoBaixa" /></td>
				</tr>
			...
			<table width="100%">
				<tr>
					<td width="40%" align="left">
						...
						onclick="window.location.href='/gsan/exibirAtualizarHidrometroMotivoBaixaAction.do?desfazer=S&reloadPage=1&idHidrometroMotivoBaixa=${idHidrometroMotivoBaixa}';">
