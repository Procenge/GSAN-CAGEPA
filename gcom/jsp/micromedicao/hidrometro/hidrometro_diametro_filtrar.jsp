...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	...
	<html:javascript staticJavascript="false"  formName="FiltrarHidrometroDiametroActionForm"/>
...
<script language="JavaScript">
	...
	function setaFocus(){
		var form = document.FiltrarHidrometroDiametroActionForm;
		form.descricaoDiametroHidrometro.focus();
	}
	...
	function validarForm() {
      ...
      form.action = 'filtrarHidrometroDiametroAction.do';
	  if(validateFiltrarHidrometroDiametroActionForm(form)){	
...
<html:form action="/filtrarHidrometroDiametroAction"
	...
	method="post"
	onsubmit="return FiltrarHidrometroDiametroActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Diametro do Hidrômetro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar o(s) diametro(s) do hidrômetro, informe os dados abaixo:</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="descricaoDiametroHidrometro" size="35" maxlength="20"
						tabindex="1" /></td>
				</tr>
