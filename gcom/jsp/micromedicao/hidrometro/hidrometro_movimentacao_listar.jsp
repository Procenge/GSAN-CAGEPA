...
<html:form
  action="/gerarRelatorioHidrometroMovimentacaoAction"
				...
				<table width="100%" border="0">
                    ...
                    <div align="right"><a href="javascript:toggleBox('demodiv',1);">
							<img border="0"
								...
								title="Imprimir Movimentação de Hidrômetro" /> </a></div></td>
					</tr>
				</table>
				<table width="100%" border="0">
					<tr>
...
<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioHidrometroMovimentacaoAction.do" />
