...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script>
	...
	<html:javascript staticJavascript="false"  formName="FiltrarHidrometroLocalArmazenagemActionForm"/>
...
<script language="JavaScript">
	...
	function setaFocus(){
		var form = document.FiltrarHidrometroLocalArmazenagemActionForm;
		form.descricaoLocalArmazenagemHidrometro.focus();
	}
	...
	function validarForm() {
      ...
      form.action = 'filtrarHidrometroLocalArmazenagemAction.do';
	  if(validateFiltrarHidrometroLocalArmazenagemActionForm(form)){	
...
<html:form action="/filtrarHidrometroLocalArmazenagemAction"
	name="FiltrarHidrometroLocalArmazenagemActionForm"
	type="gcom.gui.micromedicao.hidrometro.FiltrarHidrometroLocalArmazenagemActionForm"
	method="post"
	onsubmit="return FiltrarHidrometroLocalArmazenagemActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td width="80%">Para filtrar o(s) local(is) de armazenagem do hidrômetro, informe os dados abaixo:</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="descricaoLocalArmazenagemHidrometro" size="20" maxlength="20"
						tabindex="1" /></td>
				</tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left"
						onclick="window.location.href='/gsan/exibirFiltrarHidrometroLocalArmazenagemAction.do?menu=sim'">
					</td>
