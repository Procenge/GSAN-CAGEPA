...
<link rel="stylesheet"
	...
	<html:javascript staticJavascript="false"  formName="InserirHidrometroTipoActionForm"
...
<script language="JavaScript">
    ...
    var form = document.forms[0];
	  if(validateInserirHidrometroTipoActionForm(form)){	     
...
<html:form action="/inserirHidrometroTipoAction.do"
	name="InserirHidrometroTipoActionForm"
	type="gcom.gui.micromedicao.hidrometro.InserirHidrometroTipoActionForm"
	method="post"
	onsubmit="return InserirHidrometroTipoActionForm(this);">
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Inserir Tipo do Hidrômetro</td>
		...
		<table width="100%" border="0">
			<tr>
				<td colspan="2">Para inserir o tipo do(s) hidrômetro(s), informe os dados abaixo:</td>
			</tr>
			<tr>
