	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="590" border="0" align="center" cellpadding="0"
				...
				<logic:notEmpty name="colecaoHidrometro" scope="request">
				...
				<tr>
					...
					%>
						...
						%>
							<tr bgcolor="#FFFFFF">
								...
								<td width="18%"><span
									...
									<logic:notEmpty name="hidrometro" property="hidrometroMarca">
									<bean:write name="hidrometro"
									     property="hidrometroMarca.descricao" /> 
									</logic:notEmpty>
								
								
								</span></td>
								<td width="12%"><span style="font-size: 10px; font-color:#000000; font-face:verdana">
							<logic:notEmpty name="hidrometro" property="hidrometroCapacidade">
							
								<bean:write name="hidrometro"
									property="hidrometroCapacidade.descricao" /> 
							</logic:notEmpty>	
							</span></td>
							...
							<span
								...
								<span style="font-size: 10px; font-color:#000000; font-face:verdana">
	 								 <bean:write name="hidrometro" property="hidrometroSituacao.descricao" /> </span>
								</logic:notEmpty>
						...
						<logic:notEmpty name="hidrometro" property="hidrometroLocalArmazenagem">
									...
									<bean:write name="hidrometro"
										property="hidrometroLocalArmazenagem.descricao" /> 
						</logic:notEmpty>
						</span>
								</td>
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td><gcom:controleAcessoBotao name="Button" value="Movimentar"
