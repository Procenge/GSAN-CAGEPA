	...
	<table width="672" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td>Selecione os im&oacute;veis para desfazer o
					v&iacute;nculo para rateio de consumo:</td>
					<td align="right"></td>								
				</tr>
				</table>
				<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						<tr bgcolor="#99CCFF">
							<td width="4%">
									<strong><A HREF="javascript:facilitador(this);" id="0"><strong>Todos</strong></A></strong>							</td>
							<td width="10%">
				...
				cor = "#cbe5fe";%>
							<tr bgcolor="#cbe5fe">
								<%}%>
								<td><strong> <input type="checkbox" name="idImovel"
									value="<bean:define
								...
								<div align="center"><bean:define name="clienteimovel"
									property="imovel" id="imovel" /><%=((gcom.cadastro.imovel.Imovel) imovel)
							.getInscricaoFormatada()%></div>
								</td>
								<td width="21%">
								<div align="left"><bean:define name="clienteimovel"
									property="cliente" id="cliente" /> <bean:write name="cliente"
									property="nome" /></div>
								</td>
								<td width="45%">
								<div align="left"><bean:define name="clienteimovel"
				...
				<tr>
					...
					<div align="right"><input name="Button" type="button"
						class="bottonRightCol" value="Desfazer V&iacute;nculo"
						onclick="verficarSelecao(idImovel, 'checkbox')"> <input
