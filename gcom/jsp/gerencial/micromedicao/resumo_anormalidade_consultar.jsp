            ...
            <p>
              <table >
                 ...
                 <tr>
                   ...
                   <td width="100%" align="right">&nbsp;</td>
                   <td><input type="button" name="Button" class="bottonRightCol" value="Resumo das Anormalidades de Consumo" onclick="javascript:window.location.href='consultarResumoAnormalidadeConsumoAction.do';" /></td>
                 </tr>
              </table>
           </td>
        </tr>
