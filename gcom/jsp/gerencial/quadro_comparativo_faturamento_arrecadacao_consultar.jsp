...
<script language="JavaScript">
	...
	function validaCamposObrigatorios(){
		...
		if(form.mesAnoReferencia.value == '') {
			msg = "Informe o Mês/Ano de Referência";
			form.mesAnoReferencia.focus();
		}
		
 		if(opcaoTotalizacao == 2){
	...
	function limparSemOpcaoTotalizacao(){
  		...
  		form.action='exibirConsultarQuadroComparativoFaturamentoArrecadacaoAction.do?menu=sim';
	    form.submit();
	...
	*/
	...
	function limparLocalidade() {
  	...
  	function limparMesAnoReferencia() {
  		var form = document.forms[0];
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Consultar Quadro Comparativo Faturamento e Arrecada&ccedil;&atilde;o </td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">Para consultar o quadro comparativo, informe os dados abaixo:</td>
				</tr>
				
              	<tr> 
                	<td><strong>Mês/Ano de Referência:</strong>
				...
				<tr>
					...
					<td>
						...
						<html:select property="opcaoTotalizacao" 
		                    ...
		                    <html:option value="2">GER&Ecirc;NCIA REGIONAL</html:option>
		                    <html:option value="3">LOCALIDADE</html:option>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirConsultarQuadroComparativoFaturamentoArrecadacaoAction.do?objetoConsulta=1','localidade','Localidade');"/>
