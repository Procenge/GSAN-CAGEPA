			                    	...
			                    	<table width="100%" border="0">
				                        ...
				                        <tr>
				                            <td height="10" colspan="2"><strong>D&eacute;bitos Cobrados: </strong></td>
			                          		<td>
			                          			<strong>
			                          				<input name="valorDebitos" type="text"  disabled style="background-color:#EFEFEF; border:0; text-align:right; color: #000000;" value="<bean:write name="ResumoAnaliseFaturamentoActionForm" property="valorDebitos" formatKey="money.format" />" size="15" maxlength="15">
			                            		</strong>
			                            	</td>
				                        </tr>
				                        <tr>
				                        	<td height="10" colspan="2"><strong>Cr&eacute;ditos Realizados: </strong></td>
			                          		<td>
			                          			<strong>
				                          			<input name="valorCreditos" type="text"  disabled style="background-color:#EFEFEF; border:0; text-align:right; color: #000000;" value="<bean:write name="ResumoAnaliseFaturamentoActionForm" property="valorCreditos" formatKey="money.format" />" size="15" maxlength="15">
			                          			</strong>
		                          			</td> 
				                        </tr>
				                        <tr>
              ...
              <table>
                 <tr>
                   ...
                   <td width="100%" align="right">
                   	 ...
                   	 <a href="javascript:abrirPopupRelatorio('/gsan/gerarRelatorioAnaliseFaturamentoAction.do');">
                     	<img align="right" border="0" src="<bean:message key='caminho.imagens'/>print.gif"  title="Imprimir Análise Faturamento"/>
                     </a>
