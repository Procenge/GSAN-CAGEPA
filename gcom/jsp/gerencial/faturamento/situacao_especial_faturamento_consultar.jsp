...
<html:form action="/removerBairroAction"
	...
	type="gcom.gui.gerencial.faturamento.InformarResumoSituacaoEspecialFaturamentoActionForm" method="post">
	...
	<tr>
		...
		<logic:iterate name="colecaoRFSE" scope="session" id="RFSE">
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0"
				...
				property="resumoFaturamentoSituacaoEspecialConsultaUnidadeNegocioHelper"
				id="unidadeNegocio">
			...
			<tr>
				...
				<td align="right"><a
							...
							<img border="0"
								...
								title="Gerar Relatório das Situações Especiais de Faturamento" /> </a></td>
			</tr>
