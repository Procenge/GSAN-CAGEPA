...
<html:javascript staticJavascript="false"
	formName="GerarRelatorioPosicaoDiariaArrecadacaoForm" />
...
<html:form action="/gerarRelatorioPosicaoDiariaArrecadacao"
	...
	<input type="hidden" name="relatorio" value="RelatorioPosicaoDiariaArrecadacao.rpt"/>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relatório Posição Diária da Arrecadação</td>
			...
			<table width="100%" border="0">
				...
				<tr>
		          <td width="30%"><strong>Mês/Ano da Arrecadação:<font color="#FF0000">*</font></strong></td>
		          <td width="70%">
			...
			<table width="100%" border="0">
				<tr>
					<td valign="top"><input name="button" type="button"
						...
						onclick="window.location.href='/gsan/exibirGerarRelatorioPosicaoDiariaArrecadacaoAction.do?menu=sim'">&nbsp;</td>
					<td valign="top">
