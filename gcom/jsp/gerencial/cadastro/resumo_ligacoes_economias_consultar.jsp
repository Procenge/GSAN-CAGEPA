          ...
          <logic:present name="colecaoResumoLigacoesEconomias">
          	<tr>
                <td width="614" height="398"> <div style="width: 100%; height: 100%; overflow: auto; "> 
                    <table width="100%" align="center" bgcolor="#99CCFF">
                      ...
                      <%int cont=0;%>
                      <c:set var="sumLigacoesComHidrometro" value="0"/>
                      <c:set var="sumLigacoesSemHidrometro" value="0"/>
                      <c:set var="sumEconomiaComHidrometro" value="0"/>
                      <c:set var="sumEconomiaSemHidrometro" value="0"/>
                      <logic:notEmpty name="colecaoResumoLigacoesEconomias">
                        ...
                        <c:set var="sumLigacoesComHidrometro" value="${resumoLigacoesEconomiasAgua.quantidadeLigacoesComHidrometro + sumLigacoesComHidrometro }" />
                        <c:set var="sumLigacoesSemHidrometro" value="${resumoLigacoesEconomiasAgua.quantidadeLigacoesSemHidrometro + sumLigacoesSemHidrometro }" />
                        <c:set var="sumEconomiaComHidrometro" value="${resumoLigacoesEconomiasAgua.quantidadeEconomiaComHidrometro + sumEconomiaComHidrometro }" />
                        <c:set var="sumEconomiaSemHidrometro" value="${resumoLigacoesEconomiasAgua.quantidadeEconomiaSemHidrometro + sumEconomiaSemHidrometro }" />
                        
                        <c:set var="sumTotaEconomia" value="${resumoLigacoesEconomiasAgua.totalEconomia + sumTotaEconomia }" />
                        <c:set var="sumTotaligacoes" value="${resumoLigacoesEconomiasAgua.totalLigacoes + sumTotaligacoes }" />
                          <%
                               cont = cont+1;
                            if (cont%2==0){%>
                              <tr bgcolor="#FFFFFF">
                  ...
                  <table width="100%" bgcolor="#99CCFF">
                  	<tr bordercolor="#FFFFFF" bgcolor="#90c7fc"> 
                        <td width="47%"><div align="left"><strong>TOTAL</strong></div></td>
                      	<td width="8%" align="right"><strong> <c:out value="${sumLigacoesComHidrometro}"/> </strong></td>
                      	<td width="9%" align="right"><strong><c:out value="${sumLigacoesSemHidrometro}"/></strong></td>
                      	<td width="8%" align="right"><strong><c:out value="${sumTotaligacoes}"/></strong></td>
                      	<td width="9%" align="right"><strong><c:out value="${sumEconomiaComHidrometro}"/></strong></td>
                      	<td width="9%" align="right"><strong><c:out value="${sumEconomiaSemHidrometro}"/></strong></td>
                      	<td width="10%" align="right"><strong><c:out value="${sumTotaEconomia}"/></strong></td>
                      </tr>
                      </table>
                      </td>
                  </tr>
              ...
              <table>
                 <tr>
                   ...
                   <td align="right"><a href="javascript:abrirPopupRelatorio('gerarRelatorioResumoLigacoesEconomiaAction.do');"><img  border="0" src="<bean:message key="caminho.imagens"/>print.gif"></a></td>
                 </tr>
                 <tr>
   	               <td><input type="button" name="Button" class="bottonRightCol" value="Voltar" onclick="javascript:window.location.href='exibirInformarDadosGeracaoRelatorioConsultaAction.do?menu=sim&tipoResumo=LIGACAO_ECONOMIA';" /></td>
                   <td width="600" align="right">&nbsp;</td>
                 </tr>
              </table>
           </td>
