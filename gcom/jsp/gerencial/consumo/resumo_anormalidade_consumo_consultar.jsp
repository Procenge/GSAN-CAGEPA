          ...
          <logic:present name="colecaoResumoAnormalidadeRelatorio">
            ...
            <p>
              <table width="100%">
                 <tr>
                   <td ></td>
                   <td align="right"><a href="javascript:abrirPopupRelatorio('gerarRelatorioResumoAnormalidadeConsumoAction.do');"><img  border="0" src="<bean:message key="caminho.imagens"/>print.gif"></a></td>
                 </tr>
                 <tr>
