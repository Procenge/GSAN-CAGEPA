					...
					<tr>
						...
						<tr>
							...
							<td colspan="3">
								...
								<html:text maxlength="4"
									property="municipio" 
									size="4"
									onkeypress="javascript:limparBairro();validaEnter(event, 'exibirFiltrarProgramacaoAbastecimentoManutencaoAction.do?objetoConsulta=1', 'municipio');" />
							...
							<td colspan="3">
								<strong> 
									<html:text maxlength="4" 
										property="bairro"
										size="4"
										onkeypress="javascript:return validaEnterDependencia(event, 'exibirFiltrarProgramacaoAbastecimentoManutencaoAction.do?objetoConsulta=2', this, document.forms[0].municipio.value,'Municipio');" />
						...
						<tr>
							...
							<td align="right" height="24">
								<gcom:controleAcessoBotao name="Botao" 
									value="Pesquisar" 
