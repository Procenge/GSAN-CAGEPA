...
<script>
	...
	function validateAtualizarSistemaEsgotoActionForm(form){
		return validateRequired(form);
	}

	function required () {
		this.aa1 = new Array("codigoSistemaEsgoto", "Informe o Código.", new Function ("varName", " return this[varName];"));
		this.aa = new Array("descricaoSistemaEsgoto", "Informe a Descrição.", new Function ("varName", " return this[varName];"));
		this.ab = new Array("gerenciaRegionalID", "Informe a Gerência Regional.", new Function ("varName", " return this[varName];"));
	}
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td  width="30%"class="style3"><strong>Gerência Regional:<font color="#FF0000">*</font></strong></td>
					<td  width="70%" colspan="2">
				...
				<tr>
					<td><strong>Indicador de uso:<font color="#FF0000">*</font></strong></td>
						<td><html:radio property="indicadorUso" value="1" tabindex="6"/><strong>Ativo
							<html:radio property="indicadorUso" value="2" tabindex="7"/>Inativo</strong> 
						</td>
				</tr>
			...
			<table width="100%">
				<tr>
					...
					<td align="right">
						...
						value="Atualizar" onclick="javascript:validarForm();" tabindex="8" />
					</td>
				</tr>
			</table>
		</tr>
