...
<logic:notPresent name="fechaPopup" scope="request">
	<body leftmargin="5" topmargin="5" onload="resizePageSemLink(600, 550)";>
</logic:notPresent>

<logic:present name="fechaPopup" scope="request">
	<body leftmargin="5" topmargin="5" onload="chamarReload('exibirInformarProgramacaoAbastecimentoManutencaoAction.do?tipoOperacao=I');window.close()">
</logic:present>
