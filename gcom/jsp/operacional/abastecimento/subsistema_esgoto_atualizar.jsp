...
<body leftmargin="5" topmargin="5"	onload="setarFoco('descricaoSubsistemaEsgoto');">
			...
			<table width="100%" border="0">
				...
				<tr>
				  ...
				  <td  width="70%" colspan="2"><strong><b><span class="style2"> 
				  		<html:text property="codigo" size="2" maxlength="2" readonly="true" onkeypress="return isCampoNumerico(event);" style="background-color:#EFEFEF; border:0; color: #000000"/> </span></b></strong></td>
				</tr>
				...
				<tr>
				  ...
				  <td  width="70%" colspan="2">
				  			<html:select property="sistemaEsgoto" disabled="true" style="background-color:#EFEFEF; border:0; color: #000000">
			...
			<table width="100%">
				<tr>
					...
					<td align="right">
						...
						value="Atualizar" onclick="javascript:validarForm();" />
					</td>
				</tr>
			</table>
		</tr>
