		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%">
						<tr bgcolor="#E2F0FE">
							<td width="34%" height="17" bgcolor="#E2F0FE">Tempo de Execu&ccedil;&atilde;o:&nbsp;
							<bean:write name="tempoExecucaoProcesso" /></td>
							<td width="31%">&nbsp;</td>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						...
						<tr bordercolor="#FFFFFF" bgcolor="#99CCFF">
							...
							<td width="12%">
							<div align="center"><strong>Tempo de Execu&ccedil;&atilde;o</strong></div>
							</td>
							<td width="12%">
							<div align="center"><strong><strong>Hora de Conclus&atilde;o*</strong></strong></div>
							</td>
							<td width="25%">
							<div align="center" class="style9"><strong> <strong>SITUA&Ccedil;&Atilde;O</strong></strong></div>
							</td>
						</tr>
						<%int cont = 0;%>
			...
			if (cont % 2 == 0) {%>
							...
							<tr bgcolor="#FFFFFF">
								...
								<td>
								<div align="center">${funcionalidadeIniciada.funcionalidadeSituacao.descricaoOperacaoSituacao}</div>
								</td>
								<td>
									<c:if test="${funcionalidadeIniciada.textoLogExecucaoBlob != null}">
									<input 
										type="button" name="visualizarLog" value="Log" 
										class="bottonRightCol"										
										onclick="abrirPopup('exibirFuncionalidadeIniciadaLogAction.do?idFuncionalidadeIniciada=${funcionalidadeIniciada.id}', 250, 495);" 
									/>
									</c:if>
									<c:if test="${funcionalidadeIniciada.textoLogExecucaoBlob == null}">
									<input 
				...
				<tr>
					...
					<td colspan="2" align="right"><c:if
						test="${requestScope.processoIniciado.processoSituacao.id == requestScope.concluido || 
									requestScope.processoIniciado.processoSituacao.id == requestScope.concluidoComErro || 
									requestScope.processoIniciado.processoSituacao.id == requestScope.execucaoCancelada}">
						<gcom:controleAcessoBotao name="buttonReiniciar"
