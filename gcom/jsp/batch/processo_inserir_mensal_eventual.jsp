...
<html:javascript staticJavascript="false"  formName="InserirProcessoMensalEventualActionForm" />
...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
    ...
    if (tipoConsulta == 'processoIniciadoPrecedente') {
        form.idProcessoIniciadoPrecedente.value = codigoRegistro;
        form.descricaoProcessoIniciadoPrecedente.value = descricaoRegistro;
        form.descricaoProcessoIniciadoPrecedente.style.color = "#000000";
      }
...
function validaEnterSemEvent() {
	...
	var form = document.forms[0];	
	var valorCampo = form.idProcesso.value;
	var caminho = '/gsan/exibirInserirProcessoMensalEventualAction.do' ;
				...
				<tr>
					...
					<td colspan="2"><html:text property="idProcesso" size="5"
						...
						<a href="javascript:abrirPopup('exibirPesquisarProcessoAction.do?limparForm=OK&tipoConsulta=processo');">
								<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Processo" />
						</a> 
						
						<span class="style1"> <logic:present
						name="idProcessoNaoEncontrado">
						...
						border="0" onclick="javascript:limparProcesso();"> </span></td>
				</tr>
...
--%>				
				...
				<tr>
					...
					<a href="javascript:abrirPopup('exibirPesquisarProcessoAction.do?limparForm=OK&tipoConsulta=processoIniciadoPrecedente');">
						<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Processo Iniciado Precedente" />
					</a>
					...
					<logic:iterate name="colecaoProcessoFuncionalidade"
						...
						<tr>
							...
							<td><bean:write name="processoFuncionalidade"
								property="unidadeProcessamento.descricao" /></td>
						</tr>
					</logic:iterate>
				</logic:present>
