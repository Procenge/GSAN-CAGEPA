...
<script language="JavaScript">
    ...
    function validateAtualizarUsuarioDadosGeraisActionForm(form) {                                                                   
    	if (bCancel) 
      		return true; 
       		...
       		return validateRequired(form) && validateLong(form) && validateCaracterEspecial(form) && validateDate(form) && validateEmail(form) && enviar(form.usuarioTipo.value) && testarCampoValorZero(form.idFuncionario, 'Matrícula do Funcionário') && testarCampoValorZero(form.idLotacao, 'Unidade de Lotação'); 
   	}
    ...
    function DateValidations () { 
     	...
     	this.aa = new Array("dataNascimento", "Data de Nascimento não é uma data válida.", new Function ("varName", "this.datePattern='dd/MM/yyyy';  return this[varName];"));
    } 
		...
		<tr>
			...
			<table border="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td width="74%">
							<html:text maxlength="9" 
								...
								size="9"
								onkeypress="javascript:pesquisaMatriculaFuncionario();return validaEnterComMensagem(event, 'exibirAtualizarUsuarioDadosGeraisAction.do', 'idFuncionario','Matricula Funcionario');"
								onkeyup="limparCamposFuncionario();" /> 
							
							<a href="javascript:chamarPopup('exibirPesquisarFuncionarioAction.do?limpaForm=sim', 495, 300,document.forms[0].idFuncionario);">
							...
							<logic:equal property="funcionarioNaoEncontrada"
					...
					<tr>
						<td width="26%"><strong>Unidade Organizacional:</strong></td>
...
<tr> 
            <td width="26%"><strong>Data de Nascimento:</strong></td>
            <td width="74%">
			  <html:text  property="dataNascimento" maxlength="10" size="10" onkeypress="javascript:mascaraData(this,event);"/>
			  <img border="0"  src="<bean:message key='caminho.imagens'/>calendario.gif" onclick="javascript:abrirCalendario('AtualizarUsuarioDadosGeraisActionForm', 'dataNascimento');" width="20" border="0" align="middle" alt="Exibir Calendário" />
 		    </td>
          </tr>
					...
					<tr>
						<td width="26%"><strong>E-Mail:</strong></td>
