		...
		<tr>
			...
			<table border="0" width="100%">
				...
				<tr>
					...
					<a
						href="javascript:chamarPopup('exibirPesquisarFuncionarioAction.do','funcionario', 495, 300,document.forms[0].idFuncionario,'','');"><img
				...
				<tr>
					...
					<td width="74%"><html:text
						...
						property="dataCadastramentoInicial" size="10" maxlength="10" /> <a
					...
					&nbsp; <html:text onkeyup="mascaraData(this, event);"
						property="dataCadastramentoFinal" size="10" maxlength="10" /> <a
				...
				<tr>
					...
					<td width="74%"><html:text
						...
						property="dataExpiracaoInicial" size="10" maxlength="10" /> <a
					...
					&nbsp; <html:text onkeyup="mascaraData(this, event);"
						property="dataExpiracaoFinal" size="10" maxlength="10" /> <a
