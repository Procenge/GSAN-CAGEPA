...
<link rel="stylesheet"
	...
	type="text/css">
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="PesquisarUsuarioActionForm" />
...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(600, 370);">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3"><html:text property="nome" size="50" maxlength="50"  tabindex="2" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td colspan="3"><html:text property="matriculaFuncionario" size="9"
						maxlength="9"  tabindex="3" onkeyup="limparPesquisaFuncionarioNome();"
						onkeypress="javascript:return validaEnter(event, 'exibirUsuarioPesquisar.do?objetoConsulta=1', 'matriculaFuncionario');" />

					<a
						onclick="javascript:redirecionarSubmit('exibirPesquisarFuncionarioAction.do?caminhoRetornoTelaPesquisaFuncionario=exibirUsuarioPesquisar');">
				...
				<tr>
					<td>
						...
						<input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left" onclick="window.location.href='<html:rewrite page="/exibirUsuarioPesquisar.do?desfazer=S"/>'" >
		            </td>
