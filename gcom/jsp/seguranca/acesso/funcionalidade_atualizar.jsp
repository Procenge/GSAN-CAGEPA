...
<html:javascript staticJavascript="false"  formName="AtualizarFuncionalidadeActionForm" />
...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		if(testarCampoValorZero(document.AtualizarFuncionalidadeActionForm.descricao, 'Descrição') && 
			...
			if(validateAtualizarFuncionalidadeActionForm(form)){
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						<html:hidden property="idFuncionalidade" /> 
						<bean:write name="AtualizarFuncionalidadeActionForm" property="idFuncionalidade" />
					</td>
				</tr>
				...
				<tr>
				  ...
				  <td>
				  	<html:text name="AtualizarFuncionalidadeActionForm" property="numeroOrdemMenu" />
				  </td>
				</tr>
