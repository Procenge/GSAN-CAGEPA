						  ...
						  <tr>
							<td>
							  <font color="#FF0000"> 
							    ...
							    <gcom:controleAcessoBotao name="Button" value="Remover" onclick="verficarSelecao(idRegistrosRemocao)" url="removerOperacaoAction.do" align="left"/>
							  </font> 
							  <input name="button" 
							     	 type="button" 
