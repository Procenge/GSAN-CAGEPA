...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="InserirFuncionalidadeActionForm" />
...
function validarForm(form){
	...
	if(testarCampoValorZero(document.InserirFuncionalidadeActionForm.descricao, 'Descrição') && 
	...
	testarCampoValorZero(document.InserirFuncionalidadeActionForm.modulo, 'Módulo')) {
		...
		if(validateInserirFuncionalidadeActionForm(form)){
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para adicionar a funcionalidade, informe os dados abaixo:</td>
				</tr>
				<tr>
				  <td><strong>Número ordem menu:<font color="#FF0000">*</font></strong></td>
				  <td>
					<strong> 
					  <html:text property="numeroOrdemMenu" size="12" maxlength="12" style="text-transform: none;"/> 
					</strong>
				  </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><strong> </strong> <html:text property="caminhoMenu" size="60" maxlength="300" style="text-transform: none;"/></td>
				</tr>
				<tr>
					<td><strong>Caminho URL:<font color="#FF0000">*</font></strong></td>
					<td><strong> </strong> <html:text property="caminhoUrl" size="60" maxlength="300" style="text-transform: none;"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol"
						value="Desfazer" align="left" onclick="window.location.href='<html:rewrite page="/exibirInserirFuncionalidadeAction.do?desfazer=S"/>'" > <input name="Button" type="button"
