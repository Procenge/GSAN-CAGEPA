...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(590, 246);">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<a
						href="javascript:redirecionarSubmit('exibirPesquisarTabelaAction.do?caminhoRetornoTelaPesquisa=exibirPesquisarColunaTabelaAction');">
