	      ...
	      <tr>
              ...
              <tr> 
  				<td colspan="4" height="23"><font style="font-size: 10px;" color="#000000" face="Verdana, Arial, Helvetica, sans-serif">
		   			<strong>Opera&ccedil;&otilde;es Realizadas
                ...
                <logic:notPresent name="descricaoArgumento">                      
                  <td><div align="center">
                  		<div id="divHint" class="jsHint"></div>
													<a href="javascript:consultarOperacao('<bean:write name="operacaoEfetuada" property="id" />')"
	                  									onmouseover="mostraHint(event,'Nome do Identificador: <bean:write name="operacaoEfetuada" property="descricaoArgumento" />');" 
...
//				}
           ...
           <table width="100%" border="0">
            ...
            <table width="100%" border="0">
              <tr>
                <td><input name="adicionar" class="bottonRightCol" value="Novo Filtro" onclick="javascript:filtrar();" type="button"></td>
                <td valign="top">
							<div align="right"><a href="javascript:toggleBox('demodiv',1);">
							<img border="0"
								src="<bean:message key="caminho.imagens"/>print.gif"
								title="Imprimir Operações" /> </a></div>
				</td>
              </tr>
            </table>
