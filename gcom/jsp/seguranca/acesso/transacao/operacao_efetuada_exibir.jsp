...
function voltar() {
	...
	document.forms[0].action = 'filtrarOperacaoEfetuadaAction.do';
...
<html:form action="/filtrarOperacaoEfetuadaAction" method="post"
	...
	<input type="hidden" name="idOperacaoEfetuada" value="<bean:write name="idOperacaoEfetuada"/>" />
				...
				%>
								<tr bgcolor="#99ccff">
									<td colspan="4" ><strong><font size="1,5">
										<%=tla.getTabela().getDescricaoTabela()
										+ (tla.getId1() != null ? " - id [" + tla.getId1() + (tla.getId2() != null ? "; " + tla.getId2() : "") + "]" : "")
										+ ((tla.getAlteracaoTipo() != null && tla.getAlteracaoTipo().getDescricao() != null) ? " - (" + tla.getAlteracaoTipo().getDescricao().toLowerCase() + ")" : "") %>
										</font></strong>
									</td>
								</tr>
				<%
			...
			%>
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><font size="1,5"><bean:write
													...
													property="tabelaLinhaAlteracao.tabela.descricaoTabela" /></font></div>
												</td>
												<td height="17">
...
<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioConsultarOperacaoEfetuadaAction.do" />
