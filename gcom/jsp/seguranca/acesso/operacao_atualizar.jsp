...
function validarForm(form){
	...
	if(testarCampoValorZero(document.AtualizarOperacaoActionForm.descricao, 'Descrição')
			&& testarCampoValorZero(document.AtualizarOperacaoActionForm.descricaoAbreviada, 'Descrição Abreviada')
			&& testarCampoValorZero(document.AtualizarOperacaoActionForm.caminhoUrl, 'Caminho URL')){
	...
	if(objetoRelacionado.disabled != true){
		if (objeto == null || codigoObjeto == null){
			...
			if (codigoObjeto.length < 1 || isNaN(codigoObjeto)){
				...
				abrirPopup(url + "?" + "menu=sim&" + "tipo=" + tipo + "&" + objeto + "=" + codigoObjeto + "&caminhoRetornoTelaPesquisaColunaTabela=" + tipo, altura, largura);
			}
		}
	}
}
  ...
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
	  ...
	  <table width="100%" border="0">
		...
		<tr>
			<td><strong>Indicador de Auditoria:<font color="#FF0000">*</font></strong></td>
			<td>
				<div align="left">
	        		<html:radio property="indicadorAuditoria" value="1"/><strong>Sim</strong>
	        		<html:radio property="indicadorAuditoria" value="2"/><strong>N&atilde;o</strong>
				</div>
			</td>
		</tr>
		  ...
		  <tr>
			<td><strong>Argumento de Pesquisa:</strong></td>
			  ...
			  <logic:equal name="habilitarArgumentoPesquisa" value="true">
				...
				<a	href="javascript:chamarPopup('exibirPesquisarColunaTabelaAction.do', '', null, null, 400, 800, '','');">
						<img width="23" height="21" border="0"
							src="<bean:message key="caminho.imagens"/>pesquisa.gif"
							title="Pesquisar Tabela" /> </a>
			
				<!--    <img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Tabela" onclick="javascript:abrirPopup('exibirPesquisarColunaTabelaAction.do', 400, 800);" style="cursor: hand;"/>-->
							
				  <logic:present name="argumentoPesquisaNaoEncontrado">
				    <logic:equal name="argumentoPesquisaNaoEncontrado" value="exception">
					  <html:text property="descricaoArgumentoPesquisa" size="45" maxlength="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />
					</logic:equal>
						
					<logic:notEqual name="argumentoPesquisaNaoEncontrado" value="exception">
				  ...
				  <logic:notPresent name="argumentoPesquisaNaoEncontrado">
				    <logic:empty name="AtualizarOperacaoActionForm" property="idArgumentoPesquisa">
					  <html:text property="descricaoArgumentoPesquisa" value="" size="45" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />
					</logic:empty>
					<logic:notEmpty name="AtualizarOperacaoActionForm" property="idArgumentoPesquisa">
					  <html:text property="descricaoArgumentoPesquisa" size="45" maxlength="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
					</logic:notEmpty>
				  </logic:notPresent> 
			 ...
			 <logic:equal name="habilitarArgumentoPesquisa" value="false">
			   <td colspan="3">
			     <html:text property="idArgumentoPesquisa" size="9" maxlength="9" disabled="true" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />
			     <img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Argumento de Pesquisa" /> 
			     <html:text property="descricaoArgumentoPesquisa" size="45" maxlength="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />		
	    ...
	    <tr>
          ...
          <td align="right">
            <gcom:controleAcessoBotao name="Botao" value="Atualizar" onclick="validarForm(document.forms[0]);" url="atualizarOperacaoAction.do" tabindex="13"/>
          </td>
        </tr>
