		...
		<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="13%">
									<div align="center"><strong>Ponto de<br>Entrada</strong></div>
									</td>
									<td width="19%">
			...
			if (cont % 2 == 0) {%>
											...
											<td align="center"><logic:equal
													name="funcionalidade" property="indicadorPontoEntrada"
													value="1">
											<a  href="<%=funcionalidade.getCaminhoUrl().indexOf("?")==-1?funcionalidade.getCaminhoUrl()+"?":funcionalidade.getCaminhoUrl()+"&"%>manter=sim&menu=sim">
												Acessar
											</a>
											</logic:equal>&nbsp;
											</td>
