				...
				<td valign="top" width="30">
				  <table width="99%" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
					...
					<%--Esquema de paginação das operações cadastradas--%>
					  <logic:iterate name="operacoesCadastradas" id="operacao">
					    <tr bordercolor="#90c7fc">
					      <td>
					        <strong>
					         <input  type="checkbox" name="operacoes" value="<bean:write name="operacao" property="id"/>" checked="true" onclick="javascript:trocar();"> 
					        </strong>
					      </td>
						  <td>
					        <strong>
					...
					<%--Esquema de paginação das operações Não cadastradas--%>
					  <logic:iterate name="operacoesNaoCadastradas" id="operacao">
					    <tr bordercolor="#90c7fc">
					      <td>
					        <strong>
					          <input onclick="javascript:trocar();" type="checkbox" name="operacoes" value="<bean:write name="operacao" property="id"/>"/>
					        </strong>
					      </td>
						  <td>
					        <strong>
					...
					<logic:notPresent name="naoTemOperacoes" >
					  <tr>
					    <td colspan="4">
					      <input name="btnSalvar" class="bottonRightCol" disabled="disabled" value="Salvar" type="button" onclick="javascritp:salvar();">
					    </td>
					  </tr>
					</logic:notPresent> 
	              </table>
