...
<script language="JavaScript"><!--
	...
	function limparForm() {
		...
		var form = document.forms[0];
		window.location.href='/gsan/exibirEfetuarInstalacaoHidrometroComLigacaoAguaLoteAction.do?menu=sim'
...
<html:form action="/efetuarInstalacaoHidrometroComLigacaoAguaLoteAction.do"
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Instalação de Hidrômetro com Ligação de Água em
									Lote</td>
									<td width="11"><img border="0"
