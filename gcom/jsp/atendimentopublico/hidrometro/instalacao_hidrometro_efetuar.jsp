									...
									<table width="100%" border="0" align="center">
										...
										<tr>
											...
											<td><!-- Campo Ordem de Serviço --> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarInstalacaoHidrometroAction.do', 'idOrdemServico','Ordem de Serviço');"
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="80%" colspan="3"><html:text property="idFuncionario"
																...
																onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirEfetuarInstalacaoHidrometroAction.do', 'idFuncionario', 'Funcionário');" />
															<a 
																href="javascript:abrirPopup('exibirEfetuarInstalacaoHidrometroAction.do?pesquisarFuncionario=OK',400,400);">
