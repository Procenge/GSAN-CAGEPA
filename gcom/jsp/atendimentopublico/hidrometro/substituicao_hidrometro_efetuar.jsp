													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="58%"><html:text property="numeroHidrometro"
																...
																onkeypress="validaEnterString(event, 'exibirEfetuarSubstituicaoHidrometroAction.do?pesquisaHidrometro=sim', 'numeroHidrometro','Número do Hidrômetro');" />
															<a
														...
														<tr>
															...
															<td width="80%" colspan="3"><html:text property="idFuncionario"
																...
																onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirEfetuarSubstituicaoHidrometroAction.do', 'idFuncionario', 'Funcionário');" />
															<a 
