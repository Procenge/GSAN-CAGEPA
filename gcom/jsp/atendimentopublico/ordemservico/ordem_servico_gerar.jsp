...
<script language="JavaScript">
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'servicoTipo') {
		    ...
		    form.action = "/gsan/exibirGerarOrdemServicoAction.do?telaManterRA=sim";
    		form.submit();  
	    }	    
	...
	function limparForm() {
	    ...
	    form.action = 'exibirGerarOrdemServicoAction.do?telaManterRA=sim';
		form.submit();
	}  
	...
	function consultarOS() {
		var form = document.forms[0];
		abrirPopup('exibirConsultarRegistroAtendimentoOSAction.do?numeroRA='+ form.numeroRA.value, 550, 735);
	}
	...
	function raAnterior(){
 		var form = document.forms[0];
 		form.action = "exibirGerarOrdemServicoAction.do?raAnterior=1&numeroRA=" + form.numeroRA.value + "&telaManterRA=sim";
 		submeterFormPadrao(form);
	}

	function proximoRA(){
 		var form = document.forms[0];
 		form.action = "exibirGerarOrdemServicoAction.do?proximoRA=1&numeroRA=" + form.numeroRA.value + "&telaManterRA=sim";
 		submeterFormPadrao(form);
	}
...
<html:form action="/exibirGerarOrdemServicoAction" method="post">
	...
	<html:hidden property="primeiraVez" />
	                     				...
	                     				<td align="center">
	                    					<span class="style2">
	                     					<a href="javascript:extendeTabela('Local',true);"/>
	                     						<b>Dados do RA - Registro de Atendimento</b>
	                     					</a>
	                    					</span>
	                     				</td>
	                    			</tr>
                			...
                			<table border="0" width="100%">
		                    			...
		                    			<tr> 
		                      				...
		                      				<td colspan="3">
		                        				...
		                        				<html:text property="idServicoTipo" 
														   size="7" 
														   maxlength="4" 
														   onkeyup="validaEnterComMensagem(event, 'exibirGerarOrdemServicoAction.do?telaManterRA=sim', 'idServicoTipo', 'Serviço Tipo');" />
			                    			...
			                    			<tr> 
			                      				...
			                      				<td colspan="3">
			                        				<html:text property="idOrdemServicoReferencia" 
			                        						   size="7" 
			                        						   maxlength="9" 
			                        						   onkeyup="validaEnterComMensagem(event, 'exibirGerarOrdemServicoAction.do?telaManterRA=sim', 'idOrdemServicoReferencia', 'Ordem de Serviço de Referência');" />
							                    			...
							                    			<tr>
							                      				...
							                      				<td colspan="3">
							                        				...
							                        				<html:text property="idServicoTipoReferencia" 
							                        						   size="7" 
							                        						   maxlength="4" 
							                        						   onkeyup="validaEnterComMensagem(event, 'exibirGerarOrdemServicoAction.do?telaManterRA=sim', 'idServicoTipoReferencia', 'Serviço Tipo de Referência');" />
                    			...
                    			<tr> 
                      				...
                      				<td colspan="3"><strong><b><span class="style2"> <strong> 
                        				<html:textarea property="observacao" cols="50" rows="4" onkeyup="validarTamanhoMaximoTextArea(this,1000);"/>
