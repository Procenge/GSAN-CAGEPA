...
<html:javascript staticJavascript="false"
	formName="AtualizarOsProgramNaoEncerMotivoActionForm" />

<script language="JavaScript">
  
	function validaForm() {	
		var form = document.forms[0];
		if (validateAtualizarOsProgramNaoEncerMotivoActionForm(form)) {		
	...
	function reload() {
		var form = document.forms[0];
		form.action = "/gsan/exibirAtualizarOsProgramNaoEncerMotivoAction.do";
		form.submit();
	}  
...
<html:form action="/atualizarOsProgramNaoEncerMotivoAction"
	name="AtualizarOsProgramNaoEncerMotivoActionForm"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Motivo do não encerramento da OS</td>
			...
			<table width="100%" border="0">
				<tr>
					<td height="10" colspan="3">Para atualizar uma Motivo do não encerramento da OS, informe
					os dados abaixo:</td>
				</tr>
				...
				<tr>
					<td colspan="2"><font color="#FF0000"> <logic:present
						...
						<input type="button" name="ButtonReset" class="bottonRightCol"
							value="Voltar"
							onClick="javascript:window.location.href='/gsan/exibirFiltrarOsProgramNaoEncerMotivoAction.do'">
