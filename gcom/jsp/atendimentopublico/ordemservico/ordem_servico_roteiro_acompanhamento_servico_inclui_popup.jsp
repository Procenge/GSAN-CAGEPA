	...
	function habilitaGerarOs(){
   	...
   	function validaForm(){
   		...
   		if(form.sequencialProgramacaoPrevisto.value == ""){
   			...
   			return false;
   		} else if(isNaN(form.sequencialProgramacaoPrevisto.value) ){
   			if(form.sequencialProgramacaoPrevisto.value > form.sequencialProgramacao.value){
...
<body leftmargin="5" topmargin="5" onload="javascript:habilitaGerarOs();window.focus();resizePageSemLink(600, 550);">
								...
								<tr>
									...
									<td>
										<html:text maxlength="9" 
											...
											property="numeroRA" 
											size="9"
											onkeypress="validaEnterComMensagem(event, 'exibirAcompanharRoteiroProgramacaoOrdemServicoIncluirAction.do?objetoConsulta=1','numeroRA','Numero RA');"/>
											
											<a href="javascript:chamarForm('exibirPesquisarRegistroAtendimentoAction.do?caminhoRetornoTelaPesquisaRegistroAtendimento=exibirAcompanharRoteiroProgramacaoOrdemServicoIncluirAction',document.forms[0].numeroRA);">
								...
								<tr>
									...
									<td>
										<html:text maxlength="9" 
											...
											size="9"
											onkeypress="validaEnterComMensagem(event, 'exibirAcompanharRoteiroProgramacaoOrdemServicoIncluirAction.do?objetoConsulta=2','idOrdemServico','Numero OS');"/>
											
											<a href="javascript:chamarForm('exibirPesquisarOrdemServicoAction.do?caminhoRetornoTelaPesquisaOrdemServico=exibirAcompanharRoteiroProgramacaoOrdemServicoIncluirAction',document.forms[0].idOrdemServico);">
