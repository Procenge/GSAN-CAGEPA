		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Tipo de Serviço</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td>Para filtrar o(s) tipo(s) de serviço, informe os dados abaixo:</td>
					<td width="84"><input type="checkbox" name="indicadorAtualizar"
			...
			<table width="100%" border="0">
				<tr>
					<td><strong>Código do Tipo de Serviço:</strong></td>
					<td><html:text property="idTipoServico" size="4" maxlength="4"
						onkeypress="" /></td>
				</tr>			
				<tr>
					<td width="40%"><strong>Descrição do Tipo de Serviço:</strong></td>
					<td width="60%"><html:text property="descricaoTipoServico" size="50"
						maxlength="50" onkeypress="" /></td>
				</tr>
				<tr>
					<td><strong>Abreviatura do Tipo de Serviço:</strong></td>
				...
				<tr>
					...
					<td colspan="3"><span class="style2"> <html:text
						...
						size="35" maxlength="40" /><a href="javascript:limpar('atividade');"><img
				...
				<tr>
					...
					<html:text property="dsTipoServicoMaterial"
						...
						size="35" maxlength="40" /><a href="javascript:limpar('material');"><img
								border="0" title="Apagar" src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a></span></td>
				</tr>
				<tr>
					<td colspan="4"><strong> <font color="#FF0000"></font></strong>
				...
				<tr>
					...
					<td width="63%" height="24">
						<html:text maxlength="8" property="idUnidadeOrganizacionalDestino" size="6" tabindex="12"
							onkeypress="javascript:limparPesquisaDescricaoUnidadeOrganizacionalDestino();validaEnterComMensagem(event, 'exibirFiltrarTipoServicoAction.do', 'idUnidadeOrganizacionalDestino', 'Unidade de Destino');return isCampoNumerico(event);"/>
						<a href="javascript:abrirPopup('exibirPesquisarUnidadeOrganizacionalAction.do?indicadorUsoTodos=1&limpaForm=sim', 275, 480);">
						...
						<logic:present name="unidadeOrganizacionalDestinoNaoEncontrado" scope="request">
							<html:text property="descricaoUnidadeOrganizacionalDestino" size="33" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000"/>
						</logic:present>

						<logic:notPresent name="unidadeOrganizacionalDestinoNaoEncontrado" scope="request">
							<html:text property="descricaoUnidadeOrganizacionalDestino" size="33" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
						</logic:notPresent>
