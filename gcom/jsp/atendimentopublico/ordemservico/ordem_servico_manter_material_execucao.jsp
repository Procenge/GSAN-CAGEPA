...
<logic:present name="voltar">
	<body leftmargin="5" topmargin="5" onload="window.location.href='${sessionScope.caminhoRetornoManterMaterial}';">
</logic:present>
...
<logic:notPresent name="voltar">
	...
	<logic:notPresent name="inserir">
		<body leftmargin="5" topmargin="5" onload="window.focus();resizePageSemLink(680, 450);setarFoco('${requestScope.nomeCampo}');">
	</logic:notPresent>
