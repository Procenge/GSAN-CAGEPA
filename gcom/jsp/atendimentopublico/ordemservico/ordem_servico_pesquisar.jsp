...
<body leftmargin="5" topmargin="5"
	onload="javascript:validaForm();window.focus();resizePageSemLink(650, 600);setarFoco('${requestScope.nomeCampo}');">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="9" 
							...
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=1','numeroRA','Número do RA');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="9" 
							...
							onkeyup="validaForm();" 
							onkeydown="validaForm();"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=2','documentoCobranca','Documento de Cobrança');"/>
							...
							<a href="javascript:chamarForm('exibirFiltrarDocumentosCobrancaAction.do?menu=sim&ehPopup=true&caminhoRetornoTelaPesquisaDocumentoCobranca=exibirPesquisarOrdemServicoAction',document.forms[0].documentoCobranca);">
								<img width="23" 
									...
									border="0"
									src="<bean:message key="caminho.imagens"/>pesquisa.gif"
									title="Pesquisar Documento Cobrança" />
							</a>
				...
				<%--  <tr>
					...
					<td>
						<html:radio property="situacaoProgramacao" value="<%="0"%>" onclick="javascrpi:validaForm();"/>
						<strong>Todos</strong> 
						<html:radio property="situacaoProgramacao" value="<%=""+ConstantesSistema.SIM%>" onclick="javascrpi:validaForm();"/>
						<strong>Programadas</strong>
						<html:radio property="situacaoProgramacao" value="<%=""+ConstantesSistema.NAO%>" onclick="javascrpi:validaForm();"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="9" 
							...
							size="9"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=3','matriculaImovel','Matrícula do Imóvel');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="9" 
							...
							size="9"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=4','codigoCliente','Código do Cliente');"/>
				...
				<tr>
					...
					<td>
						<html:text maxlength="8" 
							...
							size="6"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=5','unidadeGeracao','Unidade de Geração');"/> 
				...
				<tr>
					...
					<td>
						<html:text maxlength="8" 
							...
							size="6"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=6','unidadeAtual','Unidade Atual');"/> 
				...
				<%-- <tr>
					...
					<td>
						<html:text maxlength="4" 
							...
							size="4"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=7','unidadeSuperior','Unidade Superior');"/> 
							
							<a href="javascript:redirecionarSubmit('exibirPesquisarUnidadeOrganizacionalAction.do?caminhoRetornoTelaPesquisaUnidadeOrganizacional=exibirPesquisarOrdemServicoAction&tipoUnidade=unidadeSuperior');">
				...
				<tr>
					...
					<td>
						<html:text maxlength="4" 
							...
							property="municipio" 
							size="4"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=8','municipio','Município');"/> 
				...
				<tr>
					...
					<td>
						<html:text maxlength="4" 
							...
							property="bairro" 
							size="4"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=9','bairro','Bairro');"/> 
				...
				<tr>
					...
					<td>
						<html:text maxlength="9" 
							...
							property="logradouro" 
							size="9"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarOrdemServicoAction.do?objetoConsultaOs=10','logradouro','Logradouro');"/> 
