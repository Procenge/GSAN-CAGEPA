...
<html:javascript staticJavascript="false"  formName="filtrarOsProgramNaoEncerMotivoActionForm" dynamicJavascript="false" />
...
<html:form action="/filtrarOsProgramNaoEncerMotivoAction" method="post"
	name="FiltrarOsProgramNaoEncerMotivoActionForm" 
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Filtro de Motivo do não encerramento da OS</td>
			...
			<table width="100%" border="0">
				<tr>
					<td width="80%">Preencha os campos para pesquisar uma Motivo do não encerramento da OS:</td>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Indicador Uso:</strong></td>
					<td><strong> 
