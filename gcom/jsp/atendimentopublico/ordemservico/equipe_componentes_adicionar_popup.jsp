	        		...
	        		<tr>
	          			...
	          			<td colspan="4">
	          				<strong>
								...
								<a href="javascript:redirecionarSubmit('exibirPesquisarFuncionarioAction.do?caminhoRetornoTelaPesquisaFuncionario=exibirInserirEquipeAction');"><img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
