          				...
          				<td colspan="3">
          					<strong>
								...
								<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23"	height="21" 
									 style="cursor:hand;" name="imagem"	
									 onclick="chamarPopup('exibirPesquisarUnidadeOrganizacionalAction.do', 'exibirPesquisarEquipeAction', null, null, 275, 480, '',document.forms[0].unidadeOrganizacionalId);"
									 alt="Pesquisar">
        			...
        			<tr> 
          				...
          				<td colspan="3">
          					<strong> 
								...
								<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23"	height="21" 
									 style="cursor:hand;" name="imagem"	onclick="chamarPopup('exibirPesquisarTipoPerfilServicoAction.do', 'exibirPesquisarEquipeAction', null, null, 275, 480, '',document.forms[0].tipoPerfilServicoId);"
									 alt="Pesquisar">
