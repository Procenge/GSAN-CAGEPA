        			...
        			<tr bgcolor="#cbe5fe"> 
          				<td align="center" colspan="2"> 
          					<table width="100%" border="0" bgcolor="#99CCFF">
	              				<tr bgcolor="#99CCFF"> 
	                				<td height="18" colspan="2"><div align="center"><span class="style2">Dados do RA - Registro de Atendimento</span></div></td>
	              				</tr>
	              				<tr bgcolor="#cbe5fe"> 
	                				<td colspan="2"> 
		                      				...
		                      				<td colspan="3">
		                        				...
		                        				<html:text property="idServicoTipo" 
                 					    		...
                 					    		<img src="imagens/pesquisa.gif" 
		                        					 ...
		                        					 height="21"
                    					 			 style="cursor: hand;"
                 					    			 onclick="javascript:redirecionarSubmit('exibirPesquisarTipoServicoAction.do?caminhoRetornoTelaPesquisaTipoServico=exibirGerarOrdemServicoAction&tipo=servicoTipo&forward=exibirGerarOrdemServicoPopup');"
                 					    			 alt="Pesquisar"> 
                    			...
                    			<tr> 
                      				...
                      				<td colspan="3">
                        				...
                        				<html:textarea property="observacao" 
                        					cols="50" 
                        					rows="4" onkeyup="validarTamanhoMaximoTextArea(this,1000);"/>
                        				</strong>
                        			</td>
                    			</tr>
        ...
        <tr> 
          	...
          	<td width="58%">
              	...
              	<input name="Submit223222" 
              		type="button" 
              		class="bottonRightCol" 
              		onClick="javascript:validarForm();" value="Gerar">
              	</div>
           	</td>
        </tr>
        <tr> 
