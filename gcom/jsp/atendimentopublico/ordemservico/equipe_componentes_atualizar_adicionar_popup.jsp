...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(600, 300)">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<a href="javascript:redirecionarSubmit('exibirPesquisarFuncionarioAction.do?caminhoRetornoTelaPesquisaFuncionario=exibirAtualizarEquipeAction');"><img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
