...
<script language="JavaScript">
    ...
    var form = document.forms[0];
	  if(validateAtualizarMaterialActionForm(form)){	     
...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="AtualizarMaterialActionForm" />
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para atualizar um material, informe os dados gerais abaixo:</td>
				</tr>
				
				<tr>
					<td><strong>Código do Material :</strong></td>
					<td colspan="2"><html:text property="codigoMaterial" size="10"
				...
				<tr>
					...
					<td colspan="2">
						<html:select property="unidadeMaterial" tabindex="4" style="width:200px;">
			...
			<table width="100%">
				<tr>
					<td width="40%" align="left">
						...
						value="Desfazer" 
						onclick="window.location.href='/gsan/exibirAtualizarMaterialAction.do?desfazer=S&reloadPage=1&idMaterial=<bean:write name="AtualizarMaterialActionForm" property="codigoMaterial" />';">
