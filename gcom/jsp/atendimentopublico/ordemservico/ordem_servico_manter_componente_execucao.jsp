...
function voltarParaEncerrar(){
	...
	var form = document.forms[0];
	window.location.href='/gsan/exibirEncerrarOrdemServicoAction.do?dataRoteiro=' + form.dataRoteiro.value;
}

</script>
</head>

<body leftmargin="5" topmargin="5" onload="window.focus();resizePageSemLink(680, 470);setarFoco('${requestScope.nomeCampo}');">
    ...
    <table height="100%">
      ...
      <table width="100%" border="0">
				...
				<tr>
      			...
      			<logic:present name="colecaoManterDadosAtividadesOrdemServicoHelper">
      				...
      				<logic:equal name="dadosAtividadesOrdemServico" property="ordemServicoAtividade.atividade.id" value="${requestScope.idAtividade}">
      					...
      					<% String dataExecucao = (String) request.getAttribute("dataExecucaoEquipeComponente"); %>
      					...
      					<logic:iterate name="colecaoOSAtividadePeriodoExecucaoHelper" id="dadosOsAtividadePeriodoExecucao" type="OSAtividadePeriodoExecucaoHelper">
	      					...
	      					<%if (dadosOsAtividadePeriodoExecucao.getOsAtividadePeriodoExecucao().getDataInicioFormatada().equals(dataExecucao)
	      									&& dadosOsAtividadePeriodoExecucao.getOsAtividadePeriodoExecucao().getHoraInicioFormatada().equals(horaInicioExecucao)
	      									&& dadosOsAtividadePeriodoExecucao.getOsAtividadePeriodoExecucao().getHoraFimFormatada().equals(horaFimExecucao)){ %>
	      				
	      					
	      						<bean:define name="dadosOsAtividadePeriodoExecucao" property="ordemServicoExecucaoEquipeHelper" type="OSExecucaoEquipeHelper" id="dadosOsExecucaoEquipeHelper" />		
	      						
	      						<%Integer idEquipe = (Integer) request.getAttribute("idEquipe"); %>
	      						
	      						
	      							<%if (dadosOsAtividadePeriodoExecucao.getOrdemServicoExecucaoEquipeHelper().getOsExecucaoEquipe().getEquipe().getId()
	      								  .equals(idEquipe)){ %>
        ...
        <tr>
			...
			style="width: 80px" onclick="javascript:voltarParaEncerrar()"></td>
        </tr>
      </table>
