...
<html:javascript staticJavascript="false"  formName="InserirServicoTipoActionForm" />
...
<script language="JavaScript">
	...
	function removeRowTableAssociadas(id) {
		var form = document.forms[0];	
		form.action= "/gsan/pesquisarRemoverServicoTipoAssociadoInserirAction.do?idServicoAssociadoRemover=" + id;
		form.submit();
	}

	function removeRowTableServicoTipoTramite(id) {
		var form = document.forms[0];	
		form.action= "/gsan/pesquisarRemoverServicoTipoTramiteInserirAction.do?idServicoTipoTramiteRemover=" + id;
		form.submit();
	}

	function validaForm() {
	  	var form = document.forms[0];
	  	form.action = "inserirServicoTipoAction.do";
		if(validateInserirServicoTipoActionForm(form)) {
  	...
  	function validaTodosRadioButton() {
		...
		if (!form.indicadorPermiteAlterarValor[0].checked
			...
			alert("Informe Indicador Permitir Alterar Valor de Débito");		
			return false;
		}
	...
	function atualizarColecaoServicoTipoValorLocalidade(id, valor){
		...
		var valorAtualizado = valor.value;
 		form.action = "/gsan/exibirInserirServicoTipoAction.do?atualizarIdLocalidade="+id+"&servicoValorLocalidade="+valorAtualizado;
		form.submit();
...
<body leftmargin="5" topmargin="5" onload="setarFoco('descricao');controlaTipoServicoReferenciaOnKeyUp();">
		...
		<tr>
			...
			<table width="100%" height="311" border="0">
				...
				<tr>
					...
					<td align="left"><label> <html:radio property="pavimento" value="3" />
					<strong>Opcional</strong></label>
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left" width="20%"><label> <html:radio
						property="codigoServico" value="C" /> <strong>Operacional</strong></label>
					</td>
					<td align="left"><label> <html:radio property="codigoServico"
						value="O" /> <strong>Comercial</strong></label></td>
				</tr>
				...
				<tr> 
					...
					<td align="left"><label> <html:radio property="indicadorDeslocamento" value="3" />
					<strong>Opcional</strong></label></td>
				</tr>
				...
				<tr> 
					...
					<td align="left"><label> <html:radio property="indicadorHorariosExecucao" value="3" />
					<strong>Opcional</strong></label></td>
				</tr>
				...
				<tr> 
					...
					<td align="left"><label> <html:radio property="indicadorCausaOcorrencia" value="3" />
					<strong>Opcional</strong></label></td>
				</tr>
				...
				<tr> 
					...
					<td align="left"><label> <html:radio property="indicadorRedeRamalAgua" value="3" />
					<strong>Opcional</strong></label></td>
				</tr>
				...
				<tr> 
					...
					<td align="left"><label> <html:radio property="indicadorRedeRamalEsgoto" value="3" />
					<strong>Opcional</strong></label></td>
				</tr>
				...
				<tr> 
					...
					<td align="left"><label> <html:radio property="indicadorMaterial" value="3" />
					<strong>Opcional</strong></label></td>
				</tr>
				...
				<tr> 
					...
					<td align="left"><label> <html:radio property="indicadorVala" value="3" />
					<strong>Opcional</strong></label></td>
				</tr>
					...
					<table width="100%" id="tableServicoTipoValorLocalidade" align="center"
						...
						<tbody>
							...
							<c:forEach var="servicoTipoValorLocalidade"
								items="${InserirServicoTipoActionForm.servicoTipoValorLocalidade}"
								varStatus="i">
				...
				<tr>
					...
					<td>
					 <div align="right">
						<input type="button" name="Submit242" class="bottonRightCol" value="Adicionar" onclick="abrirPopup('exibirPesquisarServicoTipoAssociadoAction.do?operacao=adicionar', 'servicoAssociado', null, null, 620, 680, '','');">
					 </div>
					</td>
				</tr>
				<tr>
					...
					<table width="100%" id="tableServicosAssociados" align="center" bgcolor="#99CCFF">
						...
						<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
							...
							<td width="18%">
							 <div align="center"><strong>Ordem de Geração</strong></div>
							</td>
						</tr>
						<tbody>
					<% int cont = 0; %>
				...
				<logic:present name="indicadorParametroTramite" scope="session">
					...
					<tr>
						...
						<td>
						 <div align="right">
							<input type="button" name="Submit243" class="bottonRightCol" value="Adicionar" onclick="abrirPopup('exibirPesquisarServicoTipoTramiteAction.do?operacao=adicionar&origemTelaPrincipal=true', 'servicoTipoTramite', null, null, 635, 370, '','');">
						 </div>
						</td>
					</tr>
					<tr>
