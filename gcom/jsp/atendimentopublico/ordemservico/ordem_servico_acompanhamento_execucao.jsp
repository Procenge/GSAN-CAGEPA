...
<script language="JavaScript">
	...
	function validarForm(){
    	...
    	if(validateGerarRelatorioAcompanhamentoExecucaoOSActionForm(form)){
			if(validaTodosPeriodos(form.relatorioTipo.value)){
    ...
    function validaTodosPeriodos(tipoRelatorio) {

		var form = document.forms[0];
		
		if (validaPeriodoAtendimento(form, tipoRelatorio) && validaPeriodoEncerramento(form)) {
    ...
    function validaPeriodoAtendimento(form, tipoRelatorio) {
    	...
    	(periodoAtendimentoInicial == null || periodoAtendimentoInicial == '') && 
    	(periodoAtendimentoFinal == null || periodoAtendimentoFinal == '') &&
    	tipoRelatorio != '3' && tipoRelatorio != '4') {
	...
	function limparFormulario(tipo){
		...
		limparEquipeProgramacao();
		limparEquipeExecucao();
		form.relatorioTipo.value = tipo;
		form.action = '/gsan/exibirGerarRelatorioAcompanhamentoExecucaoOSAction.do?menu=sim&tipoRelatorio'+tipo;
		form.submit();
	}
...
<html:form action="/filtrarOrdemServicoAction" method="post"
	...
	<html:hidden property="relatorioTipo" />
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg"> <bean:write name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="titulo"/> </td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<logic:equal name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="1">
					<html:radio property="origemServico"
						value="<%=""+ConstantesSistema.ORIGEM_SERVICO_SELETIVO%>"
						onclick="javascript:validaOrigemServico('2');" disabled="true"/>
					</logic:equal> 
					<logic:notEqual name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="1">
					<html:radio property="origemServico"
						value="<%=""+ConstantesSistema.ORIGEM_SERVICO_SELETIVO%>"
							...
							<table width="50" align="center">
								<tr>
									<td align="center"><input type="button" class="bottonRightCol"
										onclick="javascript:MoverTodosDadosSelectMenu1PARAMenu2('GerarRelatorioAcompanhamentoExecucaoOSActionForm', 'tipoServico', 'tipoServicoSelecionados');"
										value=" &gt;&gt; "></td>
								</tr>

								<tr>
									<td align="center"><input type="button" class="bottonRightCol"
										onclick="javascript:MoverDadosSelectMenu1PARAMenu2('GerarRelatorioAcompanhamentoExecucaoOSActionForm', 'tipoServico', 'tipoServicoSelecionados');"
										value=" &nbsp;&gt;  "></td>
								</tr>

								<tr>
									<td align="center"><input type="button" class="bottonRightCol"
										onclick="javascript:MoverDadosSelectMenu2PARAMenu1('GerarRelatorioAcompanhamentoExecucaoOSActionForm', 'tipoServico', 'tipoServicoSelecionados');"
										value=" &nbsp;&lt;  "></td>
								</tr>

								<tr>
									<td align="center"><input type="button" class="bottonRightCol"
										onclick="javascript:MoverTodosDadosSelectMenu2PARAMenu1('GerarRelatorioAcompanhamentoExecucaoOSActionForm', 'tipoServico', 'tipoServicoSelecionados');"
										value=" &lt;&lt; "></td>
								</tr>
							</table>
							</td>
				...
				<tr>
					...
					<td colspan="2" width="81%" height="24"><html:text maxlength="3"
						...
						onkeypress=" validaEnterComMensagem(event, 'exibirGerarRelatorioAcompanhamentoExecucaoOSAction.do?objetoConsulta=6','idLocalidadeFiltro','Localidade'); javascript:limparDescricaoLocalidade();pesquisaLocalidade(this.value);return isCampoNumerico(event);" />
					<a
					...
					<img width="23" height="21" border="0"
						...
						<logic:empty name="GerarRelatorioAcompanhamentoExecucaoOSActionForm"
							property="idLocalidadeFiltro">
							<html:text property="localidadeDescricaoFiltro" value=""
								size="40" maxlength="30" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
						<logic:notEmpty name="GerarRelatorioAcompanhamentoExecucaoOSActionForm"
							property="idLocalidadeFiltro">
							<html:text property="localidadeDescricaoFiltro" size="40"
								maxlength="30" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
				...
				<tr>
					...
					<td><html:text maxlength="4" tabindex="9"
				...
				<tr>
					...
					<td><html:text maxlength="4" tabindex="10"
				...
				<tr>
					<td height="24">
						<logic:equal name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="1">
							...
							value="Limpar"
							onclick="javascrip:limparFormulario(1);" 
							tabindex="12"/>
						</logic:equal>
						<logic:notEqual name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="1">
							<logic:equal name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="2">
								<input type="button" class="bottonRightCol"
								value="Limpar"
								onclick="javascrip:limparFormulario(2);" 
								tabindex="12"/>
							</logic:equal>
							<logic:notEqual name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="2">
								<logic:equal name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="3">
									<input type="button" class="bottonRightCol"
									value="Limpar"
									onclick="javascrip:limparFormulario(3);" 
									tabindex="12"/>
								</logic:equal>
								<logic:notEqual name="GerarRelatorioAcompanhamentoExecucaoOSActionForm" property="relatorioTipo" value="3">
									<input type="button" class="bottonRightCol"
									value="Limpar"
									onclick="javascrip:limparFormulario(4);" 
									tabindex="12"/>
								</logic:notEqual>
					...
					<td align="right"><input type="button" name="Button"
						class="bottonRightCol" value="Filtrar" tabindex="11"
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioAcompanhamentoExecucaoOSAction.do&left=400&top=510" />
