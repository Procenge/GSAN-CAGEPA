			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Atividades Cadastradas:</strong></font></td>
				</tr>
				<tr>
									...
									if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<td width="37%" align="center"><html:link
														href="/gsan/exibirAtualizarAtividadeAction.do"
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="233"><font color="#FF0000"> <html:submit
								...
								onClick="javascript:window.location.href='/gsan/exibirFiltrarAtividadeAction.do?paginacao=sim'">
						</tr>
					</table>
					</td>
				</tr>
