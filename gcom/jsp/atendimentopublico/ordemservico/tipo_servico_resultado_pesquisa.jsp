...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(800, 300);">
	...
	<tr>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr bordercolor="#000000">
				...
				<td width="35%" align="center" bgcolor="#90c7fc"><strong>Descrição do Tipo de Serviço</strong></td>
				<td width="12%" align="center" bgcolor="#90c7fc"><strong>Prioridade do Tipo de Serviço</strong></td>
				<td width="25%" align="center" bgcolor="#90c7fc"><strong>Atualização do Comercial</strong></td>
						...
						<pg:item>
							...
							<%}%>
								...
								<logic:present name="tipo">
									<logic:present name="caminhoRetornoTelaPesquisaTipoServico" scope="session">
										<td width="6%" align="center">
										    <a href="javascript:enviarDadosParametros('<bean:write name="caminhoRetornoTelaPesquisaTipoServico"/>', '<bean:write name="tipoServico" property="id"/>', '<bean:write name="tipoServico" property="descricao"/>', 'tipoServico');">
												<bean:write name="tipoServico" property="id" />
											</a>
									...
									<td width="12%">
									    <logic:notEmpty name="tipoServico" property="servicoTipoPrioridade">
