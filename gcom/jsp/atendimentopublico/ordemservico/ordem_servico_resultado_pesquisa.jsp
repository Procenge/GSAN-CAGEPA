						                        	...
						                        	<div align="center">
														<logic:notEmpty name="helper" property="ordemServico.registroAtendimento">
						                        			...
						                        			<logic:present name="caminhoRetornoResultadoPesquisaOS">
								                        		...
								                        		<a  title="Consultar Dados do RA - Registro de Atendimento" href="javascript:window.location.href='<html:rewrite page="/exibirConsultarRegistroAtendimentoPopupAction.do?numeroRA=${helper.ordemServico.registroAtendimento.id}"/>&caminhoTelaPesquisaRetorno=${sessionScope.caminhoRetornoResultadoPesquisaOS}';">
															...
															<logic:notPresent name="caminhoRetornoResultadoPesquisaOS">
																...
																<a  title="Consultar Dados do RA - Registro de Atendimento" href="javascript:window.location.href='<html:rewrite page="/exibirConsultarRegistroAtendimentoPopupAction.do?numeroRA=${helper.ordemServico.registroAtendimento.id}"/>';">
																	<bean:write name="helper" property="ordemServico.registroAtendimento.id" /> 
																</a>
