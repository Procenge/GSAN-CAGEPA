...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(670,600);javascript:setarFoco('${requestScope.nomeCampo}');">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<img src="imagens/pesquisa.gif" width="23" height="21"
						...
						size="35" maxlength="40" /> <a href="javascript:limpar('servicoPerfilTipo');"> <img
								border="0" title="Apagar"
								src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a></span></td>
				</tr>
				...
				<tr>
					...
					<img src="imagens/pesquisa.gif" width="23" height="21"
						...
						readonly="true" style="background-color:#EFEFEF; border:0"
						size="35" maxlength="40" /> <a href="javascript:limpar('servicoTipoReferencia');"> <img
								border="0" title="Apagar"
								src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a></span></td>
				</tr>
				...
				<tr>
					...
					<td height="24">
						<html:text maxlength="8" property="idUnidadeOrganizacionalDestino" size="6" tabindex="6"
							onkeypress="javascript:limparPesquisaDescricaoUnidadeOrganizacionalDestino();validaEnterComMensagem(event, 'exibirPesquisarTipoServicoAction.do', 'idUnidadeOrganizacionalDestino', 'Unidade de Destino');return isCampoNumerico(event);"/>
						<a href="javascript:redirecionarSubmit('exibirPesquisarUnidadeOrganizacionalAction.do?caminhoRetornoTelaPesquisaUnidadeOrganizacional=exibirPesquisarTipoServicoAction&tipoUnidade=unidadeAtendimento');">
						...
						<logic:present name="unidadeOrganizacionalDestinoNaoEncontrado" scope="request">
							<html:text property="descricaoUnidadeOrganizacionalDestino" size="36" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000"/>
						</logic:present>

						<logic:notPresent name="unidadeOrganizacionalDestinoNaoEncontrado" scope="request">
							<html:text property="descricaoUnidadeOrganizacionalDestino" size="36" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
						</logic:notPresent>
