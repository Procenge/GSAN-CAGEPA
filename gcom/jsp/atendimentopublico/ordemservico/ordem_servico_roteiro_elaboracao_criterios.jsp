	...
	function validarForm(){
    	...
    	if(validateElaborarOrdemServicoRoteiroCriteriosActionForm(form)){
			if(validaTodosPeriodos()){
				...
				var s2 = document.forms['ElaborarOrdemServicoRoteiroCriteriosActionForm'].elements['tipoServicoSelecionados'];

				if (s2 == null || s2.length == 0) {
					MoverTodosDadosSelectMenu1PARAMenu2('ElaborarOrdemServicoRoteiroCriteriosActionForm', 'tipoServico', 'tipoServicoSelecionados');
				}
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						...
						<html:radio property="origemServicos" value="3" onclick="javascript:mudaForm();"/>
						<strong>Ambos</strong> 
				...
				<tr>
					...
					<td>
						<strong> 
						<html:select property="criterioSelecao" style="width: 230px;" onchange="javascript:mudaForm();">
				...
				<tr>
					...
					<table width="100%" border=0 cellpadding=0 cellspacing=0 align="left">
						<tr>
							<td width="200">
									<div align="left"><strong>Disponíveis - Quantidade de OS</strong></div>
							
								<html:select property="tipoServico" size="6" multiple="true" style="width: 500px;">
										<html:options collection="colecaoTipoServico" labelProperty="descricaoQtidadeOs" property="id" />
								</html:select>
							</td>
							...
							<td>
								...
								<html:select property="tipoServicoSelecionados" size="6" multiple="true" style="width:500px">
								</html:select>
							</td>
						</tr>
					</table>
				...
				<tr>
					<td>
						<strong>Processo Adm./Jud. :</strong>
					</td>
					<td>
						<html:radio property="indicadorProcessoAdmJud" value="<%=""+ConstantesSistema.TODOS%>" />
						<strong>Todos</strong> 
						<html:radio property="indicadorProcessoAdmJud" value="<%=""+ConstantesSistema.SIM%>" />
						<strong>Sim</strong>
						<html:radio property="indicadorProcessoAdmJud" value="<%=""+ConstantesSistema.NAO%>" />
						<strong>N&atilde;o</strong>
					</td>
				</tr>
