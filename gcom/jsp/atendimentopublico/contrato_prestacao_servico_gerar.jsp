...
<link rel="stylesheet"
	...
	type="text/css">
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="GerarContratoPrestacaoServicoActionForm"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2" align="right">
 					...
 					<input type="button" name="Button" class="bottonRightCol" value="Gerar" onclick="javascript:validarForm(document.forms[0]);"/>
