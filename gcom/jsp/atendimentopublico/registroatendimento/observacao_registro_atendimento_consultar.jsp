		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="parabg">Pesquisar Observações do RA - Registro de Atendimento</td>
					<td width="11">
									...
									<table border="0" width="100%">
 										...
 										<tr> 
						                	...
						                	<td>
												...
												<a href="javascript:abrirCalendarioReplicando('PesquisarObservacaoRegistroAtendimentoActionForm', 'periodoAtendimentoInicial', 'periodoAtendimentoFinal');">
													<img border="0" 
