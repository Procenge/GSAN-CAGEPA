...
function abrirPopupComSubmit(form,altura, largura){
 ...
 form.action = 'recuperarDadosInserirTipoSolicitacaoEspecificacaoAction.do?retornarTela=exibirInserirTipoSolicitacaoEspecificacaoAction.do&limparCampoAnterior=true';
 submeterFormPadrao(form);
}
						...
						<logic:present name="colecaoSolicitacaoTipoEspecificacao">
							...
							%>
										<tr bgcolor="#FFFFFF">
											...
											<td width="80%">
											<a href="javascript:document.forms[0].target='';abrirPopup('exibirAdicionarSolicitacaoEspecificacaoAction.do?ultimaAlteracao=<bean:write name="solicitacaoTipoEspecificacao" property="ultimaAlteracao.time"/>',710,440);">
											<bean:write
												name="solicitacaoTipoEspecificacao" property="descricao" /></a></td>
										</tr>
