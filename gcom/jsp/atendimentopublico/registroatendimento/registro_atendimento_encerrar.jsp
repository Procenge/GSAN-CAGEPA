			...
			<td width="615" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="parabg">Encerrar RA - Registro de Atendimento</td>
						<td width="11">
	                     				...
	                     				<td align="center">
	                    					<span class="style2">
	                     					<a href="javascript:extendeTabela('Local',true);"/>
	                     						<b>Dados Gerais do RA - Registro de Atendimento</b>
	                     					</a>
	                    					</span>
	                     				</td>
	                    			</tr>
				...
				<tr> 
                	<td height="10" colspan="2">Para encerrar o RA - Registro de Atendimento, informe os dados abaixo:</td>
                 </tr>
           			...
           			<td align="center">
                   		<table width="100%" border="0" bgcolor="#99CCFF">
	    					<tr bgcolor="#99CCFF">
                     			<td align="center">
                   					<span class="style2">
                    						<b>Dados do Encerramento do RA - Registro de Atendimento</b>
                   					</span>
                     			</td>
                    		</tr>
							...
							<tr bgcolor="#cbe5fe">
								<td>
									<table border="0" width="100%">
										...
										<tr> 	
                                    		<td class="style3">
                                    			<strong>Parecer do Encerramento:<font color="#FF0000">*</font></strong>
                                    		</td>
                                    		<td colspan="3">
                                    			<span class="style2">
                                    				<strong>
