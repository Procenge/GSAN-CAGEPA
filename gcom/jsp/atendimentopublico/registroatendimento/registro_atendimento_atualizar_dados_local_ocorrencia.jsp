...
window.onmousemove = verificarCamposHistoryBack;
    ...
    function InteiroZeroPositivoValidations () { 
     ...
     this.as = new Array("cdSetorComercial", "Setor Comercial deve somente conter números positivos ou zero.", new Function ("varName", " return this[varName];"));
     this.at = new Array("nnQuadra", "Quadra deve somente conter números positivos ou zero.", new Function ("varName", " return this[varName];"));
    }
				...
				<tr>
					...
					<logic:empty name="AtualizarRegistroAtendimentoActionForm" property="idOrdemServico"> --%>
						...
						<html:text property="idImovel" size="10" maxlength="9"
							tabindex="1"
							onkeypress="validaEnterComMensagem(event, 'atualizarRegistroAtendimentoWizardAction.do?action=exibirAtualizarRegistroAtendimentoDadosLocalOcorrenciaAction&pesquisarImovel=OK', 'idImovel', 'Matrícula do Imóvel');"
				...
				<logic:equal name="solicitacaoTipoRelativoFaltaAgua" value="SIM">
					<tr>
						...
						<td colspan="2"><logic:present name="desabilitarMunicipioBairro">
							...
							<html:text property="idMunicipio" size="5" maxlength="4"
								tabindex="5"
								onkeypress="validaEnterComMensagem(event, 'atualizarRegistroAtendimentoWizardAction.do?action=exibirAtualizarRegistroAtendimentoDadosLocalOcorrenciaAction&pesquisarMunicipio=OK', 'idMunicipio', 'Município');"
				...
				<logic:notEqual name="solicitacaoTipoRelativoFaltaAgua" value="SIM">
					<tr>
						...
						<td colspan="2"><html:text property="idMunicipio" size="5"
							...
							height="21" border="0"
							src="<bean:message key="caminho.imagens"/>pesquisa.gif"
							title="Pesquisar Município" /> <html:text
				...
				<logic:equal name="solicitacaoTipoRelativoFaltaAgua" value="SIM">
					<tr>
						...
						<td colspan="2"><logic:present name="desabilitarMunicipioBairro">
							...
							<html:text property="cdBairro" size="5" maxlength="4"
								tabindex="6"
								onkeypress="validaEnterDependencia(event, 'atualizarRegistroAtendimentoWizardAction.do?action=exibirAtualizarRegistroAtendimentoDadosLocalOcorrenciaAction&pesquisarBairro=OK', document.forms[0].cdBairro, document.forms[0].idMunicipio.value, 'Município');"
