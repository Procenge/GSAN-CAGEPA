			...
			<td width="700" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="parabg">Trâmite do RA - Registro de Atendimento</td>
						<td width="11">
											...
											<tr bgcolor="#cbe5fe">
												<td>
													<table border="0" width="100%">
							                            ...
							                            <tr> 
						                              		<td class="style3"><strong>Motivo do Trâmite:</strong></td>
						                              		<td colspan="3">
																<html:text property="motivoTramite" readonly="true"
																	style="background-color:#EFEFEF; border:0;" size="48"
																	maxlength="50"/>
						                                	</td>
							                            </tr>
