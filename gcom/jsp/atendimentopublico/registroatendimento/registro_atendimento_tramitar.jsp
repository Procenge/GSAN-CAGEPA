		...
		if (validateTramitarRegistroAtendimentoActionForm(form)) {
			...
			if (validaMotivo) {
				if (form.motivoTramite.value != "-1") {
					...
					alert("Escolha o motivo do tramite");
...
<html:form action="/tramitarRegistroAtendimentoAction.do"
			...
			<td width="615" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="parabg">Tramitar RA - Registro de Atendimento</td>
						<td width="11">
				...
				<tr> 
                	<td height="10" colspan="2">Para tramitar o RA - Registro de Atendimento, informe os dados abaixo:</td>
                 </tr>
									...
									<table border="0" width="100%">
                								...
                								<span class="style2">
                									<strong>
														<html:text property="unidadeDestinoId" size="6" maxlength="8"
							   									   onkeypress="javascript:validaEnterComMensagem(event, 'exibirTramitarRegistroAtendimentoAction.do?validaUnidadeDestino=true', 'unidadeDestinoId','Unidade Destino');"/>
														<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23"	height="21" 
						 									 style="cursor:hand;" name="imagem"	onclick="chamarPopup('exibirPesquisarUnidadeOrganizacionalAction.do', 'unidadeOrganizacional', null, null, 275, 480, '',document.forms[0].unidadeAtendimentoId);"
						 									 alt="Pesquisar">
                								...
                								<span class="style2">
                									<strong>
														...
														<html:text property="usuarioResponsavelId" size="9" maxlength="9"
							   									   onkeypress="javascript:validaEnterComMensagem(event, 'exibirTramitarRegistroAtendimentoAction.do?validaUsuarioResponsavel=true', 'usuarioResponsavelId','Usuário Responsável');"/>
								   						</logic:notEqual>
										...
										<logic:equal name="<%=SistemaParametro.SISTEMA_PARAMETRO%>" property="parmId" value="<%="" + SistemaParametro.INDICADOR_EMPRESA_DESO%>" scope="session">
											<tr>
												...
												<td><html:select property="motivoTramite" tabindex="4">
