		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<a
						href="javascript:redirecionarSubmit('recuperarDadosPesquisarAdicionarSolicitacaoEspecificacaoTipoServicoAction.do?caminhoRetornoTelaPesquisaTipoServico=exibirAtualizarAdicionarSolicitacaoEspecificacaoTipoServicoAction&limpar=1');">
