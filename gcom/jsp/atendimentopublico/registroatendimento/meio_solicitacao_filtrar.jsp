...
<html:javascript staticJavascript="false"  formName="MeioSolicitacaoActionForm" dynamicJavascript="false" />
...
<html:form action="/filtrarMeioSolicitacaoAction" method="post"
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Filtro de Meio Solicitacao</td>
			...
			<table width="100%" border="0">
				<tr>
					<td width="80%">Preencha os campos para pesquisar um meio solicitação:</td>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Indicador de Liberação de Documento de Identidade:<font color="#FF0000">*</font></strong></td>
					<td><strong> <html:radio property="indicadorLiberacaoDocIdent" value="1"/> Sim
