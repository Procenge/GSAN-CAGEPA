		...
		<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					Atendimento encontrados: <bean:write name="quantidadeRAHelper" scope="session"/> </strong> </font></td>
				</tr>
			</table>
  			...
  			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr bordercolor="#000000">
					...
					<td width="8%" bgcolor="#90c7fc">
						<div align="left"><strong>Nº RA</strong></div>
					</td>
					
					<td width="5%" bgcolor="#90c7fc">
						<div align="left"><strong>OS Progr.</strong></div>
					</td>
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td valign="top" align="right"><input name="button" type="button"
								...
								onclick="window.location.href='<html:rewrite page="/registroAtendimentoTramitacaoAction.do"/>'"
