...
function abrirPopupComSubmit(form,altura, largura){
 ...
 form.action = 'recuperarDadosAtualizarTipoSolicitacaoEspecificacaoAction.do?inserir=sim&limpaSessao=sim&adicionar=sim&retornarTela=exibirAtualizarTipoSolicitacaoEspecificacaoAction.do&limparCampoAnterior=true';
 submeterFormPadrao(form);
}
								...
								<logic:iterate name="colecaoSolicitacaoTipoEspecificacao"
									...
									<div align="left"><a
										href="javascript:document.forms[0].target='';
												abrirPopup('exibirAtualizarAdicionarSolicitacaoEspecificacaoAction.do?atualizar=sim&posicao=${count}',710,440);">
