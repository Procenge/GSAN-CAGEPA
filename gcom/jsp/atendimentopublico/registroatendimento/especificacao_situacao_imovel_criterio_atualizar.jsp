...
<logic:notPresent name="fechaPopup" scope="request">
	<body leftmargin="5" topmargin="5" onload="javascript:habilitaCampos();resizePageSemLink(600, 350)";>
</logic:notPresent>

<logic:present name="fechaPopup" scope="request">
	<body leftmargin="5" topmargin="5" onload="chamarReload('exibirAtualizarEspecificacaoSituacaoImovelAction.do?tipoOperacao=A');window.close()">
</logic:present>
