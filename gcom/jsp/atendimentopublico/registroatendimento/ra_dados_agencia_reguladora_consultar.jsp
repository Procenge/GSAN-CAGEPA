		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">
						Consultar Dados do RA - Registro de Atendimento pela Agência Reguladora
					</td>
					<td width="11">
					...
					<table width="100%" border="0" align="center">
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								<tr bgcolor="#99CCFF">
									<td align="center"><span class="style2"> 
										<a href="javascript:extendeTabela('RegistroAtendimento',true);"/><b>Dados do RA - Registro de Atendimento</b></a></span>
									</td>
								</tr>
							</table>
							</div>
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								<tr bgcolor="#99CCFF">
									<td align="center"><span class="style2"> 
										<a href="javascript:extendeTabela('RegistroAtendimento',false);" /><b>Dados do RA - Registro de Atendimento</b></a></span>
									</td>
								</tr>
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<td colspan="3">
												...
												style="background-color:#EFEFEF; border:0;" size="16" maxlength="16" />
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												style="background-color:#EFEFEF; border:0;" size="4" maxlength="5" />
											</td>
										</tr>
							...
							<td>
								<table border="0" width="100%">
									<tr>
										...
										<logic:present name="colecaoRaDadosAgenciaReguladoraFone">
