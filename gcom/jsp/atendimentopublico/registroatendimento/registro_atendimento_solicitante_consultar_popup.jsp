			...
			<td width="700" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="parabg">Consultar Solicitante(s) do RA - Registro de Atendimento</td>
						<td width="11">
		          						...
		          						<div align="left"> 
		              						<table width="100%" align="center" bgcolor="#99CCFF">
		                						...
		                						<tr bordercolor="#FFFFFF" bgcolor="#79BBFD"> 
		                  							<td width="8%"><div align="center"><strong>Principal</strong></div></td>
		                  							<td width="31%"><div align="center"><strong>Nome do Solicitante</strong></div></td>
