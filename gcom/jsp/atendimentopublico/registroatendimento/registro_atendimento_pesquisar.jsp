...
<body leftmargin="5" topmargin="5" onload="resizePageSemLink(730, 600);">
...
<html:hidden property="origemInserirRA" />
			...
			<td width="675" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			        <tr>
			          ...
			          <td class="parabg">Pesquisar RA - Registro de Atendimento</td>
