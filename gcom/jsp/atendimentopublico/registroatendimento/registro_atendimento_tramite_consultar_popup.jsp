			...
			<td width="700" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="parabg">Consultar Trâmites do RA - Registro de Atendimento</td>
						<td width="11">
            	...
            	<table width="100%" border="0">
        			...
        			<tr> 
          				<td width="100%" colspan="1">
          					<table width="100%" border="0">
	        					<tr> 
	          						<td width="100%"><strong>Trâmites:</strong></td>
	        					</tr>
		        				<tr> 
		          					<td><strong></strong>
		          						<div align="left"> 
			                					...
			                					<c:set var="count" value="0"/>
					                        		...
					                        		<c:choose>
								                        ...
								                        <logic:equal name="sistemaParametro" property="parmId" scope="session" value="<%=SistemaParametro.INDICADOR_EMPRESA_DESO.toString()%>">
		                  								<td bordercolor="#90c7fc">
								                        	<div align="left">
								                        	<logic:notEmpty name="tramite" property="motivoTramite">							                        
						                        				<bean:write name="tramite" property="motivoTramite.descricao" />
						                        			</logic:notEmpty>
								                        	</div>
								                        </td>
		                  								</logic:equal>
