		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<a href="javascript:redirecionarSubmit('exibirPesquisarTipoServicoAction.do?caminhoRetornoTelaPesquisaTipoServico=exibirPesquisarTipoSolicitacaoEspecificacoesAction', 400, 600);">
