	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Selecionar RA - Registro de Atendimento para
					Tramitação</td>
			...
			<table width="100%" border="0">
				<tr>
					<td>Para selecionar o(s) registro(s) de atendimento, informe os
					dados abaixo:</td>
				</tr>
			</table>
			<table width="100%" border="0">
				<tr>
					...
					<td width="66%"><html:text property="numeroRa" size="9"
						maxlength="9" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong>Ordem de Serviço Programada:</strong></td>
					<td width="66%" align="right">
						<div align="left">
							<html:radio property="indicadorOSProgramada" tabindex="4" 
								value="<%=ConstantesSistema.SIM.toString()%>" />
							<strong>Sim</strong>
							
							<html:radio property="indicadorOSProgramada" tabindex="5"
				...
				<tr>
					...
					<td colspan="6"><span class="style2"><strong> <html:text
						...
						href="javascript:abrirCalendarioReplicando('FiltrarRegistroAtendimentoTramitacaoActionForm', 'periodoAtendimentoInicial', 'periodoAtendimentoFinal');">
					<img border="0"
						...
						href="javascript:abrirCalendario('FiltrarRegistroAtendimentoTramitacaoActionForm', 'periodoAtendimentoFinal');">
					<img border="0"
						src="<bean:message key='caminho.imagens'/>calendario.gif"
						width="16" height="15" border="0" alt="Exibir Calendário"
						tabindex="4" /></a> </strong>(dd/mm/aaaa)<strong> </strong></span></td>
				</tr>
				<tr>
					<td height="24" colspan="7" bordercolor="#000000" class="style1">
					<hr>
				...
				<tr>
					...
					<td colspan="6"><span class="style2"><strong> <html:text
						property="municipioId" size="4" maxlength="4"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarRegistroAtendimentoTramitacaoAction.do?validaMunicipio=true', 'municipioId','Município');"
						onkeyup="limparLogradouro();" /> <img
						src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23"
						height="21" name="imagem"
						onclick="chamarPopup('exibirPesquisarMunicipioAction.do', 'municipio', null, null, 275, 480, '',document.forms[0].municipioId);"
						alt="Pesquisar"> <logic:present name="municipioEncontrada"
						scope="session">
						<html:text property="municipioDescricao" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000"
							size="40" maxlength="40" />
					</logic:present> <logic:notPresent name="municipioEncontrada"
						scope="session">
						<html:text property="municipioDescricao" readonly="true"
				...
				<tr>
					...
					<td colspan="6"><span class="style2"><strong> <html:text
						property="bairroId" size="4" maxlength="4"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarRegistroAtendimentoTramitacaoAction.do?validaBairro=true', 'bairroId','Bairro');" />
					<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
						...
						alt="Pesquisar"> <logic:present name="bairroEncontrada"
						scope="session">
						<html:text property="bairroDescricao" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000"
							size="40" maxlength="40" />
					</logic:present> <logic:notPresent name="bairroEncontrada"
						scope="session">
						<html:text property="bairroDescricao" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #ff0000"
							size="40" maxlength="40" />
				...
				<tr>
					...
					<td colspan="6"><span class="style2"><strong> <html:text
						property="logradouroId" size="9" maxlength="9"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarRegistroAtendimentoTramitacaoAction.do?validaLogradouro=true', 'logradouroId','Logradouro');" />
					<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
						width="23" height="21" name="imagem"
						...
						alt="Pesquisar"> <logic:present name="logradouroEncontrada"
						scope="session">
						<html:text property="logradouroDescricao" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000"
							size="40" maxlength="40" />
					</logic:present> <logic:notPresent name="logradouroEncontrada"
						scope="session">
						<html:text property="logradouroDescricao" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #ff0000"
							size="40" maxlength="40" />
				...
				<tr>
					...
					<div align="left"><span class="style2"><strong> <html:text
						property="unidadeAtualId" size="6" maxlength="8"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarRegistroAtendimentoTramitacaoAction.do?validaUnidadeAtual=true', 'unidadeAtualId','Unidade Atual');" />
					<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
						width="23" height="21" name="imagem"
						...
						alt="Pesquisar"> <logic:present name="unidadeAtualEncontrada"
						scope="session">
				...
				<tr>
					...
					<td colspan="6" align="right">
					<div align="left"><span class="style2"><strong> <html:text
						property="unidadeSuperiorId" size="6" maxlength="8"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarRegistroAtendimentoTramitacaoAction.do?validaUnidadeSuperior=true', 'unidadeSuperiorId','Unidade Superior');" />
					<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
						width="23" height="21" name="imagem"
						...
						alt="Pesquisar"> <logic:present name="unidadeSuperiorEncontrada"
						scope="session">
						<html:text property="unidadeSuperiorDescricao" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000"
							size="40" maxlength="40" />
					</logic:present> <logic:notPresent name="unidadeSuperiorEncontrada"
						scope="session">
						<html:text property="unidadeSuperiorDescricao" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #ff0000"
							size="40" maxlength="40" />
