...
<html:form action="/inserirMeioSolicitacaoAction" 
	method="post" 
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Meio Solicitação</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="3">Para inserir um meio solicitação,
				...
				<tr>
					<td width="30%" height="0"><strong>Descri&ccedil;&atilde;o Abreviada:</strong></td>
					<td colspan="2">
				...
				<tr>
					<td><strong>Indicador de Liberação do Documento de Identidade:</strong></td>
					<td><strong>
