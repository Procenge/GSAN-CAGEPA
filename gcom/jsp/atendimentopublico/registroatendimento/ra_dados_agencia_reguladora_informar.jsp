   ...
   function validarForm() {
    var form = document.forms[0];
	  if(validateInformarRaDadosAgenciaReguladoraActionForm(form)){		
		  ...
		  if(form.numeroRADados.value == ''){
	  	  	alert('Pesquise o Número do RA.');
	...
	function limparRaDados(){
	
		var form = document.forms[0];
		
		form.numeroRADados.value = '';
		form.situacaoRA.value = '';
		form.tipoSolicitacaoId.value = '';
		form.tipoSolicitacaoDescricao.value = '';
		form.especificacaoId.value = '';
		form.especificacaoDescricao.value = '';
		form.meioSolicitacaoDescricao.value = '';
		form.matriculaImovel.value = '';
		form.inscricaoImovel.value = '';
		form.dataAtendimento.value = '';
		form.horaAtendimento.value = '';
		form.dataPrevista.value = '';
		form.idMotivoEncerramento.value = '';
		form.motivoEncerramento.value = '';
		form.idClienteSolicitante.value = '';
		form.clienteSolicitante.value = '';
		form.enderecoOcorrencia.value = '';		
		form.idUnidadeSolicitante.value = '';
		form.unidadeSolicitante.value = '';
		form.nomeSolicitante.value = '';
		form.pontoReferencia.value = '';
		form.bairroId.value = '';
		form.bairroDescricao.value = '';
		form.areaBairroId.value = '';
		form.areaBairroDescricao.value = '';
		form.localidadeId.value = '';
		form.setorComercialCodigo.value = '';
		form.divisaoEsgotoDescricao.value = '';
		form.divisaoEsgotoId.value = '';
		form.divisaoEsgotoDescricao.value = '';
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr>
											<td height="10" width="22%"><strong>N&uacute;mero do RA:<font color="#FF0000">*</font></strong></td>

											<td>
												<html:text property="numeroRA" size="9" maxlength="9" 
													onkeyup="javascript:limparRaDados();return validaEnter(event, 'exibirInformarRaDadosAgenciaReguladoraAction.do?pesquisarRa=OK', 'numeroRA');"
													onkeypress="return isCampoNumerico(event);"/>
												<input type="button" class="bottonRightCol" value="Pesquisar"
													style="width: 80px" onclick="limparRaDados();validarRA();" on/>
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<td width="70%" colspan="2">
												<html:text property="dataPrevisaoOriginal" size="16" maxlength="16"
												tabindex="3" onkeyup="mascaraData(this,event)" 
												style="background-color:#EFEFEF; border:0; color: #000000;" readonly="true"/> dd/mm/aaaa hh:mm</td>
										</tr>
										...
										<tr>
											...
											<td width="70%" colspan="2"><html:text
												property="dataPrevisaoAtual" size="16" maxlength="16"
											...
											<img border="0"
												...
												alt="Exibir Calendário" /></a> dd/mm/aaaa hh:mm</td>
										</tr>
