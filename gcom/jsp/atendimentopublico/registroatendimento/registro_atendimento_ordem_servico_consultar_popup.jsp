...
<html:form action="/exibirConsultarRegistroAtendimentoOSAction.do"
			...
			<td width="700" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="parabg">Consultar Ordens de Serviço do RA - Registro de Atendimento</td>
						<td width="11">
	                      				...
	                      				<table width="100%" border="0" bgcolor="#99CCFF">
						    				<tr bgcolor="#99CCFF">
	                         					<td height="18" colspan="2">
	                         						<div align="center">
	                         							<span class="style2"><b>Dados do RA - Registro de Atendimento </b></span>
	                         						</div>
	                         					</td>
	                        				</tr>
											<tr bgcolor="#cbe5fe">
   ...
   <logic:present name="botaoVoltar" scope="request" >
	<logic:equal name="botaoVoltar" scope="request" value="sim">
						<td width="10%" valign="MIDDLE">
          					<div align="right" valign="MIDDLE">
        					 <input type="button" name="sub" class="bottonRightCol" value="Voltar" onclick="history.back();">
        					</div>
          				</td>
	</logic:equal>
	</logic:present>
