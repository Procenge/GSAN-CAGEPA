		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						<logic:present name="consultaDados">
						  	<html:radio property="indicadorCalculoDataPrevistaAtendimento" value='<%= String.valueOf(SolicitacaoTipoEspecificacao.INDICADOR_CALCULO_DATA_PREVISTA_ATENDIMENTO_SIM) %>' tabindex="3" disabled="true"/> <strong>Dias Úteis</strong>&nbsp; 
						...
						<logic:notPresent name="consultaDados">
							<html:radio property="indicadorCalculoDataPrevistaAtendimento" value='<%= String.valueOf(SolicitacaoTipoEspecificacao.INDICADOR_CALCULO_DATA_PREVISTA_ATENDIMENTO_SIM) %>' tabindex="3"/> <strong>Dias Úteis</strong>&nbsp; 
						...
						<tr>
							<td>
						    	...
						    	<strong>Cliente</strong>&nbsp; <html:radio property="indicadorTipoVerificarDebito"
							 	value='<%= String.valueOf(SolicitacaoTipoEspecificacao.INDICADOR_DEBITOS_IMOVEIS) %>' tabindex="14" disabled="true"/> <strong>Imóvel</strong>
				...
				<tr>
					...
					<td>
						<logic:present name="consultaDados">
							...
							<img width="29" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Mensagem Automática Padrão"/>
						...
						<logic:notPresent name="consultaDados">
							<html:text maxlength="4" property="idSolicitacaoTipoEspecificacaoMensagem" size="4" tabindex="30"
								onkeypress="javascript:validaEnterComMensagem(event, 'exibirAdicionarSolicitacaoEspecificacaoAction.do?objetoConsulta=1', 'idSolicitacaoTipoEspecificacaoMensagem', 'Mensagem Automática Padrão');"/>
