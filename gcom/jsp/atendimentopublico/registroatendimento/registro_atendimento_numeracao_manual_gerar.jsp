		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
		        	...
		        	<td width="470">
					<html:text property="idUnidadeOrganizacional" size="6" maxlength="8" tabindex="2" onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirGerarNumeracaoManualRegistroAtendimentoAction.do?pesquisarUnidade=OK', 'idUnidadeOrganizacional', 'Unidade Organizacional');"/>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td align="right">
						<gcom:controleAcessoBotao name="gerar" value="Gerar" onclick="validarForm(document.forms[0]);" url="gerarNumeracaoManualRegistroAtendimentoAction.do" tabindex="5"/>	
					</td>
				</tr>
			</table>
