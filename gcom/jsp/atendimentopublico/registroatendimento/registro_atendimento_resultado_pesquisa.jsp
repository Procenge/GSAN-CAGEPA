...
<html:javascript staticJavascript="false"  formName="PesquisarRegistroAtendimentoActionForm" dynamicJavascript="false" />
</head>
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Pesquisa de RA - Registro de Atendimento</td>
									...
									<pg:item>
										...
										<logic:notEmpty name="caminhoRetornoTelaPesquisaRegistroAtendimento">
											<td bordercolor="#90c7fc">
					                        	<div align="center">
													<a title="Selecionar RA - Registro de Atendimento" 
										...
										<logic:empty name="origemInserirRA">
										...
										<logic:notEmpty name="origemInserirRA">
											<td bordercolor="#90c7fc">
					                        	<div align="center">
														<a href="exibirConsultarRegistroAtendimentoPopupAction.do?numeroRA=<bean:write name="helper" property="registroAtendimento.id"/>">
