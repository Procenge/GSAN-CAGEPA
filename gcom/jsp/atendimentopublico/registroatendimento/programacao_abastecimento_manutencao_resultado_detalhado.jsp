...
<body leftmargin="5" topmargin="5"
	onload="javascript:resizePageSemLink(590, 692);">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#90c7fc">
						<tr bgcolor="#90c7fc">
							<td align="center"><strong>Data Início</strong></td>
			...
			if (cont % 2 == 0) {%>
								...
								<tr bgcolor="#cbe5fe">
									...
									<div align="center"><bean:write name="abastecimentoProgramacao"
										property="dataInicio" formatKey="date.format" /></div>
									</td>
									<td width="15%">
									<div align="center"><bean:write name="abastecimentoProgramacao"
										property="horaInicio" formatKey="hour.format" /></div>
									</td>
									
									<td width="15%">
									<div align="center"><bean:write name="abastecimentoProgramacao"
										property="dataFim" formatKey="date.format" /></div>
									</td>
									<td width="15%">
									<div align="center"><bean:write name="abastecimentoProgramacao"
