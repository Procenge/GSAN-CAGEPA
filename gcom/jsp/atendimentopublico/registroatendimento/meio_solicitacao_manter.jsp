...
<html:form action="/removerMeioSolicitacaoAction"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Meio Solicitação</td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Meios Solicitações Cadastrados:</strong></font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#99CCFF">
								<tr bordercolor="#000000" bgcolor="#90c7fc">
									...
									<td bgcolor="#90c7fc">
									<div align="center"><strong>Liberação Documento Identidade</strong></div>
									</td>
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<logic:present name="colecaoMeioSolicitacao">
										<%int cont = 0;%>
										<logic:iterate name="colecaoMeioSolicitacao" id="meioSolicitacao"
											scope="request">
											<pg:item>
												<%cont = cont + 1;
									if (cont % 2 == 0) {%>
												...
												<tr bgcolor="#FFFFFF">
													...
													<div align="center"><input type="checkbox"
														name="idRegistrosRemocao" value="${meioSolicitacao.id}"></div>
													</td>

													<td width="12%" align="center">${meioSolicitacao.id}</td>
													
													<td width="37%" align="center"><html:link
														href="/gsan/exibirAtualizarMeioSolicitacaoAction.do"
														paramName="meioSolicitacao" paramProperty="id"
														paramId="idRegistroAtualizacao">${meioSolicitacao.descricao}
													</html:link></td>
													
													
													<td width="37%" align="center">${meioSolicitacao.descricaoAbreviada}</td>
													<td width="50%" align="center"><logic:equal
														name="meioSolicitacao"
														property="indicadorLiberacaoDocIdent" value="1">
											Sim
										</logic:equal> <logic:equal name="meioSolicitacao"
														property="indicadorLiberacaoDocIdent" value="2">
											Não
										</logic:equal></td>
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="233"><font color="#FF0000"> <html:submit
								...
								onClick="javascript:window.location.href='/gsan/exibirFiltrarMeioSolicitacaoAction.do?paginacao=sim'">
						</tr>
					</table>
					</td>
				</tr>
