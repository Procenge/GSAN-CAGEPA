...
<script language="JavaScript">
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'hidrometro') {
	      	...
	      	form.action='exibirEfetuarReligacaoAguaComInstalacaoHidrometroAction.do?objetoConsulta=1&numeroHidrometro=' + codigoRegistro;
	      	form.submit();
...
<html:form action="/efetuarReligacaoAguaComInstalacaoHidrometroAction.do?calculaValores=S"
									...
									<table width="100%" border="0" align="center">
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarReligacaoAguaComInstalacaoHidrometroAction.do', 'idOrdemServico','Ordem de Serviço');"
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="80%" colspan="3"><html:text property="idFuncionario"
																...
																onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirEfetuarReligacaoAguaComInstalacaoHidrometroAction.do', 'idFuncionario', 'Funcionário');" />
															<a 
																href="javascript:abrirPopup('exibirEfetuarReligacaoAguaComInstalacaoHidrometroAction.do?pesquisarFuncionario=OK',400,400);">
															<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar Funcionario"
																...
																<logic:empty name="EfetuarReligacaoAguaComInstalacaoHidrometroActionForm"
																	property="idFuncionario">
																	<html:text property="descricaoFuncionario" value="" size="30"
																		readonly="true"
																		style="background-color:#EFEFEF; border:0; color: #ff0000" />
																</logic:empty>
																<logic:notEmpty name="EfetuarReligacaoAguaComInstalacaoHidrometroActionForm"
																	property="idFuncionario">
																	<html:text property="descricaoFuncionario" size="30"
																		readonly="true"
																		style="background-color:#EFEFEF; border:0; color: #000000" />
													...
													<table border="0" width="100%">
														<tr>
															...
															<td width="58%"><html:text property="numeroHidrometro"
																...
																onkeypress="validaEnterString(event, 'exibirEfetuarReligacaoAguaComInstalacaoHidrometroAction.do?objetoConsulta=1', 'numeroHidrometro','Número do Hidrômetro');" />
															<a
