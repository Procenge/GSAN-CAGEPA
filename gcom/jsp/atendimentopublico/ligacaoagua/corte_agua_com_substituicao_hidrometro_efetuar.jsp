...
<html:javascript staticJavascript="false"
	formName="EfetuarCorteAguaComSubstituicaoHidrometroActionForm"
	dynamicJavascript="true" />

<script language="JavaScript">
	
	function validaForm() {
		var form = document.EfetuarCorteAguaComSubstituicaoHidrometroActionForm;
		if (validateEfetuarCorteAguaComSubstituicaoHidrometroActionForm(form) && validaDebito()){
	...
	function limparForm() {
		...
		form.action = 'exibirEfetuarCorteAguaComSubstituicaoHidrometroAction.do?desfazer=sim';
		form.submit();
	 }
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'hidrometro') {
	      	form.action='exibirEfetuarCorteAguaComSubstituicaoHidrometroAction.do?objetoConsulta=1&numeroHidrometroNovo='+codigoRegistro;
	      	form.submit();

    	} else if (tipoConsulta == 'ordemServico') {

	    	form.idOrdemServico.value = codigoRegistro;
	      	form.action='exibirEfetuarCorteAguaComSubstituicaoHidrometroAction.do';
	...
	function calcularValores(){
		...
		var form = document.EfetuarCorteAguaComSubstituicaoHidrometroActionForm;
	   	...
	   	if (validateEfetuarCorteAguaComSubstituicaoHidrometroActionForm(form) && validaDebito()){
		   	if (quantidadeParcelasMaiorQueZero()) {
			   form.action='exibirEfetuarCorteAguaComSubstituicaoHidrometroAction.do?calculaValores=S';
			   form.submit();
		   	} else {
...
<html:form action="/efetuarCorteAguaComSubstituicaoHidrometroAction.do?calculaValores=S"
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Corte de &Aacute;gua Com Substitui&ccedil;&atilde;o de
									Hidr&ocirc;metro</td>
									<td width="11"><img border="0"
							...
							<table width="100%" border="0">
								<tr>
									...
									<table width="100%" border="0" align="center">
										<tr>
											...
											corte de &aacute;gua com substitui&ccedil;&atilde;o de
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarCorteAguaComSubstituicaoHidrometroAction.do', 'idOrdemServico','Ordem de Serviço');"
												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<html:hidden name="EfetuarCorteAguaComSubstituicaoHidrometroActionForm" property="idTipoMedicao"/>
														</tr>
														<tr>
														...
														<tr>
															...
															<td width="58%"><html:text property="numeroHidrometroNovo"
																size="11" 
																onkeypress="validaEnterString(event, 'exibirEfetuarCorteAguaComSubstituicaoHidrometroAction.do?objetoConsulta=1', 'numeroHidrometroNovo','Número do Hidrômetro Novo');"/>
								...
								<%-- Dados da Geração --%>
								<logic:notEmpty name="EfetuarCorteAguaComSubstituicaoHidrometroActionForm"
												...
												<table width="100%" border="0" bgcolor="#99CCFF">
													...
													<tr bgcolor="#cbe5fe">
														...
														<table border="0" width="100%">
															...
															<logic:notEqual name="EfetuarCorteAguaComSubstituicaoHidrometroActionForm" property="alteracaoValor" value="OK">
															<tr>
															...
															<logic:equal name="EfetuarCorteAguaComSubstituicaoHidrometroActionForm" property="alteracaoValor" value="OK">
															<tr>
																<td height="10"><strong> Valor do D&eacute;bito: </strong>
																</td>
