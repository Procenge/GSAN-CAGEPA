												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">
														...
														<logic:present name="supressaoSemRetirada">
															<tr>
																<td><strong>Retirada de Hidrômetro?<font color="#FF0000">*</font></strong></td>
																<td><strong>
																		<html:radio property="indicadorRetirardaHidrometro" value="1" /> Sim
																		<html:radio property="indicadorRetirardaHidrometro" value="2" /> Não
																	</strong>
																</td>
															</tr>
														</logic:present>
														...
														<tr>
															...
															<td width="80%" colspan="3"><html:text property="idFuncionario"
																...
																onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirEfetuarSupressaoLigacaoAguaAction.do', 'idFuncionario', 'Funcionário');" />
															<a 
