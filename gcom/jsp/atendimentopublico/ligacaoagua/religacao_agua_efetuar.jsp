													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="80%" colspan="3"><html:text property="idFuncionario"
																...
																onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirEfetuarReligacaoAguaAction.do', 'idFuncionario', 'Funcionário');" />
															<a 
																href="javascript:abrirPopup('exibirEfetuarReligacaoAguaAction.do?pesquisarFuncionario=OK',400,400);">
															<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar Funcionario"
																...
																<logic:empty name="EfetuarReligacaoAguaActionForm"
