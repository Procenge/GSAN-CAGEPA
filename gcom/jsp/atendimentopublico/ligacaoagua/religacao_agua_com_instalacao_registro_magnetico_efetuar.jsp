						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Religação Água com Instalação de Registro Magnetico</td>
									<td width="11"><img border="0"
							...
							<table width="100%" border="0">
								<tr>
									...
									<table width="100%" border="0" align="center">
										<tr>
											<td height="10" colspan="2">Para efetuar o religação de água com instalação de registro magnetico, informe os dados abaixo</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarReligacaoAguaComInstalacaoRegistroMagneticoAction.do', 'idOrdemServico','Ordem de Serviço');"
