...
<script language="JavaScript">
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'hidrometro') {
	      	...
	      	form.action='exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do?objetoConsulta=1&numeroHidrometro=' + codigoRegistro;
	      	form.submit();
					...
					<table width="550" border="0" cellspacing="5" cellpadding="0">
						<tr>
							...
							<table width="100%" border="0">
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="80%" colspan="3"><html:text property="idFuncionario"
																...
																onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do', 'idFuncionario', 'Funcionário');" />
															<a 
																href="javascript:abrirPopup('exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do?pesquisarFuncionario=OK',400,400);">
															<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar Funcionario"
																...
																<logic:empty name="EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm"
																	property="idFuncionario">
																	<html:text property="descricaoFuncionario" value="" size="30"
																		readonly="true"
																		style="background-color:#EFEFEF; border:0; color: #ff0000" />
																</logic:empty>
																<logic:notEmpty name="EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm"
																	property="idFuncionario">
																	<html:text property="descricaoFuncionario" size="30"
																		readonly="true"
																		style="background-color:#EFEFEF; border:0; color: #000000" />
								...
								<logic:notEmpty name="EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm" property="idTipoDebito">
									<tr>
										<td height="31">
										<table width="100%" border="0" align="center">
											<tr bgcolor="#cbe5fe">
...
<!-- ligacao_agua_com_instalacao_hidrometro_restabelecimento_efetuar.jsp -->
</html:html>
