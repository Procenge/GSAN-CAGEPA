									...
									<table width="100%" border="0" align="center">
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarLigacaoAguaComInstalacaoHidrometroAction.do', 'idOrdemServico','Ordem de Serviço');"
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="80%" colspan="3"><html:text property="idFuncionario"
																...
																onkeypress="limparDescricao();validaEnterComMensagem(event, 'exibirEfetuarLigacaoAguaComInstalacaoHidrometroAction.do', 'idFuncionario', 'Funcionário');" />
															<a 
																href="javascript:abrirPopup('exibirEfetuarLigacaoAguaComInstalacaoHidrometroAction.do?pesquisarFuncionario=OK',400,400);">
															<img src="/gsan/imagens/pesquisa.gif" alt="Pesquisar Funcionario"
																...
																<logic:empty name="EfetuarLigacaoAguaComInstalacaoHidrometroActionForm"
																	property="idFuncionario">
																	<html:text property="descricaoFuncionario" value="" size="30"
																		readonly="true"
																		style="background-color:#EFEFEF; border:0; color: #ff0000" />
																</logic:empty>
																<logic:notEmpty name="EfetuarLigacaoAguaComInstalacaoHidrometroActionForm"
																	property="idFuncionario">
																	<html:text property="descricaoFuncionario" size="30"
																		readonly="true"
																		style="background-color:#EFEFEF; border:0; color: #000000" />
												...
												<table width="100%" border="0" bgcolor="#99CCFF">
													...
													<tr bgcolor="#cbe5fe">
														...
														<table border="0" width="100%">
															...
															<logic:notEqual name="EfetuarLigacaoAguaComInstalacaoHidrometroActionForm" property="alteracaoValor" value="OK">
															<tr>
															...
															<logic:equal name="EfetuarLigacaoAguaComInstalacaoHidrometroActionForm" property="alteracaoValor" value="OK">
															<tr>
																<td><strong>Valor do Débito:</strong></td>
																<td colspan="2"><strong> <html:text
