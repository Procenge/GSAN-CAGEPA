...
<script language="JavaScript">
   ...
   if(testarCampoValorZero(document.EfetuarReligacaoAguaComInstalacaoTubeteMagneticoActionForm.idOrdemServico, 'Ordem de Serviço')&& 
   testarCampoValorZero(document.EfetuarReligacaoAguaComInstalacaoTubeteMagneticoActionForm.matriculaImovel, 'Matrícula do imóvel')&&
   testarCampoValorZero(document.EfetuarReligacaoAguaAComInstalacaoTubeteMagneticoctionForm.inscricaoImovel, 'Inscrição do Imóvel')&&   
   testarCampoValorZero(document.EfetuarReligacaoAguaComInstalacaoTubeteMagneticoActionForm.cpfCnpjCliente, 'cpfCnpjCliente')&&
   testarCampoValorZero(document.EfetuarReligacaoAguaComInstalacaoTubeteMagneticoActionForm.situacaoLigacaoAgua, 'Situação da Ligacao Agua')&& 
   testarCampoValorZero(document.EfetuarReligacaoAguaComInstalacaoTubeteMagneticoActionForm.situacaoLigacaoEsgoto, 'Situação da Ligacao Esgoto')) {
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Religação de Ligação de Água com Instalação Tubete Magnético</td>
									<td width="11"><img border="0"
							...
							<table width="100%" border="0">
								<tr>
									...
									<table width="100%" border="0" align="center">
										<tr>
											<td height="10" colspan="2">Para efetuar a religação da
											ligação de água com instalação de Tubete Magnético, informe os dados abaixo:</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarReligacaoAguaComInstalacaoTubeteMagneticoAction.do', 'idOrdemServico','Ordem de Serviço');"
