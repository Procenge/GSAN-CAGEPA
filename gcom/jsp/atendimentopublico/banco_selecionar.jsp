			...
			<table width="100%" height="34" border="0" align="center"
				...
				<tr>
					...
					<td width="20%" align="center"><a
						href="javascript:abrirPopup('enviarDadosBancosAction.do?banco=BancoBrasil', 800, 600);">
					<img align="center" border="0"
						src="<bean:message key="caminho.imagens"/>logobrasil.png"
						title="Banco do Brasil" /></a></td>
					...
					<td width="20%" align="center"><a
						href="javascript:
						window.open('http://www.bancoreal.com.br','mywindow','width=700,height=700,toolbar=yes,
						location=yes,directories=yes,status=yes,menubar=yes,scrollbars=yes,copyhistory=yes,
						resizable=yes');window.close();"><!-- <a
						href="javascript:abrirPopup('enviarDadosBancosAction.do?banco=BancoReal', 400, 800);"> --><img
						align="center" border="0"
						src="<bean:message key="caminho.imagens"/>logo_real.gif"
						title="Banco Real" /></a></td>
