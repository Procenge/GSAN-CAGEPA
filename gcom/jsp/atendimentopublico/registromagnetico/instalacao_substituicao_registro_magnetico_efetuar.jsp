...
<html:javascript staticJavascript="false"
	formName="EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm" />

<script language="JavaScript">

    function validaForm() {
    	var form = document.EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm;

		if(form.motivoNaoCobranca != null && form.motivoNaoCobranca.value == "-1" && form.valorParcelas.value == ''){
			alert('Calcule o Valor da Parcela.');		  		
		} else {		 		
			if (validateEfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm(form) && quantidadeParcelasMaiorQueZero()) {
	...
	function limparForm() {
		...
		form.action = 'exibirEfetuarInstalacaoSubstituicaoRegistroMagneticoAction.do?desfazer=sim';
		form.submit();
	 }
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    if (tipoConsulta == 'ordemServico') {
	    	form.idOrdemServico.value = codigoRegistro;
	      	form.action='exibirEfetuarInstalacaoSubstituicaoRegistroMagneticoAction.do';
	      	form.submit();
	    } else {	    	
	...
	function calcularValores(){
		var form = document.EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm;
	   	...
	   	if (validateEfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm(form) && validaDebito()){	   	
	   		if (quantidadeParcelasMaiorQueZero()) {
	   			form.action='exibirEfetuarInstalacaoSubstituicaoRegistroMagneticoAction.do?calculaValores=S';
		      	form.submit();
		   	}
		}
	}
...
<html:form action="/efetuarInstalacaoSubstituicaoRegistroMagneticoAction.do?calculaValores=S"
	name="EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm"
	type="gcom.gui.atendimentopublico.EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm"
	method="post">
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Instalação/Substituição de Registro Magnetico</td>
									<td width="11"><img border="0"
							...
							<table width="100%" border="0">
								<tr>
									...
									<table width="100%" border="0" align="center">
										<tr>
											<td height="10" colspan="2">Para efetuar a instalação/substituição de registro magnetico, informe os dados abaixo</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarInstalacaoSubstituicaoRegistroMagneticoAction.do', 'idOrdemServico','Ordem de Serviço');"
									...
									<table width="100%" border="0" align="center">
										<tr bgcolor="#cbe5fe">
											...
											<table width="100%" border="0" bgcolor="#99CCFF">
												...
												<tr bgcolor="#99CCFF">
													<td height="18" colspan="2">
													<div align="center"><span class="style2"> Dados da Instalação/Substituição do Registro Magnético </span></div>
													</td>
												</tr>
												<tr bgcolor="#cbe5fe">
													<td>
													<table border="0" width="100%">
														<tr>
															<td width="42%" height="10"><strong> Data da Instalação/Substituição <font color="#FF0000">*</font> </strong>
															</td>
								...
								<logic:notEmpty name="EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm"
														...
														<table border="0" width="100%">
															...
															<tr>
																...
																<td colspan="2"><html:text property="idTipoDebito"
																	...
																	style="background-color:#EFEFEF; border:0;" size="28"
																	maxlength="28" /></td>
															</tr>

															
															<logic:notEqual name="EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm"
															...
															<logic:equal name="EfetuarInstalacaoSubstituicaoRegistroMagneticoActionForm"
																property="alteracaoValor" value="OK">
																<tr>
																	<td><strong>Valor do Débito:</strong></td>
																	<td colspan="2"><html:text property="valorDebito"
