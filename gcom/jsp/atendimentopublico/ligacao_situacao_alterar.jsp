			...
			<table width="100%" border="0">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										<tr>
											...
											<td width="88%" colspan="3"><html:text
										...
										<tr>
											...
											<td colspan="3"><html:text property="clienteUsuario"
												readonly="true"
												style="background-color:#EFEFEF; border:0; color: #000000"
										...
										<tr>
											...
											<td colspan="3"><html:text property="cpfCnpjCliente"
												readonly="true"
												style="background-color:#EFEFEF; border:0; color: #000000"
												size="40" maxlength="40" /></td>
										</tr>
				...
				<tr>
					<td colspan="4"><strong>Ligação a ser Alterada:<font
						...
						onclick="javascript:redicionaTipoLigacao();"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										<tr>
											<td><strong>Situação Atual da Ligação:</strong></td>
										...
										<tr>
											<td><strong>Selecione a Nova Situação:<logic:notEmpty
