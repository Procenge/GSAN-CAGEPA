...
<html:javascript staticJavascript="false"
	formName="EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm" />
...
<script language="JavaScript">
	...
	function validaForm() {
		var form = document.EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm;
		if (validateEfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm(form) && validaDebito()){
				//submeterFormPadrao(form);
				form.action='efetuarInstalacaoSubstituicaoTubeteMagneticoAction.do?menu=sim';
		      	form.submit();
		}
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    if (tipoConsulta == 'ordemServico') {
	    	form.idOrdemServico.value = codigoRegistro;
	      	form.action='exibirEfetuarInstalacaoSubstituicaoTubeteMagneticoAction.do';
	      	form.submit();
	    } else {	    	
	...
	function calcularValores(){
		...
		var form = document.EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm;
	   	if (validateEfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm(form) && validaDebito()){
	   		...
	   		form.action='exibirEfetuarInstalacaoSubstituicaoTubeteMagneticoAction.do?calculaValores=S';
	      	form.submit();
		}
	}
...
<html:form action="/exibirEfetuarInstalacaoSubstituicaoTubeteMagneticoAction.do"
	name="EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm"
	type="gcom.gui.atendimentopublico.EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm"
	method="post">
		                  ...
		                  <logic:present name="semMenu">
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Instalação/Substituição Tubete Magnético</td>
									<td width="11"><img border="0"
							...
							<table width="100%" border="0">
								<tr>
									...
									<table width="100%" border="0" align="center">
										<tr>
											<td height="10" colspan="2">Para efetuar a instalação/substituição de Tubete Magnético, informe os dados abaixo:</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarInstalacaoSubstituicaoTubeteMagneticoAction.do', 'idOrdemServico','Ordem de Serviço');"
										...
										<tr bgcolor="#cbe5fe">
											...
											<table width="100%" border="0" bgcolor="#99CCFF">
												<tr bgcolor="#99CCFF">
													...
													<td height="18" colspan="2">
													<div align="center">Dados da Instalação/Substituição do Tubete Magnético</div>
													</td>
												</tr>
												<tr bgcolor="#cbe5fe">
													<td>
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="39%" height="10"><strong>Data da Instalaçao/Substituição:<span
								...
								<logic:notEmpty name="EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm"
												...
												<table width="100%" border="0" bgcolor="#99CCFF">
													...
													<tr bgcolor="#cbe5fe">
														...
														<table border="0" width="100%">
															...
															<logic:notEqual name="EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm" property="alteracaoValor" value="OK">
																<tr>
															...
															<logic:equal name="EfetuarInstalacaoSubstituicaoTubeteMagneticoActionForm" property="alteracaoValor" value="OK">
																<tr>
																	<td>Valor do Débito:<font color="#FF0000">*</font></td>
																	<td colspan="2">
																		<html:text property="valorDebito"
