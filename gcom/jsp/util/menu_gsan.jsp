...
<link rel="StyleSheet" href="<bean:message key="caminho.css"/>dtree.css"
	type="text/css" />
	
<script type="text/javascript"
	src="<bean:message key="caminho.js"/>dtree.js"></script>
	
<table width="100%" border="0" class="layerMenu">
<tr>
    <td>
  ...
  <%-- 
	<tr>
		...
		<div class="dtree"><script><!-- -
		  ...
		  d.add(207,206,'Manter RA - Registro de Atendimento','exibirFiltrarRegistroAtendimentoAction.do?menu=sim');
		  ...
		  d.add(213,206,'Inserir RA - Registro de Atendimento','exibirInserirRegistroAtendimentoAction.do?menu=sim');
