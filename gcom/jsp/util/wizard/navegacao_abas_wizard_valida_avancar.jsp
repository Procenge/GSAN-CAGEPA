...
<table align="right" cellpadding="0" cellspacing="0">
	<tr>
		...
		<logic:iterate name="statusWizard" property="relacaoNumeroPaginaCaminho" id="itemWizard" scope="page">
		...
		var hint = <%=""+condicaoHint%>;
		 ...
		 switch (qtdAbas){
			...
			case 6: 
				...
				if (hint == "0"){
					document.getElementById("Layer1").style.left = 138;
				}
				else{
					document.getElementById("Layer1").style.left = 138;
				}
			...
			case 7: 
				...
				if (hint == "0"){
					document.getElementById("Layer1").style.left = 125;
				}
				else{
					document.getElementById("Layer1").style.left = 92;
				}
