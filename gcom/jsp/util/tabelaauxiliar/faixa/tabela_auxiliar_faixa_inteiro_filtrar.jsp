...
<html:form action="/filtrarTabelaAuxiliarFaixaInteiroAction" method="post">
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="id" maxlength="3" onkeypress="return isCampoNumerico(event);" size="3"/><font size="1">&nbsp;(somente
					números)</font> <br>
					<font color="red"><html:errors property="id" /></font></td>
				</tr>
				<tr>
					<td width="30%"><strong>Menor Faixa (m2):</strong></td>
					<td ><input type"text" name="menorFaixa" onkeypress="return isCampoNumerico(event);"
				...
				<tr>
					<td width="30%"><strong>Maior Faixa (m2):</strong></td>
					<td><input type"text" name="maiorFaixa" onkeypress="return isCampoNumerico(event);"
