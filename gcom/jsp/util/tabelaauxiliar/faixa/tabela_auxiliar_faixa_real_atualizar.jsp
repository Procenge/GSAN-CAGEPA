...
<html:form action="/atualizarTabelaAuxiliarFaixaRealAction"
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="30%" height="24"><strong><bean:write name="descricaoFaixaMenor"/>:<font
				...
				<tr>
					<td width="30%" height="24"><strong><bean:write name="descricaoFaixaMaior"/>:<font
						color="#FF0000">*</font></strong></td>
				...
				<tr>
					<td><logic:present name="manter" scope="session">
						...
						<input type="button" name="ButtonReset" class="bottonRightCol"
							value="Voltar"
							onClick="javascript:window.location.href='/gsan/exibirManterTabelaAuxiliarFaixaRealAction.do'">

					</logic:present> <logic:notPresent name="manter" scope="session">
						<input type="button" name="ButtonReset" class="bottonRightCol"
							value="Voltar"
							onClick="javascript:window.location.href='/gsan/exibirFiltrarTabelaAuxiliarFaixaRealAction.do'">
					</logic:notPresent> <input type="button" name="ButtonReset"
						class="bottonRightCol" value="Desfazer"
						onClick="window.location.href='<html:rewrite page="/exibirAtualizarTabelaAuxiliarFaixaRealAction.do?desfazer=S"/>'">
