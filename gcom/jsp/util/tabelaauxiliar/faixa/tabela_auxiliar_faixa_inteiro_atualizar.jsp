...
<html:form action="/atualizarTabelaAuxiliarFaixaInteiroAction"
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="30%" height="24"><strong>Menor Faixa (m2):<font
						color="#FF0000">*</font></strong></td>
					<td width="85%"><input type"text" name="menorFaixa" onkeypress="return isCampoNumerico(event);"
				...
				<tr>
					<td width="30%" height="24"><strong>Maior Faixa (m2):<font
						color="#FF0000">*</font></strong></td>
					<td width="85%"><input type"text" name="maiorFaixa" onkeypress="return isCampoNumerico(event);"
				...
				<tr>
					<td><logic:present name="manter" scope="session">
						...
						<input type="button" name="ButtonReset" class="bottonRightCol"
							value="Voltar"
							onClick="javascript:window.location.href='/gsan/exibirManterTabelaAuxiliarFaixaInteiroAction.do'">

					</logic:present> <logic:notPresent name="manter" scope="session">
						<input type="button" name="ButtonReset" class="bottonRightCol"
							value="Voltar"
							onClick="javascript:window.location.href='/gsan/exibirFiltrarTabelaAuxiliarFaixaInteiroAction.do'">
					</logic:notPresent> <input type="button" name="ButtonReset"
						class="bottonRightCol" value="Desfazer"
						onClick="window.location.href='<html:rewrite page="/exibirAtualizarTabelaAuxiliarFaixaInteiroAction.do?desfazer=S"/>'">
