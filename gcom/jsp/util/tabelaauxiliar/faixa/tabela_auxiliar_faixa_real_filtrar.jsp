...
<html:form action="/filtrarTabelaAuxiliarFaixaRealAction" method="post">
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="30%"><strong><bean:write name="descricaoFaixaMenor"/>:</strong></td>
					<td ><input type"text" name="volumeMenorFaixa"
						maxlength="<bean:write name="tamMaxCampoVolumeMenor" scope="session"/>"
						size="<bean:write name="tamMaxCampoVolumeMenor" scope="session"/>" onkeyup="javascript:formataValorMonetario(this, 7);"/>
					<br>
					<font color="red"><html:errors property="volumeMenorFaixa" /></font></td>
				</tr>
				<tr>
					<td width="30%"><strong><bean:write name="descricaoFaixaMaior"/>:</strong></td>
					<td><input type"text" name="volumeMaiorFaixa"
						maxlength="<bean:write name="tamMaxCampoVolumeMaior" scope="session"/>"
						size="<bean:write name="tamMaxCampoVolumeMaior" scope="session"/>" onkeyup="javascript:formataValorMonetario(this, 7);"/>
					<br>
