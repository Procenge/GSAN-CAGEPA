...
<html:form
  action="/removerTabelaAuxiliarFaixaInteiroAction"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="29%">
									<div align="center"><strong>Menor Faixa (m2)</strong></div>
									</td>
									<td width="30%">
									<div align="center"><strong>Maior Faixa (m2)</strong></div>
									</td>
									<td width="30%">
			...
			if (cont % 2 == 0) {%>
											...
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><html:link
													href="/gsan/exibirAtualizarTabelaAuxiliarFaixaInteiroAction.do?tela=areaConstruidaFaixa&manter=sim"
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit styleClass="bottonRightCol" value="Excluir" property="Button"/></font> <input name="button" type="button"
										...
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarTabelaAuxiliarFaixaInteiroAction.do?limpar=S&tela=${sessionScope.tela}"/>'"
