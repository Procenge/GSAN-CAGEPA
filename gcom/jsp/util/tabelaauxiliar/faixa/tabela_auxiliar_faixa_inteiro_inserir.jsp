...
<html:form action="/inserirTabelaAuxiliarFaixaInteiroAction" method="post"
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="30%" height="0"><strong>Menor Faixa (m2):<font
						color="#FF0000">*</font></strong></td>
					<td colspan="2"><input type="text" name="menorFaixa" onkeypress="return isCampoNumerico(event);"
						size="<bean:write name="tamMaxCampoMenorFaixa" scope="request"/>"
						maxlength="<bean:write name="tamMaxCampoMenorFaixa" scope="request" />"
						></td>
				</tr>
				<tr>
					<td width="30%" height="0"><strong>Maior Faixa (m2):<font
						color="#FF0000">*</font></strong></td>
					<td colspan="2"><input type="text" name="maiorFaixa" onkeypress="return isCampoNumerico(event);"
