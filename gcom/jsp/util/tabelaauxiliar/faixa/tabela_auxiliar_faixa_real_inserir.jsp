...
<html:form action="/inserirTabelaAuxiliarFaixaRealAction" method="post"
	...
	<table width="770" border="0" cellspacing="4" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="30%" height="0"><strong><bean:write name="descricaoFaixaMenor"/>:<font
				...
				<tr>
					<td width="30%" height="0"><strong><bean:write name="descricaoFaixaMaior"/>:<font
						color="#FF0000">*</font></strong></td>
