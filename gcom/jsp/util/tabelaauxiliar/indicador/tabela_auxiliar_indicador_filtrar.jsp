...
<html:form action="/filtrarTabelaAuxiliarIndicadorAction" method="post">
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td><html:text property="id" onblur="javascript:validaCampoCodigo();"  maxlength="3" size="3"/><font size="1">&nbsp;(somente 
					números)</font> <br>
