...
<html:form
  action="/filtrarTabelaAuxiliarAction"
  method="post"
>
  ...
  <tr>
    ...
    <td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td width="19%" ><strong><bean:write name="descricao" scope="session"/>:</strong></td>
          <td width="81%"><input type"text" name="descricao" maxlength="<bean:write name="tamanhoMaximoCampo" scope="session"/>" size="<bean:write name="tamanhoMaximoCampo" scope="session"/>"/>
