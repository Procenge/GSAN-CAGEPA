...
<html:form action="/atualizarTabelaAuxiliarAbreviadaAction"
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><strong><bean:write name="tabelaAuxiliarAbreviada"
				...
				<tr>
					<td width="50%" height="24"><strong><bean:write
				...
				<tr>
					...
					<logic:present name="manter" scope="session">
						...
						onClick="window.location.href='<html:rewrite page="/exibirAtualizarTabelaAuxiliarAbreviadaAction.do?desfazer=S"/>'">
					</td>
