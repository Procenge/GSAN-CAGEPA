...
<html:form
  action="/removerTabelaAuxiliarAbreviadaAction"
			...
			if (cont % 2 == 0) {%>
											...
											<tr bgcolor="#cbe5fe">
												...
												<td width="16%" align="center"><html:link
													href="/gsan/exibirAtualizarTabelaAuxiliarAbreviadaAction.do?manter=sim"
												...
												<!--<td width="30%" align="center"><logic:equal
													name="tabelasAuxiliaresAbreviadas" property="indicadorUso"
													value="1">
											SIM
											</logic:equal> <logic:equal name="tabelasAuxiliaresAbreviadas"
